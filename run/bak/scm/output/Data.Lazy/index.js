...
var ordLazy = function (dictOrd) {
    ...
    return {
        compare: function (x) {
            return function (y) {
                return compare(force(x))(force(y));
            };
        },
        Eq0: function () {
            return eqLazy1;
...
var semigroupLazy = function (dictSemigroup) {
    ...
    return {
        append: function (a) {
            return function (b) {
                return defer(function (v) {
                    return append1(force(a))(force(b));
                });
            };
        }
    };
...
var semiringLazy = function (dictSemiring) {
    ...
    return {
        add: function (a) {
            return function (b) {
                return defer(function (v) {
                    return add(force(a))(force(b));
                });
            };
        },
        zero: defer(function (v) {
            return zero;
        }),
        mul: function (a) {
            return function (b) {
                return defer(function (v) {
                    return mul(force(a))(force(b));
                });
            };
        },
        one: defer(function (v) {
            return one;
        })
    };
};
        ...
        return function (f) {
            return function (l) {
                return map1(function ($105) {
                    return defer(Data_Function["const"]($105));
                })(f(force(l)));
            };
        };
    },
    sequence: function (dictApplicative) {
        ...
        return function (l) {
            return map1(function ($106) {
                return defer(Data_Function["const"]($106));
            })(force(l));
        };
    },
    Functor0: function () {
...
var traversable1Lazy = {
    traverse1: function (dictApply) {
        ...
        return function (f) {
            return function (l) {
                return map1(function ($107) {
                    return defer(Data_Function["const"]($107));
                })(f(force(l)));
            };
        };
    },
    sequence1: function (dictApply) {
        var map1 = Data_Functor.map(dictApply.Functor0());
        return function (l) {
            return map1(function ($108) {
                return defer(Data_Function["const"]($108));
            })(force(l));
        };
    },
    Foldable10: function () {
...
var euclideanRingLazy = function (dictEuclideanRing) {
    ...
    return {
        degree: (function () {
            var $109 = Data_EuclideanRing.degree(dictEuclideanRing);
            return function ($110) {
                return $109(force($110));
            };
        })(),
        div: function (a) {
            return function (b) {
                return defer(function (v) {
                    return div(force(a))(force(b));
                });
            };
        },
        mod: function (a) {
...
var boundedLazy = function (dictBounded) {
    ...
    return {
        top: defer(function (v) {
            return top;
        }),
        bottom: defer(function (v) {
            return bottom;
        }),
        Ord0: function () {
            return ordLazy1;
