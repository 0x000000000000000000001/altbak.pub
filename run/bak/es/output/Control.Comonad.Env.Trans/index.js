...
const traversableEnvT = dictTraversable => {
  ...
  return {
    sequence: dictApplicative => {
      ...
      return v => Functor0.map(Data$dTuple.Tuple(v._1))(dictTraversable.sequence(dictApplicative)(v._2));
    },
    traverse: dictApplicative => {
      const Functor0 = dictApplicative.Apply0().Functor0();
      return f => v => Functor0.map(Data$dTuple.Tuple(v._1))(dictTraversable.traverse(dictApplicative)(f)(v._2));
    },
...
const traversableWithIndexEnvT = dictTraversableWithIndex => {
  ...
  return {
    traverseWithIndex: dictApplicative => {
      const Functor0 = dictApplicative.Apply0().Functor0();
      return f => v => Functor0.map(Data$dTuple.Tuple(v._1))(dictTraversableWithIndex.traverseWithIndex(dictApplicative)(f)(v._2));
    },
