...
return gopurs_runtime.Any(Call_genYear(dictMonadGen_0_box))
})
	})
...
return gopurs_runtime.Any(Call_genWeekday(dictMonadGen_0_box))
})
	})
...
return gopurs_runtime.Any(Call_genMonth(dictMonadGen_0_box))
})
	})
...
return gopurs_runtime.Any(Call_genDay(dictMonadGen_0_box))
})
	})
	return cache_genDay
}

func Call_genYear(dictMonadGen_0_loop gopurs_runtime.Value) interface{} {
...
__t1 = gopurs_runtime.Any((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(__local_var_2_0.UnsafePtr).V0)
goto end_branch_1
} else {
...
func Call_genWeekday(dictMonadGen_0_loop gopurs_runtime.Value) interface{} {
var dictMonadGen_0 gopurs_runtime.Value = dictMonadGen_0_loop
_ = dictMonadGen_0
return gopurs_runtime.UnboxAny(gopurs_runtime.Apply2(pkg_Data_Enum_Gen.Get_genBoundedEnum(), dictMonadGen_0, pkg_Data_Date_Component.Get_boundedEnumWeekday()))
}

func Call_genMonth(dictMonadGen_0_loop gopurs_runtime.Value) interface{} {
var dictMonadGen_0 gopurs_runtime.Value = dictMonadGen_0_loop
_ = dictMonadGen_0
return gopurs_runtime.UnboxAny(gopurs_runtime.Apply2(pkg_Data_Enum_Gen.Get_genBoundedEnum(), dictMonadGen_0, pkg_Data_Date_Component.Get_boundedEnumMonth()))
}

func Call_genDay(dictMonadGen_0_loop gopurs_runtime.Value) interface{} {
var dictMonadGen_0 gopurs_runtime.Value = dictMonadGen_0_loop
_ = dictMonadGen_0
return gopurs_runtime.UnboxAny(gopurs_runtime.Apply2(pkg_Data_Enum_Gen.Get_genBoundedEnum(), dictMonadGen_0, pkg_Data_Date_Component.Get_boundedEnumDay()))
}
