...
{
if (gopurs_runtime.Bool(Call_lessThanOrEq__4087042607(n_2, gopurs_runtime.Int(0))).IntVal) != (0) {
__t1 = acc_3
goto end_branch_1
} else {
...
{
n_2_loop = gopurs_runtime.Apply2(Get_sub__1043827704(), n_2, gopurs_runtime.Int(1))
