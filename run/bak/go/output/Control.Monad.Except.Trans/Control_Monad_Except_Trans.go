...
var cache_runExceptT__gopurs_runtime_Value_1081969883 gopurs_runtime.Value
var once_runExceptT__gopurs_runtime_Value_1081969883 sync.Once
func Get_runExceptT__gopurs_runtime_Value_1081969883() gopurs_runtime.Value {
	once_runExceptT__gopurs_runtime_Value_1081969883.Do(func() {
		cache_runExceptT__gopurs_runtime_Value_1081969883 = gopurs_runtime.Func(func(v_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_runExceptT__gopurs_runtime_Value_1081969883(v_0_box)
})
	})
	return cache_runExceptT__gopurs_runtime_Value_1081969883
}
...
return gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonad_0, "Applicative0"), gopurs_runtime.Value{}), "pure"), gopurs_runtime.Value{Type: 9, IntVal: 2465973597, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value]{1, a_2})})
}))
}))
	})
...
var cache_mapExceptT__gopurs_runtime_Value_1035271418 gopurs_runtime.Value
var once_mapExceptT__gopurs_runtime_Value_1035271418 sync.Once
func Get_mapExceptT__gopurs_runtime_Value_1035271418() gopurs_runtime.Value {
	once_mapExceptT__gopurs_runtime_Value_1035271418.Do(func() {
		cache_mapExceptT__gopurs_runtime_Value_1035271418 = gopurs_runtime.Func2(func(f_0_box gopurs_runtime.Value, v_1_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_mapExceptT__gopurs_runtime_Value_1035271418(f_0_box, v_1_box)
})
	})
	return cache_mapExceptT__gopurs_runtime_Value_1035271418
}

var cache_mapExceptT__gopurs_runtime_Value_2837505914 gopurs_runtime.Value
var once_mapExceptT__gopurs_runtime_Value_2837505914 sync.Once
func Get_mapExceptT__gopurs_runtime_Value_2837505914() gopurs_runtime.Value {
	once_mapExceptT__gopurs_runtime_Value_2837505914.Do(func() {
		cache_mapExceptT__gopurs_runtime_Value_2837505914 = gopurs_runtime.Func2(func(f_0_box gopurs_runtime.Value, v_1_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_mapExceptT__gopurs_runtime_Value_2837505914(f_0_box, v_1_box)
})
	})
	return cache_mapExceptT__gopurs_runtime_Value_2837505914
}
...
(*pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value])(f_1.UnsafePtr).V0 = (*pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value])(v2_3.UnsafePtr).V0
return f_1
} else {
return gopurs_runtime.Value{Type: 9, IntVal: 2465973597, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value]{1, (*pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value])(v2_3.UnsafePtr).V0})}
}
}()
goto end_branch_0
} else {
...
(*pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value])(v_2.UnsafePtr).V0 = gopurs_runtime.Apply(f_1, (*pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value])(v2_3.UnsafePtr).V0)
return v_2
} else {
return gopurs_runtime.Value{Type: 9, IntVal: 3711209382, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value]{1, gopurs_runtime.Apply(f_1, (*pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value])(v2_3.UnsafePtr).V0)})}
}
}()
goto end_branch_0
} else {
...
func Call_runExceptT__gopurs_runtime_Value_1081969883(v_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
var v_0 gopurs_runtime.Value = v_0_loop
_ = v_0
return v_0
}
...
func Call_mapExceptT__gopurs_runtime_Value_1035271418(f_0_loop gopurs_runtime.Value, v_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var f_0 gopurs_runtime.Value = f_0_loop
_ = f_0
var v_1 gopurs_runtime.Value = v_1_loop
_ = v_1
...
func Call_mapExceptT__gopurs_runtime_Value_2837505914(f_0_loop gopurs_runtime.Value, v_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var f_0 gopurs_runtime.Value = f_0_loop
_ = f_0
var v_1 gopurs_runtime.Value = v_1_loop
_ = v_1
...
{
if (v2_3.Type == 9 && v2_3.IntVal == 3711209382) {
__t0 = gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonad_0, "Applicative0"), gopurs_runtime.Value{}), "pure"), gopurs_runtime.Value{Type: 9, IntVal: 3711209382, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value]{1, (*pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value])(v2_3.UnsafePtr).V0})})
goto end_branch_0
} else {
...
__local_var_3_2 := Call_bindExceptT(dictMonad_0)
_ = __local_var_3_2
...
return gopurs_runtime.Apply(gopurs_runtime.RecordGet(Call_applicativeExceptT(dictMonad_0), "pure"), gopurs_runtime.Apply(f_prime_6, a_prime_7))
}))
}))
}))
}
...
return gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonad_0, "Applicative0"), gopurs_runtime.Value{}), "pure"), gopurs_runtime.Value{Type: 9, IntVal: 2465973597, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value]{1, x_1})})
}))
}
...
var dictMonad_0 gopurs_runtime.Value = dictMonad_0_loop
_ = dictMonad_0
__local_var_1_0 := Call_applyExceptT(dictMonad_0)
_ = __local_var_1_0
...
_ = __local_var_1_0
monadExceptT1_2_1 := gopurs_runtime.RecordDict2("Applicative0", "Bind1", gopurs_runtime.Func(func(_dollar__unused_2 gopurs_runtime.Value) gopurs_runtime.Value {
return Call_applicativeExceptT(__local_var_1_0)
}), gopurs_runtime.Func(func(_dollar__unused_2 gopurs_runtime.Value) gopurs_runtime.Value {
return Call_bindExceptT(__local_var_1_0)
}))
_ = monadExceptT1_2_1
...
return gopurs_runtime.Apply(c_4, func() gopurs_runtime.Value {
if ((__local_var_1_0.UnsafePtr) != (nil)) && (((*struct{Rc uint32})(__local_var_1_0.UnsafePtr).Rc) == (1)) {
(*pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value])(__local_var_1_0.UnsafePtr).V0 = a_5
return __local_var_1_0
} else {
return gopurs_runtime.Value{Type: 9, IntVal: 2465973597, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value]{1, a_5})}
}
}())
}))
}))
...
if ((Monad0_1_0.UnsafePtr) != (nil)) && (((*struct{Rc uint32})(Monad0_1_0.UnsafePtr).Rc) == (1)) {
(*pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value])(Monad0_1_0.UnsafePtr).V0 = (*pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value])(m_prime_5.UnsafePtr).V0
return Monad0_1_0
} else {
return gopurs_runtime.Value{Type: 9, IntVal: 3711209382, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value]{1, (*pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value])(m_prime_5.UnsafePtr).V0})}
}
}()
return Monad0_1_0
} else {
...
if ((Monad0_1_0.UnsafePtr) != (nil)) && (((*struct{Rc uint32})(Monad0_1_0.UnsafePtr).Rc) == (1)) {
(*pkg_Control_Monad_Rec_Class.Constructor_Loop[gopurs_runtime.Value, gopurs_runtime.Value])(Monad0_1_0.UnsafePtr).V0 = (*pkg_Control_Monad_Rec_Class.Constructor_Loop[gopurs_runtime.Value, gopurs_runtime.Value])((*pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value])(m_prime_5.UnsafePtr).V0.UnsafePtr).V0
return Monad0_1_0
} else {
return gopurs_runtime.Value{Type: 9, IntVal: 525585346, UnsafePtr: unsafe.Pointer(&pkg_Control_Monad_Rec_Class.Constructor_Loop[gopurs_runtime.Value, gopurs_runtime.Value]{1, (*pkg_Control_Monad_Rec_Class.Constructor_Loop[gopurs_runtime.Value, gopurs_runtime.Value])((*pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value])(m_prime_5.UnsafePtr).V0.UnsafePtr).V0})}
}
}()
goto end_branch_3
} else {
...
(*pkg_Control_Monad_Rec_Class.Constructor_Done[gopurs_runtime.Value, gopurs_runtime.Value])(Monad0_1_0.UnsafePtr).V0 = func() gopurs_runtime.Value {
if ((Monad0_1_0.UnsafePtr) != (nil)) && (((*struct{Rc uint32})(Monad0_1_0.UnsafePtr).Rc) == (1)) {
(*pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value])(Monad0_1_0.UnsafePtr).V0 = (*pkg_Control_Monad_Rec_Class.Constructor_Done[gopurs_runtime.Value, gopurs_runtime.Value])((*pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value])(m_prime_5.UnsafePtr).V0.UnsafePtr).V0
return Monad0_1_0
} else {
...
_ = Monoid0_5_4
monadTellExceptT1_6_5 := Call_monadTellExceptT(MonadTell1_1_0)
...
if ((Monad1_2_1.UnsafePtr) != (nil)) && (((*struct{Rc uint32})(Monad1_2_1.UnsafePtr).Rc) == (1)) {
(*pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(Monad1_2_1.UnsafePtr).V0 = r_10
(*pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(Monad1_2_1.UnsafePtr).V1 = __local_var_9_6
return Monad1_2_1
} else {
return gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value]{1, r_10, __local_var_9_6})}
}
}()
...
if ((Monad1_2_1.UnsafePtr) != (nil)) && (((*struct{Rc uint32})(Monad1_2_1.UnsafePtr).Rc) == (1)) {
(*pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(Monad1_2_1.UnsafePtr).V0 = func() gopurs_runtime.Value {
if ((Monad1_2_1.UnsafePtr) != (nil)) && (((*struct{Rc uint32})(Monad1_2_1.UnsafePtr).Rc) == (1)) {
(*pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value])(Monad1_2_1.UnsafePtr).V0 = (*pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value])(a_8.UnsafePtr).V0
return Monad1_2_1
} else {
return gopurs_runtime.Value{Type: 9, IntVal: 3711209382, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value]{1, (*pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value])(a_8.UnsafePtr).V0})}
}
}()
(*pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(Monad1_2_1.UnsafePtr).V1 = Get_identity()
return Monad1_2_1
} else {
...
(*pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(Monad1_2_1.UnsafePtr).V0 = func() gopurs_runtime.Value {
if ((Monad1_2_1.UnsafePtr) != (nil)) && (((*struct{Rc uint32})(Monad1_2_1.UnsafePtr).Rc) == (1)) {
(*pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value])(Monad1_2_1.UnsafePtr).V0 = (*pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])((*pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value])(a_8.UnsafePtr).V0.UnsafePtr).V0
return Monad1_2_1
} else {
return gopurs_runtime.Value{Type: 9, IntVal: 2465973597, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value]{1, (*pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])((*pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value])(a_8.UnsafePtr).V0.UnsafePtr).V0})}
}
}()
(*pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(Monad1_2_1.UnsafePtr).V1 = (*pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])((*pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value])(a_8.UnsafePtr).V0.UnsafePtr).V1
return Monad1_2_1
} else {
return gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value]{1, func() gopurs_runtime.Value {
if ((Monad1_2_1.UnsafePtr) != (nil)) && (((*struct{Rc uint32})(Monad1_2_1.UnsafePtr).Rc) == (1)) {
...
}(), (*pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])((*pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value])(a_8.UnsafePtr).V0.UnsafePtr).V1})}
}
}()
goto end_branch_7
} else {
...
if ((monadExceptT1_1_0.UnsafePtr) != (nil)) && (((*struct{Rc uint32})(monadExceptT1_1_0.UnsafePtr).Rc) == (1)) {
(*pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value])(monadExceptT1_1_0.UnsafePtr).V0 = x_2
return monadExceptT1_1_0
} else {
return gopurs_runtime.Value{Type: 9, IntVal: 3711209382, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value]{1, x_2})}
}
}())
}))
}
...
var dictMonad_0 gopurs_runtime.Value = dictMonad_0_loop
_ = dictMonad_0
monadThrowExceptT1_1_0 := Call_monadThrowExceptT(dictMonad_0)
...
__t1 = gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonad_0, "Applicative0"), gopurs_runtime.Value{}), "pure"), func() gopurs_runtime.Value {
if ((monadThrowExceptT1_1_0.UnsafePtr) != (nil)) && (((*struct{Rc uint32})(monadThrowExceptT1_1_0.UnsafePtr).Rc) == (1)) {
(*pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value])(monadThrowExceptT1_1_0.UnsafePtr).V0 = (*pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value])(v2_4.UnsafePtr).V0
return monadThrowExceptT1_1_0
} else {
return gopurs_runtime.Value{Type: 9, IntVal: 2465973597, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value]{1, (*pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value])(v2_4.UnsafePtr).V0})}
}
}())
goto end_branch_1
} else {
...
}), gopurs_runtime.Apply(gopurs_runtime.RecordGet(Call_applicativeExceptT(dictMonad_0), "pure"), gopurs_runtime.RecordGet(dictMonoid_2, "mempty")))
})
}
...
__t4 = gopurs_runtime.Apply(gopurs_runtime.RecordGet(__local_var_3_1, "pure"), func() gopurs_runtime.Value {
if ((Bind1_2_0.UnsafePtr) != (nil)) && (((*struct{Rc uint32})(Bind1_2_0.UnsafePtr).Rc) == (1)) {
(*pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value])(Bind1_2_0.UnsafePtr).V0 = (*pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value])(rm_8.UnsafePtr).V0
return Bind1_2_0
} else {
return gopurs_runtime.Value{Type: 9, IntVal: 2465973597, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value]{1, (*pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value])(rm_8.UnsafePtr).V0})}
}
}())
goto end_branch_4
} else {
...
__t6 = gopurs_runtime.Apply(gopurs_runtime.RecordGet(__local_var_3_1, "pure"), func() gopurs_runtime.Value {
if ((Bind1_2_0.UnsafePtr) != (nil)) && (((*struct{Rc uint32})(Bind1_2_0.UnsafePtr).Rc) == (1)) {
(*pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value])(Bind1_2_0.UnsafePtr).V0 = (*pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value])(rn_10.UnsafePtr).V0
return Bind1_2_0
} else {
return gopurs_runtime.Value{Type: 9, IntVal: 2465973597, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value]{1, (*pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value])(rn_10.UnsafePtr).V0})}
}
}())
goto end_branch_6
} else {
...
__t6 = gopurs_runtime.Apply(gopurs_runtime.RecordGet(__local_var_3_1, "pure"), func() gopurs_runtime.Value {
if ((Bind1_2_0.UnsafePtr) != (nil)) && (((*struct{Rc uint32})(Bind1_2_0.UnsafePtr).Rc) == (1)) {
(*pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value])(Bind1_2_0.UnsafePtr).V0 = gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictSemigroup_0, "append"), __local_var_9_5, (*pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value])(rn_10.UnsafePtr).V0)
return Bind1_2_0
} else {
return gopurs_runtime.Value{Type: 9, IntVal: 3711209382, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value]{1, gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictSemigroup_0, "append"), __local_var_9_5, (*pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value])(rn_10.UnsafePtr).V0)})}
}
}())
goto end_branch_6
} else {
