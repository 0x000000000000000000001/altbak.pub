...
return Call_liftEffect((*Record_liftEffect_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
...
func Call_liftEffect(dict_0_loop *Record_liftEffect_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_liftEffect_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.liftEffect
}
