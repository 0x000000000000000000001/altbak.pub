...
return Call_liftST((*Record_liftST_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
	return cache_liftST
}
...
func Call_liftST(dict_0_loop *Record_liftST_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_liftST_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.liftST
}
