...
{
if (i_0.IntVal) == (0) {
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just{gopurs_runtime.Value{Type: 9, IntVal: 1454898258, UnsafePtr: nil}})}
goto end_branch_0
} else {
...
__t2 = gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Maybe.Get_functorMaybe(), "map"), pkg_Data_Generic_Rep.Get_Inl(), gopurs_runtime.Apply(((*gopurs_runtime.RecordData2)(dictGenericEnum_0.UnsafePtr)).V0, (*pkg_Data_Generic_Rep.Constructor_Inl)(v_6.UnsafePtr).V0))
goto end_branch_2
} else {
...
v1_7_3 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictGenericEnum1_3, "genericPred'"), (*pkg_Data_Generic_Rep.Constructor_Inr)(v_6.UnsafePtr).V0)
_ = v1_7_3
var __t4 gopurs_runtime.Value
{
if (v1_7_3.Type == 9 && v1_7_3.IntVal == 3589588149) {
__t4 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just{gopurs_runtime.Value{Type: 9, IntVal: 3478632216, UnsafePtr: unsafe.Pointer(&pkg_Data_Generic_Rep.Constructor_Inl{genericTop_prime_2_0})}})}
goto end_branch_4
} else {
...
__t4 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just{gopurs_runtime.Value{Type: 9, IntVal: 492034566, UnsafePtr: unsafe.Pointer(&pkg_Data_Generic_Rep.Constructor_Inr{(*pkg_Data_Maybe.Constructor_Just)(v1_7_3.UnsafePtr).V0})}})}
goto end_branch_4
} else {
...
{
if (v_6.Type == 9 && v_6.IntVal == 3478632216) {
v1_7_6 := gopurs_runtime.Apply(((*gopurs_runtime.RecordData2)(dictGenericEnum_0.UnsafePtr)).V1, (*pkg_Data_Generic_Rep.Constructor_Inl)(v_6.UnsafePtr).V0)
_ = v1_7_6
var __t7 gopurs_runtime.Value
{
if (v1_7_6.Type == 9 && v1_7_6.IntVal == 3589588149) {
__t7 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just{gopurs_runtime.Value{Type: 9, IntVal: 492034566, UnsafePtr: unsafe.Pointer(&pkg_Data_Generic_Rep.Constructor_Inr{genericBottom_prime_5_1})}})}
goto end_branch_7
} else {
...
__t7 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just{gopurs_runtime.Value{Type: 9, IntVal: 3478632216, UnsafePtr: unsafe.Pointer(&pkg_Data_Generic_Rep.Constructor_Inl{(*pkg_Data_Maybe.Constructor_Just)(v1_7_6.UnsafePtr).V0})}})}
goto end_branch_7
} else {
...
{
if (v_6.Type == 9 && v_6.IntVal == 492034566) {
__t5 = gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Maybe.Get_functorMaybe(), "map"), pkg_Data_Generic_Rep.Get_Inr(), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictGenericEnum1_3, "genericSucc'"), (*pkg_Data_Generic_Rep.Constructor_Inr)(v_6.UnsafePtr).V0))
goto end_branch_5
} else {
...
return gopurs_runtime.Value{Type: 9, IntVal: 1171963320, UnsafePtr: unsafe.Pointer(&pkg_Data_Generic_Rep.Constructor_Product{a_10, genericTop_prime_5_0})}
}), gopurs_runtime.Apply(((*gopurs_runtime.RecordData2)(dictGenericEnum_0.UnsafePtr)).V0, (*pkg_Data_Generic_Rep.Constructor_Product)(v_8.UnsafePtr).V0))
goto end_branch_3
} else {
...
v1_9_4 := gopurs_runtime.Apply(((*gopurs_runtime.RecordData2)(dictGenericEnum1_3.UnsafePtr)).V1, (*pkg_Data_Generic_Rep.Constructor_Product)(v_8.UnsafePtr).V1)
_ = v1_9_4
var __t5 gopurs_runtime.Value
{
...
return gopurs_runtime.Value{Type: 9, IntVal: 1171963320, UnsafePtr: unsafe.Pointer(&pkg_Data_Generic_Rep.Constructor_Product{a_10, genericBottom_prime_7_1})}
}), gopurs_runtime.Apply(((*gopurs_runtime.RecordData2)(dictGenericEnum_0.UnsafePtr)).V1, (*pkg_Data_Generic_Rep.Constructor_Product)(v_8.UnsafePtr).V0))
goto end_branch_5
} else {
...
__t1 = gopurs_runtime.Apply(((*gopurs_runtime.RecordData3)(dictGenericBoundedEnum_0.UnsafePtr)).V1, (*pkg_Data_Generic_Rep.Constructor_Inl)(v_3.UnsafePtr).V0)
goto end_branch_1
} else {
...
__t1 = gopurs_runtime.Int((gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictGenericBoundedEnum1_2, "genericFromEnum'"), (*pkg_Data_Generic_Rep.Constructor_Inr)(v_3.UnsafePtr).V0).IntVal) + (genericCardinality_prime1_1_0.IntVal))
goto end_branch_1
} else {
...
return gopurs_runtime.Int(((gopurs_runtime.Apply(((*gopurs_runtime.RecordData3)(dictGenericBoundedEnum_0.UnsafePtr)).V1, (*pkg_Data_Generic_Rep.Constructor_Product)(v1_4.UnsafePtr).V0).IntVal) * (genericCardinality_prime2_3_1.IntVal)) + (gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictGenericBoundedEnum1_2, "genericFromEnum'"), (*pkg_Data_Generic_Rep.Constructor_Product)(v1_4.UnsafePtr).V1).IntVal))
