...
_ = s_1
return Call_append__493084344(gopurs_runtime.Str(s_1), gopurs_runtime.Str(gopurs_runtime.Apply(pkg_Data_String_CodePoints.Get_singleton(), gopurs_runtime.Int(c_0)).StrVal())).StrVal()
}
...
var s_1 string = s_1_loop
_ = s_1
return Call_append__493084344(gopurs_runtime.Str(gopurs_runtime.Apply(pkg_Data_String_CodePoints.Get_singleton(), gopurs_runtime.Int(c_0)).StrVal()), gopurs_runtime.Str(s_1)).StrVal()
}
