...
func Get_singleton() gopurs_runtime.Value {
	once_singleton.Do(func() {
		cache_singleton = gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), pkg_Data_String_NonEmpty_Internal.Get_NonEmptyString(), pkg_Data_String_CodePoints.Get_singleton())
	})
...
func Get_lastIndexOf() gopurs_runtime.Value {
	once_lastIndexOf.Do(func() {
		cache_lastIndexOf = gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), Get_liftS(), pkg_Data_String_CodePoints.Get_lastIndexOf())
	})
...
func Get_indexOf() gopurs_runtime.Value {
	once_indexOf.Do(func() {
		cache_indexOf = gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), Get_liftS(), pkg_Data_String_CodePoints.Get_indexOf())
	})
...
func Get_length() gopurs_runtime.Value {
	once_length.Do(func() {
		cache_length = gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), pkg_Data_String_CodePoints.Get_length(), Get_fromNonEmptyString())
	})
	return cache_length
}
...
func Get_toCodePointArray() gopurs_runtime.Value {
	once_toCodePointArray.Do(func() {
		cache_toCodePointArray = gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), pkg_Data_String_CodePoints.Get_toCodePointArray(), Get_fromNonEmptyString())
	})
...
func Get_toNonEmptyCodePointArray() gopurs_runtime.Value {
	once_toNonEmptyCodePointArray.Do(func() {
		cache_toNonEmptyCodePointArray = gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), Get_fromJust(), gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), pkg_Data_Array_NonEmpty.Get_fromArray(), Get_toCodePointArray()))
	})
...
func Get_fromNonEmptyCodePointArray() gopurs_runtime.Value {
	once_fromNonEmptyCodePointArray.Do(func() {
		cache_fromNonEmptyCodePointArray = gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), Get_fromJust(), gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), Get_fromCodePointArray(), pkg_Data_Array_NonEmpty.Get_toArray()))
	})
...
func Get_countPrefix() gopurs_runtime.Value {
	once_countPrefix.Do(func() {
		cache_countPrefix = gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), Get_liftS(), pkg_Data_String_CodePoints.Get_countPrefix())
	})
...
func Get_codePointAt() gopurs_runtime.Value {
	once_codePointAt.Do(func() {
		cache_codePointAt = gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), Get_liftS(), pkg_Data_String_CodePoints.Get_codePointAt())
	})
...
return gopurs_runtime.Apply2(pkg_Data_String_CodePoints.Get_take(), gopurs_runtime.Apply2(pkg_Data_String_CodePoints.Get_countPrefix(), f_0, v_1), v_1)
}))
}
...
_ = pat_0
return gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), Get_liftS(), gopurs_runtime.Apply(pkg_Data_String_CodePoints.Get_lastIndexOf_prime(), pat_0))
}

func Call_indexOf_prime(pat_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
var pat_0 gopurs_runtime.Value = pat_0_loop
_ = pat_0
return gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), Get_liftS(), gopurs_runtime.Apply(pkg_Data_String_CodePoints.Get_indexOf_prime(), pat_0))
}
...
_ = f_0
return gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), pkg_Data_String_NonEmpty_Internal.Get_fromString(), gopurs_runtime.Func(func(v_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(pkg_Data_String_CodePoints.Get_dropWhile(), f_0, v_1)
}))
}
...
var __t0 gopurs_runtime.Value
{
if (gopurs_runtime.Apply2(Get_greaterThanOrEq(), gopurs_runtime.Int(i_0), gopurs_runtime.Apply(pkg_Data_String_CodePoints.Get_length(), nes_1)).IntVal) != (0) {
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 3589588149, UnsafePtr: nil}
goto end_branch_0
} else {
