...
__t0 = (*pkg_Data_Either.Constructor_Left)(v_0.UnsafePtr).V0
goto end_branch_0
} else {
...
{
if (v_0.Type == 9 && v_0.IntVal == 2465973597) {
__t1 = (*pkg_Data_Either.Constructor_Right)(v_0.UnsafePtr).V0
goto end_branch_1
} else {
...
__t1 = gopurs_runtime.Apply(gopurs_runtime.RecordGet(Get_applicativeAff(), "pure"), (*pkg_Control_Monad_Rec_Class.Constructor_Done)(res_3.UnsafePtr).V0)
goto end_branch_1
} else {
...
__t1 = gopurs_runtime.Apply(go__1_0, (*pkg_Control_Monad_Rec_Class.Constructor_Loop)(res_3.UnsafePtr).V0)
goto end_branch_1
} else {
