...
return gopurs_runtime.Str("(App " + gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictShow_0_loop, "show"), v_1).StrVal + ")")
}))
}()
})
	})
...
func Get_semigroupApp() gopurs_runtime.Value {
	once_semigroupApp.Do(func() {
		semigroupApp = gopurs_runtime.Func2(Call_semigroupApp)
	})
	return semigroupApp
}
...
_ = semigroupApp2_4_2
return gopurs_runtime.RecordDict2("mempty", "Semigroup0", gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictApplicative_0_loop, "pure"), gopurs_runtime.RecordGet(dictMonoid_2, "mempty")), gopurs_runtime.Func(func(_dollar__unused_5 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_hoistApp() gopurs_runtime.Value {
	once_hoistApp.Do(func() {
		hoistApp = gopurs_runtime.Func2(Call_hoistApp)
	})
	return hoistApp
}
...
func Get_eqApp() gopurs_runtime.Value {
	once_eqApp.Do(func() {
		eqApp = gopurs_runtime.Func2(Call_eqApp)
	})
	return eqApp
}
...
_ = dictSemigroup_1
append1_2_0 := gopurs_runtime.RecordGet(dictSemigroup_1_loop, "append")
_ = append1_2_0
...
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictApply_0_loop, "apply"), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictApply_0_loop, "Functor0"), gopurs_runtime.Value{}), "map"), append1_2_0, v_3), v1_4)
}))
}
