...
return gopurs_runtime.Any(Call_showApp(dictShow_0_box))
})
	})
...
return gopurs_runtime.Any(Call_semigroupApp(dictApply_0_box, dictSemigroup_1_box))
})
	})
...
return gopurs_runtime.Any(Call_plusApp(dictPlus_0_box))
})
	})
...
func Get_newtypeApp() gopurs_runtime.Value {
	once_newtypeApp.Do(func() {
		cache_newtypeApp = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("Coercible0", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Any(Call_monadPlusApp(dictMonadPlus_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monadApp(dictMonad_0_box))
})
	})
...
return gopurs_runtime.Any(Call_lazyApp(dictLazy_0_box))
})
	})
...
func Get_hoistLowerApp() gopurs_runtime.Value {
	once_hoistLowerApp.Do(func() {
		cache_hoistLowerApp = gopurs_runtime.Func(func(arg0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Any(func(inner_arg0 interface{}) interface{} {
...
func Get_hoistLiftApp() gopurs_runtime.Value {
	once_hoistLiftApp.Do(func() {
		cache_hoistLiftApp = gopurs_runtime.Func(func(arg0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Any(func(inner_arg0 interface{}) interface{} {
return gopurs_runtime.UnboxAny(gopurs_runtime.Apply(pkg_Unsafe_Coerce.Get_unsafeCoerce(), gopurs_runtime.Any(inner_arg0)))
}(gopurs_runtime.UnboxAny(arg0)))
})
...
var cache_hoistLiftApp__func_interface____interface___3734180027 gopurs_runtime.Value
var once_hoistLiftApp__func_interface____interface___3734180027 sync.Once
func Get_hoistLiftApp__func_interface____interface___3734180027() gopurs_runtime.Value {
	once_hoistLiftApp__func_interface____interface___3734180027.Do(func() {
		cache_hoistLiftApp__func_interface____interface___3734180027 = gopurs_runtime.Func(func(arg0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Any(func(inner_arg0 interface{}) interface{} {
return gopurs_runtime.UnboxAny(gopurs_runtime.Apply(pkg_Unsafe_Coerce.Get_unsafeCoerce(), gopurs_runtime.Any(inner_arg0)))
}(gopurs_runtime.UnboxAny(arg0)))
})
	})
	return cache_hoistLiftApp__func_interface____interface___3734180027
}
...
return gopurs_runtime.Any(Call_hoistApp(func(inner_arg0 interface{}) interface{} {
...
return gopurs_runtime.Any(Call_functorApp(dictFunctor_0_box))
})
	})
...
return gopurs_runtime.Any(Call_extendApp(dictExtend_0_box))
})
	})
...
return gopurs_runtime.Any(Call_eqApp(dictEq1_0_box, dictEq_1_box))
})
	})
	return cache_eqApp
}
...
return gopurs_runtime.Any(Call_eq1App(dictEq1_0_box))
})
	})
	return cache_eq1App
}
...
return gopurs_runtime.Any(Call_ord1App(dictOrd1_0_box))
})
	})
...
return gopurs_runtime.Any(Call_comonadApp(dictComonad_0_box))
})
	})
...
return gopurs_runtime.Any(Call_bindApp(dictBind_0_box))
})
	})
...
return gopurs_runtime.Any(Call_applyApp(dictApply_0_box))
})
	})
...
return gopurs_runtime.Any(Call_applicativeApp(dictApplicative_0_box))
})
	})
...
return gopurs_runtime.Any(Call_alternativeApp(dictAlternative_0_box))
})
	})
...
return gopurs_runtime.Any(Call_altApp(dictAlt_0_box))
})
	})
	return cache_altApp
}
...
func Call_showApp(dictShow_0_loop gopurs_runtime.Value) interface{} {
...
func Call_semigroupApp(dictApply_0_loop gopurs_runtime.Value, dictSemigroup_1_loop gopurs_runtime.Value) interface{} {
...
_ = append1_2_0
return gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("append", gopurs_runtime.Func2(func(v_3 gopurs_runtime.Value, v1_4 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_plusApp(dictPlus_0_loop gopurs_runtime.Value) interface{} {
...
func Call_monadPlusApp(dictMonadPlus_0_loop gopurs_runtime.Value) interface{} {
var dictMonadPlus_0 gopurs_runtime.Value = dictMonadPlus_0_loop
_ = dictMonadPlus_0
return gopurs_runtime.UnboxAny(dictMonadPlus_0)
}

func Call_monadApp(dictMonad_0_loop gopurs_runtime.Value) interface{} {
var dictMonad_0 gopurs_runtime.Value = dictMonad_0_loop
_ = dictMonad_0
return gopurs_runtime.UnboxAny(dictMonad_0)
}

func Call_lazyApp(dictLazy_0_loop gopurs_runtime.Value) interface{} {
var dictLazy_0 gopurs_runtime.Value = dictLazy_0_loop
_ = dictLazy_0
return gopurs_runtime.UnboxAny(dictLazy_0)
}

func Call_hoistApp(f_0_loop func(interface{}) interface{}, v_1_loop interface{}) interface{} {
...
func Call_functorApp(dictFunctor_0_loop gopurs_runtime.Value) interface{} {
var dictFunctor_0 gopurs_runtime.Value = dictFunctor_0_loop
_ = dictFunctor_0
return gopurs_runtime.UnboxAny(dictFunctor_0)
}

func Call_extendApp(dictExtend_0_loop gopurs_runtime.Value) interface{} {
var dictExtend_0 gopurs_runtime.Value = dictExtend_0_loop
_ = dictExtend_0
return gopurs_runtime.UnboxAny(dictExtend_0)
}

func Call_eqApp(dictEq1_0_loop gopurs_runtime.Value, dictEq_1_loop gopurs_runtime.Value) interface{} {
...
func Call_eq1App(dictEq1_0_loop gopurs_runtime.Value) interface{} {
var dictEq1_0 gopurs_runtime.Value = dictEq1_0_loop
_ = dictEq1_0
...
func Call_ord1App(dictOrd1_0_loop gopurs_runtime.Value) interface{} {
var dictOrd1_0 gopurs_runtime.Value = dictOrd1_0_loop
_ = dictOrd1_0
__local_var_1_0 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictOrd1_0, "Eq10"), gopurs_runtime.Value{})
_ = __local_var_1_0
...
func Call_comonadApp(dictComonad_0_loop gopurs_runtime.Value) interface{} {
var dictComonad_0 gopurs_runtime.Value = dictComonad_0_loop
_ = dictComonad_0
return gopurs_runtime.UnboxAny(dictComonad_0)
}

func Call_bindApp(dictBind_0_loop gopurs_runtime.Value) interface{} {
var dictBind_0 gopurs_runtime.Value = dictBind_0_loop
_ = dictBind_0
return gopurs_runtime.UnboxAny(dictBind_0)
}

func Call_applyApp(dictApply_0_loop gopurs_runtime.Value) interface{} {
var dictApply_0 gopurs_runtime.Value = dictApply_0_loop
_ = dictApply_0
return gopurs_runtime.UnboxAny(dictApply_0)
}

func Call_applicativeApp(dictApplicative_0_loop gopurs_runtime.Value) interface{} {
var dictApplicative_0 gopurs_runtime.Value = dictApplicative_0_loop
_ = dictApplicative_0
return gopurs_runtime.UnboxAny(dictApplicative_0)
}

func Call_alternativeApp(dictAlternative_0_loop gopurs_runtime.Value) interface{} {
var dictAlternative_0 gopurs_runtime.Value = dictAlternative_0_loop
_ = dictAlternative_0
return gopurs_runtime.UnboxAny(dictAlternative_0)
}

func Call_altApp(dictAlt_0_loop gopurs_runtime.Value) interface{} {
