...
if ((functorProduct1_3_1.UnsafePtr) != (nil)) && (((*struct{Rc uint32})(functorProduct1_3_1.UnsafePtr).Rc) == (1)) {
(*pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value])(functorProduct1_3_1.UnsafePtr).V0 = x_6
return functorProduct1_3_1
} else {
...
return gopurs_runtime.Apply(f_4, func() gopurs_runtime.Value {
if ((functorProduct1_3_1.UnsafePtr) != (nil)) && (((*struct{Rc uint32})(functorProduct1_3_1.UnsafePtr).Rc) == (1)) {
(*pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value])(functorProduct1_3_1.UnsafePtr).V0 = x_6
return functorProduct1_3_1
} else {
...
return gopurs_runtime.Apply(f_4, func() gopurs_runtime.Value {
if ((functorCoproduct1_3_1.UnsafePtr) != (nil)) && (((*struct{Rc uint32})(functorCoproduct1_3_1.UnsafePtr).Rc) == (1)) {
(*pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value])(functorCoproduct1_3_1.UnsafePtr).V0 = x_6
return functorCoproduct1_3_1
} else {
return gopurs_runtime.Value{Type: 9, IntVal: 3711209382, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value]{1, x_6})}
}
...
return gopurs_runtime.Apply(f_4, func() gopurs_runtime.Value {
if ((functorCoproduct1_3_1.UnsafePtr) != (nil)) && (((*struct{Rc uint32})(functorCoproduct1_3_1.UnsafePtr).Rc) == (1)) {
(*pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value])(functorCoproduct1_3_1.UnsafePtr).V0 = x_6
return functorCoproduct1_3_1
} else {
return gopurs_runtime.Value{Type: 9, IntVal: 2465973597, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value]{1, x_6})}
}
...
(*pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(__local_var_1_0.UnsafePtr).V0 = x_7
(*pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(__local_var_1_0.UnsafePtr).V1 = b_8
return __local_var_1_0
} else {
return gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value]{1, x_7, b_8})}
}
}())
}))
}), v_6)
