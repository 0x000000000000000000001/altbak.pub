...
func Get_parTraverse_() gopurs_runtime.Value {
	once_parTraverse_.Do(func() {
		parTraverse_ = gopurs_runtime.Func2(Call_parTraverse_)
	})
	return parTraverse_
}
...
func Get_parTraverse() gopurs_runtime.Value {
	once_parTraverse.Do(func() {
		parTraverse = gopurs_runtime.Func3(Call_parTraverse)
	})
	return parTraverse
}
...
func Get_parSequence_() gopurs_runtime.Value {
	once_parSequence_.Do(func() {
		parSequence_ = gopurs_runtime.Func2(Call_parSequence_)
	})
	return parSequence_
}
...
func Get_parSequence() gopurs_runtime.Value {
	once_parSequence.Do(func() {
		parSequence = gopurs_runtime.Func3(Call_parSequence)
	})
	return parSequence
}
...
func Get_parOneOfMap() gopurs_runtime.Value {
	once_parOneOfMap.Do(func() {
		parOneOfMap = gopurs_runtime.Func2(Call_parOneOfMap)
	})
	return parOneOfMap
}
...
func Get_parOneOf() gopurs_runtime.Value {
	once_parOneOf.Do(func() {
		parOneOf = gopurs_runtime.Func2(Call_parOneOf)
	})
	return parOneOf
}
...
func Get_parApply() gopurs_runtime.Value {
	once_parApply.Do(func() {
		parApply = gopurs_runtime.Func3(Call_parApply)
	})
	return parApply
}
...
_ = dictApplicative_1
traverse__2_0 := gopurs_runtime.Apply(pkg_Data_Foldable.Get_traverse_(), dictApplicative_1_loop)
_ = traverse__2_0
...
return gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictParallel_0_loop, "parallel"), gopurs_runtime.Apply(f_5, x_6))
}))
_ = __local_var_6_2
return gopurs_runtime.Func(func(x_7 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictParallel_0_loop, "sequential"), gopurs_runtime.Apply(__local_var_6_2, x_7))
})
})
})
}
...
_ = dictTraversable_2
traverse_3_0 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictTraversable_2_loop, "traverse"), dictApplicative_1_loop)
_ = traverse_3_0
...
return gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictParallel_0_loop, "parallel"), gopurs_runtime.Apply(f_4, x_5))
}))
_ = __local_var_5_1
return gopurs_runtime.Func(func(x_6 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictParallel_0_loop, "sequential"), gopurs_runtime.Apply(__local_var_5_1, x_6))
})
})
}
...
var dictTraversable_2 gopurs_runtime.Value = dictTraversable_2_loop
_ = dictTraversable_2
__local_var_3_0 := gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictTraversable_2_loop, "traverse"), dictApplicative_1_loop, gopurs_runtime.Func(func(x_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictParallel_0_loop, "parallel"), x_3)
}))
_ = __local_var_3_0
return gopurs_runtime.Func(func(x_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictParallel_0_loop, "sequential"), gopurs_runtime.Apply(__local_var_3_0, x_4))
})
}
...
_ = dictAlternative_1
Plus1_2_0 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictAlternative_1_loop, "Plus1"), gopurs_runtime.Value{})
_ = Plus1_2_0
return gopurs_runtime.Func(func(dictFoldable_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(Plus1_2_0, "Alt0"), gopurs_runtime.Value{}), "alt"), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictParallel_0_loop, "parallel"), gopurs_runtime.Apply(f_6, x_7)))
}), empty_4_1)
_ = __local_var_7_2
return gopurs_runtime.Func(func(x_8 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictParallel_0_loop, "sequential"), gopurs_runtime.Apply(__local_var_7_2, x_8))
})
})
})
}
...
return gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(Plus1_2_0, "Alt0"), gopurs_runtime.Value{}), "alt"), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictParallel_0_loop, "parallel"), x_6))
}), empty_4_1)
_ = __local_var_6_2
return gopurs_runtime.Func(func(x_7 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictParallel_0_loop, "sequential"), gopurs_runtime.Apply(__local_var_6_2, x_7))
...
_ = ma_2
return gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictParallel_0_loop, "sequential"), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictParallel_0_loop, "Apply1"), gopurs_runtime.Value{}), "apply"), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictParallel_0_loop, "parallel"), mf_1_loop), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictParallel_0_loop, "parallel"), ma_2_loop)))
}
