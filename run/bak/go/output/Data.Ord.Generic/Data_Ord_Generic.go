...
return Call_genericCompare(gopurs_runtime.CoerceToStruct[pkg_Data_Generic_Rep.Constructor_Generic[gopurs_runtime.Value, gopurs_runtime.Value]](dictGeneric_0_box), gopurs_runtime.CoerceToStruct[Constructor_GenericOrd[gopurs_runtime.Value]](dictGenericOrd_1_box), x_2_box, y_3_box)
})
	})
...
func Call_genericCompare(dictGeneric_0_loop *pkg_Data_Generic_Rep.Constructor_Generic[gopurs_runtime.Value, gopurs_runtime.Value], dictGenericOrd_1_loop *Constructor_GenericOrd[gopurs_runtime.Value], x_2_loop gopurs_runtime.Value, y_3_loop gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = y_3
return gopurs_runtime.Apply2(dictGenericOrd_1.V0, gopurs_runtime.Apply(dictGeneric_0.V0, x_2), gopurs_runtime.Apply(dictGeneric_0.V0, y_3))
}
