...
__t1 = gopurs_runtime.Apply(gopurs_runtime.Apply(dictGenericOrd_0.PtrVal.(map[string]gopurs_runtime.Value)["genericCompare'"], v_2.PtrVal.(map[string]gopurs_runtime.Value)["value0"]), v1_3.PtrVal.(map[string]gopurs_runtime.Value)["value0"])
goto end_branch_1
} else {
...
{
if (gopurs_runtime.Bool(v1_3.PtrVal.(map[string]gopurs_runtime.Value)["_tag"].StrVal == "Inr")).IntVal != 0 {
__t2 = gopurs_runtime.Apply(gopurs_runtime.Apply(dictGenericOrd1_1.PtrVal.(map[string]gopurs_runtime.Value)["genericCompare'"], v_2.PtrVal.(map[string]gopurs_runtime.Value)["value0"]), v1_3.PtrVal.(map[string]gopurs_runtime.Value)["value0"])
goto end_branch_2
} else {
