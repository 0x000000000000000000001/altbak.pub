...
return gopurs_runtime.Any(Call_showConj(dictShow_0_box))
})
	})
...
return gopurs_runtime.Any(Call_semiringConj(dictHeytingAlgebra_0_box))
})
	})
...
return gopurs_runtime.Any(Call_semigroupConj(dictHeytingAlgebra_0_box))
})
	})
...
return gopurs_runtime.Any(Call_ordConj(dictOrd_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monoidConj(dictHeytingAlgebra_0_box))
})
	})
...
func Get_functorConj() gopurs_runtime.Value {
	once_functorConj.Do(func() {
		cache_functorConj = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("map", gopurs_runtime.Func2(func(f_0 gopurs_runtime.Value, m_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Any(Call_eqConj(dictEq_0_box))
})
	})
	return cache_eqConj
}
...
func Get_eq1Conj() gopurs_runtime.Value {
	once_eq1Conj.Do(func() {
		cache_eq1Conj = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("eq1", gopurs_runtime.Func(func(dictEq_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_ord1Conj() gopurs_runtime.Value {
	once_ord1Conj.Do(func() {
		cache_ord1Conj = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Eq10", "compare1", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return Get_eq1Conj()
...
return gopurs_runtime.Any(Call_boundedConj(dictBounded_0_box))
})
	})
...
func Get_applyConj() gopurs_runtime.Value {
	once_applyConj.Do(func() {
		cache_applyConj = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Functor0", "apply", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_bindConj() gopurs_runtime.Value {
	once_bindConj.Do(func() {
		cache_bindConj = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Apply0", "bind", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_applicativeConj() gopurs_runtime.Value {
	once_applicativeConj.Do(func() {
		cache_applicativeConj = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Apply0", "pure", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return Get_applyConj()
}), Get_Conj())))
	})
...
func Get_monadConj() gopurs_runtime.Value {
	once_monadConj.Do(func() {
		cache_monadConj = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Applicative0", "Bind1", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_showConj(dictShow_0_loop gopurs_runtime.Value) interface{} {
...
func Call_semiringConj(dictHeytingAlgebra_0_loop gopurs_runtime.Value) interface{} {
...
func Call_semigroupConj(dictHeytingAlgebra_0_loop gopurs_runtime.Value) interface{} {
var dictHeytingAlgebra_0 gopurs_runtime.Value = dictHeytingAlgebra_0_loop
_ = dictHeytingAlgebra_0
...
func Call_ordConj(dictOrd_0_loop gopurs_runtime.Value) interface{} {
var dictOrd_0 gopurs_runtime.Value = dictOrd_0_loop
_ = dictOrd_0
return gopurs_runtime.UnboxAny(dictOrd_0)
}

func Call_monoidConj(dictHeytingAlgebra_0_loop gopurs_runtime.Value) interface{} {
var dictHeytingAlgebra_0 gopurs_runtime.Value = dictHeytingAlgebra_0_loop
_ = dictHeytingAlgebra_0
...
func Call_eqConj(dictEq_0_loop gopurs_runtime.Value) interface{} {
var dictEq_0 gopurs_runtime.Value = dictEq_0_loop
_ = dictEq_0
return gopurs_runtime.UnboxAny(dictEq_0)
}

func Call_boundedConj(dictBounded_0_loop gopurs_runtime.Value) interface{} {
