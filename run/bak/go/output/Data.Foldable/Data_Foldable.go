...
return gopurs_runtime.Value{Type: 9, IntVal: 2421944209, UnsafePtr: unsafe.Pointer(&Constructor_Node{value0})}
})
	})
	return cache_Node
}
...
return gopurs_runtime.Value{Type: 9, IntVal: 2812549951, UnsafePtr: unsafe.Pointer(&Constructor_Append{value0, value1})}
})
})
	})
	return cache_Append
...
return gopurs_runtime.Apply(f_1, (*pkg_Data_Tuple.Constructor_Tuple)(v_2.UnsafePtr).V1)
...
return gopurs_runtime.Apply2(f_0, z_1, (*pkg_Data_Tuple.Constructor_Tuple)(v_2.UnsafePtr).V1)
}), gopurs_runtime.Func3(func(f_0 gopurs_runtime.Value, z_1 gopurs_runtime.Value, v_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(f_0, (*pkg_Data_Tuple.Constructor_Tuple)(v_2.UnsafePtr).V1, z_1)
}))
	})
...
__t1 = gopurs_runtime.Apply(v_2, (*pkg_Data_Maybe.Constructor_Just)(v1_3.UnsafePtr).V0)
goto end_branch_1
} else {
...
__t2 = gopurs_runtime.Apply2(v_0, v1_1, (*pkg_Data_Maybe.Constructor_Just)(v2_2.UnsafePtr).V0)
goto end_branch_2
} else {
...
{
if (v2_2.Type == 9 && v2_2.IntVal == 930809136) {
__t3 = gopurs_runtime.Apply2(v_0, (*pkg_Data_Maybe.Constructor_Just)(v2_2.UnsafePtr).V0, v1_1)
goto end_branch_3
} else {
...
__t1 = gopurs_runtime.Apply(v_2, (*pkg_Data_Either.Constructor_Right)(v1_3.UnsafePtr).V0)
goto end_branch_1
} else {
...
__t2 = gopurs_runtime.Apply2(v_0, v1_1, (*pkg_Data_Either.Constructor_Right)(v2_2.UnsafePtr).V0)
goto end_branch_2
} else {
...
{
if (v2_2.Type == 9 && v2_2.IntVal == 2465973597) {
__t3 = gopurs_runtime.Apply2(v_0, (*pkg_Data_Either.Constructor_Right)(v2_2.UnsafePtr).V0, v1_1)
goto end_branch_3
} else {
...
acc_2_loop = gopurs_runtime.Apply2(fn_0, acc_2, (*Constructor_Node)(lhs_3.UnsafePtr).V0)
lhs_3_loop = rhs_4
...
var __t3 gopurs_runtime.Value
{
var __t_tag_4 gopurs_runtime.Value = (*Constructor_Append)(lhs_3.UnsafePtr).V1
if (__t_tag_4.Type == 9 && __t_tag_4.IntVal == 2065045956) {
acc_2_loop = acc_2
lhs_3_loop = (*Constructor_Append)(lhs_3.UnsafePtr).V0
rhs_4_loop = rhs_4
continue go__1_1
...
acc_2_loop = acc_2
lhs_3_loop = (*Constructor_Append)(lhs_3.UnsafePtr).V0
rhs_4_loop = (*Constructor_Append)(lhs_3.UnsafePtr).V1
continue go__1_1
__t3 = gopurs_runtime.Value{}
goto end_branch_3
} else {
...
acc_2_loop = acc_2
lhs_3_loop = (*Constructor_Append)(lhs_3.UnsafePtr).V0
rhs_4_loop = gopurs_runtime.Value{Type: 9, IntVal: 2812549951, UnsafePtr: unsafe.Pointer(&Constructor_Append{(*Constructor_Append)(lhs_3.UnsafePtr).V1, rhs_4})}
continue go__1_1
__t3 = gopurs_runtime.Value{}
}
end_branch_3:
...
acc_2_loop = gopurs_runtime.Apply2(fn_0, (*Constructor_Node)(rhs_4.UnsafePtr).V0, acc_2)
...
{
var __t_tag_9 gopurs_runtime.Value = (*Constructor_Append)(rhs_4.UnsafePtr).V0
if (__t_tag_9.Type == 9 && __t_tag_9.IntVal == 2065045956) {
acc_2_loop = acc_2
lhs_3_loop = lhs_3
rhs_4_loop = (*Constructor_Append)(rhs_4.UnsafePtr).V1
continue go__1_6
...
if (lhs_3.Type == 9 && lhs_3.IntVal == 2065045956) {
acc_2_loop = acc_2
lhs_3_loop = (*Constructor_Append)(rhs_4.UnsafePtr).V0
rhs_4_loop = (*Constructor_Append)(rhs_4.UnsafePtr).V1
continue go__1_6
__t8 = gopurs_runtime.Value{}
goto end_branch_8
...
{
acc_2_loop = acc_2
lhs_3_loop = gopurs_runtime.Value{Type: 9, IntVal: 2812549951, UnsafePtr: unsafe.Pointer(&Constructor_Append{lhs_3, (*Constructor_Append)(rhs_4.UnsafePtr).V0})}
rhs_4_loop = (*Constructor_Append)(rhs_4.UnsafePtr).V1
continue go__1_6
__t8 = gopurs_runtime.Value{}
}
...
type Constructor_Append struct {
	V0 gopurs_runtime.Value
...
_ = idx_1
__local_var_2_0 := gopurs_runtime.Apply2(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V2, gopurs_runtime.Func2(func(a_2 gopurs_runtime.Value, cursor_3 gopurs_runtime.Value) gopurs_runtime.Value {
var __t1 gopurs_runtime.Value
{
...
__t1 = gopurs_runtime.RecordDict2("elem", "pos", gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just{a_2})}, gopurs_runtime.RecordGet(cursor_3, "pos"))
goto end_branch_1
} else {
...
var dictFoldable_0 gopurs_runtime.Value = dictFoldable_0_loop
_ = dictFoldable_0
return gopurs_runtime.Apply2(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V2, gopurs_runtime.Func2(func(v_1 gopurs_runtime.Value, v1_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = dictPlus_1
return gopurs_runtime.Apply2(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V2, gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictPlus_1, "Alt0_NOT_FOUND"), gopurs_runtime.Value{}), "alt"), ((*gopurs_runtime.RecordData1)(dictPlus_1.UnsafePtr)).V0)
}
...
var dictPlus_1 gopurs_runtime.Value = dictPlus_1_loop
_ = dictPlus_1
empty_2_0 := ((*gopurs_runtime.RecordData1)(dictPlus_1.UnsafePtr)).V0
_ = empty_2_0
return gopurs_runtime.Func(func(f_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V2, gopurs_runtime.Func(func(x_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictPlus_1, "Alt0_NOT_FOUND"), gopurs_runtime.Value{}), "alt"), gopurs_runtime.Apply(f_3, x_4))
}), empty_2_0)
})
}
...
var idx_1 int64 = idx_1_loop
_ = idx_1
__local_var_2_0 := gopurs_runtime.Apply2(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V1, gopurs_runtime.Func2(func(cursor_2 gopurs_runtime.Value, a_3 gopurs_runtime.Value) gopurs_runtime.Value {
var __t1 gopurs_runtime.Value
{
...
__t1 = gopurs_runtime.RecordDict2("elem", "pos", gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just{a_3})}, gopurs_runtime.RecordGet(cursor_2, "pos"))
goto end_branch_1
} else {
...
return gopurs_runtime.RecordGet(gopurs_runtime.Apply3(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V1, gopurs_runtime.Func2(func(v_6 gopurs_runtime.Value, v1_7 gopurs_runtime.Value) gopurs_runtime.Value {
var __t2 gopurs_runtime.Value
{
...
_ = dictSemiring_1
one_2_0 := ((*gopurs_runtime.RecordData4)(dictSemiring_1.UnsafePtr)).V2
_ = one_2_0
return gopurs_runtime.Apply2(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V1, gopurs_runtime.Func2(func(c_3 gopurs_runtime.Value, v_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(((*gopurs_runtime.RecordData4)(dictSemiring_1.UnsafePtr)).V0, one_2_0, c_3)
}), ((*gopurs_runtime.RecordData4)(dictSemiring_1.UnsafePtr)).V3)
}
...
_ = cmp_1
return gopurs_runtime.Apply2(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V1, gopurs_runtime.Func2(func(v_2 gopurs_runtime.Value, v1_3 gopurs_runtime.Value) gopurs_runtime.Value {
var __t0 gopurs_runtime.Value
{
if (v_2.Type == 9 && v_2.IntVal == 3589588149) {
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just{v1_3})}
goto end_branch_0
} else {
...
var __t1 gopurs_runtime.Value
{
if (gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Ordering.Get_eqOrdering(), "eq"), gopurs_runtime.Apply2(cmp_1, (*pkg_Data_Maybe.Constructor_Just)(v_2.UnsafePtr).V0, v1_3), gopurs_runtime.Value{Type: 9, IntVal: 380165415, UnsafePtr: nil}).IntVal) != (0) {
__t1 = (*pkg_Data_Maybe.Constructor_Just)(v_2.UnsafePtr).V0
goto end_branch_1
} else {
...
end_branch_1:
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just{__t1})}
goto end_branch_0
} else {
...
var __t1 gopurs_runtime.Value
{
if (gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Ordering.Get_eqOrdering(), "eq"), gopurs_runtime.Apply2(cmp_1, (*pkg_Data_Maybe.Constructor_Just)(v_2.UnsafePtr).V0, v1_3), gopurs_runtime.Value{Type: 9, IntVal: 1527465420, UnsafePtr: nil}).IntVal) != (0) {
__t1 = (*pkg_Data_Maybe.Constructor_Just)(v_2.UnsafePtr).V0
goto end_branch_1
} else {
...
var dictSemiring_1 gopurs_runtime.Value = dictSemiring_1_loop
_ = dictSemiring_1
return gopurs_runtime.Apply2(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V1, ((*gopurs_runtime.RecordData4)(dictSemiring_1.UnsafePtr)).V1, ((*gopurs_runtime.RecordData4)(dictSemiring_1.UnsafePtr)).V2)
}
...
var dictSemiring_1 gopurs_runtime.Value = dictSemiring_1_loop
_ = dictSemiring_1
return gopurs_runtime.Apply2(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V1, ((*gopurs_runtime.RecordData4)(dictSemiring_1.UnsafePtr)).V0, ((*gopurs_runtime.RecordData4)(dictSemiring_1.UnsafePtr)).V3)
}
...
_ = mempty_2_0
return gopurs_runtime.Func(func(f_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V2, gopurs_runtime.Func2(func(x_4 gopurs_runtime.Value, acc_5 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonoid_1, "Semigroup0_NOT_FOUND"), gopurs_runtime.Value{}), "append"), gopurs_runtime.Apply(f_3, x_4), acc_5)
}), mempty_2_0)
})
}
...
_ = mempty_2_0
return gopurs_runtime.Func(func(f_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V1, gopurs_runtime.Func2(func(acc_4 gopurs_runtime.Value, x_5 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonoid_1, "Semigroup0_NOT_FOUND"), gopurs_runtime.Value{}), "append"), acc_4, gopurs_runtime.Apply(f_3, x_5))
}), mempty_2_0)
})
}
...
return gopurs_runtime.Apply(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V0, dictMonoid_1)
...
return gopurs_runtime.Apply3(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V1, f_1, i_2, v_3)
}), gopurs_runtime.Func3(func(f_1 gopurs_runtime.Value, i_2 gopurs_runtime.Value, v_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply3(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V2, f_1, i_2, v_3)
}))
}
...
foldMap4_3_0 := gopurs_runtime.Apply(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V0, dictMonoid_2)
_ = foldMap4_3_0
foldMap5_4_1 := gopurs_runtime.Apply(((*gopurs_runtime.RecordData3)(dictFoldable1_1.UnsafePtr)).V0, dictMonoid_2)
_ = foldMap5_4_1
...
return gopurs_runtime.Apply3(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V1, gopurs_runtime.Apply(((*gopurs_runtime.RecordData3)(dictFoldable1_1.UnsafePtr)).V1, f_2), i_3, v_4)
}), gopurs_runtime.Func3(func(f_2 gopurs_runtime.Value, i_3 gopurs_runtime.Value, v_4 gopurs_runtime.Value) gopurs_runtime.Value {
__local_var_5_2 := gopurs_runtime.Apply(((*gopurs_runtime.RecordData3)(dictFoldable1_1.UnsafePtr)).V2, f_2)
_ = __local_var_5_2
return gopurs_runtime.Apply3(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V2, gopurs_runtime.Func2(func(b_6 gopurs_runtime.Value, a_7 gopurs_runtime.Value) gopurs_runtime.Value {
...
__t4 = gopurs_runtime.Apply(__local_var_6_2, (*pkg_Data_Either.Constructor_Left)(v2_8.UnsafePtr).V0)
goto end_branch_4
} else {
...
__t4 = gopurs_runtime.Apply(__local_var_7_3, (*pkg_Data_Either.Constructor_Right)(v2_8.UnsafePtr).V0)
goto end_branch_4
} else {
...
__local_var_4_5 := gopurs_runtime.Apply2(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V1, f_2, z_3)
_ = __local_var_4_5
__local_var_5_6 := gopurs_runtime.Apply2(((*gopurs_runtime.RecordData3)(dictFoldable1_1.UnsafePtr)).V1, f_2, z_3)
_ = __local_var_5_6
return gopurs_runtime.Func(func(v2_6 gopurs_runtime.Value) gopurs_runtime.Value {
var __t7 gopurs_runtime.Value
{
if (v2_6.Type == 9 && v2_6.IntVal == 3711209382) {
__t7 = gopurs_runtime.Apply(__local_var_4_5, (*pkg_Data_Either.Constructor_Left)(v2_6.UnsafePtr).V0)
goto end_branch_7
} else {
...
__t7 = gopurs_runtime.Apply(__local_var_5_6, (*pkg_Data_Either.Constructor_Right)(v2_6.UnsafePtr).V0)
goto end_branch_7
} else {
...
__local_var_4_8 := gopurs_runtime.Apply2(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V2, f_2, z_3)
_ = __local_var_4_8
__local_var_5_9 := gopurs_runtime.Apply2(((*gopurs_runtime.RecordData3)(dictFoldable1_1.UnsafePtr)).V2, f_2, z_3)
_ = __local_var_5_9
return gopurs_runtime.Func(func(v2_6 gopurs_runtime.Value) gopurs_runtime.Value {
var __t10 gopurs_runtime.Value
{
if (v2_6.Type == 9 && v2_6.IntVal == 3711209382) {
__t10 = gopurs_runtime.Apply(__local_var_4_8, (*pkg_Data_Either.Constructor_Left)(v2_6.UnsafePtr).V0)
goto end_branch_10
} else {
...
{
if (v2_6.Type == 9 && v2_6.IntVal == 2465973597) {
__t10 = gopurs_runtime.Apply(__local_var_5_9, (*pkg_Data_Either.Constructor_Right)(v2_6.UnsafePtr).V0)
goto end_branch_10
} else {
...
return gopurs_runtime.Apply3(((*gopurs_runtime.RecordData3)(dictFoldable1_1.UnsafePtr)).V1, f_2, gopurs_runtime.Apply3(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V1, f_2, z_3, (*pkg_Data_Tuple.Constructor_Tuple)(v_4.UnsafePtr).V0), (*pkg_Data_Tuple.Constructor_Tuple)(v_4.UnsafePtr).V1)
}), gopurs_runtime.Func3(func(f_2 gopurs_runtime.Value, z_3 gopurs_runtime.Value, v_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply3(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V2, f_2, gopurs_runtime.Apply3(((*gopurs_runtime.RecordData3)(dictFoldable1_1.UnsafePtr)).V2, f_2, z_3, (*pkg_Data_Tuple.Constructor_Tuple)(v_4.UnsafePtr).V1), (*pkg_Data_Tuple.Constructor_Tuple)(v_4.UnsafePtr).V0)
}))
}
...
var dictFoldable_0 gopurs_runtime.Value = dictFoldable_0_loop
_ = dictFoldable_0
foldMap2_1_0 := gopurs_runtime.Apply(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V0, Get_monoidFreeMonoidTree())
_ = foldMap2_1_0
...
var dictFoldable_0 gopurs_runtime.Value = dictFoldable_0_loop
_ = dictFoldable_0
foldMap2_1_0 := gopurs_runtime.Apply(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V0, pkg_Data_Maybe_First.Get_monoidFirst())
_ = foldMap2_1_0
...
var __t1 gopurs_runtime.Value
{
if (gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictEq_2, "eq"), a_3, (*pkg_Data_Tuple.Constructor_Tuple)(v_4.UnsafePtr).V0).IntVal) != (0) {
__t1 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just{(*pkg_Data_Tuple.Constructor_Tuple)(v_4.UnsafePtr).V1})}
goto end_branch_1
} else {
...
var dictFoldable_0 gopurs_runtime.Value = dictFoldable_0_loop
_ = dictFoldable_0
foldMap2_1_0 := gopurs_runtime.Apply(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V0, Get_monoidEndo())
_ = foldMap2_1_0
...
_ = b0_3
return gopurs_runtime.Apply2(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V1, gopurs_runtime.Func2(func(b_4 gopurs_runtime.Value, a_5 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonad_1, "Bind1_NOT_FOUND"), gopurs_runtime.Value{}), "bind"), b_4, gopurs_runtime.Func(func(a_6 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(f_2, a_6, a_5)
}))
}), gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonad_1, "Applicative0_NOT_FOUND"), gopurs_runtime.Value{}), "pure"), b0_3))
}
...
var dictMonoid_1 gopurs_runtime.Value = dictMonoid_1_loop
_ = dictMonoid_1
return gopurs_runtime.Apply2(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V0, dictMonoid_1, Get_identity())
}
...
return gopurs_runtime.Apply(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V0, gopurs_runtime.RecordDict2("Semigroup0", "mempty", gopurs_runtime.Func(func(_dollar__unused_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
any1_1_0 := gopurs_runtime.Apply(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V0, gopurs_runtime.RecordDict2("Semigroup0", "mempty", gopurs_runtime.Func(func(_dollar__unused_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = semigroupDisj1_2_0
return gopurs_runtime.Apply2(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V0, gopurs_runtime.RecordDict2("Semigroup0", "mempty", gopurs_runtime.Func(func(_dollar__unused_3 gopurs_runtime.Value) gopurs_runtime.Value {
return semigroupDisj1_2_0
}), ((*gopurs_runtime.RecordData)(dictHeytingAlgebra_1.UnsafePtr)).Vals[2]), Get_identity())
}
...
return gopurs_runtime.Apply2(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V0, gopurs_runtime.RecordDict2("Semigroup0", "mempty", gopurs_runtime.Func(func(_dollar__unused_3 gopurs_runtime.Value) gopurs_runtime.Value {
return semigroupConj1_2_0
}), ((*gopurs_runtime.RecordData)(dictHeytingAlgebra_1.UnsafePtr)).Vals[5]), Get_identity())
}
