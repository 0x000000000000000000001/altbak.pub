...
acc_2_loop = gopurs_runtime.Apply(gopurs_runtime.Apply(fn_0, acc_2), lhs_3.PtrVal.(map[string]gopurs_runtime.Value)["value0"])
lhs_3_loop = rhs_4
rhs_4_loop = gopurs_runtime.Record(map[string]gopurs_runtime.Value{"_tag": gopurs_runtime.Str("Empty")})
continue go__1_0
...
acc_2_loop = acc_2
lhs_3_loop = lhs_3.PtrVal.(map[string]gopurs_runtime.Value)["value0"]
rhs_4_loop = rhs_4
continue go__1_0
...
acc_2_loop = acc_2
lhs_3_loop = lhs_3.PtrVal.(map[string]gopurs_runtime.Value)["value0"]
rhs_4_loop = lhs_3.PtrVal.(map[string]gopurs_runtime.Value)["value1"]
continue go__1_0
__t2 = gopurs_runtime.Value{}
goto end_branch_2
} else {
...
acc_2_loop = acc_2
lhs_3_loop = lhs_3.PtrVal.(map[string]gopurs_runtime.Value)["value0"]
rhs_4_loop = gopurs_runtime.Record(map[string]gopurs_runtime.Value{"_tag": gopurs_runtime.Str("Append"), "value0": lhs_3.PtrVal.(map[string]gopurs_runtime.Value)["value1"], "value1": rhs_4})
continue go__1_0
__t2 = gopurs_runtime.Value{}
}
end_branch_2:
...
acc_2_loop = gopurs_runtime.Apply(gopurs_runtime.Apply(fn_0, rhs_4.PtrVal.(map[string]gopurs_runtime.Value)["value0"]), acc_2)
lhs_3_loop = gopurs_runtime.Record(map[string]gopurs_runtime.Value{"_tag": gopurs_runtime.Str("Empty")})
rhs_4_loop = lhs_3
continue go__1_4
...
acc_2_loop = acc_2
lhs_3_loop = lhs_3
rhs_4_loop = rhs_4.PtrVal.(map[string]gopurs_runtime.Value)["value1"]
continue go__1_4
...
if (gopurs_runtime.Bool(lhs_3.PtrVal.(map[string]gopurs_runtime.Value)["_tag"].StrVal == "Empty")).IntVal != 0 {
acc_2_loop = acc_2
lhs_3_loop = rhs_4.PtrVal.(map[string]gopurs_runtime.Value)["value0"]
rhs_4_loop = rhs_4.PtrVal.(map[string]gopurs_runtime.Value)["value1"]
continue go__1_4
__t6 = gopurs_runtime.Value{}
goto end_branch_6
...
{
acc_2_loop = acc_2
lhs_3_loop = gopurs_runtime.Record(map[string]gopurs_runtime.Value{"_tag": gopurs_runtime.Str("Append"), "value0": lhs_3, "value1": rhs_4.PtrVal.(map[string]gopurs_runtime.Value)["value0"]})
rhs_4_loop = rhs_4.PtrVal.(map[string]gopurs_runtime.Value)["value1"]
continue go__1_4
__t6 = gopurs_runtime.Value{}
}
