...
func Get_Even() gopurs_runtime.Value {
	once_Even.Do(func() {
		cache_Even = gopurs_runtime.Value{Type: 9, IntVal: 2591059121, UnsafePtr: unsafe.Pointer(nil)}
	})
	return cache_Even
}
...
func Get_Odd() gopurs_runtime.Value {
	once_Odd.Do(func() {
		cache_Odd = gopurs_runtime.Value{Type: 9, IntVal: 658452902, UnsafePtr: unsafe.Pointer(nil)}
	})
	return cache_Odd
}
...
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 2591059121, UnsafePtr: unsafe.Pointer(nil)}
goto end_branch_0
} else {
...
{
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 658452902, UnsafePtr: unsafe.Pointer(nil)}
}
end_branch_0:
return __t0
})
...
__t1 = gopurs_runtime.Value{Type: 9, IntVal: 658452902, UnsafePtr: unsafe.Pointer(nil)}
goto end_branch_1
} else {
...
{
__t1 = gopurs_runtime.Value{Type: 9, IntVal: 2591059121, UnsafePtr: unsafe.Pointer(nil)}
}
end_branch_1:
return __t1
})
}), gopurs_runtime.Value{Type: 9, IntVal: 658452902, UnsafePtr: unsafe.Pointer(nil)}, gopurs_runtime.Value{Type: 9, IntVal: 2591059121, UnsafePtr: unsafe.Pointer(nil)})
	})
...
return gopurs_runtime.Func(func(v1_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 2591059121, UnsafePtr: unsafe.Pointer(nil)}
})
}))
	})
...
}), gopurs_runtime.Value{Type: 9, IntVal: 2591059121, UnsafePtr: unsafe.Pointer(nil)}, gopurs_runtime.Value{Type: 9, IntVal: 658452902, UnsafePtr: unsafe.Pointer(nil)})
	})
