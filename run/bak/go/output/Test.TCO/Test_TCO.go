...
func Get_act() gopurs_runtime.Value {
	once_act.Do(func() {
		act = gopurs_runtime.Apply(pkg_Effect_Console.Get_log(), gopurs_runtime.Apply(pkg_Data_Show.Get_showIntImpl(), gopurs_runtime.Apply2(Get_deepTailRec(), gopurs_runtime.Int(100000), gopurs_runtime.Int(0))))
	})
	return act
}
