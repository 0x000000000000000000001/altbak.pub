...
return gopurs_runtime.Apply(pkg_Effect_Console.Get_log(), gopurs_runtime.Str(gopurs_runtime.Apply(gopurs_runtime.RecordGet(pkg_Data_Show.Get_showInt(), "show"), gopurs_runtime.Int(gopurs_runtime.Int(Call_deepTailRec(dummy_0.IntVal, 0)).IntVal)).StrVal()))
}))
	})
	return cache_act
}
...
v1_1_loop = Call_add__560788792(gopurs_runtime.Int(v1_1), gopurs_runtime.Int(Call_mod__2185172824(gopurs_runtime.Int(v_0), gopurs_runtime.Int(3)).IntVal)).IntVal
