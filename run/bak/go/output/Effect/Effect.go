...
return Call_semigroupEffect((*Record_append__gopurs_runtime_Value)(dictSemigroup_0_box.UnsafePtr))
})
	})
...
return Call_monoidEffect((*Record_mempty_gopurs_runtime_Value)(dictMonoid_0_box.UnsafePtr))
})
	})
...
func Call_semigroupEffect(dictSemigroup_0_loop *Record_append__gopurs_runtime_Value) gopurs_runtime.Value {
...
func Call_monoidEffect(dictMonoid_0_loop *Record_mempty_gopurs_runtime_Value) gopurs_runtime.Value {
