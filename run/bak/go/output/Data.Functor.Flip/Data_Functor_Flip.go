...
return Call_showFlip((*Record_show_gopurs_runtime_Value)(dictShow_0_box.UnsafePtr))
})
	})
...
return Call_semigroupoidFlip((*Record_compose_gopurs_runtime_Value)(dictSemigroupoid_0_box.UnsafePtr))
})
	})
...
return gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(Call_ordFlip((*Record_compare_gopurs_runtime_Value)(dictOrd_0_box.UnsafePtr)))}
})
	})
...
return Call_functorFlip((*Record_bimap_gopurs_runtime_Value)(dictBifunctor_0_box.UnsafePtr))
})
	})
...
return gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(Call_eqFlip((*Record_eq_gopurs_runtime_Value)(dictEq_0_box.UnsafePtr)))}
})
	})
	return cache_eqFlip
}
...
return Call_contravariantFlip((*Record_dimap_gopurs_runtime_Value)(dictProfunctor_0_box.UnsafePtr))
})
	})
...
return Call_categoryFlip((*Record_identity_gopurs_runtime_Value)(dictCategory_0_box.UnsafePtr))
})
	})
...
return Call_bifunctorFlip((*Record_bimap_gopurs_runtime_Value)(dictBifunctor_0_box.UnsafePtr))
})
	})
...
return Call_biapplyFlip((*Record_biapply_gopurs_runtime_Value)(dictBiapply_0_box.UnsafePtr))
})
	})
...
return Call_biapplicativeFlip((*Record_bipure_gopurs_runtime_Value)(dictBiapplicative_0_box.UnsafePtr))
})
	})
...
func Call_showFlip(dictShow_0_loop *Record_show_gopurs_runtime_Value) gopurs_runtime.Value {
var dictShow_0 *Record_show_gopurs_runtime_Value = dictShow_0_loop
_ = dictShow_0
return gopurs_runtime.RecordDict1("show", gopurs_runtime.Func(func(v_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str("(Flip "), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Apply(dictShow_0.show, v_1), gopurs_runtime.Str(")")))
}))
}

func Call_semigroupoidFlip(dictSemigroupoid_0_loop *Record_compose_gopurs_runtime_Value) gopurs_runtime.Value {
var dictSemigroupoid_0 *Record_compose_gopurs_runtime_Value = dictSemigroupoid_0_loop
...
return gopurs_runtime.Apply2(dictSemigroupoid_0.compose, v1_2, v_1)
}))
}

func Call_ordFlip(dictOrd_0_loop *Record_compare_gopurs_runtime_Value) *Record_compare_gopurs_runtime_Value {
var dictOrd_0 *Record_compare_gopurs_runtime_Value = dictOrd_0_loop
_ = dictOrd_0
return dictOrd_0
}

func Call_functorFlip(dictBifunctor_0_loop *Record_bimap_gopurs_runtime_Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply3(dictBifunctor_0.bimap, f_1, pkg_Data_Bifunctor.Get_identity(), v_2)
}))
}

func Call_eqFlip(dictEq_0_loop *Record_eq_gopurs_runtime_Value) *Record_eq_gopurs_runtime_Value {
var dictEq_0 *Record_eq_gopurs_runtime_Value = dictEq_0_loop
_ = dictEq_0
return dictEq_0
}

func Call_contravariantFlip(dictProfunctor_0_loop *Record_dimap_gopurs_runtime_Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply3(dictProfunctor_0.dimap, f_1, pkg_Data_Profunctor.Get_identity(), v_2)
}))
}

func Call_categoryFlip(dictCategory_0_loop *Record_identity_gopurs_runtime_Value) gopurs_runtime.Value {
var dictCategory_0 *Record_identity_gopurs_runtime_Value = dictCategory_0_loop
_ = dictCategory_0
__local_var_1_0 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictCategory_0)}, "Semigroupoid0_NOT_FOUND"), gopurs_runtime.Value{})
_ = __local_var_1_0
...
}), dictCategory_0.identity)
}

func Call_bifunctorFlip(dictBifunctor_0_loop *Record_bimap_gopurs_runtime_Value) gopurs_runtime.Value {
var dictBifunctor_0 *Record_bimap_gopurs_runtime_Value = dictBifunctor_0_loop
_ = dictBifunctor_0
...
return gopurs_runtime.Apply3(dictBifunctor_0.bimap, g_2, f_1, v_3)
}))
}

func Call_biapplyFlip(dictBiapply_0_loop *Record_biapply_gopurs_runtime_Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply2(dictBiapply_0.biapply, v_3, v1_4)
}))
}

func Call_biapplicativeFlip(dictBiapplicative_0_loop *Record_bipure_gopurs_runtime_Value) gopurs_runtime.Value {
...
_ = __local_var_2_1
bifunctorFlip1_3_3 := gopurs_runtime.RecordDict1("bimap", gopurs_runtime.Func3(func(f_3 gopurs_runtime.Value, g_4 gopurs_runtime.Value, v_5 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply3(gopurs_runtime.RecordGet(__local_var_2_1, "bimap"), g_4, f_3, v_5)
}))
_ = bifunctorFlip1_3_3
biapplyFlip1_3_2 := gopurs_runtime.RecordDict2("Bifunctor0", "biapply", gopurs_runtime.Func(func(_dollar__unused_4 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply2(dictBiapplicative_0.bipure, b_5, a_4)
}))
}
