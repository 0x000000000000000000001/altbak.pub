...
return gopurs_runtime.Any(Call_showFlip(dictShow_0_box))
})
	})
...
return gopurs_runtime.Any(Call_semigroupoidFlip(dictSemigroupoid_0_box))
})
	})
...
return gopurs_runtime.Any(Call_ordFlip(dictOrd_0_box))
})
	})
...
func Get_newtypeFlip() gopurs_runtime.Value {
	once_newtypeFlip.Do(func() {
		cache_newtypeFlip = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("Coercible0", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Any(Call_functorFlip(dictBifunctor_0_box))
})
	})
...
return gopurs_runtime.Any(Call_eqFlip(dictEq_0_box))
})
	})
	return cache_eqFlip
}
...
return gopurs_runtime.Any(Call_contravariantFlip(dictProfunctor_0_box))
})
	})
...
return gopurs_runtime.Any(Call_categoryFlip(dictCategory_0_box))
})
	})
...
return gopurs_runtime.Any(Call_bifunctorFlip(dictBifunctor_0_box))
})
	})
...
return gopurs_runtime.Any(Call_biapplyFlip(dictBiapply_0_box))
})
	})
...
return gopurs_runtime.Any(Call_biapplicativeFlip(dictBiapplicative_0_box))
})
	})
...
func Call_showFlip(dictShow_0_loop gopurs_runtime.Value) interface{} {
...
func Call_semigroupoidFlip(dictSemigroupoid_0_loop gopurs_runtime.Value) interface{} {
var dictSemigroupoid_0 gopurs_runtime.Value = dictSemigroupoid_0_loop
_ = dictSemigroupoid_0
return gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("compose", gopurs_runtime.Func2(func(v_1 gopurs_runtime.Value, v1_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictSemigroupoid_0, "compose"), v1_2, v_1)
})))
}

func Call_ordFlip(dictOrd_0_loop gopurs_runtime.Value) interface{} {
var dictOrd_0 gopurs_runtime.Value = dictOrd_0_loop
_ = dictOrd_0
return gopurs_runtime.UnboxAny(dictOrd_0)
}

func Call_functorFlip(dictBifunctor_0_loop gopurs_runtime.Value) interface{} {
...
func Call_eqFlip(dictEq_0_loop gopurs_runtime.Value) interface{} {
var dictEq_0 gopurs_runtime.Value = dictEq_0_loop
_ = dictEq_0
return gopurs_runtime.UnboxAny(dictEq_0)
}

func Call_contravariantFlip(dictProfunctor_0_loop gopurs_runtime.Value) interface{} {
var dictProfunctor_0 gopurs_runtime.Value = dictProfunctor_0_loop
_ = dictProfunctor_0
return gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("cmap", gopurs_runtime.Func2(func(f_1 gopurs_runtime.Value, v_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply3(gopurs_runtime.RecordGet(dictProfunctor_0, "dimap"), f_1, pkg_Data_Profunctor.Get_identity(), v_2)
})))
}

func Call_categoryFlip(dictCategory_0_loop gopurs_runtime.Value) interface{} {
...
func Call_bifunctorFlip(dictBifunctor_0_loop gopurs_runtime.Value) interface{} {
var dictBifunctor_0 gopurs_runtime.Value = dictBifunctor_0_loop
_ = dictBifunctor_0
...
func Call_biapplyFlip(dictBiapply_0_loop gopurs_runtime.Value) interface{} {
...
func Call_biapplicativeFlip(dictBiapplicative_0_loop gopurs_runtime.Value) interface{} {
