...
return Call_imapF((*Record_map__gopurs_runtime_Value)(dictFunctor_0_box.UnsafePtr), f_1_box, v_2_box)
})
	})
	return cache_imapF
}
...
return Call_imap((*Record_imap_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
	return cache_imap
}
...
return Call_invariantAlternate((*Record_imap_gopurs_runtime_Value)(dictInvariant_0_box.UnsafePtr))
})
	})
...
func Call_imapF(dictFunctor_0_loop *Record_map__gopurs_runtime_Value, f_1_loop gopurs_runtime.Value, v_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = v_2
return gopurs_runtime.Apply(dictFunctor_0.map_, f_1)
}

func Call_imap(dict_0_loop *Record_imap_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_imap_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.imap
}

func Call_invariantAlternate(dictInvariant_0_loop *Record_imap_gopurs_runtime_Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply3(dictInvariant_0.imap, f_1, g_2, v_3)
}))
}
