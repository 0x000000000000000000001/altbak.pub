...
return gopurs_runtime.Any(Call_semigroupJoin(dictSemigroupoid_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monoidJoin(dictCategory_0_box))
})
	})
...
return gopurs_runtime.Any(Call_invariantJoin(dictProfunctor_0_box))
})
	})
...
func Call_semigroupJoin(dictSemigroupoid_0_loop gopurs_runtime.Value) interface{} {
...
func Call_monoidJoin(dictCategory_0_loop gopurs_runtime.Value) interface{} {
...
func Call_invariantJoin(dictProfunctor_0_loop gopurs_runtime.Value) interface{} {
