...
return gopurs_runtime.Int(Call_add__560788792(gopurs_runtime.Int(a_0.IntVal), gopurs_runtime.Int(b_1.IntVal)).IntVal)
})
...
func Get_test() gopurs_runtime.Value {
	once_test.Do(func() {
		cache_test = gopurs_runtime.Int(Call_polyLoop__1285086188(gopurs_runtime.Int(10000000), gopurs_runtime.Int(0)).IntVal)
	})
	return cache_test
}
...
var cache_polyLoop__6451692 gopurs_runtime.Value
var once_polyLoop__6451692 sync.Once
func Get_polyLoop__6451692() gopurs_runtime.Value {
	once_polyLoop__6451692.Do(func() {
		cache_polyLoop__6451692 = gopurs_runtime.Func(func(dictMonoidish_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_polyLoop__6451692(gopurs_runtime.CoerceToStruct[Constructor_Monoidish[gopurs_runtime.Value]](dictMonoidish_0_box))
})
	})
	return cache_polyLoop__6451692
}
...
func Get_polyLoop__1285086188() gopurs_runtime.Value {
	once_polyLoop__1285086188.Do(func() {
		cache_polyLoop__1285086188 = gopurs_runtime.Func2(func(__eta0_0_box gopurs_runtime.Value, __eta1_1_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_polyLoop__1285086188(__eta0_0_box, __eta1_1_box)
})
	})
...
{
__t1 = gopurs_runtime.Apply2(Call_polyLoop(dictMonoidish_0), gopurs_runtime.Int(Call_sub__1043827704(gopurs_runtime.Int(v_2.IntVal), gopurs_runtime.Int(1)).IntVal), gopurs_runtime.Apply2(dictMonoidish_0.V0, v1_3, mempty_1_1_0))
}
end_branch_1:
return __t1
})
...
func Call_polyLoop__6451692(dictMonoidish_0_loop *Constructor_Monoidish[gopurs_runtime.Value]) gopurs_runtime.Value {
var dictMonoidish_0 *Constructor_Monoidish[gopurs_runtime.Value] = dictMonoidish_0_loop
_ = dictMonoidish_0
mempty_1_1_0 := dictMonoidish_0.V1
_ = mempty_1_1_0
...
func Call_polyLoop__1285086188(__eta0_0_loop gopurs_runtime.Value, __eta1_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var __eta0_0 gopurs_runtime.Value = __eta0_0_loop
_ = __eta0_0
var __eta1_1 gopurs_runtime.Value = __eta1_1_loop
_ = __eta1_1
