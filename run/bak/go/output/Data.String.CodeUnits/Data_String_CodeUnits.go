...
func Get_takeRight() gopurs_runtime.Value {
	once_takeRight.Do(func() {
		takeRight = gopurs_runtime.Func2(func(i_0 gopurs_runtime.Value, s_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_stripSuffix() gopurs_runtime.Value {
	once_stripSuffix.Do(func() {
		stripSuffix = gopurs_runtime.Func2(func(v_0 gopurs_runtime.Value, str_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_stripPrefix() gopurs_runtime.Value {
	once_stripPrefix.Do(func() {
		stripPrefix = gopurs_runtime.Func2(func(v_0 gopurs_runtime.Value, str_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_startsWith() gopurs_runtime.Value {
	once_startsWith.Do(func() {
		startsWith = gopurs_runtime.Func2(func(pat_0 gopurs_runtime.Value, x_1 gopurs_runtime.Value) gopurs_runtime.Value {
__local_var_2_0 := gopurs_runtime.Apply2(Get_stripPrefix(), pat_0, x_1)
_ = __local_var_2_0
var __t1 gopurs_runtime.Value
{
...
func Get_endsWith() gopurs_runtime.Value {
	once_endsWith.Do(func() {
		endsWith = gopurs_runtime.Func2(func(pat_0 gopurs_runtime.Value, x_1 gopurs_runtime.Value) gopurs_runtime.Value {
__local_var_2_0 := gopurs_runtime.Apply2(Get_stripSuffix(), pat_0, x_1)
_ = __local_var_2_0
var __t1 gopurs_runtime.Value
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(__local_var_2_0, "_tag").StrVal == "Nothing")).IntVal != 0 {
...
func Get_dropRight() gopurs_runtime.Value {
	once_dropRight.Do(func() {
		dropRight = gopurs_runtime.Func2(func(i_0 gopurs_runtime.Value, s_1 gopurs_runtime.Value) gopurs_runtime.Value {
