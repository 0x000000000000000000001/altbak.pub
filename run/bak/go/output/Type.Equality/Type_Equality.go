...
return Call_proof((*Record_proof_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
	return cache_proof
}
...
return Call_to((*Record_proof_gopurs_runtime_Value)(dictTypeEquals_0_box.UnsafePtr))
})
	})
	return cache_to
}
...
return Call_from((*Record_proof_gopurs_runtime_Value)(dictTypeEquals_0_box.UnsafePtr))
})
	})
	return cache_from
}
...
func Call_proof(dict_0_loop *Record_proof_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_proof_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.proof
}

func Call_to(dictTypeEquals_0_loop *Record_proof_gopurs_runtime_Value) gopurs_runtime.Value {
var dictTypeEquals_0 *Record_proof_gopurs_runtime_Value = dictTypeEquals_0_loop
_ = dictTypeEquals_0
return gopurs_runtime.Apply(dictTypeEquals_0.proof, gopurs_runtime.Func(func(a_1 gopurs_runtime.Value) gopurs_runtime.Value {
return a_1
}))
}

func Call_from(dictTypeEquals_0_loop *Record_proof_gopurs_runtime_Value) gopurs_runtime.Value {
var dictTypeEquals_0 *Record_proof_gopurs_runtime_Value = dictTypeEquals_0_loop
_ = dictTypeEquals_0
return gopurs_runtime.Apply(dictTypeEquals_0.proof, gopurs_runtime.Func(func(a_1 gopurs_runtime.Value) gopurs_runtime.Value {
return a_1
