...
return Call_state((*Record_state_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
	return cache_state
}
...
return Call_put((*Record_state_gopurs_runtime_Value)(dictMonadState_0_box.UnsafePtr), s_1_box)
})
	})
	return cache_put
}
...
return Call_modify_((*Record_state_gopurs_runtime_Value)(dictMonadState_0_box.UnsafePtr), f_1_box)
})
	})
...
return Call_modify((*Record_state_gopurs_runtime_Value)(dictMonadState_0_box.UnsafePtr), f_1_box)
})
	})
	return cache_modify
}
...
return Call_gets((*Record_state_gopurs_runtime_Value)(dictMonadState_0_box.UnsafePtr), f_1_box)
})
	})
	return cache_gets
}
...
return Call_get((*Record_state_gopurs_runtime_Value)(dictMonadState_0_box.UnsafePtr))
})
	})
	return cache_get
}
...
func Call_state(dict_0_loop *Record_state_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_state_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.state
}

func Call_put(dictMonadState_0_loop *Record_state_gopurs_runtime_Value, s_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictMonadState_0 *Record_state_gopurs_runtime_Value = dictMonadState_0_loop
_ = dictMonadState_0
var s_1 gopurs_runtime.Value = s_1_loop
_ = s_1
return gopurs_runtime.Apply(dictMonadState_0.state, gopurs_runtime.Func(func(v_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_modify_(dictMonadState_0_loop *Record_state_gopurs_runtime_Value, f_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictMonadState_0 *Record_state_gopurs_runtime_Value = dictMonadState_0_loop
_ = dictMonadState_0
var f_1 gopurs_runtime.Value = f_1_loop
_ = f_1
return gopurs_runtime.Apply(dictMonadState_0.state, gopurs_runtime.Func(func(s_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_modify(dictMonadState_0_loop *Record_state_gopurs_runtime_Value, f_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictMonadState_0 *Record_state_gopurs_runtime_Value = dictMonadState_0_loop
_ = dictMonadState_0
var f_1 gopurs_runtime.Value = f_1_loop
_ = f_1
...
func Call_gets(dictMonadState_0_loop *Record_state_gopurs_runtime_Value, f_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictMonadState_0 *Record_state_gopurs_runtime_Value = dictMonadState_0_loop
_ = dictMonadState_0
var f_1 gopurs_runtime.Value = f_1_loop
_ = f_1
...
func Call_get(dictMonadState_0_loop *Record_state_gopurs_runtime_Value) gopurs_runtime.Value {
var dictMonadState_0 *Record_state_gopurs_runtime_Value = dictMonadState_0_loop
_ = dictMonadState_0
return gopurs_runtime.Apply(dictMonadState_0.state, gopurs_runtime.Func(func(s_1 gopurs_runtime.Value) gopurs_runtime.Value {
