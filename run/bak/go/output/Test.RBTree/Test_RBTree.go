...
func Get_R() gopurs_runtime.Value {
	once_R.Do(func() {
		cache_R = gopurs_runtime.Value{Type: 9, IntVal: 3668501016, UnsafePtr: unsafe.Pointer(nil)}
	})
	return cache_R
}
...
func Get_B() gopurs_runtime.Value {
	once_B.Do(func() {
		cache_B = gopurs_runtime.Value{Type: 9, IntVal: 1583507464, UnsafePtr: unsafe.Pointer(nil)}
	})
	return cache_B
}
...
return gopurs_runtime.Value{Type: 9, IntVal: 3983586014, UnsafePtr: unsafe.Pointer(&Constructor_T{1, value0, gopurs_runtime.CoerceToStruct[Constructor_T](value1), value2.IntVal, gopurs_runtime.CoerceToStruct[Constructor_T](value3)})}
})
})
})
})
...
return gopurs_runtime.Value{Type: 9, IntVal: 3983586014, UnsafePtr: unsafe.Pointer(Call_balance(v_0_box, gopurs_runtime.CoerceToStruct[Constructor_T](v1_1_box), v2_2_box.IntVal, gopurs_runtime.CoerceToStruct[Constructor_T](v3_3_box)))}
})
	})
