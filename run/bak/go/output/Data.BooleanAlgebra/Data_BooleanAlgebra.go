...
heytingAlgebraRecordCons1_3_0 := gopurs_runtime.Apply3(pkg_Data_HeytingAlgebra.Get_heytingAlgebraRecordCons(), dictIsSymbol_0, gopurs_runtime.Value{}, gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictBooleanAlgebraRecord_2, "HeytingAlgebraRecord0_NOT_FOUND"), gopurs_runtime.Value{}))
...
__local_var_2_0 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictBooleanAlgebraRecord_1, "HeytingAlgebraRecord0_NOT_FOUND"), gopurs_runtime.Value{})
_ = __local_var_2_0
...
__local_var_1_0 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictBooleanAlgebra_0, "HeytingAlgebra0_NOT_FOUND"), gopurs_runtime.Value{})
_ = __local_var_1_0
