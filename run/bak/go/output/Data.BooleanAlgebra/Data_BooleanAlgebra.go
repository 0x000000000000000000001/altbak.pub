...
return Call_booleanAlgebraRecordCons((*Record_reflectSymbol_gopurs_runtime_Value)(dictIsSymbol_0_box.UnsafePtr), (*Record_)(_dollar__unused_1_box.UnsafePtr), (*Record_)(dictBooleanAlgebraRecord_2_box.UnsafePtr))
})
	})
...
return Call_booleanAlgebraRecord((*Record_)(_dollar__unused_0_box.UnsafePtr), (*Record_)(dictBooleanAlgebraRecord_1_box.UnsafePtr))
})
	})
...
return Call_booleanAlgebraFn((*Record_)(dictBooleanAlgebra_0_box.UnsafePtr))
})
	})
...
func Call_booleanAlgebraRecordCons(dictIsSymbol_0_loop *Record_reflectSymbol_gopurs_runtime_Value, _dollar__unused_1_loop *Record_, dictBooleanAlgebraRecord_2_loop *Record_) gopurs_runtime.Value {
...
_ = _dollar__unused_1
var dictBooleanAlgebraRecord_2 *Record_ = dictBooleanAlgebraRecord_2_loop
_ = dictBooleanAlgebraRecord_2
heytingAlgebraRecordCons1_3_0 := gopurs_runtime.Apply3(pkg_Data_HeytingAlgebra.Get_heytingAlgebraRecordCons(), gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictIsSymbol_0)}, gopurs_runtime.Value{}, gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictBooleanAlgebraRecord_2)}, "HeytingAlgebraRecord0_NOT_FOUND"), gopurs_runtime.Value{}))
...
func Call_booleanAlgebraRecord(_dollar__unused_0_loop *Record_, dictBooleanAlgebraRecord_1_loop *Record_) gopurs_runtime.Value {
var _dollar__unused_0 *Record_ = _dollar__unused_0_loop
_ = _dollar__unused_0
var dictBooleanAlgebraRecord_1 *Record_ = dictBooleanAlgebraRecord_1_loop
_ = dictBooleanAlgebraRecord_1
__local_var_2_0 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictBooleanAlgebraRecord_1)}, "HeytingAlgebraRecord0_NOT_FOUND"), gopurs_runtime.Value{})
_ = __local_var_2_0
...
func Call_booleanAlgebraFn(dictBooleanAlgebra_0_loop *Record_) gopurs_runtime.Value {
var dictBooleanAlgebra_0 *Record_ = dictBooleanAlgebra_0_loop
_ = dictBooleanAlgebra_0
__local_var_1_0 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictBooleanAlgebra_0)}, "HeytingAlgebra0_NOT_FOUND"), gopurs_runtime.Value{})
_ = __local_var_1_0
ff1_2_1 := gopurs_runtime.RecordGet(__local_var_1_0, "ff")
_ = ff1_2_1
tt1_3_3 := gopurs_runtime.RecordGet(__local_var_1_0, "tt")
_ = tt1_3_3
heytingAlgebraFunction_3_2 := gopurs_runtime.RecordDict([]string{"conj", "disj", "ff", "implies", "not", "tt"}, []gopurs_runtime.Value{gopurs_runtime.Func3(func(f_4 gopurs_runtime.Value, g_5 gopurs_runtime.Value, a_6 gopurs_runtime.Value) gopurs_runtime.Value {
