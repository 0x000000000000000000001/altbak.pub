...
func Get_Tolerance() gopurs_runtime.Value {
	once_Tolerance.Do(func() {
		cache_Tolerance = gopurs_runtime.Func(func(x_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Fraction() gopurs_runtime.Value {
	once_Fraction.Do(func() {
		cache_Fraction = gopurs_runtime.Func(func(x_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
var x_0 gopurs_runtime.Value = x_0_loop
_ = x_0
return x_0
