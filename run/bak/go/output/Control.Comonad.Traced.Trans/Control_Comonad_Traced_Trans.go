...
return Call_functorTracedT((*Record_map__gopurs_runtime_Value)(dictFunctor_0_box.UnsafePtr))
})
	})
...
return Call_extendTracedT((*Record_extend_gopurs_runtime_Value)(dictExtend_0_box.UnsafePtr))
})
	})
...
return Call_comonadTransTracedT((*Record_mempty_gopurs_runtime_Value)(dictMonoid_0_box.UnsafePtr))
})
	})
...
return Call_comonadTracedT((*Record_extract_gopurs_runtime_Value)(dictComonad_0_box.UnsafePtr))
})
	})
...
func Call_functorTracedT(dictFunctor_0_loop *Record_map__gopurs_runtime_Value) gopurs_runtime.Value {
...
func Call_extendTracedT(dictExtend_0_loop *Record_extend_gopurs_runtime_Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply2(dictExtend_0.extend, gopurs_runtime.Func2(func(w_prime_6 gopurs_runtime.Value, t_7 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_comonadTransTracedT(dictMonoid_0_loop *Record_mempty_gopurs_runtime_Value) gopurs_runtime.Value {
...
func Call_comonadTracedT(dictComonad_0_loop *Record_extract_gopurs_runtime_Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply2(dictComonad_0.extract, v_7, mempty_5_4)
}))
})
}
