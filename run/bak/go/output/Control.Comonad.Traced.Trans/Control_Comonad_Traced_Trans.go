...
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictExtend_0_loop, "extend"), gopurs_runtime.Func2(func(w_prime_6 gopurs_runtime.Value, t_7 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictComonad_0_loop, "extract"), v_7, mempty_5_4)
