...
func Get_foldMap1() gopurs_runtime.Value {
	once_foldMap1.Do(func() {
		cache_foldMap1 = gopurs_runtime.Func2(func(arg0 gopurs_runtime.Value, arg1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 1358893437, UnsafePtr: unsafe.Pointer(func(inner_arg0 func(gopurs_runtime.Value) *pkg_Data_List_Types.Constructor_Cons[gopurs_runtime.Value], inner_arg1 *pkg_Data_List_Types.Constructor_Cons[gopurs_runtime.Value]) *pkg_Data_List_Types.Constructor_Cons[gopurs_runtime.Value] {
return (*pkg_Data_List_Types.Constructor_Cons[gopurs_runtime.Value])(gopurs_runtime.Apply2(gopurs_runtime.Apply(gopurs_runtime.RecordGet(pkg_Data_List_Types.Get_foldableList(), "foldMap"), pkg_Data_List_Types.Get_monoidList()), gopurs_runtime.Func(func(arg0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 1358893437, UnsafePtr: unsafe.Pointer(inner_arg0(arg0))}
}), gopurs_runtime.Value{Type: 9, IntVal: 1358893437, UnsafePtr: unsafe.Pointer(inner_arg1)}).UnsafePtr)
}(func(inner_arg0 gopurs_runtime.Value) *pkg_Data_List_Types.Constructor_Cons[gopurs_runtime.Value] {
return (*pkg_Data_List_Types.Constructor_Cons[gopurs_runtime.Value])(gopurs_runtime.Apply(arg0, inner_arg0).UnsafePtr)
}, (*pkg_Data_List_Types.Constructor_Cons[gopurs_runtime.Value])(arg1.UnsafePtr)))}
})
	})
...
return gopurs_runtime.Apply(__local_var_0_0, gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 2861335956, UnsafePtr: unsafe.Pointer(&pkg_Data_Map_Internal.Constructor_IterNode[gopurs_runtime.Value, gopurs_runtime.Value]{(*pkg_Data_Map_Internal.Constructor_Node[interface{}, interface{}])(x_1.UnsafePtr), gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 2509360378, UnsafePtr: nil})})}))
})
}()
	})
...
return gopurs_runtime.Value{Type: 9, IntVal: 324739070, UnsafePtr: unsafe.Pointer(Call_unIsoDuration((*pkg_Data_Map_Internal.Constructor_Node[gopurs_runtime.Value, float64])(v_0_box.UnsafePtr)))}
})
	})
...
func Get_showIsoDuration() gopurs_runtime.Value {
	once_showIsoDuration.Do(func() {
		cache_showIsoDuration = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("show", gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_showError() gopurs_runtime.Value {
	once_showError.Do(func() {
		cache_showError = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("show", gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_eqIsoDuration() gopurs_runtime.Value {
	once_eqIsoDuration.Do(func() {
		cache_eqIsoDuration = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("eq", gopurs_runtime.Func2(func(x_0 gopurs_runtime.Value, y_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_ordIsoDuration() gopurs_runtime.Value {
	once_ordIsoDuration.Do(func() {
		cache_ordIsoDuration = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Eq0", "compare", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_eqError() gopurs_runtime.Value {
	once_eqError.Do(func() {
		cache_eqError = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("eq", gopurs_runtime.Func2(func(x_0 gopurs_runtime.Value, y_1 gopurs_runtime.Value) gopurs_runtime.Value {
var __t0 gopurs_runtime.Value
{
...
func Get_ordError() gopurs_runtime.Value {
	once_ordError.Do(func() {
		cache_ordError = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Eq0", "compare", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return Get_eqError()
}), gopurs_runtime.Func2(func(x_0 gopurs_runtime.Value, y_1 gopurs_runtime.Value) gopurs_runtime.Value {
var __t0 gopurs_runtime.Value
{
...
return gopurs_runtime.Value{Type: 9, IntVal: 1358893437, UnsafePtr: unsafe.Pointer(Call_checkWeekUsage(gopurs_runtime.UnboxAny(v_0_box)))}
})
	})
...
return gopurs_runtime.Value{Type: 9, IntVal: 1358893437, UnsafePtr: unsafe.Pointer(Call_checkNegativeValues(gopurs_runtime.UnboxAny(v_0_box)))}
})
	})
...
return gopurs_runtime.Value{Type: 9, IntVal: 1358893437, UnsafePtr: unsafe.Pointer(Call_checkFractionalUse(gopurs_runtime.UnboxAny(v_0_box)))}
})
	})
...
return gopurs_runtime.Value{Type: 9, IntVal: 1358893437, UnsafePtr: unsafe.Pointer(Call_checkEmptiness(gopurs_runtime.UnboxAny(v_0_box)))}
})
	})
...
return gopurs_runtime.Value{Type: 9, IntVal: 1358893437, UnsafePtr: unsafe.Pointer(Call_checkValidIsoDuration((*pkg_Data_Map_Internal.Constructor_Node[gopurs_runtime.Value, float64])(v_0_box.UnsafePtr)))}
})
	})
...
return Call_mkIsoDuration((*pkg_Data_Map_Internal.Constructor_Node[gopurs_runtime.Value, float64])(d_0_box.UnsafePtr))
})
	})
...
{
if (v_2.Type == 9 && v_2.IntVal == 324739070 && v_2.UnsafePtr != nil) {
v1_3_2 := gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Interval_Duration.Get_ordDurationComponent(), "compare"), k_0, gopurs_runtime.Any((*pkg_Data_Map_Internal.Constructor_Node[gopurs_runtime.Value, gopurs_runtime.Value])(v_2.UnsafePtr).V2))
_ = v1_3_2
var __t3 gopurs_runtime.Value
{
if (v1_3_2.Type == 9 && v1_3_2.IntVal == 1527465420) {
v_2_loop = gopurs_runtime.UnboxAny(gopurs_runtime.Value{Type: 9, IntVal: 324739070, UnsafePtr: unsafe.Pointer((*pkg_Data_Map_Internal.Constructor_Node[gopurs_runtime.Value, gopurs_runtime.Value])(v_2.UnsafePtr).V4)})
continue go__1_0
...
v_2_loop = gopurs_runtime.UnboxAny(gopurs_runtime.Value{Type: 9, IntVal: 324739070, UnsafePtr: unsafe.Pointer((*pkg_Data_Map_Internal.Constructor_Node[gopurs_runtime.Value, gopurs_runtime.Value])(v_2.UnsafePtr).V5)})
continue go__1_0
__t3 = gopurs_runtime.Value{}
goto end_branch_3
} else {
...
__t3 = gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]{gopurs_runtime.UnboxAny(gopurs_runtime.Any((*pkg_Data_Map_Internal.Constructor_Node[gopurs_runtime.Value, gopurs_runtime.Value])(v_2.UnsafePtr).V3))})})
goto end_branch_3
} else {
...
func Call_unIsoDuration(v_0_loop *pkg_Data_Map_Internal.Constructor_Node[gopurs_runtime.Value, float64]) *pkg_Data_Map_Internal.Constructor_Node[gopurs_runtime.Value, float64] {
var v_0 *pkg_Data_Map_Internal.Constructor_Node[gopurs_runtime.Value, float64] = v_0_loop
_ = v_0
return v_0
}
...
func Call_checkWeekUsage(v_0_loop interface{}) *pkg_Data_List_Types.Constructor_Cons[gopurs_runtime.Value] {
var v_0 interface{} = v_0_loop
_ = v_0
var __t0 gopurs_runtime.Value
{
__local_var_1_1 := gopurs_runtime.Apply(Call_lookup(gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 401302776, UnsafePtr: nil})), gopurs_runtime.RecordGet(gopurs_runtime.Any(v_0), "asMap"))
_ = __local_var_1_1
var __t2 gopurs_runtime.Value
{
...
var __t3 gopurs_runtime.Value
{
var __t_tag_4 gopurs_runtime.Value = gopurs_runtime.RecordGet(gopurs_runtime.Any(v_0), "asMap")
...
{
var __t_tag_5 gopurs_runtime.Value = gopurs_runtime.RecordGet(gopurs_runtime.Any(v_0), "asMap")
if (__t_tag_5.Type == 9 && __t_tag_5.IntVal == 324739070 && __t_tag_5.UnsafePtr != nil) {
__t3 = gopurs_runtime.Int((*pkg_Data_Map_Internal.Constructor_Node[gopurs_runtime.Value, gopurs_runtime.Value])(gopurs_runtime.RecordGet(gopurs_runtime.Any(v_0), "asMap").UnsafePtr).V1)
goto end_branch_3
} else {
...
__t0 = gopurs_runtime.Apply(gopurs_runtime.RecordGet(pkg_Data_List_Types.Get_applicativeList(), "pure"), gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 1775501833, UnsafePtr: nil}))
goto end_branch_0
} else {
...
func Call_checkNegativeValues(v_0_loop interface{}) *pkg_Data_List_Types.Constructor_Cons[gopurs_runtime.Value] {
var v_0 interface{} = v_0_loop
_ = v_0
...
var __t0 gopurs_runtime.Value
{
if (gopurs_runtime.Any((*pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(v1_1.UnsafePtr).V1).FloatVal()) >= (0.0) {
__t0 = gopurs_runtime.RecordGet(pkg_Data_List_Types.Get_plusList(), "empty")
goto end_branch_0
} else {
...
{
__t0 = gopurs_runtime.Apply(gopurs_runtime.RecordGet(pkg_Data_List_Types.Get_applicativeList(), "pure"), gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 3224543173, UnsafePtr: unsafe.Pointer(&Constructor_ContainsNegativeValue{gopurs_runtime.Any((*pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(v1_1.UnsafePtr).V0)})}))
}
end_branch_0:
return __t0
}), gopurs_runtime.RecordGet(gopurs_runtime.Any(v_0), "asList")).UnsafePtr)
}

func Call_checkFractionalUse(v_0_loop interface{}) *pkg_Data_List_Types.Constructor_Cons[gopurs_runtime.Value] {
var v_0 interface{} = v_0_loop
_ = v_0
...
return gopurs_runtime.Apply(gopurs_runtime.RecordGet(pkg_Data_HeytingAlgebra.Get_heytingAlgebraBoolean(), "not"), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Eq.Get_eqBoolean(), "eq"), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Eq.Get_eqNumber(), "eq"), gopurs_runtime.Apply(pkg_Data_Number.Get_floor(), gopurs_runtime.Any((*pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(x_1.UnsafePtr).V1)), gopurs_runtime.Any((*pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(x_1.UnsafePtr).V1)), gopurs_runtime.Bool(false)))
}), gopurs_runtime.RecordGet(gopurs_runtime.Any(v_0), "asList"))
_ = __local_var_1_0
var __t1 gopurs_runtime.Value
{
...
return gopurs_runtime.Apply(pkg_Data_Number.Get_abs(), gopurs_runtime.Any((*pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(x_2.UnsafePtr).V1))
...
__t1 = gopurs_runtime.Apply(gopurs_runtime.RecordGet(pkg_Data_List_Types.Get_applicativeList(), "pure"), gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 574232667, UnsafePtr: unsafe.Pointer(&Constructor_InvalidFractionalUse{gopurs_runtime.Any((*pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(gopurs_runtime.Any((*pkg_Data_List_Types.Constructor_Cons[gopurs_runtime.Value])(gopurs_runtime.RecordGet(__local_var_1_0, "rest").UnsafePtr).V0).UnsafePtr).V0)})}))
goto end_branch_1
} else {
...
func Call_checkEmptiness(v_0_loop interface{}) *pkg_Data_List_Types.Constructor_Cons[gopurs_runtime.Value] {
var v_0 interface{} = v_0_loop
_ = v_0
var __t0 gopurs_runtime.Value
{
var __t_tag_1 gopurs_runtime.Value = gopurs_runtime.RecordGet(gopurs_runtime.Any(v_0), "asList")
if (__t_tag_1.Type == 9 && __t_tag_1.IntVal == 1358893437 && __t_tag_1.UnsafePtr == nil) {
__t0 = gopurs_runtime.Apply(gopurs_runtime.RecordGet(pkg_Data_List_Types.Get_applicativeList(), "pure"), gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 1422140417, UnsafePtr: nil}))
goto end_branch_0
} else {
...
func Call_checkValidIsoDuration(v_0_loop *pkg_Data_Map_Internal.Constructor_Node[gopurs_runtime.Value, float64]) *pkg_Data_List_Types.Constructor_Cons[gopurs_runtime.Value] {
var v_0 *pkg_Data_Map_Internal.Constructor_Node[gopurs_runtime.Value, float64] = v_0_loop
_ = v_0
var go__1_0 gopurs_runtime.Value
go__1_0 = gopurs_runtime.Func(func(v_2_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
...
return (*pkg_Data_List_Types.Constructor_Cons[gopurs_runtime.Value])(gopurs_runtime.Apply2(Get_fold(), gopurs_runtime.Array([]gopurs_runtime.Value{Get_checkWeekUsage(), Get_checkEmptiness(), Get_checkFractionalUse(), Get_checkNegativeValues()}), gopurs_runtime.RecordDict2("asList", "asMap", gopurs_runtime.Apply2(gopurs_runtime.Any(go__1_0), gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 1358893437, UnsafePtr: nil}), gopurs_runtime.Apply(Get_toUnfoldable(), gopurs_runtime.Value{Type: 9, IntVal: 324739070, UnsafePtr: unsafe.Pointer(v_0)})), gopurs_runtime.Value{Type: 9, IntVal: 324739070, UnsafePtr: unsafe.Pointer(v_0)})).UnsafePtr)
}

func Call_mkIsoDuration(d_0_loop *pkg_Data_Map_Internal.Constructor_Node[gopurs_runtime.Value, float64]) gopurs_runtime.Value {
var d_0 *pkg_Data_Map_Internal.Constructor_Node[gopurs_runtime.Value, float64] = d_0_loop
_ = d_0
...
__t1 = gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 2465973597, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value]{gopurs_runtime.UnboxAny(gopurs_runtime.Value{Type: 9, IntVal: 324739070, UnsafePtr: unsafe.Pointer(d_0)})})})
goto end_branch_1
} else {
...
{
if (__local_var_1_0.Type == 9 && __local_var_1_0.IntVal == 1358893437 && __local_var_1_0.UnsafePtr != nil) {
__t1 = gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 3711209382, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value]{gopurs_runtime.Value{Type: 9, IntVal: 3111306138, UnsafePtr: unsafe.Pointer(&pkg_Data_NonEmpty.Constructor_NonEmpty[gopurs_runtime.Value, gopurs_runtime.Value]{gopurs_runtime.UnboxAny(gopurs_runtime.Any((*pkg_Data_List_Types.Constructor_Cons[gopurs_runtime.Value])(__local_var_1_0.UnsafePtr).V0)), gopurs_runtime.UnboxAny(gopurs_runtime.Value{Type: 9, IntVal: 1358893437, UnsafePtr: unsafe.Pointer((*pkg_Data_List_Types.Constructor_Cons[gopurs_runtime.Value])(__local_var_1_0.UnsafePtr).V1)})})}})})
goto end_branch_1
} else {
