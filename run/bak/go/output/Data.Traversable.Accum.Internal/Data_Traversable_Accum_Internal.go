...
func Get_StateR() gopurs_runtime.Value {
	once_StateR.Do(func() {
		cache_StateR = gopurs_runtime.Func(func(x_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_StateL() gopurs_runtime.Value {
	once_StateL.Do(func() {
		cache_StateL = gopurs_runtime.Func(func(x_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
var x_0 gopurs_runtime.Value = x_0_loop
_ = x_0
return x_0
...
func Get_stateR() gopurs_runtime.Value {
	once_stateR.Do(func() {
		cache_stateR = gopurs_runtime.Func(func(v_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
...
func Get_stateL() gopurs_runtime.Value {
	once_stateL.Do(func() {
		cache_stateL = gopurs_runtime.Func(func(v_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
var v_0 gopurs_runtime.Value = v_0_loop
_ = v_0
return v_0
...
func Get_applyStateR() gopurs_runtime.Value {
	once_applyStateR.Do(func() {
		cache_applyStateR = gopurs_runtime.RecordDict2("apply", "Functor0", gopurs_runtime.Func3(func(f_0 gopurs_runtime.Value, x_1 gopurs_runtime.Value, s_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_applyStateL() gopurs_runtime.Value {
	once_applyStateL.Do(func() {
		cache_applyStateL = gopurs_runtime.RecordDict2("apply", "Functor0", gopurs_runtime.Func3(func(f_0 gopurs_runtime.Value, x_1 gopurs_runtime.Value, s_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_applicativeStateR() gopurs_runtime.Value {
	once_applicativeStateR.Do(func() {
		cache_applicativeStateR = gopurs_runtime.RecordDict2("pure", "Apply0", gopurs_runtime.Func2(func(a_0 gopurs_runtime.Value, s_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_applicativeStateL() gopurs_runtime.Value {
	once_applicativeStateL.Do(func() {
		cache_applicativeStateL = gopurs_runtime.RecordDict2("pure", "Apply0", gopurs_runtime.Func2(func(a_0 gopurs_runtime.Value, s_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.RecordDict2("accum", "value", s_1, a_0)
}), gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
