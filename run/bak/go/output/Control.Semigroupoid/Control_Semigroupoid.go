...
return Call_compose((*Record_compose_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
...
return Call_composeFlipped((*Record_compose_gopurs_runtime_Value)(dictSemigroupoid_0_box.UnsafePtr), f_1_box, g_2_box)
})
	})
...
func Call_compose(dict_0_loop *Record_compose_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_compose_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.compose
}

func Call_composeFlipped(dictSemigroupoid_0_loop *Record_compose_gopurs_runtime_Value, f_1_loop gopurs_runtime.Value, g_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = g_2
return gopurs_runtime.Apply2(dictSemigroupoid_0.compose, g_2, f_1)
}
