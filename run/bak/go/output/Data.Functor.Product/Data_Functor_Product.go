...
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str("(product "), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Apply(((*gopurs_runtime.RecordData1)(dictShow_0.UnsafePtr)).V0, (*pkg_Data_Tuple.Constructor_Tuple)(v_2.UnsafePtr).V0), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str(" "), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Apply(((*gopurs_runtime.RecordData1)(dictShow1_1.UnsafePtr)).V0, (*pkg_Data_Tuple.Constructor_Tuple)(v_2.UnsafePtr).V1), gopurs_runtime.Str(")")))))
}))
}
...
_ = ga_1
return gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&pkg_Data_Tuple.Constructor_Tuple{fa_0, ga_1})}
}
...
return gopurs_runtime.Apply3(gopurs_runtime.RecordGet(pkg_Data_Bifunctor.Get_bifunctorTuple(), "bimap"), gopurs_runtime.Apply(((*gopurs_runtime.RecordData1)(dictFunctor_0.UnsafePtr)).V0, f_2), gopurs_runtime.Apply(((*gopurs_runtime.RecordData1)(dictFunctor1_1.UnsafePtr)).V0, f_2), v_3)
}))
}
...
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_HeytingAlgebra.Get_heytingAlgebraBoolean(), "conj"), gopurs_runtime.Apply2(eq12_3_0, (*pkg_Data_Tuple.Constructor_Tuple)(v_5.UnsafePtr).V0, (*pkg_Data_Tuple.Constructor_Tuple)(v1_6.UnsafePtr).V0), gopurs_runtime.Apply2(eq13_4_1, (*pkg_Data_Tuple.Constructor_Tuple)(v_5.UnsafePtr).V1, (*pkg_Data_Tuple.Constructor_Tuple)(v1_6.UnsafePtr).V1))
})
}))
}
...
compare12_5_2 := gopurs_runtime.Apply(((*gopurs_runtime.RecordData1)(dictOrd1_0.UnsafePtr)).V0, dictOrd_4)
_ = compare12_5_2
...
v2_9_4 := gopurs_runtime.Apply2(compare12_5_2, (*pkg_Data_Tuple.Constructor_Tuple)(v_7.UnsafePtr).V0, (*pkg_Data_Tuple.Constructor_Tuple)(v1_8.UnsafePtr).V0)
_ = v2_9_4
var __t5 gopurs_runtime.Value
{
if (v2_9_4.Type == 9 && v2_9_4.IntVal == 902936544) {
__t5 = gopurs_runtime.Apply2(compare13_6_3, (*pkg_Data_Tuple.Constructor_Tuple)(v_7.UnsafePtr).V1, (*pkg_Data_Tuple.Constructor_Tuple)(v1_8.UnsafePtr).V1)
goto end_branch_5
} else {
...
return gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&pkg_Data_Tuple.Constructor_Tuple{gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictApply_0.UnsafePtr)).V0, (*pkg_Data_Tuple.Constructor_Tuple)(v_4.UnsafePtr).V0, (*pkg_Data_Tuple.Constructor_Tuple)(v1_5.UnsafePtr).V0), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictApply1_2, "apply"), (*pkg_Data_Tuple.Constructor_Tuple)(v_4.UnsafePtr).V1, (*pkg_Data_Tuple.Constructor_Tuple)(v1_5.UnsafePtr).V1)})}
}))
})
}
...
return gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&pkg_Data_Tuple.Constructor_Tuple{gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictBind_0.UnsafePtr)).V0, (*pkg_Data_Tuple.Constructor_Tuple)(v_4.UnsafePtr).V0, gopurs_runtime.Func(func(x_6 gopurs_runtime.Value) gopurs_runtime.Value {
return (*pkg_Data_Tuple.Constructor_Tuple)(gopurs_runtime.Apply(f_5, x_6).UnsafePtr).V0
})), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictBind1_2, "bind"), (*pkg_Data_Tuple.Constructor_Tuple)(v_4.UnsafePtr).V1, gopurs_runtime.Func(func(x_6 gopurs_runtime.Value) gopurs_runtime.Value {
return (*pkg_Data_Tuple.Constructor_Tuple)(gopurs_runtime.Apply(f_5, x_6).UnsafePtr).V1
}))})}
}))
})
}
...
return gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&pkg_Data_Tuple.Constructor_Tuple{gopurs_runtime.Apply(((*gopurs_runtime.RecordData1)(dictApplicative_0.UnsafePtr)).V0, a_4), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictApplicative1_2, "pure"), a_4)})}
}))
})
}
