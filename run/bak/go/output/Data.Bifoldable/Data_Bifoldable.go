...
func Get_bitraverse_() gopurs_runtime.Value {
	once_bitraverse_.Do(func() {
		bitraverse_ = gopurs_runtime.Func2(func(dictBifoldable_0 gopurs_runtime.Value, dictApplicative_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_bifor_() gopurs_runtime.Value {
	once_bifor_.Do(func() {
		bifor_ = gopurs_runtime.Func2(func(dictBifoldable_0 gopurs_runtime.Value, dictApplicative_1 gopurs_runtime.Value) gopurs_runtime.Value {
bitraverse_2_2_0 := gopurs_runtime.Apply2(Get_bitraverse_(), dictBifoldable_0, dictApplicative_1)
_ = bitraverse_2_2_0
...
func Get_bisequence_() gopurs_runtime.Value {
	once_bisequence_.Do(func() {
		bisequence_ = gopurs_runtime.Func2(func(dictBifoldable_0 gopurs_runtime.Value, dictApplicative_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply4(Get_bitraverse_(), dictBifoldable_0, dictApplicative_1, gopurs_runtime.RecordGet(pkg_Control_Category.Get_categoryFn(), "identity"), gopurs_runtime.RecordGet(pkg_Control_Category.Get_categoryFn(), "identity"))
})
	})
	return bisequence_
}
...
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonoid_0, "Semigroup0"), gopurs_runtime.Value{}), "append"), gopurs_runtime.Apply(f_1, gopurs_runtime.RecordGet(v_3, "value0")), gopurs_runtime.Apply(g_2, gopurs_runtime.RecordGet(v_3, "value1")))
...
return gopurs_runtime.Apply2(f_0, gopurs_runtime.RecordGet(v_3, "value0"), gopurs_runtime.Apply2(g_1, gopurs_runtime.RecordGet(v_3, "value1"), z_2))
}), gopurs_runtime.Func4(func(f_0 gopurs_runtime.Value, g_1 gopurs_runtime.Value, z_2 gopurs_runtime.Value, v_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(g_1, gopurs_runtime.Apply2(f_0, z_2, gopurs_runtime.RecordGet(v_3, "value0")), gopurs_runtime.RecordGet(v_3, "value1"))
}))
	})
...
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(v3_3, "_tag").StrVal == "Left")).IntVal != 0 {
__t0 = gopurs_runtime.Apply2(v_0, gopurs_runtime.RecordGet(v3_3, "value0"), v2_2)
goto end_branch_0
} else {
...
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(v3_3, "_tag").StrVal == "Right")).IntVal != 0 {
__t0 = gopurs_runtime.Apply2(v1_1, gopurs_runtime.RecordGet(v3_3, "value0"), v2_2)
goto end_branch_0
} else {
...
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(v3_3, "_tag").StrVal == "Left")).IntVal != 0 {
__t1 = gopurs_runtime.Apply2(v_0, v2_2, gopurs_runtime.RecordGet(v3_3, "value0"))
goto end_branch_1
} else {
...
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(v3_3, "_tag").StrVal == "Right")).IntVal != 0 {
__t1 = gopurs_runtime.Apply2(v1_1, v2_2, gopurs_runtime.RecordGet(v3_3, "value0"))
goto end_branch_1
} else {
...
__t2 = gopurs_runtime.Apply(v_1, gopurs_runtime.RecordGet(v2_3, "value0"))
goto end_branch_2
} else {
...
__t2 = gopurs_runtime.Apply(v1_2, gopurs_runtime.RecordGet(v2_3, "value0"))
goto end_branch_2
} else {
...
func Get_bifoldMapDefaultR() gopurs_runtime.Value {
	once_bifoldMapDefaultR.Do(func() {
		bifoldMapDefaultR = gopurs_runtime.Func2(func(dictBifoldable_0 gopurs_runtime.Value, dictMonoid_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_bifoldMapDefaultL() gopurs_runtime.Value {
	once_bifoldMapDefaultL.Do(func() {
		bifoldMapDefaultL = gopurs_runtime.Func2(func(dictBifoldable_0 gopurs_runtime.Value, dictMonoid_1 gopurs_runtime.Value) gopurs_runtime.Value {
__local_var_2_0 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonoid_1, "Semigroup0"), gopurs_runtime.Value{})
_ = __local_var_2_0
mempty_3_1 := gopurs_runtime.RecordGet(dictMonoid_1, "mempty")
_ = mempty_3_1
...
func Get_bifoldableProduct2() gopurs_runtime.Value {
	once_bifoldableProduct2.Do(func() {
		bifoldableProduct2 = gopurs_runtime.Func(func(dictBifoldable_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(dictBifoldable1_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
bifoldableProduct2:
for {
if false { continue bifoldableProduct2 }
var dictBifoldable_0 = dictBifoldable_0_loop
_ = dictBifoldable_0
var dictBifoldable1_1 = dictBifoldable1_1_loop
_ = dictBifoldable1_1
...
return gopurs_runtime.Apply5(Get_bifoldrDefault(), gopurs_runtime.Apply2(Get_bifoldableProduct2(), dictBifoldable_0, dictBifoldable1_1), l_2, r_3, u_4, m_5)
...
return gopurs_runtime.Apply5(Get_bifoldlDefault(), gopurs_runtime.Apply2(Get_bifoldableProduct2(), dictBifoldable_0, dictBifoldable1_1), l_2, r_3, u_4, m_5)
...
func Get_bifold() gopurs_runtime.Value {
	once_bifold.Do(func() {
		bifold = gopurs_runtime.Func2(func(dictBifoldable_0 gopurs_runtime.Value, dictMonoid_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_biany() gopurs_runtime.Value {
	once_biany.Do(func() {
		biany = gopurs_runtime.Func2(func(dictBifoldable_0 gopurs_runtime.Value, dictBooleanAlgebra_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_biall() gopurs_runtime.Value {
	once_biall.Do(func() {
		biall = gopurs_runtime.Func2(func(dictBifoldable_0 gopurs_runtime.Value, dictBooleanAlgebra_1 gopurs_runtime.Value) gopurs_runtime.Value {
__local_var_2_1 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictBooleanAlgebra_1, "HeytingAlgebra0"), gopurs_runtime.Value{})
_ = __local_var_2_1
