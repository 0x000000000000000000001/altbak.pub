...
_ = v1_1_0
return gopurs_runtime.RecordDict2("head", "tail", (*pkg_Data_NonEmpty.Constructor_NonEmpty)(v1_1_0.UnsafePtr).V0, (*pkg_Data_NonEmpty.Constructor_NonEmpty)(v1_1_0.UnsafePtr).V1)
}
...
v1_1_0 := gopurs_runtime.Apply(v_0, pkg_Data_Unit.Get_unit())
_ = v1_1_0
__local_var_2_1 := (*pkg_Data_NonEmpty.Constructor_NonEmpty)(v1_1_0.UnsafePtr).V0
_ = __local_var_2_1
__local_var_3_2 := (*pkg_Data_NonEmpty.Constructor_NonEmpty)(v1_1_0.UnsafePtr).V1
_ = __local_var_3_2
return gopurs_runtime.Func(func(v_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 218341868, UnsafePtr: unsafe.Pointer(&pkg_Data_List_Lazy_Types.Constructor_Cons{__local_var_2_1, __local_var_3_2})}
})
}
...
var v_0 gopurs_runtime.Value = v_0_loop
_ = v_0
return (*pkg_Data_NonEmpty.Constructor_NonEmpty)(gopurs_runtime.Apply(v_0, pkg_Data_Unit.Get_unit()).UnsafePtr).V1
}
...
return gopurs_runtime.Value{Type: 9, IntVal: 218341868, UnsafePtr: unsafe.Pointer(&pkg_Data_List_Lazy_Types.Constructor_Cons{x_0, go__2_0})}
}))
return gopurs_runtime.Value{Type: 9, IntVal: 3111306138, UnsafePtr: unsafe.Pointer(&pkg_Data_NonEmpty.Constructor_NonEmpty{x_0, go__2_0})}
}

func Call_length(v_0_loop gopurs_runtime.Value) int64 {
var v_0 gopurs_runtime.Value = v_0_loop
_ = v_0
return (1) + (gopurs_runtime.Apply(pkg_Data_List_Lazy.Get_length(), (*pkg_Data_NonEmpty.Constructor_NonEmpty)(gopurs_runtime.Apply(v_0, pkg_Data_Unit.Get_unit()).UnsafePtr).V1).IntVal)
}
...
v1_1_0 := gopurs_runtime.Apply(v_0, pkg_Data_Unit.Get_unit())
_ = v1_1_0
__local_var_2_1 := gopurs_runtime.Apply(pkg_Data_List_Lazy.Get_last(), (*pkg_Data_NonEmpty.Constructor_NonEmpty)(v1_1_0.UnsafePtr).V1)
_ = __local_var_2_1
var __t2 gopurs_runtime.Value
{
if (__local_var_2_1.Type == 9 && __local_var_2_1.IntVal == 3589588149) {
__t2 = (*pkg_Data_NonEmpty.Constructor_NonEmpty)(v1_1_0.UnsafePtr).V0
goto end_branch_2
} else {
...
_ = v_2
return gopurs_runtime.Value{Type: 9, IntVal: 3111306138, UnsafePtr: unsafe.Pointer(&pkg_Data_NonEmpty.Constructor_NonEmpty{x_1, gopurs_runtime.Apply2(pkg_Data_List_Lazy.Get_iterate(), f_0, gopurs_runtime.Apply(f_0, x_1))})}
}
...
v1_1_0 := gopurs_runtime.Apply(v_0, pkg_Data_Unit.Get_unit())
_ = v1_1_0
__local_var_2_1 := gopurs_runtime.Apply(pkg_Data_List_Lazy.Get_init_(), (*pkg_Data_NonEmpty.Constructor_NonEmpty)(v1_1_0.UnsafePtr).V1)
_ = __local_var_2_1
var __t2 gopurs_runtime.Value
{
if (__local_var_2_1.Type == 9 && __local_var_2_1.IntVal == 3589588149) {
...
{
if (__local_var_2_1.Type == 9 && __local_var_2_1.IntVal == 930809136) {
__local_var_3_3 := (*pkg_Data_Maybe.Constructor_Just)(__local_var_2_1.UnsafePtr).V0
_ = __local_var_3_3
__t2 = gopurs_runtime.Func(func(v_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 218341868, UnsafePtr: unsafe.Pointer(&pkg_Data_List_Lazy_Types.Constructor_Cons{(*pkg_Data_NonEmpty.Constructor_NonEmpty)(v1_1_0.UnsafePtr).V0, __local_var_3_3})}
})
goto end_branch_2
} else {
...
__local_var_2_2 := (*pkg_Data_List_Lazy_Types.Constructor_Cons)(v_1_0.UnsafePtr).V0
_ = __local_var_2_2
__local_var_3_3 := (*pkg_Data_List_Lazy_Types.Constructor_Cons)(v_1_0.UnsafePtr).V1
_ = __local_var_3_3
__t1 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just{gopurs_runtime.Func(func(v1_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 3111306138, UnsafePtr: unsafe.Pointer(&pkg_Data_NonEmpty.Constructor_NonEmpty{__local_var_2_2, __local_var_3_3})}
})})}
goto end_branch_1
} else {
...
_ = v2_3_0
__local_var_4_1 := (*pkg_Data_NonEmpty.Constructor_NonEmpty)(v2_3_0.UnsafePtr).V0
_ = __local_var_4_1
__local_var_5_2 := (*pkg_Data_NonEmpty.Constructor_NonEmpty)(v2_3_0.UnsafePtr).V1
_ = __local_var_5_2
return gopurs_runtime.Value{Type: 9, IntVal: 3111306138, UnsafePtr: unsafe.Pointer(&pkg_Data_NonEmpty.Constructor_NonEmpty{y_0, gopurs_runtime.Func(func(v_6 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 218341868, UnsafePtr: unsafe.Pointer(&pkg_Data_List_Lazy_Types.Constructor_Cons{__local_var_4_1, __local_var_5_2})}
})})}
}
