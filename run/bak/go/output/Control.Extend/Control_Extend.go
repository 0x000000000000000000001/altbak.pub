...
func Get_extendFn() gopurs_runtime.Value {
	once_extendFn.Do(func() {
		cache_extendFn = gopurs_runtime.Func(func(dictSemigroup_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_extendArray() gopurs_runtime.Value {
	once_extendArray.Do(func() {
		cache_extendArray = gopurs_runtime.RecordDict2("extend", "Functor0", Get_arrayExtend(), gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_extend() gopurs_runtime.Value {
	once_extend.Do(func() {
		cache_extend = gopurs_runtime.Func(func(dict_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
...
func Get_duplicate() gopurs_runtime.Value {
	once_duplicate.Do(func() {
		cache_duplicate = gopurs_runtime.Func(func(dictExtend_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
