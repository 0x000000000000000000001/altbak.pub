...
return Call_extendFn((*Record_append__gopurs_runtime_Value)(dictSemigroup_0_box.UnsafePtr))
})
	})
...
return Call_extend((*Record_extend_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
	return cache_extend
}
...
return Call_extendFlipped((*Record_extend_gopurs_runtime_Value)(dictExtend_0_box.UnsafePtr), w_1_box, f_2_box)
})
	})
...
return Call_duplicate((*Record_extend_gopurs_runtime_Value)(dictExtend_0_box.UnsafePtr))
})
	})
...
return Call_composeCoKleisliFlipped((*Record_extend_gopurs_runtime_Value)(dictExtend_0_box.UnsafePtr), f_1_box, g_2_box, w_3_box)
})
	})
...
return Call_composeCoKleisli((*Record_extend_gopurs_runtime_Value)(dictExtend_0_box.UnsafePtr), f_1_box, g_2_box, w_3_box)
})
	})
...
func Call_extendFn(dictSemigroup_0_loop *Record_append__gopurs_runtime_Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply(g_2, gopurs_runtime.Apply2(dictSemigroup_0.append_, w_3, w_prime_4))
}))
}))
}

func Call_extend(dict_0_loop *Record_extend_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_extend_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.extend
}

func Call_extendFlipped(dictExtend_0_loop *Record_extend_gopurs_runtime_Value, w_1_loop gopurs_runtime.Value, f_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = f_2
return gopurs_runtime.Apply2(dictExtend_0.extend, f_2, w_1)
}

func Call_duplicate(dictExtend_0_loop *Record_extend_gopurs_runtime_Value) gopurs_runtime.Value {
var dictExtend_0 *Record_extend_gopurs_runtime_Value = dictExtend_0_loop
_ = dictExtend_0
return gopurs_runtime.Apply(dictExtend_0.extend, Get_identity())
}

func Call_composeCoKleisliFlipped(dictExtend_0_loop *Record_extend_gopurs_runtime_Value, f_1_loop gopurs_runtime.Value, g_2_loop gopurs_runtime.Value, w_3_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictExtend_0 *Record_extend_gopurs_runtime_Value = dictExtend_0_loop
_ = dictExtend_0
...
_ = w_3
return gopurs_runtime.Apply(f_1, gopurs_runtime.Apply2(dictExtend_0.extend, g_2, w_3))
}

func Call_composeCoKleisli(dictExtend_0_loop *Record_extend_gopurs_runtime_Value, f_1_loop gopurs_runtime.Value, g_2_loop gopurs_runtime.Value, w_3_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictExtend_0 *Record_extend_gopurs_runtime_Value = dictExtend_0_loop
_ = dictExtend_0
var f_1 gopurs_runtime.Value = f_1_loop
_ = f_1
...
var w_3 gopurs_runtime.Value = w_3_loop
_ = w_3
return gopurs_runtime.Apply(g_2, gopurs_runtime.Apply2(dictExtend_0.extend, f_1, w_3))
}
