...
__t0 = gopurs_runtime.Bool(((y_3.Type == 9 && y_3.IntVal == 3711209382)) && ((gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictEq_0.UnsafePtr)).V0, (*Data_Data_Either_Left)(x_2.UnsafePtr).V0, (*Data_Data_Either_Left)(y_3.UnsafePtr).V0).IntVal) != (0)))
goto end_branch_0
} else {
...
{
__t0 = gopurs_runtime.Bool(((x_2.Type == 9 && x_2.IntVal == 2465973597)) && (((y_3.Type == 9 && y_3.IntVal == 2465973597)) && ((gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictEq1_1.UnsafePtr)).V0, (*Data_Data_Either_Right)(x_2.UnsafePtr).V0, (*Data_Data_Either_Right)(y_3.UnsafePtr).V0).IntVal) != (0))))
}
end_branch_0:
return __t0
}))
...
__t5 = gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictOrd_0.UnsafePtr)).V0, (*Data_Data_Either_Left)(x_5.UnsafePtr).V0, (*Data_Data_Either_Left)(y_6.UnsafePtr).V0)
goto end_branch_5
} else {
