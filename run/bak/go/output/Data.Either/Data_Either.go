...
func Get_apply__4071263818() gopurs_runtime.Value {
	once_apply__4071263818.Do(func() {
		cache_apply__4071263818 = gopurs_runtime.Func2(func(v_0_box gopurs_runtime.Value, v1_1_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_apply__4071263818(v_0_box, v1_1_box)
})
	})
...
var cache_map__4176008549 gopurs_runtime.Value
var once_map__4176008549 sync.Once
func Get_map__4176008549() gopurs_runtime.Value {
	once_map__4176008549.Do(func() {
		cache_map__4176008549 = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_map__4176008549(gopurs_runtime.CoerceToStruct[pkg_Data_Functor.Constructor_Functor[gopurs_runtime.Value]](dict_0_box))
})
	})
	return cache_map__4176008549
}
...
func Call_apply__4071263818(v_0_loop gopurs_runtime.Value, v1_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var v_0 gopurs_runtime.Value = v_0_loop
_ = v_0
var v1_1 gopurs_runtime.Value = v1_1_loop
_ = v1_1
...
func Call_map__4176008549(dict_0_loop *pkg_Data_Functor.Constructor_Functor[gopurs_runtime.Value]) gopurs_runtime.Value {
