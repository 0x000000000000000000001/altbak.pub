...
return gopurs_runtime.Value{Type: 9, IntVal: 3711209382, UnsafePtr: unsafe.Pointer(&Constructor_Left{value0})}
})
	})
	return cache_Left
}
...
return gopurs_runtime.Value{Type: 9, IntVal: 2465973597, UnsafePtr: unsafe.Pointer(&Constructor_Right{value0})}
})
	})
	return cache_Right
}
...
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 3478632216, UnsafePtr: unsafe.Pointer(&pkg_Data_Generic_Rep.Constructor_Inl{(*Constructor_Left)(x_0.UnsafePtr).V0})}
goto end_branch_0
} else {
...
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 492034566, UnsafePtr: unsafe.Pointer(&pkg_Data_Generic_Rep.Constructor_Inr{(*Constructor_Right)(x_0.UnsafePtr).V0})}
goto end_branch_0
} else {
...
__t1 = gopurs_runtime.Value{Type: 9, IntVal: 3711209382, UnsafePtr: unsafe.Pointer(&Constructor_Left{(*pkg_Data_Generic_Rep.Constructor_Inl)(x_0.UnsafePtr).V0})}
goto end_branch_1
} else {
...
__t1 = gopurs_runtime.Value{Type: 9, IntVal: 2465973597, UnsafePtr: unsafe.Pointer(&Constructor_Right{(*pkg_Data_Generic_Rep.Constructor_Inr)(x_0.UnsafePtr).V0})}
goto end_branch_1
} else {
...
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 3711209382, UnsafePtr: unsafe.Pointer(&Constructor_Left{(*Constructor_Left)(m_1.UnsafePtr).V0})}
goto end_branch_0
} else {
...
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 2465973597, UnsafePtr: unsafe.Pointer(&Constructor_Right{gopurs_runtime.Apply(f_0, (*Constructor_Right)(m_1.UnsafePtr).V0)})}
goto end_branch_0
} else {
...
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 3711209382, UnsafePtr: unsafe.Pointer(&Constructor_Left{(*Constructor_Left)(v1_1.UnsafePtr).V0})}
goto end_branch_0
} else {
...
{
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 2465973597, UnsafePtr: unsafe.Pointer(&Constructor_Right{gopurs_runtime.Apply(v_0, v1_1)})}
}
end_branch_0:
return __t0
}))
...
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 3711209382, UnsafePtr: unsafe.Pointer(&Constructor_Left{(*Constructor_Left)(v_0.UnsafePtr).V0})}
goto end_branch_0
} else {
...
__t0 = gopurs_runtime.Apply2(gopurs_runtime.RecordGet(Get_functorEither(), "map"), (*Constructor_Right)(v_0.UnsafePtr).V0, v1_1)
goto end_branch_0
} else {
...
__local_var_1_1 := (*Constructor_Left)(v2_0.UnsafePtr).V0
_ = __local_var_1_1
__t0 = gopurs_runtime.Func(func(v_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 3711209382, UnsafePtr: unsafe.Pointer(&Constructor_Left{__local_var_1_1})}
})
goto end_branch_0
} else {
...
__local_var_1_2 := (*Constructor_Right)(v2_0.UnsafePtr).V0
_ = __local_var_1_2
...
type Constructor_Left struct {
	V0 gopurs_runtime.Value
}


type Constructor_Right struct {
	V0 gopurs_runtime.Value
}
...
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 3711209382, UnsafePtr: unsafe.Pointer(&Constructor_Left{gopurs_runtime.Apply(f_0, pkg_Data_Unit.Get_unit())})}
goto end_branch_0
} else {
...
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 2465973597, UnsafePtr: unsafe.Pointer(&Constructor_Right{(*pkg_Data_Maybe.Constructor_Just)(v2_1.UnsafePtr).V0})}
goto end_branch_0
} else {
...
{
if (v2_1.Type == 9 && v2_1.IntVal == 3589588149) {
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 3711209382, UnsafePtr: unsafe.Pointer(&Constructor_Left{a_0})}
goto end_branch_0
} else {
...
__t0 = (*Constructor_Right)(v1_1.UnsafePtr).V0
goto end_branch_0
} else {
...
{
if (v1_1.Type == 9 && v1_1.IntVal == 3711209382) {
__t0 = (*Constructor_Left)(v1_1.UnsafePtr).V0
goto end_branch_0
} else {
...
__t0 = gopurs_runtime.Bool(((y_3.Type == 9 && y_3.IntVal == 3711209382)) && ((gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictEq_0.UnsafePtr)).V0, (*Constructor_Left)(x_2.UnsafePtr).V0, (*Constructor_Left)(y_3.UnsafePtr).V0).IntVal) != (0)))
goto end_branch_0
} else {
...
{
__t0 = gopurs_runtime.Bool(((x_2.Type == 9 && x_2.IntVal == 2465973597)) && (((y_3.Type == 9 && y_3.IntVal == 2465973597)) && ((gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictEq1_1.UnsafePtr)).V0, (*Constructor_Right)(x_2.UnsafePtr).V0, (*Constructor_Right)(y_3.UnsafePtr).V0).IntVal) != (0))))
}
end_branch_0:
return __t0
}))
...
__t3 = gopurs_runtime.Bool(((y_5.Type == 9 && y_5.IntVal == 3711209382)) && ((gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_1_0, "eq"), (*Constructor_Left)(x_4.UnsafePtr).V0, (*Constructor_Left)(y_5.UnsafePtr).V0).IntVal) != (0)))
goto end_branch_3
} else {
...
{
__t3 = gopurs_runtime.Bool(((x_4.Type == 9 && x_4.IntVal == 2465973597)) && (((y_5.Type == 9 && y_5.IntVal == 2465973597)) && ((gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_3_1, "eq"), (*Constructor_Right)(x_4.UnsafePtr).V0, (*Constructor_Right)(y_5.UnsafePtr).V0).IntVal) != (0))))
}
end_branch_3:
return __t3
}))
...
__t5 = gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictOrd_0.UnsafePtr)).V0, (*Constructor_Left)(x_5.UnsafePtr).V0, (*Constructor_Left)(y_6.UnsafePtr).V0)
goto end_branch_5
} else {
...
__t4 = gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictOrd1_2, "compare"), (*Constructor_Right)(x_5.UnsafePtr).V0, (*Constructor_Right)(y_6.UnsafePtr).V0)
goto end_branch_4
} else {
...
{
__t0 = gopurs_runtime.Bool(((x_2.Type == 9 && x_2.IntVal == 2465973597)) && (((y_3.Type == 9 && y_3.IntVal == 2465973597)) && ((gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictEq1_1, "eq"), (*Constructor_Right)(x_2.UnsafePtr).V0, (*Constructor_Right)(y_3.UnsafePtr).V0).IntVal) != (0))))
}
end_branch_0:
return __t0
}))
...
{
if (x_4.Type == 9 && x_4.IntVal == 3711209382) {
__t3 = gopurs_runtime.Bool(((y_5.Type == 9 && y_5.IntVal == 3711209382)) && ((gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_2_1, "eq"), (*Constructor_Left)(x_4.UnsafePtr).V0, (*Constructor_Left)(y_5.UnsafePtr).V0).IntVal) != (0)))
goto end_branch_3
} else {
...
{
__t3 = gopurs_runtime.Bool(((x_4.Type == 9 && x_4.IntVal == 2465973597)) && (((y_5.Type == 9 && y_5.IntVal == 2465973597)) && ((gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictEq1_3, "eq"), (*Constructor_Right)(x_4.UnsafePtr).V0, (*Constructor_Right)(y_5.UnsafePtr).V0).IntVal) != (0))))
}
end_branch_3:
return __t3
}))
...
__t0 = gopurs_runtime.Apply(v_0, (*Constructor_Left)(v2_2.UnsafePtr).V0)
goto end_branch_0
} else {
...
__t0 = gopurs_runtime.Apply(v1_1, (*Constructor_Right)(v2_2.UnsafePtr).V0)
goto end_branch_0
} else {
...
{
if (v2_0.Type == 9 && v2_0.IntVal == 2465973597) {
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just{(*Constructor_Right)(v2_0.UnsafePtr).V0})}
goto end_branch_0
} else {
...
}), gopurs_runtime.Value{Type: 9, IntVal: 3711209382, UnsafePtr: unsafe.Pointer(&Constructor_Left{bottom_1_0})}, gopurs_runtime.Value{Type: 9, IntVal: 2465973597, UnsafePtr: unsafe.Pointer(&Constructor_Right{gopurs_runtime.RecordGet(dictBounded1_3, "top")})})
})
}
...
{
if (v2_0.Type == 9 && v2_0.IntVal == 3711209382) {
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just{(*Constructor_Left)(v2_0.UnsafePtr).V0})}
goto end_branch_0
} else {
