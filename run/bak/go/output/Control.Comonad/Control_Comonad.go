...
return Call_extract__gopurs_runtime_Value_1031647521(dict_0_box)
})
	})
...
func Call_extract__gopurs_runtime_Value_1031647521(dict_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dict_0 gopurs_runtime.Value = dict_0_loop
_ = dict_0
return gopurs_runtime.RecordGet(dict_0, "extract")
}
