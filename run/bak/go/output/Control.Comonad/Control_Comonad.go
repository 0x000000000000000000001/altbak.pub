...
return Call_extract((*Record_extract_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
...
func Call_extract(dict_0_loop *Record_extract_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_extract_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.extract
}
