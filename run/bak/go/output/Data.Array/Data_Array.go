...
i_3_loop = gopurs_runtime.Apply(gopurs_runtime.Apply(pkg_Data_Semiring.Get_intAdd(), i_3), gopurs_runtime.Int(1))
continue go__2_0
...
{
if (gopurs_runtime.Bool(v_4_1.PtrVal.(map[string]gopurs_runtime.Value)["_tag"].StrVal == "Just")).IntVal != 0 {
idx_2_loop = gopurs_runtime.Apply(gopurs_runtime.Apply(pkg_Data_Semiring.Get_intAdd(), idx_2), gopurs_runtime.Int(1))
allArrays_3_loop = gopurs_runtime.Apply(pkg_Control_Monad_ST_Internal.Get_run(), gopurs_runtime.Apply(gopurs_runtime.Apply(pkg_Data_Array_ST.Get_withArray(), gopurs_runtime.Apply(pkg_Data_Array_ST.Get_push(), v_4_1.PtrVal.(map[string]gopurs_runtime.Value)["value0"])), allArrays_3))
continue go__1_0
