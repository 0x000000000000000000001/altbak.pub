...
var cache_groupBy__gopurs_runtime_Value_2127428871 gopurs_runtime.Value
var once_groupBy__gopurs_runtime_Value_2127428871 sync.Once
func Get_groupBy__gopurs_runtime_Value_2127428871() gopurs_runtime.Value {
	once_groupBy__gopurs_runtime_Value_2127428871.Do(func() {
		cache_groupBy__gopurs_runtime_Value_2127428871 = gopurs_runtime.Func2(func(op_0_box gopurs_runtime.Value, xs_1_box gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
					arr := Call_groupBy__gopurs_runtime_Value_2127428871(op_0_box, func() []gopurs_runtime.Value {
					arr := *(*[]gopurs_runtime.Value)(xs_1_box.UnsafePtr)
					unboxed := make([]gopurs_runtime.Value, len(arr))
					for i, v := range arr { unboxed[i] = v }
					return unboxed
	...
	return cache_groupBy__gopurs_runtime_Value_2127428871
}
...
var cache_groupAllBy__gopurs_runtime_Value_3941591069 gopurs_runtime.Value
var once_groupAllBy__gopurs_runtime_Value_3941591069 sync.Once
func Get_groupAllBy__gopurs_runtime_Value_3941591069() gopurs_runtime.Value {
	once_groupAllBy__gopurs_runtime_Value_3941591069.Do(func() {
		cache_groupAllBy__gopurs_runtime_Value_3941591069 = gopurs_runtime.Func(func(cmp_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_groupAllBy__gopurs_runtime_Value_3941591069(cmp_0_box)
})
	})
	return cache_groupAllBy__gopurs_runtime_Value_3941591069
}
...
(*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(go__2_0.UnsafePtr).V0 = i_3
return go__2_0
} else {
...
func Call_groupBy__gopurs_runtime_Value_2127428871(op_0_loop gopurs_runtime.Value, xs_1_loop []gopurs_runtime.Value) [][]gopurs_runtime.Value {
var op_0 gopurs_runtime.Value = op_0_loop
_ = op_0
var xs_1 []gopurs_runtime.Value = xs_1_loop
_ = xs_1
...
func Call_groupAllBy__gopurs_runtime_Value_3941591069(cmp_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
var cmp_0 gopurs_runtime.Value = cmp_0_loop
_ = cmp_0
__local_var_1_0 := gopurs_runtime.Apply(Get_groupBy(), gopurs_runtime.Func2(func(x_1 gopurs_runtime.Value, y_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Ordering.Get_eqOrdering(), "eq"), gopurs_runtime.Apply2(cmp_0, x_1, y_2), gopurs_runtime.Value{Type: 9, IntVal: 902936544, UnsafePtr: nil})
