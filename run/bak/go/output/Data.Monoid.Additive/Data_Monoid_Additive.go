...
return Call_showAdditive((*Record_show_gopurs_runtime_Value)(dictShow_0_box.UnsafePtr))
})
	})
...
return Call_semigroupAdditive((*Record_add_gopurs_runtime_Value_mul_gopurs_runtime_Value_one_gopurs_runtime_Value_zero_gopurs_runtime_Value)(dictSemiring_0_box.UnsafePtr))
})
	})
...
return gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(Call_ordAdditive((*Record_compare_gopurs_runtime_Value)(dictOrd_0_box.UnsafePtr)))}
})
	})
...
return Call_monoidAdditive((*Record_add_gopurs_runtime_Value_mul_gopurs_runtime_Value_one_gopurs_runtime_Value_zero_gopurs_runtime_Value)(dictSemiring_0_box.UnsafePtr))
})
	})
...
return gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(Call_eqAdditive((*Record_eq_gopurs_runtime_Value)(dictEq_0_box.UnsafePtr)))}
})
	})
...
return gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(Call_boundedAdditive((*Record_bottom_gopurs_runtime_Value_top_gopurs_runtime_Value)(dictBounded_0_box.UnsafePtr)))}
})
	})
...
func Call_showAdditive(dictShow_0_loop *Record_show_gopurs_runtime_Value) gopurs_runtime.Value {
var dictShow_0 *Record_show_gopurs_runtime_Value = dictShow_0_loop
_ = dictShow_0
return gopurs_runtime.RecordDict1("show", gopurs_runtime.Func(func(v_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str("(Additive "), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Apply(dictShow_0.show, v_1), gopurs_runtime.Str(")")))
}))
}

func Call_semigroupAdditive(dictSemiring_0_loop *Record_add_gopurs_runtime_Value_mul_gopurs_runtime_Value_one_gopurs_runtime_Value_zero_gopurs_runtime_Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply2(dictSemiring_0.add, v_1, v1_2)
}))
}

func Call_ordAdditive(dictOrd_0_loop *Record_compare_gopurs_runtime_Value) *Record_compare_gopurs_runtime_Value {
var dictOrd_0 *Record_compare_gopurs_runtime_Value = dictOrd_0_loop
_ = dictOrd_0
return dictOrd_0
}

func Call_monoidAdditive(dictSemiring_0_loop *Record_add_gopurs_runtime_Value_mul_gopurs_runtime_Value_one_gopurs_runtime_Value_zero_gopurs_runtime_Value) gopurs_runtime.Value {
var dictSemiring_0 *Record_add_gopurs_runtime_Value_mul_gopurs_runtime_Value_one_gopurs_runtime_Value_zero_gopurs_runtime_Value = dictSemiring_0_loop
_ = dictSemiring_0
...
func Call_eqAdditive(dictEq_0_loop *Record_eq_gopurs_runtime_Value) *Record_eq_gopurs_runtime_Value {
var dictEq_0 *Record_eq_gopurs_runtime_Value = dictEq_0_loop
_ = dictEq_0
return dictEq_0
}

func Call_boundedAdditive(dictBounded_0_loop *Record_bottom_gopurs_runtime_Value_top_gopurs_runtime_Value) *Record_bottom_gopurs_runtime_Value_top_gopurs_runtime_Value {
