...
return gopurs_runtime.Any(Call_showAdditive(dictShow_0_box))
})
	})
...
return gopurs_runtime.Any(Call_semigroupAdditive(dictSemiring_0_box))
})
	})
...
return gopurs_runtime.Any(Call_ordAdditive(dictOrd_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monoidAdditive(dictSemiring_0_box))
})
	})
...
func Get_functorAdditive() gopurs_runtime.Value {
	once_functorAdditive.Do(func() {
		cache_functorAdditive = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("map", gopurs_runtime.Func2(func(f_0 gopurs_runtime.Value, m_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Any(Call_eqAdditive(dictEq_0_box))
})
	})
...
func Get_eq1Additive() gopurs_runtime.Value {
	once_eq1Additive.Do(func() {
		cache_eq1Additive = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("eq1", gopurs_runtime.Func(func(dictEq_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_ord1Additive() gopurs_runtime.Value {
	once_ord1Additive.Do(func() {
		cache_ord1Additive = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Eq10", "compare1", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Any(Call_boundedAdditive(dictBounded_0_box))
})
	})
...
func Get_applyAdditive() gopurs_runtime.Value {
	once_applyAdditive.Do(func() {
		cache_applyAdditive = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Functor0", "apply", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_bindAdditive() gopurs_runtime.Value {
	once_bindAdditive.Do(func() {
		cache_bindAdditive = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Apply0", "bind", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_applicativeAdditive() gopurs_runtime.Value {
	once_applicativeAdditive.Do(func() {
		cache_applicativeAdditive = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Apply0", "pure", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return Get_applyAdditive()
}), Get_Additive())))
	})
...
func Get_monadAdditive() gopurs_runtime.Value {
	once_monadAdditive.Do(func() {
		cache_monadAdditive = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Applicative0", "Bind1", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_showAdditive(dictShow_0_loop gopurs_runtime.Value) interface{} {
...
func Call_semigroupAdditive(dictSemiring_0_loop gopurs_runtime.Value) interface{} {
...
func Call_ordAdditive(dictOrd_0_loop gopurs_runtime.Value) interface{} {
var dictOrd_0 gopurs_runtime.Value = dictOrd_0_loop
_ = dictOrd_0
return gopurs_runtime.UnboxAny(dictOrd_0)
}

func Call_monoidAdditive(dictSemiring_0_loop gopurs_runtime.Value) interface{} {
var dictSemiring_0 gopurs_runtime.Value = dictSemiring_0_loop
_ = dictSemiring_0
...
func Call_eqAdditive(dictEq_0_loop gopurs_runtime.Value) interface{} {
var dictEq_0 gopurs_runtime.Value = dictEq_0_loop
_ = dictEq_0
return gopurs_runtime.UnboxAny(dictEq_0)
}

func Call_boundedAdditive(dictBounded_0_loop gopurs_runtime.Value) interface{} {
