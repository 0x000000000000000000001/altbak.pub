...
return gopurs_runtime.Any(Call_showLast(dictShow_0_box))
})
	})
...
func Get_semigroupLast() gopurs_runtime.Value {
	once_semigroupLast.Do(func() {
		cache_semigroupLast = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("append", gopurs_runtime.Func2(func(v_0 gopurs_runtime.Value, v1_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Any(Call_ordLast(dictOrd_0_box))
})
	})
...
func Get_ord1Last() gopurs_runtime.Value {
	once_ord1Last.Do(func() {
		cache_ord1Last = gopurs_runtime.Any(gopurs_runtime.UnboxAny(pkg_Data_Maybe.Get_ord1Maybe()))
	})
...
func Get_monoidLast() gopurs_runtime.Value {
	once_monoidLast.Do(func() {
		cache_monoidLast = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Semigroup0", "mempty", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_monadLast() gopurs_runtime.Value {
	once_monadLast.Do(func() {
		cache_monadLast = gopurs_runtime.Any(gopurs_runtime.UnboxAny(pkg_Data_Maybe.Get_monadMaybe()))
	})
...
func Get_invariantLast() gopurs_runtime.Value {
	once_invariantLast.Do(func() {
		cache_invariantLast = gopurs_runtime.Any(gopurs_runtime.UnboxAny(pkg_Data_Maybe.Get_invariantMaybe()))
	})
...
func Get_functorLast() gopurs_runtime.Value {
	once_functorLast.Do(func() {
		cache_functorLast = gopurs_runtime.Any(gopurs_runtime.UnboxAny(pkg_Data_Maybe.Get_functorMaybe()))
	})
...
func Get_extendLast() gopurs_runtime.Value {
	once_extendLast.Do(func() {
		cache_extendLast = gopurs_runtime.Any(gopurs_runtime.UnboxAny(pkg_Data_Maybe.Get_extendMaybe()))
	})
...
return gopurs_runtime.Any(Call_eqLast(dictEq_0_box))
})
	})
	return cache_eqLast
}
...
func Get_eq1Last() gopurs_runtime.Value {
	once_eq1Last.Do(func() {
		cache_eq1Last = gopurs_runtime.Any(gopurs_runtime.UnboxAny(pkg_Data_Maybe.Get_eq1Maybe()))
	})
...
return gopurs_runtime.Any(Call_boundedLast(dictBounded_0_box))
})
	})
...
func Get_bindLast() gopurs_runtime.Value {
	once_bindLast.Do(func() {
		cache_bindLast = gopurs_runtime.Any(gopurs_runtime.UnboxAny(pkg_Data_Maybe.Get_bindMaybe()))
	})
...
func Get_applyLast() gopurs_runtime.Value {
	once_applyLast.Do(func() {
		cache_applyLast = gopurs_runtime.Any(gopurs_runtime.UnboxAny(pkg_Data_Maybe.Get_applyMaybe()))
	})
...
func Get_applicativeLast() gopurs_runtime.Value {
	once_applicativeLast.Do(func() {
		cache_applicativeLast = gopurs_runtime.Any(gopurs_runtime.UnboxAny(pkg_Data_Maybe.Get_applicativeMaybe()))
	})
...
func Get_altLast() gopurs_runtime.Value {
	once_altLast.Do(func() {
		cache_altLast = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Functor0", "alt", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_plusLast() gopurs_runtime.Value {
	once_plusLast.Do(func() {
		cache_plusLast = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Alt0", "empty", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return Get_altLast()
}), gopurs_runtime.RecordGet(Get_monoidLast(), "mempty"))))
	})
...
func Get_alternativeLast() gopurs_runtime.Value {
	once_alternativeLast.Do(func() {
		cache_alternativeLast = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Applicative0", "Plus1", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_showLast(dictShow_0_loop gopurs_runtime.Value) interface{} {
...
func Call_ordLast(dictOrd_0_loop gopurs_runtime.Value) interface{} {
...
func Call_eqLast(dictEq_0_loop gopurs_runtime.Value) interface{} {
...
func Call_boundedLast(dictBounded_0_loop gopurs_runtime.Value) interface{} {
