...
return Call_showLast((*Record_show_gopurs_runtime_Value)(dictShow_0_box.UnsafePtr))
})
	})
...
return Call_ordLast((*Record_compare_gopurs_runtime_Value)(dictOrd_0_box.UnsafePtr))
})
	})
...
return Call_eqLast((*Record_eq_gopurs_runtime_Value)(dictEq_0_box.UnsafePtr))
})
	})
	return cache_eqLast
}
...
return Call_boundedLast((*Record_bottom_gopurs_runtime_Value_top_gopurs_runtime_Value)(dictBounded_0_box.UnsafePtr))
})
	})
...
func Call_showLast(dictShow_0_loop *Record_show_gopurs_runtime_Value) gopurs_runtime.Value {
...
func Call_ordLast(dictOrd_0_loop *Record_compare_gopurs_runtime_Value) gopurs_runtime.Value {
...
func Call_eqLast(dictEq_0_loop *Record_eq_gopurs_runtime_Value) gopurs_runtime.Value {
...
func Call_boundedLast(dictBounded_0_loop *Record_bottom_gopurs_runtime_Value_top_gopurs_runtime_Value) gopurs_runtime.Value {
