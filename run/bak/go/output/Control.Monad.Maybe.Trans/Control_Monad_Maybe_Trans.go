...
return gopurs_runtime.Any(Call_runMaybeT(gopurs_runtime.UnboxAny(v_0_box)))
})
	})
...
func Get_newtypeMaybeT() gopurs_runtime.Value {
	once_newtypeMaybeT.Do(func() {
		cache_newtypeMaybeT = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("Coercible0", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_monadTransMaybeT() gopurs_runtime.Value {
	once_monadTransMaybeT.Do(func() {
		cache_monadTransMaybeT = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("lift", gopurs_runtime.Func2(func(dictMonad_0 gopurs_runtime.Value, x_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Any(Call_mapMaybeT(func(inner_arg0 interface{}) interface{} {
...
var cache_mapMaybeT__func_func_interface____interface____interface____interface___1035271418 gopurs_runtime.Value
var once_mapMaybeT__func_func_interface____interface____interface____interface___1035271418 sync.Once
func Get_mapMaybeT__func_func_interface____interface____interface____interface___1035271418() gopurs_runtime.Value {
	once_mapMaybeT__func_func_interface____interface____interface____interface___1035271418.Do(func() {
		cache_mapMaybeT__func_func_interface____interface____interface____interface___1035271418 = gopurs_runtime.Func2(func(f_0_box gopurs_runtime.Value, v_1_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Any(Call_mapMaybeT__func_func_interface____interface____interface____interface___1035271418(func(inner_arg0 interface{}) interface{} {
return gopurs_runtime.UnboxAny(gopurs_runtime.Apply(f_0_box, gopurs_runtime.Any(inner_arg0)))
}, gopurs_runtime.UnboxAny(v_1_box)))
})
	})
	return cache_mapMaybeT__func_func_interface____interface____interface____interface___1035271418
}

var cache_mapMaybeT__func_func_interface____interface____interface____interface___2439405242 gopurs_runtime.Value
var once_mapMaybeT__func_func_interface____interface____interface____interface___2439405242 sync.Once
func Get_mapMaybeT__func_func_interface____interface____interface____interface___2439405242() gopurs_runtime.Value {
	once_mapMaybeT__func_func_interface____interface____interface____interface___2439405242.Do(func() {
		cache_mapMaybeT__func_func_interface____interface____interface____interface___2439405242 = gopurs_runtime.Func2(func(f_0_box gopurs_runtime.Value, v_1_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Any(Call_mapMaybeT__func_func_interface____interface____interface____interface___2439405242(func(inner_arg0 interface{}) interface{} {
return gopurs_runtime.UnboxAny(gopurs_runtime.Apply(f_0_box, gopurs_runtime.Any(inner_arg0)))
}, gopurs_runtime.UnboxAny(v_1_box)))
})
	})
	return cache_mapMaybeT__func_func_interface____interface____interface____interface___2439405242
}
...
return gopurs_runtime.Any(Call_functorMaybeT(dictFunctor_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monadMaybeT(dictMonad_0_box))
})
	})
...
return gopurs_runtime.Any(Call_bindMaybeT(dictMonad_0_box))
})
	})
...
return gopurs_runtime.Any(Call_applyMaybeT(dictMonad_0_box))
})
	})
...
return gopurs_runtime.Any(Call_applicativeMaybeT(dictMonad_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monadAskMaybeT(dictMonadAsk_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monadReaderMaybeT(dictMonadReader_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monadContMaybeT(dictMonadCont_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monadEffectMaybe(dictMonadEffect_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monadRecMaybeT(dictMonadRec_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monadStateMaybeT(dictMonadState_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monadTellMaybeT(dictMonadTell_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monadWriterMaybeT(dictMonadWriter_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monadThrowMaybeT(dictMonadThrow_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monadErrorMaybeT(dictMonadError_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monadSTMaybeT(dictMonadST_0_box))
})
	})
...
return gopurs_runtime.Any(Call_altMaybeT(dictMonad_0_box))
})
	})
...
return gopurs_runtime.Any(Call_plusMaybeT(dictMonad_0_box))
})
	})
...
return gopurs_runtime.Any(Call_alternativeMaybeT(dictMonad_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monadPlusMaybeT(dictMonad_0_box))
})
	})
...
func Call_runMaybeT(v_0_loop interface{}) interface{} {
var v_0 interface{} = v_0_loop
_ = v_0
return v_0
}

func Call_mapMaybeT(f_0_loop func(interface{}) interface{}, v_1_loop interface{}) interface{} {
...
func Call_mapMaybeT__func_func_interface____interface____interface____interface___1035271418(f_0_loop func(interface{}) interface{}, v_1_loop interface{}) interface{} {
var f_0 func(interface{}) interface{} = f_0_loop
_ = f_0
var v_1 interface{} = v_1_loop
_ = v_1
...
func Call_mapMaybeT__func_func_interface____interface____interface____interface___2439405242(f_0_loop func(interface{}) interface{}, v_1_loop interface{}) interface{} {
var f_0 func(interface{}) interface{} = f_0_loop
_ = f_0
var v_1 interface{} = v_1_loop
_ = v_1
...
func Call_functorMaybeT(dictFunctor_0_loop gopurs_runtime.Value) interface{} {
...
func Call_monadMaybeT(dictMonad_0_loop gopurs_runtime.Value) interface{} {
...
return gopurs_runtime.Any(Call_applicativeMaybeT(dictMonad_0))
}), gopurs_runtime.Func(func(_dollar__unused_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Any(Call_bindMaybeT(dictMonad_0))
})))
}

func Call_bindMaybeT(dictMonad_0_loop gopurs_runtime.Value) interface{} {
var dictMonad_0 gopurs_runtime.Value = dictMonad_0_loop
_ = dictMonad_0
...
return gopurs_runtime.Any(Call_applyMaybeT(dictMonad_0))
...
__t0 = gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonad_0, "Applicative0"), gopurs_runtime.Value{}), "pure"), gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: nil}))
goto end_branch_0
} else {
...
{
if (v1_3.Type == 9 && v1_3.IntVal == 930809136 && v1_3.UnsafePtr != nil) {
__t0 = gopurs_runtime.Apply(f_2, gopurs_runtime.Any((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(v1_3.UnsafePtr).V0))
goto end_branch_0
} else {
...
func Call_applyMaybeT(dictMonad_0_loop gopurs_runtime.Value) interface{} {
var dictMonad_0 gopurs_runtime.Value = dictMonad_0_loop
_ = dictMonad_0
...
__local_var_3_2 := gopurs_runtime.Any(Call_bindMaybeT(dictMonad_0))
_ = __local_var_3_2
...
return gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Any(Call_applicativeMaybeT(dictMonad_0)), "pure"), gopurs_runtime.Apply(f_prime_6, a_prime_7))
}))
}))
})))
}

func Call_applicativeMaybeT(dictMonad_0_loop gopurs_runtime.Value) interface{} {
var dictMonad_0 gopurs_runtime.Value = dictMonad_0_loop
_ = dictMonad_0
...
return gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonad_0, "Applicative0"), gopurs_runtime.Value{}), "pure"), gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]{gopurs_runtime.UnboxAny(x_1)})}))
})))
}
...
var dictMonad_0 gopurs_runtime.Value = dictMonad_0_loop
_ = dictMonad_0
__local_var_1_0 := gopurs_runtime.Any(Call_applyMaybeT(dictMonad_0))
_ = __local_var_1_0
...
func Call_monadAskMaybeT(dictMonadAsk_0_loop gopurs_runtime.Value) interface{} {
...
return gopurs_runtime.Any(Call_applicativeMaybeT(Monad0_1_0))
}), gopurs_runtime.Func(func(_dollar__unused_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Any(Call_bindMaybeT(Monad0_1_0))
}))
_ = monadMaybeT1_2_1
...
func Call_monadReaderMaybeT(dictMonadReader_0_loop gopurs_runtime.Value) interface{} {
var dictMonadReader_0 gopurs_runtime.Value = dictMonadReader_0_loop
_ = dictMonadReader_0
monadAskMaybeT1_1_0 := gopurs_runtime.Any(Call_monadAskMaybeT(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonadReader_0, "MonadAsk0"), gopurs_runtime.Value{})))
...
func Call_monadContMaybeT(dictMonadCont_0_loop gopurs_runtime.Value) interface{} {
...
_ = __local_var_1_0
monadMaybeT1_2_1 := gopurs_runtime.RecordDict2("Applicative0", "Bind1", gopurs_runtime.Func(func(_dollar__unused_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Any(Call_applicativeMaybeT(__local_var_1_0))
}), gopurs_runtime.Func(func(_dollar__unused_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Any(Call_bindMaybeT(__local_var_1_0))
}))
_ = monadMaybeT1_2_1
...
return gopurs_runtime.Apply(c_4, gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]{gopurs_runtime.UnboxAny(a_5)})}))
}))
}))
})))
}

func Call_monadEffectMaybe(dictMonadEffect_0_loop gopurs_runtime.Value) interface{} {
...
func Call_monadRecMaybeT(dictMonadRec_0_loop gopurs_runtime.Value) interface{} {
...
__t2 = gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 60402430, UnsafePtr: unsafe.Pointer(&pkg_Control_Monad_Rec_Class.Constructor_Done[gopurs_runtime.Value, gopurs_runtime.Value]{gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: nil}})})
goto end_branch_2
} else {
...
{
var __t_tag_4 gopurs_runtime.Value = gopurs_runtime.Any((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(m_prime_5.UnsafePtr).V0)
if (__t_tag_4.Type == 9 && __t_tag_4.IntVal == 525585346) {
__t3 = gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 525585346, UnsafePtr: unsafe.Pointer(&pkg_Control_Monad_Rec_Class.Constructor_Loop[gopurs_runtime.Value, gopurs_runtime.Value]{gopurs_runtime.UnboxAny(gopurs_runtime.Any((*pkg_Control_Monad_Rec_Class.Constructor_Loop[gopurs_runtime.Value, gopurs_runtime.Value])(gopurs_runtime.Any((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(m_prime_5.UnsafePtr).V0).UnsafePtr).V0))})})
goto end_branch_3
} else {
...
{
var __t_tag_5 gopurs_runtime.Value = gopurs_runtime.Any((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(m_prime_5.UnsafePtr).V0)
if (__t_tag_5.Type == 9 && __t_tag_5.IntVal == 60402430) {
__t3 = gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 60402430, UnsafePtr: unsafe.Pointer(&pkg_Control_Monad_Rec_Class.Constructor_Done[gopurs_runtime.Value, gopurs_runtime.Value]{gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]{gopurs_runtime.UnboxAny(gopurs_runtime.Any((*pkg_Control_Monad_Rec_Class.Constructor_Done[gopurs_runtime.Value, gopurs_runtime.Value])(gopurs_runtime.Any((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(m_prime_5.UnsafePtr).V0).UnsafePtr).V0))})}})})
goto end_branch_3
} else {
...
func Call_monadStateMaybeT(dictMonadState_0_loop gopurs_runtime.Value) interface{} {
...
func Call_monadTellMaybeT(dictMonadTell_0_loop gopurs_runtime.Value) interface{} {
...
_ = Semigroup0_2_1
monadMaybeT1_3_2 := gopurs_runtime.RecordDict2("Applicative0", "Bind1", gopurs_runtime.Func(func(_dollar__unused_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Any(Call_applicativeMaybeT(Monad1_1_0))
}), gopurs_runtime.Func(func(_dollar__unused_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Any(Call_bindMaybeT(Monad1_1_0))
}))
_ = monadMaybeT1_3_2
...
func Call_monadWriterMaybeT(dictMonadWriter_0_loop gopurs_runtime.Value) interface{} {
...
_ = Monoid0_5_4
monadTellMaybeT1_6_5 := gopurs_runtime.Any(Call_monadTellMaybeT(MonadTell1_1_0))
...
__t7 = gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value]{gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: nil}, gopurs_runtime.UnboxAny(Get_identity())})})
goto end_branch_7
} else {
...
{
if (a_8.Type == 9 && a_8.IntVal == 930809136 && a_8.UnsafePtr != nil) {
__t7 = gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value]{gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]{gopurs_runtime.UnboxAny(gopurs_runtime.Any((*pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(gopurs_runtime.Any((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(a_8.UnsafePtr).V0).UnsafePtr).V0))})}, gopurs_runtime.UnboxAny(gopurs_runtime.Any((*pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(gopurs_runtime.Any((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(a_8.UnsafePtr).V0).UnsafePtr).V1))})})
goto end_branch_7
} else {
...
func Call_monadThrowMaybeT(dictMonadThrow_0_loop gopurs_runtime.Value) interface{} {
...
func Call_monadErrorMaybeT(dictMonadError_0_loop gopurs_runtime.Value) interface{} {
var dictMonadError_0 gopurs_runtime.Value = dictMonadError_0_loop
_ = dictMonadError_0
monadThrowMaybeT1_1_0 := gopurs_runtime.Any(Call_monadThrowMaybeT(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonadError_0, "MonadThrow0"), gopurs_runtime.Value{})))
...
func Call_monadSTMaybeT(dictMonadST_0_loop gopurs_runtime.Value) interface{} {
...
var dictMonad_0 gopurs_runtime.Value = dictMonad_0_loop
_ = dictMonad_0
semigroupMaybeT1_1_0 := Call_semigroupMaybeT(dictMonad_0)
...
}), gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Any(Call_applicativeMaybeT(dictMonad_0)), "pure"), gopurs_runtime.RecordGet(dictMonoid_2, "mempty")))
})
}

func Call_altMaybeT(dictMonad_0_loop gopurs_runtime.Value) interface{} {
var dictMonad_0 gopurs_runtime.Value = dictMonad_0_loop
_ = dictMonad_0
...
func Call_plusMaybeT(dictMonad_0_loop gopurs_runtime.Value) interface{} {
var dictMonad_0 gopurs_runtime.Value = dictMonad_0_loop
_ = dictMonad_0
altMaybeT1_1_0 := gopurs_runtime.Any(Call_altMaybeT(dictMonad_0))
_ = altMaybeT1_1_0
...
}), gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonad_0, "Applicative0"), gopurs_runtime.Value{}), "pure"), gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: nil}))))
}

func Call_alternativeMaybeT(dictMonad_0_loop gopurs_runtime.Value) interface{} {
var dictMonad_0 gopurs_runtime.Value = dictMonad_0_loop
_ = dictMonad_0
applicativeMaybeT1_1_0 := gopurs_runtime.Any(Call_applicativeMaybeT(dictMonad_0))
_ = applicativeMaybeT1_1_0
plusMaybeT1_2_1 := gopurs_runtime.Any(Call_plusMaybeT(dictMonad_0))
_ = plusMaybeT1_2_1
...
func Call_monadPlusMaybeT(dictMonad_0_loop gopurs_runtime.Value) interface{} {
var dictMonad_0 gopurs_runtime.Value = dictMonad_0_loop
_ = dictMonad_0
...
_ = monadMaybeT1_1_0
alternativeMaybeT1_2_1 := gopurs_runtime.Any(Call_alternativeMaybeT(dictMonad_0))
