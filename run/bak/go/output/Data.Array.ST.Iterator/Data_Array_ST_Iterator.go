...
{
if (__local_var_3_2.Type == 9 && __local_var_3_2.IntVal == 42808261) {
...
{
if (__local_var_3_2.Type == 9 && __local_var_3_2.IntVal == 1354639136) {
...
{
if (mx_6_5.Type == 9 && mx_6_5.IntVal == 1354639136) && gopurs_runtime.Apply(p_0, (*pkg_Data_Maybe.Data_Data_Maybe_Just)(mx_6_5.UnsafePtr).V0).IntVal != 0 {
...
{
if (mx_4_4.Type == 9 && mx_4_4.IntVal == 1354639136) {
...
{
if (mx_4_4.Type == 9 && mx_4_4.IntVal == 42808261) {
