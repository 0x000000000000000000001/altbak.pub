...
var cache_pushWhile__gopurs_runtime_Value_2417809961 gopurs_runtime.Value
var once_pushWhile__gopurs_runtime_Value_2417809961 sync.Once
func Get_pushWhile__gopurs_runtime_Value_2417809961() gopurs_runtime.Value {
	once_pushWhile__gopurs_runtime_Value_2417809961.Do(func() {
		cache_pushWhile__gopurs_runtime_Value_2417809961 = gopurs_runtime.Func3(func(p_0_box gopurs_runtime.Value, iter_1_box gopurs_runtime.Value, array_2_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_pushWhile__gopurs_runtime_Value_2417809961(p_0_box, iter_1_box, array_2_box)
})
	})
	return cache_pushWhile__gopurs_runtime_Value_2417809961
}

var cache_pushWhile__gopurs_runtime_Value_968863402 gopurs_runtime.Value
var once_pushWhile__gopurs_runtime_Value_968863402 sync.Once
func Get_pushWhile__gopurs_runtime_Value_968863402() gopurs_runtime.Value {
	once_pushWhile__gopurs_runtime_Value_968863402.Do(func() {
		cache_pushWhile__gopurs_runtime_Value_968863402 = gopurs_runtime.Func3(func(p_0_box gopurs_runtime.Value, iter_1_box gopurs_runtime.Value, array_2_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_pushWhile__gopurs_runtime_Value_968863402(p_0_box, iter_1_box, array_2_box)
})
	})
	return cache_pushWhile__gopurs_runtime_Value_968863402
}
...
var cache_iterate__gopurs_runtime_Value_535536594 gopurs_runtime.Value
var once_iterate__gopurs_runtime_Value_535536594 sync.Once
func Get_iterate__gopurs_runtime_Value_535536594() gopurs_runtime.Value {
	once_iterate__gopurs_runtime_Value_535536594.Do(func() {
		cache_iterate__gopurs_runtime_Value_535536594 = gopurs_runtime.Func2(func(iter_0_box gopurs_runtime.Value, f_1_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_iterate__gopurs_runtime_Value_535536594(iter_0_box, f_1_box)
})
	})
	return cache_iterate__gopurs_runtime_Value_535536594
}
...
__local_var_5_2 := (*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(mx_4.UnsafePtr).V0
_ = __local_var_5_2
...
func Call_pushWhile__gopurs_runtime_Value_2417809961(p_0_loop gopurs_runtime.Value, iter_1_loop gopurs_runtime.Value, array_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
var p_0 gopurs_runtime.Value = p_0_loop
_ = p_0
var iter_1 gopurs_runtime.Value = iter_1_loop
_ = iter_1
...
func Call_pushWhile__gopurs_runtime_Value_968863402(p_0_loop gopurs_runtime.Value, iter_1_loop gopurs_runtime.Value, array_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
var p_0 gopurs_runtime.Value = p_0_loop
_ = p_0
var iter_1 gopurs_runtime.Value = iter_1_loop
_ = iter_1
...
__t1 = gopurs_runtime.Apply(f_1, (*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(mx_3.UnsafePtr).V0)
goto end_branch_1
} else {
...
func Call_iterate__gopurs_runtime_Value_535536594(iter_0_loop gopurs_runtime.Value, f_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var iter_0 gopurs_runtime.Value = iter_0_loop
_ = iter_0
var f_1 gopurs_runtime.Value = f_1_loop
_ = f_1
