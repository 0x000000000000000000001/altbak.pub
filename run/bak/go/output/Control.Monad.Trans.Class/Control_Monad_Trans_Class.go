...
return Call_lift((*Record_lift_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
	return cache_lift
}
...
func Call_lift(dict_0_loop *Record_lift_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_lift_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.lift
}
