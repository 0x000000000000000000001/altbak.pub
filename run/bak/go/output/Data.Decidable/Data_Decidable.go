...
return Call_lose((*Record_lose_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
	return cache_lose
}
...
return Call_lost((*Record_lose_gopurs_runtime_Value)(dictDecidable_0_box.UnsafePtr))
})
	})
	return cache_lost
}
...
return Call_decidableOp((*Record_mempty_gopurs_runtime_Value)(dictMonoid_0_box.UnsafePtr))
})
	})
...
func Call_lose(dict_0_loop *Record_lose_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_lose_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.lose
}

func Call_lost(dictDecidable_0_loop *Record_lose_gopurs_runtime_Value) gopurs_runtime.Value {
var dictDecidable_0 *Record_lose_gopurs_runtime_Value = dictDecidable_0_loop
_ = dictDecidable_0
return gopurs_runtime.Apply(dictDecidable_0.lose, Get_identity())
}

func Call_decidableOp(dictMonoid_0_loop *Record_mempty_gopurs_runtime_Value) gopurs_runtime.Value {
var dictMonoid_0 *Record_mempty_gopurs_runtime_Value = dictMonoid_0_loop
_ = dictMonoid_0
chooseOp_1_0 := gopurs_runtime.Apply(pkg_Data_Decide.Get_chooseOp(), gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictMonoid_0)}, "Semigroup0_NOT_FOUND"), gopurs_runtime.Value{}))
_ = chooseOp_1_0
divisibleOp_2_1 := gopurs_runtime.Apply(pkg_Data_Divisible.Get_divisibleOp(), gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictMonoid_0)})
_ = divisibleOp_2_1
