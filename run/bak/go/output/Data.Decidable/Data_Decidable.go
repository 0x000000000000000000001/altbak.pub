...
var cache_lose__func_gopurs_runtime_Value__func_interface____gopurs_runtime_Value__interface___1539196098 gopurs_runtime.Value
var once_lose__func_gopurs_runtime_Value__func_interface____gopurs_runtime_Value__interface___1539196098 sync.Once
func Get_lose__func_gopurs_runtime_Value__func_interface____gopurs_runtime_Value__interface___1539196098() gopurs_runtime.Value {
	once_lose__func_gopurs_runtime_Value__func_interface____gopurs_runtime_Value__interface___1539196098.Do(func() {
		cache_lose__func_gopurs_runtime_Value__func_interface____gopurs_runtime_Value__interface___1539196098 = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_lose__func_gopurs_runtime_Value__func_interface____gopurs_runtime_Value__interface___1539196098(dict_0_box)
})
	})
	return cache_lose__func_gopurs_runtime_Value__func_interface____gopurs_runtime_Value__interface___1539196098
}
...
return gopurs_runtime.Any(Call_lost(dictDecidable_0_box))
})
	})
	return cache_lost
}
...
func Get_decidablePredicate() gopurs_runtime.Value {
	once_decidablePredicate.Do(func() {
		cache_decidablePredicate = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict3("Decide0", "Divisible1", "lose", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = v_3
v_3_loop = gopurs_runtime.UnboxAny(v_3)
continue spin_2_0
return gopurs_runtime.Value{}
}
}()
})
return gopurs_runtime.Apply(gopurs_runtime.Any(spin_2_0), gopurs_runtime.Apply(f_0, a_1))
}))))
	})
...
return gopurs_runtime.Any(Call_decidableOp(dictMonoid_0_box))
})
	})
...
func Get_decidableEquivalence() gopurs_runtime.Value {
	once_decidableEquivalence.Do(func() {
		cache_decidableEquivalence = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict3("Decide0", "Divisible1", "lose", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_decidableComparison() gopurs_runtime.Value {
	once_decidableComparison.Do(func() {
		cache_decidableComparison = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict3("Decide0", "Divisible1", "lose", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply(gopurs_runtime.Any(spin_3_0), gopurs_runtime.Apply(f_0, a_1))
}))))
	})
...
func Call_lose__func_gopurs_runtime_Value__func_interface____gopurs_runtime_Value__interface___1539196098(dict_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dict_0 gopurs_runtime.Value = dict_0_loop
_ = dict_0
return gopurs_runtime.RecordGet(dict_0, "lose")
}

func Call_lost(dictDecidable_0_loop gopurs_runtime.Value) interface{} {
var dictDecidable_0 gopurs_runtime.Value = dictDecidable_0_loop
_ = dictDecidable_0
return gopurs_runtime.UnboxAny(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictDecidable_0, "lose"), Get_identity()))
}

func Call_decidableOp(dictMonoid_0_loop gopurs_runtime.Value) interface{} {
...
_ = divisibleOp_2_1
return gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict3("Decide0", "Divisible1", "lose", gopurs_runtime.Func(func(_dollar__unused_3 gopurs_runtime.Value) gopurs_runtime.Value {
return chooseOp_1_0
...
return gopurs_runtime.Apply(gopurs_runtime.Any(spin_5_2), gopurs_runtime.Apply(f_3, a_4))
})))
}
