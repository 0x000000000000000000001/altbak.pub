...
var cache_right__gopurs_runtime_Value_1193983057 gopurs_runtime.Value
var once_right__gopurs_runtime_Value_1193983057 sync.Once
func Get_right__gopurs_runtime_Value_1193983057() gopurs_runtime.Value {
	once_right__gopurs_runtime_Value_1193983057.Do(func() {
		cache_right__gopurs_runtime_Value_1193983057 = gopurs_runtime.Func(func(ga_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_right__gopurs_runtime_Value_1193983057(ga_0_box)
})
	})
	return cache_right__gopurs_runtime_Value_1193983057
}
...
var cache_left__gopurs_runtime_Value_786465523 gopurs_runtime.Value
var once_left__gopurs_runtime_Value_786465523 sync.Once
func Get_left__gopurs_runtime_Value_786465523() gopurs_runtime.Value {
	once_left__gopurs_runtime_Value_786465523.Do(func() {
		cache_left__gopurs_runtime_Value_786465523 = gopurs_runtime.Func(func(fa_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_left__gopurs_runtime_Value_786465523(fa_0_box)
})
	})
	return cache_left__gopurs_runtime_Value_786465523
}

var cache_left__gopurs_runtime_Value_4018477375 gopurs_runtime.Value
var once_left__gopurs_runtime_Value_4018477375 sync.Once
func Get_left__gopurs_runtime_Value_4018477375() gopurs_runtime.Value {
	once_left__gopurs_runtime_Value_4018477375.Do(func() {
		cache_left__gopurs_runtime_Value_4018477375 = gopurs_runtime.Func(func(fa_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_left__gopurs_runtime_Value_4018477375(fa_0_box)
})
	})
	return cache_left__gopurs_runtime_Value_4018477375
}
...
var cache_coproduct__gopurs_runtime_Value_413515331 gopurs_runtime.Value
var once_coproduct__gopurs_runtime_Value_413515331 sync.Once
func Get_coproduct__gopurs_runtime_Value_413515331() gopurs_runtime.Value {
	once_coproduct__gopurs_runtime_Value_413515331.Do(func() {
		cache_coproduct__gopurs_runtime_Value_413515331 = gopurs_runtime.Func3(func(v_0_box gopurs_runtime.Value, v1_1_box gopurs_runtime.Value, v2_2_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_coproduct__gopurs_runtime_Value_413515331(v_0_box, v1_1_box, v2_2_box)
})
	})
	return cache_coproduct__gopurs_runtime_Value_413515331
}
...
func Call_right__gopurs_runtime_Value_1193983057(ga_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
var ga_0 gopurs_runtime.Value = ga_0_loop
_ = ga_0
return gopurs_runtime.Value{Type: 9, IntVal: 2465973597, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value]{1, ga_0})}
}
...
func Call_left__gopurs_runtime_Value_786465523(fa_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
var fa_0 gopurs_runtime.Value = fa_0_loop
_ = fa_0
return gopurs_runtime.Value{Type: 9, IntVal: 3711209382, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value]{1, fa_0})}
}

func Call_left__gopurs_runtime_Value_4018477375(fa_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
var fa_0 gopurs_runtime.Value = fa_0_loop
_ = fa_0
return gopurs_runtime.Value{Type: 9, IntVal: 3711209382, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value]{1, fa_0})}
}
...
func Call_coproduct__gopurs_runtime_Value_413515331(v_0_loop gopurs_runtime.Value, v1_1_loop gopurs_runtime.Value, v2_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
var v_0 gopurs_runtime.Value = v_0_loop
_ = v_0
var v1_1 gopurs_runtime.Value = v1_1_loop
_ = v1_1
