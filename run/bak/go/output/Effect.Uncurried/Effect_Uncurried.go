...
return gopurs_runtime.Apply3(pkg_Effect.Get_lift2(), ((*gopurs_runtime.RecordData1)(dictSemigroup_0.UnsafePtr)).V0, gopurs_runtime.Func(func(_ gopurs_runtime.Value) gopurs_runtime.Value {
