...
return Call_pure((*Record_pure_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
	return cache_pure
}
...
return Call_unless((*Record_pure_gopurs_runtime_Value)(dictApplicative_0_box.UnsafePtr), (v_1_box.IntVal) != (0), v1_2_box)
})
	})
	return cache_unless
}
...
return Call_when((*Record_pure_gopurs_runtime_Value)(dictApplicative_0_box.UnsafePtr), (v_1_box.IntVal) != (0), v1_2_box)
})
	})
	return cache_when
}
...
return Call_liftA1((*Record_pure_gopurs_runtime_Value)(dictApplicative_0_box.UnsafePtr), f_1_box, a_2_box)
})
	})
	return cache_liftA1
}
...
func Call_pure(dict_0_loop *Record_pure_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_pure_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.pure
}

func Call_unless(dictApplicative_0_loop *Record_pure_gopurs_runtime_Value, v_1_loop bool, v1_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
...
{
if v_1 {
__t0 = gopurs_runtime.Apply(dictApplicative_0.pure, pkg_Data_Unit.Get_unit())
goto end_branch_0
} else {
...
func Call_when(dictApplicative_0_loop *Record_pure_gopurs_runtime_Value, v_1_loop bool, v1_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictApplicative_0 *Record_pure_gopurs_runtime_Value = dictApplicative_0_loop
_ = dictApplicative_0
var v_1 bool = v_1_loop
_ = v_1
...
func Call_liftA1(dictApplicative_0_loop *Record_pure_gopurs_runtime_Value, f_1_loop gopurs_runtime.Value, a_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictApplicative_0 *Record_pure_gopurs_runtime_Value = dictApplicative_0_loop
_ = dictApplicative_0
...
_ = a_2
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictApplicative_0)}, "Apply0_NOT_FOUND"), gopurs_runtime.Value{}), "apply"), gopurs_runtime.Apply(dictApplicative_0.pure, f_1), a_2)
}
