...
_ = dict_0
return gopurs_runtime.RecordGet(dict_0_loop, "pure")
}()
})
	})
	return pure
...
func Get_unless() gopurs_runtime.Value {
	once_unless.Do(func() {
		unless = gopurs_runtime.Func3(Call_unless)
	})
	return unless
}
...
func Get_when() gopurs_runtime.Value {
	once_when.Do(func() {
		when = gopurs_runtime.Func3(Call_when)
	})
	return when
}
...
func Get_liftA1() gopurs_runtime.Value {
	once_liftA1.Do(func() {
		liftA1 = gopurs_runtime.Func3(Call_liftA1)
	})
	return liftA1
}
...
{
if v_1_loop.IntVal != 0 {
__t0 = gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictApplicative_0_loop, "pure"), pkg_Data_Unit.Get_unit())
goto end_branch_0
} else {
...
_ = a_2
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictApplicative_0_loop, "Apply0"), gopurs_runtime.Value{}), "apply"), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictApplicative_0_loop, "pure"), f_1_loop), a_2_loop)
}
