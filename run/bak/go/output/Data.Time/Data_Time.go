...
return gopurs_runtime.Str(Call_append__493084344(gopurs_runtime.Str("(Time "), gopurs_runtime.Str(Call_append__493084344(gopurs_runtime.Str(Call_show__1488465650(gopurs_runtime.Int((*Constructor_Time)(v_0.UnsafePtr).V0)).StrVal()), gopurs_runtime.Str(Call_append__493084344(gopurs_runtime.Str(" "), gopurs_runtime.Str(Call_append__493084344(gopurs_runtime.Str(Call_show__1488465650(gopurs_runtime.Int((*Constructor_Time)(v_0.UnsafePtr).V1)).StrVal()), gopurs_runtime.Str(Call_append__493084344(gopurs_runtime.Str(" "), gopurs_runtime.Str(Call_append__493084344(gopurs_runtime.Str(Call_show__1488465650(gopurs_runtime.Int((*Constructor_Time)(v_0.UnsafePtr).V2)).StrVal()), gopurs_runtime.Str(Call_append__493084344(gopurs_runtime.Str(" "), gopurs_runtime.Str(Call_append__493084344(gopurs_runtime.Str(Call_show__1488465650(gopurs_runtime.Int((*Constructor_Time)(v_0.UnsafePtr).V3)).StrVal()), gopurs_runtime.Str(")")).StrVal())).StrVal())).StrVal())).StrVal())).StrVal())).StrVal())).StrVal())).StrVal())
}))
	})
...
return gopurs_runtime.Bool((Call_conj__3676519832(gopurs_runtime.Bool((Call_conj__3676519832(gopurs_runtime.Bool((Call_conj__3676519832(gopurs_runtime.Bool((Call_eq__2843686287(gopurs_runtime.Int((*Constructor_Time)(x_0.UnsafePtr).V0), gopurs_runtime.Int((*Constructor_Time)(y_1.UnsafePtr).V0)).IntVal) != (0)), gopurs_runtime.Bool((Call_eq__2843686287(gopurs_runtime.Int((*Constructor_Time)(x_0.UnsafePtr).V1), gopurs_runtime.Int((*Constructor_Time)(y_1.UnsafePtr).V1)).IntVal) != (0))).IntVal) != (0)), gopurs_runtime.Bool((Call_eq__2843686287(gopurs_runtime.Int((*Constructor_Time)(x_0.UnsafePtr).V2), gopurs_runtime.Int((*Constructor_Time)(y_1.UnsafePtr).V2)).IntVal) != (0))).IntVal) != (0)), gopurs_runtime.Bool((Call_eq__2843686287(gopurs_runtime.Int((*Constructor_Time)(x_0.UnsafePtr).V3), gopurs_runtime.Int((*Constructor_Time)(y_1.UnsafePtr).V3)).IntVal) != (0))).IntVal) != (0))
})
}))
	})
	return cache_eqTime
...
return gopurs_runtime.Func(func(y_1 gopurs_runtime.Value) gopurs_runtime.Value {
v_2_0 := Call_compare__372254389(gopurs_runtime.Int((*Constructor_Time)(x_0.UnsafePtr).V0), gopurs_runtime.Int((*Constructor_Time)(y_1.UnsafePtr).V0))
_ = v_2_0
var __t5 uint32
{
...
{
v1_3_1 := Call_compare__372254389(gopurs_runtime.Int((*Constructor_Time)(x_0.UnsafePtr).V1), gopurs_runtime.Int((*Constructor_Time)(y_1.UnsafePtr).V1))
_ = v1_3_1
var __t4 uint32
{
...
{
v2_4_2 := Call_compare__372254389(gopurs_runtime.Int((*Constructor_Time)(x_0.UnsafePtr).V2), gopurs_runtime.Int((*Constructor_Time)(y_1.UnsafePtr).V2))
_ = v2_4_2
var __t3 uint32
{
...
{
__t3 = uint32(Call_compare__372254389(gopurs_runtime.Int((*Constructor_Time)(x_0.UnsafePtr).V3), gopurs_runtime.Int((*Constructor_Time)(y_1.UnsafePtr).V3)).IntVal)
}
end_branch_3:
__t4 = __t3
}
...
var cache_over__2540313282 gopurs_runtime.Value
var once_over__2540313282 sync.Once
func Get_over__2540313282() gopurs_runtime.Value {
	once_over__2540313282.Do(func() {
		cache_over__2540313282 = gopurs_runtime.Func3(func(_dollar__unused_0_box gopurs_runtime.Value, _dollar__unused_1_box gopurs_runtime.Value, v_2_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_over__2540313282(gopurs_runtime.CoerceToStruct[pkg_Data_Newtype.Constructor_Newtype[gopurs_runtime.Value, gopurs_runtime.Value]](_dollar__unused_0_box), gopurs_runtime.CoerceToStruct[pkg_Data_Newtype.Constructor_Newtype[gopurs_runtime.Value, gopurs_runtime.Value]](_dollar__unused_1_box), v_2_box)
})
	})
	return cache_over__2540313282
}
...
var cache_over__440224418 gopurs_runtime.Value
var once_over__440224418 sync.Once
func Get_over__440224418() gopurs_runtime.Value {
	once_over__440224418.Do(func() {
		cache_over__440224418 = gopurs_runtime.Func2(func(_dollar__unused_0_box gopurs_runtime.Value, v_1_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_over__440224418(_dollar__unused_0_box, v_1_box)
})
	})
	return cache_over__440224418
}
...
var cache_mul__101133084 gopurs_runtime.Value
var once_mul__101133084 sync.Once
func Get_mul__101133084() gopurs_runtime.Value {
	once_mul__101133084.Do(func() {
		cache_mul__101133084 = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_mul__101133084(gopurs_runtime.CoerceToStruct[pkg_Data_Semiring.Constructor_Semiring[float64]](dict_0_box))
})
	})
	return cache_mul__101133084
}
...
func Get_mul__137136408() gopurs_runtime.Value {
	once_mul__137136408.Do(func() {
		cache_mul__137136408 = gopurs_runtime.Func2(func(__eta0_0_box gopurs_runtime.Value, __eta1_1_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_mul__137136408(__eta0_0_box, __eta1_1_box)
})
	})
...
func Get_fromDuration__4195558286() gopurs_runtime.Value {
	once_fromDuration__4195558286.Do(func() {
		cache_fromDuration__4195558286 = gopurs_runtime.Func(func(__eta0_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_fromDuration__4195558286(__eta0_0_box)
})
	})
...
_ = v_0
hours_1_0 := gopurs_runtime.Apply(pkg_Data_Number.Get_floor(), gopurs_runtime.Float(Call_div__1002719800(gopurs_runtime.Float(v_0), gopurs_runtime.Float(3600000.0)).FloatVal())).FloatVal()
_ = hours_1_0
minutes_2_1 := gopurs_runtime.Apply(pkg_Data_Number.Get_floor(), gopurs_runtime.Float(Call_div__1002719800(gopurs_runtime.Float(Call_sub__1135378904(gopurs_runtime.Float(v_0), gopurs_runtime.Float(Call_mul__137136408(gopurs_runtime.Float(hours_1_0), gopurs_runtime.Float(3600000.0)).FloatVal())).FloatVal()), gopurs_runtime.Float(60000.0)).FloatVal())).FloatVal()
_ = minutes_2_1
seconds_3_2 := gopurs_runtime.Apply(pkg_Data_Number.Get_floor(), gopurs_runtime.Float(Call_div__1002719800(gopurs_runtime.Float(Call_sub__1135378904(gopurs_runtime.Float(v_0), gopurs_runtime.Float(Call_add__137136408(gopurs_runtime.Float(Call_mul__137136408(gopurs_runtime.Float(hours_1_0), gopurs_runtime.Float(3600000.0)).FloatVal()), gopurs_runtime.Float(Call_mul__137136408(gopurs_runtime.Float(minutes_2_1), gopurs_runtime.Float(60000.0)).FloatVal())).FloatVal())).FloatVal()), gopurs_runtime.Float(1000.0)).FloatVal())).FloatVal()
_ = seconds_3_2
...
}), gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[*Constructor_Time]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Call_apply__3882563466(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Call_apply__3867059818(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Call_apply__3489442218(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Call_map__2165919164(Get_Time(), gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[int64]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Call_toEnum__2099864294(gopurs_runtime.Apply(pkg_Data_Int.Get_unsafeClamp(), gopurs_runtime.Apply(pkg_Data_Number.Get_floor(), gopurs_runtime.Float(hours_1_0))).IntVal))})))}), gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[int64]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Call_toEnum__2099864294(gopurs_runtime.Apply(pkg_Data_Int.Get_unsafeClamp(), gopurs_runtime.Apply(pkg_Data_Number.Get_floor(), gopurs_runtime.Float(minutes_2_1))).IntVal))})))}), gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[int64]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Call_toEnum__2099864294(gopurs_runtime.Apply(pkg_Data_Int.Get_unsafeClamp(), gopurs_runtime.Apply(pkg_Data_Number.Get_floor(), gopurs_runtime.Float(seconds_3_2))).IntVal))})))}), gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[int64]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Call_toEnum__2099864294(gopurs_runtime.Apply(pkg_Data_Int.Get_unsafeClamp(), gopurs_runtime.Apply(pkg_Data_Number.Get_floor(), gopurs_runtime.Float(Call_sub__1135378904(gopurs_runtime.Float(v_0), gopurs_runtime.Float(Call_add__137136408(gopurs_runtime.Float(Call_add__137136408(gopurs_runtime.Float(Call_mul__137136408(gopurs_runtime.Float(hours_1_0), gopurs_runtime.Float(3600000.0)).FloatVal()), gopurs_runtime.Float(Call_mul__137136408(gopurs_runtime.Float(minutes_2_1), gopurs_runtime.Float(60000.0)).FloatVal())).FloatVal()), gopurs_runtime.Float(Call_mul__137136408(gopurs_runtime.Float(seconds_3_2), gopurs_runtime.Float(1000.0)).FloatVal())).FloatVal())).FloatVal()))).IntVal))})))}))}))
}
...
_ = t_0
return Call_add__137136408(gopurs_runtime.Float(Call_add__137136408(gopurs_runtime.Float(Call_add__137136408(gopurs_runtime.Float(Call_mul__137136408(gopurs_runtime.Float(3600000.0), gopurs_runtime.Float(gopurs_runtime.Apply(pkg_Data_Int.Get_toNumber(), gopurs_runtime.Int(gopurs_runtime.Int(Call_fromEnum__3599151655((*Constructor_Time)(gopurs_runtime.Value{Type: 9, IntVal: 922918650, UnsafePtr: unsafe.Pointer(t_0)}.UnsafePtr).V0)).IntVal)).FloatVal())).FloatVal()), gopurs_runtime.Float(Call_mul__137136408(gopurs_runtime.Float(60000.0), gopurs_runtime.Float(gopurs_runtime.Apply(pkg_Data_Int.Get_toNumber(), gopurs_runtime.Int(gopurs_runtime.Int(Call_fromEnum__3599151655((*Constructor_Time)(gopurs_runtime.Value{Type: 9, IntVal: 922918650, UnsafePtr: unsafe.Pointer(t_0)}.UnsafePtr).V1)).IntVal)).FloatVal())).FloatVal())).FloatVal()), gopurs_runtime.Float(Call_mul__137136408(gopurs_runtime.Float(1000.0), gopurs_runtime.Float(gopurs_runtime.Apply(pkg_Data_Int.Get_toNumber(), gopurs_runtime.Int(gopurs_runtime.Int(Call_fromEnum__3599151655((*Constructor_Time)(gopurs_runtime.Value{Type: 9, IntVal: 922918650, UnsafePtr: unsafe.Pointer(t_0)}.UnsafePtr).V2)).IntVal)).FloatVal())).FloatVal())).FloatVal()), gopurs_runtime.Float(gopurs_runtime.Apply(pkg_Data_Int.Get_toNumber(), gopurs_runtime.Int(gopurs_runtime.Int(Call_fromEnum__3599151655((*Constructor_Time)(gopurs_runtime.Value{Type: 9, IntVal: 922918650, UnsafePtr: unsafe.Pointer(t_0)}.UnsafePtr).V3)).IntVal)).FloatVal())).FloatVal()
}
...
_ = t2_2
return gopurs_runtime.Apply(dictDuration_0.V1, gopurs_runtime.Float(gopurs_runtime.Float(Call_append__3678571768(gopurs_runtime.Float(Call_timeToMillis(t1_1)).FloatVal(), Call_negateDuration__4195558286(gopurs_runtime.Float(gopurs_runtime.Float(Call_timeToMillis(t2_2)).FloatVal())).FloatVal())).FloatVal()))
}
...
_ = d_prime_3_0
wholeDays_4_1 := gopurs_runtime.Apply(pkg_Data_Number.Get_floor(), gopurs_runtime.Float(Call_div__1002719800(gopurs_runtime.Float(Call_unwrap__777744115(gopurs_runtime.Float(d_prime_3_0.FloatVal())).FloatVal()), gopurs_runtime.Float(86400000.0)).FloatVal())).FloatVal()
_ = wholeDays_4_1
msAdjusted_5_2 := gopurs_runtime.Float(Call_append__3678571768(gopurs_runtime.Float(Call_timeToMillis(t_2)).FloatVal(), gopurs_runtime.Float(Call_append__3678571768(d_prime_3_0.FloatVal(), Call_negateDuration__4195558286(gopurs_runtime.Float(Call_fromDuration__4195558286(gopurs_runtime.Float(wholeDays_4_1)).FloatVal())).FloatVal())).FloatVal()))
_ = msAdjusted_5_2
var __t5 float64
{
...
wrap_6_3 := __t5
_ = wrap_6_3
return gopurs_runtime.CoerceToStruct[pkg_Data_Tuple.Constructor_Tuple[float64, *Constructor_Time]](gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value]{1, gopurs_runtime.Float(gopurs_runtime.Float(Call_append__3678571768(wholeDays_4_1, wrap_6_3)).FloatVal()), gopurs_runtime.Value{Type: 9, IntVal: 922918650, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Time](gopurs_runtime.Value{Type: 9, IntVal: 922918650, UnsafePtr: unsafe.Pointer(Call_millisToTime(gopurs_runtime.Float(Call_append__3678571768(msAdjusted_5_2.FloatVal(), Call_mul__137136408(gopurs_runtime.Float(86400000.0), gopurs_runtime.Float(Call_negate__2151342916(gopurs_runtime.Float(wrap_6_3)).FloatVal())).FloatVal())).FloatVal()))}))}})})
}
...
func Call_apply__3882563466(v_0_loop *pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value], v1_1_loop *pkg_Data_Maybe.Constructor_Just[int64]) *pkg_Data_Maybe.Constructor_Just[*Constructor_Time] {
...
end_branch_0:
return gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[*Constructor_Time]](__t0)
}
...
func Call_over__2540313282(_dollar__unused_0_loop *pkg_Data_Newtype.Constructor_Newtype[gopurs_runtime.Value, gopurs_runtime.Value], _dollar__unused_1_loop *pkg_Data_Newtype.Constructor_Newtype[gopurs_runtime.Value, gopurs_runtime.Value], v_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_over__440224418(_dollar__unused_0_loop gopurs_runtime.Value, v_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var _dollar__unused_0 gopurs_runtime.Value = _dollar__unused_0_loop
_ = _dollar__unused_0
...
func Call_mul__101133084(dict_0_loop *pkg_Data_Semiring.Constructor_Semiring[float64]) gopurs_runtime.Value {
var dict_0 *pkg_Data_Semiring.Constructor_Semiring[float64] = dict_0_loop
_ = dict_0
return dict_0.V1
}

func Call_mul__137136408(__eta0_0_loop gopurs_runtime.Value, __eta1_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var __eta0_0 gopurs_runtime.Value = __eta0_0_loop
_ = __eta0_0
var __eta1_1 gopurs_runtime.Value = __eta1_1_loop
_ = __eta1_1
...
func Call_fromDuration__4195558286(__eta0_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
var __eta0_0 gopurs_runtime.Value = __eta0_0_loop
_ = __eta0_0
