...
func Get_describe() gopurs_runtime.Value {
	once_describe.Do(func() {
		cache_describe = gopurs_runtime.Apply(pkg_Effect_Console.Get_log(), gopurs_runtime.Str("Ackermann (3, 4):"))
	})
...
return gopurs_runtime.Apply(pkg_Effect_Console.Get_log(), gopurs_runtime.Str(gopurs_runtime.Apply(gopurs_runtime.RecordGet(pkg_Data_Show.Get_showInt(), "show"), gopurs_runtime.Int(gopurs_runtime.Int(Call_ackermann(dummy_0.IntVal, 4)).IntVal)).StrVal()))
}))
	})
	return cache_act
}
...
{
if (v_0) == (0) {
__t0 = gopurs_runtime.Apply2(Get_add__560788792(), gopurs_runtime.Int(v1_1), gopurs_runtime.Int(1)).IntVal
goto end_branch_0
} else {
...
{
v_0_loop = gopurs_runtime.Apply2(Get_sub__1043827704(), gopurs_runtime.Int(v_0), gopurs_runtime.Int(1)).IntVal
v1_1_loop = gopurs_runtime.Int(Call_ackermann(v_0, gopurs_runtime.Apply2(Get_sub__1043827704(), gopurs_runtime.Int(v1_1), gopurs_runtime.Int(1)).IntVal)).IntVal
continue ackermann
__t0 = gopurs_runtime.Value{}.IntVal
}
end_branch_0:
