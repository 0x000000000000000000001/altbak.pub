...
{
if (v_0) == (0) {
__t0 = Call_add__560788792(gopurs_runtime.Int(v1_1), gopurs_runtime.Int(1)).IntVal
goto end_branch_0
} else {
...
{
v_0_loop = Call_sub__1043827704(gopurs_runtime.Int(v_0), gopurs_runtime.Int(1)).IntVal
v1_1_loop = gopurs_runtime.Int(Call_ackermann(v_0, Call_sub__1043827704(gopurs_runtime.Int(v1_1), gopurs_runtime.Int(1)).IntVal)).IntVal
continue ackermann
__t0 = gopurs_runtime.Value{}.IntVal
}
end_branch_0:
