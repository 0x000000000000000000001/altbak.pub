...
__t0 = gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str("(StartEnd "), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Apply(((*gopurs_runtime.RecordData1)(dictShow1_1.UnsafePtr)).V0, (*Data_Data_Interval_StartEnd)(v_2.UnsafePtr).V0), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str(" "), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Apply(((*gopurs_runtime.RecordData1)(dictShow1_1.UnsafePtr)).V0, (*Data_Data_Interval_StartEnd)(v_2.UnsafePtr).V1), gopurs_runtime.Str(")")))))
goto end_branch_0
} else {
...
__t0 = gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str("(DurationEnd "), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Apply(((*gopurs_runtime.RecordData1)(dictShow_0.UnsafePtr)).V0, (*Data_Data_Interval_DurationEnd)(v_2.UnsafePtr).V0), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str(" "), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Apply(((*gopurs_runtime.RecordData1)(dictShow1_1.UnsafePtr)).V0, (*Data_Data_Interval_DurationEnd)(v_2.UnsafePtr).V1), gopurs_runtime.Str(")")))))
goto end_branch_0
} else {
...
__t0 = gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str("(StartDuration "), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Apply(((*gopurs_runtime.RecordData1)(dictShow1_1.UnsafePtr)).V0, (*Data_Data_Interval_StartDuration)(v_2.UnsafePtr).V0), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str(" "), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Apply(((*gopurs_runtime.RecordData1)(dictShow_0.UnsafePtr)).V0, (*Data_Data_Interval_StartDuration)(v_2.UnsafePtr).V1), gopurs_runtime.Str(")")))))
goto end_branch_0
} else {
...
_ = v_2
return gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictFunctor_0.UnsafePtr)).V0, gopurs_runtime.Apply(Get_RecurringInterval(), (*Data_Data_Interval_RecurringInterval)(v_2.UnsafePtr).V0), gopurs_runtime.Apply(f_1, (*Data_Data_Interval_RecurringInterval)(v_2.UnsafePtr).V1))
}
...
__t0 = gopurs_runtime.Bool(((y_3.Type == 9 && y_3.IntVal == 237113226)) && ((gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_HeytingAlgebra.Get_heytingAlgebraBoolean(), "conj"), gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictEq1_1.UnsafePtr)).V0, (*Data_Data_Interval_StartEnd)(x_2.UnsafePtr).V0, (*Data_Data_Interval_StartEnd)(y_3.UnsafePtr).V0), gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictEq1_1.UnsafePtr)).V0, (*Data_Data_Interval_StartEnd)(x_2.UnsafePtr).V1, (*Data_Data_Interval_StartEnd)(y_3.UnsafePtr).V1)).IntVal) != (0)))
goto end_branch_0
} else {
...
__t0 = gopurs_runtime.Bool(((y_3.Type == 9 && y_3.IntVal == 1992629780)) && ((gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_HeytingAlgebra.Get_heytingAlgebraBoolean(), "conj"), gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictEq_0.UnsafePtr)).V0, (*Data_Data_Interval_DurationEnd)(x_2.UnsafePtr).V0, (*Data_Data_Interval_DurationEnd)(y_3.UnsafePtr).V0), gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictEq1_1.UnsafePtr)).V0, (*Data_Data_Interval_DurationEnd)(x_2.UnsafePtr).V1, (*Data_Data_Interval_DurationEnd)(y_3.UnsafePtr).V1)).IntVal) != (0)))
goto end_branch_0
} else {
...
__t0 = gopurs_runtime.Bool(((y_3.Type == 9 && y_3.IntVal == 2020675835)) && ((gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_HeytingAlgebra.Get_heytingAlgebraBoolean(), "conj"), gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictEq1_1.UnsafePtr)).V0, (*Data_Data_Interval_StartDuration)(x_2.UnsafePtr).V0, (*Data_Data_Interval_StartDuration)(y_3.UnsafePtr).V0), gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictEq_0.UnsafePtr)).V0, (*Data_Data_Interval_StartDuration)(x_2.UnsafePtr).V1, (*Data_Data_Interval_StartDuration)(y_3.UnsafePtr).V1)).IntVal) != (0)))
goto end_branch_0
} else {
...
{
__t0 = gopurs_runtime.Bool(((x_2.Type == 9 && x_2.IntVal == 2281256335)) && (((y_3.Type == 9 && y_3.IntVal == 2281256335)) && ((gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictEq_0.UnsafePtr)).V0, (*Data_Data_Interval_DurationOnly)(x_2.UnsafePtr).V0, (*Data_Data_Interval_DurationOnly)(y_3.UnsafePtr).V0).IntVal) != (0))))
}
end_branch_0:
return __t0
}))
...
v_6_7 := gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictOrd_0.UnsafePtr)).V0, (*Data_Data_Interval_DurationEnd)(x_4.UnsafePtr).V0, (*Data_Data_Interval_DurationEnd)(y_5.UnsafePtr).V0)
_ = v_6_7
...
{
__t11 = gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictOrd_0.UnsafePtr)).V0, (*Data_Data_Interval_StartDuration)(x_4.UnsafePtr).V1, (*Data_Data_Interval_StartDuration)(y_5.UnsafePtr).V1)
}
end_branch_11:
__t9 = __t11
goto end_branch_9
...
__t2 = gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictOrd_0.UnsafePtr)).V0, (*Data_Data_Interval_DurationOnly)(x_4.UnsafePtr).V0, (*Data_Data_Interval_DurationOnly)(y_5.UnsafePtr).V0)
goto end_branch_2
} else {
