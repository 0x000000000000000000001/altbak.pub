...
return gopurs_runtime.Any(Call_genDateTime(dictMonadGen_0_box))
})
	})
	return cache_genDateTime
}

func Call_genDateTime(dictMonadGen_0_loop gopurs_runtime.Value) interface{} {
...
_ = Apply0_1_0
return gopurs_runtime.UnboxAny(gopurs_runtime.Apply2(gopurs_runtime.RecordGet(Apply0_1_0, "apply"), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(Apply0_1_0, "Functor0"), gopurs_runtime.Value{}), "map"), pkg_Data_DateTime.Get_DateTime(), gopurs_runtime.Apply(pkg_Data_Date_Gen.Get_genDate(), dictMonadGen_0)), gopurs_runtime.Apply(pkg_Data_Time_Gen.Get_genTime(), dictMonadGen_0)))
}
