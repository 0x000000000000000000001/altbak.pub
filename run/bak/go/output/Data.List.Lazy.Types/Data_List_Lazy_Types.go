...
var x_0 gopurs_runtime.Value = x_0_loop
_ = x_0
return gopurs_runtime.Apply(pkg_Data_Lazy.Get_force(), x_0_loop)
}()
})
	})
	return step
...
__t1 = gopurs_runtime.Constructor2("Cons", (*[1024]gopurs_runtime.Value)(__local_var_3_0.UnsafePtr)[0], gopurs_runtime.Apply2(gopurs_runtime.RecordGet(Get_semigroupList(), "append"), (*[1024]gopurs_runtime.Value)(__local_var_3_0.UnsafePtr)[1], ys_1))
goto end_branch_1
} else {
...
{
if gopurs_runtime.Bool(__local_var_3_0.StrVal == "Cons").IntVal != 0 {
__t1 = gopurs_runtime.Constructor2("Cons", gopurs_runtime.Apply(f_0, (*[1024]gopurs_runtime.Value)(__local_var_3_0.UnsafePtr)[0]), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(Get_functorList(), "map"), f_0, (*[1024]gopurs_runtime.Value)(__local_var_3_0.UnsafePtr)[1]))
goto end_branch_1
} else {
...
_ = __local_var_3_0
return gopurs_runtime.Constructor2("NonEmpty", gopurs_runtime.Apply(f_0, (*[1024]gopurs_runtime.Value)(__local_var_3_0.UnsafePtr)[0]), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(Get_functorList(), "map"), f_0, (*[1024]gopurs_runtime.Value)(__local_var_3_0.UnsafePtr)[1]))
}))
}))
	})
...
{
__t1 = gopurs_runtime.Bool(gopurs_runtime.Bool(v_4.StrVal == "Cons").IntVal != 0 && gopurs_runtime.Bool(v1_5.StrVal == "Cons").IntVal != 0 && gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictEq_0, "eq"), (*[1024]gopurs_runtime.Value)(v_4.UnsafePtr)[0], (*[1024]gopurs_runtime.Value)(v1_5.UnsafePtr)[0]).IntVal != 0 && gopurs_runtime.Apply2(go__3_0, gopurs_runtime.Apply(pkg_Data_Lazy.Get_force(), (*[1024]gopurs_runtime.Value)(v_4.UnsafePtr)[1]), gopurs_runtime.Apply(pkg_Data_Lazy.Get_force(), (*[1024]gopurs_runtime.Value)(v1_5.UnsafePtr)[1])).IntVal != 0)
}
end_branch_1:
return __t1
})
...
return gopurs_runtime.Bool(gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictEq_0_loop, "eq"), (*[1024]gopurs_runtime.Value)(x_1.UnsafePtr)[0], (*[1024]gopurs_runtime.Value)(y_2.UnsafePtr)[0]).IntVal != 0 && gopurs_runtime.Apply3(gopurs_runtime.RecordGet(Get_eq1List(), "eq1"), dictEq_0_loop, (*[1024]gopurs_runtime.Value)(x_1.UnsafePtr)[1], (*[1024]gopurs_runtime.Value)(y_2.UnsafePtr)[1]).IntVal != 0)
}))
}()
})
	})
...
var dictEq_0 gopurs_runtime.Value = dictEq_0_loop
_ = dictEq_0
return gopurs_runtime.RecordDict1("eq", gopurs_runtime.Apply(gopurs_runtime.RecordGet(Get_eq1List(), "eq1"), dictEq_0_loop))
}()
})
	})
	return eqList
...
var dictEq_0 gopurs_runtime.Value = dictEq_0_loop
_ = dictEq_0
__local_var_1_0 := gopurs_runtime.Apply(Get_eqNonEmpty(), dictEq_0_loop)
_ = __local_var_1_0
...
v_4_loop = gopurs_runtime.Apply(pkg_Data_Lazy.Get_force(), (*[1024]gopurs_runtime.Value)(v_4.UnsafePtr)[1])
v1_5_loop = gopurs_runtime.Apply(pkg_Data_Lazy.Get_force(), (*[1024]gopurs_runtime.Value)(v1_5.UnsafePtr)[1])
continue go__3_0
...
_ = dictOrd_0
return gopurs_runtime.RecordDict2("compare", "Eq0", gopurs_runtime.Apply(gopurs_runtime.RecordGet(Get_ord1List(), "compare1"), dictOrd_0_loop), gopurs_runtime.Func(func(_dollar__unused_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.RecordDict1("eq", gopurs_runtime.Apply(gopurs_runtime.RecordGet(Get_eq1List(), "eq1"), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictOrd_0_loop, "Eq0"), gopurs_runtime.Value{})))
}))
}()
})
	})
...
var dictOrd_0 gopurs_runtime.Value = dictOrd_0_loop
_ = dictOrd_0
return gopurs_runtime.Apply(pkg_Data_Lazy.Get_ordLazy(), gopurs_runtime.Apply(Get_ordNonEmpty(), dictOrd_0_loop))
}()
})
	})
...
b_2_loop = gopurs_runtime.Apply2(op_0, b_2, (*[1024]gopurs_runtime.Value)(v_4_1.UnsafePtr)[0])
xs_3_loop = (*[1024]gopurs_runtime.Value)(v_4_1.UnsafePtr)[1]
continue go__1_0
...
return gopurs_runtime.Apply3(gopurs_runtime.RecordGet(Get_foldableList(), "foldl"), f_0, gopurs_runtime.Apply2(f_0, b_1, (*[1024]gopurs_runtime.Value)(v_2.UnsafePtr)[0]), (*[1024]gopurs_runtime.Value)(v_2.UnsafePtr)[1])
}), gopurs_runtime.Func3(func(f_0 gopurs_runtime.Value, b_1 gopurs_runtime.Value, v_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
}), gopurs_runtime.RecordDict2("val", "acc", Get_nil(), Get_nil()), (*[1024]gopurs_runtime.Value)(v_2_0.UnsafePtr)[1]), "val")
_ = __local_var_4_3
...
__local_var_2_0 := (*[1024]gopurs_runtime.Value)(gopurs_runtime.Apply(pkg_Data_Lazy.Get_force(), v_1).UnsafePtr)[1]
_ = __local_var_2_0
...
_ = __local_var_3_0
return gopurs_runtime.Apply2(f_0, (*[1024]gopurs_runtime.Value)(__local_var_3_0.UnsafePtr)[0], gopurs_runtime.Apply3(gopurs_runtime.RecordGet(Get_foldableList(), "foldr"), f_0, b_1, (*[1024]gopurs_runtime.Value)(__local_var_3_0.UnsafePtr)[1]))
}), gopurs_runtime.Func3(func(f_0 gopurs_runtime.Value, b_1 gopurs_runtime.Value, v_2 gopurs_runtime.Value) gopurs_runtime.Value {
__local_var_3_1 := gopurs_runtime.Apply(pkg_Data_Lazy.Get_force(), v_2)
_ = __local_var_3_1
return gopurs_runtime.Apply3(gopurs_runtime.RecordGet(Get_foldableList(), "foldl"), f_0, gopurs_runtime.Apply2(f_0, b_1, (*[1024]gopurs_runtime.Value)(__local_var_3_1.UnsafePtr)[0]), (*[1024]gopurs_runtime.Value)(__local_var_3_1.UnsafePtr)[1])
}), gopurs_runtime.Func(func(dictMonoid_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
{
if gopurs_runtime.Bool(v_2_0.StrVal == "Cons").IntVal != 0 {
__t1 = gopurs_runtime.Str("(fromFoldable [" + gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictShow_0_loop, "show"), (*[1024]gopurs_runtime.Value)(v_2_0.UnsafePtr)[0]).StrVal + gopurs_runtime.Apply3(gopurs_runtime.RecordGet(Get_foldableList(), "foldl"), gopurs_runtime.Func2(func(shown_3 gopurs_runtime.Value, x_prime_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Str(shown_3.StrVal + "," + gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictShow_0_loop, "show"), x_prime_4).StrVal)
}), gopurs_runtime.Str(""), (*[1024]gopurs_runtime.Value)(v_2_0.UnsafePtr)[1]).StrVal + "])")
goto end_branch_1
} else {
...
__local_var_3_1 := gopurs_runtime.Apply(pkg_Data_Lazy.Get_force(), v_2)
_ = __local_var_3_1
return gopurs_runtime.Str("(NonEmptyList (defer \\_ -> (NonEmpty " + gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictShow_0_loop, "show"), (*[1024]gopurs_runtime.Value)(__local_var_3_1.UnsafePtr)[0]).StrVal + " " + gopurs_runtime.Apply(gopurs_runtime.RecordGet(__local_var_1_0, "show"), (*[1024]gopurs_runtime.Value)(__local_var_3_1.UnsafePtr)[1]).StrVal + ")))")
}))
}()
})
	})
...
__t0 = gopurs_runtime.Str("(" + gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictShow_0_loop, "show"), (*[1024]gopurs_runtime.Value)(v_1.UnsafePtr)[0]).StrVal + " : " + gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(Get_showList(), dictShow_0_loop), "show"), (*[1024]gopurs_runtime.Value)(v_1.UnsafePtr)[1]).StrVal + ")")
goto end_branch_0
} else {
...
__local_var_4_1 := (*[1024]gopurs_runtime.Value)(v1_3.UnsafePtr)[1]
_ = __local_var_4_1
__local_var_5_2 := (*[1024]gopurs_runtime.Value)(v1_3.UnsafePtr)[0]
_ = __local_var_5_2
return gopurs_runtime.Func(func(a_6 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Constructor2("Tuple", gopurs_runtime.Int(__local_var_5_2.IntVal + 1), gopurs_runtime.Apply(pkg_Data_Lazy.Get_defer_(), gopurs_runtime.Func(func(v_7 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = v_3_0
return (*[1024]gopurs_runtime.Value)(gopurs_runtime.Apply3(gopurs_runtime.RecordGet(Get_foldableList(), "foldl"), gopurs_runtime.Func(func(v1_4 gopurs_runtime.Value) gopurs_runtime.Value {
__local_var_5_3 := (*[1024]gopurs_runtime.Value)(v1_4.UnsafePtr)[1]
_ = __local_var_5_3
__local_var_6_4 := (*[1024]gopurs_runtime.Value)(v1_4.UnsafePtr)[0]
_ = __local_var_6_4
return gopurs_runtime.Func(func(a_7 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Constructor2("Tuple", gopurs_runtime.Int(__local_var_6_4.IntVal - 1), gopurs_runtime.Apply3(f_0, gopurs_runtime.Int(__local_var_6_4.IntVal - 1), a_7, __local_var_5_3))
})
}), gopurs_runtime.Constructor2("Tuple", (*[1024]gopurs_runtime.Value)(v_3_0.UnsafePtr)[0], b_1), (*[1024]gopurs_runtime.Value)(v_3_0.UnsafePtr)[1]).UnsafePtr)[1]
...
__local_var_3_6 := (*[1024]gopurs_runtime.Value)(v_2.UnsafePtr)[1]
_ = __local_var_3_6
__local_var_4_7 := (*[1024]gopurs_runtime.Value)(v_2.UnsafePtr)[0]
_ = __local_var_4_7
return gopurs_runtime.Func(func(a_5 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Constructor2("Tuple", gopurs_runtime.Int(__local_var_4_7.IntVal + 1), gopurs_runtime.Apply3(f_0, __local_var_4_7, __local_var_3_6, a_5))
})
}), gopurs_runtime.Constructor2("Tuple", gopurs_runtime.Int(0), acc_1))
_ = __local_var_2_5
return gopurs_runtime.Func(func(x_3 gopurs_runtime.Value) gopurs_runtime.Value {
return (*[1024]gopurs_runtime.Value)(gopurs_runtime.Apply(__local_var_2_5, x_3).UnsafePtr)[1]
})
}), gopurs_runtime.Func(func(dictMonoid_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
{
if gopurs_runtime.Bool(x_3.StrVal == "Just").IntVal != 0 {
__t0 = gopurs_runtime.Int(1 + (*[1024]gopurs_runtime.Value)(x_3.UnsafePtr)[0].IntVal)
goto end_branch_0
} else {
...
_ = v_0
return gopurs_runtime.Apply(pkg_Data_Lazy.Get_defer_(), gopurs_runtime.Func(func(x_1 gopurs_runtime.Value) gopurs_runtime.Value {
v2_2_0 := gopurs_runtime.Apply(pkg_Data_Lazy.Get_force(), v_0_loop)
_ = v2_2_0
__local_var_3_1 := (*[1024]gopurs_runtime.Value)(v2_2_0.UnsafePtr)[0]
_ = __local_var_3_1
__local_var_4_2 := (*[1024]gopurs_runtime.Value)(v2_2_0.UnsafePtr)[1]
_ = __local_var_4_2
...
_ = v1_2_0
__local_var_3_1 := (*[1024]gopurs_runtime.Value)(v1_2_0.UnsafePtr)[0]
_ = __local_var_3_1
__local_var_4_2 := (*[1024]gopurs_runtime.Value)(v1_2_0.UnsafePtr)[1]
_ = __local_var_4_2
...
var __t2 gopurs_runtime.Value
{
if gopurs_runtime.Bool((*[1024]gopurs_runtime.Value)(v1_4_1.UnsafePtr)[1].StrVal == "Just").IntVal != 0 {
__local_var_5_3 := (*[1024]gopurs_runtime.Value)(v1_4_1.UnsafePtr)[0]
_ = __local_var_5_3
__local_var_6_4 := gopurs_runtime.Apply2(go__0_0, f_1, (*[1024]gopurs_runtime.Value)((*[1024]gopurs_runtime.Value)(v1_4_1.UnsafePtr)[1].UnsafePtr)[0])
_ = __local_var_6_4
...
{
if gopurs_runtime.Bool((*[1024]gopurs_runtime.Value)(v1_4_1.UnsafePtr)[1].StrVal == "Nothing").IntVal != 0 {
__local_var_5_5 := (*[1024]gopurs_runtime.Value)(v1_4_1.UnsafePtr)[0]
_ = __local_var_5_5
...
__local_var_5_3 := (*[1024]gopurs_runtime.Value)((*[1024]gopurs_runtime.Value)(v1_4_1.UnsafePtr)[0].UnsafePtr)[0]
_ = __local_var_5_3
__local_var_6_4 := gopurs_runtime.Apply2(go__0_0, f_1, (*[1024]gopurs_runtime.Value)((*[1024]gopurs_runtime.Value)(v1_4_1.UnsafePtr)[0].UnsafePtr)[1])
_ = __local_var_6_4
__t2 = gopurs_runtime.Apply(pkg_Data_Lazy.Get_defer_(), gopurs_runtime.Func(func(v_7 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Constructor2("Cons", __local_var_5_3, __local_var_6_4)
}))
...
func Get_unfoldr1() gopurs_runtime.Value {
	once_unfoldr1.Do(func() {
		unfoldr1 = gopurs_runtime.Func2(Call_unfoldr1)
	})
	return unfoldr1
}
...
{
if gopurs_runtime.Bool(__local_var_3_0.StrVal == "Cons").IntVal != 0 {
__t1 = gopurs_runtime.Apply(pkg_Data_Lazy.Get_force(), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(Get_semigroupList(), "append"), gopurs_runtime.Apply(f_1, (*[1024]gopurs_runtime.Value)(__local_var_3_0.UnsafePtr)[0]), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(Get_bindList(), "bind"), (*[1024]gopurs_runtime.Value)(__local_var_3_0.UnsafePtr)[1], f_1)))
goto end_branch_1
} else {
...
_ = v3_3_1
__local_var_4_2 := (*[1024]gopurs_runtime.Value)(v2_2_0.UnsafePtr)[0]
_ = __local_var_4_2
__local_var_5_3 := (*[1024]gopurs_runtime.Value)(v2_2_0.UnsafePtr)[1]
_ = __local_var_5_3
__local_var_6_4 := (*[1024]gopurs_runtime.Value)(v3_3_1.UnsafePtr)[0]
_ = __local_var_6_4
__local_var_7_5 := (*[1024]gopurs_runtime.Value)(v3_3_1.UnsafePtr)[1]
_ = __local_var_7_5
...
v1_2_0 := gopurs_runtime.Apply(pkg_Data_Lazy.Get_force(), v_0)
_ = v1_2_0
__local_var_3_1 := (*[1024]gopurs_runtime.Value)(v1_2_0.UnsafePtr)[1]
_ = __local_var_3_1
v2_4_2 := gopurs_runtime.Apply(pkg_Data_Lazy.Get_force(), gopurs_runtime.Apply(f_1, (*[1024]gopurs_runtime.Value)(v1_2_0.UnsafePtr)[0]))
_ = v2_4_2
__local_var_5_3 := (*[1024]gopurs_runtime.Value)(v2_4_2.UnsafePtr)[0]
_ = __local_var_5_3
__local_var_6_4 := (*[1024]gopurs_runtime.Value)(v2_4_2.UnsafePtr)[1]
_ = __local_var_6_4
...
_ = xs_1
return gopurs_runtime.Apply(pkg_Data_Lazy.Get_defer_(), gopurs_runtime.Func(func(v_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Constructor2("Cons", x_0_loop, xs_1_loop)
}))
}
...
_ = v_1
return gopurs_runtime.Constructor2("NonEmpty", gopurs_runtime.Apply2(f_0_loop, gopurs_runtime.Constructor0("Nothing"), (*[1024]gopurs_runtime.Value)(v_1_loop.UnsafePtr)[0]), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(Get_functorWithIndexList(), "mapWithIndex"), gopurs_runtime.Func(func(x_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(f_0_loop, gopurs_runtime.Constructor1("Just", x_2))
}), (*[1024]gopurs_runtime.Value)(v_1_loop.UnsafePtr)[1]))
}
...
_ = b_1
__local_var_2_0 := gopurs_runtime.Apply(f_0_loop, b_1_loop)
_ = __local_var_2_0
return gopurs_runtime.Constructor2("NonEmpty", (*[1024]gopurs_runtime.Value)(__local_var_2_0.UnsafePtr)[0], gopurs_runtime.Apply2(gopurs_runtime.RecordGet(Get_unfoldableList(), "unfoldr"), gopurs_runtime.Func(func(v1_3 gopurs_runtime.Value) gopurs_runtime.Value {
var __t1 gopurs_runtime.Value
{
if gopurs_runtime.Bool(v1_3.StrVal == "Just").IntVal != 0 {
__t1 = gopurs_runtime.Constructor1("Just", gopurs_runtime.Apply(f_0_loop, (*[1024]gopurs_runtime.Value)(v1_3.UnsafePtr)[0]))
goto end_branch_1
} else {
...
end_branch_1:
return __t1
}), (*[1024]gopurs_runtime.Value)(__local_var_2_0.UnsafePtr)[1]))
}
