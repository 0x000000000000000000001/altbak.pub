...
v_4_loop = gopurs_runtime.Apply(pkg_Data_Lazy.Get_force(), gopurs_runtime.Apply(pkg_Unsafe_Coerce.Get_unsafeCoerce(), v_4.PtrVal.(map[string]gopurs_runtime.Value)["value1"]))
v1_5_loop = gopurs_runtime.Apply(pkg_Data_Lazy.Get_force(), gopurs_runtime.Apply(pkg_Unsafe_Coerce.Get_unsafeCoerce(), v1_5.PtrVal.(map[string]gopurs_runtime.Value)["value1"]))
continue go__3_0
...
b_2_loop = gopurs_runtime.Apply(gopurs_runtime.Apply(op_0, b_2), v_4_1.PtrVal.(map[string]gopurs_runtime.Value)["value0"])
xs_3_loop = v_4_1.PtrVal.(map[string]gopurs_runtime.Value)["value1"]
continue go__1_0
...
__local_var_6_4 := gopurs_runtime.Apply(gopurs_runtime.Apply(go__0_0, f_1), v1_4_1.PtrVal.(map[string]gopurs_runtime.Value)["value1"].PtrVal.(map[string]gopurs_runtime.Value)["value0"])
...
__local_var_5_5 := v1_4_1.PtrVal.(map[string]gopurs_runtime.Value)["value0"]
...
return gopurs_runtime.Record(map[string]gopurs_runtime.Value{"_tag": gopurs_runtime.Str("Cons"), "value0": __local_var_5_5, "value1": Get_nil()})
}))
goto end_branch_2
} else {
