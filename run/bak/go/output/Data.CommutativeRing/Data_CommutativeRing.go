...
func Get_commutativeRingRecordCons() gopurs_runtime.Value {
	once_commutativeRingRecordCons.Do(func() {
		commutativeRingRecordCons = gopurs_runtime.Func3(func(dictIsSymbol_0 gopurs_runtime.Value, _dollar__unused_1 gopurs_runtime.Value, dictCommutativeRingRecord_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_commutativeRingRecord() gopurs_runtime.Value {
	once_commutativeRingRecord.Do(func() {
		commutativeRingRecord = gopurs_runtime.Func2(func(_dollar__unused_0 gopurs_runtime.Value, dictCommutativeRingRecord_1 gopurs_runtime.Value) gopurs_runtime.Value {
