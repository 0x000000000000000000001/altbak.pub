...
_ = s_1
return (*pkg_Data_Tuple.Constructor_Tuple)(gopurs_runtime.Apply(v_0, s_1).UnsafePtr).V1
}
...
var s_1 gopurs_runtime.Value = s_1_loop
_ = s_1
return (*pkg_Data_Tuple.Constructor_Tuple)(gopurs_runtime.Apply(v_0, s_1).UnsafePtr).V0
}
