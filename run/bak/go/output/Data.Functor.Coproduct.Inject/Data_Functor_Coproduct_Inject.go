...
return Call_prj((*Record_inj_gopurs_runtime_Value_prj_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
	return cache_prj
}
...
return Call_inj((*Record_inj_gopurs_runtime_Value_prj_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
	return cache_inj
}
...
return Call_injectRight((*Record_inj_gopurs_runtime_Value_prj_gopurs_runtime_Value)(dictInject_0_box.UnsafePtr))
})
	})
...
func Call_prj(dict_0_loop *Record_inj_gopurs_runtime_Value_prj_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_inj_gopurs_runtime_Value_prj_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.prj
}

func Call_inj(dict_0_loop *Record_inj_gopurs_runtime_Value_prj_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_inj_gopurs_runtime_Value_prj_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.inj
}

func Call_injectRight(dictInject_0_loop *Record_inj_gopurs_runtime_Value_prj_gopurs_runtime_Value) gopurs_runtime.Value {
var dictInject_0 *Record_inj_gopurs_runtime_Value_prj_gopurs_runtime_Value = dictInject_0_loop
_ = dictInject_0
return gopurs_runtime.RecordDict2("inj", "prj", gopurs_runtime.Func(func(x_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 2465973597, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Data_Data_Either_Right{gopurs_runtime.Apply(dictInject_0.inj, x_1)})}
...
__t0 = gopurs_runtime.Apply(dictInject_0.prj, (*pkg_Data_Either.Data_Data_Either_Right)(v2_1.UnsafePtr).V0)
goto end_branch_0
} else {
