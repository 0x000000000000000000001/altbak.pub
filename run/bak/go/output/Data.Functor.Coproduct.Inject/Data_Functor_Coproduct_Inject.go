...
return gopurs_runtime.Value{Type: 9, IntVal: 3711209382, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value]{1, x_0})}
...
var cache_const__3168103323 gopurs_runtime.Value
var once_const__3168103323 sync.Once
func Get_const__3168103323() gopurs_runtime.Value {
	once_const__3168103323.Do(func() {
		cache_const__3168103323 = gopurs_runtime.Func2(func(a_0_box gopurs_runtime.Value, v_1_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_const__3168103323(a_0_box, v_1_box)
})
	})
	return cache_const__3168103323
}
...
var cache_coproduct__2507487339 gopurs_runtime.Value
var once_coproduct__2507487339 sync.Once
func Get_coproduct__2507487339() gopurs_runtime.Value {
	once_coproduct__2507487339.Do(func() {
		cache_coproduct__2507487339 = gopurs_runtime.Func3(func(v_0_box gopurs_runtime.Value, v1_1_box gopurs_runtime.Value, v2_2_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_coproduct__2507487339(v_0_box, v1_1_box, v2_2_box)
})
	})
	return cache_coproduct__2507487339
}

type Constructor_Inject[T_f any, T_g any] struct {
	Rc uint32
...
func Call_const__3168103323(a_0_loop gopurs_runtime.Value, v_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var a_0 gopurs_runtime.Value = a_0_loop
_ = a_0
var v_1 gopurs_runtime.Value = v_1_loop
_ = v_1
...
func Call_coproduct__2507487339(v_0_loop gopurs_runtime.Value, v1_1_loop gopurs_runtime.Value, v2_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
var v_0 gopurs_runtime.Value = v_0_loop
_ = v_0
var v1_1 gopurs_runtime.Value = v1_1_loop
_ = v1_1
