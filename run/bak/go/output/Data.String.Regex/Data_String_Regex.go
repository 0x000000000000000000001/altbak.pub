...
end_branch_5:
return Call_append__493084344(gopurs_runtime.Str(__t0), gopurs_runtime.Str(Call_append__493084344(gopurs_runtime.Str(__t1), gopurs_runtime.Str(Call_append__493084344(gopurs_runtime.Str(__t2), gopurs_runtime.Str(Call_append__493084344(gopurs_runtime.Str(__t3), gopurs_runtime.Str(Call_append__493084344(gopurs_runtime.Str(__t4), gopurs_runtime.Str(__t5)).StrVal())).StrVal())).StrVal())).StrVal())).StrVal()
}
