...
func Get_act() gopurs_runtime.Value {
	once_act.Do(func() {
		cache_act = gopurs_runtime.Apply2(Get_bind__3550378017(), gopurs_runtime.Apply(pkg_Bench.Get_opaque(), gopurs_runtime.Int(20)), gopurs_runtime.Func(func(dummy_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return Call_chainModifications(gopurs_runtime.Apply2(Get_sub__1043827704(), gopurs_runtime.Int(v_0), gopurs_runtime.Int(1)).IntVal)
}))
}
end_branch_0:
return __t0
...
v1_1_loop = gopurs_runtime.Apply2(Get_add__560788792(), gopurs_runtime.Int(v1_1), gopurs_runtime.Int(gopurs_runtime.RecordGet(Call_runState__2373419117(Call_chainModifications(60), gopurs_runtime.Int(0)), "state").IntVal)).IntVal
