...
return gopurs_runtime.Any(Call_showConst(dictShow_0_box))
})
	})
...
return gopurs_runtime.Any(Call_semiringConst(dictSemiring_0_box))
})
	})
...
func Get_semigroupoidConst() gopurs_runtime.Value {
	once_semigroupoidConst.Do(func() {
		cache_semigroupoidConst = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("compose", gopurs_runtime.Func2(func(v_0 gopurs_runtime.Value, v1_1 gopurs_runtime.Value) gopurs_runtime.Value {
return v1_1
}))))
	})
...
return gopurs_runtime.Any(Call_semigroupConst(dictSemigroup_0_box))
})
	})
...
return gopurs_runtime.Any(Call_ringConst(dictRing_0_box))
})
	})
...
return gopurs_runtime.Any(Call_ordConst(dictOrd_0_box))
})
	})
...
func Get_newtypeConst() gopurs_runtime.Value {
	once_newtypeConst.Do(func() {
		cache_newtypeConst = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("Coercible0", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Any(Call_monoidConst(dictMonoid_0_box))
})
	})
...
return gopurs_runtime.Any(Call_heytingAlgebraConst(dictHeytingAlgebra_0_box))
})
	})
...
func Get_functorConst() gopurs_runtime.Value {
	once_functorConst.Do(func() {
		cache_functorConst = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("map", gopurs_runtime.Func2(func(f_0 gopurs_runtime.Value, m_1 gopurs_runtime.Value) gopurs_runtime.Value {
return m_1
}))))
	})
...
func Get_invariantConst() gopurs_runtime.Value {
	once_invariantConst.Do(func() {
		cache_invariantConst = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("imap", gopurs_runtime.Func2(func(f_0 gopurs_runtime.Value, v_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Any(Call_euclideanRingConst(dictEuclideanRing_0_box))
})
	})
...
return gopurs_runtime.Any(Call_eqConst(dictEq_0_box))
})
	})
...
return gopurs_runtime.Any(Call_eq1Const(dictEq_0_box))
})
	})
...
return gopurs_runtime.Any(Call_ord1Const(dictOrd_0_box))
})
	})
...
return gopurs_runtime.Any(Call_commutativeRingConst(dictCommutativeRing_0_box))
})
	})
...
return gopurs_runtime.Any(Call_boundedConst(dictBounded_0_box))
})
	})
...
return gopurs_runtime.Any(Call_booleanAlgebraConst(dictBooleanAlgebra_0_box))
})
	})
...
return gopurs_runtime.Any(Call_applyConst(dictSemigroup_0_box))
})
	})
...
return gopurs_runtime.Any(Call_applicativeConst(dictMonoid_0_box))
})
	})
...
func Call_showConst(dictShow_0_loop gopurs_runtime.Value) interface{} {
...
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str("(Const "), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictShow_0, "show"), v_1), gopurs_runtime.Str(")")))
})))
}

func Call_semiringConst(dictSemiring_0_loop gopurs_runtime.Value) interface{} {
var dictSemiring_0 gopurs_runtime.Value = dictSemiring_0_loop
_ = dictSemiring_0
return gopurs_runtime.UnboxAny(dictSemiring_0)
}

func Call_semigroupConst(dictSemigroup_0_loop gopurs_runtime.Value) interface{} {
var dictSemigroup_0 gopurs_runtime.Value = dictSemigroup_0_loop
_ = dictSemigroup_0
return gopurs_runtime.UnboxAny(dictSemigroup_0)
}

func Call_ringConst(dictRing_0_loop gopurs_runtime.Value) interface{} {
var dictRing_0 gopurs_runtime.Value = dictRing_0_loop
_ = dictRing_0
return gopurs_runtime.UnboxAny(dictRing_0)
}

func Call_ordConst(dictOrd_0_loop gopurs_runtime.Value) interface{} {
var dictOrd_0 gopurs_runtime.Value = dictOrd_0_loop
_ = dictOrd_0
return gopurs_runtime.UnboxAny(dictOrd_0)
}

func Call_monoidConst(dictMonoid_0_loop gopurs_runtime.Value) interface{} {
var dictMonoid_0 gopurs_runtime.Value = dictMonoid_0_loop
_ = dictMonoid_0
return gopurs_runtime.UnboxAny(dictMonoid_0)
}

func Call_heytingAlgebraConst(dictHeytingAlgebra_0_loop gopurs_runtime.Value) interface{} {
...
func Call_euclideanRingConst(dictEuclideanRing_0_loop gopurs_runtime.Value) interface{} {
...
func Call_eqConst(dictEq_0_loop gopurs_runtime.Value) interface{} {
var dictEq_0 gopurs_runtime.Value = dictEq_0_loop
_ = dictEq_0
return gopurs_runtime.UnboxAny(dictEq_0)
}

func Call_eq1Const(dictEq_0_loop gopurs_runtime.Value) interface{} {
var dictEq_0 gopurs_runtime.Value = dictEq_0_loop
_ = dictEq_0
eq_1_0 := gopurs_runtime.RecordGet(dictEq_0, "eq")
_ = eq_1_0
return gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("eq1", gopurs_runtime.Func(func(dictEq1_2 gopurs_runtime.Value) gopurs_runtime.Value {
return eq_1_0
})))
}

func Call_ord1Const(dictOrd_0_loop gopurs_runtime.Value) interface{} {
var dictOrd_0 gopurs_runtime.Value = dictOrd_0_loop
_ = dictOrd_0
...
_ = eq_2_1
return gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Eq10", "compare1", gopurs_runtime.Func(func(_dollar__unused_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_commutativeRingConst(dictCommutativeRing_0_loop gopurs_runtime.Value) interface{} {
...
func Call_boundedConst(dictBounded_0_loop gopurs_runtime.Value) interface{} {
var dictBounded_0 gopurs_runtime.Value = dictBounded_0_loop
_ = dictBounded_0
return gopurs_runtime.UnboxAny(dictBounded_0)
}

func Call_booleanAlgebraConst(dictBooleanAlgebra_0_loop gopurs_runtime.Value) interface{} {
...
func Call_applyConst(dictSemigroup_0_loop gopurs_runtime.Value) interface{} {
var dictSemigroup_0 gopurs_runtime.Value = dictSemigroup_0_loop
_ = dictSemigroup_0
...
func Call_applicativeConst(dictMonoid_0_loop gopurs_runtime.Value) interface{} {
var dictMonoid_0 gopurs_runtime.Value = dictMonoid_0_loop
_ = dictMonoid_0
