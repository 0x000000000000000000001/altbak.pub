...
return gopurs_runtime.Any(Call_showJoin(dictShow_0_box))
})
	})
...
return gopurs_runtime.Any(Call_ordJoin(dictOrd_0_box))
})
	})
...
func Get_newtypeJoin() gopurs_runtime.Value {
	once_newtypeJoin.Do(func() {
		cache_newtypeJoin = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("Coercible0", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Any(Call_eqJoin(dictEq_0_box))
})
	})
	return cache_eqJoin
}
...
return gopurs_runtime.Any(Call_bifunctorJoin(dictBifunctor_0_box))
})
	})
...
return gopurs_runtime.Any(Call_biapplyJoin(dictBiapply_0_box))
})
	})
...
return gopurs_runtime.Any(Call_biapplicativeJoin(dictBiapplicative_0_box))
})
	})
...
func Call_showJoin(dictShow_0_loop gopurs_runtime.Value) interface{} {
...
func Call_ordJoin(dictOrd_0_loop gopurs_runtime.Value) interface{} {
var dictOrd_0 gopurs_runtime.Value = dictOrd_0_loop
_ = dictOrd_0
return gopurs_runtime.UnboxAny(dictOrd_0)
}

func Call_eqJoin(dictEq_0_loop gopurs_runtime.Value) interface{} {
var dictEq_0 gopurs_runtime.Value = dictEq_0_loop
_ = dictEq_0
return gopurs_runtime.UnboxAny(dictEq_0)
}

func Call_bifunctorJoin(dictBifunctor_0_loop gopurs_runtime.Value) interface{} {
...
func Call_biapplyJoin(dictBiapply_0_loop gopurs_runtime.Value) interface{} {
...
func Call_biapplicativeJoin(dictBiapplicative_0_loop gopurs_runtime.Value) interface{} {
...
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictBiapplicative_0, "bipure"), a_4, a_4)
})))
}
