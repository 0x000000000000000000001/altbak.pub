...
return Call_showJoin((*Record_show_gopurs_runtime_Value)(dictShow_0_box.UnsafePtr))
})
	})
...
return gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(Call_ordJoin((*Record_compare_gopurs_runtime_Value)(dictOrd_0_box.UnsafePtr)))}
})
	})
...
return gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(Call_eqJoin((*Record_eq_gopurs_runtime_Value)(dictEq_0_box.UnsafePtr)))}
})
	})
	return cache_eqJoin
}
...
return Call_bifunctorJoin((*Record_bimap_gopurs_runtime_Value)(dictBifunctor_0_box.UnsafePtr))
})
	})
...
return Call_biapplyJoin((*Record_biapply_gopurs_runtime_Value)(dictBiapply_0_box.UnsafePtr))
})
	})
...
return Call_biapplicativeJoin((*Record_bipure_gopurs_runtime_Value)(dictBiapplicative_0_box.UnsafePtr))
})
	})
...
func Call_showJoin(dictShow_0_loop *Record_show_gopurs_runtime_Value) gopurs_runtime.Value {
var dictShow_0 *Record_show_gopurs_runtime_Value = dictShow_0_loop
_ = dictShow_0
return gopurs_runtime.RecordDict1("show", gopurs_runtime.Func(func(v_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str("(Join "), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Apply(dictShow_0.show, v_1), gopurs_runtime.Str(")")))
}))
}

func Call_ordJoin(dictOrd_0_loop *Record_compare_gopurs_runtime_Value) *Record_compare_gopurs_runtime_Value {
var dictOrd_0 *Record_compare_gopurs_runtime_Value = dictOrd_0_loop
_ = dictOrd_0
return dictOrd_0
}

func Call_eqJoin(dictEq_0_loop *Record_eq_gopurs_runtime_Value) *Record_eq_gopurs_runtime_Value {
var dictEq_0 *Record_eq_gopurs_runtime_Value = dictEq_0_loop
_ = dictEq_0
return dictEq_0
}

func Call_bifunctorJoin(dictBifunctor_0_loop *Record_bimap_gopurs_runtime_Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply3(dictBifunctor_0.bimap, f_1, f_1, v_2)
}))
}

func Call_biapplyJoin(dictBiapply_0_loop *Record_biapply_gopurs_runtime_Value) gopurs_runtime.Value {
...
func Call_biapplicativeJoin(dictBiapplicative_0_loop *Record_bipure_gopurs_runtime_Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply2(dictBiapplicative_0.bipure, a_4, a_4)
}))
}
