...
func Get_loopIO() gopurs_runtime.Value {
	once_loopIO.Do(func() {
		cache_loopIO = gopurs_runtime.Func(func(n_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_act() gopurs_runtime.Value {
	once_act.Do(func() {
		cache_act = gopurs_runtime.Apply(Get_loopIO(), gopurs_runtime.Int(10000))
	})
	return cache_act
}
