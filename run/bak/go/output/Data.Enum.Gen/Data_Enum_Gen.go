...
return Call_genBoundedEnum((*Record_chooseBool_gopurs_runtime_Value_chooseFloat_gopurs_runtime_Value_chooseInt_gopurs_runtime_Value_resize_gopurs_runtime_Value_sized_gopurs_runtime_Value)(dictMonadGen_0_box.UnsafePtr))
})
	})
...
func Call_genBoundedEnum(dictMonadGen_0_loop *Record_chooseBool_gopurs_runtime_Value_chooseFloat_gopurs_runtime_Value_chooseInt_gopurs_runtime_Value_resize_gopurs_runtime_Value_sized_gopurs_runtime_Value) gopurs_runtime.Value {
...
_ = dictMonadGen_0
elements_1_0 := gopurs_runtime.Apply2(pkg_Control_Monad_Gen.Get_elements(), gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictMonadGen_0)}, Get_foldable1NonEmpty())
_ = elements_1_0
...
__t4 = gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictMonadGen_0)}, "Monad0_NOT_FOUND"), gopurs_runtime.Value{}), "Applicative0"), gopurs_runtime.Value{}), "pure"), gopurs_runtime.RecordGet(Bounded0_4_2, "bottom"))
goto end_branch_4
} else {
