...
return Call_defer_((*Record_defer__gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
	return cache_defer_
}
...
return Call_fix((*Record_defer__gopurs_runtime_Value)(dictLazy_0_box.UnsafePtr), f_1_box)
})
	})
	return cache_fix
}
...
func Call_defer_(dict_0_loop *Record_defer__gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_defer__gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.defer_
}

func Call_fix(dictLazy_0_loop *Record_defer__gopurs_runtime_Value, f_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = go__2_0
go__2_0 = gopurs_runtime.Apply(dictLazy_0.defer_, gopurs_runtime.Func(func(v_3 gopurs_runtime.Value) gopurs_runtime.Value {
