...
func Get_showCaseInsensitiveNonEmptyString() gopurs_runtime.Value {
	once_showCaseInsensitiveNonEmptyString.Do(func() {
		cache_showCaseInsensitiveNonEmptyString = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("show", gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str("(CaseInsensitiveNonEmptyString "), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Apply(gopurs_runtime.RecordGet(pkg_Data_String_NonEmpty_Internal.Get_showNonEmptyString(), "show"), v_0), gopurs_runtime.Str(")")))
}))))
	})
...
func Get_newtypeCaseInsensitiveNonEmptyString() gopurs_runtime.Value {
	once_newtypeCaseInsensitiveNonEmptyString.Do(func() {
		cache_newtypeCaseInsensitiveNonEmptyString = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("Coercible0", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_eqCaseInsensitiveNonEmptyString() gopurs_runtime.Value {
	once_eqCaseInsensitiveNonEmptyString.Do(func() {
		cache_eqCaseInsensitiveNonEmptyString = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("eq", gopurs_runtime.Func2(func(v_0 gopurs_runtime.Value, v1_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_ordCaseInsensitiveNonEmptyString() gopurs_runtime.Value {
	once_ordCaseInsensitiveNonEmptyString.Do(func() {
		cache_ordCaseInsensitiveNonEmptyString = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Eq0", "compare", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
