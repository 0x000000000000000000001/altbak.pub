...
var cache_applicativeMultiplicative__4045440648 gopurs_runtime.Value
var once_applicativeMultiplicative__4045440648 sync.Once
func Get_applicativeMultiplicative__4045440648() gopurs_runtime.Value {
	once_applicativeMultiplicative__4045440648.Do(func() {
		cache_applicativeMultiplicative__4045440648 = gopurs_runtime.RecordDict2("Apply0", "pure", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return Get_applyMultiplicative()
}), Get_Multiplicative())
	})
	return cache_applicativeMultiplicative__4045440648
}

var cache_applyMultiplicative__3199351098 gopurs_runtime.Value
var once_applyMultiplicative__3199351098 sync.Once
func Get_applyMultiplicative__3199351098() gopurs_runtime.Value {
	once_applyMultiplicative__3199351098.Do(func() {
		cache_applyMultiplicative__3199351098 = gopurs_runtime.RecordDict2("Functor0", "apply", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return Get_functorMultiplicative()
}), gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(v1_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(v_0, v1_1)
	...
	return cache_applyMultiplicative__3199351098
}

var cache_bindMultiplicative__329376103 gopurs_runtime.Value
var once_bindMultiplicative__329376103 sync.Once
func Get_bindMultiplicative__329376103() gopurs_runtime.Value {
	once_bindMultiplicative__329376103.Do(func() {
		cache_bindMultiplicative__329376103 = gopurs_runtime.RecordDict2("Apply0", "bind", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return Get_applyMultiplicative()
}), gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(f_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(f_1, v_0)
	...
	return cache_bindMultiplicative__329376103
}

var cache_eq1Multiplicative__1905950174 gopurs_runtime.Value
var once_eq1Multiplicative__1905950174 sync.Once
func Get_eq1Multiplicative__1905950174() gopurs_runtime.Value {
	once_eq1Multiplicative__1905950174.Do(func() {
		cache_eq1Multiplicative__1905950174 = gopurs_runtime.RecordDict1("eq1", gopurs_runtime.Func(func(dictEq_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.RecordGet(dictEq_0, "eq")
}))
	})
	return cache_eq1Multiplicative__1905950174
}
...
return gopurs_runtime.Str(gopurs_runtime.Apply2(Get_append__493084344(), gopurs_runtime.Str("(Multiplicative "), gopurs_runtime.Str(gopurs_runtime.Apply2(Get_append__493084344(), gopurs_runtime.Str(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictShow_0, "show"), v_1).StrVal()), gopurs_runtime.Str(")")).StrVal())).StrVal())
}))
}
