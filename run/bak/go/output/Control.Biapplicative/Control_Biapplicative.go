...
return Call_bipure((*Record_bipure_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
	return cache_bipure
}
...
func Call_bipure(dict_0_loop *Record_bipure_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_bipure_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.bipure
}
