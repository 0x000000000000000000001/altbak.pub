...
return gopurs_runtime.Str(gopurs_runtime.Str(gopurs_runtime.Str("(Joker ").StrVal + gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictShow_0, "show"), v_1).StrVal).StrVal + gopurs_runtime.Str(")").StrVal)
}))
})
	})
	return showJoker
...
func Get_hoistJoker() gopurs_runtime.Value {
	once_hoistJoker.Do(func() {
		hoistJoker = gopurs_runtime.Func2(func(f_0 gopurs_runtime.Value, v_1 gopurs_runtime.Value) gopurs_runtime.Value {
