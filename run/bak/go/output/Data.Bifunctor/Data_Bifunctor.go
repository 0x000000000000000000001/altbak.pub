...
return Call_bimap((*Record_bimap_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
	return cache_bimap
}
...
return Call_bivoid((*Record_bimap_gopurs_runtime_Value)(dictBifunctor_0_box.UnsafePtr))
})
	})
	return cache_bivoid
}
...
return Call_lmap((*Record_bimap_gopurs_runtime_Value)(dictBifunctor_0_box.UnsafePtr), f_1_box)
})
	})
	return cache_lmap
}
...
return Call_rmap((*Record_bimap_gopurs_runtime_Value)(dictBifunctor_0_box.UnsafePtr))
})
	})
	return cache_rmap
}
...
func Call_bimap(dict_0_loop *Record_bimap_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_bimap_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.bimap
}

func Call_bivoid(dictBifunctor_0_loop *Record_bimap_gopurs_runtime_Value) gopurs_runtime.Value {
var dictBifunctor_0 *Record_bimap_gopurs_runtime_Value = dictBifunctor_0_loop
_ = dictBifunctor_0
return gopurs_runtime.Apply2(dictBifunctor_0.bimap, gopurs_runtime.Func(func(v_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_lmap(dictBifunctor_0_loop *Record_bimap_gopurs_runtime_Value, f_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictBifunctor_0 *Record_bimap_gopurs_runtime_Value = dictBifunctor_0_loop
_ = dictBifunctor_0
var f_1 gopurs_runtime.Value = f_1_loop
_ = f_1
return gopurs_runtime.Apply2(dictBifunctor_0.bimap, f_1, Get_identity())
}

func Call_rmap(dictBifunctor_0_loop *Record_bimap_gopurs_runtime_Value) gopurs_runtime.Value {
var dictBifunctor_0 *Record_bimap_gopurs_runtime_Value = dictBifunctor_0_loop
_ = dictBifunctor_0
return gopurs_runtime.Apply(dictBifunctor_0.bimap, Get_identity())
}
