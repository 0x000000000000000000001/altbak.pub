...
return gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&pkg_Data_Tuple.Constructor_Tuple{gopurs_runtime.Apply(f_0, (*pkg_Data_Tuple.Constructor_Tuple)(v_2.UnsafePtr).V0), gopurs_runtime.Apply(g_1, (*pkg_Data_Tuple.Constructor_Tuple)(v_2.UnsafePtr).V1)})}
}))
	})
...
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 3711209382, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Left{gopurs_runtime.Apply(v_0, (*pkg_Data_Either.Constructor_Left)(v2_2.UnsafePtr).V0)})}
goto end_branch_0
} else {
...
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 2465973597, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Right{gopurs_runtime.Apply(v1_1, (*pkg_Data_Either.Constructor_Right)(v2_2.UnsafePtr).V0)})}
goto end_branch_0
} else {
