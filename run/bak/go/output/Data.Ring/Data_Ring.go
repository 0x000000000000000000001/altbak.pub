...
return Call_subRecord((*Record_subRecord_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
...
return Call_sub((*Record_sub_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
	return cache_sub
}
...
return Call_ringRecordCons((*Record_reflectSymbol_gopurs_runtime_Value)(dictIsSymbol_0_box.UnsafePtr), (*Record_)(_dollar__unused_1_box.UnsafePtr), (*Record_subRecord_gopurs_runtime_Value)(dictRingRecord_2_box.UnsafePtr))
})
	})
...
return Call_ringRecord((*Record_)(_dollar__unused_0_box.UnsafePtr), (*Record_subRecord_gopurs_runtime_Value)(dictRingRecord_1_box.UnsafePtr))
})
	})
...
return Call_ringFn((*Record_sub_gopurs_runtime_Value)(dictRing_0_box.UnsafePtr))
})
	})
	return cache_ringFn
}
...
return Call_negate((*Record_sub_gopurs_runtime_Value)(dictRing_0_box.UnsafePtr))
})
	})
	return cache_negate
}
...
func Call_subRecord(dict_0_loop *Record_subRecord_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_subRecord_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.subRecord
}

func Call_sub(dict_0_loop *Record_sub_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_sub_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.sub
}

func Call_ringRecordCons(dictIsSymbol_0_loop *Record_reflectSymbol_gopurs_runtime_Value, _dollar__unused_1_loop *Record_, dictRingRecord_2_loop *Record_subRecord_gopurs_runtime_Value) gopurs_runtime.Value {
...
_ = _dollar__unused_1
var dictRingRecord_2 *Record_subRecord_gopurs_runtime_Value = dictRingRecord_2_loop
_ = dictRingRecord_2
semiringRecordCons1_3_0 := gopurs_runtime.Apply3(pkg_Data_Semiring.Get_semiringRecordCons(), gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictIsSymbol_0)}, gopurs_runtime.Value{}, gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictRingRecord_2)}, "SemiringRecord0_NOT_FOUND"), gopurs_runtime.Value{}))
...
_ = get_10_3
return gopurs_runtime.Apply3(pkg_Record_Unsafe.Get_unsafeSet(), key_9_2, gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictRing_4, "sub"), gopurs_runtime.Apply(get_10_3, ra_7), gopurs_runtime.Apply(get_10_3, rb_8)), gopurs_runtime.Apply3(dictRingRecord_2.subRecord, gopurs_runtime.Value{Type: 9, IntVal: 513803634, UnsafePtr: nil}, ra_7, rb_8))
}))
})
}

func Call_ringRecord(_dollar__unused_0_loop *Record_, dictRingRecord_1_loop *Record_subRecord_gopurs_runtime_Value) gopurs_runtime.Value {
var _dollar__unused_0 *Record_ = _dollar__unused_0_loop
_ = _dollar__unused_0
var dictRingRecord_1 *Record_subRecord_gopurs_runtime_Value = dictRingRecord_1_loop
_ = dictRingRecord_1
__local_var_2_0 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictRingRecord_1)}, "SemiringRecord0_NOT_FOUND"), gopurs_runtime.Value{})
_ = __local_var_2_0
semiringRecord1_3_1 := gopurs_runtime.RecordDict4("add", "mul", "one", "zero", gopurs_runtime.Apply(gopurs_runtime.RecordGet(__local_var_2_0, "addRecord"), gopurs_runtime.Value{Type: 9, IntVal: 513803634, UnsafePtr: nil}), gopurs_runtime.Apply(gopurs_runtime.RecordGet(__local_var_2_0, "mulRecord"), gopurs_runtime.Value{Type: 9, IntVal: 513803634, UnsafePtr: nil}), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_2_0, "oneRecord"), gopurs_runtime.Value{Type: 9, IntVal: 513803634, UnsafePtr: nil}, gopurs_runtime.Value{Type: 9, IntVal: 513803634, UnsafePtr: nil}), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_2_0, "zeroRecord"), gopurs_runtime.Value{Type: 9, IntVal: 513803634, UnsafePtr: nil}, gopurs_runtime.Value{Type: 9, IntVal: 513803634, UnsafePtr: nil}))
...
}), gopurs_runtime.Apply(dictRingRecord_1.subRecord, gopurs_runtime.Value{Type: 9, IntVal: 513803634, UnsafePtr: nil}))
}

func Call_ringFn(dictRing_0_loop *Record_sub_gopurs_runtime_Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply2(dictRing_0.sub, gopurs_runtime.Apply(f_4, x_6), gopurs_runtime.Apply(g_5, x_6))
}))
}

func Call_negate(dictRing_0_loop *Record_sub_gopurs_runtime_Value) gopurs_runtime.Value {
var dictRing_0 *Record_sub_gopurs_runtime_Value = dictRing_0_loop
_ = dictRing_0
zero_1_0 := gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictRing_0)}, "Semiring0_NOT_FOUND"), gopurs_runtime.Value{}), "zero")
_ = zero_1_0
return gopurs_runtime.Func(func(a_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(dictRing_0.sub, zero_1_0, a_2)
})
}
