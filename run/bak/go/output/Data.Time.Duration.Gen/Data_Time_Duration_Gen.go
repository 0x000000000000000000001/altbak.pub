...
return gopurs_runtime.Any(Call_genSeconds(dictMonadGen_0_box))
})
	})
...
return gopurs_runtime.Any(Call_genMinutes(dictMonadGen_0_box))
})
	})
...
return gopurs_runtime.Any(Call_genMilliseconds(dictMonadGen_0_box))
})
	})
...
return gopurs_runtime.Any(Call_genHours(dictMonadGen_0_box))
})
	})
...
return gopurs_runtime.Any(Call_genDays(dictMonadGen_0_box))
})
	})
	return cache_genDays
}

func Call_genSeconds(dictMonadGen_0_loop gopurs_runtime.Value) interface{} {
...
func Call_genMinutes(dictMonadGen_0_loop gopurs_runtime.Value) interface{} {
var dictMonadGen_0 gopurs_runtime.Value = dictMonadGen_0_loop
_ = dictMonadGen_0
...
func Call_genMilliseconds(dictMonadGen_0_loop gopurs_runtime.Value) interface{} {
var dictMonadGen_0 gopurs_runtime.Value = dictMonadGen_0_loop
_ = dictMonadGen_0
...
func Call_genHours(dictMonadGen_0_loop gopurs_runtime.Value) interface{} {
var dictMonadGen_0 gopurs_runtime.Value = dictMonadGen_0_loop
_ = dictMonadGen_0
...
func Call_genDays(dictMonadGen_0_loop gopurs_runtime.Value) interface{} {
var dictMonadGen_0 gopurs_runtime.Value = dictMonadGen_0_loop
_ = dictMonadGen_0
