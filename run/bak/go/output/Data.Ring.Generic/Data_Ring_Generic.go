...
var cache_genericSub_prime__469823367 gopurs_runtime.Value
var once_genericSub_prime__469823367 sync.Once
func Get_genericSub_prime__469823367() gopurs_runtime.Value {
	once_genericSub_prime__469823367.Do(func() {
		cache_genericSub_prime__469823367 = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_genericSub_prime__469823367(gopurs_runtime.CoerceToStruct[Constructor_GenericRing[gopurs_runtime.Value]](dict_0_box))
})
	})
	return cache_genericSub_prime__469823367
}
...
_ = y_3
return gopurs_runtime.Apply(dictGeneric_0.V1, gopurs_runtime.Apply3(Get_genericSub_prime__469823367(), gopurs_runtime.Value{Type: 9, IntVal: 3896698597, UnsafePtr: unsafe.Pointer(dictGenericRing_1)}, gopurs_runtime.Apply(dictGeneric_0.V0, x_2), gopurs_runtime.Apply(dictGeneric_0.V0, y_3)))
}
...
func Call_genericSub_prime__469823367(dict_0_loop *Constructor_GenericRing[gopurs_runtime.Value]) gopurs_runtime.Value {
var dict_0 *Constructor_GenericRing[gopurs_runtime.Value] = dict_0_loop
_ = dict_0
return dict_0.V0
}
