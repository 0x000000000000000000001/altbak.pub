...
return gopurs_runtime.Value{Type: 9, IntVal: 1171963320, UnsafePtr: unsafe.Pointer(&pkg_Data_Generic_Rep.Constructor_Product{gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictGenericRing_0.UnsafePtr)).V0, (*pkg_Data_Generic_Rep.Constructor_Product)(v_2.UnsafePtr).V0, (*pkg_Data_Generic_Rep.Constructor_Product)(v1_3.UnsafePtr).V0), gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictGenericRing1_1.UnsafePtr)).V0, (*pkg_Data_Generic_Rep.Constructor_Product)(v_2.UnsafePtr).V1, (*pkg_Data_Generic_Rep.Constructor_Product)(v1_3.UnsafePtr).V1)})}
}))
}
