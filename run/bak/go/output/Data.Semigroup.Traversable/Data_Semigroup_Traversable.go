...
return Call_traverse1((*Record_sequence1_gopurs_runtime_Value_traverse1_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
...
return Call_sequence1Default((*Record_sequence1_gopurs_runtime_Value_traverse1_gopurs_runtime_Value)(dictTraversable1_0_box.UnsafePtr), (*Record_apply_gopurs_runtime_Value)(dictApply_1_box.UnsafePtr))
})
	})
...
return Call_sequence1((*Record_sequence1_gopurs_runtime_Value_traverse1_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
...
return Call_traverse1Default((*Record_sequence1_gopurs_runtime_Value_traverse1_gopurs_runtime_Value)(dictTraversable1_0_box.UnsafePtr), (*Record_apply_gopurs_runtime_Value)(dictApply_1_box.UnsafePtr))
})
	})
...
func Call_traverse1(dict_0_loop *Record_sequence1_gopurs_runtime_Value_traverse1_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_sequence1_gopurs_runtime_Value_traverse1_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.traverse1
}

func Call_sequence1Default(dictTraversable1_0_loop *Record_sequence1_gopurs_runtime_Value_traverse1_gopurs_runtime_Value, dictApply_1_loop *Record_apply_gopurs_runtime_Value) gopurs_runtime.Value {
var dictTraversable1_0 *Record_sequence1_gopurs_runtime_Value_traverse1_gopurs_runtime_Value = dictTraversable1_0_loop
_ = dictTraversable1_0
var dictApply_1 *Record_apply_gopurs_runtime_Value = dictApply_1_loop
_ = dictApply_1
return gopurs_runtime.Apply2(dictTraversable1_0.traverse1, gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictApply_1)}, Get_identity())
}

func Call_sequence1(dict_0_loop *Record_sequence1_gopurs_runtime_Value_traverse1_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_sequence1_gopurs_runtime_Value_traverse1_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.sequence1
}

func Call_traverse1Default(dictTraversable1_0_loop *Record_sequence1_gopurs_runtime_Value_traverse1_gopurs_runtime_Value, dictApply_1_loop *Record_apply_gopurs_runtime_Value) gopurs_runtime.Value {
var dictTraversable1_0 *Record_sequence1_gopurs_runtime_Value_traverse1_gopurs_runtime_Value = dictTraversable1_0_loop
_ = dictTraversable1_0
var dictApply_1 *Record_apply_gopurs_runtime_Value = dictApply_1_loop
_ = dictApply_1
sequence12_2_0 := gopurs_runtime.Apply(dictTraversable1_0.sequence1, gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictApply_1)})
_ = sequence12_2_0
return gopurs_runtime.Func2(func(f_3 gopurs_runtime.Value, ta_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(sequence12_2_0, gopurs_runtime.Apply2(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictTraversable1_0)}, "Traversable1_NOT_FOUND"), gopurs_runtime.Value{}), "Functor0"), gopurs_runtime.Value{}), "map"), f_3, ta_4))
})
}
