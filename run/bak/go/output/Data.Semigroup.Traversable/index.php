...
\PhpursThunks::$thunks['Data_Semigroup_Traversable_traverse1'] = function() { $v = function($dict_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_Semigroup_Traversable_traversableTuple'] = function() { $v = ["traverse1" => (function() {
...
\PhpursThunks::$thunks['Data_Semigroup_Traversable_traversableIdentity'] = function() { $v = ["traverse1" => (function() {
  $__fn = function($dictApply_0 = null, $f_1 = null, $v_2 = null) use (&$__fn) {
  $__num = \func_num_args();
  if ($__num < 3) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 3);
...
\PhpursThunks::$thunks['Data_Semigroup_Traversable_traversableDual'] = function() { $v = ["traverse1" => (function() {
  $__fn = function($dictApply_0 = null, $f_1 = null, $v_2 = null) use (&$__fn) {
  $__num = \func_num_args();
  if ($__num < 3) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 3);
...
\PhpursThunks::$thunks['Data_Semigroup_Traversable_traversableMultiplicative'] = function() { $v = ["traverse1" => (function() {
  $__fn = function($dictApply_0 = null, $f_1 = null, $v_2 = null) use (&$__fn) {
  $__num = \func_num_args();
  if ($__num < 3) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 3);
...
\PhpursThunks::$thunks['Data_Semigroup_Traversable_sequence1'] = function() { $v = function($dict_0 = null) {
  $__num = \func_num_args();
