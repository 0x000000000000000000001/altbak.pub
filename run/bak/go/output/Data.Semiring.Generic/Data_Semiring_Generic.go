...
return gopurs_runtime.Apply(((*gopurs_runtime.RecordData2)(dictGeneric_0.UnsafePtr)).V1, ((*gopurs_runtime.RecordData4)(dictGenericSemiring_1.UnsafePtr)).V3)
}
...
return gopurs_runtime.Apply2(((*gopurs_runtime.RecordData4)(dictSemiring_0.UnsafePtr)).V0, v_1, v1_2)
...
}), ((*gopurs_runtime.RecordData4)(dictSemiring_0.UnsafePtr)).V2, ((*gopurs_runtime.RecordData4)(dictSemiring_0.UnsafePtr)).V3)
}
...
var dictGenericSemiring_1 gopurs_runtime.Value = dictGenericSemiring_1_loop
_ = dictGenericSemiring_1
return gopurs_runtime.Apply(((*gopurs_runtime.RecordData2)(dictGeneric_0.UnsafePtr)).V1, ((*gopurs_runtime.RecordData4)(dictGenericSemiring_1.UnsafePtr)).V2)
}
...
_ = y_3
return gopurs_runtime.Apply(((*gopurs_runtime.RecordData2)(dictGeneric_0.UnsafePtr)).V1, gopurs_runtime.Apply2(((*gopurs_runtime.RecordData4)(dictGenericSemiring_1.UnsafePtr)).V1, gopurs_runtime.Apply(((*gopurs_runtime.RecordData2)(dictGeneric_0.UnsafePtr)).V0, x_2), gopurs_runtime.Apply(((*gopurs_runtime.RecordData2)(dictGeneric_0.UnsafePtr)).V0, y_3)))
}
...
return gopurs_runtime.RecordDict4("genericAdd'", "genericMul'", "genericOne'", "genericZero'", gopurs_runtime.Func2(func(v_1 gopurs_runtime.Value, v1_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(((*gopurs_runtime.RecordData4)(dictGenericSemiring_0.UnsafePtr)).V0, v_1, v1_2)
}), gopurs_runtime.Func2(func(v_1 gopurs_runtime.Value, v1_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(((*gopurs_runtime.RecordData4)(dictGenericSemiring_0.UnsafePtr)).V1, v_1, v1_2)
}), ((*gopurs_runtime.RecordData4)(dictGenericSemiring_0.UnsafePtr)).V2, ((*gopurs_runtime.RecordData4)(dictGenericSemiring_0.UnsafePtr)).V3)
}

func Call_genericSemiringProduct(dictGenericSemiring_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictGenericSemiring_0 gopurs_runtime.Value = dictGenericSemiring_0_loop
_ = dictGenericSemiring_0
genericZero_prime1_1_0 := ((*gopurs_runtime.RecordData4)(dictGenericSemiring_0.UnsafePtr)).V3
_ = genericZero_prime1_1_0
genericOne_prime1_2_1 := ((*gopurs_runtime.RecordData4)(dictGenericSemiring_0.UnsafePtr)).V2
...
return gopurs_runtime.Value{Type: 9, IntVal: 1171963320, UnsafePtr: unsafe.Pointer(&pkg_Data_Generic_Rep.Data_Data_Generic_Rep_Product{gopurs_runtime.Apply2(((*gopurs_runtime.RecordData4)(dictGenericSemiring_0.UnsafePtr)).V0, (*pkg_Data_Generic_Rep.Data_Data_Generic_Rep_Product)(v_4.UnsafePtr).V0, (*pkg_Data_Generic_Rep.Data_Data_Generic_Rep_Product)(v1_5.UnsafePtr).V0), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictGenericSemiring1_3, "genericAdd'"), (*pkg_Data_Generic_Rep.Data_Data_Generic_Rep_Product)(v_4.UnsafePtr).V1, (*pkg_Data_Generic_Rep.Data_Data_Generic_Rep_Product)(v1_5.UnsafePtr).V1)})}
}), gopurs_runtime.Func2(func(v_4 gopurs_runtime.Value, v1_5 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 1171963320, UnsafePtr: unsafe.Pointer(&pkg_Data_Generic_Rep.Data_Data_Generic_Rep_Product{gopurs_runtime.Apply2(((*gopurs_runtime.RecordData4)(dictGenericSemiring_0.UnsafePtr)).V1, (*pkg_Data_Generic_Rep.Data_Data_Generic_Rep_Product)(v_4.UnsafePtr).V0, (*pkg_Data_Generic_Rep.Data_Data_Generic_Rep_Product)(v1_5.UnsafePtr).V0), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictGenericSemiring1_3, "genericMul'"), (*pkg_Data_Generic_Rep.Data_Data_Generic_Rep_Product)(v_4.UnsafePtr).V1, (*pkg_Data_Generic_Rep.Data_Data_Generic_Rep_Product)(v1_5.UnsafePtr).V1)})}
}), gopurs_runtime.Value{Type: 9, IntVal: 1171963320, UnsafePtr: unsafe.Pointer(&pkg_Data_Generic_Rep.Data_Data_Generic_Rep_Product{genericOne_prime1_2_1, gopurs_runtime.RecordGet(dictGenericSemiring1_3, "genericOne'")})}, gopurs_runtime.Value{Type: 9, IntVal: 1171963320, UnsafePtr: unsafe.Pointer(&pkg_Data_Generic_Rep.Data_Data_Generic_Rep_Product{genericZero_prime1_1_0, gopurs_runtime.RecordGet(dictGenericSemiring1_3, "genericZero'")})})
})
}
...
var y_3 gopurs_runtime.Value = y_3_loop
_ = y_3
return gopurs_runtime.Apply(((*gopurs_runtime.RecordData2)(dictGeneric_0.UnsafePtr)).V1, gopurs_runtime.Apply2(((*gopurs_runtime.RecordData4)(dictGenericSemiring_1.UnsafePtr)).V0, gopurs_runtime.Apply(((*gopurs_runtime.RecordData2)(dictGeneric_0.UnsafePtr)).V0, x_2), gopurs_runtime.Apply(((*gopurs_runtime.RecordData2)(dictGeneric_0.UnsafePtr)).V0, y_3)))
}
