...
return gopurs_runtime.Any(Call_semigroupoidStar(dictBind_0_box))
})
	})
...
return gopurs_runtime.Any(Call_profunctorStar(dictFunctor_0_box))
})
	})
...
return gopurs_runtime.Any(Call_strongStar(dictFunctor_0_box))
})
	})
...
func Get_newtypeStar() gopurs_runtime.Value {
	once_newtypeStar.Do(func() {
		cache_newtypeStar = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("Coercible0", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Any(Call_invariantStar(dictInvariant_0_box))
})
	})
...
return gopurs_runtime.Any(Call_hoistStar(func(inner_arg0 interface{}) interface{} {
...
return gopurs_runtime.Any(Call_functorStar(dictFunctor_0_box))
})
	})
...
return gopurs_runtime.Any(Call_distributiveStar(dictDistributive_0_box))
})
	})
...
return gopurs_runtime.Any(Call_closedStar(dictDistributive_0_box))
})
	})
...
return gopurs_runtime.Any(Call_choiceStar(dictApplicative_0_box))
})
	})
...
return gopurs_runtime.Any(Call_categoryStar(dictMonad_0_box))
})
	})
...
return gopurs_runtime.Any(Call_applyStar(dictApply_0_box))
})
	})
...
return gopurs_runtime.Any(Call_bindStar(dictBind_0_box))
})
	})
...
return gopurs_runtime.Any(Call_applicativeStar(dictApplicative_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monadStar(dictMonad_0_box))
})
	})
...
return gopurs_runtime.Any(Call_altStar(dictAlt_0_box))
})
	})
...
return gopurs_runtime.Any(Call_plusStar(dictPlus_0_box))
})
	})
...
return gopurs_runtime.Any(Call_alternativeStar(dictAlternative_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monadPlusStar(dictMonadPlus_0_box))
})
	})
...
func Call_semigroupoidStar(dictBind_0_loop gopurs_runtime.Value) interface{} {
var dictBind_0 gopurs_runtime.Value = dictBind_0_loop
_ = dictBind_0
return gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("compose", gopurs_runtime.Func3(func(v_1 gopurs_runtime.Value, v1_2 gopurs_runtime.Value, x_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictBind_0, "bind"), gopurs_runtime.Apply(v1_2, x_3), v_1)
})))
}

func Call_profunctorStar(dictFunctor_0_loop gopurs_runtime.Value) interface{} {
var dictFunctor_0 gopurs_runtime.Value = dictFunctor_0_loop
_ = dictFunctor_0
return gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("dimap", gopurs_runtime.Func3(func(f_1 gopurs_runtime.Value, g_2 gopurs_runtime.Value, v_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_strongStar(dictFunctor_0_loop gopurs_runtime.Value) interface{} {
var dictFunctor_0 gopurs_runtime.Value = dictFunctor_0_loop
_ = dictFunctor_0
...
return gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict3("Profunctor0", "first", "second", gopurs_runtime.Func(func(_dollar__unused_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
__local_var_4_2 := gopurs_runtime.Any((*pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(v1_3.UnsafePtr).V1)
_ = __local_var_4_2
...
return gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value]{gopurs_runtime.UnboxAny(v2_5), gopurs_runtime.UnboxAny(__local_var_4_2)})})
}), gopurs_runtime.Apply(v_2, gopurs_runtime.Any((*pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(v1_3.UnsafePtr).V0)))
}), gopurs_runtime.Func2(func(v_2 gopurs_runtime.Value, v1_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictFunctor_0, "map"), gopurs_runtime.Apply(pkg_Data_Tuple.Get_Tuple(), gopurs_runtime.Any((*pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(v1_3.UnsafePtr).V0)), gopurs_runtime.Apply(v_2, gopurs_runtime.Any((*pkg_Data_Tuple.Constructor_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(v1_3.UnsafePtr).V1)))
})))
}

func Call_invariantStar(dictInvariant_0_loop gopurs_runtime.Value) interface{} {
...
func Call_hoistStar(f_0_loop func(interface{}) interface{}, v_1_loop func(interface{}) interface{}, x_2_loop interface{}) interface{} {
...
func Call_functorStar(dictFunctor_0_loop gopurs_runtime.Value) interface{} {
var dictFunctor_0 gopurs_runtime.Value = dictFunctor_0_loop
_ = dictFunctor_0
...
func Call_distributiveStar(dictDistributive_0_loop gopurs_runtime.Value) interface{} {
distributiveStar:
for {
...
__local_var_5_3 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Any(Call_distributiveStar(dictDistributive_0)), "distribute"), dictFunctor_3)
_ = __local_var_5_3
...
func Call_closedStar(dictDistributive_0_loop gopurs_runtime.Value) interface{} {
var dictDistributive_0 gopurs_runtime.Value = dictDistributive_0_loop
_ = dictDistributive_0
...
return gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Profunctor0", "closed", gopurs_runtime.Func(func(_dollar__unused_4 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_choiceStar(dictApplicative_0_loop gopurs_runtime.Value) interface{} {
...
return gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict3("Profunctor0", "left", "right", gopurs_runtime.Func(func(_dollar__unused_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
__t4 = gopurs_runtime.Apply(__local_var_4_3, gopurs_runtime.Apply(v_3, gopurs_runtime.Any((*pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value])(v2_5.UnsafePtr).V0)))
goto end_branch_4
} else {
...
__t4 = gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictApplicative_0, "pure"), gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 2465973597, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value]{gopurs_runtime.UnboxAny(gopurs_runtime.Any((*pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value])(v2_5.UnsafePtr).V0))})}))
goto end_branch_4
} else {
...
{
if (v2_5.Type == 9 && v2_5.IntVal == 3711209382) {
__t6 = gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictApplicative_0, "pure"), gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 3711209382, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value]{gopurs_runtime.UnboxAny(gopurs_runtime.Any((*pkg_Data_Either.Constructor_Left[gopurs_runtime.Value, gopurs_runtime.Value])(v2_5.UnsafePtr).V0))})}))
goto end_branch_6
} else {
...
{
if (v2_5.Type == 9 && v2_5.IntVal == 2465973597) {
__t6 = gopurs_runtime.Apply(__local_var_4_5, gopurs_runtime.Apply(v_3, gopurs_runtime.Any((*pkg_Data_Either.Constructor_Right[gopurs_runtime.Value, gopurs_runtime.Value])(v2_5.UnsafePtr).V0)))
goto end_branch_6
} else {
...
func Call_categoryStar(dictMonad_0_loop gopurs_runtime.Value) interface{} {
...
return gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Semigroupoid0", "identity", gopurs_runtime.Func(func(_dollar__unused_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_applyStar(dictApply_0_loop gopurs_runtime.Value) interface{} {
...
func Call_bindStar(dictBind_0_loop gopurs_runtime.Value) interface{} {
var dictBind_0 gopurs_runtime.Value = dictBind_0_loop
_ = dictBind_0
...
func Call_applicativeStar(dictApplicative_0_loop gopurs_runtime.Value) interface{} {
var dictApplicative_0 gopurs_runtime.Value = dictApplicative_0_loop
_ = dictApplicative_0
...
_ = applyStar1_3_2
return gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Apply0", "pure", gopurs_runtime.Func(func(_dollar__unused_4 gopurs_runtime.Value) gopurs_runtime.Value {
return applyStar1_3_2
...
func Call_monadStar(dictMonad_0_loop gopurs_runtime.Value) interface{} {
var dictMonad_0 gopurs_runtime.Value = dictMonad_0_loop
_ = dictMonad_0
...
bindStar1_4_7 := gopurs_runtime.Any(Call_bindStar(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonad_0, "Bind1"), gopurs_runtime.Value{})))
_ = bindStar1_4_7
...
func Call_altStar(dictAlt_0_loop gopurs_runtime.Value) interface{} {
...
func Call_plusStar(dictPlus_0_loop gopurs_runtime.Value) interface{} {
...
func Call_alternativeStar(dictAlternative_0_loop gopurs_runtime.Value) interface{} {
...
func Call_monadPlusStar(dictMonadPlus_0_loop gopurs_runtime.Value) interface{} {
var dictMonadPlus_0 gopurs_runtime.Value = dictMonadPlus_0_loop
_ = dictMonadPlus_0
monadStar1_1_0 := gopurs_runtime.Any(Call_monadStar(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonadPlus_0, "Monad0"), gopurs_runtime.Value{})))
_ = monadStar1_1_0
alternativeStar1_2_1 := gopurs_runtime.Any(Call_alternativeStar(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonadPlus_0, "Alternative1"), gopurs_runtime.Value{})))
