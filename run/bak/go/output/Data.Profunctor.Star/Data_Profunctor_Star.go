...
__local_var_4_2 := (*pkg_Data_Tuple.Constructor_Tuple)(v1_3.UnsafePtr).V1
_ = __local_var_4_2
...
return gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&pkg_Data_Tuple.Constructor_Tuple{v2_5, __local_var_4_2})}
}), gopurs_runtime.Apply(v_2, (*pkg_Data_Tuple.Constructor_Tuple)(v1_3.UnsafePtr).V0))
}), gopurs_runtime.Func2(func(v_2 gopurs_runtime.Value, v1_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictFunctor_0.UnsafePtr)).V0, gopurs_runtime.Apply(pkg_Data_Tuple.Get_Tuple(), (*pkg_Data_Tuple.Constructor_Tuple)(v1_3.UnsafePtr).V0), gopurs_runtime.Apply(v_2, (*pkg_Data_Tuple.Constructor_Tuple)(v1_3.UnsafePtr).V1))
}))
}
...
__t4 = gopurs_runtime.Apply(__local_var_4_3, gopurs_runtime.Apply(v_3, (*pkg_Data_Either.Constructor_Left)(v2_5.UnsafePtr).V0))
goto end_branch_4
} else {
...
__t4 = gopurs_runtime.Apply(((*gopurs_runtime.RecordData1)(dictApplicative_0.UnsafePtr)).V0, gopurs_runtime.Value{Type: 9, IntVal: 2465973597, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Right{(*pkg_Data_Either.Constructor_Right)(v2_5.UnsafePtr).V0})})
goto end_branch_4
} else {
...
{
if (v2_5.Type == 9 && v2_5.IntVal == 3711209382) {
__t6 = gopurs_runtime.Apply(((*gopurs_runtime.RecordData1)(dictApplicative_0.UnsafePtr)).V0, gopurs_runtime.Value{Type: 9, IntVal: 3711209382, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Left{(*pkg_Data_Either.Constructor_Left)(v2_5.UnsafePtr).V0})})
goto end_branch_6
} else {
...
{
if (v2_5.Type == 9 && v2_5.IntVal == 2465973597) {
__t6 = gopurs_runtime.Apply(__local_var_4_5, gopurs_runtime.Apply(v_3, (*pkg_Data_Either.Constructor_Right)(v2_5.UnsafePtr).V0))
goto end_branch_6
} else {
