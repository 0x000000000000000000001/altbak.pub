...
func Get_semigroupEquivalence() gopurs_runtime.Value {
	once_semigroupEquivalence.Do(func() {
		cache_semigroupEquivalence = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("append", gopurs_runtime.Func4(func(v_0 gopurs_runtime.Value, v1_1 gopurs_runtime.Value, a_2 gopurs_runtime.Value, b_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_newtypeEquivalence() gopurs_runtime.Value {
	once_newtypeEquivalence.Do(func() {
		cache_newtypeEquivalence = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("Coercible0", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_monoidEquivalence() gopurs_runtime.Value {
	once_monoidEquivalence.Do(func() {
		cache_monoidEquivalence = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Semigroup0", "mempty", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_contravariantEquivalence() gopurs_runtime.Value {
	once_contravariantEquivalence.Do(func() {
		cache_contravariantEquivalence = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("cmap", gopurs_runtime.Func4(func(f_0 gopurs_runtime.Value, v_1 gopurs_runtime.Value, x_2 gopurs_runtime.Value, y_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Bool(Call_comparisonEquivalence(func(inner_arg0 interface{}, inner_arg1 interface{}) gopurs_runtime.Value {
...
func Call_comparisonEquivalence(v_0_loop func(interface{}, interface{}) gopurs_runtime.Value, a_1_loop interface{}, b_2_loop interface{}) bool {
...
_ = b_2
return (gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Ordering.Get_eqOrdering(), "eq"), v_0(a_1, b_2), gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 902936544, UnsafePtr: nil})).IntVal) != (0)
}
