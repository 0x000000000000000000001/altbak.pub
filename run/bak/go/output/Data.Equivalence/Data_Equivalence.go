...
return Call_defaultEquivalence((*Record_eq_gopurs_runtime_Value)(dictEq_0_box.UnsafePtr))
})
	})
...
func Call_defaultEquivalence(dictEq_0_loop *Record_eq_gopurs_runtime_Value) gopurs_runtime.Value {
