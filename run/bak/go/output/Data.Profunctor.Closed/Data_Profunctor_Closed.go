...
func Get_closedFunction() gopurs_runtime.Value {
	once_closedFunction.Do(func() {
		cache_closedFunction = gopurs_runtime.RecordDict2("closed", "Profunctor0", gopurs_runtime.RecordGet(pkg_Control_Semigroupoid.Get_semigroupoidFn(), "compose"), gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_closed() gopurs_runtime.Value {
	once_closed.Do(func() {
		cache_closed = gopurs_runtime.Func(func(dict_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
