...
return Call_closed((*Record_closed_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
	return cache_closed
}
...
func Call_closed(dict_0_loop *Record_closed_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_closed_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.closed
}
