...
return gopurs_runtime.Value{Type: 9, IntVal: 759514854, UnsafePtr: unsafe.Pointer(&Constructor_Cons{value0, value1})}
})
})
	})
	return cache_Cons
...
{
var __t_tag_2 gopurs_runtime.Value = (*pkg_Data_Tuple.Constructor_Tuple)(v2_3_0.UnsafePtr).V0
if (__t_tag_2.Type == 9 && __t_tag_2.IntVal == 930809136) {
__t1 = gopurs_runtime.Apply(v1_1, (*pkg_Data_Maybe.Constructor_Just)((*pkg_Data_Tuple.Constructor_Tuple)(v2_3_0.UnsafePtr).V0.UnsafePtr).V0)
goto end_branch_1
} else {
...
{
if (gopurs_runtime.Apply2(Get_lessThanOrEq(), (*pkg_Data_Tuple.Constructor_Tuple)(v_7.UnsafePtr).V1, gopurs_runtime.Int(0)).IntVal) != (0) {
__t7 = gopurs_runtime.Apply(gopurs_runtime.RecordGet(__local_var_3_1, "pure"), gopurs_runtime.Value{Type: 9, IntVal: 60402430, UnsafePtr: unsafe.Pointer(&pkg_Control_Monad_Rec_Class.Constructor_Done{(*pkg_Data_Tuple.Constructor_Tuple)(v_7.UnsafePtr).V0})})
goto end_branch_7
} else {
...
{
__local_var_8_5 := (*pkg_Data_Tuple.Constructor_Tuple)(v_7.UnsafePtr).V0
_ = __local_var_8_5
__local_var_9_6 := (*pkg_Data_Tuple.Constructor_Tuple)(v_7.UnsafePtr).V1
_ = __local_var_9_6
...
return gopurs_runtime.Apply(gopurs_runtime.RecordGet(__local_var_3_1, "pure"), gopurs_runtime.Value{Type: 9, IntVal: 525585346, UnsafePtr: unsafe.Pointer(&pkg_Control_Monad_Rec_Class.Constructor_Loop{gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&pkg_Data_Tuple.Constructor_Tuple{gopurs_runtime.Value{Type: 9, IntVal: 759514854, UnsafePtr: unsafe.Pointer(&Constructor_Cons{x_10, __local_var_8_5})}, gopurs_runtime.Int((__local_var_9_6.IntVal) - (1))})}})})
}))
}
end_branch_7:
return __t7
...
__t3 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just{gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&pkg_Data_Tuple.Constructor_Tuple{(*Constructor_Cons)(v_7.UnsafePtr).V0, (*Constructor_Cons)(v_7.UnsafePtr).V1})}})}
goto end_branch_3
} else {
...
var __t3 gopurs_runtime.Value
{
var __t_tag_4 gopurs_runtime.Value = (*Constructor_Cons)(v1_6.UnsafePtr).V1
if (__t_tag_4.Type == 9 && __t_tag_4.IntVal == 583744028) {
__t3 = (*Constructor_Cons)(v1_6.UnsafePtr).V0
goto end_branch_3
} else {
...
v1_6_loop = (*Constructor_Cons)(v1_6.UnsafePtr).V1
continue go__4_1
...
__t2 = gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&pkg_Data_Tuple.Constructor_Tuple{gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just{gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Ring.Get_ringNumber(), "sub"), pos_3, __local_var_1_0)})}, __local_var_2_1})}
goto end_branch_2
} else {
...
{
__t2 = gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&pkg_Data_Tuple.Constructor_Tuple{gopurs_runtime.Value{Type: 9, IntVal: 3589588149, UnsafePtr: nil}, __local_var_2_1})}
}
end_branch_2:
return __t2
})
...
return (*pkg_Data_Tuple.Constructor_Tuple)(gopurs_runtime.Apply(__local_var_5_2, x_6).UnsafePtr).V1
}))
})
}
...
__t1 = gopurs_runtime.Value{Type: 9, IntVal: 525585346, UnsafePtr: unsafe.Pointer(&pkg_Control_Monad_Rec_Class.Constructor_Loop{pkg_Data_Unit.Get_unit()})}
goto end_branch_1
} else {
...
__t1 = gopurs_runtime.Value{Type: 9, IntVal: 60402430, UnsafePtr: unsafe.Pointer(&pkg_Control_Monad_Rec_Class.Constructor_Done{(*pkg_Data_Maybe.Constructor_Just)(a_5.UnsafePtr).V0})}
goto end_branch_1
} else {
...
__t2 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just{a_6})}
goto end_branch_2
} else {
