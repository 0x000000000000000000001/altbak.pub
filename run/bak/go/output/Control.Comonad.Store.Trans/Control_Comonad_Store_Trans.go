...
__local_var_2_0 := (*pkg_Data_Tuple.Constructor_Tuple)(v_1.UnsafePtr).V1
_ = __local_var_2_0
...
}), (*pkg_Data_Tuple.Constructor_Tuple)(v_1.UnsafePtr).V0)
}))
	})
...
return gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&pkg_Data_Tuple.Constructor_Tuple{gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictFunctor_0.UnsafePtr)).V0, gopurs_runtime.Func2(func(h_3 gopurs_runtime.Value, x_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(f_1, gopurs_runtime.Apply(h_3, x_4))
}), (*pkg_Data_Tuple.Constructor_Tuple)(v_2.UnsafePtr).V0), (*pkg_Data_Tuple.Constructor_Tuple)(v_2.UnsafePtr).V1})}
}))
}
...
return gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&pkg_Data_Tuple.Constructor_Tuple{gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_1_0, "map"), gopurs_runtime.Func2(func(h_4 gopurs_runtime.Value, x_5 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(f_2, gopurs_runtime.Apply(h_4, x_5))
}), (*pkg_Data_Tuple.Constructor_Tuple)(v_3.UnsafePtr).V0), (*pkg_Data_Tuple.Constructor_Tuple)(v_3.UnsafePtr).V1})}
}))
...
return gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&pkg_Data_Tuple.Constructor_Tuple{gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictExtend_0.UnsafePtr)).V0, gopurs_runtime.Func2(func(w_prime_5 gopurs_runtime.Value, s_prime_6 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(f_3, gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&pkg_Data_Tuple.Constructor_Tuple{w_prime_5, s_prime_6})})
}), (*pkg_Data_Tuple.Constructor_Tuple)(v_4.UnsafePtr).V0), (*pkg_Data_Tuple.Constructor_Tuple)(v_4.UnsafePtr).V1})}
}))
}
...
return gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&pkg_Data_Tuple.Constructor_Tuple{gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_2_1, "map"), gopurs_runtime.Func2(func(h_5 gopurs_runtime.Value, x_6 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&pkg_Data_Tuple.Constructor_Tuple{gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_1_0, "extend"), gopurs_runtime.Func2(func(w_prime_6 gopurs_runtime.Value, s_prime_7 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(f_4, gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&pkg_Data_Tuple.Constructor_Tuple{w_prime_6, s_prime_7})})
}), (*pkg_Data_Tuple.Constructor_Tuple)(v_5.UnsafePtr).V0), (*pkg_Data_Tuple.Constructor_Tuple)(v_5.UnsafePtr).V1})}
}))
_ = extendStoreT1_3_2
...
return gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictComonad_0.UnsafePtr)).V0, (*pkg_Data_Tuple.Constructor_Tuple)(v_4.UnsafePtr).V0, (*pkg_Data_Tuple.Constructor_Tuple)(v_4.UnsafePtr).V1)
}))
}
