...
return gopurs_runtime.Bool((gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_HeytingAlgebra.Get_heytingAlgebraBoolean(), "conj"), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Date.Get_eqDate(), "eq"), (*Constructor_DateTime)(x_0.UnsafePtr).V0, (*Constructor_DateTime)(y_1.UnsafePtr).V0), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Time.Get_eqTime(), "eq"), (*Constructor_DateTime)(x_0.UnsafePtr).V1, (*Constructor_DateTime)(y_1.UnsafePtr).V1)).IntVal) != (0))
})
}))
	})
...
_ = v_0
return gopurs_runtime.RecordDict([]string{"day", "hour", "millisecond", "minute", "month", "second", "year"}, []gopurs_runtime.Value{gopurs_runtime.Int(gopurs_runtime.Apply(gopurs_runtime.RecordGet(pkg_Data_Date_Component.Get_boundedEnumDay(), "fromEnum"), gopurs_runtime.Int((*pkg_Data_Date.Constructor_Date)((*Constructor_DateTime)(v_0.UnsafePtr).V0.UnsafePtr).V2)).IntVal), gopurs_runtime.Int(gopurs_runtime.Apply(gopurs_runtime.RecordGet(pkg_Data_Time_Component.Get_boundedEnumHour(), "fromEnum"), gopurs_runtime.Int((*pkg_Data_Time.Constructor_Time)((*Constructor_DateTime)(v_0.UnsafePtr).V1.UnsafePtr).V0)).IntVal), gopurs_runtime.Int(gopurs_runtime.Apply(gopurs_runtime.RecordGet(pkg_Data_Time_Component.Get_boundedEnumMillisecond(), "fromEnum"), gopurs_runtime.Int((*pkg_Data_Time.Constructor_Time)((*Constructor_DateTime)(v_0.UnsafePtr).V1.UnsafePtr).V3)).IntVal), gopurs_runtime.Int(gopurs_runtime.Apply(gopurs_runtime.RecordGet(pkg_Data_Time_Component.Get_boundedEnumMinute(), "fromEnum"), gopurs_runtime.Int((*pkg_Data_Time.Constructor_Time)((*Constructor_DateTime)(v_0.UnsafePtr).V1.UnsafePtr).V1)).IntVal), gopurs_runtime.Int(gopurs_runtime.Apply(gopurs_runtime.RecordGet(pkg_Data_Date_Component.Get_boundedEnumMonth(), "fromEnum"), (*pkg_Data_Date.Constructor_Date)((*Constructor_DateTime)(v_0.UnsafePtr).V0.UnsafePtr).V1).IntVal), gopurs_runtime.Int(gopurs_runtime.Apply(gopurs_runtime.RecordGet(pkg_Data_Time_Component.Get_boundedEnumSecond(), "fromEnum"), gopurs_runtime.Int((*pkg_Data_Time.Constructor_Time)((*Constructor_DateTime)(v_0.UnsafePtr).V1.UnsafePtr).V2)).IntVal), gopurs_runtime.Int(gopurs_runtime.Apply(gopurs_runtime.RecordGet(pkg_Data_Date_Component.Get_boundedEnumYear(), "fromEnum"), gopurs_runtime.Int((*pkg_Data_Date.Constructor_Date)((*Constructor_DateTime)(v_0.UnsafePtr).V0.UnsafePtr).V0)).IntVal)})
}
