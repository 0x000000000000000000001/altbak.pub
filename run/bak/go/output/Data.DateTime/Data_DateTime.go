...
_ = v_2
return gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictFunctor_0.UnsafePtr)).V0, gopurs_runtime.Apply(Get_DateTime(), (*Data_Data_DateTime_DateTime)(v_2.UnsafePtr).V0), gopurs_runtime.Apply(f_1, (*Data_Data_DateTime_DateTime)(v_2.UnsafePtr).V1))
}
