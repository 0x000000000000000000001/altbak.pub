...
\PhpursThunks::$thunks['Data_Set_foldableSet'] = function() { $v = ["foldMap" => function($dictMonoid_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_Set_eq1Set'] = function() { $v = ["eq1" => (function() {
...
\PhpursThunks::$thunks['Data_Set_ord1Set'] = function() { $v = ["compare1" => function($dictOrd_0 = null) {
  $__num = \func_num_args();
