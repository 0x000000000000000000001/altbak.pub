...
end_branch_2:
return gopurs_runtime.Bool(gopurs_runtime.Bool(__t1.IntVal != __t2.IntVal).IntVal != 0 && gopurs_runtime.Bool(gopurs_runtime.UncurriedApp3(pkg_Data_Map_Internal.Get_unsafeDifference(), compare_1_0, s1_2, s2_3).StrVal == "Leaf").IntVal != 0)
})
})
	})
	return properSubset
