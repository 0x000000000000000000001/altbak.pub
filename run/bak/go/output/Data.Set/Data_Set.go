...
return gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Call_identity((*pkg_Data_Maybe.Constructor_Just[interface{}])(x_0_box.UnsafePtr)))}
})
	})
...
return gopurs_runtime.Value{Type: 9, IntVal: 324739070, UnsafePtr: unsafe.Pointer(Call_toMap((*pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value])(v_0_box.UnsafePtr)))}
})
	})
	return cache_toMap
}
...
func Get_size() gopurs_runtime.Value {
	once_size.Do(func() {
		cache_size = gopurs_runtime.Func(func(arg0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Int(func(inner_arg0 *pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value]) int64 {
return gopurs_runtime.Apply(pkg_Data_Map_Internal.Get_size__func_ptrData_Map_Internal_Constructor_Node[interface____gopurs_runtime_Value]__int64_2718636619(), gopurs_runtime.Value{Type: 9, IntVal: 324739070, UnsafePtr: unsafe.Pointer(inner_arg0)}).IntVal
}((*pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value])(arg0.UnsafePtr)))
})
	})
	return cache_size
}
...
return gopurs_runtime.Value{Type: 9, IntVal: 324739070, UnsafePtr: unsafe.Pointer(Call_singleton(gopurs_runtime.UnboxAny(a_0_box)))}
})
	})
	return cache_singleton
}

var cache_singleton__func_interface____ptrData_Map_Internal_Constructor_Node[interface____gopurs_runtime_Value]_2466601955 gopurs_runtime.Value
var once_singleton__func_interface____ptrData_Map_Internal_Constructor_Node[interface____gopurs_runtime_Value]_2466601955 sync.Once
func Get_singleton__func_interface____ptrData_Map_Internal_Constructor_Node[interface____gopurs_runtime_Value]_2466601955() gopurs_runtime.Value {
	once_singleton__func_interface____ptrData_Map_Internal_Constructor_Node[interface____gopurs_runtime_Value]_2466601955.Do(func() {
		cache_singleton__func_interface____ptrData_Map_Internal_Constructor_Node[interface____gopurs_runtime_Value]_2466601955 = gopurs_runtime.Func(func(a_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 324739070, UnsafePtr: unsafe.Pointer(Call_singleton__func_interface____ptrData_Map_Internal_Constructor_Node[interface____gopurs_runtime_Value]_2466601955(gopurs_runtime.UnboxAny(a_0_box)))}
})
	})
	return cache_singleton__func_interface____ptrData_Map_Internal_Constructor_Node[interface____gopurs_runtime_Value]_2466601955
}
...
return gopurs_runtime.Any(Call_showSet(dictShow_0_box))
})
	})
...
return gopurs_runtime.Any(Call_semigroupSet(dictOrd_0_box))
})
	})
...
func Get_isEmpty() gopurs_runtime.Value {
	once_isEmpty.Do(func() {
		cache_isEmpty = gopurs_runtime.Func(func(arg0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Bool(func(inner_arg0 *pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value]) bool {
return (gopurs_runtime.Apply(pkg_Data_Map_Internal.Get_isEmpty__func_ptrData_Map_Internal_Constructor_Node[interface____gopurs_runtime_Value]__bool_4056224668(), gopurs_runtime.Value{Type: 9, IntVal: 324739070, UnsafePtr: unsafe.Pointer(inner_arg0)}).IntVal) != (0)
}((*pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value])(arg0.UnsafePtr)))
})
	})
...
return gopurs_runtime.Value{Type: 9, IntVal: 324739070, UnsafePtr: unsafe.Pointer(Call_insert(dictOrd_0_box, gopurs_runtime.UnboxAny(a_1_box), (*pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value])(v_2_box.UnsafePtr)))}
})
	})
	return cache_insert
}
...
func Get_fromMap() gopurs_runtime.Value {
	once_fromMap.Do(func() {
		cache_fromMap = gopurs_runtime.Func(func(arg0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 324739070, UnsafePtr: unsafe.Pointer(func(inner_arg0 *pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value]) *pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value] {
return (*pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value])(gopurs_runtime.Apply(Get_Set(), gopurs_runtime.Value{Type: 9, IntVal: 324739070, UnsafePtr: unsafe.Pointer(inner_arg0)}).UnsafePtr)
}((*pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value])(arg0.UnsafePtr)))}
})
	})
...
func Get_foldableSet() gopurs_runtime.Value {
	once_foldableSet.Do(func() {
		cache_foldableSet = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict3("foldMap", "foldl", "foldr", gopurs_runtime.Func(func(dictMonoid_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Call_findMin((*pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value])(v_0_box.UnsafePtr)))}
})
	})
...
return gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Call_findMax((*pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value])(v_0_box.UnsafePtr)))}
})
	})
...
return gopurs_runtime.Any(Call_eqSet(dictEq_0_box))
})
	})
	return cache_eqSet
}
...
return gopurs_runtime.Any(Call_ordSet(dictOrd_0_box))
})
	})
	return cache_ordSet
}
...
func Get_eq1Set() gopurs_runtime.Value {
	once_eq1Set.Do(func() {
		cache_eq1Set = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("eq1", gopurs_runtime.Func3(func(dictEq_0 gopurs_runtime.Value, v_1 gopurs_runtime.Value, v1_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_ord1Set() gopurs_runtime.Value {
	once_ord1Set.Do(func() {
		cache_ord1Set = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Eq10", "compare1", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return Get_eq1Set()
}), gopurs_runtime.Func(func(dictOrd_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.RecordGet(gopurs_runtime.Any(Call_ordSet(dictOrd_0)), "compare")
}))))
	})
...
func Get_empty() gopurs_runtime.Value {
	once_empty.Do(func() {
		cache_empty = gopurs_runtime.Value{Type: 9, IntVal: 324739070, UnsafePtr: unsafe.Pointer((*pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value])(gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 324739070, UnsafePtr: nil}).UnsafePtr))}
	})
	return cache_empty
}
...
return Call_map_(dictOrd_0_box, func(inner_arg0 interface{}) interface{} {
...
return gopurs_runtime.Any(Call_monoidSet(dictOrd_0_box))
})
	})
...
func Call_identity(x_0_loop *pkg_Data_Maybe.Constructor_Just[interface{}]) *pkg_Data_Maybe.Constructor_Just[interface{}] {
...
__t1 = gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]{gopurs_runtime.UnboxAny(pkg_Data_Unit.Get_unit())})})
goto end_branch_1
} else {
...
func Call_toMap(v_0_loop *pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value]) *pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value] {
var v_0 *pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value] = v_0_loop
_ = v_0
return v_0
}
...
func Call_singleton(a_0_loop interface{}) *pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value] {
var a_0 interface{} = a_0_loop
_ = a_0
return (*pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value])(gopurs_runtime.Value{Type: 9, IntVal: 324739070, UnsafePtr: unsafe.Pointer(&pkg_Data_Map_Internal.Constructor_Node[gopurs_runtime.Value, gopurs_runtime.Value]{1, 1, a_0, gopurs_runtime.UnboxAny(pkg_Data_Unit.Get_unit()), (*pkg_Data_Map_Internal.Constructor_Node[interface{}, interface{}])(gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 324739070, UnsafePtr: nil}).UnsafePtr), (*pkg_Data_Map_Internal.Constructor_Node[interface{}, interface{}])(gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 324739070, UnsafePtr: nil}).UnsafePtr)})}.UnsafePtr)
}

func Call_singleton__func_interface____ptrData_Map_Internal_Constructor_Node[interface____gopurs_runtime_Value]_2466601955(a_0_loop interface{}) *pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value] {
var a_0 interface{} = a_0_loop
_ = a_0
return (*pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value])(gopurs_runtime.Value{Type: 9, IntVal: 324739070, UnsafePtr: unsafe.Pointer(&pkg_Data_Map_Internal.Constructor_Node[gopurs_runtime.Value, gopurs_runtime.Value]{1, 1, a_0, gopurs_runtime.UnboxAny(pkg_Data_Unit.Get_unit()), (*pkg_Data_Map_Internal.Constructor_Node[interface{}, interface{}])(gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 324739070, UnsafePtr: nil}).UnsafePtr), (*pkg_Data_Map_Internal.Constructor_Node[interface{}, interface{}])(gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 324739070, UnsafePtr: nil}).UnsafePtr)})}.UnsafePtr)
}

func Call_showSet(dictShow_0_loop gopurs_runtime.Value) interface{} {
var dictShow_0 gopurs_runtime.Value = dictShow_0_loop
_ = dictShow_0
return gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("show", gopurs_runtime.Func(func(s_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_semigroupSet(dictOrd_0_loop gopurs_runtime.Value) interface{} {
var dictOrd_0 gopurs_runtime.Value = dictOrd_0_loop
_ = dictOrd_0
compare_1_0 := gopurs_runtime.RecordGet(dictOrd_0, "compare")
_ = compare_1_0
return gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("append", gopurs_runtime.Func2(func(m1_2 gopurs_runtime.Value, m2_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.UncurriedApp4(pkg_Data_Map_Internal.Get_unsafeUnionWith(), compare_1_0, pkg_Data_Function.Get_const_(), m1_2, m2_3)
})))
}
...
{
if (v_3.Type == 9 && v_3.IntVal == 324739070 && v_3.UnsafePtr != nil) {
v1_4_2 := gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictOrd_0, "compare"), gopurs_runtime.Any(k_1), gopurs_runtime.Any((*pkg_Data_Map_Internal.Constructor_Node[gopurs_runtime.Value, gopurs_runtime.Value])(v_3.UnsafePtr).V2))
_ = v1_4_2
var __t3 gopurs_runtime.Value
{
if (v1_4_2.Type == 9 && v1_4_2.IntVal == 1527465420) {
v_3_loop = gopurs_runtime.UnboxAny(gopurs_runtime.Value{Type: 9, IntVal: 324739070, UnsafePtr: unsafe.Pointer((*pkg_Data_Map_Internal.Constructor_Node[gopurs_runtime.Value, gopurs_runtime.Value])(v_3.UnsafePtr).V4)})
continue go__2_0
...
v_3_loop = gopurs_runtime.UnboxAny(gopurs_runtime.Value{Type: 9, IntVal: 324739070, UnsafePtr: unsafe.Pointer((*pkg_Data_Map_Internal.Constructor_Node[gopurs_runtime.Value, gopurs_runtime.Value])(v_3.UnsafePtr).V5)})
continue go__2_0
__t3 = gopurs_runtime.Value{}
goto end_branch_3
} else {
...
func Call_insert(dictOrd_0_loop gopurs_runtime.Value, a_1_loop interface{}, v_2_loop *pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value]) *pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value] {
var dictOrd_0 gopurs_runtime.Value = dictOrd_0_loop
_ = dictOrd_0
var a_1 interface{} = a_1_loop
_ = a_1
var v_2 *pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value] = v_2_loop
_ = v_2
return (*pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value])(gopurs_runtime.Apply4(pkg_Data_Map_Internal.Get_insert(), dictOrd_0, gopurs_runtime.Any(a_1), pkg_Data_Unit.Get_unit(), gopurs_runtime.Value{Type: 9, IntVal: 324739070, UnsafePtr: unsafe.Pointer(v_2)}).UnsafePtr)
}

func Call_findMin(v_0_loop *pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value]) *pkg_Data_Maybe.Constructor_Just[interface{}] {
var v_0 *pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value] = v_0_loop
_ = v_0
return (*pkg_Data_Maybe.Constructor_Just[interface{}])(gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Maybe.Get_functorMaybe(), "map"), gopurs_runtime.Func(func(v1_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_findMax(v_0_loop *pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value]) *pkg_Data_Maybe.Constructor_Just[interface{}] {
var v_0 *pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value] = v_0_loop
_ = v_0
return (*pkg_Data_Maybe.Constructor_Just[interface{}])(gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Maybe.Get_functorMaybe(), "map"), gopurs_runtime.Func(func(v1_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.RecordGet(v1_1, "key")
...
func Call_eqSet(dictEq_0_loop gopurs_runtime.Value) interface{} {
var dictEq_0 gopurs_runtime.Value = dictEq_0_loop
_ = dictEq_0
return gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("eq", gopurs_runtime.Func2(func(v_1 gopurs_runtime.Value, v1_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(gopurs_runtime.Apply2(pkg_Data_Map_Internal.Get_eqMap(), dictEq_0, pkg_Data_Eq.Get_eqUnit()), "eq"), v_1, v1_2)
})))
}

func Call_ordSet(dictOrd_0_loop gopurs_runtime.Value) interface{} {
var dictOrd_0 gopurs_runtime.Value = dictOrd_0_loop
_ = dictOrd_0
...
func Call_map_(dictOrd_0_loop gopurs_runtime.Value, f_1_loop func(interface{}) interface{}) gopurs_runtime.Value {
var dictOrd_0 gopurs_runtime.Value = dictOrd_0_loop
_ = dictOrd_0
...
return gopurs_runtime.Apply4(pkg_Data_Map_Internal.Get_insert(), dictOrd_0, gopurs_runtime.Any(f_1(gopurs_runtime.UnboxAny(a_3))), pkg_Data_Unit.Get_unit(), m_2)
}), gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 324739070, UnsafePtr: nil}))
}

func Call_mapMaybe(dictOrd_0_loop gopurs_runtime.Value, f_1_loop func(interface{}) *pkg_Data_Maybe.Constructor_Just[interface{}]) gopurs_runtime.Value {
var dictOrd_0 gopurs_runtime.Value = dictOrd_0_loop
_ = dictOrd_0
...
__local_var_4_0 := gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(f_1(gopurs_runtime.UnboxAny(a_2)))}
_ = __local_var_4_0
var __t1 gopurs_runtime.Value
{
...
{
if (__local_var_4_0.Type == 9 && __local_var_4_0.IntVal == 930809136 && __local_var_4_0.UnsafePtr != nil) {
__t1 = gopurs_runtime.Apply4(pkg_Data_Map_Internal.Get_insert(), dictOrd_0, gopurs_runtime.Any((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(__local_var_4_0.UnsafePtr).V0), pkg_Data_Unit.Get_unit(), acc_3)
goto end_branch_1
} else {
...
func Call_monoidSet(dictOrd_0_loop gopurs_runtime.Value) interface{} {
var dictOrd_0 gopurs_runtime.Value = dictOrd_0_loop
_ = dictOrd_0
...
var dictOrd_0 gopurs_runtime.Value = dictOrd_0_loop
_ = dictOrd_0
return Call_mapMaybe(dictOrd_0, func(inner_arg0 interface{}) *pkg_Data_Maybe.Constructor_Just[interface{}] {
