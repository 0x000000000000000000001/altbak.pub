...
var cache_absurd__gopurs_runtime_Value_1344965310 gopurs_runtime.Value
var once_absurd__gopurs_runtime_Value_1344965310 sync.Once
func Get_absurd__gopurs_runtime_Value_1344965310() gopurs_runtime.Value {
	once_absurd__gopurs_runtime_Value_1344965310.Do(func() {
		cache_absurd__gopurs_runtime_Value_1344965310 = gopurs_runtime.Func(func(a_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_absurd__gopurs_runtime_Value_1344965310(a_0_box)
})
	})
	return cache_absurd__gopurs_runtime_Value_1344965310
}

var cache_absurd__gopurs_runtime_Value_1234480061 gopurs_runtime.Value
var once_absurd__gopurs_runtime_Value_1234480061 sync.Once
func Get_absurd__gopurs_runtime_Value_1234480061() gopurs_runtime.Value {
	once_absurd__gopurs_runtime_Value_1234480061.Do(func() {
		cache_absurd__gopurs_runtime_Value_1234480061 = gopurs_runtime.Func(func(a_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_absurd__gopurs_runtime_Value_1234480061(a_0_box)
})
	})
	return cache_absurd__gopurs_runtime_Value_1234480061
}
...
func Call_absurd__gopurs_runtime_Value_1344965310(a_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
var a_0 gopurs_runtime.Value = a_0_loop
_ = a_0
var spin_1_0 gopurs_runtime.Value
spin_1_0 = gopurs_runtime.Func(func(v_2_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_absurd__gopurs_runtime_Value_1234480061(a_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
var a_0 gopurs_runtime.Value = a_0_loop
_ = a_0
var spin_1_0 gopurs_runtime.Value
spin_1_0 = gopurs_runtime.Func(func(v_2_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
