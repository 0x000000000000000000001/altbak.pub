...
return gopurs_runtime.Any(Call_genTime(dictMonadGen_0_box))
})
	})
	return cache_genTime
}

func Call_genTime(dictMonadGen_0_loop gopurs_runtime.Value) interface{} {
