...
var cache_succC__gopurs_runtime_Value_3882721754 gopurs_runtime.Value
var once_succC__gopurs_runtime_Value_3882721754 sync.Once
func Get_succC__gopurs_runtime_Value_3882721754() gopurs_runtime.Value {
	once_succC__gopurs_runtime_Value_3882721754.Do(func() {
		cache_succC__gopurs_runtime_Value_3882721754 = gopurs_runtime.Func3(func(n_0_box gopurs_runtime.Value, f_1_box gopurs_runtime.Value, x_2_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_succC__gopurs_runtime_Value_3882721754(n_0_box, f_1_box, x_2_box)
})
	})
	return cache_succC__gopurs_runtime_Value_3882721754
}
...
var cache_mulC__gopurs_runtime_Value_2338611642 gopurs_runtime.Value
var once_mulC__gopurs_runtime_Value_2338611642 sync.Once
func Get_mulC__gopurs_runtime_Value_2338611642() gopurs_runtime.Value {
	once_mulC__gopurs_runtime_Value_2338611642.Do(func() {
		cache_mulC__gopurs_runtime_Value_2338611642 = gopurs_runtime.Func4(func(m_0_box gopurs_runtime.Value, n_1_box gopurs_runtime.Value, f_2_box gopurs_runtime.Value, x_3_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_mulC__gopurs_runtime_Value_2338611642(m_0_box, n_1_box, f_2_box, x_3_box)
})
	})
	return cache_mulC__gopurs_runtime_Value_2338611642
}
...
func Call_succC__gopurs_runtime_Value_3882721754(n_0_loop gopurs_runtime.Value, f_1_loop gopurs_runtime.Value, x_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
var n_0 gopurs_runtime.Value = n_0_loop
_ = n_0
var f_1 gopurs_runtime.Value = f_1_loop
_ = f_1
...
func Call_mulC__gopurs_runtime_Value_2338611642(m_0_loop gopurs_runtime.Value, n_1_loop gopurs_runtime.Value, f_2_loop gopurs_runtime.Value, x_3_loop gopurs_runtime.Value) gopurs_runtime.Value {
var m_0 gopurs_runtime.Value = m_0_loop
_ = m_0
var n_1 gopurs_runtime.Value = n_1_loop
_ = n_1
