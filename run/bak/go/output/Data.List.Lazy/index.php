...
return ((($GLOBALS['Data_List_Lazy_Types_foldableList'] ?? \PhpursThunks::eval('Data_List_Lazy_Types_foldableList')))['foldMap'])(["mempty" => false, "Semigroup0" => function($dollar__unused_1 = null) use ($semigroupDisj1_0_0) {
  $__num = \func_num_args();
...
$__t1 = ["init" => (($GLOBALS['Data_Lazy_defer'] ?? \PhpursThunks::eval('Data_Lazy_defer')))(function($v_6 = null) use ($__local_var_3_2, $__local_var_5_4) {
  $__num = \func_num_args();
...
goto end_branch_1;;
  ...
  $__t1 = ["init" => ($GLOBALS['Data_List_Lazy_Types_nil'] ?? \PhpursThunks::eval('Data_List_Lazy_Types_nil')), "rest" => $xs_1];
  end_branch_1:;
  $__res = $__t1;
  goto __end;;
  __end:
...
\PhpursThunks::$thunks['Data_List_Lazy_partition'] = function() { $v = function($f_0 = null) {
  ...
  $__t0 = null;;
  if (($f_0)($x_1)) {
$__t0 = ["yes" => (($GLOBALS['Data_Lazy_defer'] ?? \PhpursThunks::eval('Data_Lazy_defer')))(function($v_3 = null) use ($v_2, $x_1) {
  $__num = \func_num_args();
...
goto end_branch_0;;
  ...
  $__t0 = ["yes" => ($v_2)['yes'], "no" => (($GLOBALS['Data_Lazy_defer'] ?? \PhpursThunks::eval('Data_Lazy_defer')))(function($v_3 = null) use ($v_2, $x_1) {
  $__num = \func_num_args();
  ...
  return $__fn;
})()))(["yes" => ($GLOBALS['Data_List_Lazy_Types_nil'] ?? \PhpursThunks::eval('Data_List_Lazy_Types_nil')), "no" => ($GLOBALS['Data_List_Lazy_Types_nil'] ?? \PhpursThunks::eval('Data_List_Lazy_Types_nil'))]);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}; return $v; };
...
\PhpursThunks::$thunks['Data_List_Lazy_newtypePattern'] = function() { $v = ["Coercible0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
