...
v_6_loop = __local_var_4_5.PtrVal.(func(gopurs_runtime.Value) gopurs_runtime.Value)(v_6.PtrVal.(map[string]gopurs_runtime.Value)["value0"])
continue go__5_8
...
v_2_loop = gopurs_runtime.Apply(pkg_Data_Lazy.Get_force(), gopurs_runtime.Apply(pkg_Unsafe_Coerce.Get_unsafeCoerce(), v_2.PtrVal.(map[string]gopurs_runtime.Value)["value1"]))
continue go__1_0
...
{
v_1_loop = gopurs_runtime.Apply(pkg_Data_Lazy.Get_force(), gopurs_runtime.Apply(pkg_Unsafe_Coerce.Get_unsafeCoerce(), v_1.PtrVal.(map[string]gopurs_runtime.Value)["value1"]))
continue go__0_0
...
{
v_2_loop = gopurs_runtime.Apply(pkg_Data_Lazy.Get_force(), gopurs_runtime.Apply(pkg_Unsafe_Coerce.Get_unsafeCoerce(), v_2.PtrVal.(map[string]gopurs_runtime.Value)["value1"]))
v1_3_loop = gopurs_runtime.Apply(gopurs_runtime.Apply(pkg_Data_Ring.Get_intSub(), v1_3), gopurs_runtime.Int(1))
continue go__1_0
__t2 = gopurs_runtime.Value{}
}
end_branch_2:
...
{
n_2_loop = gopurs_runtime.Apply(gopurs_runtime.Apply(pkg_Data_Semiring.Get_intAdd(), n_2), gopurs_runtime.Int(1))
list_3_loop = __local_var_4_1.PtrVal.(map[string]gopurs_runtime.Value)["value0"].PtrVal.(map[string]gopurs_runtime.Value)["tail"]
continue go__1_0
__t3 = gopurs_runtime.Value{}
}
end_branch_3:
...
{
if (gopurs_runtime.Bool(v1_3.PtrVal.(map[string]gopurs_runtime.Value)["_tag"].StrVal == "Cons")).IntVal != 0 {
v_2_loop = gopurs_runtime.Apply(gopurs_runtime.Apply(pkg_Data_Ring.Get_intSub(), v_2), gopurs_runtime.Int(1))
v1_3_loop = gopurs_runtime.Apply(pkg_Data_Lazy.Get_force(), gopurs_runtime.Apply(pkg_Unsafe_Coerce.Get_unsafeCoerce(), v1_3.PtrVal.(map[string]gopurs_runtime.Value)["value1"]))
continue go__1_0
__t1 = gopurs_runtime.Value{}
goto end_branch_1
} else {
