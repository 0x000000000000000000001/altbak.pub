...
end_branch_4:
if (__t4.IntVal) != (0) {
__t2 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Data_Data_Maybe_Just{pkg_Data_List_Lazy_Types.Get_nil()})}
goto end_branch_2
} else {
...
{
__t2 = gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Maybe.Get_functorMaybe(), "map"), gopurs_runtime.Apply(pkg_Data_List_Lazy_Types.Get_cons(), (*pkg_Data_List_Lazy_Types.Data_Data_List_Lazy_Types_Cons)(v_1.UnsafePtr).V0), gopurs_runtime.Apply(go__0_0, gopurs_runtime.Apply(pkg_Data_Lazy.Get_force(), (*pkg_Data_List_Lazy_Types.Data_Data_List_Lazy_Types_Cons)(v_1.UnsafePtr).V1)))
}
end_branch_2:
__t1 = __t2
goto end_branch_1
...
__t1 = gopurs_runtime.Apply(pkg_Data_Lazy.Get_force(), (*pkg_Data_List_Lazy_Types.Data_Data_List_Lazy_Types_Cons)(v_3.UnsafePtr).V1)
goto end_branch_1
} else {
...
{
if (n_0) == (0) {
__t1 = gopurs_runtime.Apply(pkg_Data_Lazy.Get_force(), (*pkg_Data_List_Lazy_Types.Data_Data_List_Lazy_Types_Cons)(v1_2.UnsafePtr).V1)
goto end_branch_1
} else {
...
__t3 = gopurs_runtime.Apply(pkg_Data_Lazy.Get_force(), (*pkg_Data_List_Lazy_Types.Data_Data_List_Lazy_Types_Cons)(v1_3.UnsafePtr).V1)
goto end_branch_3
} else {
