...
{
__t0 = gopurs_runtime.RecordDict2("_tag", "value0", gopurs_runtime.Str("Just"), gopurs_runtime.Apply2(pkg_Data_String_CodeUnits.Get_take(), i_0, nes_1))
}
end_branch_0:
return __t0
})
...
{
__t0 = gopurs_runtime.RecordDict2("_tag", "value0", gopurs_runtime.Str("Just"), gopurs_runtime.Apply2(pkg_Data_String_CodeUnits.Get_drop(), gopurs_runtime.Int(gopurs_runtime.Apply(pkg_Data_String_CodeUnits.Get_length(), nes_1).IntVal - i_0.IntVal), nes_1))
}
end_branch_0:
return __t0
})
...
{
__t0 = gopurs_runtime.RecordDict2("_tag", "value0", gopurs_runtime.Str("Just"), gopurs_runtime.Apply(pkg_Data_String_CodeUnits.Get_fromCharArray(), v_0))
}
end_branch_0:
return __t0
})
...
var __t0 gopurs_runtime.Value
{
if (gopurs_runtime.Bool(i_0.IntVal >= gopurs_runtime.Apply(pkg_Data_String_CodeUnits.Get_length(), nes_1).IntVal)).IntVal != 0 {
__t0 = gopurs_runtime.RecordDict1("_tag", gopurs_runtime.Str("Nothing"))
goto end_branch_0
} else {
...
{
__t0 = gopurs_runtime.RecordDict2("_tag", "value0", gopurs_runtime.Str("Just"), gopurs_runtime.Apply2(pkg_Data_String_CodeUnits.Get_take(), gopurs_runtime.Int(gopurs_runtime.Apply(pkg_Data_String_CodeUnits.Get_length(), nes_1).IntVal - i_0.IntVal), nes_1))
}
end_branch_0:
return __t0
})
...
{
__t0 = gopurs_runtime.RecordDict2("_tag", "value0", gopurs_runtime.Str("Just"), gopurs_runtime.Apply2(pkg_Data_String_CodeUnits.Get_drop(), i_0, nes_1))
}
end_branch_0:
return __t0
})
