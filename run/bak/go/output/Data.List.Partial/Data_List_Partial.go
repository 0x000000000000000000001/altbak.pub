...
var cache_last__gopurs_runtime_Value_3843077731 gopurs_runtime.Value
var once_last__gopurs_runtime_Value_3843077731 sync.Once
func Get_last__gopurs_runtime_Value_3843077731() gopurs_runtime.Value {
	once_last__gopurs_runtime_Value_3843077731.Do(func() {
		cache_last__gopurs_runtime_Value_3843077731 = gopurs_runtime.Func2(func(_dollar__unused_0_box gopurs_runtime.Value, v_1_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_last__gopurs_runtime_Value_3843077731(_dollar__unused_0_box, (*pkg_Data_List_Types.Constructor_Cons[gopurs_runtime.Value])(v_1_box.UnsafePtr))
})
	})
	return cache_last__gopurs_runtime_Value_3843077731
}
...
func Call_last__gopurs_runtime_Value_3843077731(_dollar__unused_0_loop gopurs_runtime.Value, v_1_loop *pkg_Data_List_Types.Constructor_Cons[gopurs_runtime.Value]) gopurs_runtime.Value {
var _dollar__unused_0 gopurs_runtime.Value = _dollar__unused_0_loop
_ = _dollar__unused_0
var v_1 *pkg_Data_List_Types.Constructor_Cons[gopurs_runtime.Value] = v_1_loop
_ = v_1
...
{
__t1 = gopurs_runtime.Value{Type: 9, IntVal: 1358893437, UnsafePtr: unsafe.Pointer(&pkg_Data_List_Types.Constructor_Cons[gopurs_runtime.Value]{(*pkg_Data_List_Types.Constructor_Cons[gopurs_runtime.Value])(gopurs_runtime.Value{Type: 9, IntVal: 1358893437, UnsafePtr: unsafe.Pointer(v_1)}.UnsafePtr).V0, (*pkg_Data_List_Types.Constructor_Cons[gopurs_runtime.Value])(gopurs_runtime.Apply2(Get_init_(), gopurs_runtime.Value{}, gopurs_runtime.Value{Type: 9, IntVal: 1358893437, UnsafePtr: unsafe.Pointer((*pkg_Data_List_Types.Constructor_Cons[gopurs_runtime.Value])(gopurs_runtime.Value{Type: 9, IntVal: 1358893437, UnsafePtr: unsafe.Pointer(v_1)}.UnsafePtr).V1)}).UnsafePtr)})}
}
end_branch_1:
__t0 = __t1
goto end_branch_0
