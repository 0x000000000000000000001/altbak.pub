...
return Call_eqRecord((*Record_eqRecord_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
...
return Call_eqRec((*Record_)(_dollar__unused_0_box.UnsafePtr), (*Record_eqRecord_gopurs_runtime_Value)(dictEqRecord_1_box.UnsafePtr))
})
	})
	return cache_eqRec
}
...
return Call_eq1((*Record_eq1_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
	return cache_eq1
}
...
return Call_eq((*Record_eq_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
	return cache_eq
}
...
return Call_eqArray((*Record_eq_gopurs_runtime_Value)(dictEq_0_box.UnsafePtr))
})
	})
...
return Call_eqRowCons((*Record_eqRecord_gopurs_runtime_Value)(dictEqRecord_0_box.UnsafePtr), (*Record_)(_dollar__unused_1_box.UnsafePtr), (*Record_reflectSymbol_gopurs_runtime_Value)(dictIsSymbol_2_box.UnsafePtr), (*Record_eq_gopurs_runtime_Value)(dictEq_3_box.UnsafePtr))
})
	})
...
return Call_notEq((*Record_eq_gopurs_runtime_Value)(dictEq_0_box.UnsafePtr), x_1_box, y_2_box)
})
	})
	return cache_notEq
}
...
return Call_notEq1((*Record_eq1_gopurs_runtime_Value)(dictEq1_0_box.UnsafePtr), (*Record_eq_gopurs_runtime_Value)(dictEq_1_box.UnsafePtr))
})
	})
	return cache_notEq1
}
...
func Call_eqRecord(dict_0_loop *Record_eqRecord_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_eqRecord_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.eqRecord
}

func Call_eqRec(_dollar__unused_0_loop *Record_, dictEqRecord_1_loop *Record_eqRecord_gopurs_runtime_Value) gopurs_runtime.Value {
var _dollar__unused_0 *Record_ = _dollar__unused_0_loop
_ = _dollar__unused_0
var dictEqRecord_1 *Record_eqRecord_gopurs_runtime_Value = dictEqRecord_1_loop
_ = dictEqRecord_1
return gopurs_runtime.RecordDict1("eq", gopurs_runtime.Apply(dictEqRecord_1.eqRecord, gopurs_runtime.Value{Type: 9, IntVal: 513803634, UnsafePtr: nil}))
}

func Call_eq1(dict_0_loop *Record_eq1_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_eq1_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.eq1
}

func Call_eq(dict_0_loop *Record_eq_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_eq_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.eq
}

func Call_eqArray(dictEq_0_loop *Record_eq_gopurs_runtime_Value) gopurs_runtime.Value {
var dictEq_0 *Record_eq_gopurs_runtime_Value = dictEq_0_loop
_ = dictEq_0
return gopurs_runtime.RecordDict1("eq", gopurs_runtime.Apply(Get_eqArrayImpl(), dictEq_0.eq))
}

func Call_eqRowCons(dictEqRecord_0_loop *Record_eqRecord_gopurs_runtime_Value, _dollar__unused_1_loop *Record_, dictIsSymbol_2_loop *Record_reflectSymbol_gopurs_runtime_Value, dictEq_3_loop *Record_eq_gopurs_runtime_Value) gopurs_runtime.Value {
var dictEqRecord_0 *Record_eqRecord_gopurs_runtime_Value = dictEqRecord_0_loop
_ = dictEqRecord_0
var _dollar__unused_1 *Record_ = _dollar__unused_1_loop
_ = _dollar__unused_1
var dictIsSymbol_2 *Record_reflectSymbol_gopurs_runtime_Value = dictIsSymbol_2_loop
_ = dictIsSymbol_2
var dictEq_3 *Record_eq_gopurs_runtime_Value = dictEq_3_loop
_ = dictEq_3
...
get_7_0 := gopurs_runtime.Apply(pkg_Record_Unsafe.Get_unsafeGet(), gopurs_runtime.Apply(dictIsSymbol_2.reflectSymbol, gopurs_runtime.Value{Type: 9, IntVal: 513803634, UnsafePtr: nil}))
_ = get_7_0
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_HeytingAlgebra.Get_heytingAlgebraBoolean(), "conj"), gopurs_runtime.Apply2(dictEq_3.eq, gopurs_runtime.Apply(get_7_0, ra_5), gopurs_runtime.Apply(get_7_0, rb_6)), gopurs_runtime.Apply3(dictEqRecord_0.eqRecord, gopurs_runtime.Value{Type: 9, IntVal: 513803634, UnsafePtr: nil}, ra_5, rb_6))
}))
}

func Call_notEq(dictEq_0_loop *Record_eq_gopurs_runtime_Value, x_1_loop gopurs_runtime.Value, y_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictEq_0 *Record_eq_gopurs_runtime_Value = dictEq_0_loop
_ = dictEq_0
...
_ = y_2
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(Get_eqBoolean(), "eq"), gopurs_runtime.Apply2(dictEq_0.eq, x_1, y_2), gopurs_runtime.Bool(false))
}

func Call_notEq1(dictEq1_0_loop *Record_eq1_gopurs_runtime_Value, dictEq_1_loop *Record_eq_gopurs_runtime_Value) gopurs_runtime.Value {
var dictEq1_0 *Record_eq1_gopurs_runtime_Value = dictEq1_0_loop
_ = dictEq1_0
var dictEq_1 *Record_eq_gopurs_runtime_Value = dictEq_1_loop
_ = dictEq_1
eq12_2_0 := gopurs_runtime.Apply(dictEq1_0.eq1, gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictEq_1)})
_ = eq12_2_0
