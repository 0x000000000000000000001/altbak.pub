...
return gopurs_runtime.Any(Call_showEndo(dictShow_0_box))
})
	})
...
return gopurs_runtime.Any(Call_semigroupEndo(dictSemigroupoid_0_box))
})
	})
...
return gopurs_runtime.Any(Call_ordEndo(dictOrd_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monoidEndo(dictCategory_0_box))
})
	})
...
return gopurs_runtime.Any(Call_eqEndo(dictEq_0_box))
})
	})
	return cache_eqEndo
}
...
return gopurs_runtime.Any(Call_boundedEndo(dictBounded_0_box))
})
	})
...
func Call_showEndo(dictShow_0_loop gopurs_runtime.Value) interface{} {
...
func Call_semigroupEndo(dictSemigroupoid_0_loop gopurs_runtime.Value) interface{} {
...
func Call_ordEndo(dictOrd_0_loop gopurs_runtime.Value) interface{} {
var dictOrd_0 gopurs_runtime.Value = dictOrd_0_loop
_ = dictOrd_0
return gopurs_runtime.UnboxAny(dictOrd_0)
}

func Call_monoidEndo(dictCategory_0_loop gopurs_runtime.Value) interface{} {
...
func Call_eqEndo(dictEq_0_loop gopurs_runtime.Value) interface{} {
var dictEq_0 gopurs_runtime.Value = dictEq_0_loop
_ = dictEq_0
return gopurs_runtime.UnboxAny(dictEq_0)
}

func Call_boundedEndo(dictBounded_0_loop gopurs_runtime.Value) interface{} {
