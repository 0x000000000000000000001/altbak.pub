...
go__go_2_0_6 = gopurs_runtime.Func(func(source_3_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Value{Type: 9, IntVal: 1358893437, UnsafePtr: unsafe.Pointer((*Constructor_Cons[gopurs_runtime.Value])(gopurs_runtime.Apply2(go__go_2_0_6, b_1, gopurs_runtime.Value{Type: 9, IntVal: 1358893437, UnsafePtr: nil}).UnsafePtr))}
})
}))
	})
...
return gopurs_runtime.Value{Type: 9, IntVal: 1358893437, UnsafePtr: unsafe.Pointer((*Constructor_Cons[gopurs_runtime.Value])(gopurs_runtime.Apply2(go__go_2_0_7, b_1, gopurs_runtime.Value{Type: 9, IntVal: 1358893437, UnsafePtr: nil}).UnsafePtr))}
})
}))
	})
...
return gopurs_runtime.Bool((gopurs_runtime.Apply3(go__go_3_0_8, xs_1, ys_2, gopurs_runtime.Bool(true)).IntVal) != (0))
})
})
}))
	})
...
return gopurs_runtime.Apply2(go__go_3_0_9, xs_1, ys_2)
})
})
}))
	})
