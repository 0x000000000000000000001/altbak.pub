...
func Get_Nil() gopurs_runtime.Value {
	once_Nil.Do(func() {
		Nil = gopurs_runtime.RecordDict1("_tag", gopurs_runtime.Str("Nil"))
	})
	return Nil
}
...
return gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), value0, value1)
})
})
	})
	return Cons
...
return gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), gopurs_runtime.RecordGet(v_0, "value0"), gopurs_runtime.RecordGet(v_0, "value1"))
})
	})
	return toList
}
...
return gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("NonEmpty"), a_0, gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), gopurs_runtime.RecordGet(v_1, "value0"), gopurs_runtime.RecordGet(v_1, "value1")))
})
	})
	return nelCons
}
...
{
if (gopurs_runtime.Bool(gopurs_runtime.Bool(gopurs_runtime.RecordGet(v1_3, "_tag").StrVal == "Cons").IntVal != 0 && gopurs_runtime.Bool(gopurs_runtime.Bool(gopurs_runtime.RecordGet(gopurs_runtime.RecordGet(v1_3, "value1"), "_tag").StrVal == "Cons").IntVal != 0 && gopurs_runtime.Bool(gopurs_runtime.RecordGet(gopurs_runtime.RecordGet(gopurs_runtime.RecordGet(v1_3, "value1"), "value1"), "_tag").StrVal == "Cons").IntVal != 0).IntVal != 0)).IntVal != 0 {
v_2_loop = gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), v1_3, v_2)
v1_3_loop = gopurs_runtime.RecordGet(gopurs_runtime.RecordGet(gopurs_runtime.RecordGet(v1_3, "value1"), "value1"), "value1")
...
{
if (gopurs_runtime.Bool(gopurs_runtime.Bool(gopurs_runtime.RecordGet(v2_5, "_tag").StrVal == "Cons").IntVal != 0 && gopurs_runtime.Bool(gopurs_runtime.Bool(gopurs_runtime.RecordGet(gopurs_runtime.RecordGet(v2_5, "value0"), "_tag").StrVal == "Cons").IntVal != 0 && gopurs_runtime.Bool(gopurs_runtime.Bool(gopurs_runtime.RecordGet(gopurs_runtime.RecordGet(gopurs_runtime.RecordGet(v2_5, "value0"), "value1"), "_tag").StrVal == "Cons").IntVal != 0 && gopurs_runtime.Bool(gopurs_runtime.RecordGet(gopurs_runtime.RecordGet(gopurs_runtime.RecordGet(gopurs_runtime.RecordGet(v2_5, "value0"), "value1"), "value1"), "_tag").StrVal == "Cons").IntVal != 0).IntVal != 0).IntVal != 0)).IntVal != 0 {
v2_5_loop = gopurs_runtime.RecordGet(v2_5, "value1")
v3_6_loop = gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), gopurs_runtime.Apply(f_0, gopurs_runtime.RecordGet(gopurs_runtime.RecordGet(v2_5, "value0"), "value0")), gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), gopurs_runtime.Apply(f_0, gopurs_runtime.RecordGet(gopurs_runtime.RecordGet(gopurs_runtime.RecordGet(v2_5, "value0"), "value1"), "value0")), gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), gopurs_runtime.Apply(f_0, gopurs_runtime.RecordGet(gopurs_runtime.RecordGet(gopurs_runtime.RecordGet(gopurs_runtime.RecordGet(v2_5, "value0"), "value1"), "value1"), "value0")), v3_6)))
...
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(gopurs_runtime.RecordGet(v1_3, "value1"), "_tag").StrVal == "Cons")).IntVal != 0 {
var __t5 gopurs_runtime.Value
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(gopurs_runtime.RecordGet(gopurs_runtime.RecordGet(v1_3, "value1"), "value1"), "_tag").StrVal == "Nil")).IntVal != 0 {
__t5 = gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), gopurs_runtime.Apply(f_0, gopurs_runtime.RecordGet(v1_3, "value0")), gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), gopurs_runtime.Apply(f_0, gopurs_runtime.RecordGet(gopurs_runtime.RecordGet(v1_3, "value1"), "value0")), gopurs_runtime.RecordDict1("_tag", gopurs_runtime.Str("Nil"))))
goto end_branch_5
} else {
...
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(gopurs_runtime.RecordGet(v1_3, "value1"), "_tag").StrVal == "Nil")).IntVal != 0 {
__t4 = gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), gopurs_runtime.Apply(f_0, gopurs_runtime.RecordGet(v1_3, "value0")), gopurs_runtime.RecordDict1("_tag", gopurs_runtime.Str("Nil")))
goto end_branch_4
} else {
...
{
__t4 = gopurs_runtime.RecordDict1("_tag", gopurs_runtime.Str("Nil"))
}
end_branch_4:
__t3 = __t4
goto end_branch_3
...
{
__t3 = gopurs_runtime.RecordDict1("_tag", gopurs_runtime.Str("Nil"))
}
end_branch_3:
...
return gopurs_runtime.Apply(chunkedRevMap_1_0, gopurs_runtime.RecordDict1("_tag", gopurs_runtime.Str("Nil")))
})
	})
	return listMap
}
...
return gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("NonEmpty"), gopurs_runtime.Apply(f_0, gopurs_runtime.RecordGet(m_1, "value0")), gopurs_runtime.Apply2(Get_listMap(), f_0, gopurs_runtime.RecordGet(m_1, "value1")))
}))
	})
...
__local_var_4_3 := gopurs_runtime.Apply(go__3_1, gopurs_runtime.RecordDict1("_tag", gopurs_runtime.Str("Nil")))
_ = __local_var_4_3
...
b_2_loop = gopurs_runtime.Apply2(f_0, b_2, gopurs_runtime.RecordGet(v_3, "value0"))
...
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonoid_0, "Semigroup0"), gopurs_runtime.Value{}), "append"), gopurs_runtime.Apply(f_2, gopurs_runtime.RecordGet(v_3, "value0")), gopurs_runtime.Apply2(foldMap1_1_0, f_2, gopurs_runtime.RecordGet(v_3, "value1")))
})
...
b_4_loop = gopurs_runtime.Apply2(f_0, b_4, gopurs_runtime.RecordGet(v_5, "value0"))
...
return gopurs_runtime.Apply2(go__3_1, gopurs_runtime.Apply2(f_0, b_1, gopurs_runtime.RecordGet(v_2, "value0")), gopurs_runtime.RecordGet(v_2, "value1"))
}), gopurs_runtime.Func3(func(f_0 gopurs_runtime.Value, b_1 gopurs_runtime.Value, v_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(f_0, gopurs_runtime.RecordGet(v_2, "value0"), gopurs_runtime.Apply3(gopurs_runtime.RecordGet(Get_foldableList(), "foldr"), f_0, b_1, gopurs_runtime.RecordGet(v_2, "value1")))
}))
	})
...
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(v_5, "_tag").StrVal == "Cons")).IntVal != 0 {
b_4_loop = gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Tuple"), gopurs_runtime.Int(gopurs_runtime.RecordGet(b_4, "value0").IntVal + gopurs_runtime.Int(1).IntVal), gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), gopurs_runtime.RecordGet(v_5, "value0"), gopurs_runtime.RecordGet(b_4, "value1")))
v_5_loop = gopurs_runtime.RecordGet(v_5, "value1")
continue go__3_0
...
v_4_2 := gopurs_runtime.Apply2(go__3_0, gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Tuple"), gopurs_runtime.Int(0), gopurs_runtime.RecordDict1("_tag", gopurs_runtime.Str("Nil"))), xs_2)
_ = v_4_2
...
var __t4 gopurs_runtime.Value
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(v_7, "_tag").StrVal == "Nil")).IntVal != 0 {
__t4 = b_6
goto end_branch_4
} else {
...
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(v_7, "_tag").StrVal == "Cons")).IntVal != 0 {
b_6_loop = gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Tuple"), gopurs_runtime.Int(gopurs_runtime.RecordGet(b_6, "value0").IntVal - gopurs_runtime.Int(1).IntVal), gopurs_runtime.Apply3(f_0, gopurs_runtime.Int(gopurs_runtime.RecordGet(b_6, "value0").IntVal - gopurs_runtime.Int(1).IntVal), gopurs_runtime.RecordGet(v_7, "value0"), gopurs_runtime.RecordGet(b_6, "value1")))
v_7_loop = gopurs_runtime.RecordGet(v_7, "value1")
continue go__5_3
...
return gopurs_runtime.RecordGet(gopurs_runtime.Apply2(go__5_3, gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Tuple"), gopurs_runtime.RecordGet(v_4_2, "value0"), b_1), gopurs_runtime.RecordGet(v_4_2, "value1")), "value1")
...
b_3_loop = gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Tuple"), gopurs_runtime.Int(gopurs_runtime.RecordGet(b_3, "value0").IntVal + gopurs_runtime.Int(1).IntVal), gopurs_runtime.Apply3(f_0, gopurs_runtime.RecordGet(b_3, "value0"), gopurs_runtime.RecordGet(b_3, "value1"), gopurs_runtime.RecordGet(v_4, "value0")))
...
__local_var_3_7 := gopurs_runtime.Apply(go__2_5, gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Tuple"), gopurs_runtime.Int(0), acc_1))
_ = __local_var_3_7
return gopurs_runtime.Func(func(x_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.RecordGet(gopurs_runtime.Apply(__local_var_3_7, x_4), "value1")
})
}), gopurs_runtime.Func(func(dictMonoid_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
var __t1 gopurs_runtime.Value
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(x_4, "_tag").StrVal == "Nothing")).IntVal != 0 {
...
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(x_4, "_tag").StrVal == "Just")).IntVal != 0 {
__t1 = gopurs_runtime.Int(gopurs_runtime.Int(1).IntVal + gopurs_runtime.RecordGet(x_4, "value0").IntVal)
goto end_branch_1
} else {
...
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(x_3, "_tag").StrVal == "Just")).IntVal != 0 {
__t2 = gopurs_runtime.Int(gopurs_runtime.Int(1).IntVal + gopurs_runtime.RecordGet(x_3, "value0").IntVal)
goto end_branch_2
} else {
...
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(x_3, "_tag").StrVal == "Just")).IntVal != 0 {
__t3 = gopurs_runtime.Int(gopurs_runtime.Int(1).IntVal + gopurs_runtime.RecordGet(x_3, "value0").IntVal)
goto end_branch_3
} else {
...
return gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), gopurs_runtime.Apply2(f_0, i_1, x_2), acc_3)
...
return gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("NonEmpty"), gopurs_runtime.Apply2(f_0, gopurs_runtime.RecordDict1("_tag", gopurs_runtime.Str("Nothing")), gopurs_runtime.RecordGet(v_1, "value0")), gopurs_runtime.Apply3(gopurs_runtime.RecordGet(Get_foldableWithIndexList(), "foldrWithIndex"), gopurs_runtime.Func3(func(i_2 gopurs_runtime.Value, x_3 gopurs_runtime.Value, acc_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), gopurs_runtime.Apply2(f_0, gopurs_runtime.RecordDict2("_tag", "value0", gopurs_runtime.Str("Just"), i_2), x_3), acc_4)
}), gopurs_runtime.RecordDict1("_tag", gopurs_runtime.Str("Nil")), gopurs_runtime.RecordGet(v_1, "value1")))
})
	})
	return mapWithIndex
}
...
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(x_2, "_tag").StrVal == "Just")).IntVal != 0 {
__t0 = gopurs_runtime.Int(gopurs_runtime.Int(1).IntVal + gopurs_runtime.RecordGet(x_2, "value0").IntVal)
goto end_branch_0
} else {
...
func Get_monoidList() gopurs_runtime.Value {
	once_monoidList.Do(func() {
		monoidList = gopurs_runtime.RecordDict2("mempty", "Semigroup0", gopurs_runtime.RecordDict1("_tag", gopurs_runtime.Str("Nil")), gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("NonEmpty"), gopurs_runtime.RecordGet(v_0, "value0"), gopurs_runtime.Apply3(gopurs_runtime.RecordGet(Get_foldableList(), "foldr"), Get_Cons(), gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), gopurs_runtime.RecordGet(as_prime_1, "value0"), gopurs_runtime.RecordGet(as_prime_1, "value1")), gopurs_runtime.RecordGet(v_0, "value1")))
}))
	})
...
__t3 = gopurs_runtime.RecordDict2("init", "acc", gopurs_runtime.Bool(false), gopurs_runtime.RecordGet(v_5, "value0"))
goto end_branch_3
} else {
...
{
__t3 = gopurs_runtime.RecordDict2("init", "acc", gopurs_runtime.Bool(false), gopurs_runtime.Str(gopurs_runtime.Str(gopurs_runtime.RecordGet(b_4, "acc").StrVal + gopurs_runtime.Str(" : ").StrVal).StrVal + gopurs_runtime.RecordGet(v_5, "value0").StrVal))
}
end_branch_3:
b_4_loop = __t3
v_5_loop = gopurs_runtime.RecordGet(v_5, "value1")
...
__t4 = gopurs_runtime.Str(gopurs_runtime.Str(gopurs_runtime.Str("(").StrVal + gopurs_runtime.RecordGet(gopurs_runtime.Apply2(go__3_1, gopurs_runtime.RecordDict2("init", "acc", gopurs_runtime.Bool(true), gopurs_runtime.Str("")), gopurs_runtime.Apply2(Get_listMap(), show_1_0, v_2)), "acc").StrVal).StrVal + gopurs_runtime.Str(" : Nil)").StrVal)
}
end_branch_4:
return __t4
}))
...
_ = __local_var_1_0
return gopurs_runtime.RecordDict1("show", gopurs_runtime.Func(func(v_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Str(gopurs_runtime.Str(gopurs_runtime.Str(gopurs_runtime.Str(gopurs_runtime.Str("(NonEmptyList (NonEmpty ").StrVal + gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictShow_0, "show"), gopurs_runtime.RecordGet(v_2, "value0")).StrVal).StrVal + gopurs_runtime.Str(" ").StrVal).StrVal + gopurs_runtime.Apply(gopurs_runtime.RecordGet(__local_var_1_0, "show"), gopurs_runtime.RecordGet(v_2, "value1")).StrVal).StrVal + gopurs_runtime.Str("))").StrVal)
}))
})
	})
...
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(v_5, "_tag").StrVal == "Cons")).IntVal != 0 {
b_4_loop = gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), gopurs_runtime.RecordGet(v_5, "value0"), b_4)
v_5_loop = gopurs_runtime.RecordGet(v_5, "value1")
continue go__3_2
...
__local_var_3_1 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(Apply0_1_0, "Functor0"), gopurs_runtime.Value{}), "map"), gopurs_runtime.Apply(go__3_2, gopurs_runtime.RecordDict1("_tag", gopurs_runtime.Str("Nil"))))
_ = __local_var_3_1
...
return gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), a_8, b_7)
}), b_5), gopurs_runtime.Apply(f_2, gopurs_runtime.RecordGet(v_6, "value0")))
...
__local_var_5_6 := gopurs_runtime.Apply(go__4_4, gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictApplicative_0, "pure"), gopurs_runtime.RecordDict1("_tag", gopurs_runtime.Str("Nil"))))
_ = __local_var_5_6
...
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(v_6, "_tag").StrVal == "Cons")).IntVal != 0 {
b_5_loop = gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Tuple"), gopurs_runtime.Int(gopurs_runtime.RecordGet(b_5, "value0").IntVal + gopurs_runtime.Int(1).IntVal), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(Apply0_1_0, "apply"), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(Apply0_1_0, "Functor0"), gopurs_runtime.Value{}), "map"), gopurs_runtime.Func2(func(b_7 gopurs_runtime.Value, a_8 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), a_8, b_7)
}), gopurs_runtime.RecordGet(b_5, "value1")), gopurs_runtime.Apply2(f_2, gopurs_runtime.RecordGet(b_5, "value0"), gopurs_runtime.RecordGet(v_6, "value0"))))
v_6_loop = gopurs_runtime.RecordGet(v_6, "value1")
continue go__4_4
__t5 = gopurs_runtime.Value{}
goto end_branch_5
...
__local_var_5_6 := gopurs_runtime.Apply(go__4_4, gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Tuple"), gopurs_runtime.Int(0), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictApplicative_0, "pure"), gopurs_runtime.RecordDict1("_tag", gopurs_runtime.Str("Nil")))))
_ = __local_var_5_6
return gopurs_runtime.Func(func(x_6 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(__local_var_3_1, gopurs_runtime.RecordGet(gopurs_runtime.Apply(__local_var_5_6, x_6), "value1"))
})
})
}), gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
var source_3 = source_3_loop
_ = source_3
var memo_4 = memo_4_loop
_ = memo_4
v_5_1 := gopurs_runtime.Apply(f_0, source_3)
_ = v_5_1
var __t2 gopurs_runtime.Value
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(gopurs_runtime.RecordGet(v_5_1, "value1"), "_tag").StrVal == "Just")).IntVal != 0 {
source_3_loop = gopurs_runtime.RecordGet(gopurs_runtime.RecordGet(v_5_1, "value1"), "value0")
memo_4_loop = gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), gopurs_runtime.RecordGet(v_5_1, "value0"), memo_4)
continue go__2_0
__t2 = gopurs_runtime.Value{}
goto end_branch_2
} else {
...
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(gopurs_runtime.RecordGet(v_5_1, "value1"), "_tag").StrVal == "Nothing")).IntVal != 0 {
...
var __t4 gopurs_runtime.Value
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(v_8, "_tag").StrVal == "Nil")).IntVal != 0 {
__t4 = b_7
goto end_branch_4
} else {
...
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(v_8, "_tag").StrVal == "Cons")).IntVal != 0 {
b_7_loop = gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), gopurs_runtime.RecordGet(v_8, "value0"), b_7)
v_8_loop = gopurs_runtime.RecordGet(v_8, "value1")
continue go__6_3
__t4 = gopurs_runtime.Value{}
goto end_branch_4
} else {
...
__t2 = gopurs_runtime.Apply2(go__6_3, gopurs_runtime.RecordDict1("_tag", gopurs_runtime.Str("Nil")), gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), gopurs_runtime.RecordGet(v_5_1, "value0"), memo_4))
goto end_branch_2
} else {
...
return gopurs_runtime.Apply2(go__2_0, b_1, gopurs_runtime.RecordDict1("_tag", gopurs_runtime.Str("Nil")))
}))
	})
...
__t2 = gopurs_runtime.Apply2(go__6_3, gopurs_runtime.RecordDict1("_tag", gopurs_runtime.Str("Nil")), memo_4)
goto end_branch_2
} else {
...
source_3_loop = gopurs_runtime.RecordGet(gopurs_runtime.RecordGet(v_5_1, "value0"), "value1")
memo_4_loop = gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), gopurs_runtime.RecordGet(gopurs_runtime.RecordGet(v_5_1, "value0"), "value0"), memo_4)
continue go__2_0
__t2 = gopurs_runtime.Value{}
goto end_branch_2
} else {
...
for {
if false { continue go__3_1 }
var source_4 = source_4_loop
_ = source_4
var memo_5 = memo_5_loop
_ = memo_5
var __t4 gopurs_runtime.Value
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(source_4, "_tag").StrVal == "Just")).IntVal != 0 {
source_4_loop = gopurs_runtime.RecordGet(gopurs_runtime.Apply(f_0, gopurs_runtime.RecordGet(source_4, "value0")), "value1")
memo_5_loop = gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), gopurs_runtime.RecordGet(gopurs_runtime.Apply(f_0, gopurs_runtime.RecordGet(source_4, "value0")), "value0"), memo_5)
continue go__3_1
__t4 = gopurs_runtime.Value{}
goto end_branch_4
} else {
...
__t4 = gopurs_runtime.Apply2(go__6_2, gopurs_runtime.RecordDict1("_tag", gopurs_runtime.Str("Nil")), memo_5)
}
end_branch_4:
return __t4
}
...
return gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("NonEmpty"), gopurs_runtime.RecordGet(__local_var_2_0, "value0"), gopurs_runtime.Apply2(go__3_1, gopurs_runtime.RecordGet(__local_var_2_0, "value1"), gopurs_runtime.RecordDict1("_tag", gopurs_runtime.Str("Nil"))))
}))
	})
...
return gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("NonEmpty"), gopurs_runtime.Apply(f_0, v_1), gopurs_runtime.RecordGet(gopurs_runtime.Apply3(gopurs_runtime.RecordGet(Get_foldableList(), "foldr"), gopurs_runtime.Func2(func(a_2 gopurs_runtime.Value, v1_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.RecordDict2("val", "acc", gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), gopurs_runtime.Apply(f_0, gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("NonEmpty"), a_2, gopurs_runtime.RecordGet(v1_3, "acc"))), gopurs_runtime.RecordGet(v1_3, "val")), gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), a_2, gopurs_runtime.RecordGet(v1_3, "acc")))
}), gopurs_runtime.RecordDict2("val", "acc", gopurs_runtime.RecordDict1("_tag", gopurs_runtime.Str("Nil")), gopurs_runtime.RecordDict1("_tag", gopurs_runtime.Str("Nil"))), gopurs_runtime.RecordGet(v_1, "value1")), "val"))
}), gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return Get_functorNonEmptyList()
}))
	})
...
__t0 = gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), gopurs_runtime.Apply(v_0, v1_1), gopurs_runtime.RecordGet(gopurs_runtime.Apply3(gopurs_runtime.RecordGet(Get_foldableList(), "foldr"), gopurs_runtime.Func2(func(a_prime_2 gopurs_runtime.Value, v2_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.RecordDict2("val", "acc", gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), gopurs_runtime.Apply(v_0, gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), a_prime_2, gopurs_runtime.RecordGet(v2_3, "acc"))), gopurs_runtime.RecordGet(v2_3, "val")), gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), a_prime_2, gopurs_runtime.RecordGet(v2_3, "acc")))
}), gopurs_runtime.RecordDict2("val", "acc", gopurs_runtime.RecordDict1("_tag", gopurs_runtime.Str("Nil")), gopurs_runtime.RecordDict1("_tag", gopurs_runtime.Str("Nil"))), gopurs_runtime.RecordGet(v1_1, "value1")), "val"))
goto end_branch_0
} else {
...
return gopurs_runtime.Bool(gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictEq_0, "eq"), gopurs_runtime.RecordGet(x_1, "value0"), gopurs_runtime.RecordGet(y_2, "value0")).IntVal != 0 && gopurs_runtime.Apply3(go__3_0, gopurs_runtime.RecordGet(x_1, "value1"), gopurs_runtime.RecordGet(y_2, "value1"), gopurs_runtime.Bool(true)).IntVal != 0)
}))
	})
...
v2_6_3 := gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictOrd_0, "compare"), gopurs_runtime.RecordGet(v_4, "value0"), gopurs_runtime.RecordGet(v1_5, "value0"))
_ = v2_6_3
var __t4 gopurs_runtime.Value
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(v2_6_3, "_tag").StrVal == "EQ")).IntVal != 0 {
v_4_loop = gopurs_runtime.RecordGet(v_4, "value1")
v1_5_loop = gopurs_runtime.RecordGet(v1_5, "value1")
continue go__3_0
__t4 = gopurs_runtime.Value{}
...
v2_8_7 := gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictOrd_0, "compare"), gopurs_runtime.RecordGet(v_6, "value0"), gopurs_runtime.RecordGet(v1_7, "value0"))
_ = v2_8_7
var __t8 gopurs_runtime.Value
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(v2_8_7, "_tag").StrVal == "EQ")).IntVal != 0 {
v_6_loop = gopurs_runtime.RecordGet(v_6, "value1")
...
__t0 = gopurs_runtime.Apply3(gopurs_runtime.RecordGet(Get_foldableList(), "foldr"), Get_Cons(), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(Get_applyList(), "apply"), gopurs_runtime.RecordGet(v_0, "value1"), v1_1), gopurs_runtime.Apply2(Get_listMap(), gopurs_runtime.RecordGet(v_0, "value0"), v1_1))
goto end_branch_0
} else {
...
return gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("NonEmpty"), gopurs_runtime.Apply(gopurs_runtime.RecordGet(v_0, "value0"), gopurs_runtime.RecordGet(v1_1, "value0")), gopurs_runtime.Apply3(gopurs_runtime.RecordGet(Get_foldableList(), "foldr"), Get_Cons(), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(Get_applyList(), "apply"), gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), gopurs_runtime.RecordGet(v_0, "value0"), gopurs_runtime.RecordGet(v_0, "value1")), gopurs_runtime.RecordGet(v1_1, "value1")), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(Get_applyList(), "apply"), gopurs_runtime.RecordGet(v_0, "value1"), gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), gopurs_runtime.RecordGet(v1_1, "value0"), gopurs_runtime.RecordDict1("_tag", gopurs_runtime.Str("Nil"))))))
}), gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return Get_functorNonEmptyList()
}))
	})
...
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(v_0, "_tag").StrVal == "Cons")).IntVal != 0 {
__t0 = gopurs_runtime.Apply3(gopurs_runtime.RecordGet(Get_foldableList(), "foldr"), Get_Cons(), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(Get_bindList(), "bind"), gopurs_runtime.RecordGet(v_0, "value1"), v1_1), gopurs_runtime.Apply(v1_1, gopurs_runtime.RecordGet(v_0, "value0")))
goto end_branch_0
} else {
...
v1_2_0 := gopurs_runtime.Apply(f_1, gopurs_runtime.RecordGet(v_0, "value0"))
_ = v1_2_0
return gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("NonEmpty"), gopurs_runtime.RecordGet(v1_2_0, "value0"), gopurs_runtime.Apply3(gopurs_runtime.RecordGet(Get_foldableList(), "foldr"), Get_Cons(), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(Get_bindList(), "bind"), gopurs_runtime.RecordGet(v_0, "value1"), gopurs_runtime.Func(func(x_3 gopurs_runtime.Value) gopurs_runtime.Value {
__local_var_4_1 := gopurs_runtime.Apply(f_1, x_3)
_ = __local_var_4_1
return gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), gopurs_runtime.RecordGet(__local_var_4_1, "value0"), gopurs_runtime.RecordGet(__local_var_4_1, "value1"))
})), gopurs_runtime.RecordGet(v1_2_0, "value1")))
}), gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_plusList() gopurs_runtime.Value {
	once_plusList.Do(func() {
		plusList = gopurs_runtime.RecordDict2("empty", "Alt0", gopurs_runtime.RecordDict1("_tag", gopurs_runtime.Str("Nil")), gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return Get_altList()
}))
	})
	return plusList
...
return gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("NonEmpty"), x_0, gopurs_runtime.RecordDict1("_tag", gopurs_runtime.Str("Nil")))
}), gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return Get_applyNonEmptyList()
}))
	})
...
go__4_3 = gopurs_runtime.Func(func(b_5_loop gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(v_6_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
go__4_3:
for {
if false { continue go__4_3 }
var b_5 = b_5_loop
_ = b_5
var v_6 = v_6_loop
_ = v_6
...
return gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("NonEmpty"), a_8, gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), gopurs_runtime.RecordGet(b_7, "value0"), gopurs_runtime.RecordGet(b_7, "value1")))
}), b_5), gopurs_runtime.Apply(f_2, gopurs_runtime.RecordGet(v_6, "value0")))
v_6_loop = gopurs_runtime.RecordGet(v_6, "value1")
continue go__4_3
__t4 = gopurs_runtime.Value{}
...
go__5_1 = gopurs_runtime.Func(func(b_6_loop gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(v_7_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
go__5_1:
for {
...
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(v_7, "_tag").StrVal == "Cons")).IntVal != 0 {
b_6_loop = gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("NonEmpty"), gopurs_runtime.RecordGet(v_7, "value0"), gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Cons"), gopurs_runtime.RecordGet(b_6, "value0"), gopurs_runtime.RecordGet(b_6, "value1")))
v_7_loop = gopurs_runtime.RecordGet(v_7, "value1")
continue go__5_1
__t2 = gopurs_runtime.Value{}
goto end_branch_2
...
return gopurs_runtime.Apply2(go__5_1, gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("NonEmpty"), gopurs_runtime.RecordGet(v1_4, "value0"), gopurs_runtime.RecordDict1("_tag", gopurs_runtime.Str("Nil"))), gopurs_runtime.RecordGet(v1_4, "value1"))
}), gopurs_runtime.Apply2(go__4_3, gopurs_runtime.Apply2(gopurs_runtime.RecordGet(Functor0_1_0, "map"), gopurs_runtime.RecordGet(Get_applicativeNonEmptyList(), "pure"), gopurs_runtime.Apply(f_2, gopurs_runtime.RecordGet(v_3, "value0"))), gopurs_runtime.RecordGet(v_3, "value1")))
})
