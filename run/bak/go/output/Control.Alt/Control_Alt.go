...
return Call_alt((*Record_alt_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
	return cache_alt
}
...
func Call_alt(dict_0_loop *Record_alt_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_alt_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.alt
}
