...
return Call_recip((*Record_recip_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
	return cache_recip
}
...
return Call_rightDiv((*Record_recip_gopurs_runtime_Value)(dictDivisionRing_0_box.UnsafePtr), a_1_box, b_2_box)
})
	})
...
return Call_leftDiv((*Record_recip_gopurs_runtime_Value)(dictDivisionRing_0_box.UnsafePtr), a_1_box, b_2_box)
})
	})
...
func Call_recip(dict_0_loop *Record_recip_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_recip_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.recip
}

func Call_rightDiv(dictDivisionRing_0_loop *Record_recip_gopurs_runtime_Value, a_1_loop gopurs_runtime.Value, b_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictDivisionRing_0 *Record_recip_gopurs_runtime_Value = dictDivisionRing_0_loop
_ = dictDivisionRing_0
var a_1 gopurs_runtime.Value = a_1_loop
_ = a_1
var b_2 gopurs_runtime.Value = b_2_loop
_ = b_2
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictDivisionRing_0)}, "Ring0_NOT_FOUND"), gopurs_runtime.Value{}), "Semiring0"), gopurs_runtime.Value{}), "mul"), a_1, gopurs_runtime.Apply(dictDivisionRing_0.recip, b_2))
}

func Call_leftDiv(dictDivisionRing_0_loop *Record_recip_gopurs_runtime_Value, a_1_loop gopurs_runtime.Value, b_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictDivisionRing_0 *Record_recip_gopurs_runtime_Value = dictDivisionRing_0_loop
_ = dictDivisionRing_0
var a_1 gopurs_runtime.Value = a_1_loop
_ = a_1
var b_2 gopurs_runtime.Value = b_2_loop
_ = b_2
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictDivisionRing_0)}, "Ring0_NOT_FOUND"), gopurs_runtime.Value{}), "Semiring0"), gopurs_runtime.Value{}), "mul"), gopurs_runtime.Apply(dictDivisionRing_0.recip, b_2), a_1)
}
