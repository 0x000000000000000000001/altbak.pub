...
return gopurs_runtime.RecordGet(v_2, "value0")
...
return gopurs_runtime.RecordGet(v_3, "value0")
...
__local_var_4_2 := gopurs_runtime.RecordGet(x_3, "value1")
_ = __local_var_4_2
...
}), gopurs_runtime.RecordGet(x_3, "value0")))
}), gopurs_runtime.Func(func(_dollar__unused_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.RecordDict2("local", "ComonadAsk0", gopurs_runtime.Func2(func(f_2 gopurs_runtime.Value, v_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Tuple"), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictComonadEnv_0, "local"), f_2, gopurs_runtime.RecordGet(v_3, "value0")), gopurs_runtime.RecordGet(v_3, "value1"))
}), gopurs_runtime.Func(func(_dollar__unused_2 gopurs_runtime.Value) gopurs_runtime.Value {
