...
return Call_local((*Record_local_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
	return cache_local
}
...
return Call_comonadAskEnvT((*Record_extract_gopurs_runtime_Value)(dictComonad_0_box.UnsafePtr))
})
	})
...
return Call_comonadEnvEnvT((*Record_extract_gopurs_runtime_Value)(dictComonad_0_box.UnsafePtr))
})
	})
...
return Call_ask((*Record_ask_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
	return cache_ask
}
...
return Call_asks((*Record_ask_gopurs_runtime_Value)(dictComonadAsk_0_box.UnsafePtr), f_1_box, x_2_box)
})
	})
	return cache_asks
}
...
return Call_comonadAskStoreT((*Record_ask_gopurs_runtime_Value)(dictComonadAsk_0_box.UnsafePtr))
})
	})
...
return Call_comonadEnvStoreT((*Record_local_gopurs_runtime_Value)(dictComonadEnv_0_box.UnsafePtr))
})
	})
...
return Call_comonadAskTracedT((*Record_ask_gopurs_runtime_Value)(dictComonadAsk_0_box.UnsafePtr))
})
	})
...
return Call_comonadEnvTracedT((*Record_local_gopurs_runtime_Value)(dictComonadEnv_0_box.UnsafePtr))
})
	})
...
func Call_local(dict_0_loop *Record_local_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_local_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.local
}

func Call_comonadAskEnvT(dictComonad_0_loop *Record_extract_gopurs_runtime_Value) gopurs_runtime.Value {
var dictComonad_0 *Record_extract_gopurs_runtime_Value = dictComonad_0_loop
_ = dictComonad_0
comonadEnvT_1_0 := gopurs_runtime.Apply(pkg_Control_Comonad_Env_Trans.Get_comonadEnvT(), gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictComonad_0)})
_ = comonadEnvT_1_0
...
func Call_comonadEnvEnvT(dictComonad_0_loop *Record_extract_gopurs_runtime_Value) gopurs_runtime.Value {
var dictComonad_0 *Record_extract_gopurs_runtime_Value = dictComonad_0_loop
_ = dictComonad_0
comonadEnvT_1_0 := gopurs_runtime.Apply(pkg_Control_Comonad_Env_Trans.Get_comonadEnvT(), gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictComonad_0)})
_ = comonadEnvT_1_0
...
func Call_ask(dict_0_loop *Record_ask_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_ask_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.ask
}

func Call_asks(dictComonadAsk_0_loop *Record_ask_gopurs_runtime_Value, f_1_loop gopurs_runtime.Value, x_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictComonadAsk_0 *Record_ask_gopurs_runtime_Value = dictComonadAsk_0_loop
_ = dictComonadAsk_0
var f_1 gopurs_runtime.Value = f_1_loop
_ = f_1
var x_2 gopurs_runtime.Value = x_2_loop
_ = x_2
return gopurs_runtime.Apply(f_1, gopurs_runtime.Apply(dictComonadAsk_0.ask, x_2))
}

func Call_comonadAskStoreT(dictComonadAsk_0_loop *Record_ask_gopurs_runtime_Value) gopurs_runtime.Value {
var dictComonadAsk_0 *Record_ask_gopurs_runtime_Value = dictComonadAsk_0_loop
_ = dictComonadAsk_0
Comonad0_1_0 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictComonadAsk_0)}, "Comonad0_NOT_FOUND"), gopurs_runtime.Value{})
_ = Comonad0_1_0
...
return gopurs_runtime.Apply(dictComonadAsk_0.ask, gopurs_runtime.Apply(__local_var_3_2, x_4))
}))
}

func Call_comonadEnvStoreT(dictComonadEnv_0_loop *Record_local_gopurs_runtime_Value) gopurs_runtime.Value {
var dictComonadEnv_0 *Record_local_gopurs_runtime_Value = dictComonadEnv_0_loop
_ = dictComonadEnv_0
comonadAskStoreT1_1_0 := gopurs_runtime.Apply(Get_comonadAskStoreT(), gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictComonadEnv_0)}, "ComonadAsk0_NOT_FOUND"), gopurs_runtime.Value{}))
_ = comonadAskStoreT1_1_0
return gopurs_runtime.RecordDict2("ComonadAsk0", "local", gopurs_runtime.Func(func(_dollar__unused_2 gopurs_runtime.Value) gopurs_runtime.Value {
return comonadAskStoreT1_1_0
}), gopurs_runtime.Func2(func(f_2 gopurs_runtime.Value, v_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&pkg_Data_Tuple.Data_Data_Tuple_Tuple{gopurs_runtime.Apply2(dictComonadEnv_0.local, f_2, (*pkg_Data_Tuple.Data_Data_Tuple_Tuple)(v_3.UnsafePtr).V0), (*pkg_Data_Tuple.Data_Data_Tuple_Tuple)(v_3.UnsafePtr).V1})}
}))
}

func Call_comonadAskTracedT(dictComonadAsk_0_loop *Record_ask_gopurs_runtime_Value) gopurs_runtime.Value {
var dictComonadAsk_0 *Record_ask_gopurs_runtime_Value = dictComonadAsk_0_loop
_ = dictComonadAsk_0
Comonad0_1_0 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictComonadAsk_0)}, "Comonad0_NOT_FOUND"), gopurs_runtime.Value{})
_ = Comonad0_1_0
...
return gopurs_runtime.Apply(dictComonadAsk_0.ask, gopurs_runtime.Apply2(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(Comonad0_1_0, "Extend0"), gopurs_runtime.Value{}), "Functor0"), gopurs_runtime.Value{}), "map"), gopurs_runtime.Func(func(f_7 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_comonadEnvTracedT(dictComonadEnv_0_loop *Record_local_gopurs_runtime_Value) gopurs_runtime.Value {
var dictComonadEnv_0 *Record_local_gopurs_runtime_Value = dictComonadEnv_0_loop
_ = dictComonadEnv_0
comonadAskTracedT1_1_0 := gopurs_runtime.Apply(Get_comonadAskTracedT(), gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictComonadEnv_0)}, "ComonadAsk0_NOT_FOUND"), gopurs_runtime.Value{}))
...
return gopurs_runtime.Apply2(dictComonadEnv_0.local, f_4, v_5)
}))
})
}
