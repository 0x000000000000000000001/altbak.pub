...
return gopurs_runtime.Value{Type: 9, IntVal: 525585346, UnsafePtr: unsafe.Pointer(&Constructor_Loop{value0})}
})
	})
	return cache_Loop
}
...
return gopurs_runtime.Value{Type: 9, IntVal: 60402430, UnsafePtr: unsafe.Pointer(&Constructor_Done{value0})}
})
	})
	return cache_Done
}
...
__t1 = gopurs_runtime.Value{Type: 9, IntVal: 60402430, UnsafePtr: unsafe.Pointer(&Constructor_Done{gopurs_runtime.Value{Type: 9, IntVal: 3589588149, UnsafePtr: nil}})}
goto end_branch_1
} else {
...
{
var __t_tag_3 gopurs_runtime.Value = (*pkg_Data_Maybe.Constructor_Just)(v_2.UnsafePtr).V0
if (__t_tag_3.Type == 9 && __t_tag_3.IntVal == 525585346) {
__t2 = gopurs_runtime.Value{Type: 9, IntVal: 525585346, UnsafePtr: unsafe.Pointer(&Constructor_Loop{gopurs_runtime.Apply(f_0, (*Constructor_Loop)((*pkg_Data_Maybe.Constructor_Just)(v_2.UnsafePtr).V0.UnsafePtr).V0)})}
goto end_branch_2
} else {
...
{
var __t_tag_4 gopurs_runtime.Value = (*pkg_Data_Maybe.Constructor_Just)(v_2.UnsafePtr).V0
if (__t_tag_4.Type == 9 && __t_tag_4.IntVal == 60402430) {
__t2 = gopurs_runtime.Value{Type: 9, IntVal: 60402430, UnsafePtr: unsafe.Pointer(&Constructor_Done{gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just{(*Constructor_Done)((*pkg_Data_Maybe.Constructor_Just)(v_2.UnsafePtr).V0.UnsafePtr).V0})}})}
goto end_branch_2
} else {
...
v_4_loop = gopurs_runtime.UncurriedApp(__local_var_2_0, (*Constructor_Loop)(v_4.UnsafePtr).V0)
continue go__3_5
...
__t6 = (*Constructor_Done)(v_4.UnsafePtr).V0
goto end_branch_6
} else {
...
v_2_loop = gopurs_runtime.Apply(f_0, (*Constructor_Loop)(v_2.UnsafePtr).V0)
continue go__1_0
...
__t1 = (*Constructor_Done)(v_2.UnsafePtr).V0
goto end_branch_1
} else {
...
{
if (v_4.Type == 9 && v_4.IntVal == 525585346) {
v_4_loop = gopurs_runtime.Apply2(f_0, (*Constructor_Loop)(v_4.UnsafePtr).V0, e_2)
continue go__3_0
__t1 = gopurs_runtime.Value{}
goto end_branch_1
} else {
...
{
if (v_4.Type == 9 && v_4.IntVal == 60402430) {
__t1 = (*Constructor_Done)(v_4.UnsafePtr).V0
goto end_branch_1
} else {
...
__t1 = gopurs_runtime.Value{Type: 9, IntVal: 60402430, UnsafePtr: unsafe.Pointer(&Constructor_Done{gopurs_runtime.Value{Type: 9, IntVal: 3711209382, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Left{(*pkg_Data_Either.Constructor_Left)(v_2.UnsafePtr).V0})}})}
goto end_branch_1
} else {
...
var __t2 gopurs_runtime.Value
{
var __t_tag_3 gopurs_runtime.Value = (*pkg_Data_Either.Constructor_Right)(v_2.UnsafePtr).V0
if (__t_tag_3.Type == 9 && __t_tag_3.IntVal == 525585346) {
__t2 = gopurs_runtime.Value{Type: 9, IntVal: 525585346, UnsafePtr: unsafe.Pointer(&Constructor_Loop{gopurs_runtime.Apply(f_0, (*Constructor_Loop)((*pkg_Data_Either.Constructor_Right)(v_2.UnsafePtr).V0.UnsafePtr).V0)})}
goto end_branch_2
} else {
...
{
var __t_tag_4 gopurs_runtime.Value = (*pkg_Data_Either.Constructor_Right)(v_2.UnsafePtr).V0
if (__t_tag_4.Type == 9 && __t_tag_4.IntVal == 60402430) {
__t2 = gopurs_runtime.Value{Type: 9, IntVal: 60402430, UnsafePtr: unsafe.Pointer(&Constructor_Done{gopurs_runtime.Value{Type: 9, IntVal: 2465973597, UnsafePtr: unsafe.Pointer(&pkg_Data_Either.Constructor_Right{(*Constructor_Done)((*pkg_Data_Either.Constructor_Right)(v_2.UnsafePtr).V0.UnsafePtr).V0})}})}
goto end_branch_2
} else {
...
__t0 = gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Effect.Get_bindEffect(), "bind"), gopurs_runtime.Apply(f_0, (*Constructor_Loop)(v_3.UnsafePtr).V0), gopurs_runtime.Func(func(e_4 gopurs_runtime.Value) gopurs_runtime.Value {
...
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 525585346, UnsafePtr: unsafe.Pointer(&Constructor_Loop{(*Constructor_Loop)(m_1.UnsafePtr).V0})}
goto end_branch_0
} else {
...
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 60402430, UnsafePtr: unsafe.Pointer(&Constructor_Done{gopurs_runtime.Apply(f_0, (*Constructor_Done)(m_1.UnsafePtr).V0)})}
goto end_branch_0
} else {
...
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 525585346, UnsafePtr: unsafe.Pointer(&Constructor_Loop{gopurs_runtime.Apply(v_0, (*Constructor_Loop)(v2_2.UnsafePtr).V0)})}
goto end_branch_0
} else {
...
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 60402430, UnsafePtr: unsafe.Pointer(&Constructor_Done{gopurs_runtime.Apply(v1_1, (*Constructor_Done)(v2_2.UnsafePtr).V0)})}
goto end_branch_0
} else {
...
__t1 = gopurs_runtime.Value{Type: 9, IntVal: 525585346, UnsafePtr: unsafe.Pointer(&Constructor_Loop{pkg_Data_Unit.Get_unit()})}
goto end_branch_1
} else {
...
__t1 = gopurs_runtime.Value{Type: 9, IntVal: 60402430, UnsafePtr: unsafe.Pointer(&Constructor_Done{(*pkg_Data_Maybe.Constructor_Just)(v1_4.UnsafePtr).V0})}
goto end_branch_1
} else {
...
__t2 = gopurs_runtime.Value{Type: 9, IntVal: 60402430, UnsafePtr: unsafe.Pointer(&Constructor_Done{v_5})}
goto end_branch_2
} else {
...
__t2 = gopurs_runtime.Value{Type: 9, IntVal: 525585346, UnsafePtr: unsafe.Pointer(&Constructor_Loop{gopurs_runtime.Apply2(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonoid_0, "Semigroup0_NOT_FOUND"), gopurs_runtime.Value{}), "append"), v_5, (*pkg_Data_Maybe.Constructor_Just)(v1_6.UnsafePtr).V0)})}
goto end_branch_2
} else {
...
{
if (v_4.Type == 9 && v_4.IntVal == 525585346) {
v_4_loop = gopurs_runtime.Apply2(f_0, gopurs_runtime.RecordGet((*Constructor_Loop)(v_4.UnsafePtr).V0, "a"), gopurs_runtime.RecordGet((*Constructor_Loop)(v_4.UnsafePtr).V0, "b"))
continue go__3_0
__t1 = gopurs_runtime.Value{}
goto end_branch_1
} else {
...
v_5_loop = gopurs_runtime.Apply3(f_0, gopurs_runtime.RecordGet((*Constructor_Loop)(v_5.UnsafePtr).V0, "a"), gopurs_runtime.RecordGet((*Constructor_Loop)(v_5.UnsafePtr).V0, "b"), gopurs_runtime.RecordGet((*Constructor_Loop)(v_5.UnsafePtr).V0, "c"))
continue go__4_0
__t1 = gopurs_runtime.Value{}
goto end_branch_1
} else {
...
__t1 = (*Constructor_Done)(v_5.UnsafePtr).V0
goto end_branch_1
} else {
...
_ = c_2
return gopurs_runtime.Value{Type: 9, IntVal: 525585346, UnsafePtr: unsafe.Pointer(&Constructor_Loop{gopurs_runtime.RecordDict3("a", "b", "c", a_0, b_1, c_2)})}
}
...
var b_1 gopurs_runtime.Value = b_1_loop
_ = b_1
return gopurs_runtime.Value{Type: 9, IntVal: 525585346, UnsafePtr: unsafe.Pointer(&Constructor_Loop{gopurs_runtime.RecordDict2("a", "b", a_0, b_1)})}
}
...
return gopurs_runtime.Value{Type: 9, IntVal: 525585346, UnsafePtr: unsafe.Pointer(&Constructor_Loop{u_3})}
}), ma_2)
}), pkg_Data_Unit.Get_unit())
})
}
