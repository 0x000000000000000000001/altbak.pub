...
v_2_loop = gopurs_runtime.Apply(f_0, v_2.PtrVal.(map[string]gopurs_runtime.Value)["value0"])
continue go__1_0
...
v_4_loop = gopurs_runtime.Apply(gopurs_runtime.Apply(f_0, v_4.PtrVal.(map[string]gopurs_runtime.Value)["value0"].PtrVal.(map[string]gopurs_runtime.Value)["a"]), v_4.PtrVal.(map[string]gopurs_runtime.Value)["value0"].PtrVal.(map[string]gopurs_runtime.Value)["b"])
continue go__3_0
__t1 = gopurs_runtime.Value{}
goto end_branch_1
} else {
...
v_5_loop = gopurs_runtime.Apply(gopurs_runtime.Apply(gopurs_runtime.Apply(f_0, v_5.PtrVal.(map[string]gopurs_runtime.Value)["value0"].PtrVal.(map[string]gopurs_runtime.Value)["a"]), v_5.PtrVal.(map[string]gopurs_runtime.Value)["value0"].PtrVal.(map[string]gopurs_runtime.Value)["b"]), v_5.PtrVal.(map[string]gopurs_runtime.Value)["value0"].PtrVal.(map[string]gopurs_runtime.Value)["c"])
continue go__4_0
__t1 = gopurs_runtime.Value{}
goto end_branch_1
} else {
...
{
if (gopurs_runtime.Bool(v_4.PtrVal.(map[string]gopurs_runtime.Value)["_tag"].StrVal == "Loop")).IntVal != 0 {
v_4_loop = __local_var_2_0.PtrVal.(func(gopurs_runtime.Value) gopurs_runtime.Value)(v_4.PtrVal.(map[string]gopurs_runtime.Value)["value0"])
continue go__3_3
...
{
if (gopurs_runtime.Bool(v_4.PtrVal.(map[string]gopurs_runtime.Value)["_tag"].StrVal == "Loop")).IntVal != 0 {
v_4_loop = gopurs_runtime.Apply(gopurs_runtime.Apply(f_0, v_4.PtrVal.(map[string]gopurs_runtime.Value)["value0"]), e_2)
continue go__3_0
__t1 = gopurs_runtime.Value{}
goto end_branch_1
} else {
