...
return gopurs_runtime.Apply(g_1, gopurs_runtime.Apply((*Data_Data_Profunctor_Split_SplitF)(v_2.UnsafePtr).V1, x_3))
...
func Is_Data_Data_Profunctor_Split_SplitF(v gopurs_runtime.Value) bool {
...
_ = v_1
return gopurs_runtime.Apply3(f_0, (*Data_Data_Profunctor_Split_SplitF)(v_1.UnsafePtr).V0, (*Data_Data_Profunctor_Split_SplitF)(v_1.UnsafePtr).V1, (*Data_Data_Profunctor_Split_SplitF)(v_1.UnsafePtr).V2)
}
...
_ = fx_2
return gopurs_runtime.Value{Type: 9, IntVal: 1995432569, UnsafePtr: unsafe.Pointer(&Data_Data_Profunctor_Split_SplitF{f_0, g_1, fx_2})}
}
...
var v_1 gopurs_runtime.Value = v_1_loop
_ = v_1
return gopurs_runtime.Value{Type: 9, IntVal: 1995432569, UnsafePtr: unsafe.Pointer(&Data_Data_Profunctor_Split_SplitF{(*Data_Data_Profunctor_Split_SplitF)(v_1.UnsafePtr).V0, (*Data_Data_Profunctor_Split_SplitF)(v_1.UnsafePtr).V1, gopurs_runtime.Apply(nat_0, (*Data_Data_Profunctor_Split_SplitF)(v_1.UnsafePtr).V2)})}
}
