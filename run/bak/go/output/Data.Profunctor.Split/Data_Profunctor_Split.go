...
return gopurs_runtime.Apply3(f_0, gopurs_runtime.ConstructorGet(v_1, 0), gopurs_runtime.ConstructorGet(v_1, 1), gopurs_runtime.ConstructorGet(v_1, 2))
})
	})
	return unSplit
}
...
return gopurs_runtime.Apply(gopurs_runtime.ConstructorGet(v_2, 0), gopurs_runtime.Apply(f_0, x_3))
}), gopurs_runtime.Func(func(x_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(g_1, gopurs_runtime.Apply(gopurs_runtime.ConstructorGet(v_2, 1), x_3))
}), gopurs_runtime.ConstructorGet(v_2, 2))
}))
	})
...
return gopurs_runtime.Apply3(gopurs_runtime.RecordGet(dictInvariant_0, "imap"), gopurs_runtime.ConstructorGet(v_1, 1), gopurs_runtime.ConstructorGet(v_1, 0), gopurs_runtime.ConstructorGet(v_1, 2))
})
	})
	return lowerSplit
}
...
return gopurs_runtime.Constructor3("SplitF", gopurs_runtime.ConstructorGet(v_1, 0), gopurs_runtime.ConstructorGet(v_1, 1), gopurs_runtime.Apply(nat_0, gopurs_runtime.ConstructorGet(v_1, 2)))
})
	})
	return hoistSplit
}
...
return gopurs_runtime.Constructor3("SplitF", gopurs_runtime.ConstructorGet(v_1, 0), gopurs_runtime.Func(func(x_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(f_0, gopurs_runtime.Apply(gopurs_runtime.ConstructorGet(v_1, 1), x_2))
}), gopurs_runtime.ConstructorGet(v_1, 2))
}))
	})
	return functorSplit
}
