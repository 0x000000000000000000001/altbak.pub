...
return Call_filterEvens(func() []int64 {
	_arr := *(*[]gopurs_runtime.Value)(arr_0_box.UnsafePtr)
	_res := make([]int64, len(_arr))
...
func Call_filterEvens(arr_0_loop []int64) gopurs_runtime.Value {
