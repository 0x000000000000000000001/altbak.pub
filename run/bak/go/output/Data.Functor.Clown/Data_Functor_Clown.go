...
return gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictContravariant_0.UnsafePtr)).V0, f_1, v1_3)
}))
}
...
return gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictFunctor_0.UnsafePtr)).V0, f_1, v1_3)
}))
}
