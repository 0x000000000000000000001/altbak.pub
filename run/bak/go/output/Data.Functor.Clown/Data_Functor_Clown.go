...
return Call_showClown((*Record_show_gopurs_runtime_Value)(dictShow_0_box.UnsafePtr))
})
	})
...
return Call_profunctorClown((*Record_cmap_gopurs_runtime_Value)(dictContravariant_0_box.UnsafePtr))
})
	})
...
return gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(Call_ordClown((*Record_compare_gopurs_runtime_Value)(dictOrd_0_box.UnsafePtr)))}
})
	})
...
return gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(Call_eqClown((*Record_eq_gopurs_runtime_Value)(dictEq_0_box.UnsafePtr)))}
})
	})
...
return Call_bifunctorClown((*Record_map__gopurs_runtime_Value)(dictFunctor_0_box.UnsafePtr))
})
	})
...
return Call_biapplyClown((*Record_apply_gopurs_runtime_Value)(dictApply_0_box.UnsafePtr))
})
	})
...
return Call_biapplicativeClown((*Record_pure_gopurs_runtime_Value)(dictApplicative_0_box.UnsafePtr))
})
	})
...
func Call_showClown(dictShow_0_loop *Record_show_gopurs_runtime_Value) gopurs_runtime.Value {
var dictShow_0 *Record_show_gopurs_runtime_Value = dictShow_0_loop
_ = dictShow_0
return gopurs_runtime.RecordDict1("show", gopurs_runtime.Func(func(v_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str("(Clown "), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Apply(dictShow_0.show, v_1), gopurs_runtime.Str(")")))
}))
}

func Call_profunctorClown(dictContravariant_0_loop *Record_cmap_gopurs_runtime_Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply2(dictContravariant_0.cmap, f_1, v1_3)
}))
}

func Call_ordClown(dictOrd_0_loop *Record_compare_gopurs_runtime_Value) *Record_compare_gopurs_runtime_Value {
...
func Call_eqClown(dictEq_0_loop *Record_eq_gopurs_runtime_Value) *Record_eq_gopurs_runtime_Value {
var dictEq_0 *Record_eq_gopurs_runtime_Value = dictEq_0_loop
_ = dictEq_0
return dictEq_0
}

func Call_bifunctorClown(dictFunctor_0_loop *Record_map__gopurs_runtime_Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply2(dictFunctor_0.map_, f_1, v1_3)
}))
}

func Call_biapplyClown(dictApply_0_loop *Record_apply_gopurs_runtime_Value) gopurs_runtime.Value {
...
func Call_biapplicativeClown(dictApplicative_0_loop *Record_pure_gopurs_runtime_Value) gopurs_runtime.Value {
...
biapplyClown1_3_2 := gopurs_runtime.RecordDict2("Bifunctor0", "biapply", gopurs_runtime.Func(func(_dollar__unused_4 gopurs_runtime.Value) gopurs_runtime.Value {
