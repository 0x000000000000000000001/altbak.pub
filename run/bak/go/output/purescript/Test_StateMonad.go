...
_ = __local_var_1_1
return gopurs_runtime.Apply(gopurs_runtime.Apply(Get_Effect_Console_log(), gopurs_runtime.Str(gopurs_runtime.Apply(gopurs_runtime.RecordGet(Get_Data_Show_showInt(), "show"), gopurs_runtime.Int(gopurs_runtime.Int(Call_Test_StateMonad_runManyTimes(__local_var_1_1.IntVal, 0)).IntVal)).StrVal())), gopurs_runtime.Value{})
})
}()
	})
