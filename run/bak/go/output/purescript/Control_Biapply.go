...
return gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&Constructor_Data_Tuple_Tuple[gopurs_runtime.Value, gopurs_runtime.Value]{1, gopurs_runtime.Apply((*Constructor_Data_Tuple_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(v_0.UnsafePtr).V0, (*Constructor_Data_Tuple_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(v1_1.UnsafePtr).V0), gopurs_runtime.Apply((*Constructor_Data_Tuple_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(v_0.UnsafePtr).V1, (*Constructor_Data_Tuple_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(v1_1.UnsafePtr).V1)})}
})
}))
	})
...
return Call_Control_Biapply_biapply__3394381979(gopurs_runtime.CoerceToStruct[Constructor_Control_Biapply_Biapply[gopurs_runtime.Value]](dict_0_box))
})
	})
...
return Call_Control_Biapply_biapply__2409699611(gopurs_runtime.CoerceToStruct[Constructor_Control_Biapply_Biapply[gopurs_runtime.Value]](dict_0_box))
})
	})
...
func Call_Control_Biapply_biapply__3394381979(dict_0_loop *Constructor_Control_Biapply_Biapply[gopurs_runtime.Value]) gopurs_runtime.Value {
var dict_0 *Constructor_Control_Biapply_Biapply[gopurs_runtime.Value] = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V1)
}

func Call_Control_Biapply_biapply__2409699611(dict_0_loop *Constructor_Control_Biapply_Biapply[gopurs_runtime.Value]) gopurs_runtime.Value {
var dict_0 *Constructor_Control_Biapply_Biapply[gopurs_runtime.Value] = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V1)
}
