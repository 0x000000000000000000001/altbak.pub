...
func Get_Data_String_CodePoints_showCodePoint() gopurs_runtime.Value {
	once_Data_String_CodePoints_showCodePoint.Do(func() {
		cache_Data_String_CodePoints_showCodePoint = gopurs_runtime.Value{Type: 9, IntVal: 1835580986, UnsafePtr: unsafe.Pointer(&Constructor_Data_Show_Show{1, gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Data_String_CodePoints_eqCodePoint() gopurs_runtime.Value {
	once_Data_String_CodePoints_eqCodePoint.Do(func() {
		cache_Data_String_CodePoints_eqCodePoint = gopurs_runtime.Value{Type: 9, IntVal: 1012063514, UnsafePtr: unsafe.Pointer(&Constructor_Data_Eq_Eq{1, gopurs_runtime.Func(func(x_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Data_String_CodePoints_ordCodePoint() gopurs_runtime.Value {
	once_Data_String_CodePoints_ordCodePoint.Do(func() {
		cache_Data_String_CodePoints_ordCodePoint = gopurs_runtime.Value{Type: 9, IntVal: 1435789946, UnsafePtr: unsafe.Pointer(&Constructor_Data_Ord_Ord{1, gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 1012063514, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Eq_Eq](Get_Data_String_CodePoints_eqCodePoint()))}
...
func Get_Data_String_CodePoints_boundedCodePoint() gopurs_runtime.Value {
	once_Data_String_CodePoints_boundedCodePoint.Do(func() {
		cache_Data_String_CodePoints_boundedCodePoint = gopurs_runtime.Value{Type: 9, IntVal: 3510799738, UnsafePtr: unsafe.Pointer(&Constructor_Data_Bounded_Bounded{1, gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 1435789946, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Ord_Ord](Get_Data_String_CodePoints_ordCodePoint()))}
...
func Get_Data_String_CodePoints_boundedEnumCodePoint() gopurs_runtime.Value {
	once_Data_String_CodePoints_boundedEnumCodePoint.Do(func() {
		cache_Data_String_CodePoints_boundedEnumCodePoint = gopurs_runtime.Value{Type: 9, IntVal: 287434377, UnsafePtr: unsafe.Pointer(&Constructor_Data_Enum_BoundedEnum{1, gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 3510799738, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Bounded_Bounded](Get_Data_String_CodePoints_boundedCodePoint()))}
}), gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 4075786298, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Enum_Enum](Get_Data_String_CodePoints_enumCodePoint()))}
}), gopurs_runtime.Int(1114112).IntVal, gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Data_String_CodePoints_enumCodePoint() gopurs_runtime.Value {
	once_Data_String_CodePoints_enumCodePoint.Do(func() {
		cache_Data_String_CodePoints_enumCodePoint = gopurs_runtime.Value{Type: 9, IntVal: 4075786298, UnsafePtr: unsafe.Pointer(&Constructor_Data_Enum_Enum{1, gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 1435789946, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Ord_Ord](Get_Data_String_CodePoints_ordCodePoint()))}
...
__t1 = &Constructor_Data_Maybe_Just{1, gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&Constructor_Data_Tuple_Tuple{1, gopurs_runtime.Int(gopurs_runtime.RecordGet((__local_var_1_0).V0, "head").IntVal), gopurs_runtime.Str(gopurs_runtime.RecordGet((__local_var_1_0).V0, "tail").StrVal())})}}
goto end_branch_1
} else {
...
__t0 = (*Constructor_Data_Maybe_Just)(v_2.UnsafePtr).V0
goto end_branch_0
} else {
...
__t1 = &Constructor_Data_Maybe_Just{1, gopurs_runtime.Int(gopurs_runtime.Int(int64(gopurs_runtime.ArrayLength(gopurs_runtime.Apply(Get_Data_String_CodePoints_toCodePointArray(), gopurs_runtime.Str(gopurs_runtime.Apply2(Get_Data_String_CodeUnits_take(), gopurs_runtime.Int((__local_var_2_0).V0.IntVal), gopurs_runtime.Str(s_1)).StrVal()))))).IntVal)}
goto end_branch_1
} else {
...
_ = x_0
return gopurs_runtime.Apply(Get_Data_String_CodeUnits_singleton(), gopurs_runtime.Apply3(Get_Data_Enum_toEnumWithDefaults__3941305703(), gopurs_runtime.Str(Get_Data_Bounded_bottomChar().StrVal()), gopurs_runtime.Str(Get_Data_Bounded_topChar().StrVal()), gopurs_runtime.Int(x_0))).StrVal()
}
...
end_branch_0:
if __t0 {
__t1 = gopurs_runtime.Apply(Get_Data_String_CodeUnits_singleton(), gopurs_runtime.Apply3(Get_Data_Enum_toEnumWithDefaults__3941305703(), gopurs_runtime.Str(Get_Data_Bounded_bottomChar().StrVal()), gopurs_runtime.Str(Get_Data_Bounded_topChar().StrVal()), gopurs_runtime.Int(v_0))).StrVal()
goto end_branch_1
} else {
...
{
__t1 = (gopurs_runtime.Apply(Get_Data_String_CodeUnits_singleton(), gopurs_runtime.Apply3(Get_Data_Enum_toEnumWithDefaults__3941305703(), gopurs_runtime.Str(Get_Data_Bounded_bottomChar().StrVal()), gopurs_runtime.Str(Get_Data_Bounded_topChar().StrVal()), gopurs_runtime.Int((((v_0) - (65536)) / (1024)) + (55296)))).StrVal()) + (gopurs_runtime.Apply(Get_Data_String_CodeUnits_singleton(), gopurs_runtime.Apply3(Get_Data_Enum_toEnumWithDefaults__3941305703(), gopurs_runtime.Str(Get_Data_Bounded_bottomChar().StrVal()), gopurs_runtime.Str(Get_Data_Bounded_topChar().StrVal()), gopurs_runtime.Int((gopurs_runtime.Apply2(Get_Data_EuclideanRing_intMod(), gopurs_runtime.Int((v_0) - (65536)), gopurs_runtime.Int(1024)).IntVal) + (56320)))).StrVal())
}
end_branch_1:
return __t1
}
...
__t2 = &Constructor_Data_Maybe_Just{1, gopurs_runtime.Int((i_1) + (gopurs_runtime.Int(int64(gopurs_runtime.ArrayLength(gopurs_runtime.Apply(Get_Data_String_CodePoints_toCodePointArray(), gopurs_runtime.Str(gopurs_runtime.Apply2(Get_Data_String_CodeUnits_take(), gopurs_runtime.Int((__local_var_4_1).V0.IntVal), gopurs_runtime.Str(s_prime_3_0)).StrVal()))))).IntVal))}
goto end_branch_2
} else {
...
var x_0 string = x_0_loop
_ = x_0
return gopurs_runtime.Apply(Get_Data_Enum_toCharCode(), gopurs_runtime.Str(x_0)).IntVal
}
...
{
if (n_0) == (0) {
__t1 = gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&Constructor_Data_Maybe_Just{1, gopurs_runtime.Int(gopurs_runtime.RecordGet((v_2_0).V0, "head").IntVal)})})
goto end_branch_1
} else {
...
{
__t1 = &Constructor_Data_Maybe_Just{1, gopurs_runtime.Int(gopurs_runtime.Apply(Get_Data_String_CodePoints_unsafeCodePointAt0(), gopurs_runtime.Str(v1_1)).IntVal)}
}
end_branch_1:
__t2 = gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(__t1)})
goto end_branch_2
...
{
__t2 = gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just](gopurs_runtime.Apply6(Get_Data_String_CodePoints__codePointAt(), Get_Data_String_CodePoints_codePointAtFallback(), Get_Data_Maybe_Just(), gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer((*Constructor_Data_Maybe_Just)(nil))}, Get_Data_String_CodePoints_unsafeCodePointAt0(), gopurs_runtime.Int(v_0), gopurs_runtime.Str(v1_1)))
}
end_branch_2:
return __t2
}
