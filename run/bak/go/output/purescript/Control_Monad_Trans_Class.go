...
return Call_Control_Monad_Trans_Class_lift__3816229929(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Trans_Class_MonadTrans[gopurs_runtime.Value]](dict_0_box))
})
	})
...
return gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Call_Control_Monad_Trans_Class_lift__1866483406(gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just[gopurs_runtime.Value]](dictMonad_0_box)))}
})
	})
...
return Call_Control_Monad_Trans_Class_lift__115114023(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Trans_Class_MonadTrans[gopurs_runtime.Value]](dict_0_box))
})
	})
...
func init() {
	gopurs_runtime.StructGetters[2835982595] = func(ptr unsafe.Pointer, key string) gopurs_runtime.Value {
		c := (*Constructor_Control_Monad_Trans_Class_MonadTrans[gopurs_runtime.Value])(ptr)
		_ = c
		switch key {
...
func Call_Control_Monad_Trans_Class_lift__3816229929(dict_0_loop *Constructor_Control_Monad_Trans_Class_MonadTrans[gopurs_runtime.Value]) gopurs_runtime.Value {
var dict_0 *Constructor_Control_Monad_Trans_Class_MonadTrans[gopurs_runtime.Value] = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V0)
}
...
func Call_Control_Monad_Trans_Class_lift__1866483406(dictMonad_0_loop *Constructor_Data_Maybe_Just[gopurs_runtime.Value]) *Constructor_Data_Maybe_Just[gopurs_runtime.Value] {
var dictMonad_0 *Constructor_Data_Maybe_Just[gopurs_runtime.Value] = dictMonad_0_loop
_ = dictMonad_0
// TAST (Let): Bind1_1_1 -> *Constructor_Control_Bind_Bind[gopurs_runtime.Value]
Bind1_1_1 := gopurs_runtime.CoerceToStruct[Constructor_Control_Bind_Bind[gopurs_runtime.Value]](gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(dictMonad_0)}, "Bind1"), gopurs_runtime.Value{}))
_ = Bind1_1_1
// TAST (Let): Applicative0_2_2 -> *Constructor_Control_Applicative_Applicative[gopurs_runtime.Value]
Applicative0_2_2 := gopurs_runtime.CoerceToStruct[Constructor_Control_Applicative_Applicative[gopurs_runtime.Value]](gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(dictMonad_0)}, "Applicative0"), gopurs_runtime.Value{}))
_ = Applicative0_2_2
...
_ = __local_var_1_0
return gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just[gopurs_runtime.Value]](gopurs_runtime.Func(func(x_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(Get_Control_Monad_Maybe_Trans_MaybeT(), gopurs_runtime.Apply(__local_var_1_0, x_2))
}))
}

func Call_Control_Monad_Trans_Class_lift__115114023(dict_0_loop *Constructor_Control_Monad_Trans_Class_MonadTrans[gopurs_runtime.Value]) gopurs_runtime.Value {
var dict_0 *Constructor_Control_Monad_Trans_Class_MonadTrans[gopurs_runtime.Value] = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V0)
}
