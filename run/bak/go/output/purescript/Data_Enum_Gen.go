...
func Get_Data_Enum_Gen_foldable1NonEmpty() gopurs_runtime.Value {
	once_Data_Enum_Gen_foldable1NonEmpty.Do(func() {
		cache_Data_Enum_Gen_foldable1NonEmpty = gopurs_runtime.Value{Type: 9, IntVal: 2465059545, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Semigroup_Foldable_Foldable1](gopurs_runtime.Apply(Get_Data_NonEmpty_foldable1NonEmpty(), Get_Data_Foldable_foldableArray())))}
	})
...
__t4 = gopurs_runtime.Apply3(Get_Control_Monad_Gen_elements(), gopurs_runtime.Value{Type: 9, IntVal: 2254593219, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Gen_Class_MonadGen](dictMonadGen_0))}, gopurs_runtime.Value{Type: 9, IntVal: 2465059545, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Semigroup_Foldable_Foldable1](gopurs_runtime.Apply(Get_Data_NonEmpty_foldable1NonEmpty(), Get_Data_Foldable_foldableArray())))}, gopurs_runtime.Value{Type: 9, IntVal: 3111306138, UnsafePtr: unsafe.Pointer(&Constructor_Data_NonEmpty_NonEmpty{1, gopurs_runtime.Box(Bounded0_4_2.V1), gopurs_runtime.Array(func() []gopurs_runtime.Value {
					arr := *(*[]gopurs_runtime.Value)(gopurs_runtime.Apply4(Get_Data_Enum_enumFromTo(), gopurs_runtime.Value{Type: 9, IntVal: 4075786298, UnsafePtr: unsafe.Pointer(Enum1_3_1)}, gopurs_runtime.Value{Type: 9, IntVal: 3553002490, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Unfoldable1_Unfoldable1](Get_Data_Unfoldable1_unfoldable1Array()))}, (*Constructor_Data_Maybe_Just)(v_5_3.UnsafePtr).V0, gopurs_runtime.Box(Bounded0_4_2.V2)).UnsafePtr)
