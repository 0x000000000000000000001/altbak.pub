...
return gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&Constructor_Data_Tuple_Tuple[gopurs_runtime.Value, gopurs_runtime.Value]{1, gopurs_runtime.Apply(a2b_0, (*Constructor_Data_Tuple_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(v_1.UnsafePtr).V0), (*Constructor_Data_Tuple_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(v_1.UnsafePtr).V1})}
})
...
return Call_Data_Profunctor_Strong_first__1843542330(gopurs_runtime.CoerceToStruct[Constructor_Data_Profunctor_Strong_Strong[gopurs_runtime.Value]](dict_0_box))
})
	})
...
return Call_Data_Profunctor_Strong_second__1843542330(gopurs_runtime.CoerceToStruct[Constructor_Data_Profunctor_Strong_Strong[gopurs_runtime.Value]](dict_0_box))
})
	})
...
return Call_Data_Profunctor_Strong_splitStrong__2623652703(gopurs_runtime.CoerceToStruct[Constructor_Control_Semigroupoid_Semigroupoid[gopurs_runtime.Value]](dictSemigroupoid_0_box), gopurs_runtime.CoerceToStruct[Constructor_Data_Profunctor_Strong_Strong[gopurs_runtime.Value]](dictStrong_1_box), l_2_box, r_3_box)
})
	})
...
return gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&Constructor_Data_Tuple_Tuple[gopurs_runtime.Value, gopurs_runtime.Value]{1, a_5, a_5})}
...
func Call_Data_Profunctor_Strong_first__1843542330(dict_0_loop *Constructor_Data_Profunctor_Strong_Strong[gopurs_runtime.Value]) gopurs_runtime.Value {
var dict_0 *Constructor_Data_Profunctor_Strong_Strong[gopurs_runtime.Value] = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V1)
}

func Call_Data_Profunctor_Strong_second__1843542330(dict_0_loop *Constructor_Data_Profunctor_Strong_Strong[gopurs_runtime.Value]) gopurs_runtime.Value {
var dict_0 *Constructor_Data_Profunctor_Strong_Strong[gopurs_runtime.Value] = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V2)
}

func Call_Data_Profunctor_Strong_splitStrong__2623652703(dictSemigroupoid_0_loop *Constructor_Control_Semigroupoid_Semigroupoid[gopurs_runtime.Value], dictStrong_1_loop *Constructor_Data_Profunctor_Strong_Strong[gopurs_runtime.Value], l_2_loop gopurs_runtime.Value, r_3_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictSemigroupoid_0 *Constructor_Control_Semigroupoid_Semigroupoid[gopurs_runtime.Value] = dictSemigroupoid_0_loop
_ = dictSemigroupoid_0
var dictStrong_1 *Constructor_Data_Profunctor_Strong_Strong[gopurs_runtime.Value] = dictStrong_1_loop
_ = dictStrong_1
