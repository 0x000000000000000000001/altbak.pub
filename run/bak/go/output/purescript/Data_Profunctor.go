...
return Call_Data_Profunctor_dimap(gopurs_runtime.CoerceToStruct[Constructor_Data_Profunctor_Profunctor](dict_0_box))
})
	})
...
return Call_Data_Profunctor_lcmap(gopurs_runtime.CoerceToStruct[Constructor_Data_Profunctor_Profunctor](dictProfunctor_0_box), a2b_1_box)
})
	})
...
return Call_Data_Profunctor_rmap(gopurs_runtime.CoerceToStruct[Constructor_Data_Profunctor_Profunctor](dictProfunctor_0_box), b2c_1_box)
})
	})
...
return Call_Data_Profunctor_unwrapIso(gopurs_runtime.CoerceToStruct[Constructor_Data_Profunctor_Profunctor](dictProfunctor_0_box), gopurs_runtime.CoerceToStruct[Constructor_Data_Newtype_Newtype](_dollar__unused_1_box))
})
	})
...
return Call_Data_Profunctor_wrapIso(gopurs_runtime.CoerceToStruct[Constructor_Data_Profunctor_Profunctor](dictProfunctor_0_box), gopurs_runtime.CoerceToStruct[Constructor_Data_Newtype_Newtype](_dollar__unused_1_box), v_2_box)
})
	})
...
return Call_Data_Profunctor_arr(gopurs_runtime.CoerceToStruct[Constructor_Control_Category_Category](dictCategory_0_box))
})
	})
...
return Call_Data_Profunctor_dimap__398801877(gopurs_runtime.CoerceToStruct[Constructor_Data_Profunctor_Profunctor](dict_0_box))
})
	})
...
return Call_Data_Profunctor_dimap__413237333(gopurs_runtime.CoerceToStruct[Constructor_Data_Profunctor_Profunctor](dict_0_box))
})
	})
...
return Call_Data_Profunctor_dimap__1466332548(gopurs_runtime.CoerceToStruct[Constructor_Data_Profunctor_Profunctor](dict_0_box))
})
	})
...
return Call_Data_Profunctor_dimap__2995647076(gopurs_runtime.CoerceToStruct[Constructor_Data_Profunctor_Profunctor](dict_0_box))
})
	})
...
return Call_Data_Profunctor_dimap__109135140(gopurs_runtime.CoerceToStruct[Constructor_Data_Profunctor_Profunctor](dict_0_box))
})
	})
...
return Call_Data_Profunctor_dimap__2951692932(gopurs_runtime.CoerceToStruct[Constructor_Data_Profunctor_Profunctor](dict_0_box))
})
	})
...
return Call_Data_Profunctor_lcmap__1762133278(gopurs_runtime.CoerceToStruct[Constructor_Data_Profunctor_Profunctor](dictProfunctor_0_box), a2b_1_box)
})
	})
...
return Call_Data_Profunctor_lcmap__1379840958(gopurs_runtime.CoerceToStruct[Constructor_Data_Profunctor_Profunctor](dictProfunctor_0_box), a2b_1_box)
})
	})
...
return Call_Data_Profunctor_rmap__1762133278(gopurs_runtime.CoerceToStruct[Constructor_Data_Profunctor_Profunctor](dictProfunctor_0_box), b2c_1_box)
})
	})
...
return Call_Data_Profunctor_rmap__2905617982(gopurs_runtime.CoerceToStruct[Constructor_Data_Profunctor_Profunctor](dictProfunctor_0_box), b2c_1_box)
})
	})
	return cache_Data_Profunctor_rmap__2905617982
}

type Constructor_Data_Profunctor_Profunctor struct {
	Rc uint32
...
func init() {
	gopurs_runtime.StructGetters[2367018778] = func(ptr unsafe.Pointer, key string) gopurs_runtime.Value {
		c := (*Constructor_Data_Profunctor_Profunctor)(ptr)
		_ = c
		switch key {
...
func Call_Data_Profunctor_dimap(dict_0_loop *Constructor_Data_Profunctor_Profunctor) gopurs_runtime.Value {
var dict_0 *Constructor_Data_Profunctor_Profunctor = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V0)
}

func Call_Data_Profunctor_lcmap(dictProfunctor_0_loop *Constructor_Data_Profunctor_Profunctor, a2b_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictProfunctor_0 *Constructor_Data_Profunctor_Profunctor = dictProfunctor_0_loop
_ = dictProfunctor_0
...
func Call_Data_Profunctor_wrapIso(dictProfunctor_0_loop *Constructor_Data_Profunctor_Profunctor, _dollar__unused_1_loop *Constructor_Data_Newtype_Newtype, v_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictProfunctor_0 *Constructor_Data_Profunctor_Profunctor = dictProfunctor_0_loop
_ = dictProfunctor_0
var _dollar__unused_1 *Constructor_Data_Newtype_Newtype = _dollar__unused_1_loop
_ = _dollar__unused_1
...
func Call_Data_Profunctor_arr(dictCategory_0_loop *Constructor_Control_Category_Category) gopurs_runtime.Value {
var dictCategory_0 *Constructor_Control_Category_Category = dictCategory_0_loop
_ = dictCategory_0
...
func Call_Data_Profunctor_dimap__398801877(dict_0_loop *Constructor_Data_Profunctor_Profunctor) gopurs_runtime.Value {
var dict_0 *Constructor_Data_Profunctor_Profunctor = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V0)
}

func Call_Data_Profunctor_dimap__413237333(dict_0_loop *Constructor_Data_Profunctor_Profunctor) gopurs_runtime.Value {
var dict_0 *Constructor_Data_Profunctor_Profunctor = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V0)
}

func Call_Data_Profunctor_dimap__1466332548(dict_0_loop *Constructor_Data_Profunctor_Profunctor) gopurs_runtime.Value {
var dict_0 *Constructor_Data_Profunctor_Profunctor = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V0)
}

func Call_Data_Profunctor_dimap__2995647076(dict_0_loop *Constructor_Data_Profunctor_Profunctor) gopurs_runtime.Value {
var dict_0 *Constructor_Data_Profunctor_Profunctor = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V0)
}

func Call_Data_Profunctor_dimap__109135140(dict_0_loop *Constructor_Data_Profunctor_Profunctor) gopurs_runtime.Value {
var dict_0 *Constructor_Data_Profunctor_Profunctor = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V0)
}

func Call_Data_Profunctor_dimap__2951692932(dict_0_loop *Constructor_Data_Profunctor_Profunctor) gopurs_runtime.Value {
var dict_0 *Constructor_Data_Profunctor_Profunctor = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V0)
}

func Call_Data_Profunctor_lcmap__1762133278(dictProfunctor_0_loop *Constructor_Data_Profunctor_Profunctor, a2b_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictProfunctor_0 *Constructor_Data_Profunctor_Profunctor = dictProfunctor_0_loop
_ = dictProfunctor_0
var a2b_1 gopurs_runtime.Value = a2b_1_loop
_ = a2b_1
