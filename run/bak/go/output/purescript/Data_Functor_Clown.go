...
func Get_Data_Functor_Clown_newtypeClown() gopurs_runtime.Value {
	once_Data_Functor_Clown_newtypeClown.Do(func() {
		cache_Data_Functor_Clown_newtypeClown = gopurs_runtime.RecordDict1("Coercible0", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Data_Functor_Clown_functorClown() gopurs_runtime.Value {
	once_Data_Functor_Clown_functorClown.Do(func() {
		cache_Data_Functor_Clown_functorClown = gopurs_runtime.RecordDict1("map", gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = __local_var_1_1
// TAST (Let): bifunctorClown1_1_0 -> gopurs_runtime.Value
...
_ = __local_var_2_3
// TAST (Let): bifunctorClown1_2_2 -> gopurs_runtime.Value
...
// TAST (Let): biapplyClown1_1_0 -> gopurs_runtime.Value
