...
return Call_Control_Monad_Writer_Class_tell(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Writer_Class_MonadTell](dict_0_box))
})
	})
...
return Call_Control_Monad_Writer_Class_pass(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Writer_Class_MonadWriter](dict_0_box))
})
	})
...
return Call_Control_Monad_Writer_Class_listen(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Writer_Class_MonadWriter](dict_0_box))
})
	})
...
return Call_Control_Monad_Writer_Class_listens(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Writer_Class_MonadWriter](dictMonadWriter_0_box))
})
	})
...
return Call_Control_Monad_Writer_Class_censor(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Writer_Class_MonadWriter](dictMonadWriter_0_box))
})
	})
...
return Call_Control_Monad_Writer_Class_listen__1604579315(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Writer_Class_MonadWriter](dict_0_box))
})
	})
...
return Call_Control_Monad_Writer_Class_listen__1880450835(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Writer_Class_MonadWriter](dict_0_box))
})
	})
...
return Call_Control_Monad_Writer_Class_listen__3817169875(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Writer_Class_MonadWriter](dict_0_box))
})
	})
...
return Call_Control_Monad_Writer_Class_listen__2047803155(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Writer_Class_MonadWriter](dict_0_box))
})
	})
...
return Call_Control_Monad_Writer_Class_pass__1553691451(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Writer_Class_MonadWriter](dict_0_box))
})
	})
...
return Call_Control_Monad_Writer_Class_pass__1787406491(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Writer_Class_MonadWriter](dict_0_box))
})
	})
...
return Call_Control_Monad_Writer_Class_pass__2416360603(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Writer_Class_MonadWriter](dict_0_box))
})
	})
...
return Call_Control_Monad_Writer_Class_pass__261986203(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Writer_Class_MonadWriter](dict_0_box))
})
	})
	return cache_Control_Monad_Writer_Class_pass__261986203
}

type Constructor_Control_Monad_Writer_Class_MonadTell struct {
	Rc uint32
...
func init() {
	gopurs_runtime.StructGetters[551781469] = func(ptr unsafe.Pointer, key string) gopurs_runtime.Value {
		c := (*Constructor_Control_Monad_Writer_Class_MonadTell)(ptr)
		_ = c
		switch key {
...
type Constructor_Control_Monad_Writer_Class_MonadWriter struct {
	Rc uint32
	V0 gopurs_runtime.Value
	V1 gopurs_runtime.Value
	V2 gopurs_runtime.Value
...
func init() {
	gopurs_runtime.StructGetters[784743459] = func(ptr unsafe.Pointer, key string) gopurs_runtime.Value {
		c := (*Constructor_Control_Monad_Writer_Class_MonadWriter)(ptr)
		_ = c
		switch key {
...
func Call_Control_Monad_Writer_Class_tell(dict_0_loop *Constructor_Control_Monad_Writer_Class_MonadTell) gopurs_runtime.Value {
var dict_0 *Constructor_Control_Monad_Writer_Class_MonadTell = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V2)
}

func Call_Control_Monad_Writer_Class_pass(dict_0_loop *Constructor_Control_Monad_Writer_Class_MonadWriter) gopurs_runtime.Value {
var dict_0 *Constructor_Control_Monad_Writer_Class_MonadWriter = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V3)
}

func Call_Control_Monad_Writer_Class_listen(dict_0_loop *Constructor_Control_Monad_Writer_Class_MonadWriter) gopurs_runtime.Value {
var dict_0 *Constructor_Control_Monad_Writer_Class_MonadWriter = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V2)
}

func Call_Control_Monad_Writer_Class_listens(dictMonadWriter_0_loop *Constructor_Control_Monad_Writer_Class_MonadWriter) gopurs_runtime.Value {
var dictMonadWriter_0 *Constructor_Control_Monad_Writer_Class_MonadWriter = dictMonadWriter_0_loop
_ = dictMonadWriter_0
...
Bind1_2_1 := gopurs_runtime.CoerceToStruct[Constructor_Control_Bind_Bind](gopurs_runtime.Apply(gopurs_runtime.RecordGet(Monad1_1_0, "Bind1"), gopurs_runtime.Value{}))
_ = Bind1_2_1
...
return gopurs_runtime.Apply(pure_3_2, gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&Constructor_Data_Tuple_Tuple{1, (*Constructor_Data_Tuple_Tuple)(v_6.UnsafePtr).V0, gopurs_runtime.Apply(f_4, (*Constructor_Data_Tuple_Tuple)(v_6.UnsafePtr).V1)})})
}))
})
})
}

func Call_Control_Monad_Writer_Class_censor(dictMonadWriter_0_loop *Constructor_Control_Monad_Writer_Class_MonadWriter) gopurs_runtime.Value {
var dictMonadWriter_0 *Constructor_Control_Monad_Writer_Class_MonadWriter = dictMonadWriter_0_loop
_ = dictMonadWriter_0
// TAST (Let): Monad1_1_0 -> gopurs_runtime.Value
Monad1_1_0 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.Box(dictMonadWriter_0.V0), gopurs_runtime.Value{}), "Monad1"), gopurs_runtime.Value{})
...
return gopurs_runtime.Apply(pure_3_2, gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&Constructor_Data_Tuple_Tuple{1, a_6, f_4})})
})))
})
})
}

func Call_Control_Monad_Writer_Class_listen__1604579315(dict_0_loop *Constructor_Control_Monad_Writer_Class_MonadWriter) gopurs_runtime.Value {
var dict_0 *Constructor_Control_Monad_Writer_Class_MonadWriter = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V2)
}

func Call_Control_Monad_Writer_Class_listen__1880450835(dict_0_loop *Constructor_Control_Monad_Writer_Class_MonadWriter) gopurs_runtime.Value {
var dict_0 *Constructor_Control_Monad_Writer_Class_MonadWriter = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V2)
}

func Call_Control_Monad_Writer_Class_listen__3817169875(dict_0_loop *Constructor_Control_Monad_Writer_Class_MonadWriter) gopurs_runtime.Value {
var dict_0 *Constructor_Control_Monad_Writer_Class_MonadWriter = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V2)
}

func Call_Control_Monad_Writer_Class_listen__2047803155(dict_0_loop *Constructor_Control_Monad_Writer_Class_MonadWriter) gopurs_runtime.Value {
var dict_0 *Constructor_Control_Monad_Writer_Class_MonadWriter = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V2)
}

func Call_Control_Monad_Writer_Class_pass__1553691451(dict_0_loop *Constructor_Control_Monad_Writer_Class_MonadWriter) gopurs_runtime.Value {
var dict_0 *Constructor_Control_Monad_Writer_Class_MonadWriter = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V3)
}

func Call_Control_Monad_Writer_Class_pass__1787406491(dict_0_loop *Constructor_Control_Monad_Writer_Class_MonadWriter) gopurs_runtime.Value {
var dict_0 *Constructor_Control_Monad_Writer_Class_MonadWriter = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V3)
}

func Call_Control_Monad_Writer_Class_pass__2416360603(dict_0_loop *Constructor_Control_Monad_Writer_Class_MonadWriter) gopurs_runtime.Value {
var dict_0 *Constructor_Control_Monad_Writer_Class_MonadWriter = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V3)
}

func Call_Control_Monad_Writer_Class_pass__261986203(dict_0_loop *Constructor_Control_Monad_Writer_Class_MonadWriter) gopurs_runtime.Value {
var dict_0 *Constructor_Control_Monad_Writer_Class_MonadWriter = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V3)
}
