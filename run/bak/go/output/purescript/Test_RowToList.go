...
var cache_Test_RowToList_RecordKeys_dollarDict gopurs_runtime.Value
var once_Test_RowToList_RecordKeys_dollarDict sync.Once
func Get_Test_RowToList_RecordKeys_dollarDict() gopurs_runtime.Value {
	once_Test_RowToList_RecordKeys_dollarDict.Do(func() {
		cache_Test_RowToList_RecordKeys_dollarDict = gopurs_runtime.Func(func(x_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_Test_RowToList_RecordKeys_dollarDict(x_0_box)
})
	})
	return cache_Test_RowToList_RecordKeys_dollarDict
}
...
return Call_Test_RowToList_keysImpl(gopurs_runtime.CoerceToStruct[Constructor_Test_RowToList_RecordKeys](dict_0_box))
})
	})
...
func Get_Test_RowToList_keys() gopurs_runtime.Value {
	once_Test_RowToList_keys.Do(func() {
		cache_Test_RowToList_keys = gopurs_runtime.Func3(func(_dollar__unused_0_box gopurs_runtime.Value, dictRecordKeys_1_box gopurs_runtime.Value, v_2_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Int(Call_Test_RowToList_keys(_dollar__unused_0_box, gopurs_runtime.CoerceToStruct[Constructor_Test_RowToList_RecordKeys](dictRecordKeys_1_box), v_2_box))
})
	})
...
func Get_Test_RowToList_act() gopurs_runtime.Value {
	once_Test_RowToList_act.Do(func() {
		cache_Test_RowToList_act = func() gopurs_runtime.Value {
// TAST (Let): __local_var_0_0 -> gopurs_runtime.Value
...
_ = __local_var_1_1
return gopurs_runtime.Apply(gopurs_runtime.Apply(Get_Effect_Console_log(), gopurs_runtime.Str(gopurs_runtime.Apply(gopurs_runtime.RecordGet(Get_Data_Show_showInt(), "show"), gopurs_runtime.Int(gopurs_runtime.Apply(gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Test_RowToList_RecordKeys](Get_Test_RowToList_keysCons1()).V0), gopurs_runtime.Value{Type: 9, IntVal: int64(513803634), UnsafePtr: nil}).IntVal)).StrVal())), gopurs_runtime.Value{})
})
}()
	})
...
var cache_Test_RowToList_keys__2593753752 gopurs_runtime.Value
var once_Test_RowToList_keys__2593753752 sync.Once
func Get_Test_RowToList_keys__2593753752() gopurs_runtime.Value {
	once_Test_RowToList_keys__2593753752.Do(func() {
		cache_Test_RowToList_keys__2593753752 = gopurs_runtime.Func3(func(_dollar__unused_0_box gopurs_runtime.Value, dictRecordKeys_1_box gopurs_runtime.Value, v_2_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Int(Call_Test_RowToList_keys__2593753752(_dollar__unused_0_box, gopurs_runtime.CoerceToStruct[Constructor_Test_RowToList_RecordKeys](dictRecordKeys_1_box), v_2_box))
})
	})
	return cache_Test_RowToList_keys__2593753752
}

var cache_Test_RowToList_keysImpl__1765041470 gopurs_runtime.Value
var once_Test_RowToList_keysImpl__1765041470 sync.Once
func Get_Test_RowToList_keysImpl__1765041470() gopurs_runtime.Value {
	once_Test_RowToList_keysImpl__1765041470.Do(func() {
		cache_Test_RowToList_keysImpl__1765041470 = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_Test_RowToList_keysImpl__1765041470(gopurs_runtime.CoerceToStruct[Constructor_Test_RowToList_RecordKeys](dict_0_box))
})
	})
	return cache_Test_RowToList_keysImpl__1765041470
}

var cache_Test_RowToList_keysImpl__3375262200 gopurs_runtime.Value
var once_Test_RowToList_keysImpl__3375262200 sync.Once
func Get_Test_RowToList_keysImpl__3375262200() gopurs_runtime.Value {
	once_Test_RowToList_keysImpl__3375262200.Do(func() {
		cache_Test_RowToList_keysImpl__3375262200 = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_Test_RowToList_keysImpl__3375262200(gopurs_runtime.CoerceToStruct[Constructor_Test_RowToList_RecordKeys](dict_0_box))
})
	})
	return cache_Test_RowToList_keysImpl__3375262200
}

type Constructor_Test_RowToList_RecordKeys struct {
	Rc uint32
...
func init() {
	gopurs_runtime.StructGetters[561174694] = func(ptr unsafe.Pointer, key string) gopurs_runtime.Value {
		c := (*Constructor_Test_RowToList_RecordKeys)(ptr)
		_ = c
		switch key {
...
func Call_Test_RowToList_RecordKeys_dollarDict(x_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
var x_0 gopurs_runtime.Value = x_0_loop
_ = x_0
return x_0
}

func Call_Test_RowToList_keysImpl(dict_0_loop *Constructor_Test_RowToList_RecordKeys) gopurs_runtime.Value {
var dict_0 *Constructor_Test_RowToList_RecordKeys = dict_0_loop
_ = dict_0
...
_ = _dollar__unused_0
var dictRecordKeys_1 *Constructor_Test_RowToList_RecordKeys = dictRecordKeys_1_loop
_ = dictRecordKeys_1
...
func Call_Test_RowToList_keys__2593753752(_dollar__unused_0_loop gopurs_runtime.Value, dictRecordKeys_1_loop *Constructor_Test_RowToList_RecordKeys, v_2_loop gopurs_runtime.Value) int64 {
var _dollar__unused_0 gopurs_runtime.Value = _dollar__unused_0_loop
_ = _dollar__unused_0
var dictRecordKeys_1 *Constructor_Test_RowToList_RecordKeys = dictRecordKeys_1_loop
_ = dictRecordKeys_1
...
func Call_Test_RowToList_keysImpl__1765041470(dict_0_loop *Constructor_Test_RowToList_RecordKeys) gopurs_runtime.Value {
var dict_0 *Constructor_Test_RowToList_RecordKeys = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V0)
}

func Call_Test_RowToList_keysImpl__3375262200(dict_0_loop *Constructor_Test_RowToList_RecordKeys) gopurs_runtime.Value {
var dict_0 *Constructor_Test_RowToList_RecordKeys = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V0)
}
