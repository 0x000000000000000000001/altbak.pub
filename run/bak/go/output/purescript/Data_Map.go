...
__local_var_0_0 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(Get_Data_Map_Internal_functorMap(), "map"), gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
