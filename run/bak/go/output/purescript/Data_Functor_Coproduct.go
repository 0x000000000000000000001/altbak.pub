...
_ = ga_0
return gopurs_runtime.Value{Type: 9, IntVal: 2465973597, UnsafePtr: unsafe.Pointer(&Constructor_Data_Either_Right{1, ga_0})}
}
...
_ = fa_0
return gopurs_runtime.Value{Type: 9, IntVal: 3711209382, UnsafePtr: unsafe.Pointer(&Constructor_Data_Either_Left{1, fa_0})}
}
...
__t0 = (gopurs_runtime.Apply3(gopurs_runtime.RecordGet(dictEq1_0, "eq1"), gopurs_runtime.Value{Type: 9, IntVal: 1012063514, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Eq_Eq](dictEq_2))}, (*Constructor_Data_Either_Left)(v_3.UnsafePtr).V0, (*Constructor_Data_Either_Left)(v1_4.UnsafePtr).V0).IntVal) != (0)
goto end_branch_0
} else {
...
{
if (v1_6.Type == 9 && v1_6.IntVal == 3711209382) {
__t5 = uint32(gopurs_runtime.Apply3(gopurs_runtime.RecordGet(dictOrd1_0, "compare1"), gopurs_runtime.Value{Type: 9, IntVal: 1435789946, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Ord_Ord](dictOrd_4))}, (*Constructor_Data_Either_Left)(v_5.UnsafePtr).V0, (*Constructor_Data_Either_Left)(v1_6.UnsafePtr).V0).IntVal)
goto end_branch_5
} else {
...
{
if ((v_5.Type == 9 && v_5.IntVal == 2465973597)) && ((v1_6.Type == 9 && v1_6.IntVal == 2465973597)) {
__t6 = uint32(gopurs_runtime.Apply3(gopurs_runtime.RecordGet(dictOrd11_2, "compare1"), gopurs_runtime.Value{Type: 9, IntVal: 1435789946, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Ord_Ord](dictOrd_4))}, (*Constructor_Data_Either_Right)(v_5.UnsafePtr).V0, (*Constructor_Data_Either_Right)(v1_6.UnsafePtr).V0).IntVal)
goto end_branch_6
} else {
...
var __t4 bool
{
if (v1_7.Type == 9 && v1_7.IntVal == 3711209382) {
__t4 = (gopurs_runtime.Apply3(gopurs_runtime.RecordGet(__local_var_1_0, "eq1"), gopurs_runtime.Value{Type: 9, IntVal: 1012063514, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Eq_Eq](__local_var_5_3))}, (*Constructor_Data_Either_Left)(v_6.UnsafePtr).V0, (*Constructor_Data_Either_Left)(v1_7.UnsafePtr).V0).IntVal) != (0)
goto end_branch_4
} else {
...
{
if ((v_6.Type == 9 && v_6.IntVal == 2465973597)) && ((v1_7.Type == 9 && v1_7.IntVal == 2465973597)) {
__t5 = (gopurs_runtime.Apply3(gopurs_runtime.RecordGet(__local_var_3_1, "eq1"), gopurs_runtime.Value{Type: 9, IntVal: 1012063514, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Eq_Eq](__local_var_5_3))}, (*Constructor_Data_Either_Right)(v_6.UnsafePtr).V0, (*Constructor_Data_Either_Right)(v1_7.UnsafePtr).V0).IntVal) != (0)
goto end_branch_5
} else {
...
{
if (v1_7.Type == 9 && v1_7.IntVal == 3711209382) {
__t6 = uint32(gopurs_runtime.Apply3(gopurs_runtime.RecordGet(dictOrd1_0, "compare1"), gopurs_runtime.Value{Type: 9, IntVal: 1435789946, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Ord_Ord](dictOrd_4))}, (*Constructor_Data_Either_Left)(v_6.UnsafePtr).V0, (*Constructor_Data_Either_Left)(v1_7.UnsafePtr).V0).IntVal)
goto end_branch_6
} else {
...
{
if ((v_6.Type == 9 && v_6.IntVal == 2465973597)) && ((v1_7.Type == 9 && v1_7.IntVal == 2465973597)) {
__t7 = uint32(gopurs_runtime.Apply3(gopurs_runtime.RecordGet(dictOrd11_2, "compare1"), gopurs_runtime.Value{Type: 9, IntVal: 1435789946, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Ord_Ord](dictOrd_4))}, (*Constructor_Data_Either_Right)(v_6.UnsafePtr).V0, (*Constructor_Data_Either_Right)(v1_7.UnsafePtr).V0).IntVal)
goto end_branch_7
} else {
...
__local_var_4_3 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictComonad1_3, "Extend0"), gopurs_runtime.Value{})
_ = __local_var_4_3
...
func Call_Data_Functor_Coproduct_coproduct__2507487339(v_0_loop gopurs_runtime.Value, v1_1_loop gopurs_runtime.Value, v2_2_loop gopurs_runtime.Value) *Constructor_Data_Maybe_Just {
var v_0 gopurs_runtime.Value = v_0_loop
_ = v_0
var v1_1 gopurs_runtime.Value = v1_1_loop
_ = v1_1
