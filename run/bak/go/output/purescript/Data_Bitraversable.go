...
// TAST (Let): Apply0_1_2 -> *Constructor_Control_Apply_Apply[gopurs_runtime.Value]
...
_ = Apply0_1_2
// TAST (Let): Functor0_2_3 -> *Constructor_Data_Functor_Functor[gopurs_runtime.Value]
...
return Call_Data_Bitraversable_bisequence__3517827200(gopurs_runtime.CoerceToStruct[Constructor_Data_Bitraversable_Bitraversable[gopurs_runtime.Value]](dict_0_box))
})
	})
...
return Call_Data_Bitraversable_bitraverse__3884078439(gopurs_runtime.CoerceToStruct[Constructor_Data_Bitraversable_Bitraversable[gopurs_runtime.Value]](dict_0_box))
})
	})
...
return Call_Data_Bitraversable_bitraverse__1091604167(gopurs_runtime.CoerceToStruct[Constructor_Data_Bitraversable_Bitraversable[gopurs_runtime.Value]](dict_0_box))
})
	})
...
return gopurs_runtime.Func(func(v_7 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 3559137202, UnsafePtr: unsafe.Pointer(&Constructor_Data_Functor_Product2_Product2[gopurs_runtime.Value, gopurs_runtime.Value, gopurs_runtime.Value, gopurs_runtime.Value]{1, gopurs_runtime.Apply3(gopurs_runtime.RecordGet(__local_var_1_0, "bimap"), f_5, g_6, (*Constructor_Data_Functor_Product2_Product2[gopurs_runtime.Value, gopurs_runtime.Value, gopurs_runtime.Value, gopurs_runtime.Value])(v_7.UnsafePtr).V0), gopurs_runtime.Apply3(gopurs_runtime.RecordGet(__local_var_4_3, "bimap"), f_5, g_6, (*Constructor_Data_Functor_Product2_Product2[gopurs_runtime.Value, gopurs_runtime.Value, gopurs_runtime.Value, gopurs_runtime.Value])(v_7.UnsafePtr).V1)})}
})
})
}))
...
_ = Apply0_7_5
// TAST (Let): Functor0_8_6 -> *Constructor_Data_Functor_Functor[gopurs_runtime.Value]
...
// TAST (Let): Apply0_7_7 -> *Constructor_Control_Apply_Apply[gopurs_runtime.Value]
...
_ = Apply0_7_7
// TAST (Let): Functor0_8_8 -> *Constructor_Data_Functor_Functor[gopurs_runtime.Value]
...
var dictBitraversable_0 *Constructor_Data_Bitraversable_Bitraversable[gopurs_runtime.Value] = dictBitraversable_0_loop
_ = dictBitraversable_0
// TAST (Let): Bifunctor0_1_0 -> *Constructor_Data_Bifunctor_Bifunctor[gopurs_runtime.Value]
...
func Call_Data_Bitraversable_bisequence__3517827200(dict_0_loop *Constructor_Data_Bitraversable_Bitraversable[gopurs_runtime.Value]) gopurs_runtime.Value {
var dict_0 *Constructor_Data_Bitraversable_Bitraversable[gopurs_runtime.Value] = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V2)
}

func Call_Data_Bitraversable_bitraverse__3884078439(dict_0_loop *Constructor_Data_Bitraversable_Bitraversable[gopurs_runtime.Value]) gopurs_runtime.Value {
var dict_0 *Constructor_Data_Bitraversable_Bitraversable[gopurs_runtime.Value] = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V3)
}

func Call_Data_Bitraversable_bitraverse__1091604167(dict_0_loop *Constructor_Data_Bitraversable_Bitraversable[gopurs_runtime.Value]) gopurs_runtime.Value {
var dict_0 *Constructor_Data_Bitraversable_Bitraversable[gopurs_runtime.Value] = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V3)
}
