...
func Get_Data_String_NonEmpty_CaseInsensitive_showCaseInsensitiveNonEmptyString() gopurs_runtime.Value {
	once_Data_String_NonEmpty_CaseInsensitive_showCaseInsensitiveNonEmptyString.Do(func() {
		cache_Data_String_NonEmpty_CaseInsensitive_showCaseInsensitiveNonEmptyString = gopurs_runtime.Value{Type: 9, IntVal: 1835580986, UnsafePtr: unsafe.Pointer(&Constructor_Data_Show_Show{1, gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Data_String_NonEmpty_CaseInsensitive_newtypeCaseInsensitiveNonEmptyString() gopurs_runtime.Value {
	once_Data_String_NonEmpty_CaseInsensitive_newtypeCaseInsensitiveNonEmptyString.Do(func() {
		cache_Data_String_NonEmpty_CaseInsensitive_newtypeCaseInsensitiveNonEmptyString = gopurs_runtime.Value{Type: 9, IntVal: 3322196858, UnsafePtr: unsafe.Pointer(&Constructor_Data_Newtype_Newtype{1, gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Data_String_NonEmpty_CaseInsensitive_eqCaseInsensitiveNonEmptyString() gopurs_runtime.Value {
	once_Data_String_NonEmpty_CaseInsensitive_eqCaseInsensitiveNonEmptyString.Do(func() {
		cache_Data_String_NonEmpty_CaseInsensitive_eqCaseInsensitiveNonEmptyString = gopurs_runtime.Value{Type: 9, IntVal: 1012063514, UnsafePtr: unsafe.Pointer(&Constructor_Data_Eq_Eq{1, gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Data_String_NonEmpty_CaseInsensitive_ordCaseInsensitiveNonEmptyString() gopurs_runtime.Value {
	once_Data_String_NonEmpty_CaseInsensitive_ordCaseInsensitiveNonEmptyString.Do(func() {
		cache_Data_String_NonEmpty_CaseInsensitive_ordCaseInsensitiveNonEmptyString = gopurs_runtime.Value{Type: 9, IntVal: 1435789946, UnsafePtr: unsafe.Pointer(&Constructor_Data_Ord_Ord{1, gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 1012063514, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Eq_Eq](Get_Data_String_NonEmpty_CaseInsensitive_eqCaseInsensitiveNonEmptyString()))}
