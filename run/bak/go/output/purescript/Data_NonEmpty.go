...
return Call_Data_NonEmpty_foldl1(gopurs_runtime.CoerceToStruct[Constructor_Data_Foldable_Foldable](dictFoldable_0_box))
})
	})
...
__local_var_3_0 := gopurs_runtime.CoerceToStruct[Constructor_Data_Tuple_Tuple](gopurs_runtime.Apply2(gopurs_runtime.RecordGet(Get_Data_Tuple_functorTuple(), "map"), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictUnfoldable_0, "unfoldr"), gopurs_runtime.Apply(gopurs_runtime.RecordGet(Get_Data_Maybe_functorMaybe(), "map"), f_1)), gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Tuple_Tuple](gopurs_runtime.Apply(f_1, b_2)))}))
_ = __local_var_3_0
...
Semigroup0_3_1 := gopurs_runtime.CoerceToStruct[Constructor_Data_Semigroup_Semigroup](gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonoid_2, "Semigroup0"), gopurs_runtime.Value{}))
_ = Semigroup0_3_1
...
// TAST (Let): Apply0_4_3 -> *Constructor_Control_Apply_Apply
Apply0_4_3 := gopurs_runtime.CoerceToStruct[Constructor_Control_Apply_Apply](gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictApplicative_3, "Apply0"), gopurs_runtime.Value{}))
_ = Apply0_4_3
// TAST (Let): Functor0_5_4 -> *Constructor_Data_Functor_Functor
Functor0_5_4 := gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor](gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictApplicative_3, "Apply0"), gopurs_runtime.Value{}), "Functor0"), gopurs_runtime.Value{}))
_ = Functor0_5_4
...
// TAST (Let): Apply0_5_6 -> *Constructor_Control_Apply_Apply
Apply0_5_6 := gopurs_runtime.CoerceToStruct[Constructor_Control_Apply_Apply](gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictApplicative_4, "Apply0"), gopurs_runtime.Value{}))
_ = Apply0_5_6
// TAST (Let): Functor0_6_7 -> *Constructor_Data_Functor_Functor
Functor0_6_7 := gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor](gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictApplicative_4, "Apply0"), gopurs_runtime.Value{}), "Functor0"), gopurs_runtime.Value{}))
_ = Functor0_6_7
...
__local_var_4_1 := gopurs_runtime.Apply(f_2, (*Constructor_Data_NonEmpty_NonEmpty)(v_3.UnsafePtr).V0)
_ = __local_var_4_1
// TAST (Let): __local_var_5_2 -> *Constructor_Data_Maybe_Just
__local_var_5_2 := gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just](gopurs_runtime.Apply3(gopurs_runtime.RecordGet(dictFoldable_0, "foldr"), gopurs_runtime.Func(func(a1_5 gopurs_runtime.Value) gopurs_runtime.Value {
...
{
if (v2_7.Type == 9 && v2_7.IntVal == 930809136 && v2_7.UnsafePtr != nil) {
__t5 = gopurs_runtime.Apply(__local_var_6_4, (*Constructor_Data_Maybe_Just)(v2_7.UnsafePtr).V0)
goto end_branch_5
} else {
...
return gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&Constructor_Data_Maybe_Just{1, gopurs_runtime.Apply(__local_var_6_3, x_7)})}
})
...
__t6 = (*Constructor_Data_NonEmpty_NonEmpty)(v_3.UnsafePtr).V0
goto end_branch_6
} else {
...
{
if (__local_var_5_2 != nil) {
__t6 = gopurs_runtime.Apply(__local_var_4_1, (__local_var_5_2).V0)
goto end_branch_6
} else {
...
func Call_Data_NonEmpty_foldl1(dictFoldable_0_loop *Constructor_Data_Foldable_Foldable) gopurs_runtime.Value {
...
return gopurs_runtime.Func(func(y_5 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Bool(((gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictEq_3, "eq"), (*Constructor_Data_NonEmpty_NonEmpty)(x_4.UnsafePtr).V0, (*Constructor_Data_NonEmpty_NonEmpty)(y_5.UnsafePtr).V0).IntVal) != (0)) && ((gopurs_runtime.Apply3(gopurs_runtime.RecordGet(__local_var_2_2, "eq1"), gopurs_runtime.Value{Type: 9, IntVal: 1012063514, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Eq_Eq](dictEq_3))}, (*Constructor_Data_NonEmpty_NonEmpty)(x_4.UnsafePtr).V1, (*Constructor_Data_NonEmpty_NonEmpty)(y_5.UnsafePtr).V1).IntVal) != (0)))
})
})
}))
_ = eq1NonEmpty1_2_1
...
_ = __eta0_0
return gopurs_runtime.Value{Type: 9, IntVal: 3111306138, UnsafePtr: unsafe.Pointer(&Constructor_Data_NonEmpty_NonEmpty{1, __eta0_0, gopurs_runtime.RecordGet(Get_Data_List_Lazy_Types_plusList(), "empty")})}
}
