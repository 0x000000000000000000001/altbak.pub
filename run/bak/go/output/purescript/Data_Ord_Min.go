...
func Get_Data_Ord_Min_newtypeMin() gopurs_runtime.Value {
	once_Data_Ord_Min_newtypeMin.Do(func() {
		cache_Data_Ord_Min_newtypeMin = gopurs_runtime.RecordDict1("Coercible0", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = __local_var_1_1
// TAST (Let): semigroupMin1_1_0 -> gopurs_runtime.Value
...
var dictOrd_0 gopurs_runtime.Value = dictOrd_0_loop
_ = dictOrd_0
// TAST (Let): eqMin1_1_0 -> gopurs_runtime.Value
