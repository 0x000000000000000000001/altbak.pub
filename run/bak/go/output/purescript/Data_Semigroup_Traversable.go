...
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(Get_Data_Semigroup_Traversable_traversableDual(), "traverse1"), gopurs_runtime.Value{Type: 9, IntVal: 3032403085, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Apply_Apply[gopurs_runtime.Value]](dictApply_0))}, Get_Data_Semigroup_Traversable_identity())
}), gopurs_runtime.Func(func(dictApply_0 gopurs_runtime.Value) gopurs_runtime.Value {
// TAST (Let): Functor0_1_0 -> *Constructor_Data_Functor_Functor[gopurs_runtime.Value]
Functor0_1_0 := gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor[gopurs_runtime.Value]](gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictApply_0, "Functor0"), gopurs_runtime.Value{}))
_ = Functor0_1_0
...
return Call_Data_Semigroup_Traversable_sequence1__4078930642(gopurs_runtime.CoerceToStruct[Constructor_Data_Semigroup_Traversable_Traversable1[gopurs_runtime.Value]](dict_0_box))
})
	})
...
return Call_Data_Semigroup_Traversable_sequence1__2726498490(gopurs_runtime.CoerceToStruct[Constructor_Data_NonEmpty_NonEmpty[*Constructor_Data_List_Types_Cons[gopurs_runtime.Value], gopurs_runtime.Value]](dictApply_0_box))
})
	})
...
return Call_Data_Semigroup_Traversable_traverse1__236758920(gopurs_runtime.CoerceToStruct[Constructor_Data_Semigroup_Traversable_Traversable1[*Constructor_Data_NonEmpty_NonEmpty[gopurs_runtime.Value, gopurs_runtime.Value]]](dict_0_box))
})
	})
...
return Call_Data_Semigroup_Traversable_traverse1__157785005(gopurs_runtime.CoerceToStruct[Constructor_Data_Semigroup_Traversable_Traversable1[gopurs_runtime.Value]](dict_0_box))
})
	})
...
return Call_Data_Semigroup_Traversable_traverse1__4157595309(gopurs_runtime.CoerceToStruct[Constructor_Data_Semigroup_Traversable_Traversable1[gopurs_runtime.Value]](dict_0_box))
})
	})
...
func init() {
	gopurs_runtime.StructGetters[1596088409] = func(ptr unsafe.Pointer, key string) gopurs_runtime.Value {
		c := (*Constructor_Data_Semigroup_Traversable_Traversable1[gopurs_runtime.Value])(ptr)
		_ = c
		switch key {
...
func Call_Data_Semigroup_Traversable_sequence1__4078930642(dict_0_loop *Constructor_Data_Semigroup_Traversable_Traversable1[gopurs_runtime.Value]) gopurs_runtime.Value {
var dict_0 *Constructor_Data_Semigroup_Traversable_Traversable1[gopurs_runtime.Value] = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V2)
}

func Call_Data_Semigroup_Traversable_sequence1__2726498490(dictApply_0_loop *Constructor_Data_NonEmpty_NonEmpty[*Constructor_Data_List_Types_Cons[gopurs_runtime.Value], gopurs_runtime.Value]) gopurs_runtime.Value {
var dictApply_0 *Constructor_Data_NonEmpty_NonEmpty[*Constructor_Data_List_Types_Cons[gopurs_runtime.Value], gopurs_runtime.Value] = dictApply_0_loop
_ = dictApply_0
...
func Call_Data_Semigroup_Traversable_traverse1__236758920(dict_0_loop *Constructor_Data_Semigroup_Traversable_Traversable1[*Constructor_Data_NonEmpty_NonEmpty[gopurs_runtime.Value, gopurs_runtime.Value]]) gopurs_runtime.Value {
var dict_0 *Constructor_Data_Semigroup_Traversable_Traversable1[*Constructor_Data_NonEmpty_NonEmpty[gopurs_runtime.Value, gopurs_runtime.Value]] = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V3)
}

func Call_Data_Semigroup_Traversable_traverse1__157785005(dict_0_loop *Constructor_Data_Semigroup_Traversable_Traversable1[gopurs_runtime.Value]) gopurs_runtime.Value {
var dict_0 *Constructor_Data_Semigroup_Traversable_Traversable1[gopurs_runtime.Value] = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V3)
}

func Call_Data_Semigroup_Traversable_traverse1__4157595309(dict_0_loop *Constructor_Data_Semigroup_Traversable_Traversable1[gopurs_runtime.Value]) gopurs_runtime.Value {
var dict_0 *Constructor_Data_Semigroup_Traversable_Traversable1[gopurs_runtime.Value] = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V3)
}
...
return gopurs_runtime.Value{Type: 9, IntVal: 3111306138, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_NonEmpty_NonEmpty[*Constructor_Data_List_Types_Cons[gopurs_runtime.Value], *Constructor_Data_List_Types_Cons[gopurs_runtime.Value]]](gopurs_runtime.Apply3(gopurs_runtime.RecordGet(Get_Data_List_Types_foldableList(), "foldl"), gopurs_runtime.Func(func(b_5 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(a_6 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(Get_Data_List_Types_nelCons(), a_6, b_5)
})
}), gopurs_runtime.Value{Type: 9, IntVal: 3111306138, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_NonEmpty_NonEmpty[*Constructor_Data_List_Types_Cons[gopurs_runtime.Value], *Constructor_Data_List_Types_Cons[gopurs_runtime.Value]]](gopurs_runtime.Apply(gopurs_runtime.RecordGet(Get_Data_List_Types_applicativeNonEmptyList(), "pure"), gopurs_runtime.Value{Type: 9, IntVal: 1358893437, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_List_Types_Cons[gopurs_runtime.Value]]((*Constructor_Data_NonEmpty_NonEmpty[gopurs_runtime.Value, gopurs_runtime.Value])(v1_4.UnsafePtr).V0))})))}, gopurs_runtime.Value{Type: 9, IntVal: 1358893437, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_List_Types_Cons[*Constructor_Data_List_Types_Cons[gopurs_runtime.Value]]]((*Constructor_Data_NonEmpty_NonEmpty[gopurs_runtime.Value, gopurs_runtime.Value])(v1_4.UnsafePtr).V1))})))}
