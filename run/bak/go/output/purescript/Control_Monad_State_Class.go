...
return Call_Control_Monad_State_Class_state(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_State_Class_MonadState](dict_0_box))
})
	})
...
return Call_Control_Monad_State_Class_put(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_State_Class_MonadState](dictMonadState_0_box), s_1_box)
})
	})
...
return Call_Control_Monad_State_Class_modify_(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_State_Class_MonadState](dictMonadState_0_box), f_1_box)
})
	})
...
return Call_Control_Monad_State_Class_modify(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_State_Class_MonadState](dictMonadState_0_box), f_1_box)
})
	})
...
return Call_Control_Monad_State_Class_gets(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_State_Class_MonadState](dictMonadState_0_box), f_1_box)
})
	})
...
return Call_Control_Monad_State_Class_state__1155042704(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_State_Class_MonadState](dict_0_box))
})
	})
...
return Call_Control_Monad_State_Class_state__3572857840(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_State_Class_MonadState](dict_0_box))
})
	})
	return cache_Control_Monad_State_Class_state__3572857840
}

type Constructor_Control_Monad_State_Class_MonadState struct {
	Rc uint32
...
func init() {
	gopurs_runtime.StructGetters[2100320995] = func(ptr unsafe.Pointer, key string) gopurs_runtime.Value {
		c := (*Constructor_Control_Monad_State_Class_MonadState)(ptr)
		_ = c
		switch key {
...
func Call_Control_Monad_State_Class_state(dict_0_loop *Constructor_Control_Monad_State_Class_MonadState) gopurs_runtime.Value {
var dict_0 *Constructor_Control_Monad_State_Class_MonadState = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V1)
}

func Call_Control_Monad_State_Class_put(dictMonadState_0_loop *Constructor_Control_Monad_State_Class_MonadState, s_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictMonadState_0 *Constructor_Control_Monad_State_Class_MonadState = dictMonadState_0_loop
_ = dictMonadState_0
...
return gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&Constructor_Data_Tuple_Tuple{1, Get_Data_Unit_unit(), s_1})}
}))
}

func Call_Control_Monad_State_Class_modify_(dictMonadState_0_loop *Constructor_Control_Monad_State_Class_MonadState, f_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictMonadState_0 *Constructor_Control_Monad_State_Class_MonadState = dictMonadState_0_loop
_ = dictMonadState_0
...
return gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&Constructor_Data_Tuple_Tuple{1, Get_Data_Unit_unit(), gopurs_runtime.Apply(f_1, s_2)})}
}))
}

func Call_Control_Monad_State_Class_modify(dictMonadState_0_loop *Constructor_Control_Monad_State_Class_MonadState, f_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictMonadState_0 *Constructor_Control_Monad_State_Class_MonadState = dictMonadState_0_loop
_ = dictMonadState_0
var f_1 gopurs_runtime.Value = f_1_loop
_ = f_1
...
_ = s_prime_3_0
return gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&Constructor_Data_Tuple_Tuple{1, s_prime_3_0, s_prime_3_0})}
}))
}

func Call_Control_Monad_State_Class_gets(dictMonadState_0_loop *Constructor_Control_Monad_State_Class_MonadState, f_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictMonadState_0 *Constructor_Control_Monad_State_Class_MonadState = dictMonadState_0_loop
_ = dictMonadState_0
var f_1 gopurs_runtime.Value = f_1_loop
_ = f_1
return gopurs_runtime.Apply(gopurs_runtime.Box(dictMonadState_0.V1), gopurs_runtime.Func(func(s_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&Constructor_Data_Tuple_Tuple{1, gopurs_runtime.Apply(f_1, s_2), s_2})}
}))
}
...
return gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&Constructor_Data_Tuple_Tuple{1, s_1, s_1})}
}))
}

func Call_Control_Monad_State_Class_state__1155042704(dict_0_loop *Constructor_Control_Monad_State_Class_MonadState) gopurs_runtime.Value {
var dict_0 *Constructor_Control_Monad_State_Class_MonadState = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V1)
}

func Call_Control_Monad_State_Class_state__3572857840(dict_0_loop *Constructor_Control_Monad_State_Class_MonadState) gopurs_runtime.Value {
var dict_0 *Constructor_Control_Monad_State_Class_MonadState = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V1)
}
