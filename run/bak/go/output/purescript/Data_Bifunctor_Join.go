...
func Get_Data_Bifunctor_Join_newtypeJoin() gopurs_runtime.Value {
	once_Data_Bifunctor_Join_newtypeJoin.Do(func() {
		cache_Data_Bifunctor_Join_newtypeJoin = gopurs_runtime.Value{Type: 9, IntVal: 3322196858, UnsafePtr: unsafe.Pointer(&Constructor_Data_Newtype_Newtype{1, gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = __local_var_1_1
// TAST (Let): bifunctorJoin1_1_0 -> *Constructor_Data_Functor_Functor
bifunctorJoin1_1_0 := gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor](gopurs_runtime.RecordDict1("map", gopurs_runtime.Func(func(f_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = __local_var_2_3
// TAST (Let): bifunctorJoin1_2_2 -> *Constructor_Data_Functor_Functor
bifunctorJoin1_2_2 := gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor](gopurs_runtime.RecordDict1("map", gopurs_runtime.Func(func(f_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
// TAST (Let): biapplyJoin1_1_0 -> *Constructor_Control_Apply_Apply
biapplyJoin1_1_0 := &Constructor_Control_Apply_Apply{1, gopurs_runtime.Func(func(_dollar__unused_3 gopurs_runtime.Value) gopurs_runtime.Value {
