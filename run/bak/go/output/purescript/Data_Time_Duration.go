...
_ = __local_var_0_0
// TAST (Let): Semiring0_1_1 -> *Constructor_Data_Semiring_Semiring[gopurs_runtime.Value]
Semiring0_1_1 := gopurs_runtime.CoerceToStruct[Constructor_Data_Semiring_Semiring[gopurs_runtime.Value]](gopurs_runtime.Apply(gopurs_runtime.RecordGet(__local_var_0_0, "Semiring0"), gopurs_runtime.Value{}))
_ = Semiring0_1_1
...
return Call_Data_Time_Duration_negateDuration(gopurs_runtime.CoerceToStruct[Constructor_Data_Time_Duration_Duration[gopurs_runtime.Value]](dictDuration_0_box), x_1_box)
})
	})
...
return Call_Data_Time_Duration_fromDuration__1721614606(gopurs_runtime.CoerceToStruct[Constructor_Data_Time_Duration_Duration[gopurs_runtime.Value]](dict_0_box))
})
	})
...
return Call_Data_Time_Duration_negateDuration__3870190523(gopurs_runtime.CoerceToStruct[Constructor_Data_Time_Duration_Duration[gopurs_runtime.Value]](dictDuration_0_box), x_1_box)
})
	})
...
return Call_Data_Time_Duration_toDuration__2440169646(gopurs_runtime.CoerceToStruct[Constructor_Data_Time_Duration_Duration[gopurs_runtime.Value]](dict_0_box))
})
	})
...
func Call_Data_Time_Duration_negateDuration(dictDuration_0_loop *Constructor_Data_Time_Duration_Duration[gopurs_runtime.Value], x_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_Data_Time_Duration_fromDuration__1721614606(dict_0_loop *Constructor_Data_Time_Duration_Duration[gopurs_runtime.Value]) gopurs_runtime.Value {
var dict_0 *Constructor_Data_Time_Duration_Duration[gopurs_runtime.Value] = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V0)
}
...
func Call_Data_Time_Duration_negateDuration__3870190523(dictDuration_0_loop *Constructor_Data_Time_Duration_Duration[gopurs_runtime.Value], x_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictDuration_0 *Constructor_Data_Time_Duration_Duration[gopurs_runtime.Value] = dictDuration_0_loop
_ = dictDuration_0
var x_1 gopurs_runtime.Value = x_1_loop
_ = x_1
...
func Call_Data_Time_Duration_toDuration__2440169646(dict_0_loop *Constructor_Data_Time_Duration_Duration[gopurs_runtime.Value]) gopurs_runtime.Value {
var dict_0 *Constructor_Data_Time_Duration_Duration[gopurs_runtime.Value] = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V1)
}
