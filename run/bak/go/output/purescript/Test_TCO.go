...
func Get_Test_TCO_logShow() gopurs_runtime.Value {
	once_Test_TCO_logShow.Do(func() {
		cache_Test_TCO_logShow = gopurs_runtime.Apply(Get_Effect_Console_logShow(), Get_Data_Show_showInt())
	})
...
func Get_Test_TCO_act() gopurs_runtime.Value {
	once_Test_TCO_act.Do(func() {
		cache_Test_TCO_act = func() gopurs_runtime.Value {
...
_ = __local_var_1_1
return gopurs_runtime.Apply(gopurs_runtime.Apply(Get_Effect_Console_log(), gopurs_runtime.Str(gopurs_runtime.Apply(gopurs_runtime.RecordGet(Get_Data_Show_showInt(), "show"), gopurs_runtime.Int(gopurs_runtime.Int(Call_Test_TCO_deepTailRec(__local_var_1_1.IntVal, 0)).IntVal)).StrVal())), gopurs_runtime.Value{})
})
}()
	})
