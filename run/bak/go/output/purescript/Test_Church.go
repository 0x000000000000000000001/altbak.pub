...
_ = __local_var_1_1
return gopurs_runtime.Apply(gopurs_runtime.Apply(Get_Effect_Console_log(), gopurs_runtime.Str(gopurs_runtime.Apply(gopurs_runtime.RecordGet(Get_Data_Show_showInt(), "show"), gopurs_runtime.Int(gopurs_runtime.Apply2(Call_Test_Church_c100k(__local_var_1_1.IntVal), gopurs_runtime.Func(func(x_2 gopurs_runtime.Value) gopurs_runtime.Value {
