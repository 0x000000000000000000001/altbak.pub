...
func Get_Data_Equivalence_semigroupEquivalence() gopurs_runtime.Value {
	once_Data_Equivalence_semigroupEquivalence.Do(func() {
		cache_Data_Equivalence_semigroupEquivalence = gopurs_runtime.Value{Type: 9, IntVal: 2053112122, UnsafePtr: unsafe.Pointer(&Constructor_Data_Semigroup_Semigroup{1, gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Data_Equivalence_newtypeEquivalence() gopurs_runtime.Value {
	once_Data_Equivalence_newtypeEquivalence.Do(func() {
		cache_Data_Equivalence_newtypeEquivalence = gopurs_runtime.Value{Type: 9, IntVal: 3322196858, UnsafePtr: unsafe.Pointer(&Constructor_Data_Newtype_Newtype{1, gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Data_Equivalence_monoidEquivalence() gopurs_runtime.Value {
	once_Data_Equivalence_monoidEquivalence.Do(func() {
		cache_Data_Equivalence_monoidEquivalence = gopurs_runtime.Value{Type: 9, IntVal: 1722653594, UnsafePtr: unsafe.Pointer(&Constructor_Data_Monoid_Monoid{1, gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 2053112122, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Semigroup_Semigroup](Get_Data_Equivalence_semigroupEquivalence()))}
...
func Get_Data_Equivalence_contravariantEquivalence() gopurs_runtime.Value {
	once_Data_Equivalence_contravariantEquivalence.Do(func() {
		cache_Data_Equivalence_contravariantEquivalence = gopurs_runtime.Value{Type: 9, IntVal: 85171506, UnsafePtr: unsafe.Pointer(&Constructor_Data_Functor_Contravariant_Contravariant{1, gopurs_runtime.Func(func(f_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
var cache_Data_Equivalence_contravariantEquivalence__1745327145 gopurs_runtime.Value
var once_Data_Equivalence_contravariantEquivalence__1745327145 sync.Once
func Get_Data_Equivalence_contravariantEquivalence__1745327145() gopurs_runtime.Value {
	once_Data_Equivalence_contravariantEquivalence__1745327145.Do(func() {
		cache_Data_Equivalence_contravariantEquivalence__1745327145 = gopurs_runtime.Value{Type: 9, IntVal: 85171506, UnsafePtr: unsafe.Pointer(&Constructor_Data_Functor_Contravariant_Contravariant{1, gopurs_runtime.Func(func(f_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(v_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(x_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(y_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(v_1, gopurs_runtime.Apply(f_0, x_2), gopurs_runtime.Apply(f_0, y_3))
	...
	return cache_Data_Equivalence_contravariantEquivalence__1745327145
}

var cache_Data_Equivalence_semigroupEquivalence__2006742817 gopurs_runtime.Value
var once_Data_Equivalence_semigroupEquivalence__2006742817 sync.Once
func Get_Data_Equivalence_semigroupEquivalence__2006742817() gopurs_runtime.Value {
	once_Data_Equivalence_semigroupEquivalence__2006742817.Do(func() {
		cache_Data_Equivalence_semigroupEquivalence__2006742817 = gopurs_runtime.Value{Type: 9, IntVal: 2053112122, UnsafePtr: unsafe.Pointer(&Constructor_Data_Semigroup_Semigroup{1, gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(v1_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(a_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(b_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Bool(((gopurs_runtime.Apply2(v_0, a_2, b_3).IntVal) != (0)) && ((gopurs_runtime.Apply2(v1_1, a_2, b_3).IntVal) != (0)))
	...
	return cache_Data_Equivalence_semigroupEquivalence__2006742817
}
