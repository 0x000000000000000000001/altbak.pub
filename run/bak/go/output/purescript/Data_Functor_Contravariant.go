...
return Call_Data_Functor_Contravariant_cmap__326373820(gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Contravariant_Contravariant[gopurs_runtime.Value]](dict_0_box))
})
	})
...
return Call_Data_Functor_Contravariant_cmap__1884541340(gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Contravariant_Contravariant[gopurs_runtime.Value]](dict_0_box))
})
	})
...
func init() {
	gopurs_runtime.StructGetters[85171506] = func(ptr unsafe.Pointer, key string) gopurs_runtime.Value {
		c := (*Constructor_Data_Functor_Contravariant_Contravariant[gopurs_runtime.Value])(ptr)
		_ = c
		switch key {
...
func Call_Data_Functor_Contravariant_cmap__326373820(dict_0_loop *Constructor_Data_Functor_Contravariant_Contravariant[gopurs_runtime.Value]) gopurs_runtime.Value {
var dict_0 *Constructor_Data_Functor_Contravariant_Contravariant[gopurs_runtime.Value] = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V0)
}

func Call_Data_Functor_Contravariant_cmap__1884541340(dict_0_loop *Constructor_Data_Functor_Contravariant_Contravariant[gopurs_runtime.Value]) gopurs_runtime.Value {
var dict_0 *Constructor_Data_Functor_Contravariant_Contravariant[gopurs_runtime.Value] = dict_0_loop
_ = dict_0
return gopurs_runtime.Box(dict_0.V0)
}
