...
_ = __local_var_13_13
__local_var_14_14 := gopurs_runtime.Apply(gopurs_runtime.Apply2(Get_Bench_runBench(), Get_Test_RowToList_describe(), Get_Test_RowToList_act()), gopurs_runtime.Value{})
_ = __local_var_14_14
