...
_ = __local_var_1_1
return gopurs_runtime.Apply(gopurs_runtime.Apply(Get_Effect_Console_log(), gopurs_runtime.Str(gopurs_runtime.Apply(Get_Data_Show_showIntImpl(), gopurs_runtime.Int(Call_Test_RBTree_depth(Call_Test_RBTree_buildTree(__local_var_1_1.IntVal, (*Constructor_Test_RBTree_T)(nil))))).StrVal())), gopurs_runtime.Value{})
})
}()
	})
...
end_branch_2:
if __t2 {
__t3 = Call_Test_RBTree_balance((v1_1).V0, Call_Test_RBTree_ins(v_0, (v1_1).V1), (v1_1).V2, (v1_1).V3)
goto end_branch_3
} else {
