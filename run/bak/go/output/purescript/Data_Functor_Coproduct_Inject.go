...
func Get_Data_Functor_Coproduct_Inject_injectReflexive() gopurs_runtime.Value {
	once_Data_Functor_Coproduct_Inject_injectReflexive.Do(func() {
		cache_Data_Functor_Coproduct_Inject_injectReflexive = gopurs_runtime.RecordDict2("inj", "prj", gopurs_runtime.Func(func(x_0 gopurs_runtime.Value) gopurs_runtime.Value {
return x_0
}), Get_Data_Maybe_Just())
	})
