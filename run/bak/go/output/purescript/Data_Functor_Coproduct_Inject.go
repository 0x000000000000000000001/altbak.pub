...
var cache_Data_Functor_Coproduct_Inject_Inject_dollarDict gopurs_runtime.Value
var once_Data_Functor_Coproduct_Inject_Inject_dollarDict sync.Once
func Get_Data_Functor_Coproduct_Inject_Inject_dollarDict() gopurs_runtime.Value {
	once_Data_Functor_Coproduct_Inject_Inject_dollarDict.Do(func() {
		cache_Data_Functor_Coproduct_Inject_Inject_dollarDict = gopurs_runtime.Func(func(x_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_Data_Functor_Coproduct_Inject_Inject_dollarDict(x_0_box)
})
	})
	return cache_Data_Functor_Coproduct_Inject_Inject_dollarDict
}
...
func Get_Data_Functor_Coproduct_Inject_injectReflexive() gopurs_runtime.Value {
	once_Data_Functor_Coproduct_Inject_injectReflexive.Do(func() {
		cache_Data_Functor_Coproduct_Inject_injectReflexive = gopurs_runtime.Value{Type: 9, IntVal: 3819687178, UnsafePtr: unsafe.Pointer(&Constructor_Data_Functor_Coproduct_Inject_Inject{1, gopurs_runtime.Func(func(x_0 gopurs_runtime.Value) gopurs_runtime.Value {
return x_0
}), Get_Data_Maybe_Just()})}
	})
...
func Get_Data_Functor_Coproduct_Inject_injectLeft() gopurs_runtime.Value {
	once_Data_Functor_Coproduct_Inject_injectLeft.Do(func() {
		cache_Data_Functor_Coproduct_Inject_injectLeft = gopurs_runtime.Value{Type: 9, IntVal: 3819687178, UnsafePtr: unsafe.Pointer(&Constructor_Data_Functor_Coproduct_Inject_Inject{1, gopurs_runtime.Func(func(x_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_Data_Functor_Coproduct_Inject_Inject_dollarDict(x_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = dictInject_0
return gopurs_runtime.Value{Type: 9, IntVal: 3819687178, UnsafePtr: unsafe.Pointer(&Constructor_Data_Functor_Coproduct_Inject_Inject{1, gopurs_runtime.Func(func(x_1 gopurs_runtime.Value) gopurs_runtime.Value {
