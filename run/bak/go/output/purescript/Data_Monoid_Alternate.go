...
func Get_Data_Monoid_Alternate_newtypeAlternate() gopurs_runtime.Value {
	once_Data_Monoid_Alternate_newtypeAlternate.Do(func() {
		cache_Data_Monoid_Alternate_newtypeAlternate = gopurs_runtime.Value{Type: 9, IntVal: 3322196858, UnsafePtr: unsafe.Pointer(&Constructor_Data_Newtype_Newtype{1, gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = dictOrd1_0
return gopurs_runtime.Value{Type: 9, IntVal: 1632188299, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Ord_Ord1](dictOrd1_0))}
}
...
_ = __local_var_1_1
// TAST (Let): semigroupAlternate1_1_0 -> *Constructor_Data_Semigroup_Semigroup
semigroupAlternate1_1_0 := gopurs_runtime.CoerceToStruct[Constructor_Data_Semigroup_Semigroup](gopurs_runtime.RecordDict1("append", gopurs_runtime.Func(func(v_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = dictEq1_0
return gopurs_runtime.Value{Type: 9, IntVal: 1715248107, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Eq_Eq1](dictEq1_0))}
}
