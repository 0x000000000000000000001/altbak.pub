...
_ = __local_var_1_1
return gopurs_runtime.Apply(gopurs_runtime.Apply(Get_Effect_Console_log(), gopurs_runtime.Str(gopurs_runtime.Apply(Get_Data_Show_showIntImpl(), gopurs_runtime.Int(Call_Test_Ackermann_ackermann(__local_var_1_1.IntVal, 4))).StrVal())), gopurs_runtime.Value{})
})
}()
	})
