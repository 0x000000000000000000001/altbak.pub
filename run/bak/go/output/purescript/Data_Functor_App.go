...
func Get_Data_Functor_App_newtypeApp() gopurs_runtime.Value {
	once_Data_Functor_App_newtypeApp.Do(func() {
		cache_Data_Functor_App_newtypeApp = gopurs_runtime.RecordDict1("Coercible0", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = append_3_2
// TAST (Let): semigroupApp2_3_1 -> gopurs_runtime.Value
...
_ = __local_var_3_2
// TAST (Let): eqApp2_3_1 -> gopurs_runtime.Value
...
_ = __local_var_1_1
// TAST (Let): eq1App1_1_0 -> gopurs_runtime.Value
