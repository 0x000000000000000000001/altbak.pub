...
func Get_Data_Interval_foldableInterval() gopurs_runtime.Value {
	once_Data_Interval_foldableInterval.Do(func() {
		cache_Data_Interval_foldableInterval = gopurs_runtime.Value{Type: 9, IntVal: 4280266298, UnsafePtr: unsafe.Pointer(&Constructor_Data_Foldable_Foldable{1, gopurs_runtime.Func(func(dictMonoid_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply2(gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Data_Foldable_Foldable](Get_Data_Interval_foldableInterval()).V1), gopurs_runtime.Func(func(acc_4 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Func(func(u_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(xs_2 gopurs_runtime.Value) gopurs_runtime.Value {
var go__go_3_3_0 gopurs_runtime.Value
go__go_3_3_0 = gopurs_runtime.Func(func(acc_4_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
...
go__go_3_3_0:
for {
if false { continue go__go_3_3_0 }
...
{
var __t_tag_5 gopurs_runtime.Value = (*Constructor_Data_Foldable_Append)(rhs_6.UnsafePtr).V0
if (__t_tag_5.Type == 9 && __t_tag_5.IntVal == 2065045956) {
acc_4_loop = acc_4
lhs_5_loop = lhs_5
...
return gopurs_runtime.Apply3(go__go_3_3_0, u_1, gopurs_runtime.Value{Type: 9, IntVal: 2065045956, UnsafePtr: unsafe.Pointer(nil)}, gopurs_runtime.Apply3(gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Data_Foldable_Foldable](Get_Data_Interval_foldableInterval()).V0), gopurs_runtime.Value{Type: 9, IntVal: 1722653594, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Monoid_Monoid](Get_Data_Foldable_monoidFreeMonoidTree()))}, Get_Data_Foldable_Node(), xs_2))
})
})
})})}
	})
...
func Get_Data_Interval_foldableRecurringInterval() gopurs_runtime.Value {
	once_Data_Interval_foldableRecurringInterval.Do(func() {
		cache_Data_Interval_foldableRecurringInterval = gopurs_runtime.Value{Type: 9, IntVal: 4280266298, UnsafePtr: unsafe.Pointer(&Constructor_Data_Foldable_Foldable{1, gopurs_runtime.Func(func(dictMonoid_0 gopurs_runtime.Value) gopurs_runtime.Value {
// TAST (Let): Semigroup0_1_0 -> *Constructor_Data_Semigroup_Semigroup
Semigroup0_1_0 := gopurs_runtime.CoerceToStruct[Constructor_Data_Semigroup_Semigroup](gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonoid_0, "Semigroup0"), gopurs_runtime.Value{}))
_ = Semigroup0_1_0
// TAST (Let): mempty_2_1 -> gopurs_runtime.Value
...
_ = mempty_2_1
return gopurs_runtime.Func(func(f_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Data_Foldable_Foldable](Get_Data_Interval_foldableRecurringInterval()).V1), gopurs_runtime.Func(func(acc_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(x_5 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.Box(Semigroup0_1_0.V0), acc_4, gopurs_runtime.Apply(f_3, x_5))
})
}), mempty_2_1)
...
go__go_3_6_1 = gopurs_runtime.Func(func(acc_4_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(lhs_5_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(rhs_6_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
var acc_4_loop gopurs_runtime.Value = acc_4_loop_val
...
go__go_3_6_1:
for {
if false { continue go__go_3_6_1 }
var acc_4 gopurs_runtime.Value = acc_4_loop
_ = acc_4
var lhs_5 gopurs_runtime.Value = lhs_5_loop
_ = lhs_5
...
{
if (rhs_6.Type == 9 && rhs_6.IntVal == 2421944209) {
acc_4_loop = gopurs_runtime.Apply2(f_0, (*Constructor_Data_Foldable_Node)(rhs_6.UnsafePtr).V0, acc_4)
lhs_5_loop = gopurs_runtime.Value{Type: 9, IntVal: 2065045956, UnsafePtr: unsafe.Pointer(nil)}
rhs_6_loop = lhs_5
continue go__go_3_6_1
...
{
var __t_tag_8 gopurs_runtime.Value = (*Constructor_Data_Foldable_Append)(rhs_6.UnsafePtr).V0
...
__t15 = gopurs_runtime.Value{Type: 9, IntVal: 2812549951, UnsafePtr: unsafe.Pointer(&Constructor_Data_Foldable_Append{1, gopurs_runtime.Value{Type: 9, IntVal: 2812549951, UnsafePtr: unsafe.Pointer(&Constructor_Data_Foldable_Append{1, gopurs_runtime.Value{Type: 9, IntVal: 2065045956, UnsafePtr: unsafe.Pointer(nil)}, gopurs_runtime.Value{Type: 9, IntVal: 2421944209, UnsafePtr: unsafe.Pointer(&Constructor_Data_Foldable_Node{1, (*Constructor_Data_Interval_StartEnd)((*Constructor_Data_Interval_RecurringInterval)(x_2.UnsafePtr).V1.UnsafePtr).V0})}})}, gopurs_runtime.Value{Type: 9, IntVal: 2421944209, UnsafePtr: unsafe.Pointer(&Constructor_Data_Foldable_Node{1, (*Constructor_Data_Interval_StartEnd)((*Constructor_Data_Interval_RecurringInterval)(x_2.UnsafePtr).V1.UnsafePtr).V1})}})}
goto end_branch_15
} else {
...
__t15 = gopurs_runtime.Value{Type: 9, IntVal: 2812549951, UnsafePtr: unsafe.Pointer(&Constructor_Data_Foldable_Append{1, gopurs_runtime.Value{Type: 9, IntVal: 2065045956, UnsafePtr: unsafe.Pointer(nil)}, gopurs_runtime.Value{Type: 9, IntVal: 2421944209, UnsafePtr: unsafe.Pointer(&Constructor_Data_Foldable_Node{1, (*Constructor_Data_Interval_DurationEnd)((*Constructor_Data_Interval_RecurringInterval)(x_2.UnsafePtr).V1.UnsafePtr).V1})}})}
goto end_branch_15
} else {
...
__t15 = gopurs_runtime.Value{Type: 9, IntVal: 2812549951, UnsafePtr: unsafe.Pointer(&Constructor_Data_Foldable_Append{1, gopurs_runtime.Value{Type: 9, IntVal: 2065045956, UnsafePtr: unsafe.Pointer(nil)}, gopurs_runtime.Value{Type: 9, IntVal: 2421944209, UnsafePtr: unsafe.Pointer(&Constructor_Data_Foldable_Node{1, (*Constructor_Data_Interval_StartDuration)((*Constructor_Data_Interval_RecurringInterval)(x_2.UnsafePtr).V1.UnsafePtr).V0})}})}
goto end_branch_15
} else {
...
{
__t15 = gopurs_runtime.Value{Type: 9, IntVal: 2065045956, UnsafePtr: unsafe.Pointer(nil)}
}
end_branch_15:
return gopurs_runtime.Apply3(go__go_3_6_1, i_1, gopurs_runtime.Value{Type: 9, IntVal: 2065045956, UnsafePtr: unsafe.Pointer(nil)}, __t15)
})
})
})})}
	})
...
func Get_Data_Interval_bifunctorInterval() gopurs_runtime.Value {
	once_Data_Interval_bifunctorInterval.Do(func() {
		cache_Data_Interval_bifunctorInterval = gopurs_runtime.Value{Type: 9, IntVal: 4141114362, UnsafePtr: unsafe.Pointer(&Constructor_Data_Bifunctor_Bifunctor{1, gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(v1_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(v2_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Data_Interval_bifunctorRecurringInterval() gopurs_runtime.Value {
	once_Data_Interval_bifunctorRecurringInterval.Do(func() {
		cache_Data_Interval_bifunctorRecurringInterval = gopurs_runtime.Value{Type: 9, IntVal: 4141114362, UnsafePtr: unsafe.Pointer(&Constructor_Data_Bifunctor_Bifunctor{1, gopurs_runtime.Func(func(f_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Data_Interval_functorInterval() gopurs_runtime.Value {
	once_Data_Interval_functorInterval.Do(func() {
		cache_Data_Interval_functorInterval = gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer(&Constructor_Data_Functor_Functor{1, gopurs_runtime.Func(func(v1_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Data_Interval_extendInterval() gopurs_runtime.Value {
	once_Data_Interval_extendInterval.Do(func() {
		cache_Data_Interval_extendInterval = gopurs_runtime.Value{Type: 9, IntVal: 3028639021, UnsafePtr: unsafe.Pointer(&Constructor_Control_Extend_Extend{1, gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor](Get_Data_Interval_functorInterval()))}
}), gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(v1_1 gopurs_runtime.Value) gopurs_runtime.Value {
var __t0 gopurs_runtime.Value
{
...
func Get_Data_Interval_functorRecurringInterval() gopurs_runtime.Value {
	once_Data_Interval_functorRecurringInterval.Do(func() {
		cache_Data_Interval_functorRecurringInterval = gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer(&Constructor_Data_Functor_Functor{1, gopurs_runtime.Func(func(f_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Data_Interval_extendRecurringInterval() gopurs_runtime.Value {
	once_Data_Interval_extendRecurringInterval.Do(func() {
		cache_Data_Interval_extendRecurringInterval = gopurs_runtime.Value{Type: 9, IntVal: 3028639021, UnsafePtr: unsafe.Pointer(&Constructor_Control_Extend_Extend{1, gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor](Get_Data_Interval_functorRecurringInterval()))}
}), gopurs_runtime.Func(func(f_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(v_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Data_Interval_traversableInterval() gopurs_runtime.Value {
	once_Data_Interval_traversableInterval.Do(func() {
		cache_Data_Interval_traversableInterval = gopurs_runtime.Value{Type: 9, IntVal: 3941073978, UnsafePtr: unsafe.Pointer(&Constructor_Data_Traversable_Traversable{1, gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 4280266298, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Foldable_Foldable](Get_Data_Interval_foldableInterval()))}
}), gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor](Get_Data_Interval_functorInterval()))}
}), gopurs_runtime.Func(func(dictApplicative_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Data_Traversable_Traversable](Get_Data_Interval_traversableInterval()).V3), gopurs_runtime.Value{Type: 9, IntVal: 1459134221, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Applicative_Applicative](dictApplicative_0))}, gopurs_runtime.Func(func(x_1 gopurs_runtime.Value) gopurs_runtime.Value {
return x_1
}))
}), gopurs_runtime.Func(func(dictApplicative_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Data_Interval_traversableRecurringInterval() gopurs_runtime.Value {
	once_Data_Interval_traversableRecurringInterval.Do(func() {
		cache_Data_Interval_traversableRecurringInterval = gopurs_runtime.Value{Type: 9, IntVal: 3941073978, UnsafePtr: unsafe.Pointer(&Constructor_Data_Traversable_Traversable{1, gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 4280266298, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Foldable_Foldable](Get_Data_Interval_foldableRecurringInterval()))}
}), gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor](Get_Data_Interval_functorRecurringInterval()))}
}), gopurs_runtime.Func(func(dictApplicative_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Data_Traversable_Traversable](Get_Data_Interval_traversableRecurringInterval()).V3), gopurs_runtime.Value{Type: 9, IntVal: 1459134221, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Applicative_Applicative](dictApplicative_0))}, gopurs_runtime.Func(func(x_1 gopurs_runtime.Value) gopurs_runtime.Value {
return x_1
}))
}), gopurs_runtime.Func(func(dictApplicative_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
// TAST (Let): Apply0_4_1 -> *Constructor_Control_Apply_Apply
Apply0_4_1 := gopurs_runtime.CoerceToStruct[Constructor_Control_Apply_Apply](gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictApplicative_0, "Apply0"), gopurs_runtime.Value{}))
_ = Apply0_4_1
// TAST (Let): Functor0_5_2 -> *Constructor_Data_Functor_Functor
Functor0_5_2 := gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor](gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictApplicative_0, "Apply0"), gopurs_runtime.Value{}), "Functor0"), gopurs_runtime.Value{}))
_ = Functor0_5_2
var __t8 gopurs_runtime.Value
{
var __t_tag_3 gopurs_runtime.Value = (*Constructor_Data_Interval_RecurringInterval)(i_3.UnsafePtr).V1
if (__t_tag_3.Type == 9 && __t_tag_3.IntVal == 237113226) {
__t8 = gopurs_runtime.Apply2(gopurs_runtime.Box(Apply0_4_1.V1), gopurs_runtime.Apply2(gopurs_runtime.Box(Functor0_5_2.V0), Get_Data_Interval_StartEnd(), gopurs_runtime.Apply(f_2, (*Constructor_Data_Interval_StartEnd)((*Constructor_Data_Interval_RecurringInterval)(i_3.UnsafePtr).V1.UnsafePtr).V0)), gopurs_runtime.Apply(f_2, (*Constructor_Data_Interval_StartEnd)((*Constructor_Data_Interval_RecurringInterval)(i_3.UnsafePtr).V1.UnsafePtr).V1))
goto end_branch_8
} else {
...
{
var __t_tag_4 gopurs_runtime.Value = (*Constructor_Data_Interval_RecurringInterval)(i_3.UnsafePtr).V1
if (__t_tag_4.Type == 9 && __t_tag_4.IntVal == 1992629780) {
__t8 = gopurs_runtime.Apply2(gopurs_runtime.Box(Functor0_5_2.V0), gopurs_runtime.Apply(Get_Data_Interval_DurationEnd(), (*Constructor_Data_Interval_DurationEnd)((*Constructor_Data_Interval_RecurringInterval)(i_3.UnsafePtr).V1.UnsafePtr).V0), gopurs_runtime.Apply(f_2, (*Constructor_Data_Interval_DurationEnd)((*Constructor_Data_Interval_RecurringInterval)(i_3.UnsafePtr).V1.UnsafePtr).V1))
goto end_branch_8
} else {
...
{
var __t_tag_5 gopurs_runtime.Value = (*Constructor_Data_Interval_RecurringInterval)(i_3.UnsafePtr).V1
if (__t_tag_5.Type == 9 && __t_tag_5.IntVal == 2020675835) {
// TAST (Let): __local_var_6_6 -> gopurs_runtime.Value
__local_var_6_6 := (*Constructor_Data_Interval_StartDuration)((*Constructor_Data_Interval_RecurringInterval)(i_3.UnsafePtr).V1.UnsafePtr).V1
_ = __local_var_6_6
__t8 = gopurs_runtime.Apply2(gopurs_runtime.Box(Functor0_5_2.V0), gopurs_runtime.Func(func(v2_7 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 2020675835, UnsafePtr: unsafe.Pointer(&Constructor_Data_Interval_StartDuration{1, v2_7, __local_var_6_6})}
...
{
var __t_tag_7 gopurs_runtime.Value = (*Constructor_Data_Interval_RecurringInterval)(i_3.UnsafePtr).V1
if (__t_tag_7.Type == 9 && __t_tag_7.IntVal == 2281256335) {
__t8 = gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictApplicative_0, "pure"), gopurs_runtime.Value{Type: 9, IntVal: 2281256335, UnsafePtr: unsafe.Pointer(&Constructor_Data_Interval_DurationOnly{1, (*Constructor_Data_Interval_DurationOnly)((*Constructor_Data_Interval_RecurringInterval)(i_3.UnsafePtr).V1.UnsafePtr).V0})})
goto end_branch_8
} else {
...
end_branch_8:
return gopurs_runtime.Apply2(gopurs_runtime.Box(Functor0_1_0.V0), gopurs_runtime.Apply(Get_Data_Interval_RecurringInterval(), gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer((*Constructor_Data_Interval_RecurringInterval)(i_3.UnsafePtr).V0)}), __t8)
})
})
})})}
	})
...
func Get_Data_Interval_bifoldableInterval() gopurs_runtime.Value {
	once_Data_Interval_bifoldableInterval.Do(func() {
		cache_Data_Interval_bifoldableInterval = gopurs_runtime.Value{Type: 9, IntVal: 4001671834, UnsafePtr: unsafe.Pointer(&Constructor_Data_Bifoldable_Bifoldable{1, gopurs_runtime.Func(func(dictMonoid_0 gopurs_runtime.Value) gopurs_runtime.Value {
// TAST (Let): Semigroup0_1_0 -> *Constructor_Data_Semigroup_Semigroup
Semigroup0_1_0 := gopurs_runtime.CoerceToStruct[Constructor_Data_Semigroup_Semigroup](gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonoid_0, "Semigroup0"), gopurs_runtime.Value{}))
_ = Semigroup0_1_0
// TAST (Let): mempty_2_1 -> gopurs_runtime.Value
...
return gopurs_runtime.Apply3(gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Data_Bifoldable_Bifoldable](Get_Data_Interval_bifoldableInterval()).V1), gopurs_runtime.Func(func(m_5 gopurs_runtime.Value) gopurs_runtime.Value {
...
// TAST (Let): semigroupEndo1_4_3 -> *Constructor_Data_Semigroup_Semigroup
semigroupEndo1_4_3 := &Constructor_Data_Semigroup_Semigroup{1, gopurs_runtime.Func(func(v_4 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply5(gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Data_Bifoldable_Bifoldable](Get_Data_Interval_bifoldableInterval()).V0), gopurs_runtime.Value{Type: 9, IntVal: 1722653594, UnsafePtr: unsafe.Pointer(&Constructor_Data_Monoid_Monoid{1, gopurs_runtime.Func(func(_dollar__unused_5 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 2053112122, UnsafePtr: unsafe.Pointer(semigroupEndo1_4_3)}
...
func Get_Data_Interval_bifoldableRecurringInterval() gopurs_runtime.Value {
	once_Data_Interval_bifoldableRecurringInterval.Do(func() {
		cache_Data_Interval_bifoldableRecurringInterval = gopurs_runtime.Value{Type: 9, IntVal: 4001671834, UnsafePtr: unsafe.Pointer(&Constructor_Data_Bifoldable_Bifoldable{1, gopurs_runtime.Func(func(dictMonoid_0 gopurs_runtime.Value) gopurs_runtime.Value {
// TAST (Let): Semigroup0_1_0 -> *Constructor_Data_Semigroup_Semigroup
Semigroup0_1_0 := gopurs_runtime.CoerceToStruct[Constructor_Data_Semigroup_Semigroup](gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonoid_0, "Semigroup0"), gopurs_runtime.Value{}))
_ = Semigroup0_1_0
// TAST (Let): mempty_2_1 -> gopurs_runtime.Value
...
return gopurs_runtime.Func(func(f_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(g_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply3(gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Data_Bifoldable_Bifoldable](Get_Data_Interval_bifoldableRecurringInterval()).V1), gopurs_runtime.Func(func(m_5 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(a_6 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.Box(Semigroup0_1_0.V0), m_5, gopurs_runtime.Apply(f_3, a_6))
})
}), gopurs_runtime.Func(func(m_5 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Func(func(i_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(x_3 gopurs_runtime.Value) gopurs_runtime.Value {
// TAST (Let): semigroupEndo1_4_8 -> *Constructor_Data_Semigroup_Semigroup
semigroupEndo1_4_8 := &Constructor_Data_Semigroup_Semigroup{1, gopurs_runtime.Func(func(v_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(v1_5 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(x_6 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(v_4, gopurs_runtime.Apply(v1_5, x_6))
})
...
_ = semigroupEndo1_4_8
// TAST (Let): __local_var_4_7 -> *Constructor_Data_Monoid_Monoid
__local_var_4_7 := &Constructor_Data_Monoid_Monoid{1, gopurs_runtime.Func(func(_dollar__unused_5 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 2053112122, UnsafePtr: unsafe.Pointer(semigroupEndo1_4_8)}
}), gopurs_runtime.Func(func(x_5 gopurs_runtime.Value) gopurs_runtime.Value {
return x_5
})}
_ = __local_var_4_7
// TAST (Let): Semigroup0_5_9 -> *Constructor_Data_Semigroup_Semigroup
Semigroup0_5_9 := gopurs_runtime.CoerceToStruct[Constructor_Data_Semigroup_Semigroup](gopurs_runtime.Apply(gopurs_runtime.Box(__local_var_4_7.V0), gopurs_runtime.Value{}))
_ = Semigroup0_5_9
var __t14 gopurs_runtime.Value
{
var __t_tag_10 gopurs_runtime.Value = (*Constructor_Data_Interval_RecurringInterval)(x_3.UnsafePtr).V1
if (__t_tag_10.Type == 9 && __t_tag_10.IntVal == 237113226) {
__t14 = gopurs_runtime.Apply2(gopurs_runtime.Box(Semigroup0_5_9.V0), gopurs_runtime.Apply2(gopurs_runtime.Box(Semigroup0_5_9.V0), gopurs_runtime.Box(__local_var_4_7.V1), gopurs_runtime.Apply(g_1, (*Constructor_Data_Interval_StartEnd)((*Constructor_Data_Interval_RecurringInterval)(x_3.UnsafePtr).V1.UnsafePtr).V0)), gopurs_runtime.Apply(g_1, (*Constructor_Data_Interval_StartEnd)((*Constructor_Data_Interval_RecurringInterval)(x_3.UnsafePtr).V1.UnsafePtr).V1))
goto end_branch_14
} else {
...
{
var __t_tag_11 gopurs_runtime.Value = (*Constructor_Data_Interval_RecurringInterval)(x_3.UnsafePtr).V1
if (__t_tag_11.Type == 9 && __t_tag_11.IntVal == 1992629780) {
__t14 = gopurs_runtime.Apply2(gopurs_runtime.Box(Semigroup0_5_9.V0), gopurs_runtime.Apply2(gopurs_runtime.Box(Semigroup0_5_9.V0), gopurs_runtime.Box(__local_var_4_7.V1), gopurs_runtime.Apply(f_0, (*Constructor_Data_Interval_DurationEnd)((*Constructor_Data_Interval_RecurringInterval)(x_3.UnsafePtr).V1.UnsafePtr).V0)), gopurs_runtime.Apply(g_1, (*Constructor_Data_Interval_DurationEnd)((*Constructor_Data_Interval_RecurringInterval)(x_3.UnsafePtr).V1.UnsafePtr).V1))
goto end_branch_14
} else {
...
{
var __t_tag_12 gopurs_runtime.Value = (*Constructor_Data_Interval_RecurringInterval)(x_3.UnsafePtr).V1
if (__t_tag_12.Type == 9 && __t_tag_12.IntVal == 2020675835) {
__t14 = gopurs_runtime.Apply2(gopurs_runtime.Box(Semigroup0_5_9.V0), gopurs_runtime.Apply2(gopurs_runtime.Box(Semigroup0_5_9.V0), gopurs_runtime.Box(__local_var_4_7.V1), gopurs_runtime.Apply(f_0, (*Constructor_Data_Interval_StartDuration)((*Constructor_Data_Interval_RecurringInterval)(x_3.UnsafePtr).V1.UnsafePtr).V1)), gopurs_runtime.Apply(g_1, (*Constructor_Data_Interval_StartDuration)((*Constructor_Data_Interval_RecurringInterval)(x_3.UnsafePtr).V1.UnsafePtr).V0))
goto end_branch_14
} else {
...
__t14 = gopurs_runtime.Apply2(gopurs_runtime.Box(Semigroup0_5_9.V0), gopurs_runtime.Box(__local_var_4_7.V1), gopurs_runtime.Apply(f_0, (*Constructor_Data_Interval_DurationOnly)((*Constructor_Data_Interval_RecurringInterval)(x_3.UnsafePtr).V1.UnsafePtr).V0))
goto end_branch_14
} else {
...
end_branch_14:
return gopurs_runtime.Apply(__t14, i_2)
})
})
})
})})}
...
func Get_Data_Interval_bitraversableInterval() gopurs_runtime.Value {
	once_Data_Interval_bitraversableInterval.Do(func() {
		cache_Data_Interval_bitraversableInterval = gopurs_runtime.Value{Type: 9, IntVal: 3704227322, UnsafePtr: unsafe.Pointer(&Constructor_Data_Bitraversable_Bitraversable{1, gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 4001671834, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Bifoldable_Bifoldable](Get_Data_Interval_bifoldableInterval()))}
}), gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 4141114362, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Bifunctor_Bifunctor](Get_Data_Interval_bifunctorInterval()))}
}), gopurs_runtime.Func(func(dictApplicative_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply3(gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Data_Bitraversable_Bitraversable](Get_Data_Interval_bitraversableInterval()).V3), gopurs_runtime.Value{Type: 9, IntVal: 1459134221, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Applicative_Applicative](dictApplicative_0))}, gopurs_runtime.Func(func(x_1 gopurs_runtime.Value) gopurs_runtime.Value {
return x_1
}), gopurs_runtime.Func(func(x_1 gopurs_runtime.Value) gopurs_runtime.Value {
return x_1
}))
...
func Get_Data_Interval_bitraversableRecurringInterval() gopurs_runtime.Value {
	once_Data_Interval_bitraversableRecurringInterval.Do(func() {
		cache_Data_Interval_bitraversableRecurringInterval = gopurs_runtime.Value{Type: 9, IntVal: 3704227322, UnsafePtr: unsafe.Pointer(&Constructor_Data_Bitraversable_Bitraversable{1, gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 4001671834, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Bifoldable_Bifoldable](Get_Data_Interval_bifoldableRecurringInterval()))}
}), gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 4141114362, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Bifunctor_Bifunctor](Get_Data_Interval_bifunctorRecurringInterval()))}
}), gopurs_runtime.Func(func(dictApplicative_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply3(gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Data_Bitraversable_Bitraversable](Get_Data_Interval_bitraversableRecurringInterval()).V3), gopurs_runtime.Value{Type: 9, IntVal: 1459134221, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Applicative_Applicative](dictApplicative_0))}, gopurs_runtime.Func(func(x_1 gopurs_runtime.Value) gopurs_runtime.Value {
return x_1
}), gopurs_runtime.Func(func(x_1 gopurs_runtime.Value) gopurs_runtime.Value {
return x_1
}))
...
// TAST (Let): Apply0_5_1 -> *Constructor_Control_Apply_Apply
Apply0_5_1 := gopurs_runtime.CoerceToStruct[Constructor_Control_Apply_Apply](gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictApplicative_0, "Apply0"), gopurs_runtime.Value{}))
_ = Apply0_5_1
// TAST (Let): Functor0_6_2 -> *Constructor_Data_Functor_Functor
Functor0_6_2 := gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor](gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictApplicative_0, "Apply0"), gopurs_runtime.Value{}), "Functor0"), gopurs_runtime.Value{}))
_ = Functor0_6_2
var __t7 gopurs_runtime.Value
{
var __t_tag_3 gopurs_runtime.Value = (*Constructor_Data_Interval_RecurringInterval)(i_4.UnsafePtr).V1
if (__t_tag_3.Type == 9 && __t_tag_3.IntVal == 237113226) {
__t7 = gopurs_runtime.Apply2(gopurs_runtime.Box(Apply0_5_1.V1), gopurs_runtime.Apply2(gopurs_runtime.Box(Functor0_6_2.V0), Get_Data_Interval_StartEnd(), gopurs_runtime.Apply(r_3, (*Constructor_Data_Interval_StartEnd)((*Constructor_Data_Interval_RecurringInterval)(i_4.UnsafePtr).V1.UnsafePtr).V0)), gopurs_runtime.Apply(r_3, (*Constructor_Data_Interval_StartEnd)((*Constructor_Data_Interval_RecurringInterval)(i_4.UnsafePtr).V1.UnsafePtr).V1))
goto end_branch_7
} else {
...
{
var __t_tag_5 gopurs_runtime.Value = (*Constructor_Data_Interval_RecurringInterval)(i_4.UnsafePtr).V1
if (__t_tag_5.Type == 9 && __t_tag_5.IntVal == 2020675835) {
__t7 = gopurs_runtime.Apply2(gopurs_runtime.Box(Apply0_5_1.V1), gopurs_runtime.Apply2(gopurs_runtime.Box(Functor0_6_2.V0), Get_Data_Interval_StartDuration(), gopurs_runtime.Apply(r_3, (*Constructor_Data_Interval_StartDuration)((*Constructor_Data_Interval_RecurringInterval)(i_4.UnsafePtr).V1.UnsafePtr).V0)), gopurs_runtime.Apply(l_2, (*Constructor_Data_Interval_StartDuration)((*Constructor_Data_Interval_RecurringInterval)(i_4.UnsafePtr).V1.UnsafePtr).V1))
goto end_branch_7
} else {
...
{
var __t_tag_6 gopurs_runtime.Value = (*Constructor_Data_Interval_RecurringInterval)(i_4.UnsafePtr).V1
if (__t_tag_6.Type == 9 && __t_tag_6.IntVal == 2281256335) {
__t7 = gopurs_runtime.Apply2(gopurs_runtime.Box(Functor0_6_2.V0), Get_Data_Interval_DurationOnly(), gopurs_runtime.Apply(l_2, (*Constructor_Data_Interval_DurationOnly)((*Constructor_Data_Interval_RecurringInterval)(i_4.UnsafePtr).V1.UnsafePtr).V0))
goto end_branch_7
} else {
...
end_branch_7:
return gopurs_runtime.Apply2(gopurs_runtime.Box(Functor0_1_0.V0), gopurs_runtime.Apply(Get_Data_Interval_RecurringInterval(), gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer((*Constructor_Data_Interval_RecurringInterval)(i_4.UnsafePtr).V0)}), __t7)
})
})
})
})})}
...
func Get_Data_Interval_extendInterval__2367002404() gopurs_runtime.Value {
	once_Data_Interval_extendInterval__2367002404.Do(func() {
		cache_Data_Interval_extendInterval__2367002404 = gopurs_runtime.Value{Type: 9, IntVal: 3028639021, UnsafePtr: unsafe.Pointer(&Constructor_Control_Extend_Extend{1, gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor](Get_Data_Interval_functorInterval()))}
}), gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(v1_1 gopurs_runtime.Value) gopurs_runtime.Value {
var __t0 gopurs_runtime.Value
...
func Get_Data_Interval_foldableInterval__3140210451() gopurs_runtime.Value {
	once_Data_Interval_foldableInterval__3140210451.Do(func() {
		cache_Data_Interval_foldableInterval__3140210451 = gopurs_runtime.Value{Type: 9, IntVal: 4280266298, UnsafePtr: unsafe.Pointer(&Constructor_Data_Foldable_Foldable{1, gopurs_runtime.Func(func(dictMonoid_0 gopurs_runtime.Value) gopurs_runtime.Value {
// TAST (Let): Semigroup0_1_0 -> *Constructor_Data_Semigroup_Semigroup
Semigroup0_1_0 := gopurs_runtime.CoerceToStruct[Constructor_Data_Semigroup_Semigroup](gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonoid_0, "Semigroup0"), gopurs_runtime.Value{}))
_ = Semigroup0_1_0
// TAST (Let): mempty_2_1 -> gopurs_runtime.Value
...
go__go_3_4_2 = gopurs_runtime.Func(func(acc_4_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(lhs_5_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(rhs_6_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
var acc_4_loop gopurs_runtime.Value = acc_4_loop_val
...
go__go_3_4_2:
for {
if false { continue go__go_3_4_2 }
var acc_4 gopurs_runtime.Value = acc_4_loop
_ = acc_4
var lhs_5 gopurs_runtime.Value = lhs_5_loop
_ = lhs_5
...
var __t7 gopurs_runtime.Value
{
var __t_tag_6 gopurs_runtime.Value = (*Constructor_Data_Foldable_Append)(rhs_6.UnsafePtr).V0
...
var __t10 gopurs_runtime.Value
{
if (xs_2.Type == 9 && xs_2.IntVal == 237113226) {
__t10 = gopurs_runtime.Value{Type: 9, IntVal: 2812549951, UnsafePtr: unsafe.Pointer(&Constructor_Data_Foldable_Append{1, gopurs_runtime.Value{Type: 9, IntVal: 2812549951, UnsafePtr: unsafe.Pointer(&Constructor_Data_Foldable_Append{1, gopurs_runtime.Value{Type: 9, IntVal: 2065045956, UnsafePtr: unsafe.Pointer(nil)}, gopurs_runtime.Value{Type: 9, IntVal: 2421944209, UnsafePtr: unsafe.Pointer(&Constructor_Data_Foldable_Node{1, (*Constructor_Data_Interval_StartEnd)(xs_2.UnsafePtr).V0})}})}, gopurs_runtime.Value{Type: 9, IntVal: 2421944209, UnsafePtr: unsafe.Pointer(&Constructor_Data_Foldable_Node{1, (*Constructor_Data_Interval_StartEnd)(xs_2.UnsafePtr).V1})}})}
goto end_branch_10
} else {
...
{
if (xs_2.Type == 9 && xs_2.IntVal == 1992629780) {
__t10 = gopurs_runtime.Value{Type: 9, IntVal: 2812549951, UnsafePtr: unsafe.Pointer(&Constructor_Data_Foldable_Append{1, gopurs_runtime.Value{Type: 9, IntVal: 2065045956, UnsafePtr: unsafe.Pointer(nil)}, gopurs_runtime.Value{Type: 9, IntVal: 2421944209, UnsafePtr: unsafe.Pointer(&Constructor_Data_Foldable_Node{1, (*Constructor_Data_Interval_DurationEnd)(xs_2.UnsafePtr).V1})}})}
goto end_branch_10
} else {
...
{
if (xs_2.Type == 9 && xs_2.IntVal == 2020675835) {
__t10 = gopurs_runtime.Value{Type: 9, IntVal: 2812549951, UnsafePtr: unsafe.Pointer(&Constructor_Data_Foldable_Append{1, gopurs_runtime.Value{Type: 9, IntVal: 2065045956, UnsafePtr: unsafe.Pointer(nil)}, gopurs_runtime.Value{Type: 9, IntVal: 2421944209, UnsafePtr: unsafe.Pointer(&Constructor_Data_Foldable_Node{1, (*Constructor_Data_Interval_StartDuration)(xs_2.UnsafePtr).V0})}})}
goto end_branch_10
} else {
...
{
__t10 = gopurs_runtime.Value{Type: 9, IntVal: 2065045956, UnsafePtr: unsafe.Pointer(nil)}
}
end_branch_10:
return gopurs_runtime.Apply3(go__go_3_4_2, u_1, gopurs_runtime.Value{Type: 9, IntVal: 2065045956, UnsafePtr: unsafe.Pointer(nil)}, __t10)
})
})
})})}
	})
...
var cache_Data_Interval_foldableRecurringInterval__2114031058 gopurs_runtime.Value
var once_Data_Interval_foldableRecurringInterval__2114031058 sync.Once
func Get_Data_Interval_foldableRecurringInterval__2114031058() gopurs_runtime.Value {
	once_Data_Interval_foldableRecurringInterval__2114031058.Do(func() {
		cache_Data_Interval_foldableRecurringInterval__2114031058 = gopurs_runtime.Value{Type: 9, IntVal: 4280266298, UnsafePtr: unsafe.Pointer(&Constructor_Data_Foldable_Foldable{1, gopurs_runtime.Func(func(dictMonoid_0 gopurs_runtime.Value) gopurs_runtime.Value {
// TAST (Let): Semigroup0_1_0 -> *Constructor_Data_Semigroup_Semigroup
Semigroup0_1_0 := gopurs_runtime.CoerceToStruct[Constructor_Data_Semigroup_Semigroup](gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonoid_0, "Semigroup0"), gopurs_runtime.Value{}))
_ = Semigroup0_1_0
// TAST (Let): mempty_2_1 -> gopurs_runtime.Value
...
return gopurs_runtime.Func(func(i_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(x_2 gopurs_runtime.Value) gopurs_runtime.Value {
var go__go_3_10_3 gopurs_runtime.Value
go__go_3_10_3 = gopurs_runtime.Func(func(acc_4_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(lhs_5_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(rhs_6_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
var acc_4_loop gopurs_runtime.Value = acc_4_loop_val
...
go__go_3_10_3:
for {
if false { continue go__go_3_10_3 }
var acc_4 gopurs_runtime.Value = acc_4_loop
_ = acc_4
var lhs_5 gopurs_runtime.Value = lhs_5_loop
_ = lhs_5
...
{
var __t_tag_12 gopurs_runtime.Value = (*Constructor_Data_Foldable_Append)(rhs_6.UnsafePtr).V0
...
{
var __t_tag_16 gopurs_runtime.Value = (*Constructor_Data_Interval_RecurringInterval)(x_2.UnsafePtr).V1
if (__t_tag_16.Type == 9 && __t_tag_16.IntVal == 237113226) {
__t19 = gopurs_runtime.Value{Type: 9, IntVal: 2812549951, UnsafePtr: unsafe.Pointer(&Constructor_Data_Foldable_Append{1, gopurs_runtime.Value{Type: 9, IntVal: 2812549951, UnsafePtr: unsafe.Pointer(&Constructor_Data_Foldable_Append{1, gopurs_runtime.Value{Type: 9, IntVal: 2065045956, UnsafePtr: unsafe.Pointer(nil)}, gopurs_runtime.Value{Type: 9, IntVal: 2421944209, UnsafePtr: unsafe.Pointer(&Constructor_Data_Foldable_Node{1, (*Constructor_Data_Interval_StartEnd)((*Constructor_Data_Interval_RecurringInterval)(x_2.UnsafePtr).V1.UnsafePtr).V0})}})}, gopurs_runtime.Value{Type: 9, IntVal: 2421944209, UnsafePtr: unsafe.Pointer(&Constructor_Data_Foldable_Node{1, (*Constructor_Data_Interval_StartEnd)((*Constructor_Data_Interval_RecurringInterval)(x_2.UnsafePtr).V1.UnsafePtr).V1})}})}
goto end_branch_19
} else {
...
{
var __t_tag_17 gopurs_runtime.Value = (*Constructor_Data_Interval_RecurringInterval)(x_2.UnsafePtr).V1
if (__t_tag_17.Type == 9 && __t_tag_17.IntVal == 1992629780) {
__t19 = gopurs_runtime.Value{Type: 9, IntVal: 2812549951, UnsafePtr: unsafe.Pointer(&Constructor_Data_Foldable_Append{1, gopurs_runtime.Value{Type: 9, IntVal: 2065045956, UnsafePtr: unsafe.Pointer(nil)}, gopurs_runtime.Value{Type: 9, IntVal: 2421944209, UnsafePtr: unsafe.Pointer(&Constructor_Data_Foldable_Node{1, (*Constructor_Data_Interval_DurationEnd)((*Constructor_Data_Interval_RecurringInterval)(x_2.UnsafePtr).V1.UnsafePtr).V1})}})}
goto end_branch_19
} else {
...
{
var __t_tag_18 gopurs_runtime.Value = (*Constructor_Data_Interval_RecurringInterval)(x_2.UnsafePtr).V1
if (__t_tag_18.Type == 9 && __t_tag_18.IntVal == 2020675835) {
__t19 = gopurs_runtime.Value{Type: 9, IntVal: 2812549951, UnsafePtr: unsafe.Pointer(&Constructor_Data_Foldable_Append{1, gopurs_runtime.Value{Type: 9, IntVal: 2065045956, UnsafePtr: unsafe.Pointer(nil)}, gopurs_runtime.Value{Type: 9, IntVal: 2421944209, UnsafePtr: unsafe.Pointer(&Constructor_Data_Foldable_Node{1, (*Constructor_Data_Interval_StartDuration)((*Constructor_Data_Interval_RecurringInterval)(x_2.UnsafePtr).V1.UnsafePtr).V0})}})}
goto end_branch_19
} else {
...
{
__t19 = gopurs_runtime.Value{Type: 9, IntVal: 2065045956, UnsafePtr: unsafe.Pointer(nil)}
}
end_branch_19:
return gopurs_runtime.Apply3(go__go_3_10_3, i_1, gopurs_runtime.Value{Type: 9, IntVal: 2065045956, UnsafePtr: unsafe.Pointer(nil)}, __t19)
})
})
})})}
	})
	return cache_Data_Interval_foldableRecurringInterval__2114031058
}
...
func Get_Data_Interval_functorInterval__3565473811() gopurs_runtime.Value {
	once_Data_Interval_functorInterval__3565473811.Do(func() {
		cache_Data_Interval_functorInterval__3565473811 = gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer(&Constructor_Data_Functor_Functor{1, gopurs_runtime.Func(func(v1_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(v2_1 gopurs_runtime.Value) gopurs_runtime.Value {
var __t0 gopurs_runtime.Value
{
if (v2_1.Type == 9 && v2_1.IntVal == 237113226) {
...
var cache_Data_Interval_functorRecurringInterval__1678968146 gopurs_runtime.Value
var once_Data_Interval_functorRecurringInterval__1678968146 sync.Once
func Get_Data_Interval_functorRecurringInterval__1678968146() gopurs_runtime.Value {
	once_Data_Interval_functorRecurringInterval__1678968146.Do(func() {
		cache_Data_Interval_functorRecurringInterval__1678968146 = gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer(&Constructor_Data_Functor_Functor{1, gopurs_runtime.Func(func(f_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(v_1 gopurs_runtime.Value) gopurs_runtime.Value {
var __t4 gopurs_runtime.Value
{
var __t_tag_0 gopurs_runtime.Value = (*Constructor_Data_Interval_RecurringInterval)(v_1.UnsafePtr).V1
...
return gopurs_runtime.Value{Type: 9, IntVal: 2355637979, UnsafePtr: unsafe.Pointer(&Constructor_Data_Interval_RecurringInterval{1, (*Constructor_Data_Interval_RecurringInterval)(v_1.UnsafePtr).V0, __t4})}
	...
	return cache_Data_Interval_functorRecurringInterval__1678968146
}
...
func Get_Data_Interval_traversableInterval__1002691347() gopurs_runtime.Value {
	once_Data_Interval_traversableInterval__1002691347.Do(func() {
		cache_Data_Interval_traversableInterval__1002691347 = gopurs_runtime.Value{Type: 9, IntVal: 3941073978, UnsafePtr: unsafe.Pointer(&Constructor_Data_Traversable_Traversable{1, gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 4280266298, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Foldable_Foldable](Get_Data_Interval_foldableInterval()))}
}), gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor](Get_Data_Interval_functorInterval()))}
}), gopurs_runtime.Func(func(dictApplicative_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
__t3 = gopurs_runtime.Apply2(gopurs_runtime.Box(Apply0_1_0.V1), gopurs_runtime.Apply2(gopurs_runtime.Box(Functor0_2_1.V0), Get_Data_Interval_StartEnd(), (*Constructor_Data_Interval_StartEnd)(v1_3.UnsafePtr).V0), (*Constructor_Data_Interval_StartEnd)(v1_3.UnsafePtr).V1)
goto end_branch_3
} else {
...
__t3 = gopurs_runtime.Apply2(gopurs_runtime.Box(Functor0_2_1.V0), gopurs_runtime.Apply(Get_Data_Interval_DurationEnd(), (*Constructor_Data_Interval_DurationEnd)(v1_3.UnsafePtr).V0), (*Constructor_Data_Interval_DurationEnd)(v1_3.UnsafePtr).V1)
goto end_branch_3
} else {
...
__local_var_4_2 := (*Constructor_Data_Interval_StartDuration)(v1_3.UnsafePtr).V1
_ = __local_var_4_2
...
return gopurs_runtime.Value{Type: 9, IntVal: 2020675835, UnsafePtr: unsafe.Pointer(&Constructor_Data_Interval_StartDuration{1, v2_5, __local_var_4_2})}
...
__t3 = gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictApplicative_0, "pure"), gopurs_runtime.Value{Type: 9, IntVal: 2281256335, UnsafePtr: unsafe.Pointer(&Constructor_Data_Interval_DurationOnly{1, (*Constructor_Data_Interval_DurationOnly)(v1_3.UnsafePtr).V0})})
goto end_branch_3
} else {
...
_ = showInterval2_2_0
return gopurs_runtime.Value{Type: 9, IntVal: 1835580986, UnsafePtr: unsafe.Pointer(&Constructor_Data_Show_Show{1, gopurs_runtime.Func(func(v_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = eqInterval2_2_0
return gopurs_runtime.Value{Type: 9, IntVal: 1012063514, UnsafePtr: unsafe.Pointer(&Constructor_Data_Eq_Eq{1, gopurs_runtime.Func(func(x_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = __local_var_3_2
// TAST (Let): eqInterval2_3_1 -> *Constructor_Data_Eq_Eq
eqInterval2_3_1 := gopurs_runtime.CoerceToStruct[Constructor_Data_Eq_Eq](gopurs_runtime.RecordDict1("eq", gopurs_runtime.Func(func(x_4 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = __local_var_4_4
// TAST (Let): eqInterval2_4_3 -> *Constructor_Data_Eq_Eq
eqInterval2_4_3 := gopurs_runtime.CoerceToStruct[Constructor_Data_Eq_Eq](gopurs_runtime.RecordDict1("eq", gopurs_runtime.Func(func(x_5 gopurs_runtime.Value) gopurs_runtime.Value {
...
ordInterval2_4_2 := &Constructor_Data_Ord_Ord{1, gopurs_runtime.Func(func(_dollar__unused_5 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 1012063514, UnsafePtr: unsafe.Pointer(eqInterval2_4_3)}
}), gopurs_runtime.Func(func(x_5 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(y_6 gopurs_runtime.Value) gopurs_runtime.Value {
var __t18 uint32
{
...
_ = eqInterval2_6_21
// TAST (Let): eqRecurringInterval2_5_19 -> *Constructor_Data_Eq_Eq
eqRecurringInterval2_5_19 := &Constructor_Data_Eq_Eq{1, gopurs_runtime.Func(func(x_7 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Value{Type: 9, IntVal: 1012063514, UnsafePtr: unsafe.Pointer(eqRecurringInterval2_5_19)}
...
if __t_and_40 {
__t41 = uint32(gopurs_runtime.Apply5(Get_Data_Ord_ordIntImpl(), gopurs_runtime.Value{Type: 9, IntVal: int64(1527465420), UnsafePtr: nil}, gopurs_runtime.Value{Type: 9, IntVal: int64(902936544), UnsafePtr: nil}, gopurs_runtime.Value{Type: 9, IntVal: int64(380165415), UnsafePtr: nil}, ((*Constructor_Data_Interval_RecurringInterval)(x_6.UnsafePtr).V0).V0, ((*Constructor_Data_Interval_RecurringInterval)(y_7.UnsafePtr).V0).V0).IntVal)
goto end_branch_41
} else {
