...
{
__t1 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&Constructor_Data_Maybe_Just[gopurs_runtime.Value]{1, gopurs_runtime.Str(gopurs_runtime.Apply(Get_Data_String_CodePoints_fromCodePointArray(), func() gopurs_runtime.Value {
					arr := func() []int64 {
...
func Call_Data_String_NonEmpty_CodePoints_lastIndexOf_prime(pat_0_loop string, x_1_loop int64, v_2_loop string) *Constructor_Data_Maybe_Just[int64] {
...
_ = v_2
return gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just[int64]](gopurs_runtime.Apply3(Get_Data_String_CodePoints_lastIndexOf_prime(), gopurs_runtime.Str(pat_0), gopurs_runtime.Int(x_1), gopurs_runtime.Str(v_2)))
}

func Call_Data_String_NonEmpty_CodePoints_lastIndexOf(x_0_loop string, v_1_loop string) *Constructor_Data_Maybe_Just[int64] {
var x_0 string = x_0_loop
_ = x_0
var v_1 string = v_1_loop
_ = v_1
return gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just[int64]](gopurs_runtime.Apply2(Get_Data_String_CodePoints_lastIndexOf(), gopurs_runtime.Str(x_0), gopurs_runtime.Str(v_1)))
}

func Call_Data_String_NonEmpty_CodePoints_indexOf_prime(pat_0_loop string, x_1_loop int64, v_2_loop string) *Constructor_Data_Maybe_Just[int64] {
var pat_0 string = pat_0_loop
_ = pat_0
var x_1 int64 = x_1_loop
_ = x_1
var v_2 string = v_2_loop
_ = v_2
return gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just[int64]](gopurs_runtime.Apply3(Get_Data_String_CodePoints_indexOf_prime(), gopurs_runtime.Str(pat_0), gopurs_runtime.Int(x_1), gopurs_runtime.Str(v_2)))
}

func Call_Data_String_NonEmpty_CodePoints_indexOf(x_0_loop string, v_1_loop string) *Constructor_Data_Maybe_Just[int64] {
var x_0 string = x_0_loop
_ = x_0
var v_1 string = v_1_loop
_ = v_1
return gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just[int64]](gopurs_runtime.Apply2(Get_Data_String_CodePoints_indexOf(), gopurs_runtime.Str(x_0), gopurs_runtime.Str(v_1)))
}
...
func Call_Data_String_NonEmpty_CodePoints_take(i_0_loop int64, nes_1_loop string) *Constructor_Data_Maybe_Just[string] {
var i_0 int64 = i_0_loop
_ = i_0
var nes_1 string = nes_1_loop
_ = nes_1
...
{
__t1 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&Constructor_Data_Maybe_Just[gopurs_runtime.Value]{1, gopurs_runtime.Str(gopurs_runtime.Apply2(Get_Data_String_CodePoints_take(), gopurs_runtime.Int(i_0), gopurs_runtime.Str(nes_1)).StrVal())})}
}
end_branch_1:
...
}), gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just[int64]](gopurs_runtime.Apply2(Get_Data_String_CodePoints_codePointAt(), gopurs_runtime.Int(0), gopurs_runtime.Str(nes_0))))}).IntVal), gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just[string]](__t1))})
}
...
_ = dictFoldable1_0
return gopurs_runtime.Apply2(gopurs_runtime.Box(dictFoldable1_0.V1), gopurs_runtime.Value{Type: 9, IntVal: 2053112122, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Semigroup_Semigroup[string]](Get_Data_Semigroup_semigroupString()))}, Get_Data_String_NonEmpty_CodePoints_singleton())
}

func Call_Data_String_NonEmpty_CodePoints_fromCodePointArray(v_0_loop []int64) *Constructor_Data_Maybe_Just[string] {
...
func Call_Data_String_NonEmpty_CodePoints_drop(i_0_loop int64, nes_1_loop string) *Constructor_Data_Maybe_Just[string] {
var i_0 int64 = i_0_loop
_ = i_0
var nes_1 string = nes_1_loop
_ = nes_1
...
func Call_Data_String_NonEmpty_CodePoints_codePointAt(x_0_loop int64, v_1_loop string) *Constructor_Data_Maybe_Just[int64] {
var x_0 int64 = x_0_loop
_ = x_0
var v_1 string = v_1_loop
_ = v_1
return gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just[int64]](gopurs_runtime.Apply2(Get_Data_String_CodePoints_codePointAt(), gopurs_runtime.Int(x_0), gopurs_runtime.Str(v_1)))
}
...
func Call_Data_String_NonEmpty_CodePoints_liftS__1220682938(f_0_loop gopurs_runtime.Value, v_1_loop string) *Constructor_Data_Maybe_Just[int64] {
var f_0 gopurs_runtime.Value = f_0_loop
_ = f_0
var v_1 string = v_1_loop
_ = v_1
