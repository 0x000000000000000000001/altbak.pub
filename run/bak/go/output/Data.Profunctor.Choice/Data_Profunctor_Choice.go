...
return Call_right((*Record_left_gopurs_runtime_Value_right_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
	return cache_right
}
...
return Call_left((*Record_left_gopurs_runtime_Value_right_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
	return cache_left
}
...
return Call_splitChoice((*Record_compose_gopurs_runtime_Value)(dictSemigroupoid_0_box.UnsafePtr), (*Record_left_gopurs_runtime_Value_right_gopurs_runtime_Value)(dictChoice_1_box.UnsafePtr), l_2_box, r_3_box)
})
	})
...
return Call_fanin((*Record_compose_gopurs_runtime_Value)(dictSemigroupoid_0_box.UnsafePtr), (*Record_left_gopurs_runtime_Value_right_gopurs_runtime_Value)(dictChoice_1_box.UnsafePtr))
})
	})
	return cache_fanin
}
...
func Call_right(dict_0_loop *Record_left_gopurs_runtime_Value_right_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_left_gopurs_runtime_Value_right_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.right
}

func Call_left(dict_0_loop *Record_left_gopurs_runtime_Value_right_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_left_gopurs_runtime_Value_right_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.left
}

func Call_splitChoice(dictSemigroupoid_0_loop *Record_compose_gopurs_runtime_Value, dictChoice_1_loop *Record_left_gopurs_runtime_Value_right_gopurs_runtime_Value, l_2_loop gopurs_runtime.Value, r_3_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictSemigroupoid_0 *Record_compose_gopurs_runtime_Value = dictSemigroupoid_0_loop
_ = dictSemigroupoid_0
var dictChoice_1 *Record_left_gopurs_runtime_Value_right_gopurs_runtime_Value = dictChoice_1_loop
_ = dictChoice_1
var l_2 gopurs_runtime.Value = l_2_loop
_ = l_2
var r_3 gopurs_runtime.Value = r_3_loop
_ = r_3
return gopurs_runtime.Apply2(dictSemigroupoid_0.compose, gopurs_runtime.Apply(dictChoice_1.right, r_3), gopurs_runtime.Apply(dictChoice_1.left, l_2))
}

func Call_fanin(dictSemigroupoid_0_loop *Record_compose_gopurs_runtime_Value, dictChoice_1_loop *Record_left_gopurs_runtime_Value_right_gopurs_runtime_Value) gopurs_runtime.Value {
var dictSemigroupoid_0 *Record_compose_gopurs_runtime_Value = dictSemigroupoid_0_loop
_ = dictSemigroupoid_0
var dictChoice_1 *Record_left_gopurs_runtime_Value_right_gopurs_runtime_Value = dictChoice_1_loop
_ = dictChoice_1
rmap_2_0 := gopurs_runtime.Apply(pkg_Data_Profunctor.Get_rmap(), gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictChoice_1)}, "Profunctor0_NOT_FOUND"), gopurs_runtime.Value{}))
_ = rmap_2_0
...
end_branch_1:
return __t1
}), gopurs_runtime.Apply2(dictSemigroupoid_0.compose, gopurs_runtime.Apply(dictChoice_1.right, r_4), gopurs_runtime.Apply(dictChoice_1.left, l_3)))
})
}
