...
return gopurs_runtime.Any(Call_monadSTIdentityT(dictMonadST_0_box))
})
	})
...
return gopurs_runtime.Any(Call_traversableIdentityT(dictTraversable_0_box))
})
	})
...
return gopurs_runtime.Any(Call_runIdentityT(gopurs_runtime.UnboxAny(v_0_box)))
})
	})
	return cache_runIdentityT
}

var cache_runIdentityT__func_interface____interface___1334010785 gopurs_runtime.Value
var once_runIdentityT__func_interface____interface___1334010785 sync.Once
func Get_runIdentityT__func_interface____interface___1334010785() gopurs_runtime.Value {
	once_runIdentityT__func_interface____interface___1334010785.Do(func() {
		cache_runIdentityT__func_interface____interface___1334010785 = gopurs_runtime.Func(func(v_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Any(Call_runIdentityT__func_interface____interface___1334010785(gopurs_runtime.UnboxAny(v_0_box)))
})
	})
	return cache_runIdentityT__func_interface____interface___1334010785
}
...
return gopurs_runtime.Any(Call_plusIdentityT(dictPlus_0_box))
})
	})
...
func Get_newtypeIdentityT() gopurs_runtime.Value {
	once_newtypeIdentityT.Do(func() {
		cache_newtypeIdentityT = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("Coercible0", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Any(Call_monadWriterIdentityT(dictMonadWriter_0_box))
})
	})
...
func Get_monadTransIdentityT() gopurs_runtime.Value {
	once_monadTransIdentityT.Do(func() {
		cache_monadTransIdentityT = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("lift", gopurs_runtime.Func(func(dictMonad_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Any(Call_monadThrowIdentityT(dictMonadThrow_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monadTellIdentityT(dictMonadTell_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monadStateIdentityT(dictMonadState_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monadRecIdentityT(dictMonadRec_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monadReaderIdentityT(dictMonadReader_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monadPlusIdentityT(dictMonadPlus_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monadIdentityT(dictMonad_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monadErrorIdentityT(dictMonadError_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monadEffectIdentityT(dictMonadEffect_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monadContIdentityT(dictMonadCont_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monadAskIdentityT(dictMonadAsk_0_box))
})
	})
...
return gopurs_runtime.Any(Call_mapIdentityT(func(inner_arg0 interface{}) interface{} {
...
return gopurs_runtime.Any(Call_functorIdentityT(dictFunctor_0_box))
})
	})
...
return gopurs_runtime.Any(Call_foldableIdentityT(dictFoldable_0_box))
})
	})
...
return gopurs_runtime.Any(Call_extendIdentityI(dictExtend_0_box))
})
	})
...
return gopurs_runtime.Any(Call_eqIdentityT(dictEq1_0_box, dictEq_1_box))
})
	})
...
return gopurs_runtime.Any(Call_eq1IdentityT(dictEq1_0_box))
})
	})
...
return gopurs_runtime.Any(Call_ord1IdentityT(dictOrd1_0_box))
})
	})
...
return gopurs_runtime.Any(Call_comonadIdentityT(dictComonad_0_box))
})
	})
...
return gopurs_runtime.Any(Call_bindIdentityT(dictBind_0_box))
})
	})
...
return gopurs_runtime.Any(Call_applyIdentityT(dictApply_0_box))
})
	})
...
return gopurs_runtime.Any(Call_applicativeIdentityT(dictApplicative_0_box))
})
	})
...
return gopurs_runtime.Any(Call_alternativeIdentityT(dictAlternative_0_box))
})
	})
...
return gopurs_runtime.Any(Call_altIdentityT(dictAlt_0_box))
})
	})
...
func Call_monadSTIdentityT(dictMonadST_0_loop gopurs_runtime.Value) interface{} {
var dictMonadST_0 gopurs_runtime.Value = dictMonadST_0_loop
_ = dictMonadST_0
return gopurs_runtime.UnboxAny(dictMonadST_0)
}

func Call_traversableIdentityT(dictTraversable_0_loop gopurs_runtime.Value) interface{} {
var dictTraversable_0 gopurs_runtime.Value = dictTraversable_0_loop
_ = dictTraversable_0
return gopurs_runtime.UnboxAny(dictTraversable_0)
}

func Call_runIdentityT(v_0_loop interface{}) interface{} {
var v_0 interface{} = v_0_loop
_ = v_0
return v_0
}

func Call_runIdentityT__func_interface____interface___1334010785(v_0_loop interface{}) interface{} {
var v_0 interface{} = v_0_loop
_ = v_0
return v_0
}

func Call_plusIdentityT(dictPlus_0_loop gopurs_runtime.Value) interface{} {
var dictPlus_0 gopurs_runtime.Value = dictPlus_0_loop
_ = dictPlus_0
return gopurs_runtime.UnboxAny(dictPlus_0)
}

func Call_monadWriterIdentityT(dictMonadWriter_0_loop gopurs_runtime.Value) interface{} {
var dictMonadWriter_0 gopurs_runtime.Value = dictMonadWriter_0_loop
_ = dictMonadWriter_0
return gopurs_runtime.UnboxAny(dictMonadWriter_0)
}

func Call_monadThrowIdentityT(dictMonadThrow_0_loop gopurs_runtime.Value) interface{} {
var dictMonadThrow_0 gopurs_runtime.Value = dictMonadThrow_0_loop
_ = dictMonadThrow_0
return gopurs_runtime.UnboxAny(dictMonadThrow_0)
}

func Call_monadTellIdentityT(dictMonadTell_0_loop gopurs_runtime.Value) interface{} {
var dictMonadTell_0 gopurs_runtime.Value = dictMonadTell_0_loop
_ = dictMonadTell_0
return gopurs_runtime.UnboxAny(dictMonadTell_0)
}

func Call_monadStateIdentityT(dictMonadState_0_loop gopurs_runtime.Value) interface{} {
var dictMonadState_0 gopurs_runtime.Value = dictMonadState_0_loop
_ = dictMonadState_0
return gopurs_runtime.UnboxAny(dictMonadState_0)
}

func Call_monadRecIdentityT(dictMonadRec_0_loop gopurs_runtime.Value) interface{} {
var dictMonadRec_0 gopurs_runtime.Value = dictMonadRec_0_loop
_ = dictMonadRec_0
return gopurs_runtime.UnboxAny(dictMonadRec_0)
}

func Call_monadReaderIdentityT(dictMonadReader_0_loop gopurs_runtime.Value) interface{} {
var dictMonadReader_0 gopurs_runtime.Value = dictMonadReader_0_loop
_ = dictMonadReader_0
return gopurs_runtime.UnboxAny(dictMonadReader_0)
}

func Call_monadPlusIdentityT(dictMonadPlus_0_loop gopurs_runtime.Value) interface{} {
var dictMonadPlus_0 gopurs_runtime.Value = dictMonadPlus_0_loop
_ = dictMonadPlus_0
return gopurs_runtime.UnboxAny(dictMonadPlus_0)
}

func Call_monadIdentityT(dictMonad_0_loop gopurs_runtime.Value) interface{} {
var dictMonad_0 gopurs_runtime.Value = dictMonad_0_loop
_ = dictMonad_0
return gopurs_runtime.UnboxAny(dictMonad_0)
}

func Call_monadErrorIdentityT(dictMonadError_0_loop gopurs_runtime.Value) interface{} {
var dictMonadError_0 gopurs_runtime.Value = dictMonadError_0_loop
_ = dictMonadError_0
return gopurs_runtime.UnboxAny(dictMonadError_0)
}

func Call_monadEffectIdentityT(dictMonadEffect_0_loop gopurs_runtime.Value) interface{} {
var dictMonadEffect_0 gopurs_runtime.Value = dictMonadEffect_0_loop
_ = dictMonadEffect_0
return gopurs_runtime.UnboxAny(dictMonadEffect_0)
}

func Call_monadContIdentityT(dictMonadCont_0_loop gopurs_runtime.Value) interface{} {
var dictMonadCont_0 gopurs_runtime.Value = dictMonadCont_0_loop
_ = dictMonadCont_0
return gopurs_runtime.UnboxAny(dictMonadCont_0)
}

func Call_monadAskIdentityT(dictMonadAsk_0_loop gopurs_runtime.Value) interface{} {
var dictMonadAsk_0 gopurs_runtime.Value = dictMonadAsk_0_loop
_ = dictMonadAsk_0
return gopurs_runtime.UnboxAny(dictMonadAsk_0)
}

func Call_mapIdentityT(f_0_loop func(interface{}) interface{}, v_1_loop interface{}) interface{} {
...
func Call_functorIdentityT(dictFunctor_0_loop gopurs_runtime.Value) interface{} {
var dictFunctor_0 gopurs_runtime.Value = dictFunctor_0_loop
_ = dictFunctor_0
return gopurs_runtime.UnboxAny(dictFunctor_0)
}

func Call_foldableIdentityT(dictFoldable_0_loop gopurs_runtime.Value) interface{} {
var dictFoldable_0 gopurs_runtime.Value = dictFoldable_0_loop
_ = dictFoldable_0
return gopurs_runtime.UnboxAny(dictFoldable_0)
}

func Call_extendIdentityI(dictExtend_0_loop gopurs_runtime.Value) interface{} {
...
_ = __local_var_1_0
return gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Functor0", "extend", gopurs_runtime.Func(func(_dollar__unused_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_eqIdentityT(dictEq1_0_loop gopurs_runtime.Value, dictEq_1_loop gopurs_runtime.Value) interface{} {
...
func Call_eq1IdentityT(dictEq1_0_loop gopurs_runtime.Value) interface{} {
var dictEq1_0 gopurs_runtime.Value = dictEq1_0_loop
_ = dictEq1_0
...
func Call_ord1IdentityT(dictOrd1_0_loop gopurs_runtime.Value) interface{} {
var dictOrd1_0 gopurs_runtime.Value = dictOrd1_0_loop
_ = dictOrd1_0
__local_var_1_0 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictOrd1_0, "Eq10"), gopurs_runtime.Value{})
_ = __local_var_1_0
...
func Call_comonadIdentityT(dictComonad_0_loop gopurs_runtime.Value) interface{} {
...
return gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Extend0", "extract", gopurs_runtime.Func(func(_dollar__unused_4 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_bindIdentityT(dictBind_0_loop gopurs_runtime.Value) interface{} {
var dictBind_0 gopurs_runtime.Value = dictBind_0_loop
_ = dictBind_0
return gopurs_runtime.UnboxAny(dictBind_0)
}

func Call_applyIdentityT(dictApply_0_loop gopurs_runtime.Value) interface{} {
var dictApply_0 gopurs_runtime.Value = dictApply_0_loop
_ = dictApply_0
return gopurs_runtime.UnboxAny(dictApply_0)
}

func Call_applicativeIdentityT(dictApplicative_0_loop gopurs_runtime.Value) interface{} {
var dictApplicative_0 gopurs_runtime.Value = dictApplicative_0_loop
_ = dictApplicative_0
return gopurs_runtime.UnboxAny(dictApplicative_0)
}

func Call_alternativeIdentityT(dictAlternative_0_loop gopurs_runtime.Value) interface{} {
var dictAlternative_0 gopurs_runtime.Value = dictAlternative_0_loop
_ = dictAlternative_0
return gopurs_runtime.UnboxAny(dictAlternative_0)
}

func Call_altIdentityT(dictAlt_0_loop gopurs_runtime.Value) interface{} {
var dictAlt_0 gopurs_runtime.Value = dictAlt_0_loop
_ = dictAlt_0
return gopurs_runtime.UnboxAny(dictAlt_0)
}
