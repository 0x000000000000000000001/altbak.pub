...
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Effect.Get_bindEffect(), "bind"), gopurs_runtime.Apply2(pkg_Bench.Get_runBench(), pkg_Test_Parallelism.Get_describe(), pkg_Test_Parallelism.Get_act()), gopurs_runtime.Func(func(t18_17 gopurs_runtime.Value) gopurs_runtime.Value {
