...
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str("(NonEmpty "), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Apply(((*gopurs_runtime.RecordData1)(dictShow_0.UnsafePtr)).V0, (*Data_Data_NonEmpty_NonEmpty)(v_2.UnsafePtr).V0), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str(" "), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Apply(((*gopurs_runtime.RecordData1)(dictShow1_1.UnsafePtr)).V0, (*Data_Data_NonEmpty_NonEmpty)(v_2.UnsafePtr).V1), gopurs_runtime.Str(")")))))
}))
}
...
return gopurs_runtime.Value{Type: 9, IntVal: 3111306138, UnsafePtr: unsafe.Pointer(&Data_Data_NonEmpty_NonEmpty{(*Data_Data_NonEmpty_NonEmpty)(v_2.UnsafePtr).V0, gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictSemigroup_1.UnsafePtr)).V0, (*Data_Data_NonEmpty_NonEmpty)(v_2.UnsafePtr).V1, gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictSemigroup_1.UnsafePtr)).V0, gopurs_runtime.Apply(((*gopurs_runtime.RecordData1)(dictApplicative_0.UnsafePtr)).V0, (*Data_Data_NonEmpty_NonEmpty)(v1_3.UnsafePtr).V0), (*Data_Data_NonEmpty_NonEmpty)(v1_3.UnsafePtr).V1))})}
}))
}
...
_ = v_1
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictAlternative_0, "Plus1_NOT_FOUND"), gopurs_runtime.Value{}), "Alt0"), gopurs_runtime.Value{}), "alt"), gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictAlternative_0, "Applicative0_NOT_FOUND"), gopurs_runtime.Value{}), "pure"), (*Data_Data_NonEmpty_NonEmpty)(v_1.UnsafePtr).V0), (*Data_Data_NonEmpty_NonEmpty)(v_1.UnsafePtr).V1)
}
...
return gopurs_runtime.Value{Type: 9, IntVal: 3111306138, UnsafePtr: unsafe.Pointer(&Data_Data_NonEmpty_NonEmpty{gopurs_runtime.Apply(f_1, (*Data_Data_NonEmpty_NonEmpty)(m_2.UnsafePtr).V0), gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictFunctor_0.UnsafePtr)).V0, f_1, (*Data_Data_NonEmpty_NonEmpty)(m_2.UnsafePtr).V1)})}
}))
}
...
return gopurs_runtime.Value{Type: 9, IntVal: 3111306138, UnsafePtr: unsafe.Pointer(&Data_Data_NonEmpty_NonEmpty{gopurs_runtime.Apply2(f_3, gopurs_runtime.Value{Type: 9, IntVal: 3589588149, UnsafePtr: nil}, (*Data_Data_NonEmpty_NonEmpty)(v_4.UnsafePtr).V0), gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictFunctorWithIndex_0.UnsafePtr)).V0, gopurs_runtime.Func(func(x_5 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply3(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V1, f_1, gopurs_runtime.Apply2(f_1, b_2, (*Data_Data_NonEmpty_NonEmpty)(v_3.UnsafePtr).V0), (*Data_Data_NonEmpty_NonEmpty)(v_3.UnsafePtr).V1)
}), gopurs_runtime.Func3(func(f_1 gopurs_runtime.Value, b_2 gopurs_runtime.Value, v_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(f_1, (*Data_Data_NonEmpty_NonEmpty)(v_3.UnsafePtr).V0, gopurs_runtime.Apply3(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V2, f_1, b_2, (*Data_Data_NonEmpty_NonEmpty)(v_3.UnsafePtr).V1))
}))
}
...
return gopurs_runtime.Apply3(f_3, gopurs_runtime.Value{Type: 9, IntVal: 3589588149, UnsafePtr: nil}, (*Data_Data_NonEmpty_NonEmpty)(v_5.UnsafePtr).V0, gopurs_runtime.Apply3(((*gopurs_runtime.RecordData3)(dictFoldableWithIndex_0.UnsafePtr)).V2, gopurs_runtime.Func(func(x_6 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(f_3, gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Data_Data_Maybe_Just{x_6})})
...
return gopurs_runtime.Apply3(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V1, f_2, (*Data_Data_NonEmpty_NonEmpty)(v_3.UnsafePtr).V0, (*Data_Data_NonEmpty_NonEmpty)(v_3.UnsafePtr).V1)
}), gopurs_runtime.Func2(func(f_2 gopurs_runtime.Value, v_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_HeytingAlgebra.Get_heytingAlgebraBoolean(), "conj"), gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictEq_1.UnsafePtr)).V0, (*Data_Data_NonEmpty_NonEmpty)(x_3.UnsafePtr).V0, (*Data_Data_NonEmpty_NonEmpty)(y_4.UnsafePtr).V0), gopurs_runtime.Apply2(eq11_2_0, (*Data_Data_NonEmpty_NonEmpty)(x_3.UnsafePtr).V1, (*Data_Data_NonEmpty_NonEmpty)(y_4.UnsafePtr).V1))
}))
}
