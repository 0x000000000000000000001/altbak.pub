...
_ = __local_var_3_0
return gopurs_runtime.Constructor2("NonEmpty", (*[1024]gopurs_runtime.Value)(__local_var_3_0.UnsafePtr)[0], gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictUnfoldable_0_loop, "unfoldr"), gopurs_runtime.Func(func(v1_4 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = dictPlus_0
empty_1_0 := gopurs_runtime.RecordGet(dictPlus_0_loop, "empty")
_ = empty_1_0
...
func Get_showNonEmpty() gopurs_runtime.Value {
	once_showNonEmpty.Do(func() {
		showNonEmpty = gopurs_runtime.Func2(Call_showNonEmpty)
	})
	return showNonEmpty
}
...
func Get_semigroupNonEmpty() gopurs_runtime.Value {
	once_semigroupNonEmpty.Do(func() {
		semigroupNonEmpty = gopurs_runtime.Func2(Call_semigroupNonEmpty)
	})
...
return gopurs_runtime.Constructor2("NonEmpty", gopurs_runtime.Apply(f_1, (*[1024]gopurs_runtime.Value)(m_2.UnsafePtr)[0]), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictFunctor_0_loop, "map"), f_1, (*[1024]gopurs_runtime.Value)(m_2.UnsafePtr)[1]))
}))
}()
})
	})
...
func Get_fromNonEmpty() gopurs_runtime.Value {
	once_fromNonEmpty.Do(func() {
		fromNonEmpty = gopurs_runtime.Func2(Call_fromNonEmpty)
	})
	return fromNonEmpty
}
...
return gopurs_runtime.Apply3(gopurs_runtime.RecordGet(dictFoldable_0_loop, "foldl"), f_1, gopurs_runtime.Apply2(f_1, b_2, (*[1024]gopurs_runtime.Value)(v_3.UnsafePtr)[0]), (*[1024]gopurs_runtime.Value)(v_3.UnsafePtr)[1])
}), gopurs_runtime.Func3(func(f_1 gopurs_runtime.Value, b_2 gopurs_runtime.Value, v_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(f_1, (*[1024]gopurs_runtime.Value)(v_3.UnsafePtr)[0], gopurs_runtime.Apply3(gopurs_runtime.RecordGet(dictFoldable_0_loop, "foldr"), f_1, b_2, (*[1024]gopurs_runtime.Value)(v_3.UnsafePtr)[1]))
}))
}()
})
	})
...
return gopurs_runtime.Apply3(gopurs_runtime.RecordGet(dictFoldableWithIndex_0_loop, "foldlWithIndex"), gopurs_runtime.Func(func(x_6 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply3(f_3, gopurs_runtime.Constructor0("Nothing"), (*[1024]gopurs_runtime.Value)(v_5.UnsafePtr)[0], gopurs_runtime.Apply3(gopurs_runtime.RecordGet(dictFoldableWithIndex_0_loop, "foldrWithIndex"), gopurs_runtime.Func(func(x_6 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(f_3, gopurs_runtime.Constructor1("Just", x_6))
...
_ = Apply0_6_5
sequence1_7_6 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictTraversable_0_loop, "sequence"), dictApplicative_5)
_ = sequence1_7_6
...
_ = Apply0_6_7
traverse1_7_8 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictTraversable_0_loop, "traverse"), dictApplicative_5)
_ = traverse1_7_8
...
foldableWithIndexNonEmpty1_4_4 := gopurs_runtime.Apply(Get_foldableWithIndexNonEmpty(), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictTraversableWithIndex_0_loop, "FoldableWithIndex1"), gopurs_runtime.Value{}))
_ = foldableWithIndexNonEmpty1_4_4
traversableNonEmpty1_5_5 := gopurs_runtime.Apply(Get_traversableNonEmpty(), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictTraversableWithIndex_0_loop, "Traversable2"), gopurs_runtime.Value{}))
...
_ = Apply0_7_6
traverseWithIndex1_8_7 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictTraversableWithIndex_0_loop, "traverseWithIndex"), dictApplicative_6)
...
foldMap1_2_1 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictFoldable_0_loop, "foldMap"), dictMonoid_1)
_ = foldMap1_2_1
return gopurs_runtime.Func2(func(f_3 gopurs_runtime.Value, v_4 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply3(gopurs_runtime.RecordGet(dictFoldable_0_loop, "foldl"), gopurs_runtime.Func2(func(s_5 gopurs_runtime.Value, a1_6 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = __local_var_4_2
__local_var_5_3 := gopurs_runtime.Apply3(gopurs_runtime.RecordGet(dictFoldable_0_loop, "foldr"), gopurs_runtime.Func(func(a1_5 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply3(gopurs_runtime.RecordGet(dictFoldable_0_loop, "foldl"), f_2, (*[1024]gopurs_runtime.Value)(v_3.UnsafePtr)[0], (*[1024]gopurs_runtime.Value)(v_3.UnsafePtr)[1])
...
var dictFoldable_0 gopurs_runtime.Value = dictFoldable_0_loop
_ = dictFoldable_0
return gopurs_runtime.RecordGet(gopurs_runtime.Apply(Get_foldable1NonEmpty(), dictFoldable_0_loop), "foldl1")
}()
})
	})
	return foldl1
...
func Get_eqNonEmpty() gopurs_runtime.Value {
	once_eqNonEmpty.Do(func() {
		eqNonEmpty = gopurs_runtime.Func2(Call_eqNonEmpty)
	})
	return eqNonEmpty
}
...
eq11_2_0 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictEq1_0_loop, "eq1"), dictEq_1)
_ = eq11_2_0
...
var dictOrd1_0 gopurs_runtime.Value = dictOrd1_0_loop
_ = dictOrd1_0
ordNonEmpty1_1_0 := gopurs_runtime.Apply(Get_ordNonEmpty(), dictOrd1_0_loop)
_ = ordNonEmpty1_1_0
...
return gopurs_runtime.Str("(NonEmpty " + gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictShow_0_loop, "show"), (*[1024]gopurs_runtime.Value)(v_2.UnsafePtr)[0]).StrVal + " " + gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictShow1_1_loop, "show"), (*[1024]gopurs_runtime.Value)(v_2.UnsafePtr)[1]).StrVal + ")")
}))
}
...
return gopurs_runtime.Constructor2("NonEmpty", (*[1024]gopurs_runtime.Value)(v_2.UnsafePtr)[0], gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictSemigroup_1_loop, "append"), (*[1024]gopurs_runtime.Value)(v_2.UnsafePtr)[1], gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictSemigroup_1_loop, "append"), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictApplicative_0_loop, "pure"), (*[1024]gopurs_runtime.Value)(v1_3.UnsafePtr)[0]), (*[1024]gopurs_runtime.Value)(v1_3.UnsafePtr)[1])))
}))
}
...
_ = v_1
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictAlternative_0_loop, "Plus1"), gopurs_runtime.Value{}), "Alt0"), gopurs_runtime.Value{}), "alt"), gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictAlternative_0_loop, "Applicative0"), gopurs_runtime.Value{}), "pure"), (*[1024]gopurs_runtime.Value)(v_1_loop.UnsafePtr)[0]), (*[1024]gopurs_runtime.Value)(v_1_loop.UnsafePtr)[1])
}
...
var v_1 gopurs_runtime.Value = v_1_loop
_ = v_1
return gopurs_runtime.Apply2(f_0_loop, (*[1024]gopurs_runtime.Value)(v_1_loop.UnsafePtr)[0], (*[1024]gopurs_runtime.Value)(v_1_loop.UnsafePtr)[1])
}
...
return gopurs_runtime.Bool(gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictEq_1_loop, "eq"), (*[1024]gopurs_runtime.Value)(x_3.UnsafePtr)[0], (*[1024]gopurs_runtime.Value)(y_4.UnsafePtr)[0]).IntVal != 0 && gopurs_runtime.Apply2(eq11_2_0, (*[1024]gopurs_runtime.Value)(x_3.UnsafePtr)[1], (*[1024]gopurs_runtime.Value)(y_4.UnsafePtr)[1]).IntVal != 0)
}))
}
