...
_ = __local_var_3_0
return gopurs_runtime.Constructor2("NonEmpty", gopurs_runtime.ConstructorGet(__local_var_3_0, 0), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictUnfoldable_0, "unfoldr"), gopurs_runtime.Func(func(v1_4 gopurs_runtime.Value) gopurs_runtime.Value {
var __t1 gopurs_runtime.Value
{
if (gopurs_runtime.Bool(v1_4.StrVal == "Just")).IntVal != 0 {
__t1 = gopurs_runtime.Constructor1("Just", gopurs_runtime.Apply(f_1, gopurs_runtime.ConstructorGet(v1_4, 0)))
goto end_branch_1
} else {
...
end_branch_1:
return __t1
}), gopurs_runtime.ConstructorGet(__local_var_3_0, 1)))
}))
})
	})
...
return gopurs_runtime.Str(gopurs_runtime.Str(gopurs_runtime.Str(gopurs_runtime.Str(gopurs_runtime.Str("(NonEmpty ").StrVal + gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictShow_0, "show"), gopurs_runtime.ConstructorGet(v_2, 0)).StrVal).StrVal + gopurs_runtime.Str(" ").StrVal).StrVal + gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictShow1_1, "show"), gopurs_runtime.ConstructorGet(v_2, 1)).StrVal).StrVal + gopurs_runtime.Str(")").StrVal)
}))
})
	})
	return showNonEmpty
...
return gopurs_runtime.Constructor2("NonEmpty", gopurs_runtime.ConstructorGet(v_2, 0), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictSemigroup_1, "append"), gopurs_runtime.ConstructorGet(v_2, 1), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictSemigroup_1, "append"), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictApplicative_0, "pure"), gopurs_runtime.ConstructorGet(v1_3, 0)), gopurs_runtime.ConstructorGet(v1_3, 1))))
}))
})
	})
...
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictAlternative_0, "Plus1"), gopurs_runtime.Value{}), "Alt0"), gopurs_runtime.Value{}), "alt"), gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictAlternative_0, "Applicative0"), gopurs_runtime.Value{}), "pure"), gopurs_runtime.ConstructorGet(v_1, 0)), gopurs_runtime.ConstructorGet(v_1, 1))
})
	})
	return oneOf
}
...
return gopurs_runtime.Constructor2("NonEmpty", gopurs_runtime.Apply(f_1, gopurs_runtime.ConstructorGet(m_2, 0)), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictFunctor_0, "map"), f_1, gopurs_runtime.ConstructorGet(m_2, 1)))
}))
})
	})
...
return gopurs_runtime.Constructor2("NonEmpty", gopurs_runtime.Apply(f_2, gopurs_runtime.ConstructorGet(m_3, 0)), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_1_0, "map"), f_2, gopurs_runtime.ConstructorGet(m_3, 1)))
}))
...
return gopurs_runtime.Constructor2("NonEmpty", gopurs_runtime.Apply2(f_3, gopurs_runtime.Constructor0("Nothing"), gopurs_runtime.ConstructorGet(v_4, 0)), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictFunctorWithIndex_0, "mapWithIndex"), gopurs_runtime.Func(func(x_5 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(f_3, gopurs_runtime.Constructor1("Just", x_5))
}), gopurs_runtime.ConstructorGet(v_4, 1)))
...
return gopurs_runtime.Apply2(f_0, gopurs_runtime.ConstructorGet(v_1, 0), gopurs_runtime.ConstructorGet(v_1, 1))
})
	})
	return fromNonEmpty
}
...
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonoid_1, "Semigroup0"), gopurs_runtime.Value{}), "append"), gopurs_runtime.Apply(f_3, gopurs_runtime.ConstructorGet(v_4, 0)), gopurs_runtime.Apply2(foldMap1_2_0, f_3, gopurs_runtime.ConstructorGet(v_4, 1)))
})
...
return gopurs_runtime.Apply3(gopurs_runtime.RecordGet(dictFoldable_0, "foldl"), f_1, gopurs_runtime.Apply2(f_1, b_2, gopurs_runtime.ConstructorGet(v_3, 0)), gopurs_runtime.ConstructorGet(v_3, 1))
}), gopurs_runtime.Func3(func(f_1 gopurs_runtime.Value, b_2 gopurs_runtime.Value, v_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(f_1, gopurs_runtime.ConstructorGet(v_3, 0), gopurs_runtime.Apply3(gopurs_runtime.RecordGet(dictFoldable_0, "foldr"), f_1, b_2, gopurs_runtime.ConstructorGet(v_3, 1)))
}))
})
	})
...
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonoid_2, "Semigroup0"), gopurs_runtime.Value{}), "append"), gopurs_runtime.Apply(f_4, gopurs_runtime.ConstructorGet(v_5, 0)), gopurs_runtime.Apply2(foldMap1_3_2, f_4, gopurs_runtime.ConstructorGet(v_5, 1)))
})
...
return gopurs_runtime.Apply3(gopurs_runtime.RecordGet(__local_var_1_0, "foldl"), f_2, gopurs_runtime.Apply2(f_2, b_3, gopurs_runtime.ConstructorGet(v_4, 0)), gopurs_runtime.ConstructorGet(v_4, 1))
}), gopurs_runtime.Func3(func(f_2 gopurs_runtime.Value, b_3 gopurs_runtime.Value, v_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(f_2, gopurs_runtime.ConstructorGet(v_4, 0), gopurs_runtime.Apply3(gopurs_runtime.RecordGet(__local_var_1_0, "foldr"), f_2, b_3, gopurs_runtime.ConstructorGet(v_4, 1)))
}))
...
}), gopurs_runtime.Apply3(f_3, gopurs_runtime.Constructor0("Nothing"), b_4, gopurs_runtime.ConstructorGet(v_5, 0)), gopurs_runtime.ConstructorGet(v_5, 1))
}), gopurs_runtime.Func3(func(f_3 gopurs_runtime.Value, b_4 gopurs_runtime.Value, v_5 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply3(f_3, gopurs_runtime.Constructor0("Nothing"), gopurs_runtime.ConstructorGet(v_5, 0), gopurs_runtime.Apply3(gopurs_runtime.RecordGet(dictFoldableWithIndex_0, "foldrWithIndex"), gopurs_runtime.Func(func(x_6 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(f_3, gopurs_runtime.Constructor1("Just", x_6))
}), b_4, gopurs_runtime.ConstructorGet(v_5, 1)))
}), gopurs_runtime.Func(func(_dollar__unused_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonoid_4, "Semigroup0"), gopurs_runtime.Value{}), "append"), gopurs_runtime.Apply(f_6, gopurs_runtime.ConstructorGet(v_7, 0)), gopurs_runtime.Apply2(foldMap1_5_4, f_6, gopurs_runtime.ConstructorGet(v_7, 1)))
})
...
return gopurs_runtime.Apply3(gopurs_runtime.RecordGet(__local_var_3_2, "foldl"), f_4, gopurs_runtime.Apply2(f_4, b_5, gopurs_runtime.ConstructorGet(v_6, 0)), gopurs_runtime.ConstructorGet(v_6, 1))
}), gopurs_runtime.Func3(func(f_4 gopurs_runtime.Value, b_5 gopurs_runtime.Value, v_6 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(f_4, gopurs_runtime.ConstructorGet(v_6, 0), gopurs_runtime.Apply3(gopurs_runtime.RecordGet(__local_var_3_2, "foldr"), f_4, b_5, gopurs_runtime.ConstructorGet(v_6, 1)))
}))
...
return gopurs_runtime.Constructor2("NonEmpty", gopurs_runtime.Apply(f_3, gopurs_runtime.ConstructorGet(m_4, 0)), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_2_1, "map"), f_3, gopurs_runtime.ConstructorGet(m_4, 1)))
}))
...
return gopurs_runtime.Constructor2("NonEmpty", gopurs_runtime.Apply2(f_4, gopurs_runtime.Constructor0("Nothing"), gopurs_runtime.ConstructorGet(v_5, 0)), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_1_0, "mapWithIndex"), gopurs_runtime.Func(func(x_6 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(f_4, gopurs_runtime.Constructor1("Just", x_6))
}), gopurs_runtime.ConstructorGet(v_5, 1)))
...
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(Apply0_7_6, "apply"), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(Apply0_7_6, "Functor0"), gopurs_runtime.Value{}), "map"), Get_NonEmpty(), gopurs_runtime.Apply2(f_9, gopurs_runtime.Constructor0("Nothing"), gopurs_runtime.ConstructorGet(v_10, 0))), gopurs_runtime.Apply2(traverseWithIndex1_8_7, gopurs_runtime.Func(func(x_11 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(f_9, gopurs_runtime.Constructor1("Just", x_11))
}), gopurs_runtime.ConstructorGet(v_10, 1)))
})
...
_ = foldMap1_2_1
return gopurs_runtime.Func2(func(f_3 gopurs_runtime.Value, v_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonoid_1, "Semigroup0"), gopurs_runtime.Value{}), "append"), gopurs_runtime.Apply(f_3, gopurs_runtime.ConstructorGet(v_4, 0)), gopurs_runtime.Apply2(foldMap1_2_1, f_3, gopurs_runtime.ConstructorGet(v_4, 1)))
})
}), gopurs_runtime.Func3(func(f_1 gopurs_runtime.Value, b_2 gopurs_runtime.Value, v_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply3(gopurs_runtime.RecordGet(dictFoldable_0, "foldl"), f_1, gopurs_runtime.Apply2(f_1, b_2, gopurs_runtime.ConstructorGet(v_3, 0)), gopurs_runtime.ConstructorGet(v_3, 1))
}), gopurs_runtime.Func3(func(f_1 gopurs_runtime.Value, b_2 gopurs_runtime.Value, v_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
}), gopurs_runtime.Apply(f_3, gopurs_runtime.ConstructorGet(v_4, 0)), gopurs_runtime.ConstructorGet(v_4, 1))
}), gopurs_runtime.Func2(func(f_2 gopurs_runtime.Value, v_3 gopurs_runtime.Value) gopurs_runtime.Value {
__local_var_4_2 := gopurs_runtime.Apply(f_2, gopurs_runtime.ConstructorGet(v_3, 0))
_ = __local_var_4_2
...
__t5 = gopurs_runtime.Apply(__local_var_6_4, gopurs_runtime.ConstructorGet(x_7, 0))
goto end_branch_5
} else {
...
}), gopurs_runtime.Constructor0("Nothing"), gopurs_runtime.ConstructorGet(v_3, 1))
_ = __local_var_5_3
var __t6 gopurs_runtime.Value
{
if (gopurs_runtime.Bool(__local_var_5_3.StrVal == "Nothing")).IntVal != 0 {
__t6 = gopurs_runtime.ConstructorGet(v_3, 0)
goto end_branch_6
} else {
...
__t6 = gopurs_runtime.Apply(__local_var_4_2, gopurs_runtime.ConstructorGet(__local_var_5_3, 0))
goto end_branch_6
} else {
...
return gopurs_runtime.Apply3(gopurs_runtime.RecordGet(dictFoldable_0, "foldl"), f_2, gopurs_runtime.ConstructorGet(v_3, 0), gopurs_runtime.ConstructorGet(v_3, 1))
...
return gopurs_runtime.Bool(gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictEq_1, "eq"), gopurs_runtime.ConstructorGet(x_3, 0), gopurs_runtime.ConstructorGet(y_4, 0)).IntVal != 0 && gopurs_runtime.Apply2(eq11_2_0, gopurs_runtime.ConstructorGet(x_3, 1), gopurs_runtime.ConstructorGet(y_4, 1)).IntVal != 0)
}))
})
	})
	return eqNonEmpty
...
return gopurs_runtime.Bool(gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_4_2, "eq"), gopurs_runtime.ConstructorGet(x_6, 0), gopurs_runtime.ConstructorGet(y_7, 0)).IntVal != 0 && gopurs_runtime.Apply2(eq11_5_3, gopurs_runtime.ConstructorGet(x_6, 1), gopurs_runtime.ConstructorGet(y_7, 1)).IntVal != 0)
}))
_ = eqNonEmpty2_6_4
...
v_9_5 := gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictOrd_2, "compare"), gopurs_runtime.ConstructorGet(x_7, 0), gopurs_runtime.ConstructorGet(y_8, 0))
_ = v_9_5
var __t6 gopurs_runtime.Value
{
...
{
__t6 = gopurs_runtime.Apply2(compare11_3_1, gopurs_runtime.ConstructorGet(x_7, 1), gopurs_runtime.ConstructorGet(y_8, 1))
}
end_branch_6:
return __t6
...
return gopurs_runtime.Bool(gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictEq_3, "eq"), gopurs_runtime.ConstructorGet(x_5, 0), gopurs_runtime.ConstructorGet(y_6, 0)).IntVal != 0 && gopurs_runtime.Apply2(eq11_4_3, gopurs_runtime.ConstructorGet(x_5, 1), gopurs_runtime.ConstructorGet(y_6, 1)).IntVal != 0)
})
}))
_ = eq1NonEmpty1_3_2
