...
var cache_group__gopurs_runtime_Value_227222742 gopurs_runtime.Value
var once_group__gopurs_runtime_Value_227222742 sync.Once
func Get_group__gopurs_runtime_Value_227222742() gopurs_runtime.Value {
	once_group__gopurs_runtime_Value_227222742.Do(func() {
		cache_group__gopurs_runtime_Value_227222742 = gopurs_runtime.Func2(func(dictMonadEffect_0_box gopurs_runtime.Value, x_1_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_group__gopurs_runtime_Value_227222742(gopurs_runtime.CoerceToStruct[pkg_Effect_Class.Constructor_MonadEffect[gopurs_runtime.Value]](dictMonadEffect_0_box), x_1_box.StrVal())
})
	})
	return cache_group__gopurs_runtime_Value_227222742
}
...
func Call_group__gopurs_runtime_Value_227222742(dictMonadEffect_0_loop *pkg_Effect_Class.Constructor_MonadEffect[gopurs_runtime.Value], x_1_loop string) gopurs_runtime.Value {
var dictMonadEffect_0 *pkg_Effect_Class.Constructor_MonadEffect[gopurs_runtime.Value] = dictMonadEffect_0_loop
_ = dictMonadEffect_0
var x_1 string = x_1_loop
_ = x_1
