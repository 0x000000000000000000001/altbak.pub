...
_ = dictBounded_0
return gopurs_runtime.RecordDict1("genericTop'", gopurs_runtime.RecordGet(dictBounded_0_loop, "top"))
}()
})
	})
...
_ = dict_0
return gopurs_runtime.RecordGet(dict_0_loop, "genericTop'")
}()
})
	})
...
_ = dictGenericTop_0
return gopurs_runtime.RecordDict1("genericTop'", gopurs_runtime.RecordGet(dictGenericTop_0_loop, "genericTop'"))
}()
})
	})
...
var dictGenericTop_0 gopurs_runtime.Value = dictGenericTop_0_loop
_ = dictGenericTop_0
genericTop_prime1_1_0 := gopurs_runtime.RecordGet(dictGenericTop_0_loop, "genericTop'")
...
var dictGenericTop_0 gopurs_runtime.Value = dictGenericTop_0_loop
_ = dictGenericTop_0
return gopurs_runtime.RecordDict1("genericTop'", gopurs_runtime.Constructor1("Inr", gopurs_runtime.RecordGet(dictGenericTop_0_loop, "genericTop'")))
}()
})
	})
...
func Get_genericTop() gopurs_runtime.Value {
	once_genericTop.Do(func() {
		genericTop = gopurs_runtime.Func2(Call_genericTop)
	})
	return genericTop
}
...
var dictBounded_0 gopurs_runtime.Value = dictBounded_0_loop
_ = dictBounded_0
return gopurs_runtime.RecordDict1("genericBottom'", gopurs_runtime.RecordGet(dictBounded_0_loop, "bottom"))
}()
})
	})
...
var dict_0 gopurs_runtime.Value = dict_0_loop
_ = dict_0
return gopurs_runtime.RecordGet(dict_0_loop, "genericBottom'")
}()
})
	})
...
return gopurs_runtime.RecordDict1("genericBottom'", gopurs_runtime.RecordGet(dictGenericBottom_0_loop, "genericBottom'"))
}()
})
	})
...
var dictGenericBottom_0 gopurs_runtime.Value = dictGenericBottom_0_loop
_ = dictGenericBottom_0
genericBottom_prime1_1_0 := gopurs_runtime.RecordGet(dictGenericBottom_0_loop, "genericBottom'")
...
var dictGenericBottom_0 gopurs_runtime.Value = dictGenericBottom_0_loop
_ = dictGenericBottom_0
return gopurs_runtime.RecordDict1("genericBottom'", gopurs_runtime.Constructor1("Inl", gopurs_runtime.RecordGet(dictGenericBottom_0_loop, "genericBottom'")))
}()
})
	})
...
func Get_genericBottom() gopurs_runtime.Value {
	once_genericBottom.Do(func() {
		genericBottom = gopurs_runtime.Func2(Call_genericBottom)
	})
...
_ = dictGenericTop_1
return gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictGeneric_0_loop, "to"), gopurs_runtime.RecordGet(dictGenericTop_1_loop, "genericTop'"))
}
...
return gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictGeneric_0_loop, "to"), gopurs_runtime.RecordGet(dictGenericBottom_1_loop, "genericBottom'"))
}
