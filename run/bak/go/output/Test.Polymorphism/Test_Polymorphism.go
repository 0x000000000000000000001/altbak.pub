...
func Get_mempty_() gopurs_runtime.Value {
	once_mempty_.Do(func() {
		cache_mempty_ = gopurs_runtime.Func(func(dict_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_mappend_() gopurs_runtime.Value {
	once_mappend_.Do(func() {
		cache_mappend_ = gopurs_runtime.Func(func(dict_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
var dict_0 gopurs_runtime.Value = dict_0_loop
_ = dict_0
...
func Get_polyLoop() gopurs_runtime.Value {
	once_polyLoop.Do(func() {
		cache_polyLoop = gopurs_runtime.Func(func(dictMonoidish_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
...
func Get_intMonoidish() gopurs_runtime.Value {
	once_intMonoidish.Do(func() {
		cache_intMonoidish = gopurs_runtime.RecordDict2("mempty_", "mappend_", gopurs_runtime.Int(1), gopurs_runtime.Func2(func(x_0 gopurs_runtime.Value, y_1 gopurs_runtime.Value) gopurs_runtime.Value {
