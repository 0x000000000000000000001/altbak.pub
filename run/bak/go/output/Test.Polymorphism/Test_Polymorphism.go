...
return Call_mempty_((*Record_mappend__gopurs_runtime_Value_mempty__gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
...
return Call_mappend_((*Record_mappend__gopurs_runtime_Value_mempty__gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
...
return Call_polyLoop((*Record_mappend__gopurs_runtime_Value_mempty__gopurs_runtime_Value)(dictMonoidish_0_box.UnsafePtr))
})
	})
...
func Call_mempty_(dict_0_loop *Record_mappend__gopurs_runtime_Value_mempty__gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_mappend__gopurs_runtime_Value_mempty__gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.mempty_
}

func Call_mappend_(dict_0_loop *Record_mappend__gopurs_runtime_Value_mempty__gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_mappend__gopurs_runtime_Value_mempty__gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.mappend_
}

func Call_polyLoop(dictMonoidish_0_loop *Record_mappend__gopurs_runtime_Value_mempty__gopurs_runtime_Value) gopurs_runtime.Value {
var dictMonoidish_0 *Record_mappend__gopurs_runtime_Value_mempty__gopurs_runtime_Value = dictMonoidish_0_loop
_ = dictMonoidish_0
...
v1_6_loop = gopurs_runtime.Apply2(dictMonoidish_0.mappend_, v1_6, mempty_1_1_0)
continue go__4_1
