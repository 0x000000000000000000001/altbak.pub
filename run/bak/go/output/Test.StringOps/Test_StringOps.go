...
func Get_runStringOps() gopurs_runtime.Value {
	once_runStringOps.Do(func() {
		cache_runStringOps = gopurs_runtime.Func(func(n_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
...
v2_4_loop = gopurs_runtime.Int((v2_4.IntVal) + (gopurs_runtime.Int(int64(gopurs_runtime.ArrayLength(gopurs_runtime.Apply2(pkg_Data_String_Common.Get_split(), gopurs_runtime.Str("e"), gopurs_runtime.Apply3(pkg_Data_String_Regex.Get_replace(), Get_regexPattern(), gopurs_runtime.Str("matched"), gopurs_runtime.Str(concatted_5_1)))))).IntVal))
continue loop_1_0
...
func Get_act() gopurs_runtime.Value {
	once_act.Do(func() {
		cache_act = gopurs_runtime.Apply(pkg_Effect_Console.Get_log(), gopurs_runtime.Apply(pkg_Data_Show.Get_showIntImpl(), gopurs_runtime.Apply(Get_runStringOps(), gopurs_runtime.Int(1000))))
	})
	return cache_act
}
