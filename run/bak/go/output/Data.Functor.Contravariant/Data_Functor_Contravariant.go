...
return Call_cmap((*Record_cmap_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
	return cache_cmap
}
...
return Call_cmapFlipped((*Record_cmap_gopurs_runtime_Value)(dictContravariant_0_box.UnsafePtr), x_1_box, f_2_box)
})
	})
...
return Call_coerce((*Record_cmap_gopurs_runtime_Value)(dictContravariant_0_box.UnsafePtr), (*Record_map__gopurs_runtime_Value)(dictFunctor_1_box.UnsafePtr), a_2_box)
})
	})
	return cache_coerce
}
...
return Call_imapC((*Record_cmap_gopurs_runtime_Value)(dictContravariant_0_box.UnsafePtr), v_1_box, f_2_box)
})
	})
	return cache_imapC
}
...
func Call_cmap(dict_0_loop *Record_cmap_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_cmap_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.cmap
}

func Call_cmapFlipped(dictContravariant_0_loop *Record_cmap_gopurs_runtime_Value, x_1_loop gopurs_runtime.Value, f_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = f_2
return gopurs_runtime.Apply2(dictContravariant_0.cmap, f_2, x_1)
}

func Call_coerce(dictContravariant_0_loop *Record_cmap_gopurs_runtime_Value, dictFunctor_1_loop *Record_map__gopurs_runtime_Value, a_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictContravariant_0 *Record_cmap_gopurs_runtime_Value = dictContravariant_0_loop
_ = dictContravariant_0
...
_ = a_2
return gopurs_runtime.Apply2(dictFunctor_1.map_, pkg_Data_Void.Get_absurd(), gopurs_runtime.Apply2(dictContravariant_0.cmap, pkg_Data_Void.Get_absurd(), a_2))
}

func Call_imapC(dictContravariant_0_loop *Record_cmap_gopurs_runtime_Value, v_1_loop gopurs_runtime.Value, f_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictContravariant_0 *Record_cmap_gopurs_runtime_Value = dictContravariant_0_loop
_ = dictContravariant_0
...
var f_2 gopurs_runtime.Value = f_2_loop
_ = f_2
return gopurs_runtime.Apply(dictContravariant_0.cmap, f_2)
}
