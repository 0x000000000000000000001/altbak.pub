...
var cache_applicativeDisj__4045440648 gopurs_runtime.Value
var once_applicativeDisj__4045440648 sync.Once
func Get_applicativeDisj__4045440648() gopurs_runtime.Value {
	once_applicativeDisj__4045440648.Do(func() {
		cache_applicativeDisj__4045440648 = gopurs_runtime.RecordDict2("Apply0", "pure", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return Get_applyDisj()
}), Get_Disj())
	})
	return cache_applicativeDisj__4045440648
}

var cache_applyDisj__3199351098 gopurs_runtime.Value
var once_applyDisj__3199351098 sync.Once
func Get_applyDisj__3199351098() gopurs_runtime.Value {
	once_applyDisj__3199351098.Do(func() {
		cache_applyDisj__3199351098 = gopurs_runtime.RecordDict2("Functor0", "apply", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return Get_functorDisj()
}), gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(v1_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(v_0, v1_1)
	...
	return cache_applyDisj__3199351098
}

var cache_bindDisj__329376103 gopurs_runtime.Value
var once_bindDisj__329376103 sync.Once
func Get_bindDisj__329376103() gopurs_runtime.Value {
	once_bindDisj__329376103.Do(func() {
		cache_bindDisj__329376103 = gopurs_runtime.RecordDict2("Apply0", "bind", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return Get_applyDisj()
}), gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(f_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(f_1, v_0)
	...
	return cache_bindDisj__329376103
}

var cache_eq1Disj__1905950174 gopurs_runtime.Value
var once_eq1Disj__1905950174 sync.Once
func Get_eq1Disj__1905950174() gopurs_runtime.Value {
	once_eq1Disj__1905950174.Do(func() {
		cache_eq1Disj__1905950174 = gopurs_runtime.RecordDict1("eq1", gopurs_runtime.Func(func(dictEq_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.RecordGet(dictEq_0, "eq")
}))
	})
	return cache_eq1Disj__1905950174
}
...
return gopurs_runtime.Str(gopurs_runtime.Apply2(Get_append__493084344(), gopurs_runtime.Str("(Disj "), gopurs_runtime.Str(gopurs_runtime.Apply2(Get_append__493084344(), gopurs_runtime.Str(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictShow_0, "show"), v_1).StrVal()), gopurs_runtime.Str(")")).StrVal())).StrVal())
}))
}
