...
return gopurs_runtime.Any(Call_showDisj(dictShow_0_box))
})
	})
...
return gopurs_runtime.Any(Call_semiringDisj(dictHeytingAlgebra_0_box))
})
	})
...
return gopurs_runtime.Any(Call_semigroupDisj(dictHeytingAlgebra_0_box))
})
	})
...
return gopurs_runtime.Any(Call_ordDisj(dictOrd_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monoidDisj(dictHeytingAlgebra_0_box))
})
	})
...
func Get_functorDisj() gopurs_runtime.Value {
	once_functorDisj.Do(func() {
		cache_functorDisj = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("map", gopurs_runtime.Func2(func(f_0 gopurs_runtime.Value, m_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Any(Call_eqDisj(dictEq_0_box))
})
	})
	return cache_eqDisj
}
...
func Get_eq1Disj() gopurs_runtime.Value {
	once_eq1Disj.Do(func() {
		cache_eq1Disj = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("eq1", gopurs_runtime.Func(func(dictEq_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_ord1Disj() gopurs_runtime.Value {
	once_ord1Disj.Do(func() {
		cache_ord1Disj = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Eq10", "compare1", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return Get_eq1Disj()
...
return gopurs_runtime.Any(Call_boundedDisj(dictBounded_0_box))
})
	})
...
func Get_applyDisj() gopurs_runtime.Value {
	once_applyDisj.Do(func() {
		cache_applyDisj = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Functor0", "apply", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_bindDisj() gopurs_runtime.Value {
	once_bindDisj.Do(func() {
		cache_bindDisj = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Apply0", "bind", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_applicativeDisj() gopurs_runtime.Value {
	once_applicativeDisj.Do(func() {
		cache_applicativeDisj = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Apply0", "pure", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return Get_applyDisj()
}), Get_Disj())))
	})
...
func Get_monadDisj() gopurs_runtime.Value {
	once_monadDisj.Do(func() {
		cache_monadDisj = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Applicative0", "Bind1", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_showDisj(dictShow_0_loop gopurs_runtime.Value) interface{} {
...
func Call_semiringDisj(dictHeytingAlgebra_0_loop gopurs_runtime.Value) interface{} {
var dictHeytingAlgebra_0 gopurs_runtime.Value = dictHeytingAlgebra_0_loop
_ = dictHeytingAlgebra_0
return gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict4("add", "mul", "one", "zero", gopurs_runtime.Func2(func(v_1 gopurs_runtime.Value, v1_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_semigroupDisj(dictHeytingAlgebra_0_loop gopurs_runtime.Value) interface{} {
var dictHeytingAlgebra_0 gopurs_runtime.Value = dictHeytingAlgebra_0_loop
_ = dictHeytingAlgebra_0
...
func Call_ordDisj(dictOrd_0_loop gopurs_runtime.Value) interface{} {
var dictOrd_0 gopurs_runtime.Value = dictOrd_0_loop
_ = dictOrd_0
return gopurs_runtime.UnboxAny(dictOrd_0)
}

func Call_monoidDisj(dictHeytingAlgebra_0_loop gopurs_runtime.Value) interface{} {
var dictHeytingAlgebra_0 gopurs_runtime.Value = dictHeytingAlgebra_0_loop
_ = dictHeytingAlgebra_0
...
func Call_eqDisj(dictEq_0_loop gopurs_runtime.Value) interface{} {
var dictEq_0 gopurs_runtime.Value = dictEq_0_loop
_ = dictEq_0
return gopurs_runtime.UnboxAny(dictEq_0)
}

func Call_boundedDisj(dictBounded_0_loop gopurs_runtime.Value) interface{} {
