...
func Get_unright() gopurs_runtime.Value {
	once_unright.Do(func() {
		unright = gopurs_runtime.Func(func(dict_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_unleft() gopurs_runtime.Value {
	once_unleft.Do(func() {
		unleft = gopurs_runtime.Func(func(dict_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
var dict_0 gopurs_runtime.Value = dict_0_loop
_ = dict_0
