...
\PhpursThunks::$thunks['Data_Bounded_boundedUnit'] = function() { $v = ["top" => ($GLOBALS['Data_Unit_unit'] ?? \PhpursThunks::eval('Data_Unit_unit')), "bottom" => ($GLOBALS['Data_Unit_unit'] ?? \PhpursThunks::eval('Data_Unit_unit')), "Ord0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_Bounded_boundedRecordNil'] = function() { $v = ["topRecord" => (function() {
...
\PhpursThunks::$thunks['Data_Bounded_boundedProxy'] = function() { $v = ["bottom" => new Phpurs_Data0("Proxy"), "top" => new Phpurs_Data0("Proxy"), "Ord0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_Bounded_boundedOrdering'] = function() { $v = ["top" => new Phpurs_Data0("GT"), "bottom" => new Phpurs_Data0("LT"), "Ord0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_Bounded_boundedNumber'] = function() { $v = ["top" => ($GLOBALS['Data_Bounded_topNumber'] ?? \PhpursThunks::eval('Data_Bounded_topNumber')), "bottom" => ($GLOBALS['Data_Bounded_bottomNumber'] ?? \PhpursThunks::eval('Data_Bounded_bottomNumber')), "Ord0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_Bounded_boundedInt'] = function() { $v = ["top" => ($GLOBALS['Data_Bounded_topInt'] ?? \PhpursThunks::eval('Data_Bounded_topInt')), "bottom" => ($GLOBALS['Data_Bounded_bottomInt'] ?? \PhpursThunks::eval('Data_Bounded_bottomInt')), "Ord0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_Bounded_boundedChar'] = function() { $v = ["top" => ($GLOBALS['Data_Bounded_topChar'] ?? \PhpursThunks::eval('Data_Bounded_topChar')), "bottom" => ($GLOBALS['Data_Bounded_bottomChar'] ?? \PhpursThunks::eval('Data_Bounded_bottomChar')), "Ord0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_Bounded_boundedBoolean'] = function() { $v = ["top" => true, "bottom" => false, "Ord0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
