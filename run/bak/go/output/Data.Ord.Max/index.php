...
\PhpursThunks::$thunks['Data_Ord_Max_newtypeMax'] = function() { $v = ["Coercible0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
...
goto end_branch_2;;
  ...
  $__res = ["mempty" => ($dictBounded_0)['bottom'], "Semigroup0" => function($dollar__unused_3 = null) use ($semigroupMax1_2_1) {
  $__num = \func_num_args();
