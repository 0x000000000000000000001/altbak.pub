...
return gopurs_runtime.Any(Call_showMax(dictShow_0_box))
})
	})
...
return gopurs_runtime.Any(Call_semigroupMax(dictOrd_0_box))
})
	})
...
func Get_newtypeMax() gopurs_runtime.Value {
	once_newtypeMax.Do(func() {
		cache_newtypeMax = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("Coercible0", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Any(Call_monoidMax(dictBounded_0_box))
})
	})
...
return gopurs_runtime.Any(Call_eqMax(dictEq_0_box))
})
	})
	return cache_eqMax
}
...
return gopurs_runtime.Any(Call_ordMax(dictOrd_0_box))
})
	})
	return cache_ordMax
}
...
func Call_showMax(dictShow_0_loop gopurs_runtime.Value) interface{} {
...
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str("(Max "), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictShow_0, "show"), v_1), gopurs_runtime.Str(")")))
})))
}

func Call_semigroupMax(dictOrd_0_loop gopurs_runtime.Value) interface{} {
...
func Call_monoidMax(dictBounded_0_loop gopurs_runtime.Value) interface{} {
...
func Call_eqMax(dictEq_0_loop gopurs_runtime.Value) interface{} {
var dictEq_0 gopurs_runtime.Value = dictEq_0_loop
_ = dictEq_0
return gopurs_runtime.UnboxAny(dictEq_0)
}

func Call_ordMax(dictOrd_0_loop gopurs_runtime.Value) interface{} {
var dictOrd_0 gopurs_runtime.Value = dictOrd_0_loop
_ = dictOrd_0
