...
return Call_showMax((*Record_show_gopurs_runtime_Value)(dictShow_0_box.UnsafePtr))
})
	})
...
return Call_semigroupMax((*Record_compare_gopurs_runtime_Value)(dictOrd_0_box.UnsafePtr))
})
	})
...
return Call_monoidMax((*Record_bottom_gopurs_runtime_Value_top_gopurs_runtime_Value)(dictBounded_0_box.UnsafePtr))
})
	})
...
return gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(Call_eqMax((*Record_eq_gopurs_runtime_Value)(dictEq_0_box.UnsafePtr)))}
})
	})
	return cache_eqMax
}
...
return Call_ordMax((*Record_compare_gopurs_runtime_Value)(dictOrd_0_box.UnsafePtr))
})
	})
	return cache_ordMax
}
...
func Call_showMax(dictShow_0_loop *Record_show_gopurs_runtime_Value) gopurs_runtime.Value {
var dictShow_0 *Record_show_gopurs_runtime_Value = dictShow_0_loop
_ = dictShow_0
return gopurs_runtime.RecordDict1("show", gopurs_runtime.Func(func(v_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str("(Max "), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Apply(dictShow_0.show, v_1), gopurs_runtime.Str(")")))
}))
}

func Call_semigroupMax(dictOrd_0_loop *Record_compare_gopurs_runtime_Value) gopurs_runtime.Value {
...
v_3_0 := gopurs_runtime.Apply2(dictOrd_0.compare, v_1, v1_2)
_ = v_3_0
...
func Call_monoidMax(dictBounded_0_loop *Record_bottom_gopurs_runtime_Value_top_gopurs_runtime_Value) gopurs_runtime.Value {
...
}), dictBounded_0.bottom)
}

func Call_eqMax(dictEq_0_loop *Record_eq_gopurs_runtime_Value) *Record_eq_gopurs_runtime_Value {
var dictEq_0 *Record_eq_gopurs_runtime_Value = dictEq_0_loop
_ = dictEq_0
return dictEq_0
}

func Call_ordMax(dictOrd_0_loop *Record_compare_gopurs_runtime_Value) gopurs_runtime.Value {
var dictOrd_0 *Record_compare_gopurs_runtime_Value = dictOrd_0_loop
_ = dictOrd_0
...
return gopurs_runtime.Apply2(dictOrd_0.compare, v_2, v1_3)
}))
}
