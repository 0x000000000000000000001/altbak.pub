...
return gopurs_runtime.Str(gopurs_runtime.Str(gopurs_runtime.Str("(Max ").StrVal + gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictShow_0, "show"), v_1).StrVal).StrVal + gopurs_runtime.Str(")").StrVal)
}))
})
	})
	return showMax
...
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(v_4_2, "_tag").StrVal == "LT")).IntVal != 0 {
__t3 = v1_3
goto end_branch_3
} else {
...
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(v_4_2, "_tag").StrVal == "EQ")).IntVal != 0 {
__t3 = v_2
goto end_branch_3
} else {
...
{
if (gopurs_runtime.Bool(gopurs_runtime.RecordGet(v_4_2, "_tag").StrVal == "GT")).IntVal != 0 {
__t3 = v_2
goto end_branch_3
} else {
