...
return Call_semigroupOp((*Record_append__gopurs_runtime_Value)(dictSemigroup_0_box.UnsafePtr))
})
	})
...
return Call_monoidOp((*Record_mempty_gopurs_runtime_Value)(dictMonoid_0_box.UnsafePtr))
})
	})
...
func Call_semigroupOp(dictSemigroup_0_loop *Record_append__gopurs_runtime_Value) gopurs_runtime.Value {
...
func Call_monoidOp(dictMonoid_0_loop *Record_mempty_gopurs_runtime_Value) gopurs_runtime.Value {
