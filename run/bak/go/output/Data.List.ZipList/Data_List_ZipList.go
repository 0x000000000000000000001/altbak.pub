...
func Get_traversableZipList() gopurs_runtime.Value {
	once_traversableZipList.Do(func() {
		cache_traversableZipList = gopurs_runtime.Any(gopurs_runtime.UnboxAny(pkg_Data_List_Lazy_Types.Get_traversableList()))
	})
...
return gopurs_runtime.Any(Call_showZipList(dictShow_0_box))
})
	})
...
func Get_semigroupZipList() gopurs_runtime.Value {
	once_semigroupZipList.Do(func() {
		cache_semigroupZipList = gopurs_runtime.Any(gopurs_runtime.UnboxAny(pkg_Data_List_Lazy_Types.Get_semigroupList()))
	})
...
return gopurs_runtime.Any(Call_ordZipList(dictOrd_0_box))
})
	})
...
func Get_newtypeZipList() gopurs_runtime.Value {
	once_newtypeZipList.Do(func() {
		cache_newtypeZipList = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("Coercible0", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_monoidZipList() gopurs_runtime.Value {
	once_monoidZipList.Do(func() {
		cache_monoidZipList = gopurs_runtime.Any(gopurs_runtime.UnboxAny(pkg_Data_List_Lazy_Types.Get_monoidList()))
	})
...
func Get_functorZipList() gopurs_runtime.Value {
	once_functorZipList.Do(func() {
		cache_functorZipList = gopurs_runtime.Any(gopurs_runtime.UnboxAny(pkg_Data_List_Lazy_Types.Get_functorList()))
	})
...
func Get_foldableZipList() gopurs_runtime.Value {
	once_foldableZipList.Do(func() {
		cache_foldableZipList = gopurs_runtime.Any(gopurs_runtime.UnboxAny(pkg_Data_List_Lazy_Types.Get_foldableList()))
	})
...
return gopurs_runtime.Any(Call_eqZipList(dictEq_0_box))
})
	})
...
func Get_applyZipList() gopurs_runtime.Value {
	once_applyZipList.Do(func() {
		cache_applyZipList = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Functor0", "apply", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Any(Call_zipListIsNotBind(_dollar__unused_0_box))
})
	})
...
func Get_applicativeZipList() gopurs_runtime.Value {
	once_applicativeZipList.Do(func() {
		cache_applicativeZipList = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Apply0", "pure", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 218341868, UnsafePtr: unsafe.Pointer(&pkg_Data_List_Lazy_Types.Constructor_Cons[gopurs_runtime.Value]{gopurs_runtime.UnboxAny(x_0), func(inner_arg0 gopurs_runtime.Value) *pkg_Data_List_Lazy_Types.Constructor_Cons[interface{}] {
...
func Get_altZipList() gopurs_runtime.Value {
	once_altZipList.Do(func() {
		cache_altZipList = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Functor0", "alt", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return pkg_Data_List_Lazy_Types.Get_functorList()
}), gopurs_runtime.Func2(func(v_0 gopurs_runtime.Value, v1_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_plusZipList() gopurs_runtime.Value {
	once_plusZipList.Do(func() {
		cache_plusZipList = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Alt0", "empty", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_alternativeZipList() gopurs_runtime.Value {
	once_alternativeZipList.Do(func() {
		cache_alternativeZipList = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Applicative0", "Plus1", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_showZipList(dictShow_0_loop gopurs_runtime.Value) interface{} {
...
func Call_ordZipList(dictOrd_0_loop gopurs_runtime.Value) interface{} {
var dictOrd_0 gopurs_runtime.Value = dictOrd_0_loop
_ = dictOrd_0
return gopurs_runtime.UnboxAny(gopurs_runtime.Apply(pkg_Data_List_Lazy_Types.Get_ordList(), dictOrd_0))
}

func Call_eqZipList(dictEq_0_loop gopurs_runtime.Value) interface{} {
var dictEq_0 gopurs_runtime.Value = dictEq_0_loop
_ = dictEq_0
return gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("eq", gopurs_runtime.Apply(gopurs_runtime.RecordGet(pkg_Data_List_Lazy_Types.Get_eq1List(), "eq1"), dictEq_0)))
}

func Call_zipListIsNotBind(_dollar__unused_0_loop gopurs_runtime.Value) interface{} {
