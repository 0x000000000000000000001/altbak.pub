...
return Call_identity((*Record_identity_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
...
func Call_identity(dict_0_loop *Record_identity_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_identity_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.identity
}
