...
return gopurs_runtime.Str(gopurs_runtime.Apply2(Get_append__493084344(), gopurs_runtime.Str("First ("), gopurs_runtime.Apply2(Get_append__493084344(), gopurs_runtime.Apply(showMaybe_1_0.V0, v_2), gopurs_runtime.Str(")"))).StrVal())
}))
}
