...
return Get_altFirst()
}), gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]](gopurs_runtime.RecordGet(Get_monoidFirst(), "mempty")))})
	})
...
var cache_altFirst__4201091523 gopurs_runtime.Value
var once_altFirst__4201091523 sync.Once
func Get_altFirst__4201091523() gopurs_runtime.Value {
	once_altFirst__4201091523.Do(func() {
		cache_altFirst__4201091523 = gopurs_runtime.RecordDict2("Functor0", "alt", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return pkg_Data_Maybe.Get_functorMaybe()
}), gopurs_runtime.RecordGet(Get_semigroupFirst(), "append"))
	})
	return cache_altFirst__4201091523
}

var cache_applicativeFirst__500933224 gopurs_runtime.Value
var once_applicativeFirst__500933224 sync.Once
func Get_applicativeFirst__500933224() gopurs_runtime.Value {
	once_applicativeFirst__500933224.Do(func() {
		cache_applicativeFirst__500933224 = pkg_Data_Maybe.Get_applicativeMaybe()
	})
	return cache_applicativeFirst__500933224
}
...
var cache_plusFirst__400696082 gopurs_runtime.Value
var once_plusFirst__400696082 sync.Once
func Get_plusFirst__400696082() gopurs_runtime.Value {
	once_plusFirst__400696082.Do(func() {
		cache_plusFirst__400696082 = gopurs_runtime.RecordDict2("Alt0", "empty", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return Get_altFirst()
}), gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]](gopurs_runtime.RecordGet(Get_monoidFirst(), "mempty")))})
	})
	return cache_plusFirst__400696082
}
