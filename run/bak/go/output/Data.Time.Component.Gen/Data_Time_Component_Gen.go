...
return gopurs_runtime.Apply(gopurs_runtime.Apply(pkg_Data_Enum_Gen.Get_genBoundedEnum(), dictMonadGen_0), pkg_Data_Time_Component.Get_boundedEnumSecond())
})
	})
	return genSecond
}
...
return gopurs_runtime.Apply(gopurs_runtime.Apply(pkg_Data_Enum_Gen.Get_genBoundedEnum(), dictMonadGen_0), pkg_Data_Time_Component.Get_boundedEnumMinute())
})
	})
	return genMinute
}
...
return gopurs_runtime.Apply(gopurs_runtime.Apply(pkg_Data_Enum_Gen.Get_genBoundedEnum(), dictMonadGen_0), pkg_Data_Time_Component.Get_boundedEnumMillisecond())
})
	})
...
return gopurs_runtime.Apply(gopurs_runtime.Apply(pkg_Data_Enum_Gen.Get_genBoundedEnum(), dictMonadGen_0), pkg_Data_Time_Component.Get_boundedEnumHour())
})
	})
	return genHour
}
