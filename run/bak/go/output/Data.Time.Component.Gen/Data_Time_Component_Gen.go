...
return Call_genSecond(dictMonadGen_0_box)
})
	})
...
return Call_genMinute(dictMonadGen_0_box)
})
	})
...
return Call_genMillisecond(dictMonadGen_0_box)
})
	})
...
return Call_genHour(dictMonadGen_0_box)
})
	})
	return cache_genHour
}

func Call_genSecond(dictMonadGen_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_genMinute(dictMonadGen_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictMonadGen_0 gopurs_runtime.Value = dictMonadGen_0_loop
_ = dictMonadGen_0
...
func Call_genMillisecond(dictMonadGen_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictMonadGen_0 gopurs_runtime.Value = dictMonadGen_0_loop
_ = dictMonadGen_0
...
func Call_genHour(dictMonadGen_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictMonadGen_0 gopurs_runtime.Value = dictMonadGen_0_loop
_ = dictMonadGen_0
