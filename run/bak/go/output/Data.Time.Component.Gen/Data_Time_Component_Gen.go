...
func Get_genSecond() gopurs_runtime.Value {
	once_genSecond.Do(func() {
		cache_genSecond = gopurs_runtime.Func(func(dictMonadGen_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_genMinute() gopurs_runtime.Value {
	once_genMinute.Do(func() {
		cache_genMinute = gopurs_runtime.Func(func(dictMonadGen_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
var dictMonadGen_0 gopurs_runtime.Value = dictMonadGen_0_loop
_ = dictMonadGen_0
...
func Get_genMillisecond() gopurs_runtime.Value {
	once_genMillisecond.Do(func() {
		cache_genMillisecond = gopurs_runtime.Func(func(dictMonadGen_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
var dictMonadGen_0 gopurs_runtime.Value = dictMonadGen_0_loop
_ = dictMonadGen_0
...
func Get_genHour() gopurs_runtime.Value {
	once_genHour.Do(func() {
		cache_genHour = gopurs_runtime.Func(func(dictMonadGen_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
var dictMonadGen_0 gopurs_runtime.Value = dictMonadGen_0_loop
_ = dictMonadGen_0
