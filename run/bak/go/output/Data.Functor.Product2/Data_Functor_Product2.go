...
return gopurs_runtime.Value{Type: 9, IntVal: 3559137202, UnsafePtr: unsafe.Pointer(&Constructor_Product2{value0, value1})}
})
})
	})
...
type Constructor_Product2 struct {
...
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str("(Product2 "), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Apply(((*gopurs_runtime.RecordData1)(dictShow_0.UnsafePtr)).V0, (*Constructor_Product2)(v_2.UnsafePtr).V0), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str(" "), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Apply(((*gopurs_runtime.RecordData1)(dictShow1_1.UnsafePtr)).V0, (*Constructor_Product2)(v_2.UnsafePtr).V1), gopurs_runtime.Str(")")))))
}))
}
...
return gopurs_runtime.Value{Type: 9, IntVal: 3559137202, UnsafePtr: unsafe.Pointer(&Constructor_Product2{gopurs_runtime.Apply3(((*gopurs_runtime.RecordData1)(dictProfunctor_0.UnsafePtr)).V0, f_2, g_3, (*Constructor_Product2)(v_4.UnsafePtr).V0), gopurs_runtime.Apply3(((*gopurs_runtime.RecordData1)(dictProfunctor1_1.UnsafePtr)).V0, f_2, g_3, (*Constructor_Product2)(v_4.UnsafePtr).V1)})}
}))
}
...
return gopurs_runtime.Value{Type: 9, IntVal: 3559137202, UnsafePtr: unsafe.Pointer(&Constructor_Product2{gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictFunctor_0.UnsafePtr)).V0, f_2, (*Constructor_Product2)(v_3.UnsafePtr).V0), gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictFunctor1_1.UnsafePtr)).V0, f_2, (*Constructor_Product2)(v_3.UnsafePtr).V1)})}
}))
}
...
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_HeytingAlgebra.Get_heytingAlgebraBoolean(), "conj"), gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictEq_0.UnsafePtr)).V0, (*Constructor_Product2)(x_2.UnsafePtr).V0, (*Constructor_Product2)(y_3.UnsafePtr).V0), gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictEq1_1.UnsafePtr)).V0, (*Constructor_Product2)(x_2.UnsafePtr).V1, (*Constructor_Product2)(y_3.UnsafePtr).V1))
}))
}
...
v_6_2 := gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictOrd_0.UnsafePtr)).V0, (*Constructor_Product2)(x_4.UnsafePtr).V0, (*Constructor_Product2)(y_5.UnsafePtr).V0)
_ = v_6_2
...
{
__t3 = gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictOrd1_2, "compare"), (*Constructor_Product2)(x_4.UnsafePtr).V1, (*Constructor_Product2)(y_5.UnsafePtr).V1)
}
end_branch_3:
return __t3
}))
...
return gopurs_runtime.Value{Type: 9, IntVal: 3559137202, UnsafePtr: unsafe.Pointer(&Constructor_Product2{gopurs_runtime.Apply3(((*gopurs_runtime.RecordData1)(dictBifunctor_0.UnsafePtr)).V0, f_2, g_3, (*Constructor_Product2)(v_4.UnsafePtr).V0), gopurs_runtime.Apply3(((*gopurs_runtime.RecordData1)(dictBifunctor1_1.UnsafePtr)).V0, f_2, g_3, (*Constructor_Product2)(v_4.UnsafePtr).V1)})}
}))
}
...
return gopurs_runtime.Value{Type: 9, IntVal: 3559137202, UnsafePtr: unsafe.Pointer(&Constructor_Product2{gopurs_runtime.Apply3(gopurs_runtime.RecordGet(__local_var_1_0, "bimap"), f_4, g_5, (*Constructor_Product2)(v_6.UnsafePtr).V0), gopurs_runtime.Apply3(gopurs_runtime.RecordGet(__local_var_3_1, "bimap"), f_4, g_5, (*Constructor_Product2)(v_6.UnsafePtr).V1)})}
}))
...
return gopurs_runtime.Value{Type: 9, IntVal: 3559137202, UnsafePtr: unsafe.Pointer(&Constructor_Product2{gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictBiapply_0.UnsafePtr)).V0, (*Constructor_Product2)(v_5.UnsafePtr).V0, (*Constructor_Product2)(v1_6.UnsafePtr).V0), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictBiapply1_2, "biapply"), (*Constructor_Product2)(v_5.UnsafePtr).V1, (*Constructor_Product2)(v1_6.UnsafePtr).V1)})}
}))
})
}
...
return gopurs_runtime.Value{Type: 9, IntVal: 3559137202, UnsafePtr: unsafe.Pointer(&Constructor_Product2{gopurs_runtime.Apply3(gopurs_runtime.RecordGet(__local_var_2_1, "bimap"), f_6, g_7, (*Constructor_Product2)(v_8.UnsafePtr).V0), gopurs_runtime.Apply3(gopurs_runtime.RecordGet(__local_var_5_3, "bimap"), f_6, g_7, (*Constructor_Product2)(v_8.UnsafePtr).V1)})}
}))
...
return gopurs_runtime.Value{Type: 9, IntVal: 3559137202, UnsafePtr: unsafe.Pointer(&Constructor_Product2{gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_1_0, "biapply"), (*Constructor_Product2)(v_7.UnsafePtr).V0, (*Constructor_Product2)(v1_8.UnsafePtr).V0), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_4_2, "biapply"), (*Constructor_Product2)(v_7.UnsafePtr).V1, (*Constructor_Product2)(v1_8.UnsafePtr).V1)})}
}))
...
return gopurs_runtime.Value{Type: 9, IntVal: 3559137202, UnsafePtr: unsafe.Pointer(&Constructor_Product2{gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictBiapplicative_0.UnsafePtr)).V0, a_7, b_8), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictBiapplicative1_3, "bipure"), a_7, b_8)})}
}))
})
}
