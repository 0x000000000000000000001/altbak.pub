...
return gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Product2"), value0, value1)
})
})
	})
	return Product2
...
return gopurs_runtime.Str(gopurs_runtime.Str(gopurs_runtime.Str(gopurs_runtime.Str(gopurs_runtime.Str("(Product2 ").StrVal + gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictShow_0, "show"), gopurs_runtime.RecordGet(v_2, "value0")).StrVal).StrVal + gopurs_runtime.Str(" ").StrVal).StrVal + gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictShow1_1, "show"), gopurs_runtime.RecordGet(v_2, "value1")).StrVal).StrVal + gopurs_runtime.Str(")").StrVal)
}))
})
	})
	return showProduct2
...
return gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Product2"), gopurs_runtime.Apply3(gopurs_runtime.RecordGet(dictProfunctor_0, "dimap"), f_2, g_3, gopurs_runtime.RecordGet(v_4, "value0")), gopurs_runtime.Apply3(gopurs_runtime.RecordGet(dictProfunctor1_1, "dimap"), f_2, g_3, gopurs_runtime.RecordGet(v_4, "value1")))
}))
})
	})
...
return gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Product2"), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictFunctor_0, "map"), f_2, gopurs_runtime.RecordGet(v_3, "value0")), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictFunctor1_1, "map"), f_2, gopurs_runtime.RecordGet(v_3, "value1")))
}))
})
	})
...
return gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Product2"), gopurs_runtime.Apply3(gopurs_runtime.RecordGet(dictBifunctor_0, "bimap"), f_2, g_3, gopurs_runtime.RecordGet(v_4, "value0")), gopurs_runtime.Apply3(gopurs_runtime.RecordGet(dictBifunctor1_1, "bimap"), f_2, g_3, gopurs_runtime.RecordGet(v_4, "value1")))
}))
})
	})
...
return gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Product2"), gopurs_runtime.Apply3(gopurs_runtime.RecordGet(__local_var_1_0, "bimap"), f_4, g_5, gopurs_runtime.RecordGet(v_6, "value0")), gopurs_runtime.Apply3(gopurs_runtime.RecordGet(__local_var_3_1, "bimap"), f_4, g_5, gopurs_runtime.RecordGet(v_6, "value1")))
}))
...
return gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Product2"), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictBiapply_0, "biapply"), gopurs_runtime.RecordGet(v_5, "value0"), gopurs_runtime.RecordGet(v1_6, "value0")), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictBiapply1_2, "biapply"), gopurs_runtime.RecordGet(v_5, "value1"), gopurs_runtime.RecordGet(v1_6, "value1")))
}), gopurs_runtime.Func(func(_dollar__unused_5 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Product2"), gopurs_runtime.Apply3(gopurs_runtime.RecordGet(__local_var_2_1, "bimap"), f_6, g_7, gopurs_runtime.RecordGet(v_8, "value0")), gopurs_runtime.Apply3(gopurs_runtime.RecordGet(__local_var_5_3, "bimap"), f_6, g_7, gopurs_runtime.RecordGet(v_8, "value1")))
}))
...
return gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Product2"), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_1_0, "biapply"), gopurs_runtime.RecordGet(v_7, "value0"), gopurs_runtime.RecordGet(v1_8, "value0")), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_4_2, "biapply"), gopurs_runtime.RecordGet(v_7, "value1"), gopurs_runtime.RecordGet(v1_8, "value1")))
...
return gopurs_runtime.RecordDict3("_tag", "value0", "value1", gopurs_runtime.Str("Product2"), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictBiapplicative_0, "bipure"), a_7, b_8), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictBiapplicative1_3, "bipure"), a_7, b_8))
}), gopurs_runtime.Func(func(_dollar__unused_7 gopurs_runtime.Value) gopurs_runtime.Value {
