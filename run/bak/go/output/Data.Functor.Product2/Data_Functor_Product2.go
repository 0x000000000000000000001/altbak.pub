...
return gopurs_runtime.Value{Type: 9, IntVal: 3559137202, UnsafePtr: unsafe.Pointer(&Data_Data_Functor_Product2_Product2{gopurs_runtime.Apply3(((*gopurs_runtime.RecordData1)(dictProfunctor_0.UnsafePtr)).V0, f_2, g_3, (*Data_Data_Functor_Product2_Product2)(v_4.UnsafePtr).V0), gopurs_runtime.Apply3(((*gopurs_runtime.RecordData1)(dictProfunctor1_1.UnsafePtr)).V0, f_2, g_3, (*Data_Data_Functor_Product2_Product2)(v_4.UnsafePtr).V1)})}
}))
}
...
return gopurs_runtime.Value{Type: 9, IntVal: 3559137202, UnsafePtr: unsafe.Pointer(&Data_Data_Functor_Product2_Product2{gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictFunctor_0.UnsafePtr)).V0, f_2, (*Data_Data_Functor_Product2_Product2)(v_3.UnsafePtr).V0), gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictFunctor1_1.UnsafePtr)).V0, f_2, (*Data_Data_Functor_Product2_Product2)(v_3.UnsafePtr).V1)})}
}))
}
...
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_HeytingAlgebra.Get_heytingAlgebraBoolean(), "conj"), gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictEq_0.UnsafePtr)).V0, (*Data_Data_Functor_Product2_Product2)(x_2.UnsafePtr).V0, (*Data_Data_Functor_Product2_Product2)(y_3.UnsafePtr).V0), gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictEq1_1.UnsafePtr)).V0, (*Data_Data_Functor_Product2_Product2)(x_2.UnsafePtr).V1, (*Data_Data_Functor_Product2_Product2)(y_3.UnsafePtr).V1))
}))
}
...
v_6_2 := gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictOrd_0.UnsafePtr)).V0, (*Data_Data_Functor_Product2_Product2)(x_4.UnsafePtr).V0, (*Data_Data_Functor_Product2_Product2)(y_5.UnsafePtr).V0)
_ = v_6_2
...
return gopurs_runtime.Value{Type: 9, IntVal: 3559137202, UnsafePtr: unsafe.Pointer(&Data_Data_Functor_Product2_Product2{gopurs_runtime.Apply3(((*gopurs_runtime.RecordData1)(dictBifunctor_0.UnsafePtr)).V0, f_2, g_3, (*Data_Data_Functor_Product2_Product2)(v_4.UnsafePtr).V0), gopurs_runtime.Apply3(((*gopurs_runtime.RecordData1)(dictBifunctor1_1.UnsafePtr)).V0, f_2, g_3, (*Data_Data_Functor_Product2_Product2)(v_4.UnsafePtr).V1)})}
}))
}
...
return gopurs_runtime.Value{Type: 9, IntVal: 3559137202, UnsafePtr: unsafe.Pointer(&Data_Data_Functor_Product2_Product2{gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictBiapply_0.UnsafePtr)).V0, (*Data_Data_Functor_Product2_Product2)(v_5.UnsafePtr).V0, (*Data_Data_Functor_Product2_Product2)(v1_6.UnsafePtr).V0), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictBiapply1_2, "biapply"), (*Data_Data_Functor_Product2_Product2)(v_5.UnsafePtr).V1, (*Data_Data_Functor_Product2_Product2)(v1_6.UnsafePtr).V1)})}
}))
})
}
...
return gopurs_runtime.Value{Type: 9, IntVal: 3559137202, UnsafePtr: unsafe.Pointer(&Data_Data_Functor_Product2_Product2{gopurs_runtime.Apply2(((*gopurs_runtime.RecordData1)(dictBiapplicative_0.UnsafePtr)).V0, a_7, b_8), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictBiapplicative1_3, "bipure"), a_7, b_8)})}
}))
})
}
