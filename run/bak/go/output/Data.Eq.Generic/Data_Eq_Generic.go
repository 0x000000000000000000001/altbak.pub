...
func Get_genericEqNoConstructors() gopurs_runtime.Value {
	once_genericEqNoConstructors.Do(func() {
		cache_genericEqNoConstructors = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("genericEq'", gopurs_runtime.Func2(func(v_0 gopurs_runtime.Value, v1_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_genericEqNoArguments() gopurs_runtime.Value {
	once_genericEqNoArguments.Do(func() {
		cache_genericEqNoArguments = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("genericEq'", gopurs_runtime.Func2(func(v_0 gopurs_runtime.Value, v1_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Bool(true)
}))))
	})
...
return gopurs_runtime.Any(Call_genericEqArgument(dictEq_0_box))
})
	})
...
var cache_genericEq_prime__func_gopurs_runtime_Value__interface____interface____bool_595886037 gopurs_runtime.Value
var once_genericEq_prime__func_gopurs_runtime_Value__interface____interface____bool_595886037 sync.Once
func Get_genericEq_prime__func_gopurs_runtime_Value__interface____interface____bool_595886037() gopurs_runtime.Value {
	once_genericEq_prime__func_gopurs_runtime_Value__interface____interface____bool_595886037.Do(func() {
		cache_genericEq_prime__func_gopurs_runtime_Value__interface____interface____bool_595886037 = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_genericEq_prime__func_gopurs_runtime_Value__interface____interface____bool_595886037(dict_0_box)
})
	})
	return cache_genericEq_prime__func_gopurs_runtime_Value__interface____interface____bool_595886037
}
...
return gopurs_runtime.Any(Call_genericEqConstructor(dictGenericEq_0_box))
})
	})
...
return gopurs_runtime.Any(Call_genericEqProduct(dictGenericEq_0_box, dictGenericEq1_1_box))
})
	})
...
return gopurs_runtime.Any(Call_genericEqSum(dictGenericEq_0_box, dictGenericEq1_1_box))
})
	})
...
return gopurs_runtime.Bool(Call_genericEq(dictGeneric_0_box, dictGenericEq_1_box, gopurs_runtime.UnboxAny(x_2_box), gopurs_runtime.UnboxAny(y_3_box)))
})
	})
	return cache_genericEq
}

func Call_genericEqArgument(dictEq_0_loop gopurs_runtime.Value) interface{} {
var dictEq_0 gopurs_runtime.Value = dictEq_0_loop
_ = dictEq_0
return gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("genericEq'", gopurs_runtime.Func2(func(v_1 gopurs_runtime.Value, v1_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_genericEq_prime__func_gopurs_runtime_Value__interface____interface____bool_595886037(dict_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dict_0 gopurs_runtime.Value = dict_0_loop
_ = dict_0
return gopurs_runtime.RecordGet(dict_0, "genericEq'")
}

func Call_genericEqConstructor(dictGenericEq_0_loop gopurs_runtime.Value) interface{} {
...
func Call_genericEqProduct(dictGenericEq_0_loop gopurs_runtime.Value, dictGenericEq1_1_loop gopurs_runtime.Value) interface{} {
var dictGenericEq_0 gopurs_runtime.Value = dictGenericEq_0_loop
_ = dictGenericEq_0
var dictGenericEq1_1 gopurs_runtime.Value = dictGenericEq1_1_loop
_ = dictGenericEq1_1
return gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("genericEq'", gopurs_runtime.Func2(func(v_2 gopurs_runtime.Value, v1_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_HeytingAlgebra.Get_heytingAlgebraBoolean(), "conj"), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictGenericEq_0, "genericEq'"), gopurs_runtime.Any((*pkg_Data_Generic_Rep.Constructor_Product[gopurs_runtime.Value, gopurs_runtime.Value])(v_2.UnsafePtr).V0), gopurs_runtime.Any((*pkg_Data_Generic_Rep.Constructor_Product[gopurs_runtime.Value, gopurs_runtime.Value])(v1_3.UnsafePtr).V0)), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictGenericEq1_1, "genericEq'"), gopurs_runtime.Any((*pkg_Data_Generic_Rep.Constructor_Product[gopurs_runtime.Value, gopurs_runtime.Value])(v_2.UnsafePtr).V1), gopurs_runtime.Any((*pkg_Data_Generic_Rep.Constructor_Product[gopurs_runtime.Value, gopurs_runtime.Value])(v1_3.UnsafePtr).V1)))
})))
}

func Call_genericEqSum(dictGenericEq_0_loop gopurs_runtime.Value, dictGenericEq1_1_loop gopurs_runtime.Value) interface{} {
var dictGenericEq_0 gopurs_runtime.Value = dictGenericEq_0_loop
_ = dictGenericEq_0
var dictGenericEq1_1 gopurs_runtime.Value = dictGenericEq1_1_loop
_ = dictGenericEq1_1
...
{
__t0 = gopurs_runtime.Bool(((v_2.Type == 9 && v_2.IntVal == 492034566)) && (((v1_3.Type == 9 && v1_3.IntVal == 492034566)) && ((gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictGenericEq1_1, "genericEq'"), gopurs_runtime.Any((*pkg_Data_Generic_Rep.Constructor_Inr[gopurs_runtime.Value, gopurs_runtime.Value])(v_2.UnsafePtr).V0), gopurs_runtime.Any((*pkg_Data_Generic_Rep.Constructor_Inr[gopurs_runtime.Value, gopurs_runtime.Value])(v1_3.UnsafePtr).V0)).IntVal) != (0))))
}
end_branch_0:
return __t0
})))
...
func Call_genericEq(dictGeneric_0_loop gopurs_runtime.Value, dictGenericEq_1_loop gopurs_runtime.Value, x_2_loop interface{}, y_3_loop interface{}) bool {
...
_ = y_3
return (gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictGenericEq_1, "genericEq'"), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictGeneric_0, "from"), gopurs_runtime.Any(x_2)), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictGeneric_0, "from"), gopurs_runtime.Any(y_3))).IntVal) != (0)
}
