...
return Call_showAlternate((*Record_show_gopurs_runtime_Value)(dictShow_0_box.UnsafePtr))
})
	})
...
return Call_semigroupAlternate((*Record_alt_gopurs_runtime_Value)(dictAlt_0_box.UnsafePtr))
})
	})
...
return gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(Call_plusAlternate((*Record_empty_gopurs_runtime_Value)(dictPlus_0_box.UnsafePtr)))}
})
	})
...
return gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(Call_ordAlternate((*Record_compare_gopurs_runtime_Value)(dictOrd_0_box.UnsafePtr)))}
})
	})
...
return gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(Call_ord1Alternate((*Record_compare1_gopurs_runtime_Value)(dictOrd1_0_box.UnsafePtr)))}
})
	})
...
return Call_monoidAlternate((*Record_empty_gopurs_runtime_Value)(dictPlus_0_box.UnsafePtr))
})
	})
...
return gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(Call_monadAlternate((*Record_)(dictMonad_0_box.UnsafePtr)))}
})
	})
...
return gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(Call_functorAlternate((*Record_map__gopurs_runtime_Value)(dictFunctor_0_box.UnsafePtr)))}
})
	})
...
return gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(Call_extendAlternate((*Record_extend_gopurs_runtime_Value)(dictExtend_0_box.UnsafePtr)))}
})
	})
...
return gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(Call_eqAlternate((*Record_eq_gopurs_runtime_Value)(dictEq_0_box.UnsafePtr)))}
})
	})
...
return gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(Call_eq1Alternate((*Record_eq1_gopurs_runtime_Value)(dictEq1_0_box.UnsafePtr)))}
})
	})
...
return gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(Call_comonadAlternate((*Record_extract_gopurs_runtime_Value)(dictComonad_0_box.UnsafePtr)))}
})
	})
...
return gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(Call_boundedAlternate((*Record_bottom_gopurs_runtime_Value_top_gopurs_runtime_Value)(dictBounded_0_box.UnsafePtr)))}
})
	})
...
return gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(Call_bindAlternate((*Record_bind_gopurs_runtime_Value)(dictBind_0_box.UnsafePtr)))}
})
	})
...
return gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(Call_applyAlternate((*Record_apply_gopurs_runtime_Value)(dictApply_0_box.UnsafePtr)))}
})
	})
...
return gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(Call_applicativeAlternate((*Record_pure_gopurs_runtime_Value)(dictApplicative_0_box.UnsafePtr)))}
})
	})
...
return gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(Call_alternativeAlternate((*Record_)(dictAlternative_0_box.UnsafePtr)))}
})
	})
...
return gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(Call_altAlternate((*Record_alt_gopurs_runtime_Value)(dictAlt_0_box.UnsafePtr)))}
})
	})
...
func Call_showAlternate(dictShow_0_loop *Record_show_gopurs_runtime_Value) gopurs_runtime.Value {
var dictShow_0 *Record_show_gopurs_runtime_Value = dictShow_0_loop
_ = dictShow_0
return gopurs_runtime.RecordDict1("show", gopurs_runtime.Func(func(v_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str("(Alternate "), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Apply(dictShow_0.show, v_1), gopurs_runtime.Str(")")))
}))
}

func Call_semigroupAlternate(dictAlt_0_loop *Record_alt_gopurs_runtime_Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply2(dictAlt_0.alt, v_1, v1_2)
}))
}

func Call_plusAlternate(dictPlus_0_loop *Record_empty_gopurs_runtime_Value) *Record_empty_gopurs_runtime_Value {
var dictPlus_0 *Record_empty_gopurs_runtime_Value = dictPlus_0_loop
_ = dictPlus_0
return dictPlus_0
}

func Call_ordAlternate(dictOrd_0_loop *Record_compare_gopurs_runtime_Value) *Record_compare_gopurs_runtime_Value {
var dictOrd_0 *Record_compare_gopurs_runtime_Value = dictOrd_0_loop
_ = dictOrd_0
return dictOrd_0
}

func Call_ord1Alternate(dictOrd1_0_loop *Record_compare1_gopurs_runtime_Value) *Record_compare1_gopurs_runtime_Value {
var dictOrd1_0 *Record_compare1_gopurs_runtime_Value = dictOrd1_0_loop
_ = dictOrd1_0
return dictOrd1_0
}

func Call_monoidAlternate(dictPlus_0_loop *Record_empty_gopurs_runtime_Value) gopurs_runtime.Value {
var dictPlus_0 *Record_empty_gopurs_runtime_Value = dictPlus_0_loop
_ = dictPlus_0
...
func Call_monadAlternate(dictMonad_0_loop *Record_) *Record_ {
var dictMonad_0 *Record_ = dictMonad_0_loop
_ = dictMonad_0
return dictMonad_0
}

func Call_functorAlternate(dictFunctor_0_loop *Record_map__gopurs_runtime_Value) *Record_map__gopurs_runtime_Value {
var dictFunctor_0 *Record_map__gopurs_runtime_Value = dictFunctor_0_loop
_ = dictFunctor_0
return dictFunctor_0
}

func Call_extendAlternate(dictExtend_0_loop *Record_extend_gopurs_runtime_Value) *Record_extend_gopurs_runtime_Value {
var dictExtend_0 *Record_extend_gopurs_runtime_Value = dictExtend_0_loop
_ = dictExtend_0
return dictExtend_0
}

func Call_eqAlternate(dictEq_0_loop *Record_eq_gopurs_runtime_Value) *Record_eq_gopurs_runtime_Value {
var dictEq_0 *Record_eq_gopurs_runtime_Value = dictEq_0_loop
_ = dictEq_0
return dictEq_0
}

func Call_eq1Alternate(dictEq1_0_loop *Record_eq1_gopurs_runtime_Value) *Record_eq1_gopurs_runtime_Value {
var dictEq1_0 *Record_eq1_gopurs_runtime_Value = dictEq1_0_loop
_ = dictEq1_0
return dictEq1_0
}

func Call_comonadAlternate(dictComonad_0_loop *Record_extract_gopurs_runtime_Value) *Record_extract_gopurs_runtime_Value {
var dictComonad_0 *Record_extract_gopurs_runtime_Value = dictComonad_0_loop
_ = dictComonad_0
return dictComonad_0
}

func Call_boundedAlternate(dictBounded_0_loop *Record_bottom_gopurs_runtime_Value_top_gopurs_runtime_Value) *Record_bottom_gopurs_runtime_Value_top_gopurs_runtime_Value {
var dictBounded_0 *Record_bottom_gopurs_runtime_Value_top_gopurs_runtime_Value = dictBounded_0_loop
_ = dictBounded_0
return dictBounded_0
}

func Call_bindAlternate(dictBind_0_loop *Record_bind_gopurs_runtime_Value) *Record_bind_gopurs_runtime_Value {
var dictBind_0 *Record_bind_gopurs_runtime_Value = dictBind_0_loop
_ = dictBind_0
return dictBind_0
}

func Call_applyAlternate(dictApply_0_loop *Record_apply_gopurs_runtime_Value) *Record_apply_gopurs_runtime_Value {
var dictApply_0 *Record_apply_gopurs_runtime_Value = dictApply_0_loop
_ = dictApply_0
return dictApply_0
}

func Call_applicativeAlternate(dictApplicative_0_loop *Record_pure_gopurs_runtime_Value) *Record_pure_gopurs_runtime_Value {
var dictApplicative_0 *Record_pure_gopurs_runtime_Value = dictApplicative_0_loop
_ = dictApplicative_0
return dictApplicative_0
}

func Call_alternativeAlternate(dictAlternative_0_loop *Record_) *Record_ {
var dictAlternative_0 *Record_ = dictAlternative_0_loop
_ = dictAlternative_0
return dictAlternative_0
}

func Call_altAlternate(dictAlt_0_loop *Record_alt_gopurs_runtime_Value) *Record_alt_gopurs_runtime_Value {
var dictAlt_0 *Record_alt_gopurs_runtime_Value = dictAlt_0_loop
_ = dictAlt_0
return dictAlt_0
}
