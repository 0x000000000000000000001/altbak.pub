...
var _Gopurs_Go__defer = // TAST: (ForAll [a] (Func [(Func [Unit] (TypeVar a))] (ADT ["Data","Lazy","Lazy"] [(TypeVar a)])))
gopurs_runtime.Func(func(arg0 gopurs_runtime.Value) gopurs_runtime.Value {
	go_arg0 := arg0
	go_res := Defer(go_arg0)
	return gopurs_runtime.Box(go_res)
})
var _Gopurs_Force = // TAST: (ForAll [a] (Func [(ADT ["Data","Lazy","Lazy"] [(TypeVar a)])] (TypeVar a)))
gopurs_runtime.Func(func(arg0 gopurs_runtime.Value) gopurs_runtime.Value {
	go_arg0 := arg0
