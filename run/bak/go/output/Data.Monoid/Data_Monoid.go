...
func Get_monoidUnit() gopurs_runtime.Value {
	once_monoidUnit.Do(func() {
		cache_monoidUnit = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Semigroup0", "mempty", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_monoidString() gopurs_runtime.Value {
	once_monoidString.Do(func() {
		cache_monoidString = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Semigroup0", "mempty", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_monoidRecordNil() gopurs_runtime.Value {
	once_monoidRecordNil.Do(func() {
		cache_monoidRecordNil = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("SemigroupRecord0", "memptyRecord", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_monoidOrdering() gopurs_runtime.Value {
	once_monoidOrdering.Do(func() {
		cache_monoidOrdering = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Semigroup0", "mempty", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return pkg_Data_Ordering.Get_semigroupOrdering()
}), gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 902936544, UnsafePtr: nil}))))
	})
...
func Get_monoidArray() gopurs_runtime.Value {
	once_monoidArray.Do(func() {
		cache_monoidArray = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Semigroup0", "mempty", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Any(Call_monoidRecord(_dollar__unused_0_box, dictMonoidRecord_1_box))
})
	})
...
return gopurs_runtime.Any(Call_mempty(dict_0_box))
})
	})
	return cache_mempty
}

var cache_mempty__func_gopurs_runtime_Value__interface___850932430 gopurs_runtime.Value
var once_mempty__func_gopurs_runtime_Value__interface___850932430 sync.Once
func Get_mempty__func_gopurs_runtime_Value__interface___850932430() gopurs_runtime.Value {
	once_mempty__func_gopurs_runtime_Value__interface___850932430.Do(func() {
		cache_mempty__func_gopurs_runtime_Value__interface___850932430 = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Any(Call_mempty__func_gopurs_runtime_Value__interface___850932430(dict_0_box))
})
	})
	return cache_mempty__func_gopurs_runtime_Value__interface___850932430
}
...
return gopurs_runtime.Any(Call_monoidFn(dictMonoid_0_box))
})
	})
...
func Call_monoidRecord(_dollar__unused_0_loop gopurs_runtime.Value, dictMonoidRecord_1_loop gopurs_runtime.Value) interface{} {
var _dollar__unused_0 gopurs_runtime.Value = _dollar__unused_0_loop
_ = _dollar__unused_0
var dictMonoidRecord_1 gopurs_runtime.Value = dictMonoidRecord_1_loop
_ = dictMonoidRecord_1
semigroupRecord1_2_0 := gopurs_runtime.RecordDict1("append", gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonoidRecord_1, "SemigroupRecord0"), gopurs_runtime.Value{}), "appendRecord"), gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 513803634, UnsafePtr: nil})))
...
}), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonoidRecord_1, "memptyRecord"), gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 513803634, UnsafePtr: nil}))))
}

func Call_mempty(dict_0_loop gopurs_runtime.Value) interface{} {
var dict_0 gopurs_runtime.Value = dict_0_loop
_ = dict_0
return gopurs_runtime.UnboxAny(gopurs_runtime.RecordGet(dict_0, "mempty"))
}

func Call_mempty__func_gopurs_runtime_Value__interface___850932430(dict_0_loop gopurs_runtime.Value) interface{} {
var dict_0 gopurs_runtime.Value = dict_0_loop
_ = dict_0
return gopurs_runtime.UnboxAny(gopurs_runtime.RecordGet(dict_0, "mempty"))
}

func Call_monoidFn(dictMonoid_0_loop gopurs_runtime.Value) interface{} {
...
return gopurs_runtime.Apply3(pkg_Record_Unsafe.Get_unsafeSet(), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictIsSymbol_0, "reflectSymbol"), gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 513803634, UnsafePtr: nil})), mempty1_2_0, gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonoidRecord_5, "memptyRecord"), gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 513803634, UnsafePtr: nil})))
}))
})
}
...
x_prime_6_5 := gopurs_runtime.Apply(gopurs_runtime.Any(go__4_2), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_EuclideanRing.Get_euclideanRingInt(), "div"), p_5, gopurs_runtime.Int(2)))
_ = x_prime_6_5
...
{
x_prime_6_3 := gopurs_runtime.Apply(gopurs_runtime.Any(go__4_2), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_EuclideanRing.Get_euclideanRingInt(), "div"), p_5, gopurs_runtime.Int(2)))
_ = x_prime_6_3
