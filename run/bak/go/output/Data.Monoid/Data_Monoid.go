...
{
if (gopurs_runtime.Bool(p_5.IntVal <= gopurs_runtime.Int(0).IntVal)).IntVal != 0 {
__t4 = mempty1_1_0
goto end_branch_4
} else {
...
{
if (gopurs_runtime.Bool(p_5.IntVal == gopurs_runtime.Int(1).IntVal)).IntVal != 0 {
__t4 = x_3
goto end_branch_4
} else {
...
{
if (gopurs_runtime.Bool(gopurs_runtime.Apply2(pkg_Data_EuclideanRing.Get_intMod(), p_5, gopurs_runtime.Int(2)).IntVal == gopurs_runtime.Int(0).IntVal)).IntVal != 0 {
x_prime_6_5 := gopurs_runtime.Apply(go__4_2, gopurs_runtime.Int(p_5.IntVal / gopurs_runtime.Int(2).IntVal))
_ = x_prime_6_5
...
{
x_prime_6_3 := gopurs_runtime.Apply(go__4_2, gopurs_runtime.Int(p_5.IntVal / gopurs_runtime.Int(2).IntVal))
_ = x_prime_6_3
