...
func Get_Min() gopurs_runtime.Value {
	once_Min.Do(func() {
		cache_Min = gopurs_runtime.Func(func(x_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_showMin() gopurs_runtime.Value {
	once_showMin.Do(func() {
		cache_showMin = gopurs_runtime.Func(func(dictShow_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
...
func Get_semigroupMin() gopurs_runtime.Value {
	once_semigroupMin.Do(func() {
		cache_semigroupMin = gopurs_runtime.Func(func(dictOrd_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
...
func Get_monoidMin() gopurs_runtime.Value {
	once_monoidMin.Do(func() {
		cache_monoidMin = gopurs_runtime.Func(func(dictBounded_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
...
func Get_eqMin() gopurs_runtime.Value {
	once_eqMin.Do(func() {
		cache_eqMin = gopurs_runtime.Func(func(dictEq_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
...
func Get_ordMin() gopurs_runtime.Value {
	once_ordMin.Do(func() {
		cache_ordMin = gopurs_runtime.Func(func(dictOrd_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
var dictOrd_0 gopurs_runtime.Value = dictOrd_0_loop
_ = dictOrd_0
