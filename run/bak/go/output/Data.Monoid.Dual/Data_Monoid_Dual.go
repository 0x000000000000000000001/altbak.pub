...
return gopurs_runtime.Any(Call_showDual(dictShow_0_box))
})
	})
...
return gopurs_runtime.Any(Call_semigroupDual(dictSemigroup_0_box))
})
	})
...
return gopurs_runtime.Any(Call_ordDual(dictOrd_0_box))
})
	})
...
return gopurs_runtime.Any(Call_monoidDual(dictMonoid_0_box))
})
	})
...
func Get_functorDual() gopurs_runtime.Value {
	once_functorDual.Do(func() {
		cache_functorDual = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("map", gopurs_runtime.Func2(func(f_0 gopurs_runtime.Value, m_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Any(Call_eqDual(dictEq_0_box))
})
	})
	return cache_eqDual
}
...
func Get_eq1Dual() gopurs_runtime.Value {
	once_eq1Dual.Do(func() {
		cache_eq1Dual = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("eq1", gopurs_runtime.Func(func(dictEq_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_ord1Dual() gopurs_runtime.Value {
	once_ord1Dual.Do(func() {
		cache_ord1Dual = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Eq10", "compare1", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return Get_eq1Dual()
...
return gopurs_runtime.Any(Call_boundedDual(dictBounded_0_box))
})
	})
...
func Get_applyDual() gopurs_runtime.Value {
	once_applyDual.Do(func() {
		cache_applyDual = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Functor0", "apply", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_bindDual() gopurs_runtime.Value {
	once_bindDual.Do(func() {
		cache_bindDual = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Apply0", "bind", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_applicativeDual() gopurs_runtime.Value {
	once_applicativeDual.Do(func() {
		cache_applicativeDual = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Apply0", "pure", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return Get_applyDual()
}), Get_Dual())))
	})
...
func Get_monadDual() gopurs_runtime.Value {
	once_monadDual.Do(func() {
		cache_monadDual = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Applicative0", "Bind1", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_showDual(dictShow_0_loop gopurs_runtime.Value) interface{} {
...
func Call_semigroupDual(dictSemigroup_0_loop gopurs_runtime.Value) interface{} {
...
func Call_ordDual(dictOrd_0_loop gopurs_runtime.Value) interface{} {
var dictOrd_0 gopurs_runtime.Value = dictOrd_0_loop
_ = dictOrd_0
return gopurs_runtime.UnboxAny(dictOrd_0)
}

func Call_monoidDual(dictMonoid_0_loop gopurs_runtime.Value) interface{} {
...
func Call_eqDual(dictEq_0_loop gopurs_runtime.Value) interface{} {
var dictEq_0 gopurs_runtime.Value = dictEq_0_loop
_ = dictEq_0
return gopurs_runtime.UnboxAny(dictEq_0)
}

func Call_boundedDual(dictBounded_0_loop gopurs_runtime.Value) interface{} {
