...
func Get_cotraverse() gopurs_runtime.Value {
	once_cotraverse.Do(func() {
		cotraverse = gopurs_runtime.Func2(func(dictDistributive_0 gopurs_runtime.Value, dictFunctor_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_collectDefault() gopurs_runtime.Value {
	once_collectDefault.Do(func() {
		collectDefault = gopurs_runtime.Func2(func(dictDistributive_0 gopurs_runtime.Value, dictFunctor_1 gopurs_runtime.Value) gopurs_runtime.Value {
distribute2_2_0 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictDistributive_0, "distribute"), dictFunctor_1)
_ = distribute2_2_0
return gopurs_runtime.Func(func(f_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
var dictTypeEquals_0 = dictTypeEquals_0_loop
_ = dictTypeEquals_0
...
func Get_distributeDefault() gopurs_runtime.Value {
	once_distributeDefault.Do(func() {
		distributeDefault = gopurs_runtime.Func2(func(dictDistributive_0 gopurs_runtime.Value, dictFunctor_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictDistributive_0, "collect"), dictFunctor_1, gopurs_runtime.RecordGet(pkg_Control_Category.Get_categoryFn(), "identity"))
})
	})
