...
return Call_distribute((*Record_collect_gopurs_runtime_Value_distribute_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
...
return Call_cotraverse((*Record_collect_gopurs_runtime_Value_distribute_gopurs_runtime_Value)(dictDistributive_0_box.UnsafePtr), (*Record_map__gopurs_runtime_Value)(dictFunctor_1_box.UnsafePtr))
})
	})
...
return Call_collectDefault((*Record_collect_gopurs_runtime_Value_distribute_gopurs_runtime_Value)(dictDistributive_0_box.UnsafePtr), (*Record_map__gopurs_runtime_Value)(dictFunctor_1_box.UnsafePtr))
})
	})
...
return Call_distributiveTuple((*Record_proof_gopurs_runtime_Value)(dictTypeEquals_0_box.UnsafePtr))
})
	})
...
return Call_collect((*Record_collect_gopurs_runtime_Value_distribute_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
...
return Call_distributeDefault((*Record_collect_gopurs_runtime_Value_distribute_gopurs_runtime_Value)(dictDistributive_0_box.UnsafePtr), (*Record_map__gopurs_runtime_Value)(dictFunctor_1_box.UnsafePtr))
})
	})
...
func Call_distribute(dict_0_loop *Record_collect_gopurs_runtime_Value_distribute_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_collect_gopurs_runtime_Value_distribute_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.distribute
}

func Call_cotraverse(dictDistributive_0_loop *Record_collect_gopurs_runtime_Value_distribute_gopurs_runtime_Value, dictFunctor_1_loop *Record_map__gopurs_runtime_Value) gopurs_runtime.Value {
...
_ = dictFunctor_1
distribute2_2_0 := gopurs_runtime.Apply(dictDistributive_0.distribute, gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictFunctor_1)})
_ = distribute2_2_0
return gopurs_runtime.Func(func(f_3 gopurs_runtime.Value) gopurs_runtime.Value {
__local_var_4_1 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictDistributive_0)}, "Functor0_NOT_FOUND"), gopurs_runtime.Value{}), "map"), f_3)
_ = __local_var_4_1
...
func Call_collectDefault(dictDistributive_0_loop *Record_collect_gopurs_runtime_Value_distribute_gopurs_runtime_Value, dictFunctor_1_loop *Record_map__gopurs_runtime_Value) gopurs_runtime.Value {
var dictDistributive_0 *Record_collect_gopurs_runtime_Value_distribute_gopurs_runtime_Value = dictDistributive_0_loop
_ = dictDistributive_0
var dictFunctor_1 *Record_map__gopurs_runtime_Value = dictFunctor_1_loop
_ = dictFunctor_1
...
_ = distribute2_2_0
return gopurs_runtime.Func(func(f_3 gopurs_runtime.Value) gopurs_runtime.Value {
__local_var_4_1 := gopurs_runtime.Apply(dictFunctor_1.map_, f_3)
_ = __local_var_4_1
return gopurs_runtime.Func(func(x_5 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_distributiveTuple(dictTypeEquals_0_loop *Record_proof_gopurs_runtime_Value) gopurs_runtime.Value {
distributiveTuple:
for {
if false { continue distributiveTuple }
var dictTypeEquals_0 *Record_proof_gopurs_runtime_Value = dictTypeEquals_0_loop
_ = dictTypeEquals_0
from_1_0 := gopurs_runtime.Apply(dictTypeEquals_0.proof, gopurs_runtime.Func(func(a_1 gopurs_runtime.Value) gopurs_runtime.Value {
return a_1
}))
_ = from_1_0
...
distribute2_3_1 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(Get_distributiveTuple(), gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictTypeEquals_0)}), "distribute"), dictFunctor_2)
_ = distribute2_3_1
...
func Call_collect(dict_0_loop *Record_collect_gopurs_runtime_Value_distribute_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_collect_gopurs_runtime_Value_distribute_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.collect
}

func Call_distributeDefault(dictDistributive_0_loop *Record_collect_gopurs_runtime_Value_distribute_gopurs_runtime_Value, dictFunctor_1_loop *Record_map__gopurs_runtime_Value) gopurs_runtime.Value {
var dictDistributive_0 *Record_collect_gopurs_runtime_Value_distribute_gopurs_runtime_Value = dictDistributive_0_loop
_ = dictDistributive_0
var dictFunctor_1 *Record_map__gopurs_runtime_Value = dictFunctor_1_loop
_ = dictFunctor_1
return gopurs_runtime.Apply2(dictDistributive_0.collect, gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictFunctor_1)}, Get_identity())
}
