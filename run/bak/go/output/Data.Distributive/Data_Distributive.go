...
func Get_distributiveIdentity() gopurs_runtime.Value {
	once_distributiveIdentity.Do(func() {
		cache_distributiveIdentity = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict3("Functor0", "collect", "distribute", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
var cache_distribute__func_gopurs_runtime_Value__gopurs_runtime_Value__interface____interface___304256629 gopurs_runtime.Value
var once_distribute__func_gopurs_runtime_Value__gopurs_runtime_Value__interface____interface___304256629 sync.Once
func Get_distribute__func_gopurs_runtime_Value__gopurs_runtime_Value__interface____interface___304256629() gopurs_runtime.Value {
	once_distribute__func_gopurs_runtime_Value__gopurs_runtime_Value__interface____interface___304256629.Do(func() {
		cache_distribute__func_gopurs_runtime_Value__gopurs_runtime_Value__interface____interface___304256629 = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_distribute__func_gopurs_runtime_Value__gopurs_runtime_Value__interface____interface___304256629(dict_0_box)
})
	})
	return cache_distribute__func_gopurs_runtime_Value__gopurs_runtime_Value__interface____interface___304256629
}
...
func Get_distributiveFunction() gopurs_runtime.Value {
	once_distributiveFunction.Do(func() {
		cache_distributiveFunction = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict3("Functor0", "collect", "distribute", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Any(Call_distributiveTuple(dictTypeEquals_0_box))
})
	})
...
var cache_collect__func_gopurs_runtime_Value__gopurs_runtime_Value__func_interface____interface____interface____interface___2080349267 gopurs_runtime.Value
var once_collect__func_gopurs_runtime_Value__gopurs_runtime_Value__func_interface____interface____interface____interface___2080349267 sync.Once
func Get_collect__func_gopurs_runtime_Value__gopurs_runtime_Value__func_interface____interface____interface____interface___2080349267() gopurs_runtime.Value {
	once_collect__func_gopurs_runtime_Value__gopurs_runtime_Value__func_interface____interface____interface____interface___2080349267.Do(func() {
		cache_collect__func_gopurs_runtime_Value__gopurs_runtime_Value__func_interface____interface____interface____interface___2080349267 = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_collect__func_gopurs_runtime_Value__gopurs_runtime_Value__func_interface____interface____interface____interface___2080349267(dict_0_box)
})
	})
	return cache_collect__func_gopurs_runtime_Value__gopurs_runtime_Value__func_interface____interface____interface____interface___2080349267
}
...
func Call_distribute__func_gopurs_runtime_Value__gopurs_runtime_Value__interface____interface___304256629(dict_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dict_0 gopurs_runtime.Value = dict_0_loop
_ = dict_0
return gopurs_runtime.RecordGet(dict_0, "distribute")
}
...
func Call_distributiveTuple(dictTypeEquals_0_loop gopurs_runtime.Value) interface{} {
distributiveTuple:
for {
...
_ = from_1_0
return gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict3("Functor0", "collect", "distribute", gopurs_runtime.Func(func(_dollar__unused_2 gopurs_runtime.Value) gopurs_runtime.Value {
return pkg_Data_Tuple.Get_functorTuple()
}), gopurs_runtime.Func(func(dictFunctor_2 gopurs_runtime.Value) gopurs_runtime.Value {
distribute2_3_1 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Any(Call_distributiveTuple(dictTypeEquals_0)), "distribute"), dictFunctor_2)
_ = distribute2_3_1
...
func Call_collect__func_gopurs_runtime_Value__gopurs_runtime_Value__func_interface____interface____interface____interface___2080349267(dict_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dict_0 gopurs_runtime.Value = dict_0_loop
_ = dict_0
return gopurs_runtime.RecordGet(dict_0, "collect")
}
