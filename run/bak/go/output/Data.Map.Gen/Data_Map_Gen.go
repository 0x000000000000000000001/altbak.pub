...
func Get_genMap() gopurs_runtime.Value {
	once_genMap.Do(func() {
		genMap = gopurs_runtime.Func2(Call_genMap)
	})
	return genMap
}
...
_ = dictMonadGen_1
Bind1_2_0 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonadGen_1_loop, "Monad0"), gopurs_runtime.Value{}), "Bind1"), gopurs_runtime.Value{})
_ = Bind1_2_0
...
_ = __local_var_4_2
unfoldable1_5_3 := gopurs_runtime.Apply3(pkg_Control_Monad_Gen.Get_unfoldable(), dictMonadRec_0_loop, dictMonadGen_1_loop, pkg_Data_List_Types.Get_unfoldableList())
_ = unfoldable1_5_3
...
return gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonadGen_1_loop, "sized"), gopurs_runtime.Func(func(size_10 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(Bind1_2_0, "bind"), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictMonadGen_1_loop, "chooseInt"), gopurs_runtime.Int(0), size_10), gopurs_runtime.Func(func(newSize_11 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictMonadGen_1_loop, "resize"), gopurs_runtime.Func(func(v_12 gopurs_runtime.Value) gopurs_runtime.Value {
return newSize_11
