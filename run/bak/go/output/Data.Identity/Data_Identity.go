...
return gopurs_runtime.Any(Call_showIdentity(dictShow_0_box))
})
	})
...
return gopurs_runtime.Any(Call_semiringIdentity(dictSemiring_0_box))
})
	})
...
return gopurs_runtime.Any(Call_semigroupIdentity(dictSemigroup_0_box))
})
	})
...
return gopurs_runtime.Any(Call_ringIdentity(dictRing_0_box))
})
	})
...
return gopurs_runtime.Any(Call_ordIdentity(dictOrd_0_box))
})
	})
...
func Get_newtypeIdentity() gopurs_runtime.Value {
	once_newtypeIdentity.Do(func() {
		cache_newtypeIdentity = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("Coercible0", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Any(Call_monoidIdentity(dictMonoid_0_box))
})
	})
...
return gopurs_runtime.Any(Call_lazyIdentity(dictLazy_0_box))
})
	})
...
return gopurs_runtime.Any(Call_heytingAlgebraIdentity(dictHeytingAlgebra_0_box))
})
	})
...
func Get_functorIdentity() gopurs_runtime.Value {
	once_functorIdentity.Do(func() {
		cache_functorIdentity = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("map", gopurs_runtime.Func2(func(f_0 gopurs_runtime.Value, m_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_invariantIdentity() gopurs_runtime.Value {
	once_invariantIdentity.Do(func() {
		cache_invariantIdentity = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("imap", gopurs_runtime.Func2(func(f_0 gopurs_runtime.Value, v_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_extendIdentity() gopurs_runtime.Value {
	once_extendIdentity.Do(func() {
		cache_extendIdentity = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Functor0", "extend", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Any(Call_euclideanRingIdentity(dictEuclideanRing_0_box))
})
	})
...
return gopurs_runtime.Any(Call_eqIdentity(dictEq_0_box))
})
	})
...
func Get_eq1Identity() gopurs_runtime.Value {
	once_eq1Identity.Do(func() {
		cache_eq1Identity = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("eq1", gopurs_runtime.Func(func(dictEq_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_ord1Identity() gopurs_runtime.Value {
	once_ord1Identity.Do(func() {
		cache_ord1Identity = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Eq10", "compare1", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_comonadIdentity() gopurs_runtime.Value {
	once_comonadIdentity.Do(func() {
		cache_comonadIdentity = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Extend0", "extract", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Any(Call_commutativeRingIdentity(dictCommutativeRing_0_box))
})
	})
...
return gopurs_runtime.Any(Call_boundedIdentity(dictBounded_0_box))
})
	})
...
return gopurs_runtime.Any(Call_booleanAlgebraIdentity(dictBooleanAlgebra_0_box))
})
	})
...
func Get_applyIdentity() gopurs_runtime.Value {
	once_applyIdentity.Do(func() {
		cache_applyIdentity = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Functor0", "apply", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return Get_functorIdentity()
...
func Get_bindIdentity() gopurs_runtime.Value {
	once_bindIdentity.Do(func() {
		cache_bindIdentity = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Apply0", "bind", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_applicativeIdentity() gopurs_runtime.Value {
	once_applicativeIdentity.Do(func() {
		cache_applicativeIdentity = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Apply0", "pure", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return Get_applyIdentity()
}), Get_Identity())))
	})
...
func Get_monadIdentity() gopurs_runtime.Value {
	once_monadIdentity.Do(func() {
		cache_monadIdentity = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Applicative0", "Bind1", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_altIdentity() gopurs_runtime.Value {
	once_altIdentity.Do(func() {
		cache_altIdentity = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Functor0", "alt", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return Get_functorIdentity()
...
func Call_showIdentity(dictShow_0_loop gopurs_runtime.Value) interface{} {
...
func Call_semiringIdentity(dictSemiring_0_loop gopurs_runtime.Value) interface{} {
var dictSemiring_0 gopurs_runtime.Value = dictSemiring_0_loop
_ = dictSemiring_0
return gopurs_runtime.UnboxAny(dictSemiring_0)
}

func Call_semigroupIdentity(dictSemigroup_0_loop gopurs_runtime.Value) interface{} {
var dictSemigroup_0 gopurs_runtime.Value = dictSemigroup_0_loop
_ = dictSemigroup_0
return gopurs_runtime.UnboxAny(dictSemigroup_0)
}

func Call_ringIdentity(dictRing_0_loop gopurs_runtime.Value) interface{} {
var dictRing_0 gopurs_runtime.Value = dictRing_0_loop
_ = dictRing_0
return gopurs_runtime.UnboxAny(dictRing_0)
}

func Call_ordIdentity(dictOrd_0_loop gopurs_runtime.Value) interface{} {
var dictOrd_0 gopurs_runtime.Value = dictOrd_0_loop
_ = dictOrd_0
return gopurs_runtime.UnboxAny(dictOrd_0)
}

func Call_monoidIdentity(dictMonoid_0_loop gopurs_runtime.Value) interface{} {
var dictMonoid_0 gopurs_runtime.Value = dictMonoid_0_loop
_ = dictMonoid_0
return gopurs_runtime.UnboxAny(dictMonoid_0)
}

func Call_lazyIdentity(dictLazy_0_loop gopurs_runtime.Value) interface{} {
var dictLazy_0 gopurs_runtime.Value = dictLazy_0_loop
_ = dictLazy_0
return gopurs_runtime.UnboxAny(dictLazy_0)
}

func Call_heytingAlgebraIdentity(dictHeytingAlgebra_0_loop gopurs_runtime.Value) interface{} {
var dictHeytingAlgebra_0 gopurs_runtime.Value = dictHeytingAlgebra_0_loop
_ = dictHeytingAlgebra_0
return gopurs_runtime.UnboxAny(dictHeytingAlgebra_0)
}

func Call_euclideanRingIdentity(dictEuclideanRing_0_loop gopurs_runtime.Value) interface{} {
var dictEuclideanRing_0 gopurs_runtime.Value = dictEuclideanRing_0_loop
_ = dictEuclideanRing_0
return gopurs_runtime.UnboxAny(dictEuclideanRing_0)
}

func Call_eqIdentity(dictEq_0_loop gopurs_runtime.Value) interface{} {
var dictEq_0 gopurs_runtime.Value = dictEq_0_loop
_ = dictEq_0
return gopurs_runtime.UnboxAny(dictEq_0)
}

func Call_commutativeRingIdentity(dictCommutativeRing_0_loop gopurs_runtime.Value) interface{} {
var dictCommutativeRing_0 gopurs_runtime.Value = dictCommutativeRing_0_loop
_ = dictCommutativeRing_0
return gopurs_runtime.UnboxAny(dictCommutativeRing_0)
}

func Call_boundedIdentity(dictBounded_0_loop gopurs_runtime.Value) interface{} {
var dictBounded_0 gopurs_runtime.Value = dictBounded_0_loop
_ = dictBounded_0
return gopurs_runtime.UnboxAny(dictBounded_0)
}

func Call_booleanAlgebraIdentity(dictBooleanAlgebra_0_loop gopurs_runtime.Value) interface{} {
var dictBooleanAlgebra_0 gopurs_runtime.Value = dictBooleanAlgebra_0_loop
_ = dictBooleanAlgebra_0
return gopurs_runtime.UnboxAny(dictBooleanAlgebra_0)
}
