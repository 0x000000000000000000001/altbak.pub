...
_ = __local_var_3_0
return gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(&pkg_Data_Tuple.Data_Data_Tuple_Tuple{(*pkg_Control_Monad_RWS_Trans.Data_Control_Monad_RWS_Trans_RWSResult)(__local_var_3_0.UnsafePtr).V0, (*pkg_Control_Monad_RWS_Trans.Data_Control_Monad_RWS_Trans_RWSResult)(__local_var_3_0.UnsafePtr).V2})}
}
