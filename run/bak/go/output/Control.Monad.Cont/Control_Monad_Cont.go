...
func Get_withCont() gopurs_runtime.Value {
	once_withCont.Do(func() {
		withCont = gopurs_runtime.Func(func(f_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply(pkg_Unsafe_Coerce.Get_unsafeCoerce(), gopurs_runtime.Apply(k_2, x_3))
})))
})
})
})
...
func Get_runCont() gopurs_runtime.Value {
	once_runCont.Do(func() {
		runCont = gopurs_runtime.Func(func(cc_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(k_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(pkg_Unsafe_Coerce.Get_unsafeCoerce(), gopurs_runtime.Apply(cc_0, gopurs_runtime.Func(func(x_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_mapCont() gopurs_runtime.Value {
	once_mapCont.Do(func() {
		mapCont = gopurs_runtime.Func(func(f_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(v_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(k_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(f_0, gopurs_runtime.Apply(pkg_Unsafe_Coerce.Get_unsafeCoerce(), gopurs_runtime.Apply(v_1, k_2)))
})
})
})
	})
...
func Get_cont() gopurs_runtime.Value {
	once_cont.Do(func() {
		cont = gopurs_runtime.Func(func(f_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply(pkg_Unsafe_Coerce.Get_unsafeCoerce(), gopurs_runtime.Apply(c_1, x_2))
}))
})
})
	})
