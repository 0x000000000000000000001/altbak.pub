...
func Get_act() gopurs_runtime.Value {
	once_act.Do(func() {
		cache_act = Call_bind__3550378017(gopurs_runtime.Apply(pkg_Bench.Get_opaque(), gopurs_runtime.Int(1000)), gopurs_runtime.Func(func(dummy_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Int(Call_add__560788792(gopurs_runtime.Int(Call_force__3902501304(v1_1).IntVal), gopurs_runtime.Int(1)).IntVal)
}))
...
{
v_0_loop = Call_sub__1043827704(gopurs_runtime.Int(v_0), gopurs_runtime.Int(1)).IntVal
v1_1_loop = Call_add__560788792(gopurs_runtime.Int(v1_1), gopurs_runtime.Int(Call_force__3902501304(Call_buildThunks(1000, gopurs_runtime.Apply(Get_defer__3520065601(), gopurs_runtime.Func(func(v2_2 gopurs_runtime.Value) gopurs_runtime.Value {
