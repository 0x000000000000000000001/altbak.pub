...
return Call_empty((*Record_empty_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
	return cache_empty
}
...
func Call_empty(dict_0_loop *Record_empty_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_empty_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.empty
}
