...
func Get_genString() gopurs_runtime.Value {
	once_genString.Do(func() {
		genString = gopurs_runtime.Func2(Call_genString)
	})
	return genString
}
...
func Get_genUnicodeString() gopurs_runtime.Value {
	once_genUnicodeString.Do(func() {
		genUnicodeString = gopurs_runtime.Func2(Call_genUnicodeString)
	})
...
func Get_genDigitString() gopurs_runtime.Value {
	once_genDigitString.Do(func() {
		genDigitString = gopurs_runtime.Func2(Call_genDigitString)
	})
...
func Get_genAsciiString_prime() gopurs_runtime.Value {
	once_genAsciiString_prime.Do(func() {
		genAsciiString_prime = gopurs_runtime.Func2(Call_genAsciiString_prime)
	})
...
func Get_genAsciiString() gopurs_runtime.Value {
	once_genAsciiString.Do(func() {
		genAsciiString = gopurs_runtime.Func2(Call_genAsciiString)
	})
...
func Get_genAlphaUppercaseString() gopurs_runtime.Value {
	once_genAlphaUppercaseString.Do(func() {
		genAlphaUppercaseString = gopurs_runtime.Func2(Call_genAlphaUppercaseString)
	})
...
func Get_genAlphaString() gopurs_runtime.Value {
	once_genAlphaString.Do(func() {
		genAlphaString = gopurs_runtime.Func2(Call_genAlphaString)
	})
...
func Get_genAlphaLowercaseString() gopurs_runtime.Value {
	once_genAlphaLowercaseString.Do(func() {
		genAlphaLowercaseString = gopurs_runtime.Func2(Call_genAlphaLowercaseString)
	})
...
_ = Bind1_2_0
unfoldable1_3_1 := gopurs_runtime.Apply3(pkg_Control_Monad_Gen.Get_unfoldable(), dictMonadRec_0_loop, dictMonadGen_1_loop, pkg_Data_Unfoldable.Get_unfoldableArray())
_ = unfoldable1_3_1
