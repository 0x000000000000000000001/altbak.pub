...
func Get_traversableWithIndexSemigroupMap() gopurs_runtime.Value {
	once_traversableWithIndexSemigroupMap.Do(func() {
		cache_traversableWithIndexSemigroupMap = gopurs_runtime.Any(gopurs_runtime.UnboxAny(pkg_Data_Map_Internal.Get_traversableWithIndexMap()))
	})
...
func Get_traversableSemigroupMap() gopurs_runtime.Value {
	once_traversableSemigroupMap.Do(func() {
		cache_traversableSemigroupMap = gopurs_runtime.Any(gopurs_runtime.UnboxAny(pkg_Data_Map_Internal.Get_traversableMap()))
	})
...
return gopurs_runtime.Any(Call_showSemigroupMap(dictShow_0_box, dictShow1_1_box))
})
	})
...
return gopurs_runtime.Any(Call_plusSemigroupMap(dictOrd_0_box))
})
	})
...
return gopurs_runtime.Any(Call_ord1SemigroupMap(dictOrd_0_box))
})
	})
...
func Get_newtypeSemigroupMap() gopurs_runtime.Value {
	once_newtypeSemigroupMap.Do(func() {
		cache_newtypeSemigroupMap = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("Coercible0", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Value{Type: 9, IntVal: 324739070, UnsafePtr: unsafe.Pointer(func(inner_arg0 *pkg_Data_Map_Internal.Constructor_Node[interface{}, interface{}]) *pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value] {
return (*pkg_Data_Map_Internal.Constructor_Node[interface{}, gopurs_runtime.Value])(gopurs_runtime.Apply(gopurs_runtime.Apply(gopurs_runtime.RecordGet(pkg_Data_Map_Internal.Get_functorMap(), "map"), gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
return pkg_Data_Unit.Get_unit()
})), gopurs_runtime.Value{Type: 9, IntVal: 324739070, UnsafePtr: unsafe.Pointer(inner_arg0)}).UnsafePtr)
}((*pkg_Data_Map_Internal.Constructor_Node[interface{}, interface{}])(arg0.UnsafePtr)))}
})
	})
	return cache_keys
}
...
func Get_functorWithIndexSemigroupMap() gopurs_runtime.Value {
	once_functorWithIndexSemigroupMap.Do(func() {
		cache_functorWithIndexSemigroupMap = gopurs_runtime.Any(gopurs_runtime.UnboxAny(pkg_Data_Map_Internal.Get_functorWithIndexMap()))
	})
...
func Get_functorSemigroupMap() gopurs_runtime.Value {
	once_functorSemigroupMap.Do(func() {
		cache_functorSemigroupMap = gopurs_runtime.Any(gopurs_runtime.UnboxAny(pkg_Data_Map_Internal.Get_functorMap()))
	})
...
func Get_foldableWithIndexSemigroupMap() gopurs_runtime.Value {
	once_foldableWithIndexSemigroupMap.Do(func() {
		cache_foldableWithIndexSemigroupMap = gopurs_runtime.Any(gopurs_runtime.UnboxAny(pkg_Data_Map_Internal.Get_foldableWithIndexMap()))
	})
...
func Get_foldableSemigroupMap() gopurs_runtime.Value {
	once_foldableSemigroupMap.Do(func() {
		cache_foldableSemigroupMap = gopurs_runtime.Any(gopurs_runtime.UnboxAny(pkg_Data_Map_Internal.Get_foldableMap()))
	})
...
return gopurs_runtime.Any(Call_eqSemigroupMap(dictEq_0_box, dictEq1_1_box))
})
	})
...
return gopurs_runtime.Any(Call_eq1SemigroupMap(dictEq_0_box))
})
	})
...
return gopurs_runtime.Any(Call_bindSemigroupMap(dictOrd_0_box))
})
	})
...
return gopurs_runtime.Any(Call_applySemigroupMap(dictOrd_0_box))
})
	})
...
return gopurs_runtime.Any(Call_altSemigroupMap(dictOrd_0_box))
})
	})
...
func Call_showSemigroupMap(dictShow_0_loop gopurs_runtime.Value, dictShow1_1_loop gopurs_runtime.Value) interface{} {
var dictShow_0 gopurs_runtime.Value = dictShow_0_loop
_ = dictShow_0
var dictShow1_1 gopurs_runtime.Value = dictShow1_1_loop
_ = dictShow1_1
return gopurs_runtime.UnboxAny(gopurs_runtime.Apply2(pkg_Data_Map_Internal.Get_showMap(), dictShow_0, dictShow1_1))
}
...
func Call_plusSemigroupMap(dictOrd_0_loop gopurs_runtime.Value) interface{} {
var dictOrd_0 gopurs_runtime.Value = dictOrd_0_loop
_ = dictOrd_0
return gopurs_runtime.UnboxAny(gopurs_runtime.Apply(pkg_Data_Map_Internal.Get_plusMap(), dictOrd_0))
}
...
func Call_ord1SemigroupMap(dictOrd_0_loop gopurs_runtime.Value) interface{} {
var dictOrd_0 gopurs_runtime.Value = dictOrd_0_loop
_ = dictOrd_0
return gopurs_runtime.UnboxAny(gopurs_runtime.Apply(pkg_Data_Map_Internal.Get_ord1Map(), dictOrd_0))
}
...
func Call_eqSemigroupMap(dictEq_0_loop gopurs_runtime.Value, dictEq1_1_loop gopurs_runtime.Value) interface{} {
var dictEq_0 gopurs_runtime.Value = dictEq_0_loop
_ = dictEq_0
var dictEq1_1 gopurs_runtime.Value = dictEq1_1_loop
_ = dictEq1_1
return gopurs_runtime.UnboxAny(gopurs_runtime.Apply2(pkg_Data_Map_Internal.Get_eqMap(), dictEq_0, dictEq1_1))
}

func Call_eq1SemigroupMap(dictEq_0_loop gopurs_runtime.Value) interface{} {
var dictEq_0 gopurs_runtime.Value = dictEq_0_loop
_ = dictEq_0
...
func Call_bindSemigroupMap(dictOrd_0_loop gopurs_runtime.Value) interface{} {
var dictOrd_0 gopurs_runtime.Value = dictOrd_0_loop
_ = dictOrd_0
return gopurs_runtime.UnboxAny(gopurs_runtime.Apply(pkg_Data_Map_Internal.Get_bindMap(), dictOrd_0))
}

func Call_applySemigroupMap(dictOrd_0_loop gopurs_runtime.Value) interface{} {
var dictOrd_0 gopurs_runtime.Value = dictOrd_0_loop
_ = dictOrd_0
compare_1_0 := gopurs_runtime.RecordGet(dictOrd_0, "compare")
_ = compare_1_0
...
func Call_altSemigroupMap(dictOrd_0_loop gopurs_runtime.Value) interface{} {
var dictOrd_0 gopurs_runtime.Value = dictOrd_0_loop
_ = dictOrd_0
compare_1_0 := gopurs_runtime.RecordGet(dictOrd_0, "compare")
_ = compare_1_0
