...
return gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(&Constructor_Date{value0.IntVal, value1, value2.IntVal})}
})
})
})
	})
...
func Get_showDate() gopurs_runtime.Value {
	once_showDate.Do(func() {
		cache_showDate = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("show", gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_eqDate() gopurs_runtime.Value {
	once_eqDate.Do(func() {
		cache_eqDate = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("eq", gopurs_runtime.Func2(func(x_0 gopurs_runtime.Value, y_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_ordDate() gopurs_runtime.Value {
	once_ordDate.Do(func() {
		cache_ordDate = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Eq0", "compare", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return Get_eqDate()
...
func Get_enumDate() gopurs_runtime.Value {
	once_enumDate.Do(func() {
		cache_enumDate = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict3("Ord0", "pred", "succ", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return Get_ordDate()
...
__t5 = gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 3889233761, UnsafePtr: nil})
goto end_branch_5
} else {
...
{
if (pm_1_0.Type == 9 && pm_1_0.IntVal == 930809136 && pm_1_0.UnsafePtr != nil) {
__t5 = gopurs_runtime.Any((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(pm_1_0.UnsafePtr).V0)
goto end_branch_5
} else {
...
{
__t7 = gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]{gopurs_runtime.UnboxAny(gopurs_runtime.Int((*Constructor_Date)(v_0.UnsafePtr).V0))})})
}
end_branch_7:
...
end_branch_11:
if (__t11.IntVal) != (0) {
__t10 = gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]{gopurs_runtime.UnboxAny(l_4_6)})})
goto end_branch_10
} else {
...
{
if (Call_greaterThan(v1_2_13, gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]{gopurs_runtime.UnboxAny(gopurs_runtime.Int(Call_lastDayOfMonth(gopurs_runtime.Int((*Constructor_Date)(v_0.UnsafePtr).V0).IntVal, (*Constructor_Date)(v_0.UnsafePtr).V1)))})})).IntVal) != (0) {
...
{
__t16 = gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]{gopurs_runtime.UnboxAny(gopurs_runtime.Int((*Constructor_Date)(v_0.UnsafePtr).V0))})})
}
end_branch_16:
...
{
if (sm_1_12.Type == 9 && sm_1_12.IntVal == 930809136 && sm_1_12.UnsafePtr == nil) {
__t21 = gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 1908470532, UnsafePtr: nil})
goto end_branch_21
} else {
...
{
if (sm_1_12.Type == 9 && sm_1_12.IntVal == 930809136 && sm_1_12.UnsafePtr != nil) {
__t21 = gopurs_runtime.Any((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(sm_1_12.UnsafePtr).V0)
goto end_branch_21
} else {
...
return gopurs_runtime.Any(Call_diff(dictDuration_0_box, v_1_box, v1_2_box))
})
	})
	return cache_diff
}
...
func Get_boundedDate() gopurs_runtime.Value {
	once_boundedDate.Do(func() {
		cache_boundedDate = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict3("Ord0", "bottom", "top", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return Get_ordDate()
}), gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(&Constructor_Date{gopurs_runtime.RecordGet(pkg_Data_Date_Component.Get_boundedYear(), "bottom").IntVal, gopurs_runtime.RecordGet(pkg_Data_Date_Component.Get_boundedMonth(), "bottom"), gopurs_runtime.RecordGet(pkg_Data_Date_Component.Get_boundedDay(), "bottom").IntVal})}), gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(&Constructor_Date{gopurs_runtime.RecordGet(pkg_Data_Date_Component.Get_boundedYear(), "top").IntVal, gopurs_runtime.RecordGet(pkg_Data_Date_Component.Get_boundedMonth(), "top"), gopurs_runtime.RecordGet(pkg_Data_Date_Component.Get_boundedDay(), "top").IntVal})}))))
	})
...
var cache_calcWeekday gopurs_runtime.Value
var once_calcWeekday sync.Once
func Get_calcWeekday() gopurs_runtime.Value {
	once_calcWeekday.Do(func() {
		cache_calcWeekday = CalcWeekday
	})
	return cache_calcWeekday
}

var cache_canonicalDateImpl gopurs_runtime.Value
var once_canonicalDateImpl sync.Once
func Get_canonicalDateImpl() gopurs_runtime.Value {
	once_canonicalDateImpl.Do(func() {
		cache_canonicalDateImpl = CanonicalDateImpl
	})
	return cache_canonicalDateImpl
}
...
var __t_tag_1 gopurs_runtime.Value = gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Date_Component.Get_ordDay(), "compare"), gopurs_runtime.Any((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(a1_0.UnsafePtr).V0), gopurs_runtime.Any((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(a2_1.UnsafePtr).V0))
...
__t5 = gopurs_runtime.Any((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(__local_var_2_4.UnsafePtr).V0)
goto end_branch_5
} else {
...
__t7 = gopurs_runtime.Any((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(__local_var_2_6.UnsafePtr).V0)
goto end_branch_7
} else {
...
__t4 = gopurs_runtime.Any((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(__local_var_2_3.UnsafePtr).V0)
goto end_branch_4
} else {
...
__t9 = gopurs_runtime.Any((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(__local_var_2_8.UnsafePtr).V0)
goto end_branch_9
} else {
...
__t11 = gopurs_runtime.Any((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(__local_var_2_10.UnsafePtr).V0)
goto end_branch_11
} else {
...
__t13 = gopurs_runtime.Any((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(__local_var_2_12.UnsafePtr).V0)
goto end_branch_13
} else {
...
__t15 = gopurs_runtime.Any((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(__local_var_2_14.UnsafePtr).V0)
goto end_branch_15
} else {
...
__t17 = gopurs_runtime.Any((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(__local_var_2_16.UnsafePtr).V0)
goto end_branch_17
} else {
...
__t19 = gopurs_runtime.Any((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(__local_var_2_18.UnsafePtr).V0)
goto end_branch_19
} else {
...
__t21 = gopurs_runtime.Any((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(__local_var_2_20.UnsafePtr).V0)
goto end_branch_21
} else {
...
__t23 = gopurs_runtime.Any((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(__local_var_2_22.UnsafePtr).V0)
goto end_branch_23
} else {
...
__t25 = gopurs_runtime.Any((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(__local_var_2_24.UnsafePtr).V0)
goto end_branch_25
} else {
...
__t27 = gopurs_runtime.Any((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(__local_var_2_26.UnsafePtr).V0)
goto end_branch_27
} else {
...
func Call_diff(dictDuration_0_loop gopurs_runtime.Value, v_1_loop gopurs_runtime.Value, v1_2_loop gopurs_runtime.Value) interface{} {
...
__t1 = gopurs_runtime.Any((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(__local_var_6_0.UnsafePtr).V0)
goto end_branch_1
} else {
...
end_branch_1:
return gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(&Constructor_Date{y_prime_3.IntVal, __t1, d_prime_5.IntVal})})
...
var __t0 gopurs_runtime.Value
{
if (gopurs_runtime.Apply2(gopurs_runtime.RecordGet(Get_eqDate(), "eq"), Call_canonicalDate(y_0, m_1, d_2), gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(&Constructor_Date{y_0, m_1, d_2})})).IntVal) != (0) {
__t0 = gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]{gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(&Constructor_Date{y_0, m_1, d_2})}})})
goto end_branch_0
} else {
...
{
if (v1_3.IntVal) == (0) {
__t10 = gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]{gopurs_runtime.UnboxAny(v2_4)})})
goto end_branch_10
} else {
...
__t6 = gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 3889233761, UnsafePtr: nil})
goto end_branch_6
} else {
...
{
if (__local_var_7_5.Type == 9 && __local_var_7_5.IntVal == 930809136 && __local_var_7_5.UnsafePtr != nil) {
__t6 = gopurs_runtime.Any((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(__local_var_7_5.UnsafePtr).V0)
goto end_branch_6
} else {
...
{
if (hi_8_7.IntVal) != (0) {
__t8 = gopurs_runtime.Apply(gopurs_runtime.RecordGet(Get_enumDate(), "succ"), gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(&Constructor_Date{gopurs_runtime.Int((*Constructor_Date)(v2_4.UnsafePtr).V0).IntVal, (*Constructor_Date)(v2_4.UnsafePtr).V1, l_7_3.IntVal})}))
goto end_branch_8
} else {
...
end_branch_9:
__t10 = gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Maybe.Get_bindMaybe(), "bind"), __t8, gopurs_runtime.Apply(gopurs_runtime.Any(adj_2_0), __t9))
}
end_branch_10:
return __t10
})
...
return gopurs_runtime.Apply2(gopurs_runtime.Any(adj_2_0), a_3, date_1)
})).UnsafePtr)
}
