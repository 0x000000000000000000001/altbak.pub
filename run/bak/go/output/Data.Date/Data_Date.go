...
n_2_0 := gopurs_runtime.UncurriedApp3(Get_calcWeekday(), gopurs_runtime.Int((*Constructor_Date)(v_1.UnsafePtr).V0), gopurs_runtime.Int(gopurs_runtime.Int(Call_fromEnum__1196942535((*Constructor_Date)(v_1.UnsafePtr).V1)).IntVal), gopurs_runtime.Int((*Constructor_Date)(v_1.UnsafePtr).V2))
_ = n_2_0
var __t1 uint32
{
if (Call_eq__2843686287(gopurs_runtime.Int(n_2_0.IntVal), gopurs_runtime.Int(0)).IntVal) != (0) {
__t1 = uint32(Call_fromJust__3809843644(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[uint32]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Call_toEnum__2793813158(7))}))})).IntVal)
goto end_branch_1
} else {
...
{
__t1 = uint32(Call_fromJust__3809843644(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[uint32]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Call_toEnum__2793813158(n_2_0.IntVal))}))})).IntVal)
}
end_branch_1:
...
return gopurs_runtime.Str(Call_append__493084344(gopurs_runtime.Str("(Date "), gopurs_runtime.Str(Call_append__493084344(gopurs_runtime.Str(Call_show__1488465650(gopurs_runtime.Int((*Constructor_Date)(v_0.UnsafePtr).V0)).StrVal()), gopurs_runtime.Str(Call_append__493084344(gopurs_runtime.Str(" "), gopurs_runtime.Str(Call_append__493084344(gopurs_runtime.Str(gopurs_runtime.Str(Call_show__1626410898((*Constructor_Date)(v_0.UnsafePtr).V1)).StrVal()), gopurs_runtime.Str(Call_append__493084344(gopurs_runtime.Str(" "), gopurs_runtime.Str(Call_append__493084344(gopurs_runtime.Str(Call_show__1488465650(gopurs_runtime.Int((*Constructor_Date)(v_0.UnsafePtr).V2)).StrVal()), gopurs_runtime.Str(")")).StrVal())).StrVal())).StrVal())).StrVal())).StrVal())).StrVal())
}))
	})
...
return gopurs_runtime.Bool((Call_conj__3676519832(gopurs_runtime.Bool((Call_conj__3676519832(gopurs_runtime.Bool((Call_eq__2843686287(gopurs_runtime.Int((*Constructor_Date)(x_0.UnsafePtr).V0), gopurs_runtime.Int((*Constructor_Date)(y_1.UnsafePtr).V0)).IntVal) != (0)), gopurs_runtime.Bool((gopurs_runtime.Bool(Call_eq__3887832182((*Constructor_Date)(x_0.UnsafePtr).V1, (*Constructor_Date)(y_1.UnsafePtr).V1)).IntVal) != (0))).IntVal) != (0)), gopurs_runtime.Bool((Call_eq__2843686287(gopurs_runtime.Int((*Constructor_Date)(x_0.UnsafePtr).V2), gopurs_runtime.Int((*Constructor_Date)(y_1.UnsafePtr).V2)).IntVal) != (0))).IntVal) != (0))
})
}))
	})
	return cache_eqDate
...
return gopurs_runtime.Func(func(y_1 gopurs_runtime.Value) gopurs_runtime.Value {
v_2_0 := Call_compare__372254389(gopurs_runtime.Int((*Constructor_Date)(x_0.UnsafePtr).V0), gopurs_runtime.Int((*Constructor_Date)(y_1.UnsafePtr).V0))
_ = v_2_0
var __t3 uint32
{
...
{
v1_3_1 := gopurs_runtime.Value{Type: 9, IntVal: int64(Call_compare__696857420((*Constructor_Date)(x_0.UnsafePtr).V1, (*Constructor_Date)(y_1.UnsafePtr).V1)), UnsafePtr: nil}
_ = v1_3_1
var __t2 uint32
{
...
{
__t2 = uint32(Call_compare__372254389(gopurs_runtime.Int((*Constructor_Date)(x_0.UnsafePtr).V2), gopurs_runtime.Int((*Constructor_Date)(y_1.UnsafePtr).V2)).IntVal)
}
end_branch_2:
__t3 = __t2
}
...
pm_1_0 := gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[uint32]](Call_pred__2010692236(gopurs_runtime.Value{Type: 9, IntVal: int64((*Constructor_Date)(v_0.UnsafePtr).V1), UnsafePtr: nil}))
_ = pm_1_0
pd_2_1 := gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[int64]](Call_pred__2914940949(gopurs_runtime.Int((*Constructor_Date)(v_0.UnsafePtr).V2)))
_ = pd_2_1
var __t3 uint32
{
if (gopurs_runtime.Bool(Call_isNothing__1358705270(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(pd_2_1)}))).IntVal) != (0) {
__t3 = uint32(Call_fromMaybe__18840980(gopurs_runtime.Value{Type: 9, IntVal: int64(3889233761), UnsafePtr: nil}, gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(pm_1_0)})).IntVal)
goto end_branch_3
} else {
...
var __t5 gopurs_runtime.Value
{
if (Call_conj__3676519832(gopurs_runtime.Bool((gopurs_runtime.Bool(Call_isNothing__1358705270(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(pd_2_1)}))).IntVal) != (0)), gopurs_runtime.Bool((gopurs_runtime.Bool(Call_isNothing__2787066607(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(pm_1_0)}))).IntVal) != (0))).IntVal) != (0) {
__t5 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[int64]](Call_pred__2914940949(gopurs_runtime.Int((*Constructor_Date)(v_0.UnsafePtr).V0))))}
goto end_branch_5
} else {
...
{
if (gopurs_runtime.Bool(Call_isNothing__1358705270(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(pd_2_1)}))).IntVal) != (0) {
__t6 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]{1, gopurs_runtime.Int(l_4_4.IntVal)})}
goto end_branch_6
} else {
...
end_branch_6:
return gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[*Constructor_Date]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Call_apply__1471729482(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Call_apply__1572009162(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Call_map__4155962236(Get_Date(), gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[int64]](__t5)))}), gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[uint32]](Call_pure__3181299446(gopurs_runtime.Value{Type: 9, IntVal: int64(m_prime_3_2), UnsafePtr: nil}))))}), gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[int64]](__t6)))}))}
}), gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
sm_1_7 := gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[uint32]](Call_succ__2010692236(gopurs_runtime.Value{Type: 9, IntVal: int64((*Constructor_Date)(v_0.UnsafePtr).V1), UnsafePtr: nil}))
_ = sm_1_7
v1_2_8 := gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[int64]](Call_succ__2914940949(gopurs_runtime.Int((*Constructor_Date)(v_0.UnsafePtr).V2)))
_ = v1_2_8
var __t10 gopurs_runtime.Value
{
if (gopurs_runtime.Bool(Call_greaterThan__2400628110(gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(v1_2_8)}, gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]{1, gopurs_runtime.Int(gopurs_runtime.Int(Call_lastDayOfMonth((*Constructor_Date)(v_0.UnsafePtr).V0, (*Constructor_Date)(v_0.UnsafePtr).V1)).IntVal)})})).IntVal) != (0) {
...
{
if (Call_conj__3676519832(gopurs_runtime.Bool((gopurs_runtime.Bool(Call_isNothing__1358705270(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(sd_3_9)}))).IntVal) != (0)), gopurs_runtime.Bool((gopurs_runtime.Bool(Call_isNothing__2787066607(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(sm_1_7)}))).IntVal) != (0))).IntVal) != (0) {
__t11 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[int64]](Call_succ__2914940949(gopurs_runtime.Int((*Constructor_Date)(v_0.UnsafePtr).V0))))}
goto end_branch_11
} else {
...
__t12 = uint32(Call_fromMaybe__18840980(gopurs_runtime.Value{Type: 9, IntVal: int64(1908470532), UnsafePtr: nil}, gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(sm_1_7)})).IntVal)
goto end_branch_12
} else {
...
{
if (gopurs_runtime.Bool(Call_isNothing__1358705270(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(sd_3_9)}))).IntVal) != (0) {
__t13 = gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[int64]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Call_toEnum__2099864294(1))})
goto end_branch_13
} else {
...
end_branch_13:
return gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[*Constructor_Date]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Call_apply__1471729482(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Call_apply__1572009162(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Call_map__4155962236(Get_Date(), gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[int64]](__t11)))}), gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[uint32]](Call_pure__3181299446(gopurs_runtime.Value{Type: 9, IntVal: int64(__t12), UnsafePtr: nil}))))}), __t13))}))}
}))
	})
...
return Call_succ__412946465(gopurs_runtime.CoerceToStruct[pkg_Data_Enum.Constructor_Enum[*Constructor_Date]](dict_0_box))
})
	})
...
return gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Call_succ__2858180024(gopurs_runtime.CoerceToStruct[Constructor_Date](v_0_box)))}
})
	})
...
return Call_toEnum__2203070892(gopurs_runtime.CoerceToStruct[pkg_Data_Enum.Constructor_BoundedEnum[*Constructor_Date]](dict_0_box))
})
	})
...
func Get_toEnum__2793813158() gopurs_runtime.Value {
	once_toEnum__2793813158.Do(func() {
		cache_toEnum__2793813158 = gopurs_runtime.Func(func(v_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Call_toEnum__2793813158(v_0_box.IntVal))}
})
	})
...
return Call_eq__3259097883(gopurs_runtime.CoerceToStruct[pkg_Data_Eq.Constructor_Eq[*Constructor_Date]](dict_0_box))
})
	})
...
return gopurs_runtime.Bool(Call_eq__1204755874(gopurs_runtime.CoerceToStruct[Constructor_Date](x_0_box), gopurs_runtime.CoerceToStruct[Constructor_Date](y_1_box)))
})
	})
...
return Call_conj__4093645121(gopurs_runtime.CoerceToStruct[pkg_Data_HeytingAlgebra.Constructor_HeytingAlgebra[*Constructor_Date]](dict_0_box))
})
	})
...
_ = y_0
y_prime_1_0 := gopurs_runtime.Int(Call_fromEnum__3599151655(y_0)).IntVal
_ = y_prime_1_0
return (Call_conj__3676519832(gopurs_runtime.Bool((Call_eq__2843686287(gopurs_runtime.Int(Call_mod__2185172824(gopurs_runtime.Int(y_prime_1_0), gopurs_runtime.Int(4)).IntVal), gopurs_runtime.Int(0)).IntVal) != (0)), gopurs_runtime.Bool((Call_disj__3676519832(gopurs_runtime.Bool((Call_eq__2843686287(gopurs_runtime.Int(Call_mod__2185172824(gopurs_runtime.Int(y_prime_1_0), gopurs_runtime.Int(400)).IntVal), gopurs_runtime.Int(0)).IntVal) != (0)), gopurs_runtime.Bool((Call_not__3201284355(gopurs_runtime.Bool((Call_eq__2843686287(gopurs_runtime.Int(Call_mod__2185172824(gopurs_runtime.Int(y_prime_1_0), gopurs_runtime.Int(100)).IntVal), gopurs_runtime.Int(0)).IntVal) != (0))).IntVal) != (0))).IntVal) != (0))).IntVal) != (0)
}
...
_ = v1_2
return gopurs_runtime.Apply(dictDuration_0.V1, gopurs_runtime.Float(gopurs_runtime.UncurriedApp6(Get_calcDiff(), gopurs_runtime.Int((*Constructor_Date)(gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(v_1)}.UnsafePtr).V0), gopurs_runtime.Int(gopurs_runtime.Int(Call_fromEnum__1196942535((*Constructor_Date)(gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(v_1)}.UnsafePtr).V1)).IntVal), gopurs_runtime.Int((*Constructor_Date)(gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(v_1)}.UnsafePtr).V2), gopurs_runtime.Int((*Constructor_Date)(gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(v1_2)}.UnsafePtr).V0), gopurs_runtime.Int(gopurs_runtime.Int(Call_fromEnum__1196942535((*Constructor_Date)(gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(v1_2)}.UnsafePtr).V1)).IntVal), gopurs_runtime.Int((*Constructor_Date)(gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(v1_2)}.UnsafePtr).V2)).FloatVal()))
}
...
var __t0 gopurs_runtime.Value
{
if (gopurs_runtime.Bool(Call_eq__1204755874(gopurs_runtime.CoerceToStruct[Constructor_Date](gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(Call_canonicalDate(y_0, m_1, d_2))}), gopurs_runtime.CoerceToStruct[Constructor_Date](gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(&Constructor_Date{1, y_0, m_1, d_2})}))).IntVal) != (0) {
...
{
if (v1_3.IntVal) == (0) {
__t8 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]{1, gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Date](v2_4))}})}
goto end_branch_8
} else {
...
{
j_5_1 := Call_add__560788792(gopurs_runtime.Int(v1_3.IntVal), gopurs_runtime.Int(gopurs_runtime.Int(Call_fromEnum__3599151655((*Constructor_Date)(v2_4.UnsafePtr).V2)).IntVal))
_ = j_5_1
low_6_2 := gopurs_runtime.Bool(Call_lessThan__4087042607(gopurs_runtime.Int(j_5_1.IntVal), gopurs_runtime.Int(1)))
_ = low_6_2
var __t4 uint32
{
if (low_6_2.IntVal) != (0) {
__t4 = uint32(Call_fromMaybe__18840980(gopurs_runtime.Value{Type: 9, IntVal: int64(3889233761), UnsafePtr: nil}, gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[uint32]](Call_pred__2010692236(gopurs_runtime.Value{Type: 9, IntVal: int64((*Constructor_Date)(v2_4.UnsafePtr).V1), UnsafePtr: nil})))})).IntVal)
goto end_branch_4
} else {
...
_ = l_7_3
hi_8_5 := gopurs_runtime.Bool(Call_greaterThan__4087042607(gopurs_runtime.Int(j_5_1.IntVal), gopurs_runtime.Int(gopurs_runtime.Int(Call_fromEnum__3599151655(l_7_3.IntVal)).IntVal)))
_ = hi_8_5
var __t6 int64
{
if (low_6_2.IntVal) != (0) {
...
{
if (hi_8_5.IntVal) != (0) {
__t6 = Call_sub__1043827704(gopurs_runtime.Int(Call_sub__1043827704(gopurs_runtime.Int(j_5_1.IntVal), gopurs_runtime.Int(gopurs_runtime.Int(Call_fromEnum__3599151655(l_7_3.IntVal)).IntVal)).IntVal), gopurs_runtime.Int(1)).IntVal
goto end_branch_6
} else {
...
{
if (low_6_2.IntVal) != (0) {
__t7 = gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[*Constructor_Date]](gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Maybe.Get_bindMaybe(), "bind"), gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[*Constructor_Date]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Call_map__3447677596(gopurs_runtime.Apply2(Get_Date(), gopurs_runtime.Int((*Constructor_Date)(v2_4.UnsafePtr).V0), gopurs_runtime.Value{Type: 9, IntVal: int64((*Constructor_Date)(v2_4.UnsafePtr).V1), UnsafePtr: nil}), gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[int64]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Call_toEnum__2099864294(1))})))}))}, gopurs_runtime.RecordGet(Get_enumDate(), "pred")))
goto end_branch_7
} else {
...
{
if (hi_8_5.IntVal) != (0) {
__t7 = gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[*Constructor_Date]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Call_succ__2858180024(gopurs_runtime.CoerceToStruct[Constructor_Date](gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(&Constructor_Date{1, (*Constructor_Date)(v2_4.UnsafePtr).V0, (*Constructor_Date)(v2_4.UnsafePtr).V1, l_7_3.IntVal})})))})
goto end_branch_7
} else {
...
return gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[*Constructor_Date]](gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Call_bind__4062037089(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[int64]](gopurs_runtime.Apply(pkg_Data_Int.Get_fromNumber(), gopurs_runtime.Float(v_0))), gopurs_runtime.Apply2(Get_flip__1826582752(), adj_2_0_0, gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(date_1)})))})
}
...
func Call_apply__1471729482(v_0_loop *pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value], v1_1_loop *pkg_Data_Maybe.Constructor_Just[int64]) *pkg_Data_Maybe.Constructor_Just[*Constructor_Date] {
...
func Call_bind__4062037089(v_0_loop *pkg_Data_Maybe.Constructor_Just[int64], v1_1_loop gopurs_runtime.Value) *pkg_Data_Maybe.Constructor_Just[*Constructor_Date] {
...
func Call_succ__412946465(dict_0_loop *pkg_Data_Enum.Constructor_Enum[*Constructor_Date]) gopurs_runtime.Value {
var dict_0 *pkg_Data_Enum.Constructor_Enum[*Constructor_Date] = dict_0_loop
_ = dict_0
return dict_0.V2
}
...
func Call_succ__2858180024(v_0_loop *Constructor_Date) *pkg_Data_Maybe.Constructor_Just[*Constructor_Date] {
var v_0 *Constructor_Date = v_0_loop
_ = v_0
sm_1_0 := gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[uint32]](gopurs_runtime.Apply(gopurs_runtime.RecordGet(pkg_Data_Date_Component.Get_enumMonth(), "succ"), gopurs_runtime.Value{Type: 9, IntVal: int64((*Constructor_Date)(gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(v_0)}.UnsafePtr).V1), UnsafePtr: nil}))
_ = sm_1_0
v1_2_1 := gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[int64]](gopurs_runtime.Apply(gopurs_runtime.RecordGet(pkg_Data_Date_Component.Get_enumDay(), "succ"), gopurs_runtime.Int((*Constructor_Date)(gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(v_0)}.UnsafePtr).V2)))
_ = v1_2_1
var __t5 gopurs_runtime.Value
{
var __t4 bool
{
var __t_tag_3 gopurs_runtime.Value = gopurs_runtime.Apply2(gopurs_runtime.CoerceToStruct[pkg_Data_Ord.Constructor_Ord[*pkg_Data_Maybe.Constructor_Just[int64]]](Get_ordMaybe()).V1, gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(v1_2_1)}, gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]{1, gopurs_runtime.Int(gopurs_runtime.Int(Call_lastDayOfMonth((*Constructor_Date)(gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(v_0)}.UnsafePtr).V0, (*Constructor_Date)(gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(v_0)}.UnsafePtr).V1)).IntVal)})})
...
__t8 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[int64]](gopurs_runtime.Apply(gopurs_runtime.RecordGet(pkg_Data_Date_Component.Get_enumYear(), "succ"), gopurs_runtime.Int((*Constructor_Date)(gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(v_0)}.UnsafePtr).V0))))}
goto end_branch_8
} else {
...
{
__t8 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]{1, gopurs_runtime.Int((*Constructor_Date)(gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(v_0)}.UnsafePtr).V0)})}
}
end_branch_8:
var __t11 uint32
{
...
{
__t11 = (*Constructor_Date)(gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(v_0)}.UnsafePtr).V1
}
end_branch_11:
var __t13 *pkg_Data_Maybe.Constructor_Just[int64]
{
...
end_branch_13:
return gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[*Constructor_Date]](gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Maybe.Get_applyMaybe(), "apply"), gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]](gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Maybe.Get_applyMaybe(), "apply"), gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]](gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Maybe.Get_functorMaybe(), "map"), Get_Date(), gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[int64]](__t8))})))}, gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[uint32]](gopurs_runtime.Apply(gopurs_runtime.RecordGet(pkg_Data_Maybe.Get_applicativeMaybe(), "pure"), gopurs_runtime.Value{Type: 9, IntVal: int64(__t11), UnsafePtr: nil})))})))}, gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(__t13)}))
}

func Call_toEnum__2203070892(dict_0_loop *pkg_Data_Enum.Constructor_BoundedEnum[*Constructor_Date]) gopurs_runtime.Value {
var dict_0 *pkg_Data_Enum.Constructor_BoundedEnum[*Constructor_Date] = dict_0_loop
_ = dict_0
return dict_0.V4
}
...
func Call_toEnum__2793813158(v_0_loop int64) *pkg_Data_Maybe.Constructor_Just[uint32] {
var v_0 int64 = v_0_loop
_ = v_0
var __t0 gopurs_runtime.Value
{
if (v_0) == (1) {
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]{1, gopurs_runtime.Value{Type: 9, IntVal: int64(2900196686), UnsafePtr: nil}})}
goto end_branch_0
} else {
...
{
if (v_0) == (2) {
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]{1, gopurs_runtime.Value{Type: 9, IntVal: int64(20457557), UnsafePtr: nil}})}
goto end_branch_0
} else {
...
{
if (v_0) == (3) {
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]{1, gopurs_runtime.Value{Type: 9, IntVal: int64(4227105004), UnsafePtr: nil}})}
goto end_branch_0
} else {
...
{
if (v_0) == (4) {
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]{1, gopurs_runtime.Value{Type: 9, IntVal: int64(3818857258), UnsafePtr: nil}})}
goto end_branch_0
} else {
...
{
if (v_0) == (5) {
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]{1, gopurs_runtime.Value{Type: 9, IntVal: int64(2946274527), UnsafePtr: nil}})}
goto end_branch_0
} else {
...
{
if (v_0) == (6) {
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]{1, gopurs_runtime.Value{Type: 9, IntVal: int64(1070786179), UnsafePtr: nil}})}
goto end_branch_0
} else {
...
{
if (v_0) == (7) {
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]{1, gopurs_runtime.Value{Type: 9, IntVal: int64(1326716170), UnsafePtr: nil}})}
goto end_branch_0
} else {
...
func Call_eq__3259097883(dict_0_loop *pkg_Data_Eq.Constructor_Eq[*Constructor_Date]) gopurs_runtime.Value {
var dict_0 *pkg_Data_Eq.Constructor_Eq[*Constructor_Date] = dict_0_loop
_ = dict_0
return dict_0.V0
}
...
func Call_eq__1204755874(x_0_loop *Constructor_Date, y_1_loop *Constructor_Date) bool {
var x_0 *Constructor_Date = x_0_loop
_ = x_0
var y_1 *Constructor_Date = y_1_loop
_ = y_1
return (gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_HeytingAlgebra.Get_heytingAlgebraBoolean(), "conj"), gopurs_runtime.Bool((gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_HeytingAlgebra.Get_heytingAlgebraBoolean(), "conj"), gopurs_runtime.Bool((gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Date_Component.Get_eqYear(), "eq"), gopurs_runtime.Int((*Constructor_Date)(gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(x_0)}.UnsafePtr).V0), gopurs_runtime.Int((*Constructor_Date)(gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(y_1)}.UnsafePtr).V0)).IntVal) != (0)), gopurs_runtime.Bool((gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Date_Component.Get_eqMonth(), "eq"), gopurs_runtime.Value{Type: 9, IntVal: int64((*Constructor_Date)(gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(x_0)}.UnsafePtr).V1), UnsafePtr: nil}, gopurs_runtime.Value{Type: 9, IntVal: int64((*Constructor_Date)(gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(y_1)}.UnsafePtr).V1), UnsafePtr: nil}).IntVal) != (0))).IntVal) != (0)), gopurs_runtime.Bool((gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Date_Component.Get_eqDay(), "eq"), gopurs_runtime.Int((*Constructor_Date)(gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(x_0)}.UnsafePtr).V2), gopurs_runtime.Int((*Constructor_Date)(gopurs_runtime.Value{Type: 9, IntVal: 745776346, UnsafePtr: unsafe.Pointer(y_1)}.UnsafePtr).V2)).IntVal) != (0))).IntVal) != (0)
}
...
func Call_map__3447677596(v_0_loop gopurs_runtime.Value, v1_1_loop *pkg_Data_Maybe.Constructor_Just[int64]) *pkg_Data_Maybe.Constructor_Just[*Constructor_Date] {
...
func Call_conj__4093645121(dict_0_loop *pkg_Data_HeytingAlgebra.Constructor_HeytingAlgebra[*Constructor_Date]) gopurs_runtime.Value {
var dict_0 *pkg_Data_HeytingAlgebra.Constructor_HeytingAlgebra[*Constructor_Date] = dict_0_loop
_ = dict_0
return dict_0.V0
}
