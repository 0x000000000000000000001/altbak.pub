...
func Get_divisiblePredicate() gopurs_runtime.Value {
	once_divisiblePredicate.Do(func() {
		cache_divisiblePredicate = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Divide0", "conquer", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Any(Call_divisibleOp(dictMonoid_0_box))
})
	})
...
func Get_divisibleEquivalence() gopurs_runtime.Value {
	once_divisibleEquivalence.Do(func() {
		cache_divisibleEquivalence = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Divide0", "conquer", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_divisibleComparison() gopurs_runtime.Value {
	once_divisibleComparison.Do(func() {
		cache_divisibleComparison = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Divide0", "conquer", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Any(Call_conquer(dict_0_box))
})
	})
	return cache_conquer
}

func Call_divisibleOp(dictMonoid_0_loop gopurs_runtime.Value) interface{} {
...
_ = __local_var_2_1
return gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict2("Divide0", "conquer", gopurs_runtime.Func(func(_dollar__unused_2 gopurs_runtime.Value) gopurs_runtime.Value {
return divideOp_1_0
...
func Call_conquer(dict_0_loop gopurs_runtime.Value) interface{} {
var dict_0 gopurs_runtime.Value = dict_0_loop
_ = dict_0
return gopurs_runtime.UnboxAny(gopurs_runtime.RecordGet(dict_0, "conquer"))
}
