...
return Call_divisibleOp((*Record_mempty_gopurs_runtime_Value)(dictMonoid_0_box.UnsafePtr))
})
	})
...
return Call_conquer((*Record_conquer_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
...
func Call_divisibleOp(dictMonoid_0_loop *Record_mempty_gopurs_runtime_Value) gopurs_runtime.Value {
var dictMonoid_0 *Record_mempty_gopurs_runtime_Value = dictMonoid_0_loop
_ = dictMonoid_0
divideOp_1_0 := gopurs_runtime.Apply(pkg_Data_Divide.Get_divideOp(), gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictMonoid_0)}, "Semigroup0_NOT_FOUND"), gopurs_runtime.Value{}))
_ = divideOp_1_0
...
func Call_conquer(dict_0_loop *Record_conquer_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_conquer_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.conquer
}
