...
var cache_profunctorFn__ptrConstructor_Profunctor_gopurs_runtime_Value__542207281 gopurs_runtime.Value
var once_profunctorFn__ptrConstructor_Profunctor_gopurs_runtime_Value__542207281 sync.Once
func Get_profunctorFn__ptrConstructor_Profunctor_gopurs_runtime_Value__542207281() gopurs_runtime.Value {
	once_profunctorFn__ptrConstructor_Profunctor_gopurs_runtime_Value__542207281.Do(func() {
		cache_profunctorFn__ptrConstructor_Profunctor_gopurs_runtime_Value__542207281 = gopurs_runtime.Value{Type: 9, IntVal: 2367018778, UnsafePtr: unsafe.Pointer(&Constructor_Profunctor[gopurs_runtime.Value]{1, gopurs_runtime.Func(func(a2b_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(c2d_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(b2c_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(x_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(c2d_1, gopurs_runtime.Apply(b2c_2, gopurs_runtime.Apply(a2b_0, x_3)))
	...
	return cache_profunctorFn__ptrConstructor_Profunctor_gopurs_runtime_Value__542207281
}
...
return Call_dimap(gopurs_runtime.CoerceToStruct[Constructor_Profunctor[gopurs_runtime.Value]](dict_0_box))
})
	})
	return cache_dimap
}
...
return Call_dimap__gopurs_runtime_Value_1466332548(gopurs_runtime.CoerceToStruct[Constructor_Profunctor[gopurs_runtime.Value]](dict_0_box))
})
	})
...
return Call_lcmap(gopurs_runtime.CoerceToStruct[Constructor_Profunctor[gopurs_runtime.Value]](dictProfunctor_0_box), a2b_1_box)
})
	})
	return cache_lcmap
}
...
return Call_lcmap__gopurs_runtime_Value_1762133278(gopurs_runtime.CoerceToStruct[Constructor_Profunctor[gopurs_runtime.Value]](dictProfunctor_0_box), a2b_1_box)
})
	})
...
return Call_rmap(gopurs_runtime.CoerceToStruct[Constructor_Profunctor[gopurs_runtime.Value]](dictProfunctor_0_box), b2c_1_box)
})
	})
	return cache_rmap
}
...
return Call_rmap__gopurs_runtime_Value_1762133278(gopurs_runtime.CoerceToStruct[Constructor_Profunctor[gopurs_runtime.Value]](dictProfunctor_0_box), b2c_1_box)
})
	})
...
return Call_unwrapIso(gopurs_runtime.CoerceToStruct[Constructor_Profunctor[gopurs_runtime.Value]](dictProfunctor_0_box), gopurs_runtime.CoerceToStruct[pkg_Data_Newtype.Constructor_Newtype[gopurs_runtime.Value, gopurs_runtime.Value]](_dollar__unused_1_box))
})
	})
...
return Call_wrapIso(gopurs_runtime.CoerceToStruct[Constructor_Profunctor[gopurs_runtime.Value]](dictProfunctor_0_box), gopurs_runtime.CoerceToStruct[pkg_Data_Newtype.Constructor_Newtype[gopurs_runtime.Value, gopurs_runtime.Value]](_dollar__unused_1_box), v_2_box)
})
	})
...
return Call_arr(gopurs_runtime.CoerceToStruct[pkg_Control_Category.Constructor_Category[gopurs_runtime.Value]](dictCategory_0_box))
})
	})
	return cache_arr
}

type Constructor_Profunctor[T_p any] struct {
	Rc uint32
...
func init() {
	gopurs_runtime.StructGetters[2367018778] = func(ptr unsafe.Pointer, key string) gopurs_runtime.Value {
		c := (*Constructor_Profunctor[gopurs_runtime.Value])(ptr)
		switch key {
		case "dimap": return c.V0
		default: panic("Key not found in dictionary Constructor_Profunctor: " + key)
		}
	}
}
...
func Call_dimap(dict_0_loop *Constructor_Profunctor[gopurs_runtime.Value]) gopurs_runtime.Value {
var dict_0 *Constructor_Profunctor[gopurs_runtime.Value] = dict_0_loop
_ = dict_0
return dict_0.V0
}

func Call_dimap__gopurs_runtime_Value_1466332548(dict_0_loop *Constructor_Profunctor[gopurs_runtime.Value]) gopurs_runtime.Value {
var dict_0 *Constructor_Profunctor[gopurs_runtime.Value] = dict_0_loop
_ = dict_0
return dict_0.V0
}

func Call_lcmap(dictProfunctor_0_loop *Constructor_Profunctor[gopurs_runtime.Value], a2b_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictProfunctor_0 *Constructor_Profunctor[gopurs_runtime.Value] = dictProfunctor_0_loop
_ = dictProfunctor_0
var a2b_1 gopurs_runtime.Value = a2b_1_loop
_ = a2b_1
return gopurs_runtime.Apply2(dictProfunctor_0.V0, a2b_1, Get_identity())
}

func Call_lcmap__gopurs_runtime_Value_1762133278(dictProfunctor_0_loop *Constructor_Profunctor[gopurs_runtime.Value], a2b_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictProfunctor_0 *Constructor_Profunctor[gopurs_runtime.Value] = dictProfunctor_0_loop
_ = dictProfunctor_0
var a2b_1 gopurs_runtime.Value = a2b_1_loop
_ = a2b_1
...
func Call_rmap(dictProfunctor_0_loop *Constructor_Profunctor[gopurs_runtime.Value], b2c_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictProfunctor_0 *Constructor_Profunctor[gopurs_runtime.Value] = dictProfunctor_0_loop
_ = dictProfunctor_0
var b2c_1 gopurs_runtime.Value = b2c_1_loop
_ = b2c_1
return gopurs_runtime.Apply2(dictProfunctor_0.V0, Get_identity1(), b2c_1)
}

func Call_rmap__gopurs_runtime_Value_1762133278(dictProfunctor_0_loop *Constructor_Profunctor[gopurs_runtime.Value], b2c_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictProfunctor_0 *Constructor_Profunctor[gopurs_runtime.Value] = dictProfunctor_0_loop
_ = dictProfunctor_0
var b2c_1 gopurs_runtime.Value = b2c_1_loop
_ = b2c_1
...
func Call_unwrapIso(dictProfunctor_0_loop *Constructor_Profunctor[gopurs_runtime.Value], _dollar__unused_1_loop *pkg_Data_Newtype.Constructor_Newtype[gopurs_runtime.Value, gopurs_runtime.Value]) gopurs_runtime.Value {
var dictProfunctor_0 *Constructor_Profunctor[gopurs_runtime.Value] = dictProfunctor_0_loop
_ = dictProfunctor_0
...
_ = _dollar__unused_1
return gopurs_runtime.Apply2(dictProfunctor_0.V0, pkg_Unsafe_Coerce.Get_unsafeCoerce(), pkg_Unsafe_Coerce.Get_unsafeCoerce())
}

func Call_wrapIso(dictProfunctor_0_loop *Constructor_Profunctor[gopurs_runtime.Value], _dollar__unused_1_loop *pkg_Data_Newtype.Constructor_Newtype[gopurs_runtime.Value, gopurs_runtime.Value], v_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictProfunctor_0 *Constructor_Profunctor[gopurs_runtime.Value] = dictProfunctor_0_loop
_ = dictProfunctor_0
var _dollar__unused_1 *pkg_Data_Newtype.Constructor_Newtype[gopurs_runtime.Value, gopurs_runtime.Value] = _dollar__unused_1_loop
_ = _dollar__unused_1
...
func Call_arr(dictCategory_0_loop *pkg_Control_Category.Constructor_Category[gopurs_runtime.Value]) gopurs_runtime.Value {
var dictCategory_0 *pkg_Control_Category.Constructor_Category[gopurs_runtime.Value] = dictCategory_0_loop
_ = dictCategory_0
identity2_1_0 := dictCategory_0.V1
_ = identity2_1_0
