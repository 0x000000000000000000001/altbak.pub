...
return Call_dimap((*Record_dimap_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
	return cache_dimap
}
...
return Call_lcmap((*Record_dimap_gopurs_runtime_Value)(dictProfunctor_0_box.UnsafePtr), a2b_1_box)
})
	})
	return cache_lcmap
}
...
return Call_rmap((*Record_dimap_gopurs_runtime_Value)(dictProfunctor_0_box.UnsafePtr), b2c_1_box)
})
	})
	return cache_rmap
}
...
return Call_unwrapIso((*Record_dimap_gopurs_runtime_Value)(dictProfunctor_0_box.UnsafePtr), (*Record_)(_dollar__unused_1_box.UnsafePtr))
})
	})
...
return Call_wrapIso((*Record_dimap_gopurs_runtime_Value)(dictProfunctor_0_box.UnsafePtr), (*Record_)(_dollar__unused_1_box.UnsafePtr), v_2_box)
})
	})
...
return Call_arr((*Record_identity_gopurs_runtime_Value)(dictCategory_0_box.UnsafePtr))
})
	})
	return cache_arr
}
...
func Call_dimap(dict_0_loop *Record_dimap_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_dimap_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.dimap
}

func Call_lcmap(dictProfunctor_0_loop *Record_dimap_gopurs_runtime_Value, a2b_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictProfunctor_0 *Record_dimap_gopurs_runtime_Value = dictProfunctor_0_loop
_ = dictProfunctor_0
var a2b_1 gopurs_runtime.Value = a2b_1_loop
_ = a2b_1
return gopurs_runtime.Apply2(dictProfunctor_0.dimap, a2b_1, Get_identity())
}

func Call_rmap(dictProfunctor_0_loop *Record_dimap_gopurs_runtime_Value, b2c_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictProfunctor_0 *Record_dimap_gopurs_runtime_Value = dictProfunctor_0_loop
_ = dictProfunctor_0
var b2c_1 gopurs_runtime.Value = b2c_1_loop
_ = b2c_1
return gopurs_runtime.Apply2(dictProfunctor_0.dimap, Get_identity(), b2c_1)
}

func Call_unwrapIso(dictProfunctor_0_loop *Record_dimap_gopurs_runtime_Value, _dollar__unused_1_loop *Record_) gopurs_runtime.Value {
var dictProfunctor_0 *Record_dimap_gopurs_runtime_Value = dictProfunctor_0_loop
_ = dictProfunctor_0
var _dollar__unused_1 *Record_ = _dollar__unused_1_loop
_ = _dollar__unused_1
return gopurs_runtime.Apply2(dictProfunctor_0.dimap, pkg_Unsafe_Coerce.Get_unsafeCoerce(), pkg_Unsafe_Coerce.Get_unsafeCoerce())
}

func Call_wrapIso(dictProfunctor_0_loop *Record_dimap_gopurs_runtime_Value, _dollar__unused_1_loop *Record_, v_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictProfunctor_0 *Record_dimap_gopurs_runtime_Value = dictProfunctor_0_loop
_ = dictProfunctor_0
var _dollar__unused_1 *Record_ = _dollar__unused_1_loop
_ = _dollar__unused_1
...
func Call_arr(dictCategory_0_loop *Record_identity_gopurs_runtime_Value) gopurs_runtime.Value {
