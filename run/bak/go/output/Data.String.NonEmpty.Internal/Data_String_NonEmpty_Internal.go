...
func Get_NonEmptyString() gopurs_runtime.Value {
	once_NonEmptyString.Do(func() {
		cache_NonEmptyString = gopurs_runtime.Func(func(x_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_NonEmptyReplacement() gopurs_runtime.Value {
	once_NonEmptyReplacement.Do(func() {
		cache_NonEmptyReplacement = gopurs_runtime.Func(func(x_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
var x_0 gopurs_runtime.Value = x_0_loop
_ = x_0
return x_0
...
func Get_toUpper() gopurs_runtime.Value {
	once_toUpper.Do(func() {
		cache_toUpper = gopurs_runtime.Func(func(v_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
...
func Get_toString() gopurs_runtime.Value {
	once_toString.Do(func() {
		cache_toString = gopurs_runtime.Func(func(v_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
var v_0 gopurs_runtime.Value = v_0_loop
_ = v_0
return v_0
...
func Get_toLower() gopurs_runtime.Value {
	once_toLower.Do(func() {
		cache_toLower = gopurs_runtime.Func(func(v_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
var v_0 gopurs_runtime.Value = v_0_loop
_ = v_0
...
func Get_nonEmptyNonEmpty() gopurs_runtime.Value {
	once_nonEmptyNonEmpty.Do(func() {
		cache_nonEmptyNonEmpty = gopurs_runtime.Func(func(dictIsSymbol_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
...
func Get_nes() gopurs_runtime.Value {
	once_nes.Do(func() {
		cache_nes = gopurs_runtime.Func(func(dict_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
...
func Get_makeNonEmptyBad() gopurs_runtime.Value {
	once_makeNonEmptyBad.Do(func() {
		cache_makeNonEmptyBad = gopurs_runtime.Func(func(_dollar__unused_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
...
func Get_joinWith1() gopurs_runtime.Value {
	once_joinWith1.Do(func() {
		cache_joinWith1 = gopurs_runtime.Func(func(dictFoldable1_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
...
func Get_joinWith() gopurs_runtime.Value {
	once_joinWith.Do(func() {
		cache_joinWith = gopurs_runtime.Func3(func(dictFoldable_0_box gopurs_runtime.Value, splice_1_box gopurs_runtime.Value, xs_2_box gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_join1With() gopurs_runtime.Value {
	once_join1With.Do(func() {
		cache_join1With = gopurs_runtime.Func(func(dictFoldable1_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
var dictFoldable1_0 gopurs_runtime.Value = dictFoldable1_0_loop
_ = dictFoldable1_0
__local_var_1_0 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictFoldable1_0, "Foldable0"), gopurs_runtime.Value{})
...
func Get_fromString() gopurs_runtime.Value {
	once_fromString.Do(func() {
		cache_fromString = gopurs_runtime.Func(func(v_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
var v_0 gopurs_runtime.Value = v_0_loop
_ = v_0
...
func Get_trim() gopurs_runtime.Value {
	once_trim.Do(func() {
		cache_trim = gopurs_runtime.Func(func(v_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
var v_0 gopurs_runtime.Value = v_0_loop
_ = v_0
...
func Get_contains() gopurs_runtime.Value {
	once_contains.Do(func() {
		cache_contains = gopurs_runtime.Func(func(x_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
var x_0 gopurs_runtime.Value = x_0_loop
_ = x_0
...
{
__t2 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Data_Data_Maybe_Just{(*pkg_Data_Maybe.Data_Data_Maybe_Just)(__local_var_2_0.UnsafePtr).V0})}
}
end_branch_2:
__t1 = __t2
goto end_branch_1
