...
{
if (gopurs_runtime.Bool(gopurs_runtime.ConstructorGet(__local_var_2_0, 0).StrVal == gopurs_runtime.Str("").StrVal)).IntVal != 0 {
...
{
__t2 = gopurs_runtime.Constructor1("Just", gopurs_runtime.ConstructorGet(__local_var_2_0, 0))
}
end_branch_2:
__t1 = __t2
goto end_branch_1
