...
func Get_composeKleisliFlipped() gopurs_runtime.Value {
	once_composeKleisliFlipped.Do(func() {
		cache_composeKleisliFlipped = gopurs_runtime.Func3(func(f_0_box gopurs_runtime.Value, g_1_box gopurs_runtime.Value, a_2_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_composeKleisliFlipped(f_0_box, g_1_box, a_2_box)
})
	})
...
var cache_liftS__gopurs_runtime_Value_895676186 gopurs_runtime.Value
var once_liftS__gopurs_runtime_Value_895676186 sync.Once
func Get_liftS__gopurs_runtime_Value_895676186() gopurs_runtime.Value {
	once_liftS__gopurs_runtime_Value_895676186.Do(func() {
		cache_liftS__gopurs_runtime_Value_895676186 = gopurs_runtime.Func2(func(f_0_box gopurs_runtime.Value, v_1_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Bool(Call_liftS__gopurs_runtime_Value_895676186(f_0_box, v_1_box.StrVal()))
})
	})
	return cache_liftS__gopurs_runtime_Value_895676186
}

var cache_liftS__gopurs_runtime_Value_4000603354 gopurs_runtime.Value
var once_liftS__gopurs_runtime_Value_4000603354 sync.Once
func Get_liftS__gopurs_runtime_Value_4000603354() gopurs_runtime.Value {
	once_liftS__gopurs_runtime_Value_4000603354.Do(func() {
		cache_liftS__gopurs_runtime_Value_4000603354 = gopurs_runtime.Func2(func(f_0_box gopurs_runtime.Value, v_1_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Call_liftS__gopurs_runtime_Value_4000603354(f_0_box, v_1_box.StrVal()))}
})
	})
	return cache_liftS__gopurs_runtime_Value_4000603354
}

var cache_liftS__gopurs_runtime_Value_3197146330 gopurs_runtime.Value
var once_liftS__gopurs_runtime_Value_3197146330 sync.Once
func Get_liftS__gopurs_runtime_Value_3197146330() gopurs_runtime.Value {
	once_liftS__gopurs_runtime_Value_3197146330.Do(func() {
		cache_liftS__gopurs_runtime_Value_3197146330 = gopurs_runtime.Func2(func(f_0_box gopurs_runtime.Value, v_1_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_liftS__gopurs_runtime_Value_3197146330(f_0_box, v_1_box.StrVal())
})
	})
	return cache_liftS__gopurs_runtime_Value_3197146330
}
...
var cache_joinWith__gopurs_runtime_Value_3583909088 gopurs_runtime.Value
var once_joinWith__gopurs_runtime_Value_3583909088 sync.Once
func Get_joinWith__gopurs_runtime_Value_3583909088() gopurs_runtime.Value {
	once_joinWith__gopurs_runtime_Value_3583909088.Do(func() {
		cache_joinWith__gopurs_runtime_Value_3583909088 = gopurs_runtime.Func(func(dictFoldable_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_joinWith__gopurs_runtime_Value_3583909088(dictFoldable_0_box)
})
	})
	return cache_joinWith__gopurs_runtime_Value_3583909088
}
...
func Call_composeKleisliFlipped(f_0_loop gopurs_runtime.Value, g_1_loop gopurs_runtime.Value, a_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Str(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictIsSymbol_0, "reflectSymbol"), p_1).StrVal())
}))
}
...
func Call_liftS__gopurs_runtime_Value_895676186(f_0_loop gopurs_runtime.Value, v_1_loop string) bool {
var f_0 gopurs_runtime.Value = f_0_loop
_ = f_0
var v_1 string = v_1_loop
_ = v_1
...
func Call_liftS__gopurs_runtime_Value_4000603354(f_0_loop gopurs_runtime.Value, v_1_loop string) *pkg_Data_Maybe.Constructor_Just[string] {
var f_0 gopurs_runtime.Value = f_0_loop
_ = f_0
var v_1 string = v_1_loop
_ = v_1
return (*pkg_Data_Maybe.Constructor_Just[string])(gopurs_runtime.Apply(f_0, gopurs_runtime.Str(v_1)).UnsafePtr)
}

func Call_liftS__gopurs_runtime_Value_3197146330(f_0_loop gopurs_runtime.Value, v_1_loop string) gopurs_runtime.Value {
var f_0 gopurs_runtime.Value = f_0_loop
_ = f_0
var v_1 string = v_1_loop
_ = v_1
...
return gopurs_runtime.RecordGet(gopurs_runtime.Apply3(gopurs_runtime.RecordGet(__local_var_1_0, "foldl"), gopurs_runtime.Func(func(v_5 gopurs_runtime.Value) gopurs_runtime.Value {
...
}), gopurs_runtime.RecordDict2("acc", "init", gopurs_runtime.RecordGet(pkg_Data_Monoid.Get_monoidString(), "mempty"), gopurs_runtime.Bool(true)), x_4), "acc")
})
})
}
...
return gopurs_runtime.RecordGet(gopurs_runtime.Apply3(gopurs_runtime.RecordGet(dictFoldable_0, "foldl"), gopurs_runtime.Func(func(v_4 gopurs_runtime.Value) gopurs_runtime.Value {
...
}), gopurs_runtime.RecordDict2("acc", "init", gopurs_runtime.RecordGet(pkg_Data_Monoid.Get_monoidString(), "mempty"), gopurs_runtime.Bool(true)), x_3), "acc")
})
})
}

func Call_joinWith__gopurs_runtime_Value_3583909088(dictFoldable_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictFoldable_0 gopurs_runtime.Value = dictFoldable_0_loop
_ = dictFoldable_0
__local_var_1_0 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(pkg_Data_Monoid.Get_monoidString(), "Semigroup0"), gopurs_runtime.Value{})
_ = __local_var_1_0
...
var dictFoldable1_0 gopurs_runtime.Value = dictFoldable1_0_loop
_ = dictFoldable1_0
joinWith2_1_0 := Call_joinWith(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictFoldable1_0, "Foldable0"), gopurs_runtime.Value{}))
_ = joinWith2_1_0
return gopurs_runtime.Func(func(splice_2 gopurs_runtime.Value) gopurs_runtime.Value {
__local_var_3_1 := gopurs_runtime.Apply(joinWith2_1_0, splice_2)
_ = __local_var_3_1
return gopurs_runtime.Func(func(x_4 gopurs_runtime.Value) gopurs_runtime.Value {
...
{
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer((*pkg_Data_Maybe.Constructor_Just[string])(gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]{1, gopurs_runtime.Str(v_0)})}.UnsafePtr))}
}
end_branch_0:
...
var pat_0 string = pat_0_loop
_ = pat_0
return gopurs_runtime.Apply2(Get_composeKleisliFlipped(), Get_fromString(), gopurs_runtime.Func(func(v_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(pkg_Data_String_CodeUnits.Get_stripPrefix(), gopurs_runtime.Str(pat_0), v_1)
}))
}
...
_ = pat_0
return gopurs_runtime.Apply2(Get_composeKleisliFlipped(), Get_fromString(), gopurs_runtime.Func(func(v_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(pkg_Data_String_CodeUnits.Get_stripSuffix(), gopurs_runtime.Str(pat_0), v_1)
}))
}
...
__t1 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer((*pkg_Data_Maybe.Constructor_Just[string])(gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: nil}.UnsafePtr))}
goto end_branch_1
} else {
...
{
__t1 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer((*pkg_Data_Maybe.Constructor_Just[string])(gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]{1, __local_var_1_0})}.UnsafePtr))}
}
end_branch_1:
