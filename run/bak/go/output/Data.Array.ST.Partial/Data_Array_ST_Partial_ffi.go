...
var _Gopurs_PeekImpl = // TAST: (ForAll [h, a] (ADT ["Control","Monad","ST","Uncurried","STFn2"] [Int, (ADT ["Data","Array","ST","STArray"] [(TypeVar h), (TypeVar a)]), (TypeVar h), (TypeVar a)]))
...
var _Gopurs_PokeImpl = // TAST: (ForAll [h, a] (ADT ["Control","Monad","ST","Uncurried","STFn3"] [Int, (TypeVar a), (ADT ["Data","Array","ST","STArray"] [(TypeVar h), (TypeVar a)]), (TypeVar h), Unit]))
