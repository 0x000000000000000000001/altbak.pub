...
return Call_poke(_dollar__unused_0_box)
})
	})
	return cache_poke
}
...
return Call_peek(_dollar__unused_0_box)
})
	})
	return cache_peek
}
...
func Call_peek(_dollar__unused_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
var _dollar__unused_0 gopurs_runtime.Value = _dollar__unused_0_loop
_ = _dollar__unused_0
