...
func Get_poke() gopurs_runtime.Value {
	once_poke.Do(func() {
		cache_poke = gopurs_runtime.Func(func(_dollar__unused_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_poke((*Record_)(_dollar__unused_0_box.UnsafePtr))
})
	})
	return cache_poke
}
...
func Get_peek() gopurs_runtime.Value {
	once_peek.Do(func() {
		cache_peek = gopurs_runtime.Func(func(_dollar__unused_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_peek((*Record_)(_dollar__unused_0_box.UnsafePtr))
})
	})
	return cache_peek
}
...
func Call_poke(_dollar__unused_0_loop *Record_) gopurs_runtime.Value {
...
func Call_peek(_dollar__unused_0_loop *Record_) gopurs_runtime.Value {
var _dollar__unused_0 *Record_ = _dollar__unused_0_loop
_ = _dollar__unused_0
