...
return gopurs_runtime.Value{Type: 9, IntVal: 3478632216, UnsafePtr: unsafe.Pointer(&Constructor_Inl[gopurs_runtime.Value, gopurs_runtime.Value]{gopurs_runtime.UnboxAny(value0)})}
})
	})
	return cache_Inl
}
...
return gopurs_runtime.Value{Type: 9, IntVal: 492034566, UnsafePtr: unsafe.Pointer(&Constructor_Inr[gopurs_runtime.Value, gopurs_runtime.Value]{gopurs_runtime.UnboxAny(value0)})}
})
	})
	return cache_Inr
}
...
return gopurs_runtime.Value{Type: 9, IntVal: 1171963320, UnsafePtr: unsafe.Pointer(&Constructor_Product[gopurs_runtime.Value, gopurs_runtime.Value]{gopurs_runtime.UnboxAny(value0), gopurs_runtime.UnboxAny(value1)})}
})
})
	})
...
var cache_to__func_gopurs_runtime_Value__interface____interface___2695181986 gopurs_runtime.Value
var once_to__func_gopurs_runtime_Value__interface____interface___2695181986 sync.Once
func Get_to__func_gopurs_runtime_Value__interface____interface___2695181986() gopurs_runtime.Value {
	once_to__func_gopurs_runtime_Value__interface____interface___2695181986.Do(func() {
		cache_to__func_gopurs_runtime_Value__interface____interface___2695181986 = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_to__func_gopurs_runtime_Value__interface____interface___2695181986(dict_0_box)
})
	})
	return cache_to__func_gopurs_runtime_Value__interface____interface___2695181986
}
...
return gopurs_runtime.Any(Call_showSum(dictShow_0_box, dictShow1_1_box))
})
	})
...
func Get_showNoArguments() gopurs_runtime.Value {
	once_showNoArguments.Do(func() {
		cache_showNoArguments = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("show", gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Any(Call_showConstructor(dictIsSymbol_0_box, dictShow_1_box))
})
	})
...
return gopurs_runtime.Any(Call_showArgument(dictShow_0_box))
})
	})
...
var cache_from__func_gopurs_runtime_Value__interface____interface___4189692514 gopurs_runtime.Value
var once_from__func_gopurs_runtime_Value__interface____interface___4189692514 sync.Once
func Get_from__func_gopurs_runtime_Value__interface____interface___4189692514() gopurs_runtime.Value {
	once_from__func_gopurs_runtime_Value__interface____interface___4189692514.Do(func() {
		cache_from__func_gopurs_runtime_Value__interface____interface___4189692514 = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_from__func_gopurs_runtime_Value__interface____interface___4189692514(dict_0_box)
})
	})
	return cache_from__func_gopurs_runtime_Value__interface____interface___4189692514
}
...
func Call_to__func_gopurs_runtime_Value__interface____interface___2695181986(dict_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dict_0 gopurs_runtime.Value = dict_0_loop
_ = dict_0
return gopurs_runtime.RecordGet(dict_0, "to")
}

func Call_showSum(dictShow_0_loop gopurs_runtime.Value, dictShow1_1_loop gopurs_runtime.Value) interface{} {
...
__t0 = gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str("(Inr "), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictShow1_1, "show"), gopurs_runtime.Any((*Constructor_Inr[gopurs_runtime.Value, gopurs_runtime.Value])(v_2.UnsafePtr).V0)), gopurs_runtime.Str(")")))
goto end_branch_0
} else {
...
_ = dictShow1_1
return gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("show", gopurs_runtime.Func(func(v_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str("(Product "), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictShow_0, "show"), gopurs_runtime.Any((*Constructor_Product[gopurs_runtime.Value, gopurs_runtime.Value])(v_2.UnsafePtr).V0)), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str(" "), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictShow1_1, "show"), gopurs_runtime.Any((*Constructor_Product[gopurs_runtime.Value, gopurs_runtime.Value])(v_2.UnsafePtr).V1)), gopurs_runtime.Str(")")))))
})))
}

func Call_showConstructor(dictIsSymbol_0_loop gopurs_runtime.Value, dictShow_1_loop gopurs_runtime.Value) interface{} {
var dictIsSymbol_0 gopurs_runtime.Value = dictIsSymbol_0_loop
_ = dictIsSymbol_0
var dictShow_1 gopurs_runtime.Value = dictShow_1_loop
_ = dictShow_1
return gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("show", gopurs_runtime.Func(func(v_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str("(Constructor @"), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Apply(gopurs_runtime.RecordGet(pkg_Data_Show.Get_showString(), "show"), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictIsSymbol_0, "reflectSymbol"), gopurs_runtime.Any(gopurs_runtime.Value{Type: 9, IntVal: 513803634, UnsafePtr: nil}))), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str(" "), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictShow_1, "show"), v_2), gopurs_runtime.Str(")")))))
})))
}

func Call_showArgument(dictShow_0_loop gopurs_runtime.Value) interface{} {
var dictShow_0 gopurs_runtime.Value = dictShow_0_loop
_ = dictShow_0
...
func Call_from__func_gopurs_runtime_Value__interface____interface___4189692514(dict_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dict_0 gopurs_runtime.Value = dict_0_loop
_ = dict_0
return gopurs_runtime.RecordGet(dict_0, "from")
}
