...
return gopurs_runtime.Str(gopurs_runtime.Apply2(Get_append__493084344(), gopurs_runtime.Str("(CodePoint 0x"), gopurs_runtime.Apply2(Get_append__493084344(), gopurs_runtime.Apply(pkg_Data_String_Common.Get_toUpper(), gopurs_runtime.Apply2(pkg_Data_Int.Get_toStringAs(), gopurs_runtime.Int(16), v_0)), gopurs_runtime.Str(")"))).StrVal())
}))
	})
...
__local_var_0_0 := gopurs_runtime.Apply2(Get_toEnumWithDefaults__3941305703(), gopurs_runtime.RecordGet(pkg_Data_Bounded.Get_boundedChar(), "bottom"), gopurs_runtime.RecordGet(pkg_Data_Bounded.Get_boundedChar(), "top"))
_ = __local_var_0_0
...
return gopurs_runtime.Bool((gopurs_runtime.Apply2(Get_eq__2843686287(), x_0, y_1).IntVal) != (0))
})
}))
	})
...
return gopurs_runtime.Func(func(y_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: int64(uint32(gopurs_runtime.Apply2(Get_compare__372254389(), x_0, y_1).IntVal)), UnsafePtr: nil}
})
}))
	})
...
}), gopurs_runtime.Int(gopurs_runtime.Apply2(Get_add__560788792(), gopurs_runtime.Int(1114111), gopurs_runtime.Int(1)).IntVal), gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Int(v_0.IntVal)
}), gopurs_runtime.Func(func(n_0 gopurs_runtime.Value) gopurs_runtime.Value {
var __t0 gopurs_runtime.Value
{
if (gopurs_runtime.Apply2(Get_conj__3676519832(), gopurs_runtime.Bool(Call_greaterThanOrEq__4087042607(n_0, gopurs_runtime.Int(0))), gopurs_runtime.Bool(Call_lessThanOrEq__4087042607(n_0, gopurs_runtime.Int(1114111)))).IntVal) != (0) {
...
_ = trail_1
return gopurs_runtime.Apply2(Get_add__560788792(), gopurs_runtime.Apply2(Get_add__560788792(), gopurs_runtime.Apply2(Get_mul__560788792(), gopurs_runtime.Apply2(Get_sub__1043827704(), gopurs_runtime.Int(lead_0), gopurs_runtime.Int(55296)), gopurs_runtime.Int(1024)), gopurs_runtime.Apply2(Get_sub__1043827704(), gopurs_runtime.Int(trail_1), gopurs_runtime.Int(56320))), gopurs_runtime.Int(65536)).IntVal
}
...
var s_0 string = s_0_loop
_ = s_0
return gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[*pkg_Data_Tuple.Constructor_Tuple[int64, string]]](gopurs_runtime.Apply2(Get_map__2116777468(), gopurs_runtime.Func(func(v_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
var s_0 string = s_0_loop
_ = s_0
cu0_1_0 := gopurs_runtime.Apply(Get_fromEnum__1606852103(), gopurs_runtime.Apply2(pkg_Data_String_Unsafe.Get_charAt(), gopurs_runtime.Int(0), gopurs_runtime.Str(s_0))).IntVal
_ = cu0_1_0
var __t3 int64
{
if (gopurs_runtime.Apply2(Get_conj__3676519832(), gopurs_runtime.Apply2(Get_conj__3676519832(), gopurs_runtime.Bool(Call_lessThanOrEq__4087042607(gopurs_runtime.Int(55296), gopurs_runtime.Int(cu0_1_0))), gopurs_runtime.Bool(Call_lessThanOrEq__4087042607(gopurs_runtime.Int(cu0_1_0), gopurs_runtime.Int(56319)))), gopurs_runtime.Bool(Call_greaterThan__4087042607(gopurs_runtime.Apply(pkg_Data_String_CodeUnits.Get_length(), gopurs_runtime.Str(s_0)), gopurs_runtime.Int(1)))).IntVal) != (0) {
cu1_2_1 := gopurs_runtime.Apply(Get_fromEnum__1606852103(), gopurs_runtime.Apply2(pkg_Data_String_Unsafe.Get_charAt(), gopurs_runtime.Int(1), gopurs_runtime.Str(s_0))).IntVal
_ = cu1_2_1
var __t2 int64
{
if (gopurs_runtime.Apply2(Get_conj__3676519832(), gopurs_runtime.Bool(Call_lessThanOrEq__4087042607(gopurs_runtime.Int(56320), gopurs_runtime.Int(cu1_2_1))), gopurs_runtime.Bool(Call_lessThanOrEq__4087042607(gopurs_runtime.Int(cu1_2_1), gopurs_runtime.Int(57343)))).IntVal) != (0) {
...
_ = s_1
return gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[int64]](gopurs_runtime.Apply2(Get_map__291265340(), gopurs_runtime.Func(func(i_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
{
__t0 = gopurs_runtime.Apply2(Get_append__493084344(), gopurs_runtime.Apply(Get_fromCharCode(), gopurs_runtime.Apply2(Get_add__560788792(), gopurs_runtime.Apply2(Get_div__2185172824(), gopurs_runtime.Apply2(Get_sub__1043827704(), gopurs_runtime.Int(v_0), gopurs_runtime.Int(65536)), gopurs_runtime.Int(1024)), gopurs_runtime.Int(55296))), gopurs_runtime.Apply(Get_fromCharCode(), gopurs_runtime.Apply2(Get_add__560788792(), gopurs_runtime.Apply2(Get_mod__2185172824(), gopurs_runtime.Apply2(Get_sub__1043827704(), gopurs_runtime.Int(v_0), gopurs_runtime.Int(65536)), gopurs_runtime.Int(1024)), gopurs_runtime.Int(56320)))).StrVal()
}
end_branch_0:
return __t0
}
...
__t1 = gopurs_runtime.Apply2(Get_append__493084344(), gopurs_runtime.Apply(Get_singleton(), gopurs_runtime.RecordGet((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(v2_2_0)}.UnsafePtr).V0, "head")), gopurs_runtime.Str(Call_takeFallback(gopurs_runtime.Apply2(Get_sub__1043827704(), gopurs_runtime.Int(v_0), gopurs_runtime.Int(1)).IntVal, gopurs_runtime.RecordGet((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(v2_2_0)}.UnsafePtr).V0, "tail").StrVal()))).StrVal()
goto end_branch_1
} else {
...
_ = s_2
return gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[int64]](gopurs_runtime.Apply2(Get_map__291265340(), gopurs_runtime.Func(func(k_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = s_prime_3_0
return gopurs_runtime.CoerceToStruct[pkg_Data_Maybe.Constructor_Just[int64]](gopurs_runtime.Apply2(Get_map__291265340(), gopurs_runtime.Func(func(k_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Int(gopurs_runtime.Apply2(Get_add__560788792(), gopurs_runtime.Int(i_1), gopurs_runtime.Int(int64(gopurs_runtime.ArrayLength(gopurs_runtime.Apply(Get_toCodePointArray(), gopurs_runtime.Apply2(pkg_Data_String_CodeUnits.Get_take(), k_4, s_prime_3_0)))))).IntVal)
}), gopurs_runtime.Apply2(pkg_Data_String_CodeUnits.Get_indexOf(), gopurs_runtime.Str(p_0), s_prime_3_0)))
}
...
accum_2_loop = gopurs_runtime.Apply2(Get_add__560788792(), gopurs_runtime.Int(accum_2), gopurs_runtime.Int(1)).IntVal
continue countTail
...
{
if (gopurs_runtime.Apply2(Get_eq__2843686287(), gopurs_runtime.Int(n_0), gopurs_runtime.Int(0)).IntVal) != (0) {
...
{
n_0_loop = gopurs_runtime.Apply2(Get_sub__1043827704(), gopurs_runtime.Int(n_0), gopurs_runtime.Int(1)).IntVal
...
{
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value]{1, gopurs_runtime.Apply(Get_unsafeCodePointAt0(), gopurs_runtime.Str(v1_1))})}
}
end_branch_0:
__t1 = __t0
goto end_branch_1
