...
return Call_discard((*Record_discard_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
...
return Call_bind((*Record_bind_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
	return cache_bind
}
...
return Call_bindFlipped((*Record_bind_gopurs_runtime_Value)(dictBind_0_box.UnsafePtr), b_1_box, a_2_box)
})
	})
...
return Call_composeKleisliFlipped((*Record_bind_gopurs_runtime_Value)(dictBind_0_box.UnsafePtr), f_1_box, g_2_box, a_3_box)
})
	})
...
return Call_composeKleisli((*Record_bind_gopurs_runtime_Value)(dictBind_0_box.UnsafePtr), f_1_box, g_2_box, a_3_box)
})
	})
...
return Call_ifM((*Record_bind_gopurs_runtime_Value)(dictBind_0_box.UnsafePtr), cond_1_box, t_2_box, f_3_box)
})
	})
	return cache_ifM
}
...
return Call_join((*Record_bind_gopurs_runtime_Value)(dictBind_0_box.UnsafePtr), m_1_box)
})
	})
	return cache_join
}
...
func Call_discard(dict_0_loop *Record_discard_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_discard_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.discard
}

func Call_bind(dict_0_loop *Record_bind_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_bind_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.bind
}

func Call_bindFlipped(dictBind_0_loop *Record_bind_gopurs_runtime_Value, b_1_loop gopurs_runtime.Value, a_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = a_2
return gopurs_runtime.Apply2(dictBind_0.bind, a_2, b_1)
}

func Call_composeKleisliFlipped(dictBind_0_loop *Record_bind_gopurs_runtime_Value, f_1_loop gopurs_runtime.Value, g_2_loop gopurs_runtime.Value, a_3_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictBind_0 *Record_bind_gopurs_runtime_Value = dictBind_0_loop
_ = dictBind_0
...
_ = a_3
return gopurs_runtime.Apply2(dictBind_0.bind, gopurs_runtime.Apply(g_2, a_3), f_1)
}

func Call_composeKleisli(dictBind_0_loop *Record_bind_gopurs_runtime_Value, f_1_loop gopurs_runtime.Value, g_2_loop gopurs_runtime.Value, a_3_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictBind_0 *Record_bind_gopurs_runtime_Value = dictBind_0_loop
_ = dictBind_0
var f_1 gopurs_runtime.Value = f_1_loop
_ = f_1
...
var a_3 gopurs_runtime.Value = a_3_loop
_ = a_3
return gopurs_runtime.Apply2(dictBind_0.bind, gopurs_runtime.Apply(f_1, a_3), g_2)
}

func Call_ifM(dictBind_0_loop *Record_bind_gopurs_runtime_Value, cond_1_loop gopurs_runtime.Value, t_2_loop gopurs_runtime.Value, f_3_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictBind_0 *Record_bind_gopurs_runtime_Value = dictBind_0_loop
_ = dictBind_0
...
_ = f_3
return gopurs_runtime.Apply2(dictBind_0.bind, cond_1, gopurs_runtime.Func(func(cond_prime_4 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_join(dictBind_0_loop *Record_bind_gopurs_runtime_Value, m_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictBind_0 *Record_bind_gopurs_runtime_Value = dictBind_0_loop
_ = dictBind_0
var m_1 gopurs_runtime.Value = m_1_loop
_ = m_1
return gopurs_runtime.Apply2(dictBind_0.bind, m_1, Get_identity())
}
