...
func Get_Nothing() gopurs_runtime.Value {
	once_Nothing.Do(func() {
		cache_Nothing = gopurs_runtime.Value{Type: 9, IntVal: 3589588149, UnsafePtr: nil}
	})
...
return Call_isNothing(v2_0_box)
})
	})
...
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 3478632216, UnsafePtr: unsafe.Pointer(&pkg_Data_Generic_Rep.Data_Data_Generic_Rep_Inl{gopurs_runtime.Value{Type: 9, IntVal: 1454898258, UnsafePtr: nil}})}
goto end_branch_0
} else {
...
__t0 = gopurs_runtime.Value{Type: 9, IntVal: 492034566, UnsafePtr: unsafe.Pointer(&pkg_Data_Generic_Rep.Data_Data_Generic_Rep_Inr{(*Data_Data_Maybe_Just)(x_0.UnsafePtr).V0})}
goto end_branch_0
} else {
...
__t1 = gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&Data_Data_Maybe_Just{(*pkg_Data_Generic_Rep.Data_Data_Generic_Rep_Inr)(x_0.UnsafePtr).V0})}
goto end_branch_1
} else {
...
__t0 = gopurs_runtime.Apply2(gopurs_runtime.RecordGet(Get_functorMaybe(), "map"), (*Data_Data_Maybe_Just)(v_0.UnsafePtr).V0, v1_1)
goto end_branch_0
} else {
