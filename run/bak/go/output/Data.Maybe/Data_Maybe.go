...
__t0 = gopurs_runtime.Str("(Just " + gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictShow_0_loop, "show"), (*[1024]gopurs_runtime.Value)(v_1.UnsafePtr)[0]).StrVal + ")")
goto end_branch_0
} else {
...
__t0 = gopurs_runtime.Constructor1("Just", gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictSemigroup_0_loop, "append"), (*[1024]gopurs_runtime.Value)(v_1.UnsafePtr)[0], (*[1024]gopurs_runtime.Value)(v1_2.UnsafePtr)[0]))
goto end_branch_0
} else {
...
func Get_optional() gopurs_runtime.Value {
	once_optional.Do(func() {
		optional = gopurs_runtime.Func3(Call_optional)
	})
	return optional
}
...
{
if gopurs_runtime.Bool(v_1.StrVal == "Just").IntVal != 0 && gopurs_runtime.Bool(v1_2.StrVal == "Just").IntVal != 0 {
__t1 = gopurs_runtime.Constructor1("Just", gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictSemigroup_0_loop, "append"), (*[1024]gopurs_runtime.Value)(v_1.UnsafePtr)[0], (*[1024]gopurs_runtime.Value)(v1_2.UnsafePtr)[0]))
goto end_branch_1
} else {
...
func Get_maybe_prime() gopurs_runtime.Value {
	once_maybe_prime.Do(func() {
		maybe_prime = gopurs_runtime.Func3(Call_maybe_prime)
	})
	return maybe_prime
}
...
func Get_maybe() gopurs_runtime.Value {
	once_maybe.Do(func() {
		maybe = gopurs_runtime.Func3(Call_maybe)
	})
	return maybe
}
...
var __t0 gopurs_runtime.Value
{
if gopurs_runtime.Bool(v2_0_loop.StrVal == "Nothing").IntVal != 0 {
...
{
if gopurs_runtime.Bool(v2_0_loop.StrVal == "Just").IntVal != 0 {
...
_ = a_0
return gopurs_runtime.Apply2(Get_maybe_prime(), a_0_loop, gopurs_runtime.RecordGet(pkg_Control_Category.Get_categoryFn(), "identity"))
}()
})
	})
...
func Get_fromMaybe() gopurs_runtime.Value {
	once_fromMaybe.Do(func() {
		fromMaybe = gopurs_runtime.Func2(Call_fromMaybe)
	})
	return fromMaybe
}
...
func Get_fromJust() gopurs_runtime.Value {
	once_fromJust.Do(func() {
		fromJust = gopurs_runtime.Func2(Call_fromJust)
	})
	return fromJust
}
...
_ = ordMaybe1_3_2
return gopurs_runtime.RecordDict3("top", "bottom", "Ord0", gopurs_runtime.Constructor1("Just", gopurs_runtime.RecordGet(dictBounded_0_loop, "top")), gopurs_runtime.Constructor0("Nothing"), gopurs_runtime.Func(func(_dollar__unused_4 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = dictSemiring_0
return gopurs_runtime.RecordDict4("zero", "one", "add", "mul", gopurs_runtime.Constructor0("Nothing"), gopurs_runtime.Constructor1("Just", gopurs_runtime.RecordGet(dictSemiring_0_loop, "one")), gopurs_runtime.Func2(func(v_1 gopurs_runtime.Value, v1_2 gopurs_runtime.Value) gopurs_runtime.Value {
var __t0 gopurs_runtime.Value
{
if gopurs_runtime.Bool(v_1.StrVal == "Nothing").IntVal != 0 {
__t0 = v1_2
...
{
if gopurs_runtime.Bool(v_1.StrVal == "Just").IntVal != 0 && gopurs_runtime.Bool(v1_2.StrVal == "Just").IntVal != 0 {
__t0 = gopurs_runtime.Constructor1("Just", gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictSemiring_0_loop, "add"), (*[1024]gopurs_runtime.Value)(v_1.UnsafePtr)[0], (*[1024]gopurs_runtime.Value)(v1_2.UnsafePtr)[0]))
goto end_branch_0
} else {
...
{
if gopurs_runtime.Bool(x_1.StrVal == "Just").IntVal != 0 && gopurs_runtime.Bool(y_2.StrVal == "Just").IntVal != 0 {
__t1 = gopurs_runtime.Constructor1("Just", gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictSemiring_0_loop, "mul"), (*[1024]gopurs_runtime.Value)(x_1.UnsafePtr)[0], (*[1024]gopurs_runtime.Value)(y_2.UnsafePtr)[0]))
goto end_branch_1
} else {
...
_ = a_2
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictAlt_0_loop, "alt"), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictAlt_0_loop, "Functor0"), gopurs_runtime.Value{}), "map"), Get_Just(), a_2_loop), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictApplicative_1_loop, "pure"), gopurs_runtime.Constructor0("Nothing")))
}
...
var __t0 gopurs_runtime.Value
{
if gopurs_runtime.Bool(v2_2_loop.StrVal == "Nothing").IntVal != 0 {
...
{
if gopurs_runtime.Bool(v2_2_loop.StrVal == "Just").IntVal != 0 {
...
__t0 = (*[1024]gopurs_runtime.Value)(v2_1_loop.UnsafePtr)[0]
goto end_branch_0
} else {
...
var __t0 gopurs_runtime.Value
{
if gopurs_runtime.Bool(v_1_loop.StrVal == "Just").IntVal != 0 {
