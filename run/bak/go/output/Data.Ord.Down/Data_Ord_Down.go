...
return gopurs_runtime.Any(Call_showDown(dictShow_0_box))
})
	})
...
func Get_newtypeDown() gopurs_runtime.Value {
	once_newtypeDown.Do(func() {
		cache_newtypeDown = gopurs_runtime.Any(gopurs_runtime.UnboxAny(gopurs_runtime.RecordDict1("Coercible0", gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Any(Call_eqDown(dictEq_0_box))
})
	})
	return cache_eqDown
}
...
return gopurs_runtime.Any(Call_ordDown(dictOrd_0_box))
})
	})
...
return gopurs_runtime.Any(Call_boundedDown(dictBounded_0_box))
})
	})
...
func Call_showDown(dictShow_0_loop gopurs_runtime.Value) interface{} {
...
func Call_eqDown(dictEq_0_loop gopurs_runtime.Value) interface{} {
var dictEq_0 gopurs_runtime.Value = dictEq_0_loop
_ = dictEq_0
return gopurs_runtime.UnboxAny(dictEq_0)
}

func Call_ordDown(dictOrd_0_loop gopurs_runtime.Value) interface{} {
...
func Call_boundedDown(dictBounded_0_loop gopurs_runtime.Value) interface{} {
