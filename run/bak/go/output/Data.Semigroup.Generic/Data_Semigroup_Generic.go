...
func Get_genericSemigroupProduct() gopurs_runtime.Value {
	once_genericSemigroupProduct.Do(func() {
		genericSemigroupProduct = gopurs_runtime.Func2(func(dictGenericSemigroup_0_box gopurs_runtime.Value, dictGenericSemigroup1_1_box gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_genericAppend() gopurs_runtime.Value {
	once_genericAppend.Do(func() {
		genericAppend = gopurs_runtime.Func4(func(dictGeneric_0_box gopurs_runtime.Value, dictGenericSemigroup_1_box gopurs_runtime.Value, x_2_box gopurs_runtime.Value, y_3_box gopurs_runtime.Value) gopurs_runtime.Value {
