...
return Call_showRecordFields((*Record_showRecordFields_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
...
return Call_showRecord((*Record_)(_dollar__unused_0_box.UnsafePtr), (*Record_)(_dollar__unused_1_box.UnsafePtr), (*Record_showRecordFields_gopurs_runtime_Value)(dictShowRecordFields_2_box.UnsafePtr))
})
	})
...
return Call_show((*Record_show_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
	return cache_show
}
...
return Call_showArray((*Record_show_gopurs_runtime_Value)(dictShow_0_box.UnsafePtr))
})
	})
...
return Call_showRecordFieldsCons((*Record_reflectSymbol_gopurs_runtime_Value)(dictIsSymbol_0_box.UnsafePtr), (*Record_showRecordFields_gopurs_runtime_Value)(dictShowRecordFields_1_box.UnsafePtr), (*Record_show_gopurs_runtime_Value)(dictShow_2_box.UnsafePtr))
})
	})
...
return Call_showRecordFieldsConsNil((*Record_reflectSymbol_gopurs_runtime_Value)(dictIsSymbol_0_box.UnsafePtr), (*Record_show_gopurs_runtime_Value)(dictShow_1_box.UnsafePtr))
})
	})
...
func Call_showRecordFields(dict_0_loop *Record_showRecordFields_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_showRecordFields_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.showRecordFields
}

func Call_showRecord(_dollar__unused_0_loop *Record_, _dollar__unused_1_loop *Record_, dictShowRecordFields_2_loop *Record_showRecordFields_gopurs_runtime_Value) gopurs_runtime.Value {
var _dollar__unused_0 *Record_ = _dollar__unused_0_loop
_ = _dollar__unused_0
var _dollar__unused_1 *Record_ = _dollar__unused_1_loop
_ = _dollar__unused_1
var dictShowRecordFields_2 *Record_showRecordFields_gopurs_runtime_Value = dictShowRecordFields_2_loop
...
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str("{"), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Apply2(dictShowRecordFields_2.showRecordFields, gopurs_runtime.Value{Type: 9, IntVal: 513803634, UnsafePtr: nil}, record_3), gopurs_runtime.Str("}")))
}))
}

func Call_show(dict_0_loop *Record_show_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_show_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.show
}

func Call_showArray(dictShow_0_loop *Record_show_gopurs_runtime_Value) gopurs_runtime.Value {
var dictShow_0 *Record_show_gopurs_runtime_Value = dictShow_0_loop
_ = dictShow_0
return gopurs_runtime.RecordDict1("show", gopurs_runtime.Apply(Get_showArrayImpl(), dictShow_0.show))
}

func Call_showRecordFieldsCons(dictIsSymbol_0_loop *Record_reflectSymbol_gopurs_runtime_Value, dictShowRecordFields_1_loop *Record_showRecordFields_gopurs_runtime_Value, dictShow_2_loop *Record_show_gopurs_runtime_Value) gopurs_runtime.Value {
var dictIsSymbol_0 *Record_reflectSymbol_gopurs_runtime_Value = dictIsSymbol_0_loop
_ = dictIsSymbol_0
var dictShowRecordFields_1 *Record_showRecordFields_gopurs_runtime_Value = dictShowRecordFields_1_loop
_ = dictShowRecordFields_1
var dictShow_2 *Record_show_gopurs_runtime_Value = dictShow_2_loop
_ = dictShow_2
...
key_5_0 := gopurs_runtime.Apply(dictIsSymbol_0.reflectSymbol, gopurs_runtime.Value{Type: 9, IntVal: 513803634, UnsafePtr: nil})
_ = key_5_0
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str(" "), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), key_5_0, gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str(": "), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Apply(dictShow_2.show, gopurs_runtime.Apply2(pkg_Record_Unsafe.Get_unsafeGet(), key_5_0, record_4)), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str(","), gopurs_runtime.Apply2(dictShowRecordFields_1.showRecordFields, gopurs_runtime.Value{Type: 9, IntVal: 513803634, UnsafePtr: nil}, record_4))))))
}))
}

func Call_showRecordFieldsConsNil(dictIsSymbol_0_loop *Record_reflectSymbol_gopurs_runtime_Value, dictShow_1_loop *Record_show_gopurs_runtime_Value) gopurs_runtime.Value {
var dictIsSymbol_0 *Record_reflectSymbol_gopurs_runtime_Value = dictIsSymbol_0_loop
_ = dictIsSymbol_0
...
key_4_0 := gopurs_runtime.Apply(dictIsSymbol_0.reflectSymbol, gopurs_runtime.Value{Type: 9, IntVal: 513803634, UnsafePtr: nil})
_ = key_4_0
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str(" "), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), key_4_0, gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Str(": "), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Semigroup.Get_semigroupString(), "append"), gopurs_runtime.Apply(dictShow_1.show, gopurs_runtime.Apply2(pkg_Record_Unsafe.Get_unsafeGet(), key_4_0, record_3)), gopurs_runtime.Str(" ")))))
}))
}
