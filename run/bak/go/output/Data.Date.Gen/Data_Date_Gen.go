...
return gopurs_runtime.Any(Call_genDate(dictMonadGen_0_box))
})
	})
	return cache_genDate
}

func Call_genDate(dictMonadGen_0_loop gopurs_runtime.Value) interface{} {
...
_ = Bind1_2_1
return gopurs_runtime.UnboxAny(gopurs_runtime.Apply2(gopurs_runtime.RecordGet(Bind1_2_1, "bind"), gopurs_runtime.Apply(pkg_Data_Date_Component_Gen.Get_genYear(), dictMonadGen_0), gopurs_runtime.Func(func(year_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
__t4 = gopurs_runtime.Any((*pkg_Data_Maybe.Constructor_Just[gopurs_runtime.Value])(__local_var_5_3.UnsafePtr).V0)
goto end_branch_4
} else {
