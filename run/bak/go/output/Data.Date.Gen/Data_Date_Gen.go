...
return Call_genDate((*Record_chooseBool_gopurs_runtime_Value_chooseFloat_gopurs_runtime_Value_chooseInt_gopurs_runtime_Value_resize_gopurs_runtime_Value_sized_gopurs_runtime_Value)(dictMonadGen_0_box.UnsafePtr))
})
	})
...
func Call_genDate(dictMonadGen_0_loop *Record_chooseBool_gopurs_runtime_Value_chooseFloat_gopurs_runtime_Value_chooseInt_gopurs_runtime_Value_resize_gopurs_runtime_Value_sized_gopurs_runtime_Value) gopurs_runtime.Value {
...
_ = Bind1_2_1
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(Bind1_2_1, "bind"), gopurs_runtime.Apply(pkg_Data_Date_Component_Gen.Get_genYear(), gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictMonadGen_0)}), gopurs_runtime.Func(func(year_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
}), gopurs_runtime.Apply2(dictMonadGen_0.chooseInt, gopurs_runtime.Int(0), __t2)), gopurs_runtime.Func(func(days_4 gopurs_runtime.Value) gopurs_runtime.Value {
...
__t4 = (*pkg_Data_Maybe.Data_Data_Maybe_Just)(__local_var_5_3.UnsafePtr).V0
goto end_branch_4
} else {
