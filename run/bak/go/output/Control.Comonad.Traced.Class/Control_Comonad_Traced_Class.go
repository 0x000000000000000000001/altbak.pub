...
return Call_track((*Record_track_gopurs_runtime_Value)(dict_0_box.UnsafePtr))
})
	})
	return cache_track
}
...
return Call_tracks((*Record_track_gopurs_runtime_Value)(dictComonadTraced_0_box.UnsafePtr), f_1_box, w_2_box)
})
	})
	return cache_tracks
}
...
return Call_listens((*Record_map__gopurs_runtime_Value)(dictFunctor_0_box.UnsafePtr), f_1_box, v_2_box)
})
	})
...
return Call_listen((*Record_map__gopurs_runtime_Value)(dictFunctor_0_box.UnsafePtr), v_1_box)
})
	})
	return cache_listen
}
...
return Call_comonadTracedTracedT((*Record_extract_gopurs_runtime_Value)(dictComonad_0_box.UnsafePtr))
})
	})
...
return Call_comonadTracedStoreT((*Record_track_gopurs_runtime_Value)(dictComonadTraced_0_box.UnsafePtr))
})
	})
...
return Call_comonadTracedIdentityT((*Record_track_gopurs_runtime_Value)(dictComonadTraced_0_box.UnsafePtr))
})
	})
...
return Call_comonadTracedEnvT((*Record_track_gopurs_runtime_Value)(dictComonadTraced_0_box.UnsafePtr))
})
	})
...
return Call_censor((*Record_map__gopurs_runtime_Value)(dictFunctor_0_box.UnsafePtr), f_1_box, v_2_box)
})
	})
	return cache_censor
}
...
func Call_track(dict_0_loop *Record_track_gopurs_runtime_Value) gopurs_runtime.Value {
var dict_0 *Record_track_gopurs_runtime_Value = dict_0_loop
_ = dict_0
return dict_0.track
}

func Call_tracks(dictComonadTraced_0_loop *Record_track_gopurs_runtime_Value, f_1_loop gopurs_runtime.Value, w_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictComonadTraced_0 *Record_track_gopurs_runtime_Value = dictComonadTraced_0_loop
_ = dictComonadTraced_0
var f_1 gopurs_runtime.Value = f_1_loop
_ = f_1
var w_2 gopurs_runtime.Value = w_2_loop
_ = w_2
return gopurs_runtime.Apply2(dictComonadTraced_0.track, gopurs_runtime.Apply(f_1, gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictComonadTraced_0)}, "Comonad0_NOT_FOUND"), gopurs_runtime.Value{}), "extract"), w_2)), w_2)
}
...
func Call_listens(dictFunctor_0_loop *Record_map__gopurs_runtime_Value, f_1_loop gopurs_runtime.Value, v_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = v_2
return gopurs_runtime.Apply2(dictFunctor_0.map_, gopurs_runtime.Func2(func(g_3 gopurs_runtime.Value, t_4 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_listen(dictFunctor_0_loop *Record_map__gopurs_runtime_Value, v_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictFunctor_0 *Record_map__gopurs_runtime_Value = dictFunctor_0_loop
_ = dictFunctor_0
var v_1 gopurs_runtime.Value = v_1_loop
_ = v_1
return gopurs_runtime.Apply2(dictFunctor_0.map_, gopurs_runtime.Func2(func(f_2 gopurs_runtime.Value, t_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_comonadTracedTracedT(dictComonad_0_loop *Record_extract_gopurs_runtime_Value) gopurs_runtime.Value {
var dictComonad_0 *Record_extract_gopurs_runtime_Value = dictComonad_0_loop
_ = dictComonad_0
comonadTracedT_1_0 := gopurs_runtime.Apply(pkg_Control_Comonad_Traced_Trans.Get_comonadTracedT(), gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictComonad_0)})
...
return gopurs_runtime.Apply2(dictComonad_0.extract, v_5, t_4)
}))
})
}

func Call_comonadTracedStoreT(dictComonadTraced_0_loop *Record_track_gopurs_runtime_Value) gopurs_runtime.Value {
var dictComonadTraced_0 *Record_track_gopurs_runtime_Value = dictComonadTraced_0_loop
_ = dictComonadTraced_0
comonadStoreT_1_0 := gopurs_runtime.Apply(pkg_Control_Comonad_Store_Trans.Get_comonadStoreT(), gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictComonadTraced_0)}, "Comonad0_NOT_FOUND"), gopurs_runtime.Value{}))
_ = comonadStoreT_1_0
...
}), gopurs_runtime.Apply(Get_lowerTrack1(), gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictComonadTraced_0)}))
}

func Call_comonadTracedIdentityT(dictComonadTraced_0_loop *Record_track_gopurs_runtime_Value) gopurs_runtime.Value {
var dictComonadTraced_0 *Record_track_gopurs_runtime_Value = dictComonadTraced_0_loop
_ = dictComonadTraced_0
__local_var_1_0 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictComonadTraced_0)}, "Comonad0_NOT_FOUND"), gopurs_runtime.Value{})
_ = __local_var_1_0
...
}), gopurs_runtime.Apply(Get_lowerTrack2(), gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictComonadTraced_0)}))
}

func Call_comonadTracedEnvT(dictComonadTraced_0_loop *Record_track_gopurs_runtime_Value) gopurs_runtime.Value {
var dictComonadTraced_0 *Record_track_gopurs_runtime_Value = dictComonadTraced_0_loop
_ = dictComonadTraced_0
comonadEnvT_1_0 := gopurs_runtime.Apply(pkg_Control_Comonad_Env_Trans.Get_comonadEnvT(), gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictComonadTraced_0)}, "Comonad0_NOT_FOUND"), gopurs_runtime.Value{}))
_ = comonadEnvT_1_0
return gopurs_runtime.RecordDict2("Comonad0", "track", gopurs_runtime.Func(func(_dollar__unused_2 gopurs_runtime.Value) gopurs_runtime.Value {
return comonadEnvT_1_0
}), gopurs_runtime.Apply(Get_lowerTrack3(), gopurs_runtime.Value{Type: 8, IntVal: 0, UnsafePtr: unsafe.Pointer(dictComonadTraced_0)}))
}

func Call_censor(dictFunctor_0_loop *Record_map__gopurs_runtime_Value, f_1_loop gopurs_runtime.Value, v_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictFunctor_0 *Record_map__gopurs_runtime_Value = dictFunctor_0_loop
_ = dictFunctor_0
var f_1 gopurs_runtime.Value = f_1_loop
_ = f_1
var v_2 gopurs_runtime.Value = v_2_loop
_ = v_2
return gopurs_runtime.Apply2(dictFunctor_0.map_, gopurs_runtime.Func2(func(v1_3 gopurs_runtime.Value, x_4 gopurs_runtime.Value) gopurs_runtime.Value {
