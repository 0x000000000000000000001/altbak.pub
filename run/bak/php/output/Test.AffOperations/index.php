...
\PhpursThunks::$thunks['Test_AffOperations_act'] = function() { $v = (($GLOBALS['Effect_Aff_launchAff_'] ?? \PhpursThunks::eval('Effect_Aff_launchAff_')))(((($GLOBALS['Effect_Aff__bind'] ?? \PhpursThunks::eval('Effect_Aff__bind')))((((($GLOBALS['Data_Function_Uncurried_runFn2'] ?? \PhpursThunks::eval('Data_Function_Uncurried_runFn2')))(($GLOBALS['Effect_Aff__delay'] ?? \PhpursThunks::eval('Effect_Aff__delay'))))(($GLOBALS['Data_Either_Right'] ?? \PhpursThunks::eval('Data_Either_Right'))))(10.0)))(function($dollar__unused_0 = null) {
  $__num = \func_num_args();
