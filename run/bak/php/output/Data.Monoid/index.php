...
$GLOBALS['Data_Monoid_monoidString'] = ["mempty" => "", "Semigroup0" => function($_dollar__unused_0 = null) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Monoid_monoidRecordNil'] = ["memptyRecord" => function($v_0 = null) {
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "SemigroupRecord0" => function($_dollar__unused_0 = null) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Monoid_monoidOrdering'] = ["mempty" => new \Data\Ordering\Data_Ordering_EQ(), "Semigroup0" => function($_dollar__unused_0 = null) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Monoid_monoidArray'] = ["mempty" => [], "Semigroup0" => function($_dollar__unused_0 = null) {
  $__num = \func_num_args();
...
function majData_majMonoid_monoidmajRecord($_dollar__unused_0, $dictMonoidRecord_1 = null) {
  ...
  $__res = ["mempty" => (($dictMonoidRecord_1)['memptyRecord'])(new \Type\Proxy\Type_Proxy_Proxy()), "Semigroup0" => function($_dollar__unused_3 = null) use ($semigroupRecord1_2_0) {
  $__num = \func_num_args();
...
function majData_majMonoid_monoidmajRecordmajCons($dictIsSymbol_0, $dictMonoid_1 = null) {
  ...
  $__fn = function($_dollar__unused_4 = null, $dictMonoidRecord_5 = null) use ($Semigroup0_3_1, $dictIsSymbol_0, $mempty1_2_0, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
