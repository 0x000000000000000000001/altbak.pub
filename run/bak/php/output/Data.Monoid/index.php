...
$GLOBALS['Data_Monoid_monoidUnit'] = ["mempty" => $GLOBALS['Data_Unit_unit'], "Semigroup0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Monoid_monoidString'] = ["mempty" => "", "Semigroup0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Monoid_monoidRecordNil'] = ["memptyRecord" => function($v_0) {
  $__num = \func_num_args();
  $__res = [];
  goto __end;;
  __end:
...
$GLOBALS['Data_Monoid_monoidOrdering'] = ["mempty" => new \Data\Ordering\Data_Ordering_EQ(), "Semigroup0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Monoid_monoidArray'] = ["mempty" => [], "Semigroup0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
...
function majData_majMonoid_monoidmajRecord($_dollar__unused_0, $dictMonoidRecord_1 = null) {
  ...
  $semigroupRecord1_2_0 = ["append" => (((($dictMonoidRecord_1)['SemigroupRecord0'])(null))['appendRecord'])(new \Type\Proxy\Type_Proxy_Proxy())];
  $__res = ["mempty" => (($dictMonoidRecord_1)['memptyRecord'])(new \Type\Proxy\Type_Proxy_Proxy()), "Semigroup0" => function($_dollar__unused_3) use ($semigroupRecord1_2_0) {
  $__num = \func_num_args();
...
function majData_majMonoid_monoidmajRecordmajCons($dictIsSymbol_0, $dictMonoid_1 = null) {
  ...
  $__res = ($GLOBALS['Record_Unsafe_unsafeSet'])($key_10_3, (($Semigroup0_3_1)['append'])(($get_11_4)($ra_8), ($get_11_4)($rb_9)), (($__local_var_6_2)['appendRecord'])(new \Type\Proxy\Type_Proxy_Proxy(), $ra_8, $rb_9));
  goto __end;;
  __end:
  return $__num > 3 ? $__res(...\array_slice(\func_get_args(), 3)) : $__res;
  };
  ...
  $__res = ["memptyRecord" => function($v_8) use ($dictIsSymbol_0, $dictMonoidRecord_5, $mempty1_2_0) {
  $__num = \func_num_args();
  $__res = ($GLOBALS['Record_Unsafe_unsafeSet'])((($dictIsSymbol_0)['reflectSymbol'])(new \Type\Proxy\Type_Proxy_Proxy()), $mempty1_2_0, (($dictMonoidRecord_5)['memptyRecord'])(new \Type\Proxy\Type_Proxy_Proxy()));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
