...
\PhpursThunks::$thunks['Data_List_any'] = function() { $v = (function() use (&$__fn) {
...
return ((($GLOBALS['Data_List_Types_foldableList'] ?? \PhpursThunks::eval('Data_List_Types_foldableList')))->{'foldMap'})((object)["mempty" => false, "Semigroup0" => function($dollar__unused_1 = null) use ($semigroupDisj1_0_0) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_List_updateAt'] = function() { $v = (function() {
  ...
  $__tco_done_Data_List_updateAt = false;
  $__tco_res_Data_List_updateAt = null;
  $__tco_loop_Data_List_updateAt = (function() use (&$__tco_done_Data_List_updateAt, &$__tco_var_Data_List_updateAt_v_0, &$__tco_var_Data_List_updateAt_v1_1, &$__tco_var_Data_List_updateAt_v2_2) {
  $__fn = function($v_0 = null, $v1_1 = null, $v2_2 = null) use (&$__tco_done_Data_List_updateAt, &$__tco_var_Data_List_updateAt_v_0, &$__tco_var_Data_List_updateAt_v1_1, &$__tco_var_Data_List_updateAt_v2_2, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 3) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 3);
  }
  $__tco_done_Data_List_updateAt = true;
...
$__local_var_3_1 = (((($GLOBALS['Data_List_updateAt'] ?? \PhpursThunks::eval('Data_List_updateAt')))(($v_0 - 1)))($v1_1))(($v2_2)->{'value1'});
$__t2 = null;;
...
goto end_branch_0;;
  ...
  while (($__tco_done_Data_List_updateAt === false)) {
$__tco_res_Data_List_updateAt = ($__tco_loop_Data_List_updateAt)($__tco_var_Data_List_updateAt_v_0, $__tco_var_Data_List_updateAt_v1_1, $__tco_var_Data_List_updateAt_v2_2);
};
  $__res = $__tco_res_Data_List_updateAt;
  goto __end;;
  __end:
  return $__num > 3 ? $__res(...\array_slice(\func_get_args(), 3)) : $__res;
  };
...
\PhpursThunks::$thunks['Data_List_span'] = function() { $v = (function() {
  ...
  $__tco_done_Data_List_span = false;
  $__tco_res_Data_List_span = null;
  $__tco_loop_Data_List_span = (function() use (&$__tco_done_Data_List_span, &$__tco_var_Data_List_span_v_0, &$__tco_var_Data_List_span_v1_1) {
  $__fn = function($v_0 = null, $v1_1 = null) use (&$__tco_done_Data_List_span, &$__tco_var_Data_List_span_v_0, &$__tco_var_Data_List_span_v1_1, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_done_Data_List_span = true;
...
goto end_branch_0;;
  ...
  while (($__tco_done_Data_List_span === false)) {
$__tco_res_Data_List_span = ($__tco_loop_Data_List_span)($__tco_var_Data_List_span_v_0, $__tco_var_Data_List_span_v1_1);
};
  $__res = $__tco_res_Data_List_span;
  goto __end;;
  __end:
  return $__num > 2 ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
  };
...
$__t10 = ((($descending_4_7)((($v_5)->{'value1'})->{'value0'}))(new Phpurs_Data2("Cons", ($v_5)->{'value0'}, new Phpurs_Data0("Nil"))))((($v_5)->{'value1'})->{'value1'});
goto end_branch_10;;
};
$__local_var_6_9 = ($v_5)->{'value0'};
$__t10 = ((($ascending_4_7)((($v_5)->{'value1'})->{'value0'}))(function($v1_7 = null) use ($__local_var_6_9) {
  $__num = \func_num_args();
  $__res = new Phpurs_Data2("Cons", $__local_var_6_9, $v1_7);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))((($v_5)->{'value1'})->{'value1'});
...
goto end_branch_8;;
  ...
  $__t8 = new Phpurs_Data2("Cons", $v_5, new Phpurs_Data0("Nil"));
  end_branch_8:;
  $__res = $__t8;
  goto __end;;
  __end:
...
$__t11 = ((($descending_4_7)(($v2_7)->{'value0'}))(new Phpurs_Data2("Cons", $v_5, $v1_6)))(($v2_7)->{'value1'});
goto end_branch_11;;
};
  $__t11 = new Phpurs_Data2("Cons", new Phpurs_Data2("Cons", $v_5, $v1_6), ($sequences_4_7)($v2_7));
  end_branch_11:;
  $__res = $__t11;
  goto __end;;
  __end:
  ...
  $__t12 = null;;
  if ((function() use ($cmp_0, $v2_7, $v_5, &$__fn) {
$__local_var_8_13 = (($cmp_0)($v_5))(($v2_7)->{'value0'});
return ((is_object($v2_7) && (($v2_7)->{'tag'} === "Cons")) && ((is_object($__local_var_8_13) && (($__local_var_8_13)->{'tag'} === "LT")) || ( ! (is_object($__local_var_8_13) && (($__local_var_8_13)->{'tag'} === "GT")))));
})()) {
$__t12 = ((($ascending_4_7)(($v2_7)->{'value0'}))(function($ys_8 = null) use ($v1_6, $v_5) {
  $__num = \func_num_args();
...
goto end_branch_12;;
  ...
  $__t12 = new Phpurs_Data2("Cons", ($v1_6)(new Phpurs_Data2("Cons", $v_5, new Phpurs_Data0("Nil"))), ($sequences_4_7)($v2_7));
  end_branch_12:;
  $__res = $__t12;
  goto __end;;
  __end:
...
\PhpursThunks::$thunks['Data_List_showPattern'] = function() { $v = function($dictShow_0 = null) {
  ...
  $__num = \func_num_args();
  $__res = (("(Pattern " . (((($GLOBALS['Data_List_Types_showList'] ?? \PhpursThunks::eval('Data_List_Types_showList')))($dictShow_0))->{'show'})($v_1)) . ")");
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}];
...
\PhpursThunks::$thunks['Data_List_last'] = function() { $v = function($v_0 = null) {
  ...
  $__tco_done_Data_List_last = false;
  $__tco_res_Data_List_last = null;
  $__tco_loop_Data_List_last = function($v_0 = null) use (&$__tco_done_Data_List_last, &$__tco_var_Data_List_last_v_0) {
  $__num = \func_num_args();
  $__tco_done_Data_List_last = true;
...
goto end_branch_0;;
  ...
  while (($__tco_done_Data_List_last === false)) {
$__tco_res_Data_List_last = ($__tco_loop_Data_List_last)($__tco_var_Data_List_last_v_0);
};
  $__res = $__tco_res_Data_List_last;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}; return $v; };
\PhpursThunks::$thunks['Data_List_insertBy'] = function() { $v = (function() {
  ...
  $__tco_done_Data_List_insertBy = false;
  $__tco_res_Data_List_insertBy = null;
  $__tco_loop_Data_List_insertBy = (function() use (&$__tco_done_Data_List_insertBy, &$__tco_var_Data_List_insertBy_v_0, &$__tco_var_Data_List_insertBy_v1_1, &$__tco_var_Data_List_insertBy_v2_2) {
  $__fn = function($v_0 = null, $v1_1 = null, $v2_2 = null) use (&$__tco_done_Data_List_insertBy, &$__tco_var_Data_List_insertBy_v_0, &$__tco_var_Data_List_insertBy_v1_1, &$__tco_var_Data_List_insertBy_v2_2, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 3) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 3);
  }
  $__tco_done_Data_List_insertBy = true;
...
goto end_branch_0;;
  ...
  while (($__tco_done_Data_List_insertBy === false)) {
$__tco_res_Data_List_insertBy = ($__tco_loop_Data_List_insertBy)($__tco_var_Data_List_insertBy_v_0, $__tco_var_Data_List_insertBy_v1_1, $__tco_var_Data_List_insertBy_v2_2);
};
  $__res = $__tco_res_Data_List_insertBy;
  goto __end;;
  __end:
  return $__num > 3 ? $__res(...\array_slice(\func_get_args(), 3)) : $__res;
  };
...
\PhpursThunks::$thunks['Data_List_insertAt'] = function() { $v = (function() {
  ...
  $__tco_done_Data_List_insertAt = false;
  $__tco_res_Data_List_insertAt = null;
  $__tco_loop_Data_List_insertAt = (function() use (&$__tco_done_Data_List_insertAt, &$__tco_var_Data_List_insertAt_v_0, &$__tco_var_Data_List_insertAt_v1_1, &$__tco_var_Data_List_insertAt_v2_2) {
  $__fn = function($v_0 = null, $v1_1 = null, $v2_2 = null) use (&$__tco_done_Data_List_insertAt, &$__tco_var_Data_List_insertAt_v_0, &$__tco_var_Data_List_insertAt_v1_1, &$__tco_var_Data_List_insertAt_v2_2, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 3) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 3);
  }
  $__tco_done_Data_List_insertAt = true;
...
break;
  ...
  if ((is_object($v2_2) && (($v2_2)->{'tag'} === "Cons"))) {
$__local_var_3_1 = (((($GLOBALS['Data_List_insertAt'] ?? \PhpursThunks::eval('Data_List_insertAt')))(($v_0 - 1)))($v1_1))(($v2_2)->{'value1'});
$__t2 = null;;
if ((is_object($__local_var_3_1) && (($__local_var_3_1)->{'tag'} === "Just"))) {
$__t2 = new Phpurs_Data1("Just", new Phpurs_Data2("Cons", ($v2_2)->{'value0'}, ($__local_var_3_1)->{'value0'}));
goto end_branch_2;;
...
goto end_branch_0;;
  ...
  while (($__tco_done_Data_List_insertAt === false)) {
$__tco_res_Data_List_insertAt = ($__tco_loop_Data_List_insertAt)($__tco_var_Data_List_insertAt_v_0, $__tco_var_Data_List_insertAt_v1_1, $__tco_var_Data_List_insertAt_v2_2);
};
  $__res = $__tco_res_Data_List_insertAt;
  goto __end;;
  __end:
  return $__num > 3 ? $__res(...\array_slice(\func_get_args(), 3)) : $__res;
  };
...
\PhpursThunks::$thunks['Data_List_index'] = function() { $v = (function() {
  ...
  $__tco_done_Data_List_index = false;
  $__tco_res_Data_List_index = null;
  $__tco_loop_Data_List_index = (function() use (&$__tco_done_Data_List_index, &$__tco_var_Data_List_index_v_0, &$__tco_var_Data_List_index_v1_1) {
  $__fn = function($v_0 = null, $v1_1 = null) use (&$__tco_done_Data_List_index, &$__tco_var_Data_List_index_v_0, &$__tco_var_Data_List_index_v1_1, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_done_Data_List_index = true;
...
goto end_branch_0;;
  ...
  while (($__tco_done_Data_List_index === false)) {
$__tco_res_Data_List_index = ($__tco_loop_Data_List_index)($__tco_var_Data_List_index_v_0, $__tco_var_Data_List_index_v1_1);
};
  $__res = $__tco_res_Data_List_index;
  goto __end;;
  __end:
  return $__num > 2 ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
  };
...
\PhpursThunks::$thunks['Data_List_transpose'] = function() { $v = function($v_0 = null) {
  ...
  $__tco_done_Data_List_transpose = false;
  $__tco_res_Data_List_transpose = null;
  $__tco_loop_Data_List_transpose = function($v_0 = null) use (&$__tco_done_Data_List_transpose, &$__tco_var_Data_List_transpose_v_0) {
  $__num = \func_num_args();
  $__tco_done_Data_List_transpose = true;
...
$go_1_4 = (function() use (&$go_1_4) {
  $__fn = function($v_2 = null, $v1_3 = null) use (&$go_1_4, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_var_go_1_4_4_v_2 = $v_2;
  $__tco_var_go_1_4_4_v1_3 = $v1_3;
  $__tco_done_go_1_4_4 = false;
  $__tco_res_go_1_4_4 = null;
  $__tco_loop_go_1_4_4 = (function() use (&$__tco_done_go_1_4_4, &$__tco_var_go_1_4_4_v_2, &$__tco_var_go_1_4_4_v1_3, &$go_1_4) {
  $__fn = function($v_2 = null, $v1_3 = null) use (&$__tco_done_go_1_4_4, &$__tco_var_go_1_4_4_v_2, &$__tco_var_go_1_4_4_v1_3, &$go_1_4, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_done_go_1_4_4 = true;
  $v_2 = $__tco_var_go_1_4_4_v_2;
  $v1_3 = $__tco_var_go_1_4_4_v1_3;
  $__t4 = null;;
  if ((is_object($v1_3) && (($v1_3)->{'tag'} === "Nil"))) {
$go_4_5 = null;
$go_4_5 = (function() use (&$__tco_done_go_1_4_4, &$__tco_var_go_1_4_4_v_2, &$__tco_var_go_1_4_4_v1_3, &$go_4_5) {
  $__fn = function($v_5 = null, $v1_6 = null) use (&$__tco_done_go_1_4_4, &$__tco_var_go_1_4_4_v_2, &$__tco_var_go_1_4_4_v1_3, &$go_4_5, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_var_go_4_5_5_v_5 = $v_5;
  $__tco_var_go_4_5_5_v1_6 = $v1_6;
  $__tco_done_go_4_5_5 = false;
  $__tco_res_go_4_5_5 = null;
  $__tco_loop_go_4_5_5 = (function() use (&$__tco_done_go_1_4_4, &$__tco_var_go_1_4_4_v_2, &$__tco_var_go_1_4_4_v1_3, &$__tco_done_go_4_5_5, &$__tco_var_go_4_5_5_v_5, &$__tco_var_go_4_5_5_v1_6, &$go_4_5) {
  $__fn = function($v_5 = null, $v1_6 = null) use (&$__tco_done_go_1_4_4, &$__tco_var_go_1_4_4_v_2, &$__tco_var_go_1_4_4_v1_3, &$__tco_done_go_4_5_5, &$__tco_var_go_4_5_5_v_5, &$__tco_var_go_4_5_5_v1_6, &$go_4_5, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_done_go_4_5_5 = true;
  $v_5 = $__tco_var_go_4_5_5_v_5;
  $v1_6 = $__tco_var_go_4_5_5_v1_6;
  $__t5 = null;;
  if ((is_object($v1_6) && (($v1_6)->{'tag'} === "Nil"))) {
$__t5 = $v_5;
goto end_branch_5;;
...
$__tco_7 = ($v1_6)->{'value1'};
$__tco_var_go_4_5_5_v_5 = $__tco_6;
$__tco_var_go_4_5_5_v1_6 = $__tco_7;
$__tco_done_go_4_5_5 = false;
$__res = null;
goto __end;;
$__t5 = null;
goto end_branch_5;;
  ...
  while (($__tco_done_go_4_5_5 === false)) {
$__tco_res_go_4_5_5 = ($__tco_loop_go_4_5_5)($__tco_var_go_4_5_5_v_5, $__tco_var_go_4_5_5_v1_6);
};
  $__res = $__tco_res_go_4_5_5;
  goto __end;;
  __end:
  return $__num > 2 ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
  };
...
$__tco_7 = $v_2;
$__tco_8 = ($v1_3)->{'value1'};
$__tco_var_go_1_4_4_v_2 = $__tco_7;
$__tco_var_go_1_4_4_v1_3 = $__tco_8;
$__tco_done_go_1_4_4 = false;
$__res = null;
goto __end;;
$__t6 = null;
...
$__tco_var_go_1_4_4_v_2 = $__tco_9;
$__tco_var_go_1_4_4_v1_3 = $__tco_10;
$__tco_done_go_1_4_4 = false;
$__res = null;
goto __end;;
$__t6 = null;
...
goto end_branch_4;;
  ...
  while (($__tco_done_go_1_4_4 === false)) {
$__tco_res_go_1_4_4 = ($__tco_loop_go_1_4_4)($__tco_var_go_1_4_4_v_2, $__tco_var_go_1_4_4_v1_3);
};
  $__res = $__tco_res_go_1_4_4;
  goto __end;;
  __end:
  return $__num > 2 ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
  };
...
$__t1 = new Phpurs_Data2("Cons", new Phpurs_Data2("Cons", (($v_0)->{'value0'})->{'value0'}, (($go_1_3)(new Phpurs_Data0("Nil")))(($v_0)->{'value1'})), (($GLOBALS['Data_List_transpose'] ?? \PhpursThunks::eval('Data_List_transpose')))(new Phpurs_Data2("Cons", (($v_0)->{'value0'})->{'value1'}, (($go_1_4)(new Phpurs_Data0("Nil")))(($v_0)->{'value1'}))));
goto end_branch_1;;
};
throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
$__t1 = null;
...
goto end_branch_0;;
  ...
  while (($__tco_done_Data_List_transpose === false)) {
$__tco_res_Data_List_transpose = ($__tco_loop_Data_List_transpose)($__tco_var_Data_List_transpose_v_0);
};
  $__res = $__tco_res_Data_List_transpose;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}; return $v; };
\PhpursThunks::$thunks['Data_List_groupBy'] = function() { $v = (function() {
  ...
  $__tco_done_Data_List_groupBy = false;
  $__tco_res_Data_List_groupBy = null;
  $__tco_loop_Data_List_groupBy = (function() use (&$__tco_done_Data_List_groupBy, &$__tco_var_Data_List_groupBy_v_0, &$__tco_var_Data_List_groupBy_v1_1) {
  $__fn = function($v_0 = null, $v1_1 = null) use (&$__tco_done_Data_List_groupBy, &$__tco_var_Data_List_groupBy_v_0, &$__tco_var_Data_List_groupBy_v1_1, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_done_Data_List_groupBy = true;
...
goto end_branch_0;;
  ...
  while (($__tco_done_Data_List_groupBy === false)) {
$__tco_res_Data_List_groupBy = ($__tco_loop_Data_List_groupBy)($__tco_var_Data_List_groupBy_v_0, $__tco_var_Data_List_groupBy_v1_1);
};
  $__res = $__tco_res_Data_List_groupBy;
  goto __end;;
  __end:
  return $__num > 2 ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
  };
...
\PhpursThunks::$thunks['Data_List_foldM'] = function() { $v = (function() {
  ...
  $__tco_done_Data_List_foldM = false;
  $__tco_res_Data_List_foldM = null;
  $__tco_loop_Data_List_foldM = (function() use (&$__tco_done_Data_List_foldM, &$__tco_var_Data_List_foldM_dictMonad_0, &$__tco_var_Data_List_foldM_v_1, &$__tco_var_Data_List_foldM_v1_2, &$__tco_var_Data_List_foldM_v2_3) {
  $__fn = function($dictMonad_0 = null, $v_1 = null, $v1_2 = null, $v2_3 = null) use (&$__tco_done_Data_List_foldM, &$__tco_var_Data_List_foldM_dictMonad_0, &$__tco_var_Data_List_foldM_v_1, &$__tco_var_Data_List_foldM_v1_2, &$__tco_var_Data_List_foldM_v2_3, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 4) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 4);
  }
  $__tco_done_Data_List_foldM = true;
...
goto end_branch_0;;
  ...
  while (($__tco_done_Data_List_foldM === false)) {
$__tco_res_Data_List_foldM = ($__tco_loop_Data_List_foldM)($__tco_var_Data_List_foldM_dictMonad_0, $__tco_var_Data_List_foldM_v_1, $__tco_var_Data_List_foldM_v1_2, $__tco_var_Data_List_foldM_v2_3);
};
  $__res = $__tco_res_Data_List_foldM;
  goto __end;;
  __end:
  return $__num > 4 ? $__res(...\array_slice(\func_get_args(), 4)) : $__res;
  };
...
\PhpursThunks::$thunks['Data_List_findLastIndex'] = function() { $v = (function() {
  ...
  $go_2_0 = null;
  $go_2_0 = (function() use ($fn_0, &$go_2_0) {
  $__fn = function($v_3 = null, $v1_4 = null) use ($fn_0, &$go_2_0, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  ...
  $__tco_done_go_2_0_0 = false;
  $__tco_res_go_2_0_0 = null;
  $__tco_loop_go_2_0_0 = (function() use (&$__tco_done_go_2_0_0, &$__tco_var_go_2_0_0_v_3, &$__tco_var_go_2_0_0_v1_4, $fn_0, &$go_2_0) {
  $__fn = function($v_3 = null, $v1_4 = null) use (&$__tco_done_go_2_0_0, &$__tco_var_go_2_0_0_v_3, &$__tco_var_go_2_0_0_v1_4, $fn_0, &$go_2_0, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
...
$__tco_res_go_3_1_1 = ($__tco_loop_go_3_1_1)($__tco_var_go_3_1_1_v_4, $__tco_var_go_3_1_1_v1_5);
  ...
  $__local_var_3_1 = (($go_2_0)(0))((($go_3_1)(new Phpurs_Data0("Nil")))($xs_1));
  $__t3 = null;;
  if ((is_object($__local_var_3_1) && (($__local_var_3_1)->{'tag'} === "Just"))) {
$go_4_4 = null;
$go_4_4 = (function() use (&$go_4_4) {
  $__fn = function($b_5 = null, $v_6 = null) use (&$go_4_4, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_var_go_4_4_4_b_5 = $b_5;
  $__tco_var_go_4_4_4_v_6 = $v_6;
  $__tco_done_go_4_4_4 = false;
  $__tco_res_go_4_4_4 = null;
  $__tco_loop_go_4_4_4 = (function() use (&$__tco_done_go_4_4_4, &$__tco_var_go_4_4_4_b_5, &$__tco_var_go_4_4_4_v_6, &$go_4_4) {
  $__fn = function($b_5 = null, $v_6 = null) use (&$__tco_done_go_4_4_4, &$__tco_var_go_4_4_4_b_5, &$__tco_var_go_4_4_4_v_6, &$go_4_4, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_done_go_4_4_4 = true;
  $b_5 = $__tco_var_go_4_4_4_b_5;
  $v_6 = $__tco_var_go_4_4_4_v_6;
  $__t4 = null;;
  if ((is_object($v_6) && (($v_6)->{'tag'} === "Nil"))) {
$__t4 = $b_5;
goto end_branch_4;;
...
$__tco_5 = ($b_5 + 1);
$__tco_6 = ($v_6)->{'value1'};
$__tco_var_go_4_4_4_b_5 = $__tco_5;
$__tco_var_go_4_4_4_v_6 = $__tco_6;
$__tco_done_go_4_4_4 = false;
$__res = null;
goto __end;;
$__t4 = null;
goto end_branch_4;;
  ...
  while (($__tco_done_go_4_4_4 === false)) {
$__tco_res_go_4_4_4 = ($__tco_loop_go_4_4_4)($__tco_var_go_4_4_4_b_5, $__tco_var_go_4_4_4_v_6);
};
  $__res = $__tco_res_go_4_4_4;
  goto __end;;
  __end:
...
$__t3 = new Phpurs_Data1("Just", (((($go_4_4)(0))($xs_1) - 1) - ($__local_var_3_1)->{'value0'}));
goto end_branch_3;;
};
...
\PhpursThunks::$thunks['Data_List_filterM'] = function() { $v = function($dictMonad_0 = null) {
  ...
  $__tco_done_Data_List_filterM = false;
  $__tco_res_Data_List_filterM = null;
  $__tco_loop_Data_List_filterM = function($dictMonad_0 = null) use (&$__tco_done_Data_List_filterM, &$__tco_var_Data_List_filterM_dictMonad_0) {
  $__num = \func_num_args();
  $__tco_done_Data_List_filterM = true;
...
goto end_branch_2;;
  ...
  while (($__tco_done_Data_List_filterM === false)) {
$__tco_res_Data_List_filterM = ($__tco_loop_Data_List_filterM)($__tco_var_Data_List_filterM_dictMonad_0);
};
  $__res = $__tco_res_Data_List_filterM;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}; return $v; };
...
\PhpursThunks::$thunks['Data_List_nubByEq'] = function() { $v = (function() {
  ...
  $__tco_done_Data_List_nubByEq = false;
  $__tco_res_Data_List_nubByEq = null;
  $__tco_loop_Data_List_nubByEq = (function() use (&$__tco_done_Data_List_nubByEq, &$__tco_var_Data_List_nubByEq_v_0, &$__tco_var_Data_List_nubByEq_v1_1) {
  $__fn = function($v_0 = null, $v1_1 = null) use (&$__tco_done_Data_List_nubByEq, &$__tco_var_Data_List_nubByEq_v_0, &$__tco_var_Data_List_nubByEq_v1_1, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_done_Data_List_nubByEq = true;
...
goto end_branch_0;;
  ...
  while (($__tco_done_Data_List_nubByEq === false)) {
$__tco_res_Data_List_nubByEq = ($__tco_loop_Data_List_nubByEq)($__tco_var_Data_List_nubByEq_v_0, $__tco_var_Data_List_nubByEq_v1_1);
};
  $__res = $__tco_res_Data_List_nubByEq;
  goto __end;;
  __end:
  return $__num > 2 ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
  };
...
\PhpursThunks::$thunks['Data_List_elemIndex'] = function() { $v = (function() {
  ...
  $go_2_0 = null;
  $go_2_0 = (function() use ($dictEq_0, &$go_2_0, $x_1) {
  $__fn = function($v_3 = null, $v1_4 = null) use ($dictEq_0, &$go_2_0, $x_1, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  ...
  $__tco_done_go_2_0_0 = false;
  $__tco_res_go_2_0_0 = null;
  $__tco_loop_go_2_0_0 = (function() use (&$__tco_done_go_2_0_0, &$__tco_var_go_2_0_0_v_3, &$__tco_var_go_2_0_0_v1_4, $dictEq_0, &$go_2_0, $x_1) {
  $__fn = function($v_3 = null, $v1_4 = null) use (&$__tco_done_go_2_0_0, &$__tco_var_go_2_0_0_v_3, &$__tco_var_go_2_0_0_v1_4, $dictEq_0, &$go_2_0, $x_1, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
...
\PhpursThunks::$thunks['Data_List_dropEnd'] = function() { $v = (function() {
  ...
  $go_2_0 = null;
  $go_2_0 = (function() use (&$go_2_0) {
  $__fn = function($b_3 = null, $v_4 = null) use (&$go_2_0, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_var_go_2_0_0_b_3 = $b_3;
  $__tco_var_go_2_0_0_v_4 = $v_4;
  $__tco_done_go_2_0_0 = false;
  $__tco_res_go_2_0_0 = null;
  $__tco_loop_go_2_0_0 = (function() use (&$__tco_done_go_2_0_0, &$__tco_var_go_2_0_0_b_3, &$__tco_var_go_2_0_0_v_4, &$go_2_0) {
  $__fn = function($b_3 = null, $v_4 = null) use (&$__tco_done_go_2_0_0, &$__tco_var_go_2_0_0_b_3, &$__tco_var_go_2_0_0_v_4, &$go_2_0, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_done_go_2_0_0 = true;
  $b_3 = $__tco_var_go_2_0_0_b_3;
  $v_4 = $__tco_var_go_2_0_0_v_4;
  $__t0 = null;;
  if ((is_object($v_4) && (($v_4)->{'tag'} === "Nil"))) {
$__t0 = $b_3;
goto end_branch_0;;
...
$__tco_1 = ($b_3 + 1);
$__tco_2 = ($v_4)->{'value1'};
$__tco_var_go_2_0_0_b_3 = $__tco_1;
$__tco_var_go_2_0_0_v_4 = $__tco_2;
$__tco_done_go_2_0_0 = false;
$__res = null;
goto __end;;
$__t0 = null;
goto end_branch_0;;
  ...
  while (($__tco_done_go_2_0_0 === false)) {
$__tco_res_go_2_0_0 = ($__tco_loop_go_2_0_0)($__tco_var_go_2_0_0_b_3, $__tco_var_go_2_0_0_v_4);
};
  $__res = $__tco_res_go_2_0_0;
  goto __end;;
  __end:
  ...
  $__res = ((($GLOBALS['Data_List_take'] ?? \PhpursThunks::eval('Data_List_take')))(((($go_2_0)(0))($xs_1) - $n_0)))($xs_1);
  goto __end;;
  __end:
  return $__num > 2 ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
  };
...
\PhpursThunks::$thunks['Data_List_drop'] = function() { $v = (function() {
  ...
  $__tco_done_Data_List_drop = false;
  $__tco_res_Data_List_drop = null;
  $__tco_loop_Data_List_drop = (function() use (&$__tco_done_Data_List_drop, &$__tco_var_Data_List_drop_v_0, &$__tco_var_Data_List_drop_v1_1) {
  $__fn = function($v_0 = null, $v1_1 = null) use (&$__tco_done_Data_List_drop, &$__tco_var_Data_List_drop_v_0, &$__tco_var_Data_List_drop_v1_1, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_done_Data_List_drop = true;
...
goto end_branch_0;;
  ...
  while (($__tco_done_Data_List_drop === false)) {
$__tco_res_Data_List_drop = ($__tco_loop_Data_List_drop)($__tco_var_Data_List_drop_v_0, $__tco_var_Data_List_drop_v1_1);
};
  $__res = $__tco_res_Data_List_drop;
  goto __end;;
  __end:
  return $__num > 2 ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
  };
...
\PhpursThunks::$thunks['Data_List_slice'] = function() { $v = (function() {
  ...
  $__res = ((($GLOBALS['Data_List_take'] ?? \PhpursThunks::eval('Data_List_take')))(($end_1 - $start_0)))(((($GLOBALS['Data_List_drop'] ?? \PhpursThunks::eval('Data_List_drop')))($start_0))($xs_2));
  goto __end;;
  __end:
  return $__num > 3 ? $__res(...\array_slice(\func_get_args(), 3)) : $__res;
  };
...
$__tco_res_go_2_0_0 = ($__tco_loop_go_2_0_0)($__tco_var_go_2_0_0_b_3, $__tco_var_go_2_0_0_v_4);
  ...
  $__res = ((($GLOBALS['Data_List_drop'] ?? \PhpursThunks::eval('Data_List_drop')))(((($go_2_0)(0))($xs_1) - $n_0)))($xs_1);
  goto __end;;
  __end:
  return $__num > 2 ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
  };
...
\PhpursThunks::$thunks['Data_List_deleteBy'] = function() { $v = (function() {
  ...
  $__tco_done_Data_List_deleteBy = false;
  $__tco_res_Data_List_deleteBy = null;
  $__tco_loop_Data_List_deleteBy = (function() use (&$__tco_done_Data_List_deleteBy, &$__tco_var_Data_List_deleteBy_v_0, &$__tco_var_Data_List_deleteBy_v1_1, &$__tco_var_Data_List_deleteBy_v2_2) {
  $__fn = function($v_0 = null, $v1_1 = null, $v2_2 = null) use (&$__tco_done_Data_List_deleteBy, &$__tco_var_Data_List_deleteBy_v_0, &$__tco_var_Data_List_deleteBy_v1_1, &$__tco_var_Data_List_deleteBy_v2_2, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 3) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 3);
  }
  $__tco_done_Data_List_deleteBy = true;
...
goto end_branch_0;;
  ...
  while (($__tco_done_Data_List_deleteBy === false)) {
$__tco_res_Data_List_deleteBy = ($__tco_loop_Data_List_deleteBy)($__tco_var_Data_List_deleteBy_v_0, $__tco_var_Data_List_deleteBy_v1_1, $__tco_var_Data_List_deleteBy_v2_2);
};
  $__res = $__tco_res_Data_List_deleteBy;
  goto __end;;
  __end:
  return $__num > 3 ? $__res(...\array_slice(\func_get_args(), 3)) : $__res;
  };
...
\PhpursThunks::$thunks['Data_List_deleteAt'] = function() { $v = (function() {
  ...
  $__tco_done_Data_List_deleteAt = false;
  $__tco_res_Data_List_deleteAt = null;
  $__tco_loop_Data_List_deleteAt = (function() use (&$__tco_done_Data_List_deleteAt, &$__tco_var_Data_List_deleteAt_v_0, &$__tco_var_Data_List_deleteAt_v1_1) {
  $__fn = function($v_0 = null, $v1_1 = null) use (&$__tco_done_Data_List_deleteAt, &$__tco_var_Data_List_deleteAt_v_0, &$__tco_var_Data_List_deleteAt_v1_1, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_done_Data_List_deleteAt = true;
...
$__local_var_2_1 = ((($GLOBALS['Data_List_deleteAt'] ?? \PhpursThunks::eval('Data_List_deleteAt')))(($v_0 - 1)))(($v1_1)->{'value1'});
$__t2 = null;;
if ((is_object($__local_var_2_1) && (($__local_var_2_1)->{'tag'} === "Just"))) {
...
goto end_branch_0;;
  ...
  while (($__tco_done_Data_List_deleteAt === false)) {
$__tco_res_Data_List_deleteAt = ($__tco_loop_Data_List_deleteAt)($__tco_var_Data_List_deleteAt_v_0, $__tco_var_Data_List_deleteAt_v1_1);
};
  $__res = $__tco_res_Data_List_deleteAt;
  goto __end;;
  __end:
  return $__num > 2 ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
  };
...
\PhpursThunks::$thunks['Data_List_alterAt'] = function() { $v = (function() {
  ...
  $__tco_done_Data_List_alterAt = false;
  $__tco_res_Data_List_alterAt = null;
  $__tco_loop_Data_List_alterAt = (function() use (&$__tco_done_Data_List_alterAt, &$__tco_var_Data_List_alterAt_v_0, &$__tco_var_Data_List_alterAt_v1_1, &$__tco_var_Data_List_alterAt_v2_2) {
  $__fn = function($v_0 = null, $v1_1 = null, $v2_2 = null) use (&$__tco_done_Data_List_alterAt, &$__tco_var_Data_List_alterAt_v_0, &$__tco_var_Data_List_alterAt_v1_1, &$__tco_var_Data_List_alterAt_v2_2, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 3) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 3);
  }
  $__tco_done_Data_List_alterAt = true;
...
$__local_var_3_1 = (((($GLOBALS['Data_List_alterAt'] ?? \PhpursThunks::eval('Data_List_alterAt')))(($v_0 - 1)))($v1_1))(($v2_2)->{'value1'});
$__t2 = null;;
if ((is_object($__local_var_3_1) && (($__local_var_3_1)->{'tag'} === "Just"))) {
$__t2 = new Phpurs_Data1("Just", new Phpurs_Data2("Cons", ($v2_2)->{'value0'}, ($__local_var_3_1)->{'value0'}));
goto end_branch_2;;
...
goto end_branch_0;;
  ...
  while (($__tco_done_Data_List_alterAt === false)) {
$__tco_res_Data_List_alterAt = ($__tco_loop_Data_List_alterAt)($__tco_var_Data_List_alterAt_v_0, $__tco_var_Data_List_alterAt_v1_1, $__tco_var_Data_List_alterAt_v2_2);
};
  $__res = $__tco_res_Data_List_alterAt;
  goto __end;;
  __end:
  return $__num > 3 ? $__res(...\array_slice(\func_get_args(), 3)) : $__res;
  };
