...
func Get_unionBy() gopurs_runtime.Value {
	once_unionBy.Do(func() {
		cache_unionBy = gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), gopurs_runtime.Apply(Get_wrappedOperation2(), gopurs_runtime.Str("unionBy")), pkg_Data_List.Get_unionBy())
	})
...
func Get_sortBy() gopurs_runtime.Value {
	once_sortBy.Do(func() {
		cache_sortBy = gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), gopurs_runtime.Apply(Get_wrappedOperation(), gopurs_runtime.Str("sortBy")), pkg_Data_List.Get_sortBy())
	})
	return cache_sortBy
}
...
func Get_singleton() gopurs_runtime.Value {
	once_singleton.Do(func() {
		cache_singleton = gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), pkg_Data_List_Types.Get_NonEmptyList(), gopurs_runtime.Func(func(a_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 3111306138, UnsafePtr: unsafe.Pointer(&pkg_Data_NonEmpty.Constructor_NonEmpty[gopurs_runtime.Value, gopurs_runtime.Value]{a_0, gopurs_runtime.RecordGet(pkg_Data_List_Types.Get_plusList(), "empty")})}
}))
	})
...
func Get_nubByEq() gopurs_runtime.Value {
	once_nubByEq.Do(func() {
		cache_nubByEq = gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), gopurs_runtime.Apply(Get_wrappedOperation(), gopurs_runtime.Str("nubByEq")), pkg_Data_List.Get_nubByEq())
	})
...
func Get_nubBy() gopurs_runtime.Value {
	once_nubBy.Do(func() {
		cache_nubBy = gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), gopurs_runtime.Apply(Get_wrappedOperation(), gopurs_runtime.Str("nubBy")), pkg_Data_List.Get_nubBy())
	})
	return cache_nubBy
}
...
func Get_lift() gopurs_runtime.Value {
	once_lift.Do(func() {
		cache_lift = gopurs_runtime.Func2(func(f_0_box gopurs_runtime.Value, v_1_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_lift(f_0_box, v_1_box)
})
	})
	return cache_lift
}
...
func Get_mapMaybe() gopurs_runtime.Value {
	once_mapMaybe.Do(func() {
		cache_mapMaybe = gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), Get_lift(), pkg_Data_List.Get_mapMaybe())
	})
...
func Get_partition() gopurs_runtime.Value {
	once_partition.Do(func() {
		cache_partition = gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), Get_lift(), pkg_Data_List.Get_partition())
	})
...
func Get_span() gopurs_runtime.Value {
	once_span.Do(func() {
		cache_span = gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), Get_lift(), pkg_Data_List.Get_span())
	})
	return cache_span
}
...
func Get_take() gopurs_runtime.Value {
	once_take.Do(func() {
		cache_take = gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), Get_lift(), pkg_Data_List.Get_take())
	})
	return cache_take
}
...
func Get_takeWhile() gopurs_runtime.Value {
	once_takeWhile.Do(func() {
		cache_takeWhile = gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), Get_lift(), pkg_Data_List.Get_takeWhile())
	})
...
func Get_intersectBy() gopurs_runtime.Value {
	once_intersectBy.Do(func() {
		cache_intersectBy = gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), gopurs_runtime.Apply(Get_wrappedOperation2(), gopurs_runtime.Str("intersectBy")), pkg_Data_List.Get_intersectBy())
	})
...
func Get_groupBy() gopurs_runtime.Value {
	once_groupBy.Do(func() {
		cache_groupBy = gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), gopurs_runtime.Apply(Get_wrappedOperation(), gopurs_runtime.Str("groupBy")), pkg_Data_List.Get_groupBy())
	})
...
func Get_groupAllBy() gopurs_runtime.Value {
	once_groupAllBy.Do(func() {
		cache_groupAllBy = gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), gopurs_runtime.Apply(Get_wrappedOperation(), gopurs_runtime.Str("groupAllBy")), pkg_Data_List.Get_groupAllBy())
	})
...
func Get_filter() gopurs_runtime.Value {
	once_filter.Do(func() {
		cache_filter = gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), Get_lift(), pkg_Data_List.Get_filter())
	})
	return cache_filter
}
...
func Get_dropWhile() gopurs_runtime.Value {
	once_dropWhile.Do(func() {
		cache_dropWhile = gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), Get_lift(), pkg_Data_List.Get_dropWhile())
	})
...
func Get_drop() gopurs_runtime.Value {
	once_drop.Do(func() {
		cache_drop = gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), Get_lift(), pkg_Data_List.Get_drop())
	})
	return cache_drop
}
...
_ = __local_var_3_0
__t1 = gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Maybe.Get_functorMaybe(), "map"), gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), pkg_Data_List_Types.Get_NonEmptyList(), gopurs_runtime.Func(func(v1_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 3111306138, UnsafePtr: unsafe.Pointer(&pkg_Data_NonEmpty.Constructor_NonEmpty[gopurs_runtime.Value, gopurs_runtime.Value]{__local_var_3_0, v1_4})}
...
_ = dictUnfoldable_0
return gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), gopurs_runtime.Apply(((*gopurs_runtime.RecordData1)(dictUnfoldable_0.UnsafePtr)).V0, gopurs_runtime.Func(func(xs_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
__t0 = gopurs_runtime.Apply(Get_singleton(), v1_1)
goto end_branch_0
} else {
...
__t1 = gopurs_runtime.Apply2(gopurs_runtime.RecordGet(pkg_Data_Maybe.Get_functorMaybe(), "map"), gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), pkg_Data_List_Types.Get_NonEmptyList(), gopurs_runtime.Func(func(v1_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 3111306138, UnsafePtr: unsafe.Pointer(&pkg_Data_NonEmpty.Constructor_NonEmpty[gopurs_runtime.Value, gopurs_runtime.Value]{__local_var_3_0, v1_4})}
})), gopurs_runtime.Apply3(pkg_Data_List.Get_alterAt(), gopurs_runtime.Int((i_0) - (1)), gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), pkg_Data_Maybe.Get_Just(), f_1), (*pkg_Data_NonEmpty.Constructor_NonEmpty[gopurs_runtime.Value, gopurs_runtime.Value])(v_2.UnsafePtr).V1))
}
end_branch_1:
return __t1
}

func Call_lift(f_0_loop gopurs_runtime.Value, v_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var f_0 gopurs_runtime.Value = f_0_loop
_ = f_0
var v_1 gopurs_runtime.Value = v_1_loop
_ = v_1
...
_ = dictFoldable_0
return gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), Get_fromList(), gopurs_runtime.Apply2(((*gopurs_runtime.RecordData3)(dictFoldable_0.UnsafePtr)).V2, pkg_Data_List_Types.Get_Cons(), gopurs_runtime.Value{Type: 9, IntVal: 786377863, UnsafePtr: nil}))
}
...
var dictMonad_0 gopurs_runtime.Value = dictMonad_0_loop
_ = dictMonad_0
return gopurs_runtime.Apply2(pkg_Control_Semigroupoid.Get_composeImpl(), Get_lift(), gopurs_runtime.Apply(pkg_Data_List.Get_filterM(), dictMonad_0))
}
