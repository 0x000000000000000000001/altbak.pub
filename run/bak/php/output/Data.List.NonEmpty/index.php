...
function majData_majList_majNonmajEmpty_zipmajWithmajA($dictApplicative_0) {
  ...
  $__res = function($f_2) use ($sequence11_1_0) {
  $__num = \func_num_args();
  $__res = function($xs_3) use ($f_2, $sequence11_1_0) {
  $__num = \func_num_args();
  $__res = function($ys_4) use ($f_2, $sequence11_1_0, $xs_3) {
  $__num = \func_num_args();
...
$__t1 = \Partial\majPartial__crashmajWith(((($GLOBALS['Data_Semigroup_semigroupString'])->{'append'})("Impossible: empty list in NonEmptyList "))($name_0));
goto end_branch_1;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t1 = null;
...
function majData_majList_majNonmajEmpty_appendmajFoldable($dictFoldable_0) {
  ...
  $__res = function($v_2) use ($fromFoldable1_1_0) {
  $__num = \func_num_args();
  $__res = function($ys_3) use ($fromFoldable1_1_0, $v_2) {
  $__num = \func_num_args();
