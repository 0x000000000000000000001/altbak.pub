...
function majData_majList_majNonmajEmpty_wrappedmajOperation2($name_0, $f_1 = null, $v_2 = null, $v1_3 = null) {
  $__num = \func_num_args();
...
function majData_majList_majNonmajEmpty_wrappedmajOperation($name_0, $f_1 = null, $v_2 = null) {
  $__num = \func_num_args();
...
function majData_majList_majNonmajEmpty_updatemajAt($i_0, $a_1 = null, $v_2 = null) {
  $__num = \func_num_args();
...
$__t1 = ["init" => new \Data\List\Types\Data_List_Types_Nil(), "last" => ($v_0)->{'value0'}];
goto end_branch_1;;
};
  if ($v1_1_0 instanceof \Data\Maybe\Data_Maybe_Just) {
$__t1 = ["init" => new \Data\List\Types\Data_List_Types_Cons(($v_0)->{'value0'}, (($v1_1_0)->{'value0'})['init']), "last" => (($v1_1_0)->{'value0'})['last']];
goto end_branch_1;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t1 = null;
...
$GLOBALS['Data_List_NonEmpty_singleton_closure'] = ($GLOBALS['Control_Semigroupoid_composeImpl'])($GLOBALS['Data_List_Types_NonEmptyList'], function($a_0 = null) {
  $__num = \func_num_args();
...
function majData_majList_majNonmajEmpty_modifymajAt($i_0, $f_1 = null, $v_2 = null) {
  $__num = \func_num_args();
...
function majData_majList_majNonmajEmpty_take($v_0, $v_1 = null) {
  $__num = \func_num_args();
...
function majData_majList_majNonmajEmpty_length($v_0) {
  $__num = \func_num_args();
...
if (($GLOBALS['Data_List_last'])((($v_0)->{'value1'})->{'value1'}) instanceof \Data\Maybe\Data_Maybe_Nothing) {
$__t1 = ($v_0)->{'value0'};
goto end_branch_1;;
};
if (($GLOBALS['Data_List_last'])((($v_0)->{'value1'})->{'value1'}) instanceof \Data\Maybe\Data_Maybe_Just) {
...
function majData_majList_majNonmajEmpty_insertmajAt($i_0, $a_1 = null, $v_2 = null) {
  $__num = \func_num_args();
...
function majData_majList_majNonmajEmpty_index($v_0, $i_1 = null) {
  ...
  $__res = match ($i_1) { 0 => new \Data\Maybe\Data_Maybe_Just(($v_0)->{'value0'}), default => ($GLOBALS['Data_List_index'])(($v_0)->{'value1'}, ($i_1 - 1)) };
  goto __end;;
  __end:
  return 2 < $__num ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
}
...
function majData_majList_majNonmajEmpty_drop($v_0, $v_1 = null) {
  $__num = \func_num_args();
