...
function majControl_majParallel_majClass_applymajParmajCont($dictMonadEffect_0) {
  ...
  $__res = (($Bind1_1_0)['bind'])((($dictMonadEffect_0)['liftEffect'])(($GLOBALS['Effect_Ref__new'])(new \Data\Maybe\Data_Maybe_Nothing())), function($ra_6 = null) use ($Bind1_1_0, $dictMonadEffect_0, $discard1_2_1, $k_5, $v1_4, $v_3) {
  $__num = \func_num_args();
  $__res = (($Bind1_1_0)['bind'])((($dictMonadEffect_0)['liftEffect'])(($GLOBALS['Effect_Ref__new'])(new \Data\Maybe\Data_Maybe_Nothing())), function($rb_7 = null) use ($Bind1_1_0, $dictMonadEffect_0, $discard1_2_1, $k_5, $ra_6, $v1_4, $v_3) {
  $__num = \func_num_args();
