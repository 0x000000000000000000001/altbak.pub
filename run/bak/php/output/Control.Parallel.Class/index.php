...
function majControl_majParallel_majClass_monadmajParmajWritermajT($dictMonoid_0) {
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Apply0" => function($_dollar__unused_6) use ($applyWriterT1_4_4) {
  $__num = \func_num_args();
  $__res = $applyWriterT1_4_4;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Apply1" => function($_dollar__unused_6) use ($applyWriterT2_5_5) {
  $__num = \func_num_args();
...
function majControl_majParallel_majClass_monadmajParmajMaybemajT($dictParallel_0) {
  ...
  return $__fn;
})(), "Functor0" => function($_dollar__unused_5) use ($functorCompose2_4_3) {
  $__num = \func_num_args();
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Apply0" => function($_dollar__unused_7) use ($applyMaybeT_6_5) {
  $__num = \func_num_args();
  $__res = $applyMaybeT_6_5;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Apply1" => function($_dollar__unused_7) use ($applyCompose_4_3) {
  $__num = \func_num_args();
...
function majControl_majParallel_majClass_monadmajParmajExceptmajT($dictParallel_0) {
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Apply0" => function($_dollar__unused_7) use ($applyExceptT_6_5) {
  $__num = \func_num_args();
...
function majControl_majParallel_majClass_monadmajParmajParmajCont($dictMonadEffect_0) {
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Apply0" => function($_dollar__unused_3) use ($applyContT_2_1) {
  $__num = \func_num_args();
