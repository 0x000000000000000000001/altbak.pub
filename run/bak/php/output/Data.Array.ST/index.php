...
$GLOBALS['Data_Array_ST_cloneImpl'] = ($ffi_Data_Array_ST['cloneImpl'] ?? \phpurs_ffi_fallback($ffi_Data_Array_ST, 'cloneImpl'));
$GLOBALS['Data_Array_ST_freezeImpl'] = ($ffi_Data_Array_ST['freezeImpl'] ?? \phpurs_ffi_fallback($ffi_Data_Array_ST, 'freezeImpl'));
$GLOBALS['Data_Array_ST_lengthImpl'] = ($ffi_Data_Array_ST['lengthImpl'] ?? \phpurs_ffi_fallback($ffi_Data_Array_ST, 'lengthImpl'));
$GLOBALS['Data_Array_ST_new'] = ($ffi_Data_Array_ST['new'] ?? \phpurs_ffi_fallback($ffi_Data_Array_ST, 'new'));
$GLOBALS['Data_Array_ST_peekImpl'] = ($ffi_Data_Array_ST['peekImpl'] ?? \phpurs_ffi_fallback($ffi_Data_Array_ST, 'peekImpl'));
$GLOBALS['Data_Array_ST_pokeImpl'] = ($ffi_Data_Array_ST['pokeImpl'] ?? \phpurs_ffi_fallback($ffi_Data_Array_ST, 'pokeImpl'));
$GLOBALS['Data_Array_ST_popImpl'] = ($ffi_Data_Array_ST['popImpl'] ?? \phpurs_ffi_fallback($ffi_Data_Array_ST, 'popImpl'));
$GLOBALS['Data_Array_ST_pushAllImpl'] = ($ffi_Data_Array_ST['pushAllImpl'] ?? \phpurs_ffi_fallback($ffi_Data_Array_ST, 'pushAllImpl'));
$GLOBALS['Data_Array_ST_pushImpl'] = ($ffi_Data_Array_ST['pushImpl'] ?? \phpurs_ffi_fallback($ffi_Data_Array_ST, 'pushImpl'));
$GLOBALS['Data_Array_ST_shiftImpl'] = ($ffi_Data_Array_ST['shiftImpl'] ?? \phpurs_ffi_fallback($ffi_Data_Array_ST, 'shiftImpl'));
$GLOBALS['Data_Array_ST_sortByImpl'] = ($ffi_Data_Array_ST['sortByImpl'] ?? \phpurs_ffi_fallback($ffi_Data_Array_ST, 'sortByImpl'));
$GLOBALS['Data_Array_ST_spliceImpl'] = ($ffi_Data_Array_ST['spliceImpl'] ?? \phpurs_ffi_fallback($ffi_Data_Array_ST, 'spliceImpl'));
$GLOBALS['Data_Array_ST_thawImpl'] = ($ffi_Data_Array_ST['thawImpl'] ?? \phpurs_ffi_fallback($ffi_Data_Array_ST, 'thawImpl'));
$GLOBALS['Data_Array_ST_toAssocArrayImpl'] = ($ffi_Data_Array_ST['toAssocArrayImpl'] ?? \phpurs_ffi_fallback($ffi_Data_Array_ST, 'toAssocArrayImpl'));
$GLOBALS['Data_Array_ST_unsafeFreezeImpl'] = ($ffi_Data_Array_ST['unsafeFreezeImpl'] ?? \phpurs_ffi_fallback($ffi_Data_Array_ST, 'unsafeFreezeImpl'));
$GLOBALS['Data_Array_ST_unsafeThawImpl'] = ($ffi_Data_Array_ST['unsafeThawImpl'] ?? \phpurs_ffi_fallback($ffi_Data_Array_ST, 'unsafeThawImpl'));
$GLOBALS['Data_Array_ST_unshiftAllImpl'] = ($ffi_Data_Array_ST['unshiftAllImpl'] ?? \phpurs_ffi_fallback($ffi_Data_Array_ST, 'unshiftAllImpl'));
