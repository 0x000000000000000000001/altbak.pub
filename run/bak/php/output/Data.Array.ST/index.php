...
function majData_majArray_majSmajT_splice($v_0, $v_1 = null, $v_2 = null, $v_3 = null) {
  $__num = \func_num_args();
...
// Data_Array_ST_poke
function majData_majArray_majSmajT_poke($v_0, $v_1 = null, $v_2 = null) {
  $__num = \func_num_args();
...
// Data_Array_ST_peek
function majData_majArray_majSmajT_peek($v_0, $v_1 = null) {
  $__num = \func_num_args();
...
function majData_majArray_majSmajT_modify($i_0, $f_1 = null, $xs_2 = null) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majArray_majSmajT_modify';
  if ($__num < 3) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 3);
  }
  $__res = (($GLOBALS['Control_Monad_ST_Internal_bindST'])['bind'])(($GLOBALS['Control_Monad_ST_Uncurried_runSTFn4'])($GLOBALS['Data_Array_ST_peekImpl'], $GLOBALS['Data_Maybe_Just'], new \Data\Maybe\Data_Maybe_Nothing(), $i_0, $xs_2), function($entry_3 = null) use ($f_1, $i_0, $xs_2) {
  $__num = \func_num_args();
  $__t0 = null;;
