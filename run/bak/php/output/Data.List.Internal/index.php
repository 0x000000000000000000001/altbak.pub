...
\PhpursThunks::$thunks['Data_List_Internal_fromZipper'] = function() { $v = (function() {
  ...
  $__tco_done_Data_List_Internal_fromZipper = false;
  $__tco_res_Data_List_Internal_fromZipper = null;
  $__tco_loop_Data_List_Internal_fromZipper = (function() use (&$__tco_done_Data_List_Internal_fromZipper, &$__tco_var_Data_List_Internal_fromZipper_v_0, &$__tco_var_Data_List_Internal_fromZipper_v1_1) {
  $__fn = function($v_0 = null, $v1_1 = null) use (&$__tco_done_Data_List_Internal_fromZipper, &$__tco_var_Data_List_Internal_fromZipper_v_0, &$__tco_var_Data_List_Internal_fromZipper_v1_1, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_done_Data_List_Internal_fromZipper = true;
...
goto end_branch_0;;
  ...
  while (($__tco_done_Data_List_Internal_fromZipper === false)) {
$__tco_res_Data_List_Internal_fromZipper = ($__tco_loop_Data_List_Internal_fromZipper)($__tco_var_Data_List_Internal_fromZipper_v_0, $__tco_var_Data_List_Internal_fromZipper_v1_1);
};
  $__res = $__tco_res_Data_List_Internal_fromZipper;
  goto __end;;
  __end:
  return $__num > 2 ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
  };
...
goto end_branch_0;;
  ...
  while (($__tco_done_up_3_0_0 === false)) {
...
goto end_branch_1;;
  ...
  while (($__tco_done_down_4_1_1 === false)) {
