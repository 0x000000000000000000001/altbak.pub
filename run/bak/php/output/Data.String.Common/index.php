...
function majData_majString_majCommon__localemajCompare($v0, $v1 = null, $v2 = null, $v3 = null, $v4 = null) {
  ...
  $f = ($ffi_Data_String_Common['_localeCompare'] ?? \phpurs_ffi_fallback($ffi_Data_String_Common, '_localeCompare'));
...
function majData_majString_majCommon_joinmajWith(string $v0, $v1 = null): string|\Closure {
  ...
  global $ffi_Data_String_Common;
  $f = ($ffi_Data_String_Common['joinWith'] ?? \phpurs_ffi_fallback($ffi_Data_String_Common, 'joinWith'));
  return $f($v0, $v1);
}
...
function majData_majString_majCommon_replace(string $v0, $v1 = null, $v2 = null): string|\Closure {
  ...
  global $ffi_Data_String_Common;
  $f = ($ffi_Data_String_Common['replace'] ?? \phpurs_ffi_fallback($ffi_Data_String_Common, 'replace'));
  return $f($v0, $v1, $v2);
}
...
function majData_majString_majCommon_replacemajAll(string $v0, $v1 = null, $v2 = null): string|\Closure {
  ...
  global $ffi_Data_String_Common;
  $f = ($ffi_Data_String_Common['replaceAll'] ?? \phpurs_ffi_fallback($ffi_Data_String_Common, 'replaceAll'));
  return $f($v0, $v1, $v2);
}
...
function majData_majString_majCommon_split(string $v0, $v1 = null) {
  ...
  global $ffi_Data_String_Common;
  $f = ($ffi_Data_String_Common['split'] ?? \phpurs_ffi_fallback($ffi_Data_String_Common, 'split'));
  return $f($v0, $v1);
}
...
function majData_majString_majCommon_tomajLower(string $v0): string|\Closure {
  ...
  global $ffi_Data_String_Common;
  $f = ($ffi_Data_String_Common['toLower'] ?? \phpurs_ffi_fallback($ffi_Data_String_Common, 'toLower'));
  return $f($v0);
}
...
function majData_majString_majCommon_tomajUpper(string $v0): string|\Closure {
  ...
  global $ffi_Data_String_Common;
  $f = ($ffi_Data_String_Common['toUpper'] ?? \phpurs_ffi_fallback($ffi_Data_String_Common, 'toUpper'));
  return $f($v0);
}
...
function majData_majString_majCommon_trim(string $v0): string|\Closure {
  ...
  global $ffi_Data_String_Common;
  $f = ($ffi_Data_String_Common['trim'] ?? \phpurs_ffi_fallback($ffi_Data_String_Common, 'trim'));
  return $f($v0);
}
