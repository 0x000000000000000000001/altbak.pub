...
\PhpursThunks::$thunks['Data_Const_newtypeConst'] = function() { $v = (object)["Coercible0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_Const_eq1Const'] = function() { $v = function($dictEq_0 = null) {
  $__num = \func_num_args();
  $eq_1_0 = ($dictEq_0)->{'eq'};
  $__res = (object)["eq1" => function($dictEq1_2 = null) use ($eq_1_0) {
  $__num = \func_num_args();
  $__res = $eq_1_0;
  goto __end;;
  __end:
...
\PhpursThunks::$thunks['Data_Const_ord1Const'] = function() { $v = function($dictOrd_0 = null) {
  ...
  $__res = (object)["compare1" => function($dictOrd1_3 = null) use ($compare_1_0) {
  $__num = \func_num_args();
  $__res = $compare_1_0;
  goto __end;;
  __end:
  ...
  $__num = \func_num_args();
  $__res = (object)["eq1" => function($dictEq1_4 = null) use ($eq_2_1) {
  $__num = \func_num_args();
  $__res = $eq_2_1;
  goto __end;;
  __end:
...
\PhpursThunks::$thunks['Data_Const_applicativeConst'] = function() { $v = function($dictMonoid_0 = null) {
  ...
  $__res = (object)["pure" => function($v_4 = null) use ($mempty_1_0) {
  $__num = \func_num_args();
  $__res = $mempty_1_0;
  goto __end;;
  __end:
