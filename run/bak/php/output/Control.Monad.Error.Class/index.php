...
\PhpursThunks::$thunks['Control_Monad_Error_Class_monadThrowMaybe'] = function() { $v = (object)["throwError" => function($v_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_Error_Class_monadThrowEither'] = function() { $v = (object)["throwError" => ($GLOBALS['Data_Either_Left'] ?? \PhpursThunks::eval('Data_Either_Left')), "Monad0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_Error_Class_monadThrowEffect'] = function() { $v = (object)["throwError" => ($GLOBALS['Effect_Exception_throwException'] ?? \PhpursThunks::eval('Effect_Exception_throwException')), "Monad0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
