...
function majData_majString_majNonmajEmpty_majCodemajUnits_frommajNonmajEmptymajString($v_0): string|\Closure {
  $__num = \func_num_args();
...
function majData_majString_majNonmajEmpty_majCodemajUnits_length($v_0): int|\Closure {
  $__num = \func_num_args();
