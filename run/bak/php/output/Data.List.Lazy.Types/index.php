...
\PhpursThunks::$thunks['Data_List_Lazy_Types_semigroupList'] = function() { $v = (object)["append" => (function() {
  ...
  $__res = (($GLOBALS['Data_Lazy_defer'] ?? \PhpursThunks::eval('Data_Lazy_defer')))(function($v_2) use ($xs_0, $ys_1) {
  $__num = \func_num_args();
  // DEBUG UncurriedAbs: currentBindingName=Nothing, recVars=["Data_List_Lazy_Types_semigroupList"];
...
\PhpursThunks::$thunks['Data_List_Lazy_Types_functorList'] = function() { $v = (object)["map" => (function() {
  ...
  $__res = (($GLOBALS['Data_Lazy_defer'] ?? \PhpursThunks::eval('Data_Lazy_defer')))(function($v_2) use ($f_0, $xs_1) {
  $__num = \func_num_args();
  // DEBUG UncurriedAbs: currentBindingName=Nothing, recVars=["Data_List_Lazy_Types_functorList"];
...
\PhpursThunks::$thunks['Data_List_Lazy_Types_eqNonEmpty'] = function() { $v = function($dictEq_0) {
  $__num = \func_num_args();
  // DEBUG UncurriedAbs: currentBindingName=(Just "Data_List_Lazy_Types_eqNonEmpty"), recVars=[];
...
\PhpursThunks::$thunks['Data_List_Lazy_Types_foldableWithIndexList'] = function() { $v = (object)["foldrWithIndex" => (function() {
  ...
  $__num = \func_num_args();
  // DEBUG UncurriedAbs: currentBindingName=Nothing, recVars=["Data_List_Lazy_Types_foldableWithIndexList"];
  $__res = new Phpurs_Data2("Tuple", ($__local_var_5_1 + 1), (($GLOBALS['Data_Lazy_defer'] ?? \PhpursThunks::eval('Data_Lazy_defer')))(function($v_7) use ($__local_var_4_0, $a_6) {
  $__num = \func_num_args();
  // DEBUG UncurriedAbs: currentBindingName=Nothing, recVars=["Data_List_Lazy_Types_foldableWithIndexList"];
...
$__t1 = null;
  ...
  // DEBUG UncurriedAbs: currentBindingName=Nothing, recVars=[];
  $__res = ((((($GLOBALS['Data_List_Lazy_Types_foldableWithIndexNonEmpty'] ?? \PhpursThunks::eval('Data_List_Lazy_Types_foldableWithIndexNonEmpty')))->foldlWithIndex)(((($GLOBALS['Control_Semigroupoid_composeImpl'] ?? \PhpursThunks::eval('Control_Semigroupoid_composeImpl')))($f_0))(function($v2_3) {
  $__num = \func_num_args();
  // DEBUG UncurriedAbs: currentBindingName=Nothing, recVars=[];
...
$__t2 = null;
  ...
  // DEBUG UncurriedAbs: currentBindingName=Nothing, recVars=[];
  $__res = ((((($GLOBALS['Data_List_Lazy_Types_foldableWithIndexNonEmpty'] ?? \PhpursThunks::eval('Data_List_Lazy_Types_foldableWithIndexNonEmpty')))->foldrWithIndex)(((($GLOBALS['Control_Semigroupoid_composeImpl'] ?? \PhpursThunks::eval('Control_Semigroupoid_composeImpl')))($f_0))(function($v2_3) {
  $__num = \func_num_args();
  // DEBUG UncurriedAbs: currentBindingName=Nothing, recVars=[];
  if ((is_object($v2_3) && (($v2_3)->tag === "Nothing"))) {
$__t3 = 0;
...
\PhpursThunks::$thunks['Data_List_Lazy_Types_functorWithIndexNonEmptyList'] = function() { $v = (object)["mapWithIndex" => (function() {
  ...
  $__num = \func_num_args();
  // DEBUG UncurriedAbs: currentBindingName=Nothing, recVars=[];
  $__res = ((($GLOBALS['Data_List_Lazy_Types_mapWithIndex'] ?? \PhpursThunks::eval('Data_List_Lazy_Types_mapWithIndex')))(((($GLOBALS['Control_Semigroupoid_composeImpl'] ?? \PhpursThunks::eval('Control_Semigroupoid_composeImpl')))($f_0))(function($v2_3) {
  $__num = \func_num_args();
  // DEBUG UncurriedAbs: currentBindingName=Nothing, recVars=[];
  if ((is_object($v2_3) && (($v2_3)->tag === "Nothing"))) {
$__t0 = 0;
...
\PhpursThunks::$thunks['Data_List_Lazy_Types_traversableWithIndexNonEmptyList'] = function() { $v = (object)["traverseWithIndex" => function($dictApplicative_0) {
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))((($traverseWithIndex1_1_0)(((($GLOBALS['Control_Semigroupoid_composeImpl'] ?? \PhpursThunks::eval('Control_Semigroupoid_composeImpl')))($f_2))(function($v2_4) {
  $__num = \func_num_args();
  // DEBUG UncurriedAbs: currentBindingName=Nothing, recVars=[];
  if ((is_object($v2_4) && (($v2_4)->tag === "Nothing"))) {
$__t1 = 0;
...
\PhpursThunks::$thunks['Data_List_Lazy_Types_bindList'] = function() { $v = (object)["bind" => (function() {
  ...
  // DEBUG UncurriedAbs: currentBindingName=Nothing, recVars=["Data_List_Lazy_Types_monadList","Data_List_Lazy_Types_bindList","Data_List_Lazy_Types_applyList","Data_List_Lazy_Types_applicativeList"];
  $__res = (($GLOBALS['Data_Lazy_defer'] ?? \PhpursThunks::eval('Data_Lazy_defer')))(function($v_2) use ($f_1, $xs_0) {
  $__num = \func_num_args();
  // DEBUG UncurriedAbs: currentBindingName=Nothing, recVars=["Data_List_Lazy_Types_monadList","Data_List_Lazy_Types_bindList","Data_List_Lazy_Types_applyList","Data_List_Lazy_Types_applicativeList"];
  $__local_var_3_0 = (($GLOBALS['Data_Lazy_force'] ?? \PhpursThunks::eval('Data_Lazy_force')))($xs_0);
  if ((is_object($__local_var_3_0) && (($__local_var_3_0)->tag === "Nil"))) {
