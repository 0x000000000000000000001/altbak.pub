...
final class Data_List_Lazy_Types_Nil { public function __construct() {} }
final class Data_List_Lazy_Types_Cons { public function __construct(public  $value0, public  $value1) {} }
...
// Data_List_Lazy_Types_nil
$GLOBALS['Data_List_Lazy_Types_nil'] = ($GLOBALS['Data_Lazy_defer'])(function($v_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_List_Lazy_Types_newtypeNonEmptyList'] = ["Coercible0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
  $__res = null;
  goto __end;;
  __end:
...
$GLOBALS['Data_List_Lazy_Types_newtypeList'] = ["Coercible0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
  $__res = null;
  goto __end;;
  __end:
...
$GLOBALS['Data_List_Lazy_Types_monoidList'] = ["mempty" => $GLOBALS['Data_List_Lazy_Types_nil'], "Semigroup0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_List_Lazy_Types_lazyList'] = ["defer" => function($f_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_List_Lazy_Types_functorList'] = ["map" => (function() {
...
$GLOBALS['Data_List_Lazy_Types_eq1List'] = ["eq1" => (function() {
...
goto end_branch_1;;
  ...
  $__t1 = ($v_4 instanceof \Data\List\Lazy\Types\Data_List_Lazy_Types_Cons && ($v1_5 instanceof \Data\List\Lazy\Types\Data_List_Lazy_Types_Cons && ((($dictEq_0)['eq'])(($v_4)->{'value0'}, ($v1_5)->{'value0'}) && ($go__3_0)(($GLOBALS['Data_List_Lazy_Types_step'])(($v_4)->{'value1'}), ($GLOBALS['Data_List_Lazy_Types_step'])(($v1_5)->{'value1'})))));
  end_branch_1:;
  $__res = $__t1;
  goto __end;;
  __end:
...
$GLOBALS['Data_List_Lazy_Types_eq1NonEmptyList'] = ["eq1" => function($dictEq_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_List_Lazy_Types_ord1List'] = ["compare1" => (function() {
...
$GLOBALS['Data_List_Lazy_Types_ord1NonEmptyList'] = ["compare1" => function($dictOrd_0) {
  $__num = \func_num_args();
...
function majData_majList_majLazy_majTypes_ordmajList($dictOrd_0) {
  ...
  $__res = ["compare" => (($GLOBALS['Data_List_Lazy_Types_ord1List'])['compare1'])($dictOrd_0), "Eq0" => function($_dollar__unused_2) use ($eqList1_1_0) {
  $__num = \func_num_args();
  $__res = $eqList1_1_0;
  goto __end;;
  __end:
...
function majData_majList_majLazy_majTypes_ordmajNonmajEmptymajList($dictOrd_0) {
  ...
  $__res = ($GLOBALS['Data_Lazy_ordLazy'])(($GLOBALS['Data_List_Lazy_Types_ordNonEmpty'])($dictOrd_0));
  goto __end;;
  __end:
  return 1 < $__num ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}
...
function majData_majList_majLazy_majTypes_cons($x_0, $xs_1 = null) {
  ...
  $__res = ($GLOBALS['Data_Lazy_defer'])(function($v_2) use ($x_0, $xs_1) {
  $__num = \func_num_args();
...
$GLOBALS['Data_List_Lazy_Types_foldableList'] = ["foldr" => (function() {
  ...
  $__res = ($GLOBALS['Data_Lazy_defer'])(function($v_5) use ($a_4, $b_3) {
  $__num = \func_num_args();
...
$GLOBALS['Data_List_Lazy_Types_foldableNonEmpty'] = ["foldMap" => function($dictMonoid_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_List_Lazy_Types_extendList'] = ["extend" => (function() {
  ...
  $v_2_0 = ($GLOBALS['Data_List_Lazy_Types_step'])($l_1);
  $__t1 = null;;
...
$__local_var_4_3 = ((($GLOBALS['Data_List_Lazy_Types_foldableList'])['foldr'])((function() use ($f_0) {
  ...
  $acc_prime_8_5 = ($GLOBALS['Data_Lazy_defer'])(function($v_8) use ($__local_var_6_3, $a_4) {
  $__num = \func_num_args();
  ...
  $__res = ["val" => ($GLOBALS['Data_Lazy_defer'])(function($v_10) use ($__local_var_7_4, $__local_var_9_6) {
  $__num = \func_num_args();
  ...
  return $__fn;
})(), ["val" => $GLOBALS['Data_List_Lazy_Types_nil'], "acc" => $GLOBALS['Data_List_Lazy_Types_nil']], ($v_2_0)->{'value1'}))['val'];
$__t1 = ($GLOBALS['Data_Lazy_defer'])(function($v_5) use ($__local_var_3_2, $__local_var_4_3) {
  $__num = \func_num_args();
...
$GLOBALS['Data_List_Lazy_Types_extendNonEmptyList'] = ["extend" => (function() {
  $__fn = function($f_0, $v_1 = null) use (&$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__local_var_2_0 = (($GLOBALS['Data_Lazy_force'])($v_1))->{'value1'};
  $__res = ($GLOBALS['Data_Lazy_defer'])(function($v2_3) use ($__local_var_2_0, $f_0, $v_1) {
  $__num = \func_num_args();
  ...
  $__local_var_8_3 = ($f_0)(($GLOBALS['Data_Lazy_defer'])(function($v2_8) use ($__local_var_6_1, $a_4) {
  $__num = \func_num_args();
  ...
  $__res = ["val" => ($GLOBALS['Data_Lazy_defer'])(function($v_9) use ($__local_var_7_2, $__local_var_8_3) {
  $__num = \func_num_args();
  $__res = new \Data\List\Lazy\Types\Data_List_Lazy_Types_Cons($__local_var_8_3, $__local_var_7_2);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}), "acc" => ($GLOBALS['Data_Lazy_defer'])(function($v_8) use ($__local_var_6_1, $a_4) {
  $__num = \func_num_args();
  ...
  return $__fn;
})(), ["val" => $GLOBALS['Data_List_Lazy_Types_nil'], "acc" => $GLOBALS['Data_List_Lazy_Types_nil']], $__local_var_2_0))['val']);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
...
$GLOBALS['Data_List_Lazy_Types_foldableNonEmptyList'] = ["foldr" => (function() {
  $__fn = function($f_0, $b_1 = null, $v_2 = null) use (&$__fn) {
  $__num = \func_num_args();
  if ($__num < 3) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 3);
...
function majData_majList_majLazy_majTypes_showmajList($dictShow_0) {
  ...
  $__res = ["show" => function($xs_1) use ($dictShow_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_List_Lazy_Types_foldableWithIndexList'] = ["foldrWithIndex" => (function() {
  ...
  $__num = \func_num_args();
  $__res = new \Data\Tuple\Data_Tuple_Tuple(($__local_var_5_1 + 1), ($GLOBALS['Data_Lazy_defer'])(function($v_7) use ($__local_var_4_0, $a_6) {
  $__num = \func_num_args();
...
$GLOBALS['Data_List_Lazy_Types_foldableWithIndexNonEmpty'] = ($GLOBALS['Data_NonEmpty_foldableWithIndexNonEmpty'])($GLOBALS['Data_List_Lazy_Types_foldableWithIndexList']);

// Data_List_Lazy_Types_foldableWithIndexNonEmptyList
$GLOBALS['Data_List_Lazy_Types_foldableWithIndexNonEmptyList'] = ["foldMapWithIndex" => function($dictMonoid_0) {
  $__num = \func_num_args();
...
goto end_branch_2;;
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}), $b_1, ($GLOBALS['Data_Lazy_force'])($v_2));
  goto __end;;
  __end:
  return $__num > 3 ? $__res(...\array_slice(\func_get_args(), 3)) : $__res;
  };
...
$GLOBALS['Data_List_Lazy_Types_functorWithIndexList'] = ["mapWithIndex" => function($f_0) {
  $__num = \func_num_args();
  ...
  $__res = ($GLOBALS['Data_Lazy_defer'])(function($v_5) use ($__local_var_4_0, $acc_3) {
  $__num = \func_num_args();
...
$GLOBALS['Data_List_Lazy_Types_mapWithIndex'] = (($GLOBALS['Data_NonEmpty_functorWithIndex'])($GLOBALS['Data_List_Lazy_Types_functorWithIndexList']))['mapWithIndex'];

// Data_List_Lazy_Types_functorWithIndexNonEmptyList
$GLOBALS['Data_List_Lazy_Types_functorWithIndexNonEmptyList'] = ["mapWithIndex" => (function() {
  $__fn = function($f_0, $v_1 = null) use (&$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__res = ($GLOBALS['Data_Lazy_defer'])(function($v1_2) use ($f_0, $v_1) {
  $__num = \func_num_args();
...
function majData_majList_majLazy_majTypes_tomajList($v_0) {
  ...
  $__res = ($GLOBALS['Data_Lazy_defer'])(function($v_5) use ($__local_var_3_1, $__local_var_4_2) {
  $__num = \func_num_args();
...
$GLOBALS['Data_List_Lazy_Types_semigroupNonEmptyList'] = ["append" => (function() {
  ...
  $__res = ($GLOBALS['Data_Lazy_defer'])(function($v2_5) use ($__local_var_3_1, $__local_var_4_2, $as_prime_1) {
  $__num = \func_num_args();
  $__res = new \Data\NonEmpty\Data_NonEmpty_NonEmpty($__local_var_3_1, (($GLOBALS['Data_List_Lazy_Types_semigroupList'])['append'])($__local_var_4_2, ($GLOBALS['Data_List_Lazy_Types_toList'])($as_prime_1)));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
...
$GLOBALS['Data_List_Lazy_Types_traversableList'] = ["traverse" => function($dictApplicative_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_List_Lazy_Types_traversableNonEmpty'] = ($GLOBALS['Data_NonEmpty_traversableNonEmpty'])($GLOBALS['Data_List_Lazy_Types_traversableList']);

// Data_List_Lazy_Types_traversableNonEmptyList
$GLOBALS['Data_List_Lazy_Types_traversableNonEmptyList'] = ["traverse" => function($dictApplicative_0) {
  $__num = \func_num_args();
  ...
  $__num = \func_num_args();
  $__res = ($GLOBALS['Data_Lazy_defer'])(function($v1_5) use ($xxs_4) {
  $__num = \func_num_args();
  $__res = $xxs_4;
  goto __end;;
  __end:
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, ($traverse1_1_0)($f_2, ($GLOBALS['Data_Lazy_force'])($v_3)));
  goto __end;;
  __end:
  return $__num > 2 ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
  };
  ...
  $__num = \func_num_args();
  $__res = ($GLOBALS['Data_Lazy_defer'])(function($v1_4) use ($xxs_3) {
  $__num = \func_num_args();
  $__res = $xxs_3;
  goto __end;;
  __end:
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, ($sequence1_1_1)(($GLOBALS['Data_Lazy_force'])($v_2)));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
$GLOBALS['Data_List_Lazy_Types_traversableWithIndexList'] = ["traverseWithIndex" => function($dictApplicative_0) {
  $__num = \func_num_args();
  $Apply0_1_0 = (($dictApplicative_0)['Apply0'])(null);
  $__res = function($f_2) use ($Apply0_1_0, $dictApplicative_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_List_Lazy_Types_traverseWithIndex'] = (($GLOBALS['Data_NonEmpty_traversableWithIndexNonEmpty'])($GLOBALS['Data_List_Lazy_Types_traversableWithIndexList']))['traverseWithIndex'];

// Data_List_Lazy_Types_traversableWithIndexNonEmptyList
$GLOBALS['Data_List_Lazy_Types_traversableWithIndexNonEmptyList'] = ["traverseWithIndex" => function($dictApplicative_0) {
  $__num = \func_num_args();
...
$__t2 = ($GLOBALS['Data_Lazy_defer'])(function($v_7) use ($__local_var_5_3, $__local_var_6_4) {
  $__num = \func_num_args();
...
$__t2 = ($GLOBALS['Data_Lazy_defer'])(function($v_6) use ($__local_var_5_5) {
  $__num = \func_num_args();
...
return ["unfoldr" => $go__0_0, "Unfoldable10" => function($_dollar__unused_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_List_Lazy_Types_unfoldable1NonEmptyList'] = ["unfoldr1" => (function() {
  ...
  $__res = ($GLOBALS['Data_Lazy_defer'])(function($v_2) use ($b_1, $f_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_List_Lazy_Types_comonadNonEmptyList'] = ["extract" => function($v_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_List_Lazy_Types_monadList'] = ["Applicative0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_List_Lazy_Types_bindList'] = ["bind" => (function() {
...
$GLOBALS['Data_List_Lazy_Types_applicativeList'] = ["pure" => function($a_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_List_Lazy_Types_applyNonEmptyList'] = ["apply" => (function() {
  $__fn = function($v_0, $v1_1 = null) use (&$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $v2_2_0 = ($GLOBALS['Data_Lazy_force'])($v1_1);
  $v3_3_1 = ($GLOBALS['Data_Lazy_force'])($v_0);
  $__local_var_4_2 = ($v2_2_0)->{'value0'};
  $__local_var_5_3 = ($v2_2_0)->{'value1'};
  $__local_var_6_4 = ($v3_3_1)->{'value0'};
  $__local_var_7_5 = ($v3_3_1)->{'value1'};
  $__res = ($GLOBALS['Data_Lazy_defer'])(function($v4_8) use ($__local_var_4_2, $__local_var_5_3, $__local_var_6_4, $__local_var_7_5) {
  $__num = \func_num_args();
  $__res = new \Data\NonEmpty\Data_NonEmpty_NonEmpty(($__local_var_6_4)($__local_var_4_2), (($GLOBALS['Data_List_Lazy_Types_semigroupList'])['append'])((($GLOBALS['Data_List_Lazy_Types_applyList'])['apply'])($__local_var_7_5, ($GLOBALS['Data_Lazy_defer'])(function($v_9) use ($__local_var_4_2) {
  $__num = \func_num_args();
  $__res = new \Data\List\Lazy\Types\Data_List_Lazy_Types_Cons($__local_var_4_2, $GLOBALS['Data_List_Lazy_Types_nil']);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
})), (($GLOBALS['Data_List_Lazy_Types_applyList'])['apply'])(($GLOBALS['Data_Lazy_defer'])(function($v_9) use ($__local_var_6_4, $__local_var_7_5) {
  $__num = \func_num_args();
...
$GLOBALS['Data_List_Lazy_Types_bindNonEmptyList'] = ["bind" => (function() {
  ...
  $v2_4_2 = ($GLOBALS['Data_Lazy_force'])(($f_1)(($v1_2_0)->{'value0'}));
  $__local_var_5_3 = ($v2_4_2)->{'value0'};
  $__local_var_6_4 = ($v2_4_2)->{'value1'};
  $__res = ($GLOBALS['Data_Lazy_defer'])(function($v3_7) use ($__local_var_3_1, $__local_var_5_3, $__local_var_6_4, $f_1) {
  $__num = \func_num_args();
...
$GLOBALS['Data_List_Lazy_Types_altNonEmptyList'] = ["alt" => ($GLOBALS['Data_List_Lazy_Types_semigroupNonEmptyList'])['append'], "Functor0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
  $__res = $GLOBALS['Data_List_Lazy_Types_functorNonEmptyList'];
  goto __end;;
  __end:
...
$GLOBALS['Data_List_Lazy_Types_altList'] = ["alt" => ($GLOBALS['Data_List_Lazy_Types_semigroupList'])['append'], "Functor0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
  $__res = $GLOBALS['Data_List_Lazy_Types_functorList'];
  goto __end;;
  __end:
...
$GLOBALS['Data_List_Lazy_Types_plusList'] = ["empty" => $GLOBALS['Data_List_Lazy_Types_nil'], "Alt0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_List_Lazy_Types_alternativeList'] = ["Applicative0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
  $__res = $GLOBALS['Data_List_Lazy_Types_applicativeList'];
  goto __end;;
  __end:
...
$GLOBALS['Data_List_Lazy_Types_monadPlusList'] = ["Monad0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_List_Lazy_Types_applicativeNonEmptyList'] = ["pure" => function($a_0) {
  $__num = \func_num_args();
  $__res = ($GLOBALS['Data_Lazy_defer'])(function($v_1) use ($a_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_List_Lazy_Types_monadNonEmptyList'] = ["Applicative0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
