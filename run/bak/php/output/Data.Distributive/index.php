...
\PhpursThunks::$thunks['Data_Distributive_distributiveTuple'] = function() { $v = function($dictTypeEquals_0 = null) {
  ...
  $__tco_done_Data_Distributive_distributiveTuple = false;
  $__tco_res_Data_Distributive_distributiveTuple = null;
  $__tco_loop_Data_Distributive_distributiveTuple = function($dictTypeEquals_0 = null) use (&$__tco_done_Data_Distributive_distributiveTuple, &$__tco_var_Data_Distributive_distributiveTuple_dictTypeEquals_0) {
  $__num = \func_num_args();
  $__tco_done_Data_Distributive_distributiveTuple = true;
  ...
  while (($__tco_done_Data_Distributive_distributiveTuple === false)) {
$__tco_res_Data_Distributive_distributiveTuple = ($__tco_loop_Data_Distributive_distributiveTuple)($__tco_var_Data_Distributive_distributiveTuple_dictTypeEquals_0);
};
  $__res = $__tco_res_Data_Distributive_distributiveTuple;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}; return $v; };
