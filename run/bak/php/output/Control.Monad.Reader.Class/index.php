...
\PhpursThunks::$thunks['Control_Monad_Reader_Class_monadAskFun'] = function() { $v = (object)["ask" => (($GLOBALS['Control_Category_categoryFn'] ?? \PhpursThunks::eval('Control_Category_categoryFn')))->{'identity'}, "Monad0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
