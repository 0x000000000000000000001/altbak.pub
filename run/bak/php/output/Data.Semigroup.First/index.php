...
$GLOBALS['Data_Semigroup_First_applicativeFirst'] = ["pure" => $GLOBALS['Data_Semigroup_First_First'], "Apply0" => function($_dollar__unused_0 = null) {
  $__num = \func_num_args();
  $__res = $GLOBALS['Data_Semigroup_First_applyFirst'];
  goto __end;;
  __end:
...
$GLOBALS['Data_Semigroup_First_monadFirst'] = ["Applicative0" => function($_dollar__unused_0 = null) {
  $__num = \func_num_args();
