...
\PhpursThunks::$thunks['Data_Semigroup_First_eq1First'] = function() { $v = (object)["eq1" => function($dictEq_0 = null) {
  $__num = \func_num_args();
  $__res = ($dictEq_0)->{'eq'};
  goto __end;;
  __end:
...
\PhpursThunks::$thunks['Data_Semigroup_First_ord1First'] = function() { $v = (object)["compare1" => function($dictOrd_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_Semigroup_First_applicativeFirst'] = function() { $v = (object)["pure" => ($GLOBALS['Data_Semigroup_First_First'] ?? \PhpursThunks::eval('Data_Semigroup_First_First')), "Apply0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
  $__res = ($GLOBALS['Data_Semigroup_First_applyFirst'] ?? \PhpursThunks::eval('Data_Semigroup_First_applyFirst'));
  goto __end;;
  __end:
...
\PhpursThunks::$thunks['Data_Semigroup_First_monadFirst'] = function() { $v = (object)["Applicative0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
