...
$GLOBALS['Data_Semigroup_Traversable_traversableTuple'] = ["traverse1" => (function() {
  $__fn = function($dictApply_0 = null, $f_1 = null, $v_2 = null) use (&$__fn) {
  $__num = \func_num_args();
  if ($__num < 3) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 3);
  }
  $__res = ((((($dictApply_0)['Functor0'])($GLOBALS['Prim_undefined']))['map'])(($GLOBALS['Data_Tuple_Tuple'])(($v_2)->{'value0'})))(($f_1)(($v_2)->{'value1'}));
  goto __end;;
  __end:
  ...
  $__fn = function($dictApply_0 = null, $v_1 = null) use (&$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__res = ((((($dictApply_0)['Functor0'])($GLOBALS['Prim_undefined']))['map'])(($GLOBALS['Data_Tuple_Tuple'])(($v_1)->{'value0'})))(($v_1)->{'value1'});
  goto __end;;
  __end:
...
$GLOBALS['Data_Semigroup_Traversable_traversableIdentity'] = ["traverse1" => (function() {
  $__fn = function($dictApply_0 = null, $f_1 = null, $v_2 = null) use (&$__fn) {
  $__num = \func_num_args();
  if ($__num < 3) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 3);
  }
  $__res = ((((($dictApply_0)['Functor0'])($GLOBALS['Prim_undefined']))['map'])($GLOBALS['Data_Identity_Identity']))(($f_1)($v_2));
  goto __end;;
  __end:
  return $__num > 3 ? $__res(...\array_slice(\func_get_args(), 3)) : $__res;
  };
  ...
  $__res = ((((($dictApply_0)['Functor0'])($GLOBALS['Prim_undefined']))['map'])($GLOBALS['Data_Identity_Identity']))($v_1);
  goto __end;;
  __end:
  return $__num > 2 ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
  };
...
$GLOBALS['Data_Semigroup_Traversable_sequence1Default'] = (function() {
  $__fn = function($dictTraversable1_0 = null, $dictApply_1 = null) use (&$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
...
$GLOBALS['Data_Semigroup_Traversable_traversableDual'] = ["traverse1" => (function() {
  $__fn = function($dictApply_0 = null, $f_1 = null, $v_2 = null) use (&$__fn) {
  $__num = \func_num_args();
  if ($__num < 3) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 3);
  }
  $__res = ((((($dictApply_0)['Functor0'])($GLOBALS['Prim_undefined']))['map'])($GLOBALS['Data_Monoid_Dual_Dual']))(($f_1)($v_2));
  goto __end;;
  __end:
  return $__num > 3 ? $__res(...\array_slice(\func_get_args(), 3)) : $__res;
  };
...
$GLOBALS['Data_Semigroup_Traversable_traversableMultiplicative'] = ["traverse1" => (function() {
  $__fn = function($dictApply_0 = null, $f_1 = null, $v_2 = null) use (&$__fn) {
  $__num = \func_num_args();
  if ($__num < 3) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 3);
  }
  $__res = ((((($dictApply_0)['Functor0'])($GLOBALS['Prim_undefined']))['map'])($GLOBALS['Data_Monoid_Multiplicative_Multiplicative']))(($f_1)($v_2));
  goto __end;;
  __end:
  return $__num > 3 ? $__res(...\array_slice(\func_get_args(), 3)) : $__res;
  };
...
$GLOBALS['Data_Semigroup_Traversable_sequence1'] = function($dict_0 = null) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Semigroup_Traversable_traverse1Default'] = (function() {
  $__fn = function($dictTraversable1_0 = null, $dictApply_1 = null) use (&$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  ...
  $__fn = function($f_3 = null, $ta_4 = null) use ($dictTraversable1_0, $sequence12_2_0, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__res = ($sequence12_2_0)(((((((($dictTraversable1_0)['Traversable1'])($GLOBALS['Prim_undefined']))['Functor0'])($GLOBALS['Prim_undefined']))['map'])($f_3))($ta_4));
  goto __end;;
  __end:
  return $__num > 2 ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
  };
