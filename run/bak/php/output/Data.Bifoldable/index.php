...
\PhpursThunks::$thunks['Data_Bifoldable_bifoldableProduct2'] = function() { $v = (function() {
  ...
  $__tco_done_Data_Bifoldable_bifoldableProduct2 = false;
  $__tco_res_Data_Bifoldable_bifoldableProduct2 = null;
  $__tco_loop_Data_Bifoldable_bifoldableProduct2 = (function() use (&$__tco_done_Data_Bifoldable_bifoldableProduct2, &$__tco_var_Data_Bifoldable_bifoldableProduct2_dictBifoldable_0, &$__tco_var_Data_Bifoldable_bifoldableProduct2_dictBifoldable1_1) {
  $__fn = function($dictBifoldable_0 = null, $dictBifoldable1_1 = null) use (&$__tco_done_Data_Bifoldable_bifoldableProduct2, &$__tco_var_Data_Bifoldable_bifoldableProduct2_dictBifoldable_0, &$__tco_var_Data_Bifoldable_bifoldableProduct2_dictBifoldable1_1, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_done_Data_Bifoldable_bifoldableProduct2 = true;
  ...
  while (($__tco_done_Data_Bifoldable_bifoldableProduct2 === false)) {
$__tco_res_Data_Bifoldable_bifoldableProduct2 = ($__tco_loop_Data_Bifoldable_bifoldableProduct2)($__tco_var_Data_Bifoldable_bifoldableProduct2_dictBifoldable_0, $__tco_var_Data_Bifoldable_bifoldableProduct2_dictBifoldable1_1);
};
  $__res = $__tco_res_Data_Bifoldable_bifoldableProduct2;
  goto __end;;
  __end:
  return $__num > 2 ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
  };
