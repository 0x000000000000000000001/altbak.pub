...
$GLOBALS['Data_Either_Inject_injectReflexive'] = ["inj" => function($x_0) {
  $__num = \func_num_args();
  $__res = $x_0;
  goto __end;;
  __end:
...
$GLOBALS['Data_Either_Inject_injectLeft'] = ["inj" => $GLOBALS['Data_Either_Left'], "prj" => function($v2_0) {
  $__num = \func_num_args();
  $__t0 = null;;
...
function majData_majEither_majInject_injectmajRight($dictInject_0) {
  ...
  $__res = ["inj" => ($GLOBALS['Control_Semigroupoid_composeImpl'])($GLOBALS['Data_Either_Right'], ($dictInject_0)['inj']), "prj" => function($v2_1) use ($dictInject_0) {
  $__num = \func_num_args();
  $__t0 = null;;
