...
\PhpursThunks::$thunks['Control_Monad_Writer_Trans_newtypeWriterT'] = function() { $v = (object)["Coercible0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_Writer_Trans_applyWriterT'] = function() { $v = (function() {
  ...
  $functorWriterT1_3_1 = (object)["map" => function($f_3 = null) use ($Functor0_2_0) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_Writer_Trans_applicativeWriterT'] = function() { $v = function($dictMonoid_0 = null) {
  ...
  $__res = (object)["pure" => function($a_5 = null) use ($dictApplicative_3, $mempty_1_0) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_Writer_Trans_monadWriterT'] = function() { $v = function($dictMonoid_0 = null) {
  ...
  $__res = (object)["Applicative0" => function($dollar__unused_6 = null) use ($applicativeWriterT2_4_2) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_Writer_Trans_monadAskWriterT'] = function() { $v = function($dictMonoid_0 = null) {
  ...
  $__res = (object)["ask" => ((((($GLOBALS['Control_Monad_Writer_Trans_monadTransWriterT'] ?? \PhpursThunks::eval('Control_Monad_Writer_Trans_monadTransWriterT')))($dictMonoid_0))->{'lift'})($Monad0_3_1))(($dictMonadAsk_2)->{'ask'}), "Monad0" => function($dollar__unused_5 = null) use ($monadWriterT2_4_2) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_Writer_Trans_monadReaderWriterT'] = function() { $v = function($dictMonoid_0 = null) {
  ...
  $__res = (object)["local" => function($f_4 = null) use ($dictMonadReader_2) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_Writer_Trans_monadContWriterT'] = function() { $v = function($dictMonoid_0 = null) {
  ...
  $__res = (object)["callCC" => function($f_5 = null) use ($dictMonadCont_3, $mempty_1_0) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_Writer_Trans_monadEffectWriter'] = function() { $v = function($dictMonoid_0 = null) {
  ...
  $monadWriterT2_4_2 = ($monadWriterT1_1_0)($Monad0_3_1);
  $__res = (object)["liftEffect" => ((($GLOBALS['Control_Semigroupoid_composeImpl'] ?? \PhpursThunks::eval('Control_Semigroupoid_composeImpl')))((((($GLOBALS['Control_Monad_Writer_Trans_monadTransWriterT'] ?? \PhpursThunks::eval('Control_Monad_Writer_Trans_monadTransWriterT')))($dictMonoid_0))->{'lift'})($Monad0_3_1)))(($dictMonadEffect_2)->{'liftEffect'}), "Monad0" => function($dollar__unused_5 = null) use ($monadWriterT2_4_2) {
  $__num = \func_num_args();
  $__res = $monadWriterT2_4_2;
  goto __end;;
  __end:
...
\PhpursThunks::$thunks['Control_Monad_Writer_Trans_monadStateWriterT'] = function() { $v = function($dictMonoid_0 = null) {
  ...
  $__res = (object)["state" => function($f_6 = null) use ($dictMonadState_2, $lift1_4_2) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_Writer_Trans_monadWriterWriterT'] = function() { $v = function($dictMonoid_0 = null) {
  ...
  $__res = (object)["listen" => function($v_6 = null) use ($__local_var_3_1, $__local_var_4_2) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_Writer_Trans_monadThrowWriterT'] = function() { $v = function($dictMonoid_0 = null) {
  ...
  $lift1_4_2 = (((($GLOBALS['Control_Monad_Writer_Trans_monadTransWriterT'] ?? \PhpursThunks::eval('Control_Monad_Writer_Trans_monadTransWriterT')))($dictMonoid_0))->{'lift'})($Monad0_3_1);
  $monadWriterT2_5_3 = ($monadWriterT1_1_0)($Monad0_3_1);
  $__res = (object)["throwError" => function($e_6 = null) use ($dictMonadThrow_2, $lift1_4_2) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_Writer_Trans_monadSTWriterT'] = function() { $v = function($dictMonoid_0 = null) {
  ...
  $monadWriterT2_4_2 = ($monadWriterT1_1_0)($Monad0_3_1);
  $__res = (object)["liftST" => ((($GLOBALS['Control_Semigroupoid_composeImpl'] ?? \PhpursThunks::eval('Control_Semigroupoid_composeImpl')))((((($GLOBALS['Control_Monad_Writer_Trans_monadTransWriterT'] ?? \PhpursThunks::eval('Control_Monad_Writer_Trans_monadTransWriterT')))($dictMonoid_0))->{'lift'})($Monad0_3_1)))(($dictMonadST_2)->{'liftST'}), "Monad0" => function($dollar__unused_5 = null) use ($monadWriterT2_4_2) {
  $__num = \func_num_args();
  $__res = $monadWriterT2_4_2;
  goto __end;;
  __end:
...
\PhpursThunks::$thunks['Control_Monad_Writer_Trans_monoidWriterT'] = function() { $v = function($dictApplicative_0 = null) {
  ...
  $__res = (object)["mempty" => ((((($GLOBALS['Control_Monad_Writer_Trans_applicativeWriterT'] ?? \PhpursThunks::eval('Control_Monad_Writer_Trans_applicativeWriterT')))($dictMonoid_2))($dictApplicative_0))->{'pure'})(($dictMonoid1_4)->{'mempty'}), "Semigroup0" => function($dollar__unused_6 = null) use ($semigroupWriterT3_5_2) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_Writer_Trans_altWriterT'] = function() { $v = function($dictAlt_0 = null) {
  ...
  $functorWriterT1_2_1 = (object)["map" => function($f_2 = null) use ($__local_var_1_0) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_Writer_Trans_plusWriterT'] = function() { $v = function($dictPlus_0 = null) {
  ...
  $__res = (object)["empty" => ($dictPlus_0)->{'empty'}, "Alt0" => function($dollar__unused_2 = null) use ($altWriterT1_1_0) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_Writer_Trans_alternativeWriterT'] = function() { $v = function($dictMonoid_0 = null) {
  ...
  $__res = (object)["Applicative0" => function($dollar__unused_6 = null) use ($applicativeWriterT2_3_1) {
  $__num = \func_num_args();
  ...
  $__num = \func_num_args();
  $__res = (object)["empty" => ($__local_var_4_2)->{'empty'}, "Alt0" => function($dollar__unused_7 = null) use ($altWriterT1_5_3) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_Writer_Trans_monadPlusWriterT'] = function() { $v = function($dictMonoid_0 = null) {
  ...
  $__res = (object)["Monad0" => function($dollar__unused_6 = null) use ($monadWriterT2_4_2) {
  $__num = \func_num_args();
  $__res = $monadWriterT2_4_2;
  goto __end;;
  __end:
