...
final class Control_Monad_List_Trans_Yield { public function __construct(public mixed $value0, public mixed $value1) {} }
final class Control_Monad_List_Trans_Skip { public function __construct(public mixed $value0) {} }
...
$__t0 = new \Control\Monad\List\Trans\Control_Monad_List_Trans_Yield((($v_3)->{'value0'})->{'value1'}, ($GLOBALS['Data_Lazy_defer'])(function($v1_5 = null) use ($__local_var_4_1, $dictMonad_0, $f_1) {
  $__num = \func_num_args();
...
function majControl_majMonad_majList_majTrans_prepend($dictApplicative_0, $h_1 = null, $t_2 = null) {
  ...
  $__res = (($dictApplicative_0)['pure'])(new \Control\Monad\List\Trans\Control_Monad_List_Trans_Yield($h_1, ($GLOBALS['Data_Lazy_defer'])(function($v_3 = null) use ($t_2) {
  $__num = \func_num_args();
  $__res = $t_2;
  goto __end;;
  __end:
...
function majControl_majMonad_majList_majTrans_singleton($dictApplicative_0) {
  ...
  $__num = \func_num_args();
  $__res = (($dictApplicative_0)['pure'])(new \Control\Monad\List\Trans\Control_Monad_List_Trans_Yield($a_2, ($GLOBALS['Data_Lazy_defer'])(function($v_3 = null) use ($nil1_1_0) {
  $__num = \func_num_args();
  $__res = $nil1_1_0;
  goto __end;;
  __end:
...
$__t3 = (($Applicative0_1_0)['pure'])(new \Control\Monad\List\Trans\Control_Monad_List_Trans_Yield(($GLOBALS['Data_Lazy_force'])((($GLOBALS['Data_Lazy_applicativeLazy'])['pure'])(($v_6)->{'value0'})), ($GLOBALS['Data_Lazy_defer'])(function($v1_8 = null) use ($__local_var_7_4, $f_3, &$go__5_2) {
  $__num = \func_num_args();
...
$__t4 = (($Applicative0_1_0)['pure'])(new \Control\Monad\List\Trans\Control_Monad_List_Trans_Yield(($GLOBALS['Data_Lazy_force'])((($GLOBALS['Data_Lazy_applicativeLazy'])['pure'])((($v_7)->{'value0'})->{'value0'})), ($GLOBALS['Data_Lazy_defer'])(function($v1_9 = null) use ($__local_var_8_5, $f_4, &$go__6_3) {
  $__num = \func_num_args();
...
function majControl_majMonad_majList_majTrans_concat($dictApplicative_0) {
  ...
  $__t1 = null;;
  if ($v_4 instanceof \Control\Monad\List\Trans\Control_Monad_List_Trans_Yield) {
$__t1 = new \Control\Monad\List\Trans\Control_Monad_List_Trans_Yield(($v_4)->{'value0'}, (($GLOBALS['Data_Lazy_functorLazy'])['map'])(function($v1_5 = null) use ($dictApplicative_0, $y_3) {
  $__num = \func_num_args();
...
goto end_branch_1;;
  ...
  if ($v_4 instanceof \Control\Monad\List\Trans\Control_Monad_List_Trans_Skip) {
$__t1 = new \Control\Monad\List\Trans\Control_Monad_List_Trans_Skip((($GLOBALS['Data_Lazy_functorLazy'])['map'])(function($v1_5 = null) use ($dictApplicative_0, $y_3) {
  $__num = \func_num_args();
  $__res = ($GLOBALS['Control_Monad_List_Trans_concat'])($dictApplicative_0, $v1_5, $y_3);
  goto __end;;
  __end:
...
goto end_branch_1;;
  ...
  if ($v_4 instanceof \Control\Monad\List\Trans\Control_Monad_List_Trans_Done) {
$__t1 = new \Control\Monad\List\Trans\Control_Monad_List_Trans_Skip(($GLOBALS['Data_Lazy_defer'])(function($v_5 = null) use ($y_3) {
  $__num = \func_num_args();
  $__res = $y_3;
  goto __end;;
  __end:
...
function majControl_majMonad_majList_majTrans_monoidmajListmajT($dictApplicative_0) {
  ...
  $__res = ["mempty" => (($dictApplicative_0)['pure'])(new \Control\Monad\List\Trans\Control_Monad_List_Trans_Done()), "Semigroup0" => function($_dollar__unused_2 = null) use ($semigroupListT1_1_0) {
  $__num = \func_num_args();
...
$__t2 = new \Control\Monad\List\Trans\Control_Monad_List_Trans_Skip((($GLOBALS['Data_Lazy_functorLazy'])['map'])(function($s_prime_7 = null) use ($__local_var_6_3, $append_1_0, $dictMonad_0, $f_4) {
  $__num = \func_num_args();
...
$__t2 = new \Control\Monad\List\Trans\Control_Monad_List_Trans_Skip((($GLOBALS['Data_Lazy_functorLazy'])['map'])(function($v1_6 = null) use ($dictMonad_0, $f_4) {
  $__num = \func_num_args();
...
function majControl_majMonad_majList_majTrans_plusmajListmajT($dictMonad_0) {
  ...
  $__res = ["empty" => (($Applicative0_1_0)['pure'])(new \Control\Monad\List\Trans\Control_Monad_List_Trans_Done()), "Alt0" => function($_dollar__unused_3 = null) use ($altListT1_2_1) {
  $__num = \func_num_args();
  $__res = $altListT1_2_1;
  goto __end;;
  __end:
