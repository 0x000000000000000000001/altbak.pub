...
final class Control_Monad_List_Trans_Yield { public function __construct(public  $value0, public  $value1) {} }
final class Control_Monad_List_Trans_Skip { public function __construct(public  $value0) {} }
final class Control_Monad_List_Trans_Done { public function __construct() {} }
...
$__t0 = new \Control\Monad\List\Trans\Control_Monad_List_Trans_Yield((($v_3)->{'value0'})->{'value1'}, ($GLOBALS['Data_Lazy_defer'])(function($v1_5) use ($__local_var_4_1, $dictMonad_0, $f_1) {
  $__num = \func_num_args();
...
$__t1 = (($__local_var_1_0)['pure'])(new \Data\Maybe\Data_Maybe_Just(new \Data\Tuple\Data_Tuple_Tuple(($v1_3)->{'value0'}, ($GLOBALS['Data_Lazy_force'])(($v1_3)->{'value1'}))));
goto end_branch_1;;
};
...
function majControl_majMonad_majList_majTrans_scanl($dictMonad_0, $f_1 = null, $b_2 = null, $l_3 = null) {
  ...
  $__res = ($GLOBALS['Control_Monad_List_Trans_unfold'])($dictMonad_0, function($v_4) use ($dictMonad_0, $f_1) {
  $__num = \func_num_args();
...
$__t1 = new \Data\Maybe\Data_Maybe_Just(new \Data\Tuple\Data_Tuple_Tuple(new \Data\Tuple\Data_Tuple_Tuple(($f_1)($__local_var_5_0, ($v1_6)->{'value0'}), ($GLOBALS['Data_Lazy_force'])(($v1_6)->{'value1'})), $__local_var_5_0));
goto end_branch_1;;
};
  if ($v1_6 instanceof \Control\Monad\List\Trans\Control_Monad_List_Trans_Skip) {
$__t1 = new \Data\Maybe\Data_Maybe_Just(new \Data\Tuple\Data_Tuple_Tuple(new \Data\Tuple\Data_Tuple_Tuple($__local_var_5_0, ($GLOBALS['Data_Lazy_force'])(($v1_6)->{'value0'})), $__local_var_5_0));
goto end_branch_1;;
};
...
function majControl_majMonad_majList_majTrans_prepend($dictApplicative_0, $h_1 = null, $t_2 = null) {
  ...
  $__res = (($dictApplicative_0)['pure'])(new \Control\Monad\List\Trans\Control_Monad_List_Trans_Yield($h_1, ($GLOBALS['Data_Lazy_defer'])(function($v_3) use ($t_2) {
  $__num = \func_num_args();
  $__res = $t_2;
  goto __end;;
  __end:
...
function majControl_majMonad_majList_majTrans_singleton($dictApplicative_0) {
  ...
  $__num = \func_num_args();
  $__res = (($dictApplicative_0)['pure'])(new \Control\Monad\List\Trans\Control_Monad_List_Trans_Yield($a_2, ($GLOBALS['Data_Lazy_defer'])(function($v_3) use ($nil1_1_0) {
  $__num = \func_num_args();
  $__res = $nil1_1_0;
  goto __end;;
  __end:
...
$__local_var_13_8 = ($GLOBALS['Data_Lazy_defer'])(function($v2_13) use ($__local_var_11_6, $__local_var_12_7, $dictMonad_0, $f_6) {
  $__num = \func_num_args();
...
$GLOBALS['Control_Monad_List_Trans_newtypeListT'] = ["Coercible0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
  $__res = null;
  goto __end;;
  __end:
...
function majControl_majMonad_majList_majTrans_iterate($dictMonad_0, $f_1 = null, $a_2 = null) {
  ...
  $__res = ($GLOBALS['Control_Monad_List_Trans_unfold'])($dictMonad_0, function($x_3) use ($dictMonad_0, $f_1) {
  $__num = \func_num_args();
...
function majControl_majMonad_majList_majTrans_functormajListmajT($dictFunctor_0) {
  ...
  $__t0 = null;;
  if ($v_3 instanceof \Control\Monad\List\Trans\Control_Monad_List_Trans_Yield) {
$__t0 = new \Control\Monad\List\Trans\Control_Monad_List_Trans_Yield(($f_1)(($v_3)->{'value0'}), (($GLOBALS['Data_Lazy_functorLazy'])['map'])(((($GLOBALS['Control_Monad_List_Trans_functorListT'])($dictFunctor_0))['map'])($f_1), ($v_3)->{'value1'}));
goto end_branch_0;;
};
  if ($v_3 instanceof \Control\Monad\List\Trans\Control_Monad_List_Trans_Skip) {
$__t0 = new \Control\Monad\List\Trans\Control_Monad_List_Trans_Skip((($GLOBALS['Data_Lazy_functorLazy'])['map'])(((($GLOBALS['Control_Monad_List_Trans_functorListT'])($dictFunctor_0))['map'])($f_1), ($v_3)->{'value0'}));
goto end_branch_0;;
};
  if ($v_3 instanceof \Control\Monad\List\Trans\Control_Monad_List_Trans_Done) {
$__t0 = new \Control\Monad\List\Trans\Control_Monad_List_Trans_Done();
...
function majControl_majMonad_majList_majTrans_frommajEffect($dictApplicative_0) {
  ...
  $__num = \func_num_args();
  $__local_var_3_1 = ($GLOBALS['Data_Lazy_defer'])(function($v_3) use ($nil1_1_0) {
  $__num = \func_num_args();
  $__res = $nil1_1_0;
  goto __end;;
  __end:
...
$GLOBALS['Control_Monad_List_Trans_monadTransListT'] = ["lift" => function($dictMonad_0) {
  $__num = \func_num_args();
...
$__t5 = (($__local_var_3_2)['bind'])(($f_5)($__local_var_9_4, (($v_10)->{'value0'})->{'value0'}), function($b_prime_12) use ($__local_var_11_6, $__local_var_2_1) {
  $__num = \func_num_args();
  $__res = (($__local_var_2_1)['pure'])(new \Control\Monad\Rec\Class\Control_Monad_Rec_Class_Loop(["a" => $b_prime_12, "b" => $__local_var_11_6]));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
...
$__t4 = (($__local_var_2_1)['pure'])(new \Control\Monad\Rec\Class\Control_Monad_Rec_Class_Loop(["a" => ($f_4)($__local_var_8_3, (($v_9)->{'value0'})->{'value0'}), "b" => (($v_9)->{'value0'})->{'value1'}]));
goto end_branch_4;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t4 = null;
...
function majControl_majMonad_majList_majTrans_cons($dictApplicative_0, $lh_1 = null, $t_2 = null) {
  ...
  $__res = (($dictApplicative_0)['pure'])(new \Control\Monad\List\Trans\Control_Monad_List_Trans_Yield(($GLOBALS['Data_Lazy_force'])($lh_1), $t_2));
  goto __end;;
  __end:
  return 3 < $__num ? $__res(...\array_slice(\func_get_args(), 3)) : $__res;
}
...
$__t3 = (($Applicative0_1_0)['pure'])(new \Control\Monad\List\Trans\Control_Monad_List_Trans_Yield(($GLOBALS['Data_Lazy_force'])((($GLOBALS['Data_Lazy_applicativeLazy'])['pure'])(($v_6)->{'value0'})), ($GLOBALS['Data_Lazy_defer'])(function($v1_8) use ($__local_var_7_4, $f_3, &$go__5_2) {
  $__num = \func_num_args();
...
$__t4 = (($Applicative0_1_0)['pure'])(new \Control\Monad\List\Trans\Control_Monad_List_Trans_Yield(($GLOBALS['Data_Lazy_force'])((($GLOBALS['Data_Lazy_applicativeLazy'])['pure'])((($v_7)->{'value0'})->{'value0'})), ($GLOBALS['Data_Lazy_defer'])(function($v1_9) use ($__local_var_8_5, $f_4, &$go__6_3) {
  $__num = \func_num_args();
...
goto end_branch_1;;
  ...
  if ($v_4 instanceof \Control\Monad\List\Trans\Control_Monad_List_Trans_Done) {
$__t1 = new \Control\Monad\List\Trans\Control_Monad_List_Trans_Skip(($GLOBALS['Data_Lazy_defer'])(function($v_5) use ($y_3) {
  $__num = \func_num_args();
  $__res = $y_3;
  goto __end;;
  __end:
...
function majControl_majMonad_majList_majTrans_monoidmajListmajT($dictApplicative_0) {
  ...
  $__res = ["mempty" => (($dictApplicative_0)['pure'])(new \Control\Monad\List\Trans\Control_Monad_List_Trans_Done()), "Semigroup0" => function($_dollar__unused_2) use ($semigroupListT1_1_0) {
  $__num = \func_num_args();
...
function majControl_majMonad_majList_majTrans_applicativemajListmajT($dictMonad_0) {
  ...
  $__res = ["pure" => ($GLOBALS['Control_Monad_List_Trans_singleton'])((($dictMonad_0)['Applicative0'])(null)), "Apply0" => function($_dollar__unused_1) use ($dictMonad_0) {
  $__num = \func_num_args();
  $__res = ($GLOBALS['Control_Monad_List_Trans_applyListT'])($dictMonad_0);
  goto __end;;
  __end:
...
function majControl_majMonad_majList_majTrans_monadmajEffectmajListmajT($dictMonadEffect_0) {
  ...
  $monadListT1_2_1 = ["Applicative0" => function($_dollar__unused_2) use ($Monad0_1_0) {
  $__num = \func_num_args();
  $__res = ["pure" => ($GLOBALS['Control_Monad_List_Trans_singleton'])((($Monad0_1_0)['Applicative0'])(null)), "Apply0" => function($_dollar__unused_3) use ($Monad0_1_0) {
  $__num = \func_num_args();
  ...
  $__res = ["liftEffect" => ($GLOBALS['Control_Semigroupoid_composeImpl'])((($GLOBALS['Control_Monad_List_Trans_monadTransListT'])['lift'])($Monad0_1_0), ($dictMonadEffect_0)['liftEffect']), "Monad0" => function($_dollar__unused_3) use ($monadListT1_2_1) {
  $__num = \func_num_args();
...
function majControl_majMonad_majList_majTrans_monadmajSmajTmajListmajT($dictMonadST_0) {
  ...
  $__res = ["liftST" => ($GLOBALS['Control_Semigroupoid_composeImpl'])((($GLOBALS['Control_Monad_List_Trans_monadTransListT'])['lift'])($Monad0_1_0), ($dictMonadST_0)['liftST']), "Monad0" => function($_dollar__unused_3) use ($monadListT1_2_1) {
  $__num = \func_num_args();
  $__res = $monadListT1_2_1;
  goto __end;;
  __end:
...
function majControl_majMonad_majList_majTrans_altmajListmajT($dictApplicative_0) {
  ...
  $__res = ["alt" => ($GLOBALS['Control_Monad_List_Trans_concat'])($dictApplicative_0), "Functor0" => function($_dollar__unused_2) use ($functorListT1_1_0) {
  $__num = \func_num_args();
  $__res = $functorListT1_1_0;
  goto __end;;
  __end:
...
function majControl_majMonad_majList_majTrans_plusmajListmajT($dictMonad_0) {
  ...
  $__res = ["empty" => (($Applicative0_1_0)['pure'])(new \Control\Monad\List\Trans\Control_Monad_List_Trans_Done()), "Alt0" => function($_dollar__unused_3) use ($altListT1_2_1) {
  $__num = \func_num_args();
  $__res = $altListT1_2_1;
  goto __end;;
  __end:
...
function majControl_majMonad_majList_majTrans_alternativemajListmajT($dictMonad_0) {
  ...
  $applicativeListT1_1_0 = ["pure" => ($GLOBALS['Control_Monad_List_Trans_singleton'])((($dictMonad_0)['Applicative0'])(null)), "Apply0" => function($_dollar__unused_1) use ($dictMonad_0) {
  $__num = \func_num_args();
  $__res = ($GLOBALS['Control_Monad_List_Trans_applyListT'])($dictMonad_0);
  goto __end;;
  __end:
  ...
  $__res = ["Applicative0" => function($_dollar__unused_3) use ($applicativeListT1_1_0) {
  $__num = \func_num_args();
...
function majControl_majMonad_majList_majTrans_monadmajPlusmajListmajT($dictMonad_0) {
  ...
  $monadListT1_1_0 = ["Applicative0" => function($_dollar__unused_1) use ($dictMonad_0) {
  $__num = \func_num_args();
  $__res = ["pure" => ($GLOBALS['Control_Monad_List_Trans_singleton'])((($dictMonad_0)['Applicative0'])(null)), "Apply0" => function($_dollar__unused_2) use ($dictMonad_0) {
  $__num = \func_num_args();
  $__res = ($GLOBALS['Control_Monad_List_Trans_applyListT'])($dictMonad_0);
  goto __end;;
  __end:
  ...
  $__res = ["Monad0" => function($_dollar__unused_3) use ($monadListT1_1_0) {
  $__num = \func_num_args();
