...
\PhpursThunks::$thunks['Data_String_CodePoints_boundedEnumCodePoint'] = function() { $v = (object)["cardinality" => 1114112, "fromEnum" => function($v_0) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_String_CodePoints_enumCodePoint'] = function() { $v = (object)["succ" => function($a_0) {
  $__num = \func_num_args();
  // DEBUG UncurriedAbs: currentBindingName=Nothing, recVars=["Data_String_CodePoints_boundedEnumCodePoint","Data_String_CodePoints_enumCodePoint"];
