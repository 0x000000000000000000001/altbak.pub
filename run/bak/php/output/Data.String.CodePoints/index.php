...
\PhpursThunks::$thunks['Data_String_CodePoints_CodePoint'] = function() { $v = function($x_0 = null) {
  $__num = \func_num_args();
  $__res = $x_0;
  goto __end;;
  __end:
...
\PhpursThunks::$thunks['Data_String_CodePoints_unconsButWithTuple'] = function() { $v = function($s_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_String_CodePoints_toCodePointArrayFallback'] = function() { $v = function($s_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_String_CodePoints_unsafeCodePointAt0Fallback'] = function() { $v = function($s_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_String_CodePoints_takeFallback'] = function() { $v = (function() {
  ...
  $__tco_done_Data_String_CodePoints_takeFallback = false;
  $__tco_res_Data_String_CodePoints_takeFallback = null;
  $__tco_loop_Data_String_CodePoints_takeFallback = (function() use (&$__tco_done_Data_String_CodePoints_takeFallback, &$__tco_var_Data_String_CodePoints_takeFallback_v_0, &$__tco_var_Data_String_CodePoints_takeFallback_v1_1) {
  $__fn = function($v_0 = null, $v1_1 = null) use (&$__tco_done_Data_String_CodePoints_takeFallback, &$__tco_var_Data_String_CodePoints_takeFallback_v_0, &$__tco_var_Data_String_CodePoints_takeFallback_v1_1, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_done_Data_String_CodePoints_takeFallback = true;
...
goto end_branch_1;;
  ...
  while (($__tco_done_Data_String_CodePoints_takeFallback === false)) {
$__tco_res_Data_String_CodePoints_takeFallback = ($__tco_loop_Data_String_CodePoints_takeFallback)($__tco_var_Data_String_CodePoints_takeFallback_v_0, $__tco_var_Data_String_CodePoints_takeFallback_v1_1);
};
  $__res = $__tco_res_Data_String_CodePoints_takeFallback;
  goto __end;;
  __end:
  return $__num > 2 ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
  };
...
\PhpursThunks::$thunks['Data_String_CodePoints_countTail'] = function() { $v = (function() {
  ...
  $__tco_done_Data_String_CodePoints_countTail = false;
  $__tco_res_Data_String_CodePoints_countTail = null;
  $__tco_loop_Data_String_CodePoints_countTail = (function() use (&$__tco_done_Data_String_CodePoints_countTail, &$__tco_var_Data_String_CodePoints_countTail_p_0, &$__tco_var_Data_String_CodePoints_countTail_s_1, &$__tco_var_Data_String_CodePoints_countTail_accum_2) {
  $__fn = function($p_0 = null, $s_1 = null, $accum_2 = null) use (&$__tco_done_Data_String_CodePoints_countTail, &$__tco_var_Data_String_CodePoints_countTail_p_0, &$__tco_var_Data_String_CodePoints_countTail_s_1, &$__tco_var_Data_String_CodePoints_countTail_accum_2, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 3) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 3);
  }
  $__tco_done_Data_String_CodePoints_countTail = true;
...
goto end_branch_1;;
  ...
  while (($__tco_done_Data_String_CodePoints_countTail === false)) {
$__tco_res_Data_String_CodePoints_countTail = ($__tco_loop_Data_String_CodePoints_countTail)($__tco_var_Data_String_CodePoints_countTail_p_0, $__tco_var_Data_String_CodePoints_countTail_s_1, $__tco_var_Data_String_CodePoints_countTail_accum_2);
};
  $__res = $__tco_res_Data_String_CodePoints_countTail;
  goto __end;;
  __end:
  return $__num > 3 ? $__res(...\array_slice(\func_get_args(), 3)) : $__res;
  };
...
\PhpursThunks::$thunks['Data_String_CodePoints_codePointAtFallback'] = function() { $v = (function() {
  ...
  $__tco_done_Data_String_CodePoints_codePointAtFallback = false;
  $__tco_res_Data_String_CodePoints_codePointAtFallback = null;
  $__tco_loop_Data_String_CodePoints_codePointAtFallback = (function() use (&$__tco_done_Data_String_CodePoints_codePointAtFallback, &$__tco_var_Data_String_CodePoints_codePointAtFallback_n_0, &$__tco_var_Data_String_CodePoints_codePointAtFallback_s_1) {
  $__fn = function($n_0 = null, $s_1 = null) use (&$__tco_done_Data_String_CodePoints_codePointAtFallback, &$__tco_var_Data_String_CodePoints_codePointAtFallback_n_0, &$__tco_var_Data_String_CodePoints_codePointAtFallback_s_1, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_done_Data_String_CodePoints_codePointAtFallback = true;
...
goto end_branch_1;;
  ...
  while (($__tco_done_Data_String_CodePoints_codePointAtFallback === false)) {
$__tco_res_Data_String_CodePoints_codePointAtFallback = ($__tco_loop_Data_String_CodePoints_codePointAtFallback)($__tco_var_Data_String_CodePoints_codePointAtFallback_n_0, $__tco_var_Data_String_CodePoints_codePointAtFallback_s_1);
};
  $__res = $__tco_res_Data_String_CodePoints_codePointAtFallback;
  goto __end;;
  __end:
  return $__num > 2 ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
  };
...
\PhpursThunks::$thunks['Data_String_CodePoints_boundedCodePoint'] = function() { $v = (object)["bottom" => 0, "top" => 1114111, "Ord0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
