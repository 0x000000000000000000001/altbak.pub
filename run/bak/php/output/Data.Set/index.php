...
function majData_majSet_toggle($dictOrd_0) {
  ...
  $__res = function($a_2) use ($alter_1_0) {
  $__num = \func_num_args();
  $__res = function($v_3) use ($a_2, $alter_1_0) {
  $__num = \func_num_args();
...
function majData_majSet_tomajList($v_0) {
  ...
  $__res = \Data\Map\Internal\majData_majMap_majInternal_keys($v_0);
  goto __end;;
  __end:
  return 1 < $__num ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}
...
function majData_majSet_showmajSet($dictShow_0) {
  ...
  $__num = \func_num_args();
  $__res = ((($GLOBALS['Data_Semigroup_semigroupString'])->{'append'})("(fromFoldable "))(((($GLOBALS['Data_Semigroup_semigroupString'])->{'append'})(\Data\Show\majData_majShow_showmajArraymajImpl(($dictShow_0)->{'show'}, ($GLOBALS['Data_Set_toUnfoldable1'])($s_1))))(")"));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}];
...
function majData_majSet_findmajMin($v_0) {
  ...
  $__res = ((($GLOBALS['Data_Maybe_functorMaybe'])->{'map'})(function($v1_1) {
  $__num = \func_num_args();
  $__res = ($v1_1)->{'key'};
  goto __end;;
  __end:
...
function majData_majSet_eqmajSet($dictEq_0) {
  ...
  $__res = (object)["eq" => function($v_1) use ($dictEq_0) {
  $__num = \func_num_args();
  $__res = function($v1_2) use ($dictEq_0, $v_1) {
  $__num = \func_num_args();
...
function majData_majSet_ordmajSet($dictOrd_0) {
  ...
  $eqSet1_1_0 = (object)["eq" => function($v_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  ...
  $__res = (object)["compare" => function($s1_2) use ($dictOrd_0) {
  $__num = \func_num_args();
  $__res = function($s2_3) use ($dictOrd_0, $s1_2) {
  $__num = \func_num_args();
  $__res = (((($GLOBALS['Data_List_Types_ordList'])($dictOrd_0))->{'compare'})(\Data\Map\Internal\majData_majMap_majInternal_keys($s1_2)))(\Data\Map\Internal\majData_majMap_majInternal_keys($s2_3));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Eq0" => function($_dollar__unused_2) use ($eqSet1_1_0) {
  $__num = \func_num_args();
  $__res = $eqSet1_1_0;
  goto __end;;
  __end:
...
$GLOBALS['Data_Set_eq1Set'] = (object)["eq1" => function($dictEq_0) {
  $__num = \func_num_args();
  $__res = function($v_1) use ($dictEq_0) {
  $__num = \func_num_args();
  $__res = function($v1_2) use ($dictEq_0, $v_1) {
  $__num = \func_num_args();
  $__res = ((((($GLOBALS['Data_Map_Internal_eqMap'])($dictEq_0))($GLOBALS['Data_Eq_eqUnit']))->{'eq'})($v_1))($v1_2);
...
function majData_majSet_map($dictOrd_0, $f_1 = null) {
  ...
  $__res = ((($GLOBALS['Data_Set_foldableSet'])->{'foldl'})(function($m_2) use ($dictOrd_0, $f_1) {
  $__num = \func_num_args();
  $__res = function($a_3) use ($dictOrd_0, $f_1, $m_2) {
  $__num = \func_num_args();
...
function majData_majSet_mapmajMaybe($dictOrd_0, $f_1 = null) {
  ...
  $__res = ((($GLOBALS['Data_Set_foldableSet'])->{'foldr'})(function($a_2) use ($dictOrd_0, $f_1) {
  $__num = \func_num_args();
  $__res = function($acc_3) use ($a_2, $dictOrd_0, $f_1) {
  $__num = \func_num_args();
...
function majData_majSet_monoidmajSet($dictOrd_0) {
  ...
  $__res = (object)["mempty" => new \Data\Map\Internal\Data_Map_Internal_Leaf(), "Semigroup0" => function($_dollar__unused_2) use ($semigroupSet1_1_0) {
  $__num = \func_num_args();
...
function majData_majSet_subset($dictOrd_0) {
  ...
  $compare_1_0 = ($dictOrd_0)->{'compare'};
  $__res = function($s1_2) use ($compare_1_0) {
  $__num = \func_num_args();
  $__res = function($s2_3) use ($compare_1_0, $s1_2) {
  $__num = \func_num_args();
  $__t1 = null;;
  if (($GLOBALS['Data_Map_Internal_unsafeDifference'])($compare_1_0, $s1_2, $s2_3) instanceof \Data\Map\Internal\Data_Map_Internal_Leaf) {
$__t1 = true;
goto end_branch_1;;
};
  $__t1 = false;
...
goto end_branch_3;;
  ...
  $__t3 = false;
  end_branch_3:;
  $__res = ((($GLOBALS['Data_HeytingAlgebra_heytingAlgebraBoolean'])->{'conj'})(((($GLOBALS['Data_Eq_eqBoolean'])->{'eq'})(($__t1 === $__t2)))(false)))($__t3);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
