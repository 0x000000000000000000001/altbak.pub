...
\PhpursThunks::$thunks['Test_Church_fromInt'] = function() { $v = function($v_0 = null) {
  ...
  $__tco_done_Test_Church_fromInt = false;
  $__tco_res_Test_Church_fromInt = null;
  $__tco_loop_Test_Church_fromInt = function($v_0 = null) use (&$__tco_done_Test_Church_fromInt, &$__tco_var_Test_Church_fromInt_v_0) {
  $__num = \func_num_args();
  $__tco_done_Test_Church_fromInt = true;
...
break;
  ...
  while (($__tco_done_Test_Church_fromInt === false)) {
$__tco_res_Test_Church_fromInt = ($__tco_loop_Test_Church_fromInt)($__tco_var_Test_Church_fromInt_v_0);
};
  $__res = $__tco_res_Test_Church_fromInt;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}; return $v; };
