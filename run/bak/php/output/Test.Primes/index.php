...
$__tco_1 = ($v_2)->{'value1'};
$__tco_2 = ((($GLOBALS['Data_Semiring_intAdd'] ?? \PhpursThunks::eval('Data_Semiring_intAdd')))($v1_3))(($v_2)->{'value0'});
