...
\PhpursThunks::$thunks['Test_Primes_filter'] = function() { $v = (function() {
  ...
  $__fn = function($v_3 = null, $v1_4 = null) use (&$go_2_0, $p_0, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  ...
  $__tco_done_go_2_0_0 = false;
  $__tco_res_go_2_0_0 = null;
  $__tco_loop_go_2_0_0 = (function() use (&$__tco_done_go_2_0_0, &$__tco_var_go_2_0_0_v_3, &$__tco_var_go_2_0_0_v1_4, &$go_2_0, $p_0) {
  $__fn = function($v_3 = null, $v1_4 = null) use (&$__tco_done_go_2_0_0, &$__tco_var_go_2_0_0_v_3, &$__tco_var_go_2_0_0_v1_4, &$go_2_0, $p_0, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
...
$go_5_1 = null;
$go_5_1 = (function() use (&$__tco_done_go_2_0_0, &$__tco_var_go_2_0_0_v_3, &$__tco_var_go_2_0_0_v1_4, &$go_5_1) {
  $__fn = function($v_6 = null, $v1_7 = null) use (&$__tco_done_go_2_0_0, &$__tco_var_go_2_0_0_v_3, &$__tco_var_go_2_0_0_v1_4, &$go_5_1, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  ...
  $__tco_loop_go_5_1_1 = (function() use (&$__tco_done_go_2_0_0, &$__tco_var_go_2_0_0_v_3, &$__tco_var_go_2_0_0_v1_4, &$__tco_done_go_5_1_1, &$__tco_var_go_5_1_1_v_6, &$__tco_var_go_5_1_1_v1_7, &$go_5_1) {
  $__fn = function($v_6 = null, $v1_7 = null) use (&$__tco_done_go_2_0_0, &$__tco_var_go_2_0_0_v_3, &$__tco_var_go_2_0_0_v1_4, &$__tco_done_go_5_1_1, &$__tco_var_go_5_1_1_v_6, &$__tco_var_go_5_1_1_v1_7, &$go_5_1, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
...
$__tco_res_go_5_1_1 = ($__tco_loop_go_5_1_1)($__tco_var_go_5_1_1_v_6, $__tco_var_go_5_1_1_v1_7);
};
...
$__t0 = (($go_5_1)($v1_4))(new Phpurs_Data0("Nil"));
goto end_branch_0;;
};
...
$__tco_var_go_2_0_0_v_3 = $__tco_5;
$__tco_var_go_2_0_0_v1_4 = $__tco_6;
$__tco_done_go_2_0_0 = false;
$__res = null;
goto __end;;
$__t4 = null;
...
$__tco_2 = ($v_3)->{'value1'};
$__tco_3 = $v1_4;
$__tco_var_go_2_0_0_v_3 = $__tco_2;
$__tco_var_go_2_0_0_v1_4 = $__tco_3;
$__tco_done_go_2_0_0 = false;
$__res = null;
goto __end;;
$__t4 = null;
...
\PhpursThunks::$thunks['Test_Primes_sieve'] = function() { $v = function($v_0 = null) {
  ...
  $__tco_done_Test_Primes_sieve = false;
  $__tco_res_Test_Primes_sieve = null;
  $__tco_loop_Test_Primes_sieve = function($v_0 = null) use (&$__tco_done_Test_Primes_sieve, &$__tco_var_Test_Primes_sieve_v_0) {
  $__num = \func_num_args();
  $__tco_done_Test_Primes_sieve = true;
...
$go_2_2 = (function() use ($__local_var_1_1, &$go_2_2) {
  $__fn = function($v_3 = null, $v1_4 = null) use ($__local_var_1_1, &$go_2_2, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  ...
  $__tco_loop_go_2_2_2 = (function() use (&$__tco_done_go_2_2_2, &$__tco_var_go_2_2_2_v_3, &$__tco_var_go_2_2_2_v1_4, $__local_var_1_1, &$go_2_2) {
  $__fn = function($v_3 = null, $v1_4 = null) use (&$__tco_done_go_2_2_2, &$__tco_var_go_2_2_2_v_3, &$__tco_var_go_2_2_2_v1_4, $__local_var_1_1, &$go_2_2, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  ...
  if ((is_object($v_3) && (($v_3)->{'tag'} === "Nil"))) {
$go_5_3 = null;
$go_5_3 = (function() use (&$__tco_done_go_2_2_2, &$__tco_var_go_2_2_2_v_3, &$__tco_var_go_2_2_2_v1_4, &$go_5_3) {
  $__fn = function($v_6 = null, $v1_7 = null) use (&$__tco_done_go_2_2_2, &$__tco_var_go_2_2_2_v_3, &$__tco_var_go_2_2_2_v1_4, &$go_5_3, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_var_go_5_3_3_v_6 = $v_6;
  $__tco_var_go_5_3_3_v1_7 = $v1_7;
  $__tco_done_go_5_3_3 = false;
  $__tco_res_go_5_3_3 = null;
  $__tco_loop_go_5_3_3 = (function() use (&$__tco_done_go_2_2_2, &$__tco_var_go_2_2_2_v_3, &$__tco_var_go_2_2_2_v1_4, &$__tco_done_go_5_3_3, &$__tco_var_go_5_3_3_v_6, &$__tco_var_go_5_3_3_v1_7, &$go_5_3) {
  $__fn = function($v_6 = null, $v1_7 = null) use (&$__tco_done_go_2_2_2, &$__tco_var_go_2_2_2_v_3, &$__tco_var_go_2_2_2_v1_4, &$__tco_done_go_5_3_3, &$__tco_var_go_5_3_3_v_6, &$__tco_var_go_5_3_3_v1_7, &$go_5_3, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_done_go_5_3_3 = true;
  $v_6 = $__tco_var_go_5_3_3_v_6;
  $v1_7 = $__tco_var_go_5_3_3_v1_7;
  $__t3 = null;;
  if ((is_object($v_6) && (($v_6)->{'tag'} === "Nil"))) {
$__t3 = $v1_7;
goto end_branch_3;;
...
$__tco_var_go_5_3_3_v_6 = $__tco_4;
$__tco_var_go_5_3_3_v1_7 = $__tco_5;
$__tco_done_go_5_3_3 = false;
$__res = null;
goto __end;;
$__t3 = null;
goto end_branch_3;;
  ...
  while (($__tco_done_go_5_3_3 === false)) {
$__tco_res_go_5_3_3 = ($__tco_loop_go_5_3_3)($__tco_var_go_5_3_3_v_6, $__tco_var_go_5_3_3_v1_7);
};
  $__res = $__tco_res_go_5_3_3;
  goto __end;;
  __end:
  return $__num > 2 ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
  };
...
$__t2 = (($go_5_3)($v1_4))(new Phpurs_Data0("Nil"));
goto end_branch_2;;
};
  if ((is_object($v_3) && (($v_3)->{'tag'} === "Cons"))) {
$__t6 = null;;
...
$__tco_var_go_2_2_2_v1_4 = $__tco_8;
$__tco_done_go_2_2_2 = false;
$__res = null;
goto __end;;
$__t6 = null;
...
$__tco_4 = ($v_3)->{'value1'};
$__tco_5 = $v1_4;
$__tco_var_go_2_2_2_v_3 = $__tco_4;
$__tco_var_go_2_2_2_v1_4 = $__tco_5;
$__tco_done_go_2_2_2 = false;
$__res = null;
goto __end;;
$__t6 = null;
...
goto end_branch_0;;
  ...
  while (($__tco_done_Test_Primes_sieve === false)) {
$__tco_res_Test_Primes_sieve = ($__tco_loop_Test_Primes_sieve)($__tco_var_Test_Primes_sieve_v_0);
};
  $__res = $__tco_res_Test_Primes_sieve;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}; return $v; };
...
$__local_var_0_0 = (($GLOBALS['Bench_opaque'] ?? \PhpursThunks::eval('Bench_opaque')))(500);
...
$__tco_var_go_2_2_2_v_3 = $__tco_3;
$__tco_var_go_2_2_2_v1_4 = $__tco_4;
$__tco_done_go_2_2_2 = false;
$__res = null;
goto __end;;
$__t2 = null;
...
$go_3_3 = (function() use (&$go_3_3) {
  $__fn = function($curr_4 = null, $acc_5 = null) use (&$go_3_3, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_var_go_3_3_3_curr_4 = $curr_4;
  $__tco_var_go_3_3_3_acc_5 = $acc_5;
  $__tco_done_go_3_3_3 = false;
  $__tco_res_go_3_3_3 = null;
  $__tco_loop_go_3_3_3 = (function() use (&$__tco_done_go_3_3_3, &$__tco_var_go_3_3_3_curr_4, &$__tco_var_go_3_3_3_acc_5, &$go_3_3) {
  $__fn = function($curr_4 = null, $acc_5 = null) use (&$__tco_done_go_3_3_3, &$__tco_var_go_3_3_3_curr_4, &$__tco_var_go_3_3_3_acc_5, &$go_3_3, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_done_go_3_3_3 = true;
  $curr_4 = $__tco_var_go_3_3_3_curr_4;
  $acc_5 = $__tco_var_go_3_3_3_acc_5;
  $__t5 = null;;
  if (($curr_4 < 2)) {
$__t5 = $acc_5;
goto end_branch_5;;
  ...
  $__tco_3 = ($curr_4 - 1);
  $__tco_4 = new Phpurs_Data2("Cons", $curr_4, $acc_5);
  $__tco_var_go_3_3_3_curr_4 = $__tco_3;
  $__tco_var_go_3_3_3_acc_5 = $__tco_4;
  $__tco_done_go_3_3_3 = false;
  $__res = null;
  goto __end;;
  $__t5 = null;
...
$__tco_res_go_3_3_3 = ($__tco_loop_go_3_3_3)($__tco_var_go_3_3_3_curr_4, $__tco_var_go_3_3_3_acc_5);
};
...
return (($GLOBALS['Effect_Console_log'] ?? \PhpursThunks::eval('Effect_Console_log')))((($GLOBALS['Data_Show_showIntImpl'] ?? \PhpursThunks::eval('Data_Show_showIntImpl')))((($go_2_2)((($GLOBALS['Test_Primes_sieve'] ?? \PhpursThunks::eval('Test_Primes_sieve')))((($go_3_3)($dummy_1_1))(new Phpurs_Data0("Nil")))))(0)));
})(); return $v; };
