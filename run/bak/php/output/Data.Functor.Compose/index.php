...
\PhpursThunks::$thunks['Data_Functor_Compose_ord1Compose'] = function() { $v = function($dictOrd1_0 = null) {
  ...
  $eq1Compose2_6_4 = (object)["eq1" => function($dictEq_6 = null) use ($__local_var_2_1, $__local_var_5_3) {
  $__num = \func_num_args();
  ...
  $__res = (object)["compare1" => function($dictOrd_7 = null) use ($ordCompose2_4_2) {
  $__num = \func_num_args();
