...
\PhpursThunks::$thunks['Data_EuclideanRing_mod'] = function() { $v = function($dict_0 = null) {
  $__num = \func_num_args();
  $__res = ($dict_0)->{'mod'};
  goto __end;;
  __end:
...
\PhpursThunks::$thunks['Data_EuclideanRing_gcd'] = function() { $v = (function() {
  $__fn = function($dictEq_0 = null, $dictEuclideanRing_1 = null) use (&$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
  ...
  $__tco_done_Data_EuclideanRing_gcd = false;
  $__tco_res_Data_EuclideanRing_gcd = null;
  $__tco_loop_Data_EuclideanRing_gcd = (function() use (&$__tco_done_Data_EuclideanRing_gcd, &$__tco_var_Data_EuclideanRing_gcd_dictEq_0, &$__tco_var_Data_EuclideanRing_gcd_dictEuclideanRing_1) {
  $__fn = function($dictEq_0 = null, $dictEuclideanRing_1 = null) use (&$__tco_done_Data_EuclideanRing_gcd, &$__tco_var_Data_EuclideanRing_gcd_dictEq_0, &$__tco_var_Data_EuclideanRing_gcd_dictEuclideanRing_1, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_done_Data_EuclideanRing_gcd = true;
...
goto end_branch_1;;
  ...
  while (($__tco_done_Data_EuclideanRing_gcd === false)) {
$__tco_res_Data_EuclideanRing_gcd = ($__tco_loop_Data_EuclideanRing_gcd)($__tco_var_Data_EuclideanRing_gcd_dictEq_0, $__tco_var_Data_EuclideanRing_gcd_dictEuclideanRing_1);
};
  $__res = $__tco_res_Data_EuclideanRing_gcd;
  goto __end;;
  __end:
  return $__num > 2 ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
  };
...
\PhpursThunks::$thunks['Data_EuclideanRing_euclideanRingNumber'] = function() { $v = (object)["degree" => function($v_0 = null) {
  $__num = \func_num_args();
  $__res = 1;
  goto __end;;
  __end:
...
\PhpursThunks::$thunks['Data_EuclideanRing_div'] = function() { $v = function($dict_0 = null) {
  $__num = \func_num_args();
  $__res = ($dict_0)->{'div'};
  goto __end;;
  __end:
...
\PhpursThunks::$thunks['Data_EuclideanRing_lcm'] = function() { $v = (function() {
  ...
  $__fn = function($a_5 = null, $b_6 = null) use ($Semiring0_2_0, $dictEq_0, $dictEuclideanRing_1, $gcd2_4_2, $zero_3_1, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
...
\PhpursThunks::$thunks['Data_EuclideanRing_degree'] = function() { $v = function($dict_0 = null) {
  $__num = \func_num_args();
  $__res = ($dict_0)->{'degree'};
  goto __end;;
  __end:
