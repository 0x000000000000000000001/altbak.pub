...
$GLOBALS['Data_Ord_Max_newtypeMax'] = ["Coercible0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
  $__res = null;
  goto __end;;
  __end:
...
goto end_branch_2;;
  ...
  $__res = ["mempty" => ($dictBounded_0)['bottom'], "Semigroup0" => function($_dollar__unused_3) use ($semigroupMax1_2_1) {
  $__num = \func_num_args();
