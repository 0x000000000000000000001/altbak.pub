...
function majControl_majMonad_majSmajT_majUncurried_mkmajSmajTmajFn1($v0) {
  ...
  $f = ($ffi_Control_Monad_ST_Uncurried['mkSTFn1'] ?? \phpurs_ffi_fallback($ffi_Control_Monad_ST_Uncurried, 'mkSTFn1'));
  return $f($v0);
}
...
function majControl_majMonad_majSmajT_majUncurried_mkmajSmajTmajFn10($v0) {
  ...
  global $ffi_Control_Monad_ST_Uncurried;
  $f = ($ffi_Control_Monad_ST_Uncurried['mkSTFn10'] ?? \phpurs_ffi_fallback($ffi_Control_Monad_ST_Uncurried, 'mkSTFn10'));
  return $f($v0);
}
...
function majControl_majMonad_majSmajT_majUncurried_mkmajSmajTmajFn2($v0) {
  ...
  global $ffi_Control_Monad_ST_Uncurried;
  $f = ($ffi_Control_Monad_ST_Uncurried['mkSTFn2'] ?? \phpurs_ffi_fallback($ffi_Control_Monad_ST_Uncurried, 'mkSTFn2'));
  return $f($v0);
}
...
function majControl_majMonad_majSmajT_majUncurried_mkmajSmajTmajFn3($v0) {
  ...
  global $ffi_Control_Monad_ST_Uncurried;
  $f = ($ffi_Control_Monad_ST_Uncurried['mkSTFn3'] ?? \phpurs_ffi_fallback($ffi_Control_Monad_ST_Uncurried, 'mkSTFn3'));
  return $f($v0);
}
...
function majControl_majMonad_majSmajT_majUncurried_mkmajSmajTmajFn4($v0) {
  ...
  global $ffi_Control_Monad_ST_Uncurried;
  $f = ($ffi_Control_Monad_ST_Uncurried['mkSTFn4'] ?? \phpurs_ffi_fallback($ffi_Control_Monad_ST_Uncurried, 'mkSTFn4'));
  return $f($v0);
}
...
function majControl_majMonad_majSmajT_majUncurried_mkmajSmajTmajFn5($v0) {
  ...
  global $ffi_Control_Monad_ST_Uncurried;
  $f = ($ffi_Control_Monad_ST_Uncurried['mkSTFn5'] ?? \phpurs_ffi_fallback($ffi_Control_Monad_ST_Uncurried, 'mkSTFn5'));
  return $f($v0);
}
...
function majControl_majMonad_majSmajT_majUncurried_mkmajSmajTmajFn6($v0) {
  ...
  global $ffi_Control_Monad_ST_Uncurried;
  $f = ($ffi_Control_Monad_ST_Uncurried['mkSTFn6'] ?? \phpurs_ffi_fallback($ffi_Control_Monad_ST_Uncurried, 'mkSTFn6'));
  return $f($v0);
}
...
function majControl_majMonad_majSmajT_majUncurried_mkmajSmajTmajFn7($v0) {
  ...
  global $ffi_Control_Monad_ST_Uncurried;
  $f = ($ffi_Control_Monad_ST_Uncurried['mkSTFn7'] ?? \phpurs_ffi_fallback($ffi_Control_Monad_ST_Uncurried, 'mkSTFn7'));
  return $f($v0);
}
...
function majControl_majMonad_majSmajT_majUncurried_mkmajSmajTmajFn8($v0) {
  ...
  global $ffi_Control_Monad_ST_Uncurried;
  $f = ($ffi_Control_Monad_ST_Uncurried['mkSTFn8'] ?? \phpurs_ffi_fallback($ffi_Control_Monad_ST_Uncurried, 'mkSTFn8'));
  return $f($v0);
}
...
function majControl_majMonad_majSmajT_majUncurried_mkmajSmajTmajFn9($v0) {
  ...
  global $ffi_Control_Monad_ST_Uncurried;
  $f = ($ffi_Control_Monad_ST_Uncurried['mkSTFn9'] ?? \phpurs_ffi_fallback($ffi_Control_Monad_ST_Uncurried, 'mkSTFn9'));
  return $f($v0);
}
...
function majControl_majMonad_majSmajT_majUncurried_runmajSmajTmajFn1($v0, $v1 = null) {
  ...
  global $ffi_Control_Monad_ST_Uncurried;
  $f = ($ffi_Control_Monad_ST_Uncurried['runSTFn1'] ?? \phpurs_ffi_fallback($ffi_Control_Monad_ST_Uncurried, 'runSTFn1'));
  return $f($v0, $v1);
}
...
function majControl_majMonad_majSmajT_majUncurried_runmajSmajTmajFn10($v0, $v1 = null, $v2 = null, $v3 = null, $v4 = null, $v5 = null, $v6 = null, $v7 = null, $v8 = null, $v9 = null, $v10 = null) {
  ...
  global $ffi_Control_Monad_ST_Uncurried;
  $f = ($ffi_Control_Monad_ST_Uncurried['runSTFn10'] ?? \phpurs_ffi_fallback($ffi_Control_Monad_ST_Uncurried, 'runSTFn10'));
...
function majControl_majMonad_majSmajT_majUncurried_runmajSmajTmajFn2($v0, $v1 = null, $v2 = null) {
  ...
  global $ffi_Control_Monad_ST_Uncurried;
  $f = ($ffi_Control_Monad_ST_Uncurried['runSTFn2'] ?? \phpurs_ffi_fallback($ffi_Control_Monad_ST_Uncurried, 'runSTFn2'));
  return $f($v0, $v1, $v2);
}
...
function majControl_majMonad_majSmajT_majUncurried_runmajSmajTmajFn3($v0, $v1 = null, $v2 = null, $v3 = null) {
  ...
  global $ffi_Control_Monad_ST_Uncurried;
  $f = ($ffi_Control_Monad_ST_Uncurried['runSTFn3'] ?? \phpurs_ffi_fallback($ffi_Control_Monad_ST_Uncurried, 'runSTFn3'));
...
function majControl_majMonad_majSmajT_majUncurried_runmajSmajTmajFn4($v0, $v1 = null, $v2 = null, $v3 = null, $v4 = null) {
  ...
  global $ffi_Control_Monad_ST_Uncurried;
  $f = ($ffi_Control_Monad_ST_Uncurried['runSTFn4'] ?? \phpurs_ffi_fallback($ffi_Control_Monad_ST_Uncurried, 'runSTFn4'));
...
function majControl_majMonad_majSmajT_majUncurried_runmajSmajTmajFn5($v0, $v1 = null, $v2 = null, $v3 = null, $v4 = null, $v5 = null) {
  ...
  global $ffi_Control_Monad_ST_Uncurried;
  $f = ($ffi_Control_Monad_ST_Uncurried['runSTFn5'] ?? \phpurs_ffi_fallback($ffi_Control_Monad_ST_Uncurried, 'runSTFn5'));
...
function majControl_majMonad_majSmajT_majUncurried_runmajSmajTmajFn6($v0, $v1 = null, $v2 = null, $v3 = null, $v4 = null, $v5 = null, $v6 = null) {
  ...
  global $ffi_Control_Monad_ST_Uncurried;
  $f = ($ffi_Control_Monad_ST_Uncurried['runSTFn6'] ?? \phpurs_ffi_fallback($ffi_Control_Monad_ST_Uncurried, 'runSTFn6'));
...
function majControl_majMonad_majSmajT_majUncurried_runmajSmajTmajFn7($v0, $v1 = null, $v2 = null, $v3 = null, $v4 = null, $v5 = null, $v6 = null, $v7 = null) {
  ...
  global $ffi_Control_Monad_ST_Uncurried;
  $f = ($ffi_Control_Monad_ST_Uncurried['runSTFn7'] ?? \phpurs_ffi_fallback($ffi_Control_Monad_ST_Uncurried, 'runSTFn7'));
...
function majControl_majMonad_majSmajT_majUncurried_runmajSmajTmajFn8($v0, $v1 = null, $v2 = null, $v3 = null, $v4 = null, $v5 = null, $v6 = null, $v7 = null, $v8 = null) {
  ...
  global $ffi_Control_Monad_ST_Uncurried;
  $f = ($ffi_Control_Monad_ST_Uncurried['runSTFn8'] ?? \phpurs_ffi_fallback($ffi_Control_Monad_ST_Uncurried, 'runSTFn8'));
...
function majControl_majMonad_majSmajT_majUncurried_runmajSmajTmajFn9($v0, $v1 = null, $v2 = null, $v3 = null, $v4 = null, $v5 = null, $v6 = null, $v7 = null, $v8 = null, $v9 = null) {
  ...
  global $ffi_Control_Monad_ST_Uncurried;
  $f = ($ffi_Control_Monad_ST_Uncurried['runSTFn9'] ?? \phpurs_ffi_fallback($ffi_Control_Monad_ST_Uncurried, 'runSTFn9'));
