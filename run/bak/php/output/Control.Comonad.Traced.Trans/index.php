...
\PhpursThunks::$thunks['Control_Comonad_Traced_Trans_newtypeTracedT'] = function() { $v = (object)["Coercible0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Comonad_Traced_Trans_extendTracedT'] = function() { $v = function($dictExtend_0 = null) {
  ...
  $__fn = function($w__prime___6 = null, $t_7 = null) use ($Functor0_1_0, $dictSemigroup_3, $f_4, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__res = ($f_4)(((($Functor0_1_0)->{'map'})((function() use ($dictSemigroup_3, $t_7) {
  $__fn = function($h_8 = null, $t__prime___9 = null) use ($dictSemigroup_3, $t_7, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  ...
  return $__fn;
})(), "Functor0" => function($dollar__unused_4 = null) use ($functorTracedT1_2_1) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Comonad_Traced_Trans_comonadTracedT'] = function() { $v = function($dictComonad_0 = null) {
  ...
  $__res = (object)["extract" => function($v_5 = null) use ($dictComonad_0, $mempty_3_1) {
  $__num = \func_num_args();
  $__res = ((($dictComonad_0)->{'extract'})($v_5))($mempty_3_1);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Extend0" => function($dollar__unused_5 = null) use ($extendTracedT2_4_2) {
  $__num = \func_num_args();
