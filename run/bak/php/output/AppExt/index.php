...
\PhpursThunks::$thunks['AppExt_main'] = function() { $v = (function() use (&$__fn) {
...
$dollar__unused_5_5 = ((((($GLOBALS['Control_Apply_applySecond'] ?? \PhpursThunks::eval('Control_Apply_applySecond')))(($GLOBALS['Effect_applyEffect'] ?? \PhpursThunks::eval('Effect_applyEffect'))))(($GLOBALS['Test_StringOps_describe'] ?? \PhpursThunks::eval('Test_StringOps_describe'))))(($GLOBALS['Test_AffOperations_describe'] ?? \PhpursThunks::eval('Test_AffOperations_describe'))))();
$dollar__unused_6_6 = ((((($GLOBALS['Control_Apply_applySecond'] ?? \PhpursThunks::eval('Control_Apply_applySecond')))(($GLOBALS['Effect_applyEffect'] ?? \PhpursThunks::eval('Effect_applyEffect'))))(($GLOBALS['Test_StringOps_act'] ?? \PhpursThunks::eval('Test_StringOps_act'))))(($GLOBALS['Test_AffOperations_act'] ?? \PhpursThunks::eval('Test_AffOperations_act'))))();
return ($GLOBALS['Data_Unit_unit'] ?? \PhpursThunks::eval('Data_Unit_unit'));
})(); return $v; };
