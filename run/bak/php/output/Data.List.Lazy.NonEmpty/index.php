...
function majData_majList_majLazy_majNonmajEmpty_length($v_0) {
  $__num = \func_num_args();
...
$__t1 = new \Data\Maybe\Data_Maybe_Just(($GLOBALS['Data_Lazy_defer'])(function($v1_4 = null) use ($__local_var_2_2, $__local_var_3_3) {
  $__num = \func_num_args();
...
function majData_majList_majLazy_majNonmajEmpty_cons($y_0, $v_1 = null) {
  ...
  $__res = new \Data\NonEmpty\Data_NonEmpty_NonEmpty($y_0, ($GLOBALS['Data_Lazy_defer'])(function($v_6 = null) use ($__local_var_4_1, $__local_var_5_2) {
  $__num = \func_num_args();
