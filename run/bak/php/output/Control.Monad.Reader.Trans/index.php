...
\PhpursThunks::$thunks['Control_Monad_Reader_Trans_newtypeReaderT'] = function() { $v = (object)["Coercible0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_Reader_Trans_monadTransReaderT'] = function() { $v = (object)["lift" => function($dictMonad_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_Reader_Trans_distributiveReaderT'] = function() { $v = function($dictDistributive_0 = null) {
  ...
  $__tco_done_Control_Monad_Reader_Trans_distributiveReaderT = false;
  $__tco_res_Control_Monad_Reader_Trans_distributiveReaderT = null;
  $__tco_loop_Control_Monad_Reader_Trans_distributiveReaderT = function($dictDistributive_0 = null) use (&$__tco_done_Control_Monad_Reader_Trans_distributiveReaderT, &$__tco_var_Control_Monad_Reader_Trans_distributiveReaderT_dictDistributive_0) {
  $__num = \func_num_args();
  $__tco_done_Control_Monad_Reader_Trans_distributiveReaderT = true;
  ...
  $__res = (object)["distribute" => function($dictFunctor_2 = null) use ($dictDistributive_0) {
  $__num = \func_num_args();
  ...
  while (($__tco_done_Control_Monad_Reader_Trans_distributiveReaderT === false)) {
$__tco_res_Control_Monad_Reader_Trans_distributiveReaderT = ($__tco_loop_Control_Monad_Reader_Trans_distributiveReaderT)($__tco_var_Control_Monad_Reader_Trans_distributiveReaderT_dictDistributive_0);
};
  $__res = $__tco_res_Control_Monad_Reader_Trans_distributiveReaderT;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}; return $v; };
...
\PhpursThunks::$thunks['Control_Monad_Reader_Trans_monadReaderT'] = function() { $v = function($dictMonad_0 = null) {
  ...
  $__res = (object)["Applicative0" => function($dollar__unused_3 = null) use ($applicativeReaderT1_1_0) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_Reader_Trans_monadAskReaderT'] = function() { $v = function($dictMonad_0 = null) {
  ...
  $__res = (object)["ask" => ((($dictMonad_0)->{'Applicative0'})(($GLOBALS['Prim_undefined'] ?? \PhpursThunks::eval('Prim_undefined'))))->{'pure'}, "Monad0" => function($dollar__unused_2 = null) use ($monadReaderT1_1_0) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_Reader_Trans_monadReaderReaderT'] = function() { $v = function($dictMonad_0 = null) {
  $__num = \func_num_args();
  $monadReaderT1_1_0 = (($GLOBALS['Control_Monad_Reader_Trans_monadReaderT'] ?? \PhpursThunks::eval('Control_Monad_Reader_Trans_monadReaderT')))($dictMonad_0);
  $monadAskReaderT1_2_1 = (object)["ask" => ((($dictMonad_0)->{'Applicative0'})(($GLOBALS['Prim_undefined'] ?? \PhpursThunks::eval('Prim_undefined'))))->{'pure'}, "Monad0" => function($dollar__unused_2 = null) use ($monadReaderT1_1_0) {
  $__num = \func_num_args();
  $__res = $monadReaderT1_1_0;
  goto __end;;
  __end:
  ...
  $__res = (object)["local" => ($GLOBALS['Control_Monad_Reader_Trans_withReaderT'] ?? \PhpursThunks::eval('Control_Monad_Reader_Trans_withReaderT')), "MonadAsk0" => function($dollar__unused_3 = null) use ($monadAskReaderT1_2_1) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_Reader_Trans_monoidReaderT'] = function() { $v = function($dictApplicative_0 = null) {
  ...
  $__res = (object)["mempty" => (((($GLOBALS['Control_Monad_Reader_Trans_applicativeReaderT'] ?? \PhpursThunks::eval('Control_Monad_Reader_Trans_applicativeReaderT')))($dictApplicative_0))->{'pure'})(($dictMonoid_2)->{'mempty'}), "Semigroup0" => function($dollar__unused_4 = null) use ($semigroupReaderT2_3_1) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_Reader_Trans_plusReaderT'] = function() { $v = function($dictPlus_0 = null) {
  ...
  $__res = (object)["empty" => function($v_3 = null) use ($__local_var_2_1) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_Reader_Trans_monadPlusReaderT'] = function() { $v = function($dictMonadPlus_0 = null) {
  ...
  $__res = (object)["Monad0" => function($dollar__unused_3 = null) use ($monadReaderT1_1_0) {
  $__num = \func_num_args();
  $__res = $monadReaderT1_1_0;
  goto __end;;
  __end:
