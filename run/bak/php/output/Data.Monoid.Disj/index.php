...
function majData_majMonoid_majDisj_semiringmajDisj($dictHeytingAlgebra_0) {
  ...
  $__res = (object)["zero" => ($dictHeytingAlgebra_0)->{'ff'}, "one" => ($dictHeytingAlgebra_0)->{'tt'}, "add" => function($v_1) use ($dictHeytingAlgebra_0) {
  $__num = \func_num_args();
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "mul" => function($v_1) use ($dictHeytingAlgebra_0) {
  $__num = \func_num_args();
  $__res = function($v1_2) use ($dictHeytingAlgebra_0, $v_1) {
  $__num = \func_num_args();
...
function majData_majMonoid_majDisj_semigroupmajDisj($dictHeytingAlgebra_0) {
  ...
  $__res = (object)["append" => function($v_1) use ($dictHeytingAlgebra_0) {
  $__num = \func_num_args();
  $__res = function($v1_2) use ($dictHeytingAlgebra_0, $v_1) {
  $__num = \func_num_args();
  $__res = ((($dictHeytingAlgebra_0)->{'disj'})($v_1))($v1_2);
...
function majData_majMonoid_majDisj_monoidmajDisj($dictHeytingAlgebra_0) {
  ...
  $semigroupDisj1_1_0 = (object)["append" => function($v_1) use ($dictHeytingAlgebra_0) {
  $__num = \func_num_args();
  $__res = function($v1_2) use ($dictHeytingAlgebra_0, $v_1) {
  $__num = \func_num_args();
  $__res = ((($dictHeytingAlgebra_0)->{'disj'})($v_1))($v1_2);
  ...
  $__res = (object)["mempty" => ($dictHeytingAlgebra_0)->{'ff'}, "Semigroup0" => function($_dollar__unused_2) use ($semigroupDisj1_1_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Monoid_Disj_functorDisj'] = (object)["map" => function($f_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Monoid_Disj_eq1Disj'] = (object)["eq1" => function($dictEq_0) {
  $__num = \func_num_args();
  $__res = ($dictEq_0)->{'eq'};
  goto __end;;
  __end:
...
$GLOBALS['Data_Monoid_Disj_ord1Disj'] = (object)["compare1" => function($dictOrd_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Monoid_Disj_applyDisj'] = (object)["apply" => function($v_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Monoid_Disj_bindDisj'] = (object)["bind" => function($v_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Monoid_Disj_applicativeDisj'] = (object)["pure" => $GLOBALS['Data_Monoid_Disj_Disj'], "Apply0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
  $__res = $GLOBALS['Data_Monoid_Disj_applyDisj'];
  goto __end;;
  __end:
...
$GLOBALS['Data_Monoid_Disj_monadDisj'] = (object)["Applicative0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
