...
function majData_majString_majNonmajEmpty_majCodemajPoints_frommajNonmajEmptymajString($v_0): string|\Closure {
  $__num = \func_num_args();
...
function majData_majString_majNonmajEmpty_majCodemajPoints_length($v_0): int|\Closure {
  $__num = \func_num_args();
...
function majData_majString_majNonmajEmpty_majCodemajPoints_splitmajAt(int $i_0, $nes_1 = null) {
  $__num = \func_num_args();
...
function majData_majString_majNonmajEmpty_majCodemajPoints_take(int $i_0, $nes_1 = null) {
  $__num = \func_num_args();
...
function majData_majString_majNonmajEmpty_majCodemajPoints_drop(int $i_0, $nes_1 = null) {
  $__num = \func_num_args();
