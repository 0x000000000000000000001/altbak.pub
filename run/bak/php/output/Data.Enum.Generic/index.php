...
function majData_majEnum_majGeneric_genericmajEnummajSum($dictGenericEnum_0, $dictGenericTop_1 = null) {
  ...
  $__res = ["genericPred__prime__" => function($v_6) use ($dictGenericEnum1_3, $dictGenericEnum_0, $genericTop_prime_2_0) {
  $__num = \func_num_args();
  $__t2 = null;;
...
function majData_majEnum_majGeneric_genericmajEnummajProduct($dictGenericEnum_0, $dictGenericTop_1 = null, $dictGenericBottom_2 = null, $dictGenericEnum1_3 = null, $dictGenericTop1_4 = null) {
  ...
  $__res = ["genericPred__prime__" => function($v_8) use ($dictGenericEnum1_3, $dictGenericEnum_0, $genericTop_prime_5_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Enum_Generic_genericEnumNoArguments'] = ["genericPred__prime__" => function($v_0) {
  $__num = \func_num_args();
...
function majData_majEnum_majGeneric_genericmajEnummajConstructor($dictGenericEnum_0) {
  ...
  $__res = ["genericPred__prime__" => function($v_1) use ($dictGenericEnum_0) {
  $__num = \func_num_args();
...
function majData_majEnum_majGeneric_genericmajEnummajArgument($dictEnum_0) {
  ...
  $__res = ["genericPred__prime__" => function($v_1) use ($dictEnum_0) {
  $__num = \func_num_args();
...
function majData_majEnum_majGeneric_genericmajBoundedmajEnummajSum($dictGenericBoundedEnum_0) {
  ...
  $__num = \func_num_args();
  $__res = ["genericCardinality__prime__" => ($genericCardinality_prime1_1_0 + ($dictGenericBoundedEnum1_2)['genericCardinality__prime__']), "genericToEnum__prime__" => function($n_3) use ($dictGenericBoundedEnum1_2, $dictGenericBoundedEnum_0, $genericCardinality_prime1_1_0) {
  $__num = \func_num_args();
  $__t1 = null;;
...
function majData_majEnum_majGeneric_genericmajBoundedmajEnummajProduct($dictGenericBoundedEnum_0) {
  ...
  $__res = ["genericCardinality__prime__" => ($genericCardinality_prime1_1_0 * $genericCardinality_prime2_3_1), "genericToEnum__prime__" => function($n_4) use ($dictGenericBoundedEnum1_2, $dictGenericBoundedEnum_0, $genericCardinality_prime2_3_1) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Enum_Generic_genericBoundedEnumNoArguments'] = ["genericCardinality__prime__" => 1, "genericToEnum__prime__" => function($i_0) {
  $__num = \func_num_args();
...
function majData_majEnum_majGeneric_genericmajBoundedmajEnummajConstructor($dictGenericBoundedEnum_0) {
  ...
  $__res = ["genericCardinality__prime__" => ($dictGenericBoundedEnum_0)['genericCardinality__prime__'], "genericToEnum__prime__" => function($i_1) use ($dictGenericBoundedEnum_0) {
  $__num = \func_num_args();
...
function majData_majEnum_majGeneric_genericmajBoundedmajEnummajArgument($dictBoundedEnum_0) {
  ...
  $__res = ["genericCardinality__prime__" => ($dictBoundedEnum_0)['cardinality'], "genericToEnum__prime__" => function($i_1) use ($dictBoundedEnum_0) {
  $__num = \func_num_args();
