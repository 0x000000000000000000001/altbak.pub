...
// Data_Enum_Generic_genericToEnum
$GLOBALS['Data_Enum_Generic_genericToEnum'] = (function() {
  $__fn = function($dictGeneric_0 = null, $dictGenericBoundedEnum_1 = null) use (&$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__res = (($GLOBALS['Control_Semigroupoid_composeImpl'])(function($v1_2 = null) use ($dictGeneric_0) {
  $__num = \func_num_args();
  $__t0 = null;;
...
$GLOBALS['Data_Enum_Generic_genericSucc'] = function($dictGeneric_0 = null) {
  ...
  $__num = \func_num_args();
  $__res = (($GLOBALS['Control_Semigroupoid_composeImpl'])(function($v1_3 = null) use ($dictGeneric_0) {
  $__num = \func_num_args();
  $__t1 = null;;
...
$GLOBALS['Data_Enum_Generic_genericEnumSum'] = (function() {
  ...
  $__res = ["genericPred__prime__" => function($v_6 = null) use ($dictGenericEnum1_3, $dictGenericEnum_0, $genericTop__prime___2_0) {
  $__num = \func_num_args();
  $__t2 = null;;
...
$GLOBALS['Data_Enum_Generic_genericEnumProduct'] = (function() {
  ...
  $__res = ["genericPred__prime__" => function($v_8 = null) use ($dictGenericEnum1_3, $dictGenericEnum_0, $genericTop__prime___5_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Enum_Generic_genericBoundedEnumSum'] = function($dictGenericBoundedEnum_0 = null) {
  ...
  $__num = \func_num_args();
  $__res = ["genericCardinality__prime__" => ($genericCardinality__prime__1_1_0 + ($dictGenericBoundedEnum1_2)['genericCardinality__prime__']), "genericToEnum__prime__" => function($n_3 = null) use ($dictGenericBoundedEnum1_2, $dictGenericBoundedEnum_0, $genericCardinality__prime__1_1_0) {
  $__num = \func_num_args();
  $__t3 = null;;
...
$GLOBALS['Data_Enum_Generic_genericBoundedEnumProduct'] = function($dictGenericBoundedEnum_0 = null) {
  ...
  $__res = ["genericCardinality__prime__" => ($genericCardinality__prime__1_1_0 * $genericCardinality__prime__2_3_1), "genericToEnum__prime__" => function($n_4 = null) use ($dictGenericBoundedEnum1_2, $dictGenericBoundedEnum_0, $genericCardinality__prime__2_3_1) {
  $__num = \func_num_args();
...
$__local_var_6_4 = (($dictGenericBoundedEnum1_2)['genericToEnum__prime__'])((($GLOBALS['Data_EuclideanRing_intMod'])($n_4))($genericCardinality__prime__2_3_1));
$__t5 = null;;
