...
final class Data_Either_Left { public function __construct(public  $value0) {} }
final class Data_Either_Right { public function __construct(public  $value0) {} }
...
$GLOBALS['Data_Either_genericEither'] = ["to" => function($x_0) {
  $__num = \func_num_args();
  $__t0 = null;;
...
goto end_branch_2;;
  ...
  $__res = ["compare1" => function($dictOrd1_4) use ($ordEither1_1_0) {
  $__num = \func_num_args();
...
function majData_majEither_boundedmajEither($dictBounded_0) {
  ...
  $__res = ["top" => new \Data\Either\Data_Either_Right(($dictBounded1_3)['top']), "bottom" => new \Data\Either\Data_Either_Left($bottom_1_0), "Ord0" => function($_dollar__unused_5) use ($ordEither2_4_2) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Either_bindEither'] = ["bind" => function($v2_0) {
  $__num = \func_num_args();
  $__t0 = null;;
  if ($v2_0 instanceof \Data\Either\Data_Either_Left) {
...
$GLOBALS['Data_Either_applicativeEither'] = ["pure" => $GLOBALS['Data_Either_Right'], "Apply0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
  $__res = $GLOBALS['Data_Either_applyEither'];
  goto __end;;
  __end:
...
$GLOBALS['Data_Either_monadEither'] = ["Applicative0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
