...
// Data_Semigroup_Foldable_identity1
function majData_majSemigroup_majFoldable_identity1($x_0) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majSemigroup_majFoldable_identity1';
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 1);
  }
  $__res = $x_0;
...
$GLOBALS['Data_Semigroup_Foldable_identity1'] = __NAMESPACE__ . '\\majData_majSemigroup_majFoldable_identity1';
...
function majData_majSemigroup_majFoldable_semigroupmajAct($dictApply_0) {
  ...
  $__res = (object)["append" => function($v_1) use ($dictApply_0) {
  $__num = \func_num_args();
  $__res = function($v1_2) use ($dictApply_0, $v_1) {
  $__num = \func_num_args();
...
function majData_majSemigroup_majFoldable_intercalatemajMap($dictFoldable1_0, $dictSemigroup_1 = null) {
  ...
  $foldMap12_2_0 = (($dictFoldable1_0)->{'foldMap1'})((object)["append" => function($v_2) use ($dictSemigroup_1) {
  $__num = \func_num_args();
  ...
  $__res = function($j_3) use ($foldMap12_2_0) {
  $__num = \func_num_args();
  $__res = function($f_4) use ($foldMap12_2_0, $j_3) {
  $__num = \func_num_args();
  $__res = function($foldable_5) use ($f_4, $foldMap12_2_0, $j_3) {
  $__num = \func_num_args();
...
function majData_majSemigroup_majFoldable_traverse1_($dictFoldable1_0, $dictApply_1 = null) {
  ...
  $__res = function($f_4) use ($__local_var_2_0, $foldMap12_3_1) {
  $__num = \func_num_args();
  $__res = function($t_5) use ($__local_var_2_0, $f_4, $foldMap12_3_1) {
  $__num = \func_num_args();
...
function majData_majSemigroup_majFoldable_sequence1_($dictFoldable1_0, $dictApply_1 = null) {
  ...
  $__res = ((($GLOBALS['Data_Semigroup_Foldable_traverse1_'])($dictFoldable1_0))($dictApply_1))($GLOBALS['Data_Semigroup_Foldable_identity1']);
  goto __end;;
  __end:
  return 2 < $__num ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
}
