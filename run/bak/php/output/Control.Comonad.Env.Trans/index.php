...
$GLOBALS['Control_Comonad_Env_Trans_newtypeEnvT'] = ["Coercible0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
  $__res = null;
  goto __end;;
  __end:
...
function majControl_majComonad_majEnv_majTrans_traversablemajWithmajIndexmajEnvmajT($dictTraversableWithIndex_0) {
  ...
  $__res = ["traverseWithIndex" => function($dictApplicative_6) use ($dictTraversableWithIndex_0) {
  $__num = \func_num_args();
...
function majControl_majComonad_majEnv_majTrans_comonadmajEnvmajT($dictComonad_0) {
  ...
  $__res = ["extract" => function($v_2) use ($dictComonad_0) {
  $__num = \func_num_args();
