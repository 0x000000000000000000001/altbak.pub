...
\PhpursThunks::$thunks['Control_Comonad_Env_Trans_newtypeEnvT'] = function() { $v = (object)["Coercible0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Comonad_Env_Trans_traversableEnvT'] = function() { $v = function($dictTraversable_0 = null) {
  ...
  $__res = (object)["sequence" => function($dictApplicative_5 = null) use ($dictTraversable_0) {
  $__num = \func_num_args();
