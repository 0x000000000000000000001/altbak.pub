...
\PhpursThunks::$thunks['Control_Monad_Rec_Class_tailRec'] = function() { $v = function($f_0 = null) {
  ...
  $__tco_loop_go_1_0_0 = function($v_2 = null) use (&$__tco_done_go_1_0_0, &$__tco_var_go_1_0_0_v_2, $f_0, &$go_1_0) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_Rec_Class_monadRecIdentity'] = function() { $v = (object)["tailRecM" => function($f_0 = null) {
  $__num = \func_num_args();
...
goto end_branch_0;;
  ...
  $__res = ((($GLOBALS['Effect_bindE'] ?? \PhpursThunks::eval('Effect_bindE')))(((($GLOBALS['Effect_bindE'] ?? \PhpursThunks::eval('Effect_bindE')))(($f_0)($a_1)))(($GLOBALS['Effect_Ref__new'] ?? \PhpursThunks::eval('Effect_Ref__new')))))(function($r_3 = null) use ($f_0, $fromDone_2_0) {
  $__num = \func_num_args();
  $__res = ((($GLOBALS['Effect_bindE'] ?? \PhpursThunks::eval('Effect_bindE')))((($GLOBALS['Effect_untilE'] ?? \PhpursThunks::eval('Effect_untilE')))(((($GLOBALS['Effect_bindE'] ?? \PhpursThunks::eval('Effect_bindE')))((($GLOBALS['Effect_Ref_read'] ?? \PhpursThunks::eval('Effect_Ref_read')))($r_3)))(function($v_4 = null) use ($f_0, $r_3) {
  $__num = \func_num_args();
  $__t2 = null;;
  if ((is_object($v_4) && (($v_4)->{'tag'} === "Loop"))) {
$__t2 = ((($GLOBALS['Effect_bindE'] ?? \PhpursThunks::eval('Effect_bindE')))(($f_0)(($v_4)->{'value0'})))(function($e_5 = null) use ($r_3) {
  $__num = \func_num_args();
  $__res = ((($GLOBALS['Effect_bindE'] ?? \PhpursThunks::eval('Effect_bindE')))(((($GLOBALS['Effect_Ref_write'] ?? \PhpursThunks::eval('Effect_Ref_write')))($e_5))($r_3)))(function($dollar__unused_6 = null) {
  $__num = \func_num_args();
