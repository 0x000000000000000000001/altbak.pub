...
$GLOBALS['Data_Maybe_First_newtypeFirst'] = ["Coercible0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
  $__res = null;
  goto __end;;
  __end:
...
$GLOBALS['Data_Maybe_First_monoidFirst'] = ["mempty" => new \Data\Maybe\Data_Maybe_Nothing(), "Semigroup0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Maybe_First_altFirst'] = ["alt" => ($GLOBALS['Data_Maybe_First_semigroupFirst'])['append'], "Functor0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Maybe_First_plusFirst'] = ["empty" => ($GLOBALS['Data_Maybe_First_monoidFirst'])['mempty'], "Alt0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Maybe_First_alternativeFirst'] = ["Applicative0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
