...
\PhpursThunks::$thunks['Data_Maybe_First_newtypeFirst'] = function() { $v = (object)["Coercible0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_Maybe_First_monoidFirst'] = function() { $v = (object)["mempty" => new Phpurs_Data0("Nothing"), "Semigroup0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_Maybe_First_altFirst'] = function() { $v = (object)["alt" => (($GLOBALS['Data_Maybe_First_semigroupFirst'] ?? \PhpursThunks::eval('Data_Maybe_First_semigroupFirst')))->{'append'}, "Functor0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_Maybe_First_plusFirst'] = function() { $v = (object)["empty" => new Phpurs_Data0("Nothing"), "Alt0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_Maybe_First_alternativeFirst'] = function() { $v = (object)["Applicative0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
