...
\PhpursThunks::$thunks['Control_Monad_State_Trans_newtypeStateT'] = function() { $v = (object)["Coercible0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_State_Trans_monadAskStateT'] = function() { $v = function($dictMonadAsk_0 = null) {
  ...
  $monadStateT1_2_1 = (object)["Applicative0" => function($dollar__unused_2 = null) use ($Monad0_1_0) {
  $__num = \func_num_args();
  ...
  $__res = (object)["ask" => (((($GLOBALS['Control_Monad_State_Trans_monadTransStateT'] ?? \PhpursThunks::eval('Control_Monad_State_Trans_monadTransStateT')))->{'lift'})($Monad0_1_0))(($dictMonadAsk_0)->{'ask'}), "Monad0" => function($dollar__unused_3 = null) use ($monadStateT1_2_1) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_State_Trans_monadReaderStateT'] = function() { $v = function($dictMonadReader_0 = null) {
  ...
  $__res = (object)["local" => ((($GLOBALS['Control_Semigroupoid_composeImpl'] ?? \PhpursThunks::eval('Control_Semigroupoid_composeImpl')))(($GLOBALS['Control_Monad_State_Trans_mapStateT'] ?? \PhpursThunks::eval('Control_Monad_State_Trans_mapStateT'))))(($dictMonadReader_0)->{'local'}), "MonadAsk0" => function($dollar__unused_2 = null) use ($monadAskStateT1_1_0) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_State_Trans_monadContStateT'] = function() { $v = function($dictMonadCont_0 = null) {
  ...
  $monadStateT1_2_1 = (object)["Applicative0" => function($dollar__unused_2 = null) use ($__local_var_1_0) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_State_Trans_monadStateStateT'] = function() { $v = function($dictMonad_0 = null) {
  ...
  $monadStateT1_2_1 = (object)["Applicative0" => function($dollar__unused_2 = null) use ($dictMonad_0) {
  $__num = \func_num_args();
  $__res = (($GLOBALS['Control_Monad_State_Trans_applicativeStateT'] ?? \PhpursThunks::eval('Control_Monad_State_Trans_applicativeStateT')))($dictMonad_0);
  goto __end;;
  __end:
  ...
  $__res = (object)["state" => function($f_3 = null) use ($pure_1_0) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_State_Trans_monadTellStateT'] = function() { $v = function($dictMonadTell_0 = null) {
  ...
  $monadStateT1_3_2 = (object)["Applicative0" => function($dollar__unused_3 = null) use ($Monad1_1_0) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_State_Trans_monadThrowStateT'] = function() { $v = function($dictMonadThrow_0 = null) {
  ...
  $__res = (object)["throwError" => function($e_3 = null) use ($Monad0_1_0, $dictMonadThrow_0) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_State_Trans_monoidStateT'] = function() { $v = function($dictMonad_0 = null) {
  ...
  $__res = (object)["mempty" => (((($GLOBALS['Control_Monad_State_Trans_applicativeStateT'] ?? \PhpursThunks::eval('Control_Monad_State_Trans_applicativeStateT')))($dictMonad_0))->{'pure'})(($dictMonoid_2)->{'mempty'}), "Semigroup0" => function($dollar__unused_4 = null) use ($semigroupStateT2_3_1) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_State_Trans_plusStateT'] = function() { $v = (function() {
  ...
  $__res = (object)["empty" => function($v_4 = null) use ($empty_2_0) {
  $__num = \func_num_args();
  $__res = $empty_2_0;
  goto __end;;
  __end:
...
\PhpursThunks::$thunks['Control_Monad_State_Trans_alternativeStateT'] = function() { $v = function($dictMonad_0 = null) {
  ...
  $__res = (object)["Applicative0" => function($dollar__unused_4 = null) use ($applicativeStateT1_1_0) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_State_Trans_monadPlusStateT'] = function() { $v = function($dictMonadPlus_0 = null) {
  ...
  $__res = (object)["Monad0" => function($dollar__unused_4 = null) use ($monadStateT1_2_1) {
  $__num = \func_num_args();
  $__res = $monadStateT1_2_1;
  goto __end;;
  __end:
