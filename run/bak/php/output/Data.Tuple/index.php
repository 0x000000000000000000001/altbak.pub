...
final class Data_Tuple_Tuple { public function __construct(public mixed $value0, public mixed $value1) {} }
...
function majData_majTuple_monoidmajTuple($dictMonoid_0) {
  ...
  $__res = ["mempty" => new \Data\Tuple\Data_Tuple_Tuple($mempty_1_0, ($dictMonoid1_3)['mempty']), "Semigroup0" => function($_dollar__unused_6 = null) use ($semigroupTuple2_5_3) {
  $__num = \func_num_args();
...
function majData_majTuple_lazymajTuple($dictLazy_0, $dictLazy1_1 = null) {
  ...
  $__num = \func_num_args();
  $__res = new \Data\Tuple\Data_Tuple_Tuple((($dictLazy_0)['defer'])(function($v_3 = null) use ($f_2) {
  $__num = \func_num_args();
...
function majData_majTuple_boundedmajTuple($dictBounded_0) {
  ...
  $__res = ["top" => new \Data\Tuple\Data_Tuple_Tuple($top_1_0, ($dictBounded1_4)['top']), "bottom" => new \Data\Tuple\Data_Tuple_Tuple($bottom_2_1, ($dictBounded1_4)['bottom']), "Ord0" => function($_dollar__unused_6 = null) use ($ordTuple2_5_3) {
  $__num = \func_num_args();
  $__res = $ordTuple2_5_3;
  goto __end;;
  __end:
