...
\PhpursThunks::$thunks['Control_Applicative_applicativeProxy'] = function() { $v = (object)["pure" => function($v_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Applicative_applicativeArray'] = function() { $v = (object)["pure" => function($x_0 = null) {
  $__num = \func_num_args();
  $__res = [$x_0];
  goto __end;;
  __end:
