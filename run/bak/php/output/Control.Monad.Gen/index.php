...
return (object)["mempty" => 0.0, "Semigroup0" => function($dollar__unused_1 = null) use ($semigroupAdditive1_0_0) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_Gen_fromIndex'] = function() { $v = function($dictFoldable1_0 = null) {
  ...
  $__fn = function($v_5 = null, $v1_6 = null) use ($foldMap1_1_0, &$go_4_1, $xs_3, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  ...
  $__tco_loop_go_4_1_1 = (function() use (&$__tco_done_go_4_1_1, &$__tco_var_go_4_1_1_v_5, &$__tco_var_go_4_1_1_v1_6, $foldMap1_1_0, &$go_4_1, $xs_3) {
  $__fn = function($v_5 = null, $v1_6 = null) use (&$__tco_done_go_4_1_1, &$__tco_var_go_4_1_1_v_5, &$__tco_var_go_4_1_1_v1_6, $foldMap1_1_0, &$go_4_1, $xs_3, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
...
$__t1 = (($GLOBALS['Unsafe_Coerce_unsafeCoerce'] ?? \PhpursThunks::eval('Unsafe_Coerce_unsafeCoerce')))((($foldMap1_1_0)(($GLOBALS['Data_Semigroup_Last_Last'] ?? \PhpursThunks::eval('Data_Semigroup_Last_Last'))))($xs_3));
goto end_branch_1;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t1 = null;
...
\PhpursThunks::$thunks['Control_Monad_Gen_oneOf'] = function() { $v = (function() {
  ...
  $__num = \func_num_args();
  $__res = ((((((($dictMonadGen_0)->{'Monad0'})(($GLOBALS['Prim_undefined'] ?? \PhpursThunks::eval('Prim_undefined'))))->{'Bind1'})(($GLOBALS['Prim_undefined'] ?? \PhpursThunks::eval('Prim_undefined'))))->{'bind'})(((($dictMonadGen_0)->{'chooseInt'})(0))(((($GLOBALS['Data_Ring_intSub'] ?? \PhpursThunks::eval('Data_Ring_intSub')))(($length_2_0)($xs_4)))(1))))(function($n_5 = null) use ($fromIndex1_3_1, $xs_4) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_Gen_elements'] = function() { $v = function($dictMonadGen_0 = null) {
  ...
  $__num = \func_num_args();
  $__res = ((((($Monad0_1_0)->{'Bind1'})(($GLOBALS['Prim_undefined'] ?? \PhpursThunks::eval('Prim_undefined'))))->{'bind'})(((($dictMonadGen_0)->{'chooseInt'})(0))(((($GLOBALS['Data_Ring_intSub'] ?? \PhpursThunks::eval('Data_Ring_intSub')))(($length_3_1)($xs_5)))(1))))(function($n_6 = null) use ($Monad0_1_0, $fromIndex1_4_2, $xs_5) {
  $__num = \func_num_args();
