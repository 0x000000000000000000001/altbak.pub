...
final class Control_Monad_Gen_Cons { public function __construct(public mixed $value0, public mixed $value1) {} }
final class Control_Monad_Gen_Nil { public function __construct() {} }
...
function majControl_majMonad_majGen_onemajOf($dictMonadGen_0, $dictFoldable1_1 = null) {
  ...
  $__num = \func_num_args();
  $__res = (((((($dictMonadGen_0)['Monad0'])(null))['Bind1'])(null))['bind'])((($dictMonadGen_0)['chooseInt'])(0, (($length_2_0)($xs_4) - 1)), function($n_5 = null) use ($fromIndex1_3_1, $xs_4) {
  $__num = \func_num_args();
...
function majControl_majMonad_majGen_elements($dictMonadGen_0) {
  ...
  $__num = \func_num_args();
  $__res = (((($Monad0_1_0)['Bind1'])(null))['bind'])((($dictMonadGen_0)['chooseInt'])(0, (($length_3_1)($xs_5) - 1)), function($n_6 = null) use ($Monad0_1_0, $fromIndex1_4_2, $xs_5) {
  $__num = \func_num_args();
