...
\PhpursThunks::$thunks['Effect_Aff_Class_monadAffAff'] = function() { $v = (object)["liftAff" => (($GLOBALS['Control_Category_categoryFn'] ?? \PhpursThunks::eval('Control_Category_categoryFn')))->{'identity'}, "MonadEffect0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Effect_Aff_Class_monadAffRWS'] = function() { $v = function($dictMonadAff_0 = null) {
  ...
  $__res = (object)["liftAff" => ((($GLOBALS['Control_Semigroupoid_composeImpl'] ?? \PhpursThunks::eval('Control_Semigroupoid_composeImpl')))((((($GLOBALS['Control_Monad_RWS_Trans_monadTransRWST'] ?? \PhpursThunks::eval('Control_Monad_RWS_Trans_monadTransRWST')))($dictMonoid_4))->{'lift'})($Monad0_2_1)))($liftAff1_3_2), "MonadEffect0" => function($dollar__unused_6 = null) use ($monadEffectRWS_5_3) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Effect_Aff_Class_monadAffWriter'] = function() { $v = function($dictMonadAff_0 = null) {
  ...
  $__res = (object)["liftAff" => ((($GLOBALS['Control_Semigroupoid_composeImpl'] ?? \PhpursThunks::eval('Control_Semigroupoid_composeImpl')))((((($GLOBALS['Control_Monad_Writer_Trans_monadTransWriterT'] ?? \PhpursThunks::eval('Control_Monad_Writer_Trans_monadTransWriterT')))($dictMonoid_4))->{'lift'})($Monad0_2_1)))($liftAff1_3_2), "MonadEffect0" => function($dollar__unused_6 = null) use ($monadEffectWriter_5_3) {
  $__num = \func_num_args();
