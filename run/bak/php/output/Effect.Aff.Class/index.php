...
function majEffect_majAff_majClass_monadmajAffmajRmajWmajS($dictMonadAff_0) {
  ...
  $pure_7_5 = ((($Monad0_2_1)->{'Applicative0'})(null))->{'pure'};
  $__res = (object)["liftAff" => (($GLOBALS['Control_Semigroupoid_composeImpl'])(function($m_8) use ($Monad0_2_1, $mempty_6_4, $pure_7_5) {
  $__num = \func_num_args();
  $__res = function($v_9) use ($Monad0_2_1, $m_8, $mempty_6_4, $pure_7_5) {
  $__num = \func_num_args();
  $__res = function($s_10) use ($Monad0_2_1, $m_8, $mempty_6_4, $pure_7_5) {
  $__num = \func_num_args();
  $__res = ((((($Monad0_2_1)->{'Bind1'})(null))->{'bind'})($m_8))(function($a_11) use ($mempty_6_4, $pure_7_5, $s_10) {
  $__num = \func_num_args();
  $__res = ($pure_7_5)(new \Control\Monad\RWS\Trans\Control_Monad_RWS_Trans_RWSResult($s_10, $a_11, $mempty_6_4));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
...
function majEffect_majAff_majClass_monadmajAffmajWriter($dictMonadAff_0) {
  ...
  $__res = (object)["liftAff" => (($GLOBALS['Control_Semigroupoid_composeImpl'])(function($m_8) use ($Monad0_2_1, $mempty_6_4, $pure_7_5) {
  $__num = \func_num_args();
  $__res = ((((($Monad0_2_1)->{'Bind1'})(null))->{'bind'})($m_8))(function($a_9) use ($mempty_6_4, $pure_7_5) {
  $__num = \func_num_args();
  $__res = ($pure_7_5)(new \Data\Tuple\Data_Tuple_Tuple($a_9, $mempty_6_4));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
