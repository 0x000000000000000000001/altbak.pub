...
\PhpursThunks::$thunks['Control_Comonad_Store_Trans_newtypeStoreT'] = function() { $v = (object)["Coercible0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Comonad_Store_Trans_extendStoreT'] = function() { $v = function($dictExtend_0 = null) {
  ...
  $__fn = function($w__prime___4 = null, $s__prime___5 = null) use ($f_2, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__res = ($f_2)(new Phpurs_Data2("Tuple", $w__prime___4, $s__prime___5));
  goto __end;;
  __end:
  return $__num > 2 ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
  };
  ...
  return $__fn;
})(), "Functor0" => function($dollar__unused_2 = null) use ($functorStoreT1_1_0) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Comonad_Store_Trans_comonadStoreT'] = function() { $v = function($dictComonad_0 = null) {
  ...
  $__res = (object)["extract" => function($v_2 = null) use ($dictComonad_0) {
  $__num = \func_num_args();
  $__res = ((($dictComonad_0)->{'extract'})(($v_2)->{'value0'}))(($v_2)->{'value1'});
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Extend0" => function($dollar__unused_2 = null) use ($extendStoreT1_1_0) {
  $__num = \func_num_args();
