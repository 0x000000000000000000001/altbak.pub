...
\PhpursThunks::$thunks['Control_Comonad_Env_Class_comonadAskTuple'] = function() { $v = (object)["ask" => ($GLOBALS['Data_Tuple_fst'] ?? \PhpursThunks::eval('Data_Tuple_fst')), "Comonad0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Comonad_Env_Class_comonadAskEnvT'] = function() { $v = function($dictComonad_0 = null) {
  ...
  $__res = (object)["ask" => function($v_2 = null) {
  $__num = \func_num_args();
  $__res = ($v_2)->{'value0'};
  goto __end;;
  __end:
...
\PhpursThunks::$thunks['Control_Comonad_Env_Class_comonadEnvEnvT'] = function() { $v = function($dictComonad_0 = null) {
  ...
  $__num = \func_num_args();
  $__res = (object)["ask" => function($v_3 = null) {
  $__num = \func_num_args();
  $__res = ($v_3)->{'value0'};
  goto __end;;
  __end:
