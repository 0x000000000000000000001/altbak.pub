...
\PhpursThunks::$thunks['Test_FileOps_loopIO'] = function() { $v = function($n_0 = null) {
  $__num = \func_num_args();
  $__res = ((($GLOBALS['Test_FileOps_loopE'] ?? \PhpursThunks::eval('Test_FileOps_loopE')))($n_0))(((($GLOBALS['Effect_bindE'] ?? \PhpursThunks::eval('Effect_bindE')))(((($GLOBALS['Test_FileOps_writeFileSync'] ?? \PhpursThunks::eval('Test_FileOps_writeFileSync')))("var/iotest.txt"))("Hello IO Benchmarks!")))(function($dollar__unused_1 = null) {
  $__num = \func_num_args();
  $__res = ((($GLOBALS['Effect_bindE'] ?? \PhpursThunks::eval('Effect_bindE')))((($GLOBALS['Test_FileOps_readFileSync'] ?? \PhpursThunks::eval('Test_FileOps_readFileSync')))("var/iotest.txt")))(function($dollar__unused_2 = null) {
  $__num = \func_num_args();
