...
function majTest_majFilemajOps_loopmajE(int $v0, $v1 = null) {
  ...
  $f = ($ffi_Test_FileOps['loopE'] ?? \phpurs_ffi_fallback($ffi_Test_FileOps, 'loopE'));
  return $f($v0, $v1);
}
...
function majTest_majFilemajOps_readmajFilemajSync(string $v0) {
  ...
  global $ffi_Test_FileOps;
  $f = ($ffi_Test_FileOps['readFileSync'] ?? \phpurs_ffi_fallback($ffi_Test_FileOps, 'readFileSync'));
  return $f($v0);
}
...
function majTest_majFilemajOps_writemajFilemajSync(string $v0, $v1 = null) {
  ...
  global $ffi_Test_FileOps;
  $f = ($ffi_Test_FileOps['writeFileSync'] ?? \phpurs_ffi_fallback($ffi_Test_FileOps, 'writeFileSync'));
  return $f($v0, $v1);
}
