...
function majData_majProfunctor_majStar_strongmajStar($dictFunctor_0) {
  ...
  return $__fn;
})(), "Profunctor0" => function($_dollar__unused_2 = null) use ($profunctorStar1_1_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Profunctor_Star_newtypeStar'] = ["Coercible0" => function($_dollar__unused_0 = null) {
  $__num = \func_num_args();
  $__res = null;
  goto __end;;
  __end:
...
function majData_majProfunctor_majStar_distributivemajStar($dictDistributive_0) {
  ...
  $__res = ["distribute" => function($dictFunctor_3 = null) use ($dictDistributive_0) {
  $__num = \func_num_args();
  ...
  return $__fn;
})(), "Functor0" => function($_dollar__unused_3 = null) use ($functorStar1_2_1) {
  $__num = \func_num_args();
...
function majData_majProfunctor_majStar_closedmajStar($dictDistributive_0) {
  ...
  return $__fn;
})(), "Profunctor0" => function($_dollar__unused_3 = null) use ($profunctorStar1_2_1) {
  $__num = \func_num_args();
...
goto end_branch_8;;
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Profunctor0" => function($_dollar__unused_4 = null) use ($profunctorStar1_3_2) {
  $__num = \func_num_args();
...
function majData_majProfunctor_majStar_categorymajStar($dictMonad_0) {
  ...
  $__res = ["identity" => ((($dictMonad_0)['Applicative0'])(null))['pure'], "Semigroupoid0" => function($_dollar__unused_3 = null) use ($semigroupoidStar1_2_1) {
  $__num = \func_num_args();
...
function majData_majProfunctor_majStar_bindmajStar($dictBind_0) {
  ...
  return $__fn;
})(), "Apply0" => function($_dollar__unused_2 = null) use ($applyStar1_1_0) {
  $__num = \func_num_args();
...
function majData_majProfunctor_majStar_monadmajStar($dictMonad_0) {
  ...
  $__res = ["Applicative0" => function($_dollar__unused_3 = null) use ($applicativeStar1_1_0) {
  $__num = \func_num_args();
  $__res = $applicativeStar1_1_0;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Bind1" => function($_dollar__unused_3 = null) use ($bindStar1_2_1) {
  $__num = \func_num_args();
  $__res = $bindStar1_2_1;
  goto __end;;
  __end:
...
function majData_majProfunctor_majStar_plusmajStar($dictPlus_0) {
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Alt0" => function($_dollar__unused_3 = null) use ($altStar1_2_1) {
  $__num = \func_num_args();
  $__res = $altStar1_2_1;
  goto __end;;
  __end:
...
function majData_majProfunctor_majStar_alternativemajStar($dictAlternative_0) {
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Plus1" => function($_dollar__unused_3 = null) use ($plusStar1_2_1) {
  $__num = \func_num_args();
  $__res = $plusStar1_2_1;
  goto __end;;
  __end:
...
function majData_majProfunctor_majStar_monadmajPlusmajStar($dictMonadPlus_0) {
  ...
  $__res = ["Monad0" => function($_dollar__unused_3 = null) use ($monadStar1_1_0) {
  $__num = \func_num_args();
  $__res = $monadStar1_1_0;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Alternative1" => function($_dollar__unused_3 = null) use ($alternativeStar1_2_1) {
  $__num = \func_num_args();
