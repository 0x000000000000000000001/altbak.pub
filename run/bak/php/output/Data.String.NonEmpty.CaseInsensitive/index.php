...
\PhpursThunks::$thunks['Data_String_NonEmpty_CaseInsensitive_newtypeCaseInsensitiveNonEmptyString'] = function() { $v = (object)["Coercible0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
