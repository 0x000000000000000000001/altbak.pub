...
\PhpursThunks::$thunks['Control_Monad_Reader_runReader'] = function() { $v = function($v_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_Reader_mapReader'] = function() { $v = function($f_0 = null) {
  $__num = \func_num_args();
