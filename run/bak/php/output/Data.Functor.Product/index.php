...
$GLOBALS['Data_Functor_Product_newtypeProduct'] = ["Coercible0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
  $__res = null;
  goto __end;;
  __end:
...
function majData_majFunctor_majProduct_ord1majProduct($dictOrd1_0) {
  ...
  $__res = ["compare1" => function($dictOrd_4) use ($dictOrd11_2, $dictOrd1_0) {
  $__num = \func_num_args();
...
function majData_majFunctor_majProduct_ordmajProduct($dictOrd1_0) {
  ...
  $__res = ["compare" => ((($ord1Product1_1_0)($dictOrd11_3))['compare1'])($dictOrd_5), "Eq0" => function($_dollar__unused_7) use ($eqProduct3_6_3) {
  $__num = \func_num_args();
...
function majData_majFunctor_majProduct_applicativemajProduct($dictApplicative_0) {
  ...
  $__res = ["pure" => function($a_4) use ($dictApplicative1_2, $dictApplicative_0) {
  $__num = \func_num_args();
...
function majData_majFunctor_majProduct_monadmajProduct($dictMonad_0) {
  ...
  $__res = ["Applicative0" => function($_dollar__unused_6) use ($applicativeProduct2_4_2) {
  $__num = \func_num_args();
