...
function majData_majFunctor_majProduct_eqmajProduct($dictEq1_0, $dictEq11_1 = null, $dictEq_2 = null) {
  ...
  $__res = (object)["eq" => (((($GLOBALS['Data_Functor_Product_eq1Product'])($dictEq1_0))($dictEq11_1))->{'eq1'})($dictEq_2)];
  goto __end;;
  __end:
...
function majData_majFunctor_majProduct_ord1majProduct($dictOrd1_0) {
  ...
  $__res = function($v_7) use ($compare12_5_2, $compare13_6_3) {
  $__num = \func_num_args();
  $__res = function($v1_8) use ($compare12_5_2, $compare13_6_3, $v_7) {
  $__num = \func_num_args();
...
function majData_majFunctor_majProduct_bindmajProduct($dictBind_0) {
  ...
  $__res = (object)["bind" => function($v_4) use ($dictBind1_2, $dictBind_0) {
  $__num = \func_num_args();
  $__res = function($f_5) use ($dictBind1_2, $dictBind_0, $v_4) {
  $__num = \func_num_args();
