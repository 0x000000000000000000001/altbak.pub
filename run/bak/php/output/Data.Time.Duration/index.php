...
\PhpursThunks::$thunks['Data_Time_Duration_durationSeconds'] = function() { $v = (object)["fromDuration" => function($v_0) {
  $__num = \func_num_args();
  // DEBUG UncurriedAbs: currentBindingName=Nothing, recVars=[];
  $__res = ($v_0 * 1000.0);
  goto __end;;
...
\PhpursThunks::$thunks['Data_Time_Duration_durationMinutes'] = function() { $v = (object)["fromDuration" => function($v_0) {
  $__num = \func_num_args();
  // DEBUG UncurriedAbs: currentBindingName=Nothing, recVars=[];
  $__res = ($v_0 * 60000.0);
  goto __end;;
...
\PhpursThunks::$thunks['Data_Time_Duration_durationHours'] = function() { $v = (object)["fromDuration" => function($v_0) {
  $__num = \func_num_args();
  // DEBUG UncurriedAbs: currentBindingName=Nothing, recVars=[];
  $__res = ($v_0 * 3600000.0);
  goto __end;;
...
\PhpursThunks::$thunks['Data_Time_Duration_durationDays'] = function() { $v = (object)["fromDuration" => function($v_0) {
  $__num = \func_num_args();
  // DEBUG UncurriedAbs: currentBindingName=Nothing, recVars=[];
