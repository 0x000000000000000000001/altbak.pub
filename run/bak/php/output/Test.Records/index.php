...
// ALL IMPORTS: Bench, Control.Bind, Data.EuclideanRing, Data.Ring, Data.Semiring, Data.Show, Effect, Effect.Console, Prelude, Prim, Test.Records
// TO REQUIRE: Bench, Control.Bind, Data.EuclideanRing, Data.Ring, Data.Semiring, Data.Show, Effect, Effect.Console, Prelude, Test.Records
...
\PhpursThunks::$thunks['Test_Records_updateRec'] = function() { $v = (function() {
  ...
  $__tco_done_Test_Records_updateRec = false;
  $__tco_res_Test_Records_updateRec = null;
  $__tco_loop_Test_Records_updateRec = (function() use (&$__tco_done_Test_Records_updateRec, &$__tco_var_Test_Records_updateRec_v_0, &$__tco_var_Test_Records_updateRec_v1_1) {
  $__fn = function($v_0 = null, $v1_1 = null) use (&$__tco_done_Test_Records_updateRec, &$__tco_var_Test_Records_updateRec_v_0, &$__tco_var_Test_Records_updateRec_v1_1, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_done_Test_Records_updateRec = true;
...
break;
  ...
  while (($__tco_done_Test_Records_updateRec === false)) {
$__tco_res_Test_Records_updateRec = ($__tco_loop_Test_Records_updateRec)($__tco_var_Test_Records_updateRec_v_0, $__tco_var_Test_Records_updateRec_v1_1);
};
  $__res = $__tco_res_Test_Records_updateRec;
  goto __end;;
  __end:
  return $__num > 2 ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
  };
