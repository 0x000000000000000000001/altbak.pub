...
function majData_majMonoid_majDual_majDual($x_0) {
  $__num = \func_num_args();
...
function majData_majMonoid_majDual_showmajDual($dictShow_0) {
  $__num = \func_num_args();
...
function majData_majMonoid_majDual_semigroupmajDual($dictSemigroup_0) {
  $__num = \func_num_args();
...
function majData_majMonoid_majDual_ordmajDual($dictOrd_0) {
  $__num = \func_num_args();
...
function majData_majMonoid_majDual_monoidmajDual($dictMonoid_0) {
  $__num = \func_num_args();
  ...
  $__res = ["mempty" => ($dictMonoid_0)['mempty'], "Semigroup0" => function($_dollar__unused_3) use ($semigroupDual1_2_1) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Monoid_Dual_functorDual'] = ["map" => (function() {
...
$GLOBALS['Data_Monoid_Dual_eq1Dual'] = ["eq1" => function($dictEq_0) {
  $__num = \func_num_args();
  $__res = ($dictEq_0)['eq'];
  goto __end;;
  __end:
...
$GLOBALS['Data_Monoid_Dual_ord1Dual'] = ["compare1" => function($dictOrd_0) {
  $__num = \func_num_args();
...
function majData_majMonoid_majDual_boundedmajDual($dictBounded_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Monoid_Dual_applyDual'] = ["apply" => (function() {
...
$GLOBALS['Data_Monoid_Dual_bindDual'] = ["bind" => (function() {
...
$GLOBALS['Data_Monoid_Dual_applicativeDual'] = ["pure" => $GLOBALS['Data_Monoid_Dual_Dual'], "Apply0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
  $__res = $GLOBALS['Data_Monoid_Dual_applyDual'];
  goto __end;;
  __end:
...
$GLOBALS['Data_Monoid_Dual_monadDual'] = ["Applicative0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
