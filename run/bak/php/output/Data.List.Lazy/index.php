...
return (($GLOBALS['Data_List_Lazy_Types_foldableList'])['foldMap'])(["mempty" => ($GLOBALS['Data_HeytingAlgebra_heytingAlgebraBoolean'])['ff'], "Semigroup0" => function($_dollar__unused_1) use ($semigroupDisj1_0_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_List_Lazy_unzip_closure'] = (($GLOBALS['Data_List_Lazy_Types_foldableList'])['foldr'])(function($v_0) {
  ...
  $__res = new \Data\Tuple\Data_Tuple_Tuple(($GLOBALS['Data_Lazy_defer'])(function($v_6) use ($__local_var_1_0, $__local_var_4_2) {
  $__num = \func_num_args();
  $__res = new \Data\List\Lazy\Types\Data_List_Lazy_Types_Cons($__local_var_1_0, $__local_var_4_2);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}), ($GLOBALS['Data_Lazy_defer'])(function($v_6) use ($__local_var_2_1, $__local_var_5_3) {
  $__num = \func_num_args();
...
$__t1 = ["init" => ($GLOBALS['Data_Lazy_defer'])(function($v_6) use ($__local_var_3_2, $__local_var_5_4) {
  $__num = \func_num_args();
...
function majData_majList_majLazy_snoc($xs_0, $x_1 = null) {
  ...
  $__res = (($GLOBALS['Data_List_Lazy_Types_foldableList'])['foldr'])($GLOBALS['Data_List_Lazy_Types_cons'], ($GLOBALS['Data_Lazy_defer'])(function($v_2) use ($x_1) {
  $__num = \func_num_args();
...
function majData_majList_majLazy_reverse($xs_0) {
  ...
  $__res = ($GLOBALS['Data_Lazy_defer'])(function($v_4) use ($a_3, $b_2) {
  $__num = \func_num_args();
...
goto end_branch_2;;
  ...
  $__num = \func_num_args();
  $__res = (($__local_var_1_0)['pure'])(($GLOBALS['Data_Lazy_defer'])(function($v_7) use ($a_5, $as_6) {
  $__num = \func_num_args();
...
function majData_majList_majLazy_repeat($x_0) {
  ...
  $__num = \func_num_args();
  $__res = ($GLOBALS['Data_Lazy_defer'])(function($v_3) use (&$go__1_0, $x_0) {
  $__num = \func_num_args();
...
function majData_majList_majLazy_replicate(int $i_0, $xs_1 = null) {
  ...
  $__num = \func_num_args();
  $__res = ($GLOBALS['Data_Lazy_defer'])(function($v_4) use (&$go__2_0, $xs_1) {
  $__num = \func_num_args();
...
function majData_majList_majLazy_partition($f_0) {
  ...
  $__t0 = null;;
  if (($f_0)($x_1)) {
$__t0 = ["yes" => ($GLOBALS['Data_Lazy_defer'])(function($v_3) use ($v_2, $x_1) {
  $__num = \func_num_args();
...
goto end_branch_0;;
  ...
  $__t0 = ["yes" => ($v_2)['yes'], "no" => ($GLOBALS['Data_Lazy_defer'])(function($v_3) use ($v_2, $x_1) {
  $__num = \func_num_args();
...
$GLOBALS['Data_List_Lazy_newtypePattern'] = ["Coercible0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
  $__res = null;
  goto __end;;
  __end:
...
function majData_majList_majLazy_iterate($f_0, $x_1 = null) {
  ...
  $__res = ($GLOBALS['Data_Lazy_defer'])(function($v_5) use ($__local_var_4_1, $x_1) {
  $__num = \func_num_args();
...
function majData_majList_majLazy_insertmajAt(int $v_0, $v1_1 = null, $v2_2 = null) {
  ...
  $__res = match ($v_0) { 0 => ($GLOBALS['Data_Lazy_defer'])(function($v_3) use ($v1_1, $v2_2) {
  $__num = \func_num_args();
...
$__local_var_6_8 = ($GLOBALS['Data_Lazy_defer'])(function($v_6) use ($__local_var_3_5, $__local_var_5_7) {
  $__num = \func_num_args();
...
$__local_var_7_9 = ($GLOBALS['Data_List_Lazy_transpose'])(($GLOBALS['Data_Lazy_defer'])(function($v_8) use ($__local_var_4_6, $__local_var_7_9) {
  $__num = \func_num_args();
...
$__t3 = ($GLOBALS['Data_Lazy_defer'])(function($v_8) use ($__local_var_6_8, $__local_var_7_9) {
  $__num = \func_num_args();
...
$__t0 = new \Data\List\Lazy\Types\Data_List_Lazy_Types_Cons(($GLOBALS['Data_Lazy_defer'])(function($v2_5) use ($__local_var_2_1, $__local_var_4_3) {
  $__num = \func_num_args();
...
function majData_majList_majLazy_findmajIndex($fn_0) {
  ...
  $__res = (($GLOBALS['Data_Maybe_bindMaybe'])['bind'])(($GLOBALS['Data_List_Lazy_uncons'])($list_3), function($o_4) use ($fn_0, &$go__1_0, $n_2) {
  $__num = \func_num_args();
  $__t1 = null;;
  if (($fn_0)(($o_4)['head'])) {
...
$__t3 = (($__local_var_2_1)['bind'])(($p_3)($__local_var_6_4), function($b_8) use ($__local_var_1_0, $__local_var_2_1, $__local_var_6_4, $__local_var_7_5, $dictMonad_0, $p_3) {
  ...
  $__t6 = null;;
  if ($b_8) {
$__t6 = ($GLOBALS['Data_Lazy_defer'])(function($v_10) use ($__local_var_6_4, $xs_prime_9) {
  $__num = \func_num_args();
...
function majData_majList_majLazy_intersectmajBy($eq_0, $xs_1 = null, $ys_2 = null) {
  ...
  $__res = ($GLOBALS['Data_List_Lazy_filter'])(function($x_3) use ($eq_0, $ys_2) {
  $__num = \func_num_args();
...
goto end_branch_0;;
  ...
  if ($v_1 instanceof \Data\List\Lazy\Types\Data_List_Lazy_Types_Cons) {
$__local_var_2_1 = ($v_1)->{'value0'};
$__t0 = new \Data\List\Lazy\Types\Data_List_Lazy_Types_Cons($__local_var_2_1, ($GLOBALS['Data_List_Lazy_nubByEq'])($eq_0, ($GLOBALS['Data_List_Lazy_filter'])(function($y_3) use ($__local_var_2_1, $eq_0) {
  $__num = \func_num_args();
