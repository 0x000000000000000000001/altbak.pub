...
final class Data_Interval_StartEnd { public function __construct(public  $value0, public  $value1) {} }
final class Data_Interval_DurationEnd { public function __construct(public  $value0, public  $value1) {} }
final class Data_Interval_StartDuration { public function __construct(public  $value0, public  $value1) {} }
final class Data_Interval_DurationOnly { public function __construct(public  $value0) {} }
final class Data_Interval_RecurringInterval { public function __construct(public  $value0, public  $value1) {} }
...
$GLOBALS['Data_Interval_functorInterval'] = ["map" => (($GLOBALS['Data_Interval_bifunctorInterval'])['bimap'])(function($x_0) {
  $__num = \func_num_args();
  $__res = $x_0;
  goto __end;;
  __end:
...
$GLOBALS['Data_Interval_traversableInterval'] = ["traverse" => function($dictApplicative_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Interval_traversableRecurringInterval'] = ["traverse" => function($dictApplicative_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Interval_bitraversableInterval'] = ["bitraverse" => function($dictApplicative_0) {
  $__num = \func_num_args();
  $Apply0_1_0 = (($dictApplicative_0)['Apply0'])(null);
...
$GLOBALS['Data_Interval_bitraversableRecurringInterval'] = ["bitraverse" => function($dictApplicative_0) {
  $__num = \func_num_args();
  $over1_1_0 = ($GLOBALS['Data_Interval_over'])((((($dictApplicative_0)['Apply0'])(null))['Functor0'])(null));
