...
\PhpursThunks::$thunks['Data_Functor_Flip_newtypeFlip'] = function() { $v = (object)["Coercible0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_Functor_Flip_categoryFlip'] = function() { $v = function($dictCategory_0 = null) {
  ...
  $__res = (object)["identity" => ($dictCategory_0)->{'identity'}, "Semigroupoid0" => function($dollar__unused_3 = null) use ($semigroupoidFlip1_2_1) {
  $__num = \func_num_args();
