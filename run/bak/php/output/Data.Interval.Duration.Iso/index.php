...
final class Data_Interval_Duration_Iso_ContainsNegativeValue { public function __construct(public  $value0) {} }
final class Data_Interval_Duration_Iso_InvalidFractionalUse { public function __construct(public  $value0) {} }
...
return (($GLOBALS['Data_List_Types_foldableList'])['foldMap'])(["mempty" => ($GLOBALS['Data_Semiring_semiringNumber'])['zero'], "Semigroup0" => function($_dollar__unused_1) use ($semigroupAdditive1_0_0) {
  $__num = \func_num_args();
...
return (($GLOBALS['Data_Foldable_foldableArray'])['foldMap'])(["mempty" => function($v_2) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Interval_Duration_Iso_showIsoDuration'] = ["show" => function($v_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Interval_Duration_Iso_showError'] = ["show" => function($v_0) {
  $__num = \func_num_args();
  $__t0 = null;;
...
function majData_majInterval_majDuration_majIso_checkmajNegativemajValues($v_0) {
  ...
  $__res = ($GLOBALS['Data_Interval_Duration_Iso_foldMap1'])(function($v1_1) {
  $__num = \func_num_args();
  $__t0 = null;;
  if ((($v1_1)->{'value1'} >= 0.0)) {
$__t0 = ($GLOBALS['Data_List_Types_plusList'])['empty'];
...
function majData_majInterval_majDuration_majIso_checkmajFractionalmajUse($v_0) {
  ...
  $__local_var_1_0 = ($GLOBALS['Data_List_span'])(($GLOBALS['Control_Semigroupoid_composeImpl'])(function($a_1) {
  $__num = \func_num_args();
