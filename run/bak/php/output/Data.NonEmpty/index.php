...
\PhpursThunks::$thunks['Data_NonEmpty_foldableNonEmpty'] = function() { $v = function($dictFoldable_0 = null) {
  $__num = \func_num_args();
  $__res = (object)["foldMap" => function($dictMonoid_1 = null) use ($dictFoldable_0) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_NonEmpty_foldableWithIndexNonEmpty'] = function() { $v = function($dictFoldableWithIndex_0 = null) {
  ...
  $__res = (object)["foldMapWithIndex" => function($dictMonoid_2 = null) use ($dictFoldableWithIndex_0) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_NonEmpty_traversableNonEmpty'] = function() { $v = function($dictTraversable_0 = null) {
  ...
  $__res = (object)["sequence" => function($dictApplicative_4 = null) use ($dictTraversable_0) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_NonEmpty_ord1NonEmpty'] = function() { $v = function($dictOrd1_0 = null) {
  ...
  $eq1NonEmpty1_3_2 = (object)["eq1" => function($dictEq_3 = null) use ($__local_var_2_1) {
  $__num = \func_num_args();
  ...
  $__res = (object)["compare1" => function($dictOrd_4 = null) use ($ordNonEmpty1_1_0) {
  $__num = \func_num_args();
