...
final class Data_NonEmpty_NonEmpty { public function __construct(public  $value0, public  $value1) {} }
...
function majData_majNonmajEmpty_foldablemajNonmajEmpty($dictFoldable_0) {
  ...
  $__res = ["foldMap" => function($dictMonoid_1) use ($dictFoldable_0) {
  $__num = \func_num_args();
...
function majData_majNonmajEmpty_foldablemajWithmajIndexmajNonmajEmpty($dictFoldableWithIndex_0) {
  ...
  $foldableNonEmpty1_2_1 = ["foldMap" => function($dictMonoid_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  ...
  $__res = ["foldMapWithIndex" => function($dictMonoid_3) use ($dictFoldableWithIndex_0) {
  $__num = \func_num_args();
...
function majData_majNonmajEmpty_traversablemajNonmajEmpty($dictTraversable_0) {
  ...
  $foldableNonEmpty1_4_3 = ["foldMap" => function($dictMonoid_4) use ($__local_var_3_2) {
  $__num = \func_num_args();
  ...
  $__res = ["sequence" => function($dictApplicative_5) use ($dictTraversable_0) {
  $__num = \func_num_args();
...
function majData_majNonmajEmpty_traversablemajWithmajIndexmajNonmajEmpty($dictTraversableWithIndex_0) {
  ...
  $__res = ["traverseWithIndex" => function($dictApplicative_4) use ($dictTraversableWithIndex_0) {
  $__num = \func_num_args();
...
function majData_majNonmajEmpty_foldable1majNonmajEmpty($dictFoldable_0) {
  ...
  $foldableNonEmpty1_1_0 = ["foldMap" => function($dictMonoid_1) use ($dictFoldable_0) {
  $__num = \func_num_args();
  $foldMap1_2_0 = (($dictFoldable_0)['foldMap'])($dictMonoid_1);
  $__res = (function() use ($dictMonoid_1, $foldMap1_2_0) {
  $__fn = function($f_3, $v_4 = null) use ($dictMonoid_1, $foldMap1_2_0, &$__fn) {
...
function majData_majNonmajEmpty_ord1majNonmajEmpty($dictOrd1_0) {
  ...
  $eq1NonEmpty1_3_2 = ["eq1" => function($dictEq_3) use ($__local_var_2_1) {
  $__num = \func_num_args();
  ...
  $__res = ["compare1" => function($dictOrd_4) use ($ordNonEmpty1_1_0) {
  $__num = \func_num_args();
