...
// ALL IMPORTS: Bench, Control.Bind, Data.Function, Data.Ring, Data.Semiring, Data.Show, Effect, Effect.Console, Prelude, Prim, Test.Ackermann
// TO REQUIRE: Bench, Control.Bind, Data.Function, Data.Ring, Data.Semiring, Data.Show, Effect, Effect.Console, Prelude, Test.Ackermann
...
\PhpursThunks::$thunks['Test_Ackermann_ackermann'] = function() { $v = (function() {
  ...
  $__tco_res_Test_Ackermann_ackermann = null;
  $__tco_loop_Test_Ackermann_ackermann = (function() use (&$__tco_done_Test_Ackermann_ackermann, &$__tco_var_Test_Ackermann_ackermann_v_0, &$__tco_var_Test_Ackermann_ackermann_v1_1) {
  $__fn = function($v_0 = null, $v1_1 = null) use (&$__tco_done_Test_Ackermann_ackermann, &$__tco_var_Test_Ackermann_ackermann_v_0, &$__tco_var_Test_Ackermann_ackermann_v1_1, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_done_Test_Ackermann_ackermann = true;
...
break;
  ...
  while (($__tco_done_Test_Ackermann_ackermann === false)) {
$__tco_res_Test_Ackermann_ackermann = ($__tco_loop_Test_Ackermann_ackermann)($__tco_var_Test_Ackermann_ackermann_v_0, $__tco_var_Test_Ackermann_ackermann_v1_1);
};
  $__res = $__tco_res_Test_Ackermann_ackermann;
  goto __end;;
  __end:
  return $__num > 2 ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
  };
