...
$GLOBALS['AppX_main'] = ((($GLOBALS['Effect_bindEffect'])->{'bind'})(\Bench\majBench_runmajBench($GLOBALS['Test_AstTree_describe'], $GLOBALS['Test_AstTree_act'])))(function($t1_0) {
  ...
  $__num = \func_num_args();
  $__res = ((($GLOBALS['Effect_bindEffect'])->{'bind'})(\Bench\majBench_runmajBench($GLOBALS['Test_FileOps_describe'], $GLOBALS['Test_FileOps_act'])))(function($t14_13) use ($t10_9, $t11_10, $t12_11, $t13_12, $t1_0, $t2_1, $t3_2, $t4_3, $t5_4, $t6_5, $t7_6, $t8_7, $t9_8) {
  $__num = \func_num_args();
  $__res = ((($GLOBALS['Effect_bindEffect'])->{'bind'})(\Bench\majBench_runmajBench($GLOBALS['Test_STArray_describe'], $GLOBALS['Test_STArray_act'])))(function($t15_14) use ($t10_9, $t11_10, $t12_11, $t13_12, $t14_13, $t1_0, $t2_1, $t3_2, $t4_3, $t5_4, $t6_5, $t7_6, $t8_7, $t9_8) {
  $__num = \func_num_args();
