...
$GLOBALS['Control_Monad_ST_Internal_monadST'] = ["Applicative0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
...
$GLOBALS['Control_Monad_ST_Internal_bindST'] = ["bind" => $GLOBALS['Control_Monad_ST_Internal_bind_'], "Apply0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
...
$GLOBALS['Control_Monad_ST_Internal_applicativeST'] = ["pure" => $GLOBALS['Control_Monad_ST_Internal_pure_'], "Apply0" => function($_dollar__unused_0) {
  $__num = \func_num_args();
  $__res = $GLOBALS['Control_Monad_ST_Internal_applyST'];
  goto __end;;
  __end:
...
$GLOBALS['Control_Monad_ST_Internal_monadRecST'] = ["tailRecM" => (function() {
  ...
  $__num = \func_num_args();
  $__res = ($GLOBALS['Control_Monad_ST_Internal_discard'])(($GLOBALS['Control_Monad_ST_Internal_while'])((($GLOBALS['Control_Monad_ST_Internal_functorST'])['map'])(function($v_3) {
  $__num = \func_num_args();
  $__res = $v_3 instanceof \Control\Monad\Rec\Class\Control_Monad_Rec_Class_Loop;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, ($GLOBALS['Control_Monad_ST_Internal_read'])($r_2)), (($GLOBALS['Control_Monad_ST_Internal_bindST'])['bind'])(($GLOBALS['Control_Monad_ST_Internal_read'])($r_2), function($v_3) use ($f_0, $r_2) {
  $__num = \func_num_args();
  $__t0 = null;;
...
function majControl_majMonad_majSmajT_majInternal_monoidmajSmajT($dictMonoid_0) {
  ...
  $__res = ["mempty" => (($GLOBALS['Control_Monad_ST_Internal_applicativeST'])['pure'])(($dictMonoid_0)['mempty']), "Semigroup0" => function($_dollar__unused_1) use ($dictMonoid_0) {
  $__num = \func_num_args();
