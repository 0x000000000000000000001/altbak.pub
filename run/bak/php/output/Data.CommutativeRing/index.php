...
function majData_majCommutativemajRing_commutativemajRingmajRecord($_dollar__unused_0, $dictCommutativeRingRecord_1 = null) {
  ...
  $ringRecord1_2_0 = (object)["sub" => (($__local_var_2_0)->{'subRecord'})(new \Type\Proxy\Type_Proxy_Proxy()), "Semiring0" => function($_dollar__unused_4) use ($semiringRecord1_3_1) {
  $__num = \func_num_args();
  ...
  $__res = (object)["Ring0" => function($_dollar__unused_3) use ($ringRecord1_2_0) {
  $__num = \func_num_args();
...
function majData_majCommutativemajRing_commutativemajRingmajFn($dictCommutativeRing_0) {
  ...
  $ringFn_1_0 = ($GLOBALS['Data_Ring_ringFn'])((($dictCommutativeRing_0)->{'Ring0'})(null));
  $__res = (object)["Ring0" => function($_dollar__unused_2) use ($ringFn_1_0) {
  $__num = \func_num_args();
  $__res = $ringFn_1_0;
  goto __end;;
  __end:
