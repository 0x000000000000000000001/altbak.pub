...
\PhpursThunks::$thunks['Effect_Aff_Compat_fromEffectFnAff'] = function() { $v = function($v_0 = null) {
  ...
  $__num = \func_num_args();
  $v1_2_0 = ($v_0)(function($__local_var_2 = null) use ($k_1) {
  $__num = \func_num_args();
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, function($__local_var_2 = null) use ($k_1) {
  $__num = \func_num_args();
  ...
  $__res = function($e_3 = null) use ($v1_2_0) {
  $__num = \func_num_args();
  $__res = (($GLOBALS['Effect_Aff__makeAff'] ?? \PhpursThunks::eval('Effect_Aff__makeAff')))(($GLOBALS['Effect_Aff_isLeft'] ?? \PhpursThunks::eval('Effect_Aff_isLeft')), ($GLOBALS['Effect_Aff_unsafeFromLeft'] ?? \PhpursThunks::eval('Effect_Aff_unsafeFromLeft')), ($GLOBALS['Effect_Aff_unsafeFromRight'] ?? \PhpursThunks::eval('Effect_Aff_unsafeFromRight')), ($GLOBALS['Data_Either_Left'] ?? \PhpursThunks::eval('Data_Either_Left')), ($GLOBALS['Data_Either_Right'] ?? \PhpursThunks::eval('Data_Either_Right')), function($k2_4 = null) use ($e_3, $v1_2_0) {
  $__num = \func_num_args();
  $dollar__unused_5_1 = ($v1_2_0)($e_3, function($__local_var_5 = null) use ($k2_4) {
  $__num = \func_num_args();
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, function($__local_var_5 = null) use ($k2_4) {
  $__num = \func_num_args();
