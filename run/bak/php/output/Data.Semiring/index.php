...
function majData_majSemiring_semiringmajFn($dictSemiring_0) {
  ...
  $__fn = function($f_3 = null, $g_4 = null, $x_5 = null) use ($dictSemiring_0, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 3) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 3);
  }
  ...
  return $__fn;
})(), "zero" => function($v_3 = null) use ($zero1_1_0) {
  $__num = \func_num_args();
  $__res = $zero1_1_0;
  goto __end;;
  __end:
  ...
  return $__fn;
})(), "one" => function($v_3 = null) use ($one1_2_1) {
  $__num = \func_num_args();
  $__res = $one1_2_1;
  goto __end;;
  __end:
...
function majData_majSemiring_semiringmajRecordmajCons($dictIsSymbol_0, $_dollar__unused_1 = null, $dictSemiringRecord_2 = null, $dictSemiring_3 = null) {
  ...
  $__fn = function($v_6 = null, $ra_7 = null, $rb_8 = null) use ($dictIsSymbol_0, $dictSemiringRecord_2, $dictSemiring_3, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 3) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 3);
  }
  ...
  $__fn = function($v_6 = null, $v1_7 = null) use ($dictIsSymbol_0, $dictSemiringRecord_2, $one1_4_0, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  ...
  $__fn = function($v_6 = null, $v1_7 = null) use ($dictIsSymbol_0, $dictSemiringRecord_2, $zero1_5_1, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
