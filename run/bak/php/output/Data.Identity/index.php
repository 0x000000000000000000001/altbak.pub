...
\PhpursThunks::$thunks['Data_Identity_newtypeIdentity'] = function() { $v = (object)["Coercible0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_Identity_eq1Identity'] = function() { $v = (object)["eq1" => function($dictEq_0 = null) {
  $__num = \func_num_args();
  $__res = ($dictEq_0)->{'eq'};
  goto __end;;
  __end:
...
\PhpursThunks::$thunks['Data_Identity_ord1Identity'] = function() { $v = (object)["compare1" => function($dictOrd_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_Identity_comonadIdentity'] = function() { $v = (object)["extract" => function($v_0 = null) {
  $__num = \func_num_args();
  $__res = $v_0;
  goto __end;;
  __end:
...
\PhpursThunks::$thunks['Data_Identity_applicativeIdentity'] = function() { $v = (object)["pure" => ($GLOBALS['Data_Identity_Identity'] ?? \PhpursThunks::eval('Data_Identity_Identity')), "Apply0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
  $__res = ($GLOBALS['Data_Identity_applyIdentity'] ?? \PhpursThunks::eval('Data_Identity_applyIdentity'));
  goto __end;;
  __end:
...
\PhpursThunks::$thunks['Data_Identity_monadIdentity'] = function() { $v = (object)["Applicative0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
