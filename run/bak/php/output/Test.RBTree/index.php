...
\PhpursThunks::$thunks['Test_RBTree_depth'] = function() { $v = function($v_0 = null) {
  ...
  $__tco_done_Test_RBTree_depth = false;
  $__tco_res_Test_RBTree_depth = null;
  $__tco_loop_Test_RBTree_depth = function($v_0 = null) use (&$__tco_done_Test_RBTree_depth, &$__tco_var_Test_RBTree_depth_v_0) {
  $__num = \func_num_args();
  $__tco_done_Test_RBTree_depth = true;
...
goto end_branch_0;;
  ...
  while (($__tco_done_Test_RBTree_depth === false)) {
$__tco_res_Test_RBTree_depth = ($__tco_loop_Test_RBTree_depth)($__tco_var_Test_RBTree_depth_v_0);
};
  $__res = $__tco_res_Test_RBTree_depth;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}; return $v; };
...
\PhpursThunks::$thunks['Test_RBTree_ins'] = function() { $v = (function() {
  ...
  $__tco_done_Test_RBTree_ins = false;
  $__tco_res_Test_RBTree_ins = null;
  $__tco_loop_Test_RBTree_ins = (function() use (&$__tco_done_Test_RBTree_ins, &$__tco_var_Test_RBTree_ins_v_0, &$__tco_var_Test_RBTree_ins_v1_1) {
  $__fn = function($v_0 = null, $v1_1 = null) use (&$__tco_done_Test_RBTree_ins, &$__tco_var_Test_RBTree_ins_v_0, &$__tco_var_Test_RBTree_ins_v1_1, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_done_Test_RBTree_ins = true;
...
goto end_branch_0;;
  ...
  while (($__tco_done_Test_RBTree_ins === false)) {
$__tco_res_Test_RBTree_ins = ($__tco_loop_Test_RBTree_ins)($__tco_var_Test_RBTree_ins_v_0, $__tco_var_Test_RBTree_ins_v1_1);
};
  $__res = $__tco_res_Test_RBTree_ins;
  goto __end;;
  __end:
  return $__num > 2 ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
  };
...
\PhpursThunks::$thunks['Test_RBTree_buildTree'] = function() { $v = (function() {
  ...
  $__tco_done_Test_RBTree_buildTree = false;
  $__tco_res_Test_RBTree_buildTree = null;
  $__tco_loop_Test_RBTree_buildTree = (function() use (&$__tco_done_Test_RBTree_buildTree, &$__tco_var_Test_RBTree_buildTree_v_0, &$__tco_var_Test_RBTree_buildTree_v1_1) {
  $__fn = function($v_0 = null, $v1_1 = null) use (&$__tco_done_Test_RBTree_buildTree, &$__tco_var_Test_RBTree_buildTree_v_0, &$__tco_var_Test_RBTree_buildTree_v1_1, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_done_Test_RBTree_buildTree = true;
...
break;
  ...
  while (($__tco_done_Test_RBTree_buildTree === false)) {
$__tco_res_Test_RBTree_buildTree = ($__tco_loop_Test_RBTree_buildTree)($__tco_var_Test_RBTree_buildTree_v_0, $__tco_var_Test_RBTree_buildTree_v1_1);
};
  $__res = $__tco_res_Test_RBTree_buildTree;
  goto __end;;
  __end:
  return $__num > 2 ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
  };
