...
\PhpursThunks::$thunks['Data_Ord_Min_newtypeMin'] = function() { $v = (object)["Coercible0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
...
goto end_branch_2;;
  ...
  $__res = (object)["mempty" => ($dictBounded_0)->{'top'}, "Semigroup0" => function($dollar__unused_3 = null) use ($semigroupMin1_2_1) {
  $__num = \func_num_args();
