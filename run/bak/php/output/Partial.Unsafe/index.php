...
function majPartial_majUnsafe__unsafemajPartial($v0) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\majPartial_majUnsafe__unsafemajPartial';
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 1);
  }
  global $ffi_Partial_Unsafe;
  $f = ($ffi_Partial_Unsafe['_unsafePartial'] ?? \phpurs_ffi_fallback($ffi_Partial_Unsafe, '_unsafePartial'));
  return $f($v0);
}
...
function majPartial_majUnsafe_unsafemajCrashmajWith(string $msg_0) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majPartial_majUnsafe_unsafemajCrashmajWith';
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 1);
  }
  $__res = \Partial\majPartial__crashmajWith($msg_0);
  goto __end;;
  __end:
  return 1 < $__num ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}
