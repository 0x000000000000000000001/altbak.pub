...
return pkg_Data_Array.Call__updateAt(pkg_Data_Maybe.Get_Just(), gopurs_runtime.Constructor0("Nothing"), i_0, x_1, x_2)
})
	})
	return updateAt
}
...
return pkg_Data_Array.Call_zipWithImpl(pkg_Data_Tuple.Get_Tuple(), xs_0, ys_1)
})
	})
	return zip
}
...
return pkg_Data_Array.Call_zipWithImpl(f_0, xs_1, ys_2)
})
	})
	return zipWith
}
...
return pkg_Data_Array.Call_replicateImpl(gopurs_runtime.Apply2(Get_max(), gopurs_runtime.Int(1), i_0), x_1)
})
	})
	return replicate
}
...
return pkg_Data_Array.Call_rangeImpl(x_0, y_1)
})
	})
	return range_
}
...
return pkg_Data_Array.Call__insertAt(pkg_Data_Maybe.Get_Just(), gopurs_runtime.Constructor0("Nothing"), i_0, x_1, x_2)
})
	})
	return insertAt
}
...
return pkg_Data_Array.Call_fromFoldableImpl(__local_var_1_0, x_2)
})
})
	})
...
_ = __local_var_1_0
return gopurs_runtime.Func(func(x_2 gopurs_runtime.Value) gopurs_runtime.Value {
__local_var_3_1 := pkg_Data_Array.Call_fromFoldableImpl(__local_var_1_0, x_2)
_ = __local_var_3_1
...
__local_var_1_0 := pkg_Data_Array.Call_indexImpl(pkg_Data_Maybe.Get_Just(), gopurs_runtime.Constructor0("Nothing"), x_0, gopurs_runtime.Int(0))
_ = __local_var_1_0
var __t1 gopurs_runtime.Value
{
...
{
__t0 = pkg_Data_Array.Call_sliceImpl(gopurs_runtime.Int(0), gopurs_runtime.Int(gopurs_runtime.Int(int64(len(x_0.PtrVal.([]gopurs_runtime.Value)))).IntVal - 1), x_0)
}
end_branch_0:
return __t0
})
...
__local_var_1_0 := pkg_Data_Array.Call_indexImpl(pkg_Data_Maybe.Get_Just(), gopurs_runtime.Constructor0("Nothing"), x_0, gopurs_runtime.Int(gopurs_runtime.Int(int64(len(x_0.PtrVal.([]gopurs_runtime.Value)))).IntVal - 1))
_ = __local_var_1_0
var __t1 gopurs_runtime.Value
{
if gopurs_runtime.Bool(__local_var_1_0.StrVal == "Just").IntVal != 0 {
...
__local_var_1_0 := pkg_Data_Array.Call_unconsImpl(gopurs_runtime.Func(func(v_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
return pkg_Data_Array.Call_allImpl(p_0, x_1)
})
	})
	return all
}
...
return pkg_Data_Array.Call_anyImpl(p_0, x_1)
})
	})
	return any
}
...
return pkg_Data_Array.Call__deleteAt(pkg_Data_Maybe.Get_Just(), gopurs_runtime.Constructor0("Nothing"), i_0, x_1)
})
	})
	return deleteAt
}
...
{
__t0 = pkg_Data_Array.Call_sliceImpl(i_0, gopurs_runtime.Int(int64(len(x_1.PtrVal.([]gopurs_runtime.Value)))), x_1)
}
end_branch_0:
return __t0
})
...
{
__t1 = pkg_Data_Array.Call_sliceImpl(gopurs_runtime.Int(0), gopurs_runtime.Int(__local_var_2_0), x_1)
}
end_branch_1:
return __t1
})
...
return pkg_Data_Array.Call_findIndexImpl(pkg_Data_Maybe.Get_Just(), gopurs_runtime.Constructor0("Nothing"), gopurs_runtime.Func(func(v_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
return pkg_Data_Array.Call_findLastIndexImpl(pkg_Data_Maybe.Get_Just(), gopurs_runtime.Constructor0("Nothing"), gopurs_runtime.Func(func(v_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictEq_0, "eq"), v_3, x_1)
}), x_2)
})
	})
...
return pkg_Data_Array.Call_filterImpl(f_0, x_1)
})
	})
	return filter
}
...
return pkg_Data_Array.Call_findIndexImpl(pkg_Data_Maybe.Get_Just(), gopurs_runtime.Constructor0("Nothing"), p_0, x_1)
})
	})
	return findIndex
}
...
return pkg_Data_Array.Call_findLastIndexImpl(pkg_Data_Maybe.Get_Just(), gopurs_runtime.Constructor0("Nothing"), x_0, x_1)
})
	})
...
return pkg_Data_Array.Call_findMapImpl(gopurs_runtime.Constructor0("Nothing"), pkg_Data_Maybe.Get_isJust(), p_0, x_1)
})
	})
	return findMap
}
...
return pkg_Data_Array.Call_partitionImpl(f_0, x_1)
})
	})
	return partition
}
...
return pkg_Data_Array.Call_sliceImpl(start_0, end_1, x_2)
})
	})
	return slice
}
...
{
__t0 = pkg_Data_Array.Call_sliceImpl(gopurs_runtime.Int(0), i_0, x_1)
}
end_branch_0:
return __t0
})
...
__t1 = gopurs_runtime.Constructor1("Just", gopurs_runtime.Constructor2("Tuple", gopurs_runtime.ArrayAccess(x_1, int(i_3.IntVal)), gopurs_runtime.Int(i_3.IntVal + 1)))
goto end_branch_1
} else {
...
return pkg_Data_Array.Call_scanlImpl(f_0, x_1, x_2)
})
	})
	return scanl
}
...
return pkg_Data_Array.Call_scanrImpl(f_0, x_1, x_2)
})
	})
	return scanr
}
