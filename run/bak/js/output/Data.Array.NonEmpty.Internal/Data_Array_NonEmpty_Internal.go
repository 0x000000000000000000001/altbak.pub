...
return pkg_Data_Array_NonEmpty_Internal.Call_foldr1Impl(__local_var_0, __local_var_1)
}), gopurs_runtime.Func2(func(__local_var_0 gopurs_runtime.Value, __local_var_1 gopurs_runtime.Value) gopurs_runtime.Value {
return pkg_Data_Array_NonEmpty_Internal.Call_foldl1Impl(__local_var_0, __local_var_1)
...
return pkg_Data_Array_NonEmpty_Internal.Call_traverse1Impl(apply_1_0, map__2_1, f_3)
})
