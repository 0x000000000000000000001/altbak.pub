...
__t2 = gopurs_runtime.Boolean(gopurs_runtime.Bool(v1_6.StrVal == "Left").IntVal != 0 && gopurs_runtime.Apply2(eq12_3_0, (*[1024]gopurs_runtime.Value)(v_5.UnsafePtr)[0], (*[1024]gopurs_runtime.Value)(v1_6.UnsafePtr)[0]).IntVal != 0)
goto end_branch_2
} else {
...
{
__t2 = gopurs_runtime.Boolean(gopurs_runtime.Bool(v_5.StrVal == "Right").IntVal != 0 && gopurs_runtime.Bool(v1_6.StrVal == "Right").IntVal != 0 && gopurs_runtime.Apply2(eq13_4_1, (*[1024]gopurs_runtime.Value)(v_5.UnsafePtr)[0], (*[1024]gopurs_runtime.Value)(v1_6.UnsafePtr)[0]).IntVal != 0)
}
end_branch_2:
return __t2
})
...
__t5 = gopurs_runtime.Boolean(gopurs_runtime.Bool(v1_8.StrVal == "Left").IntVal != 0 && gopurs_runtime.Apply2(eq12_5_3, (*[1024]gopurs_runtime.Value)(v_7.UnsafePtr)[0], (*[1024]gopurs_runtime.Value)(v1_8.UnsafePtr)[0]).IntVal != 0)
goto end_branch_5
} else {
...
{
__t5 = gopurs_runtime.Boolean(gopurs_runtime.Bool(v_7.StrVal == "Right").IntVal != 0 && gopurs_runtime.Bool(v1_8.StrVal == "Right").IntVal != 0 && gopurs_runtime.Apply2(eq13_6_4, (*[1024]gopurs_runtime.Value)(v_7.UnsafePtr)[0], (*[1024]gopurs_runtime.Value)(v1_8.UnsafePtr)[0]).IntVal != 0)
}
end_branch_5:
return __t5
})
...
__t7 = gopurs_runtime.Boolean(gopurs_runtime.Bool(v1_10.StrVal == "Left").IntVal != 0 && gopurs_runtime.Apply2(eq12_7_5, (*[1024]gopurs_runtime.Value)(v_9.UnsafePtr)[0], (*[1024]gopurs_runtime.Value)(v1_10.UnsafePtr)[0]).IntVal != 0)
goto end_branch_7
} else {
...
{
__t7 = gopurs_runtime.Boolean(gopurs_runtime.Bool(v_9.StrVal == "Right").IntVal != 0 && gopurs_runtime.Bool(v1_10.StrVal == "Right").IntVal != 0 && gopurs_runtime.Apply2(eq13_8_6, (*[1024]gopurs_runtime.Value)(v_9.UnsafePtr)[0], (*[1024]gopurs_runtime.Value)(v1_10.UnsafePtr)[0]).IntVal != 0)
}
end_branch_7:
return __t7
}))
