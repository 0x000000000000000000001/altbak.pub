...
func Get_heytingAlgebraBoolean() gopurs_runtime.Value {
	once_heytingAlgebraBoolean.Do(func() {
		heytingAlgebraBoolean = gopurs_runtime.RecordDict([]string{"ff", "tt", "implies", "conj", "disj", "not"}, []gopurs_runtime.Value{gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(true), gopurs_runtime.Func2(func(a_0 gopurs_runtime.Value, b_1 gopurs_runtime.Value) gopurs_runtime.Value {
