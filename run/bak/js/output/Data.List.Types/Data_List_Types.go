...
__t3 = gopurs_runtime.RecordDict2("init", "acc", gopurs_runtime.Boolean(false), (*[1024]gopurs_runtime.Value)(v_5.UnsafePtr)[0])
goto end_branch_3
} else {
...
{
__t3 = gopurs_runtime.RecordDict2("init", "acc", gopurs_runtime.Boolean(false), gopurs_runtime.Str(gopurs_runtime.RecordGet(b_4, "acc").StrVal + " : " + (*[1024]gopurs_runtime.Value)(v_5.UnsafePtr)[0].StrVal))
}
end_branch_3:
b_4_loop = __t3
v_5_loop = (*[1024]gopurs_runtime.Value)(v_5.UnsafePtr)[1]
...
__t4 = "(" + gopurs_runtime.RecordGet(gopurs_runtime.Apply2(go__3_1, gopurs_runtime.RecordDict2("init", "acc", gopurs_runtime.Boolean(true), gopurs_runtime.Str("")), gopurs_runtime.Apply2(Get_listMap(), show_1_0, v_2)), "acc").StrVal + " : Nil)"
}
end_branch_4:
return __t4
}))
...
return gopurs_runtime.Apply3(go__3_0, xs_1, ys_2, gopurs_runtime.Boolean(true))
}))
	})
	return eq1List
}
...
return gopurs_runtime.Apply3(go__4_2, xs_2, ys_3, gopurs_runtime.Boolean(true))
}))
_ = eqList1_2_1
