...
__t1 = gopurs_runtime.RecordDict2("init", "acc", gopurs_runtime.Boolean(false), v1_5)
goto end_branch_1
} else {
...
{
__t1 = gopurs_runtime.RecordDict2("init", "acc", gopurs_runtime.Boolean(false), gopurs_runtime.Str(gopurs_runtime.RecordGet(v_4, "acc").StrVal + sep_2.StrVal + v1_5.StrVal))
}
end_branch_1:
return __t1
}), gopurs_runtime.RecordDict2("init", "acc", gopurs_runtime.Boolean(true), gopurs_runtime.Str("")), xs_3), "acc")
})
})
	})
	return joinWith1
...
__t0 = gopurs_runtime.RecordDict2("init", "acc", gopurs_runtime.Boolean(false), v1_4)
goto end_branch_0
} else {
...
{
__t0 = gopurs_runtime.RecordDict2("init", "acc", gopurs_runtime.Boolean(false), gopurs_runtime.Str(gopurs_runtime.RecordGet(v_3, "acc").StrVal + splice_1.StrVal + v1_4.StrVal))
}
end_branch_0:
return __t0
}), gopurs_runtime.RecordDict2("init", "acc", gopurs_runtime.Boolean(true), gopurs_runtime.Str("")), xs_2), "acc")
})
	})
	return joinWith
}
...
{
__t1 = gopurs_runtime.RecordDict2("init", "acc", gopurs_runtime.Boolean(false), gopurs_runtime.Str(gopurs_runtime.RecordGet(v_4, "acc").StrVal + splice_2.StrVal + v1_5.StrVal))
}
end_branch_1:
return __t1
}), gopurs_runtime.RecordDict2("init", "acc", gopurs_runtime.Boolean(true), gopurs_runtime.Str("")), xs_3), "acc")
