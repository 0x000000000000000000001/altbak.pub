...
{
__t6 = gopurs_runtime.Boolean(gopurs_runtime.Bool(x_5.StrVal == "Just").IntVal != 0 && gopurs_runtime.Bool(y_6.StrVal == "Just").IntVal != 0 && gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_4_3, "eq"), (*[1024]gopurs_runtime.Value)(x_5.UnsafePtr)[0], (*[1024]gopurs_runtime.Value)(y_6.UnsafePtr)[0]).IntVal != 0)
}
end_branch_6:
return __t6
}))
...
var __t8 gopurs_runtime.Value
{
if gopurs_runtime.Bool(gopurs_runtime.Apply(Get_guard(), gopurs_runtime.Boolean(gopurs_runtime.Bool(gopurs_runtime.Apply2(gopurs_runtime.RecordGet(Ord0_1_0, "compare"), (*[1024]gopurs_runtime.Value)(__local_var_6_6.UnsafePtr)[0], v1_4).StrVal == "GT").IntVal != 0 != true)).StrVal == "Just").IntVal != 0 {
...
var __t3 gopurs_runtime.Value
{
if gopurs_runtime.Bool(gopurs_runtime.Apply(Get_guard(), gopurs_runtime.Boolean(gopurs_runtime.Bool(gopurs_runtime.Apply2(gopurs_runtime.RecordGet(Ord0_1_0, "compare"), (*[1024]gopurs_runtime.Value)(__local_var_6_1.UnsafePtr)[0], v1_4).StrVal == "LT").IntVal != 0 != true)).StrVal == "Just").IntVal != 0 {
...
__t0 = gopurs_runtime.Constructor1("Just", gopurs_runtime.Boolean(true))
goto end_branch_0
} else {
...
{
if v_0.IntVal != 0 {
__t1 = gopurs_runtime.Constructor1("Just", gopurs_runtime.Boolean(false))
goto end_branch_1
} else {
...
{
if v_0.IntVal == 0 {
__t0 = gopurs_runtime.Constructor1("Just", gopurs_runtime.Boolean(false))
goto end_branch_0
} else {
