...
func Get_SemigroupMap() gopurs_runtime.Value {
	once_SemigroupMap.Do(func() {
		SemigroupMap = gopurs_runtime.Func(func(x_0 gopurs_runtime.Value) gopurs_runtime.Value {
return x_0
})
	})
	return SemigroupMap
...
return pkg_Data_Map_Internal.Call_unsafeUnionWith(compare_1_0, append_3_1, v_4, v1_5)
}))
})
})
	})
...
func Get_ordSemigroupMap() gopurs_runtime.Value {
	once_ordSemigroupMap.Do(func() {
		ordSemigroupMap = gopurs_runtime.Func(func(dictOrd_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_ord1SemigroupMap() gopurs_runtime.Value {
	once_ord1SemigroupMap.Do(func() {
		ord1SemigroupMap = gopurs_runtime.Func(func(dictOrd_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_bindSemigroupMap() gopurs_runtime.Value {
	once_bindSemigroupMap.Do(func() {
		bindSemigroupMap = gopurs_runtime.Func(func(dictOrd_0 gopurs_runtime.Value) gopurs_runtime.Value {
