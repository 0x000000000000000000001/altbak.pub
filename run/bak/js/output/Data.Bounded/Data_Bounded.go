...
func Get_boundedBoolean() gopurs_runtime.Value {
	once_boundedBoolean.Do(func() {
		boundedBoolean = gopurs_runtime.RecordDict3("top", "bottom", "Ord0", gopurs_runtime.Boolean(true), gopurs_runtime.Boolean(false), gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
