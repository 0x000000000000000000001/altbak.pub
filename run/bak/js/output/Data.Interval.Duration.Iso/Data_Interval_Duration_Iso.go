...
{
__t2 = gopurs_runtime.Boolean(gopurs_runtime.Bool((*[1024]gopurs_runtime.Value)(x_0.UnsafePtr)[0].StrVal == "Year").IntVal != 0 && gopurs_runtime.Bool((*[1024]gopurs_runtime.Value)(y_1.UnsafePtr)[0].StrVal == "Year").IntVal != 0)
}
end_branch_2:
__t1 = gopurs_runtime.Boolean(gopurs_runtime.Bool(y_1.StrVal == "ContainsNegativeValue").IntVal != 0 && __t2.IntVal != 0)
goto end_branch_1
} else {
...
{
__t0 = gopurs_runtime.Boolean(gopurs_runtime.Bool((*[1024]gopurs_runtime.Value)(x_0.UnsafePtr)[0].StrVal == "Year").IntVal != 0 && gopurs_runtime.Bool((*[1024]gopurs_runtime.Value)(y_1.UnsafePtr)[0].StrVal == "Year").IntVal != 0)
}
end_branch_0:
__t1 = gopurs_runtime.Boolean(gopurs_runtime.Bool(x_0.StrVal == "InvalidFractionalUse").IntVal != 0 && gopurs_runtime.Bool(y_1.StrVal == "InvalidFractionalUse").IntVal != 0 && __t0.IntVal != 0)
}
end_branch_1:
return __t1
}))
...
__t2 = gopurs_runtime.Boolean(false)
goto end_branch_2
} else {
...
__t3 = gopurs_runtime.Boolean((*[1024]gopurs_runtime.Value)(gopurs_runtime.RecordGet(v_0, "asMap").UnsafePtr)[1].IntVal > 1)
goto end_branch_3
} else {
...
return gopurs_runtime.Boolean(gopurs_runtime.Apply(pkg_Data_Number.Get_floor(), (*[1024]gopurs_runtime.Value)(x_1.UnsafePtr)[1]).FloatVal() == (*[1024]gopurs_runtime.Value)(x_1.UnsafePtr)[1].FloatVal())
}), gopurs_runtime.RecordGet(v_0, "asList"))
_ = __local_var_1_0
var __t1 gopurs_runtime.Value
{
