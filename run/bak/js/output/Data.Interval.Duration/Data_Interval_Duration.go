...
{
__t0 = gopurs_runtime.Boolean(gopurs_runtime.Bool(x_0.StrVal == "Year").IntVal != 0 && gopurs_runtime.Bool(y_1.StrVal == "Year").IntVal != 0)
}
end_branch_0:
return __t0
}))
...
return pkg_Data_Map_Internal.Call_unsafeUnionWith(gopurs_runtime.RecordGet(Get_ordDurationComponent(), "compare"), pkg_Data_Semiring.Get_numAdd(), v_0, v1_1)
}))
	})
