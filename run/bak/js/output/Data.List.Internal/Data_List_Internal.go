...
func Get_fromZipper() gopurs_runtime.Value {
	once_fromZipper.Do(func() {
		fromZipper = gopurs_runtime.Func2(Call_fromZipper)
	})
	return fromZipper
}
...
__t4 = gopurs_runtime.RecordDict2("found", "result", gopurs_runtime.Boolean(false), gopurs_runtime.Apply2(up_3_0, v_5, gopurs_runtime.Constructor3("KickUp", gopurs_runtime.Constructor0("Leaf"), k_1, gopurs_runtime.Constructor0("Leaf"))))
goto end_branch_4
} else {
...
__t6 = gopurs_runtime.RecordDict2("found", "result", gopurs_runtime.Boolean(true), orig_2)
goto end_branch_6
} else {
...
__t10 = gopurs_runtime.RecordDict2("found", "result", gopurs_runtime.Boolean(true), orig_2)
goto end_branch_10
} else {
...
__t9 = gopurs_runtime.RecordDict2("found", "result", gopurs_runtime.Boolean(true), orig_2)
goto end_branch_9
} else {
