...
return gopurs_runtime.Boolean(x_0.IntVal & 1 != 0)
})
	})
	return odd
}
...
{
__t0 = gopurs_runtime.Boolean(gopurs_runtime.Bool(x_0.StrVal == "Odd").IntVal != 0 && gopurs_runtime.Bool(y_1.StrVal == "Odd").IntVal != 0)
}
end_branch_0:
return __t0
}))
...
{
__t1 = gopurs_runtime.Boolean(gopurs_runtime.Bool(x_0.StrVal == "Odd").IntVal != 0 && gopurs_runtime.Bool(y_1.StrVal == "Odd").IntVal != 0)
}
end_branch_1:
if __t1.IntVal != 0 {
__t0 = gopurs_runtime.Constructor0("Even")
