...
end_branch_1:
n_1_0 := pkg_Data_Date.Call_calcWeekday((*[1024]gopurs_runtime.Value)(v_0.UnsafePtr)[0], __t1, (*[1024]gopurs_runtime.Value)(v_0.UnsafePtr)[2])
_ = n_1_0
...
return gopurs_runtime.Boolean(gopurs_runtime.Apply2(pkg_Data_EuclideanRing.Get_intMod(), y_0, gopurs_runtime.Int(4)).IntVal == 0 && gopurs_runtime.Apply2(pkg_Data_EuclideanRing.Get_intMod(), y_0, gopurs_runtime.Int(400)).IntVal == 0 || gopurs_runtime.Apply2(pkg_Data_EuclideanRing.Get_intMod(), y_0, gopurs_runtime.Int(100)).IntVal != 0)
})
	})
	return isLeapYear
}
...
{
__t0 = gopurs_runtime.Boolean(gopurs_runtime.Bool((*[1024]gopurs_runtime.Value)(x_0.UnsafePtr)[1].StrVal == "December").IntVal != 0 && gopurs_runtime.Bool((*[1024]gopurs_runtime.Value)(y_1.UnsafePtr)[1].StrVal == "December").IntVal != 0)
}
end_branch_0:
return gopurs_runtime.Boolean((*[1024]gopurs_runtime.Value)(x_0.UnsafePtr)[0].IntVal == (*[1024]gopurs_runtime.Value)(y_1.UnsafePtr)[0].IntVal && __t0.IntVal != 0 && (*[1024]gopurs_runtime.Value)(x_0.UnsafePtr)[2].IntVal == (*[1024]gopurs_runtime.Value)(y_1.UnsafePtr)[2].IntVal)
}))
	})
	return eqDate
}
...
__t12 = gopurs_runtime.Boolean(false)
goto end_branch_12
} else {
...
__t12 = gopurs_runtime.Boolean((*[1024]gopurs_runtime.Value)(v1_3_2.UnsafePtr)[0].IntVal > __local_var_4_11.IntVal)
goto end_branch_12
} else {
...
__t15 = gopurs_runtime.Boolean(true)
goto end_branch_15
} else {
...
__t15 = gopurs_runtime.Boolean(false)
goto end_branch_15
} else {
...
{
if gopurs_runtime.Bool(v1_3_2.StrVal == "Nothing").IntVal != 0 {
__t19 = gopurs_runtime.Boolean(true)
goto end_branch_19
} else {
...
{
if gopurs_runtime.Bool(v1_3_2.StrVal == "Just").IntVal != 0 {
__t19 = gopurs_runtime.Boolean(false)
goto end_branch_19
} else {
...
{
if gopurs_runtime.Bool(sm_1_0.StrVal == "Nothing").IntVal != 0 {
__t20 = gopurs_runtime.Boolean(true)
goto end_branch_20
} else {
...
{
if gopurs_runtime.Bool(sm_1_0.StrVal == "Just").IntVal != 0 {
__t20 = gopurs_runtime.Boolean(false)
goto end_branch_20
} else {
...
{
if gopurs_runtime.Bool(v1_3_2.StrVal == "Nothing").IntVal != 0 {
__t25 = gopurs_runtime.Boolean(true)
goto end_branch_25
} else {
...
{
if gopurs_runtime.Bool(v1_3_2.StrVal == "Just").IntVal != 0 {
__t25 = gopurs_runtime.Boolean(false)
goto end_branch_25
} else {
...
{
if gopurs_runtime.Bool(v1_3_2.StrVal == "Nothing").IntVal != 0 {
__t28 = gopurs_runtime.Boolean(true)
goto end_branch_28
} else {
...
{
if gopurs_runtime.Bool(v1_3_2.StrVal == "Just").IntVal != 0 {
__t28 = gopurs_runtime.Boolean(false)
goto end_branch_28
} else {
...
{
if gopurs_runtime.Bool(v1_3_2.StrVal == "Nothing").IntVal != 0 {
__t6 = gopurs_runtime.Boolean(true)
goto end_branch_6
} else {
...
{
if gopurs_runtime.Bool(v1_3_2.StrVal == "Just").IntVal != 0 {
__t6 = gopurs_runtime.Boolean(false)
goto end_branch_6
} else {
...
{
if gopurs_runtime.Bool(v1_3_2.StrVal == "Nothing").IntVal != 0 {
__t9 = gopurs_runtime.Boolean(true)
goto end_branch_9
} else {
...
{
if gopurs_runtime.Bool(v1_3_2.StrVal == "Just").IntVal != 0 {
__t9 = gopurs_runtime.Boolean(false)
goto end_branch_9
} else {
...
{
if gopurs_runtime.Bool(pm_1_29.StrVal == "Nothing").IntVal != 0 {
__t35 = gopurs_runtime.Boolean(true)
goto end_branch_35
} else {
...
{
if gopurs_runtime.Bool(pm_1_29.StrVal == "Just").IntVal != 0 {
__t35 = gopurs_runtime.Boolean(false)
goto end_branch_35
} else {
...
end_branch_1:
return pkg_Data_Date.Call_canonicalDateImpl(gopurs_runtime.Func3(func(y_prime_3 gopurs_runtime.Value, m_prime_4 gopurs_runtime.Value, d_prime_5 gopurs_runtime.Value) gopurs_runtime.Value {
var __t0 gopurs_runtime.Value
{
