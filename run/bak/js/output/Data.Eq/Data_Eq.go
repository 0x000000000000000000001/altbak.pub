...
_ = get_7_0
return gopurs_runtime.Boolean(gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictEq_3, "eq"), gopurs_runtime.Apply(get_7_0, ra_5), gopurs_runtime.Apply(get_7_0, rb_6)).IntVal != 0 && gopurs_runtime.Apply3(gopurs_runtime.RecordGet(dictEqRecord_0, "eqRecord"), gopurs_runtime.Constructor0("Proxy"), ra_5, rb_6).IntVal != 0)
}))
})
	})
	return eqRowCons
...
return gopurs_runtime.Boolean(gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictEq_0, "eq"), x_1, y_2).IntVal != 0 != true)
})
	})
	return notEq
}
...
func Get_notEq1() gopurs_runtime.Value {
	once_notEq1.Do(func() {
		notEq1 = gopurs_runtime.Func2(func(dictEq1_0 gopurs_runtime.Value, dictEq_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Boolean(gopurs_runtime.Apply2(eq12_2_0, x_3, y_4).IntVal != 0 != true)
})
})
	})
	return notEq1
