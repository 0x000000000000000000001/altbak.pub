...
return gopurs_runtime.Boolean(gopurs_runtime.Bool(gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictOrd_0, "compare"), a1_1, a2_2).StrVal == "LT").IntVal != 0 != true)
})
	})
...
return gopurs_runtime.Boolean(gopurs_runtime.Bool(gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictOrd_0, "compare"), a1_1, a2_2).StrVal == "GT").IntVal != 0 != true)
})
	})
	return lessThanOrEq
}
...
__t0 = gopurs_runtime.Boolean(false)
goto end_branch_0
} else {
...
{
__t0 = gopurs_runtime.Boolean(gopurs_runtime.Bool(gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictOrd_0, "compare"), x_3, hi_2).StrVal == "GT").IntVal != 0 != true)
}
end_branch_0:
return __t0
})
