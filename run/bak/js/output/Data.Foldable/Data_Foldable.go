...
__t2 = gopurs_runtime.RecordDict2("init", "acc", gopurs_runtime.Boolean(false), v1_7)
goto end_branch_2
} else {
...
{
__t2 = gopurs_runtime.RecordDict2("init", "acc", gopurs_runtime.Boolean(false), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_2_0, "append"), gopurs_runtime.RecordGet(v_6, "acc"), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_2_0, "append"), sep_4, v1_7)))
}
end_branch_2:
return __t2
}), gopurs_runtime.RecordDict2("init", "acc", gopurs_runtime.Boolean(true), mempty_3_1), xs_5), "acc")
})
})
	})
	return intercalate
...
return gopurs_runtime.Boolean(v_1.IntVal != 0 || v1_2.IntVal != 0)
}))
_ = semigroupDisj1_1_1
any1_1_0 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictFoldable_0, "foldMap"), gopurs_runtime.RecordDict2("mempty", "Semigroup0", gopurs_runtime.Boolean(false), gopurs_runtime.Func(func(_dollar__unused_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Boolean(gopurs_runtime.Apply(__local_var_4_2, x_5).IntVal != 0 != true)
})
})
})
	})
