...
__t0 = gopurs_runtime.Boolean(gopurs_runtime.Apply(pkg_Data_Number.Get_abs(), v2_2).FloatVal() <= v_0.FloatVal())
goto end_branch_0
} else {
...
__t0 = gopurs_runtime.Boolean(gopurs_runtime.Apply(pkg_Data_Number.Get_abs(), v1_1).FloatVal() <= v_0.FloatVal())
goto end_branch_0
} else {
...
{
__t0 = gopurs_runtime.Boolean(gopurs_runtime.Apply(pkg_Data_Number.Get_abs(), gopurs_runtime.Float(v1_1.FloatVal() - v2_2.FloatVal())).FloatVal() <= v_0.FloatVal() * gopurs_runtime.Apply(pkg_Data_Number.Get_abs(), gopurs_runtime.Float(v1_1.FloatVal() + v2_2.FloatVal())).FloatVal() / 2.0)
}
end_branch_0:
return __t0
})
...
return gopurs_runtime.Boolean(gopurs_runtime.Apply3(Get_eqRelative(), gopurs_runtime.Float(0.000001), x_0, y_1).IntVal != 0 != true)
})
	})
...
return gopurs_runtime.Boolean(gopurs_runtime.Apply(pkg_Data_Number.Get_abs(), gopurs_runtime.Float(x_1.FloatVal() - y_2.FloatVal())).FloatVal() <= v_0.FloatVal())
})
	})
	return eqAbsolute
}
