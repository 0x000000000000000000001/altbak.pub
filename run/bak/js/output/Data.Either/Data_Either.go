...
__t0 = gopurs_runtime.Constructor1("Right", (*[1024]gopurs_runtime.Value)(v2_1.UnsafePtr)[0])
goto end_branch_0
} else {
...
__t0 = (*[1024]gopurs_runtime.Value)(v1_1.UnsafePtr)[0]
goto end_branch_0
} else {
...
__t0 = gopurs_runtime.Boolean(gopurs_runtime.Bool(y_3.StrVal == "Left").IntVal != 0 && gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictEq_0, "eq"), (*[1024]gopurs_runtime.Value)(x_2.UnsafePtr)[0], (*[1024]gopurs_runtime.Value)(y_3.UnsafePtr)[0]).IntVal != 0)
goto end_branch_0
} else {
...
{
__t0 = gopurs_runtime.Boolean(gopurs_runtime.Bool(x_2.StrVal == "Right").IntVal != 0 && gopurs_runtime.Bool(y_3.StrVal == "Right").IntVal != 0 && gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictEq1_1, "eq"), (*[1024]gopurs_runtime.Value)(x_2.UnsafePtr)[0], (*[1024]gopurs_runtime.Value)(y_3.UnsafePtr)[0]).IntVal != 0)
}
end_branch_0:
return __t0
}))
...
__t3 = gopurs_runtime.Boolean(gopurs_runtime.Bool(y_5.StrVal == "Left").IntVal != 0 && gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_1_0, "eq"), (*[1024]gopurs_runtime.Value)(x_4.UnsafePtr)[0], (*[1024]gopurs_runtime.Value)(y_5.UnsafePtr)[0]).IntVal != 0)
goto end_branch_3
} else {
...
{
__t3 = gopurs_runtime.Boolean(gopurs_runtime.Bool(x_4.StrVal == "Right").IntVal != 0 && gopurs_runtime.Bool(y_5.StrVal == "Right").IntVal != 0 && gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_3_1, "eq"), (*[1024]gopurs_runtime.Value)(x_4.UnsafePtr)[0], (*[1024]gopurs_runtime.Value)(y_5.UnsafePtr)[0]).IntVal != 0)
}
end_branch_3:
return __t3
}))
...
__t5 = gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictOrd_0, "compare"), (*[1024]gopurs_runtime.Value)(x_5.UnsafePtr)[0], (*[1024]gopurs_runtime.Value)(y_6.UnsafePtr)[0])
goto end_branch_5
} else {
...
{
if gopurs_runtime.Bool(x_4.StrVal == "Left").IntVal != 0 {
__t3 = gopurs_runtime.Boolean(gopurs_runtime.Bool(y_5.StrVal == "Left").IntVal != 0 && gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_2_1, "eq"), (*[1024]gopurs_runtime.Value)(x_4.UnsafePtr)[0], (*[1024]gopurs_runtime.Value)(y_5.UnsafePtr)[0]).IntVal != 0)
goto end_branch_3
} else {
...
{
__t3 = gopurs_runtime.Boolean(gopurs_runtime.Bool(x_4.StrVal == "Right").IntVal != 0 && gopurs_runtime.Bool(y_5.StrVal == "Right").IntVal != 0 && gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictEq1_3, "eq"), (*[1024]gopurs_runtime.Value)(x_4.UnsafePtr)[0], (*[1024]gopurs_runtime.Value)(y_5.UnsafePtr)[0]).IntVal != 0)
}
end_branch_3:
return __t3
}))
...
{
if gopurs_runtime.Bool(v2_0.StrVal == "Left").IntVal != 0 {
__t0 = gopurs_runtime.Boolean(true)
goto end_branch_0
} else {
...
__t1 = gopurs_runtime.Constructor1("Right", gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictSemigroup_0, "append"), (*[1024]gopurs_runtime.Value)(x_1.UnsafePtr)[0], (*[1024]gopurs_runtime.Value)(y_2.UnsafePtr)[0]))
goto end_branch_1
} else {
