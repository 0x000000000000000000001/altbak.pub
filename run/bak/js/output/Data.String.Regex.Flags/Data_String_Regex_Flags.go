...
func Get_unicode() gopurs_runtime.Value {
	once_unicode.Do(func() {
		unicode = gopurs_runtime.RecordDict([]string{"global", "ignoreCase", "multiline", "dotAll", "sticky", "unicode"}, []gopurs_runtime.Value{gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(true)})
	})
	return unicode
}
...
func Get_sticky() gopurs_runtime.Value {
	once_sticky.Do(func() {
		sticky = gopurs_runtime.RecordDict([]string{"global", "ignoreCase", "multiline", "dotAll", "sticky", "unicode"}, []gopurs_runtime.Value{gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(true), gopurs_runtime.Boolean(false)})
	})
	return sticky
}
...
return gopurs_runtime.RecordDict([]string{"global", "ignoreCase", "multiline", "dotAll", "sticky", "unicode"}, []gopurs_runtime.Value{gopurs_runtime.Boolean(gopurs_runtime.RecordGet(v_0, "global").IntVal != 0 || gopurs_runtime.RecordGet(v1_1, "global").IntVal != 0), gopurs_runtime.Boolean(gopurs_runtime.RecordGet(v_0, "ignoreCase").IntVal != 0 || gopurs_runtime.RecordGet(v1_1, "ignoreCase").IntVal != 0), gopurs_runtime.Boolean(gopurs_runtime.RecordGet(v_0, "multiline").IntVal != 0 || gopurs_runtime.RecordGet(v1_1, "multiline").IntVal != 0), gopurs_runtime.Boolean(gopurs_runtime.RecordGet(v_0, "dotAll").IntVal != 0 || gopurs_runtime.RecordGet(v1_1, "dotAll").IntVal != 0), gopurs_runtime.Boolean(gopurs_runtime.RecordGet(v_0, "sticky").IntVal != 0 || gopurs_runtime.RecordGet(v1_1, "sticky").IntVal != 0), gopurs_runtime.Boolean(gopurs_runtime.RecordGet(v_0, "unicode").IntVal != 0 || gopurs_runtime.RecordGet(v1_1, "unicode").IntVal != 0)})
}))
	})
...
func Get_noFlags() gopurs_runtime.Value {
	once_noFlags.Do(func() {
		noFlags = gopurs_runtime.RecordDict([]string{"global", "ignoreCase", "multiline", "dotAll", "sticky", "unicode"}, []gopurs_runtime.Value{gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(false)})
	})
	return noFlags
}
...
func Get_multiline() gopurs_runtime.Value {
	once_multiline.Do(func() {
		multiline = gopurs_runtime.RecordDict([]string{"global", "ignoreCase", "multiline", "dotAll", "sticky", "unicode"}, []gopurs_runtime.Value{gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(true), gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(false)})
	})
	return multiline
}
...
func Get_ignoreCase() gopurs_runtime.Value {
	once_ignoreCase.Do(func() {
		ignoreCase = gopurs_runtime.RecordDict([]string{"global", "ignoreCase", "multiline", "dotAll", "sticky", "unicode"}, []gopurs_runtime.Value{gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(true), gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(false)})
	})
	return ignoreCase
}
...
func Get_global() gopurs_runtime.Value {
	once_global.Do(func() {
		global = gopurs_runtime.RecordDict([]string{"global", "ignoreCase", "multiline", "dotAll", "sticky", "unicode"}, []gopurs_runtime.Value{gopurs_runtime.Boolean(true), gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(false)})
	})
	return global
}
...
func Get_dotAll() gopurs_runtime.Value {
	once_dotAll.Do(func() {
		dotAll = gopurs_runtime.RecordDict([]string{"global", "ignoreCase", "multiline", "dotAll", "sticky", "unicode"}, []gopurs_runtime.Value{gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(true), gopurs_runtime.Boolean(false), gopurs_runtime.Boolean(false)})
	})
	return dotAll
}
