...
__local_var_4_1 := pkg_Data_Map_Internal.Call_unsafeIntersectionWith(compare_1_0, pkg_Data_Function.Get_const_(), v_2, v1_3)
_ = __local_var_4_1
...
_ = compare_1_0
return gopurs_runtime.Func2(func(v_2 gopurs_runtime.Value, v1_3 gopurs_runtime.Value) gopurs_runtime.Value {
__local_var_4_1 := pkg_Data_Map_Internal.Call_unsafeDifference(compare_1_0, v_2, v1_3)
_ = __local_var_4_1
var __t2 gopurs_runtime.Value
{
if gopurs_runtime.Bool(__local_var_4_1.StrVal == "Leaf").IntVal != 0 {
