...
return pkg_Data_Map_Internal.Call_unsafeUnionWith(compare_2_0, pkg_Data_Function.Get_const_(), m1_3, m2_4)
}), gopurs_runtime.Constructor0("Leaf"))
})
	})
	return unions
...
return gopurs_runtime.Bool(pkg_Data_Map_Internal.Call_unsafeDifference(compare_1_0, s1_2, s2_3).StrVal == "Leaf")
})
})
	})
	return subset
...
end_branch_2:
return gopurs_runtime.Boolean(__t1.IntVal != __t2.IntVal && gopurs_runtime.Bool(pkg_Data_Map_Internal.Call_unsafeDifference(compare_1_0, s1_2, s2_3).StrVal == "Leaf").IntVal != 0)
})
})
	})
	return properSubset
