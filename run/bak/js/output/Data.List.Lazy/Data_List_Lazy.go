...
return gopurs_runtime.Apply(gopurs_runtime.RecordGet(pkg_Data_List_Lazy_Types.Get_foldableList(), "foldMap"), gopurs_runtime.RecordDict2("mempty", "Semigroup0", gopurs_runtime.Boolean(false), gopurs_runtime.Func(func(_dollar__unused_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
__t4 = gopurs_runtime.Boolean(true)
goto end_branch_4
} else {
...
__t4 = gopurs_runtime.Boolean(false)
goto end_branch_4
} else {
...
__t8 = gopurs_runtime.Boolean(true)
goto end_branch_8
} else {
...
return gopurs_runtime.Boolean(gopurs_runtime.Apply2(eq_0_loop, __local_var_2_1, y_3).IntVal != 0 != true)
