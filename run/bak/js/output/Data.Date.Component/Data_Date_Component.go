...
{
__t0 = gopurs_runtime.Boolean(gopurs_runtime.Bool(x_0.StrVal == "Sunday").IntVal != 0 && gopurs_runtime.Bool(y_1.StrVal == "Sunday").IntVal != 0)
}
end_branch_0:
return __t0
}))
...
{
if gopurs_runtime.Bool(x_0.StrVal == "Sunday").IntVal != 0 && gopurs_runtime.Bool(y_1.StrVal == "Sunday").IntVal != 0 {
...
{
__t0 = gopurs_runtime.Boolean(gopurs_runtime.Bool(x_0.StrVal == "December").IntVal != 0 && gopurs_runtime.Bool(y_1.StrVal == "December").IntVal != 0)
}
end_branch_0:
return __t0
}))
...
{
if gopurs_runtime.Bool(x_0.StrVal == "December").IntVal != 0 && gopurs_runtime.Bool(y_1.StrVal == "December").IntVal != 0 {
__t0 = gopurs_runtime.Constructor0("EQ")
goto end_branch_0
} else {
