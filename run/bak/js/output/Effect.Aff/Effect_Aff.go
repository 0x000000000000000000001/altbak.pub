...
func Get_suspendAff() gopurs_runtime.Value {
	once_suspendAff.Do(func() {
		suspendAff = gopurs_runtime.Apply(Get__fork(), gopurs_runtime.Boolean(false))
	})
	return suspendAff
}
...
func Get_forkAff() gopurs_runtime.Value {
	once_forkAff.Do(func() {
		forkAff = gopurs_runtime.Apply(Get__fork(), gopurs_runtime.Boolean(true))
	})
	return forkAff
}
...
return pkg_Effect_Aff.Call__makeFiber(Get_ffiUtil(), aff_0)
})
	})
	return makeFiber
}
...
__local_var_1_0 := pkg_Effect_Aff.Call__makeFiber(Get_ffiUtil(), aff_0)
_ = __local_var_1_0
...
__local_var_1_0 := pkg_Effect_Aff.Call__makeFiber(Get_ffiUtil(), x_0)
_ = __local_var_1_0
return gopurs_runtime.Func(func(_ gopurs_runtime.Value) gopurs_runtime.Value {
fiber_2_1 := gopurs_runtime.Apply(__local_var_1_0, gopurs_runtime.Value{})
_ = fiber_2_1
...
return pkg_Effect_Aff.Call__delay(pkg_Data_Either.Get_Right(), v_0)
})
	})
	return delay
}
...
return gopurs_runtime.Apply(pkg_Effect_Unsafe.Get_unsafePerformEffect(), pkg_Effect_Aff.Call__makeFiber(Get_ffiUtil(), gopurs_runtime.Apply2(Get__map(), f_0, gopurs_runtime.Apply(Get_joinFiber(), t_1))))
}))
	})
	return functorFiber
}
...
return gopurs_runtime.Apply(pkg_Effect_Unsafe.Get_unsafePerformEffect(), pkg_Effect_Aff.Call__makeFiber(Get_ffiUtil(), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(Get_applyAff(), "apply"), gopurs_runtime.Apply(Get_joinFiber(), t1_0), gopurs_runtime.Apply(Get_joinFiber(), t2_1))))
}), gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply(pkg_Effect_Unsafe.Get_unsafePerformEffect(), pkg_Effect_Aff.Call__makeFiber(Get_ffiUtil(), gopurs_runtime.Apply(Get__pure(), a_0)))
}), gopurs_runtime.Func(func(_dollar__unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = killError_1_0
__local_var_2_1 := pkg_Effect_Aff.Call__makeSupervisedFiber(Get_ffiUtil(), aff_0)
_ = __local_var_2_1
...
return pkg_Effect_Aff.Call__killAll(err_2, gopurs_runtime.RecordGet(sup_3, "supervisor"), gopurs_runtime.Apply(k_4, gopurs_runtime.Constructor1("Right", pkg_Data_Unit.Get_unit())))
}))}))
...
return pkg_Effect_Aff.Call__killAll(killError_1_0, gopurs_runtime.RecordGet(sup_3, "supervisor"), gopurs_runtime.Apply(k_4, gopurs_runtime.Constructor1("Right", pkg_Data_Unit.Get_unit())))
}))
}), gopurs_runtime.Func2(func(v_2 gopurs_runtime.Value, sup_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(Get_makeAff(), gopurs_runtime.Func(func(k_4 gopurs_runtime.Value) gopurs_runtime.Value {
return pkg_Effect_Aff.Call__killAll(killError_1_0, gopurs_runtime.RecordGet(sup_3, "supervisor"), gopurs_runtime.Apply(k_4, gopurs_runtime.Constructor1("Right", pkg_Data_Unit.Get_unit())))
...
__local_var_2_0 := pkg_Effect_Aff.Call__makeFiber(Get_ffiUtil(), gopurs_runtime.Apply2(Get__bind(), gopurs_runtime.Apply(Get_try(), aff_1), gopurs_runtime.Func(func(x_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
return pkg_Effect_Aff.Call__makeFiber(Get_ffiUtil(), gopurs_runtime.Apply2(Get__bind(), gopurs_runtime.Apply(Get_try(), aff_1), gopurs_runtime.Func(func(x_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(Get__liftEffect(), gopurs_runtime.Apply(k_0, x_2))
})))
})
	})
