...
func Get_Test_PrimesFFI_act() gopurs_runtime.Value {
	once_Test_PrimesFFI_act.Do(func() {
		cache_Test_PrimesFFI_act = gopurs_runtime.Func(func(_ gopurs_runtime.Value) gopurs_runtime.Value {
			...
			_ = dummy_1_1
			return gopurs_runtime.Apply(Get_Data_Show_showIntImpl(), gopurs_runtime.Int(gopurs_runtime.Apply(Get_Test_PrimesFFI_runPrimesFFI(), gopurs_runtime.Int(dummy_1_1.IntVal)).IntVal))
		})
	})
