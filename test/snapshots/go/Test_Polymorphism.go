	...
	once_Test_Polymorphism_act.Do(func() {
		cache_Test_Polymorphism_act = func() gopurs_runtime.Value {
			...
			return gopurs_runtime.Func(func(_ gopurs_runtime.Value) gopurs_runtime.Value {
				...
				return gopurs_runtime.Apply(gopurs_runtime.Apply(Get_Effect_Console_log(), gopurs_runtime.Str(gopurs_runtime.Apply(Get_Data_Show_showIntImpl(), gopurs_runtime.Int(gopurs_runtime.Apply2(go__go_2_2_1, gopurs_runtime.Int(dummy_1_1.IntVal), gopurs_runtime.Int(0)).IntVal)).StrVal())), gopurs_runtime.Value{})
			})
		}()
	})
