...
func Get_Test_Polymorphism_act() gopurs_runtime.Value {
	once_Test_Polymorphism_act.Do(func() {
		cache_Test_Polymorphism_act = gopurs_runtime.Func(func(_ gopurs_runtime.Value) gopurs_runtime.Value {
			...
			_ = dummy_1_1
			var Call_local_Test_Polymorphism_go__go_2_2_1 func(gopurs_runtime.Value, gopurs_runtime.Value) gopurs_runtime.Value
			_ = Call_local_Test_Polymorphism_go__go_2_2_1
			var go__go_2_2_1 gopurs_runtime.Value
			_ = go__go_2_2_1
			Call_local_Test_Polymorphism_go__go_2_2_1 = func(v_3_loop gopurs_runtime.Value, v1_4_loop gopurs_runtime.Value) gopurs_runtime.Value {
			go__go_2_2_1:
				for {
					if false {
						continue go__go_2_2_1
					}
			...
			go__go_2_2_1 = gopurs_runtime.Func(func(v_3_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
				return gopurs_runtime.Func(func(v1_4_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
					return Call_local_Test_Polymorphism_go__go_2_2_1(v_3_loop_val, v1_4_loop_val)
				})
			})
			return gopurs_runtime.Apply(Get_Data_Show_showIntImpl(), gopurs_runtime.Int(Call_local_Test_Polymorphism_go__go_2_2_1(gopurs_runtime.Int(dummy_1_1.IntVal), gopurs_runtime.Int(0)).IntVal))
		})
	})
