...
func main() {
	...
	// Clear fingerprint scratch while both full output batches remain alive.
	runtime.GC()
	...
	if err := json.NewEncoder(os.Stdout).Encode(map[string]any{
		"names": names, "construction": construction, "first_combined": firstSample, "second_combined": secondSample,
		"release_collection": drain, "retained_heap_bytes": retained.HeapAlloc, "released_heap_bytes": released.HeapAlloc,
