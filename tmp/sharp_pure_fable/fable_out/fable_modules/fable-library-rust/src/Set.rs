pub mod Set_ {
    ...
    use crate::module_52af85ec::Seq_::compareWith;
    use crate::module_52af85ec::Seq_::delay;
    use crate::module_52af85ec::Seq_::fold as fold_1;
    use crate::module_52af85ec::Seq_::reduce;
    use crate::module_52af85ec::Seq_::unfold;
    use crate::module_6dcf8b93::NativeArray_::add as add_1;
    ...
    use crate::module_c6216f2::Array_::fold as fold_2;
    use crate::module_eae1ac5e::String_::append;
    use crate::module_eae1ac5e::String_::string;
    use crate::module_ec6ee4e9::List_::cons;
    use crate::module_ec6ee4e9::List_::empty as empty_1;
    use crate::module_ec6ee4e9::List_::fold as fold_3;
    use crate::module_ec6ee4e9::List_::head;
    use crate::module_ec6ee4e9::List_::isEmpty as isEmpty_1;
    use crate::module_ec6ee4e9::List_::ofArrayWithTail;
    use crate::module_ec6ee4e9::List_::singleton as singleton_1;
    use crate::module_ec6ee4e9::List_::tail;
        ...
        '_contains: loop {
            break '_contains ({
                ...
                match &matchValue {
                    Some(matchValue_0_0) => {
                        let t: LrcPtr<Set_::SetTree_1<T>> = matchValue_0_0.clone();
                        let c: i32 = compare(k.get(), t.Key.clone());
                        if t.Height == 1_i32 {
                            c == 0_i32
                        } else {
                            if c < 0_i32 {
    ...
    pub fn collapseLHS<T: Clone + 'static>(stack: List<Set_::Set<T>>) -> List<Set_::Set<T>> {
        ...
        '_collapseLHS: loop {
            break '_collapseLHS (if !isEmpty_1(stack.get()) {
                let rest: List<Set_::Set<T>> = tail(stack.get());
                let matchValue: Option<LrcPtr<Set_::SetTree_1<T>>> =
                    (head(stack.get())).root.clone();
                match &matchValue {
                    Some(matchValue_0_0) => {
                        let t: LrcPtr<Set_::SetTree_1<T>> = matchValue_0_0.clone();
                        if t.Height == 1_i32 {
