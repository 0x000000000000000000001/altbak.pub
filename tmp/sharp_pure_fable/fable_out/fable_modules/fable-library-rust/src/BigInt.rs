...
pub mod BigInt_ {
    ...
    pub fn minusOne() -> bigint {
        (-BigInt::one()).into()
    }

    // pub fn getHashCode(x: bigint) = x.GetHashCode()
    pub fn equals(x: bigint, y: bigint) -> bool {
        x.eq(&y)
    }
    pub fn compareTo(x: bigint, y: bigint) -> i32 {
        compare(&x, &y)
    }
    ...
    pub fn sign(x: bigint) -> i32 {
        x.signum().to_i32().unwrap()
    }

    pub fn max(x: bigint, y: bigint) -> bigint {
        x.max(y).into()
    }
    pub fn min(x: bigint, y: bigint) -> bigint {
        x.min(y).into()
    }

    pub fn maxMagnitude(x: bigint, y: bigint) -> bigint {
        if abs(x.clone()) > abs(y.clone()) {
            x
        } else {
            y
        }
    ...
    pub fn divide(x: bigint, y: bigint) -> bigint {
        x / y
    }
    pub fn remainder(x: bigint, y: bigint) -> bigint {
        x % y
    }
    ...
    pub fn isZero(x: bigint) -> bool {
        x.is_zero()
    }
    pub fn isOne(x: bigint) -> bool {
        x.is_one()
    }
    pub fn isEven(x: bigint) -> bool {
        x.is_even()
    }
    pub fn isPowerOfTwo(x: bigint) -> bool {
        isPow2(x)
    }

    pub fn isNegative(x: bigint) -> bool {
        x.is_negative()
    }
    pub fn isPositive(x: bigint) -> bool {
        x.is_positive()
    }
    pub fn isEvenInteger(x: bigint) -> bool {
        x.is_even()
    }
    pub fn isOddInteger(x: bigint) -> bool {
        x.is_odd()
    }
    pub fn isPow2(x: bigint) -> bool {
        (x.clone() & (x - one())).is_zero()
    }

    pub fn fromZero() -> bigint {
        BigInt::zero().into()
    }
    pub fn fromOne() -> bigint {
        BigInt::one().into()
    }

    pub fn fromInt8(n: i8) -> bigint {
        BigInt::from_i8(n).unwrap().into()
    }
    pub fn fromUInt8(n: u8) -> bigint {
        BigInt::from_u8(n).unwrap().into()
    }
    pub fn fromInt16(n: i16) -> bigint {
        BigInt::from_i16(n).unwrap().into()
    }
    pub fn fromUInt16(n: u16) -> bigint {
        BigInt::from_u16(n).unwrap().into()
    }
    pub fn fromInt32(n: i32) -> bigint {
        BigInt::from_i32(n).unwrap().into()
    }
    pub fn fromUInt32(n: u32) -> bigint {
        BigInt::from_u32(n).unwrap().into()
    }
    pub fn fromInt64(n: i64) -> bigint {
        BigInt::from_i64(n).unwrap().into()
    }
    pub fn fromUInt64(n: u64) -> bigint {
        BigInt::from_u64(n).unwrap().into()
    }
    pub fn fromNativeInt(n: isize) -> bigint {
        BigInt::from_isize(n).unwrap().into()
    }
    pub fn fromUNativeInt(n: usize) -> bigint {
        BigInt::from_usize(n).unwrap().into()
    }

    pub fn fromFloat32(n: f32) -> bigint {
        BigInt::from_f32(n).unwrap().into()
    }
    pub fn fromFloat64(n: f64) -> bigint {
        BigInt::from_f64(n).unwrap().into()
    }

    pub fn fromDecimal(d: decimal) -> bigint {
        BigInt::from_str_radix(truncate(d).to_string().as_str(), 10)
            .unwrap()
            .into()
    }
    ...
    pub fn toInt8(x: bigint) -> i8 {
        x.to_i8().unwrap()
    }
    pub fn toUInt8(x: bigint) -> u8 {
        x.to_u8().unwrap()
    }
    pub fn toInt16(x: bigint) -> i16 {
        x.to_i16().unwrap()
    }
    pub fn toUInt16(x: bigint) -> u16 {
        x.to_u16().unwrap()
    }
    pub fn toInt32(x: bigint) -> i32 {
        x.to_i32().unwrap()
    }
    pub fn toUInt32(x: bigint) -> u32 {
        x.to_u32().unwrap()
    }
    pub fn toInt64(x: bigint) -> i64 {
        x.to_i64().unwrap()
    }
    pub fn toUInt64(x: bigint) -> u64 {
        x.to_u64().unwrap()
    }
    pub fn toNativeInt(x: bigint) -> isize {
        x.to_isize().unwrap()
    }
    pub fn toUNativeInt(x: bigint) -> usize {
        x.to_usize().unwrap()
    }
    pub fn toFloat32(x: bigint) -> f32 {
        x.to_f32().unwrap()
    }
    pub fn toFloat64(x: bigint) -> f64 {
        x.to_f64().unwrap()
    }
    ...
    pub fn toBigInt(x: bigint) -> bigint {
        x
    }

    pub fn toBoolean(x: bigint) -> bool {
        !x.is_zero()
    }
