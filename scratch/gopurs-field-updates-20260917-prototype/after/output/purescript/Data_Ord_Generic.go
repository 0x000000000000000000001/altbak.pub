...
var cache_Data_Ord_Generic_GenericOrd_dollar_Dict__3708590862 gopurs_runtime.Value
var once_Data_Ord_Generic_GenericOrd_dollar_Dict__3708590862 sync.Once
func Get_Data_Ord_Generic_GenericOrd_dollar_Dict__3708590862() gopurs_runtime.Value {
	once_Data_Ord_Generic_GenericOrd_dollar_Dict__3708590862.Do(func() {
		cache_Data_Ord_Generic_GenericOrd_dollar_Dict__3708590862 = gopurs_runtime.Func(func(x_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 950481285, UnsafePtr: unsafe.Pointer(Rebox_Data_Ord_Generic_2756679068_3050046641(Call_Data_Ord_Generic_GenericOrd_dollar_Dict__3708590862(func() struct{
	genericCompare_prime_ gopurs_runtime.Value
} {
					orig := x_0_box
					_ = orig
	...
	return cache_Data_Ord_Generic_GenericOrd_dollar_Dict__3708590862
}

var cache_Data_Ord_Generic_GenericOrd_dollar_Dict__3552420166 gopurs_runtime.Value
var once_Data_Ord_Generic_GenericOrd_dollar_Dict__3552420166 sync.Once
func Get_Data_Ord_Generic_GenericOrd_dollar_Dict__3552420166() gopurs_runtime.Value {
	once_Data_Ord_Generic_GenericOrd_dollar_Dict__3552420166.Do(func() {
		cache_Data_Ord_Generic_GenericOrd_dollar_Dict__3552420166 = gopurs_runtime.Func(func(x_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 950481285, UnsafePtr: unsafe.Pointer(Call_Data_Ord_Generic_GenericOrd_dollar_Dict__3552420166(func() struct{
	genericCompare_prime_ gopurs_runtime.Value
} {
					orig := x_0_box
					_ = orig
	...
	return cache_Data_Ord_Generic_GenericOrd_dollar_Dict__3552420166
}
...
func Call_Data_Ord_Generic_GenericOrd_dollar_Dict__3708590862(x_0_loop struct{
	genericCompare_prime_ gopurs_runtime.Value
}) *Constructor_Data_Ord_Generic_GenericOrd[uint32] {
GenericOrd_dollar_Dict__3708590862:
for {
if false { continue GenericOrd_dollar_Dict__3708590862 }
var x_0 struct{
	genericCompare_prime_ gopurs_runtime.Value
} = x_0_loop
_ = x_0
return gopurs_runtime.CoerceToStruct[Constructor_Data_Ord_Generic_GenericOrd[uint32]](func() gopurs_runtime.Value {
				orig := x_0
				_ = orig
				return gopurs_runtime.RecordDict1("genericCompare'", orig.genericCompare_prime_)
				}())
...
func Call_Data_Ord_Generic_GenericOrd_dollar_Dict__3552420166(x_0_loop struct{
	genericCompare_prime_ gopurs_runtime.Value
}) *Constructor_Data_Ord_Generic_GenericOrd[gopurs_runtime.Value] {
GenericOrd_dollar_Dict__3552420166:
for {
if false { continue GenericOrd_dollar_Dict__3552420166 }
var x_0 struct{
	genericCompare_prime_ gopurs_runtime.Value
} = x_0_loop
_ = x_0
