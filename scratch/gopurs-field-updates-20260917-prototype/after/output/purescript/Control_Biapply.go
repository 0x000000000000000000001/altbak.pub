...
return gopurs_runtime.Value{Type: 9, IntVal: 4141114362, UnsafePtr: unsafe.Pointer(Rebox_Control_Biapply_1495429347_1688994542(Rebox_Control_Biapply_1688994542_1495429347(gopurs_runtime.CoerceToStruct[Constructor_Data_Bifunctor_Bifunctor[gopurs_runtime.Value]](Get_Data_Bifunctor_bifunctorTuple()))))}
...
func init() {
	gopurs_runtime.StructGetters[3774602829] = func(ptr unsafe.Pointer, key string) gopurs_runtime.Value {
		c := (*Constructor_Control_Biapply_Biapply[gopurs_runtime.Value])(ptr)
		_ = c
		switch key {
...
return gopurs_runtime.CoerceToStruct[Constructor_Control_Biapply_Biapply[gopurs_runtime.Value]](func() gopurs_runtime.Value {
				orig := x_0
				_ = orig
				return gopurs_runtime.RecordDict2("Bifunctor0", "biapply", orig.Bifunctor0, orig.biapply)
				}())
}
...
_ = dictBiapply_0
// TAST (Let): Bifunctor0_1_0 shape=App(Other) bindingType=(ADT ["Data","Bifunctor","Bifunctor"] [(TypeVar w$scope21)])
Bifunctor0_1_0 := gopurs_runtime.CoerceToStruct[Constructor_Data_Bifunctor_Bifunctor[gopurs_runtime.Value]](gopurs_runtime.Apply(dictBiapply_0.V0, gopurs_runtime.Value{}))
_ = Bifunctor0_1_0
...
__local_var_4_2 := Call_Control_Category_identity(gopurs_runtime.Value{Type: 9, IntVal: 784524589, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Category_Category[gopurs_runtime.Value]](Get_Control_Category_categoryFn()))})
_ = __local_var_4_2
return gopurs_runtime.Apply2(dictBiapply_0.V1, gopurs_runtime.Apply2(Call_Control_Category_identity(gopurs_runtime.Value{Type: 9, IntVal: 784524589, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Category_Category[gopurs_runtime.Value]](Get_Control_Category_categoryFn()))}), gopurs_runtime.Apply2(Bifunctor0_1_0.V0, gopurs_runtime.Func(func(v_5 gopurs_runtime.Value) gopurs_runtime.Value {
...
var dictBiapply_0 *Constructor_Control_Biapply_Biapply[gopurs_runtime.Value] = dictBiapply_0_loop
_ = dictBiapply_0
// TAST (Let): Bifunctor0_1_0 shape=App(Other) bindingType=(ADT ["Data","Bifunctor","Bifunctor"] [(TypeVar w$scope34)])
Bifunctor0_1_0 := gopurs_runtime.CoerceToStruct[Constructor_Data_Bifunctor_Bifunctor[gopurs_runtime.Value]](gopurs_runtime.Apply(dictBiapply_0.V0, gopurs_runtime.Value{}))
_ = Bifunctor0_1_0
return gopurs_runtime.Func2(func(a_2 gopurs_runtime.Value, b_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(dictBiapply_0.V1, gopurs_runtime.Apply2(Call_Control_Category_identity(gopurs_runtime.Value{Type: 9, IntVal: 784524589, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Category_Category[gopurs_runtime.Value]](Get_Control_Category_categoryFn()))}), gopurs_runtime.Apply2(Bifunctor0_1_0.V0, Get_Data_Function_go__const(), Get_Data_Function_go__const()), a_2), b_3)
})
}
...
var dictBiapply_0 *Constructor_Control_Biapply_Biapply[gopurs_runtime.Value] = dictBiapply_0_loop
_ = dictBiapply_0
// TAST (Let): Bifunctor0_1_0 shape=App(Other) bindingType=(ADT ["Data","Bifunctor","Bifunctor"] [(TypeVar w$scope47)])
Bifunctor0_1_0 := gopurs_runtime.CoerceToStruct[Constructor_Data_Bifunctor_Bifunctor[gopurs_runtime.Value]](gopurs_runtime.Apply(dictBiapply_0.V0, gopurs_runtime.Value{}))
_ = Bifunctor0_1_0
...
return gopurs_runtime.Apply2(dictBiapply_0.V1, gopurs_runtime.Apply2(Call_Control_Category_identity(gopurs_runtime.Value{Type: 9, IntVal: 784524589, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Category_Category[gopurs_runtime.Value]](Get_Control_Category_categoryFn()))}), gopurs_runtime.Apply2(Bifunctor0_1_0.V0, f_2, g_3), a_4), b_5)
})
}
...
var dictBiapply_0 *Constructor_Control_Biapply_Biapply[gopurs_runtime.Value] = dictBiapply_0_loop
_ = dictBiapply_0
// TAST (Let): Bifunctor0_1_0 shape=App(Other) bindingType=(ADT ["Data","Bifunctor","Bifunctor"] [(TypeVar w$scope64)])
Bifunctor0_1_0 := gopurs_runtime.CoerceToStruct[Constructor_Data_Bifunctor_Bifunctor[gopurs_runtime.Value]](gopurs_runtime.Apply(dictBiapply_0.V0, gopurs_runtime.Value{}))
_ = Bifunctor0_1_0
...
return gopurs_runtime.Apply2(dictBiapply_0.V1, gopurs_runtime.Apply2(dictBiapply_0.V1, gopurs_runtime.Apply2(Call_Control_Category_identity(gopurs_runtime.Value{Type: 9, IntVal: 784524589, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Category_Category[gopurs_runtime.Value]](Get_Control_Category_categoryFn()))}), gopurs_runtime.Apply2(Bifunctor0_1_0.V0, f_2, g_3), a_4), b_5), c_6)
})
}
...
func Rebox_Control_Biapply_1688994542_1495429347(in *Constructor_Data_Bifunctor_Bifunctor[gopurs_runtime.Value]) *Constructor_Data_Bifunctor_Bifunctor[*Constructor_Data_Tuple_Tuple[gopurs_runtime.Value, gopurs_runtime.Value]] {
	if in == nil { return nil }
