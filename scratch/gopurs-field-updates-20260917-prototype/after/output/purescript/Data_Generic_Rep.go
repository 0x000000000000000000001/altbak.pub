...
var cache_Data_Generic_Rep_Constructor__4168339644 gopurs_runtime.Value
var once_Data_Generic_Rep_Constructor__4168339644 sync.Once
func Get_Data_Generic_Rep_Constructor__4168339644() gopurs_runtime.Value {
	once_Data_Generic_Rep_Constructor__4168339644.Do(func() {
		cache_Data_Generic_Rep_Constructor__4168339644 = gopurs_runtime.Func(func(x_unused_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: int64(Call_Data_Generic_Rep_Constructor__4168339644(uint32(x_unused_0_box.IntVal))), UnsafePtr: nil}
})
	})
	return cache_Data_Generic_Rep_Constructor__4168339644
}
...
func Call_Data_Generic_Rep_Constructor__4168339644(x_unused_0_loop uint32) uint32 {
Constructor__4168339644:
for {
if false { continue Constructor__4168339644 }
