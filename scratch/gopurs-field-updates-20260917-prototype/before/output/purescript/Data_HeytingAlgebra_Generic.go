...
var cache_Data_HeytingAlgebra_Generic_GenericHeytingAlgebra_dollar_Dict__2493745127 gopurs_runtime.Value
var once_Data_HeytingAlgebra_Generic_GenericHeytingAlgebra_dollar_Dict__2493745127 sync.Once
func Get_Data_HeytingAlgebra_Generic_GenericHeytingAlgebra_dollar_Dict__2493745127() gopurs_runtime.Value {
	once_Data_HeytingAlgebra_Generic_GenericHeytingAlgebra_dollar_Dict__2493745127.Do(func() {
		cache_Data_HeytingAlgebra_Generic_GenericHeytingAlgebra_dollar_Dict__2493745127 = gopurs_runtime.Func(func(x_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 2831861733, UnsafePtr: unsafe.Pointer(Rebox_Data_HeytingAlgebra_Generic_1092464188_1111920849(Call_Data_HeytingAlgebra_Generic_GenericHeytingAlgebra_dollar_Dict__2493745127(func() struct{
	genericConj_prime_ gopurs_runtime.Value
	genericDisj_prime_ gopurs_runtime.Value
	genericFF_prime_ uint32
	genericImplies_prime_ gopurs_runtime.Value
	genericNot_prime_ gopurs_runtime.Value
	genericTT_prime_ uint32
} {
					orig := x_0_box
					_ = orig
					clone := struct{
	...
	genericTT_prime_ uint32
					...
					clone.genericConj_prime_ = gopurs_runtime.RecordGet(orig, "genericConj'")
					clone.genericDisj_prime_ = gopurs_runtime.RecordGet(orig, "genericDisj'")
					clone.genericFF_prime_ = uint32(gopurs_runtime.RecordGet(orig, "genericFF'").IntVal)
					clone.genericImplies_prime_ = gopurs_runtime.RecordGet(orig, "genericImplies'")
					clone.genericNot_prime_ = gopurs_runtime.RecordGet(orig, "genericNot'")
					clone.genericTT_prime_ = uint32(gopurs_runtime.RecordGet(orig, "genericTT'").IntVal)
					return clone
				}())))}
})
	})
	return cache_Data_HeytingAlgebra_Generic_GenericHeytingAlgebra_dollar_Dict__2493745127
}
...
func Get_Data_HeytingAlgebra_Generic_genericNot() gopurs_runtime.Value {
	once_Data_HeytingAlgebra_Generic_genericNot.Do(func() {
		cache_Data_HeytingAlgebra_Generic_genericNot = gopurs_runtime.Func(func(dictGeneric_0_box gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Data_HeytingAlgebra_Generic_genericImplies() gopurs_runtime.Value {
	once_Data_HeytingAlgebra_Generic_genericImplies.Do(func() {
		cache_Data_HeytingAlgebra_Generic_genericImplies = gopurs_runtime.Func(func(dictGeneric_0_box gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Data_HeytingAlgebra_Generic_genericDisj() gopurs_runtime.Value {
	once_Data_HeytingAlgebra_Generic_genericDisj.Do(func() {
		cache_Data_HeytingAlgebra_Generic_genericDisj = gopurs_runtime.Func(func(dictGeneric_0_box gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Data_HeytingAlgebra_Generic_genericConj() gopurs_runtime.Value {
	once_Data_HeytingAlgebra_Generic_genericConj.Do(func() {
		cache_Data_HeytingAlgebra_Generic_genericConj = gopurs_runtime.Func(func(dictGeneric_0_box gopurs_runtime.Value) gopurs_runtime.Value {
...
func init() {
	gopurs_runtime.StructGetters[2831861733] = func(ptr unsafe.Pointer, key string) gopurs_runtime.Value {
		c := (*Constructor_Data_HeytingAlgebra_Generic_GenericHeytingAlgebra[gopurs_runtime.Value])(ptr)
		_ = c
		switch key {
...
func Call_Data_HeytingAlgebra_Generic_GenericHeytingAlgebra_dollar_Dict__2493745127(x_0_loop struct{
	genericConj_prime_ gopurs_runtime.Value
	genericDisj_prime_ gopurs_runtime.Value
	genericFF_prime_ uint32
	genericImplies_prime_ gopurs_runtime.Value
	genericNot_prime_ gopurs_runtime.Value
	genericTT_prime_ uint32
}) *Constructor_Data_HeytingAlgebra_Generic_GenericHeytingAlgebra[uint32] {
GenericHeytingAlgebra_dollar_Dict__2493745127:
for {
if false { continue GenericHeytingAlgebra_dollar_Dict__2493745127 }
var x_0 struct{
	genericConj_prime_ gopurs_runtime.Value
	genericDisj_prime_ gopurs_runtime.Value
	genericFF_prime_ uint32
...
_ = x_0
return gopurs_runtime.CoerceToStruct[Constructor_Data_HeytingAlgebra_Generic_GenericHeytingAlgebra[uint32]](func() gopurs_runtime.Value {
				orig := x_0
				_ = orig
				return gopurs_runtime.RecordDict([]string{"genericConj'", "genericDisj'", "genericFF'", "genericImplies'", "genericNot'", "genericTT'"}, []gopurs_runtime.Value{orig.genericConj_prime_, orig.genericDisj_prime_, gopurs_runtime.Value{Type: 9, IntVal: int64(orig.genericFF_prime_), UnsafePtr: nil}, orig.genericImplies_prime_, orig.genericNot_prime_, gopurs_runtime.Value{Type: 9, IntVal: int64(orig.genericTT_prime_), UnsafePtr: nil}})
				}())
}
}
...
func Call_Data_HeytingAlgebra_Generic_genericNot(dictGeneric_0_loop *Constructor_Data_Generic_Rep_Generic[gopurs_runtime.Value, gopurs_runtime.Value]) gopurs_runtime.Value {
var dictGeneric_0 *Constructor_Data_Generic_Rep_Generic[gopurs_runtime.Value, gopurs_runtime.Value] = dictGeneric_0_loop
_ = dictGeneric_0
// TAST (Let): to_1_0 shape=App(Var) bindingType=(Func [Any] (TypeVar a$scope8))
to_1_0 := Call_Data_Generic_Rep_to(dictGeneric_0)
_ = to_1_0
return gopurs_runtime.Func2(func(dictGenericHeytingAlgebra_2 gopurs_runtime.Value, x_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(to_1_0, gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictGenericHeytingAlgebra_2, "genericNot'"), gopurs_runtime.Apply(dictGeneric_0.V0, x_3)))
})
}
...
func Call_Data_HeytingAlgebra_Generic_genericImplies(dictGeneric_0_loop *Constructor_Data_Generic_Rep_Generic[gopurs_runtime.Value, gopurs_runtime.Value]) gopurs_runtime.Value {
var dictGeneric_0 *Constructor_Data_Generic_Rep_Generic[gopurs_runtime.Value, gopurs_runtime.Value] = dictGeneric_0_loop
_ = dictGeneric_0
// TAST (Let): to_1_0 shape=App(Var) bindingType=(Func [Any] (TypeVar a$scope13))
to_1_0 := Call_Data_Generic_Rep_to(dictGeneric_0)
_ = to_1_0
return gopurs_runtime.Func3(func(dictGenericHeytingAlgebra_2 gopurs_runtime.Value, x_3 gopurs_runtime.Value, y_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(to_1_0, gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictGenericHeytingAlgebra_2, "genericImplies'"), gopurs_runtime.Apply(dictGeneric_0.V0, x_3), gopurs_runtime.Apply(dictGeneric_0.V0, y_4)))
})
}
...
func Call_Data_HeytingAlgebra_Generic_genericDisj(dictGeneric_0_loop *Constructor_Data_Generic_Rep_Generic[gopurs_runtime.Value, gopurs_runtime.Value]) gopurs_runtime.Value {
var dictGeneric_0 *Constructor_Data_Generic_Rep_Generic[gopurs_runtime.Value, gopurs_runtime.Value] = dictGeneric_0_loop
_ = dictGeneric_0
// TAST (Let): to_1_0 shape=App(Var) bindingType=(Func [Any] (TypeVar a$scope33))
to_1_0 := Call_Data_Generic_Rep_to(dictGeneric_0)
_ = to_1_0
return gopurs_runtime.Func3(func(dictGenericHeytingAlgebra_2 gopurs_runtime.Value, x_3 gopurs_runtime.Value, y_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(to_1_0, gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictGenericHeytingAlgebra_2, "genericDisj'"), gopurs_runtime.Apply(dictGeneric_0.V0, x_3), gopurs_runtime.Apply(dictGeneric_0.V0, y_4)))
})
}
...
func Call_Data_HeytingAlgebra_Generic_genericConj(dictGeneric_0_loop *Constructor_Data_Generic_Rep_Generic[gopurs_runtime.Value, gopurs_runtime.Value]) gopurs_runtime.Value {
var dictGeneric_0 *Constructor_Data_Generic_Rep_Generic[gopurs_runtime.Value, gopurs_runtime.Value] = dictGeneric_0_loop
_ = dictGeneric_0
// TAST (Let): to_1_0 shape=App(Var) bindingType=(Func [Any] (TypeVar a$scope72))
to_1_0 := Call_Data_Generic_Rep_to(dictGeneric_0)
_ = to_1_0
return gopurs_runtime.Func3(func(dictGenericHeytingAlgebra_2 gopurs_runtime.Value, x_3 gopurs_runtime.Value, y_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(to_1_0, gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictGenericHeytingAlgebra_2, "genericConj'"), gopurs_runtime.Apply(dictGeneric_0.V0, x_3), gopurs_runtime.Apply(dictGeneric_0.V0, y_4)))
})
}
