...
plan = [('before', 'pure'), ('integrated', 'pure'), ('native', 'fficc')]
runs = []
...
report = dict(protocol='3 processes per variant in rotated order; 3 global warmups, 3/test, best of 10; row medians; 14 numeric results/process validated; PGO off',
...
(base / 'suite-results.json').write_text(json.dumps(report, indent=2) + '\n')
