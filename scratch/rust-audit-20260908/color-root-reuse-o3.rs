...
pub fn Test_RBTree_makeBlack(mut tree: std::rc::Rc<crate::Tree>) -> std::rc::Rc<crate::Tree> {
...
pub fn Test_RBTree_insert(x: i64, tree: std::rc::Rc<crate::Tree>) -> std::rc::Rc<crate::Tree> {
            let mut tree = Test_RBTree_ins(x, tree);
            if let Tree::T(ref mut color, ..) = std::rc::Rc::make_mut(&mut tree) { *color = Color::B; }
            tree
        }
