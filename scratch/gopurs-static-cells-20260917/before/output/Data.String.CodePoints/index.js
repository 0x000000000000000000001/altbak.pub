...
var uncons = function (s) {
    var v = $foreign["_codePointAt"](function (v1) {
        return function (v2) {
            return Data_Maybe.Nothing.value;
        };
    })(Data_Maybe.Just.create)(Data_Maybe.Nothing.value)((function () {
        var $58 = Data_String_Unsafe.charAt(0);
        return function ($59) {
            return CodePoint(fromEnum($58($59)));
        };
    })())(0)(s);
    ...
    if (v instanceof Data_Maybe.Just) {
        return new Data_Maybe.Just({
            head: v.value0,
            tail: Data_String_CodeUnits.drop(Data_String_CodeUnits.length($foreign["_take"](function (v1) {
                return function (v2) {
                    return "";
                };
            })(1)(s)))(s)
    ...
    throw new Error("Failed pattern match at Data.String.CodePoints (line 192, column 12 - line 194, column 85): " + [ v.constructor.name ]);
};
...
var unsafeCodePointAt0Fallback = function (s) {
    ...
    var $31 = isLead(cu0) && Data_String_CodeUnits.length(s) > 1;
    if ($31) {
...
var length = function ($60) {
    return Data_Array.length(toCodePointArray($60));
};
...
var fromCharCode = /* #__PURE__ */ (function () {
    var $61 = Data_Enum.toEnumWithDefaults(Data_Enum.boundedEnumChar)(Data_Bounded.bottom(Data_Bounded.boundedChar))(Data_Bounded.top(Data_Bounded.boundedChar));
    return function ($62) {
        return Data_String_CodeUnits.singleton($61($62));
    };
})();
...
var codePointFromChar = function ($63) {
    return CodePoint(fromEnum($63));
};
