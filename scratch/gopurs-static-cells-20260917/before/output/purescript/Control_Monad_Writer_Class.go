...
_ = Monad1_1_0
// TAST (Let): Bind1_2_1 shape=App(Other) bindingType=(ADT ["Control","Bind","Bind"] [(TypeVar m$scope13)])
...
_ = Bind1_2_1
// TAST (Let): pure_3_2 shape=App(Var) bindingType=(Func [(ADT ["Data","Tuple","Tuple"] [(TypeVar a$scope14), (TypeVar b$scope15)])] (TypeApp (TypeVar m$scope13) [(ADT ["Data","Tuple","Tuple"] [(TypeVar a$scope14), (TypeVar b$scope15)])]))
pure_3_2 := Call_Control_Applicative_pure(gopurs_runtime.CoerceToStruct[Constructor_Control_Applicative_Applicative[gopurs_runtime.Value]](gopurs_runtime.Apply(gopurs_runtime.RecordGet(Monad1_1_0, "Applicative0"), gopurs_runtime.Value{})))
_ = pure_3_2
...
Monad1_1_0 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(dictMonadWriter_0.V0, gopurs_runtime.Value{}), "Monad1"), gopurs_runtime.Value{})
_ = Monad1_1_0
// TAST (Let): Bind1_2_1 shape=App(Other) bindingType=(ADT ["Control","Bind","Bind"] [(TypeVar m$scope22)])
Bind1_2_1 := gopurs_runtime.CoerceToStruct[Constructor_Control_Bind_Bind[gopurs_runtime.Value]](gopurs_runtime.Apply(gopurs_runtime.RecordGet(Monad1_1_0, "Bind1"), gopurs_runtime.Value{}))
_ = Bind1_2_1
// TAST (Let): pure_3_2 shape=App(Var) bindingType=(Func [(ADT ["Data","Tuple","Tuple"] [(TypeVar a$scope23), (Func [(TypeVar w$scope21)] (TypeVar w$scope21))])] (TypeApp (TypeVar m$scope22) [(ADT ["Data","Tuple","Tuple"] [(TypeVar a$scope23), (Func [(TypeVar w$scope21)] (TypeVar w$scope21))])]))
pure_3_2 := Call_Control_Applicative_pure(gopurs_runtime.CoerceToStruct[Constructor_Control_Applicative_Applicative[gopurs_runtime.Value]](gopurs_runtime.Apply(gopurs_runtime.RecordGet(Monad1_1_0, "Applicative0"), gopurs_runtime.Value{})))
_ = pure_3_2
return gopurs_runtime.Func2(func(f_4 gopurs_runtime.Value, m_5 gopurs_runtime.Value) gopurs_runtime.Value {
