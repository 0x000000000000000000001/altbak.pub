...
func Get_Control_Extend_identity() gopurs_runtime.Value {
	once_Control_Extend_identity.Do(func() {
		cache_Control_Extend_identity = Call_Control_Category_identity(gopurs_runtime.Value{Type: 9, IntVal: 784524589, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Category_Category[gopurs_runtime.Value]](Get_Control_Category_categoryFn()))})
	})
...
var dictExtend_0 *Constructor_Control_Extend_Extend[gopurs_runtime.Value] = dictExtend_0_loop
_ = dictExtend_0
return gopurs_runtime.Apply(dictExtend_0.V1, Call_Control_Category_identity(gopurs_runtime.Value{Type: 9, IntVal: 784524589, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Category_Category[gopurs_runtime.Value]](Get_Control_Category_categoryFn()))}))
}
