...
func Get_Effect_Aff_pure() gopurs_runtime.Value {
	once_Effect_Aff_pure.Do(func() {
		cache_Effect_Aff_pure = Call_Control_Applicative_pure(gopurs_runtime.CoerceToStruct[Constructor_Control_Applicative_Applicative[gopurs_runtime.Value]](Get_Effect_applicativeEffect()))
	})
...
func Get_Effect_Aff_void() gopurs_runtime.Value {
	once_Effect_Aff_void.Do(func() {
		cache_Effect_Aff_void = Call_Data_Functor_void(gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor[gopurs_runtime.Value]](Get_Effect_functorEffect()))
	})
...
func Get_Effect_Aff_void1() gopurs_runtime.Value {
	once_Effect_Aff_void1.Do(func() {
		cache_Effect_Aff_void1 = Call_Data_Functor_void(gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor[gopurs_runtime.Value]](Get_Effect_functorEffect()))
	})
...
return func() gopurs_runtime.Value {
	...
	run gopurs_runtime.Value
				...
				_ = orig
				return gopurs_runtime.RecordDict5("isSuspended", "join", "kill", "onComplete", "run", orig.isSuspended, orig.join, orig.kill, orig.onComplete, orig.run)
				}()
})
	})
...
var cache_Effect_Aff_makeAff__925755130 gopurs_runtime.Value
var once_Effect_Aff_makeAff__925755130 sync.Once
func Get_Effect_Aff_makeAff__925755130() gopurs_runtime.Value {
	once_Effect_Aff_makeAff__925755130.Do(func() {
		cache_Effect_Aff_makeAff__925755130 = gopurs_runtime.Func(func(build_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_Effect_Aff_makeAff__925755130(build_0_box)
})
	})
	return cache_Effect_Aff_makeAff__925755130
}
...
func Get_Effect_Aff_launchAff_() gopurs_runtime.Value {
	once_Effect_Aff_launchAff_.Do(func() {
		cache_Effect_Aff_launchAff_ = gopurs_runtime.Apply2(Call_Control_Semigroupoid_compose(gopurs_runtime.CoerceToStruct[Constructor_Control_Semigroupoid_Semigroupoid[gopurs_runtime.Value]](Get_Control_Semigroupoid_semigroupoidFn())), Call_Data_Functor_void(gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor[gopurs_runtime.Value]](Get_Effect_functorEffect())), Get_Effect_Aff_launchAff())
	})
...
func Get_Effect_Aff_applyAff() gopurs_runtime.Value {
	once_Effect_Aff_applyAff.Do(func() {
		cache_Effect_Aff_applyAff = gopurs_runtime.Value{Type: 9, IntVal: 3032403085, UnsafePtr: unsafe.Pointer((&Constructor_Control_Apply_Apply[gopurs_runtime.Value]{1, gopurs_runtime.Func(func(_dollar___unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
}), Call_Control_Monad_ap(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Monad[gopurs_runtime.Value]](Get_Effect_Aff_monadAff()))}))}
	})
...
func Get_Effect_Aff_pure1() gopurs_runtime.Value {
	once_Effect_Aff_pure1.Do(func() {
		cache_Effect_Aff_pure1 = Call_Control_Applicative_pure(gopurs_runtime.CoerceToStruct[Constructor_Control_Applicative_Applicative[gopurs_runtime.Value]](Get_Effect_Aff_applicativeAff()))
	})
...
return gopurs_runtime.Value{Type: 9, IntVal: 3032403085, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Apply_Apply[gopurs_runtime.Value]](Get_Effect_Aff_applyParAff()))}
}), gopurs_runtime.Apply2(Call_Control_Semigroupoid_compose(gopurs_runtime.CoerceToStruct[Constructor_Control_Semigroupoid_Semigroupoid[gopurs_runtime.Value]](Get_Control_Semigroupoid_semigroupoidFn())), Call_Control_Parallel_Class_parallel(gopurs_runtime.CoerceToStruct[Constructor_Control_Parallel_Class_Parallel[gopurs_runtime.Value, gopurs_runtime.Value]](Get_Effect_Aff_parallelAff())), Call_Control_Applicative_pure(gopurs_runtime.CoerceToStruct[Constructor_Control_Applicative_Applicative[gopurs_runtime.Value]](Get_Effect_Aff_applicativeAff())))}))}
	})
...
func Get_Effect_Aff_liftEffect() gopurs_runtime.Value {
	once_Effect_Aff_liftEffect.Do(func() {
		cache_Effect_Aff_liftEffect = Call_Effect_Class_liftEffect(gopurs_runtime.CoerceToStruct[Constructor_Effect_Class_MonadEffect[gopurs_runtime.Value]](Get_Effect_Aff_monadEffectAff()))
	})
...
func Get_Effect_Aff_effectCanceler() gopurs_runtime.Value {
	once_Effect_Aff_effectCanceler.Do(func() {
		cache_Effect_Aff_effectCanceler = gopurs_runtime.Apply2(Call_Control_Semigroupoid_compose(gopurs_runtime.CoerceToStruct[Constructor_Control_Semigroupoid_Semigroupoid[gopurs_runtime.Value]](Get_Control_Semigroupoid_semigroupoidFn())), gopurs_runtime.Func(func(x_0 gopurs_runtime.Value) gopurs_runtime.Value {
return x_0
}), gopurs_runtime.Apply2(Call_Control_Semigroupoid_compose(gopurs_runtime.CoerceToStruct[Constructor_Control_Semigroupoid_Semigroupoid[gopurs_runtime.Value]](Get_Control_Semigroupoid_semigroupoidFn())), Get_Data_Function_go__const(), Call_Effect_Class_liftEffect(gopurs_runtime.CoerceToStruct[Constructor_Effect_Class_MonadEffect[gopurs_runtime.Value]](Get_Effect_Aff_monadEffectAff()))))
	})
...
return gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer(Rebox_Effect_Aff_179938118_2812149806(Rebox_Effect_Aff_2812149806_179938118(gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor[gopurs_runtime.Value]](Get_Effect_Aff_functorFiber()))))}
...
return func() gopurs_runtime.Value {
	...
	run gopurs_runtime.Value
					...
					orig := gopurs_runtime.Apply(Get_Effect_Unsafe_unsafePerformEffect(), Call_Effect_Aff_makeFiber(gopurs_runtime.Apply2(Call_Control_Monad_ap(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Monad[gopurs_runtime.Value]](Get_Effect_Aff_monadAff())), Call_Effect_Aff_joinFiber(func() struct{
	isSuspended gopurs_runtime.Value
	join gopurs_runtime.Value
	kill gopurs_runtime.Value
	onComplete gopurs_runtime.Value
	...
	run gopurs_runtime.Value
					...
					clone.run = gopurs_runtime.RecordGet(orig, "run")
					return clone
				}()), Call_Effect_Aff_joinFiber(func() struct{
	isSuspended gopurs_runtime.Value
	join gopurs_runtime.Value
	kill gopurs_runtime.Value
	onComplete gopurs_runtime.Value
...
return gopurs_runtime.Value{Type: 9, IntVal: 3032403085, UnsafePtr: unsafe.Pointer(Rebox_Effect_Aff_1844969297_3741347833(Rebox_Effect_Aff_3741347833_1844969297(gopurs_runtime.CoerceToStruct[Constructor_Control_Apply_Apply[gopurs_runtime.Value]](Get_Effect_Aff_applyFiber()))))}
...
func Get_Effect_Aff_fiberCanceler() gopurs_runtime.Value {
	once_Effect_Aff_fiberCanceler.Do(func() {
		cache_Effect_Aff_fiberCanceler = gopurs_runtime.Apply2(Call_Control_Semigroupoid_compose(gopurs_runtime.CoerceToStruct[Constructor_Control_Semigroupoid_Semigroupoid[gopurs_runtime.Value]](Get_Control_Semigroupoid_semigroupoidFn())), gopurs_runtime.Func(func(x_0 gopurs_runtime.Value) gopurs_runtime.Value {
return x_0
...
return gopurs_runtime.Value{Type: 9, IntVal: 778916621, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Monad[gopurs_runtime.Value]](Get_Effect_Aff_monadAff()))}
}), Call_Control_Semigroupoid_composeFlipped(gopurs_runtime.CoerceToStruct[Constructor_Control_Semigroupoid_Semigroupoid[gopurs_runtime.Value]](Get_Control_Semigroupoid_semigroupoidFn()), Call_Control_Monad_ST_Class_liftST(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_ST_Class_MonadST[gopurs_runtime.Value, gopurs_runtime.Value]](Get_Control_Monad_ST_Class_monadSTEffect())), Call_Effect_Class_liftEffect(gopurs_runtime.CoerceToStruct[Constructor_Effect_Class_MonadEffect[gopurs_runtime.Value]](Get_Effect_Aff_monadEffectAff())))}))}
	})
...
func Get_Effect_Aff_attempt() gopurs_runtime.Value {
	once_Effect_Aff_attempt.Do(func() {
		cache_Effect_Aff_attempt = Call_Control_Monad_Error_Class_try(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Error_Class_MonadError[gopurs_runtime.Value, gopurs_runtime.Value]](Get_Effect_Aff_monadErrorAff()))
	})
...
__t1 = gopurs_runtime.Apply((*go__go_1_0_0_cell), (*Constructor_Control_Monad_Rec_Class_Loop[gopurs_runtime.Value, gopurs_runtime.Value])(res_3.UnsafePtr).V0)
goto end_branch_1
} else {
...
func Get_Effect_Aff_nonCanceler() gopurs_runtime.Value {
	once_Effect_Aff_nonCanceler.Do(func() {
		cache_Effect_Aff_nonCanceler = gopurs_runtime.Apply(Get_Data_Function_const__1198217881(), gopurs_runtime.Apply(Get_Effect_Aff__pure(), Get_Data_Unit_unit()))
	})
...
func Get_Effect_Aff_monoidCanceler() gopurs_runtime.Value {
	once_Effect_Aff_monoidCanceler.Do(func() {
		cache_Effect_Aff_monoidCanceler = gopurs_runtime.Value{Type: 9, IntVal: 1722653594, UnsafePtr: unsafe.Pointer((&Constructor_Data_Monoid_Monoid[gopurs_runtime.Value]{1, gopurs_runtime.Func(func(_dollar___unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
}), gopurs_runtime.Apply(Get_Data_Function_const__1198217881(), gopurs_runtime.Apply(Get_Effect_Aff__pure(), Get_Data_Unit_unit()))}))}
	})
...
return Get_Data_Monoid_mempty__1287012906()
})
}))
	})
...
func Get_Effect_Aff_apathize() gopurs_runtime.Value {
	once_Effect_Aff_apathize.Do(func() {
		cache_Effect_Aff_apathize = Call_Control_Semigroupoid_composeFlipped(gopurs_runtime.CoerceToStruct[Constructor_Control_Semigroupoid_Semigroupoid[gopurs_runtime.Value]](Get_Control_Semigroupoid_semigroupoidFn()), Get_Effect_Aff_attempt(), gopurs_runtime.Apply(Get_Effect_Aff__map(), gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
}), Call_Control_Plus_empty(gopurs_runtime.Value{Type: 9, IntVal: 3709470893, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Plus_Plus[gopurs_runtime.Value]](Get_Effect_Aff_plusAff()))})}))}
	})
...
_ = nf_2_1
return gopurs_runtime.Apply(gopurs_runtime.Apply(Call_Control_Applicative_pure(gopurs_runtime.CoerceToStruct[Constructor_Control_Applicative_Applicative[gopurs_runtime.Value]](Get_Effect_applicativeEffect())), func() gopurs_runtime.Value {
				orig := struct{
	isSuspended gopurs_runtime.Value
	join gopurs_runtime.Value
	kill gopurs_runtime.Value
...
func Call_Effect_Aff_makeAff__925755130(build_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
makeAff__925755130:
for {
if false { continue makeAff__925755130 }
var build_0 gopurs_runtime.Value = build_0_loop
_ = build_0
return gopurs_runtime.Apply(Get_Effect_Aff__makeAffImpl(), gopurs_runtime.Func2(func(onError_1 gopurs_runtime.Value, onSuccess_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(build_0, gopurs_runtime.Func(func(either_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = fiber_2_1
return gopurs_runtime.Apply(gopurs_runtime.Apply2(Call_Control_Bind_bind(gopurs_runtime.CoerceToStruct[Constructor_Control_Bind_Bind[gopurs_runtime.Value]](Get_Effect_bindEffect())), gopurs_runtime.RecordGet(fiber_2_1, "run"), gopurs_runtime.Func(func(_dollar___unused_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(_ gopurs_runtime.Value) gopurs_runtime.Value {
return fiber_2_1
})
})), gopurs_runtime.Value{})
...
return completed_1
				...
				_ = orig
				return gopurs_runtime.RecordDict3("completed", "failed", "killed", orig.completed, orig.failed, orig.killed)
				}())
}
...
return Get_Control_Applicative_pure__2353832556()
}), gopurs_runtime.Func(func(v_2 gopurs_runtime.Value) gopurs_runtime.Value {
return Get_Control_Applicative_pure__2353832556()
...
return __local_var_1_0
				...
				_ = orig
				return gopurs_runtime.RecordDict3("completed", "failed", "killed", orig.completed, orig.failed, orig.killed)
				}(), Call_Control_Applicative_pure(gopurs_runtime.CoerceToStruct[Constructor_Control_Applicative_Applicative[gopurs_runtime.Value]](Get_Effect_Aff_applicativeAff())))
}

func Call_Effect_Aff_monoidParAff(dictMonoid_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictMonoid_0 gopurs_runtime.Value = dictMonoid_0_loop
_ = dictMonoid_0
// TAST (Let): semigroupParAff1_1_0 shape=App(Var) bindingType=(ADT ["Data","Semigroup","Semigroup"] [(ADT ["Effect","Aff","ParAff"] [(TypeVar a$scope28)])])
semigroupParAff1_1_0 := gopurs_runtime.CoerceToStruct[Constructor_Data_Semigroup_Semigroup[gopurs_runtime.Value]](Call_Effect_Aff_semigroupParAff(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonoid_0, "Semigroup0"), gopurs_runtime.Value{})))
...
}), gopurs_runtime.Apply3(Call_Control_Semigroupoid_compose(gopurs_runtime.CoerceToStruct[Constructor_Control_Semigroupoid_Semigroupoid[gopurs_runtime.Value]](Get_Control_Semigroupoid_semigroupoidFn())), Call_Control_Parallel_Class_parallel(gopurs_runtime.CoerceToStruct[Constructor_Control_Parallel_Class_Parallel[gopurs_runtime.Value, gopurs_runtime.Value]](Get_Effect_Aff_parallelAff())), Call_Control_Applicative_pure(gopurs_runtime.CoerceToStruct[Constructor_Control_Applicative_Applicative[gopurs_runtime.Value]](Get_Effect_Aff_applicativeAff())), gopurs_runtime.RecordGet(dictMonoid_0, "mempty"))}))}
}

func Call_Effect_Aff_semigroupAff(dictSemigroup_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictSemigroup_0 gopurs_runtime.Value = dictSemigroup_0_loop
_ = dictSemigroup_0
// TAST (Let): __local_var_1_0 shape=App(Var) bindingType=(Func [(TypeVar a$scope5), (TypeVar a$scope5)] (TypeVar a$scope5))
__local_var_1_0 := Call_Data_Semigroup_go__append(gopurs_runtime.CoerceToStruct[Constructor_Data_Semigroup_Semigroup[gopurs_runtime.Value]](dictSemigroup_0))
_ = __local_var_1_0
return gopurs_runtime.Value{Type: 9, IntVal: 2053112122, UnsafePtr: unsafe.Pointer((&Constructor_Data_Semigroup_Semigroup[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(a_2 gopurs_runtime.Value, b_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(Call_Control_Monad_ap(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Monad[gopurs_runtime.Value]](Get_Effect_Aff_monadAff())), gopurs_runtime.Apply2(Get_Effect_Aff__map(), __local_var_1_0, a_2), b_3)
})}))}
}
...
return gopurs_runtime.Apply2(gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor[gopurs_runtime.Value]](Get_Effect_functorEffect()).V0, Get_Effect_Aff_effectCanceler(), gopurs_runtime.Apply2(v_0.join, gopurs_runtime.Func(func(err_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
// TAST (Let): fiber_2_0 shape=LitRecord bindingType=(Record (Row [run: (ADT ["Effect","Effect"] [Unit]), kill: (Func [(ADT ["Effect","Exception","Error"] []), (Func [(ADT ["Effect","Exception","Error"] [])] (ADT ["Effect","Effect"] [Unit])), (Func [Unit] (ADT ["Effect","Effect"] [Unit]))] (ADT ["Effect","Effect"] [(ADT ["Effect","Effect"] [Unit])])), join: (Func [(Func [(ADT ["Effect","Exception","Error"] [])] (ADT ["Effect","Effect"] [Unit])), (Func [(TypeVar a$scope106)] (ADT ["Effect","Effect"] [Unit]))] (ADT ["Effect","Effect"] [(ADT ["Effect","Effect"] [Unit])])), onComplete: (Func [(TypeApp Any [(TypeVar a$scope106)])] (ADT ["Effect","Effect"] [(ADT ["Effect","Effect"] [Unit])])), isSuspended: (ADT ["Effect","Effect"] [Boolean])] Empty))
fiber_2_0 := struct{
	isSuspended gopurs_runtime.Value
	join gopurs_runtime.Value
	kill gopurs_runtime.Value
...
_ = fiber_2_0
return gopurs_runtime.Apply2(Call_Control_Bind_bind(gopurs_runtime.CoerceToStruct[Constructor_Control_Bind_Bind[gopurs_runtime.Value]](Get_Effect_Aff_bindAff())), gopurs_runtime.Apply(Get_Effect_Aff__liftEffect(), gopurs_runtime.Apply(Get_Effect_Aff__runFiber(), nf_1)), gopurs_runtime.Func(func(_dollar___unused_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
__t0 = gopurs_runtime.Apply(Call_Effect_Class_liftEffect(gopurs_runtime.CoerceToStruct[Constructor_Effect_Class_MonadEffect[gopurs_runtime.Value]](Get_Effect_Aff_monadEffectAff())), gopurs_runtime.Apply(Call_Data_Functor_void(gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor[gopurs_runtime.Value]](Get_Effect_functorEffect())), gopurs_runtime.Apply3(v_1.kill, e_0, gopurs_runtime.Func(func(v_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(_ gopurs_runtime.Value) gopurs_runtime.Value {
return Get_Data_Unit_unit()
})
...
{
__t0 = Call_Effect_Aff_makeAff__925755130(gopurs_runtime.Func(func(k_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor[gopurs_runtime.Value]](Get_Effect_functorEffect()).V0, Get_Effect_Aff_effectCanceler(), gopurs_runtime.Apply3(v_1.kill, e_0, gopurs_runtime.Func(func(err_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(k_3, func() gopurs_runtime.Value {
				_v := struct{V0 gopurs_runtime.Value; V1 gopurs_runtime.Value; V2 bool}{err_4, gopurs_runtime.Value{}, false}
				if _v.V2 {
					return gopurs_runtime.Value{Type: 9, IntVal: 2465973597, UnsafePtr: unsafe.Pointer(&Constructor_Data_Either_Right[gopurs_runtime.Value, gopurs_runtime.Value]{V0: _v.V1})}
				}
				return gopurs_runtime.Value{Type: 9, IntVal: 3711209382, UnsafePtr: unsafe.Pointer(&Constructor_Data_Either_Left[gopurs_runtime.Value, gopurs_runtime.Value]{V0: _v.V0})}
...
_ = sup_3_2
// TAST (Let): fiber_4_3 shape=LitRecord bindingType=(Record (Row [run: (ADT ["Effect","Effect"] [Unit]), kill: (Func [(ADT ["Effect","Exception","Error"] []), (Func [(ADT ["Effect","Exception","Error"] [])] (ADT ["Effect","Effect"] [Unit])), (Func [Unit] (ADT ["Effect","Effect"] [Unit]))] (ADT ["Effect","Effect"] [(ADT ["Effect","Effect"] [Unit])])), join: (Func [(Func [(ADT ["Effect","Exception","Error"] [])] (ADT ["Effect","Effect"] [Unit])), (Func [(TypeVar a$scope139)] (ADT ["Effect","Effect"] [Unit]))] (ADT ["Effect","Effect"] [(ADT ["Effect","Effect"] [Unit])])), onComplete: (Func [(TypeApp Any [(TypeVar a$scope139)])] (ADT ["Effect","Effect"] [(ADT ["Effect","Effect"] [Unit])])), isSuspended: (ADT ["Effect","Effect"] [Boolean])] Empty))
fiber_4_3 := struct{
	isSuspended gopurs_runtime.Value
	join gopurs_runtime.Value
	kill gopurs_runtime.Value
...
_ = fiber_4_3
return gopurs_runtime.Apply(gopurs_runtime.Apply2(Call_Control_Bind_bind(gopurs_runtime.CoerceToStruct[Constructor_Control_Bind_Bind[gopurs_runtime.Value]](Get_Effect_bindEffect())), fiber_4_3.run, gopurs_runtime.Func(func(_dollar___unused_5 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Func(func(_ gopurs_runtime.Value) gopurs_runtime.Value {
...
return Call_Effect_Aff_makeAff__925755130(gopurs_runtime.Func(func(k_4 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply4(Call_Control_Parallel_parTraverse_(gopurs_runtime.CoerceToStruct[Constructor_Control_Parallel_Class_Parallel[gopurs_runtime.Value, gopurs_runtime.Value]](Get_Effect_Aff_parallelAff())), gopurs_runtime.Value{Type: 9, IntVal: 1459134221, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Applicative_Applicative[gopurs_runtime.Value]](Get_Effect_Aff_applicativeParAff()))}, gopurs_runtime.Value{Type: 9, IntVal: 4280266298, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Foldable_Foldable[gopurs_runtime.Value]](Get_Data_Foldable_foldableArray()))}, Call_Control_Category_identity(gopurs_runtime.Value{Type: 9, IntVal: 784524589, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Category_Category[gopurs_runtime.Value]](Get_Control_Category_categoryFn()))}), gopurs_runtime.Array([]gopurs_runtime.Value{Call_Effect_Aff_killFiber(err_2, func() struct{
	isSuspended gopurs_runtime.Value
	join gopurs_runtime.Value
	kill gopurs_runtime.Value
	onComplete gopurs_runtime.Value
	...
	run gopurs_runtime.Value
					...
					clone.run = gopurs_runtime.RecordGet(orig, "run")
					return clone
				}()), Call_Effect_Aff_makeAff__925755130(gopurs_runtime.Func(func(k_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.UncurriedApp3(Get_Effect_Aff__killAll(), err_2, gopurs_runtime.RecordGet(sup_3, "supervisor"), gopurs_runtime.Apply(k_4, func() gopurs_runtime.Value {
				...
				_ = orig
				return gopurs_runtime.RecordDict3("completed", "failed", "killed", orig.completed, orig.failed, orig.killed)
				}(), gopurs_runtime.Apply2(Call_Control_Semigroupoid_compose(gopurs_runtime.CoerceToStruct[Constructor_Control_Semigroupoid_Semigroupoid[gopurs_runtime.Value]](Get_Control_Semigroupoid_semigroupoidFn())), Get_Effect_Aff_joinFiber(), gopurs_runtime.Func(func(v_2 gopurs_runtime.Value) gopurs_runtime.Value {
return func() gopurs_runtime.Value {
				orig := func() struct{
	isSuspended gopurs_runtime.Value
	join gopurs_runtime.Value
	...
	run gopurs_runtime.Value
					...
					orig := gopurs_runtime.RecordGet(v_2, "fiber")
					_ = orig
					clone := struct{
	isSuspended gopurs_runtime.Value
	join gopurs_runtime.Value
...
_ = aff_1
return Call_Effect_Aff_launchAff(gopurs_runtime.Apply2(Call_Control_Bind_bind(gopurs_runtime.CoerceToStruct[Constructor_Control_Bind_Bind[gopurs_runtime.Value]](Get_Effect_Aff_bindAff())), gopurs_runtime.Apply(Call_Control_Monad_Error_Class_try(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Error_Class_MonadError[gopurs_runtime.Value, gopurs_runtime.Value]](Get_Effect_Aff_monadErrorAff())), aff_1), gopurs_runtime.Apply2(Call_Control_Semigroupoid_compose(gopurs_runtime.CoerceToStruct[Constructor_Control_Semigroupoid_Semigroupoid[gopurs_runtime.Value]](Get_Control_Semigroupoid_semigroupoidFn())), Call_Effect_Class_liftEffect(gopurs_runtime.CoerceToStruct[Constructor_Effect_Class_MonadEffect[gopurs_runtime.Value]](Get_Effect_Aff_monadEffectAff())), k_0)))
}
...
var aff_1 gopurs_runtime.Value = aff_1_loop
_ = aff_1
return gopurs_runtime.Apply(Call_Data_Functor_void(gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor[gopurs_runtime.Value]](Get_Effect_functorEffect())), Call_Effect_Aff_runAff(k_0, aff_1))
}
...
var aff_1 gopurs_runtime.Value = aff_1_loop
_ = aff_1
return Call_Effect_Aff_launchSuspendedAff(gopurs_runtime.Apply2(Call_Control_Bind_bind(gopurs_runtime.CoerceToStruct[Constructor_Control_Bind_Bind[gopurs_runtime.Value]](Get_Effect_Aff_bindAff())), gopurs_runtime.Apply(Call_Control_Monad_Error_Class_try(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Error_Class_MonadError[gopurs_runtime.Value, gopurs_runtime.Value]](Get_Effect_Aff_monadErrorAff())), aff_1), gopurs_runtime.Apply2(Call_Control_Semigroupoid_compose(gopurs_runtime.CoerceToStruct[Constructor_Control_Semigroupoid_Semigroupoid[gopurs_runtime.Value]](Get_Control_Semigroupoid_semigroupoidFn())), Call_Effect_Class_liftEffect(gopurs_runtime.CoerceToStruct[Constructor_Effect_Class_MonadEffect[gopurs_runtime.Value]](Get_Effect_Aff_monadEffectAff())), k_0)))
}

func Call_Effect_Aff_monoidAff(dictMonoid_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictMonoid_0 gopurs_runtime.Value = dictMonoid_0_loop
_ = dictMonoid_0
// TAST (Let): semigroupAff1_1_0 shape=App(Var) bindingType=(ADT ["Data","Semigroup","Semigroup"] [(ADT ["Effect","Aff","Aff"] [(TypeVar a$scope32)])])
semigroupAff1_1_0 := gopurs_runtime.CoerceToStruct[Constructor_Data_Semigroup_Semigroup[gopurs_runtime.Value]](Call_Effect_Aff_semigroupAff(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonoid_0, "Semigroup0"), gopurs_runtime.Value{})))
_ = semigroupAff1_1_0
return gopurs_runtime.Value{Type: 9, IntVal: 1722653594, UnsafePtr: unsafe.Pointer((&Constructor_Data_Monoid_Monoid[gopurs_runtime.Value]{1, gopurs_runtime.Func(func(_dollar___unused_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Rebox_Effect_Aff_2812149806_179938118(in *Constructor_Data_Functor_Functor[gopurs_runtime.Value]) *Constructor_Data_Functor_Functor[struct{
	isSuspended gopurs_runtime.Value
	join gopurs_runtime.Value
	kill gopurs_runtime.Value
	onComplete gopurs_runtime.Value
	...
	if in == nil { return nil }
	out := &Constructor_Data_Functor_Functor[struct{
	isSuspended gopurs_runtime.Value
	join gopurs_runtime.Value
	kill gopurs_runtime.Value
	onComplete gopurs_runtime.Value
...
func Rebox_Effect_Aff_3741347833_1844969297(in *Constructor_Control_Apply_Apply[gopurs_runtime.Value]) *Constructor_Control_Apply_Apply[struct{
	isSuspended gopurs_runtime.Value
	join gopurs_runtime.Value
	kill gopurs_runtime.Value
	onComplete gopurs_runtime.Value
	...
	if in == nil { return nil }
	out := &Constructor_Control_Apply_Apply[struct{
	isSuspended gopurs_runtime.Value
	join gopurs_runtime.Value
	kill gopurs_runtime.Value
	onComplete gopurs_runtime.Value
