...
func Get_Data_Bifunctor_identity() gopurs_runtime.Value {
	once_Data_Bifunctor_identity.Do(func() {
		cache_Data_Bifunctor_identity = Call_Control_Category_identity(gopurs_runtime.Value{Type: 9, IntVal: 784524589, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Category_Category[gopurs_runtime.Value]](Get_Control_Category_categoryFn()))})
	})
...
func Get_Data_Bifunctor_identity1() gopurs_runtime.Value {
	once_Data_Bifunctor_identity1.Do(func() {
		cache_Data_Bifunctor_identity1 = Call_Control_Category_identity(gopurs_runtime.Value{Type: 9, IntVal: 784524589, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Category_Category[gopurs_runtime.Value]](Get_Control_Category_categoryFn()))})
	})
...
return gopurs_runtime.CoerceToStruct[Constructor_Data_Bifunctor_Bifunctor[gopurs_runtime.Value]](func() gopurs_runtime.Value {
				orig := x_0
				_ = orig
				return gopurs_runtime.RecordDict1("bimap", orig.bimap)
				}())
}
...
_ = f_1
return gopurs_runtime.Apply2(dictBifunctor_0.V0, f_1, Call_Control_Category_identity(gopurs_runtime.Value{Type: 9, IntVal: 784524589, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Category_Category[gopurs_runtime.Value]](Get_Control_Category_categoryFn()))}))
}
...
var dictBifunctor_0 *Constructor_Data_Bifunctor_Bifunctor[gopurs_runtime.Value] = dictBifunctor_0_loop
_ = dictBifunctor_0
return gopurs_runtime.Apply(dictBifunctor_0.V0, Call_Control_Category_identity(gopurs_runtime.Value{Type: 9, IntVal: 784524589, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Category_Category[gopurs_runtime.Value]](Get_Control_Category_categoryFn()))}))
}
