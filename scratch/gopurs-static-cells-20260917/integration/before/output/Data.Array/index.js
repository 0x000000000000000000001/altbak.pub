...
var nubBy = function (comp) {
    return function (xs) {
                ...
                Control_Monad_ST_Internal.foreach(indexedAndSorted)(function (v1) {
                    return function __do() {
                        var lst = Data_Functor.map(Control_Monad_ST_Internal.functorST)((function () {
                            var $135 = function ($137) {
                                return fromJust(last($137));
                            };
                            return function ($136) {
                                return Data_Tuple.snd($135($136));
                            };
        ...
        throw new Error("Failed pattern match at Data.Array (line 1108, column 17 - line 1116, column 28): " + [ v.constructor.name ]);
    };
};
            ...
            return function (array) {
                var go = function (res) {
                    return function (i) {
                        ...
                        throw new Error("Failed pattern match at Data.Array (line 1342, column 3 - line 1346, column 42): " + [ res.constructor.name, i.constructor.name ]);
                    };
                };
...
var span = function (p) {
    return function (arr) {
        var breakIndex = findIndex(function (x) {
            return !p(x);
        })(arr);
...
var mapMaybe = function (f) {
    return concatMap((function () {
        var $141 = Data_Maybe.maybe([  ])(singleton);
        return function ($142) {
            return $141(f($142));
        };
    })());
...
var filterA = function (dictApplicative) {
    ...
    return function (p) {
        var $143 = Data_Functor.map(Functor0)(mapMaybe(function (v) {
            if (v.value1) {
                return new Data_Maybe.Just(v.value0);
            };
            return Data_Maybe.Nothing.value;
        }));
        var $144 = Data_Traversable.traverse(Data_Traversable.traversableArray)(dictApplicative)(function (x) {
