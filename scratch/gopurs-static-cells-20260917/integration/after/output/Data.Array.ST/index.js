...
var sortBy = function (comp) {
    return Control_Monad_ST_Uncurried.runSTFn3($foreign.sortByImpl)(comp)(function (v) {
        ...
        throw new Error("Failed pattern match at Data.Array.ST (line 132, column 40 - line 135, column 11): " + [ v.constructor.name ]);
    });
};
    ...
    return function (f) {
        return function (xs) {
            return function __do() {
                ...
                throw new Error("Failed pattern match at Data.Array.ST (line 237, column 3 - line 239, column 26): " + [ entry.constructor.name ]);
            };
        };
    };
};
