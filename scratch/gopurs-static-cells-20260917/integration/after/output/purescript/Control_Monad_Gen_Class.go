...
var cache_Control_Monad_Gen_Class_chooseInt__2590203465 gopurs_runtime.Value
var once_Control_Monad_Gen_Class_chooseInt__2590203465 sync.Once
func Get_Control_Monad_Gen_Class_chooseInt__2590203465() gopurs_runtime.Value {
	once_Control_Monad_Gen_Class_chooseInt__2590203465.Do(func() {
		cache_Control_Monad_Gen_Class_chooseInt__2590203465 = gopurs_runtime.Func3(func(dict_0_box gopurs_runtime.Value, __eta_norm_1_1_box gopurs_runtime.Value, __eta_norm_0_2_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_Control_Monad_Gen_Class_chooseInt__2590203465(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Gen_Class_MonadGen[gopurs_runtime.Value]](dict_0_box), __eta_norm_1_1_box.IntVal, __eta_norm_0_2_box.IntVal)
})
	})
	return cache_Control_Monad_Gen_Class_chooseInt__2590203465
}
...
func Call_Control_Monad_Gen_Class_chooseInt__2590203465(dict_0_loop *Constructor_Control_Monad_Gen_Class_MonadGen[gopurs_runtime.Value], __eta_norm_1_1_loop int64, __eta_norm_0_2_loop int64) gopurs_runtime.Value {
chooseInt__2590203465:
for {
if false { continue chooseInt__2590203465 }
var dict_0 *Constructor_Control_Monad_Gen_Class_MonadGen[gopurs_runtime.Value] = dict_0_loop
_ = dict_0
...
_ = __eta_norm_0_2
return gopurs_runtime.Apply2(dict_0.V3, gopurs_runtime.Int(__eta_norm_1_1), gopurs_runtime.Int(__eta_norm_0_2))
}
}
