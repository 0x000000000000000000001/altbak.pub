...
var cache_Effect_Class_liftEffect__1233744552 gopurs_runtime.Value
var once_Effect_Class_liftEffect__1233744552 sync.Once
func Get_Effect_Class_liftEffect__1233744552() gopurs_runtime.Value {
	once_Effect_Class_liftEffect__1233744552.Do(func() {
		cache_Effect_Class_liftEffect__1233744552 = gopurs_runtime.Func(func(__eta_norm_0_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_Effect_Class_liftEffect__1233744552(__eta_norm_0_0_box)
})
	})
	return cache_Effect_Class_liftEffect__1233744552
}

var cache_Effect_Class_liftEffect__2663467359 gopurs_runtime.Value
var once_Effect_Class_liftEffect__2663467359 sync.Once
func Get_Effect_Class_liftEffect__2663467359() gopurs_runtime.Value {
	once_Effect_Class_liftEffect__2663467359.Do(func() {
		cache_Effect_Class_liftEffect__2663467359 = gopurs_runtime.Func(func(__eta_norm_0_unused_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_Effect_Class_liftEffect__2663467359(__eta_norm_0_unused_0_box)
})
	})
	return cache_Effect_Class_liftEffect__2663467359
}

var cache_Effect_Class_liftEffect__1041908680 gopurs_runtime.Value
var once_Effect_Class_liftEffect__1041908680 sync.Once
func Get_Effect_Class_liftEffect__1041908680() gopurs_runtime.Value {
	once_Effect_Class_liftEffect__1041908680.Do(func() {
		cache_Effect_Class_liftEffect__1041908680 = gopurs_runtime.Func(func(__eta_norm_0_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_Effect_Class_liftEffect__1041908680(__eta_norm_0_0_box)
})
	})
	return cache_Effect_Class_liftEffect__1041908680
}
...
func Call_Effect_Class_liftEffect__1233744552(__eta_norm_0_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
liftEffect__1233744552:
for {
if false { continue liftEffect__1233744552 }
var __eta_norm_0_0 gopurs_runtime.Value = __eta_norm_0_0_loop
_ = __eta_norm_0_0
return gopurs_runtime.Apply(gopurs_runtime.CoerceToStruct[Constructor_Effect_Class_MonadEffect[gopurs_runtime.Value]](Get_Effect_Aff_monadEffectAff()).V1, __eta_norm_0_0)
}
}

func Call_Effect_Class_liftEffect__2663467359(__eta_norm_0_unused_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
liftEffect__2663467359:
for {
if false { continue liftEffect__2663467359 }
var __eta_norm_0_unused_0 gopurs_runtime.Value = __eta_norm_0_unused_0_loop
_ = __eta_norm_0_unused_0
return gopurs_runtime.Apply(gopurs_runtime.CoerceToStruct[Constructor_Effect_Class_MonadEffect[gopurs_runtime.Value]](Get_Effect_Aff_monadEffectAff()).V1, Get_Bench_benchNow())
}
}

func Call_Effect_Class_liftEffect__1041908680(__eta_norm_0_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
liftEffect__1041908680:
for {
if false { continue liftEffect__1041908680 }
var __eta_norm_0_0 gopurs_runtime.Value = __eta_norm_0_0_loop
_ = __eta_norm_0_0
return gopurs_runtime.Apply(gopurs_runtime.CoerceToStruct[Constructor_Effect_Class_MonadEffect[gopurs_runtime.Value]](Get_Effect_Aff_monadEffectAff()).V1, __eta_norm_0_0)
}
