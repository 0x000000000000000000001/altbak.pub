...
_ = __local_var_1_1
return gopurs_runtime.Str(gopurs_runtime.Apply(Get_Data_Show_showIntImpl(), gopurs_runtime.Int(Call_Test_TCO_deepTailRec(__local_var_1_1.IntVal, int64(0)))).StrVal())
})
	})
...
v1_1_loop = (v1_1) + (gopurs_runtime.IntMod(v_0, int64(3)))
