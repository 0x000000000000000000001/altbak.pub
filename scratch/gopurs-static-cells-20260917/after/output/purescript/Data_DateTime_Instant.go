...
func Get_Data_DateTime_Instant_bottom() gopurs_runtime.Value {
	once_Data_DateTime_Instant_bottom.Do(func() {
		cache_Data_DateTime_Instant_bottom = gopurs_runtime.Int(Call_Data_Bounded_bottom(gopurs_runtime.Value{Type: 9, IntVal: 3510799738, UnsafePtr: unsafe.Pointer(Rebox_Data_DateTime_Instant_3764732725_2094947566(Rebox_Data_DateTime_Instant_2094947566_3764732725(gopurs_runtime.CoerceToStruct[Constructor_Data_Bounded_Bounded[gopurs_runtime.Value]](Get_Data_Time_Component_boundedHour()))))}).IntVal)
	})
...
func Get_Data_DateTime_Instant_bottom1() gopurs_runtime.Value {
	once_Data_DateTime_Instant_bottom1.Do(func() {
		cache_Data_DateTime_Instant_bottom1 = gopurs_runtime.Int(Call_Data_Bounded_bottom(gopurs_runtime.Value{Type: 9, IntVal: 3510799738, UnsafePtr: unsafe.Pointer(Rebox_Data_DateTime_Instant_3764732725_2094947566(Rebox_Data_DateTime_Instant_2094947566_3764732725(gopurs_runtime.CoerceToStruct[Constructor_Data_Bounded_Bounded[gopurs_runtime.Value]](Get_Data_Time_Component_boundedMinute()))))}).IntVal)
	})
...
func Get_Data_DateTime_Instant_bottom2() gopurs_runtime.Value {
	once_Data_DateTime_Instant_bottom2.Do(func() {
		cache_Data_DateTime_Instant_bottom2 = gopurs_runtime.Int(Call_Data_Bounded_bottom(gopurs_runtime.Value{Type: 9, IntVal: 3510799738, UnsafePtr: unsafe.Pointer(Rebox_Data_DateTime_Instant_3764732725_2094947566(Rebox_Data_DateTime_Instant_2094947566_3764732725(gopurs_runtime.CoerceToStruct[Constructor_Data_Bounded_Bounded[gopurs_runtime.Value]](Get_Data_Time_Component_boundedSecond()))))}).IntVal)
	})
...
func Get_Data_DateTime_Instant_bottom3() gopurs_runtime.Value {
	once_Data_DateTime_Instant_bottom3.Do(func() {
		cache_Data_DateTime_Instant_bottom3 = gopurs_runtime.Int(Call_Data_Bounded_bottom(gopurs_runtime.Value{Type: 9, IntVal: 3510799738, UnsafePtr: unsafe.Pointer(Rebox_Data_DateTime_Instant_3764732725_2094947566(Rebox_Data_DateTime_Instant_2094947566_3764732725(gopurs_runtime.CoerceToStruct[Constructor_Data_Bounded_Bounded[gopurs_runtime.Value]](Get_Data_Time_Component_boundedMillisecond()))))}).IntVal)
	})
...
end_branch_0:
return gopurs_runtime.Value{Type: 9, IntVal: 1665554298, UnsafePtr: unsafe.Pointer((&Constructor_Data_DateTime_DateTime{1, Call_Data_Date_canonicalDate(y_0.IntVal, __t0, d_2.IntVal), (&Constructor_Data_Time_Time{1, h_3.IntVal, mi_4.IntVal, s_5.IntVal, ms_6.IntVal})}))}
})
}))
	})
...
return gopurs_runtime.Str((("(Instant (Milliseconds ") + (gopurs_runtime.Apply(Get_Data_Show_showNumberImpl(), gopurs_runtime.Float(v_0.FloatVal())).StrVal())) + ("))"))
})})))}
	})
...
func Get_Data_DateTime_Instant_ordDateTime() gopurs_runtime.Value {
	once_Data_DateTime_Instant_ordDateTime.Do(func() {
		cache_Data_DateTime_Instant_ordDateTime = gopurs_runtime.Value{Type: 9, IntVal: 1435789946, UnsafePtr: unsafe.Pointer(Rebox_Data_DateTime_Instant_3047586294_4177771502(Rebox_Data_DateTime_Instant_4177771502_3047586294(gopurs_runtime.CoerceToStruct[Constructor_Data_Ord_Ord[gopurs_runtime.Value]](Get_Data_Ord_ordNumber()))))}
	})
...
func Get_Data_DateTime_Instant_eqDateTime() gopurs_runtime.Value {
	once_Data_DateTime_Instant_eqDateTime.Do(func() {
		cache_Data_DateTime_Instant_eqDateTime = gopurs_runtime.Value{Type: 9, IntVal: 1012063514, UnsafePtr: unsafe.Pointer(Rebox_Data_DateTime_Instant_687527510_3790796878(Rebox_Data_DateTime_Instant_3790796878_687527510(gopurs_runtime.CoerceToStruct[Constructor_Data_Eq_Eq[gopurs_runtime.Value]](Get_Data_Eq_eqNumber()))))}
	})
...
return gopurs_runtime.Value{Type: 9, IntVal: 1435789946, UnsafePtr: unsafe.Pointer(Rebox_Data_DateTime_Instant_3047586294_4177771502(Rebox_Data_DateTime_Instant_4177771502_3047586294(gopurs_runtime.CoerceToStruct[Constructor_Data_Ord_Ord[gopurs_runtime.Value]](Get_Data_Ord_ordNumber()))))}
...
var v_0 float64 = v_0_loop
_ = v_0
var __t3 *Constructor_Data_Maybe_Just[float64]
{
...
if __t_and_2 {
__t3 = Rebox_Data_DateTime_Instant_3094389156_3240988860(gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just[gopurs_runtime.Value]](func() gopurs_runtime.Value {
				_v := struct{V0 gopurs_runtime.Value; V1 bool}{gopurs_runtime.Float(v_0), true}
				if _v.V1 {
					return gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&Constructor_Data_Maybe_Just[gopurs_runtime.Value]{Rc: 1, V0: _v.V0})}
				}
				return gopurs_runtime.Value{Type: 9, IntVal: 930809136}
...
return func() struct{V0 gopurs_runtime.Value; V1 bool} {
				_v := gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Rebox_Data_DateTime_Instant_3240988860_3094389156(__t3))}
...
end_branch_12:
return gopurs_runtime.UncurriedApp7(Get_Data_DateTime_Instant_fromDateTimeImpl(), gopurs_runtime.Int((d_0).V0), gopurs_runtime.Int(__t12), gopurs_runtime.Int((d_0).V2), gopurs_runtime.Int(Call_Data_Bounded_bottom(gopurs_runtime.Value{Type: 9, IntVal: 3510799738, UnsafePtr: unsafe.Pointer(Rebox_Data_DateTime_Instant_3764732725_2094947566(Rebox_Data_DateTime_Instant_2094947566_3764732725(gopurs_runtime.CoerceToStruct[Constructor_Data_Bounded_Bounded[gopurs_runtime.Value]](Get_Data_Time_Component_boundedHour()))))}).IntVal), gopurs_runtime.Int(Call_Data_Bounded_bottom(gopurs_runtime.Value{Type: 9, IntVal: 3510799738, UnsafePtr: unsafe.Pointer(Rebox_Data_DateTime_Instant_3764732725_2094947566(Rebox_Data_DateTime_Instant_2094947566_3764732725(gopurs_runtime.CoerceToStruct[Constructor_Data_Bounded_Bounded[gopurs_runtime.Value]](Get_Data_Time_Component_boundedMinute()))))}).IntVal), gopurs_runtime.Int(Call_Data_Bounded_bottom(gopurs_runtime.Value{Type: 9, IntVal: 3510799738, UnsafePtr: unsafe.Pointer(Rebox_Data_DateTime_Instant_3764732725_2094947566(Rebox_Data_DateTime_Instant_2094947566_3764732725(gopurs_runtime.CoerceToStruct[Constructor_Data_Bounded_Bounded[gopurs_runtime.Value]](Get_Data_Time_Component_boundedSecond()))))}).IntVal), gopurs_runtime.Int(Call_Data_Bounded_bottom(gopurs_runtime.Value{Type: 9, IntVal: 3510799738, UnsafePtr: unsafe.Pointer(Rebox_Data_DateTime_Instant_3764732725_2094947566(Rebox_Data_DateTime_Instant_2094947566_3764732725(gopurs_runtime.CoerceToStruct[Constructor_Data_Bounded_Bounded[gopurs_runtime.Value]](Get_Data_Time_Component_boundedMillisecond()))))}).IntVal)).FloatVal()
}
...
_ = dt2_2
return gopurs_runtime.Apply(dictDuration_0.V1, gopurs_runtime.Float((dt1_1) + (Call_Data_Time_Duration_negateDuration__2130721996(dt2_2))))
}

func Rebox_Data_DateTime_Instant_2094947566_3764732725(in *Constructor_Data_Bounded_Bounded[gopurs_runtime.Value]) *Constructor_Data_Bounded_Bounded[int64] {
...
func Rebox_Data_DateTime_Instant_3764732725_2094947566(in *Constructor_Data_Bounded_Bounded[int64]) *Constructor_Data_Bounded_Bounded[gopurs_runtime.Value] {
	if in == nil { return nil }
...
func Rebox_Data_DateTime_Instant_3790796878_687527510(in *Constructor_Data_Eq_Eq[gopurs_runtime.Value]) *Constructor_Data_Eq_Eq[float64] {
	if in == nil { return nil }
...
func Rebox_Data_DateTime_Instant_4177771502_3047586294(in *Constructor_Data_Ord_Ord[gopurs_runtime.Value]) *Constructor_Data_Ord_Ord[float64] {
	if in == nil { return nil }
