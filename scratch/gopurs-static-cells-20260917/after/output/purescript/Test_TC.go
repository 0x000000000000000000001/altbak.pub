...
var cache_Test_TC_MyClass_dollar_Dict__2378374882 gopurs_runtime.Value
var once_Test_TC_MyClass_dollar_Dict__2378374882 sync.Once
func Get_Test_TC_MyClass_dollar_Dict__2378374882() gopurs_runtime.Value {
	once_Test_TC_MyClass_dollar_Dict__2378374882.Do(func() {
		cache_Test_TC_MyClass_dollar_Dict__2378374882 = gopurs_runtime.Func(func(x_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 1432427153, UnsafePtr: unsafe.Pointer(Rebox_Test_TC_173323230_3370946277(Call_Test_TC_MyClass_dollar_Dict__2378374882(func() struct{
	myMethod gopurs_runtime.Value
} {
					orig := x_0_box
					_ = orig
	...
	return cache_Test_TC_MyClass_dollar_Dict__2378374882
}
...
var cache_Test_TC_myMethod__2222584839 gopurs_runtime.Value
var once_Test_TC_myMethod__2222584839 sync.Once
func Get_Test_TC_myMethod__2222584839() gopurs_runtime.Value {
	once_Test_TC_myMethod__2222584839.Do(func() {
		cache_Test_TC_myMethod__2222584839 = gopurs_runtime.Func(func(__eta_norm_0_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Str(Call_Test_TC_myMethod__2222584839(__eta_norm_0_0_box.IntVal))
})
	})
	return cache_Test_TC_myMethod__2222584839
}
...
func init() {
	gopurs_runtime.StructGetters[1432427153] = func(ptr unsafe.Pointer, key string) gopurs_runtime.Value {
		c := (*Constructor_Test_TC_MyClass[gopurs_runtime.Value])(ptr)
		_ = c
		switch key {
...
func Call_Test_TC_MyClass_dollar_Dict__2378374882(x_0_loop struct{
	myMethod gopurs_runtime.Value
}) *Constructor_Test_TC_MyClass[int64] {
MyClass_dollar_Dict__2378374882:
for {
if false { continue MyClass_dollar_Dict__2378374882 }
var x_0 struct{
	myMethod gopurs_runtime.Value
} = x_0_loop
_ = x_0
return gopurs_runtime.CoerceToStruct[Constructor_Test_TC_MyClass[int64]](func() gopurs_runtime.Value {
				orig := x_0
				_ = orig
				return gopurs_runtime.RecordDict1("myMethod", orig.myMethod)
				}())
...
func Call_Test_TC_myMethod__2222584839(__eta_norm_0_0_loop int64) string {
myMethod__2222584839:
for {
if false { continue myMethod__2222584839 }
