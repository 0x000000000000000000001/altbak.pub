...
annotation (NeutralExpr syntax) = case syntax of
  ...
  UsageMeta _ inner -> annotation inner
  _ -> Nothing
...
scalar env expr@(NeutralExpr syntax) = case syntax of
  ...
  UsageMeta _ inner -> scalar env inner
...
checkedProjection env (NeutralExpr syntax) = case syntax of
  ...
  UsageMeta _ inner -> checkedProjection env inner
...
prefixes env prefix (NeutralExpr (UsageMeta _ inner)) = prefixes env prefix inner
...
recordOutputs env path ty (NeutralExpr (UsageMeta _ inner)) = recordOutputs env path ty inner
