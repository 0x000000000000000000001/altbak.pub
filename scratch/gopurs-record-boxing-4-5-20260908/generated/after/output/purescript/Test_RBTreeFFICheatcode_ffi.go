...
func Test_RBTreeFFICheatcode_RunRBTreeFFICheatcode(limit int) int {
...
var _Gopurs_Test_RBTreeFFICheatcode_RunRBTreeFFICheatcode = // TAST: (Func [Int] Int)
gopurs_runtime.Func(func(arg0 gopurs_runtime.Value) gopurs_runtime.Value {
	go_arg0 := gopurs_runtime.Unbox[int](arg0)
	go_res := Test_RBTreeFFICheatcode_RunRBTreeFFICheatcode(go_arg0)
