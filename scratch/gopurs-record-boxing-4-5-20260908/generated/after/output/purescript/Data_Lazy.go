...
return gopurs_runtime.Apply(Get_Data_Lazy_go__defer(), gopurs_runtime.Func(func(v_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(f_0, Get_Data_Unit_unit(), gopurs_runtime.Apply(Get_Data_Lazy_force(), l_1))
}))
})}))}
	})
...
func Get_Data_Lazy_invariantLazy() gopurs_runtime.Value {
	once_Data_Lazy_invariantLazy.Do(func() {
		cache_Data_Lazy_invariantLazy = gopurs_runtime.Value{Type: 9, IntVal: 2396985522, UnsafePtr: unsafe.Pointer((&Constructor_Data_Functor_Invariant_Invariant[gopurs_runtime.Value]{1, gopurs_runtime.Func3(func(f_0 gopurs_runtime.Value, v_1 gopurs_runtime.Value, l_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
return Call_Data_Lazy_foldMap(gopurs_runtime.CoerceToStruct[Constructor_Data_Monoid_Monoid[gopurs_runtime.Value]](dictMonoid_0_box), f_1_box, l_2_box)
})
	})
...
return gopurs_runtime.Apply2(f_1, Get_Data_Unit_unit(), gopurs_runtime.Apply(Get_Data_Lazy_force(), l_2))
}), gopurs_runtime.Func3(func(f_0 gopurs_runtime.Value, z_1 gopurs_runtime.Value, l_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply3(f_0, Get_Data_Unit_unit(), z_1, gopurs_runtime.Apply(Get_Data_Lazy_force(), l_2))
}), gopurs_runtime.Func3(func(f_0 gopurs_runtime.Value, z_1 gopurs_runtime.Value, l_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply3(f_0, Get_Data_Unit_unit(), gopurs_runtime.Apply(Get_Data_Lazy_force(), l_2), z_1)
})}))}
	})
...
return Call_Data_Lazy_traverse(gopurs_runtime.CoerceToStruct[Constructor_Control_Applicative_Applicative[gopurs_runtime.Value]](dictApplicative_0_box))
})
	})
...
Functor0_1_1 := gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor[gopurs_runtime.Value]](gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictApplicative_0, "Apply0"), gopurs_runtime.Value{}), "Functor0"), gopurs_runtime.Value{}))
_ = Functor0_1_1
// TAST (Let): traverse1_1_0 shape=Let(Abs(Abs(App(Other)))) bindingType=(Func [(Func [(TypeVar a)] (TypeApp (TypeVar m) [(TypeVar b)])), (ADT ["Data","Lazy","Lazy"] [(TypeVar a)])] (TypeApp (TypeVar m) [(ADT ["Data","Lazy","Lazy"] [(TypeVar b)])]))
traverse1_1_0 := gopurs_runtime.Func2(func(f_2 gopurs_runtime.Value, l_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.Box(Functor0_1_1.V0), gopurs_runtime.Func(func(x_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(Get_Data_Lazy_go__defer(), gopurs_runtime.Func(func(v_5 gopurs_runtime.Value) gopurs_runtime.Value {
return x_4
}))
...
func Get_Data_Lazy_eq1Lazy() gopurs_runtime.Value {
	once_Data_Lazy_eq1Lazy.Do(func() {
		cache_Data_Lazy_eq1Lazy = gopurs_runtime.Value{Type: 9, IntVal: 1715248107, UnsafePtr: unsafe.Pointer((&Constructor_Data_Eq_Eq1[gopurs_runtime.Value]{1, gopurs_runtime.Func3(func(dictEq_0 gopurs_runtime.Value, x_1 gopurs_runtime.Value, y_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = __local_var_1_1
// TAST (Let): semiringLazy1_1_0 shape=Let(LitRecord) bindingType=(ADT ["Data","Semiring","Semiring"] [(ADT ["Data","Lazy","Lazy"] [(TypeVar a)])])
semiringLazy1_1_0 := (&Constructor_Data_Semiring_Semiring[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(a_2 gopurs_runtime.Value, b_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(Get_Data_Lazy_go__defer(), gopurs_runtime.Func(func(v_4 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = __local_var_1_1
// TAST (Let): semigroupLazy1_1_0 shape=Let(LitRecord) bindingType=(ADT ["Data","Semigroup","Semigroup"] [(ADT ["Data","Lazy","Lazy"] [(TypeVar a)])])
semigroupLazy1_1_0 := (&Constructor_Data_Semigroup_Semigroup[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(a_2 gopurs_runtime.Value, b_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(Get_Data_Lazy_go__defer(), gopurs_runtime.Func(func(v_4 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_Data_Lazy_foldMap(dictMonoid_0_loop *Constructor_Data_Monoid_Monoid[gopurs_runtime.Value], f_1_loop gopurs_runtime.Value, l_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_Data_Lazy_traverse(dictApplicative_0_loop *Constructor_Control_Applicative_Applicative[gopurs_runtime.Value]) gopurs_runtime.Value {
...
_ = __local_var_1_1
// TAST (Let): eqLazy1_1_0 shape=Let(LitRecord) bindingType=(ADT ["Data","Eq","Eq"] [(ADT ["Data","Lazy","Lazy"] [(TypeVar a)])])
eqLazy1_1_0 := (&Constructor_Data_Eq_Eq[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(x_2 gopurs_runtime.Value, y_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = __local_var_2_3
// TAST (Let): semiringLazy1_2_2 shape=Let(LitRecord) bindingType=(ADT ["Data","Semiring","Semiring"] [(ADT ["Data","Lazy","Lazy"] [(TypeVar a)])])
semiringLazy1_2_2 := (&Constructor_Data_Semiring_Semiring[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(a_3 gopurs_runtime.Value, b_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(Get_Data_Lazy_go__defer(), gopurs_runtime.Func(func(v_5 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = semiringLazy1_2_2
// TAST (Let): ringLazy1_1_0 shape=Let(Let(LitRecord)) bindingType=(ADT ["Data","Ring","Ring"] [(ADT ["Data","Lazy","Lazy"] [(TypeVar a)])])
ringLazy1_1_0 := (&Constructor_Data_Ring_Ring[gopurs_runtime.Value]{1, gopurs_runtime.Func(func(_dollar___unused_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = __local_var_2_4
// TAST (Let): semiringLazy1_2_3 shape=Let(LitRecord) bindingType=(ADT ["Data","Semiring","Semiring"] [(ADT ["Data","Lazy","Lazy"] [(TypeVar a)])])
semiringLazy1_2_3 := (&Constructor_Data_Semiring_Semiring[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(a_3 gopurs_runtime.Value, b_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply(Get_Data_Lazy_go__defer(), gopurs_runtime.Func(func(v_5 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = semiringLazy1_2_3
// TAST (Let): ringLazy1_1_1 shape=Let(Let(LitRecord)) bindingType=(ADT ["Data","Ring","Ring"] [(ADT ["Data","Lazy","Lazy"] [(TypeVar a)])])
ringLazy1_1_1 := (&Constructor_Data_Ring_Ring[gopurs_runtime.Value]{1, gopurs_runtime.Func(func(_dollar___unused_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = ringLazy1_1_1
// TAST (Let): commutativeRingLazy1_1_0 shape=Let(LitRecord) bindingType=(ADT ["Data","CommutativeRing","CommutativeRing"] [(ADT ["Data","Lazy","Lazy"] [(TypeVar a)])])
commutativeRingLazy1_1_0 := (&Constructor_Data_CommutativeRing_CommutativeRing[gopurs_runtime.Value]{1, gopurs_runtime.Func(func(_dollar___unused_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = __local_var_2_3
// TAST (Let): eqLazy1_2_2 shape=Let(LitRecord) bindingType=(ADT ["Data","Eq","Eq"] [(ADT ["Data","Lazy","Lazy"] [(TypeVar a)])])
eqLazy1_2_2 := (&Constructor_Data_Eq_Eq[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(x_3 gopurs_runtime.Value, y_4 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = eqLazy1_2_2
// TAST (Let): ordLazy1_1_0 shape=Let(Let(LitRecord)) bindingType=(ADT ["Data","Ord","Ord"] [(ADT ["Data","Lazy","Lazy"] [(TypeVar a)])])
ordLazy1_1_0 := (&Constructor_Data_Ord_Ord[gopurs_runtime.Value]{1, gopurs_runtime.Func(func(_dollar___unused_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Value{Type: 9, IntVal: 926771738, UnsafePtr: unsafe.Pointer((&Constructor_Data_HeytingAlgebra_HeytingAlgebra[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(a_1 gopurs_runtime.Value, b_2 gopurs_runtime.Value) gopurs_runtime.Value {
// TAST (Let): __local_var_3_0 shape=App(Var) bindingType=(ADT ["Data","Lazy","Lazy"] [(Func [(TypeVar a)] (TypeVar a))])
...
// TAST (Let): __local_var_3_1 shape=App(Var) bindingType=(ADT ["Data","Lazy","Lazy"] [(Func [(TypeVar a)] (TypeVar a))])
...
// TAST (Let): __local_var_3_2 shape=App(Var) bindingType=(ADT ["Data","Lazy","Lazy"] [(Func [(TypeVar a)] (TypeVar a))])
...
_ = __local_var_1_1
// TAST (Let): heytingAlgebraLazy1_1_0 shape=Let(LitRecord) bindingType=(ADT ["Data","HeytingAlgebra","HeytingAlgebra"] [(ADT ["Data","Lazy","Lazy"] [(TypeVar a)])])
heytingAlgebraLazy1_1_0 := (&Constructor_Data_HeytingAlgebra_HeytingAlgebra[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(a_2 gopurs_runtime.Value, b_3 gopurs_runtime.Value) gopurs_runtime.Value {
// TAST (Let): __local_var_4_2 shape=App(Var) bindingType=(ADT ["Data","Lazy","Lazy"] [(Func [(TypeVar a)] (TypeVar a))])
...
// TAST (Let): __local_var_4_3 shape=App(Var) bindingType=(ADT ["Data","Lazy","Lazy"] [(Func [(TypeVar a)] (TypeVar a))])
...
// TAST (Let): __local_var_4_4 shape=App(Var) bindingType=(ADT ["Data","Lazy","Lazy"] [(Func [(TypeVar a)] (TypeVar a))])
