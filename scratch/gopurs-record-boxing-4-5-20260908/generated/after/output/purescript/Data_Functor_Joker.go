...
var dictFunctor_0 gopurs_runtime.Value = dictFunctor_0_loop
_ = dictFunctor_0
// TAST (Let): profunctorJoker1_1_0 shape=LitRecord bindingType=(ADT ["Data","Profunctor","Profunctor"] [(TypeApp (TypeVar f) [(TypeVar b)])])
profunctorJoker1_1_0 := (&Constructor_Data_Profunctor_Profunctor[gopurs_runtime.Value]{1, gopurs_runtime.Func3(func(v_1 gopurs_runtime.Value, g_2 gopurs_runtime.Value, v1_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictFunctor_0, "map"), g_2, v1_3)
})})
...
_ = __local_var_1_1
// TAST (Let): bifunctorJoker1_1_0 shape=Let(LitRecord) bindingType=(ADT ["Data","Bifunctor","Bifunctor"] [(TypeApp (TypeVar g) [(TypeVar b)])])
bifunctorJoker1_1_0 := (&Constructor_Data_Bifunctor_Bifunctor[gopurs_runtime.Value]{1, gopurs_runtime.Func3(func(v_2 gopurs_runtime.Value, g_3 gopurs_runtime.Value, v1_4 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = __local_var_2_3
// TAST (Let): bifunctorJoker1_2_2 shape=Let(LitRecord) bindingType=(ADT ["Data","Bifunctor","Bifunctor"] [(TypeApp (TypeVar g) [(TypeVar b)])])
bifunctorJoker1_2_2 := (&Constructor_Data_Bifunctor_Bifunctor[gopurs_runtime.Value]{1, gopurs_runtime.Func3(func(v_3 gopurs_runtime.Value, g_4 gopurs_runtime.Value, v1_5 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_2_3, "map"), g_4, v1_5)
})})
_ = bifunctorJoker1_2_2
// TAST (Let): biapplyJoker1_1_0 shape=Let(Let(LitRecord)) bindingType=(ADT ["Control","Biapply","Biapply"] [(TypeApp (TypeVar g) [(TypeVar b)])])
biapplyJoker1_1_0 := (&Constructor_Control_Biapply_Biapply[gopurs_runtime.Value]{1, gopurs_runtime.Func(func(_dollar___unused_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 4141114362, UnsafePtr: unsafe.Pointer(bifunctorJoker1_2_2)}
...
__local_var_1_1 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictApply_0, "Functor0"), gopurs_runtime.Value{})
_ = __local_var_1_1
// TAST (Let): functorJoker1_1_0 shape=Let(LitRecord) bindingType=(ADT ["Data","Functor","Functor"] [(TypeApp (TypeVar f) [(TypeVar b)])])
functorJoker1_1_0 := (&Constructor_Data_Functor_Functor[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(f_2 gopurs_runtime.Value, v_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
__local_var_2_3 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(__local_var_1_1, "Functor0"), gopurs_runtime.Value{})
_ = __local_var_2_3
// TAST (Let): functorJoker1_2_2 shape=Let(LitRecord) bindingType=(ADT ["Data","Functor","Functor"] [(TypeApp (TypeVar f) [(TypeVar b)])])
functorJoker1_2_2 := (&Constructor_Data_Functor_Functor[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(f_3 gopurs_runtime.Value, v_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_2_3, "map"), f_3, v_4)
})})
_ = functorJoker1_2_2
// TAST (Let): applyJoker1_1_0 shape=Let(Let(LitRecord)) bindingType=(ADT ["Control","Apply","Apply"] [(TypeApp (TypeVar f) [(TypeVar b)])])
applyJoker1_1_0 := (&Constructor_Control_Apply_Apply[gopurs_runtime.Value]{1, gopurs_runtime.Func(func(_dollar___unused_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer(functorJoker1_2_2)}
}), gopurs_runtime.Func2(func(v_3 gopurs_runtime.Value, v1_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_1_1, "apply"), v_3, v1_4)
})})
_ = applyJoker1_1_0
...
_ = __local_var_3_5
// TAST (Let): functorJoker1_3_4 shape=Let(LitRecord) bindingType=(ADT ["Data","Functor","Functor"] [(TypeApp (TypeVar f) [(TypeVar b)])])
functorJoker1_3_4 := (&Constructor_Data_Functor_Functor[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(f_4 gopurs_runtime.Value, v_5 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_3_5, "map"), f_4, v_5)
})})
_ = functorJoker1_3_4
// TAST (Let): applyJoker1_2_2 shape=Let(Let(LitRecord)) bindingType=(ADT ["Control","Apply","Apply"] [(TypeApp (TypeVar f) [(TypeVar b)])])
applyJoker1_2_2 := (&Constructor_Control_Apply_Apply[gopurs_runtime.Value]{1, gopurs_runtime.Func(func(_dollar___unused_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer(functorJoker1_3_4)}
...
_ = applyJoker1_2_2
// TAST (Let): applicativeJoker1_1_0 shape=Let(Let(LitRecord)) bindingType=(ADT ["Control","Applicative","Applicative"] [(TypeApp (TypeVar m) [(TypeVar b)])])
applicativeJoker1_1_0 := (&Constructor_Control_Applicative_Applicative[gopurs_runtime.Value]{1, gopurs_runtime.Func(func(_dollar___unused_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 3032403085, UnsafePtr: unsafe.Pointer(applyJoker1_2_2)}
...
_ = __local_var_4_11
// TAST (Let): functorJoker1_4_10 shape=Let(LitRecord) bindingType=(ADT ["Data","Functor","Functor"] [(TypeApp (TypeVar f) [(TypeVar b)])])
functorJoker1_4_10 := (&Constructor_Data_Functor_Functor[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(f_5 gopurs_runtime.Value, v_6 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_4_11, "map"), f_5, v_6)
})})
_ = functorJoker1_4_10
// TAST (Let): applyJoker1_3_8 shape=Let(Let(LitRecord)) bindingType=(ADT ["Control","Apply","Apply"] [(TypeApp (TypeVar f) [(TypeVar b)])])
applyJoker1_3_8 := (&Constructor_Control_Apply_Apply[gopurs_runtime.Value]{1, gopurs_runtime.Func(func(_dollar___unused_5 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer(functorJoker1_4_10)}
...
_ = applyJoker1_3_8
// TAST (Let): bindJoker1_2_6 shape=Let(Let(LitRecord)) bindingType=(ADT ["Control","Bind","Bind"] [(TypeApp (TypeVar m) [(TypeVar b)])])
bindJoker1_2_6 := (&Constructor_Control_Bind_Bind[gopurs_runtime.Value]{1, gopurs_runtime.Func(func(_dollar___unused_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 3032403085, UnsafePtr: unsafe.Pointer(applyJoker1_3_8)}
...
return gopurs_runtime.Value{Type: 9, IntVal: 4032919565, UnsafePtr: unsafe.Pointer(bindJoker1_2_6)}
})}))}
}
