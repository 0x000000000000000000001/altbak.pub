...
_ = __local_var_1_1
// TAST (Let): semigroupEndo1_1_0 shape=Let(LitRecord) bindingType=(ADT ["Data","Semigroup","Semigroup"] [(TypeApp (TypeApp (TypeVar c) [(TypeVar a), (TypeVar a)]) [(TypeVar c), (TypeVar a)])])
semigroupEndo1_1_0 := (&Constructor_Data_Semigroup_Semigroup[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(v_2 gopurs_runtime.Value, v1_3 gopurs_runtime.Value) gopurs_runtime.Value {
