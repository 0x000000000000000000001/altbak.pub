...
func Get_Data_Maybe_Last_ord1Last() gopurs_runtime.Value {
	once_Data_Maybe_Last_ord1Last.Do(func() {
		cache_Data_Maybe_Last_ord1Last = gopurs_runtime.Value{Type: 9, IntVal: 1632188299, UnsafePtr: unsafe.Pointer(Rebox_Data_Maybe_Last_170825214_3985601471(gopurs_runtime.CoerceToStruct[Constructor_Data_Ord_Ord1[*Constructor_Data_Maybe_Just[gopurs_runtime.Value]]](Get_Data_Maybe_ord1Maybe())))}
	})
...
func Get_Data_Maybe_Last_monadLast() gopurs_runtime.Value {
	once_Data_Maybe_Last_monadLast.Do(func() {
		cache_Data_Maybe_Last_monadLast = gopurs_runtime.Value{Type: 9, IntVal: 778916621, UnsafePtr: unsafe.Pointer(Rebox_Data_Maybe_Last_1642601656_2568689657(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Monad[*Constructor_Data_Maybe_Just[gopurs_runtime.Value]]](Get_Data_Maybe_monadMaybe())))}
	})
...
func Get_Data_Maybe_Last_functorLast() gopurs_runtime.Value {
	once_Data_Maybe_Last_functorLast.Do(func() {
		cache_Data_Maybe_Last_functorLast = gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer(Rebox_Data_Maybe_Last_3689823567_2812149806(gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor[*Constructor_Data_Maybe_Just[gopurs_runtime.Value]]](Get_Data_Maybe_functorMaybe())))}
	})
...
func Get_Data_Maybe_Last_extendLast() gopurs_runtime.Value {
	once_Data_Maybe_Last_extendLast.Do(func() {
		cache_Data_Maybe_Last_extendLast = gopurs_runtime.Value{Type: 9, IntVal: 3028639021, UnsafePtr: unsafe.Pointer(Rebox_Data_Maybe_Last_570732504_3290176857(gopurs_runtime.CoerceToStruct[Constructor_Control_Extend_Extend[*Constructor_Data_Maybe_Just[gopurs_runtime.Value]]](Get_Data_Maybe_extendMaybe())))}
	})
...
func Get_Data_Maybe_Last_eq1Last() gopurs_runtime.Value {
	once_Data_Maybe_Last_eq1Last.Do(func() {
		cache_Data_Maybe_Last_eq1Last = gopurs_runtime.Value{Type: 9, IntVal: 1715248107, UnsafePtr: unsafe.Pointer(Rebox_Data_Maybe_Last_1662389854_1766074591(gopurs_runtime.CoerceToStruct[Constructor_Data_Eq_Eq1[*Constructor_Data_Maybe_Just[gopurs_runtime.Value]]](Get_Data_Maybe_eq1Maybe())))}
	})
...
func Get_Data_Maybe_Last_bindLast() gopurs_runtime.Value {
	once_Data_Maybe_Last_bindLast.Do(func() {
		cache_Data_Maybe_Last_bindLast = gopurs_runtime.Value{Type: 9, IntVal: 4032919565, UnsafePtr: unsafe.Pointer(Rebox_Data_Maybe_Last_3887487416_2748095225(gopurs_runtime.CoerceToStruct[Constructor_Control_Bind_Bind[*Constructor_Data_Maybe_Just[gopurs_runtime.Value]]](Get_Data_Maybe_bindMaybe())))}
	})
...
func Get_Data_Maybe_Last_applyLast() gopurs_runtime.Value {
	once_Data_Maybe_Last_applyLast.Do(func() {
		cache_Data_Maybe_Last_applyLast = gopurs_runtime.Value{Type: 9, IntVal: 3032403085, UnsafePtr: unsafe.Pointer(Rebox_Data_Maybe_Last_3552963512_3741347833(gopurs_runtime.CoerceToStruct[Constructor_Control_Apply_Apply[*Constructor_Data_Maybe_Just[gopurs_runtime.Value]]](Get_Data_Maybe_applyMaybe())))}
	})
...
func Get_Data_Maybe_Last_applicativeLast() gopurs_runtime.Value {
	once_Data_Maybe_Last_applicativeLast.Do(func() {
		cache_Data_Maybe_Last_applicativeLast = gopurs_runtime.Value{Type: 9, IntVal: 1459134221, UnsafePtr: unsafe.Pointer(Rebox_Data_Maybe_Last_649684152_1439734649(gopurs_runtime.CoerceToStruct[Constructor_Control_Applicative_Applicative[*Constructor_Data_Maybe_Just[gopurs_runtime.Value]]](Get_Data_Maybe_applicativeMaybe())))}
	})
...
return gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer(Rebox_Data_Maybe_Last_3689823567_2812149806(gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor[*Constructor_Data_Maybe_Just[gopurs_runtime.Value]]](Get_Data_Maybe_functorMaybe())))}
...
return gopurs_runtime.Value{Type: 9, IntVal: 4060500237, UnsafePtr: unsafe.Pointer(Rebox_Data_Maybe_Last_3904200120_3421983481(gopurs_runtime.CoerceToStruct[Constructor_Control_Alt_Alt[*Constructor_Data_Maybe_Just[gopurs_runtime.Value]]](Get_Data_Maybe_Last_altLast())))}
...
return gopurs_runtime.Value{Type: 9, IntVal: 1459134221, UnsafePtr: unsafe.Pointer(Rebox_Data_Maybe_Last_649684152_1439734649(gopurs_runtime.CoerceToStruct[Constructor_Control_Applicative_Applicative[*Constructor_Data_Maybe_Just[gopurs_runtime.Value]]](Get_Data_Maybe_applicativeMaybe())))}
}), gopurs_runtime.Func(func(_dollar___unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 3709470893, UnsafePtr: unsafe.Pointer(Rebox_Data_Maybe_Last_267397720_3706288089(gopurs_runtime.CoerceToStruct[Constructor_Control_Plus_Plus[*Constructor_Data_Maybe_Just[gopurs_runtime.Value]]](Get_Data_Maybe_Last_plusLast())))}
})})))}
	})
...
return gopurs_runtime.Str((("(Last ") + (gopurs_runtime.Apply(gopurs_runtime.Box(showMaybe_1_0.V0), gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just[gopurs_runtime.Value]](v_2))}).StrVal())) + (")"))
})})))}
}
...
_ = eqMaybe1_1_0
return gopurs_runtime.Value{Type: 9, IntVal: 1435789946, UnsafePtr: unsafe.Pointer(Rebox_Data_Maybe_Last_2155612431_4177771502((&Constructor_Data_Ord_Ord[*Constructor_Data_Maybe_Just[gopurs_runtime.Value]]{1, gopurs_runtime.Func(func(_dollar___unused_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 1012063514, UnsafePtr: unsafe.Pointer(Rebox_Data_Maybe_Last_3508461103_3790796878(eqMaybe1_1_0))}
...
_ = dictEq_0
return gopurs_runtime.Value{Type: 9, IntVal: 1012063514, UnsafePtr: unsafe.Pointer(Rebox_Data_Maybe_Last_3508461103_3790796878((&Constructor_Data_Eq_Eq[*Constructor_Data_Maybe_Just[gopurs_runtime.Value]]{1, gopurs_runtime.Func2(func(x_1 gopurs_runtime.Value, y_2 gopurs_runtime.Value) gopurs_runtime.Value {
var __t5 bool
{
...
_ = dictBounded_0
return gopurs_runtime.Value{Type: 9, IntVal: 3510799738, UnsafePtr: unsafe.Pointer(Rebox_Data_Maybe_Last_591333647_2094947566(Rebox_Data_Maybe_Last_2094947566_591333647(gopurs_runtime.CoerceToStruct[Constructor_Data_Bounded_Bounded[gopurs_runtime.Value]](gopurs_runtime.Apply(Get_Data_Maybe_boundedMaybe(), dictBounded_0)))))}
}
