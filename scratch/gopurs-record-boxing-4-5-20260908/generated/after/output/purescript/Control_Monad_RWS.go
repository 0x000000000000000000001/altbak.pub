...
func Get_Control_Monad_RWS_pure() gopurs_runtime.Value {
	once_Control_Monad_RWS_pure.Do(func() {
		cache_Control_Monad_RWS_pure = gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Control_Applicative_Applicative[gopurs_runtime.Value]](Get_Data_Identity_applicativeIdentity()).V1)
	})
...
func Get_Control_Monad_RWS_withRWS() gopurs_runtime.Value {
	once_Control_Monad_RWS_withRWS.Do(func() {
		cache_Control_Monad_RWS_withRWS = gopurs_runtime.Func4(func(f_0_box gopurs_runtime.Value, m_1_box gopurs_runtime.Value, r_2_box gopurs_runtime.Value, s_3_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 2367475031, UnsafePtr: unsafe.Pointer(Call_Control_Monad_RWS_withRWS(f_0_box, m_1_box, r_2_box, s_3_box))}
})
	})
...
func Call_Control_Monad_RWS_withRWS(f_0_loop gopurs_runtime.Value, m_1_loop gopurs_runtime.Value, r_2_loop gopurs_runtime.Value, s_3_loop gopurs_runtime.Value) *Constructor_Control_Monad_RWS_Trans_RWSResult[gopurs_runtime.Value, gopurs_runtime.Value, gopurs_runtime.Value] {
...
_ = __local_var_4_0
return gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_RWS_Trans_RWSResult[gopurs_runtime.Value, gopurs_runtime.Value, gopurs_runtime.Value]](gopurs_runtime.Apply2(m_1, (__local_var_4_0).V0, (__local_var_4_0).V1))
}
...
_ = s_2
return gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_RWS_Trans_RWSResult[gopurs_runtime.Value, gopurs_runtime.Value, gopurs_runtime.Value]](gopurs_runtime.Apply2(f_0, r_1, s_2))
}
...
var s_2 gopurs_runtime.Value = s_2_loop
_ = s_2
// TAST (Let): __local_var_3_0 shape=App(Other) bindingType=(TypeVar a)
...
_ = __local_var_3_0
return struct{V0 gopurs_runtime.Value; V1 gopurs_runtime.Value}{(__local_var_3_0).V0, (__local_var_3_0).V2}
}
...
__local_var_3_0 := gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_RWS_Trans_RWSResult[gopurs_runtime.Value, gopurs_runtime.Value, gopurs_runtime.Value]](gopurs_runtime.Apply2(m_0, r_1, s_2))
_ = __local_var_3_0
return struct{V0 gopurs_runtime.Value; V1 gopurs_runtime.Value}{(__local_var_3_0).V1, (__local_var_3_0).V2}
}
