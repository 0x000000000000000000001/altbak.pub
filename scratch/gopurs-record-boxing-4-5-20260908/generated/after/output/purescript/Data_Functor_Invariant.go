...
func Get_Data_Functor_Invariant_invariantEndo() gopurs_runtime.Value {
	once_Data_Functor_Invariant_invariantEndo.Do(func() {
		cache_Data_Functor_Invariant_invariantEndo = gopurs_runtime.Value{Type: 9, IntVal: 2396985522, UnsafePtr: unsafe.Pointer((&Constructor_Data_Functor_Invariant_Invariant[gopurs_runtime.Value]{1, gopurs_runtime.Func4(func(ab_0 gopurs_runtime.Value, ba_1 gopurs_runtime.Value, v_2 gopurs_runtime.Value, x_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Data_Functor_Invariant_invariantArray() gopurs_runtime.Value {
	once_Data_Functor_Invariant_invariantArray.Do(func() {
		cache_Data_Functor_Invariant_invariantArray = gopurs_runtime.Value{Type: 9, IntVal: 2396985522, UnsafePtr: unsafe.Pointer((&Constructor_Data_Functor_Invariant_Invariant[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(f_0 gopurs_runtime.Value, v_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Data_Functor_Invariant_invariantFn() gopurs_runtime.Value {
	once_Data_Functor_Invariant_invariantFn.Do(func() {
		cache_Data_Functor_Invariant_invariantFn = gopurs_runtime.Value{Type: 9, IntVal: 2396985522, UnsafePtr: unsafe.Pointer((&Constructor_Data_Functor_Invariant_Invariant[gopurs_runtime.Value]{1, gopurs_runtime.Func4(func(f_0 gopurs_runtime.Value, v_1 gopurs_runtime.Value, g_2 gopurs_runtime.Value, x_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
func init() {
	gopurs_runtime.StructGetters[2396985522] = func(ptr unsafe.Pointer, key string) gopurs_runtime.Value {
		c := (*Constructor_Data_Functor_Invariant_Invariant[any])(ptr)
		_ = c
		switch key {
