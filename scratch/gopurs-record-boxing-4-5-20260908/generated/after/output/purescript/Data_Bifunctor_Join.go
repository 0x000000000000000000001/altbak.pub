...
func Get_Data_Bifunctor_Join_newtypeJoin() gopurs_runtime.Value {
	once_Data_Bifunctor_Join_newtypeJoin.Do(func() {
		cache_Data_Bifunctor_Join_newtypeJoin = gopurs_runtime.Value{Type: 9, IntVal: 3322196858, UnsafePtr: unsafe.Pointer((&Constructor_Data_Newtype_Newtype[gopurs_runtime.Value, gopurs_runtime.Value]{1, gopurs_runtime.Func(func(_dollar___unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = __local_var_1_1
// TAST (Let): bifunctorJoin1_1_0 shape=Let(LitRecord) bindingType=(ADT ["Data","Functor","Functor"] [(TypeApp (TypeApp (TypeVar p) [(TypeVar a), (TypeVar a)]) [(TypeVar p)])])
bifunctorJoin1_1_0 := (&Constructor_Data_Functor_Functor[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(f_2 gopurs_runtime.Value, v_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer(bifunctorJoin1_1_0)}
...
_ = __local_var_2_3
// TAST (Let): bifunctorJoin1_2_2 shape=Let(LitRecord) bindingType=(ADT ["Data","Functor","Functor"] [(TypeApp (TypeApp (TypeVar p) [(TypeVar a), (TypeVar a)]) [(TypeVar p)])])
bifunctorJoin1_2_2 := (&Constructor_Data_Functor_Functor[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(f_3 gopurs_runtime.Value, v_4 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply3(gopurs_runtime.RecordGet(__local_var_2_3, "bimap"), f_3, f_3, v_4)
})})
_ = bifunctorJoin1_2_2
// TAST (Let): biapplyJoin1_1_0 shape=Let(Let(LitRecord)) bindingType=(ADT ["Control","Apply","Apply"] [(TypeApp (TypeApp (TypeVar p) [(TypeVar a), (TypeVar a)]) [(TypeVar p)])])
biapplyJoin1_1_0 := (&Constructor_Control_Apply_Apply[gopurs_runtime.Value]{1, gopurs_runtime.Func(func(_dollar___unused_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer(bifunctorJoin1_2_2)}
...
return gopurs_runtime.Value{Type: 9, IntVal: 3032403085, UnsafePtr: unsafe.Pointer(biapplyJoin1_1_0)}
