...
func Get_Data_Const_invariantConst() gopurs_runtime.Value {
	once_Data_Const_invariantConst.Do(func() {
		cache_Data_Const_invariantConst = gopurs_runtime.Value{Type: 9, IntVal: 2396985522, UnsafePtr: unsafe.Pointer((&Constructor_Data_Functor_Invariant_Invariant[gopurs_runtime.Value]{1, gopurs_runtime.Func3(func(f_0 gopurs_runtime.Value, v_1 gopurs_runtime.Value, m_2 gopurs_runtime.Value) gopurs_runtime.Value {
return m_2
})}))}
	})
...
var dictEq_0 gopurs_runtime.Value = dictEq_0_loop
_ = dictEq_0
// TAST (Let): eq_1_0 shape=Other bindingType=(Func [(TypeApp (TypeVar a) [(TypeVar a), (TypeVar a)]), (TypeApp (TypeVar a) [(TypeVar a), (TypeVar a)])] Boolean)
...
var dictOrd_0 gopurs_runtime.Value = dictOrd_0_loop
_ = dictOrd_0
// TAST (Let): compare_1_0 shape=Other bindingType=(Func [(TypeApp (TypeVar a) [(TypeVar a), (TypeVar a)]), (TypeApp (TypeVar a) [(TypeVar a), (TypeVar a)])] (ADT ["Data","Ordering","Ordering"] []))
compare_1_0 := gopurs_runtime.RecordGet(dictOrd_0, "compare")
_ = compare_1_0
// TAST (Let): eq_2_2 shape=Other bindingType=(Func [(TypeApp (TypeVar a) [(TypeVar a), (TypeVar a)]), (TypeApp (TypeVar a) [(TypeVar a), (TypeVar a)])] Boolean)
eq_2_2 := gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictOrd_0, "Eq0"), gopurs_runtime.Value{}), "eq")
_ = eq_2_2
// TAST (Let): eq1Const1_2_1 shape=Let(LitRecord) bindingType=(ADT ["Data","Eq","Eq1"] [(TypeApp (TypeVar a) [(TypeVar a)])])
eq1Const1_2_1 := (&Constructor_Data_Eq_Eq1[gopurs_runtime.Value]{1, gopurs_runtime.Func(func(dictEq1_3 gopurs_runtime.Value) gopurs_runtime.Value {
return eq_2_2
})})
_ = eq1Const1_2_1
...
_ = __local_var_1_1
// TAST (Let): applyConst1_1_0 shape=Let(LitRecord) bindingType=(ADT ["Control","Apply","Apply"] [(TypeApp (TypeVar a) [(TypeVar a)])])
applyConst1_1_0 := (&Constructor_Control_Apply_Apply[gopurs_runtime.Value]{1, gopurs_runtime.Func(func(_dollar___unused_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor[gopurs_runtime.Value]](Get_Data_Const_functorConst()))}
