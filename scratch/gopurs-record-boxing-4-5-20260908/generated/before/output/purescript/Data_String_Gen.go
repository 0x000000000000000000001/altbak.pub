...
return gopurs_runtime.Apply2(gopurs_runtime.Box(Bind1_3_1.V1), gopurs_runtime.Apply2(gopurs_runtime.Box(dictMonadGen_1.V3), gopurs_runtime.Int(int64(1)), gopurs_runtime.Int(gopurs_runtime.Apply2(Get_Data_Ord_max__3052583336(), gopurs_runtime.Int(int64(1)), gopurs_runtime.Int(size_6.IntVal)).IntVal)), gopurs_runtime.Func(func(newSize_7 gopurs_runtime.Value) gopurs_runtime.Value {
...
var dictMonadGen_1 gopurs_runtime.Value = dictMonadGen_1_loop
_ = dictMonadGen_1
return gopurs_runtime.Apply(Call_Data_String_Gen_genString(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Rec_Class_MonadRec[gopurs_runtime.Value]](dictMonadRec_0), gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Gen_Class_MonadGen[gopurs_runtime.Value]](dictMonadGen_1)), gopurs_runtime.Apply(Get_Data_Char_Gen_genAsciiChar_prime_(), dictMonadGen_1))
}
