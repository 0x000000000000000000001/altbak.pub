...
return func() gopurs_runtime.Value {
				_v := Call_Data_Either_Inject_prj(gopurs_runtime.CoerceToStruct[Constructor_Data_Either_Inject_Inject[gopurs_runtime.Value, gopurs_runtime.Value]](dict_0_box))
				if _v.V1 {
...
func init() {
	gopurs_runtime.StructGetters[89024546] = func(ptr unsafe.Pointer, key string) gopurs_runtime.Value {
		c := (*Constructor_Data_Either_Inject_Inject[any, any])(ptr)
		_ = c
		switch key {
...
return gopurs_runtime.CoerceToStruct[Constructor_Data_Either_Inject_Inject[gopurs_runtime.Value, gopurs_runtime.Value]](func() gopurs_runtime.Value {
				orig := x_0
				_ = orig
				return gopurs_runtime.RecordDict([]string{"inj", "prj"}, []gopurs_runtime.Value{orig.inj, orig.prj})
				}())
}

func Call_Data_Either_Inject_prj(dict_0_loop *Constructor_Data_Either_Inject_Inject[gopurs_runtime.Value, gopurs_runtime.Value]) struct{V0 gopurs_runtime.Value; V1 bool} {
...
_ = dictInject_0
return gopurs_runtime.Value{Type: 9, IntVal: 89024546, UnsafePtr: unsafe.Pointer((&Constructor_Data_Either_Inject_Inject[gopurs_runtime.Value, gopurs_runtime.Value]{1, gopurs_runtime.Func(func(x_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
__t0 = gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just[gopurs_runtime.Value]](gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictInject_0, "prj"), (*Constructor_Data_Either_Right[gopurs_runtime.Value, gopurs_runtime.Value])(v2_1.UnsafePtr).V0))
goto end_branch_0
} else {
