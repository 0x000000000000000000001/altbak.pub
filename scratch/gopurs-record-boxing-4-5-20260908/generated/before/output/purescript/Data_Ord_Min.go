...
_ = __local_var_1_1
// TAST (Let): semigroupMin1_1_0 shape=Let(LitRecord) bindingType=(ADT ["Data","Semigroup","Semigroup"] [(TypeVar a)])
semigroupMin1_1_0 := (&Constructor_Data_Semigroup_Semigroup[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(v_2 gopurs_runtime.Value, v1_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
var dictOrd_0 gopurs_runtime.Value = dictOrd_0_loop
_ = dictOrd_0
// TAST (Let): eqMin1_1_0 shape=App(Other) bindingType=(ADT ["Data","Eq","Eq"] [(TypeVar a)])
