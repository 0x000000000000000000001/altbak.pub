...
func Get_Data_Functor_Flip_newtypeFlip() gopurs_runtime.Value {
	once_Data_Functor_Flip_newtypeFlip.Do(func() {
		cache_Data_Functor_Flip_newtypeFlip = gopurs_runtime.Value{Type: 9, IntVal: 3322196858, UnsafePtr: unsafe.Pointer((&Constructor_Data_Newtype_Newtype[gopurs_runtime.Value, gopurs_runtime.Value]{1, gopurs_runtime.Func(func(_dollar___unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Value{Type: 9, IntVal: 350442445, UnsafePtr: unsafe.Pointer((&Constructor_Control_Semigroupoid_Semigroupoid[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(v_1 gopurs_runtime.Value, v1_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
return gopurs_runtime.Apply3(gopurs_runtime.RecordGet(dictBifunctor_0, "bimap"), f_1, gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Control_Category_Category[gopurs_runtime.Value]](Get_Control_Category_categoryFn()).V1), v_2)
})}))}
}
...
_ = dictProfunctor_0
return gopurs_runtime.Value{Type: 9, IntVal: 85171506, UnsafePtr: unsafe.Pointer((&Constructor_Data_Functor_Contravariant_Contravariant[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(f_1 gopurs_runtime.Value, v_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply3(gopurs_runtime.RecordGet(dictProfunctor_0, "dimap"), f_1, gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Control_Category_Category[gopurs_runtime.Value]](Get_Control_Category_categoryFn()).V1), v_2)
})}))}
}
...
_ = __local_var_1_1
// TAST (Let): semigroupoidFlip1_1_0 shape=Let(LitRecord) bindingType=(TypeApp (ADT ["Control","Semigroupoid","Semigroupoid"] []) [(TypeApp (TypeApp (TypeVar p) [(TypeVar b), (TypeVar a)]) [(TypeVar p)])])
semigroupoidFlip1_1_0 := (&Constructor_Control_Semigroupoid_Semigroupoid[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(v_2 gopurs_runtime.Value, v1_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = __local_var_1_1
// TAST (Let): bifunctorFlip1_1_0 shape=Let(LitRecord) bindingType=(ADT ["Data","Bifunctor","Bifunctor"] [(TypeApp (TypeApp (TypeVar p) [(TypeVar b), (TypeVar a)]) [(TypeVar p)])])
bifunctorFlip1_1_0 := (&Constructor_Data_Bifunctor_Bifunctor[gopurs_runtime.Value]{1, gopurs_runtime.Func3(func(f_2 gopurs_runtime.Value, g_3 gopurs_runtime.Value, v_4 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = __local_var_2_3
// TAST (Let): bifunctorFlip1_2_2 shape=Let(LitRecord) bindingType=(ADT ["Data","Bifunctor","Bifunctor"] [(TypeApp (TypeApp (TypeVar p) [(TypeVar b), (TypeVar a)]) [(TypeVar p)])])
bifunctorFlip1_2_2 := (&Constructor_Data_Bifunctor_Bifunctor[gopurs_runtime.Value]{1, gopurs_runtime.Func3(func(f_3 gopurs_runtime.Value, g_4 gopurs_runtime.Value, v_5 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply3(gopurs_runtime.RecordGet(__local_var_2_3, "bimap"), g_4, f_3, v_5)
})})
_ = bifunctorFlip1_2_2
// TAST (Let): biapplyFlip1_1_0 shape=Let(Let(LitRecord)) bindingType=(ADT ["Control","Biapply","Biapply"] [(TypeApp (TypeApp (TypeVar p) [(TypeVar b), (TypeVar a)]) [(TypeVar p)])])
biapplyFlip1_1_0 := (&Constructor_Control_Biapply_Biapply[gopurs_runtime.Value]{1, gopurs_runtime.Func(func(_dollar___unused_3 gopurs_runtime.Value) gopurs_runtime.Value {
