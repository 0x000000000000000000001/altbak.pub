...
var cache_Test_Polymorphism_mempty___2089552681 gopurs_runtime.Value
var once_Test_Polymorphism_mempty___2089552681 sync.Once
func Get_Test_Polymorphism_mempty___2089552681() gopurs_runtime.Value {
	once_Test_Polymorphism_mempty___2089552681.Do(func() {
		cache_Test_Polymorphism_mempty___2089552681 = gopurs_runtime.Int(int64(1))
	})
	return cache_Test_Polymorphism_mempty___2089552681
}
...
var cache_Test_Polymorphism_mappend___3052583336 gopurs_runtime.Value
var once_Test_Polymorphism_mappend___3052583336 sync.Once
func Get_Test_Polymorphism_mappend___3052583336() gopurs_runtime.Value {
	once_Test_Polymorphism_mappend___3052583336.Do(func() {
		cache_Test_Polymorphism_mappend___3052583336 = gopurs_runtime.Func2(func(__eta_norm_1_0_box gopurs_runtime.Value, __eta_norm_0_1_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_Test_Polymorphism_mappend___3052583336(__eta_norm_1_0_box, __eta_norm_0_1_box)
})
	})
	return cache_Test_Polymorphism_mappend___3052583336
}

var cache_Test_Polymorphism_mappend___2711687305 gopurs_runtime.Value
var once_Test_Polymorphism_mappend___2711687305 sync.Once
func Get_Test_Polymorphism_mappend___2711687305() gopurs_runtime.Value {
	once_Test_Polymorphism_mappend___2711687305.Do(func() {
		cache_Test_Polymorphism_mappend___2711687305 = gopurs_runtime.Func2(func(__eta_norm_0_unused_0_box gopurs_runtime.Value, __eta_norm_1_1_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_Test_Polymorphism_mappend___2711687305(__eta_norm_0_unused_0_box, __eta_norm_1_1_box)
})
	})
	return cache_Test_Polymorphism_mappend___2711687305
}
...
var go__go_3_4_4 gopurs_runtime.Value
_ = go__go_3_4_4
// FALLBACK TCO: isLoop=false len=1
go__go_3_4_4 = gopurs_runtime.Func2(func(v_4 gopurs_runtime.Value, v1_5 gopurs_runtime.Value) gopurs_runtime.Value {
var __t5 int64
{
if (v_4.IntVal) == (int64(0)) {
__t5 = v1_5.IntVal
goto end_branch_5
} else {
...
{
__t5 = Call_local_Test_Polymorphism_go__467072791_2_2_3((v_4.IntVal) - (int64(1)), int64(2))
}
end_branch_5:
...
return gopurs_runtime.CoerceToStruct[Constructor_Test_Polymorphism_Monoidish[gopurs_runtime.Value]](func() gopurs_runtime.Value {
				orig := x_0
				_ = orig
				return gopurs_runtime.RecordDict([]string{"mappend_", "mempty_"}, []gopurs_runtime.Value{orig.mappend_, orig.mempty_})
				}())
}
...
func Call_Test_Polymorphism_mappend___3052583336(__eta_norm_1_0_loop gopurs_runtime.Value, __eta_norm_0_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
mappend___3052583336:
for {
if false { continue mappend___3052583336 }
...
func Call_Test_Polymorphism_mappend___2711687305(__eta_norm_0_unused_0_loop gopurs_runtime.Value, __eta_norm_1_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
mappend___2711687305:
for {
if false { continue mappend___2711687305 }
...
_ = __eta_norm_1_1
return gopurs_runtime.Int((__eta_norm_1_1.IntVal) + (int64(1)))
}
}
...
for {
if false { continue polyLoop__3052583336 }
...
_ = go__go_3_2_2
// FALLBACK TCO: isLoop=false len=1
go__go_3_2_2 = gopurs_runtime.Func2(func(v_4 gopurs_runtime.Value, v1_5 gopurs_runtime.Value) gopurs_runtime.Value {
var __t3 int64
{
if (v_4.IntVal) == (int64(0)) {
__t3 = v1_5.IntVal
...
{
__t3 = Call_local_Test_Polymorphism_go__467072791_2_0_1((v_4.IntVal) - (int64(1)), int64(2))
}
end_branch_3:
