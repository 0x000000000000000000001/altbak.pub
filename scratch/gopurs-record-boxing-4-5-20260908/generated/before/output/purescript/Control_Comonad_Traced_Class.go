...
return Call_Control_Comonad_Traced_Class_lowerTrack(gopurs_runtime.CoerceToStruct[Constructor_Control_Comonad_Trans_Class_ComonadTrans[gopurs_runtime.Value]](dictComonadTrans_0_box), gopurs_runtime.CoerceToStruct[Constructor_Control_Comonad_Traced_Class_ComonadTraced[gopurs_runtime.Value, gopurs_runtime.Value]](dictComonadTraced_1_box))
})
	})
...
return Call_Control_Comonad_Traced_Class_lowerTrack1(gopurs_runtime.CoerceToStruct[Constructor_Control_Comonad_Traced_Class_ComonadTraced[gopurs_runtime.Value, gopurs_runtime.Value]](dictComonadTraced_0_box))
})
	})
...
return Call_Control_Comonad_Traced_Class_lowerTrack2(gopurs_runtime.CoerceToStruct[Constructor_Control_Comonad_Traced_Class_ComonadTraced[gopurs_runtime.Value, gopurs_runtime.Value]](dictComonadTraced_0_box))
})
	})
...
return Call_Control_Comonad_Traced_Class_lowerTrack3(gopurs_runtime.CoerceToStruct[Constructor_Control_Comonad_Traced_Class_ComonadTraced[gopurs_runtime.Value, gopurs_runtime.Value]](dictComonadTraced_0_box), m_1_box)
})
	})
...
func init() {
	gopurs_runtime.StructGetters[433046755] = func(ptr unsafe.Pointer, key string) gopurs_runtime.Value {
		c := (*Constructor_Control_Comonad_Traced_Class_ComonadTraced[any, any])(ptr)
		_ = c
		switch key {
...
return gopurs_runtime.CoerceToStruct[Constructor_Control_Comonad_Traced_Class_ComonadTraced[gopurs_runtime.Value, gopurs_runtime.Value]](func() gopurs_runtime.Value {
				orig := x_0
				_ = orig
				return gopurs_runtime.RecordDict([]string{"Comonad0", "track"}, []gopurs_runtime.Value{orig.Comonad0, orig.track})
				}())
}
...
// TAST (Let): Comonad0_1_0 shape=App(Other) bindingType=(ADT ["Control","Comonad","Comonad"] [(TypeVar w)])
Comonad0_1_0 := gopurs_runtime.CoerceToStruct[Constructor_Control_Comonad_Comonad[gopurs_runtime.Value]](gopurs_runtime.Apply(gopurs_runtime.Box(dictComonadTraced_0.V0), gopurs_runtime.Value{}))
_ = Comonad0_1_0
...
func Call_Control_Comonad_Traced_Class_lowerTrack(dictComonadTrans_0_loop *Constructor_Control_Comonad_Trans_Class_ComonadTrans[gopurs_runtime.Value], dictComonadTraced_1_loop *Constructor_Control_Comonad_Traced_Class_ComonadTraced[gopurs_runtime.Value, gopurs_runtime.Value]) gopurs_runtime.Value {
...
var dictComonadTraced_1 *Constructor_Control_Comonad_Traced_Class_ComonadTraced[gopurs_runtime.Value, gopurs_runtime.Value] = dictComonadTraced_1_loop
_ = dictComonadTraced_1
// TAST (Let): lower1_2_0 shape=App(Other) bindingType=(Func [(TypeApp (TypeVar t) [(TypeVar w), (TypeVar a)])] (TypeApp (TypeVar w) [(TypeVar a)]))
...
func Call_Control_Comonad_Traced_Class_lowerTrack1(dictComonadTraced_0_loop *Constructor_Control_Comonad_Traced_Class_ComonadTraced[gopurs_runtime.Value, gopurs_runtime.Value]) gopurs_runtime.Value {
var dictComonadTraced_0 *Constructor_Control_Comonad_Traced_Class_ComonadTraced[gopurs_runtime.Value, gopurs_runtime.Value] = dictComonadTraced_0_loop
_ = dictComonadTraced_0
// TAST (Let): Functor0_1_1 shape=App(Other) bindingType=(ADT ["Data","Functor","Functor"] [(TypeVar w)])
Functor0_1_1 := gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor[gopurs_runtime.Value]](gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.Box(dictComonadTraced_0.V0), gopurs_runtime.Value{}), "Extend0"), gopurs_runtime.Value{}), "Functor0"), gopurs_runtime.Value{}))
_ = Functor0_1_1
// TAST (Let): lower1_1_0 shape=Let(Abs(Let(App(Other)))) bindingType=(Func [(TypeApp (TypeVar t) [(TypeVar w), (TypeVar a)])] (TypeApp (TypeVar w) [(TypeVar a)]))
...
__local_var_3_2 := (*Constructor_Data_Tuple_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(v_2.UnsafePtr).V1
_ = __local_var_3_2
...
func Call_Control_Comonad_Traced_Class_lowerTrack2(dictComonadTraced_0_loop *Constructor_Control_Comonad_Traced_Class_ComonadTraced[gopurs_runtime.Value, gopurs_runtime.Value]) gopurs_runtime.Value {
var dictComonadTraced_0 *Constructor_Control_Comonad_Traced_Class_ComonadTraced[gopurs_runtime.Value, gopurs_runtime.Value] = dictComonadTraced_0_loop
_ = dictComonadTraced_0
// TAST (Let): lower1_1_0 shape=App(Other) bindingType=(Func [(TypeApp (TypeVar t) [(TypeVar w), (TypeVar a)])] (TypeApp (TypeVar w) [(TypeVar a)]))
lower1_1_0 := gopurs_runtime.Apply(gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Control_Comonad_Trans_Class_ComonadTrans[gopurs_runtime.Value]](Get_Control_Comonad_Trans_Class_comonadTransIdentityT()).V0), gopurs_runtime.Apply(gopurs_runtime.Box(dictComonadTraced_0.V0), gopurs_runtime.Value{}))
_ = lower1_1_0
return gopurs_runtime.Func(func(m_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_Control_Comonad_Traced_Class_lowerTrack3(dictComonadTraced_0_loop *Constructor_Control_Comonad_Traced_Class_ComonadTraced[gopurs_runtime.Value, gopurs_runtime.Value], m_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
var dictComonadTraced_0 *Constructor_Control_Comonad_Traced_Class_ComonadTraced[gopurs_runtime.Value, gopurs_runtime.Value] = dictComonadTraced_0_loop
_ = dictComonadTraced_0
...
return gopurs_runtime.Apply(__local_var_2_0, (*Constructor_Data_Tuple_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(x_3.UnsafePtr).V1)
})
}
...
_ = v_2
return gopurs_runtime.Apply2(gopurs_runtime.Box(dictFunctor_0.V0), gopurs_runtime.Func2(func(g_3 gopurs_runtime.Value, t_4 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = v_1
return gopurs_runtime.Apply2(gopurs_runtime.Box(dictFunctor_0.V0), gopurs_runtime.Func2(func(f_2 gopurs_runtime.Value, t_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Tuple_Tuple[gopurs_runtime.Value, gopurs_runtime.Value]](func() gopurs_runtime.Value {
...
_ = dictComonad_0
// TAST (Let): comonadTracedT__193435443_1_0 shape=App(Var) bindingType=Any
comonadTracedT__193435443_1_0 := gopurs_runtime.Apply(Get_Control_Comonad_Traced_Trans_comonadTracedT(), dictComonad_0)
_ = comonadTracedT__193435443_1_0
return gopurs_runtime.Func(func(dictMonoid_2 gopurs_runtime.Value) gopurs_runtime.Value {
// TAST (Let): comonadTracedT1_3_1 shape=App(Other) bindingType=(ADT ["Control","Comonad","Comonad"] [(TypeApp (TypeVar w) [(Func [(TypeVar t)] (TypeVar a))])])
comonadTracedT1_3_1 := gopurs_runtime.CoerceToStruct[Constructor_Control_Comonad_Comonad[gopurs_runtime.Value]](gopurs_runtime.Apply(comonadTracedT__193435443_1_0, dictMonoid_2))
...
comonadStoreT_1_0 := Rebox_Control_Comonad_Traced_Class_2550391993_3056445460(gopurs_runtime.CoerceToStruct[Constructor_Control_Comonad_Comonad[gopurs_runtime.Value]](gopurs_runtime.Apply(Get_Control_Comonad_Store_Trans_comonadStoreT(), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictComonadTraced_0, "Comonad0"), gopurs_runtime.Value{}))))
_ = comonadStoreT_1_0
// TAST (Let): Functor0_2_2 shape=App(Other) bindingType=(ADT ["Data","Functor","Functor"] [(TypeVar w)])
Functor0_2_2 := gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor[gopurs_runtime.Value]](gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictComonadTraced_0, "Comonad0"), gopurs_runtime.Value{}), "Extend0"), gopurs_runtime.Value{}), "Functor0"), gopurs_runtime.Value{}))
_ = Functor0_2_2
// TAST (Let): lower1_2_1 shape=Let(Abs(Let(App(Other)))) bindingType=(Func [(TypeApp (TypeVar t) [(TypeVar w), (TypeVar a)])] (TypeApp (TypeVar w) [(TypeVar a)]))
...
__local_var_4_3 := (*Constructor_Data_Tuple_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(v_3.UnsafePtr).V1
_ = __local_var_4_3
...
}), (*Constructor_Data_Tuple_Tuple[gopurs_runtime.Value, gopurs_runtime.Value])(v_3.UnsafePtr).V0)
})
_ = lower1_2_1
...
_ = __local_var_2_3
// TAST (Let): functorIdentityT1_3_4 shape=App(Other) bindingType=(ADT ["Data","Functor","Functor"] [(TypeApp (TypeApp (TypeVar m) [(TypeVar a)]) [(TypeVar w)])])
functorIdentityT1_3_4 := gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor[gopurs_runtime.Value]](gopurs_runtime.Apply(gopurs_runtime.RecordGet(__local_var_2_3, "Functor0"), gopurs_runtime.Value{}))
_ = functorIdentityT1_3_4
// TAST (Let): extendIdentityI1_2_2 shape=Let(Let(LitRecord)) bindingType=(ADT ["Control","Extend","Extend"] [(TypeApp (TypeApp (TypeVar m) [(TypeVar a)]) [(TypeVar w)])])
extendIdentityI1_2_2 := (&Constructor_Control_Extend_Extend[gopurs_runtime.Value]{1, gopurs_runtime.Func(func(_dollar___unused_4 gopurs_runtime.Value) gopurs_runtime.Value {
...
// TAST (Let): comonadIdentityT_1_0 shape=Let(Let(LitRecord)) bindingType=(ADT ["Control","Comonad","Comonad"] [(TypeApp (TypeApp (TypeVar m) [(TypeVar a)]) [(TypeVar w)])])
comonadIdentityT_1_0 := (&Constructor_Control_Comonad_Comonad[gopurs_runtime.Value]{1, gopurs_runtime.Func(func(_dollar___unused_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
// TAST (Let): lower1_2_5 shape=App(Other) bindingType=(Func [(TypeApp (TypeVar t) [(TypeVar w), (TypeVar a)])] (TypeApp (TypeVar w) [(TypeVar a)]))
lower1_2_5 := gopurs_runtime.Apply(gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Control_Comonad_Trans_Class_ComonadTrans[gopurs_runtime.Value]](Get_Control_Comonad_Trans_Class_comonadTransIdentityT()).V0), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictComonadTraced_0, "Comonad0"), gopurs_runtime.Value{}))
_ = lower1_2_5
...
comonadEnvT_1_0 := Rebox_Control_Comonad_Traced_Class_2550391993_3056445460(gopurs_runtime.CoerceToStruct[Constructor_Control_Comonad_Comonad[gopurs_runtime.Value]](gopurs_runtime.Apply(Get_Control_Comonad_Env_Trans_comonadEnvT(), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictComonadTraced_0, "Comonad0"), gopurs_runtime.Value{}))))
_ = comonadEnvT_1_0
return gopurs_runtime.Value{Type: 9, IntVal: 433046755, UnsafePtr: unsafe.Pointer(Rebox_Control_Comonad_Traced_Class_843532572_2535844177((&Constructor_Control_Comonad_Traced_Class_ComonadTraced[gopurs_runtime.Value, *Constructor_Data_Tuple_Tuple[gopurs_runtime.Value, gopurs_runtime.Value]]{1, gopurs_runtime.Func(func(_dollar___unused_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
var v_2 gopurs_runtime.Value = v_2_loop
_ = v_2
return gopurs_runtime.Apply2(gopurs_runtime.Box(dictFunctor_0.V0), gopurs_runtime.Func2(func(v1_3 gopurs_runtime.Value, x_4 gopurs_runtime.Value) gopurs_runtime.Value {
