...
func Data_DateTime_CalcDiff(rec1 map[string]interface{}, rec2 map[string]interface{}) float64 {
...
func Data_DateTime_AdjustImpl(just func(interface{}) interface{}, nothing interface{}, offset float64, rec map[string]interface{}) interface{} {
...
var _Gopurs_Data_DateTime_AdjustImpl = // TAST: (Func [(ForAll [a] (Func [(TypeVar a)] (ADT ["Data","Maybe","Maybe"] [(TypeVar a)]))), (ForAll [a] (ADT ["Data","Maybe","Maybe"] [(TypeVar a)])), Number, Any] (ADT ["Data","Maybe","Maybe"] [Any]))
gopurs_runtime.Func4(func(arg0 gopurs_runtime.Value, arg1 gopurs_runtime.Value, arg2 gopurs_runtime.Value, arg3 gopurs_runtime.Value) gopurs_runtime.Value {
	...
	go_res := Data_DateTime_AdjustImpl(go_arg0, go_arg1, go_arg2, go_arg3)
	return gopurs_runtime.Box(go_res)
})
var _Gopurs_Data_DateTime_CalcDiff = // TAST: (ADT ["Data","Function","Uncurried","Fn2"] [Any, Any, Number])
gopurs_runtime.Func2(func(arg0 gopurs_runtime.Value, arg1 gopurs_runtime.Value) gopurs_runtime.Value {
	go_arg0 := gopurs_runtime.UnboxObject(arg0)
	go_arg1 := gopurs_runtime.UnboxObject(arg1)
	go_res := Data_DateTime_CalcDiff(go_arg0, go_arg1)
	return gopurs_runtime.Box(go_res)
})