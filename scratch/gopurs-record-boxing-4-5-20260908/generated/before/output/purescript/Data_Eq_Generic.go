...
func init() {
	gopurs_runtime.StructGetters[106035173] = func(ptr unsafe.Pointer, key string) gopurs_runtime.Value {
		c := (*Constructor_Data_Eq_Generic_GenericEq[any])(ptr)
		_ = c
		switch key {
...
return gopurs_runtime.CoerceToStruct[Constructor_Data_Eq_Generic_GenericEq[gopurs_runtime.Value]](func() gopurs_runtime.Value {
				orig := x_0
				_ = orig
				return gopurs_runtime.RecordDict([]string{"genericEq'"}, []gopurs_runtime.Value{orig.genericEq_prime_})
				}())
}
...
_ = y_3
return (gopurs_runtime.Apply2(gopurs_runtime.Box(dictGenericEq_1.V0), gopurs_runtime.Apply(gopurs_runtime.Box(dictGeneric_0.V0), x_2), gopurs_runtime.Apply(gopurs_runtime.Box(dictGeneric_0.V0), y_3)).IntVal) != (0)
}
