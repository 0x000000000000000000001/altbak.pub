...
_ = x_0
return gopurs_runtime.Value{Type: 9, IntVal: 1786680275, UnsafePtr: unsafe.Pointer((&Constructor_Data_Number_Format_Precision{1, gopurs_runtime.Apply2(Get_Data_Ord_min__3052583336(), gopurs_runtime.Int(int64(21)), gopurs_runtime.Int(gopurs_runtime.Apply2(Get_Data_Ord_max__3052583336(), gopurs_runtime.Int(int64(1)), gopurs_runtime.Int(x_0)).IntVal)).IntVal}))}
}

func Call_Data_Number_Format_fixed(x_0_loop int64) gopurs_runtime.Value {
var x_0 int64 = x_0_loop
_ = x_0
return gopurs_runtime.Value{Type: 9, IntVal: 1390206259, UnsafePtr: unsafe.Pointer((&Constructor_Data_Number_Format_Fixed{1, gopurs_runtime.Apply2(Get_Data_Ord_min__3052583336(), gopurs_runtime.Int(int64(20)), gopurs_runtime.Int(gopurs_runtime.Apply2(Get_Data_Ord_max__3052583336(), gopurs_runtime.Int(int64(0)), gopurs_runtime.Int(x_0)).IntVal)).IntVal}))}
}

func Call_Data_Number_Format_exponential(x_0_loop int64) gopurs_runtime.Value {
var x_0 int64 = x_0_loop
_ = x_0
return gopurs_runtime.Value{Type: 9, IntVal: 1734244434, UnsafePtr: unsafe.Pointer((&Constructor_Data_Number_Format_Exponential{1, gopurs_runtime.Apply2(Get_Data_Ord_min__3052583336(), gopurs_runtime.Int(int64(20)), gopurs_runtime.Int(gopurs_runtime.Apply2(Get_Data_Ord_max__3052583336(), gopurs_runtime.Int(int64(0)), gopurs_runtime.Int(x_0)).IntVal)).IntVal}))}
}
