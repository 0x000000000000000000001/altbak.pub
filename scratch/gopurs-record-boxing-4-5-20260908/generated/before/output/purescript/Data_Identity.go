...
func Get_Data_Identity_invariantIdentity() gopurs_runtime.Value {
	once_Data_Identity_invariantIdentity.Do(func() {
		cache_Data_Identity_invariantIdentity = gopurs_runtime.Value{Type: 9, IntVal: 2396985522, UnsafePtr: unsafe.Pointer((&Constructor_Data_Functor_Invariant_Invariant[gopurs_runtime.Value]{1, gopurs_runtime.Func3(func(f_0 gopurs_runtime.Value, v_1 gopurs_runtime.Value, m_2 gopurs_runtime.Value) gopurs_runtime.Value {
