...
func Get_Data_Decide_identity() gopurs_runtime.Value {
	once_Data_Decide_identity.Do(func() {
		cache_Data_Decide_identity = gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Control_Category_Category[gopurs_runtime.Value]](Get_Control_Category_categoryFn()).V1)
	})
...
// TAST (Let): __local_var_4_0 shape=App(Other) bindingType=(TypeVar c)
__local_var_4_0 := gopurs_runtime.Apply(f_0, x_3)
_ = __local_var_4_0
var __t1 gopurs_runtime.Value
{
if (__local_var_4_0.Type == 9 && __local_var_4_0.IntVal == 3711209382) {
__t1 = gopurs_runtime.Bool((gopurs_runtime.Apply(v_1, (*Constructor_Data_Either_Left[gopurs_runtime.Value, gopurs_runtime.Value])(__local_var_4_0.UnsafePtr).V0).IntVal) != (0))
goto end_branch_1
} else {
...
__t1 = gopurs_runtime.Bool((gopurs_runtime.Apply(v1_2, (*Constructor_Data_Either_Right[gopurs_runtime.Value, gopurs_runtime.Value])(__local_var_4_0.UnsafePtr).V0).IntVal) != (0))
goto end_branch_1
} else {
...
// TAST (Let): v2_5_0 shape=App(Other) bindingType=(ADT ["Data","Either","Either"] [(TypeVar b), (TypeVar c)])
v2_5_0 := gopurs_runtime.Apply(f_0, a_3)
_ = v2_5_0
var __t5 bool
{
if (v2_5_0.Type == 9 && v2_5_0.IntVal == 3711209382) {
// TAST (Let): v3_6_1 shape=App(Other) bindingType=(ADT ["Data","Either","Either"] [(TypeVar b), (TypeVar c)])
...
// TAST (Let): v3_6_3 shape=App(Other) bindingType=(ADT ["Data","Either","Either"] [(TypeVar b), (TypeVar c)])
...
func init() {
	gopurs_runtime.StructGetters[1618621146] = func(ptr unsafe.Pointer, key string) gopurs_runtime.Value {
		c := (*Constructor_Data_Decide_Decide[any])(ptr)
		_ = c
		switch key {
...
return gopurs_runtime.CoerceToStruct[Constructor_Data_Decide_Decide[gopurs_runtime.Value]](func() gopurs_runtime.Value {
				orig := x_0
				_ = orig
				return gopurs_runtime.RecordDict([]string{"Divide0", "choose"}, []gopurs_runtime.Value{orig.Divide0, orig.choose})
				}())
}
...
_ = dictSemigroup_0
// TAST (Let): divideOp_1_0 shape=LitRecord bindingType=(ADT ["Data","Divide","Divide"] [(Func [(TypeVar b)] (TypeVar r))])
divideOp_1_0 := (&Constructor_Data_Divide_Divide[gopurs_runtime.Value]{1, gopurs_runtime.Func(func(_dollar___unused_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
// TAST (Let): v2_5_1 shape=App(Other) bindingType=(ADT ["Data","Tuple","Tuple"] [(TypeVar b), (TypeVar c)])
v2_5_1 := gopurs_runtime.CoerceToStruct[Constructor_Data_Tuple_Tuple[gopurs_runtime.Value, gopurs_runtime.Value]](gopurs_runtime.Apply(f_1, a_4))
_ = v2_5_1
...
// TAST (Let): __local_var_6_2 shape=App(Other) bindingType=(TypeVar c)
__local_var_6_2 := gopurs_runtime.Apply(f_2, x_5)
_ = __local_var_6_2
var __t3 gopurs_runtime.Value
{
if (__local_var_6_2.Type == 9 && __local_var_6_2.IntVal == 3711209382) {
__t3 = gopurs_runtime.Apply(v_3, (*Constructor_Data_Either_Left[gopurs_runtime.Value, gopurs_runtime.Value])(__local_var_6_2.UnsafePtr).V0)
goto end_branch_3
} else {
...
__t3 = gopurs_runtime.Apply(v1_4, (*Constructor_Data_Either_Right[gopurs_runtime.Value, gopurs_runtime.Value])(__local_var_6_2.UnsafePtr).V0)
goto end_branch_3
} else {
...
_ = dictDecide_0
return gopurs_runtime.Apply(gopurs_runtime.Box(dictDecide_0.V1), gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Control_Category_Category[gopurs_runtime.Value]](Get_Control_Category_categoryFn()).V1))
}
