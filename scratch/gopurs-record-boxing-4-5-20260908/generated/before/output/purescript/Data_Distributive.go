...
func Get_Data_Distributive_identity() gopurs_runtime.Value {
	once_Data_Distributive_identity.Do(func() {
		cache_Data_Distributive_identity = gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Control_Category_Category[gopurs_runtime.Value]](Get_Control_Category_categoryFn()).V1)
	})
...
// TAST (Let): __local_var_2_0 shape=App(Other) bindingType=(Func [(TypeApp (TypeVar g) [(TypeVar a)])] (TypeApp (TypeVar g) [(TypeVar b)]))
...
// TAST (Let): __local_var_1_1 shape=App(Other) bindingType=(Func [(TypeApp (TypeVar g) [(TypeVar a)])] (TypeApp (TypeVar g) [(TypeVar a)]))
...
// TAST (Let): __local_var_2_0 shape=App(Other) bindingType=(Func [(TypeApp (TypeVar g) [(TypeVar a)])] (TypeApp (TypeVar g) [(Func [(TypeVar e)] (TypeVar b))]))
__local_var_2_0 := gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictFunctor_0, "map"), f_1)
_ = __local_var_2_0
return gopurs_runtime.Func(func(x_3 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(Get_Data_Distributive_distributiveFunction(), "distribute"), dictFunctor_0, gopurs_runtime.Apply(__local_var_2_0, x_3))
})
...
func init() {
	gopurs_runtime.StructGetters[457335066] = func(ptr unsafe.Pointer, key string) gopurs_runtime.Value {
		c := (*Constructor_Data_Distributive_Distributive[any])(ptr)
		_ = c
		switch key {
...
return gopurs_runtime.CoerceToStruct[Constructor_Data_Distributive_Distributive[gopurs_runtime.Value]](func() gopurs_runtime.Value {
				orig := x_0
				_ = orig
				return gopurs_runtime.RecordDict([]string{"Functor0", "collect", "distribute"}, []gopurs_runtime.Value{orig.Functor0, orig.collect, orig.distribute})
				}())
}
...
// TAST (Let): distribute2_3_1 shape=App(Other) bindingType=(Func [(TypeApp (TypeVar g) [(TypeApp (TypeVar f) [(TypeVar a)])])] (TypeApp (TypeVar f) [(TypeApp (TypeVar g) [(TypeVar a)])]))
...
_ = dictFunctor_1
// TAST (Let): distribute2_2_0 shape=App(Other) bindingType=(Func [(TypeApp (TypeVar g) [(TypeApp (TypeVar f) [(TypeVar b)])])] (TypeApp (TypeVar f) [(TypeApp (TypeVar g) [(TypeVar b)])]))
...
// TAST (Let): __local_var_4_1 shape=App(Other) bindingType=(Func [(TypeApp (TypeVar g) [(TypeVar a)])] (TypeApp (TypeVar g) [(TypeApp (TypeVar f) [(TypeVar b)])]))
...
_ = __local_var_2_2
// TAST (Let): __local_var_3_3 shape=App(Other) bindingType=(Func [(TypeApp (TypeVar g) [(ADT ["Data","Tuple","Tuple"] [(TypeVar a), (TypeVar a)])])] (TypeApp (TypeVar g) [(TypeVar a)]))
...
var dictFunctor_1 *Constructor_Data_Functor_Functor[gopurs_runtime.Value] = dictFunctor_1_loop
_ = dictFunctor_1
return gopurs_runtime.Apply2(gopurs_runtime.Box(dictDistributive_0.V1), gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer(dictFunctor_1)}, gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Control_Category_Category[gopurs_runtime.Value]](Get_Control_Category_categoryFn()).V1))
}
