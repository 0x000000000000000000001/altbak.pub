...
# 1. Replace collectLocalExpr / collectLocalBind
old_collect = """collectLocalExpr :: Set Ident -> LocalInstMap -> Expr Ann -> LocalInstMap
...
# Delete old collectLocalExpr and collectLocalBind
# It spans from line 307 to 398.
lines = code.split('\\n')
start_idx = -1
end_idx = -1
for i, line in enumerate(lines):
    if line.startswith("collectLocalExpr ::"):
        start_idx = i
    if line.startswith("collectTypesFromExpr ::"):
        end_idx = i
        break
...
new_inj2 = """                                    let localInstMap = collectAllLocalInsts [] Map.empty substitutedExpr
...
# Finally remove the localInstMap computation inside monomorphizeExpr
