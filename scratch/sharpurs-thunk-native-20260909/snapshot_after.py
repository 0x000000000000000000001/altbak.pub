...
shutil.copy2(backend / 'bin/sharpurs.js', AUDIT / 'backend-after.bundle.js')
require(sha(AUDIT / 'backend-after.bundle.js') == manifest['backendAfterBundleSha256'], 'Bundle changed during capture')
