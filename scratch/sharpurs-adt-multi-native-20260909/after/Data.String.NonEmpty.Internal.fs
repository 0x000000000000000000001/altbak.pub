...
let Data_String_NonEmpty_Internal_fromString  = (box (fun (v: obj) -> (match ((unbox ((box v)))) with | LitString "" () -> ((box Data_Maybe_Nothingusd_Ctor)) | s -> ((sharpurs_apply (box ((box ((fun (usd__arg1: obj) -> (box (Data_Maybe_Justusd_Ctor(usd__arg1)))))))) (box ((sharpurs_apply (box ((box Data_String_NonEmpty_Internal_NonEmptyString))) (box ((box s)))))))))))
