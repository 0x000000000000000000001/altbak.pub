...
let Data_Set_NonEmpty_toUnfoldable1  = (box (fun (dictUnfoldable1: obj) -> (let stepNext = (sharpurs_apply (box ((sharpurs_apply (box ((box Data_Map_Internal_stepAscCps))) (box ((sharpurs_apply (box ((box Data_Function_Uncurried_mkFn3))) (box ((box (fun (k: obj) -> (box (fun (v: obj) -> (box (fun (next: obj) -> (sharpurs_apply (box ((box ((fun (usd__arg1: obj) -> (box (Data_Maybe_Justusd_Ctor(usd__arg1)))))))) (box ((sharpurs_apply (box ((sharpurs_apply (box ((box ((fun (usd__arg1: obj) -> (fun (usd__arg2: obj) -> (box (Data_Tuple_Tupleusd_Ctor(usd__arg1, usd__arg2))))))))) (box ((box k)))))) (box ((box next))))))))))))))))))))) (box ((box (fun (v: obj) -> (box Data_Maybe_Nothingusd_Ctor)))))) in let stepHead = (sharpurs_apply (box ((sharpurs_apply (box ((box Data_Map_Internal_stepAscCps))) (box ((sharpurs_apply (box ((box Data_Function_Uncurried_mkFn3))) (box ((box (fun (k: obj) -> (box (fun (v: obj) -> (box (fun (next: obj) -> (sharpurs_apply (box ((sharpurs_apply (box ((box ((fun (usd__arg1: obj) -> (fun (usd__arg2: obj) -> (box (Data_Tuple_Tupleusd_Ctor(usd__arg1, usd__arg2))))))))) (box ((box k)))))) (box ((box next)))))))))))))))))) (box ((box (fun (v: obj) -> (sharpurs_apply (box ((box Partial_Unsafe_unsafeCrashWith))) (box ((box "toUnfoldable1: impossible"))))))))) in (sharpurs_apply (box ((sharpurs_apply (box ((sharpurs_apply (box ((box Control_Semigroupoid_compose))) (box ((box Control_Semigroupoid_semigroupoidFn)))))) (box ((sharpurs_apply (box ((sharpurs_apply (box ((box Data_Unfoldable1_unfoldr1))) (box ((box dictUnfoldable1)))))) (box ((box (fun (v: obj) -> (sharpurs_apply (box ((sharpurs_apply (box ((sharpurs_apply (box ((box Data_Functor_map))) (box ((box Data_Tuple_functorTuple)))))) (box ((box stepNext)))))) (box ((box v)))))))))))))) (box ((sharpurs_apply (box ((sharpurs_apply (box ((sharpurs_apply (box ((box Control_Semigroupoid_compose))) (box ((box Control_Semigroupoid_semigroupoidFn)))))) (box ((box stepHead)))))) (box ((sharpurs_apply (box ((sharpurs_apply (box ((sharpurs_apply (box ((box Control_Semigroupoid_compose))) (box ((box Control_Semigroupoid_semigroupoidFn)))))) (box ((box Data_Map_Internal_toMapIter)))))) (box ((sharpurs_apply (box ((sharpurs_apply (box ((sharpurs_apply (box ((box Control_Semigroupoid_compose))) (box ((box Control_Semigroupoid_semigroupoidFn)))))) (box ((box Data_Set_toMap)))))) (box ((box Data_Set_NonEmpty_coerce))))))))))))))))
...
let Data_Set_NonEmpty_fromSet  = (box (fun (s: obj) -> (match ((unbox ((sharpurs_apply (box ((box Data_Set_isEmpty))) (box ((box s))))))) with | LitBool true () -> ((box Data_Maybe_Nothingusd_Ctor)) | _ -> ((sharpurs_apply (box ((box ((fun (usd__arg1: obj) -> (box (Data_Maybe_Justusd_Ctor(usd__arg1)))))))) (box ((sharpurs_apply (box ((box Data_Set_NonEmpty_NonEmptySet))) (box ((box s)))))))))))
