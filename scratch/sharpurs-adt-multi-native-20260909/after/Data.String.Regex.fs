...
let Data_String_Regex_search  = (sharpurs_apply (box ((sharpurs_apply (box ((box Data_String_Regex__search))) (box ((box ((fun (usd__arg1: obj) -> (box (Data_Maybe_Justusd_Ctor(usd__arg1))))))))))) (box ((box Data_Maybe_Nothingusd_Ctor))))

let Data_String_Regex_replace_prime  = (sharpurs_apply (box ((sharpurs_apply (box ((box Data_String_Regex__replaceBy))) (box ((box ((fun (usd__arg1: obj) -> (box (Data_Maybe_Justusd_Ctor(usd__arg1))))))))))) (box ((box Data_Maybe_Nothingusd_Ctor))))
...
let Data_String_Regex_regex  = (box (fun (s: obj) -> (box (fun (f: obj) -> (sharpurs_apply (box ((sharpurs_apply (box ((box Data_Function_apply))) (box ((sharpurs_apply (box ((sharpurs_apply (box ((sharpurs_apply (box ((box Data_String_Regex_regexImpl))) (box ((box ((fun (usd__arg1: obj) -> (box (Data_Either_Leftusd_Ctor(usd__arg1))))))))))) (box ((box ((fun (usd__arg1: obj) -> (box (Data_Either_Rightusd_Ctor(usd__arg1))))))))))) (box ((box s))))))))) (box ((sharpurs_apply (box ((box Data_String_Regex_renderFlags))) (box ((box f)))))))))))
...
let Data_String_Regex_match  = (sharpurs_apply (box ((sharpurs_apply (box ((box Data_String_Regex__match))) (box ((box ((fun (usd__arg1: obj) -> (box (Data_Maybe_Justusd_Ctor(usd__arg1))))))))))) (box ((box Data_Maybe_Nothingusd_Ctor))))
