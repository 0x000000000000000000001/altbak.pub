...
let Data_Array_uncons  = (sharpurs_apply (box ((sharpurs_apply (box ((sharpurs_apply (box ((box Data_Function_Uncurried_runFn3))) (box ((box Data_Array_unconsImpl)))))) (box ((sharpurs_apply (box ((box Data_Function_const))) (box ((box Data_Maybe_Nothingusd_Ctor))))))))) (box ((box (fun (x: obj) -> (box (fun (xs: obj) -> (sharpurs_apply (box ((box ((fun (usd__arg1: obj) -> (box (Data_Maybe_Justusd_Ctor(usd__arg1)))))))) (box ((box ((Map.add "head" (box ((box x))) (Map.add "tail" (box ((box xs))) Map.empty))))))))))))))

let Data_Array_toUnfoldable  = (box (fun (dictUnfoldable: obj) -> (box (fun (xs: obj) -> (let len = (sharpurs_apply (box ((box Data_Array_length))) (box ((box xs)))) in let f = (box (fun (i: obj) -> (match ((unbox ((box i)))) with | i1 when (unbox (box ((unbox<int> (box ((box i1)))) < (unbox<int> (box ((box len))))))) -> ((sharpurs_apply (box ((box ((fun (usd__arg1: obj) -> (box (Data_Maybe_Justusd_Ctor(usd__arg1)))))))) (box ((sharpurs_apply (box ((sharpurs_apply (box ((box ((fun (usd__arg1: obj) -> (fun (usd__arg2: obj) -> (box (Data_Tuple_Tupleusd_Ctor(usd__arg1, usd__arg2))))))))) (box ((sharpurs_apply (box ((box Partial_Unsafe_unsafePartial))) (box ((box (fun (usd__unused: obj) -> (sharpurs_apply (box ((sharpurs_apply (box ((sharpurs_apply (box ((box Data_Array_unsafeIndex))) (box ((box Prim_undefined)))))) (box ((box xs)))))) (box ((box i1)))))))))))))) (box ((box ((unbox<int> (box ((box i1)))) + (unbox<int> (box ((box 1))))))))))))) | i1 when (unbox (box Data_Boolean_otherwise)) -> ((box Data_Maybe_Nothingusd_Ctor))))) in (sharpurs_apply (box ((sharpurs_apply (box ((sharpurs_apply (box ((box Data_Unfoldable_unfoldr))) (box ((box dictUnfoldable)))))) (box ((box f)))))) (box ((box 0)))))))))

let Data_Array_tail  = (sharpurs_apply (box ((sharpurs_apply (box ((sharpurs_apply (box ((box Data_Function_Uncurried_runFn3))) (box ((box Data_Array_unconsImpl)))))) (box ((sharpurs_apply (box ((box Data_Function_const))) (box ((box Data_Maybe_Nothingusd_Ctor))))))))) (box ((box (fun (v: obj) -> (box (fun (xs: obj) -> (sharpurs_apply (box ((box ((fun (usd__arg1: obj) -> (box (Data_Maybe_Justusd_Ctor(usd__arg1)))))))) (box ((box xs)))))))))))
...
let Data_Array_init  = (box (fun (xs: obj) -> (match ((unbox ((box xs)))) with | xs1 when (unbox (sharpurs_apply (box ((box Data_Array_null))) (box ((box xs1))))) -> ((box Data_Maybe_Nothingusd_Ctor)) | xs1 when (unbox (box Data_Boolean_otherwise)) -> ((sharpurs_apply (box ((box ((fun (usd__arg1: obj) -> (box (Data_Maybe_Justusd_Ctor(usd__arg1)))))))) (box ((sharpurs_apply (box ((sharpurs_apply (box ((sharpurs_apply (box ((box Data_Array_slice))) (box ((box Data_Array_zero)))))) (box ((sharpurs_apply (box ((sharpurs_apply (box ((sharpurs_apply (box ((box Data_Ring_sub))) (box ((box Data_Ring_ringInt)))))) (box ((sharpurs_apply (box ((box Data_Array_length))) (box ((box xs1))))))))) (box ((box Data_Array_one))))))))) (box ((box xs1)))))))))))
...
let Data_Array_insertBy  = (box (fun (cmp: obj) -> (box (fun (x: obj) -> (box (fun (ys: obj) -> (let i = (sharpurs_apply (box ((sharpurs_apply (box ((sharpurs_apply (box ((box Data_Maybe_maybe))) (box ((box 0)))))) (box ((box (fun (v: obj) -> (box ((unbox<int> (box ((box v)))) + (unbox<int> (box ((box 1))))))))))))) (box ((sharpurs_apply (box ((sharpurs_apply (box ((box Data_Array_findLastIndex))) (box ((box (fun (y: obj) -> (sharpurs_apply (box ((sharpurs_apply (box ((sharpurs_apply (box ((box Data_Eq_eq))) (box ((box Data_Ordering_eqOrdering)))))) (box ((sharpurs_apply (box ((sharpurs_apply (box ((box cmp))) (box ((box x)))))) (box ((box y))))))))) (box ((box Data_Ordering_GTusd_Ctor))))))))))) (box ((box ys))))))) in (sharpurs_apply (box ((box Partial_Unsafe_unsafePartial))) (box ((box (fun (usd__unused: obj) -> (sharpurs_apply (box ((sharpurs_apply (box ((box Data_Maybe_fromJust))) (box ((box Prim_undefined)))))) (box ((sharpurs_apply (box ((sharpurs_apply (box ((sharpurs_apply (box ((box Data_Array_insertAt))) (box ((box i)))))) (box ((box x)))))) (box ((box ys)))))))))))))))))))
