...
let rec Data_List_Partial_init_tco (usd__unused: obj) (v: obj) : obj = ((sharpurs_apply (box ((box (fun (usd__unused: obj) -> (match ((unbox ((box v)))) with | Data_List_Types_Consusd_Ctor(_, Unbox(Data_List_Types_Nilusd_Ctor)) -> ((box Data_List_Types_Nilusd_Ctor)) | Data_List_Types_Consusd_Ctor(x, xs) -> ((sharpurs_apply (box ((sharpurs_apply (box ((box ((fun (usd__arg1: obj) -> (fun (usd__arg2: obj) -> (box (Data_List_Types_Consusd_Ctor(usd__arg1, usd__arg2))))))))) (box ((box x)))))) (box ((sharpurs_apply (box ((sharpurs_apply (box ((box Data_List_Partial_init))) (box ((box Prim_undefined)))))) (box ((box xs))))))))))))) (box ((box Prim_undefined)))))
