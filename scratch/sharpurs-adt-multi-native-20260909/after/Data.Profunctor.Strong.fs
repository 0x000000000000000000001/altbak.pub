...
let Data_Profunctor_Strong_strongFn  = (sharpurs_apply (box ((box Data_Profunctor_Strong_Strongusd_Dict))) (box ((box ((Map.add "first" (box ((box (fun (a2b: obj) -> (box (fun (v: obj) -> (match (((unbox ((box a2b))), (unbox ((box v))))) with | (a2b1, Data_Tuple_Tupleusd_Ctor(a, c)) -> ((sharpurs_apply (box ((sharpurs_apply (box ((box ((fun (usd__arg1: obj) -> (fun (usd__arg2: obj) -> (box (Data_Tuple_Tupleusd_Ctor(usd__arg1, usd__arg2))))))))) (box ((sharpurs_apply (box ((box a2b1))) (box ((box a))))))))) (box ((box c)))))))))))) (Map.add "second" (box ((sharpurs_apply (box ((box Data_Functor_map))) (box ((box Data_Tuple_functorTuple)))))) (Map.add "Profunctor0" (box ((box (fun (usd__unused: obj) -> (box Data_Profunctor_profunctorFn))))) Map.empty))))))))
...
let Data_Profunctor_Strong_fanout  = (box (fun (dictSemigroupoid: obj) -> (box (fun (dictStrong: obj) -> (let Profunctor0 = (sharpurs_apply (box ((Map.find "Profunctor0" (unbox<Map<string, obj>> ((box dictStrong)))))) (box ((box Prim_undefined)))) in (box (fun (l: obj) -> (box (fun (r: obj) -> (sharpurs_apply (box ((sharpurs_apply (box ((sharpurs_apply (box ((box Data_Profunctor_lcmap))) (box ((box Profunctor0)))))) (box ((box (fun (a: obj) -> (sharpurs_apply (box ((sharpurs_apply (box ((box ((fun (usd__arg1: obj) -> (fun (usd__arg2: obj) -> (box (Data_Tuple_Tupleusd_Ctor(usd__arg1, usd__arg2))))))))) (box ((box a)))))) (box ((box a))))))))))) (box ((sharpurs_apply (box ((sharpurs_apply (box ((sharpurs_apply (box ((sharpurs_apply (box ((box Data_Profunctor_Strong_splitStrong))) (box ((box dictSemigroupoid)))))) (box ((box dictStrong)))))) (box ((box l)))))) (box ((box r))))))))))))))))
