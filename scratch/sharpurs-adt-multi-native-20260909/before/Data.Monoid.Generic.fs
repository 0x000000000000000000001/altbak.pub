...
let Data_Monoid_Generic_genericMonoidProduct  = (box (fun (dictGenericMonoid: obj) -> (box (fun (dictGenericMonoid1: obj) -> (sharpurs_apply (box ((box Data_Monoid_Generic_GenericMonoidusd_Dict))) (box ((box ((Map.add "genericMempty'" (box ((sharpurs_apply (box ((sharpurs_apply (box ((box ((fun (usd__arg1: obj) -> (fun (usd__arg2: obj) -> (box (Data_Generic_Rep_Productusd_Ctor(usd__arg1, usd__arg2))))))))) (box ((sharpurs_apply (box ((box Data_Monoid_Generic_genericMempty_prime))) (box ((box dictGenericMonoid))))))))) (box ((sharpurs_apply (box ((box Data_Monoid_Generic_genericMempty_prime))) (box ((box dictGenericMonoid1))))))))) Map.empty))))))))))
