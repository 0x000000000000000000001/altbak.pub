...
let Data_String_NonEmpty_CodePoints_fromCodePointArray  = (box (fun (v: obj) -> (match ((unbox ((box v)))) with | [|  |] -> ((box Data_Maybe_Nothingusd_Ctor)) | cs -> ((sharpurs_apply (box ((box ((fun (usd__arg1: obj) -> (box (Data_Maybe_Justusd_Ctor(usd__arg1)))))))) (box ((sharpurs_apply (box ((box Data_String_NonEmpty_CodePoints_toNonEmptyString))) (box ((sharpurs_apply (box ((box Data_String_CodePoints_fromCodePointArray))) (box ((box cs))))))))))))))
