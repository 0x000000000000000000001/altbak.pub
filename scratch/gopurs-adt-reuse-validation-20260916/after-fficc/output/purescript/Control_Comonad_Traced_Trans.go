...
_ = dictExtend_0
// TAST (Let): Functor0_1_0 shape=App(Other) bindingType=(ADT ["Data","Functor","Functor"] [(TypeVar w$scope29)])
...
_ = Functor0_1_0
// TAST (Let): functorTracedT1_2_1 shape=App(Var) bindingType=(ADT ["Data","Functor","Functor"] [(TypeApp (TypeVar w$scope29) [(Func [(TypeVar t$scope30)] (TypeVar a))])])
functorTracedT1_2_1 := gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor[gopurs_runtime.Value]](Call_Control_Comonad_Traced_Trans_functorTracedT(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictExtend_0, "Functor0"), gopurs_runtime.Value{})))
...
return gopurs_runtime.Apply(f_4, gopurs_runtime.Apply2(Functor0_1_0.V0, gopurs_runtime.Func2(func(h_8 gopurs_runtime.Value, t_prime__9 gopurs_runtime.Value) gopurs_runtime.Value {
...
// TAST (Let): Functor0_2_0 shape=App(Other) bindingType=(ADT ["Data","Functor","Functor"] [(TypeVar w$scope47)])
...
_ = dictComonad_0
// TAST (Let): extendTracedT1_1_0 shape=App(Var) bindingType=Any
extendTracedT1_1_0 := Call_Control_Comonad_Traced_Trans_extendTracedT(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictComonad_0, "Extend0"), gopurs_runtime.Value{}))
_ = extendTracedT1_1_0
return gopurs_runtime.Func(func(dictMonoid_2 gopurs_runtime.Value) gopurs_runtime.Value {
// TAST (Let): extendTracedT2_3_1 shape=App(Other) bindingType=(ADT ["Control","Extend","Extend"] [(TypeApp (TypeVar w$scope51) [(Func [(TypeVar t$scope52)] (TypeVar a))])])
extendTracedT2_3_1 := gopurs_runtime.CoerceToStruct[Constructor_Control_Extend_Extend[gopurs_runtime.Value]](gopurs_runtime.Apply(extendTracedT1_1_0, gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonoid_2, "Semigroup0"), gopurs_runtime.Value{})))
_ = extendTracedT2_3_1
...
return gopurs_runtime.Value{Type: 9, IntVal: 3028639021, UnsafePtr: unsafe.Pointer(extendTracedT2_3_1)}
