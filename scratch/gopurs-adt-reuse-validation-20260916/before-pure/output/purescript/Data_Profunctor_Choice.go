...
func Get_Data_Profunctor_Choice_identity() gopurs_runtime.Value {
	once_Data_Profunctor_Choice_identity.Do(func() {
		cache_Data_Profunctor_Choice_identity = Call_Control_Category_identity(gopurs_runtime.Value{Type: 9, IntVal: 784524589, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Category_Category[gopurs_runtime.Value]](Get_Control_Category_categoryFn()))})
	})
...
end_branch_0:
return __t0
}), Call_Data_Functor_go__map(gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor[gopurs_runtime.Value]](Get_Data_Either_functorEither()))}))}
	})
...
_ = r_3
return Call_Control_Semigroupoid_composeFlipped(dictSemigroupoid_0, gopurs_runtime.Apply(dictChoice_1.V1, l_2), gopurs_runtime.Apply(dictChoice_1.V2, r_3))
}
...
var dictChoice_1 *Constructor_Data_Profunctor_Choice_Choice[gopurs_runtime.Value] = dictChoice_1_loop
_ = dictChoice_1
// TAST (Let): Profunctor0_2_0 shape=App(Other) bindingType=(ADT ["Data","Profunctor","Profunctor"] [(TypeVar p$scope23)])
Profunctor0_2_0 := gopurs_runtime.CoerceToStruct[Constructor_Data_Profunctor_Profunctor[gopurs_runtime.Value]](gopurs_runtime.Apply(dictChoice_1.V0, gopurs_runtime.Value{}))
_ = Profunctor0_2_0
...
__local_var_5_1 := Call_Control_Category_identity(gopurs_runtime.Value{Type: 9, IntVal: 784524589, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Category_Category[gopurs_runtime.Value]](Get_Control_Category_categoryFn()))})
_ = __local_var_5_1
// TAST (Let): __local_var_6_2 shape=App(Var) bindingType=(Func [(TypeVar c$scope26)] (TypeVar c$scope26))
...
__t3 = gopurs_runtime.Apply(__local_var_6_2, (*Constructor_Data_Either_Right[gopurs_runtime.Value, gopurs_runtime.Value])(v2_7.UnsafePtr).V0)
goto end_branch_3
} else {
...
end_branch_3:
return __t3
}), Call_Data_Profunctor_Choice_splitChoice(dictSemigroupoid_0, dictChoice_1, l_3, r_4))
})
}
