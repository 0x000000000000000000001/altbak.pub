...
func Get_Data_Number_Format_precision() gopurs_runtime.Value {
	once_Data_Number_Format_precision.Do(func() {
		cache_Data_Number_Format_precision = gopurs_runtime.Apply2(Call_Control_Semigroupoid_compose(gopurs_runtime.CoerceToStruct[Constructor_Control_Semigroupoid_Semigroupoid[gopurs_runtime.Value]](Get_Control_Semigroupoid_semigroupoidFn())), Get_Data_Number_Format_Precision(), gopurs_runtime.Apply2(Get_Data_Ord_clamp__1711842232(), gopurs_runtime.Int(int64(1)), gopurs_runtime.Int(int64(21))))
	})
	return cache_Data_Number_Format_precision
}
...
func Get_Data_Number_Format_fixed() gopurs_runtime.Value {
	once_Data_Number_Format_fixed.Do(func() {
		cache_Data_Number_Format_fixed = gopurs_runtime.Apply2(Call_Control_Semigroupoid_compose(gopurs_runtime.CoerceToStruct[Constructor_Control_Semigroupoid_Semigroupoid[gopurs_runtime.Value]](Get_Control_Semigroupoid_semigroupoidFn())), Get_Data_Number_Format_Fixed(), gopurs_runtime.Apply2(Get_Data_Ord_clamp__1711842232(), gopurs_runtime.Int(int64(0)), gopurs_runtime.Int(int64(20))))
	})
	return cache_Data_Number_Format_fixed
}
...
func Get_Data_Number_Format_exponential() gopurs_runtime.Value {
	once_Data_Number_Format_exponential.Do(func() {
		cache_Data_Number_Format_exponential = gopurs_runtime.Apply2(Call_Control_Semigroupoid_compose(gopurs_runtime.CoerceToStruct[Constructor_Control_Semigroupoid_Semigroupoid[gopurs_runtime.Value]](Get_Control_Semigroupoid_semigroupoidFn())), Get_Data_Number_Format_Exponential(), gopurs_runtime.Apply2(Get_Data_Ord_clamp__1711842232(), gopurs_runtime.Int(int64(0)), gopurs_runtime.Int(int64(20))))
	})
	return cache_Data_Number_Format_exponential
}
