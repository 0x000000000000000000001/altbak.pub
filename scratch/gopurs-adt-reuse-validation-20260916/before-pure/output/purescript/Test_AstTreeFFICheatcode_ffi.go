...
func Test_AstTreeFFICheatcode_RunAstTreeFFICheatcode(limit int) int {
...
var _Gopurs_Test_AstTreeFFICheatcode_RunAstTreeFFICheatcode = // TAST: (Func [Int] Int)
gopurs_runtime.Func(func(arg0 gopurs_runtime.Value) gopurs_runtime.Value {
	go_arg0 := gopurs_runtime.Unbox[int](arg0)
	go_res := Test_AstTreeFFICheatcode_RunAstTreeFFICheatcode(go_arg0)
