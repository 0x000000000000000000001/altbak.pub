...
var monadRecST = {
    tailRecM: function (f) {
        return function (a) {
            ...
            return Control_Bind.bind(bindST)(Control_Bind.bindFlipped(bindST)($$new)(f(a)))(function (r) {
...
var monoidST = function (dictMonoid) {
    ...
    return {
        mempty: Control_Applicative.pure(applicativeST)(Data_Monoid.mempty(dictMonoid)),
        Semigroup0: function () {
            return semigroupST1;
        }
    };
