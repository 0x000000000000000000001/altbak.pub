...
func Get_Data_String_CodePoints_fromEnum() gopurs_runtime.Value {
	once_Data_String_CodePoints_fromEnum.Do(func() {
		cache_Data_String_CodePoints_fromEnum = Call_Data_Enum_fromEnum(Rebox_Data_String_CodePoints_3569500834_123048125(Rebox_Data_String_CodePoints_123048125_3569500834(gopurs_runtime.CoerceToStruct[Constructor_Data_Enum_BoundedEnum[gopurs_runtime.Value]](Get_Data_Enum_boundedEnumChar()))))
	})
...
func Get_Data_String_CodePoints_length() gopurs_runtime.Value {
	once_Data_String_CodePoints_length.Do(func() {
		cache_Data_String_CodePoints_length = gopurs_runtime.Apply2(Call_Control_Semigroupoid_compose(gopurs_runtime.CoerceToStruct[Constructor_Control_Semigroupoid_Semigroupoid[gopurs_runtime.Value]](Get_Control_Semigroupoid_semigroupoidFn())), Get_Data_Array_length(), Get_Data_String_CodePoints_toCodePointArray())
	})
...
func Get_Data_String_CodePoints_fromCharCode() gopurs_runtime.Value {
	once_Data_String_CodePoints_fromCharCode.Do(func() {
		cache_Data_String_CodePoints_fromCharCode = gopurs_runtime.Apply2(Call_Control_Semigroupoid_compose(gopurs_runtime.CoerceToStruct[Constructor_Control_Semigroupoid_Semigroupoid[gopurs_runtime.Value]](Get_Control_Semigroupoid_semigroupoidFn())), Get_Data_String_CodeUnits_singleton(), gopurs_runtime.Apply2(Get_Data_Enum_toEnumWithDefaults__4115932335(), gopurs_runtime.Str(gopurs_runtime.Str(Get_Data_Bounded_bottomChar().StrVal()).StrVal()), gopurs_runtime.Str(gopurs_runtime.Str(Get_Data_Bounded_topChar().StrVal()).StrVal())))
	})
...
return func() gopurs_runtime.Value {
				...
				_ = orig
				return gopurs_runtime.RecordDict2("after", "before", gopurs_runtime.Str(orig.after), gopurs_runtime.Str(orig.before))
				}()
})
	})
...
return gopurs_runtime.Value{Type: 9, IntVal: 1012063514, UnsafePtr: unsafe.Pointer(Rebox_Data_String_CodePoints_1053099733_3790796878(Rebox_Data_String_CodePoints_3790796878_1053099733(gopurs_runtime.CoerceToStruct[Constructor_Data_Eq_Eq[gopurs_runtime.Value]](Get_Data_String_CodePoints_eqCodePoint()))))}
...
func Get_Data_String_CodePoints_codePointFromChar() gopurs_runtime.Value {
	once_Data_String_CodePoints_codePointFromChar.Do(func() {
		cache_Data_String_CodePoints_codePointFromChar = Call_Control_Semigroupoid_composeFlipped(gopurs_runtime.CoerceToStruct[Constructor_Control_Semigroupoid_Semigroupoid[gopurs_runtime.Value]](Get_Control_Semigroupoid_semigroupoidFn()), Call_Data_Enum_fromEnum(Rebox_Data_String_CodePoints_3569500834_123048125(Rebox_Data_String_CodePoints_123048125_3569500834(gopurs_runtime.CoerceToStruct[Constructor_Data_Enum_BoundedEnum[gopurs_runtime.Value]](Get_Data_Enum_boundedEnumChar())))), gopurs_runtime.Func(func(x_0 gopurs_runtime.Value) gopurs_runtime.Value {
return x_0
}))
	})
...
return gopurs_runtime.Value{Type: 9, IntVal: 1435789946, UnsafePtr: unsafe.Pointer(Rebox_Data_String_CodePoints_3308271157_4177771502(Rebox_Data_String_CodePoints_4177771502_3308271157(gopurs_runtime.CoerceToStruct[Constructor_Data_Ord_Ord[gopurs_runtime.Value]](Get_Data_String_CodePoints_ordCodePoint()))))}
...
return gopurs_runtime.Value{Type: 9, IntVal: 3510799738, UnsafePtr: unsafe.Pointer(Rebox_Data_String_CodePoints_3764732725_2094947566(Rebox_Data_String_CodePoints_2094947566_3764732725(gopurs_runtime.CoerceToStruct[Constructor_Data_Bounded_Bounded[gopurs_runtime.Value]](Get_Data_String_CodePoints_boundedCodePoint()))))}
}), gopurs_runtime.Func(func(_dollar___unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 4075786298, UnsafePtr: unsafe.Pointer(Rebox_Data_String_CodePoints_4060049525_556578094(Rebox_Data_String_CodePoints_556578094_4060049525(gopurs_runtime.CoerceToStruct[Constructor_Data_Enum_Enum[gopurs_runtime.Value]](Get_Data_String_CodePoints_enumCodePoint()))))}
...
__t0 = Rebox_Data_String_CodePoints_3094389156_1170268447(gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just[gopurs_runtime.Value]](func() gopurs_runtime.Value {
...
end_branch_0:
return gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Rebox_Data_String_CodePoints_1170268447_3094389156(__t0))}
})})))}
	})
...
return gopurs_runtime.Value{Type: 9, IntVal: 1435789946, UnsafePtr: unsafe.Pointer(Rebox_Data_String_CodePoints_3308271157_4177771502(Rebox_Data_String_CodePoints_4177771502_3308271157(gopurs_runtime.CoerceToStruct[Constructor_Data_Ord_Ord[gopurs_runtime.Value]](Get_Data_String_CodePoints_ordCodePoint()))))}
}), gopurs_runtime.Apply2(Get_Data_Enum_defaultPred__2406132389(), Call_Data_Enum_toEnum(Rebox_Data_String_CodePoints_1306125126_123048125(Rebox_Data_String_CodePoints_123048125_1306125126(gopurs_runtime.CoerceToStruct[Constructor_Data_Enum_BoundedEnum[gopurs_runtime.Value]](Get_Data_String_CodePoints_boundedEnumCodePoint())))), Call_Data_Enum_fromEnum(Rebox_Data_String_CodePoints_1306125126_123048125(Rebox_Data_String_CodePoints_123048125_1306125126(gopurs_runtime.CoerceToStruct[Constructor_Data_Enum_BoundedEnum[gopurs_runtime.Value]](Get_Data_String_CodePoints_boundedEnumCodePoint()))))), gopurs_runtime.Apply2(Get_Data_Enum_defaultSucc__2406132389(), Call_Data_Enum_toEnum(Rebox_Data_String_CodePoints_1306125126_123048125(Rebox_Data_String_CodePoints_123048125_1306125126(gopurs_runtime.CoerceToStruct[Constructor_Data_Enum_BoundedEnum[gopurs_runtime.Value]](Get_Data_String_CodePoints_boundedEnumCodePoint())))), Call_Data_Enum_fromEnum(Rebox_Data_String_CodePoints_1306125126_123048125(Rebox_Data_String_CodePoints_123048125_1306125126(gopurs_runtime.CoerceToStruct[Constructor_Data_Enum_BoundedEnum[gopurs_runtime.Value]](Get_Data_String_CodePoints_boundedEnumCodePoint())))))})))}
	})
...
return gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Rebox_Data_String_CodePoints_1170268447_3094389156(Rebox_Data_String_CodePoints_3094389156_1170268447(gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just[gopurs_runtime.Value]](func() gopurs_runtime.Value {
				_v := struct{V0 gopurs_runtime.Value; V1 bool}{gopurs_runtime.Value{}, false}
				if _v.V1 {
					return gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&Constructor_Data_Maybe_Just[gopurs_runtime.Value]{Rc: 1, V0: _v.V0})}
				}
...
return x_1
}), gopurs_runtime.Apply2(Call_Control_Semigroupoid_compose(gopurs_runtime.CoerceToStruct[Constructor_Control_Semigroupoid_Semigroupoid[gopurs_runtime.Value]](Get_Control_Semigroupoid_semigroupoidFn())), Call_Data_Enum_fromEnum(Rebox_Data_String_CodePoints_3569500834_123048125(Rebox_Data_String_CodePoints_123048125_3569500834(gopurs_runtime.CoerceToStruct[Constructor_Data_Enum_BoundedEnum[gopurs_runtime.Value]](Get_Data_Enum_boundedEnumChar())))), gopurs_runtime.Apply(Get_Data_String_Unsafe_charAt(), gopurs_runtime.Int(int64(0))))), gopurs_runtime.Int(int64(0)), gopurs_runtime.Str(s_0))))
_ = v_1_0
...
{
if (v_1_0 == nil) {
__t1 = Rebox_Data_String_CodePoints_3094389156_1387998409(gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just[gopurs_runtime.Value]](func() gopurs_runtime.Value {
				_v := struct{V0 gopurs_runtime.Value; V1 bool}{gopurs_runtime.Value{}, false}
				if _v.V1 {
					return gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&Constructor_Data_Maybe_Just[gopurs_runtime.Value]{Rc: 1, V0: _v.V0})}
				}
...
return func() struct{V0 gopurs_runtime.Value; V1 bool} {
				_v := gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Rebox_Data_String_CodePoints_1387998409_3094389156(__t1))}
...
{
if __local_var_1_0.V1 {
__t1 = gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just[gopurs_runtime.Value]](func() gopurs_runtime.Value {
				_v := struct{V0 gopurs_runtime.Value; V1 bool}{gopurs_runtime.Value{Type: 9, IntVal: 2339352186, UnsafePtr: unsafe.Pointer(Rebox_Data_String_CodePoints_2169642284_138441832(Rebox_Data_String_CodePoints_138441832_2169642284(gopurs_runtime.CoerceToStruct[Constructor_Data_Tuple_Tuple[gopurs_runtime.Value, gopurs_runtime.Value]](func() gopurs_runtime.Value {
				_v := struct{V0 gopurs_runtime.Value; V1 gopurs_runtime.Value}{gopurs_runtime.Int(gopurs_runtime.RecordGet((*Constructor_Data_Maybe_Just[gopurs_runtime.Value])(func() gopurs_runtime.Value {
				_v := __local_var_1_0
				if _v.V1 {
					return gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&Constructor_Data_Maybe_Just[gopurs_runtime.Value]{Rc: 1, V0: _v.V0})}
				}
				return gopurs_runtime.Value{Type: 9, IntVal: 930809136}
			}().UnsafePtr).V0, "head").IntVal), gopurs_runtime.Str(gopurs_runtime.RecordGet((*Constructor_Data_Maybe_Just[gopurs_runtime.Value])(func() gopurs_runtime.Value {
				_v := __local_var_1_0
				if _v.V1 {
					return gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&Constructor_Data_Maybe_Just[gopurs_runtime.Value]{Rc: 1, V0: _v.V0})}
				}
				return gopurs_runtime.Value{Type: 9, IntVal: 930809136}
			}().UnsafePtr).V0, "tail").StrVal())}
...
return func() []int64 {
					...
					arr := *(*[]gopurs_runtime.Value)(gopurs_runtime.Apply6(Get_Data_Unfoldable_unfoldrArrayImpl(), Get_Data_Maybe_isNothing(), gopurs_runtime.Func(func(v_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
_ = __t_tag_0
if (__t_tag_0 != nil) {
__t1 = (*Constructor_Data_Maybe_Just[gopurs_runtime.Value])(v_1.UnsafePtr).V0
goto end_branch_1
} else {
...
end_branch_1:
return __t1
}), Get_Data_Tuple_fst(), Get_Data_Tuple_snd(), Get_Data_String_CodePoints_unconsButWithTuple(), gopurs_runtime.Str(s_0)).UnsafePtr)
...
__local_var_2_0 := gopurs_runtime.Apply2(Get_Data_String_CodeUnits_lastIndexOf(), gopurs_runtime.Str(p_0), gopurs_runtime.Str(s_1))
_ = __local_var_2_0
var __t1 *Constructor_Data_Maybe_Just[gopurs_runtime.Value]
{
if (__local_var_2_0.Type == 9 && __local_var_2_0.IntVal == 930809136 && __local_var_2_0.UnsafePtr != nil) {
__t1 = gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just[gopurs_runtime.Value]](func() gopurs_runtime.Value {
				_v := struct{V0 gopurs_runtime.Value; V1 bool}{gopurs_runtime.Int(gopurs_runtime.Apply(Get_Data_String_CodePoints_length(), gopurs_runtime.Str(gopurs_runtime.Apply2(Get_Data_String_CodeUnits_take(), gopurs_runtime.Int((*Constructor_Data_Maybe_Just[gopurs_runtime.Value])(__local_var_2_0.UnsafePtr).V0.IntVal), gopurs_runtime.Str(s_1)).StrVal())).IntVal), true}
				if _v.V1 {
					return gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&Constructor_Data_Maybe_Just[gopurs_runtime.Value]{Rc: 1, V0: _v.V0})}
				}
				return gopurs_runtime.Value{Type: 9, IntVal: 930809136}
...
_ = s_1
// TAST (Let): __local_var_2_0 shape=App(Var) bindingType=Any
__local_var_2_0 := gopurs_runtime.Apply2(Get_Data_String_CodeUnits_indexOf(), gopurs_runtime.Str(p_0), gopurs_runtime.Str(s_1))
_ = __local_var_2_0
var __t1 *Constructor_Data_Maybe_Just[gopurs_runtime.Value]
{
if (__local_var_2_0.Type == 9 && __local_var_2_0.IntVal == 930809136 && __local_var_2_0.UnsafePtr != nil) {
...
{
if (v_0) <= (int64(65535)) {
__t0 = gopurs_runtime.Apply(Get_Data_String_CodePoints_fromCharCode(), gopurs_runtime.Int(v_0)).StrVal()
goto end_branch_0
} else {
...
{
__t0 = (gopurs_runtime.Apply(Get_Data_String_CodePoints_fromCharCode(), gopurs_runtime.Int((gopurs_runtime.IntDiv((v_0) - (int64(65536)), int64(1024))) + (int64(55296)))).StrVal()) + (gopurs_runtime.Apply(Get_Data_String_CodePoints_fromCharCode(), gopurs_runtime.Int((gopurs_runtime.IntMod((v_0) - (int64(65536)), int64(1024))) + (int64(56320)))).StrVal())
}
end_branch_0:
return __t0
}
...
{
// TAST (Let): v2_2_0 shape=App(Var) bindingType=(ADT ["Data","Maybe","Maybe"] [(Record (Row [head: Int, tail: String] Empty))])
v2_2_0 := Rebox_Data_String_CodePoints_3094389156_1387998409(gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just[gopurs_runtime.Value]](func() gopurs_runtime.Value {
...
__local_var_3_0 := gopurs_runtime.Apply3(Get_Data_String_CodeUnits_lastIndexOf_prime_(), gopurs_runtime.Str(p_0), gopurs_runtime.Int(gopurs_runtime.Apply(Get_Data_String_CodeUnits_length(), gopurs_runtime.Str(gopurs_runtime.Apply2(Get_Data_String_CodePoints_take(), gopurs_runtime.Int(i_1), gopurs_runtime.Str(s_2)).StrVal())).IntVal), gopurs_runtime.Str(s_2))
_ = __local_var_3_0
var __t1 *Constructor_Data_Maybe_Just[gopurs_runtime.Value]
{
if (__local_var_3_0.Type == 9 && __local_var_3_0.IntVal == 930809136 && __local_var_3_0.UnsafePtr != nil) {
__t1 = gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just[gopurs_runtime.Value]](func() gopurs_runtime.Value {
				_v := struct{V0 gopurs_runtime.Value; V1 bool}{gopurs_runtime.Int(gopurs_runtime.Apply(Get_Data_String_CodePoints_length(), gopurs_runtime.Str(gopurs_runtime.Apply2(Get_Data_String_CodeUnits_take(), gopurs_runtime.Int((*Constructor_Data_Maybe_Just[gopurs_runtime.Value])(__local_var_3_0.UnsafePtr).V0.IntVal), gopurs_runtime.Str(s_2)).StrVal())).IntVal), true}
				if _v.V1 {
					return gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&Constructor_Data_Maybe_Just[gopurs_runtime.Value]{Rc: 1, V0: _v.V0})}
				}
				return gopurs_runtime.Value{Type: 9, IntVal: 930809136}
...
__local_var_4_1 := gopurs_runtime.Apply2(Get_Data_String_CodeUnits_indexOf(), gopurs_runtime.Str(p_0), gopurs_runtime.Str(s_prime__3_0))
_ = __local_var_4_1
...
__t2 = gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just[gopurs_runtime.Value]](func() gopurs_runtime.Value {
				_v := struct{V0 gopurs_runtime.Value; V1 bool}{gopurs_runtime.Int((i_1) + (gopurs_runtime.Apply(Get_Data_String_CodePoints_length(), gopurs_runtime.Str(gopurs_runtime.Apply2(Get_Data_String_CodeUnits_take(), gopurs_runtime.Int((*Constructor_Data_Maybe_Just[gopurs_runtime.Value])(__local_var_4_1.UnsafePtr).V0.IntVal), gopurs_runtime.Str(s_prime__3_0)).StrVal())).IntVal)), true}
				if _v.V1 {
					return gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&Constructor_Data_Maybe_Just[gopurs_runtime.Value]{Rc: 1, V0: _v.V0})}
				}
				return gopurs_runtime.Value{Type: 9, IntVal: 930809136}
...
_ = accum_2
// TAST (Let): v_3_0 shape=App(Var) bindingType=(ADT ["Data","Maybe","Maybe"] [(Record (Row [head: Int, tail: String] Empty))])
v_3_0 := Rebox_Data_String_CodePoints_3094389156_1387998409(gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just[gopurs_runtime.Value]](func() gopurs_runtime.Value {
...
var s_1 string = s_1_loop
_ = s_1
// TAST (Let): v_2_0 shape=App(Var) bindingType=(ADT ["Data","Maybe","Maybe"] [(Record (Row [head: Int, tail: String] Empty))])
v_2_0 := Rebox_Data_String_CodePoints_3094389156_1387998409(gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just[gopurs_runtime.Value]](func() gopurs_runtime.Value {
				_v := Call_Data_String_CodePoints_uncons(s_1)
				if _v.V1 {
					return gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&Constructor_Data_Maybe_Just[gopurs_runtime.Value]{Rc: 1, V0: _v.V0})}
				}
...
{
if (n_0) == (int64(0)) {
__t1 = Rebox_Data_String_CodePoints_3094389156_1170268447(gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just[gopurs_runtime.Value]](func() gopurs_runtime.Value {
				_v := struct{V0 gopurs_runtime.Value; V1 bool}{gopurs_runtime.Int((v_2_0).V0.head), true}
				if _v.V1 {
					return gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&Constructor_Data_Maybe_Just[gopurs_runtime.Value]{Rc: 1, V0: _v.V0})}
				}
				return gopurs_runtime.Value{Type: 9, IntVal: 930809136}
...
{
__t2 = Rebox_Data_String_CodePoints_3094389156_1170268447(gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just[gopurs_runtime.Value]](func() gopurs_runtime.Value {
				_v := struct{V0 gopurs_runtime.Value; V1 bool}{gopurs_runtime.Value{}, false}
				if _v.V1 {
					return gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&Constructor_Data_Maybe_Just[gopurs_runtime.Value]{Rc: 1, V0: _v.V0})}
				}
...
{
__t0 = Rebox_Data_String_CodePoints_3094389156_1170268447(gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just[gopurs_runtime.Value]](func() gopurs_runtime.Value {
				_v := struct{V0 gopurs_runtime.Value; V1 bool}{gopurs_runtime.Int(gopurs_runtime.Apply(Get_Data_String_CodePoints_unsafeCodePointAt0(), gopurs_runtime.Str(v1_1)).IntVal), true}
				if _v.V1 {
					return gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&Constructor_Data_Maybe_Just[gopurs_runtime.Value]{Rc: 1, V0: _v.V0})}
				}
				return gopurs_runtime.Value{Type: 9, IntVal: 930809136}
...
{
__t1 = Rebox_Data_String_CodePoints_3094389156_1170268447(gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just[gopurs_runtime.Value]](gopurs_runtime.Apply6(Get_Data_String_CodePoints__codePointAt(), Get_Data_String_CodePoints_codePointAtFallback(), Get_Data_Maybe_Just(), gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Maybe_Just[gopurs_runtime.Value]](func() gopurs_runtime.Value {
				_v := struct{V0 gopurs_runtime.Value; V1 bool}{gopurs_runtime.Value{}, false}
				if _v.V1 {
					return gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(&Constructor_Data_Maybe_Just[gopurs_runtime.Value]{Rc: 1, V0: _v.V0})}
				}
...
end_branch_1:
return func() struct{V0 gopurs_runtime.Value; V1 bool} {
				_v := gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer(Rebox_Data_String_CodePoints_1170268447_3094389156(__t1))}
				if _v.Type == 9 && _v.IntVal == 930809136 && _v.UnsafePtr != nil {
					return struct{V0 gopurs_runtime.Value; V1 bool}{V0: (*Constructor_Data_Maybe_Just[gopurs_runtime.Value])(_v.UnsafePtr).V0, V1: true}
				}
				return struct{V0 gopurs_runtime.Value; V1 bool}{V0: gopurs_runtime.Value{}, V1: false}
...
func Rebox_Data_String_CodePoints_123048125_1306125126(in *Constructor_Data_Enum_BoundedEnum[gopurs_runtime.Value]) *Constructor_Data_Enum_BoundedEnum[int64] {
	if in == nil { return nil }
...
func Rebox_Data_String_CodePoints_123048125_3569500834(in *Constructor_Data_Enum_BoundedEnum[gopurs_runtime.Value]) *Constructor_Data_Enum_BoundedEnum[string] {
	if in == nil { return nil }
...
func Rebox_Data_String_CodePoints_138441832_2169642284(in *Constructor_Data_Tuple_Tuple[gopurs_runtime.Value, gopurs_runtime.Value]) *Constructor_Data_Tuple_Tuple[int64, string] {
	if in == nil { return nil }
...
func Rebox_Data_String_CodePoints_2094947566_3764732725(in *Constructor_Data_Bounded_Bounded[gopurs_runtime.Value]) *Constructor_Data_Bounded_Bounded[int64] {
	if in == nil { return nil }
...
func Rebox_Data_String_CodePoints_3094389156_1387998409(in *Constructor_Data_Maybe_Just[gopurs_runtime.Value]) *Constructor_Data_Maybe_Just[struct{
	head int64
	tail string
}] {
	if in == nil { return nil }
...
func Rebox_Data_String_CodePoints_3569500834_123048125(in *Constructor_Data_Enum_BoundedEnum[string]) *Constructor_Data_Enum_BoundedEnum[gopurs_runtime.Value] {
	if in == nil { return nil }
	out := &Constructor_Data_Enum_BoundedEnum[gopurs_runtime.Value]{}
		out.V0 = in.V0
		out.V1 = in.V1
...
func Rebox_Data_String_CodePoints_3790796878_1053099733(in *Constructor_Data_Eq_Eq[gopurs_runtime.Value]) *Constructor_Data_Eq_Eq[int64] {
	if in == nil { return nil }
...
func Rebox_Data_String_CodePoints_4177771502_3308271157(in *Constructor_Data_Ord_Ord[gopurs_runtime.Value]) *Constructor_Data_Ord_Ord[int64] {
	if in == nil { return nil }
...
func Rebox_Data_String_CodePoints_556578094_4060049525(in *Constructor_Data_Enum_Enum[gopurs_runtime.Value]) *Constructor_Data_Enum_Enum[int64] {
	if in == nil { return nil }
