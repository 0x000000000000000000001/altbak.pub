...
var cache_Test_LazyEvaluation_Lazy__3873826587 gopurs_runtime.Value
var once_Test_LazyEvaluation_Lazy__3873826587 sync.Once
func Get_Test_LazyEvaluation_Lazy__3873826587() gopurs_runtime.Value {
	once_Test_LazyEvaluation_Lazy__3873826587.Do(func() {
		cache_Test_LazyEvaluation_Lazy__3873826587 = gopurs_runtime.Func(func(x_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_Test_LazyEvaluation_Lazy__3873826587(x_0_box)
})
	})
	return cache_Test_LazyEvaluation_Lazy__3873826587
}
...
var cache_Test_LazyEvaluation_force__3600449186 gopurs_runtime.Value
var once_Test_LazyEvaluation_force__3600449186 sync.Once
func Get_Test_LazyEvaluation_force__3600449186() gopurs_runtime.Value {
	once_Test_LazyEvaluation_force__3600449186.Do(func() {
		cache_Test_LazyEvaluation_force__3600449186 = gopurs_runtime.Func(func(v_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Int(Call_Test_LazyEvaluation_force__3600449186(v_0_box))
})
	})
	return cache_Test_LazyEvaluation_force__3600449186
}
...
func Get_Test_LazyEvaluation_go__defer() gopurs_runtime.Value {
	once_Test_LazyEvaluation_go__defer.Do(func() {
		cache_Test_LazyEvaluation_go__defer = Get_Test_LazyEvaluation_Lazy()
	})
	return cache_Test_LazyEvaluation_go__defer
}

var cache_Test_LazyEvaluation_defer__3873826587 gopurs_runtime.Value
var once_Test_LazyEvaluation_defer__3873826587 sync.Once
func Get_Test_LazyEvaluation_defer__3873826587() gopurs_runtime.Value {
	once_Test_LazyEvaluation_defer__3873826587.Do(func() {
		cache_Test_LazyEvaluation_defer__3873826587 = gopurs_runtime.Func(func(__eta_norm_0_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_Test_LazyEvaluation_defer__3873826587(__eta_norm_0_0_box)
})
	})
	return cache_Test_LazyEvaluation_defer__3873826587
}

var cache_Test_LazyEvaluation_buildThunks__gopurs_strict_thunk_0 gopurs_runtime.Value
var once_Test_LazyEvaluation_buildThunks__gopurs_strict_thunk_0 sync.Once
func Get_Test_LazyEvaluation_buildThunks__gopurs_strict_thunk_0() gopurs_runtime.Value {
	once_Test_LazyEvaluation_buildThunks__gopurs_strict_thunk_0.Do(func() {
		cache_Test_LazyEvaluation_buildThunks__gopurs_strict_thunk_0 = gopurs_runtime.Func2(func(v_0_box gopurs_runtime.Value, v1_1_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Int(Call_Test_LazyEvaluation_buildThunks__gopurs_strict_thunk_0(v_0_box.IntVal, v1_1_box.IntVal))
})
	})
	return cache_Test_LazyEvaluation_buildThunks__gopurs_strict_thunk_0
}
...
__local_var_0_0 := gopurs_runtime.Apply(Get_Bench_opaque(), gopurs_runtime.Int(int64(1000)))
_ = __local_var_0_0
__local_var_1_1 := gopurs_runtime.Apply(__local_var_0_0, gopurs_runtime.Value{})
_ = __local_var_1_1
return gopurs_runtime.Str(gopurs_runtime.Apply(Get_Data_Show_showIntImpl(), gopurs_runtime.Int(Call_Test_LazyEvaluation_runManyTimes(__local_var_1_1.IntVal, int64(0)))).StrVal())
})
	})
...
func Call_Test_LazyEvaluation_Lazy__3873826587(x_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
Lazy__3873826587:
for {
if false { continue Lazy__3873826587 }
var x_0 gopurs_runtime.Value = x_0_loop
_ = x_0
return x_0
}
...
func Call_Test_LazyEvaluation_force__3600449186(v_0_loop gopurs_runtime.Value) int64 {
force__3600449186:
for {
if false { continue force__3600449186 }
var v_0 gopurs_runtime.Value = v_0_loop
_ = v_0
...
func Call_Test_LazyEvaluation_defer__3873826587(__eta_norm_0_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
defer__3873826587:
for {
if false { continue defer__3873826587 }
...
func Call_Test_LazyEvaluation_buildThunks__gopurs_strict_thunk_0(v_0_loop int64, v1_1_loop int64) int64 {
buildThunks__gopurs_strict_thunk_0:
for {
if false { continue buildThunks__gopurs_strict_thunk_0 }
...
continue buildThunks__gopurs_strict_thunk_0
...
{
v_0_loop = (v_0) - (int64(1))
v1_1_loop = (v1_1) + (Call_Test_LazyEvaluation_buildThunks__gopurs_strict_thunk_0(int64(1000), int64(0)))
