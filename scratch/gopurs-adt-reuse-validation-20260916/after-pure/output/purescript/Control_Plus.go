...
var cache_Control_Plus_empty__3496692483 gopurs_runtime.Value
var once_Control_Plus_empty__3496692483 sync.Once
func Get_Control_Plus_empty__3496692483() gopurs_runtime.Value {
	once_Control_Plus_empty__3496692483.Do(func() {
		cache_Control_Plus_empty__3496692483 = gopurs_runtime.Value{Type: 9, IntVal: 1358893437, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_List_Types_Cons[gopurs_runtime.Value]](Rebox_Control_Plus_3706288089_2173899317(gopurs_runtime.CoerceToStruct[Constructor_Control_Plus_Plus[gopurs_runtime.Value]](Get_Data_List_Types_plusList())).V1))}
	})
	return cache_Control_Plus_empty__3496692483
}
...
return gopurs_runtime.CoerceToStruct[Constructor_Control_Plus_Plus[gopurs_runtime.Value]](func() gopurs_runtime.Value {
				orig := x_0
				_ = orig
				return gopurs_runtime.RecordDict2("Alt0", "empty", orig.Alt0, orig.empty)
				}())
}
...
func Rebox_Control_Plus_3706288089_2173899317(in *Constructor_Control_Plus_Plus[gopurs_runtime.Value]) *Constructor_Control_Plus_Plus[*Constructor_Data_List_Types_Cons[gopurs_runtime.Value]] {
