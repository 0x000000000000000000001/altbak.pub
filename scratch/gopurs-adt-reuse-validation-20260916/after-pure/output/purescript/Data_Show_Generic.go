...
var cache_Data_Show_Generic_GenericShowArgs_dollar_Dict__2157713097 gopurs_runtime.Value
var once_Data_Show_Generic_GenericShowArgs_dollar_Dict__2157713097 sync.Once
func Get_Data_Show_Generic_GenericShowArgs_dollar_Dict__2157713097() gopurs_runtime.Value {
	once_Data_Show_Generic_GenericShowArgs_dollar_Dict__2157713097.Do(func() {
		cache_Data_Show_Generic_GenericShowArgs_dollar_Dict__2157713097 = gopurs_runtime.Func(func(x_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 1968625250, UnsafePtr: unsafe.Pointer(Rebox_Data_Show_Generic_127695515_242610358(Call_Data_Show_Generic_GenericShowArgs_dollar_Dict__2157713097(func() struct{
	genericShowArgs gopurs_runtime.Value
} {
					orig := x_0_box
					_ = orig
	...
	return cache_Data_Show_Generic_GenericShowArgs_dollar_Dict__2157713097
}
...
var cache_Data_Show_Generic_GenericShow_dollar_Dict__1642615176 gopurs_runtime.Value
var once_Data_Show_Generic_GenericShow_dollar_Dict__1642615176 sync.Once
func Get_Data_Show_Generic_GenericShow_dollar_Dict__1642615176() gopurs_runtime.Value {
	once_Data_Show_Generic_GenericShow_dollar_Dict__1642615176.Do(func() {
		cache_Data_Show_Generic_GenericShow_dollar_Dict__1642615176 = gopurs_runtime.Func(func(x_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 2730968613, UnsafePtr: unsafe.Pointer(Call_Data_Show_Generic_GenericShow_dollar_Dict__1642615176(func() struct{
	genericShow_prime_ gopurs_runtime.Value
} {
					orig := x_0_box
					_ = orig
	...
	return cache_Data_Show_Generic_GenericShow_dollar_Dict__1642615176
}
...
var cache_Data_Show_Generic_genericShow_prime___618339430 gopurs_runtime.Value
var once_Data_Show_Generic_genericShow_prime___618339430 sync.Once
func Get_Data_Show_Generic_genericShow_prime___618339430() gopurs_runtime.Value {
	once_Data_Show_Generic_genericShow_prime___618339430.Do(func() {
		cache_Data_Show_Generic_genericShow_prime___618339430 = gopurs_runtime.Func(func(__eta_norm_0_0 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Str(gopurs_runtime.Apply(gopurs_runtime.CoerceToStruct[Constructor_Data_Show_Generic_GenericShow[gopurs_runtime.Value]](Get_Data_Show_Generic_genericShowNoConstructors()).V0, __eta_norm_0_0).StrVal())
})
	})
	return cache_Data_Show_Generic_genericShow_prime___618339430
}
...
return gopurs_runtime.Str(gopurs_runtime.Apply(Get_Data_Show_Generic_genericShow_prime___618339430(), a_0).StrVal())
})}))}
	})
...
func init() {
	gopurs_runtime.StructGetters[1968625250] = func(ptr unsafe.Pointer, key string) gopurs_runtime.Value {
		c := (*Constructor_Data_Show_Generic_GenericShowArgs[gopurs_runtime.Value])(ptr)
		_ = c
		switch key {
...
func init() {
	gopurs_runtime.StructGetters[2730968613] = func(ptr unsafe.Pointer, key string) gopurs_runtime.Value {
		c := (*Constructor_Data_Show_Generic_GenericShow[gopurs_runtime.Value])(ptr)
		_ = c
		switch key {
...
func Call_Data_Show_Generic_GenericShowArgs_dollar_Dict__2157713097(x_0_loop struct{
	genericShowArgs gopurs_runtime.Value
}) *Constructor_Data_Show_Generic_GenericShowArgs[uint32] {
GenericShowArgs_dollar_Dict__2157713097:
for {
if false { continue GenericShowArgs_dollar_Dict__2157713097 }
var x_0 struct{
	genericShowArgs gopurs_runtime.Value
} = x_0_loop
_ = x_0
return gopurs_runtime.CoerceToStruct[Constructor_Data_Show_Generic_GenericShowArgs[uint32]](func() gopurs_runtime.Value {
				orig := x_0
				_ = orig
				return gopurs_runtime.RecordDict1("genericShowArgs", orig.genericShowArgs)
				}())
...
func Call_Data_Show_Generic_GenericShow_dollar_Dict__1642615176(x_0_loop struct{
	genericShow_prime_ gopurs_runtime.Value
}) *Constructor_Data_Show_Generic_GenericShow[gopurs_runtime.Value] {
GenericShow_dollar_Dict__1642615176:
for {
if false { continue GenericShow_dollar_Dict__1642615176 }
var x_0 struct{
	genericShow_prime_ gopurs_runtime.Value
} = x_0_loop
_ = x_0
