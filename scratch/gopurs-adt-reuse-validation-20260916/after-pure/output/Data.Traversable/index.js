    ...
    traverse: function (dictApplicative) {
        ...
        return function (v) {
            return function (v1) {
                ...
                throw new Error("Failed pattern match at Data.Traversable (line 116, column 1 - line 120, column 33): " + [ v.constructor.name, v1.constructor.name ]);
            };
        };
    },
    sequence: function (dictApplicative) {
        ...
        return function (v) {
            ...
            throw new Error("Failed pattern match at Data.Traversable (line 116, column 1 - line 120, column 33): " + [ v.constructor.name ]);
        };
    },
    Functor0: function () {
    ...
    traverse: function (dictApplicative) {
        ...
        return function (v) {
            return function (v1) {
                ...
                throw new Error("Failed pattern match at Data.Traversable (line 150, column 1 - line 154, column 36): " + [ v.constructor.name, v1.constructor.name ]);
            };
        };
    },
    sequence: function (dictApplicative) {
        ...
        return function (v) {
            ...
            throw new Error("Failed pattern match at Data.Traversable (line 150, column 1 - line 154, column 36): " + [ v.constructor.name ]);
        };
    },
    Functor0: function () {
...
var $lazy_traversableArray = /* #__PURE__ */ $runtime_lazy("traversableArray", "Data.Traversable", function () {
    return {
        traverse: function (dictApplicative) {
            ...
            return $foreign.traverseArrayImpl(Control_Apply.apply(Apply0))(Data_Functor.map(Apply0.Functor0()))(Control_Applicative.pure(dictApplicative))(append);
        },
        sequence: function (dictApplicative) {
    ...
    return function (dictTraversable1) {
        ...
        return {
            traverse: function (dictApplicative) {
                ...
                return function (f) {
                    return Data_Functor_Coproduct.coproduct((function () {
                        var $240 = Data_Functor.map(Functor0)(function ($243) {
                            return Data_Functor_Coproduct.Coproduct(Data_Either.Left.create($243));
                        });
                        var $241 = traverse(dictTraversable)(dictApplicative)(f);
                        return function ($242) {
                            return $240($241($242));
                        };
                    })())((function () {
                        var $244 = Data_Functor.map(Functor0)(function ($247) {
                            return Data_Functor_Coproduct.Coproduct(Data_Either.Right.create($247));
                        });
                        var $245 = traverse(dictTraversable1)(dictApplicative)(f);
                        return function ($246) {
                            return $244($245($246));
                        };
                    })());
            ...
            sequence: function (dictApplicative) {
                var Functor0 = (dictApplicative.Apply0()).Functor0();
                return Data_Functor_Coproduct.coproduct((function () {
                    var $248 = Data_Functor.map(Functor0)(function ($251) {
                        return Data_Functor_Coproduct.Coproduct(Data_Either.Left.create($251));
                    });
                    var $249 = sequence1(dictApplicative);
                    return function ($250) {
                        return $248($249($250));
                    };
                })())((function () {
                    var $252 = Data_Functor.map(Functor0)(function ($255) {
                        return Data_Functor_Coproduct.Coproduct(Data_Either.Right.create($255));
                    });
                    var $253 = sequence2(dictApplicative);
                    return function ($254) {
                        return $252($253($254));
                    };
                })());
