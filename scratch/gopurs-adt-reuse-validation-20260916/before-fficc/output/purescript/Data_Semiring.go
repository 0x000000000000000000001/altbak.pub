...
var cache_Data_Semiring_Semiring_dollar_Dict__3398275504 gopurs_runtime.Value
var once_Data_Semiring_Semiring_dollar_Dict__3398275504 sync.Once
func Get_Data_Semiring_Semiring_dollar_Dict__3398275504() gopurs_runtime.Value {
	once_Data_Semiring_Semiring_dollar_Dict__3398275504.Do(func() {
		cache_Data_Semiring_Semiring_dollar_Dict__3398275504 = gopurs_runtime.Func(func(x_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 134961754, UnsafePtr: unsafe.Pointer(Rebox_Data_Semiring_2722024963_2826095630(Call_Data_Semiring_Semiring_dollar_Dict__3398275504(func() struct{
	add gopurs_runtime.Value
	mul gopurs_runtime.Value
	one uint32
	zero uint32
	...
	zero uint32
					...
					clone.add = gopurs_runtime.RecordGet(orig, "add")
					clone.mul = gopurs_runtime.RecordGet(orig, "mul")
					clone.one = uint32(gopurs_runtime.RecordGet(orig, "one").IntVal)
					clone.zero = uint32(gopurs_runtime.RecordGet(orig, "zero").IntVal)
					return clone
				}())))}
})
	})
	return cache_Data_Semiring_Semiring_dollar_Dict__3398275504
}

var cache_Data_Semiring_Semiring_dollar_Dict__3438907593 gopurs_runtime.Value
var once_Data_Semiring_Semiring_dollar_Dict__3438907593 sync.Once
func Get_Data_Semiring_Semiring_dollar_Dict__3438907593() gopurs_runtime.Value {
	once_Data_Semiring_Semiring_dollar_Dict__3438907593.Do(func() {
		cache_Data_Semiring_Semiring_dollar_Dict__3438907593 = gopurs_runtime.Func(func(x_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 134961754, UnsafePtr: unsafe.Pointer(Rebox_Data_Semiring_348932501_2826095630(Call_Data_Semiring_Semiring_dollar_Dict__3438907593(func() struct{
	add gopurs_runtime.Value
	mul gopurs_runtime.Value
	one int64
	zero int64
	...
	zero int64
					...
					clone.add = gopurs_runtime.RecordGet(orig, "add")
					clone.mul = gopurs_runtime.RecordGet(orig, "mul")
					clone.one = gopurs_runtime.RecordGet(orig, "one").IntVal
					clone.zero = gopurs_runtime.RecordGet(orig, "zero").IntVal
					return clone
				}())))}
})
	})
	return cache_Data_Semiring_Semiring_dollar_Dict__3438907593
}

var cache_Data_Semiring_Semiring_dollar_Dict__1705398553 gopurs_runtime.Value
var once_Data_Semiring_Semiring_dollar_Dict__1705398553 sync.Once
func Get_Data_Semiring_Semiring_dollar_Dict__1705398553() gopurs_runtime.Value {
	once_Data_Semiring_Semiring_dollar_Dict__1705398553.Do(func() {
		cache_Data_Semiring_Semiring_dollar_Dict__1705398553 = gopurs_runtime.Func(func(x_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 134961754, UnsafePtr: unsafe.Pointer(Rebox_Data_Semiring_602713622_2826095630(Call_Data_Semiring_Semiring_dollar_Dict__1705398553(func() struct{
	add gopurs_runtime.Value
	mul gopurs_runtime.Value
	one float64
	zero float64
	...
	zero float64
					...
					clone.add = gopurs_runtime.RecordGet(orig, "add")
					clone.mul = gopurs_runtime.RecordGet(orig, "mul")
					clone.one = gopurs_runtime.RecordGet(orig, "one").FloatVal()
					clone.zero = gopurs_runtime.RecordGet(orig, "zero").FloatVal()
					return clone
				}())))}
})
	})
	return cache_Data_Semiring_Semiring_dollar_Dict__1705398553
}

var cache_Data_Semiring_Semiring_dollar_Dict__30510428 gopurs_runtime.Value
var once_Data_Semiring_Semiring_dollar_Dict__30510428 sync.Once
func Get_Data_Semiring_Semiring_dollar_Dict__30510428() gopurs_runtime.Value {
	once_Data_Semiring_Semiring_dollar_Dict__30510428.Do(func() {
		cache_Data_Semiring_Semiring_dollar_Dict__30510428 = gopurs_runtime.Func(func(x_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 134961754, UnsafePtr: unsafe.Pointer(Call_Data_Semiring_Semiring_dollar_Dict__30510428(func() struct{
	add gopurs_runtime.Value
	mul gopurs_runtime.Value
	one gopurs_runtime.Value
	zero gopurs_runtime.Value
	...
	return cache_Data_Semiring_Semiring_dollar_Dict__30510428
}
...
var cache_Data_Semiring_mul__1135989556 gopurs_runtime.Value
var once_Data_Semiring_mul__1135989556 sync.Once
func Get_Data_Semiring_mul__1135989556() gopurs_runtime.Value {
	once_Data_Semiring_mul__1135989556.Do(func() {
		cache_Data_Semiring_mul__1135989556 = gopurs_runtime.Func2(func(__eta_norm_1_0_box gopurs_runtime.Value, __eta_norm_0_1_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Int(Call_Data_Semiring_mul__1135989556(__eta_norm_1_0_box.IntVal, __eta_norm_0_1_box.IntVal))
})
	})
	return cache_Data_Semiring_mul__1135989556
}

var cache_Data_Semiring_mul__2506932 gopurs_runtime.Value
var once_Data_Semiring_mul__2506932 sync.Once
func Get_Data_Semiring_mul__2506932() gopurs_runtime.Value {
	once_Data_Semiring_mul__2506932.Do(func() {
		cache_Data_Semiring_mul__2506932 = gopurs_runtime.Func2(func(__eta_norm_1_0_box gopurs_runtime.Value, __eta_norm_0_1_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Float(Call_Data_Semiring_mul__2506932(__eta_norm_1_0_box.FloatVal(), __eta_norm_0_1_box.FloatVal()))
})
	})
	return cache_Data_Semiring_mul__2506932
}
...
var cache_Data_Semiring_add__2675837446 gopurs_runtime.Value
var once_Data_Semiring_add__2675837446 sync.Once
func Get_Data_Semiring_add__2675837446() gopurs_runtime.Value {
	once_Data_Semiring_add__2675837446.Do(func() {
		cache_Data_Semiring_add__2675837446 = gopurs_runtime.Func2(func(__eta_norm_0_0_box gopurs_runtime.Value, __local_var_1_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Int(Call_Data_Semiring_add__2675837446(__eta_norm_0_0_box.IntVal, __local_var_1_box.IntVal))
})
	})
	return cache_Data_Semiring_add__2675837446
}

var cache_Data_Semiring_add__1135989556 gopurs_runtime.Value
var once_Data_Semiring_add__1135989556 sync.Once
func Get_Data_Semiring_add__1135989556() gopurs_runtime.Value {
	once_Data_Semiring_add__1135989556.Do(func() {
		cache_Data_Semiring_add__1135989556 = gopurs_runtime.Func2(func(__eta_norm_1_0_box gopurs_runtime.Value, __eta_norm_0_1_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Int(Call_Data_Semiring_add__1135989556(__eta_norm_1_0_box.IntVal, __eta_norm_0_1_box.IntVal))
})
	})
	return cache_Data_Semiring_add__1135989556
}

var cache_Data_Semiring_add__2506932 gopurs_runtime.Value
var once_Data_Semiring_add__2506932 sync.Once
func Get_Data_Semiring_add__2506932() gopurs_runtime.Value {
	once_Data_Semiring_add__2506932.Do(func() {
		cache_Data_Semiring_add__2506932 = gopurs_runtime.Func2(func(__eta_norm_1_0_box gopurs_runtime.Value, __eta_norm_0_1_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Float(Call_Data_Semiring_add__2506932(__eta_norm_1_0_box.FloatVal(), __eta_norm_0_1_box.FloatVal()))
})
	})
	return cache_Data_Semiring_add__2506932
}
...
return gopurs_runtime.CoerceToStruct[Constructor_Data_Semiring_SemiringRecord[gopurs_runtime.Value, gopurs_runtime.Value, gopurs_runtime.Value]](func() gopurs_runtime.Value {
				orig := x_0
				_ = orig
				return gopurs_runtime.RecordDict4("addRecord", "mulRecord", "oneRecord", "zeroRecord", orig.addRecord, orig.mulRecord, orig.oneRecord, orig.zeroRecord)
				}())
}
...
return gopurs_runtime.CoerceToStruct[Constructor_Data_Semiring_Semiring[gopurs_runtime.Value]](func() gopurs_runtime.Value {
				orig := x_0
				_ = orig
				return gopurs_runtime.RecordDict4("add", "mul", "one", "zero", orig.add, orig.mul, orig.one, orig.zero)
				}())
}

func Call_Data_Semiring_Semiring_dollar_Dict__3398275504(x_0_loop struct{
	add gopurs_runtime.Value
	mul gopurs_runtime.Value
	one uint32
	zero uint32
}) *Constructor_Data_Semiring_Semiring[uint32] {
Semiring_dollar_Dict__3398275504:
for {
if false { continue Semiring_dollar_Dict__3398275504 }
var x_0 struct{
	add gopurs_runtime.Value
	mul gopurs_runtime.Value
	one uint32
...
_ = x_0
return gopurs_runtime.CoerceToStruct[Constructor_Data_Semiring_Semiring[uint32]](func() gopurs_runtime.Value {
				orig := x_0
				_ = orig
				return gopurs_runtime.RecordDict4("add", "mul", "one", "zero", orig.add, orig.mul, gopurs_runtime.Value{Type: 9, IntVal: int64(orig.one), UnsafePtr: nil}, gopurs_runtime.Value{Type: 9, IntVal: int64(orig.zero), UnsafePtr: nil})
				}())
}
}

func Call_Data_Semiring_Semiring_dollar_Dict__3438907593(x_0_loop struct{
	add gopurs_runtime.Value
	mul gopurs_runtime.Value
	one int64
	zero int64
}) *Constructor_Data_Semiring_Semiring[int64] {
Semiring_dollar_Dict__3438907593:
for {
if false { continue Semiring_dollar_Dict__3438907593 }
var x_0 struct{
	add gopurs_runtime.Value
	mul gopurs_runtime.Value
	one int64
...
_ = x_0
return gopurs_runtime.CoerceToStruct[Constructor_Data_Semiring_Semiring[int64]](func() gopurs_runtime.Value {
				orig := x_0
				_ = orig
				return gopurs_runtime.RecordDict4("add", "mul", "one", "zero", orig.add, orig.mul, gopurs_runtime.Int(orig.one), gopurs_runtime.Int(orig.zero))
				}())
}
}

func Call_Data_Semiring_Semiring_dollar_Dict__1705398553(x_0_loop struct{
	add gopurs_runtime.Value
	mul gopurs_runtime.Value
	one float64
	zero float64
}) *Constructor_Data_Semiring_Semiring[float64] {
Semiring_dollar_Dict__1705398553:
for {
if false { continue Semiring_dollar_Dict__1705398553 }
var x_0 struct{
	add gopurs_runtime.Value
	mul gopurs_runtime.Value
	one float64
...
_ = x_0
return gopurs_runtime.CoerceToStruct[Constructor_Data_Semiring_Semiring[float64]](func() gopurs_runtime.Value {
				orig := x_0
				_ = orig
				return gopurs_runtime.RecordDict4("add", "mul", "one", "zero", orig.add, orig.mul, gopurs_runtime.Float(orig.one), gopurs_runtime.Float(orig.zero))
				}())
}
}

func Call_Data_Semiring_Semiring_dollar_Dict__30510428(x_0_loop struct{
	add gopurs_runtime.Value
	mul gopurs_runtime.Value
	one gopurs_runtime.Value
	zero gopurs_runtime.Value
}) *Constructor_Data_Semiring_Semiring[gopurs_runtime.Value] {
Semiring_dollar_Dict__30510428:
for {
if false { continue Semiring_dollar_Dict__30510428 }
var x_0 struct{
	add gopurs_runtime.Value
	mul gopurs_runtime.Value
	one gopurs_runtime.Value
...
func Call_Data_Semiring_mul__1135989556(__eta_norm_1_0_loop int64, __eta_norm_0_1_loop int64) int64 {
mul__1135989556:
for {
if false { continue mul__1135989556 }
...
func Call_Data_Semiring_mul__2506932(__eta_norm_1_0_loop float64, __eta_norm_0_1_loop float64) float64 {
mul__2506932:
for {
if false { continue mul__2506932 }
...
func Call_Data_Semiring_add__2675837446(__eta_norm_0_0_loop int64, __local_var_1_loop int64) int64 {
add__2675837446:
for {
if false { continue add__2675837446 }
var __eta_norm_0_0 int64 = __eta_norm_0_0_loop
_ = __eta_norm_0_0
var __local_var_1 int64 = __local_var_1_loop
_ = __local_var_1
return (__eta_norm_0_0) + (__local_var_1)
}
}

func Call_Data_Semiring_add__1135989556(__eta_norm_1_0_loop int64, __eta_norm_0_1_loop int64) int64 {
add__1135989556:
for {
if false { continue add__1135989556 }
var __eta_norm_1_0 int64 = __eta_norm_1_0_loop
_ = __eta_norm_1_0
var __eta_norm_0_1 int64 = __eta_norm_0_1_loop
_ = __eta_norm_0_1
...
func Call_Data_Semiring_add__2506932(__eta_norm_1_0_loop float64, __eta_norm_0_1_loop float64) float64 {
add__2506932:
for {
if false { continue add__2506932 }
var __eta_norm_1_0 float64 = __eta_norm_1_0_loop
_ = __eta_norm_1_0
var __eta_norm_0_1 float64 = __eta_norm_0_1_loop
_ = __eta_norm_0_1
...
_ = dictSemiring_3
// TAST (Let): one1_4_0 shape=App(Var) bindingType=(TypeVar focus$scope65)
one1_4_0 := Call_Data_Semiring_one(dictSemiring_3)
_ = one1_4_0
// TAST (Let): zero1_5_1 shape=App(Var) bindingType=(TypeVar focus$scope65)
zero1_5_1 := Call_Data_Semiring_zero(dictSemiring_3)
_ = zero1_5_1
...
_ = key_9_2
// TAST (Let): get__3905987523_10_3 shape=App(Var) bindingType=(Func [(Record (Row [] (TypeVar row$scope69)))] (TypeVar focus$scope65))
...
_ = key_9_4
// TAST (Let): get__3905987523_10_5 shape=App(Var) bindingType=(Func [(Record (Row [] (TypeVar row$scope69)))] (TypeVar focus$scope65))
