...
return gopurs_runtime.Apply2(dictApply_0.V1, gopurs_runtime.Apply2(Functor0_1_0.V0, Get_Data_Tuple_Tuple(), a_2), b_3)
})
}
...
_ = Bind1_2_0
// TAST (Let): Apply0_3_1 shape=App(Other) bindingType=(ADT ["Control","Apply","Apply"] [(TypeVar m$scope11)])
...
_ = Apply0_3_1
// TAST (Let): Functor0_4_2 shape=App(Other) bindingType=(ADT ["Data","Functor","Functor"] [(TypeVar m$scope11)])
...
return gopurs_runtime.Apply2(Apply0_3_1.V1, gopurs_runtime.Apply2(Functor0_4_2.V0, Get_Data_NonEmpty_NonEmpty(), gen_6), gopurs_runtime.Apply2(dictMonadGen_1.V4, gopurs_runtime.Apply2(Call_Control_Semigroupoid_compose(gopurs_runtime.CoerceToStruct[Constructor_Control_Semigroupoid_Semigroupoid[gopurs_runtime.Value]](Get_Control_Semigroupoid_semigroupoidFn())), gopurs_runtime.Apply(Get_Data_Ord_max__1543342374(), gopurs_runtime.Int(int64(0))), gopurs_runtime.Func(func(v_7 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Int((v_7.IntVal) - (int64(1)))
})), gopurs_runtime.Apply2(Call_Control_Monad_Gen_unfoldable(dictMonadRec_0, dictMonadGen_1), gopurs_runtime.Value{Type: 9, IntVal: 2670894170, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Unfoldable_Unfoldable[gopurs_runtime.Value]](dictUnfoldable_5))}, gen_6)))
})
}
...
_ = Monad0_1_0
// TAST (Let): Bind1_2_1 shape=App(Other) bindingType=(ADT ["Control","Bind","Bind"] [(TypeVar m$scope19)])
...
_ = Bind1_2_1
// TAST (Let): Functor0_3_2 shape=App(Other) bindingType=(ADT ["Data","Functor","Functor"] [(TypeVar m$scope19)])
...
_ = Functor0_3_2
// TAST (Let): Applicative0_4_3 shape=App(Other) bindingType=(ADT ["Control","Applicative","Applicative"] [(TypeVar m$scope19)])
...
__t5 = gopurs_runtime.Apply2(Functor0_3_2.V0, Get_Data_Maybe_Just(), gen_6)
goto end_branch_5
} else {
...
_ = dictFunctor_0
return gopurs_runtime.Apply(dictFunctor_0.V0, Get_Data_Identity_Identity())
}
...
Monad0_1_0 := gopurs_runtime.Apply(dictMonadGen_0.V0, gopurs_runtime.Value{})
_ = Monad0_1_0
// TAST (Let): Bind1_2_1 shape=App(Other) bindingType=(ADT ["Control","Bind","Bind"] [(TypeVar m$scope35)])
Bind1_2_1 := gopurs_runtime.CoerceToStruct[Constructor_Control_Bind_Bind[gopurs_runtime.Value]](gopurs_runtime.Apply(gopurs_runtime.RecordGet(Monad0_1_0, "Bind1"), gopurs_runtime.Value{}))
_ = Bind1_2_1
// TAST (Let): Functor0_3_2 shape=App(Other) bindingType=(ADT ["Data","Functor","Functor"] [(TypeVar m$scope35)])
Functor0_3_2 := gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor[gopurs_runtime.Value]](gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(Monad0_1_0, "Bind1"), gopurs_runtime.Value{}), "Apply0"), gopurs_runtime.Value{}), "Functor0"), gopurs_runtime.Value{}))
_ = Functor0_3_2
...
__t4 = gopurs_runtime.Apply2(Functor0_3_2.V0, Get_Data_Either_Left(), genA_5)
goto end_branch_4
} else {
...
{
__t4 = gopurs_runtime.Apply2(Functor0_3_2.V0, Get_Data_Either_Right(), genB_6)
}
end_branch_4:
return __t4
}))
