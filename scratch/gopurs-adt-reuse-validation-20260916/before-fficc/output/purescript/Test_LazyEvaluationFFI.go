...
_ = __local_var_1_1
return gopurs_runtime.Str(gopurs_runtime.Apply(Get_Data_Show_showIntImpl(), gopurs_runtime.Apply(Get_Test_LazyEvaluationFFI_runLazyEvaluationFFI(), gopurs_runtime.Int(__local_var_1_1.IntVal))).StrVal())
})
	})
