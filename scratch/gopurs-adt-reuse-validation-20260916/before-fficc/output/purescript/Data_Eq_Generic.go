...
var cache_Data_Eq_Generic_GenericEq_dollar_Dict gopurs_runtime.Value
var once_Data_Eq_Generic_GenericEq_dollar_Dict sync.Once
func Get_Data_Eq_Generic_GenericEq_dollar_Dict() gopurs_runtime.Value {
	once_Data_Eq_Generic_GenericEq_dollar_Dict.Do(func() {
		cache_Data_Eq_Generic_GenericEq_dollar_Dict = gopurs_runtime.Func(func(x_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 106035173, UnsafePtr: unsafe.Pointer(Call_Data_Eq_Generic_GenericEq_dollar_Dict(func() struct{
	genericEq_prime_ gopurs_runtime.Value
} {
					orig := x_0_box
					_ = orig
					clone := struct{
	genericEq_prime_ gopurs_runtime.Value
					...
					clone.genericEq_prime_ = gopurs_runtime.RecordGet(orig, "genericEq'")
					return clone
				}()))}
})
	})
	return cache_Data_Eq_Generic_GenericEq_dollar_Dict
}

var cache_Data_Eq_Generic_GenericEq_dollar_Dict__3702079335 gopurs_runtime.Value
var once_Data_Eq_Generic_GenericEq_dollar_Dict__3702079335 sync.Once
func Get_Data_Eq_Generic_GenericEq_dollar_Dict__3702079335() gopurs_runtime.Value {
	once_Data_Eq_Generic_GenericEq_dollar_Dict__3702079335.Do(func() {
		cache_Data_Eq_Generic_GenericEq_dollar_Dict__3702079335 = gopurs_runtime.Func(func(x_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 106035173, UnsafePtr: unsafe.Pointer(Rebox_Data_Eq_Generic_4167548092_1498596945(Call_Data_Eq_Generic_GenericEq_dollar_Dict__3702079335(func() struct{
	genericEq_prime_ gopurs_runtime.Value
} {
					orig := x_0_box
					_ = orig
	...
	return cache_Data_Eq_Generic_GenericEq_dollar_Dict__3702079335
}

var cache_Data_Eq_Generic_GenericEq_dollar_Dict__1509377583 gopurs_runtime.Value
var once_Data_Eq_Generic_GenericEq_dollar_Dict__1509377583 sync.Once
func Get_Data_Eq_Generic_GenericEq_dollar_Dict__1509377583() gopurs_runtime.Value {
	once_Data_Eq_Generic_GenericEq_dollar_Dict__1509377583.Do(func() {
		cache_Data_Eq_Generic_GenericEq_dollar_Dict__1509377583 = gopurs_runtime.Func(func(x_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Value{Type: 9, IntVal: 106035173, UnsafePtr: unsafe.Pointer(Call_Data_Eq_Generic_GenericEq_dollar_Dict__1509377583(func() struct{
	genericEq_prime_ gopurs_runtime.Value
} {
					orig := x_0_box
					_ = orig
	...
	return cache_Data_Eq_Generic_GenericEq_dollar_Dict__1509377583
}
...
func Get_Data_Eq_Generic_genericEqNoConstructors() gopurs_runtime.Value {
	once_Data_Eq_Generic_genericEqNoConstructors.Do(func() {
		cache_Data_Eq_Generic_genericEqNoConstructors = gopurs_runtime.Value{Type: 9, IntVal: 106035173, UnsafePtr: unsafe.Pointer((&Constructor_Data_Eq_Generic_GenericEq[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(v_0 gopurs_runtime.Value, v1_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Data_Eq_Generic_genericEqNoArguments() gopurs_runtime.Value {
	once_Data_Eq_Generic_genericEqNoArguments.Do(func() {
		cache_Data_Eq_Generic_genericEqNoArguments = gopurs_runtime.Value{Type: 9, IntVal: 106035173, UnsafePtr: unsafe.Pointer(Rebox_Data_Eq_Generic_4167548092_1498596945((&Constructor_Data_Eq_Generic_GenericEq[uint32]{1, gopurs_runtime.Func2(func(v_0 gopurs_runtime.Value, v1_1 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Bool(true)
})})))}
	})
...
var cache_Data_Eq_Generic_genericEq_prime_ gopurs_runtime.Value
var once_Data_Eq_Generic_genericEq_prime_ sync.Once
func Get_Data_Eq_Generic_genericEq_prime_() gopurs_runtime.Value {
	once_Data_Eq_Generic_genericEq_prime_.Do(func() {
		cache_Data_Eq_Generic_genericEq_prime_ = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
return Call_Data_Eq_Generic_genericEq_prime_(gopurs_runtime.CoerceToStruct[Constructor_Data_Eq_Generic_GenericEq[gopurs_runtime.Value]](dict_0_box))
})
	})
	return cache_Data_Eq_Generic_genericEq_prime_
}
...
func Call_Data_Eq_Generic_GenericEq_dollar_Dict(x_0_loop struct{
	genericEq_prime_ gopurs_runtime.Value
}) *Constructor_Data_Eq_Generic_GenericEq[gopurs_runtime.Value] {
var x_0 struct{
	genericEq_prime_ gopurs_runtime.Value
} = x_0_loop
_ = x_0
return gopurs_runtime.CoerceToStruct[Constructor_Data_Eq_Generic_GenericEq[gopurs_runtime.Value]](func() gopurs_runtime.Value {
				orig := x_0
				_ = orig
				return gopurs_runtime.RecordDict1("genericEq'", orig.genericEq_prime_)
				}())
}

func Call_Data_Eq_Generic_GenericEq_dollar_Dict__3702079335(x_0_loop struct{
	genericEq_prime_ gopurs_runtime.Value
}) *Constructor_Data_Eq_Generic_GenericEq[uint32] {
GenericEq_dollar_Dict__3702079335:
for {
if false { continue GenericEq_dollar_Dict__3702079335 }
var x_0 struct{
	genericEq_prime_ gopurs_runtime.Value
} = x_0_loop
_ = x_0
return gopurs_runtime.CoerceToStruct[Constructor_Data_Eq_Generic_GenericEq[uint32]](func() gopurs_runtime.Value {
				orig := x_0
				_ = orig
				return gopurs_runtime.RecordDict1("genericEq'", orig.genericEq_prime_)
				}())
...
func Call_Data_Eq_Generic_GenericEq_dollar_Dict__1509377583(x_0_loop struct{
	genericEq_prime_ gopurs_runtime.Value
}) *Constructor_Data_Eq_Generic_GenericEq[gopurs_runtime.Value] {
GenericEq_dollar_Dict__1509377583:
for {
if false { continue GenericEq_dollar_Dict__1509377583 }
var x_0 struct{
	genericEq_prime_ gopurs_runtime.Value
} = x_0_loop
_ = x_0
...
_ = dictEq_0
return gopurs_runtime.Value{Type: 9, IntVal: 106035173, UnsafePtr: unsafe.Pointer((&Constructor_Data_Eq_Generic_GenericEq[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(v_1 gopurs_runtime.Value, v1_2 gopurs_runtime.Value) gopurs_runtime.Value {
return gopurs_runtime.Bool((gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictEq_0, "eq"), v_1, v1_2).IntVal) != (0))
})}))}
}

func Call_Data_Eq_Generic_genericEq_prime_(dict_0_loop *Constructor_Data_Eq_Generic_GenericEq[gopurs_runtime.Value]) gopurs_runtime.Value {
...
_ = dictGenericEq1_1
return gopurs_runtime.Value{Type: 9, IntVal: 106035173, UnsafePtr: unsafe.Pointer(Rebox_Data_Eq_Generic_1865914110_1498596945((&Constructor_Data_Eq_Generic_GenericEq[*Constructor_Data_Generic_Rep_Product[gopurs_runtime.Value, gopurs_runtime.Value]]{1, gopurs_runtime.Func2(func(v_2 gopurs_runtime.Value, v1_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
var dictGenericEq1_1 gopurs_runtime.Value = dictGenericEq1_1_loop
_ = dictGenericEq1_1
return gopurs_runtime.Value{Type: 9, IntVal: 106035173, UnsafePtr: unsafe.Pointer((&Constructor_Data_Eq_Generic_GenericEq[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(v_2 gopurs_runtime.Value, v1_3 gopurs_runtime.Value) gopurs_runtime.Value {
var __t0 bool
{
if (v_2.Type == 9 && v_2.IntVal == 3478632216) {
__t0 = ((v1_3.Type == 9 && v1_3.IntVal == 3478632216)) && ((gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictGenericEq_0, "genericEq'"), (*Constructor_Data_Generic_Rep_Inl[gopurs_runtime.Value, gopurs_runtime.Value])(v_2.UnsafePtr).V0, (*Constructor_Data_Generic_Rep_Inl[gopurs_runtime.Value, gopurs_runtime.Value])(v1_3.UnsafePtr).V0).IntVal) != (0))
goto end_branch_0
} else {
...
{
__t0 = ((v_2.Type == 9 && v_2.IntVal == 492034566)) && (((v1_3.Type == 9 && v1_3.IntVal == 492034566)) && ((gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictGenericEq1_1, "genericEq'"), (*Constructor_Data_Generic_Rep_Inr[gopurs_runtime.Value, gopurs_runtime.Value])(v_2.UnsafePtr).V0, (*Constructor_Data_Generic_Rep_Inr[gopurs_runtime.Value, gopurs_runtime.Value])(v1_3.UnsafePtr).V0).IntVal) != (0)))
}
end_branch_0:
...
func Rebox_Data_Eq_Generic_1865914110_1498596945(in *Constructor_Data_Eq_Generic_GenericEq[*Constructor_Data_Generic_Rep_Product[gopurs_runtime.Value, gopurs_runtime.Value]]) *Constructor_Data_Eq_Generic_GenericEq[gopurs_runtime.Value] {
...
func Rebox_Data_Eq_Generic_4167548092_1498596945(in *Constructor_Data_Eq_Generic_GenericEq[uint32]) *Constructor_Data_Eq_Generic_GenericEq[gopurs_runtime.Value] {
	if in == nil { return nil }
	out := &Constructor_Data_Eq_Generic_GenericEq[gopurs_runtime.Value]{}
		out.V0 = in.V0
	return out
