...
/* Typed std::rc::Rc<crate::Tree> <- std::rc::Rc<crate::Tree> : Branch(...) */if /* OpIsTag Debug: Test_RBTree_B -> Other */ matches!((/* Typed std::rc::Rc<crate::Color> <- std::rc::Rc<crate::Color> : Local(...) */purs_local_0).as_ref(), crate::Color::B) {
    ...
    } else if (/* OpIsTag Debug: Test_RBTree_T -> Func */ matches!((/* Typed std::rc::Rc<crate::Tree> <- std::rc::Rc<crate::Tree> : Local(...) */purs_local_3).as_ref(), crate::Tree::T(..)) && /* OpIsTag Debug: Test_RBTree_R -> Other */ matches!(({ if let crate::Tree::T(ref f, ..) = (purs_local_3.clone()).as_ref() { f.clone() } else { unreachable!() } }).as_ref(), crate::Color::R)) {
