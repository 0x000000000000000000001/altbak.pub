...
pub mod Decimal_ {
    ...
    pub fn compareTo(x: decimal, y: decimal) -> i32 {
        compare(&x, &y)
    }

    pub fn scale(x: decimal) -> u8 {
        x.scale() as u8
    }
    ...
    pub fn maxMagnitude(x: decimal, y: decimal) -> decimal {
        if abs(x) > abs(y) {
            x
        } else {
            y
    ...
    pub fn minMagnitude(x: decimal, y: decimal) -> decimal {
        if abs(x) < abs(y) {
            x
        } else {
            y
    ...
    pub fn truncate(x: decimal) -> decimal {
        x.trunc()
    }
    pub fn pown(x: decimal, n: i32) -> decimal {
        x.powi(n as i64)
    }
    ...
    pub fn remainder(x: decimal, y: decimal) -> decimal {
        x % y
    }
    ...
    pub fn isNegative(x: decimal) -> bool {
        x.is_sign_negative()
    }
    pub fn isPositive(x: decimal) -> bool {
        x.is_sign_positive()
    }
    ...
    pub fn toInt8(x: decimal) -> i8 {
        x.to_i8().unwrap()
    }
    pub fn toUInt8(x: decimal) -> u8 {
        x.to_u8().unwrap()
    }
    pub fn toInt16(x: decimal) -> i16 {
        x.to_i16().unwrap()
    }
    pub fn toUInt16(x: decimal) -> u16 {
        x.to_u16().unwrap()
    }
    pub fn toInt32(x: decimal) -> i32 {
        x.to_i32().unwrap()
    }
    pub fn toUInt32(x: decimal) -> u32 {
        x.to_u32().unwrap()
    }
    pub fn toInt64(x: decimal) -> i64 {
        x.to_i64().unwrap()
    }
    pub fn toUInt64(x: decimal) -> u64 {
        x.to_u64().unwrap()
    }
    pub fn toNativeInt(x: decimal) -> isize {
        x.to_isize().unwrap()
    }
    pub fn toUNativeInt(x: decimal) -> usize {
        x.to_usize().unwrap()
    }

    pub fn toFloat32(x: decimal) -> f32 {
        x.to_f32().unwrap()
    }
    pub fn toFloat64(x: decimal) -> f64 {
        x.to_f64().unwrap()
    }

    pub fn toDecimal(x: decimal) -> decimal {
        x
    }

    pub fn toBoolean(x: decimal) -> bool {
        !x.is_zero()
    }
    ...
    pub fn fromInt8(n: i8) -> decimal {
        Decimal::from_i8(n).unwrap()
    }
    pub fn fromUInt8(n: u8) -> decimal {
        Decimal::from_u8(n).unwrap()
    }
    pub fn fromInt16(n: i16) -> decimal {
        Decimal::from_i16(n).unwrap()
    }
    pub fn fromUInt16(n: u16) -> decimal {
        Decimal::from_u16(n).unwrap()
    }
    pub fn fromInt32(n: i32) -> decimal {
        Decimal::from_i32(n).unwrap()
    }
    pub fn fromUInt32(n: u32) -> decimal {
        Decimal::from_u32(n).unwrap()
    }
    pub fn fromInt64(n: i64) -> decimal {
        Decimal::from_i64(n).unwrap()
    }
    pub fn fromUInt64(n: u64) -> decimal {
        Decimal::from_u64(n).unwrap()
    }
    pub fn fromNativeInt(n: isize) -> decimal {
        Decimal::from_isize(n).unwrap()
    }
    pub fn fromUNativeInt(n: usize) -> decimal {
        Decimal::from_usize(n).unwrap()
    }

    pub fn fromFloat32(n: f32) -> decimal {
        Decimal::from_f32(n).unwrap()
    }
    pub fn fromFloat64(n: f64) -> decimal {
        Decimal::from_f64(n).unwrap()
    }

    pub fn fromDecimal(d: decimal) -> decimal {
        d
    }
