pub mod Seq_ {
    ...
    use crate::module_22b6439c::Exception_::try_catch;
    use crate::module_2fb67a40::Global_::SR;
    use crate::module_36e5691b::HashSet_::add as add_1;
    use crate::module_36e5691b::HashSet_::new_empty as new_empty_1;
    ...
    use crate::module_3bd9ae6a::Native_::interface_cast;
    ...
    use crate::module_52af85ec::Seq_::ofArray as ofArray_1;
    ...
    use crate::module_6dcf8b93::NativeArray_::new_empty;
    ...
    use crate::module_73779dc5::HashMap_::new_empty as new_empty_2;
    ...
    use crate::module_c6216f2::Array_::foldBack as foldBack_1;
    use crate::module_c6216f2::Array_::foldBack2 as foldBack2_1;
    use crate::module_c6216f2::Array_::map as map_1;
    use crate::module_c6216f2::Array_::mapFold as mapFold_1;
    use crate::module_c6216f2::Array_::mapFoldBack as mapFoldBack_1;
    use crate::module_c6216f2::Array_::pairwise as pairwise_1;
    use crate::module_c6216f2::Array_::permute as permute_1;
    use crate::module_c6216f2::Array_::reduceBack as reduceBack_1;
    use crate::module_c6216f2::Array_::reverse as reverse_1;
    ...
    use crate::module_c6216f2::Array_::transpose as transpose_1;
    ...
    use crate::module_ec6ee4e9::List_::List;
    pub mod Enumerable {
        use super::*;
        use crate::module_ec6ee4e9::List_::head as head_2;
        use crate::module_ec6ee4e9::List_::isEmpty as isEmpty_1;
        use crate::module_ec6ee4e9::List_::tail as tail_2;
        #[derive(Clone, Debug)]
        ...
        pub fn ofList<T: Clone + 'static>(xs: List<T>) -> LrcPtr<dyn IEnumerator_1<T>> {
            ...
            let next = Func0::new({
                ...
                move || {
                    if !isEmpty_1(it.get()) {
                        let tail_1: List<T> = tail_2(it.get());
                        let head_1: T = head_2(it.get());
                        it.set(tail_1);
                        Some(head_1)
                    } else {
                        None::<T>
            ...
            let next = Func0::new({
                ...
                move || {
                        ...
                        match &innerOpt.get() {
                            None => {
                                if i.get() < 1_i32 {
                                    i.set(i.get() + 1_i32);
                                    {
                                        let it: LrcPtr<dyn IEnumerable_1<T>> = if i.get() == 0_i32 {
                                            xs.clone()
                                        } else {
                                            ys.clone()
                                        };
                    ...
                    if if !finished.get() {
                        ...
                        Some(IEnumerator_1::get_Current(getValue(innerOpt.get()).as_ref()).clone())
                    } else {
                        None::<T>
                    }
                }
            ...
            let next = Func0::new({
                ...
                move || {
                    if finished.get() {
                        ...
                        {
                            let res: Option<U> = compute(getValue(state.get()));
                            if res.is_none() {
                                finished.set(true);
                            }
                            res
        ...
        pub fn unfold<State: Clone + 'static, T: Clone + 'static>(
            ...
            let next = Func0::new({
                ...
                let f = f.clone();
                move || {
                    let matchValue: Option<LrcPtr<(T, State)>> = f(acc.get());
                    match &matchValue {
                        None => None::<T>,
                        Some(matchValue_0_0) => {
            ...
            });
            {
                let e2: LrcPtr<dyn IEnumerator_1<T>> = Seq_::ofSeq(ys);
                {
                    ...
                    });
                    {
                        ...
                        while if if c.get() == 0_i32 { b1.get() } else { false } {
                            b2.get()
                        } else {
                            false
                        } {
            ...
            });
            {
                let e2: LrcPtr<dyn IEnumerator_1<T>> = Seq_::ofSeq(ys);
                {
                    ...
                    });
                    {
                        ...
                        let b1: MutCell<bool> = MutCell::new(IEnumerator_1::MoveNext(e1.as_ref()));
                        let b2: MutCell<bool> = MutCell::new(IEnumerator_1::MoveNext(e2.as_ref()));
                        while if if res.get() { b1.get() } else { false } {
                            b2.get()
                        } else {
                            false
                        } {
    ...
    pub fn tryFindIndex<T: Clone + 'static>(
        ...
        fn inner_loop<T: Clone + 'static>(
            ...
            '_inner_loop: loop {
                break '_inner_loop (if IEnumerator_1::MoveNext(e.get().as_ref()) {
                    if predicate_1(IEnumerator_1::get_Current(e.get().as_ref()).clone()) {
                        Some(i.get())
                    } else {
                        let i_temp: i32 = i.get() + 1_i32;
                        let predicate_1_temp = predicate_1.get();
                        let e_temp: LrcPtr<dyn IEnumerator_1<T>> = e.get();
                        i.set(i_temp);
            ...
            move |i: i32| {
                if i < count_1(prefix.clone()) {
                    ...
                    if enumOpt.get().is_some() {
                        if {
                            let e: LrcPtr<dyn IEnumerator_1<T>> = getValue(enumOpt.get());
                            !finished.get()
                        } {
                            let e_1: LrcPtr<dyn IEnumerator_1<T>> = getValue(enumOpt.get());
    ...
    pub fn insertAt<T: Clone + 'static>(
        ...
        Seq_::generateIndexed(
            ...
            Func2::new({
                ...
                let y = y.clone();
                move |i: i32, e: LrcPtr<dyn IEnumerator_1<T>>| {
                    if if if isDone.get() { true } else { i < index } {
                        IEnumerator_1::MoveNext(e.as_ref())
                    } else {
                        false
                    } {
        ...
        Seq_::generateIndexed(
            ...
            Func2::new({
                ...
                move |i: i32,
                    ...
                    {
                        let inserted: Option<T> = if status.get() == 0_i32 {
