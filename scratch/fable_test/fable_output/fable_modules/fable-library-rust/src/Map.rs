pub mod Map_ {
    ...
    use crate::module_52af85ec::Seq_::fold as fold_3;
    ...
    use crate::module_c6216f2::Array_::fold as fold_1;
    ...
    use crate::module_ec6ee4e9::List_::fold as fold_2;
    ...
    pub fn copyToArray<a: Clone + 'static, b: Clone + 'static>(
        ...
        Map_::iterate(
            Func2::new({
                ...
                let j = j.clone();
                move |k: a, v: b| {
                    arr.get_mut()[j.get() as usize] = LrcPtr::new((k, v));
                    j.set(j.get() + 1_i32)
                }
            }),
            m,
    ...
    pub fn collapseLHS<K: Clone + 'static, V: Clone + 'static>(
        ...
        '_collapseLHS: loop {
            break '_collapseLHS (if !isEmpty_1(stack.get()) {
                let rest: List<Map_::Map<K, V>> = tail(stack.get());
