...
let Data_Profunctor_Split_split  = (box (fun (f: obj) -> (box (fun (g: obj) -> (box (fun (fx: obj) -> (sharpurs_apply (box ((box Data_Profunctor_Split_Split))) (box ((sharpurs_apply (box ((box Data_Exists_mkExists))) (box ((box (Data_Profunctor_Split_SplitFusd_Ctor((box f), (box g), (box fx))))))))))))))))
