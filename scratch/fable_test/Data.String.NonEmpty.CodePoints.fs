...
let Data_String_NonEmpty_CodePoints_take  = (box (fun (i: obj) -> (box (fun (nes: obj) -> (let s = (sharpurs_apply (box ((box Data_String_NonEmpty_CodePoints_fromNonEmptyString))) (box ((box nes)))) in (match ((unbox ((sharpurs_apply (box ((sharpurs_apply (box ((sharpurs_apply (box ((box Data_Ord_lessThan))) (box ((box Data_Ord_ordInt)))))) (box ((box i)))))) (box ((box 1))))))) with | LitBool true () -> ((box Data_Maybe_Nothingusd_Ctor)) | _ -> ((box (Data_Maybe_Justusd_Ctor((sharpurs_apply (box ((box Data_String_NonEmpty_CodePoints_toNonEmptyString))) (box ((sharpurs_apply (box ((sharpurs_apply (box ((box Data_String_CodePoints_take))) (box ((box i)))))) (box ((box s)))))))))))))))))
...
let Data_String_NonEmpty_CodePoints_fromCodePointArray  = (box (fun (v: obj) -> (match ((unbox ((box v)))) with | [|  |] -> ((box Data_Maybe_Nothingusd_Ctor)) | cs -> ((box (Data_Maybe_Justusd_Ctor((sharpurs_apply (box ((box Data_String_NonEmpty_CodePoints_toNonEmptyString))) (box ((sharpurs_apply (box ((box Data_String_CodePoints_fromCodePointArray))) (box ((box cs))))))))))))))
