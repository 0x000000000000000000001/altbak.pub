...
let Data_String_NonEmpty_Internal_fromString  = (box (fun (v: obj) -> (match ((unbox ((box v)))) with | LitString "" () -> ((box Data_Maybe_Nothingusd_Ctor)) | s -> ((box (Data_Maybe_Justusd_Ctor((sharpurs_apply (box ((box Data_String_NonEmpty_Internal_NonEmptyString))) (box ((box s)))))))))))
