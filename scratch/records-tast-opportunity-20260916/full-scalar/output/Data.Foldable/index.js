...
var identity4 = /* #__PURE__ */ Control_Category.identity(Control_Category.categoryFn);
...
var oneOfMap = function (dictFoldable) {
    return function (dictPlus) {
        ...
        return function (f) {
            return foldr(dictFoldable)(function ($380) {
                return alt(f($380));
            })(empty);
        };
    };
...
var traverse_ = function (dictApplicative) {
    ...
    return function (dictFoldable) {
        return function (f) {
            return foldr(dictFoldable)(function ($381) {
                return applySecond(f($381));
            ...
            return function (v1) {
                ...
                if (v instanceof Data_Maybe.Just) {
                    return new Data_Maybe.Just((function () {
                        var $216 = Data_Eq.eq(Data_Ordering.eqOrdering)(cmp(v.value0)(v1))(Data_Ordering.GT.value);
                        if ($216) {
                            return v.value0;
                        };
                        return v1;
    ...
    return function (cmp) {
        var min$prime = function (v) {
            return function (v1) {
                ...
                if (v instanceof Data_Maybe.Just) {
                    return new Data_Maybe.Just((function () {
                        var $220 = Data_Eq.eq(Data_Ordering.eqOrdering)(cmp(v.value0)(v1))(Data_Ordering.LT.value);
                        if ($220) {
                            return v.value0;
                        };
                        return v1;
...
var foldableArray = /* #__PURE__ */ $lazy_foldableArray(178);
var $lazy_foldableFreeMonoidTree = /* #__PURE__ */ $runtime_lazy("foldableFreeMonoidTree", "Data.Foldable", function () {
    return {
        foldl: function (fn) {
        ...
        foldMap: function (dictMonoid) {
            return foldMapDefaultR($lazy_foldableFreeMonoidTree(0))(dictMonoid);
        }
    };
});
var foldableFreeMonoidTree = /* #__PURE__ */ $lazy_foldableFreeMonoidTree(84);
...
var foldlDefault = function (dictFoldable) {
    return function (c) {
        return function (u) {
            return function (xs) {
                return Data_Function.apply(foldl(foldableFreeMonoidTree)(c)(u))(foldMap(dictFoldable)(monoidFreeMonoidTree)(Node.create)(xs));
            };
        };
    };
};
var foldrDefault = function (dictFoldable) {
    return function (c) {
        return function (u) {
            return function (xs) {
                return Data_Function.apply(foldr(foldableFreeMonoidTree)(c)(u))(foldMap(dictFoldable)(monoidFreeMonoidTree)(Node.create)(xs));
            };
        };
    };
};
var lookup = function (dictFoldable) {
    return function (dictEq) {
        return function (a) {
            var $384 = foldMap(dictFoldable)(Data_Maybe_First.monoidFirst)(function (v) {
                var $371 = Data_Eq.eq(dictEq)(a)(v.value0);
                if ($371) {
        ...
        return function (d) {
            return function (t) {
                return function (f) {
                    ...
                    return Data_Newtype.unwrap()(foldMap(dictFoldable)(monoidEndo)(joined)(f))(d);
                };
            };
        };
    };
...
var fold = function (dictFoldable) {
    return function (dictMonoid) {
        return foldMap(dictFoldable)(dictMonoid)(identity2);
    };
};
...
var notElem = function (dictFoldable) {
    return function (dictEq) {
        return function (x) {
            var $388 = elem(dictFoldable)(dictEq)(x);
            return function ($389) {
                return !$388($389);
            };
        };
...
var or = function (dictFoldable) {
    return function (dictHeytingAlgebra) {
        return any(dictFoldable)(dictHeytingAlgebra)(identity3);
    };
};
...
var and = function (dictFoldable) {
    return function (dictHeytingAlgebra) {
        return all(dictFoldable)(dictHeytingAlgebra)(identity4);
    };
};
export {
    foldr,
