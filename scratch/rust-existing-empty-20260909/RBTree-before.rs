...
pub fn Test_RBTree_ins(mut purs_local_0: i64, mut purs_local_1: std::rc::Rc<crate::Tree>) -> std::rc::Rc<crate::Tree> {
    ...
    loop {
        ...
        /* Typed std::rc::Rc<crate::Tree> <- std::rc::Rc<crate::Tree> : CtorSaturated(...) */{
    let mut __purust_empty_0 = std::rc::Rc::new(crate::Tree::E);
    std::rc::Rc::new(crate::Tree::T(crate::Color::R, /* Typed std::rc::Rc<crate::Tree> <- std::rc::Rc<crate::Tree> : Local(...) */__purust_empty_0.clone(), /* Typed i64 <- i64 : Local(...) */purs_local_0, /* Typed std::rc::Rc<crate::Tree> <- std::rc::Rc<crate::Tree> : Local(...) */__purust_empty_0))
}
