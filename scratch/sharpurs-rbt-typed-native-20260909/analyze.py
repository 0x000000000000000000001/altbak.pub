...
for label, change in (("Total", changes["total_ms"]), ("Lazy", changes["tests_us"][LAZY]), ("RBTree", changes["tests_us"][RBT])):
...
print(f"Official README: {official['compiled_total_ms']:.2f} ms total; "
      f"RBTree compiled {official['compiled_rbtree_us'] / 1000:.5f} ms, "
      f"native optimized {official['native_optimized_rbtree_us'] / 1000:.3f} ms (different algorithm/result).")
