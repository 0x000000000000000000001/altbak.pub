...
let Data_Ring_Generic_genericRingProduct  = (box (fun (dictGenericRing: obj) -> (box (fun (dictGenericRing1: obj) -> (sharpurs_apply (box ((box Data_Ring_Generic_GenericRingusd_Dict))) (box ((box ((Map.add "genericSub'" (box ((box (fun (v: obj) -> (box (fun (v1: obj) -> (match (((unbox ((box v))), (unbox ((box v1))))) with | (Data_Generic_Rep_Productusd_Ctor(a1, b1), Data_Generic_Rep_Productusd_Ctor(a2, b2)) -> ((box (Data_Generic_Rep_Productusd_Ctor((sharpurs_apply (box ((sharpurs_apply (box ((sharpurs_apply (box ((box Data_Ring_Generic_genericSub_prime))) (box ((box dictGenericRing)))))) (box ((box a1)))))) (box ((box a2)))), (sharpurs_apply (box ((sharpurs_apply (box ((sharpurs_apply (box ((box Data_Ring_Generic_genericSub_prime))) (box ((box dictGenericRing1)))))) (box ((box b1)))))) (box ((box b2))))))))))))))) Map.empty))))))))))
