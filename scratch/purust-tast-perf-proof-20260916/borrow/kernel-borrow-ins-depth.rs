...
// Owned ABI stays unchanged. The borrowed worker retains no input reference.
pub fn Test_RBTree_depth(purs_local_0: std::rc::Rc<crate::Tree>) -> i64 {
    Test_RBTree_depth__borrow(&purs_local_0)
}

pub fn Test_RBTree_depth__borrow(purs_local_0: &std::rc::Rc<crate::Tree>) -> i64 {
    // AST: Typed(Abs(..., Typed(Branch(...))))
    loop {
    ...
    let mut purs_local_1 = Test_RBTree_depth__borrow(/* Typed std::rc::Rc<crate::Tree> <- std::rc::Rc<crate::Tree> : Accessor(Local(...)) */{ match (purs_local_0).as_ref() { crate::Tree::T(_, ref f, ..) => f, _ => unreachable!() } });
    {
    let mut purs_local_2 = /* Typed i64 <- i64 : App(Var(...)) */Test_RBTree_depth__borrow(/* Typed std::rc::Rc<crate::Tree> <- std::rc::Rc<crate::Tree> : Accessor(Local(...)) */{ match (purs_local_0).as_ref() { crate::Tree::T(_, _, _, ref f, ..) => f, _ => unreachable!() } });
...
pub fn Test_RBTree_ins__original(mut purs_local_0: i64, mut purs_local_1: std::rc::Rc<crate::Tree>) -> std::rc::Rc<crate::Tree> {
    // AST: Typed(Abs(..., Typed(Abs(..., Typed(Branch(...))))))
    loop {
