...
pub fn Test_RBTree_ins__original(mut purs_local_0: i64, mut purs_local_1: tracked::Rc<crate::Tree>) -> tracked::Rc<crate::Tree> {
    // AST: Typed(Abs(..., Typed(Abs(..., Typed(Branch(...))))))
    loop {
...
#[inline(always)]
pub fn Test_RBTree_ins(mut key: i64, mut tree: tracked::Rc<crate::Tree>) -> tracked::Rc<crate::Tree> {
    Test_RBTree_ins__borrow(key, &mut tree);
    tree
}

fn Test_RBTree_ins__borrow(key: i64, tree: &mut tracked::Rc<crate::Tree>) {
