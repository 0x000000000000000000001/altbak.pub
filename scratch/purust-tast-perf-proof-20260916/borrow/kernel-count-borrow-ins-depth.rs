...
pub fn Test_RBTree_depth(purs_local_0: tracked::Rc<crate::Tree>) -> i64 { tracked::call("depth");
    Test_RBTree_depth__borrow(&purs_local_0)
}

pub fn Test_RBTree_depth__borrow(purs_local_0: &tracked::Rc<crate::Tree>) -> i64 { tracked::call("depth__borrow");
    // AST: Typed(Abs(..., Typed(Branch(...))))
    loop {
    ...
    let mut purs_local_1 = Test_RBTree_depth__borrow(/* Typed tracked::Rc<crate::Tree> <- tracked::Rc<crate::Tree> : Accessor(Local(...)) */{ match (purs_local_0).as_ref() { crate::Tree::T(_, ref f, ..) => f, _ => unreachable!() } });
    {
    let mut purs_local_2 = /* Typed i64 <- i64 : App(Var(...)) */Test_RBTree_depth__borrow(/* Typed tracked::Rc<crate::Tree> <- tracked::Rc<crate::Tree> : Accessor(Local(...)) */{ match (purs_local_0).as_ref() { crate::Tree::T(_, _, _, ref f, ..) => f, _ => unreachable!() } });
...
pub fn Test_RBTree_ins__original(mut purs_local_0: i64, mut purs_local_1: tracked::Rc<crate::Tree>) -> tracked::Rc<crate::Tree> { tracked::call("ins__original");
    // AST: Typed(Abs(..., Typed(Abs(..., Typed(Branch(...))))))
    loop {
...
pub fn Test_RBTree_ins(mut key: i64, mut tree: tracked::Rc<crate::Tree>) -> tracked::Rc<crate::Tree> { tracked::call("ins");
    Test_RBTree_ins__borrow(key, &mut tree);
    tree
}

fn Test_RBTree_ins__borrow(key: i64, tree: &mut tracked::Rc<crate::Tree>) { tracked::call("ins__borrow");
    if matches!(tree.as_ref(), crate::Tree::E) {
        ...
        *tree = tracked::Rc::new(crate::Tree::T(crate::Color::R, tree.clone(), key, tree.clone()));
        return;
    }

    let fields = if let Some(slot) = tracked::Rc::get_mut(tree) {
