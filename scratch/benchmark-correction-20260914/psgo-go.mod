...
require (
	...
	project.localhost/purescript-native/ffi-loader v0.0.0-00010101000000-000000000000
	project.localhost/purescript-native/output v0.0.0-00010101000000-000000000000
)

require (
	github.com/dlclark/regexp2 v1.4.0 // indirect
	github.com/i-am-the-slime/go-ffi v0.0.0-00010101000000-000000000000 // indirect
)
