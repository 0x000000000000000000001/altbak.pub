...
assert compact(signature) == "[Int, TypeVar(a)] -> TypeVar(a)"
body = go["value1"]
parameters = []
...
assert summary["act"]["nodes"].get("Syntax$TypeApp", 0) == 0
...
print("Verified: inlined go still carries [Int, TypeVar(a)] -> TypeVar(a) annotations.")
