...
function majData_majUnfoldable_unfoldrmajArraymajImpl($v0, $v1 = null, $v2 = null, $v3 = null, $v4 = null, $v5 = null) {
  ...
  $f = (\array_key_exists('unfoldrArrayImpl', $ffi_Data_Unfoldable) ? $ffi_Data_Unfoldable['unfoldrArrayImpl'] : new class { public function __invoke(...$args) { return $this; } });
...
$__t1 = new \Data\Maybe\Data_Maybe_Just((($__local_var_2_0)->{'value0'})->{'value0'});
goto end_branch_1;;
};
...
$GLOBALS['Data_Unfoldable_unfoldableArray'] = (object)["unfoldr" => (((($GLOBALS['Data_Unfoldable_unfoldrArrayImpl'])($GLOBALS['Data_Maybe_isNothing']))(function($v_0) {
  $__num = \func_num_args();
  $__t0 = null;;
...
goto end_branch_0;;
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))($GLOBALS['Data_Tuple_fst']))($GLOBALS['Data_Tuple_snd']), "Unfoldable10" => function($_dollar___unused_0) {
  $__num = \func_num_args();
...
function majData_majUnfoldable_replicatemajA($dictApplicative_0, $dictUnfoldable_1 = null, $dictTraversable_2 = null, $n_3 = null, $m_4 = null) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majUnfoldable_replicatemajA';
  if ($__num < 5) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 5);
  }
  $__res = ((($dictTraversable_2)->{'sequence'})($dictApplicative_0))(((($dictUnfoldable_1)->{'unfoldr'})(function($i_5) use ($m_4) {
  $__num = \func_num_args();
  $__t0 = null;;
  if (($i_5 <= 0)) {
$__t0 = new \Data\Maybe\Data_Maybe_Nothing();
goto end_branch_0;;
  ...
  $__t0 = new \Data\Maybe\Data_Maybe_Just(new \Data\Tuple\Data_Tuple_Tuple($m_4, ($i_5 - 1)));
  end_branch_0:;
  $__res = $__t0;
  goto __end;;
  __end:
...
function majData_majUnfoldable_frommajMaybe($dictUnfoldable_0) {
  ...
  $__num = \func_num_args();
  $__t0 = null;;
  if ($b_1 instanceof \Data\Maybe\Data_Maybe_Just) {
$__t0 = new \Data\Maybe\Data_Maybe_Just(new \Data\Tuple\Data_Tuple_Tuple(($b_1)->{'value0'}, new \Data\Maybe\Data_Maybe_Nothing()));
goto end_branch_0;;
};
  $__t0 = new \Data\Maybe\Data_Maybe_Nothing();
  end_branch_0:;
