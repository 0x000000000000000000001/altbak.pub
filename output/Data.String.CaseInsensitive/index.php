...
$GLOBALS['Data_String_CaseInsensitive_CaseInsensitiveString'] = __NAMESPACE__ . '\\majData_majString_majCasemajInsensitive_majCasemajInsensitivemajString';
...
$GLOBALS['Data_String_CaseInsensitive_showCaseInsensitiveString'] = (object)["show" => function($v_0) {
  $__num = \func_num_args();
  $__res = (("(CaseInsensitiveString " . \Data\Show\majData_majShow_showmajStringmajImpl($v_0)) . ")");
  goto __end;;
  __end:
...
$GLOBALS['Data_String_CaseInsensitive_eqCaseInsensitiveString'] = (object)["eq" => function($v_0) {
  ...
  $__num = \func_num_args();
  $__res = (\Data\String\Common\majData_majString_majCommon_tomajLower($v_0) === \Data\String\Common\majData_majString_majCommon_tomajLower($v1_1));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
$GLOBALS['Data_String_CaseInsensitive_ordCaseInsensitiveString'] = (object)["compare" => function($v_0) {
  ...
  $__res = function($v1_1) use ($v_0) {
  $__num = \func_num_args();
  $__res = \Data\Ord\majData_majOrd_ordmajStringmajImpl(new \Data\Ordering\Data_Ordering_LT(), new \Data\Ordering\Data_Ordering_EQ(), new \Data\Ordering\Data_Ordering_GT(), \Data\String\Common\majData_majString_majCommon_tomajLower($v_0), \Data\String\Common\majData_majString_majCommon_tomajLower($v1_1));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
