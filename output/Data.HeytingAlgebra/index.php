...
$GLOBALS['Data_HeytingAlgebra_heytingAlgebraUnit'] = (object)["ff" => $GLOBALS['Data_Unit_unit'], "tt" => $GLOBALS['Data_Unit_unit'], "implies" => function($v_0) {
  $__num = \func_num_args();
  $__res = function($v1_1) {
  $__num = \func_num_args();
...
$GLOBALS['Data_HeytingAlgebra_heytingAlgebraRecordNil'] = (object)["conjRecord" => function($v_0) {
  $__num = \func_num_args();
  $__res = function($v1_1) {
  $__num = \func_num_args();
  $__res = function($v2_2) {
...
$GLOBALS['Data_HeytingAlgebra_heytingAlgebraProxy'] = (object)["conj" => function($v_0) {
  $__num = \func_num_args();
  $__res = function($v1_1) {
  $__num = \func_num_args();
...
$GLOBALS['Data_HeytingAlgebra_heytingAlgebraBoolean'] = (object)["ff" => false, "tt" => true, "implies" => function($a_0) {
  $__num = \func_num_args();
  $__res = function($b_1) use ($a_0) {
  $__num = \func_num_args();
...
function majData_majHeytingmajAlgebra_heytingmajAlgebramajRecord($_dollar___unused_0, $dictHeytingAlgebraRecord_1 = null) {
  $__num = \func_num_args();
...
function majData_majHeytingmajAlgebra_heytingmajAlgebramajFunction($dictHeytingAlgebra_0) {
  ...
  $__res = (object)["ff" => function($v_1) use ($dictHeytingAlgebra_0) {
  $__num = \func_num_args();
  $__res = ($dictHeytingAlgebra_0)->{'ff'};
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "tt" => function($v_1) use ($dictHeytingAlgebra_0) {
  $__num = \func_num_args();
  $__res = ($dictHeytingAlgebra_0)->{'tt'};
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "implies" => function($f_1) use ($dictHeytingAlgebra_0) {
  $__num = \func_num_args();
  $__res = function($g_2) use ($dictHeytingAlgebra_0, $f_1) {
  $__num = \func_num_args();
  $__res = function($a_3) use ($dictHeytingAlgebra_0, $f_1, $g_2) {
  $__num = \func_num_args();
  $__res = ((($dictHeytingAlgebra_0)->{'implies'})(($f_1)($a_3)))(($g_2)($a_3));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "conj" => function($f_1) use ($dictHeytingAlgebra_0) {
  $__num = \func_num_args();
  $__res = function($g_2) use ($dictHeytingAlgebra_0, $f_1) {
  $__num = \func_num_args();
  $__res = function($a_3) use ($dictHeytingAlgebra_0, $f_1, $g_2) {
  $__num = \func_num_args();
  $__res = ((($dictHeytingAlgebra_0)->{'conj'})(($f_1)($a_3)))(($g_2)($a_3));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "disj" => function($f_1) use ($dictHeytingAlgebra_0) {
  $__num = \func_num_args();
  $__res = function($g_2) use ($dictHeytingAlgebra_0, $f_1) {
  $__num = \func_num_args();
  $__res = function($a_3) use ($dictHeytingAlgebra_0, $f_1, $g_2) {
  $__num = \func_num_args();
  $__res = ((($dictHeytingAlgebra_0)->{'disj'})(($f_1)($a_3)))(($g_2)($a_3));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "not" => function($f_1) use ($dictHeytingAlgebra_0) {
  $__num = \func_num_args();
  $__res = function($a_2) use ($dictHeytingAlgebra_0, $f_1) {
  $__num = \func_num_args();
  $__res = (($dictHeytingAlgebra_0)->{'not'})(($f_1)($a_2));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
function majData_majHeytingmajAlgebra_heytingmajAlgebramajRecordmajCons($dictIsSymbol_0, $_dollar___unused_1 = null, $dictHeytingAlgebraRecord_2 = null, $dictHeytingAlgebra_3 = null) {
  $__num = \func_num_args();
  ...
  $__res = (object)["conjRecord" => function($v_6) use ($dictHeytingAlgebraRecord_2, $dictHeytingAlgebra_3, $dictIsSymbol_0) {
  $__num = \func_num_args();
  $__res = function($ra_7) use ($dictHeytingAlgebraRecord_2, $dictHeytingAlgebra_3, $dictIsSymbol_0) {
  $__num = \func_num_args();
  $__res = function($rb_8) use ($dictHeytingAlgebraRecord_2, $dictHeytingAlgebra_3, $dictIsSymbol_0, $ra_7) {
  $__num = \func_num_args();
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "disjRecord" => function($v_6) use ($dictHeytingAlgebraRecord_2, $dictHeytingAlgebra_3, $dictIsSymbol_0) {
  $__num = \func_num_args();
  $__res = function($ra_7) use ($dictHeytingAlgebraRecord_2, $dictHeytingAlgebra_3, $dictIsSymbol_0) {
  $__num = \func_num_args();
  $__res = function($rb_8) use ($dictHeytingAlgebraRecord_2, $dictHeytingAlgebra_3, $dictIsSymbol_0, $ra_7) {
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "impliesRecord" => function($v_6) use ($dictHeytingAlgebraRecord_2, $dictHeytingAlgebra_3, $dictIsSymbol_0) {
  $__num = \func_num_args();
  $__res = function($ra_7) use ($dictHeytingAlgebraRecord_2, $dictHeytingAlgebra_3, $dictIsSymbol_0) {
  $__num = \func_num_args();
  $__res = function($rb_8) use ($dictHeytingAlgebraRecord_2, $dictHeytingAlgebra_3, $dictIsSymbol_0, $ra_7) {
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "ffRecord" => function($v_6) use ($dictHeytingAlgebraRecord_2, $dictIsSymbol_0, $ff1_4_0) {
  $__num = \func_num_args();
  $__res = function($row_7) use ($dictHeytingAlgebraRecord_2, $dictIsSymbol_0, $ff1_4_0) {
  $__num = \func_num_args();
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "notRecord" => function($v_6) use ($dictHeytingAlgebraRecord_2, $dictHeytingAlgebra_3, $dictIsSymbol_0) {
  $__num = \func_num_args();
  $__res = function($row_7) use ($dictHeytingAlgebraRecord_2, $dictHeytingAlgebra_3, $dictIsSymbol_0) {
  $__num = \func_num_args();
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "ttRecord" => function($v_6) use ($dictHeytingAlgebraRecord_2, $dictIsSymbol_0, $tt1_5_1) {
  $__num = \func_num_args();
  $__res = function($row_7) use ($dictHeytingAlgebraRecord_2, $dictIsSymbol_0, $tt1_5_1) {
  $__num = \func_num_args();
