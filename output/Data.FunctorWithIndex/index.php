...
$GLOBALS['Data_FunctorWithIndex_functorWithIndexTuple'] = (object)["mapWithIndex" => function($f_0) {
  ...
  $__num = \func_num_args();
  $__res = new \Data\Tuple\Data_Tuple_Tuple(($m_2)->{'value0'}, ($__local_var_1_0)(($m_2)->{'value1'}));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
function majData_majFunctormajWithmajIndex_functormajWithmajIndexmajProduct($dictFunctorWithIndex_0) {
  ...
  $__num = \func_num_args();
  $__local_var_3_1 = (($dictFunctorWithIndex1_2)->{'Functor0'})(null);
  $functorProduct1_3_1 = (object)["map" => function($f_4) use ($__local_var_1_0, $__local_var_3_1) {
  $__num = \func_num_args();
  ...
  $__res = (object)["mapWithIndex" => function($f_4) use ($dictFunctorWithIndex1_2, $dictFunctorWithIndex_0) {
  $__num = \func_num_args();
  $__res = function($v_5) use ($dictFunctorWithIndex1_2, $dictFunctorWithIndex_0, $f_4) {
  $__num = \func_num_args();
  $__res = new \Data\Tuple\Data_Tuple_Tuple(((($dictFunctorWithIndex_0)->{'mapWithIndex'})((($GLOBALS['Control_Semigroupoid_composeImpl'])($f_4))($GLOBALS['Data_Either_Left'])))(($v_5)->{'value0'}), ((($dictFunctorWithIndex1_2)->{'mapWithIndex'})((($GLOBALS['Control_Semigroupoid_composeImpl'])($f_4))($GLOBALS['Data_Either_Right'])))(($v_5)->{'value1'}));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Functor0" => function($_dollar___unused_4) use ($functorProduct1_3_1) {
  $__num = \func_num_args();
...
$__t1 = new \Data\Maybe\Data_Maybe_Just(($__local_var_1_0)(($v1_2)->{'value0'}));
goto end_branch_1;;
};
...
$GLOBALS['Data_FunctorWithIndex_functorWithIndexIdentity'] = (object)["mapWithIndex" => function($f_0) {
  $__num = \func_num_args();
...
$__t1 = new \Data\Either\Data_Either_Left(($m_2)->{'value0'});
goto end_branch_1;;
};
  if ($m_2 instanceof \Data\Either\Data_Either_Right) {
$__t1 = new \Data\Either\Data_Either_Right(($__local_var_1_0)(($m_2)->{'value0'}));
goto end_branch_1;;
};
...
function majData_majFunctormajWithmajIndex_functormajWithmajIndexmajCoproduct($dictFunctorWithIndex_0) {
  ...
  $__num = \func_num_args();
  $__local_var_3_1 = (($dictFunctorWithIndex1_2)->{'Functor0'})(null);
  $functorCoproduct1_3_1 = (object)["map" => function($f_4) use ($__local_var_1_0, $__local_var_3_1) {
  $__num = \func_num_args();
  $__res = function($v_5) use ($__local_var_1_0, $__local_var_3_1, $f_4) {
  $__num = \func_num_args();
...
goto end_branch_4;;
  ...
  $__res = function($v_5) use ($dictFunctorWithIndex1_2, $dictFunctorWithIndex_0, $f_4) {
  $__num = \func_num_args();
  $__local_var_6_6 = (($dictFunctorWithIndex_0)->{'mapWithIndex'})((($GLOBALS['Control_Semigroupoid_composeImpl'])($f_4))($GLOBALS['Data_Either_Left']));
  $__local_var_7_7 = (($dictFunctorWithIndex1_2)->{'mapWithIndex'})((($GLOBALS['Control_Semigroupoid_composeImpl'])($f_4))($GLOBALS['Data_Either_Right']));
  $__t8 = null;;
  if ($v_5 instanceof \Data\Either\Data_Either_Left) {
$__t8 = new \Data\Either\Data_Either_Left(($__local_var_6_6)(($v_5)->{'value0'}));
goto end_branch_8;;
};
  if ($v_5 instanceof \Data\Either\Data_Either_Right) {
$__t8 = new \Data\Either\Data_Either_Right(($__local_var_7_7)(($v_5)->{'value0'}));
goto end_branch_8;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t8 = null;
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Functor0" => function($_dollar___unused_4) use ($functorCoproduct1_3_1) {
  $__num = \func_num_args();
...
$GLOBALS['Data_FunctorWithIndex_functorWithIndexConst'] = (object)["mapWithIndex" => function($v_0) {
  $__num = \func_num_args();
  $__res = function($v1_1) {
  $__num = \func_num_args();
  $__res = $v1_1;
...
function majData_majFunctormajWithmajIndex_functormajWithmajIndexmajCompose($dictFunctorWithIndex_0) {
  ...
  $__res = function($dictFunctorWithIndex1_2) use ($__local_var_1_0, $dictFunctorWithIndex_0) {
  $__num = \func_num_args();
  $mapWithIndex1_3_1 = ($dictFunctorWithIndex1_2)->{'mapWithIndex'};
  ...
  $__res = (object)["mapWithIndex" => function($f_5) use ($dictFunctorWithIndex_0, $mapWithIndex1_3_1) {
  $__num = \func_num_args();
  $__res = function($v_6) use ($dictFunctorWithIndex_0, $f_5, $mapWithIndex1_3_1) {
  $__num = \func_num_args();
  $__res = ((($dictFunctorWithIndex_0)->{'mapWithIndex'})((($GLOBALS['Control_Semigroupoid_composeImpl'])($mapWithIndex1_3_1))(function($a_7) use ($f_5) {
  $__num = \func_num_args();
  $__res = function($b_8) use ($a_7, $f_5) {
  $__num = \func_num_args();
  $__res = ($f_5)(new \Data\Tuple\Data_Tuple_Tuple($a_7, $b_8));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Functor0" => function($_dollar___unused_5) use ($functorCompose1_4_2) {
  $__num = \func_num_args();
...
$GLOBALS['Data_FunctorWithIndex_functorWithIndexArray'] = (object)["mapWithIndex" => $GLOBALS['Data_FunctorWithIndex_mapWithIndexArray'], "Functor0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
...
function majData_majFunctormajWithmajIndex_functormajWithmajIndexmajApp($dictFunctorWithIndex_0) {
  ...
  $functorApp_1_0 = (($dictFunctorWithIndex_0)->{'Functor0'})(null);
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Functor0" => function($_dollar___unused_2) use ($functorApp_1_0) {
  $__num = \func_num_args();
