...
function majData_majSemigroup_majTraversable_sequence1majDefault($dictTraversable1_0, $dictApply_1 = null) {
  ...
  $__res = ((($dictTraversable1_0)->{'traverse1'})($dictApply_1))(function($x_2) {
  $__num = \func_num_args();
  $__res = $x_2;
  goto __end;;
  __end:
...
$GLOBALS['Data_Semigroup_Traversable_traversableDual'] = (object)["traverse1" => function($dictApply_0) {
  ...
  $__num = \func_num_args();
  $__res = ((($GLOBALS['Data_Semigroup_Traversable_traversableDual'])->{'traverse1'})($dictApply_0))(function($x_1) {
  $__num = \func_num_args();
  $__res = $x_1;
  goto __end;;
  __end:
...
$GLOBALS['Data_Semigroup_Traversable_traversableMultiplicative'] = (object)["traverse1" => function($dictApply_0) {
  ...
  $__num = \func_num_args();
  $__res = ((($GLOBALS['Data_Semigroup_Traversable_traversableMultiplicative'])->{'traverse1'})($dictApply_0))(function($x_1) {
  $__num = \func_num_args();
  $__res = $x_1;
  goto __end;;
  __end:
...
function majData_majSemigroup_majTraversable_traverse1majDefault($dictTraversable1_0) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majSemigroup_majTraversable_traverse1majDefault';
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 1);
  }
  $Functor0_1_0 = (((($dictTraversable1_0)->{'Traversable1'})(null))->{'Functor0'})(null);
  $__res = function($dictApply_2) use ($Functor0_1_0, $dictTraversable1_0) {
  $__num = \func_num_args();
  $__res = function($f_3) use ($Functor0_1_0, $dictApply_2, $dictTraversable1_0) {
  $__num = \func_num_args();
  $__res = function($ta_4) use ($Functor0_1_0, $dictApply_2, $dictTraversable1_0, $f_3) {
  $__num = \func_num_args();
  $__res = ((($dictTraversable1_0)->{'sequence1'})($dictApply_2))(((($Functor0_1_0)->{'map'})($f_3))($ta_4));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
