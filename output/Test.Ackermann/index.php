...
$GLOBALS['Test_Ackermann_describe'] = \Effect\Console\majEffect_majConsole_log("Ackermann (3, 4):");

// Test_Ackermann_ackermann
function majTest_majAckermann_ackermann(int $v_0, $v1_1 = null): int|\Closure {
  $__num = \func_num_args();
...
break;
  ...
  $__tco_0 = ($v_0 - 1);
  $__tco_1 = \Test\Ackermann\majTest_majAckermann_ackermann($v_0, ($v1_1 - 1));
...
// Test_Ackermann_act
$GLOBALS['Test_Ackermann_act'] = (function() use (&$__fn) {
...
return phpurs_execute_effect(\Effect\Console\majEffect_majConsole_log(\Data\Show\majData_majShow_showmajIntmajImpl(\Test\Ackermann\majTest_majAckermann_ackermann($dummy_1_1, 4))));
};
})();
