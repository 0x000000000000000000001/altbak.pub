...
namespace Test\RBTreeFFI;

// ALL IMPORTS: Bench, Control.Bind, Data.Function, Data.Show, Effect, Effect.Console, Prelude, Prim, Test.RBTreeFFI
// TO REQUIRE: Bench, Control.Bind, Data.Function, Data.Show, Effect, Effect.Console, Prelude, Test.RBTreeFFI
...
$ffi_Test_RBTreeFFI = \call_user_func(function() {
  $exports = [];
...
function majTest_majRmajBmajTreemajFmajFmajI_runmajRmajBmajTreemajFmajFmajI(int $v0): int|\Closure {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\majTest_majRmajBmajTreemajFmajFmajI_runmajRmajBmajTreemajFmajFmajI';
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 1);
  }
  global $ffi_Test_RBTreeFFI;
  $f = (\array_key_exists('runRBTreeFFI', $ffi_Test_RBTreeFFI) ? $ffi_Test_RBTreeFFI['runRBTreeFFI'] : new class { public function __invoke(...$args) { return $this; } });
  return $f($v0);
}
$GLOBALS['Test_RBTreeFFI_runRBTreeFFI'] = __NAMESPACE__ . '\\majTest_majRmajBmajTreemajFmajFmajI_runmajRmajBmajTreemajFmajFmajI';





// Test_RBTreeFFI_describe
$GLOBALS['Test_RBTreeFFI_describe'] = \Effect\Console\majEffect_majConsole_log("Red-Black Tree FFI (100k Worst-Case Insertions):");

// Test_RBTreeFFI_act
$GLOBALS['Test_RBTreeFFI_act'] = (function() use (&$__fn) {
...
return phpurs_execute_effect(\Effect\Console\majEffect_majConsole_log(\Data\Show\majData_majShow_showmajIntmajImpl(\Test\RBTreeFFI\majTest_majRmajBmajTreemajFmajFmajI_runmajRmajBmajTreemajFmajFmajI($dummy_1_1))));
};
})();
