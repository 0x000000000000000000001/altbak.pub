...
$GLOBALS['Control_Bind_bindArray'] = (object)["bind" => $GLOBALS['Control_Bind_arrayBind'], "Apply0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
...
function majControl_majBind_ifmajM($dictBind_0, $cond_1 = null, $t_2 = null, $f_3 = null) {
  ...
  $__res = ((($dictBind_0)->{'bind'})($cond_1))(function($cond_prime__4) use ($f_3, $t_2) {
  $__num = \func_num_args();
  $__t0 = null;;
  if ($cond_prime__4) {
$__t0 = $t_2;
...
function majControl_majBind_join($dictBind_0, $m_1 = null) {
  ...
  $__res = ((($dictBind_0)->{'bind'})($m_1))(function($x_2) {
  $__num = \func_num_args();
  $__res = $x_2;
  goto __end;;
  __end:
