...
// Data_Op_Op
function majData_majOp_majOp($x_0) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majOp_majOp';
  if ($__num < 1) {
...
function majData_majOp_semigroupmajOp($dictSemigroup_0) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majOp_semigroupmajOp';
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 1);
  }
...
// Data_Op_newtypeOp
$GLOBALS['Data_Op_newtypeOp'] = (object)["Coercible0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
  $__res = null;
  goto __end;;
  __end:
...
// Data_Op_monoidOp
function majData_majOp_monoidmajOp($dictMonoid_0) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majOp_monoidmajOp';
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 1);
  }
...
$GLOBALS['Data_Op_categoryOp'] = (object)["identity" => function($x_0) {
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Semigroupoid0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
