...
function majTest_majPolymorphism_polymajLoop($dictMonoidish_0, $n_init_1 = null, $acc_init_2 = null) {
  $__num = \func_num_args();
  ...
  $go__go_3_0 = null;
  $go__go_3_0 = (function() use ($dictMonoidish_0, &$go__go_3_0) {
  $__fn = function(int $v_4, $v1_5 = null) use ($dictMonoidish_0, &$go__go_3_0, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
...
break;
  ...
  $__tco_0 = ($v_4 - 1);
  $__tco_1 = ((($dictMonoidish_0)->{'mappend_'})($v1_5))(($dictMonoidish_0)->{'mempty_'});
  $__tco_var_go__go_3_0_0_v_4 = $__tco_0;
  $__tco_var_go__go_3_0_0_v1_5 = $__tco_1;
  ...
  $__res = (($go__go_3_0)($n_init_1))($acc_init_2);
  goto __end;;
  __end:
...
$GLOBALS['Test_Polymorphism_act'] = (function() use (&$__fn) {
...
$go__go_2_2 = (function() use (&$go__go_2_2) {
  $__fn = function(int $v_3, $v1_4 = null) use (&$go__go_2_2, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
...
break;
  ...
  $__tco_2 = ($v_3 - 1);
  $__tco_3 = ($v1_4 + 1);
  $__tco_var_go__go_2_2_2_v_3 = $__tco_2;
  $__tco_var_go__go_2_2_2_v1_4 = $__tco_3;
...
return phpurs_execute_effect(\Effect\Console\majEffect_majConsole_log(\Data\Show\majData_majShow_showmajIntmajImpl((($go__go_2_2)($dummy_1_1))(0))));
};
})();
