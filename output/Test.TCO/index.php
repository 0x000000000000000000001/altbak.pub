...
break;
  ...
  $__tco_0 = ($v_0 - 1);
  $__tco_1 = ($v1_1 + \Data\EuclideanRing\majData_majEuclideanmajRing_intmajMod($v_0, 3));
...
// Test_TCO_act
$GLOBALS['Test_TCO_act'] = (function() use (&$__fn) {
...
return phpurs_execute_effect(\Effect\Console\majEffect_majConsole_log(\Data\Show\majData_majShow_showmajIntmajImpl(\Test\TCO\majTest_majTmajCmajO_deepmajTailmajRec($dummy_1_1, 0))));
};
})();
