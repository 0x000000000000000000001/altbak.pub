...
$GLOBALS['Data_Monoid_Alternate_newtypeAlternate'] = (object)["Coercible0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
  $__res = null;
  goto __end;;
  __end:
...
function majData_majMonoid_majAlternate_monoidmajAlternate($dictPlus_0) {
  ...
  $__res = (object)["mempty" => ($dictPlus_0)->{'empty'}, "Semigroup0" => function($_dollar___unused_2) use ($semigroupAlternate1_1_0) {
  $__num = \func_num_args();
