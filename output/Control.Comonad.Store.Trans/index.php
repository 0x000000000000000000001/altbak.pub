...
function majControl_majComonad_majStore_majTrans_extendmajStoremajT($dictExtend_0) {
  ...
  $functorStoreT1_1_0 = (object)["map" => function($f_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  $__res = function($v_3) use ($__local_var_1_0, $f_2) {
  $__num = \func_num_args();
  $__res = new \Data\Tuple\Data_Tuple_Tuple(((($__local_var_1_0)->{'map'})(function($h_4) use ($f_2) {
  $__num = \func_num_args();
  $__res = (($GLOBALS['Control_Semigroupoid_composeImpl'])($f_2))($h_4);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
  ...
  $__num = \func_num_args();
  $__res = new \Data\Tuple\Data_Tuple_Tuple(((($dictExtend_0)->{'extend'})(function($w_prime__4) use ($f_2) {
  $__num = \func_num_args();
  $__res = function($s_prime__5) use ($f_2, $w_prime__4) {
  $__num = \func_num_args();
  $__res = ($f_2)(new \Data\Tuple\Data_Tuple_Tuple($w_prime__4, $s_prime__5));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
$GLOBALS['Control_Comonad_Store_Trans_comonadTransStoreT'] = (object)["lower" => function($dictComonad_0) {
  ...
  $__num = \func_num_args();
  $__local_var_3_1 = ($v_2)->{'value1'};
  $__res = ((($Functor0_1_0)->{'map'})(function($v1_4) use ($__local_var_3_1) {
  $__num = \func_num_args();
  $__res = ($v1_4)($__local_var_3_1);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))(($v_2)->{'value0'});
