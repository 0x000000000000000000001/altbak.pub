...
// Data_Maybe_optional
function majData_majMaybe_optional($dictAlt_0) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majMaybe_optional';
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 1);
  }
  $Functor0_1_0 = (($dictAlt_0)->{'Functor0'})(null);
  $__res = function($dictApplicative_2) use ($Functor0_1_0, $dictAlt_0) {
  $__num = \func_num_args();
  $__res = function($a_3) use ($Functor0_1_0, $dictAlt_0, $dictApplicative_2) {
  $__num = \func_num_args();
  $__res = ((($dictAlt_0)->{'alt'})(((($Functor0_1_0)->{'map'})($GLOBALS['Data_Maybe_Just']))($a_3)))((($dictApplicative_2)->{'pure'})(new \Data\Maybe\Data_Maybe_Nothing()));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
function majData_majMaybe_monoidmajMaybe($dictSemigroup_0) {
  ...
  $semigroupMaybe1_1_0 = (object)["append" => function($v_1) use ($dictSemigroup_0) {
  $__num = \func_num_args();
  $__res = function($v1_2) use ($dictSemigroup_0, $v_1) {
  $__num = \func_num_args();
  $__t0 = null;;
...
goto end_branch_0;;
  ...
  $__res = (object)["mempty" => new \Data\Maybe\Data_Maybe_Nothing(), "Semigroup0" => function($_dollar___unused_2) use ($semigroupMaybe1_1_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Maybe_functorMaybe'] = (object)["map" => function($v_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Maybe_invariantMaybe'] = (object)["imap" => function($f_0) {
  $__num = \func_num_args();
...
$__t0 = new \Data\Maybe\Data_Maybe_Just(($f_0)(($v1_2)->{'value0'}));
goto end_branch_0;;
};
  $__t0 = new \Data\Maybe\Data_Maybe_Nothing();
  end_branch_0:;
...
function majData_majMaybe_frommajMaybe__prime__($a_0) {
  ...
  $__res = (($GLOBALS['Data_Maybe_maybe__prime__'])($a_0))(function($x_1) {
  $__num = \func_num_args();
  $__res = $x_1;
  goto __end;;
  __end:
...
// Data_Maybe_fromJust
function majData_majMaybe_frommajJust($_dollar___unused_0, $v_1 = null) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Maybe_extendMaybe'] = (object)["extend" => function($v_0) {
  $__num = \func_num_args();
  $__res = function($v1_1) use ($v_0) {
  $__num = \func_num_args();
  $__t0 = null;;
...
$__t3 = ((($dictOrd_0)->{'compare'})(($x_2)->{'value0'}))(($y_3)->{'value0'});
goto end_branch_3;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t3 = null;
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Eq0" => function($_dollar___unused_2) use ($eqMaybe1_1_0) {
  $__num = \func_num_args();
  $__res = $eqMaybe1_1_0;
  goto __end;;
  __end:
...
// Data_Maybe_eq1Maybe
$GLOBALS['Data_Maybe_eq1Maybe'] = (object)["eq1" => function($dictEq_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Maybe_ord1Maybe'] = (object)["compare1" => function($dictOrd_0) {
  $__num = \func_num_args();
...
function majData_majMaybe_boundedmajMaybe($dictBounded_0) {
  ...
  $eqMaybe1_2_1 = (object)["eq" => function($x_3) use ($__local_var_2_1) {
  $__num = \func_num_args();
...
goto end_branch_2;;
  ...
  $ordMaybe1_1_0 = (object)["compare" => function($x_3) use ($__local_var_1_0) {
  $__num = \func_num_args();
...
$__t4 = ((($__local_var_1_0)->{'compare'})(($x_3)->{'value0'}))(($y_4)->{'value0'});
goto end_branch_4;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t4 = null;
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Eq0" => function($_dollar___unused_3) use ($eqMaybe1_2_1) {
  $__num = \func_num_args();
  $__res = $eqMaybe1_2_1;
  goto __end;;
  __end:
  ...
  $__res = (object)["top" => new \Data\Maybe\Data_Maybe_Just(($dictBounded_0)->{'top'}), "bottom" => new \Data\Maybe\Data_Maybe_Nothing(), "Ord0" => function($_dollar___unused_2) use ($ordMaybe1_1_0) {
  $__num = \func_num_args();
  $__res = $ordMaybe1_1_0;
  goto __end;;
  __end:
...
$GLOBALS['Data_Maybe_applyMaybe'] = (object)["apply" => function($v_0) {
  $__num = \func_num_args();
  $__res = function($v1_1) use ($v_0) {
  $__num = \func_num_args();
  $__t0 = null;;
...
$__t1 = null;;
if ($v1_1 instanceof \Data\Maybe\Data_Maybe_Just) {
$__t1 = new \Data\Maybe\Data_Maybe_Just((($v_0)->{'value0'})(($v1_1)->{'value0'}));
goto end_branch_1;;
};
...
$GLOBALS['Data_Maybe_bindMaybe'] = (object)["bind" => function($v_0) {
  $__num = \func_num_args();
  $__res = function($v1_1) use ($v_0) {
  $__num = \func_num_args();
  $__t0 = null;;
...
function majData_majMaybe_semiringmajMaybe($dictSemiring_0) {
  ...
  $__res = (object)["zero" => new \Data\Maybe\Data_Maybe_Nothing(), "one" => new \Data\Maybe\Data_Maybe_Just(($dictSemiring_0)->{'one'}), "add" => function($v_1) use ($dictSemiring_0) {
  $__num = \func_num_args();
...
goto end_branch_0;;
  ...
  if (($v_1 instanceof \Data\Maybe\Data_Maybe_Just && $v1_2 instanceof \Data\Maybe\Data_Maybe_Just)) {
$__t0 = new \Data\Maybe\Data_Maybe_Just(((($dictSemiring_0)->{'add'})(($v_1)->{'value0'}))(($v1_2)->{'value0'}));
goto end_branch_0;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t0 = null;
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "mul" => function($x_1) use ($dictSemiring_0) {
  $__num = \func_num_args();
  $__res = function($y_2) use ($dictSemiring_0, $x_1) {
  $__num = \func_num_args();
  $__t1 = null;;
  if ($x_1 instanceof \Data\Maybe\Data_Maybe_Just) {
$__t2 = null;;
if ($y_2 instanceof \Data\Maybe\Data_Maybe_Just) {
$__t2 = new \Data\Maybe\Data_Maybe_Just(((($dictSemiring_0)->{'mul'})(($x_1)->{'value0'}))(($y_2)->{'value0'}));
goto end_branch_2;;
};
...
$GLOBALS['Data_Maybe_applicativeMaybe'] = (object)["pure" => $GLOBALS['Data_Maybe_Just'], "Apply0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
  $__res = $GLOBALS['Data_Maybe_applyMaybe'];
  goto __end;;
  __end:
...
$GLOBALS['Data_Maybe_monadMaybe'] = (object)["Applicative0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
...
// Data_Maybe_altMaybe
$GLOBALS['Data_Maybe_altMaybe'] = (object)["alt" => function($v_0) {
  $__num = \func_num_args();
  $__res = function($v1_1) use ($v_0) {
  $__num = \func_num_args();
  $__t0 = null;;
...
$GLOBALS['Data_Maybe_plusMaybe'] = (object)["empty" => new \Data\Maybe\Data_Maybe_Nothing(), "Alt0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Maybe_alternativeMaybe'] = (object)["Applicative0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
  $__res = $GLOBALS['Data_Maybe_applicativeMaybe'];
  goto __end;;
  __end:
