...
function majControl_majMonad_majCont_withmajCont($f_0) {
  ...
  $__local_var_1_0 = (($GLOBALS['Control_Semigroupoid_composeImpl'])((($GLOBALS['Control_Semigroupoid_semigroupoidFn'])->{'compose'})(function($x_1) {
  $__num = \func_num_args();
  $__res = $x_1;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
})))((($GLOBALS['Control_Semigroupoid_composeImpl'])($f_0))((($GLOBALS['Control_Semigroupoid_semigroupoidFn'])->{'compose'})($GLOBALS['Unsafe_Coerce_unsafeCoerce'])));
...
function majControl_majMonad_majCont_runmajCont($cc_0, $k_1 = null) {
  ...
  $__res = ($cc_0)((($GLOBALS['Control_Semigroupoid_composeImpl'])(function($x_2) {
  $__num = \func_num_args();
  $__res = $x_2;
  goto __end;;
  __end:
...
function majControl_majMonad_majCont_mapmajCont($f_0) {
  ...
  $__local_var_1_0 = (($GLOBALS['Control_Semigroupoid_composeImpl'])(function($x_1) {
  $__num = \func_num_args();
  $__res = $x_1;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))((($GLOBALS['Control_Semigroupoid_composeImpl'])($f_0))($GLOBALS['Unsafe_Coerce_unsafeCoerce']));
  $__res = function($v_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  $__res = function($k_3) use ($__local_var_1_0, $v_2) {
  $__num = \func_num_args();
