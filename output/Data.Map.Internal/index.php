...
function majData_majMap_majInternal_unsafemajNode($k_0, $__local_var_1 = null, $__local_var_2 = null, $__local_var_3 = null) {
  $__num = \func_num_args();
  ...
  $__t0 = null;;
  if ($__local_var_2 instanceof \Data\Map\Internal\Data_Map_Internal_Leaf) {
$__t1 = null;;
if ($__local_var_3 instanceof \Data\Map\Internal\Data_Map_Internal_Leaf) {
$__t1 = new \Data\Map\Internal\Data_Map_Internal_Node(1, 1, $k_0, $__local_var_1, $__local_var_2, $__local_var_3);
goto end_branch_1;;
};
if ($__local_var_3 instanceof \Data\Map\Internal\Data_Map_Internal_Node) {
$__t1 = new \Data\Map\Internal\Data_Map_Internal_Node((1 + ($__local_var_3)->{'value0'}), (1 + ($__local_var_3)->{'value1'}), $k_0, $__local_var_1, $__local_var_2, $__local_var_3);
goto end_branch_1;;
};
...
goto end_branch_0;;
  ...
  if ($__local_var_2 instanceof \Data\Map\Internal\Data_Map_Internal_Node) {
$__t2 = null;;
if ($__local_var_3 instanceof \Data\Map\Internal\Data_Map_Internal_Leaf) {
$__t2 = new \Data\Map\Internal\Data_Map_Internal_Node((1 + ($__local_var_2)->{'value0'}), (1 + ($__local_var_2)->{'value1'}), $k_0, $__local_var_1, $__local_var_2, $__local_var_3);
goto end_branch_2;;
};
if ($__local_var_3 instanceof \Data\Map\Internal\Data_Map_Internal_Node) {
$__t3 = null;;
if ((($__local_var_2)->{'value0'} > ($__local_var_3)->{'value0'})) {
$__t3 = (1 + ($__local_var_2)->{'value0'});
goto end_branch_3;;
};
$__t3 = (1 + ($__local_var_3)->{'value0'});
end_branch_3:;
$__t2 = new \Data\Map\Internal\Data_Map_Internal_Node($__t3, ((1 + ($__local_var_2)->{'value1'}) + ($__local_var_3)->{'value1'}), $k_0, $__local_var_1, $__local_var_2, $__local_var_3);
goto end_branch_2;;
};
throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
$__t2 = null;
...
function majData_majMap_majInternal_unsafemajBalancedmajNode($k_0, $__local_var_1 = null, $__local_var_2 = null, $__local_var_3 = null) {
  $__num = \func_num_args();
...
if (($__local_var_3 instanceof \Data\Map\Internal\Data_Map_Internal_Node && (($__local_var_3)->{'value0'} > 1))) {
$__t2 = null;;
if ((function() use ($__local_var_3, &$__fn) {
$__t3 = null;;
if (($__local_var_3)->{'value5'} instanceof \Data\Map\Internal\Data_Map_Internal_Leaf) {
$__t3 = ((($__local_var_3)->{'value4'})->{'value0'} > 0);
goto end_branch_3;;
};
if (($__local_var_3)->{'value5'} instanceof \Data\Map\Internal\Data_Map_Internal_Node) {
$__t3 = ((($__local_var_3)->{'value4'})->{'value0'} > (($__local_var_3)->{'value5'})->{'value0'});
goto end_branch_3;;
};
throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
$__t3 = null;
end_branch_3:;
return (($__local_var_3)->{'value4'} instanceof \Data\Map\Internal\Data_Map_Internal_Node && $__t3);
})()) {
$__t2 = ($GLOBALS['Data_Map_Internal_unsafeNode'])((($__local_var_3)->{'value4'})->{'value2'}, (($__local_var_3)->{'value4'})->{'value3'}, ($GLOBALS['Data_Map_Internal_unsafeNode'])($k_0, $__local_var_1, $__local_var_2, (($__local_var_3)->{'value4'})->{'value4'}), ($GLOBALS['Data_Map_Internal_unsafeNode'])(($__local_var_3)->{'value2'}, ($__local_var_3)->{'value3'}, (($__local_var_3)->{'value4'})->{'value5'}, ($__local_var_3)->{'value5'}));
goto end_branch_2;;
};
$__t2 = ($GLOBALS['Data_Map_Internal_unsafeNode'])(($__local_var_3)->{'value2'}, ($__local_var_3)->{'value3'}, ($GLOBALS['Data_Map_Internal_unsafeNode'])($k_0, $__local_var_1, $__local_var_2, ($__local_var_3)->{'value4'}), ($__local_var_3)->{'value5'});
end_branch_2:;
$__t1 = $__t2;
goto end_branch_1;;
};
$__t1 = ($GLOBALS['Data_Map_Internal_unsafeNode'])($k_0, $__local_var_1, $__local_var_2, $__local_var_3);
end_branch_1:;
$__t0 = $__t1;
goto end_branch_0;;
};
...
if ($__local_var_3 instanceof \Data\Map\Internal\Data_Map_Internal_Node) {
$__t5 = null;;
if ((($__local_var_3)->{'value0'} > (($__local_var_2)->{'value0'} + 1))) {
$__t6 = null;;
if ((function() use ($__local_var_3, &$__fn) {
$__t7 = null;;
if (($__local_var_3)->{'value5'} instanceof \Data\Map\Internal\Data_Map_Internal_Leaf) {
$__t7 = ((($__local_var_3)->{'value4'})->{'value0'} > 0);
goto end_branch_7;;
};
if (($__local_var_3)->{'value5'} instanceof \Data\Map\Internal\Data_Map_Internal_Node) {
$__t7 = ((($__local_var_3)->{'value4'})->{'value0'} > (($__local_var_3)->{'value5'})->{'value0'});
goto end_branch_7;;
};
throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
$__t7 = null;
end_branch_7:;
return (($__local_var_3)->{'value4'} instanceof \Data\Map\Internal\Data_Map_Internal_Node && $__t7);
})()) {
$__t6 = ($GLOBALS['Data_Map_Internal_unsafeNode'])((($__local_var_3)->{'value4'})->{'value2'}, (($__local_var_3)->{'value4'})->{'value3'}, ($GLOBALS['Data_Map_Internal_unsafeNode'])($k_0, $__local_var_1, $__local_var_2, (($__local_var_3)->{'value4'})->{'value4'}), ($GLOBALS['Data_Map_Internal_unsafeNode'])(($__local_var_3)->{'value2'}, ($__local_var_3)->{'value3'}, (($__local_var_3)->{'value4'})->{'value5'}, ($__local_var_3)->{'value5'}));
goto end_branch_6;;
};
$__t6 = ($GLOBALS['Data_Map_Internal_unsafeNode'])(($__local_var_3)->{'value2'}, ($__local_var_3)->{'value3'}, ($GLOBALS['Data_Map_Internal_unsafeNode'])($k_0, $__local_var_1, $__local_var_2, ($__local_var_3)->{'value4'}), ($__local_var_3)->{'value5'});
end_branch_6:;
$__t5 = $__t6;
goto end_branch_5;;
};
if ((($__local_var_2)->{'value0'} > (($__local_var_3)->{'value0'} + 1))) {
$__t8 = null;;
if ((function() use ($__local_var_2, &$__fn) {
$__t9 = null;;
if (($__local_var_2)->{'value4'} instanceof \Data\Map\Internal\Data_Map_Internal_Leaf) {
$__t9 = (0 <= (($__local_var_2)->{'value5'})->{'value0'});
goto end_branch_9;;
};
if (($__local_var_2)->{'value4'} instanceof \Data\Map\Internal\Data_Map_Internal_Node) {
$__t9 = ((($__local_var_2)->{'value4'})->{'value0'} <= (($__local_var_2)->{'value5'})->{'value0'});
goto end_branch_9;;
};
throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
$__t9 = null;
end_branch_9:;
return (($__local_var_2)->{'value5'} instanceof \Data\Map\Internal\Data_Map_Internal_Node && $__t9);
})()) {
$__t8 = ($GLOBALS['Data_Map_Internal_unsafeNode'])((($__local_var_2)->{'value5'})->{'value2'}, (($__local_var_2)->{'value5'})->{'value3'}, ($GLOBALS['Data_Map_Internal_unsafeNode'])(($__local_var_2)->{'value2'}, ($__local_var_2)->{'value3'}, ($__local_var_2)->{'value4'}, (($__local_var_2)->{'value5'})->{'value4'}), ($GLOBALS['Data_Map_Internal_unsafeNode'])($k_0, $__local_var_1, (($__local_var_2)->{'value5'})->{'value5'}, $__local_var_3));
goto end_branch_8;;
};
$__t8 = ($GLOBALS['Data_Map_Internal_unsafeNode'])(($__local_var_2)->{'value2'}, ($__local_var_2)->{'value3'}, ($__local_var_2)->{'value4'}, ($GLOBALS['Data_Map_Internal_unsafeNode'])($k_0, $__local_var_1, ($__local_var_2)->{'value5'}, $__local_var_3));
end_branch_8:;
$__t5 = $__t8;
goto end_branch_5;;
};
$__t5 = ($GLOBALS['Data_Map_Internal_unsafeNode'])($k_0, $__local_var_1, $__local_var_2, $__local_var_3);
end_branch_5:;
$__t4 = $__t5;
goto end_branch_4;;
};
if (($__local_var_3 instanceof \Data\Map\Internal\Data_Map_Internal_Leaf && (($__local_var_2)->{'value0'} > 1))) {
$__t10 = null;;
if ((function() use ($__local_var_2, &$__fn) {
$__t11 = null;;
if (($__local_var_2)->{'value4'} instanceof \Data\Map\Internal\Data_Map_Internal_Leaf) {
$__t11 = (0 <= (($__local_var_2)->{'value5'})->{'value0'});
goto end_branch_11;;
};
if (($__local_var_2)->{'value4'} instanceof \Data\Map\Internal\Data_Map_Internal_Node) {
$__t11 = ((($__local_var_2)->{'value4'})->{'value0'} <= (($__local_var_2)->{'value5'})->{'value0'});
goto end_branch_11;;
};
throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
$__t11 = null;
end_branch_11:;
return (($__local_var_2)->{'value5'} instanceof \Data\Map\Internal\Data_Map_Internal_Node && $__t11);
})()) {
$__t10 = ($GLOBALS['Data_Map_Internal_unsafeNode'])((($__local_var_2)->{'value5'})->{'value2'}, (($__local_var_2)->{'value5'})->{'value3'}, ($GLOBALS['Data_Map_Internal_unsafeNode'])(($__local_var_2)->{'value2'}, ($__local_var_2)->{'value3'}, ($__local_var_2)->{'value4'}, (($__local_var_2)->{'value5'})->{'value4'}), ($GLOBALS['Data_Map_Internal_unsafeNode'])($k_0, $__local_var_1, (($__local_var_2)->{'value5'})->{'value5'}, $__local_var_3));
goto end_branch_10;;
};
$__t10 = ($GLOBALS['Data_Map_Internal_unsafeNode'])(($__local_var_2)->{'value2'}, ($__local_var_2)->{'value3'}, ($__local_var_2)->{'value4'}, ($GLOBALS['Data_Map_Internal_unsafeNode'])($k_0, $__local_var_1, ($__local_var_2)->{'value5'}, $__local_var_3));
end_branch_10:;
$__t4 = $__t10;
goto end_branch_4;;
};
$__t4 = ($GLOBALS['Data_Map_Internal_unsafeNode'])($k_0, $__local_var_1, $__local_var_2, $__local_var_3);
end_branch_4:;
$__t0 = $__t4;
goto end_branch_0;;
};
...
function majData_majMap_majInternal_unsafemajSplit($comp_0, $__local_var_1 = null, $__local_var_2 = null) {
  $__num = \func_num_args();
  ...
  $__tco_var_Data_Map_Internal_unsafeSplit___local_var_2 = $__local_var_2;
  ...
  $__local_var_2 = $__tco_var_Data_Map_Internal_unsafeSplit___local_var_2;
  $__t0 = null;;
  if ($__local_var_2 instanceof \Data\Map\Internal\Data_Map_Internal_Leaf) {
...
goto end_branch_0;;
  ...
  if ($__local_var_2 instanceof \Data\Map\Internal\Data_Map_Internal_Node) {
$v_3_1 = (($comp_0)($__local_var_1))(($__local_var_2)->{'value2'});
$__t2 = null;;
if ($v_3_1 instanceof \Data\Ordering\Data_Ordering_LT) {
$v1_4_3 = ($GLOBALS['Data_Map_Internal_unsafeSplit'])($comp_0, $__local_var_1, ($__local_var_2)->{'value4'});
$__t2 = new \Data\Map\Internal\Data_Map_Internal_Split(($v1_4_3)->{'value0'}, ($v1_4_3)->{'value1'}, ($GLOBALS['Data_Map_Internal_unsafeBalancedNode'])(($__local_var_2)->{'value2'}, ($__local_var_2)->{'value3'}, ($v1_4_3)->{'value2'}, ($__local_var_2)->{'value5'}));
goto end_branch_2;;
};
if ($v_3_1 instanceof \Data\Ordering\Data_Ordering_GT) {
$v1_4_4 = ($GLOBALS['Data_Map_Internal_unsafeSplit'])($comp_0, $__local_var_1, ($__local_var_2)->{'value5'});
$__t2 = new \Data\Map\Internal\Data_Map_Internal_Split(($v1_4_4)->{'value0'}, ($GLOBALS['Data_Map_Internal_unsafeBalancedNode'])(($__local_var_2)->{'value2'}, ($__local_var_2)->{'value3'}, ($__local_var_2)->{'value4'}, ($v1_4_4)->{'value1'}), ($v1_4_4)->{'value2'});
goto end_branch_2;;
};
if ($v_3_1 instanceof \Data\Ordering\Data_Ordering_EQ) {
$__t2 = new \Data\Map\Internal\Data_Map_Internal_Split(new \Data\Maybe\Data_Maybe_Just(($__local_var_2)->{'value3'}), ($__local_var_2)->{'value4'}, ($__local_var_2)->{'value5'});
goto end_branch_2;;
};
throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
$__t2 = null;
...
function majData_majMap_majInternal_unsafemajSplitmajLast($k_0, $__local_var_1 = null, $__local_var_2 = null, $__local_var_3 = null) {
  $__num = \func_num_args();
  ...
  $__tco_var_Data_Map_Internal_unsafeSplitLast___local_var_2 = $__local_var_2;
  ...
  $__local_var_2 = $__tco_var_Data_Map_Internal_unsafeSplitLast___local_var_2;
  $__local_var_3 = $__tco_var_Data_Map_Internal_unsafeSplitLast___local_var_3;
  $__t0 = null;;
  if ($__local_var_3 instanceof \Data\Map\Internal\Data_Map_Internal_Leaf) {
$__t0 = new \Data\Map\Internal\Data_Map_Internal_SplitLast($k_0, $__local_var_1, $__local_var_2);
goto end_branch_0;;
};
  if ($__local_var_3 instanceof \Data\Map\Internal\Data_Map_Internal_Node) {
...
$__t0 = new \Data\Map\Internal\Data_Map_Internal_SplitLast(($v1_4_1)->{'value0'}, ($v1_4_1)->{'value1'}, ($GLOBALS['Data_Map_Internal_unsafeBalancedNode'])($k_0, $__local_var_1, $__local_var_2, ($v1_4_1)->{'value2'}));
goto end_branch_0;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t0 = null;
...
function majData_majMap_majInternal_unsafemajDifference($comp_0, $__local_var_1 = null, $__local_var_2 = null) {
  $__num = \func_num_args();
  ...
  $__tco_var_Data_Map_Internal_unsafeDifference___local_var_2 = $__local_var_2;
  ...
  $__local_var_2 = $__tco_var_Data_Map_Internal_unsafeDifference___local_var_2;
  $__t0 = null;;
...
goto end_branch_0;;
  ...
  if ($__local_var_2 instanceof \Data\Map\Internal\Data_Map_Internal_Node) {
$v_3_1 = ($GLOBALS['Data_Map_Internal_unsafeSplit'])($comp_0, ($__local_var_2)->{'value2'}, $__local_var_1);
$__t0 = ($GLOBALS['Data_Map_Internal_unsafeJoinNodes'])(($GLOBALS['Data_Map_Internal_unsafeDifference'])($comp_0, ($v_3_1)->{'value1'}, ($__local_var_2)->{'value4'}), ($GLOBALS['Data_Map_Internal_unsafeDifference'])($comp_0, ($v_3_1)->{'value2'}, ($__local_var_2)->{'value5'}));
goto end_branch_0;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t0 = null;
...
function majData_majMap_majInternal_unsafemajIntersectionmajWith($comp_0, $__local_var_1 = null, $__local_var_2 = null, $__local_var_3 = null) {
  $__num = \func_num_args();
  ...
  $__tco_var_Data_Map_Internal_unsafeIntersectionWith___local_var_2 = $__local_var_2;
  ...
  $__local_var_2 = $__tco_var_Data_Map_Internal_unsafeIntersectionWith___local_var_2;
...
goto end_branch_0;;
  ...
  if ($__local_var_3 instanceof \Data\Map\Internal\Data_Map_Internal_Node) {
$v_4_1 = ($GLOBALS['Data_Map_Internal_unsafeSplit'])($comp_0, ($__local_var_3)->{'value2'}, $__local_var_2);
$l_prime__5_2 = ($GLOBALS['Data_Map_Internal_unsafeIntersectionWith'])($comp_0, $__local_var_1, ($v_4_1)->{'value1'}, ($__local_var_3)->{'value4'});
$r_prime__6_3 = ($GLOBALS['Data_Map_Internal_unsafeIntersectionWith'])($comp_0, $__local_var_1, ($v_4_1)->{'value2'}, ($__local_var_3)->{'value5'});
$__t4 = null;;
if (($v_4_1)->{'value0'} instanceof \Data\Maybe\Data_Maybe_Just) {
$__t4 = ($GLOBALS['Data_Map_Internal_unsafeBalancedNode'])(($__local_var_3)->{'value2'}, (($__local_var_1)((($v_4_1)->{'value0'})->{'value0'}))(($__local_var_3)->{'value3'}), $l_prime__5_2, $r_prime__6_3);
goto end_branch_4;;
};
if (($v_4_1)->{'value0'} instanceof \Data\Maybe\Data_Maybe_Nothing) {
$__t4 = ($GLOBALS['Data_Map_Internal_unsafeJoinNodes'])($l_prime__5_2, $r_prime__6_3);
goto end_branch_4;;
};
throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
$__t4 = null;
...
function majData_majMap_majInternal_unsafemajUnionmajWith($comp_0, $__local_var_1 = null, $__local_var_2 = null, $__local_var_3 = null) {
  $__num = \func_num_args();
  ...
  $__tco_var_Data_Map_Internal_unsafeUnionWith___local_var_2 = $__local_var_2;
  ...
  $__local_var_2 = $__tco_var_Data_Map_Internal_unsafeUnionWith___local_var_2;
...
goto end_branch_0;;
  ...
  if ($__local_var_3 instanceof \Data\Map\Internal\Data_Map_Internal_Node) {
$v_4_1 = ($GLOBALS['Data_Map_Internal_unsafeSplit'])($comp_0, ($__local_var_3)->{'value2'}, $__local_var_2);
$l_prime__5_2 = ($GLOBALS['Data_Map_Internal_unsafeUnionWith'])($comp_0, $__local_var_1, ($v_4_1)->{'value1'}, ($__local_var_3)->{'value4'});
$r_prime__6_3 = ($GLOBALS['Data_Map_Internal_unsafeUnionWith'])($comp_0, $__local_var_1, ($v_4_1)->{'value2'}, ($__local_var_3)->{'value5'});
$__t4 = null;;
if (($v_4_1)->{'value0'} instanceof \Data\Maybe\Data_Maybe_Just) {
$__t4 = ($GLOBALS['Data_Map_Internal_unsafeBalancedNode'])(($__local_var_3)->{'value2'}, (($__local_var_1)((($v_4_1)->{'value0'})->{'value0'}))(($__local_var_3)->{'value3'}), $l_prime__5_2, $r_prime__6_3);
goto end_branch_4;;
...
if (($v_4_1)->{'value0'} instanceof \Data\Maybe\Data_Maybe_Nothing) {
$__t4 = ($GLOBALS['Data_Map_Internal_unsafeBalancedNode'])(($__local_var_3)->{'value2'}, ($__local_var_3)->{'value3'}, $l_prime__5_2, $r_prime__6_3);
goto end_branch_4;;
};
throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
$__t4 = null;
...
goto end_branch_1;;
  ...
  if ($v_4 instanceof \Data\Map\Internal\Data_Map_Internal_Node) {
$__t1 = (((((((((($ind_3 . "[") . \Data\Show\majData_majShow_showmajIntmajImpl(($v_4)->{'value0'})) . "] ") . (($dictShow_0)->{'show'})(($v_4)->{'value2'})) . " => ") . (($dictShow1_1)->{'show'})(($v_4)->{'value3'})) . "
") . (($go__go_2_0)(($ind_3 . "    ")))(($v_4)->{'value4'})) . "
") . (($go__go_2_0)(($ind_3 . "    ")))(($v_4)->{'value5'}));
goto end_branch_1;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t1 = null;
...
function majData_majMap_majInternal_semigroupmajMap($_dollar___unused_0, $dictOrd_1 = null, $dictSemigroup_2 = null) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majMap_majInternal_semigroupmajMap';
  if ($__num < 3) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 3);
  }
  $compare_3_0 = ($dictOrd_1)->{'compare'};
  $__local_var_4_1 = ($dictSemigroup_2)->{'append'};
  $__res = (object)["append" => function($m1_5) use ($__local_var_4_1, $compare_3_0) {
  $__num = \func_num_args();
  $__res = function($m2_6) use ($__local_var_4_1, $compare_3_0, $m1_5) {
  $__num = \func_num_args();
  $__res = ($GLOBALS['Data_Map_Internal_unsafeUnionWith'])($compare_3_0, $__local_var_4_1, $m1_5, $m2_6);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
function majData_majMap_majInternal_pop($dictOrd_0) {
  ...
  $__t2 = null;;
  if (($v_4_1)->{'value0'} instanceof \Data\Maybe\Data_Maybe_Just) {
$__t2 = new \Data\Maybe\Data_Maybe_Just(new \Data\Tuple\Data_Tuple_Tuple((($v_4_1)->{'value0'})->{'value0'}, ($GLOBALS['Data_Map_Internal_unsafeJoinNodes'])(($v_4_1)->{'value1'}, ($v_4_1)->{'value2'})));
goto end_branch_2;;
};
...
function majData_majMap_majInternal_mapmajMaybe($dictOrd_0) {
  ...
  $__res = (($GLOBALS['Control_Semigroupoid_composeImpl'])(function($f_1) {
  $__num = \func_num_args();
  $go__go_2_0 = null;
  $go__go_2_0 = function($v_3) use ($f_1, &$go__go_2_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Map_Internal_stepUnfoldrUnordered_closure'] = ((($GLOBALS['Data_Map_Internal_stepWith'])($GLOBALS['Data_Map_Internal_iterMapU']))((function() {
  $__fn = function($k_0, $__local_var_1 = null, $__local_var_2 = null) use (&$__fn) {
  $__num = \func_num_args();
  if ($__num < 3) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 3);
  }
  $__res = new \Data\Maybe\Data_Maybe_Just(new \Data\Tuple\Data_Tuple_Tuple(new \Data\Tuple\Data_Tuple_Tuple($k_0, $__local_var_1), $__local_var_2));
  goto __end;;
  __end:
  return $__num > 3 ? $__res(...\array_slice(\func_get_args(), 3)) : $__res;
  };
...
$GLOBALS['Data_Map_Internal_stepUnordered_closure'] = ((($GLOBALS['Data_Map_Internal_stepWith'])($GLOBALS['Data_Map_Internal_iterMapU']))((function() {
  ...
  $__res = new \Data\Map\Internal\Data_Map_Internal_IterNext($k_0, $__local_var_1, $__local_var_2);
  goto __end;;
  __end:
  return $__num > 3 ? $__res(...\array_slice(\func_get_args(), 3)) : $__res;
  };
...
function majData_majMap_majInternal_ordmajMapmajIter($dictOrd_0) {
  ...
  $go__go_4_2 = null;
  $go__go_4_2 = function($a_5) use ($__local_var_1_0, $__local_var_3_1, &$go__go_4_2) {
  $__num = \func_num_args();
  $__res = function($b_6) use ($__local_var_1_0, $__local_var_3_1, $a_5, &$go__go_4_2) {
  $__num = \func_num_args();
...
$__t4 = ($v2_8_5 instanceof \Data\Map\Internal\Data_Map_Internal_IterNext && ((((($__local_var_1_0)->{'eq'})(($v_7_3)->{'value0'}))(($v2_8_5)->{'value0'}) && ((($__local_var_3_1)->{'eq'})(($v_7_3)->{'value1'}))(($v2_8_5)->{'value1'})) && (($go__go_4_2)(($v_7_3)->{'value2'}))(($v2_8_5)->{'value2'})));
goto end_branch_4;;
};
...
goto end_branch_4;;
  ...
  $eqMapIter2_3_1 = (object)["eq" => $go__go_4_2];
  $go__go_4_7 = null;
  $go__go_4_7 = (function() use ($dictOrd1_2, $dictOrd_0, &$go__go_4_7) {
  $__fn = function($a_5, $b_6 = null) use ($dictOrd1_2, $dictOrd_0, &$go__go_4_7, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_var_go__go_4_7_7_a_5 = $a_5;
  $__tco_var_go__go_4_7_7_b_6 = $b_6;
  tco_loop_go__go_4_7_7:;
  $a_5 = $__tco_var_go__go_4_7_7_a_5;
  $b_6 = $__tco_var_go__go_4_7_7_b_6;
  $v_7_7 = \Data\Map\Internal\majData_majMap_majInternal_stepmajAsc($b_6);
  $v1_8_8 = \Data\Map\Internal\majData_majMap_majInternal_stepmajAsc($a_5);
  $__t9 = null;;
  if ($v1_8_8 instanceof \Data\Map\Internal\Data_Map_Internal_IterNext) {
$__t10 = null;;
if ($v_7_7 instanceof \Data\Map\Internal\Data_Map_Internal_IterNext) {
$v3_9_11 = ((($dictOrd_0)->{'compare'})(($v1_8_8)->{'value0'}))(($v_7_7)->{'value0'});
$__t12 = null;;
if ($v3_9_11 instanceof \Data\Ordering\Data_Ordering_EQ) {
$v4_10_13 = ((($dictOrd1_2)->{'compare'})(($v1_8_8)->{'value1'}))(($v_7_7)->{'value1'});
$__t14 = null;;
if ($v4_10_13 instanceof \Data\Ordering\Data_Ordering_EQ) {
$__tco_15 = ($v1_8_8)->{'value2'};
$__tco_16 = ($v_7_7)->{'value2'};
$__tco_var_go__go_4_7_7_a_5 = $__tco_15;
$__tco_var_go__go_4_7_7_b_6 = $__tco_16;
...
if ($v_7_7 instanceof \Data\Map\Internal\Data_Map_Internal_IterDone) {
...
goto end_branch_9;;
  ...
  if ($v1_8_8 instanceof \Data\Map\Internal\Data_Map_Internal_IterDone) {
$__t17 = null;;
if ($v_7_7 instanceof \Data\Map\Internal\Data_Map_Internal_IterDone) {
...
goto end_branch_9;;
  ...
  $__res = (object)["compare" => $go__go_4_7, "Eq0" => function($_dollar___unused_4) use ($eqMapIter2_3_1) {
  $__num = \func_num_args();
...
$v1_5_2 = ($go__go_6_3)($m2_4);
$__t5 = null;;
if ($v1_5_2 instanceof \Data\Maybe\Data_Maybe_Nothing) {
$__t5 = false;
goto end_branch_5;;
};
if ($v1_5_2 instanceof \Data\Maybe\Data_Maybe_Just) {
$__t5 = (((($dictEq_1)->{'eq'})(($m1_3)->{'value3'}))(($v1_5_2)->{'value0'}) && ((($go__go_2_0)(($m1_3)->{'value4'}))($m2_4) && (($go__go_2_0)(($m1_3)->{'value5'}))($m2_4)));
goto end_branch_5;;
};
throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
$__t5 = null;
...
function majData_majMap_majInternal_ismajEmpty($v_0): bool|\Closure {
  ...
  $__res = $v_0 instanceof \Data\Map\Internal\Data_Map_Internal_Leaf;
  goto __end;;
  __end:
  return 1 < $__num ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}
...
$GLOBALS['Data_Map_Internal_foldableMap'] = (object)["foldr" => function($f_0) {
  ...
  $__fn = function($m_prime__3, $__local_var_4 = null) use ($f_0, &$go__go_2_0, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__t1 = null;;
  if ($m_prime__3 instanceof \Data\Map\Internal\Data_Map_Internal_Leaf) {
$__t1 = $__local_var_4;
goto end_branch_1;;
};
  if ($m_prime__3 instanceof \Data\Map\Internal\Data_Map_Internal_Node) {
$__t1 = ($go__go_2_0)(($m_prime__3)->{'value4'}, (($f_0)(($m_prime__3)->{'value3'}))(($go__go_2_0)(($m_prime__3)->{'value5'}, $__local_var_4)));
goto end_branch_1;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t1 = null;
  ...
  $__fn = function($z_prime__3, $__local_var_4 = null) use ($f_0, &$go__go_2_2, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
...
$__t3 = ($go__go_2_2)((($f_0)(($go__go_2_2)($z_prime__3, ($__local_var_4)->{'value4'})))(($__local_var_4)->{'value3'}), ($__local_var_4)->{'value5'});
goto end_branch_3;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t3 = null;
  ...
  $__res = function($f_2) use ($Semigroup0_1_4, $dictMonoid_0) {
  $__num = \func_num_args();
  $go__go_3_5 = null;
  $go__go_3_5 = function($v_4) use ($Semigroup0_1_4, $dictMonoid_0, $f_2, &$go__go_3_5) {
  $__num = \func_num_args();
  $__t6 = null;;
  if ($v_4 instanceof \Data\Map\Internal\Data_Map_Internal_Leaf) {
$__t6 = ($dictMonoid_0)->{'mempty'};
goto end_branch_6;;
};
  if ($v_4 instanceof \Data\Map\Internal\Data_Map_Internal_Node) {
$__t6 = ((($Semigroup0_1_4)->{'append'})(($go__go_3_5)(($v_4)->{'value4'})))(((($Semigroup0_1_4)->{'append'})(($f_2)(($v_4)->{'value3'})))(($go__go_3_5)(($v_4)->{'value5'})));
goto end_branch_6;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t6 = null;
...
goto end_branch_1;;
  ...
  if ($m_prime__3 instanceof \Data\Map\Internal\Data_Map_Internal_Node) {
$__t1 = ($go__go_2_0)(($m_prime__3)->{'value4'}, ((($f_0)(($m_prime__3)->{'value2'}))(($m_prime__3)->{'value3'}))(($go__go_2_0)(($m_prime__3)->{'value5'}, $__local_var_4)));
goto end_branch_1;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t1 = null;
...
goto end_branch_3;;
  ...
  if ($__local_var_4 instanceof \Data\Map\Internal\Data_Map_Internal_Node) {
$__t3 = ($go__go_2_2)(((($f_0)(($__local_var_4)->{'value2'}))(($go__go_2_2)($z_prime__3, ($__local_var_4)->{'value4'})))(($__local_var_4)->{'value3'}), ($__local_var_4)->{'value5'});
goto end_branch_3;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t3 = null;
...
goto end_branch_6;;
  ...
  if ($v_4 instanceof \Data\Map\Internal\Data_Map_Internal_Node) {
$__t6 = ((($Semigroup0_1_4)->{'append'})(($go__go_3_5)(($v_4)->{'value4'})))(((($Semigroup0_1_4)->{'append'})((($f_2)(($v_4)->{'value2'}))(($v_4)->{'value3'})))(($go__go_3_5)(($v_4)->{'value5'})));
goto end_branch_6;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t6 = null;
...
$GLOBALS['Data_Map_Internal_keys_closure'] = (function() use (&$__fn) {
$go__go_0_0 = null;
$go__go_0_0 = (function() use (&$go__go_0_0) {
  $__fn = function($m_prime__1, $__local_var_2 = null) use (&$go__go_0_0, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__t1 = null;;
  if ($m_prime__1 instanceof \Data\Map\Internal\Data_Map_Internal_Leaf) {
$__t1 = $__local_var_2;
goto end_branch_1;;
};
  if ($m_prime__1 instanceof \Data\Map\Internal\Data_Map_Internal_Node) {
$__t1 = ($go__go_0_0)(($m_prime__1)->{'value4'}, new \Data\List\Types\Data_List_Types_Cons(($m_prime__1)->{'value2'}, ($go__go_0_0)(($m_prime__1)->{'value5'}, $__local_var_2)));
goto end_branch_1;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t1 = null;
...
return function($m_1) use (&$go__go_0_0) {
  $__num = \func_num_args();
  $__res = ($go__go_0_0)($m_1, new \Data\List\Types\Data_List_Types_Nil());
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
$GLOBALS['Data_Map_Internal_traversableMap'] = (object)["traverse" => function($dictApplicative_0) {
  ...
  $__num = \func_num_args();
  $go__go_4_2 = null;
  $go__go_4_2 = function($v_5) use ($Apply0_1_0, $Functor0_2_1, $dictApplicative_0, $f_3, &$go__go_4_2) {
  $__num = \func_num_args();
  $__t3 = null;;
  if ($v_5 instanceof \Data\Map\Internal\Data_Map_Internal_Leaf) {
$__t3 = (($dictApplicative_0)->{'pure'})(new \Data\Map\Internal\Data_Map_Internal_Leaf());
goto end_branch_3;;
};
  if ($v_5 instanceof \Data\Map\Internal\Data_Map_Internal_Node) {
$__local_var_6_4 = ($v_5)->{'value0'};
$__local_var_7_5 = ($v_5)->{'value2'};
$__local_var_8_6 = ($v_5)->{'value1'};
$__t3 = ((($Apply0_1_0)->{'apply'})(((($Apply0_1_0)->{'apply'})(((($Functor0_2_1)->{'map'})(function($l_prime__9) use ($__local_var_6_4, $__local_var_7_5, $__local_var_8_6) {
  $__num = \func_num_args();
  $__res = function($v_prime__10) use ($__local_var_6_4, $__local_var_7_5, $__local_var_8_6, $l_prime__9) {
  $__num = \func_num_args();
  $__res = function($r_prime__11) use ($__local_var_6_4, $__local_var_7_5, $__local_var_8_6, $l_prime__9, $v_prime__10) {
  $__num = \func_num_args();
  $__res = new \Data\Map\Internal\Data_Map_Internal_Node($__local_var_6_4, $__local_var_8_6, $__local_var_7_5, $v_prime__10, $l_prime__9, $r_prime__11);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))(($go__go_4_2)(($v_5)->{'value4'}))))(($f_3)(($v_5)->{'value3'}))))(($go__go_4_2)(($v_5)->{'value5'}));
goto end_branch_3;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t3 = null;
  ...
  $__num = \func_num_args();
  $__res = ((($GLOBALS['Data_Map_Internal_traversableMap'])->{'traverse'})($dictApplicative_0))(function($x_1) {
  $__num = \func_num_args();
  $__res = $x_1;
  goto __end;;
  __end:
...
$__t3 = ((($Apply0_1_0)->{'apply'})(((($Apply0_1_0)->{'apply'})(((($Functor0_2_1)->{'map'})(function($l_prime__9) use ($__local_var_6_4, $__local_var_7_5, $__local_var_8_6) {
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))(($go__go_4_2)(($v_5)->{'value4'}))))((($f_3)($__local_var_7_5))(($v_5)->{'value3'}))))(($go__go_4_2)(($v_5)->{'value5'}));
goto end_branch_3;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t3 = null;
...
$GLOBALS['Data_Map_Internal_values_closure'] = (function() use (&$__fn) {
$go__go_0_0 = null;
$go__go_0_0 = (function() use (&$go__go_0_0) {
  $__fn = function($m_prime__1, $__local_var_2 = null) use (&$go__go_0_0, &$__fn) {
  $__num = \func_num_args();
...
goto end_branch_1;;
  ...
  if ($m_prime__1 instanceof \Data\Map\Internal\Data_Map_Internal_Node) {
$__t1 = ($go__go_0_0)(($m_prime__1)->{'value4'}, new \Data\List\Types\Data_List_Types_Cons(($m_prime__1)->{'value3'}, ($go__go_0_0)(($m_prime__1)->{'value5'}, $__local_var_2)));
goto end_branch_1;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t1 = null;
...
function majData_majMap_majInternal_foldmajSubmap($dictOrd_0, $dictMonoid_1 = null) {
  ...
  $__local_var_2_0 = ((($dictMonoid_1)->{'Semigroup0'})(null))->{'append'};
  $__local_var_3_1 = ($dictMonoid_1)->{'mempty'};
  $__res = function($kmin_4) use ($__local_var_2_0, $__local_var_3_1, $dictOrd_0) {
  $__num = \func_num_args();
  $__res = function($kmax_5) use ($__local_var_2_0, $__local_var_3_1, $dictOrd_0, $kmin_4) {
  $__num = \func_num_args();
  $__res = function($f_6) use ($__local_var_2_0, $__local_var_3_1, $dictOrd_0, $kmax_5, $kmin_4) {
  $__num = \func_num_args();
  $__t2 = null;;
  if ($kmin_4 instanceof \Data\Maybe\Data_Maybe_Just) {
$__local_var_7_3 = ($kmin_4)->{'value0'};
$__t2 = function($k_8) use ($__local_var_7_3, $dictOrd_0) {
  $__num = \func_num_args();
  $__res = ((($dictOrd_0)->{'compare'})($k_8))($__local_var_7_3) instanceof \Data\Ordering\Data_Ordering_LT;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
goto end_branch_2;;
  ...
  if ($kmin_4 instanceof \Data\Maybe\Data_Maybe_Nothing) {
$__t2 = function($v_7) {
  $__num = \func_num_args();
  $__res = false;
  goto __end;;
...
goto end_branch_2;;
  ...
  $tooSmall_7_2 = $__t2;
  $__t5 = null;;
  if ($kmax_5 instanceof \Data\Maybe\Data_Maybe_Just) {
$__local_var_8_6 = ($kmax_5)->{'value0'};
$__t5 = function($k_9) use ($__local_var_8_6, $dictOrd_0) {
  $__num = \func_num_args();
  $__res = ((($dictOrd_0)->{'compare'})($k_9))($__local_var_8_6) instanceof \Data\Ordering\Data_Ordering_GT;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
goto end_branch_5;;
  ...
  if ($kmax_5 instanceof \Data\Maybe\Data_Maybe_Nothing) {
$__t5 = function($v_8) {
  $__num = \func_num_args();
  $__res = false;
  goto __end;;
...
$__t9 = null;;
if ($kmax_5 instanceof \Data\Maybe\Data_Maybe_Just) {
$__local_var_9_10 = ($kmax_5)->{'value0'};
$__local_var_10_11 = ($kmin_4)->{'value0'};
$__t9 = function($k_11) use ($__local_var_10_11, $__local_var_9_10, $dictOrd_0) {
  $__num = \func_num_args();
  $__res = (( ! ((($dictOrd_0)->{'compare'})($__local_var_10_11))($k_11) instanceof \Data\Ordering\Data_Ordering_GT) && ( ! ((($dictOrd_0)->{'compare'})($k_11))($__local_var_9_10) instanceof \Data\Ordering\Data_Ordering_GT));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
if ($kmax_5 instanceof \Data\Maybe\Data_Maybe_Nothing) {
$__local_var_9_12 = ($kmin_4)->{'value0'};
$__t9 = function($k_10) use ($__local_var_9_12, $dictOrd_0) {
  $__num = \func_num_args();
  $__res = ( ! ((($dictOrd_0)->{'compare'})($__local_var_9_12))($k_10) instanceof \Data\Ordering\Data_Ordering_GT);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
$__t13 = null;;
if ($kmax_5 instanceof \Data\Maybe\Data_Maybe_Just) {
$__local_var_9_14 = ($kmax_5)->{'value0'};
$__t13 = function($k_10) use ($__local_var_9_14, $dictOrd_0) {
  $__num = \func_num_args();
  $__res = ( ! ((($dictOrd_0)->{'compare'})($k_10))($__local_var_9_14) instanceof \Data\Ordering\Data_Ordering_GT);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
goto end_branch_8;;
  ...
  $inBounds_9_8 = $__t8;
  $go__go_10_16 = null;
  $go__go_10_16 = function($v_11) use ($__local_var_2_0, $__local_var_3_1, $f_6, &$go__go_10_16, $inBounds_9_8, $tooLarge_8_5, $tooSmall_7_2) {
  $__num = \func_num_args();
  $__t17 = null;;
  if ($v_11 instanceof \Data\Map\Internal\Data_Map_Internal_Leaf) {
$__t17 = $__local_var_3_1;
goto end_branch_17;;
};
  if ($v_11 instanceof \Data\Map\Internal\Data_Map_Internal_Node) {
$__t18 = null;;
if (($tooSmall_7_2)(($v_11)->{'value2'})) {
$__t18 = $__local_var_3_1;
goto end_branch_18;;
};
$__t18 = ($go__go_10_16)(($v_11)->{'value4'});
end_branch_18:;
$__t19 = null;;
if (($inBounds_9_8)(($v_11)->{'value2'})) {
$__t19 = (($f_6)(($v_11)->{'value2'}))(($v_11)->{'value3'});
goto end_branch_19;;
};
$__t19 = $__local_var_3_1;
end_branch_19:;
$__t20 = null;;
if (($tooLarge_8_5)(($v_11)->{'value2'})) {
$__t20 = $__local_var_3_1;
goto end_branch_20;;
};
$__t20 = ($go__go_10_16)(($v_11)->{'value5'});
end_branch_20:;
$__t17 = (($__local_var_2_0)((($__local_var_2_0)($__t18))($__t19)))($__t20);
goto end_branch_17;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t17 = null;
...
function majData_majMap_majInternal_frommajFoldable($dictOrd_0, $dictFoldable_1 = null) {
  ...
  $__num = \func_num_args();
  $__local_var_4_0 = ($v_3)->{'value0'};
  $__local_var_5_1 = ($v_3)->{'value1'};
  $go__go_6_2 = null;
  $go__go_6_2 = function($v1_7) use ($__local_var_4_0, $__local_var_5_1, $dictOrd_0, &$go__go_6_2) {
  $__num = \func_num_args();
  $__t3 = null;;
  if ($v1_7 instanceof \Data\Map\Internal\Data_Map_Internal_Leaf) {
$__t3 = new \Data\Map\Internal\Data_Map_Internal_Node(1, 1, $__local_var_4_0, $__local_var_5_1, new \Data\Map\Internal\Data_Map_Internal_Leaf(), new \Data\Map\Internal\Data_Map_Internal_Leaf());
goto end_branch_3;;
};
  if ($v1_7 instanceof \Data\Map\Internal\Data_Map_Internal_Node) {
$v2_8_4 = ((($dictOrd_0)->{'compare'})($__local_var_4_0))(($v1_7)->{'value2'});
$__t5 = null;;
...
$__t5 = new \Data\Map\Internal\Data_Map_Internal_Node(($v1_7)->{'value0'}, ($v1_7)->{'value1'}, $__local_var_4_0, $__local_var_5_1, ($v1_7)->{'value4'}, ($v1_7)->{'value5'});
goto end_branch_5;;
};
throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
$__t5 = null;
...
function majData_majMap_majInternal_frommajFoldablemajWith($dictOrd_0, $dictFoldable_1 = null, $f_2 = null) {
  ...
  $__res = ((($dictFoldable_1)->{'foldl'})(function($m_3) use ($dictOrd_0, $f_2) {
  $__num = \func_num_args();
  $__res = function($v_4) use ($dictOrd_0, $f_2, $m_3) {
  $__num = \func_num_args();
  $__local_var_5_0 = ($v_4)->{'value0'};
  $__local_var_6_1 = ($v_4)->{'value1'};
  $go__go_7_2 = null;
  $go__go_7_2 = function($v1_8) use ($__local_var_5_0, $__local_var_6_1, $dictOrd_0, $f_2, &$go__go_7_2) {
  $__num = \func_num_args();
  $__t3 = null;;
  if ($v1_8 instanceof \Data\Map\Internal\Data_Map_Internal_Leaf) {
$__t3 = new \Data\Map\Internal\Data_Map_Internal_Node(1, 1, $__local_var_5_0, $__local_var_6_1, new \Data\Map\Internal\Data_Map_Internal_Leaf(), new \Data\Map\Internal\Data_Map_Internal_Leaf());
goto end_branch_3;;
};
  if ($v1_8 instanceof \Data\Map\Internal\Data_Map_Internal_Node) {
$v2_9_4 = ((($dictOrd_0)->{'compare'})($__local_var_5_0))(($v1_8)->{'value2'});
$__t5 = null;;
if ($v2_9_4 instanceof \Data\Ordering\Data_Ordering_LT) {
$__t5 = ($GLOBALS['Data_Map_Internal_unsafeBalancedNode'])(($v1_8)->{'value2'}, ($v1_8)->{'value3'}, ($go__go_7_2)(($v1_8)->{'value4'}), ($v1_8)->{'value5'});
goto end_branch_5;;
};
if ($v2_9_4 instanceof \Data\Ordering\Data_Ordering_GT) {
$__t5 = ($GLOBALS['Data_Map_Internal_unsafeBalancedNode'])(($v1_8)->{'value2'}, ($v1_8)->{'value3'}, ($v1_8)->{'value4'}, ($go__go_7_2)(($v1_8)->{'value5'}));
goto end_branch_5;;
};
if ($v2_9_4 instanceof \Data\Ordering\Data_Ordering_EQ) {
$__t5 = new \Data\Map\Internal\Data_Map_Internal_Node(($v1_8)->{'value0'}, ($v1_8)->{'value1'}, $__local_var_5_0, (($f_2)($__local_var_6_1))(($v1_8)->{'value3'}), ($v1_8)->{'value4'}, ($v1_8)->{'value5'});
goto end_branch_5;;
};
throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
$__t5 = null;
...
function majData_majMap_majInternal_frommajFoldablemajWithmajIndex($dictOrd_0, $dictFoldableWithIndex_1 = null) {
  ...
  $__num = \func_num_args();
  $go__go_5_0 = null;
  $go__go_5_0 = function($v1_6) use ($dictOrd_0, &$go__go_5_0, $k_2, $v_4) {
  $__num = \func_num_args();
  $__t1 = null;;
  if ($v1_6 instanceof \Data\Map\Internal\Data_Map_Internal_Leaf) {
$__t1 = new \Data\Map\Internal\Data_Map_Internal_Node(1, 1, $k_2, $v_4, new \Data\Map\Internal\Data_Map_Internal_Leaf(), new \Data\Map\Internal\Data_Map_Internal_Leaf());
goto end_branch_1;;
};
  if ($v1_6 instanceof \Data\Map\Internal\Data_Map_Internal_Node) {
$v2_7_2 = ((($dictOrd_0)->{'compare'})($k_2))(($v1_6)->{'value2'});
$__t3 = null;;
if ($v2_7_2 instanceof \Data\Ordering\Data_Ordering_LT) {
$__t3 = ($GLOBALS['Data_Map_Internal_unsafeBalancedNode'])(($v1_6)->{'value2'}, ($v1_6)->{'value3'}, ($go__go_5_0)(($v1_6)->{'value4'}), ($v1_6)->{'value5'});
goto end_branch_3;;
};
if ($v2_7_2 instanceof \Data\Ordering\Data_Ordering_GT) {
$__t3 = ($GLOBALS['Data_Map_Internal_unsafeBalancedNode'])(($v1_6)->{'value2'}, ($v1_6)->{'value3'}, ($v1_6)->{'value4'}, ($go__go_5_0)(($v1_6)->{'value5'}));
goto end_branch_3;;
};
if ($v2_7_2 instanceof \Data\Ordering\Data_Ordering_EQ) {
$__t3 = new \Data\Map\Internal\Data_Map_Internal_Node(($v1_6)->{'value0'}, ($v1_6)->{'value1'}, $k_2, $v_4, ($v1_6)->{'value4'}, ($v1_6)->{'value5'});
goto end_branch_3;;
};
throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
$__t3 = null;
...
function majData_majMap_majInternal_monoidmajSemigroupmajMap($_dollar___unused_0, $dictOrd_1 = null, $dictSemigroup_2 = null) {
  $__num = \func_num_args();
  ...
  $compare_3_0 = ($dictOrd_1)->{'compare'};
  $__local_var_4_1 = ($dictSemigroup_2)->{'append'};
  $semigroupMap3_3_0 = (object)["append" => function($m1_5) use ($__local_var_4_1, $compare_3_0) {
  $__num = \func_num_args();
  $__res = function($m2_6) use ($__local_var_4_1, $compare_3_0, $m1_5) {
  $__num = \func_num_args();
  $__res = ($GLOBALS['Data_Map_Internal_unsafeUnionWith'])($compare_3_0, $__local_var_4_1, $m1_5, $m2_6);
  ...
  $__res = (object)["mempty" => new \Data\Map\Internal\Data_Map_Internal_Leaf(), "Semigroup0" => function($_dollar___unused_4) use ($semigroupMap3_3_0) {
  $__num = \func_num_args();
  $__res = $semigroupMap3_3_0;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}];
...
function majData_majMap_majInternal_submap($dictOrd_0) {
  ...
  $__num = \func_num_args();
  $__t2 = null;;
  if ($kmin_2 instanceof \Data\Maybe\Data_Maybe_Just) {
$__local_var_4_3 = ($kmin_2)->{'value0'};
$__t2 = function($k_5) use ($__local_var_4_3, $dictOrd_0) {
  $__num = \func_num_args();
  $__res = ((($dictOrd_0)->{'compare'})($k_5))($__local_var_4_3) instanceof \Data\Ordering\Data_Ordering_LT;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
goto end_branch_2;;
  ...
  if ($kmin_2 instanceof \Data\Maybe\Data_Maybe_Nothing) {
$__t2 = function($v_4) {
  $__num = \func_num_args();
  $__res = false;
  goto __end;;
...
goto end_branch_2;;
  ...
  $tooSmall_4_2 = $__t2;
  $__t5 = null;;
  if ($kmax_3 instanceof \Data\Maybe\Data_Maybe_Just) {
$__local_var_5_6 = ($kmax_3)->{'value0'};
$__t5 = function($k_6) use ($__local_var_5_6, $dictOrd_0) {
  $__num = \func_num_args();
  $__res = ((($dictOrd_0)->{'compare'})($k_6))($__local_var_5_6) instanceof \Data\Ordering\Data_Ordering_GT;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
goto end_branch_5;;
  ...
  if ($kmax_3 instanceof \Data\Maybe\Data_Maybe_Nothing) {
$__t5 = function($v_5) {
  $__num = \func_num_args();
  $__res = false;
  goto __end;;
...
$__t9 = null;;
if ($kmax_3 instanceof \Data\Maybe\Data_Maybe_Just) {
$__local_var_6_10 = ($kmax_3)->{'value0'};
$__local_var_7_11 = ($kmin_2)->{'value0'};
$__t9 = function($k_8) use ($__local_var_6_10, $__local_var_7_11, $dictOrd_0) {
  $__num = \func_num_args();
  $__res = (( ! ((($dictOrd_0)->{'compare'})($__local_var_7_11))($k_8) instanceof \Data\Ordering\Data_Ordering_GT) && ( ! ((($dictOrd_0)->{'compare'})($k_8))($__local_var_6_10) instanceof \Data\Ordering\Data_Ordering_GT));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
if ($kmax_3 instanceof \Data\Maybe\Data_Maybe_Nothing) {
$__local_var_6_12 = ($kmin_2)->{'value0'};
$__t9 = function($k_7) use ($__local_var_6_12, $dictOrd_0) {
  $__num = \func_num_args();
  $__res = ( ! ((($dictOrd_0)->{'compare'})($__local_var_6_12))($k_7) instanceof \Data\Ordering\Data_Ordering_GT);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
$__t13 = null;;
if ($kmax_3 instanceof \Data\Maybe\Data_Maybe_Just) {
$__local_var_6_14 = ($kmax_3)->{'value0'};
$__t13 = function($k_7) use ($__local_var_6_14, $dictOrd_0) {
  $__num = \func_num_args();
  $__res = ( ! ((($dictOrd_0)->{'compare'})($k_7))($__local_var_6_14) instanceof \Data\Ordering\Data_Ordering_GT);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
goto end_branch_8;;
  ...
  $inBounds_6_8 = $__t8;
  $go__go_7_16 = null;
  $go__go_7_16 = function($v_8) use (&$go__go_7_16, $inBounds_6_8, $tooLarge_5_5, $tooSmall_4_2, $union1_1_0) {
  $__num = \func_num_args();
  $__t17 = null;;
  if ($v_8 instanceof \Data\Map\Internal\Data_Map_Internal_Leaf) {
$__t17 = new \Data\Map\Internal\Data_Map_Internal_Leaf();
goto end_branch_17;;
};
  if ($v_8 instanceof \Data\Map\Internal\Data_Map_Internal_Node) {
$__t18 = null;;
if (($tooSmall_4_2)(($v_8)->{'value2'})) {
$__t18 = new \Data\Map\Internal\Data_Map_Internal_Leaf();
goto end_branch_18;;
};
$__t18 = ($go__go_7_16)(($v_8)->{'value4'});
end_branch_18:;
$__t19 = null;;
if (($inBounds_6_8)(($v_8)->{'value2'})) {
$__t19 = new \Data\Map\Internal\Data_Map_Internal_Node(1, 1, ($v_8)->{'value2'}, ($v_8)->{'value3'}, new \Data\Map\Internal\Data_Map_Internal_Leaf(), new \Data\Map\Internal\Data_Map_Internal_Leaf());
goto end_branch_19;;
};
$__t19 = new \Data\Map\Internal\Data_Map_Internal_Leaf();
end_branch_19:;
$__t20 = null;;
if (($tooLarge_5_5)(($v_8)->{'value2'})) {
$__t20 = new \Data\Map\Internal\Data_Map_Internal_Leaf();
goto end_branch_20;;
};
$__t20 = ($go__go_7_16)(($v_8)->{'value5'});
end_branch_20:;
$__t17 = (($union1_1_0)((($union1_1_0)($__t18))($__t19)))($__t20);
goto end_branch_17;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t17 = null;
...
function majData_majMap_majInternal_catmajMaybes($dictOrd_0) {
  ...
  $__res = \Control\Semigroupoid\majControl_majSemigroupoid_composemajImpl(function($f_1) {
  $__num = \func_num_args();
  $go__go_2_0 = null;
  $go__go_2_0 = function($v_3) use ($f_1, &$go__go_2_0) {
  $__num = \func_num_args();
...
goto end_branch_1;;
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, $GLOBALS['Data_Function_const'], function($x_1) {
  $__num = \func_num_args();
  $__res = $x_1;
  goto __end;;
  __end:
...
goto end_branch_1;;
  ...
  if ($v_2 instanceof \Data\Map\Internal\Data_Map_Internal_Node) {
$__t1 = ((($predicate_0)(($v_2)->{'value2'}))(($v_2)->{'value3'}) || (($go__go_1_0)(($v_2)->{'value4'}) || ($go__go_1_0)(($v_2)->{'value5'})));
goto end_branch_1;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t1 = null;
...
goto end_branch_1;;
  ...
  if ($v_2 instanceof \Data\Map\Internal\Data_Map_Internal_Node) {
$__t1 = (($predicate_0)(($v_2)->{'value3'}) || (($go__go_1_0)(($v_2)->{'value4'}) || ($go__go_1_0)(($v_2)->{'value5'})));
goto end_branch_1;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t1 = null;
