...
switch ($v_0) {
case 0:
$__t3 = new \Data\Maybe\Data_Maybe_Just(new \Data\List\Types\Data_List_Types_Cons($v1_1, ($v2_2)->{'value1'}));
goto end_branch_3;;
break;
default:
;
...
$__local_var_3_1 = \Data\List\majData_majList_updatemajAt(($v_0 - 1), $v1_1, ($v2_2)->{'value1'});
$__t2 = null;;
if ($__local_var_3_1 instanceof \Data\Maybe\Data_Maybe_Just) {
$__t2 = new \Data\Maybe\Data_Maybe_Just(new \Data\List\Types\Data_List_Types_Cons(($v2_2)->{'value0'}, ($__local_var_3_1)->{'value0'}));
goto end_branch_2;;
};
...
$GLOBALS['Data_List_unzip_closure'] = (function() use (&$__fn) {
$go__go_0_0 = null;
$go__go_0_0 = (function() use (&$go__go_0_0) {
  $__fn = function($b_1, $v_2 = null) use (&$go__go_0_0, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
...
$__tco_1 = new \Data\Tuple\Data_Tuple_Tuple(new \Data\List\Types\Data_List_Types_Cons((($v_2)->{'value0'})->{'value0'}, ($b_1)->{'value0'}), new \Data\List\Types\Data_List_Types_Cons((($v_2)->{'value0'})->{'value1'}, ($b_1)->{'value1'}));
$__tco_2 = ($v_2)->{'value1'};
$__tco_var_go__go_0_0_0_b_1 = $__tco_1;
...
$go__go_0_1 = null;
$go__go_0_1 = (function() use (&$go__go_0_1) {
  $__fn = function($v_1, $v1_2 = null) use (&$go__go_0_1, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_var_go__go_0_1_1_v_1 = $v_1;
  $__tco_var_go__go_0_1_1_v1_2 = $v1_2;
  tco_loop_go__go_0_1_1:;
  $v_1 = $__tco_var_go__go_0_1_1_v_1;
  $v1_2 = $__tco_var_go__go_0_1_1_v1_2;
  $__t1 = null;;
...
$__tco_2 = new \Data\List\Types\Data_List_Types_Cons(($v1_2)->{'value0'}, $v_1);
$__tco_3 = ($v1_2)->{'value1'};
$__tco_var_go__go_0_1_1_v_1 = $__tco_2;
$__tco_var_go__go_0_1_1_v1_2 = $__tco_3;
goto tco_loop_go__go_0_1_1;;
$__t1 = null;
goto end_branch_1;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
...
return (($GLOBALS['Control_Semigroupoid_composeImpl'])(($go__go_0_0)(new \Data\Tuple\Data_Tuple_Tuple(new \Data\List\Types\Data_List_Types_Nil(), new \Data\List\Types\Data_List_Types_Nil()))))(($go__go_0_1)(new \Data\List\Types\Data_List_Types_Nil()));
})();
...
goto end_branch_0;;
  ...
  $__local_var_4_6 = (object)["a" => $v_1, "b" => $s_2];
...
$__t4 = new \Control\Monad\Rec\Class\Control_Monad_Rec_Class_Done(new \Data\Maybe\Data_Maybe_Nothing());
goto end_branch_4;;
};
...
$__t5 = new \Control\Monad\Rec\Class\Control_Monad_Rec_Class_Loop((($__local_var_3_0)(((($v_4)->{'value0'})->{'value0'})->{'a'}))(((($v_4)->{'value0'})->{'value0'})->{'b'}));
goto end_branch_5;;
};
if (($v_4)->{'value0'} instanceof \Control\Monad\Rec\Class\Control_Monad_Rec_Class_Done) {
$__t5 = new \Control\Monad\Rec\Class\Control_Monad_Rec_Class_Done(new \Data\Maybe\Data_Maybe_Just((($v_4)->{'value0'})->{'value0'}));
goto end_branch_5;;
};
throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
$__t5 = null;
...
goto end_branch_4;;
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, (($__local_var_3_0)(($__local_var_4_6)->{'a'}))(($__local_var_4_6)->{'b'}));
  goto __end;;
  __end:
  return 3 < $__num ? $__res(...\array_slice(\func_get_args(), 3)) : $__res;
}
...
goto end_branch_1;;
  ...
  $__res = \Control\Semigroupoid\majControl_majSemigroupoid_composemajImpl(($go__go_2_0)(new \Data\List\Types\Data_List_Types_Cons($x_1, new \Data\List\Types\Data_List_Types_Nil())), ($go__go_2_1)(new \Data\List\Types\Data_List_Types_Nil()), $xs_0);
  goto __end;;
  __end:
  return 2 < $__num ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
}
...
function majData_majList_sortmajBy($cmp_0) {
  ...
  $merge_1_0 = null;
  $merge_1_0 = function($v_2) use ($cmp_0, &$merge_1_0) {
  $__num = \func_num_args();
  $__res = function($v1_3) use ($cmp_0, &$merge_1_0, $v_2) {
  $__num = \func_num_args();
  $__t1 = null;;
  if ($v_2 instanceof \Data\List\Types\Data_List_Types_Cons) {
$__t2 = null;;
...
$__t3 = null;;
if ((($cmp_0)(($v_2)->{'value0'}))(($v1_3)->{'value0'}) instanceof \Data\Ordering\Data_Ordering_GT) {
...
$__t10 = null;;
if ((($cmp_0)(($v_5)->{'value0'}))((($v_5)->{'value1'})->{'value0'}) instanceof \Data\Ordering\Data_Ordering_GT) {
...
goto end_branch_8;;
  ...
  $descending_4_7 = function($v_5) use ($cmp_0, &$descending_4_7, &$sequences_4_7) {
  $__num = \func_num_args();
  $__res = function($v1_6) use ($cmp_0, &$descending_4_7, &$sequences_4_7, $v_5) {
  $__num = \func_num_args();
  $__res = function($v2_7) use ($cmp_0, &$descending_4_7, &$sequences_4_7, $v1_6, $v_5) {
  $__num = \func_num_args();
  $__t11 = null;;
  if (($v2_7 instanceof \Data\List\Types\Data_List_Types_Cons && (($cmp_0)($v_5))(($v2_7)->{'value0'}) instanceof \Data\Ordering\Data_Ordering_GT)) {
...
goto end_branch_11;;
  ...
  $ascending_4_7 = function($v_5) use (&$ascending_4_7, $cmp_0, &$sequences_4_7) {
  $__num = \func_num_args();
  $__res = function($v1_6) use (&$ascending_4_7, $cmp_0, &$sequences_4_7, $v_5) {
  $__num = \func_num_args();
  $__res = function($v2_7) use (&$ascending_4_7, $cmp_0, &$sequences_4_7, $v1_6, $v_5) {
  $__num = \func_num_args();
  $__t12 = null;;
  if (($v2_7 instanceof \Data\List\Types\Data_List_Types_Cons && ( ! (($cmp_0)($v_5))(($v2_7)->{'value0'}) instanceof \Data\Ordering\Data_Ordering_GT))) {
...
function majData_majList_showmajPattern($dictShow_0) {
  ...
  $showList_1_0 = (object)["show" => function($v_2) use ($show_1_0) {
  $__num = \func_num_args();
  $__t2 = null;;
  if ($v_2 instanceof \Data\List\Types\Data_List_Types_Nil) {
$__t2 = "Nil";
...
goto end_branch_0;;
  ...
  $__local_var_2_1 = (($go__go_1_0)($lst_0))(new \Data\List\Types\Data_List_Types_Nil());
  $__t2 = null;;
  if ($__local_var_2_1 instanceof \Data\Maybe\Data_Maybe_Just) {
$go__go_3_3 = null;
$go__go_3_3 = (function() use (&$go__go_3_3) {
  $__fn = function($v_4, $v1_5 = null) use (&$go__go_3_3, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_var_go__go_3_3_3_v_4 = $v_4;
  $__tco_var_go__go_3_3_3_v1_5 = $v1_5;
  tco_loop_go__go_3_3_3:;
  $v_4 = $__tco_var_go__go_3_3_3_v_4;
  $v1_5 = $__tco_var_go__go_3_3_3_v1_5;
  $__t3 = null;;
...
$__tco_4 = new \Data\List\Types\Data_List_Types_Cons(($v1_5)->{'value0'}, $v_4);
$__tco_5 = ($v1_5)->{'value1'};
$__tco_var_go__go_3_3_3_v_4 = $__tco_4;
$__tco_var_go__go_3_3_3_v1_5 = $__tco_5;
...
$__t2 = new \Data\Maybe\Data_Maybe_Just((object)["init" => (($go__go_3_3)(new \Data\List\Types\Data_List_Types_Nil()))((($__local_var_2_1)->{'value0'})->{'revInit'}), "last" => (($__local_var_2_1)->{'value0'})->{'last'}]);
goto end_branch_2;;
};
  $__t2 = new \Data\Maybe\Data_Maybe_Nothing();
  end_branch_2:;
...
// Data_List_zipWithA
function majData_majList_zipmajWithmajA($dictApplicative_0, $f_1 = null, $xs_2 = null, $ys_3 = null) {
  $__num = \func_num_args();
...
goto end_branch_1;;
  ...
  $go__go_5_2 = null;
  $go__go_5_2 = (function() use ($Apply0_4_0, &$go__go_5_2) {
  $__fn = function($b_6, $v_7 = null) use ($Apply0_4_0, &$go__go_5_2, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
...
goto end_branch_2;;
  ...
  if ($v_7 instanceof \Data\List\Types\Data_List_Types_Cons) {
$Functor0_8_3 = (($Apply0_4_0)->{'Functor0'})(null);
$__tco_4 = \Control\Semigroupoid\majControl_majSemigroupoid_composemajImpl(function($b_9) use ($Apply0_4_0, $Functor0_8_3, $b_6) {
  $__num = \func_num_args();
  $__res = ((($Apply0_4_0)->{'apply'})(((($Functor0_8_3)->{'map'})(function($b_10) {
  $__num = \func_num_args();
  $__res = function($a_11) use ($b_10) {
  $__num = \func_num_args();
  $__res = new \Data\List\Types\Data_List_Types_Cons($a_11, $b_10);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
$__tco_var_go__go_5_2_2_v_7 = $__tco_5;
...
goto end_branch_2;;
  ...
  $go__go_5_3 = null;
  $go__go_5_3 = (function() use ($f_1, &$go__go_5_3) {
  $__fn = function($v_6, $v1_7 = null, $v2_8 = null) use ($f_1, &$go__go_5_3, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 3) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 3);
  }
...
$__tco_4 = ($v_6)->{'value1'};
$__tco_5 = ($v1_7)->{'value1'};
$__tco_6 = new \Data\List\Types\Data_List_Types_Cons((($f_1)(($v_6)->{'value0'}))(($v1_7)->{'value0'}), $v2_8);
$__tco_var_go__go_5_3_3_v_6 = $__tco_4;
$__tco_var_go__go_5_3_3_v1_7 = $__tco_5;
$__tco_var_go__go_5_3_3_v2_8 = $__tco_6;
...
goto end_branch_3;;
  ...
  $__fn = function($v_7, $v1_8 = null) use (&$go__go_6_4, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_var_go__go_6_4_4_v_7 = $v_7;
  $__tco_var_go__go_6_4_4_v1_8 = $v1_8;
  tco_loop_go__go_6_4_4:;
  $v_7 = $__tco_var_go__go_6_4_4_v_7;
  $v1_8 = $__tco_var_go__go_6_4_4_v1_8;
  $__t4 = null;;
...
$__tco_5 = new \Data\List\Types\Data_List_Types_Cons(($v1_8)->{'value0'}, $v_7);
$__tco_6 = ($v1_8)->{'value1'};
$__tco_var_go__go_6_4_4_v_7 = $__tco_5;
$__tco_var_go__go_6_4_4_v1_8 = $__tco_6;
...
goto end_branch_4;;
  ...
  $__res = \Control\Semigroupoid\majControl_majSemigroupoid_composemajImpl((((((($dictApplicative_0)->{'Apply0'})(null))->{'Functor0'})(null))->{'map'})(($go__go_5_1)(new \Data\List\Types\Data_List_Types_Nil())), ($go__go_5_2)((($dictApplicative_0)->{'pure'})(new \Data\List\Types\Data_List_Types_Nil())), (($go__go_6_4)(new \Data\List\Types\Data_List_Types_Nil()))(((($go__go_5_3)($xs_2))($ys_3))(new \Data\List\Types\Data_List_Types_Nil())));
  goto __end;;
  __end:
...
goto end_branch_2;;
  ...
  $go__go_2_0 = null;
  $go__go_2_0 = (function() use (&$go__go_2_0) {
  $__fn = function(int $s_3, $e_4 = null, $step_5 = null, $rest_6 = null) use (&$go__go_2_0, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 4) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 4);
  }
...
function majData_majList_partition($p_0, $xs_1 = null) {
  ...
  $__fn = function($b_3, $v_4 = null) use (&$go__go_2_0, $p_0, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
...
$__t1 = null;;
if (($p_0)(($v_4)->{'value0'})) {
$__t1 = (object)["no" => ($b_3)->{'no'}, "yes" => new \Data\List\Types\Data_List_Types_Cons(($v_4)->{'value0'}, ($b_3)->{'yes'})];
goto end_branch_1;;
};
$__t1 = (object)["no" => new \Data\List\Types\Data_List_Types_Cons(($v_4)->{'value0'}, ($b_3)->{'no'}), "yes" => ($b_3)->{'yes'}];
end_branch_1:;
$__tco_2 = $__t1;
$__tco_3 = ($v_4)->{'value1'};
$__tco_var_go__go_2_0_0_b_3 = $__tco_2;
$__tco_var_go__go_2_0_0_v_4 = $__tco_3;
goto tco_loop_go__go_2_0_0;;
$__t0 = null;
goto end_branch_0;;
};
...
goto end_branch_1;;
  ...
  $__res = \Control\Semigroupoid\majControl_majSemigroupoid_composemajImpl(($go__go_2_0)((object)["no" => new \Data\List\Types\Data_List_Types_Nil(), "yes" => new \Data\List\Types\Data_List_Types_Nil()]), ($go__go_2_1)(new \Data\List\Types\Data_List_Types_Nil()), $xs_1);
  goto __end;;
  __end:
  return 2 < $__num ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
}
...
$GLOBALS['Data_List_newtypePattern'] = (object)["Coercible0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
  $__res = null;
  goto __end;;
  __end:
...
// Data_List_manyRec
function majData_majList_manymajRec($dictMonadRec_0) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majList_manymajRec';
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 1);
  }
  $Bind1_1_0 = (((($dictMonadRec_0)->{'Monad0'})(null))->{'Bind1'})(null);
  $__res = function($dictAlternative_2) use ($Bind1_1_0, $dictMonadRec_0) {
  $__num = \func_num_args();
  $Plus1_3_1 = (($dictAlternative_2)->{'Plus1'})(null);
  $Alt0_4_2 = (($Plus1_3_1)->{'Alt0'})(null);
  $Functor0_5_3 = (((($Plus1_3_1)->{'Alt0'})(null))->{'Functor0'})(null);
  $Applicative0_6_4 = (($dictAlternative_2)->{'Applicative0'})(null);
  $pure_7_5 = ((($dictAlternative_2)->{'Applicative0'})(null))->{'pure'};
  $__res = function($p_8) use ($Alt0_4_2, $Applicative0_6_4, $Bind1_1_0, $Functor0_5_3, $dictMonadRec_0, $pure_7_5) {
  $__num = \func_num_args();
  $__res = ((($dictMonadRec_0)->{'tailRecM'})(function($acc_9) use ($Alt0_4_2, $Applicative0_6_4, $Bind1_1_0, $Functor0_5_3, $p_8, $pure_7_5) {
  $__num = \func_num_args();
  $__res = ((($Bind1_1_0)->{'bind'})(((($Alt0_4_2)->{'alt'})(((($Functor0_5_3)->{'map'})($GLOBALS['Control_Monad_Rec_Class_Loop']))($p_8)))((($Applicative0_6_4)->{'pure'})(new \Control\Monad\Rec\Class\Control_Monad_Rec_Class_Done($GLOBALS['Data_Unit_unit'])))))(function($aa_10) use ($acc_9, $pure_7_5) {
  $__num = \func_num_args();
  $__t6 = null;;
  if ($aa_10 instanceof \Control\Monad\Rec\Class\Control_Monad_Rec_Class_Loop) {
$__t6 = new \Control\Monad\Rec\Class\Control_Monad_Rec_Class_Loop(new \Data\List\Types\Data_List_Types_Cons(($aa_10)->{'value0'}, $acc_9));
goto end_branch_6;;
};
  if ($aa_10 instanceof \Control\Monad\Rec\Class\Control_Monad_Rec_Class_Done) {
$go__go_11_7 = null;
$go__go_11_7 = (function() use (&$go__go_11_7) {
  $__fn = function($v_12, $v1_13 = null) use (&$go__go_11_7, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_var_go__go_11_7_7_v_12 = $v_12;
  $__tco_var_go__go_11_7_7_v1_13 = $v1_13;
  tco_loop_go__go_11_7_7:;
  $v_12 = $__tco_var_go__go_11_7_7_v_12;
  $v1_13 = $__tco_var_go__go_11_7_7_v1_13;
  $__t7 = null;;
  if ($v1_13 instanceof \Data\List\Types\Data_List_Types_Nil) {
$__t7 = $v_12;
goto end_branch_7;;
};
  if ($v1_13 instanceof \Data\List\Types\Data_List_Types_Cons) {
$__tco_8 = new \Data\List\Types\Data_List_Types_Cons(($v1_13)->{'value0'}, $v_12);
$__tco_9 = ($v1_13)->{'value1'};
$__tco_var_go__go_11_7_7_v_12 = $__tco_8;
$__tco_var_go__go_11_7_7_v1_13 = $__tco_9;
goto tco_loop_go__go_11_7_7;;
$__t7 = null;
goto end_branch_7;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
...
$__t6 = new \Control\Monad\Rec\Class\Control_Monad_Rec_Class_Done((($go__go_11_7)(new \Data\List\Types\Data_List_Types_Nil()))($acc_9));
goto end_branch_6;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t6 = null;
...
function majData_majList_somemajRec($dictMonadRec_0, $dictAlternative_1 = null) {
  ...
  $Apply0_2_0 = (((($dictAlternative_1)->{'Applicative0'})(null))->{'Apply0'})(null);
  $Functor0_3_1 = (((((($dictAlternative_1)->{'Plus1'})(null))->{'Alt0'})(null))->{'Functor0'})(null);
  $__res = function($v_4) use ($Apply0_2_0, $Functor0_3_1, $dictAlternative_1, $dictMonadRec_0) {
  $__num = \func_num_args();
  $Bind1_5_2 = (((($dictMonadRec_0)->{'Monad0'})(null))->{'Bind1'})(null);
  $Plus1_6_3 = (($dictAlternative_1)->{'Plus1'})(null);
  $Alt0_7_4 = (($Plus1_6_3)->{'Alt0'})(null);
  $Functor0_8_5 = (((($Plus1_6_3)->{'Alt0'})(null))->{'Functor0'})(null);
  $Applicative0_9_6 = (($dictAlternative_1)->{'Applicative0'})(null);
  $pure_10_7 = ((($dictAlternative_1)->{'Applicative0'})(null))->{'pure'};
  $__res = ((($Apply0_2_0)->{'apply'})(((($Functor0_3_1)->{'map'})($GLOBALS['Data_List_Types_Cons']))($v_4)))(((($dictMonadRec_0)->{'tailRecM'})(function($acc_11) use ($Alt0_7_4, $Applicative0_9_6, $Bind1_5_2, $Functor0_8_5, $pure_10_7, $v_4) {
  $__num = \func_num_args();
  $__res = ((($Bind1_5_2)->{'bind'})(((($Alt0_7_4)->{'alt'})(((($Functor0_8_5)->{'map'})($GLOBALS['Control_Monad_Rec_Class_Loop']))($v_4)))((($Applicative0_9_6)->{'pure'})(new \Control\Monad\Rec\Class\Control_Monad_Rec_Class_Done($GLOBALS['Data_Unit_unit'])))))(function($aa_12) use ($acc_11, $pure_10_7) {
  $__num = \func_num_args();
  $__t8 = null;;
  if ($aa_12 instanceof \Control\Monad\Rec\Class\Control_Monad_Rec_Class_Loop) {
$__t8 = new \Control\Monad\Rec\Class\Control_Monad_Rec_Class_Loop(new \Data\List\Types\Data_List_Types_Cons(($aa_12)->{'value0'}, $acc_11));
goto end_branch_8;;
};
  if ($aa_12 instanceof \Control\Monad\Rec\Class\Control_Monad_Rec_Class_Done) {
$go__go_13_9 = null;
$go__go_13_9 = (function() use (&$go__go_13_9) {
  $__fn = function($v_14, $v1_15 = null) use (&$go__go_13_9, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_var_go__go_13_9_9_v_14 = $v_14;
  $__tco_var_go__go_13_9_9_v1_15 = $v1_15;
  tco_loop_go__go_13_9_9:;
  $v_14 = $__tco_var_go__go_13_9_9_v_14;
  $v1_15 = $__tco_var_go__go_13_9_9_v1_15;
  $__t9 = null;;
  if ($v1_15 instanceof \Data\List\Types\Data_List_Types_Nil) {
$__t9 = $v_14;
goto end_branch_9;;
};
  if ($v1_15 instanceof \Data\List\Types\Data_List_Types_Cons) {
$__tco_10 = new \Data\List\Types\Data_List_Types_Cons(($v1_15)->{'value0'}, $v_14);
$__tco_11 = ($v1_15)->{'value1'};
$__tco_var_go__go_13_9_9_v_14 = $__tco_10;
$__tco_var_go__go_13_9_9_v1_15 = $__tco_11;
goto tco_loop_go__go_13_9_9;;
$__t9 = null;
goto end_branch_9;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
...
$__t8 = new \Control\Monad\Rec\Class\Control_Monad_Rec_Class_Done((($go__go_13_9)(new \Data\List\Types\Data_List_Types_Nil()))($acc_11));
goto end_branch_8;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t8 = null;
  end_branch_8:;
  $__res = ($pure_10_7)($__t8);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
...
// Data_List_some
function majData_majList_some($dictAlternative_0) {
  $__num = \func_num_args();
  ...
  $__num = \func_num_args();
  $__res = ((($Apply0_1_0)->{'apply'})(((($Functor0_2_1)->{'map'})($GLOBALS['Data_List_Types_Cons']))($v_4)))((($dictLazy_3)->{'defer'})(function($v1_5) use ($dictAlternative_0, $dictLazy_3, $v_4) {
  $__num = \func_num_args();
  $__res = ((($GLOBALS['Data_List_many'])($dictAlternative_0))($dictLazy_3))($v_4);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}));
...
// Data_List_many
function majData_majList_many($dictAlternative_0) {
  $__num = \func_num_args();
  ...
  $__num = \func_num_args();
  $__res = ((($Alt0_1_0)->{'alt'})(((((((($dictAlternative_0)->{'Applicative0'})(null))->{'Apply0'})(null))->{'apply'})(((((((((($dictAlternative_0)->{'Plus1'})(null))->{'Alt0'})(null))->{'Functor0'})(null))->{'map'})($GLOBALS['Data_List_Types_Cons']))($v_4)))((($dictLazy_3)->{'defer'})(function($v1_5) use ($dictAlternative_0, $dictLazy_3, $v_4) {
  $__num = \func_num_args();
  $__res = ((($GLOBALS['Data_List_many'])($dictAlternative_0))($dictLazy_3))($v_4);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))))((($Applicative0_2_1)->{'pure'})(new \Data\List\Types\Data_List_Types_Nil()));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
$GLOBALS['Data_List_length_closure'] = (function() use (&$__fn) {
$go__go_0_0 = null;
$go__go_0_0 = (function() use (&$go__go_0_0) {
  $__fn = function($b_1, $v_2 = null) use (&$go__go_0_0, &$__fn) {
  $__num = \func_num_args();
...
break;
  ...
  if ($v2_2 instanceof \Data\List\Types\Data_List_Types_Cons) {
$__local_var_3_1 = \Data\List\majData_majList_insertmajAt(($v_0 - 1), $v1_1, ($v2_2)->{'value1'});
$__t2 = null;;
if ($__local_var_3_1 instanceof \Data\Maybe\Data_Maybe_Just) {
$__t2 = new \Data\Maybe\Data_Maybe_Just(new \Data\List\Types\Data_List_Types_Cons(($v2_2)->{'value0'}, ($__local_var_3_1)->{'value0'}));
goto end_branch_2;;
...
function majData_majList_init($lst_0) {
  ...
  $__local_var_1_0 = \Data\List\majData_majList_unsnoc($lst_0);
  $__t1 = null;;
...
function majData_majList_groupmajAllmajBy($p_0) {
  ...
  $__res = (($GLOBALS['Control_Semigroupoid_composeImpl'])(($GLOBALS['Data_List_groupBy'])(function($x_1) use ($p_0) {
  $__num = \func_num_args();
  $__res = function($y_2) use ($p_0, $x_1) {
  $__num = \func_num_args();
  $__res = (($p_0)($x_1))($y_2) instanceof \Data\Ordering\Data_Ordering_EQ;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
function majData_majList_groupmajAll($dictOrd_0) {
  ...
  $compare_1_0 = ($dictOrd_0)->{'compare'};
  $__res = (($GLOBALS['Control_Semigroupoid_composeImpl'])(($GLOBALS['Data_List_groupBy'])(((($dictOrd_0)->{'Eq0'})(null))->{'eq'})))(function($xs_2) use ($compare_1_0) {
  $__num = \func_num_args();
  $__res = \Data\List\majData_majList_sortmajBy($compare_1_0, $xs_2);
  goto __end;;
  __end:
...
// Data_List_foldM
function majData_majList_foldmajM($dictMonad_0) {
  $__num = \func_num_args();
  ...
  $__res = function($v_3) use ($Applicative0_1_0, $Bind1_2_1, $dictMonad_0) {
  $__num = \func_num_args();
  $__res = function($v1_4) use ($Applicative0_1_0, $Bind1_2_1, $dictMonad_0, $v_3) {
  $__num = \func_num_args();
  $__res = function($v2_5) use ($Applicative0_1_0, $Bind1_2_1, $dictMonad_0, $v1_4, $v_3) {
  $__num = \func_num_args();
  $__t2 = null;;
  if ($v2_5 instanceof \Data\List\Types\Data_List_Types_Nil) {
$__t2 = (($Applicative0_1_0)->{'pure'})($v1_4);
goto end_branch_2;;
};
  if ($v2_5 instanceof \Data\List\Types\Data_List_Types_Cons) {
$__local_var_6_3 = ($v2_5)->{'value1'};
$__t2 = ((($Bind1_2_1)->{'bind'})((($v_3)($v1_4))(($v2_5)->{'value0'})))(function($b_prime__7) use ($__local_var_6_3, $dictMonad_0, $v_3) {
  $__num = \func_num_args();
  $__res = (((($GLOBALS['Data_List_foldM'])($dictMonad_0))($v_3))($b_prime__7))($__local_var_6_3);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
...
function majData_majList_findmajIndex($fn_0) {
  ...
  $__fn = function(int $v_2, $v1_3 = null) use ($fn_0, &$go__go_1_0, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
...
function majData_majList_findmajLastmajIndex($fn_0, $xs_1 = null) {
  ...
  $__fn = function(int $v_3, $v1_4 = null) use ($fn_0, &$go__go_2_0, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
...
goto end_branch_1;;
  ...
  $__local_var_2_0 = (($go__go_2_0)(0))((($go__go_3_1)(new \Data\List\Types\Data_List_Types_Nil()))($xs_1));
  $__t3 = null;;
  if ($__local_var_2_0 instanceof \Data\Maybe\Data_Maybe_Just) {
$go__go_3_4 = null;
$go__go_3_4 = (function() use (&$go__go_3_4) {
  $__fn = function($b_4, $v_5 = null) use (&$go__go_3_4, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
...
$__t3 = new \Data\Maybe\Data_Maybe_Just((((($go__go_3_4)(0))($xs_1) - 1) - ($__local_var_2_0)->{'value0'}));
goto end_branch_3;;
};
...
goto end_branch_0;;
  ...
  if ($v1_5 instanceof \Data\List\Types\Data_List_Types_Cons) {
$__t4 = null;;
if ((function() use ($v1_5, $v2_2, $v_0, &$__fn) {
$semigroupDisj1_6_5 = (object)["append" => function($v_6) {
  $__num = \func_num_args();
...
$__local_var_7_6 = (object)["mempty" => false, "Semigroup0" => function($_dollar___unused_7) use ($semigroupDisj1_6_5) {
  $__num = \func_num_args();
  $__res = $semigroupDisj1_6_5;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}];
$Semigroup0_8_7 = (($__local_var_7_6)->{'Semigroup0'})(null);
$__local_var_9_8 = ($v_0)(($v1_5)->{'value0'});
$go__go_10_9 = null;
$go__go_10_9 = (function() use ($Semigroup0_8_7, $__local_var_9_8, &$go__go_10_9) {
  $__fn = function($b_11, $v_12 = null) use ($Semigroup0_8_7, $__local_var_9_8, &$go__go_10_9, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_var_go__go_10_9_9_b_11 = $b_11;
  $__tco_var_go__go_10_9_9_v_12 = $v_12;
  tco_loop_go__go_10_9_9:;
  $b_11 = $__tco_var_go__go_10_9_9_b_11;
  $v_12 = $__tco_var_go__go_10_9_9_v_12;
  $__t9 = null;;
  if ($v_12 instanceof \Data\List\Types\Data_List_Types_Nil) {
$__t9 = $b_11;
goto end_branch_9;;
};
  if ($v_12 instanceof \Data\List\Types\Data_List_Types_Cons) {
$__tco_10 = \Control\Semigroupoid\majControl_majSemigroupoid_composemajImpl((($Semigroup0_8_7)->{'append'})($b_11), $__local_var_9_8, ($v_12)->{'value0'});
$__tco_11 = ($v_12)->{'value1'};
$__tco_var_go__go_10_9_9_b_11 = $__tco_10;
$__tco_var_go__go_10_9_9_v_12 = $__tco_11;
...
return (($go__go_10_9)(($__local_var_7_6)->{'mempty'}))($v2_2);
})()) {
$__tco_10 = new \Data\List\Types\Data_List_Types_Cons(($v1_5)->{'value0'}, $v_4);
$__tco_11 = ($v1_5)->{'value1'};
$__tco_var_go__go_3_0_0_v_4 = $__tco_10;
$__tco_var_go__go_3_0_0_v1_5 = $__tco_11;
goto tco_loop_go__go_3_0_0;;
$__t4 = null;
goto end_branch_4;;
};
...
goto end_branch_2;;
  ...
  if ($v1_5 instanceof \Data\List\Types\Data_List_Types_Cons) {
$__t6 = null;;
if (( ! (($v_0)($__local_var_2_1))(($v1_5)->{'value0'}))) {
...
goto end_branch_4;;
  ...
  $__num = \func_num_args();
  $__res = function($v2_8) use ($__local_var_2_6, &$go__go_5_7, $v1_7, $v_6) {
  $__num = \func_num_args();
  $__t8 = null;;
  if (( ! $v2_8)) {
$__t8 = false;
goto end_branch_8;;
  ...
  if ($v_6 instanceof \Data\List\Types\Data_List_Types_Nil) {
$__t8 = ($v1_7 instanceof \Data\List\Types\Data_List_Types_Nil && $v2_8);
goto end_branch_8;;
};
  $__t8 = ($v_6 instanceof \Data\List\Types\Data_List_Types_Cons && ($v1_7 instanceof \Data\List\Types\Data_List_Types_Cons && ((($go__go_5_7)(($v_6)->{'value1'}))(($v1_7)->{'value1'}))(($v2_8 && ((($__local_var_2_6)->{'eq'})(($v1_7)->{'value0'}))(($v_6)->{'value0'})))));
  end_branch_8:;
  $__res = $__t8;
  goto __end;;
  __end:
  ...
  $__res = ((($go__go_5_7)($xs_3))($ys_4))(true);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
function majData_majList_elemmajIndex($dictEq_0, $x_1 = null) {
  ...
  $__fn = function(int $v_3, $v1_4 = null) use ($dictEq_0, &$go__go_2_0, $x_1, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
...
goto end_branch_0;;
  ...
  $__res = \Data\List\majData_majList_take(((($go__go_2_0)(0))($xs_1) - $n_0), $xs_1);
  goto __end;;
  __end:
  return 2 < $__num ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
}
...
goto end_branch_0;;
  ...
  $__res = \Data\List\majData_majList_drop(((($go__go_2_0)(0))($xs_1) - $n_0), $xs_1);
  goto __end;;
  __end:
  return 2 < $__num ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
}
...
// Data_List_unionBy
function majData_majList_unionmajBy($eq_0, $xs_1 = null, $ys_2 = null) {
  $__num = \func_num_args();
...
goto end_branch_0;;
  ...
  $go__go_4_1 = null;
  $go__go_4_1 = (function() use ($eq_0, &$go__go_4_1) {
  $__fn = function($b_5, $v_6 = null) use ($eq_0, &$go__go_4_1, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_var_go__go_4_1_1_b_5 = $b_5;
  $__tco_var_go__go_4_1_1_v_6 = $v_6;
  tco_loop_go__go_4_1_1:;
  $b_5 = $__tco_var_go__go_4_1_1_b_5;
  $v_6 = $__tco_var_go__go_4_1_1_v_6;
  $__t1 = null;;
  if ($v_6 instanceof \Data\List\Types\Data_List_Types_Nil) {
$__t1 = $b_5;
goto end_branch_1;;
...
$__tco_2 = \Data\List\majData_majList_deletemajBy($eq_0, ($v_6)->{'value0'}, $b_5);
$__tco_3 = ($v_6)->{'value1'};
$__tco_var_go__go_4_1_1_b_5 = $__tco_2;
$__tco_var_go__go_4_1_1_v_6 = $__tco_3;
goto tco_loop_go__go_4_1_1;;
$__t1 = null;
goto end_branch_1;;
};
  ...
  $go__go_3_2 = null;
  $go__go_3_2 = (function() use (&$go__go_3_2) {
  $__fn = function($v_4, $v1_5 = null) use (&$go__go_3_2, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
...
goto end_branch_2;;
  ...
  if ($v1_5 instanceof \Data\List\Types\Data_List_Types_Cons) {
$__tco_3 = new \Data\List\Types\Data_List_Types_Cons(($v1_5)->{'value0'}, $v_4);
$__tco_4 = ($v1_5)->{'value1'};
$__tco_var_go__go_3_2_2_v_4 = $__tco_3;
$__tco_var_go__go_3_2_2_v1_5 = $__tco_4;
goto tco_loop_go__go_3_2_2;;
$__t2 = null;
goto end_branch_2;;
};
  ...
  $__res = \Control\Semigroupoid\majControl_majSemigroupoid_composemajImpl(($go__go_3_0)((($go__go_4_1)(\Data\List\majData_majList_nubmajBymajEq($eq_0, $ys_2)))($xs_1)), ($go__go_3_2)(new \Data\List\Types\Data_List_Types_Nil()), $xs_1);
  goto __end;;
  __end:
  return 3 < $__num ? $__res(...\array_slice(\func_get_args(), 3)) : $__res;
}
...
switch ($v_0) {
case 0:
$__t3 = new \Data\Maybe\Data_Maybe_Just(($v1_1)->{'value1'});
goto end_branch_3;;
break;
default:
;
...
$__local_var_2_1 = \Data\List\majData_majList_deletemajAt(($v_0 - 1), ($v1_1)->{'value1'});
$__t2 = null;;
if ($__local_var_2_1 instanceof \Data\Maybe\Data_Maybe_Just) {
$__t2 = new \Data\Maybe\Data_Maybe_Just(new \Data\List\Types\Data_List_Types_Cons(($v1_1)->{'value0'}, ($__local_var_2_1)->{'value0'}));
goto end_branch_2;;
};
$__t2 = new \Data\Maybe\Data_Maybe_Nothing();
end_branch_2:;
...
function majData_majList_difference($dictEq_0) {
  ...
  $__fn = function($b_2, $v_3 = null) use ($dictEq_0, &$go__go_1_0, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
...
$__tco_1 = \Data\List\majData_majList_deletemajBy(($dictEq_0)->{'eq'}, ($v_3)->{'value0'}, $b_2);
$__tco_2 = ($v_3)->{'value1'};
...
function majData_majList_concatmajMap($b_0, $a_1 = null) {
  ...
  $__t0 = null;;
  if ($a_1 instanceof \Data\List\Types\Data_List_Types_Nil) {
$__t0 = new \Data\List\Types\Data_List_Types_Nil();
goto end_branch_0;;
};
  if ($a_1 instanceof \Data\List\Types\Data_List_Types_Cons) {
$go__go_2_1 = null;
$go__go_2_1 = (function() use (&$go__go_2_1) {
...
$__t0 = \Control\Semigroupoid\majControl_majSemigroupoid_composemajImpl(($go__go_2_1)(((($GLOBALS['Data_List_Types_bindList'])->{'bind'})(($a_1)->{'value1'}))($b_0)), ($go__go_2_2)(new \Data\List\Types\Data_List_Types_Nil()), ($b_0)(($a_1)->{'value0'}));
goto end_branch_0;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t0 = null;
...
$go__go_1_1 = (function() use (&$go__go_1_1) {
  $__fn = function($b_2, $v_3 = null) use (&$go__go_1_1, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
...
goto end_branch_1;;
  ...
  if ($v_3 instanceof \Data\List\Types\Data_List_Types_Cons) {
$__tco_2 = new \Data\List\Types\Data_List_Types_Cons(($v_3)->{'value0'}, $b_2);
$__tco_3 = ($v_3)->{'value1'};
...
$go__go_1_2 = null;
$go__go_1_2 = (function() use (&$go__go_1_2) {
  $__fn = function($v_2, $v1_3 = null) use (&$go__go_1_2, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_var_go__go_1_2_2_v_2 = $v_2;
  $__tco_var_go__go_1_2_2_v1_3 = $v1_3;
  tco_loop_go__go_1_2_2:;
  $v_2 = $__tco_var_go__go_1_2_2_v_2;
  $v1_3 = $__tco_var_go__go_1_2_2_v1_3;
  $__t2 = null;;
  if ($v1_3 instanceof \Data\List\Types\Data_List_Types_Nil) {
$__t2 = $v_2;
goto end_branch_2;;
  ...
  if ($v1_3 instanceof \Data\List\Types\Data_List_Types_Cons) {
$__tco_3 = new \Data\List\Types\Data_List_Types_Cons(($v1_3)->{'value0'}, $v_2);
$__tco_4 = ($v1_3)->{'value1'};
$__tco_var_go__go_1_2_2_v_2 = $__tco_3;
$__tco_var_go__go_1_2_2_v1_3 = $__tco_4;
goto tco_loop_go__go_1_2_2;;
$__t2 = null;
goto end_branch_2;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
...
$__t0 = \Control\Semigroupoid\majControl_majSemigroupoid_composemajImpl(($go__go_1_1)(((($GLOBALS['Data_List_Types_bindList'])->{'bind'})(($v_0)->{'value1'}))(function($x_2) {
  $__num = \func_num_args();
  $__res = $x_2;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
})), ($go__go_1_2)(new \Data\List\Types\Data_List_Types_Nil()), ($v_0)->{'value0'});
goto end_branch_0;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t0 = null;
...
$__t5 = null;;
if ($v3_3_4 instanceof \Data\Maybe\Data_Maybe_Nothing) {
$__t5 = ($v2_2)->{'value1'};
goto end_branch_5;;
};
if ($v3_3_4 instanceof \Data\Maybe\Data_Maybe_Just) {
$__t5 = new \Data\List\Types\Data_List_Types_Cons(($v3_3_4)->{'value0'}, ($v2_2)->{'value1'});
goto end_branch_5;;
};
throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
$__t5 = null;
end_branch_5:;
$__t3 = new \Data\Maybe\Data_Maybe_Just($__t5);
goto end_branch_3;;
break;
default:
;
...
$__local_var_3_1 = \Data\List\majData_majList_altermajAt(($v_0 - 1), $v1_1, ($v2_2)->{'value1'});
$__t2 = null;;
if ($__local_var_3_1 instanceof \Data\Maybe\Data_Maybe_Just) {
$__t2 = new \Data\Maybe\Data_Maybe_Just(new \Data\List\Types\Data_List_Types_Cons(($v2_2)->{'value0'}, ($__local_var_3_1)->{'value0'}));
goto end_branch_2;;
