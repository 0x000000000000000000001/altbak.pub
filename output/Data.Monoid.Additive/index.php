...
function majData_majMonoid_majAdditive_monoidmajAdditive($dictSemiring_0) {
  ...
  $semigroupAdditive1_1_0 = (object)["append" => function($v_1) use ($dictSemiring_0) {
  $__num = \func_num_args();
  $__res = function($v1_2) use ($dictSemiring_0, $v_1) {
  $__num = \func_num_args();
  $__res = ((($dictSemiring_0)->{'add'})($v_1))($v1_2);
  ...
  $__res = (object)["mempty" => ($dictSemiring_0)->{'zero'}, "Semigroup0" => function($_dollar___unused_2) use ($semigroupAdditive1_1_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Monoid_Additive_functorAdditive'] = (object)["map" => function($f_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Monoid_Additive_applyAdditive'] = (object)["apply" => function($v_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Monoid_Additive_bindAdditive'] = (object)["bind" => function($v_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Monoid_Additive_applicativeAdditive'] = (object)["pure" => function($x_0) {
  $__num = \func_num_args();
  $__res = $x_0;
  goto __end;;
  __end:
...
$GLOBALS['Data_Monoid_Additive_monadAdditive'] = (object)["Applicative0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
