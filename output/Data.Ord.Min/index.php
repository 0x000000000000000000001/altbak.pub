...
$GLOBALS['Data_Ord_Min_newtypeMin'] = (object)["Coercible0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
  $__res = null;
  goto __end;;
  __end:
...
function majData_majOrd_majMin_monoidmajMin($dictBounded_0) {
  ...
  $semigroupMin1_1_0 = (object)["append" => function($v_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
...
goto end_branch_2;;
  ...
  $__res = (object)["mempty" => ($dictBounded_0)->{'top'}, "Semigroup0" => function($_dollar___unused_2) use ($semigroupMin1_1_0) {
  $__num = \func_num_args();
  $__res = $semigroupMin1_1_0;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}];
...
function majData_majOrd_majMin_ordmajMin($dictOrd_0) {
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Eq0" => function($_dollar___unused_2) use ($eqMin1_1_0) {
  $__num = \func_num_args();
  $__res = $eqMin1_1_0;
  goto __end;;
  __end:
