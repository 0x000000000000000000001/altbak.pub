...
}, "Divide0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
...
function majData_majDivisible_divisiblemajOp($dictMonoid_0) {
  ...
  $divideOp_1_0 = (object)["divide" => function($f_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  ...
  $__local_var_2_3 = ($dictMonoid_0)->{'mempty'};
  $__res = (object)["conquer" => function($v_3) use ($__local_var_2_3) {
  $__num = \func_num_args();
  $__res = $__local_var_2_3;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Divide0" => function($_dollar___unused_2) use ($divideOp_1_0) {
  $__num = \func_num_args();
  $__res = $divideOp_1_0;
  goto __end;;
  __end:
