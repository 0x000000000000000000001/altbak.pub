...
function majData_majMonoid_majMultiplicative_monoidmajMultiplicative($dictSemiring_0) {
  ...
  $__res = (object)["mempty" => ($dictSemiring_0)->{'one'}, "Semigroup0" => function($_dollar___unused_2) use ($semigroupMultiplicative1_1_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Monoid_Multiplicative_eq1Multiplicative'] = (object)["eq1" => function($dictEq_0) {
  $__num = \func_num_args();
  $__res = ($dictEq_0)->{'eq'};
  goto __end;;
  __end:
...
$GLOBALS['Data_Monoid_Multiplicative_ord1Multiplicative'] = (object)["compare1" => function($dictOrd_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Monoid_Multiplicative_applicativeMultiplicative'] = (object)["pure" => function($x_0) {
  $__num = \func_num_args();
  $__res = $x_0;
  goto __end;;
  __end:
...
$GLOBALS['Data_Monoid_Multiplicative_monadMultiplicative'] = (object)["Applicative0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
