...
function majControl_majComonad_majStore_runmajStore($v_0) {
  ...
  $__local_var_1_0 = new \Data\Tuple\Data_Tuple_Tuple(($v_0)->{'value1'}, ($v_0)->{'value0'});
  $__local_var_1_0 = new \Data\Tuple\Data_Tuple_Tuple(($__local_var_1_0)->{'value0'}, ($__local_var_1_0)->{'value1'});
