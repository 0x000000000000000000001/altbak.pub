...
function majData_majEq_eqmajArraymajImpl($v0, $v1 = null, $v2 = null): bool|\Closure {
  ...
  global $ffi_Data_Eq;
  $f = (\array_key_exists('eqArrayImpl', $ffi_Data_Eq) ? $ffi_Data_Eq['eqArrayImpl'] : new class { public function __invoke(...$args) { return $this; } });
  return $f($v0, $v1, $v2);
}
...
function majData_majEq_eqmajBooleanmajImpl(bool $v0, $v1 = null): bool|\Closure {
  ...
  global $ffi_Data_Eq;
  $f = (\array_key_exists('eqBooleanImpl', $ffi_Data_Eq) ? $ffi_Data_Eq['eqBooleanImpl'] : new class { public function __invoke(...$args) { return $this; } });
  return $f($v0, $v1);
}
...
function majData_majEq_eqmajCharmajImpl($v0, $v1 = null): bool|\Closure {
  ...
  global $ffi_Data_Eq;
  $f = (\array_key_exists('eqCharImpl', $ffi_Data_Eq) ? $ffi_Data_Eq['eqCharImpl'] : new class { public function __invoke(...$args) { return $this; } });
  return $f($v0, $v1);
}
...
function majData_majEq_eqmajIntmajImpl(int $v0, $v1 = null): bool|\Closure {
  ...
  global $ffi_Data_Eq;
  $f = (\array_key_exists('eqIntImpl', $ffi_Data_Eq) ? $ffi_Data_Eq['eqIntImpl'] : new class { public function __invoke(...$args) { return $this; } });
  return $f($v0, $v1);
}
...
function majData_majEq_eqmajNumbermajImpl(float $v0, $v1 = null): bool|\Closure {
  ...
  global $ffi_Data_Eq;
  $f = (\array_key_exists('eqNumberImpl', $ffi_Data_Eq) ? $ffi_Data_Eq['eqNumberImpl'] : new class { public function __invoke(...$args) { return $this; } });
  return $f($v0, $v1);
}
...
function majData_majEq_eqmajStringmajImpl(string $v0, $v1 = null): bool|\Closure {
  ...
  global $ffi_Data_Eq;
  $f = (\array_key_exists('eqStringImpl', $ffi_Data_Eq) ? $ffi_Data_Eq['eqStringImpl'] : new class { public function __invoke(...$args) { return $this; } });
  return $f($v0, $v1);
}
...
// Data_Eq_eqRec
function majData_majEq_eqmajRec($_dollar___unused_0, $dictEqRecord_1 = null) {
  $__num = \func_num_args();
...
// Data_Eq_eqRowCons
function majData_majEq_eqmajRowmajCons($dictEqRecord_0, $_dollar___unused_1 = null, $dictIsSymbol_2 = null, $dictEq_3 = null) {
  $__num = \func_num_args();
  ...
  $__res = (((($dictEq_3)->{'eq'})(($get_7_0)($ra_5)))(($get_7_0)($rb_6)) && (((($dictEqRecord_0)->{'eqRecord'})(new \Type\Proxy\Type_Proxy_Proxy()))($ra_5))($rb_6));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
// Data_Eq_notEq1
function majData_majEq_notmajEq1($dictEq1_0, $dictEq_1 = null, $x_2 = null, $y_3 = null) {
  $__num = \func_num_args();
