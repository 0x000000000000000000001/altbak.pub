...
$GLOBALS['Data_Bifunctor_Join_newtypeJoin'] = (object)["Coercible0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
  $__res = null;
  goto __end;;
  __end:
...
function majData_majBifunctor_majJoin_biapplymajJoin($dictBiapply_0) {
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Functor0" => function($_dollar___unused_2) use ($bifunctorJoin1_1_0) {
  $__num = \func_num_args();
...
function majData_majBifunctor_majJoin_biapplicativemajJoin($dictBiapplicative_0) {
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Functor0" => function($_dollar___unused_3) use ($bifunctorJoin1_2_1) {
  $__num = \func_num_args();
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Apply0" => function($_dollar___unused_2) use ($biapplyJoin1_1_0) {
  $__num = \func_num_args();
