...
$GLOBALS['Data_String_NonEmpty_Internal_showNonEmptyString'] = (object)["show" => function($v_0) {
  $__num = \func_num_args();
  $__res = (("(NonEmptyString.unsafeFromString " . \Data\Show\majData_majShow_showmajStringmajImpl($v_0)) . ")");
  goto __end;;
  __end:
...
$GLOBALS['Data_String_NonEmpty_Internal_showNonEmptyReplacement'] = (object)["show" => function($v_0) {
  $__num = \func_num_args();
  $__res = (("(NonEmptyReplacement (NonEmptyString.unsafeFromString " . \Data\Show\majData_majShow_showmajStringmajImpl($v_0)) . "))");
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}];
...
function majData_majString_majNonmajEmpty_majInternal_makemajNonmajEmptymajBad($_dollar___unused_0) {
  $__num = \func_num_args();
...
function majData_majString_majNonmajEmpty_majInternal_joinmajWith1($dictFoldable1_0) {
  ...
  $Foldable0_1_0 = (($dictFoldable1_0)->{'Foldable0'})(null);
  $__res = function($v_2) use ($Foldable0_1_0) {
  $__num = \func_num_args();
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))(function($xs_3) use ($Foldable0_1_0, $v_2) {
  $__num = \func_num_args();
  $__res = ((((($Foldable0_1_0)->{'foldl'})(function($v_4) use ($v_2) {
  $__num = \func_num_args();
  $__res = function($v1_5) use ($v_2, $v_4) {
  $__num = \func_num_args();
  $__t1 = null;;
  if (($v_4)->{'init'}) {
...
goto end_branch_1;;
  ...
  $__t1 = (object)["init" => false, "acc" => ((($v_4)->{'acc'} . $v_2) . $v1_5)];
  end_branch_1:;
  $__res = $__t1;
  goto __end;;
  __end:
...
function majData_majString_majNonmajEmpty_majInternal_joinmajWith($dictFoldable_0, $splice_1 = null) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majString_majNonmajEmpty_majInternal_joinmajWith';
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__res = (($GLOBALS['Control_Semigroupoid_composeImpl'])(function($xs_2) use ($dictFoldable_0, $splice_1) {
  $__num = \func_num_args();
  $__res = ((((($dictFoldable_0)->{'foldl'})(function($v_3) use ($splice_1) {
  $__num = \func_num_args();
  $__res = function($v1_4) use ($splice_1, $v_3) {
  $__num = \func_num_args();
  $__t0 = null;;
  if (($v_3)->{'init'}) {
$__t0 = (object)["init" => false, "acc" => $v1_4];
goto end_branch_0;;
};
  $__t0 = (object)["init" => false, "acc" => ((($v_3)->{'acc'} . $splice_1) . $v1_4)];
  end_branch_0:;
  $__res = $__t0;
  goto __end;;
  __end:
...
function majData_majString_majNonmajEmpty_majInternal_join1majWith($dictFoldable1_0) {
  ...
  $Foldable0_1_0 = (($dictFoldable1_0)->{'Foldable0'})(null);
  $__res = function($splice_2) use ($Foldable0_1_0) {
  $__num = \func_num_args();
  $__res = (($GLOBALS['Control_Semigroupoid_composeImpl'])(function($x_3) {
  $__num = \func_num_args();
  $__res = $x_3;
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))((($GLOBALS['Control_Semigroupoid_composeImpl'])(function($xs_3) use ($Foldable0_1_0, $splice_2) {
  $__num = \func_num_args();
  $__res = ((((($Foldable0_1_0)->{'foldl'})(function($v_4) use ($splice_2) {
  $__num = \func_num_args();
  $__res = function($v1_5) use ($splice_2, $v_4) {
  $__num = \func_num_args();
  $__t1 = null;;
  if (($v_4)->{'init'}) {
$__t1 = (object)["init" => false, "acc" => $v1_5];
goto end_branch_1;;
  ...
  $__t1 = (object)["init" => false, "acc" => ((($v_4)->{'acc'} . $splice_2) . $v1_5)];
  end_branch_1:;
  $__res = $__t1;
  goto __end;;
  __end:
...
function majData_majString_majNonmajEmpty_majInternal_stripmajPrefix(string $pat_0, $a_1 = null) {
  ...
  $__local_var_2_0 = \Data\String\CodeUnits\majData_majString_majCodemajUnits_stripmajPrefix($pat_0, $a_1);
  $__t1 = null;;
  if ($__local_var_2_0 instanceof \Data\Maybe\Data_Maybe_Just) {
$__t1 = match (($__local_var_2_0)->{'value0'}) { "" => new \Data\Maybe\Data_Maybe_Nothing(), default => new \Data\Maybe\Data_Maybe_Just(($__local_var_2_0)->{'value0'}) };
goto end_branch_1;;
};
  if ($__local_var_2_0 instanceof \Data\Maybe\Data_Maybe_Nothing) {
...
function majData_majString_majNonmajEmpty_majInternal_stripmajSuffix(string $pat_0, $a_1 = null) {
  ...
  $__local_var_2_0 = \Data\String\CodeUnits\majData_majString_majCodemajUnits_stripmajSuffix($pat_0, $a_1);
  $__t1 = null;;
  if ($__local_var_2_0 instanceof \Data\Maybe\Data_Maybe_Just) {
$__t1 = match (($__local_var_2_0)->{'value0'}) { "" => new \Data\Maybe\Data_Maybe_Nothing(), default => new \Data\Maybe\Data_Maybe_Just(($__local_var_2_0)->{'value0'}) };
goto end_branch_1;;
...
function majData_majString_majNonmajEmpty_majInternal_unsafemajFrommajString($_dollar___unused_0) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majString_majNonmajEmpty_majInternal_unsafemajFrommajString';
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 1);
  }
  $__res = (($GLOBALS['Control_Semigroupoid_composeImpl'])(function($v_1) {
  $__num = \func_num_args();
  $__t0 = null;;
...
goto end_branch_0;;
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))($GLOBALS['Data_String_NonEmpty_Internal_fromString']);
  goto __end;;
  __end:
  return 1 < $__num ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}
