...
function majData_majMonoid_majGeneric_genericmajMonoidmajProduct($dictGenericMonoid_0, $dictGenericMonoid1_1 = null) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majMonoid_majGeneric_genericmajMonoidmajProduct';
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__res = (object)["genericMempty__prime__" => new \Data\Generic\Rep\Data_Generic_Rep_Product(($dictGenericMonoid_0)->{'genericMempty__prime__'}, ($dictGenericMonoid1_1)->{'genericMempty__prime__'})];
  goto __end;;
  __end:
