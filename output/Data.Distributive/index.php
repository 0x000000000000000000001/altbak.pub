...
$GLOBALS['Data_Distributive_distributiveIdentity'] = (object)["distribute" => function($dictFunctor_0) {
  $__num = \func_num_args();
...
}))((($dictFunctor_0)->{'map'})($GLOBALS['Unsafe_Coerce_unsafeCoerce']));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))((($dictFunctor_0)->{'map'})((($GLOBALS['Control_Semigroupoid_composeImpl'])($GLOBALS['Unsafe_Coerce_unsafeCoerce']))($f_1)));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
function majData_majDistributive_distribute($dict_0) {
  $__num = \func_num_args();
...
function majData_majDistributive_cotraverse($dictDistributive_0) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majDistributive_cotraverse';
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 1);
  }
  $Functor0_1_0 = (($dictDistributive_0)->{'Functor0'})(null);
  $__res = function($dictFunctor_2) use ($Functor0_1_0, $dictDistributive_0) {
  $__num = \func_num_args();
  $distribute2_3_1 = (($dictDistributive_0)->{'distribute'})($dictFunctor_2);
  $__res = function($f_4) use ($Functor0_1_0, $distribute2_3_1) {
  $__num = \func_num_args();
  $__res = (($GLOBALS['Control_Semigroupoid_composeImpl'])((($Functor0_1_0)->{'map'})($f_4)))($distribute2_3_1);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
function majData_majDistributive_collectmajDefault($dictDistributive_0, $dictFunctor_1 = null) {
  $__num = \func_num_args();
...
function majData_majDistributive_distributivemajTuple($dictTypeEquals_0) {
  $__num = \func_num_args();
  ...
  $__res = (object)["collect" => function($dictFunctor_1) use ($dictTypeEquals_0) {
  $__num = \func_num_args();
  $distribute2_2_0 = ((($GLOBALS['Data_Distributive_distributiveTuple'])($dictTypeEquals_0))->{'distribute'})($dictFunctor_1);
  $__res = function($f_3) use ($dictFunctor_1, $distribute2_2_0) {
  $__num = \func_num_args();
  $__res = (($GLOBALS['Control_Semigroupoid_composeImpl'])($distribute2_2_0))((($dictFunctor_1)->{'map'})($f_3));
  goto __end;;
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "distribute" => function($dictFunctor_1) use ($dictTypeEquals_0) {
  $__num = \func_num_args();
  $__res = (($GLOBALS['Control_Semigroupoid_composeImpl'])(($GLOBALS['Data_Tuple_Tuple'])(((($dictTypeEquals_0)->{'proof'})(function($a_2) {
  $__num = \func_num_args();
  $__res = $a_2;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))($GLOBALS['Data_Unit_unit']))))((($dictFunctor_1)->{'map'})($GLOBALS['Data_Tuple_snd']));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
...
function majData_majDistributive_collect($dict_0) {
  $__num = \func_num_args();
...
function majData_majDistributive_distributemajDefault($dictDistributive_0, $dictFunctor_1 = null) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majDistributive_distributemajDefault';
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__res = ((($dictDistributive_0)->{'collect'})($dictFunctor_1))(function($x_2) {
  $__num = \func_num_args();
  $__res = $x_2;
  goto __end;;
  __end:
