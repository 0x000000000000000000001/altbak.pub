...
function majData_majBitraversable_lfor($dictBitraversable_0, $dictApplicative_1 = null) {
  ...
  $pure_2_0 = ($dictApplicative_1)->{'pure'};
  $__res = function($t_3) use ($dictApplicative_1, $dictBitraversable_0, $pure_2_0) {
  $__num = \func_num_args();
  $__res = function($f_4) use ($dictApplicative_1, $dictBitraversable_0, $pure_2_0, $t_3) {
  $__num = \func_num_args();
  $__res = ((((($dictBitraversable_0)->{'bitraverse'})($dictApplicative_1))($f_4))($pure_2_0))($t_3);
  goto __end;;
  __end:
...
function majData_majBitraversable_ltraverse($dictBitraversable_0, $dictApplicative_1 = null) {
  ...
  $pure_2_0 = ($dictApplicative_1)->{'pure'};
  $__res = function($f_3) use ($dictApplicative_1, $dictBitraversable_0, $pure_2_0) {
  $__num = \func_num_args();
  $__res = (((($dictBitraversable_0)->{'bitraverse'})($dictApplicative_1))($f_3))($pure_2_0);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
function majData_majBitraversable_rfor($dictBitraversable_0, $dictApplicative_1 = null) {
  ...
  $__res = function($f_4) use ($dictApplicative_1, $dictBitraversable_0, $pure_2_0, $t_3) {
  $__num = \func_num_args();
  $__res = ((((($dictBitraversable_0)->{'bitraverse'})($dictApplicative_1))($pure_2_0))($f_4))($t_3);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
$GLOBALS['Data_Bitraversable_bitraversableTuple'] = (object)["bitraverse" => function($dictApplicative_0) {
  ...
  $__res = function($f_3) use ($Apply0_1_0, $Functor0_2_1) {
  $__num = \func_num_args();
  $__res = function($g_4) use ($Apply0_1_0, $Functor0_2_1, $f_3) {
  $__num = \func_num_args();
  $__res = function($v_5) use ($Apply0_1_0, $Functor0_2_1, $f_3, $g_4) {
  $__num = \func_num_args();
  $__res = ((($Apply0_1_0)->{'apply'})(((($Functor0_2_1)->{'map'})($GLOBALS['Data_Tuple_Tuple']))(($f_3)(($v_5)->{'value0'}))))(($g_4)(($v_5)->{'value1'}));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  $__num = \func_num_args();
  $Apply0_1_2 = (($dictApplicative_0)->{'Apply0'})(null);
  $Functor0_2_3 = (((($dictApplicative_0)->{'Apply0'})(null))->{'Functor0'})(null);
  $__res = function($v_3) use ($Apply0_1_2, $Functor0_2_3) {
  $__num = \func_num_args();
  $__res = ((($Apply0_1_2)->{'apply'})(((($Functor0_2_3)->{'map'})($GLOBALS['Data_Tuple_Tuple']))(($v_3)->{'value0'})))(($v_3)->{'value1'});
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
function majData_majBitraversable_bitraversablemajJoker($dictTraversable_0) {
  ...
  $__num = \func_num_args();
  $__res = function($v_4) use ($__local_var_2_2, $dictMonoid_3) {
  $__num = \func_num_args();
  $__res = function($r_5) use ($__local_var_2_2, $dictMonoid_3) {
  $__num = \func_num_args();
  $__res = function($v1_6) use ($__local_var_2_2, $dictMonoid_3, $r_5) {
  $__num = \func_num_args();
  $__res = (((($__local_var_2_2)->{'foldMap'})($dictMonoid_3))($r_5))($v1_6);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  $__num = \func_num_args();
  $__res = function($r_6) use ($Functor0_4_4, $dictApplicative_3, $dictTraversable_0) {
  $__num = \func_num_args();
  $__res = function($v1_7) use ($Functor0_4_4, $dictApplicative_3, $dictTraversable_0, $r_6) {
  $__num = \func_num_args();
  $__res = ((($Functor0_4_4)->{'map'})(function($x_8) {
  $__num = \func_num_args();
  $__res = $x_8;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))((((($dictTraversable_0)->{'traverse'})($dictApplicative_3))($r_6))($v1_7));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  $__num = \func_num_args();
  $Functor0_4_5 = (((($dictApplicative_3)->{'Apply0'})(null))->{'Functor0'})(null);
  $__res = function($v_5) use ($Functor0_4_5, $dictApplicative_3, $dictTraversable_0) {
  $__num = \func_num_args();
  $__res = ((($Functor0_4_5)->{'map'})(function($x_6) {
  $__num = \func_num_args();
  $__res = $x_6;
  goto __end;;
  __end:
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Bifunctor0" => function($_dollar___unused_3) use ($bifunctorJoker_1_0) {
  $__num = \func_num_args();
  $__res = $bifunctorJoker_1_0;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Bifoldable1" => function($_dollar___unused_3) use ($bifoldableJoker_2_2) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Bitraversable_bitraversableEither'] = (object)["bitraverse" => function($dictApplicative_0) {
  ...
  $__num = \func_num_args();
  $__res = function($v1_3) use ($Functor0_1_0, $v_2) {
  $__num = \func_num_args();
  $__res = function($v2_4) use ($Functor0_1_0, $v1_3, $v_2) {
  $__num = \func_num_args();
  $__t1 = null;;
  if ($v2_4 instanceof \Data\Either\Data_Either_Left) {
$__t1 = ((($Functor0_1_0)->{'map'})($GLOBALS['Data_Either_Left']))(($v_2)(($v2_4)->{'value0'}));
goto end_branch_1;;
};
  if ($v2_4 instanceof \Data\Either\Data_Either_Right) {
$__t1 = ((($Functor0_1_0)->{'map'})($GLOBALS['Data_Either_Right']))(($v1_3)(($v2_4)->{'value0'}));
goto end_branch_1;;
};
  ...
  $__res = function($v_2) use ($Functor0_1_2) {
  $__num = \func_num_args();
  $__t3 = null;;
  if ($v_2 instanceof \Data\Either\Data_Either_Left) {
$__t3 = ((($Functor0_1_2)->{'map'})($GLOBALS['Data_Either_Left']))(($v_2)->{'value0'});
goto end_branch_3;;
};
...
$GLOBALS['Data_Bitraversable_bitraversableConst'] = (object)["bitraverse" => function($dictApplicative_0) {
  ...
  $__num = \func_num_args();
  $__res = function($v1_4) use ($Functor0_1_0, $f_2) {
  $__num = \func_num_args();
  $__res = ((($Functor0_1_0)->{'map'})(function($x_5) {
  $__num = \func_num_args();
  $__res = $x_5;
  goto __end;;
  __end:
...
function majData_majBitraversable_bitraversablemajClown($dictTraversable_0) {
  ...
  $__num = \func_num_args();
  $__res = function($l_4) use ($__local_var_2_2, $dictMonoid_3) {
  $__num = \func_num_args();
  $__res = function($v_5) use ($__local_var_2_2, $dictMonoid_3, $l_4) {
  $__num = \func_num_args();
  $__res = function($v1_6) use ($__local_var_2_2, $dictMonoid_3, $l_4) {
  $__num = \func_num_args();
  $__res = (((($__local_var_2_2)->{'foldMap'})($dictMonoid_3))($l_4))($v1_6);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  $__num = \func_num_args();
  $Functor0_4_4 = (((($dictApplicative_3)->{'Apply0'})(null))->{'Functor0'})(null);
  $__res = function($l_5) use ($Functor0_4_4, $dictApplicative_3, $dictTraversable_0) {
  $__num = \func_num_args();
  $__res = function($v_6) use ($Functor0_4_4, $dictApplicative_3, $dictTraversable_0, $l_5) {
  $__num = \func_num_args();
  $__res = function($v1_7) use ($Functor0_4_4, $dictApplicative_3, $dictTraversable_0, $l_5) {
  $__num = \func_num_args();
  $__res = ((($Functor0_4_4)->{'map'})(function($x_8) {
  $__num = \func_num_args();
  $__res = $x_8;
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))((((($dictTraversable_0)->{'traverse'})($dictApplicative_3))($l_5))($v1_7));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Bifunctor0" => function($_dollar___unused_3) use ($bifunctorClown_1_0) {
  $__num = \func_num_args();
  $__res = $bifunctorClown_1_0;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Bifoldable1" => function($_dollar___unused_3) use ($bifoldableClown_2_2) {
  $__num = \func_num_args();
...
function majData_majBitraversable_bisequencemajDefault($dictBitraversable_0, $dictApplicative_1 = null) {
  ...
  $__res = (((($dictBitraversable_0)->{'bitraverse'})($dictApplicative_1))(function($x_2) {
  $__num = \func_num_args();
  $__res = $x_2;
  goto __end;;
  __end:
...
function majData_majBitraversable_bitraversablemajFlip($dictBitraversable_0) {
  ...
  $__num = \func_num_args();
  $__res = function($r_4) use ($__local_var_2_2, $dictMonoid_3) {
  $__num = \func_num_args();
  $__res = function($l_5) use ($__local_var_2_2, $dictMonoid_3, $r_4) {
  $__num = \func_num_args();
  $__res = function($v_6) use ($__local_var_2_2, $dictMonoid_3, $l_5, $r_4) {
  $__num = \func_num_args();
  $__res = ((((($__local_var_2_2)->{'bifoldMap'})($dictMonoid_3))($l_5))($r_4))($v_6);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  $__num = \func_num_args();
  $Functor0_4_4 = (((($dictApplicative_3)->{'Apply0'})(null))->{'Functor0'})(null);
  $__res = function($r_5) use ($Functor0_4_4, $dictApplicative_3, $dictBitraversable_0) {
  $__num = \func_num_args();
  $__res = function($l_6) use ($Functor0_4_4, $dictApplicative_3, $dictBitraversable_0, $r_5) {
  $__num = \func_num_args();
  $__res = function($v_7) use ($Functor0_4_4, $dictApplicative_3, $dictBitraversable_0, $l_6, $r_5) {
  $__num = \func_num_args();
  $__res = ((($Functor0_4_4)->{'map'})(function($x_8) {
  $__num = \func_num_args();
  $__res = $x_8;
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))(((((($dictBitraversable_0)->{'bitraverse'})($dictApplicative_3))($l_6))($r_5))($v_7));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  $__num = \func_num_args();
  $Functor0_4_5 = (((($dictApplicative_3)->{'Apply0'})(null))->{'Functor0'})(null);
  $__res = function($v_5) use ($Functor0_4_5, $dictApplicative_3, $dictBitraversable_0) {
  $__num = \func_num_args();
  $__res = ((($Functor0_4_5)->{'map'})(function($x_6) {
  $__num = \func_num_args();
  $__res = $x_6;
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))(((($dictBitraversable_0)->{'bisequence'})($dictApplicative_3))($v_5));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Bifunctor0" => function($_dollar___unused_3) use ($bifunctorFlip_1_0) {
  $__num = \func_num_args();
  $__res = $bifunctorFlip_1_0;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Bifoldable1" => function($_dollar___unused_3) use ($bifoldableFlip_2_2) {
  $__num = \func_num_args();
...
function majData_majBitraversable_bitraversablemajProduct2($dictBitraversable_0) {
  ...
  $__local_var_1_0 = (($dictBitraversable_0)->{'Bifunctor0'})(null);
  $__local_var_2_1 = (($dictBitraversable_0)->{'Bifoldable1'})(null);
  $__res = function($dictBitraversable1_3) use ($__local_var_1_0, $__local_var_2_1, $dictBitraversable_0) {
  $__num = \func_num_args();
  ...
  $__local_var_5_4 = (($dictBitraversable1_3)->{'Bifoldable1'})(null);
  $bifoldableProduct21_5_4 = (object)["bifoldr" => function($l_6) use ($__local_var_2_1, $__local_var_5_4) {
  $__num = \func_num_args();
  $__res = function($r_7) use ($__local_var_2_1, $__local_var_5_4, $l_6) {
  $__num = \func_num_args();
  $__res = function($u_8) use ($__local_var_2_1, $__local_var_5_4, $l_6, $r_7) {
  $__num = \func_num_args();
  $__res = function($m_9) use ($__local_var_2_1, $__local_var_5_4, $l_6, $r_7, $u_8) {
  $__num = \func_num_args();
  $semigroupEndo1_10_5 = (object)["append" => function($v_10) {
  $__num = \func_num_args();
  $__res = function($v1_11) use ($v_10) {
  $__num = \func_num_args();
  $__res = (($GLOBALS['Control_Semigroupoid_composeImpl'])($v_10))($v1_11);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  $__res = (((((((($GLOBALS['Data_Bifoldable_bifoldableProduct2'])($__local_var_2_1))($__local_var_5_4))->{'bifoldMap'})((object)["mempty" => function($x_11) {
  $__num = \func_num_args();
  $__res = $x_11;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Semigroup0" => function($_dollar___unused_11) use ($semigroupEndo1_10_5) {
  $__num = \func_num_args();
  $__res = $semigroupEndo1_10_5;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}]))((($GLOBALS['Control_Semigroupoid_composeImpl'])(function($x_10) {
  $__num = \func_num_args();
  $__res = $x_10;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))($l_6)))((($GLOBALS['Control_Semigroupoid_composeImpl'])(function($x_10) {
  $__num = \func_num_args();
  $__res = $x_10;
  goto __end;;
  __end:
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "bifoldl" => function($l_6) use ($__local_var_2_1, $__local_var_5_4) {
  $__num = \func_num_args();
  $__res = function($r_7) use ($__local_var_2_1, $__local_var_5_4, $l_6) {
  $__num = \func_num_args();
  $__res = function($u_8) use ($__local_var_2_1, $__local_var_5_4, $l_6, $r_7) {
  ...
  $__res = function($m_9) use ($__local_var_2_1, $__local_var_5_4, $l_6, $r_7, $u_8) {
  $__num = \func_num_args();
  $semigroupEndo1_10_6 = (object)["append" => function($v_10) {
  $__num = \func_num_args();
  $__res = function($v1_11) use ($v_10) {
  $__num = \func_num_args();
  $__res = (($GLOBALS['Control_Semigroupoid_composeImpl'])($v_10))($v1_11);
  ...
  $__local_var_11_7 = (object)["mempty" => function($x_11) {
  $__num = \func_num_args();
  $__res = $x_11;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Semigroup0" => function($_dollar___unused_11) use ($semigroupEndo1_10_6) {
  $__num = \func_num_args();
  $__res = $semigroupEndo1_10_6;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}];
  $__local_var_12_8 = (($__local_var_11_7)->{'Semigroup0'})(null);
  $semigroupDual1_12_8 = (object)["append" => function($v_13) use ($__local_var_12_8) {
  $__num = \func_num_args();
  $__res = function($v1_14) use ($__local_var_12_8, $v_13) {
  $__num = \func_num_args();
  $__res = ((($__local_var_12_8)->{'append'})($v1_14))($v_13);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  $__res = (((((((($GLOBALS['Data_Bifoldable_bifoldableProduct2'])($__local_var_2_1))($__local_var_5_4))->{'bifoldMap'})((object)["mempty" => ($__local_var_11_7)->{'mempty'}, "Semigroup0" => function($_dollar___unused_13) use ($semigroupDual1_12_8) {
  $__num = \func_num_args();
  $__res = $semigroupDual1_12_8;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}]))((($GLOBALS['Control_Semigroupoid_composeImpl'])(function($x_10) {
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))(function($b_10) use ($l_6) {
  $__num = \func_num_args();
  $__res = function($a_11) use ($b_10, $l_6) {
  $__num = \func_num_args();
  $__res = (($l_6)($a_11))($b_10);
  goto __end;;
  __end:
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))(function($b_10) use ($r_7) {
  $__num = \func_num_args();
  $__res = function($a_11) use ($b_10, $r_7) {
  $__num = \func_num_args();
  $__res = (($r_7)($a_11))($b_10);
  goto __end;;
  __end:
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "bifoldMap" => function($dictMonoid_6) use ($__local_var_2_1, $__local_var_5_4) {
  $__num = \func_num_args();
  $Semigroup0_7_10 = (($dictMonoid_6)->{'Semigroup0'})(null);
  $__res = function($l_8) use ($Semigroup0_7_10, $__local_var_2_1, $__local_var_5_4, $dictMonoid_6) {
  $__num = \func_num_args();
  $__res = function($r_9) use ($Semigroup0_7_10, $__local_var_2_1, $__local_var_5_4, $dictMonoid_6, $l_8) {
  $__num = \func_num_args();
  $__res = function($v_10) use ($Semigroup0_7_10, $__local_var_2_1, $__local_var_5_4, $dictMonoid_6, $l_8, $r_9) {
  $__num = \func_num_args();
  $__res = ((($Semigroup0_7_10)->{'append'})(((((($__local_var_2_1)->{'bifoldMap'})($dictMonoid_6))($l_8))($r_9))(($v_10)->{'value0'})))(((((($__local_var_5_4)->{'bifoldMap'})($dictMonoid_6))($l_8))($r_9))(($v_10)->{'value1'}));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  $__num = \func_num_args();
  $Apply0_7_12 = (($dictApplicative_6)->{'Apply0'})(null);
  $Functor0_8_13 = (((($dictApplicative_6)->{'Apply0'})(null))->{'Functor0'})(null);
  $__res = function($l_9) use ($Apply0_7_12, $Functor0_8_13, $dictApplicative_6, $dictBitraversable1_3, $dictBitraversable_0) {
  $__num = \func_num_args();
  $__res = function($r_10) use ($Apply0_7_12, $Functor0_8_13, $dictApplicative_6, $dictBitraversable1_3, $dictBitraversable_0, $l_9) {
  $__num = \func_num_args();
  $__res = function($v_11) use ($Apply0_7_12, $Functor0_8_13, $dictApplicative_6, $dictBitraversable1_3, $dictBitraversable_0, $l_9, $r_10) {
  $__num = \func_num_args();
  $__res = ((($Apply0_7_12)->{'apply'})(((($Functor0_8_13)->{'map'})($GLOBALS['Data_Functor_Product2_Product2']))(((((($dictBitraversable_0)->{'bitraverse'})($dictApplicative_6))($l_9))($r_10))(($v_11)->{'value0'}))))(((((($dictBitraversable1_3)->{'bitraverse'})($dictApplicative_6))($l_9))($r_10))(($v_11)->{'value1'}));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  $__num = \func_num_args();
  $Apply0_7_14 = (($dictApplicative_6)->{'Apply0'})(null);
  $Functor0_8_15 = (((($dictApplicative_6)->{'Apply0'})(null))->{'Functor0'})(null);
  $__res = function($v_9) use ($Apply0_7_14, $Functor0_8_15, $dictApplicative_6, $dictBitraversable1_3, $dictBitraversable_0) {
  $__num = \func_num_args();
  $__res = ((($Apply0_7_14)->{'apply'})(((($Functor0_8_15)->{'map'})($GLOBALS['Data_Functor_Product2_Product2']))(((($dictBitraversable_0)->{'bisequence'})($dictApplicative_6))(($v_9)->{'value0'}))))(((($dictBitraversable1_3)->{'bisequence'})($dictApplicative_6))(($v_9)->{'value1'}));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Bifunctor0" => function($_dollar___unused_6) use ($bifunctorProduct21_4_2) {
  $__num = \func_num_args();
  $__res = $bifunctorProduct21_4_2;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Bifoldable1" => function($_dollar___unused_6) use ($bifoldableProduct21_5_4) {
  $__num = \func_num_args();
...
function majData_majBitraversable_bitraversemajDefault($dictBitraversable_0) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majBitraversable_bitraversemajDefault';
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 1);
  }
  $Bifunctor0_1_0 = (($dictBitraversable_0)->{'Bifunctor0'})(null);
  $__res = function($dictApplicative_2) use ($Bifunctor0_1_0, $dictBitraversable_0) {
  $__num = \func_num_args();
  $__res = function($f_3) use ($Bifunctor0_1_0, $dictApplicative_2, $dictBitraversable_0) {
  $__num = \func_num_args();
  $__res = function($g_4) use ($Bifunctor0_1_0, $dictApplicative_2, $dictBitraversable_0, $f_3) {
  $__num = \func_num_args();
  $__res = function($t_5) use ($Bifunctor0_1_0, $dictApplicative_2, $dictBitraversable_0, $f_3, $g_4) {
  $__num = \func_num_args();
  $__res = ((($dictBitraversable_0)->{'bisequence'})($dictApplicative_2))((((($Bifunctor0_1_0)->{'bimap'})($f_3))($g_4))($t_5));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
function majData_majBitraversable_bifor($dictBitraversable_0, $dictApplicative_1 = null, $t_2 = null, $f_3 = null, $g_4 = null) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majBitraversable_bifor';
  if ($__num < 5) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 5);
  }
  $__res = ((((($dictBitraversable_0)->{'bitraverse'})($dictApplicative_1))($f_3))($g_4))($t_2);
  goto __end;;
  __end:
