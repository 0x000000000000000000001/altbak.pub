...
function majData_majMonoid_majDual_monoidmajDual($dictMonoid_0) {
  ...
  $__res = (object)["mempty" => ($dictMonoid_0)->{'mempty'}, "Semigroup0" => function($_dollar___unused_2) use ($semigroupDual1_1_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Monoid_Dual_eq1Dual'] = (object)["eq1" => function($dictEq_0) {
  $__num = \func_num_args();
  $__res = ($dictEq_0)->{'eq'};
  goto __end;;
  __end:
...
$GLOBALS['Data_Monoid_Dual_ord1Dual'] = (object)["compare1" => function($dictOrd_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Monoid_Dual_applicativeDual'] = (object)["pure" => function($x_0) {
  $__num = \func_num_args();
  $__res = $x_0;
  goto __end;;
  __end:
...
$GLOBALS['Data_Monoid_Dual_monadDual'] = (object)["Applicative0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
