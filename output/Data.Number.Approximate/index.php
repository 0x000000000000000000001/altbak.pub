...
function majData_majNumber_majApproximate_eqmajRelative(float $v_0, $v1_1 = null, $v2_2 = null): bool|\Closure {
  ...
  switch ($v1_1) {
case 0.0:
$__t0 = ( ! \Data\Ord\majData_majOrd_ordmajNumbermajImpl(new \Data\Ordering\Data_Ordering_LT(), new \Data\Ordering\Data_Ordering_EQ(), new \Data\Ordering\Data_Ordering_GT(), \Data\Number\majData_majNumber_abs($v2_2), $v_0) instanceof \Data\Ordering\Data_Ordering_GT);
goto end_branch_0;;
break;
default:
;
break;
  ...
  switch ($v2_2) {
case 0.0:
$__t0 = ( ! \Data\Ord\majData_majOrd_ordmajNumbermajImpl(new \Data\Ordering\Data_Ordering_LT(), new \Data\Ordering\Data_Ordering_EQ(), new \Data\Ordering\Data_Ordering_GT(), \Data\Number\majData_majNumber_abs($v1_1), $v_0) instanceof \Data\Ordering\Data_Ordering_GT);
goto end_branch_0;;
break;
default:
;
break;
  ...
  $__t0 = ( ! \Data\Ord\majData_majOrd_ordmajNumbermajImpl(new \Data\Ordering\Data_Ordering_LT(), new \Data\Ordering\Data_Ordering_EQ(), new \Data\Ordering\Data_Ordering_GT(), \Data\Number\majData_majNumber_abs(($v1_1 - $v2_2)), (($v_0 * \Data\Number\majData_majNumber_abs(($v1_1 + $v2_2))) / 2.0)) instanceof \Data\Ordering\Data_Ordering_GT);
  end_branch_0:;
  $__res = $__t0;
  goto __end;;
  __end:
...
function majData_majNumber_majApproximate_eqmajApproximate(float $v_0, $v_1 = null): bool|\Closure {
  $__num = \func_num_args();
...
function majData_majNumber_majApproximate_neqmajApproximate(float $x_0, $y_1 = null): bool|\Closure {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majNumber_majApproximate_neqmajApproximate';
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__res = ( ! \Data\Number\Approximate\majData_majNumber_majApproximate_eqmajRelative(0.000001, $x_0, $y_1));
  goto __end;;
  __end:
  return 2 < $__num ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
}
...
function majData_majNumber_majApproximate_eqmajAbsolute(float $v_0, $x_1 = null, $y_2 = null): bool|\Closure {
  ...
  $__res = ( ! \Data\Ord\majData_majOrd_ordmajNumbermajImpl(new \Data\Ordering\Data_Ordering_LT(), new \Data\Ordering\Data_Ordering_EQ(), new \Data\Ordering\Data_Ordering_GT(), \Data\Number\majData_majNumber_abs(($x_1 - $y_2)), $v_0) instanceof \Data\Ordering\Data_Ordering_GT);
  goto __end;;
  __end:
  return 3 < $__num ? $__res(...\array_slice(\func_get_args(), 3)) : $__res;
}
