...
$GLOBALS['Effect_Console_clear'] = (\array_key_exists('clear', $ffi_Effect_Console) ? $ffi_Effect_Console['clear'] : new class { public function __invoke(...$args) { return $this; } });
function majEffect_majConsole_debug(string $v0) {
  ...
  $f = (\array_key_exists('debug', $ffi_Effect_Console) ? $ffi_Effect_Console['debug'] : new class { public function __invoke(...$args) { return $this; } });
  return $f($v0);
}
...
function majEffect_majConsole_error(string $v0) {
  ...
  global $ffi_Effect_Console;
  $f = (\array_key_exists('error', $ffi_Effect_Console) ? $ffi_Effect_Console['error'] : new class { public function __invoke(...$args) { return $this; } });
  return $f($v0);
}
...
function majEffect_majConsole_group(string $v0) {
  ...
  global $ffi_Effect_Console;
  $f = (\array_key_exists('group', $ffi_Effect_Console) ? $ffi_Effect_Console['group'] : new class { public function __invoke(...$args) { return $this; } });
  return $f($v0);
}
...
function majEffect_majConsole_groupmajCollapsed(string $v0) {
  ...
  global $ffi_Effect_Console;
  $f = (\array_key_exists('groupCollapsed', $ffi_Effect_Console) ? $ffi_Effect_Console['groupCollapsed'] : new class { public function __invoke(...$args) { return $this; } });
  return $f($v0);
}
$GLOBALS['Effect_Console_groupCollapsed'] = __NAMESPACE__ . '\\majEffect_majConsole_groupmajCollapsed';

$GLOBALS['Effect_Console_groupEnd'] = (\array_key_exists('groupEnd', $ffi_Effect_Console) ? $ffi_Effect_Console['groupEnd'] : new class { public function __invoke(...$args) { return $this; } });
function majEffect_majConsole_info(string $v0) {
  ...
  global $ffi_Effect_Console;
  $f = (\array_key_exists('info', $ffi_Effect_Console) ? $ffi_Effect_Console['info'] : new class { public function __invoke(...$args) { return $this; } });
  return $f($v0);
}
...
function majEffect_majConsole_log(string $v0) {
  ...
  global $ffi_Effect_Console;
  $f = (\array_key_exists('log', $ffi_Effect_Console) ? $ffi_Effect_Console['log'] : new class { public function __invoke(...$args) { return $this; } });
  return $f($v0);
}
...
function majEffect_majConsole_time(string $v0) {
  ...
  global $ffi_Effect_Console;
  $f = (\array_key_exists('time', $ffi_Effect_Console) ? $ffi_Effect_Console['time'] : new class { public function __invoke(...$args) { return $this; } });
  return $f($v0);
}
...
function majEffect_majConsole_timemajEnd(string $v0) {
  ...
  global $ffi_Effect_Console;
  $f = (\array_key_exists('timeEnd', $ffi_Effect_Console) ? $ffi_Effect_Console['timeEnd'] : new class { public function __invoke(...$args) { return $this; } });
  return $f($v0);
}
...
function majEffect_majConsole_timemajLog(string $v0) {
  ...
  global $ffi_Effect_Console;
  $f = (\array_key_exists('timeLog', $ffi_Effect_Console) ? $ffi_Effect_Console['timeLog'] : new class { public function __invoke(...$args) { return $this; } });
  return $f($v0);
}
...
function majEffect_majConsole_warn(string $v0) {
  ...
  global $ffi_Effect_Console;
  $f = (\array_key_exists('warn', $ffi_Effect_Console) ? $ffi_Effect_Console['warn'] : new class { public function __invoke(...$args) { return $this; } });
  return $f($v0);
}
...
function majEffect_majConsole_grouped(string $name_0, $inner_1 = null) {
  ...
  $__local_var_2_0 = \Effect\Console\majEffect_majConsole_group($name_0);
  $__res = function() use ($__local_var_2_0, $inner_1, &$__fn) {
$_dollar___unused_3_1 = phpurs_execute_effect($__local_var_2_0);
$result_4_2 = phpurs_execute_effect($inner_1);
$_dollar___unused_5_3 = phpurs_execute_effect($GLOBALS['Effect_Console_groupEnd']);
return phpurs_execute_effect(phpurs_execute_effect(phpurs_execute_effect($result_4_2)));
};
  goto __end;;
  __end:
  return 2 < $__num ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
