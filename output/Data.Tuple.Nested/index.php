...
function majData_majTuple_majNested_uncurry8($f_prime__0, $v_1 = null) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majTuple_majNested_uncurry8';
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__res = (((((((($f_prime__0)(($v_1)->{'value0'}))((($v_1)->{'value1'})->{'value0'}))(((($v_1)->{'value1'})->{'value1'})->{'value0'}))((((($v_1)->{'value1'})->{'value1'})->{'value1'})->{'value0'}))(((((($v_1)->{'value1'})->{'value1'})->{'value1'})->{'value1'})->{'value0'}))((((((($v_1)->{'value1'})->{'value1'})->{'value1'})->{'value1'})->{'value1'})->{'value0'}))(((((((($v_1)->{'value1'})->{'value1'})->{'value1'})->{'value1'})->{'value1'})->{'value1'})->{'value0'}))((((((((($v_1)->{'value1'})->{'value1'})->{'value1'})->{'value1'})->{'value1'})->{'value1'})->{'value1'})->{'value0'});
  goto __end;;
  __end:
  return 2 < $__num ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
}
...
function majData_majTuple_majNested_uncurry7($f_prime__0, $v_1 = null) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majTuple_majNested_uncurry7';
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__res = ((((((($f_prime__0)(($v_1)->{'value0'}))((($v_1)->{'value1'})->{'value0'}))(((($v_1)->{'value1'})->{'value1'})->{'value0'}))((((($v_1)->{'value1'})->{'value1'})->{'value1'})->{'value0'}))(((((($v_1)->{'value1'})->{'value1'})->{'value1'})->{'value1'})->{'value0'}))((((((($v_1)->{'value1'})->{'value1'})->{'value1'})->{'value1'})->{'value1'})->{'value0'}))(((((((($v_1)->{'value1'})->{'value1'})->{'value1'})->{'value1'})->{'value1'})->{'value1'})->{'value0'});
  goto __end;;
  __end:
  return 2 < $__num ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
}
...
function majData_majTuple_majNested_uncurry6($f_prime__0, $v_1 = null) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majTuple_majNested_uncurry6';
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__res = (((((($f_prime__0)(($v_1)->{'value0'}))((($v_1)->{'value1'})->{'value0'}))(((($v_1)->{'value1'})->{'value1'})->{'value0'}))((((($v_1)->{'value1'})->{'value1'})->{'value1'})->{'value0'}))(((((($v_1)->{'value1'})->{'value1'})->{'value1'})->{'value1'})->{'value0'}))((((((($v_1)->{'value1'})->{'value1'})->{'value1'})->{'value1'})->{'value1'})->{'value0'});
  goto __end;;
  __end:
  return 2 < $__num ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
}
...
function majData_majTuple_majNested_uncurry10($f_prime__0, $v_1 = null) {
  $__num = \func_num_args();
...
function majData_majTuple_majNested_curry8($z_0, $f_prime__1 = null, $a_2 = null, $b_3 = null, $c_4 = null, $d_5 = null, $e_6 = null, $f_7 = null, $g_8 = null, $h_9 = null) {
  $__num = \func_num_args();
...
function majData_majTuple_majNested_curry7($z_0, $f_prime__1 = null, $a_2 = null, $b_3 = null, $c_4 = null, $d_5 = null, $e_6 = null, $f_7 = null, $g_8 = null) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majTuple_majNested_curry7';
  if ($__num < 9) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 9);
  }
  $__res = ($f_prime__1)(new \Data\Tuple\Data_Tuple_Tuple($a_2, new \Data\Tuple\Data_Tuple_Tuple($b_3, new \Data\Tuple\Data_Tuple_Tuple($c_4, new \Data\Tuple\Data_Tuple_Tuple($d_5, new \Data\Tuple\Data_Tuple_Tuple($e_6, new \Data\Tuple\Data_Tuple_Tuple($f_7, new \Data\Tuple\Data_Tuple_Tuple($g_8, $z_0))))))));
  goto __end;;
  __end:
  return 9 < $__num ? $__res(...\array_slice(\func_get_args(), 9)) : $__res;
}
...
function majData_majTuple_majNested_curry6($z_0, $f_prime__1 = null, $a_2 = null, $b_3 = null, $c_4 = null, $d_5 = null, $e_6 = null, $f_7 = null) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majTuple_majNested_curry6';
  if ($__num < 8) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 8);
  }
  $__res = ($f_prime__1)(new \Data\Tuple\Data_Tuple_Tuple($a_2, new \Data\Tuple\Data_Tuple_Tuple($b_3, new \Data\Tuple\Data_Tuple_Tuple($c_4, new \Data\Tuple\Data_Tuple_Tuple($d_5, new \Data\Tuple\Data_Tuple_Tuple($e_6, new \Data\Tuple\Data_Tuple_Tuple($f_7, $z_0)))))));
  goto __end;;
  __end:
  return 8 < $__num ? $__res(...\array_slice(\func_get_args(), 8)) : $__res;
}
...
function majData_majTuple_majNested_curry10($z_0, $f_prime__1 = null, $a_2 = null, $b_3 = null, $c_4 = null, $d_5 = null, $e_6 = null, $f_7 = null, $g_8 = null, $h_9 = null, $i_10 = null, $j_11 = null) {
  $__num = \func_num_args();
