...
$GLOBALS['Data_Equivalence_newtypeEquivalence'] = (object)["Coercible0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
  $__res = null;
  goto __end;;
  __end:
...
$GLOBALS['Data_Equivalence_monoidEquivalence'] = (object)["mempty" => function($v_0) {
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Semigroup0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
...
function majData_majEquivalence_comparisonmajEquivalence($v_0, $a_1 = null, $b_2 = null): bool|\Closure {
  ...
  $__res = (($v_0)($a_1))($b_2) instanceof \Data\Ordering\Data_Ordering_EQ;
  goto __end;;
  __end:
