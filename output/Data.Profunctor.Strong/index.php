...
function majData_majProfunctor_majStrong_fanout($dictSemigroupoid_0, $dictStrong_1 = null) {
  ...
  $Profunctor0_2_0 = (($dictStrong_1)->{'Profunctor0'})(null);
  $__res = function($l_3) use ($Profunctor0_2_0, $dictSemigroupoid_0, $dictStrong_1) {
  $__num = \func_num_args();
  $__res = function($r_4) use ($Profunctor0_2_0, $dictSemigroupoid_0, $dictStrong_1, $l_3) {
  $__num = \func_num_args();
  $__res = (((($Profunctor0_2_0)->{'dimap'})(function($a_5) {
  $__num = \func_num_args();
