...
function majData_majString_majCodemajUnits_stripmajSuffix(string $v_0, $str_1 = null) {
  ...
  $__res = match (($v1_2_0)->{'after'}) { $v_0 => new \Data\Maybe\Data_Maybe_Just(($v1_2_0)->{'before'}), default => new \Data\Maybe\Data_Maybe_Nothing() };
  goto __end;;
  __end:
  return 2 < $__num ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
}
...
function majData_majString_majCodemajUnits_stripmajPrefix(string $v_0, $str_1 = null) {
  ...
  $__res = match (($v1_2_0)->{'before'}) { $v_0 => new \Data\Maybe\Data_Maybe_Just(($v1_2_0)->{'after'}), default => new \Data\Maybe\Data_Maybe_Nothing() };
  goto __end;;
  __end:
  return 2 < $__num ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
}
