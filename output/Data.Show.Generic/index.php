...
function majData_majShow_majGeneric_genericmajShowmajArgsmajProduct($dictGenericShowArgs_0, $dictGenericShowArgs1_1 = null) {
  ...
  $__num = \func_num_args();
  $__res = \Data\Semigroup\majData_majSemigroup_concatmajArray((($dictGenericShowArgs_0)->{'genericShowArgs'})(($v_2)->{'value0'}), (($dictGenericShowArgs1_1)->{'genericShowArgs'})(($v_2)->{'value1'}));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}];
...
function majData_majShow_majGeneric_genericmajShowmajConstructor($dictGenericShowArgs_0, $dictIsSymbol_1 = null) {
  ...
  $__res = match (count($v1_4_1)) { 0 => $ctor_3_0, default => (("(" . \Data\Show\Generic\majData_majShow_majGeneric_intercalate(" ", \Data\Semigroup\majData_majSemigroup_concatmajArray([$ctor_3_0], $v1_4_1))) . ")") };
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}];
...
// Data_Show_Generic_genericShow
function majData_majShow_majGeneric_genericmajShow($dictGeneric_0, $dictGenericShow_1 = null, $x_2 = null) {
  $__num = \func_num_args();
