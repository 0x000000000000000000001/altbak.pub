...
function majData_majArray_majNonmajEmpty_majInternal_showmajNonmajEmptymajArray($dictShow_0) {
  ...
  $__res = (object)["show" => function($v_2) use ($showArray_1_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Array_NonEmpty_Internal_foldable1NonEmptyArray'] = (object)["foldMap1" => function($dictSemigroup_0) {
  ...
  $__num = \func_num_args();
  $__res = (($GLOBALS['Control_Semigroupoid_composeImpl'])((($GLOBALS['Data_Array_NonEmpty_Internal_foldable1NonEmptyArray'])->{'foldl1'})($append_1_0)))(($GLOBALS['Data_Functor_arrayMap'])($f_2));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
$GLOBALS['Data_Array_NonEmpty_Internal_traversable1NonEmptyArray'] = (object)["traverse1" => function($dictApply_0) {
  ...
  $__num = \func_num_args();
  $__res = ((($GLOBALS['Data_Array_NonEmpty_Internal_traversable1NonEmptyArray'])->{'traverse1'})($dictApply_0))(function($x_1) {
  $__num = \func_num_args();
  $__res = $x_1;
  goto __end;;
  __end:
