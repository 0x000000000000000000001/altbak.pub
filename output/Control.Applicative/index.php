...
function majControl_majApplicative_liftmajA1($dictApplicative_0) {
  $__num = \func_num_args();
  ...
  $__num = \func_num_args();
  $__res = function($a_3) use ($Apply0_1_0, $dictApplicative_0, $f_2) {
  $__num = \func_num_args();
  $__res = ((($Apply0_1_0)->{'apply'})((($dictApplicative_0)->{'pure'})($f_2)))($a_3);
  goto __end;;
  __end:
