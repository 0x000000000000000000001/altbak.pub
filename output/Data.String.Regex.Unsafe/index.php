...
function majData_majString_majRegex_majUnsafe_unsafemajRegex(string $s_0, $f_1 = null) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majString_majRegex_majUnsafe_unsafemajRegex';
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__local_var_2_0 = \Data\String\Regex\majData_majString_majRegex_regex($s_0, $f_1);
  $__t1 = null;;
