...
$GLOBALS['Data_Ord_Max_newtypeMax'] = (object)["Coercible0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
  $__res = null;
  goto __end;;
  __end:
...
goto end_branch_2;;
  ...
  $__res = (object)["mempty" => ($dictBounded_0)->{'bottom'}, "Semigroup0" => function($_dollar___unused_2) use ($semigroupMax1_1_0) {
  $__num = \func_num_args();
...
function majData_majOrd_majMax_ordmajMax($dictOrd_0) {
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Eq0" => function($_dollar___unused_2) use ($eqMax1_1_0) {
  $__num = \func_num_args();
  $__res = $eqMax1_1_0;
  goto __end;;
  __end:
