...
final class Data_Functor_Product2_Product2 { public $tag = 'Product2'; public function __construct(public  $value0, public  $value1) {} }
...
function majData_majFunctor_majProduct2_showmajProduct2($dictShow_0, $dictShow1_1 = null) {
  ...
  $__num = \func_num_args();
  $__res = (((("(Product2 " . (($dictShow_0)->{'show'})(($v_2)->{'value0'})) . " ") . (($dictShow1_1)->{'show'})(($v_2)->{'value1'})) . ")");
  goto __end;;
  __end:
...
function majData_majFunctor_majProduct2_ordmajProduct2($dictOrd_0) {
  ...
  $eqProduct22_3_1 = (object)["eq" => function($x_4) use ($__local_var_1_0, $__local_var_3_1) {
  $__num = \func_num_args();
...
goto end_branch_4;;
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Eq0" => function($_dollar___unused_4) use ($eqProduct22_3_1) {
  $__num = \func_num_args();
...
function majData_majFunctor_majProduct2_biapplymajProduct2($dictBiapply_0) {
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Bifunctor0" => function($_dollar___unused_4) use ($bifunctorProduct22_3_1) {
  $__num = \func_num_args();
...
function majData_majFunctor_majProduct2_biapplicativemajProduct2($dictBiapplicative_0) {
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Bifunctor0" => function($_dollar___unused_6) use ($bifunctorProduct22_5_3) {
  $__num = \func_num_args();
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Biapply0" => function($_dollar___unused_5) use ($biapplyProduct22_4_2) {
  $__num = \func_num_args();
