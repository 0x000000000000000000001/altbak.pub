...
$GLOBALS['Data_Profunctor_Closed_closedFunction'] = (object)["closed" => ($GLOBALS['Control_Semigroupoid_semigroupoidFn'])->{'compose'}, "Profunctor0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
