...
function majData_majOrd_ordmajArraymajImpl($v0, $v1 = null, $v2 = null): int|\Closure {
  ...
  global $ffi_Data_Ord;
  $f = (\array_key_exists('ordArrayImpl', $ffi_Data_Ord) ? $ffi_Data_Ord['ordArrayImpl'] : new class { public function __invoke(...$args) { return $this; } });
  return $f($v0, $v1, $v2);
}
...
function majData_majOrd_ordmajBooleanmajImpl($v0, $v1 = null, $v2 = null, $v3 = null, $v4 = null) {
  ...
  global $ffi_Data_Ord;
  $f = (\array_key_exists('ordBooleanImpl', $ffi_Data_Ord) ? $ffi_Data_Ord['ordBooleanImpl'] : new class { public function __invoke(...$args) { return $this; } });
...
function majData_majOrd_ordmajCharmajImpl($v0, $v1 = null, $v2 = null, $v3 = null, $v4 = null) {
  ...
  global $ffi_Data_Ord;
  $f = (\array_key_exists('ordCharImpl', $ffi_Data_Ord) ? $ffi_Data_Ord['ordCharImpl'] : new class { public function __invoke(...$args) { return $this; } });
  return $f($v0, $v1, $v2, $v3, $v4);
}
...
function majData_majOrd_ordmajIntmajImpl($v0, $v1 = null, $v2 = null, $v3 = null, $v4 = null) {
  ...
  global $ffi_Data_Ord;
  $f = (\array_key_exists('ordIntImpl', $ffi_Data_Ord) ? $ffi_Data_Ord['ordIntImpl'] : new class { public function __invoke(...$args) { return $this; } });
  return $f($v0, $v1, $v2, $v3, $v4);
}
...
function majData_majOrd_ordmajNumbermajImpl($v0, $v1 = null, $v2 = null, $v3 = null, $v4 = null) {
  ...
  global $ffi_Data_Ord;
  $f = (\array_key_exists('ordNumberImpl', $ffi_Data_Ord) ? $ffi_Data_Ord['ordNumberImpl'] : new class { public function __invoke(...$args) { return $this; } });
  return $f($v0, $v1, $v2, $v3, $v4);
}
...
function majData_majOrd_ordmajStringmajImpl($v0, $v1 = null, $v2 = null, $v3 = null, $v4 = null) {
  ...
  global $ffi_Data_Ord;
  $f = (\array_key_exists('ordStringImpl', $ffi_Data_Ord) ? $ffi_Data_Ord['ordStringImpl'] : new class { public function __invoke(...$args) { return $this; } });
  return $f($v0, $v1, $v2, $v3, $v4);
}
...
// Data_Ord_ordString
$GLOBALS['Data_Ord_ordString'] = (object)["compare" => ((($GLOBALS['Data_Ord_ordStringImpl'])(new \Data\Ordering\Data_Ordering_LT()))(new \Data\Ordering\Data_Ordering_EQ()))(new \Data\Ordering\Data_Ordering_GT()), "Eq0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Ord_ordRecordNil'] = (object)["compareRecord" => function($v_0) {
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "EqRecord0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
...
// Data_Ord_ordNumber
$GLOBALS['Data_Ord_ordNumber'] = (object)["compare" => ((($GLOBALS['Data_Ord_ordNumberImpl'])(new \Data\Ordering\Data_Ordering_LT()))(new \Data\Ordering\Data_Ordering_EQ()))(new \Data\Ordering\Data_Ordering_GT()), "Eq0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
...
// Data_Ord_ordInt
$GLOBALS['Data_Ord_ordInt'] = (object)["compare" => ((($GLOBALS['Data_Ord_ordIntImpl'])(new \Data\Ordering\Data_Ordering_LT()))(new \Data\Ordering\Data_Ordering_EQ()))(new \Data\Ordering\Data_Ordering_GT()), "Eq0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
...
// Data_Ord_ordChar
$GLOBALS['Data_Ord_ordChar'] = (object)["compare" => ((($GLOBALS['Data_Ord_ordCharImpl'])(new \Data\Ordering\Data_Ordering_LT()))(new \Data\Ordering\Data_Ordering_EQ()))(new \Data\Ordering\Data_Ordering_GT()), "Eq0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
...
// Data_Ord_ordBoolean
$GLOBALS['Data_Ord_ordBoolean'] = (object)["compare" => ((($GLOBALS['Data_Ord_ordBooleanImpl'])(new \Data\Ordering\Data_Ordering_LT()))(new \Data\Ordering\Data_Ordering_EQ()))(new \Data\Ordering\Data_Ordering_GT()), "Eq0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
...
// Data_Ord_ordRecord
function majData_majOrd_ordmajRecord($_dollar___unused_0, $dictOrdRecord_1 = null) {
  $__num = \func_num_args();
  ...
  $__res = (object)["compare" => (($dictOrdRecord_1)->{'compareRecord'})(new \Type\Proxy\Type_Proxy_Proxy()), "Eq0" => function($_dollar___unused_3) use ($eqRec1_2_0) {
  $__num = \func_num_args();
  $__res = $eqRec1_2_0;
  goto __end;;
  __end:
...
function majData_majOrd_signum($dictOrd_0, $dictRing_1 = null) {
  ...
  $Semiring01_4_2 = (($dictRing_1)->{'Semiring0'})(null);
  $one_5_3 = ($Semiring0_2_0)->{'one'};
  $__res = function($x_6) use ($Semiring01_4_2, $dictOrd_0, $dictRing_1, $one_5_3, $zero_3_1) {
  $__num = \func_num_args();
  $__t5 = null;;
  if (((($dictOrd_0)->{'compare'})($x_6))($zero_3_1) instanceof \Data\Ordering\Data_Ordering_LT) {
$__t5 = ((($dictRing_1)->{'sub'})(((($dictRing_1)->{'Semiring0'})(null))->{'zero'}))(($Semiring01_4_2)->{'one'});
goto end_branch_5;;
};
  $__t4 = null;;
...
function majData_majOrd_ordmajArray($dictOrd_0) {
  ...
  $__num = \func_num_args();
  $__res = \Data\Ord\majData_majOrd_ordmajIntmajImpl(new \Data\Ordering\Data_Ordering_LT(), new \Data\Ordering\Data_Ordering_EQ(), new \Data\Ordering\Data_Ordering_GT(), 0, \Data\Ord\majData_majOrd_ordmajArraymajImpl(function($x_4) use ($dictOrd_0) {
  $__num = \func_num_args();
...
goto end_branch_2;;
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Eq0" => function($_dollar___unused_2) use ($eqArray_1_0) {
  $__num = \func_num_args();
  $__res = $eqArray_1_0;
  goto __end;;
  __end:
...
$GLOBALS['Data_Ord_ord1Array'] = (object)["compare1" => function($dictOrd_0) {
  ...
  $__num = \func_num_args();
  $__res = \Data\Ord\majData_majOrd_ordmajIntmajImpl(new \Data\Ordering\Data_Ordering_LT(), new \Data\Ordering\Data_Ordering_EQ(), new \Data\Ordering\Data_Ordering_GT(), 0, \Data\Ord\majData_majOrd_ordmajArraymajImpl(function($x_3) use ($dictOrd_0) {
  $__num = \func_num_args();
  $__res = function($y_4) use ($dictOrd_0, $x_3) {
  $__num = \func_num_args();
  $v_5_0 = ((($dictOrd_0)->{'compare'})($x_3))($y_4);
  $__t1 = null;;
  if ($v_5_0 instanceof \Data\Ordering\Data_Ordering_EQ) {
$__t1 = 0;
goto end_branch_1;;
};
  if ($v_5_0 instanceof \Data\Ordering\Data_Ordering_LT) {
$__t1 = 1;
goto end_branch_1;;
};
  if ($v_5_0 instanceof \Data\Ordering\Data_Ordering_GT) {
$__t1 = -1;
goto end_branch_1;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
...
function majData_majOrd_ordmajRecordmajCons($dictOrdRecord_0) {
  ...
  $__res = function($_dollar___unused_2) use ($dictOrdRecord_0, $eqRowCons_1_0) {
  $__num = \func_num_args();
  ...
  $__t5 = null;;
  if (( ! $left_11_4 instanceof \Data\Ordering\Data_Ordering_EQ)) {
$__t5 = $left_11_4;
goto end_branch_5;;
};
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "EqRecord0" => function($_dollar___unused_7) use ($eqRowCons2_6_2) {
  $__num = \func_num_args();
...
goto end_branch_1;;
  ...
  $__t1 = null;
  end_branch_1:;
  $__local_var_4_0 = $__t1;
  $v_5_3 = ((($dictOrd_0)->{'compare'})($hi_2))($__local_var_4_0);
  $__t4 = null;;
  if ($v_5_3 instanceof \Data\Ordering\Data_Ordering_LT) {
$__t4 = $hi_2;
goto end_branch_4;;
};
  if ($v_5_3 instanceof \Data\Ordering\Data_Ordering_EQ) {
$__t4 = $hi_2;
goto end_branch_4;;
};
  if ($v_5_3 instanceof \Data\Ordering\Data_Ordering_GT) {
...
function majData_majOrd_abs($dictOrd_0, $dictRing_1 = null) {
  ...
  $__res = function($x_3) use ($dictOrd_0, $dictRing_1, $zero_2_0) {
  $__num = \func_num_args();
  $__t1 = null;;
  if (( ! ((($dictOrd_0)->{'compare'})($x_3))($zero_2_0) instanceof \Data\Ordering\Data_Ordering_LT)) {
$__t1 = $x_3;
goto end_branch_1;;
};
  $__t1 = ((($dictRing_1)->{'sub'})(((($dictRing_1)->{'Semiring0'})(null))->{'zero'}))($x_3);
  end_branch_1:;
  $__res = $__t1;
  goto __end;;
  __end:
