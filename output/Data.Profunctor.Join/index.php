...
$GLOBALS['Data_Profunctor_Join_newtypeJoin'] = (object)["Coercible0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
  $__res = null;
  goto __end;;
  __end:
...
function majData_majProfunctor_majJoin_monoidmajJoin($dictCategory_0) {
  ...
  $semigroupJoin1_1_0 = (object)["append" => function($v_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  ...
  $__res = (object)["mempty" => ($dictCategory_0)->{'identity'}, "Semigroup0" => function($_dollar___unused_2) use ($semigroupJoin1_1_0) {
  $__num = \func_num_args();
  $__res = $semigroupJoin1_1_0;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}];
...
function majData_majProfunctor_majJoin_invariantmajJoin($dictProfunctor_0) {
  ...
  $__res = (object)["imap" => function($f_1) use ($dictProfunctor_0) {
  $__num = \func_num_args();
  $__res = function($g_2) use ($dictProfunctor_0, $f_1) {
  $__num = \func_num_args();
  $__res = function($v_3) use ($dictProfunctor_0, $f_1, $g_2) {
  $__num = \func_num_args();
