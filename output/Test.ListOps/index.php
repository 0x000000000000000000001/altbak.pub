...
final class Test_ListOps_Nil { public $tag = 'Nil'; public function __construct() {} }
final class Test_ListOps_Cons { public $tag = 'Cons'; public function __construct(public  $value0, public  $value1) {} }
...
$__t3 = null;;
switch (\Data\EuclideanRing\majData_majEuclideanmajRing_intmajMod(($v_2)->{'value0'}, 2)) {
case 0:
$__tco_4 = ($v_2)->{'value1'};
...
function majTest_majListmajOps_summajEvens(int $n_0): int|\Closure {
  ...
  $go__go_1_0 = null;
  $go__go_1_0 = (function() use (&$go__go_1_0) {
  $__fn = function(int $curr_2, $acc_3 = null) use (&$go__go_1_0, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__tco_var_go__go_1_0_0_curr_2 = $curr_2;
  $__tco_var_go__go_1_0_0_acc_3 = $acc_3;
  tco_loop_go__go_1_0_0:;
  $curr_2 = $__tco_var_go__go_1_0_0_curr_2;
...
goto end_branch_2;;
  ...
  $__tco_0 = ($curr_2 - 1);
  $__tco_1 = new \Test\ListOps\Test_ListOps_Cons($curr_2, $acc_3);
  $__tco_var_go__go_1_0_0_curr_2 = $__tco_0;
  ...
  $__res = \Test\ListOps\majTest_majListmajOps_foldl($GLOBALS['Data_Semiring_intAdd'], 0, \Test\ListOps\majTest_majListmajOps_filtermajEvens((($go__go_1_0)($n_0))(new \Test\ListOps\Test_ListOps_Nil())));
  goto __end;;
  __end:
  return 1 < $__num ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}
...
$GLOBALS['Test_ListOps_describe'] = \Effect\Console\majEffect_majConsole_log("List Processing (900 elements):");

// Test_ListOps_act
$GLOBALS['Test_ListOps_act'] = (function() use (&$__fn) {
...
return phpurs_execute_effect(\Effect\Console\majEffect_majConsole_log(\Data\Show\majData_majShow_showmajIntmajImpl(\Test\ListOps\majTest_majListmajOps_summajEvens($dummy_1_1))));
};
})();
