...
function majData_majDivisionmajRing_rightmajDiv($dictDivisionRing_0) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majDivisionmajRing_rightmajDiv';
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 1);
  }
  $Semiring0_1_0 = (((($dictDivisionRing_0)->{'Ring0'})(null))->{'Semiring0'})(null);
  $__res = function($a_2) use ($Semiring0_1_0, $dictDivisionRing_0) {
  $__num = \func_num_args();
  $__res = function($b_3) use ($Semiring0_1_0, $a_2, $dictDivisionRing_0) {
  $__num = \func_num_args();
  $__res = ((($Semiring0_1_0)->{'mul'})($a_2))((($dictDivisionRing_0)->{'recip'})($b_3));
  goto __end;;
  __end:
...
function majData_majDivisionmajRing_leftmajDiv($dictDivisionRing_0) {
  $__num = \func_num_args();
  ...
  $__res = function($b_3) use ($Semiring0_1_0, $a_2, $dictDivisionRing_0) {
  $__num = \func_num_args();
  $__res = ((($Semiring0_1_0)->{'mul'})((($dictDivisionRing_0)->{'recip'})($b_3)))($a_2);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
