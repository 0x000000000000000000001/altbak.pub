...
return phpurs_execute_effect(\Effect\Console\majEffect_majConsole_log(\Data\Show\majData_majShow_showmajIntmajImpl(\Test\LazyEvaluation\majTest_majLazymajEvaluation_runmajManymajTimes($dummy_1_1, 0))));
};
})();
