...
$GLOBALS['Data_Predicate_newtypePredicate'] = (object)["Coercible0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
  $__res = null;
  goto __end;;
  __end:
...
$GLOBALS['Data_Predicate_heytingAlgebraPredicate'] = (object)["ff" => function($v_0) {
  $__num = \func_num_args();
  $__res = false;
  goto __end;;
  __end:
...
$GLOBALS['Data_Predicate_booleanAlgebraPredicate'] = (function() use (&$__fn) {
$heytingAlgebraFunction_0_0 = (object)["ff" => function($v_0) {
  $__num = \func_num_args();
  $__res = false;
  goto __end;;
  __end:
...
return (object)["HeytingAlgebra0" => function($_dollar___unused_1) use ($heytingAlgebraFunction_0_0) {
  $__num = \func_num_args();
  $__res = $heytingAlgebraFunction_0_0;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}];
