...
$GLOBALS['Data_Ord_Down_newtypeDown'] = (object)["Coercible0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
  $__res = null;
  goto __end;;
  __end:
...
function majData_majOrd_majDown_ordmajDown($dictOrd_0) {
  ...
  $eqDown1_1_0 = (($dictOrd_0)->{'Eq0'})(null);
...
goto end_branch_2;;
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Eq0" => function($_dollar___unused_2) use ($eqDown1_1_0) {
  $__num = \func_num_args();
  $__res = $eqDown1_1_0;
  goto __end;;
  __end:
...
function majData_majOrd_majDown_boundedmajDown($dictBounded_0) {
  ...
  $eqDown1_2_1 = (($__local_var_1_0)->{'Eq0'})(null);
  $ordDown1_1_0 = (object)["compare" => function($v_3) use ($__local_var_1_0) {
  $__num = \func_num_args();
...
goto end_branch_3;;
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Eq0" => function($_dollar___unused_3) use ($eqDown1_2_1) {
  $__num = \func_num_args();
  $__res = $eqDown1_2_1;
  goto __end;;
  __end:
  ...
  $__res = (object)["top" => ($dictBounded_0)->{'bottom'}, "bottom" => ($dictBounded_0)->{'top'}, "Ord0" => function($_dollar___unused_2) use ($ordDown1_1_0) {
  $__num = \func_num_args();
  $__res = $ordDown1_1_0;
  goto __end;;
  __end:
