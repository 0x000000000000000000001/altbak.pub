...
// Data_String_NonEmpty_CodeUnits_toNonEmptyString
function majData_majString_majNonmajEmpty_majCodemajUnits_tomajNonmajEmptymajString(string $x_0): string|\Closure {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majString_majNonmajEmpty_majCodemajUnits_tomajNonmajEmptymajString';
  if ($__num < 1) {
...
$GLOBALS['Data_String_NonEmpty_CodeUnits_toNonEmptyString'] = __NAMESPACE__ . '\\majData_majString_majNonmajEmpty_majCodemajUnits_tomajNonmajEmptymajString';
...
function majData_majString_majNonmajEmpty_majCodemajUnits_snoc($c_0, $s_1 = null): string|\Closure {
  ...
  $__res = ($s_1 . \Data\String\CodeUnits\majData_majString_majCodemajUnits_singleton($c_0));
  goto __end;;
  __end:
...
$GLOBALS['Data_String_NonEmpty_CodeUnits_singleton_closure'] = (($GLOBALS['Control_Semigroupoid_composeImpl'])($GLOBALS['Data_String_NonEmpty_CodeUnits_toNonEmptyString']))($GLOBALS['Data_String_CodeUnits_singleton']);
...
$GLOBALS['Data_String_NonEmpty_CodeUnits_toNonEmptyCharArray_closure'] = (($GLOBALS['Control_Semigroupoid_composeImpl'])(function($v_0) {
  $__num = \func_num_args();
  $__t0 = null;;
...
goto end_branch_0;;
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))((($GLOBALS['Control_Semigroupoid_composeImpl'])($GLOBALS['Data_Array_NonEmpty_fromArray']))($GLOBALS['Data_String_NonEmpty_CodeUnits_toCharArray']));
...
$GLOBALS['Data_String_NonEmpty_CodeUnits_fromNonEmptyCharArray_closure'] = (($GLOBALS['Control_Semigroupoid_composeImpl'])(function($v_0) {
  $__num = \func_num_args();
  $__t0 = null;;
  if ($v_0 instanceof \Data\Maybe\Data_Maybe_Just) {
$__t0 = ($v_0)->{'value0'};
goto end_branch_0;;
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))((($GLOBALS['Control_Semigroupoid_composeImpl'])($GLOBALS['Data_String_NonEmpty_CodeUnits_fromCharArray']))($GLOBALS['Data_Array_NonEmpty_toArray']));
...
function majData_majString_majNonmajEmpty_majCodemajUnits_dropmajRight(int $i_0, $nes_1 = null) {
  ...
  $__t0 = null;;
  if (($i_0 >= \Data\String\CodeUnits\majData_majString_majCodemajUnits_length($nes_1))) {
$__t0 = new \Data\Maybe\Data_Maybe_Nothing();
goto end_branch_0;;
};
...
function majData_majString_majNonmajEmpty_majCodemajUnits_cons($c_0, $s_1 = null): string|\Closure {
  ...
  $__res = (\Data\String\CodeUnits\majData_majString_majCodemajUnits_singleton($c_0) . $s_1);
  goto __end;;
  __end:
  return 2 < $__num ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
}
