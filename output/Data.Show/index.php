...
function majData_majShow_showmajRecord($_dollar___unused_0, $_dollar___unused_1 = null, $dictShowRecordFields_2 = null) {
  $__num = \func_num_args();
  ...
  $__num = \func_num_args();
  $__res = (("{" . ((($dictShowRecordFields_2)->{'showRecordFields'})(new \Type\Proxy\Type_Proxy_Proxy()))($record_3)) . "}");
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}];
...
function majData_majShow_showmajRecordmajFieldsmajCons($dictIsSymbol_0, $dictShowRecordFields_1 = null, $dictShow_2 = null) {
  ...
  $__res = (((((" " . $key_5_0) . ": ") . (($dictShow_2)->{'show'})(\Record\Unsafe\majRecord_majUnsafe_unsafemajGet($key_5_0, $record_4))) . ",") . ((($dictShowRecordFields_1)->{'showRecordFields'})(new \Type\Proxy\Type_Proxy_Proxy()))($record_4));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
function majData_majShow_showmajRecordmajFieldsmajConsmajNil($dictIsSymbol_0, $dictShow_1 = null) {
  ...
  $__res = ((((" " . $key_4_0) . ": ") . (($dictShow_1)->{'show'})(\Record\Unsafe\majRecord_majUnsafe_unsafemajGet($key_4_0, $record_3))) . " ");
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
