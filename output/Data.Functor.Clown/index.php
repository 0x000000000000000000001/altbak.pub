...
function majData_majFunctor_majClown_showmajClown($dictShow_0) {
  ...
  $__num = \func_num_args();
  $__res = (("(Clown " . (($dictShow_0)->{'show'})($v_1)) . ")");
  goto __end;;
  __end:
...
function majData_majFunctor_majClown_profunctormajClown($dictContravariant_0) {
  ...
  $__res = (object)["dimap" => function($f_1) use ($dictContravariant_0) {
  $__num = \func_num_args();
  $__res = function($v_2) use ($dictContravariant_0, $f_1) {
  $__num = \func_num_args();
  $__res = function($v1_3) use ($dictContravariant_0, $f_1) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Functor_Clown_newtypeClown'] = (object)["Coercible0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
  $__res = null;
  goto __end;;
  __end:
...
$GLOBALS['Data_Functor_Clown_functorClown'] = (object)["map" => function($v_0) {
  $__num = \func_num_args();
  $__res = function($v1_1) {
  $__num = \func_num_args();
  $__res = $v1_1;
...
function majData_majFunctor_majClown_bifunctormajClown($dictFunctor_0) {
  ...
  $__res = (object)["bimap" => function($f_1) use ($dictFunctor_0) {
  $__num = \func_num_args();
  $__res = function($v_2) use ($dictFunctor_0, $f_1) {
  $__num = \func_num_args();
  $__res = function($v1_3) use ($dictFunctor_0, $f_1) {
  $__num = \func_num_args();
...
function majData_majFunctor_majClown_biapplymajClown($dictApply_0) {
  ...
  $bifunctorClown1_1_0 = (object)["bimap" => function($f_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Bifunctor0" => function($_dollar___unused_2) use ($bifunctorClown1_1_0) {
  $__num = \func_num_args();
  $__res = $bifunctorClown1_1_0;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}];
...
function majData_majFunctor_majClown_biapplicativemajClown($dictApplicative_0) {
  ...
  $bifunctorClown1_2_1 = (object)["bimap" => function($f_3) use ($__local_var_2_1) {
  $__num = \func_num_args();
  $__res = function($v_4) use ($__local_var_2_1, $f_3) {
  $__num = \func_num_args();
  $__res = function($v1_5) use ($__local_var_2_1, $f_3) {
  $__num = \func_num_args();
  ...
  $biapplyClown1_1_0 = (object)["biapply" => function($v_3) use ($__local_var_1_0) {
  $__num = \func_num_args();
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Bifunctor0" => function($_dollar___unused_3) use ($bifunctorClown1_2_1) {
  $__num = \func_num_args();
  ...
  $__res = (object)["bipure" => function($a_2) use ($dictApplicative_0) {
  $__num = \func_num_args();
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Biapply0" => function($_dollar___unused_2) use ($biapplyClown1_1_0) {
  $__num = \func_num_args();
