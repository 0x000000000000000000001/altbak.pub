...
function majControl_majMonad_majError_majClass_try($dictMonadError_0) {
  ...
  $__num = \func_num_args();
  $__res = ((($dictMonadError_0)->{'catchError'})(((($Functor0_2_1)->{'map'})($GLOBALS['Data_Either_Right']))($a_4)))((($GLOBALS['Control_Semigroupoid_composeImpl'])($pure_3_2))($GLOBALS['Data_Either_Left']));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
function majControl_majMonad_majError_majClass_withmajResource($dictMonadError_0) {
  ...
  $Monad0_4_3 = (((($dictMonadError_0)->{'MonadThrow0'})(null))->{'Monad0'})(null);
  $Functor0_5_4 = (((((($Monad0_4_3)->{'Bind1'})(null))->{'Apply0'})(null))->{'Functor0'})(null);
  $pure_6_5 = ((($Monad0_4_3)->{'Applicative0'})(null))->{'pure'};
  $try1_4_3 = function($a_7) use ($Functor0_5_4, $dictMonadError_0, $pure_6_5) {
  $__num = \func_num_args();
  $__res = ((($dictMonadError_0)->{'catchError'})(((($Functor0_5_4)->{'map'})($GLOBALS['Data_Either_Right']))($a_7)))((($GLOBALS['Control_Semigroupoid_composeImpl'])($pure_6_5))($GLOBALS['Data_Either_Left']));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  $pure_5_7 = ((($Monad0_2_1)->{'Applicative0'})(null))->{'pure'};
  $__res = function($acquire_6) use ($Bind1_3_2, $MonadThrow0_1_0, $pure_5_7, $try1_4_3) {
  $__num = \func_num_args();
  $__res = function($release_7) use ($Bind1_3_2, $MonadThrow0_1_0, $acquire_6, $pure_5_7, $try1_4_3) {
  $__num = \func_num_args();
  $__res = function($kleisli_8) use ($Bind1_3_2, $MonadThrow0_1_0, $acquire_6, $pure_5_7, $release_7, $try1_4_3) {
  $__num = \func_num_args();
  $__res = ((($Bind1_3_2)->{'bind'})($acquire_6))(function($resource_9) use ($Bind1_3_2, $MonadThrow0_1_0, $kleisli_8, $pure_5_7, $release_7, $try1_4_3) {
  $__num = \func_num_args();
  $__res = ((($Bind1_3_2)->{'bind'})(($try1_4_3)(($kleisli_8)($resource_9))))(function($result_10) use ($Bind1_3_2, $MonadThrow0_1_0, $pure_5_7, $release_7, $resource_9) {
  $__num = \func_num_args();
  $__res = ((($Bind1_3_2)->{'bind'})(($release_7)($resource_9)))(function($_dollar___unused_11) use ($MonadThrow0_1_0, $pure_5_7, $result_10) {
  $__num = \func_num_args();
  $__t8 = null;;
  if ($result_10 instanceof \Data\Either\Data_Either_Left) {
$__t8 = (($MonadThrow0_1_0)->{'throwError'})(($result_10)->{'value0'});
goto end_branch_8;;
};
  if ($result_10 instanceof \Data\Either\Data_Either_Right) {
$__t8 = ($pure_5_7)(($result_10)->{'value0'});
goto end_branch_8;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t8 = null;
