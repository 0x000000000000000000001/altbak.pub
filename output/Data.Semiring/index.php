...
$GLOBALS['Data_Semiring_semiringUnit'] = (object)["add" => function($v_0) {
  $__num = \func_num_args();
  $__res = function($v1_1) {
  $__num = \func_num_args();
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "zero" => $GLOBALS['Data_Unit_unit'], "mul" => function($v_0) {
  $__num = \func_num_args();
  $__res = function($v1_1) {
  $__num = \func_num_args();
  $__res = $GLOBALS['Data_Unit_unit'];
...
$GLOBALS['Data_Semiring_semiringRecordNil'] = (object)["addRecord" => function($v_0) {
  $__num = \func_num_args();
  $__res = function($v1_1) {
  $__num = \func_num_args();
  $__res = function($v2_2) {
...
$GLOBALS['Data_Semiring_semiringProxy'] = (object)["add" => function($v_0) {
  $__num = \func_num_args();
  $__res = function($v1_1) {
  $__num = \func_num_args();
...
function majData_majSemiring_semiringmajRecord($_dollar___unused_0, $dictSemiringRecord_1 = null) {
  $__num = \func_num_args();
...
function majData_majSemiring_semiringmajFn($dictSemiring_0) {
  ...
  $__res = (object)["add" => function($f_1) use ($dictSemiring_0) {
  $__num = \func_num_args();
  $__res = function($g_2) use ($dictSemiring_0, $f_1) {
  $__num = \func_num_args();
  $__res = function($x_3) use ($dictSemiring_0, $f_1, $g_2) {
  $__num = \func_num_args();
  $__res = ((($dictSemiring_0)->{'add'})(($f_1)($x_3)))(($g_2)($x_3));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "zero" => function($v_1) use ($dictSemiring_0) {
  $__num = \func_num_args();
  $__res = ($dictSemiring_0)->{'zero'};
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "mul" => function($f_1) use ($dictSemiring_0) {
  $__num = \func_num_args();
  $__res = function($g_2) use ($dictSemiring_0, $f_1) {
  $__num = \func_num_args();
  $__res = function($x_3) use ($dictSemiring_0, $f_1, $g_2) {
  $__num = \func_num_args();
  $__res = ((($dictSemiring_0)->{'mul'})(($f_1)($x_3)))(($g_2)($x_3));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "one" => function($v_1) use ($dictSemiring_0) {
  $__num = \func_num_args();
...
function majData_majSemiring_semiringmajRecordmajCons($dictIsSymbol_0, $_dollar___unused_1 = null, $dictSemiringRecord_2 = null, $dictSemiring_3 = null) {
  $__num = \func_num_args();
  ...
  $__res = (object)["addRecord" => function($v_6) use ($dictIsSymbol_0, $dictSemiringRecord_2, $dictSemiring_3) {
  $__num = \func_num_args();
  $__res = function($ra_7) use ($dictIsSymbol_0, $dictSemiringRecord_2, $dictSemiring_3) {
  $__num = \func_num_args();
  $__res = function($rb_8) use ($dictIsSymbol_0, $dictSemiringRecord_2, $dictSemiring_3, $ra_7) {
  $__num = \func_num_args();
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "mulRecord" => function($v_6) use ($dictIsSymbol_0, $dictSemiringRecord_2, $dictSemiring_3) {
  $__num = \func_num_args();
  $__res = function($ra_7) use ($dictIsSymbol_0, $dictSemiringRecord_2, $dictSemiring_3) {
  $__num = \func_num_args();
  $__res = function($rb_8) use ($dictIsSymbol_0, $dictSemiringRecord_2, $dictSemiring_3, $ra_7) {
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "oneRecord" => function($v_6) use ($dictIsSymbol_0, $dictSemiringRecord_2, $one1_4_0) {
  $__num = \func_num_args();
  $__res = function($v1_7) use ($dictIsSymbol_0, $dictSemiringRecord_2, $one1_4_0) {
  $__num = \func_num_args();
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "zeroRecord" => function($v_6) use ($dictIsSymbol_0, $dictSemiringRecord_2, $zero1_5_1) {
  $__num = \func_num_args();
  $__res = function($v1_7) use ($dictIsSymbol_0, $dictSemiringRecord_2, $zero1_5_1) {
  $__num = \func_num_args();
