...
function majTest_majArraymajOps_filtermajEvens($arr_0) {
  ...
  $__num = \func_num_args();
  $__res = (\Data\EuclideanRing\majData_majEuclideanmajRing_intmajMod($x_1, 2) === 0);
  goto __end;;
  __end:
...
function majTest_majArraymajOps_summajEvens(int $n_0): int|\Closure {
  ...
  $__res = \Data\Foldable\majData_majFoldable_foldlmajArray($GLOBALS['Data_Semiring_intAdd'], 0, ($GLOBALS['Data_Array_filterImpl'])(function($x_1) {
  $__num = \func_num_args();
  $__res = (\Data\EuclideanRing\majData_majEuclideanmajRing_intmajMod($x_1, 2) === 0);
  goto __end;;
  __end:
...
// Test_ArrayOps_act
$GLOBALS['Test_ArrayOps_act'] = (function() use (&$__fn) {
...
return phpurs_execute_effect(\Effect\Console\majEffect_majConsole_log(\Data\Show\majData_majShow_showmajIntmajImpl(\Test\ArrayOps\majTest_majArraymajOps_summajEvens($dummy_1_1))));
};
})();
