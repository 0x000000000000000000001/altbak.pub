...
function majData_majBounded_majGeneric_genericmajTopmajProduct($dictGenericTop_0, $dictGenericTop1_1 = null) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majBounded_majGeneric_genericmajTopmajProduct';
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__res = (object)["genericTop__prime__" => new \Data\Generic\Rep\Data_Generic_Rep_Product(($dictGenericTop_0)->{'genericTop__prime__'}, ($dictGenericTop1_1)->{'genericTop__prime__'})];
  goto __end;;
  __end:
...
function majData_majBounded_majGeneric_genericmajBottommajProduct($dictGenericBottom_0, $dictGenericBottom1_1 = null) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majBounded_majGeneric_genericmajBottommajProduct';
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__res = (object)["genericBottom__prime__" => new \Data\Generic\Rep\Data_Generic_Rep_Product(($dictGenericBottom_0)->{'genericBottom__prime__'}, ($dictGenericBottom1_1)->{'genericBottom__prime__'})];
  goto __end;;
  __end:
  return 2 < $__num ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
}
