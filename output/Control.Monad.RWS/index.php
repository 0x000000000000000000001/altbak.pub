...
function majControl_majMonad_majRmajWmajS_mapmajRmajWmajS($f_0) {
  ...
  $__local_var_1_0 = (($GLOBALS['Control_Semigroupoid_composeImpl'])((($GLOBALS['Control_Semigroupoid_composeImpl'])(function($x_1) {
  $__num = \func_num_args();
  $__res = $x_1;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))($f_0)))($GLOBALS['Unsafe_Coerce_unsafeCoerce']);
...
function majControl_majMonad_majRmajWmajS_execmajRmajWmajS($m_0, $r_1 = null, $s_2 = null) {
  ...
  $__local_var_3_0 = (($m_0)($r_1))($s_2);
  $__res = new \Data\Tuple\Data_Tuple_Tuple(($__local_var_3_0)->{'value0'}, ($__local_var_3_0)->{'value2'});
  goto __end;;
  __end:
  return 3 < $__num ? $__res(...\array_slice(\func_get_args(), 3)) : $__res;
}
...
function majControl_majMonad_majRmajWmajS_evalmajRmajWmajS($m_0, $r_1 = null, $s_2 = null) {
  ...
  $__local_var_3_0 = (($m_0)($r_1))($s_2);
  $__res = new \Data\Tuple\Data_Tuple_Tuple(($__local_var_3_0)->{'value1'}, ($__local_var_3_0)->{'value2'});
  goto __end;;
  __end:
  return 3 < $__num ? $__res(...\array_slice(\func_get_args(), 3)) : $__res;
}
