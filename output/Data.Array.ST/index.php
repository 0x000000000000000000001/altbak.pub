...
function majData_majArray_majSmajT_withmajArray($f_0, $xs_1 = null) {
  ...
  $__res = function() use ($f_0, $xs_1, &$__fn) {
$result_2_0 = ($GLOBALS['Data_Array_ST_thawImpl'])($xs_1);
$_dollar___unused_3_1 = phpurs_execute_effect(($f_0)($result_2_0));
return phpurs_execute_effect(phpurs_execute_effect(($GLOBALS['Data_Array_ST_unsafeFreezeImpl'])($result_2_0)));
};
  goto __end;;
  __end:
  return 2 < $__num ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
...
function majData_majArray_majSmajT_sortmajWith($dictOrd_0, $f_1 = null) {
  ...
  $__res = ($GLOBALS['Data_Array_ST_sortBy'])(function($x_2) use ($dictOrd_0, $f_1) {
  $__num = \func_num_args();
...
function majData_majArray_majSmajT_run($st_0) {
  ...
  $__res = \Control\Monad\ST\Internal\majControl_majMonad_majSmajT_majInternal_run(function() use ($st_0, &$__fn) {
$__local_var_1_0 = phpurs_execute_effect($st_0);
return phpurs_execute_effect(($GLOBALS['Data_Array_ST_unsafeFreezeImpl'])($__local_var_1_0));
});
  goto __end;;
  __end:
  return 1 < $__num ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
...
function majData_majArray_majSmajT_modify(int $i_0, $f_1 = null, $xs_2 = null) {
  ...
  $__res = function() use ($f_1, $i_0, $xs_2, &$__fn) {
$entry_3_0 = ($GLOBALS['Data_Array_ST_peekImpl'])($GLOBALS['Data_Maybe_Just'], new \Data\Maybe\Data_Maybe_Nothing(), $i_0, $xs_2);
$__t1 = null;;
if ($entry_3_0 instanceof \Data\Maybe\Data_Maybe_Just) {
$__t1 = ($GLOBALS['Data_Array_ST_pokeImpl'])($i_0, ($f_1)(($entry_3_0)->{'value0'}), $xs_2);
goto end_branch_1;;
};
if ($entry_3_0 instanceof \Data\Maybe\Data_Maybe_Nothing) {
$__t1 = false;
goto end_branch_1;;
};
throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
$__t1 = null;
end_branch_1:;
return phpurs_execute_effect($__t1);
};
  goto __end;;
  __end:
  return 3 < $__num ? $__res(...\array_slice(\func_get_args(), 3)) : $__res;
