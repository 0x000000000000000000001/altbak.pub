...
$__t0 = new \Data\Either\Data_Either_Right(($f_0)(($m_2)->{'value0'}));
goto end_branch_0;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t0 = null;
...
$__t5 = ((($dictOrd_0)->{'compare'})(($x_4)->{'value0'}))(($y_5)->{'value0'});
goto end_branch_5;;
};
...
$__t4 = ((($dictOrd1_2)->{'compare'})(($x_4)->{'value0'}))(($y_5)->{'value0'});
goto end_branch_4;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t4 = null;
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Eq0" => function($_dollar___unused_4) use ($eqEither2_3_1) {
  $__num = \func_num_args();
  $__res = $eqEither2_3_1;
  goto __end;;
  __end:
...
function majData_majEither_ord1majEither($dictOrd_0) {
  ...
  $__local_var_1_0 = (($dictOrd_0)->{'Eq0'})(null);
  $eq1Either1_1_0 = (object)["eq1" => function($dictEq1_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  ...
  $__num = \func_num_args();
  $__t1 = null;;
  if ($x_3 instanceof \Data\Either\Data_Either_Left) {
$__t1 = ($y_4 instanceof \Data\Either\Data_Either_Left && ((($__local_var_1_0)->{'eq'})(($x_3)->{'value0'}))(($y_4)->{'value0'}));
goto end_branch_1;;
};
  $__t1 = ($x_3 instanceof \Data\Either\Data_Either_Right && ($y_4 instanceof \Data\Either\Data_Either_Right && ((($dictEq1_2)->{'eq'})(($x_3)->{'value0'}))(($y_4)->{'value0'})));
  end_branch_1:;
  $__res = $__t1;
  goto __end;;
  __end:
...
$__t4 = ((($dictOrd_0)->{'compare'})(($x_3)->{'value0'}))(($y_4)->{'value0'});
goto end_branch_4;;
};
...
goto end_branch_3;;
  ...
  if (($x_3 instanceof \Data\Either\Data_Either_Right && $y_4 instanceof \Data\Either\Data_Either_Right)) {
$__t3 = ((($dictOrd1_2)->{'compare'})(($x_3)->{'value0'}))(($y_4)->{'value0'});
goto end_branch_3;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t3 = null;
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Eq10" => function($_dollar___unused_2) use ($eq1Either1_1_0) {
  $__num = \func_num_args();
  $__res = $eq1Either1_1_0;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}];
...
function majData_majEither_choose($dictAlt_0) {
  ...
  $__res = function($a_2) use ($Functor0_1_0, $dictAlt_0) {
  $__num = \func_num_args();
  $__res = function($b_3) use ($Functor0_1_0, $a_2, $dictAlt_0) {
  $__num = \func_num_args();
  $__res = ((($dictAlt_0)->{'alt'})(((($Functor0_1_0)->{'map'})($GLOBALS['Data_Either_Left']))($a_2)))(((($Functor0_1_0)->{'map'})($GLOBALS['Data_Either_Right']))($b_3));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
function majData_majEither_boundedmajEither($dictBounded_0) {
  ...
  $eqEither2_5_3 = (object)["eq" => function($x_6) use ($__local_var_2_1, $__local_var_5_3) {
  $__num = \func_num_args();
  $__res = function($y_7) use ($__local_var_2_1, $__local_var_5_3, $x_6) {
  $__num = \func_num_args();
  $__t4 = null;;
  if ($x_6 instanceof \Data\Either\Data_Either_Left) {
$__t4 = ($y_7 instanceof \Data\Either\Data_Either_Left && ((($__local_var_2_1)->{'eq'})(($x_6)->{'value0'}))(($y_7)->{'value0'}));
goto end_branch_4;;
};
  $__t4 = ($x_6 instanceof \Data\Either\Data_Either_Right && ($y_7 instanceof \Data\Either\Data_Either_Right && ((($__local_var_5_3)->{'eq'})(($x_6)->{'value0'}))(($y_7)->{'value0'})));
  end_branch_4:;
  $__res = $__t4;
  goto __end;;
  __end:
  ...
  $ordEither2_4_2 = (object)["compare" => function($x_6) use ($__local_var_1_0, $__local_var_4_2) {
  $__num = \func_num_args();
...
$__t7 = ((($__local_var_1_0)->{'compare'})(($x_6)->{'value0'}))(($y_7)->{'value0'});
goto end_branch_7;;
};
...
goto end_branch_6;;
  ...
  if (($x_6 instanceof \Data\Either\Data_Either_Right && $y_7 instanceof \Data\Either\Data_Either_Right)) {
$__t6 = ((($__local_var_4_2)->{'compare'})(($x_6)->{'value0'}))(($y_7)->{'value0'});
goto end_branch_6;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t6 = null;
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Eq0" => function($_dollar___unused_6) use ($eqEither2_5_3) {
  $__num = \func_num_args();
  $__res = $eqEither2_5_3;
  goto __end;;
  __end:
  ...
  $__res = (object)["top" => new \Data\Either\Data_Either_Right(($dictBounded1_3)->{'top'}), "bottom" => new \Data\Either\Data_Either_Left(($dictBounded_0)->{'bottom'}), "Ord0" => function($_dollar___unused_5) use ($ordEither2_4_2) {
  $__num = \func_num_args();
...
$__t1 = null;;
if ($v1_1 instanceof \Data\Either\Data_Either_Left) {
$__t1 = new \Data\Either\Data_Either_Left(($v1_1)->{'value0'});
goto end_branch_1;;
};
if ($v1_1 instanceof \Data\Either\Data_Either_Right) {
$__t1 = new \Data\Either\Data_Either_Right((($v_0)->{'value0'})(($v1_1)->{'value0'}));
goto end_branch_1;;
};
throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
$__t1 = null;
...
function majData_majEither_semigroupmajEither($dictSemigroup_0) {
  ...
  $__res = (object)["append" => function($x_1) use ($dictSemigroup_0) {
  $__num = \func_num_args();
  $__res = function($y_2) use ($dictSemigroup_0, $x_1) {
  $__num = \func_num_args();
  $__t0 = null;;
  if ($x_1 instanceof \Data\Either\Data_Either_Left) {
$__t0 = new \Data\Either\Data_Either_Left(($x_1)->{'value0'});
goto end_branch_0;;
};
  if ($x_1 instanceof \Data\Either\Data_Either_Right) {
$__t1 = null;;
if ($y_2 instanceof \Data\Either\Data_Either_Left) {
$__t1 = new \Data\Either\Data_Either_Left(($y_2)->{'value0'});
goto end_branch_1;;
};
if ($y_2 instanceof \Data\Either\Data_Either_Right) {
$__t1 = new \Data\Either\Data_Either_Right(((($dictSemigroup_0)->{'append'})(($x_1)->{'value0'}))(($y_2)->{'value0'}));
goto end_branch_1;;
};
throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
$__t1 = null;
...
$GLOBALS['Data_Either_applicativeEither'] = (object)["pure" => $GLOBALS['Data_Either_Right'], "Apply0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
  $__res = $GLOBALS['Data_Either_applyEither'];
  goto __end;;
  __end:
...
$GLOBALS['Data_Either_monadEither'] = (object)["Applicative0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
