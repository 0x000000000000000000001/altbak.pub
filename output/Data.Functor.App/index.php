...
function majData_majFunctor_majApp_semigroupmajApp($dictApply_0, $dictSemigroup_1 = null) {
  ...
  $__res = (object)["append" => function($v_3) use ($append_2_0, $dictApply_0) {
  $__num = \func_num_args();
  $__res = function($v1_4) use ($append_2_0, $dictApply_0, $v_3) {
  $__num = \func_num_args();
  $__res = ((($dictApply_0)->{'apply'})(((((($dictApply_0)->{'Functor0'})(null))->{'map'})($append_2_0))($v_3)))($v1_4);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
$GLOBALS['Data_Functor_App_newtypeApp'] = (object)["Coercible0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
  $__res = null;
  goto __end;;
  __end:
...
function majData_majFunctor_majApp_monoidmajApp($dictApplicative_0) {
  ...
  $__num = \func_num_args();
  $append_3_1 = ((($dictMonoid_2)->{'Semigroup0'})(null))->{'append'};
  $semigroupApp2_3_1 = (object)["append" => function($v_4) use ($__local_var_1_0, $append_3_1) {
  $__num = \func_num_args();
  $__res = function($v1_5) use ($__local_var_1_0, $append_3_1, $v_4) {
  $__num = \func_num_args();
  $__res = ((($__local_var_1_0)->{'apply'})(((((($__local_var_1_0)->{'Functor0'})(null))->{'map'})($append_3_1))($v_4)))($v1_5);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  $__res = (object)["mempty" => (($dictApplicative_0)->{'pure'})(($dictMonoid_2)->{'mempty'}), "Semigroup0" => function($_dollar___unused_4) use ($semigroupApp2_3_1) {
  $__num = \func_num_args();
...
function majData_majFunctor_majApp_ordmajApp($dictOrd1_0) {
  ...
  $eqApp2_3_1 = (object)["eq" => function($x_4) use ($__local_var_1_0, $__local_var_3_1) {
  $__num = \func_num_args();
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Eq0" => function($_dollar___unused_4) use ($eqApp2_3_1) {
  $__num = \func_num_args();
  $__res = $eqApp2_3_1;
  goto __end;;
  __end:
...
function majData_majFunctor_majApp_ord1majApp($dictOrd1_0) {
  ...
  $__local_var_1_0 = (($dictOrd1_0)->{'Eq10'})(null);
  $eq1App1_1_0 = (object)["eq1" => function($dictEq_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Eq10" => function($_dollar___unused_2) use ($eq1App1_1_0) {
  $__num = \func_num_args();
  $__res = $eq1App1_1_0;
  goto __end;;
  __end:
