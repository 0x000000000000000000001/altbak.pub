...
function majData_majInt_unsafemajClamp(float $x_0): int|\Closure {
  ...
  $__t2 = null;;
  if (( ! \Data\Number\majData_majNumber_ismajFinite($x_0))) {
$__t2 = 0;
goto end_branch_2;;
};
  if (( ! \Data\Ord\majData_majOrd_ordmajNumbermajImpl(new \Data\Ordering\Data_Ordering_LT(), new \Data\Ordering\Data_Ordering_EQ(), new \Data\Ordering\Data_Ordering_GT(), $x_0, \Data\Int\majData_majInt_tomajNumber($GLOBALS['Data_Bounded_topInt'])) instanceof \Data\Ordering\Data_Ordering_LT)) {
$__t2 = $GLOBALS['Data_Bounded_topInt'];
goto end_branch_2;;
};
  if (( ! \Data\Ord\majData_majOrd_ordmajNumbermajImpl(new \Data\Ordering\Data_Ordering_LT(), new \Data\Ordering\Data_Ordering_EQ(), new \Data\Ordering\Data_Ordering_GT(), $x_0, \Data\Int\majData_majInt_tomajNumber($GLOBALS['Data_Bounded_bottomInt'])) instanceof \Data\Ordering\Data_Ordering_GT)) {
...
$__t1 = null;;
if ($x_0 instanceof \Data\Int\Data_Int_Even) {
$__t1 = $y_1 instanceof \Data\Int\Data_Int_Even;
goto end_branch_1;;
};
$__t1 = ($x_0 instanceof \Data\Int\Data_Int_Odd && $y_1 instanceof \Data\Int\Data_Int_Odd);
end_branch_1:;
return $__t1;
})()) {
...
$__t2 = new \Data\Int\Data_Int_Odd();
goto end_branch_2;;
};
  $__t2 = new \Data\Int\Data_Int_Even();
  end_branch_2:;
  $__res = $__t2;
  goto __end;;
  __end:
...
// Data_Int_ringParity
$GLOBALS['Data_Int_ringParity'] = (object)["sub" => function($x_0) {
  $__num = \func_num_args();
  $__res = function($y_1) use ($x_0) {
  $__num = \func_num_args();
  $__t0 = null;;
...
$GLOBALS['Data_Int_divisionRingParity'] = (object)["recip" => function($x_0) {
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Ring0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Int_commutativeRingParity'] = (object)["Ring0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
  $__res = $GLOBALS['Data_Int_ringParity'];
  goto __end;;
  __end:
...
goto end_branch_0;;
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "CommutativeRing0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Int_boundedParity'] = (object)["bottom" => new \Data\Int\Data_Int_Even(), "top" => new \Data\Int\Data_Int_Odd(), "Ord0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
