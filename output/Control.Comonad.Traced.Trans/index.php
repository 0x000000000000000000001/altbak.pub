...
function majControl_majComonad_majTraced_majTrans_extendmajTracedmajT($dictExtend_0) {
  ...
  $functorTracedT1_2_1 = (object)["map" => function($f_3) use ($__local_var_2_1) {
  $__num = \func_num_args();
  $__res = function($v_4) use ($__local_var_2_1, $f_3) {
  $__num = \func_num_args();
  $__res = ((($__local_var_2_1)->{'map'})(function($g_5) use ($f_3) {
  $__num = \func_num_args();
  ...
  $__num = \func_num_args();
  $__res = ((($dictExtend_0)->{'extend'})(function($w_prime__6) use ($Functor0_1_0, $dictSemigroup_3, $f_4) {
  $__num = \func_num_args();
  ...
  $__num = \func_num_args();
  $__res = ($h_8)(((($dictSemigroup_3)->{'append'})($t_7))($t_prime__9));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
function majControl_majComonad_majTraced_majTrans_comonadmajTransmajTracedmajT($dictMonoid_0) {
  ...
  $__num = \func_num_args();
  $__res = ((($Functor0_2_0)->{'map'})(function($f_4) use ($dictMonoid_0) {
  $__num = \func_num_args();
  $__res = ($f_4)(($dictMonoid_0)->{'mempty'});
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))($v_3);
...
function majControl_majComonad_majTraced_majTrans_comonadmajTracedmajT($dictComonad_0) {
  ...
  $__num = \func_num_args();
  $__res = ((($__local_var_1_0)->{'extend'})(function($w_prime__7) use ($Functor0_2_1, $dictSemigroup_4, $f_5) {
  $__num = \func_num_args();
  $__res = function($t_8) use ($Functor0_2_1, $dictSemigroup_4, $f_5, $w_prime__7) {
  $__num = \func_num_args();
  $__res = ($f_5)(((($Functor0_2_1)->{'map'})(function($h_9) use ($dictSemigroup_4, $t_8) {
  $__num = \func_num_args();
  $__res = function($t_prime__10) use ($dictSemigroup_4, $h_9, $t_8) {
  $__num = \func_num_args();
  $__res = ($h_9)(((($dictSemigroup_4)->{'append'})($t_8))($t_prime__10));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Functor0" => function($_dollar___unused_5) use ($functorTracedT1_3_2) {
  $__num = \func_num_args();
  ...
  $__num = \func_num_args();
  $extendTracedT2_5_5 = ($extendTracedT1_3_2)((($dictMonoid_4)->{'Semigroup0'})(null));
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Extend0" => function($_dollar___unused_6) use ($extendTracedT2_5_5) {
  $__num = \func_num_args();
  $__res = $extendTracedT2_5_5;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}];
