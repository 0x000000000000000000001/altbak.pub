...
$GLOBALS['Data_BooleanAlgebra_booleanAlgebraUnit'] = (object)["HeytingAlgebra0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_BooleanAlgebra_booleanAlgebraRecordNil'] = (object)["HeytingAlgebraRecord0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
...
function majData_majBooleanmajAlgebra_booleanmajAlgebramajRecordmajCons($dictIsSymbol_0, $_dollar___unused_1 = null, $dictBooleanAlgebraRecord_2 = null) {
  $__num = \func_num_args();
  ...
  $__res = (object)["HeytingAlgebraRecord0" => function($_dollar___unused_6) use ($heytingAlgebraRecordCons2_5_1) {
  $__num = \func_num_args();
...
function majData_majBooleanmajAlgebra_booleanmajAlgebramajRecord($_dollar___unused_0, $dictBooleanAlgebraRecord_1 = null) {
  $__num = \func_num_args();
  ...
  $__res = (object)["HeytingAlgebra0" => function($_dollar___unused_3) use ($heytingAlgebraRecord1_2_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_BooleanAlgebra_booleanAlgebraProxy'] = (object)["HeytingAlgebra0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
...
function majData_majBooleanmajAlgebra_booleanmajAlgebramajFn($dictBooleanAlgebra_0) {
  ...
  $heytingAlgebraFunction_1_0 = (object)["ff" => function($v_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  $__res = ($__local_var_1_0)->{'ff'};
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "tt" => function($v_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  $__res = ($__local_var_1_0)->{'tt'};
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "implies" => function($f_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  $__res = function($g_3) use ($__local_var_1_0, $f_2) {
  $__num = \func_num_args();
  $__res = function($a_4) use ($__local_var_1_0, $f_2, $g_3) {
  $__num = \func_num_args();
  $__res = ((($__local_var_1_0)->{'implies'})(($f_2)($a_4)))(($g_3)($a_4));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "conj" => function($f_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  $__res = function($g_3) use ($__local_var_1_0, $f_2) {
  $__num = \func_num_args();
  $__res = function($a_4) use ($__local_var_1_0, $f_2, $g_3) {
  $__num = \func_num_args();
  $__res = ((($__local_var_1_0)->{'conj'})(($f_2)($a_4)))(($g_3)($a_4));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "disj" => function($f_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  $__res = function($g_3) use ($__local_var_1_0, $f_2) {
  $__num = \func_num_args();
  $__res = function($a_4) use ($__local_var_1_0, $f_2, $g_3) {
  $__num = \func_num_args();
  $__res = ((($__local_var_1_0)->{'disj'})(($f_2)($a_4)))(($g_3)($a_4));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "not" => function($f_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  $__res = function($a_3) use ($__local_var_1_0, $f_2) {
  $__num = \func_num_args();
  $__res = (($__local_var_1_0)->{'not'})(($f_2)($a_3));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  $__res = (object)["HeytingAlgebra0" => function($_dollar___unused_2) use ($heytingAlgebraFunction_1_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_BooleanAlgebra_booleanAlgebraBoolean'] = (object)["HeytingAlgebra0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
