...
function majData_majFunctor_majCostar_strongmajCostar($dictComonad_0) {
  ...
  $Extend0_1_0 = (($dictComonad_0)->{'Extend0'})(null);
  $Functor0_2_1 = (($Extend0_1_0)->{'Functor0'})(null);
  $__local_var_3_2 = (($Extend0_1_0)->{'Functor0'})(null);
  $profunctorCostar1_3_2 = (object)["dimap" => function($f_4) use ($__local_var_3_2) {
  $__num = \func_num_args();
  $__res = function($g_5) use ($__local_var_3_2, $f_4) {
  $__num = \func_num_args();
  $__res = function($v_6) use ($__local_var_3_2, $f_4, $g_5) {
  $__num = \func_num_args();
  $__res = (($GLOBALS['Control_Semigroupoid_composeImpl'])((($GLOBALS['Control_Semigroupoid_composeImpl'])($g_5))($v_6)))((($__local_var_3_2)->{'map'})($f_4));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  $__res = (object)["first" => function($v_4) use ($Functor0_2_1, $dictComonad_0) {
  $__num = \func_num_args();
  $__res = function($x_5) use ($Functor0_2_1, $dictComonad_0, $v_4) {
  $__num = \func_num_args();
  $__res = new \Data\Tuple\Data_Tuple_Tuple(($v_4)(((($Functor0_2_1)->{'map'})($GLOBALS['Data_Tuple_fst']))($x_5)), ((($dictComonad_0)->{'extract'})($x_5))->{'value1'});
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "second" => function($v_4) use ($Functor0_2_1, $dictComonad_0) {
  $__num = \func_num_args();
  $__res = function($x_5) use ($Functor0_2_1, $dictComonad_0, $v_4) {
  $__num = \func_num_args();
  $__res = new \Data\Tuple\Data_Tuple_Tuple(((($dictComonad_0)->{'extract'})($x_5))->{'value0'}, ($v_4)(((($Functor0_2_1)->{'map'})($GLOBALS['Data_Tuple_snd']))($x_5)));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Profunctor0" => function($_dollar___unused_4) use ($profunctorCostar1_3_2) {
  $__num = \func_num_args();
  $__res = $profunctorCostar1_3_2;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}];
...
$GLOBALS['Data_Functor_Costar_newtypeCostar'] = (object)["Coercible0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
  $__res = null;
  goto __end;;
  __end:
...
function majData_majFunctor_majCostar_hoistmajCostar($f_0, $v_1 = null) {
  ...
  $__res = (($GLOBALS['Control_Semigroupoid_composeImpl'])((($GLOBALS['Control_Semigroupoid_composeImpl'])(function($x_2) {
  $__num = \func_num_args();
  $__res = $x_2;
  goto __end;;
  __end:
...
$GLOBALS['Data_Functor_Costar_invariantCostar'] = (object)["imap" => function($f_0) {
  ...
  $__res = function($v_1) use ($f_0) {
  $__num = \func_num_args();
  $__res = function($v_2) use ($f_0) {
  $__num = \func_num_args();
  $__res = (($GLOBALS['Control_Semigroupoid_composeImpl'])($f_0))($v_2);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
function majData_majFunctor_majCostar_closedmajCostar($dictFunctor_0) {
  ...
  $profunctorCostar1_1_0 = (object)["dimap" => function($f_1) use ($dictFunctor_0) {
  $__num = \func_num_args();
  $__res = function($g_2) use ($dictFunctor_0, $f_1) {
  $__num = \func_num_args();
  $__res = function($v_3) use ($dictFunctor_0, $f_1, $g_2) {
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Profunctor0" => function($_dollar___unused_2) use ($profunctorCostar1_1_0) {
  $__num = \func_num_args();
...
function majData_majFunctor_majCostar_categorymajCostar($dictComonad_0) {
  ...
  $__res = (object)["identity" => ($dictComonad_0)->{'extract'}, "Semigroupoid0" => function($_dollar___unused_2) use ($semigroupoidCostar1_1_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Functor_Costar_monadCostar'] = (object)["Applicative0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
