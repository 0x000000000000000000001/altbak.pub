...
function majData_majLazy_showmajLazy($dictShow_0) {
  ...
  $__num = \func_num_args();
  $__res = (("(defer \\_ -> " . (($dictShow_0)->{'show'})(\Data\Lazy\majData_majLazy_force($x_1))) . ")");
  goto __end;;
  __end:
...
function majData_majLazy_semiringmajLazy($dictSemiring_0) {
  ...
  $__res = (object)["add" => function($a_1) use ($dictSemiring_0) {
  $__num = \func_num_args();
  $__res = function($b_2) use ($a_1, $dictSemiring_0) {
  $__num = \func_num_args();
  $__res = \Data\Lazy\majData_majLazy_defer(function($v_3) use ($a_1, $b_2, $dictSemiring_0) {
  $__num = \func_num_args();
  $__res = ((($dictSemiring_0)->{'add'})(\Data\Lazy\majData_majLazy_force($a_1)))(\Data\Lazy\majData_majLazy_force($b_2));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "zero" => \Data\Lazy\majData_majLazy_defer(function($v_1) use ($dictSemiring_0) {
  $__num = \func_num_args();
  $__res = ($dictSemiring_0)->{'zero'};
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}), "mul" => function($a_1) use ($dictSemiring_0) {
  $__num = \func_num_args();
  $__res = function($b_2) use ($a_1, $dictSemiring_0) {
  $__num = \func_num_args();
  $__res = \Data\Lazy\majData_majLazy_defer(function($v_3) use ($a_1, $b_2, $dictSemiring_0) {
  $__num = \func_num_args();
  $__res = ((($dictSemiring_0)->{'mul'})(\Data\Lazy\majData_majLazy_force($a_1)))(\Data\Lazy\majData_majLazy_force($b_2));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "one" => \Data\Lazy\majData_majLazy_defer(function($v_1) use ($dictSemiring_0) {
  $__num = \func_num_args();
  $__res = ($dictSemiring_0)->{'one'};
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
})];
...
function majData_majLazy_ringmajLazy($dictRing_0) {
  ...
  $semiringLazy1_1_0 = (object)["add" => function($a_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  $__res = function($b_3) use ($__local_var_1_0, $a_2) {
  $__num = \func_num_args();
  $__res = \Data\Lazy\majData_majLazy_defer(function($v_4) use ($__local_var_1_0, $a_2, $b_3) {
  $__num = \func_num_args();
  $__res = ((($__local_var_1_0)->{'add'})(\Data\Lazy\majData_majLazy_force($a_2)))(\Data\Lazy\majData_majLazy_force($b_3));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "zero" => \Data\Lazy\majData_majLazy_defer(function($v_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  $__res = ($__local_var_1_0)->{'zero'};
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}), "mul" => function($a_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  $__res = function($b_3) use ($__local_var_1_0, $a_2) {
  $__num = \func_num_args();
  $__res = \Data\Lazy\majData_majLazy_defer(function($v_4) use ($__local_var_1_0, $a_2, $b_3) {
  $__num = \func_num_args();
  $__res = ((($__local_var_1_0)->{'mul'})(\Data\Lazy\majData_majLazy_force($a_2)))(\Data\Lazy\majData_majLazy_force($b_3));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "one" => \Data\Lazy\majData_majLazy_defer(function($v_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Semiring0" => function($_dollar___unused_2) use ($semiringLazy1_1_0) {
  $__num = \func_num_args();
...
function majData_majLazy_monoidmajLazy($dictMonoid_0) {
  ...
  $semigroupLazy1_1_0 = (object)["append" => function($a_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  $__res = function($b_3) use ($__local_var_1_0, $a_2) {
  $__num = \func_num_args();
  $__res = \Data\Lazy\majData_majLazy_defer(function($v_4) use ($__local_var_1_0, $a_2, $b_3) {
  $__num = \func_num_args();
  $__res = ((($__local_var_1_0)->{'append'})(\Data\Lazy\majData_majLazy_force($a_2)))(\Data\Lazy\majData_majLazy_force($b_3));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
  ...
  $__res = (object)["mempty" => \Data\Lazy\majData_majLazy_defer(function($v_2) use ($dictMonoid_0) {
  $__num = \func_num_args();
  $__res = ($dictMonoid_0)->{'mempty'};
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}), "Semigroup0" => function($_dollar___unused_2) use ($semigroupLazy1_1_0) {
  $__num = \func_num_args();
  $__res = $semigroupLazy1_1_0;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}];
...
$GLOBALS['Data_Lazy_functorWithIndexLazy'] = (object)["mapWithIndex" => function($f_0) {
  ...
  $__num = \func_num_args();
  $__res = \Data\Lazy\majData_majLazy_defer(function($v_3) use ($__local_var_1_0, $l_2) {
  $__num = \func_num_args();
  $__res = ($__local_var_1_0)(\Data\Lazy\majData_majLazy_force($l_2));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
...
$GLOBALS['Data_Lazy_invariantLazy'] = (object)["imap" => function($f_0) {
  ...
  $__num = \func_num_args();
  $__res = function($l_2) use ($f_0) {
  $__num = \func_num_args();
  $__res = \Data\Lazy\majData_majLazy_defer(function($v_3) use ($f_0, $l_2) {
  $__num = \func_num_args();
  $__res = ($f_0)(\Data\Lazy\majData_majLazy_force($l_2));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
...
$GLOBALS['Data_Lazy_foldableWithIndexLazy'] = (object)["foldrWithIndex" => function($f_0) {
  ...
  $__num = \func_num_args();
  $__res = function($l_3) use ($__local_var_1_0, $z_2) {
  $__num = \func_num_args();
  $__res = (($__local_var_1_0)(\Data\Lazy\majData_majLazy_force($l_3)))($z_2);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  $__num = \func_num_args();
  $__res = function($l_3) use ($__local_var_1_1, $z_2) {
  $__num = \func_num_args();
  $__res = (($__local_var_1_1)($z_2))(\Data\Lazy\majData_majLazy_force($l_3));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  $__res = function($l_3) use ($__local_var_2_2) {
  $__num = \func_num_args();
  $__res = ($__local_var_2_2)(\Data\Lazy\majData_majLazy_force($l_3));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
$GLOBALS['Data_Lazy_traversableLazy'] = (object)["traverse" => function($dictApplicative_0) {
  ...
  $__num = \func_num_args();
  $__res = function($l_3) use ($Functor0_1_0, $f_2) {
  $__num = \func_num_args();
  $__res = ((($Functor0_1_0)->{'map'})((($GLOBALS['Control_Semigroupoid_composeImpl'])($GLOBALS['Data_Lazy_defer']))($GLOBALS['Data_Function_const'])))(($f_2)(\Data\Lazy\majData_majLazy_force($l_3)));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  $__res = function($l_2) use ($Functor0_1_1) {
  $__num = \func_num_args();
  $__res = ((($Functor0_1_1)->{'map'})((($GLOBALS['Control_Semigroupoid_composeImpl'])($GLOBALS['Data_Lazy_defer']))($GLOBALS['Data_Function_const'])))(\Data\Lazy\majData_majLazy_force($l_2));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
$GLOBALS['Data_Lazy_traversableWithIndexLazy'] = (object)["traverseWithIndex" => function($dictApplicative_0) {
  $__num = \func_num_args();
  $Functor0_1_0 = (((($dictApplicative_0)->{'Apply0'})(null))->{'Functor0'})(null);
  $traverse1_1_0 = function($f_2) use ($Functor0_1_0) {
  $__num = \func_num_args();
  $__res = function($l_3) use ($Functor0_1_0, $f_2) {
  $__num = \func_num_args();
  $__res = ((($Functor0_1_0)->{'map'})((($GLOBALS['Control_Semigroupoid_composeImpl'])($GLOBALS['Data_Lazy_defer']))($GLOBALS['Data_Function_const'])))(($f_2)(\Data\Lazy\majData_majLazy_force($l_3)));
...
$GLOBALS['Data_Lazy_traversable1Lazy'] = (object)["traverse1" => function($dictApply_0) {
  ...
  $__num = \func_num_args();
  $Functor0_1_1 = (($dictApply_0)->{'Functor0'})(null);
  $__res = function($l_2) use ($Functor0_1_1) {
  $__num = \func_num_args();
  $__res = ((($Functor0_1_1)->{'map'})((($GLOBALS['Control_Semigroupoid_composeImpl'])($GLOBALS['Data_Lazy_defer']))($GLOBALS['Data_Function_const'])))(\Data\Lazy\majData_majLazy_force($l_2));
  goto __end;;
...
function majData_majLazy_ordmajLazy($dictOrd_0) {
  ...
  $eqLazy1_1_0 = (object)["eq" => function($x_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Eq0" => function($_dollar___unused_2) use ($eqLazy1_1_0) {
  $__num = \func_num_args();
  $__res = $eqLazy1_1_0;
  goto __end;;
  __end:
...
$GLOBALS['Data_Lazy_ord1Lazy'] = (object)["compare1" => function($dictOrd_0) {
  $__num = \func_num_args();
  $__res = function($x_1) use ($dictOrd_0) {
  $__num = \func_num_args();
  $__res = function($y_2) use ($dictOrd_0, $x_1) {
  $__num = \func_num_args();
  $__res = ((($dictOrd_0)->{'compare'})(\Data\Lazy\majData_majLazy_force($x_1)))(\Data\Lazy\majData_majLazy_force($y_2));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
$GLOBALS['Data_Lazy_comonadLazy'] = (object)["extract" => $GLOBALS['Data_Lazy_force'], "Extend0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
...
function majData_majLazy_commutativemajRingmajLazy($dictCommutativeRing_0) {
  ...
  $semiringLazy1_2_1 = (object)["add" => function($a_3) use ($__local_var_2_1) {
  $__num = \func_num_args();
  $__res = function($b_4) use ($__local_var_2_1, $a_3) {
  $__num = \func_num_args();
  $__res = \Data\Lazy\majData_majLazy_defer(function($v_5) use ($__local_var_2_1, $a_3, $b_4) {
  $__num = \func_num_args();
  $__res = ((($__local_var_2_1)->{'add'})(\Data\Lazy\majData_majLazy_force($a_3)))(\Data\Lazy\majData_majLazy_force($b_4));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "zero" => \Data\Lazy\majData_majLazy_defer(function($v_3) use ($__local_var_2_1) {
  $__num = \func_num_args();
  $__res = ($__local_var_2_1)->{'zero'};
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}), "mul" => function($a_3) use ($__local_var_2_1) {
  $__num = \func_num_args();
  $__res = function($b_4) use ($__local_var_2_1, $a_3) {
  $__num = \func_num_args();
  $__res = \Data\Lazy\majData_majLazy_defer(function($v_5) use ($__local_var_2_1, $a_3, $b_4) {
  $__num = \func_num_args();
  $__res = ((($__local_var_2_1)->{'mul'})(\Data\Lazy\majData_majLazy_force($a_3)))(\Data\Lazy\majData_majLazy_force($b_4));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "one" => \Data\Lazy\majData_majLazy_defer(function($v_3) use ($__local_var_2_1) {
  $__num = \func_num_args();
  ...
  $ringLazy1_1_0 = (object)["sub" => function($a_3) use ($__local_var_1_0) {
  $__num = \func_num_args();
  $__res = function($b_4) use ($__local_var_1_0, $a_3) {
  $__num = \func_num_args();
  $__res = \Data\Lazy\majData_majLazy_defer(function($v_5) use ($__local_var_1_0, $a_3, $b_4) {
  $__num = \func_num_args();
  $__res = ((($__local_var_1_0)->{'sub'})(\Data\Lazy\majData_majLazy_force($a_3)))(\Data\Lazy\majData_majLazy_force($b_4));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Semiring0" => function($_dollar___unused_3) use ($semiringLazy1_2_1) {
  $__num = \func_num_args();
  $__res = $semiringLazy1_2_1;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}];
  $__res = (object)["Ring0" => function($_dollar___unused_2) use ($ringLazy1_1_0) {
  $__num = \func_num_args();
  $__res = $ringLazy1_1_0;
  goto __end;;
  __end:
...
function majData_majLazy_euclideanmajRingmajLazy($dictEuclideanRing_0) {
  ...
  $__local_var_1_0 = (((($dictEuclideanRing_0)->{'CommutativeRing0'})(null))->{'Ring0'})(null);
  $__local_var_2_1 = (($__local_var_1_0)->{'Semiring0'})(null);
  $semiringLazy1_2_1 = (object)["add" => function($a_3) use ($__local_var_2_1) {
  $__num = \func_num_args();
  $__res = function($b_4) use ($__local_var_2_1, $a_3) {
  ...
  $commutativeRingLazy1_1_0 = (object)["Ring0" => function($_dollar___unused_2) use ($ringLazy1_1_0) {
  $__num = \func_num_args();
  $__res = $ringLazy1_1_0;
  goto __end;;
  __end:
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "CommutativeRing0" => function($_dollar___unused_2) use ($commutativeRingLazy1_1_0) {
  $__num = \func_num_args();
...
function majData_majLazy_boundedmajLazy($dictBounded_0) {
  ...
  $eqLazy1_2_1 = (object)["eq" => function($x_3) use ($__local_var_2_1) {
  $__num = \func_num_args();
  $__res = function($y_4) use ($__local_var_2_1, $x_3) {
  $__num = \func_num_args();
  $__res = ((($__local_var_2_1)->{'eq'})(\Data\Lazy\majData_majLazy_force($x_3)))(\Data\Lazy\majData_majLazy_force($y_4));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  $ordLazy1_1_0 = (object)["compare" => function($x_3) use ($__local_var_1_0) {
  $__num = \func_num_args();
  $__res = function($y_4) use ($__local_var_1_0, $x_3) {
  $__num = \func_num_args();
  $__res = ((($__local_var_1_0)->{'compare'})(\Data\Lazy\majData_majLazy_force($x_3)))(\Data\Lazy\majData_majLazy_force($y_4));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Eq0" => function($_dollar___unused_3) use ($eqLazy1_2_1) {
  $__num = \func_num_args();
  $__res = $eqLazy1_2_1;
  goto __end;;
  __end:
  ...
  $__res = (object)["top" => \Data\Lazy\majData_majLazy_defer(function($v_2) use ($dictBounded_0) {
  $__num = \func_num_args();
  $__res = ($dictBounded_0)->{'top'};
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}), "bottom" => \Data\Lazy\majData_majLazy_defer(function($v_2) use ($dictBounded_0) {
  $__num = \func_num_args();
  $__res = ($dictBounded_0)->{'bottom'};
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}), "Ord0" => function($_dollar___unused_2) use ($ordLazy1_1_0) {
  $__num = \func_num_args();
  $__res = $ordLazy1_1_0;
  goto __end;;
  __end:
...
function majData_majLazy_heytingmajAlgebramajLazy($dictHeytingAlgebra_0) {
  ...
  $__res = (object)["ff" => \Data\Lazy\majData_majLazy_defer(function($v_1) use ($dictHeytingAlgebra_0) {
  $__num = \func_num_args();
  $__res = ($dictHeytingAlgebra_0)->{'ff'};
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}), "tt" => \Data\Lazy\majData_majLazy_defer(function($v_1) use ($dictHeytingAlgebra_0) {
  $__num = \func_num_args();
  $__res = ($dictHeytingAlgebra_0)->{'tt'};
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}), "implies" => function($a_1) use ($dictHeytingAlgebra_0) {
  $__num = \func_num_args();
  $__res = function($b_2) use ($a_1, $dictHeytingAlgebra_0) {
  $__num = \func_num_args();
  $__local_var_3_0 = \Data\Lazy\majData_majLazy_defer(function($v_3) use ($a_1, $dictHeytingAlgebra_0) {
  $__num = \func_num_args();
  $__res = (($dictHeytingAlgebra_0)->{'implies'})(\Data\Lazy\majData_majLazy_force($a_1));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
  $__res = \Data\Lazy\majData_majLazy_defer(function($v_4) use ($__local_var_3_0, $b_2) {
  $__num = \func_num_args();
  $__res = (\Data\Lazy\majData_majLazy_force($__local_var_3_0))(\Data\Lazy\majData_majLazy_force($b_2));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "conj" => function($a_1) use ($dictHeytingAlgebra_0) {
  $__num = \func_num_args();
  $__res = function($b_2) use ($a_1, $dictHeytingAlgebra_0) {
  $__num = \func_num_args();
  $__local_var_3_1 = \Data\Lazy\majData_majLazy_defer(function($v_3) use ($a_1, $dictHeytingAlgebra_0) {
  $__num = \func_num_args();
  $__res = (($dictHeytingAlgebra_0)->{'conj'})(\Data\Lazy\majData_majLazy_force($a_1));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
  $__res = \Data\Lazy\majData_majLazy_defer(function($v_4) use ($__local_var_3_1, $b_2) {
  $__num = \func_num_args();
  $__res = (\Data\Lazy\majData_majLazy_force($__local_var_3_1))(\Data\Lazy\majData_majLazy_force($b_2));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "disj" => function($a_1) use ($dictHeytingAlgebra_0) {
  $__num = \func_num_args();
  $__res = function($b_2) use ($a_1, $dictHeytingAlgebra_0) {
  $__num = \func_num_args();
  $__local_var_3_2 = \Data\Lazy\majData_majLazy_defer(function($v_3) use ($a_1, $dictHeytingAlgebra_0) {
  $__num = \func_num_args();
  $__res = (($dictHeytingAlgebra_0)->{'disj'})(\Data\Lazy\majData_majLazy_force($a_1));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
  $__res = \Data\Lazy\majData_majLazy_defer(function($v_4) use ($__local_var_3_2, $b_2) {
  $__num = \func_num_args();
  $__res = (\Data\Lazy\majData_majLazy_force($__local_var_3_2))(\Data\Lazy\majData_majLazy_force($b_2));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "not" => function($a_1) use ($dictHeytingAlgebra_0) {
  $__num = \func_num_args();
  $__res = \Data\Lazy\majData_majLazy_defer(function($v_2) use ($a_1, $dictHeytingAlgebra_0) {
  $__num = \func_num_args();
  $__res = (($dictHeytingAlgebra_0)->{'not'})(\Data\Lazy\majData_majLazy_force($a_1));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
...
function majData_majLazy_booleanmajAlgebramajLazy($dictBooleanAlgebra_0) {
  ...
  $heytingAlgebraLazy1_1_0 = (object)["ff" => \Data\Lazy\majData_majLazy_defer(function($v_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  $__res = ($__local_var_1_0)->{'ff'};
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}), "tt" => \Data\Lazy\majData_majLazy_defer(function($v_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  $__res = ($__local_var_1_0)->{'tt'};
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}), "implies" => function($a_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  $__res = function($b_3) use ($__local_var_1_0, $a_2) {
  $__num = \func_num_args();
  $__local_var_4_1 = \Data\Lazy\majData_majLazy_defer(function($v_4) use ($__local_var_1_0, $a_2) {
  $__num = \func_num_args();
  $__res = (($__local_var_1_0)->{'implies'})(\Data\Lazy\majData_majLazy_force($a_2));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
  $__res = \Data\Lazy\majData_majLazy_defer(function($v_5) use ($__local_var_4_1, $b_3) {
  $__num = \func_num_args();
  $__res = (\Data\Lazy\majData_majLazy_force($__local_var_4_1))(\Data\Lazy\majData_majLazy_force($b_3));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "conj" => function($a_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  $__res = function($b_3) use ($__local_var_1_0, $a_2) {
  $__num = \func_num_args();
  $__local_var_4_2 = \Data\Lazy\majData_majLazy_defer(function($v_4) use ($__local_var_1_0, $a_2) {
  $__num = \func_num_args();
  $__res = (($__local_var_1_0)->{'conj'})(\Data\Lazy\majData_majLazy_force($a_2));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
  $__res = \Data\Lazy\majData_majLazy_defer(function($v_5) use ($__local_var_4_2, $b_3) {
  $__num = \func_num_args();
  $__res = (\Data\Lazy\majData_majLazy_force($__local_var_4_2))(\Data\Lazy\majData_majLazy_force($b_3));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "disj" => function($a_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  $__res = function($b_3) use ($__local_var_1_0, $a_2) {
  $__num = \func_num_args();
  $__local_var_4_3 = \Data\Lazy\majData_majLazy_defer(function($v_4) use ($__local_var_1_0, $a_2) {
  $__num = \func_num_args();
  $__res = (($__local_var_1_0)->{'disj'})(\Data\Lazy\majData_majLazy_force($a_2));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
  $__res = \Data\Lazy\majData_majLazy_defer(function($v_5) use ($__local_var_4_3, $b_3) {
  $__num = \func_num_args();
  $__res = (\Data\Lazy\majData_majLazy_force($__local_var_4_3))(\Data\Lazy\majData_majLazy_force($b_3));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "not" => function($a_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  $__res = \Data\Lazy\majData_majLazy_defer(function($v_3) use ($__local_var_1_0, $a_2) {
  $__num = \func_num_args();
  $__res = (($__local_var_1_0)->{'not'})(\Data\Lazy\majData_majLazy_force($a_2));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
  ...
  $__res = (object)["HeytingAlgebra0" => function($_dollar___unused_2) use ($heytingAlgebraLazy1_1_0) {
  $__num = \func_num_args();
...
// Data_Lazy_monadLazy
$GLOBALS['Data_Lazy_monadLazy'] = (object)["Applicative0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
