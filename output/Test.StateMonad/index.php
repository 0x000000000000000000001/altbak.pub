...
function majTest_majStatemajMonad_chainmajModifications(int $v_0) {
  $__num = \func_num_args();
...
function majTest_majStatemajMonad_runmajManymajTimes(int $v_0, $v1_1 = null): int|\Closure {
  $__num = \func_num_args();
...
// Test_StateMonad_act
$GLOBALS['Test_StateMonad_act'] = (function() use (&$__fn) {
$__local_var_0_0 = \Bench\majBench_opaque(20);
return function() use ($__local_var_0_0, &$__fn) {
$dummy_1_1 = phpurs_execute_effect($__local_var_0_0);
return phpurs_execute_effect(\Effect\Console\majEffect_majConsole_log(\Data\Show\majData_majShow_showmajIntmajImpl(\Test\StateMonad\majTest_majStatemajMonad_runmajManymajTimes($dummy_1_1, 0))));
};
})();
