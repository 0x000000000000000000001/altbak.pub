...
$GLOBALS['Control_Monad_Reader_Class_monadReaderFun'] = (object)["local" => function($f_0) {
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "MonadAsk0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
...
function majControl_majMonad_majReader_majClass_asks($dictMonadAsk_0) {
  ...
  $Functor0_1_0 = (((((((($dictMonadAsk_0)->{'Monad0'})(null))->{'Bind1'})(null))->{'Apply0'})(null))->{'Functor0'})(null);
  $ask1_2_1 = ($dictMonadAsk_0)->{'ask'};
  $__res = function($f_3) use ($Functor0_1_0, $ask1_2_1) {
  $__num = \func_num_args();
  $__res = ((($Functor0_1_0)->{'map'})($f_3))($ask1_2_1);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
