...
$GLOBALS['Data_Profunctor_Split_profunctorSplit'] = (object)["dimap" => function($f_0) {
  $__num = \func_num_args();
...
function majData_majProfunctor_majSplit_liftmajSplit($fx_0) {
  ...
  $__res = new \Data\Profunctor\Split\Data_Profunctor_Split_SplitF(function($x_1) {
  $__num = \func_num_args();
  $__res = $x_1;
  goto __end;;
  __end:
...
$GLOBALS['Data_Profunctor_Split_functorSplit'] = (object)["map" => function($f_0) {
  $__num = \func_num_args();
