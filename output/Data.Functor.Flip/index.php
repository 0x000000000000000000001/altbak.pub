...
function majData_majFunctor_majFlip_semigroupoidmajFlip($dictSemigroupoid_0) {
  ...
  $__res = (object)["compose" => function($v_1) use ($dictSemigroupoid_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Functor_Flip_newtypeFlip'] = (object)["Coercible0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
  $__res = null;
  goto __end;;
  __end:
...
function majData_majFunctor_majFlip_functormajFlip($dictBifunctor_0) {
  ...
  $__num = \func_num_args();
  $__res = (((($dictBifunctor_0)->{'bimap'})($f_1))(function($x_3) {
  $__num = \func_num_args();
  $__res = $x_3;
  goto __end;;
  __end:
...
function majData_majFunctor_majFlip_contravariantmajFlip($dictProfunctor_0) {
  ...
  $__res = (object)["cmap" => function($f_1) use ($dictProfunctor_0) {
  $__num = \func_num_args();
  $__res = function($v_2) use ($dictProfunctor_0, $f_1) {
  $__num = \func_num_args();
  $__res = (((($dictProfunctor_0)->{'dimap'})($f_1))(function($x_3) {
  $__num = \func_num_args();
  $__res = $x_3;
  goto __end;;
  __end:
...
function majData_majFunctor_majFlip_categorymajFlip($dictCategory_0) {
  ...
  $semigroupoidFlip1_1_0 = (object)["compose" => function($v_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  ...
  $__res = (object)["identity" => ($dictCategory_0)->{'identity'}, "Semigroupoid0" => function($_dollar___unused_2) use ($semigroupoidFlip1_1_0) {
  $__num = \func_num_args();
  $__res = $semigroupoidFlip1_1_0;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}];
...
function majData_majFunctor_majFlip_bifunctormajFlip($dictBifunctor_0) {
  ...
  $__res = (object)["bimap" => function($f_1) use ($dictBifunctor_0) {
  $__num = \func_num_args();
  $__res = function($g_2) use ($dictBifunctor_0, $f_1) {
  $__num = \func_num_args();
  $__res = function($v_3) use ($dictBifunctor_0, $f_1, $g_2) {
  $__num = \func_num_args();
...
function majData_majFunctor_majFlip_biapplymajFlip($dictBiapply_0) {
  ...
  $bifunctorFlip1_1_0 = (object)["bimap" => function($f_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  ...
  $__res = (object)["biapply" => function($v_2) use ($dictBiapply_0) {
  $__num = \func_num_args();
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Bifunctor0" => function($_dollar___unused_2) use ($bifunctorFlip1_1_0) {
  $__num = \func_num_args();
  $__res = $bifunctorFlip1_1_0;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}];
...
function majData_majFunctor_majFlip_biapplicativemajFlip($dictBiapplicative_0) {
  ...
  $bifunctorFlip1_2_1 = (object)["bimap" => function($f_3) use ($__local_var_2_1) {
  $__num = \func_num_args();
  $__res = function($g_4) use ($__local_var_2_1, $f_3) {
  $__num = \func_num_args();
  $__res = function($v_5) use ($__local_var_2_1, $f_3, $g_4) {
  $__num = \func_num_args();
  ...
  $biapplyFlip1_1_0 = (object)["biapply" => function($v_3) use ($__local_var_1_0) {
  $__num = \func_num_args();
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Bifunctor0" => function($_dollar___unused_3) use ($bifunctorFlip1_2_1) {
  $__num = \func_num_args();
  ...
  $__res = (object)["bipure" => function($a_2) use ($dictBiapplicative_0) {
  $__num = \func_num_args();
  $__res = function($b_3) use ($a_2, $dictBiapplicative_0) {
  $__num = \func_num_args();
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Biapply0" => function($_dollar___unused_2) use ($biapplyFlip1_1_0) {
  $__num = \func_num_args();
