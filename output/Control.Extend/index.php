...
function majControl_majExtend_extendmajFn($dictSemigroup_0) {
  ...
  $__num = \func_num_args();
  $__res = ($f_1)(function($w_prime__4) use ($dictSemigroup_0, $g_2, $w_3) {
  $__num = \func_num_args();
  $__res = ($g_2)(((($dictSemigroup_0)->{'append'})($w_3))($w_prime__4));
  goto __end;;
  __end:
...
$GLOBALS['Control_Extend_extendArray'] = (object)["extend" => $GLOBALS['Control_Extend_arrayExtend'], "Functor0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
...
function majControl_majExtend_duplicate($dictExtend_0) {
  ...
  $__res = (($dictExtend_0)->{'extend'})(function($x_1) {
  $__num = \func_num_args();
  $__res = $x_1;
  goto __end;;
  __end:
