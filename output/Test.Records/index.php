...
break;
  ...
  ($__obj2)->{'f'} = (((($v1_1)->{'b'})->{'d'})->{'f'} + \Data\EuclideanRing\majData_majEuclideanmajRing_intmajMod($v_0, 5));
  ($__obj1)->{'d'} = $__obj2;
  ($__obj0)->{'b'} = $__obj1;
  $__tco_3 = ($v_0 - 1);
  $__tco_4 = $__obj0;
...
// Test_Records_act
$GLOBALS['Test_Records_act'] = (function() use (&$__fn) {
...
return phpurs_execute_effect(\Effect\Console\majEffect_majConsole_log(\Data\Show\majData_majShow_showmajIntmajImpl((((\Test\Records\majTest_majRecords_updatemajRec($dummy_1_1, $GLOBALS['Test_Records_initial']))->{'b'})->{'d'})->{'f'})));
};
})();
