...
function majEffect_majRef_modify_($f_0, $s_1 = null) {
  ...
  $__local_var_2_0 = \Effect\Ref\majEffect_majRef_modifymajImpl(function($s_2) use ($f_0) {
  $__num = \func_num_args();
  $s_prime__3_0 = ($f_0)($s_2);
  $__res = (object)["state" => $s_prime__3_0, "value" => $s_prime__3_0];
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, $s_1);
  $__res = function() use ($__local_var_2_0, &$__fn) {
$a_prime__3_2 = phpurs_execute_effect($__local_var_2_0);
