...
function majData_majMonoid_majDisj_monoidmajDisj($dictHeytingAlgebra_0) {
  ...
  $__res = (object)["mempty" => ($dictHeytingAlgebra_0)->{'ff'}, "Semigroup0" => function($_dollar___unused_2) use ($semigroupDisj1_1_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Monoid_Disj_applicativeDisj'] = (object)["pure" => function($x_0) {
  $__num = \func_num_args();
  $__res = $x_0;
  goto __end;;
  __end:
...
$GLOBALS['Data_Monoid_Disj_monadDisj'] = (object)["Applicative0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
