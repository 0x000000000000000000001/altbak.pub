...
function majEffect_majClass_majConsole_warnmajShow($dictMonadEffect_0) {
  ...
  $__num = \func_num_args();
  $__res = (($GLOBALS['Control_Semigroupoid_composeImpl'])($liftEffect_1_0))(function($a_3) use ($dictShow_2) {
  $__num = \func_num_args();
  $__res = \Effect\Console\majEffect_majConsole_warn((($dictShow_2)->{'show'})($a_3));
  goto __end;;
  __end:
...
function majEffect_majClass_majConsole_logmajShow($dictMonadEffect_0) {
  ...
  $__res = (($GLOBALS['Control_Semigroupoid_composeImpl'])($liftEffect_1_0))(function($a_3) use ($dictShow_2) {
  $__num = \func_num_args();
  $__res = \Effect\Console\majEffect_majConsole_log((($dictShow_2)->{'show'})($a_3));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
...
function majEffect_majClass_majConsole_infomajShow($dictMonadEffect_0) {
  ...
  $__res = (($GLOBALS['Control_Semigroupoid_composeImpl'])($liftEffect_1_0))(function($a_3) use ($dictShow_2) {
  $__num = \func_num_args();
  $__res = \Effect\Console\majEffect_majConsole_info((($dictShow_2)->{'show'})($a_3));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
...
function majEffect_majClass_majConsole_grouped($dictMonadEffect_0) {
  ...
  $groupEnd1_3_2 = (($dictMonadEffect_0)->{'liftEffect'})($GLOBALS['Effect_Console_groupEnd']);
  $Applicative0_4_3 = (($Monad0_1_0)->{'Applicative0'})(null);
  $__res = function($name_5) use ($Applicative0_4_3, $Bind1_2_1, $dictMonadEffect_0, $groupEnd1_3_2) {
  $__num = \func_num_args();
  $__res = function($inner_6) use ($Applicative0_4_3, $Bind1_2_1, $dictMonadEffect_0, $groupEnd1_3_2, $name_5) {
  $__num = \func_num_args();
  $__res = ((($Bind1_2_1)->{'bind'})(\Control\Semigroupoid\majControl_majSemigroupoid_composemajImpl(($dictMonadEffect_0)->{'liftEffect'}, $GLOBALS['Effect_Console_group'], $name_5)))(function($_dollar___unused_7) use ($Applicative0_4_3, $Bind1_2_1, $groupEnd1_3_2, $inner_6) {
  $__num = \func_num_args();
  $__res = ((($Bind1_2_1)->{'bind'})($inner_6))(function($result_8) use ($Applicative0_4_3, $Bind1_2_1, $groupEnd1_3_2) {
  $__num = \func_num_args();
  $__res = ((($Bind1_2_1)->{'bind'})($groupEnd1_3_2))(function($_dollar___unused_9) use ($Applicative0_4_3, $result_8) {
  $__num = \func_num_args();
  $__res = (($Applicative0_4_3)->{'pure'})($result_8);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
...
function majEffect_majClass_majConsole_errormajShow($dictMonadEffect_0) {
  ...
  $__res = (($GLOBALS['Control_Semigroupoid_composeImpl'])($liftEffect_1_0))(function($a_3) use ($dictShow_2) {
  $__num = \func_num_args();
  $__res = \Effect\Console\majEffect_majConsole_error((($dictShow_2)->{'show'})($a_3));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
...
function majEffect_majClass_majConsole_debugmajShow($dictMonadEffect_0) {
  ...
  $__res = (($GLOBALS['Control_Semigroupoid_composeImpl'])($liftEffect_1_0))(function($a_3) use ($dictShow_2) {
  $__num = \func_num_args();
  $__res = \Effect\Console\majEffect_majConsole_debug((($dictShow_2)->{'show'})($a_3));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
