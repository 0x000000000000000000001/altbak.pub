...
// ALL IMPORTS: Bench, Control.Bind, Data.Function, Data.Ring, Data.Semiring, Data.Show, Effect, Effect.Console, Prelude, Prim, Test.Church
// TO REQUIRE: Bench, Control.Bind, Data.Function, Data.Ring, Data.Semiring, Data.Show, Effect, Effect.Console, Prelude, Test.Church
...
// Test_Church_toInt
function majTest_majChurch_tomajInt($n_0): int|\Closure {
  $__num = \func_num_args();
...
// Test_Church_fromInt
function majTest_majChurch_frommajInt(int $v_0) {
  $__num = \func_num_args();
...
// Test_Church_c100
function majTest_majChurch_c100(int $n_0) {
  $__num = \func_num_args();
...
// Test_Church_c10k
function majTest_majChurch_c10k(int $n_0) {
  $__num = \func_num_args();
...
// Test_Church_c100k
function majTest_majChurch_c100k(int $n_0) {
  $__num = \func_num_args();
...
// Test_Church_act
$GLOBALS['Test_Church_act'] = (function() use (&$__fn) {
...
return phpurs_execute_effect(\Effect\Console\majEffect_majConsole_log(\Data\Show\majData_majShow_showmajIntmajImpl(\Test\Church\majTest_majChurch_c100k($dummy_1_1, function($x_2) {
  $__num = \func_num_args();
  $__res = ($x_2 + 1);
  goto __end;;
  __end:
