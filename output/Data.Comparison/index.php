...
$GLOBALS['Data_Comparison_semigroupComparison'] = (object)["append" => function($v_0) {
  ...
  $__num = \func_num_args();
  $__local_var_2_0 = (object)["append" => function($f_2) {
  $__num = \func_num_args();
  $__res = function($g_3) use ($f_2) {
  $__num = \func_num_args();
  $__res = function($x_4) use ($f_2, $g_3) {
  $__num = \func_num_args();
  $__local_var_5_0 = ($f_2)($x_4);
  $__local_var_6_1 = ($g_3)($x_4);
  $__t2 = null;;
  if ($__local_var_5_0 instanceof \Data\Ordering\Data_Ordering_LT) {
$__t2 = new \Data\Ordering\Data_Ordering_LT();
goto end_branch_2;;
};
  if ($__local_var_5_0 instanceof \Data\Ordering\Data_Ordering_GT) {
$__t2 = new \Data\Ordering\Data_Ordering_GT();
goto end_branch_2;;
};
  if ($__local_var_5_0 instanceof \Data\Ordering\Data_Ordering_EQ) {
$__t2 = $__local_var_6_1;
goto end_branch_2;;
};
  ...
  $__res = function($x_3) use ($__local_var_2_0, $v1_1, $v_0) {
  $__num = \func_num_args();
  $__res = ((($__local_var_2_0)->{'append'})(($v_0)($x_3)))(($v1_1)($x_3));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
$GLOBALS['Data_Comparison_newtypeComparison'] = (object)["Coercible0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
  $__res = null;
  goto __end;;
  __end:
