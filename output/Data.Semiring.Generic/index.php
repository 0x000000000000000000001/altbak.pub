...
function majData_majSemiring_majGeneric_genericmajSemiringmajProduct($dictGenericSemiring_0, $dictGenericSemiring1_1 = null) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majSemiring_majGeneric_genericmajSemiringmajProduct';
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__res = (object)["genericAdd__prime__" => function($v_2) use ($dictGenericSemiring1_1, $dictGenericSemiring_0) {
  $__num = \func_num_args();
  $__res = function($v1_3) use ($dictGenericSemiring1_1, $dictGenericSemiring_0, $v_2) {
  $__num = \func_num_args();
  $__res = new \Data\Generic\Rep\Data_Generic_Rep_Product(((($dictGenericSemiring_0)->{'genericAdd__prime__'})(($v_2)->{'value0'}))(($v1_3)->{'value0'}), ((($dictGenericSemiring1_1)->{'genericAdd__prime__'})(($v_2)->{'value1'}))(($v1_3)->{'value1'}));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "genericZero__prime__" => new \Data\Generic\Rep\Data_Generic_Rep_Product(($dictGenericSemiring_0)->{'genericZero__prime__'}, ($dictGenericSemiring1_1)->{'genericZero__prime__'}), "genericMul__prime__" => function($v_2) use ($dictGenericSemiring1_1, $dictGenericSemiring_0) {
  $__num = \func_num_args();
  $__res = function($v1_3) use ($dictGenericSemiring1_1, $dictGenericSemiring_0, $v_2) {
  $__num = \func_num_args();
  $__res = new \Data\Generic\Rep\Data_Generic_Rep_Product(((($dictGenericSemiring_0)->{'genericMul__prime__'})(($v_2)->{'value0'}))(($v1_3)->{'value0'}), ((($dictGenericSemiring1_1)->{'genericMul__prime__'})(($v_2)->{'value1'}))(($v1_3)->{'value1'}));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "genericOne__prime__" => new \Data\Generic\Rep\Data_Generic_Rep_Product(($dictGenericSemiring_0)->{'genericOne__prime__'}, ($dictGenericSemiring1_1)->{'genericOne__prime__'})];
  goto __end;;
  __end:
  return 2 < $__num ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
}
