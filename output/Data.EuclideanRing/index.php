...
$GLOBALS['Data_EuclideanRing_euclideanRingInt'] = (object)["degree" => $GLOBALS['Data_EuclideanRing_intDegree'], "div" => $GLOBALS['Data_EuclideanRing_intDiv'], "mod" => $GLOBALS['Data_EuclideanRing_intMod'], "CommutativeRing0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
...
function majData_majEuclideanmajRing_lcm($dictEq_0, $dictEuclideanRing_1 = null) {
  ...
  $Ring0_2_0 = (((($dictEuclideanRing_1)->{'CommutativeRing0'})(null))->{'Ring0'})(null);
  $zero_3_1 = ((($Ring0_2_0)->{'Semiring0'})(null))->{'zero'};
  $Semiring0_4_2 = (($Ring0_2_0)->{'Semiring0'})(null);
  $__res = function($a_5) use ($Semiring0_4_2, $dictEq_0, $dictEuclideanRing_1, $zero_3_1) {
  $__num = \func_num_args();
  $__res = function($b_6) use ($Semiring0_4_2, $a_5, $dictEq_0, $dictEuclideanRing_1, $zero_3_1) {
  $__num = \func_num_args();
  $__t4 = null;;
...
goto end_branch_4;;
  ...
  $__t3 = null;;
  if (((($dictEq_0)->{'eq'})($b_6))(((((((($dictEuclideanRing_1)->{'CommutativeRing0'})(null))->{'Ring0'})(null))->{'Semiring0'})(null))->{'zero'})) {
$__t3 = $a_5;
goto end_branch_3;;
};
  $__t3 = (((($GLOBALS['Data_EuclideanRing_gcd'])($dictEq_0))($dictEuclideanRing_1))($b_6))(((($dictEuclideanRing_1)->{'mod'})($a_5))($b_6));
  end_branch_3:;
  $__t4 = ((($dictEuclideanRing_1)->{'div'})(((($Semiring0_4_2)->{'mul'})($a_5))($b_6)))($__t3);
  end_branch_4:;
  $__res = $__t4;
  goto __end;;
  __end:
