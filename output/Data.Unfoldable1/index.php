...
$GLOBALS['Data_Unfoldable1_unfoldable1Maybe'] = (object)["unfoldr1" => function($f_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Unfoldable1_unfoldable1Array'] = (object)["unfoldr1" => (((($GLOBALS['Data_Unfoldable1_unfoldr1ArrayImpl'])($GLOBALS['Data_Maybe_isNothing']))(function($v_0) {
  $__num = \func_num_args();
  $__t0 = null;;
...
function majData_majUnfoldable1_replicate1majA($dictApply_0, $dictUnfoldable1_1 = null, $dictTraversable1_2 = null, $n_3 = null, $m_4 = null) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majUnfoldable1_replicate1majA';
  if ($__num < 5) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 5);
  }
  $__res = ((($dictTraversable1_2)->{'sequence1'})($dictApply_0))(((($dictUnfoldable1_1)->{'unfoldr1'})(function($i_5) use ($m_4) {
  $__num = \func_num_args();
  $__t0 = null;;
  if (($i_5 <= 0)) {
$__t0 = new \Data\Tuple\Data_Tuple_Tuple($m_4, new \Data\Maybe\Data_Maybe_Nothing());
goto end_branch_0;;
};
  $__t0 = new \Data\Tuple\Data_Tuple_Tuple($m_4, new \Data\Maybe\Data_Maybe_Just(($i_5 - 1)));
  end_branch_0:;
  $__res = $__t0;
  goto __end;;
  __end:
...
function majData_majUnfoldable1_singleton($dictUnfoldable1_0, $v_1 = null) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majData_majUnfoldable1_singleton';
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__res = ((($dictUnfoldable1_0)->{'unfoldr1'})(function($i_2) use ($v_1) {
  $__num = \func_num_args();
  $__t0 = null;;
  if (($i_2 <= 0)) {
$__t0 = new \Data\Tuple\Data_Tuple_Tuple($v_1, new \Data\Maybe\Data_Maybe_Nothing());
goto end_branch_0;;
};
  $__t0 = new \Data\Tuple\Data_Tuple_Tuple($v_1, new \Data\Maybe\Data_Maybe_Just(($i_2 - 1)));
  end_branch_0:;
  $__res = $__t0;
  goto __end;;
  __end:
...
goto end_branch_0;;
  ...
  $__num = \func_num_args();
  $i_prime__5_2 = ($i_4 + $__local_var_3_0);
  $__res = new \Data\Tuple\Data_Tuple_Tuple($i_4, match ($i_4) { $end_2 => new \Data\Maybe\Data_Maybe_Nothing(), default => new \Data\Maybe\Data_Maybe_Just($i_prime__5_2) });
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))($start_1);
