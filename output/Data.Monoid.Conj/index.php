...
function majData_majMonoid_majConj_semiringmajConj($dictHeytingAlgebra_0) {
  ...
  $__res = (object)["zero" => ($dictHeytingAlgebra_0)->{'tt'}, "one" => ($dictHeytingAlgebra_0)->{'ff'}, "add" => function($v_1) use ($dictHeytingAlgebra_0) {
  $__num = \func_num_args();
...
function majData_majMonoid_majConj_monoidmajConj($dictHeytingAlgebra_0) {
  ...
  $semigroupConj1_1_0 = (object)["append" => function($v_1) use ($dictHeytingAlgebra_0) {
  $__num = \func_num_args();
  $__res = function($v1_2) use ($dictHeytingAlgebra_0, $v_1) {
  $__num = \func_num_args();
  $__res = ((($dictHeytingAlgebra_0)->{'conj'})($v_1))($v1_2);
  ...
  $__res = (object)["mempty" => ($dictHeytingAlgebra_0)->{'tt'}, "Semigroup0" => function($_dollar___unused_2) use ($semigroupConj1_1_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Monoid_Conj_functorConj'] = (object)["map" => function($f_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Monoid_Conj_applyConj'] = (object)["apply" => function($v_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Monoid_Conj_bindConj'] = (object)["bind" => function($v_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Monoid_Conj_applicativeConj'] = (object)["pure" => function($x_0) {
  $__num = \func_num_args();
  $__res = $x_0;
  goto __end;;
  __end:
...
$GLOBALS['Data_Monoid_Conj_monadConj'] = (object)["Applicative0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
