...
goto end_branch_5;;
  ...
  $__t5 = "";
  end_branch_5:;
  $__res = \Data\String\Regex\majData_majString_majRegex_regexmajImpl($GLOBALS['Data_Either_Left'], $GLOBALS['Data_Either_Right'], $s_0, ((((($__t0 . $__t1) . $__t2) . $__t3) . $__t4) . $__t5));
  goto __end;;
  __end:
  return 2 < $__num ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
}
...
$GLOBALS['Data_String_Regex_flags_closure'] = (($GLOBALS['Control_Semigroupoid_composeImpl'])(function($x_0) {
  $__num = \func_num_args();
  $__res = $x_0;
  goto __end;;
  __end:
