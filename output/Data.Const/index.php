...
$GLOBALS['Data_Const_newtypeConst'] = (object)["Coercible0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
  $__res = null;
  goto __end;;
  __end:
...
function majData_majConst_ord1majConst($dictOrd_0) {
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Eq10" => function($_dollar___unused_3) use ($eq1Const1_2_1) {
  $__num = \func_num_args();
  $__res = $eq1Const1_2_1;
  goto __end;;
  __end:
...
function majData_majConst_applicativemajConst($dictMonoid_0) {
  ...
  $applyConst1_1_0 = (object)["apply" => function($v_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  $__res = function($v1_3) use ($__local_var_1_0, $v_2) {
  $__num = \func_num_args();
  $__res = ((($__local_var_1_0)->{'append'})($v_2))($v1_3);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
  ...
  $__res = (object)["pure" => function($v_2) use ($dictMonoid_0) {
  $__num = \func_num_args();
  $__res = ($dictMonoid_0)->{'mempty'};
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Apply0" => function($_dollar___unused_2) use ($applyConst1_1_0) {
  $__num = \func_num_args();
  $__res = $applyConst1_1_0;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}];
