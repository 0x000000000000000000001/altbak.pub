...
$GLOBALS['Control_Monad_ST_Class_monadSTEffect'] = (object)["liftST" => $GLOBALS['Unsafe_Coerce_unsafeCoerce'], "Monad0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
...
function majControl_majMonad_majSmajT_majClass_liftmajSmajT($dict_0) {
  $__num = \func_num_args();
