...
function majData_majSemigroup_majFoldable_maximummajBy($dictFoldable1_0, $cmp_1 = null) {
  ...
  $__res = (($dictFoldable1_0)->{'foldl1'})(function($x_2) use ($cmp_1) {
  $__num = \func_num_args();
  $__res = function($y_3) use ($cmp_1, $x_2) {
  $__num = \func_num_args();
  $__t0 = null;;
  if ((($cmp_1)($x_2))($y_3) instanceof \Data\Ordering\Data_Ordering_GT) {
$__t0 = $x_2;
goto end_branch_0;;
};
  $__t0 = $y_3;
...
function majData_majSemigroup_majFoldable_minimummajBy($dictFoldable1_0, $cmp_1 = null) {
  ...
  $__num = \func_num_args();
  $__t0 = null;;
  if ((($cmp_1)($x_2))($y_3) instanceof \Data\Ordering\Data_Ordering_LT) {
$__t0 = $x_2;
goto end_branch_0;;
};
  $__t0 = $y_3;
...
$GLOBALS['Data_Semigroup_Foldable_foldableTuple'] = (object)["foldMap1" => function($dictSemigroup_0) {
  $__num = \func_num_args();
  $__res = function($f_1) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Semigroup_Foldable_foldableMultiplicative'] = (object)["foldr1" => function($v_0) {
  $__num = \func_num_args();
  $__res = function($v1_1) {
  $__num = \func_num_args();
  $__res = $v1_1;
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "foldMap1" => function($dictSemigroup_0) {
  $__num = \func_num_args();
  $__res = function($f_1) {
  $__num = \func_num_args();
  $__res = function($v_2) use ($f_1) {
...
$GLOBALS['Data_Semigroup_Foldable_foldableIdentity'] = (object)["foldMap1" => function($dictSemigroup_0) {
  $__num = \func_num_args();
  $__res = function($f_1) {
  $__num = \func_num_args();
  $__res = function($v_2) use ($f_1) {
...
$GLOBALS['Data_Semigroup_Foldable_foldableDual'] = (object)["foldr1" => function($v_0) {
  $__num = \func_num_args();
  $__res = function($v1_1) {
  $__num = \func_num_args();
  $__res = $v1_1;
...
$GLOBALS['Data_Semigroup_Foldable_foldRight1Semigroup'] = (object)["append" => function($v_0) {
  $__num = \func_num_args();
  $__res = function($v1_1) use ($v_0) {
  $__num = \func_num_args();
  $__local_var_2_0 = ($v_0)->{'value1'};
  $__res = new \Data\Semigroup\Foldable\Data_Semigroup_Foldable_FoldRight1(function($a_3) use ($__local_var_2_0, $v1_1, $v_0) {
  $__num = \func_num_args();
  $__res = function($f_4) use ($__local_var_2_0, $a_3, $v1_1, $v_0) {
  $__num = \func_num_args();
...
$GLOBALS['Data_Semigroup_Foldable_semigroupDual'] = (object)["append" => function($v_0) {
  $__num = \func_num_args();
  $__res = function($v1_1) use ($v_0) {
  $__num = \func_num_args();
...
function majData_majSemigroup_majFoldable_foldl1majDefault($dictFoldable1_0) {
  ...
  $__res = (($GLOBALS['Control_Semigroupoid_composeImpl'])(function($b_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  $__res = function($a_3) use ($__local_var_1_0, $b_2) {
  $__num = \func_num_args();
...
function majData_majSemigroup_majFoldable_foldr1majDefault($dictFoldable1_0) {
  ...
  $__res = function($b_2) use ($__local_var_1_0) {
  $__num = \func_num_args();
  $__res = function($a_3) use ($__local_var_1_0, $b_2) {
  $__num = \func_num_args();
  $__res = (($__local_var_1_0)($a_3))($b_2);
...
function majData_majSemigroup_majFoldable_intercalatemajMap($dictFoldable1_0, $dictSemigroup_1 = null) {
  ...
  $semigroupJoinWith1_2_0 = (object)["append" => function($v_2) use ($dictSemigroup_1) {
  $__num = \func_num_args();
  $__res = function($v1_3) use ($dictSemigroup_1, $v_2) {
  $__num = \func_num_args();
  $__res = function($j_4) use ($dictSemigroup_1, $v1_3, $v_2) {
  $__num = \func_num_args();
  ...
  $__res = function($j_3) use ($dictFoldable1_0, $semigroupJoinWith1_2_0) {
  $__num = \func_num_args();
  $__res = function($f_4) use ($dictFoldable1_0, $j_3, $semigroupJoinWith1_2_0) {
  $__num = \func_num_args();
  $__res = function($foldable_5) use ($dictFoldable1_0, $f_4, $j_3, $semigroupJoinWith1_2_0) {
  $__num = \func_num_args();
  $__res = ((((($dictFoldable1_0)->{'foldMap1'})($semigroupJoinWith1_2_0))((($GLOBALS['Control_Semigroupoid_composeImpl'])(function($x_6) {
  $__num = \func_num_args();
  $__res = $x_6;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))((($GLOBALS['Control_Semigroupoid_composeImpl'])($GLOBALS['Data_Function_const']))($f_4))))($foldable_5))($j_3);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};
...
function majData_majSemigroup_majFoldable_intercalate($dictFoldable1_0, $dictSemigroup_1 = null) {
  ...
  $__res = function($a_3) use ($dictFoldable1_0, $semigroupJoinWith1_2_0) {
  $__num = \func_num_args();
  $__res = function($foldable_4) use ($a_3, $dictFoldable1_0, $semigroupJoinWith1_2_0) {
  $__num = \func_num_args();
  $__res = ((((($dictFoldable1_0)->{'foldMap1'})($semigroupJoinWith1_2_0))((($GLOBALS['Control_Semigroupoid_composeImpl'])(function($x_5) {
  $__num = \func_num_args();
  $__res = $x_5;
  goto __end;;
  __end:
...
function majData_majSemigroup_majFoldable_maximum($dictOrd_0) {
  ...
  $semigroupMax_1_0 = (object)["append" => function($v_1) use ($dictOrd_0) {
  $__num = \func_num_args();
...
function majData_majSemigroup_majFoldable_minimum($dictOrd_0) {
  ...
  $semigroupMin_1_0 = (object)["append" => function($v_1) use ($dictOrd_0) {
  $__num = \func_num_args();
  $__res = function($v1_2) use ($dictOrd_0, $v_1) {
  $__num = \func_num_args();
  $v_3_0 = ((($dictOrd_0)->{'compare'})($v_1))($v1_2);
...
function majData_majSemigroup_majFoldable_traverse1_($dictFoldable1_0, $dictApply_1 = null) {
  ...
  $semigroupAct1_3_1 = (object)["append" => function($v_3) use ($dictApply_1) {
  $__num = \func_num_args();
  $__res = function($v1_4) use ($dictApply_1, $v_3) {
  $__num = \func_num_args();
  $__res = ((($dictApply_1)->{'apply'})(((((($dictApply_1)->{'Functor0'})(null))->{'map'})(function($v_5) {
  $__num = \func_num_args();
  $__res = function($x_6) {
  $__num = \func_num_args();
  $__res = $x_6;
  ...
  $__res = function($f_4) use ($Functor0_2_0, $dictFoldable1_0, $semigroupAct1_3_1) {
  $__num = \func_num_args();
  $__res = function($t_5) use ($Functor0_2_0, $dictFoldable1_0, $f_4, $semigroupAct1_3_1) {
  $__num = \func_num_args();
  $__res = ((($Functor0_2_0)->{'map'})(function($v_6) {
  $__num = \func_num_args();
  $__res = $GLOBALS['Data_Unit_unit'];
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))((((($dictFoldable1_0)->{'foldMap1'})($semigroupAct1_3_1))((($GLOBALS['Control_Semigroupoid_composeImpl'])(function($x_6) {
  $__num = \func_num_args();
  $__res = $x_6;
  goto __end;;
  __end:
...
function majData_majSemigroup_majFoldable_for1_($dictFoldable1_0, $dictApply_1 = null) {
  ...
  $__res = function($b_4) use ($Functor0_2_0, $dictFoldable1_0, $semigroupAct1_3_1) {
  $__num = \func_num_args();
  $__res = function($a_5) use ($Functor0_2_0, $b_4, $dictFoldable1_0, $semigroupAct1_3_1) {
  $__num = \func_num_args();
  $__res = ((($Functor0_2_0)->{'map'})(function($v_6) {
  $__num = \func_num_args();
  $__res = $GLOBALS['Data_Unit_unit'];
...
function majData_majSemigroup_majFoldable_sequence1_($dictFoldable1_0, $dictApply_1 = null) {
  ...
  $__res = function($t_4) use ($Functor0_2_0, $dictFoldable1_0, $semigroupAct1_3_1) {
  $__num = \func_num_args();
  $__res = ((($Functor0_2_0)->{'map'})(function($v_5) {
  $__num = \func_num_args();
  $__res = $GLOBALS['Data_Unit_unit'];
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))((((($dictFoldable1_0)->{'foldMap1'})($semigroupAct1_3_1))((($GLOBALS['Control_Semigroupoid_composeImpl'])(function($x_5) {
  $__num = \func_num_args();
  $__res = $x_5;
  goto __end;;
  __end:
...
function majData_majSemigroup_majFoldable_fold1($dictFoldable1_0, $dictSemigroup_1 = null) {
  ...
  $__res = ((($dictFoldable1_0)->{'foldMap1'})($dictSemigroup_1))(function($x_2) {
  $__num = \func_num_args();
  $__res = $x_2;
  goto __end;;
  __end:
