...
function majData_majProfunctor_majChoice_fanin($dictSemigroupoid_0, $dictChoice_1 = null) {
  ...
  $Profunctor0_2_0 = (($dictChoice_1)->{'Profunctor0'})(null);
  $__res = function($l_3) use ($Profunctor0_2_0, $dictChoice_1, $dictSemigroupoid_0) {
  $__num = \func_num_args();
  $__res = function($r_4) use ($Profunctor0_2_0, $dictChoice_1, $dictSemigroupoid_0, $l_3) {
  $__num = \func_num_args();
  $__res = (((($Profunctor0_2_0)->{'dimap'})(function($x_5) {
  $__num = \func_num_args();
  $__res = $x_5;
  goto __end;;
  __end:
...
$__t1 = new \Data\Either\Data_Either_Left(($m_1)->{'value0'});
goto end_branch_1;;
};
  if ($m_1 instanceof \Data\Either\Data_Either_Right) {
$__t1 = new \Data\Either\Data_Either_Right(($f_0)(($m_1)->{'value0'}));
goto end_branch_1;;
};
  throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
  $__t1 = null;
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Profunctor0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
