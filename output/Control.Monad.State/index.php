...
function majControl_majMonad_majState_withmajState($v_0, $v_1 = null, $v_2 = null) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majControl_majMonad_majState_withmajState';
  if ($__num < 3) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 3);
  }
  $__res = ($GLOBALS['Control_Monad_State_withState_closure'])($v_0, $v_1, $v_2);
  goto __end;;
  __end:
...
function majControl_majMonad_majState_mapmajState($f_0) {
  ...
  $__res = ($GLOBALS['Control_Monad_State_Trans_mapStateT'])((($GLOBALS['Control_Semigroupoid_composeImpl'])(function($x_1) {
  $__num = \func_num_args();
  $__res = $x_1;
  goto __end;;
  __end:
