...
Go Benchmark            | Compiled Go (gopurs, mature WIP) | Compiled Go (<a href="https://github.com/i-am-the-slime/purescript-native">psgo</a>) | Native Go FFI | Native Go FFI Cheatcode |
----------------------- | -------------------------------- | ------------------------------------------------------------------------------------ | ------------- | ----------------------- |
