...
Tail Call Optimization  | ~ 38.00 μs                | ~ 114 μs     | ~ 35 μs                |
Deep Record Updates     | ~ 980.00 μs               | ~ 272 μs     | ~ 4 μs                 |
Ackermann               | ~ 19.00 μs                | ~ 38 μs      | ~ 18 μs                |
Church Numerals         | ~ 1506.00 μs              | ~ 598 μs     | ~ 1 μs                 |
Prime Sieve             | ~ 186.00 μs               | ~ 221 μs     | ~ 1 μs                 |
Red-Black Tree          | ~ 18985.00 μs             | ~ 59784 μs   | ~ 36070 μs             |
...
**Total Execution Time**| ~ 21.82 ms                | ~ 94.61 ms      | ~ 36.13 ms                |
