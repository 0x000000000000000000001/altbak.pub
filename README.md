...
Tail Call Optimization  | ~ 0 μs                           | ~ 13354 μs                            | ~ 39 μs       | ~ 27 μs                 |
Deep Record Updates     | ~ 609 μs                         | ~ 9492 μs                             | ~ 373 μs      | ~ 3 μs                  |
Ackermann               | ~ 15 μs                          | ~ 1267 μs                             | ~ 23 μs       | ~ 32 μs                 |
Church Numerals         | ~ 1586 μs                        | ~ 5731 μs                             | ~ 1002 μs     | ~ 29 μs                 |
Prime Sieve             | ~ 63 μs                          | ~ 2549 μs                             | ~ 134 μs      | ~ 4 μs                  |
Red-Black Tree          | ~ 21544 μs                       | ~ 870034 μs                           | ~ 26529 μs    | ~ 24856 μs              |
Polymorphism            | ~ 2216 μs                        | ~ 669801 μs                           | ~ 58848 μs    | ~ 2480 μs               |
State Monad             | ~ 42 μs                          | ~ 536 μs                              | ~ 127 μs      | ~ 1 μs                  |
Lazy Evaluation         | ~ 15933 μs                       | ~ 71586 μs                            | ~ 14816 μs    | ~ 1 μs                  |
Array Processing        | ~ 13 μs                          | ~ 61 μs                               | ~ 7 μs        | ~ 1 μs                  |
RowToList               | ~ 0 μs                           | ~ 2 μs                                | ~ 1 μs        | ~ 1 μs                  |
**Total Execution Time**    | ~ 42.03 ms                       | ~ 1645.32 ms                          | ~ 102.04 ms   | ~ 27.44 ms              |
> *Read the IMPORTANT notice below!*
...
Tail Call Optimization  | ~ 1581 μs                 | ~ 1937 μs      | ~ 109 μs                 |
Deep Record Updates     | ~ 1751 μs                 | ~ 4016 μs      | ~ 199 μs                 |
Ackermann               | ~ 42 μs                   | ~ 665 μs       | ~ 579 μs                 |
Church Numerals         | ~ 8928 μs                 | ~ 8922 μs      | ~ 105 μs                 |
Prime Sieve             | ~ 708 μs                  | ~ 7 μs         | ~ 386 μs                 |
Red-Black Tree          | ~ 269606 μs               | ~ 730387 μs    | ~ 123096 μs              |
Polymorphism            | ~ 6380 μs                 | ~ 1169540 μs   | ~ 74555 μs               |
State Monad             | ~ 397 μs                  | ~ 358 μs       | ~ 86 μs                  |
Lazy Evaluation         | ~ 91955 μs                | ~ 151601 μs    | ~ 368 μs                 |
...
Tail Call Optimization  | ~ 296 μs                  | ~ 114 μs     | ~ 47 μs                |
Deep Record Updates     | ~ 1467 μs                 | ~ 272 μs     | ~ 7 μs                 |
Ackermann               | ~ 65 μs                   | ~ 38 μs      | ~ 29 μs                |
Church Numerals         | ~ 24331 μs                | ~ 598 μs     | ~ 3 μs                 |
Prime Sieve             | ~ 385 μs                  | ~ 221 μs     | ~ 4 μs                 |
Red-Black Tree          | ~ 67125 μs                | ~ 59784 μs   | ~ 16700 μs             |
Polymorphism            | ~ 38663 μs                | ~ 8342 μs    | ~ 4 μs                 |
State Monad             | ~ 514 μs                  | ~ 145 μs     | ~ 3 μs                 |
Lazy Evaluation         | ~ 319209 μs               | ~ 24919 μs   | ~ 3 μs                 |
...
Tail Call Optimization  | ~ 184283 μs               | ~ 247 μs        | ~ 200 μs                  |
Deep Record Updates     | ~ 52581 μs                | ~ 314 μs        | ~ 225 μs                  |
Ackermann               | ~ 10568 μs                | ~ 120 μs        | ~ 107 μs                  |
Church Numerals         | ~ 140788 μs               | ~ 80 μs         | ~ 76 μs                   |
Prime Sieve             | ~ 24620 μs                | ~ 447 μs        | ~ 119 μs                  |
Red-Black Tree          | ~ 2557831 μs              | ~ 76561 μs      | ~ 65156 μs                |
Polymorphism            | ~ 9689415 μs              | ~ 3343 μs       | ~ 2805 μs                 |
State Monad             | ~ 3839 μs                 | ~ 1638 μs       | ~ 100 μs                  |
Lazy Evaluation         | ~ 1222417 μs              | ~ 107 μs        | ~ 75 μs                   |
