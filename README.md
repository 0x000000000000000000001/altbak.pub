...
Deep Record Updates     | ~ 4 μs                           | ~ 9492 μs                             | ~ 373 μs      | ~ 3 μs                  |
Ackermann               | ~ 15 μs                          | ~ 1267 μs                             | ~ 23 μs       | ~ 32 μs                 |
Church Numerals         | ~ 1613 μs                        | ~ 5731 μs                             | ~ 1002 μs     | ~ 29 μs                 |
Prime Sieve             | ~ 65 μs                          | ~ 2549 μs                             | ~ 134 μs      | ~ 4 μs                  |
Red-Black Tree          | ~ 21780 μs                       | ~ 870034 μs                           | ~ 26529 μs    | ~ 24856 μs              |
Polymorphism            | ~ 2216 μs                        | ~ 669801 μs                           | ~ 58848 μs    | ~ 2480 μs               |
State Monad             | ~ 145 μs                         | ~ 536 μs                              | ~ 127 μs      | ~ 1 μs                  |
Lazy Evaluation         | ~ 15237 μs                       | ~ 71586 μs                            | ~ 14816 μs    | ~ 1 μs                  |
Array Processing        | ~ 13 μs                          | ~ 61 μs                               | ~ 7 μs        | ~ 1 μs                  |
RowToList               | ~ 0 μs                           | ~ 2 μs                                | ~ 1 μs        | ~ 1 μs                  |
**Total Execution Time**    | ~ 41.13 ms                       | ~ 1645.32 ms                          | ~ 102.04 ms   | ~ 27.44 ms              |
> *Read the IMPORTANT notice below!*
