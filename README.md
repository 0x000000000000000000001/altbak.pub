...
> [!NOTE]
> **Go backend and the FFI approach**
> The *Native Go FFI* column demonstrates that the code generated by `gopurs` (Go mature WIP) is within a highly advantageous order of magnitude compared to the theoretical limits of the language (only a ~2x overall overhead ratio between native Go and transpiled code). However, the use of FFI remains essential and is encouraged for locally optimizing critical algorithmic *hot paths*.
> [!NOTE]
