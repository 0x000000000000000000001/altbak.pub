...
Fibonacci               | ~ 3 μs                    | ~ 11 μs        | ~ 451 μs                 |
List Processing         | ~ 154 μs                  | ~ 4 μs         | ~ 166 μs                 |
Tail Call Optimization  | ~ 75 μs                   | ~ 1937 μs      | ~ 109 μs                 |
Deep Record Updates     | ~ 1522 μs                 | ~ 4016 μs      | ~ 199 μs                 |
Ackermann               | ~ 49 μs                   | ~ 665 μs       | ~ 579 μs                 |
Church Numerals         | ~ 8859 μs                 | ~ 8922 μs      | ~ 105 μs                 |
Prime Sieve             | ~ 477 μs                  | ~ 7 μs         | ~ 386 μs                 |
Red-Black Tree          | ~ 247881 μs               | ~ 730387 μs    | ~ 123096 μs              |
Polymorphism            | ~ 6557 μs                 | ~ 1169540 μs   | ~ 74555 μs               |
State Monad             | ~ 432 μs                  | ~ 358 μs       | ~ 86 μs                  |
Lazy Evaluation         | ~ 50331 μs                | ~ 151601 μs    | ~ 368 μs                 |
Array Processing        | ~ 99 μs                   | ~ 448 μs       | ~ 249 μs                 |
RowToList               | ~ 1 μs                    | ~ 4 μs         | ~ 94 μs                  |
**Total Execution Time**    | ~ 316.45 ms           | ~ 2067.91 ms   | ~ 200.45 ms              |
...
----------------------- | ------------------------- | ------------------------ | ------------------------------ |
AST Evaluation          | ~ 1 μs                    | ~ 38 μs      | ~ 4 μs                 |
Fibonacci               | ~ 1 μs                    | ~ 27 μs      | ~ 4 μs                 |
List Processing         | ~ 27 μs                   | ~ 76 μs      | ~ 4 μs                 |
Tail Call Optimization  | ~ 37 μs                   | ~ 114 μs     | ~ 47 μs                |
Deep Record Updates     | ~ 985 μs                  | ~ 272 μs     | ~ 7 μs                 |
Ackermann               | ~ 19 μs                   | ~ 38 μs      | ~ 29 μs                |
Church Numerals         | ~ 5096 μs                 | ~ 598 μs     | ~ 3 μs                 |
Prime Sieve             | ~ 189 μs                  | ~ 221 μs     | ~ 4 μs                 |
Red-Black Tree          | ~ 40746 μs                | ~ 59784 μs   | ~ 16700 μs             |
Polymorphism            | ~ 1 μs                    | ~ 8342 μs    | ~ 4 μs                 |
State Monad             | ~ 74 μs                   | ~ 145 μs     | ~ 3 μs                 |
Lazy Evaluation         | ~ 72002 μs                | ~ 24919 μs   | ~ 3 μs                 |
Array Processing        | ~ 15 μs                   | ~ 14 μs      | ~ 3 μs                 |
RowToList               | ~ 1 μs                    | ~ 27 μs      | ~ 2 μs                 |
**Total Execution Time**| ~ 119.19 ms               | ~ 94.61 ms      | ~ 16.82 ms                |
...
----------------------- | ------------------------- | ------------------------- | ------------------------------- |
AST Evaluation          | ~ 80 μs                   | ~ 615 μs        | ~ 177 μs                  |
Fibonacci               | ~ 7 μs                    | ~ 252 μs        | ~ 63 μs                   |
List Processing         | ~ 395 μs                  | ~ 472 μs        | ~ 77 μs                   |
Tail Call Optimization  | ~ 45 μs                   | ~ 247 μs        | ~ 200 μs                  |
Deep Record Updates     | ~ 3251 μs                 | ~ 314 μs        | ~ 225 μs                  |
Ackermann               | ~ 381 μs                  | ~ 120 μs        | ~ 107 μs                  |
Church Numerals         | ~ 3596 μs                 | ~ 80 μs         | ~ 76 μs                   |
Prime Sieve             | ~ 1833 μs                 | ~ 447 μs        | ~ 119 μs                  |
Red-Black Tree          | ~ 213760 μs               | ~ 76561 μs      | ~ 65156 μs                |
Polymorphism            | ~ 2222 μs                 | ~ 3343 μs       | ~ 2805 μs                 |
State Monad             | ~ 184 μs                  | ~ 1638 μs       | ~ 100 μs                  |
Lazy Evaluation         | ~ 68987 μs                | ~ 107 μs        | ~ 75 μs                   |
Array Processing        | ~ 56 μs                   | ~ 357 μs        | ~ 75 μs                   |
RowToList               | ~ 1 μs                    | ~ 47 μs         | ~ 45 μs                   |
**Total Execution Time**| ~ 294.80 ms               | ~ 84.6 ms       | ~ 69.3 ms                 |
...
----------------------- | ------------------------- | ------------------------ | ------------------------------ |
AST Evaluation          | ~ 46.00 μs                | ~ 69 μs                  | ~ 4.4 μs                       |
Fibonacci               | ~ 5.25 μs                 | ~ 2.5 μs                 | ~ 1.9 μs                       |
List Processing         | ~ 170.42 μs               | ~ 65 μs                  | ~ 6.4 μs                       |
Tail Call Optimization  | ~ 47.54 μs                | ~ 43 μs                  | ~ 42 μs                        |
Deep Record Updates     | ~ 1032.83 μs              | ~ 132 μs                 | ~ 18 μs                        |
Ackermann               | ~ 18.46 μs                | ~ 10 μs                  | ~ 7.5 μs                       |
Church Numerals         | ~ 437.38 μs               | ~ 435 μs                 | ~ 1.8 μs                       |
Prime Sieve             | ~ 155.21 μs               | ~ 61 μs                  | ~ 8.9 μs                       |
Red-Black Tree          | ~ 18636.21 μs             | ~ 12278 μs               | ~ 12384 μs                     |
Polymorphism            | ~ 4921.67 μs              | ~ 148 μs                 | ~ 1.7 μs                       |
State Monad             | ~ 109.00 μs               | ~ 40 μs                  | ~ 6.5 μs                       |
Lazy Evaluation         | ~ 5140.96 μs              | ~ 5168 μs                | ~ 1.5 μs                       |
Array Processing        | ~ 68.79 μs                | ~ 41 μs                  | ~ 7.1 μs                       |
RowToList               | ~ 1.54 μs                 | ~ 2.2 μs                 | ~ 1.3 μs                       |
**Total Execution Time**| ~ 30.79 ms                | ~ 18.50 ms               | ~ 12.49 ms                     |
