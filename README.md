...
Benchmark               | JS            | [Arista JS](https://github.com/aristanetworks/purescript-backend-optimizer) | Compiled Go ([gopurs](https://github.com/0x000000000000000000001/gopurs))
----------------------- | ------------- | -------------- | --------------- 
