...
Church Numerals         | ~ 1583 μs                        | ~ 5731 μs                             | ~ 1002 μs     | ~ 29 μs                 |
Prime Sieve             | ~ 63 μs                          | ~ 2549 μs                             | ~ 134 μs      | ~ 4 μs                  |
Red-Black Tree          | ~ 21371 μs                       | ~ 870034 μs                           | ~ 26529 μs    | ~ 24856 μs              |
Polymorphism            | ~ 2217 μs                        | ~ 669801 μs                           | ~ 58848 μs    | ~ 2480 μs               |
State Monad             | ~ 108 μs                         | ~ 536 μs                              | ~ 127 μs      | ~ 1 μs                  |
Lazy Evaluation         | ~ 15155 μs                       | ~ 71586 μs                            | ~ 14816 μs    | ~ 1 μs                  |
Array Processing        | ~ 13 μs                          | ~ 61 μs                               | ~ 7 μs        | ~ 1 μs                  |
RowToList               | ~ 0 μs                           | ~ 2 μs                                | ~ 1 μs        | ~ 1 μs                  |
**Total Execution Time**    | ~ 40.57 ms                       | ~ 1645.32 ms                          | ~ 102.04 ms   | ~ 27.44 ms              |
> *Read the IMPORTANT notice below!*
