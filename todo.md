...
| **Last-use moves / borrowing; propagation of uniqueness** | **14 — B14, partial**, also **B12** | Selected moves and borrows are integrated, including closed-record roots moved after replacement values at last use. This lets existing setters reuse unique roots; nested children still copy in Records. Some ADT reconstruction paths retest uniqueness; read-only traversals can still clone child pointers. |
